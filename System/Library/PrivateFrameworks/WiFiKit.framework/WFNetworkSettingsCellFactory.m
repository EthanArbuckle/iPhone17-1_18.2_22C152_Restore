...
- (id)joinCellAtIndexPath:(id)a3
{
  ...
  v8 = [v7 localizedStringForKey:@"kWFLocSettingJoinNetworkTitle" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  v9 = [v6 textLabel];
  [v9 setText:v8];

  v10 = [MEMORY[0x263F1C550] defaultButtonColor];
  id v11 = [v6 textLabel];
...
- (id)forgetCellAtIndexPath:(id)a3 accessory:(BOOL)a4
{
  ...
  v13 = [v9 localizedStringForKey:v12 value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  v14 = [v8 textLabel];
  [v14 setText:v13];
  ...
  v16 = [v15 localizedStringForKey:v11 value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  v17 = [v8 textLabel];
  [v17 setText:v16];
...
- (id)outrankedCellAtIndexPath:(id)a3 chinaDevice:(BOOL)a4
{
  ...
  v14 = [MEMORY[0x263F1C550] defaultButtonColor];
  v15 = [v8 textLabel];
...
- (id)manageCellAtIndexPath:(id)a3
{
  ...
  v7 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v8 = [v7 localizedStringForKey:@"kWFLocSettingManageNetworkTitle" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  v9 = [v6 textLabel];
  [v9 setText:v8];
...
- (id)priorityCellAtIndexPath:(id)a3
{
  v3 = (void *)[objc_alloc(MEMORY[0x263F1CA48]) initWithStyle:1 reuseIdentifier:@"WFPriorityCell"];
  id v4 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  id v5 = [v4 localizedStringForKey:@"kWFLocSettingAutoJoinPriorityNetworkTitle" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  id v6 = [v3 textLabel];
  [v6 setText:v5];
...
- (id)autoJoinCellAtIndexPath:(id)a3
{
  ...
  v7 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v8 = [v7 localizedStringForKey:@"kWFLocSettingAutoJoinNetworkTitle" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  v9 = [v6 textLabel];
  [v9 setText:v8];
...
- (id)autoLoginCellAtIndexPath:(id)a3
{
  ...
  v7 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v8 = [v7 localizedStringForKey:@"kWFLocSettingAutoLoginNetworkTitle" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  v9 = [v6 textLabel];
  [v9 setText:v8];
...
- (id)saveDataModeCellAtIndexPath:(id)a3
{
  ...
  v7 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v8 = [v7 localizedStringForKey:@"kWFLocSettingSaveDataModeTitle" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  v9 = [v6 textLabel];
  [v9 setText:v8];
...
- (id)privacyProxyEnabledCellAtIndexPath:(id)a3
{
  ...
  v7 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v8 = [v7 localizedStringForKey:@"kWFLocSettingPrivacyProxyEnabledTitle" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  v9 = [v6 textLabel];
  [v9 setText:v8];
...
- (id)networkQualityCellAtIndexPath:(id)a3
{
  v3 = (void *)[objc_alloc(MEMORY[0x263F1CA48]) initWithStyle:1 reuseIdentifier:@"kWiFiNetworkQualityCellIdentifier"];
  id v4 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  id v5 = [v4 localizedStringForKey:@"kWFLocSettingNetworkQualityText" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  id v6 = [v3 textLabel];
  [v6 setText:v5];
...
- (id)wifiModeCellAtIndexPath:(id)a3
{
  v3 = (void *)[objc_alloc(MEMORY[0x263F1CA48]) initWithStyle:1 reuseIdentifier:@"kWFWiFiModeCellIdentifier"];
...
- (id)randomMACCellAtIndexPath:(id)a3 chinaDevice:(BOOL)a4
{
  ...
  if ([v5 row] == 1)
  {
    BOOL v6 = (void *)[objc_alloc(MEMORY[0x263F1CA48]) initWithStyle:1 reuseIdentifier:@"kWFRandomMACInfoCellIdentifier"];
    ...
    id v10 = [v7 localizedStringForKey:v9 value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
    id v11 = [v6 textLabel];
    [v11 setText:v10];

    [v6 setSelectionStyle:0];
    v12 = [MEMORY[0x263F1C550] altTextColor];
  ...
  {
    BOOL v6 = (void *)[objc_alloc(MEMORY[0x263F1CA48]) initWithStyle:1 reuseIdentifier:@"kWFPrivateAddressModeCellIdentifier"];
    ...
    v17 = [v14 localizedStringForKey:v16 value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
    v18 = [v6 textLabel];
    [v18 setText:v17];

    [v6 setSelectionStyle:0];
    v19 = [MEMORY[0x263F1C550] altTextColor];
...
- (id)ipv4AddressConfigCellAtIndexPath:(id)a3
{
  v3 = (void *)[objc_alloc(MEMORY[0x263F1CA48]) initWithStyle:1 reuseIdentifier:0];
  BOOL v4 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  id v5 = [v4 localizedStringForKey:@"kWFLocSettingsIPConfigureTitle" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  BOOL v6 = [v3 textLabel];
  [v6 setText:v5];

  BOOL v7 = [MEMORY[0x263F1C550] blackColor];
...
- (id)ipv4AddressCellAtIndexPath:(id)a3
{
  v3 = (void *)[objc_alloc(MEMORY[0x263F1CA48]) initWithStyle:1 reuseIdentifier:0];
  BOOL v4 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  id v5 = [v4 localizedStringForKey:@"kWFLocSettingsIPV4AddressCell" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  BOOL v6 = [v3 textLabel];
  [v6 setText:v5];
...
- (id)ipv4SubnetMaskCellAtIndexPath:(id)a3
{
  v3 = (void *)[objc_alloc(MEMORY[0x263F1CA48]) initWithStyle:1 reuseIdentifier:0];
  BOOL v4 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  id v5 = [v4 localizedStringForKey:@"kWFLocSettingsSubnetMaskCell" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  BOOL v6 = [v3 textLabel];
  [v6 setText:v5];
...
- (id)ipv4RouterCellAtIndexPath:(id)a3
{
  v3 = (void *)[objc_alloc(MEMORY[0x263F1CA48]) initWithStyle:1 reuseIdentifier:0];
  BOOL v4 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  id v5 = [v4 localizedStringForKey:@"kWFLocSettingsIPV4RouterCell" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  BOOL v6 = [v3 textLabel];
  [v6 setText:v5];
...
- (id)dhcpClientIDCellAtIndexPath:(id)a3
{
  v3 = (void *)[objc_alloc(MEMORY[0x263F1CA48]) initWithStyle:1 reuseIdentifier:0];
  BOOL v4 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  id v5 = [v4 localizedStringForKey:@"kWFLocSettingsClientIDCell" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  BOOL v6 = [v3 textLabel];
  [v6 setText:v5];
...
- (id)renewLeaseCellAtIndexPath:(id)a3
{
  ...
  BOOL v7 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v8 = [v7 localizedStringForKey:@"kWFLocSettingsRenewLeaseCell" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  v9 = [v6 textLabel];
  [v9 setText:v8];

  id v10 = [MEMORY[0x263F1C550] defaultButtonColor];
  id v11 = [v6 textLabel];
  [v11 setTextColor:v10];
...
- (id)ipv6AddressCellAtIndexPath:(id)a3
{
  v3 = (void *)[objc_alloc(MEMORY[0x263F1CA48]) initWithStyle:1 reuseIdentifier:0];
  id v4 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  id v5 = [v4 localizedStringForKey:@"kWFLocSettingsIPV6AddressCell" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  BOOL v6 = [v3 textLabel];
  [v6 setText:v5];
...
- (id)ipv6RouterCellAtIndexPath:(id)a3
{
  v3 = (void *)[objc_alloc(MEMORY[0x263F1CA48]) initWithStyle:1 reuseIdentifier:0];
  id v4 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  id v5 = [v4 localizedStringForKey:@"kWFLocSettingsIPV6RouterCell" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  BOOL v6 = [v3 textLabel];
  [v6 setText:v5];
...
- (id)dnsConfigureCellAtIndexPath:(id)a3
{
  v3 = (void *)[objc_alloc(MEMORY[0x263F1CA48]) initWithStyle:1 reuseIdentifier:@"kWFDNSCellIdentifier"];
  id v4 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  id v5 = [v4 localizedStringForKey:@"kWFLocSettingsDNSConfigureButton" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  BOOL v6 = [v3 textLabel];
  [v6 setText:v5];
...
- (id)httpProxyConfigCellAtIndexPath:(id)a3
{
  v3 = (void *)[objc_alloc(MEMORY[0x263F1CA48]) initWithStyle:1 reuseIdentifier:0];
  id v4 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  id v5 = [v4 localizedStringForKey:@"kWFLocSettingsProxyConfigureButton" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  BOOL v6 = [v3 textLabel];
  [v6 setText:v5];
...
- (id)dnsSearchDomainsCellAtIndexPath:(id)a3
{
  ...
  BOOL v7 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v8 = [v7 localizedStringForKey:@"kWFLocSettingsSearchDomainsCell" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  v9 = [v6 label];
  [v9 setText:v8];
...
- (id)dnsServerAddressesCellAtIndexPath:(id)a3
{
  ...
  BOOL v7 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v8 = [v7 localizedStringForKey:@"kWFLocSettingsDNSCell" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  v9 = [v6 label];
  [v9 setText:v8];
...
- (id)ipv4AddressTextCellAtIndexPath:(id)a3
{
  ...
  BOOL v7 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v8 = [v7 localizedStringForKey:@"kWFLocSettingsIPV4AddressCell" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  v9 = [v6 label];
  [v9 setText:v8];
...
- (id)ipv4SubnetMaskTextCellAtIndexPath:(id)a3
{
  ...
  BOOL v7 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v8 = [v7 localizedStringForKey:@"kWFLocSettingsSubnetMaskCell" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  v9 = [v6 label];
  [v9 setText:v8];
...
- (id)ipv4RouterTextCellAtIndexPath:(id)a3
{
  ...
  BOOL v7 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v8 = [v7 localizedStringForKey:@"kWFLocSettingsIPV4RouterCell" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  v9 = [v6 label];
  [v9 setText:v8];
...
- (id)dhcpClientIDTextCellAtIndexPath:(id)a3
{
  ...
  BOOL v7 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v8 = [v7 localizedStringForKey:@"kWFLocSettingsClientIDCell" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  v9 = [v6 label];
  [v9 setText:v8];
...
- (id)httpProxyURLTextCellAtIndexPath:(id)a3
{
  ...
  BOOL v7 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v8 = [v7 localizedStringForKey:@"kWFLocSettingsProxyURLCell" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  v9 = [v6 label];
  [v9 setText:v8];
...
- (id)httpProxyServerTextCellAtIndexPath:(id)a3
{
  ...
  BOOL v7 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v8 = [v7 localizedStringForKey:@"kWFLocSettingsProxyServerCell" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  v9 = [v6 label];
  [v9 setText:v8];
...
- (id)httpProxyPortTextCellAtIndexPath:(id)a3
{
  ...
  BOOL v7 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v8 = [v7 localizedStringForKey:@"kWFLocSettingsProxyPortCell" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  v9 = [v6 label];
  [v9 setText:v8];
...
- (id)httpProxyUserTextCellAtIndexPath:(id)a3
{
  ...
  BOOL v7 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v8 = [v7 localizedStringForKey:@"kWFLocSettingsProxyUsernameCell" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  v9 = [v6 label];
  [v9 setText:v8];
  ...
  id v11 = [v6 textField];
  [v11 setTextContentType:*MEMORY[0x263F1D760]];
...
- (id)httpProxyPasswordTextCellAtIndexPath:(id)a3
{
  ...
  BOOL v7 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v8 = [v7 localizedStringForKey:@"kWFLocSettingsProxyPasswordCell" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
  v9 = [v6 label];
  [v9 setText:v8];
  ...
  id v11 = [v6 textField];
  [v11 setTextContentType:*MEMORY[0x263F1D700]];
