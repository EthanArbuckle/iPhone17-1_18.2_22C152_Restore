...
void ___NETRBClientSetHostCount_block_invoke(uint64_t a1)
{
  ...
  {
    v3 = v2;
    xpc_dictionary_set_uint64(v2, netrbXPCKey, 0x3F3uLL);
    xpc_dictionary_set_string(v3, netrbXPCClientID, (const char *)(*(void *)(a1 + 48) + 32));
    xpc_dictionary_set_uint64(v3, netrbXPCHostType, *(unsigned int *)(a1 + 56));
    xpc_dictionary_set_uint64(v3, netrbXPCHosts, *(unsigned int *)(a1 + 60));
    NETRBInfoLog();
