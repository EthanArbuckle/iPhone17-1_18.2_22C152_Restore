...
- (WFNANTableViewController)init
{
  v3 = [MEMORY[0x263F86368] defaultAppearanceProxy];
  v14.receiver = self;
...
{
  v8.receiver = self;
  v8.super_class = (Class)WFNANTableViewController;
  ...
  uint64_t v7 = [v4 localizedStringForKey:v6 value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
...
- (void)_configureDataSource
{
  ...
  id v7 = objc_alloc_init(MEMORY[0x263F1C328]);
...
id __48__WFNANTableViewController__configureDataSource__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  v6 = *(void **)(a1 + 32);
  id v7 = a2;
  objc_super v8 = [v6 sections];
  v9 = objc_msgSend(v8, "objectAtIndexedSubscript:", objc_msgSend(v5, "section"));
  uint64_t v10 = [v9 unsignedIntegerValue];

  unint64_t v11 = [v7 dequeueReusableCellWithIdentifier:@"WFNANTableViewTextCellIdentifier"];

  if (!v11) {
    unint64_t v11 = (void *)[objc_alloc(MEMORY[0x263F1CA48]) initWithStyle:1 reuseIdentifier:@"WFNANTableViewTextCellIdentifier"];
  }
  if (v10 == 2)
  {
    if ([v5 row])
...
LABEL_15:
    ...
    v30 = [v29 localizedStringForKey:@"kWFLocNANSubscribers" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
    v31 = [v11 textLabel];
    [v31 setText:v30];
...
LABEL_19:
  ...
  if (v10 == 1)
  {
    ...
    v35 = [v34 localizedStringForKey:@"kWFLocNANPublishers" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
    v36 = [v11 textLabel];
    [v36 setText:v35];
  ...
  if (!v10 && ![v5 row])
  {
    ...
    v13 = [v12 localizedStringForKey:@"kWFLocNANState" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
...
- (void)_handlePublishersChangedNotification:(id)a3
{
  ...
  id v7 = [v4 userInfo];
  objc_super v8 = [v7 objectForKeyedSubscript:@"WFNANTableViewContextChangedPublisherKey"];
...
- (void)_handleSubscribersChangedNotification:(id)a3
{
  ...
  id v7 = [v4 userInfo];
  objc_super v8 = [v7 objectForKeyedSubscript:@"WFNANTableViewContextChangedSubscriberKey"];
...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
  ...
  if (v7 == 2)
  {
    ...
    objc_super v8 = WFNANSubscribeTableViewController;
    goto LABEL_7;
  }
  if (v7 == 1 && ![v11 row])
  {
    objc_super v8 = WFNANPublishTableViewController;
LABEL_7:
    v9 = (void *)[[v8 alloc] initWithContext:self->_context];
