...
+ (id)misDisablePromptOperation
{
  ...
  v4 = [v3 localizedStringForKey:@"kWFLocDisableMISAlertTitle" value:&stru_26D9BFD58 table:@"WiFiKitLocalizableStrings"];
  ...
  v10 = [v9 localizedStringForKey:@"kWFLocDisableMISAlertCancelButton" value:&stru_26D9BFD58 table:@"WiFiKitLocalizableStrings"];
  [v2 setObject:v10 forKey:*MEMORY[0x263EFFFE8]];

  v11 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
  v12 = [v11 localizedStringForKey:@"kWFLocDisableMISAlertEnableButton" value:&stru_26D9BFD58 table:@"WiFiKitLocalizableStrings"];
