  ...
  if (!v9)
  {
    ...
    if (WFCurrentLogLevel() && v30 && os_log_type_enabled(v30, v31))
    {
      *(_DWORD *)buf = 136315138;
      ...
      _os_log_impl(&dword_226071000, v30, v31, "%s: nil network", buf, 0xCu);
    }
...
LABEL_23:
  ...
  uint64_t v20 = [v17 localizedStringForKey:v19 value:&stru_26D9BFD58 table:@"WiFiKitLocalizableStrings"];
...
- (void)updateInfo:(id)a3
{
  ...
  v15 = [v12 localizedStringForKey:v14 value:&stru_26D9BFD58 table:@"WiFiKitLocalizableStrings"];
...
LABEL_17:
  v21 = [v18 localizedStringForKey:v20 value:&stru_26D9BFD58 table:@"WiFiKitLocalizableStrings"];
  motion = self->_motion;
  self->_motion = v21;
  ...
  if (v102)
  {
    ...
    objc_super v32 = [v28 localizedStringForKey:v30 value:&stru_26D9BFD58 table:@"WiFiKitLocalizableStrings"];
    ...
    v40 = [v36 localizedStringForKey:v38 value:&stru_26D9BFD58 table:@"WiFiKitLocalizableStrings"];
    cca = self->_cca;
    self->_cca = v40;
  ...
  if (v43)
  {
    ...
    else
    {
      ...
      v47 = [gateway localizedStringForKey:@"kWFLocDiagnosticsProbeNoConnection" value:&stru_26D9BFD58 table:@"WiFiKitLocalizableStrings"];
      v48 = self->_gateway;
      self->_gateway = v47;
    }
  }
  ...
  if (v51)
  {
    ...
    else
    {
      ...
      v56 = [internet localizedStringForKey:@"kWFLocDiagnosticsProbeNoConnection" value:&stru_26D9BFD58 table:@"WiFiKitLocalizableStrings"];
      v57 = self->_internet;
      self->_internet = v56;
    }
    v51 = v53;
  ...
  if (v59)
  {
    ...
    v66 = [v63 localizedStringForKey:v65 value:&stru_26D9BFD58 table:@"WiFiKitLocalizableStrings"];
    awdl = self->_awdl;
    self->_awdl = v66;
  }
  ...
  if (v68)
  {
    ...
    v73 = [v70 localizedStringForKey:v72 value:&stru_26D9BFD58 table:@"WiFiKitLocalizableStrings"];
  ...
  v80 = [v77 localizedStringForKey:v79 value:&stru_26D9BFD58 table:@"WiFiKitLocalizableStrings"];
  scan = self->_scan;
  self->_scan = v80;
  ...
  if (v82)
  {
    ...
    if (v85 && v86)
    {
      ...
      [v88 localizedStringForKey:@"kWFLocDiagnosticsLastScan" value:&stru_26D9BFD58 table:@"WiFiKitLocalizableStrings"];
      v97 = v17;
      v90 = v89 = v11;
