...
- (void)viewDidLoad
{
  ...
  v4 = [v3 localizedStringForKey:@"kWFLocNANPublish" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
...
id __55__WFNANPublishTableViewController__configureDataSource__block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v10 == 1)
  {
    ...
    if (!v12) {
      unint64_t v12 = (void *)[objc_alloc(MEMORY[0x263F1CA48]) initWithStyle:1 reuseIdentifier:@"WFNANTableViewTextCellIdentifier"];
    }
    ...
    else
    {
      ...
      v47 = [v46 localizedStringForKey:@"kWFLocNANNoPublishers" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
      v48 = [v12 textLabel];
      [v48 setText:v47];
    }
  }
  else
  {
    ...
    if (![v7 row])
    {
      ...
      v42 = [v41 localizedStringForKey:@"kWFLocNANServiceName" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
...
LABEL_18:
    ...
    if ([v7 row] == 1)
    {
      ...
      v16 = [v15 localizedStringForKey:@"kWFLocNANServiceTypeAdaptive" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
      ...
      objc_super v19 = [v18 localizedStringForKey:@"kWFLocNANServiceTypeRealtime" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
      ...
      v22 = [v21 localizedStringForKey:@"kWFLocNANServiceTypeLowLatency" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
      ...
      v24 = [MEMORY[0x263F1C550] systemBackgroundColor];
      v25 = [v12 segmentedControl];
      [v25 setBackgroundColor:v24];

      v26 = [MEMORY[0x263F1C550] secondarySystemBackgroundColor];
      v27 = [v12 contentView];
...
LABEL_6:
    ...
    if ([v7 row] == 2)
    {
      ...
      v41 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
      v42 = [v41 localizedStringForKey:@"kWFLocNANInstanceName" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
    ...
    if ([v7 row] == 3)
    {
      ...
      v41 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
      v42 = [v41 localizedStringForKey:@"kWFLocNANServiceSpecificInfo" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
    ...
    if ([v7 row] == 4)
    {
      ...
      v60 = [MEMORY[0x263F1C550] systemBackgroundColor];
    ...
    if ([v7 row] == 5)
    {
      ...
      v41 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
      v42 = [v41 localizedStringForKey:@"kWFLocNANPortNumber" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
    ...
    if ([v7 row] == 6)
    {
      ...
      v68 = [v67 localizedStringForKey:@"kWFLocNANProtocolTypeTCP" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
      ...
      v71 = [v70 localizedStringForKey:@"kWFLocNANProtocolTypeUDP" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
      ...
      v73 = [MEMORY[0x263F1C550] systemBackgroundColor];
    ...
    if ([v7 row] == 7)
    {
      ...
      v41 = [MEMORY[0x263F086E0] bundleForClass:objc_opt_class()];
      v42 = [v41 localizedStringForKey:@"kWFLocNANPassphrase" value:&stru_26D9BFD58 table:@"WiFiKitUILocalizableStrings"];
...
- (void)clearInputFields
{
  ...
  self->_instanceName = (NSString *)&stru_26D9BFD58;

  serviceSpecificInfo = self->_serviceSpecificInfo;
  self->_serviceSpecificInfo = (NSString *)&stru_26D9BFD58;

  self->_isServiceSpecificInfoHex = 1;
  self->_portNumber = (NSString *)&stru_26D9BFD58;
  self->_protocolType = 0;
  self->_passphrase = (NSString *)&stru_26D9BFD58;
}
