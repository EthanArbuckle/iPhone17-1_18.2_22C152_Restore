...
- (DAStatusReport)initWithDictionaryRepresentation:(id)a3
{
  id v4 = a3;
  v25.receiver = self;
  v25.super_class = (Class)DAStatusReport;
  objc_super v5 = [(DAStatusReport *)&v25 init];
  if (v5)
  {
...
- (id)dictionaryRepresentation
{
  ...
  if (v24)
  {
    objc_super v25 = [(DAStatusReport *)self uploadedElements];
  ...
  v30 = objc_msgSend(MEMORY[0x1E4F28ED0], "numberWithBool:", -[DAStatusReport syncingAllowed](self, "syncingAllowed"));
  ...
  if (v5)
  {
    ...
    if ((v9 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v104 = 2112;
        id v105 = v4;
        _os_log_impl(&dword_1BA3E8000, v10, OS_LOG_TYPE_ERROR, "Why are we combining status reports for different accounts? %@ vs. %@", (uint8_t *)&v102, 0x16u);
      }
    }
  }
  ...
  if (v15)
  {
    ...
    if ((v19 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v104 = 2112;
        id v105 = v4;
        _os_log_impl(&dword_1BA3E8000, v20, OS_LOG_TYPE_ERROR, "Why are we combining status reports for different accounts? %@ vs. %@", (uint8_t *)&v102, 0x16u);
      }
    }
  }
  ...
  if (v81)
  {
    ...
    if ((v85 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v86, OS_LOG_TYPE_INFO))
      {
        ...
        int v102 = 138412290;
        v103 = v87;
        _os_log_impl(&dword_1BA3E8000, v86, OS_LOG_TYPE_INFO, "Protocol version is updated to %@", (uint8_t *)&v102, 0xCu);
      }
...
- (void)noteNewHBIDataPoint:(int)a3
{
  ...
  id v8 = [MEMORY[0x1E4F28ED0] numberWithDouble:((double)a3 + v7 * (double)self->_numHBIDataPoints) / (double)(self->_numHBIDataPoints + 1)];
