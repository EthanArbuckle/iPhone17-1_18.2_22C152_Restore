...
{
  v3 = objc_opt_new();
  id v4 = objc_msgSend(MEMORY[0x1E4F28ED0], "numberWithInt:", -[DAOofParams oofState](self, "oofState"));
  ...
  v11 = objc_msgSend(MEMORY[0x1E4F28ED0], "numberWithInt:", -[DAOofParams externalState](self, "externalState"));
...
- (id)dictionaryRepresentationForASSettingTask
{
  ...
  if (v14)
  {
    ...
    [v15 setObject:&unk_1F13EE398 forKeyedSubscript:@"kDASettingsAudienceKey"];
    [v15 setObject:&unk_1F13EE3B0 forKeyedSubscript:@"kDASettingsEnabledKey"];
  ...
  {
    v18 = objc_opt_new();
    [v18 setObject:&unk_1F13EE3B0 forKeyedSubscript:@"kDASettingsAudienceKey"];
    ...
    [v13 addObject:v18];
    v21 = objc_opt_new();
    [v21 setObject:&unk_1F13EE3C8 forKeyedSubscript:@"kDASettingsAudienceKey"];
