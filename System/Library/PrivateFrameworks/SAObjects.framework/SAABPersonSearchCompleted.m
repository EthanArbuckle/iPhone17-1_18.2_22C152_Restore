@interface SAABPersonSearchCompleted
...
{
  id v3 = a3;
  v4 = [[SAABPersonSearchCompleted alloc] initWithResults:v3];
...
- (SAABPersonSearchCompleted)initWithResults:(id)a3
{
  ...
  v6 = v5;
  if (v5) {
    [(SAABPersonSearchCompleted *)v5 setResults:v4];
  }
