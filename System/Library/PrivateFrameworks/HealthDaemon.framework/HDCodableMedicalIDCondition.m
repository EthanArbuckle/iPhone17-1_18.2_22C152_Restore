@interface HDCodableMedicalIDCondition
...
@implementation HDCodableMedicalIDCondition
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)HDCodableMedicalIDCondition;
  v4 = [(HDCodableMedicalIDCondition *)&v8 description];
  v5 = [(HDCodableMedicalIDCondition *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return HDCodableMedicalIDConditionReadFrom((uint64_t)self, (uint64_t)a3);
}
...
{
  if (*((void *)a3 + 1)) {
    -[HDCodableMedicalIDCondition setTextDescription:](self, "setTextDescription:");
  }
}
