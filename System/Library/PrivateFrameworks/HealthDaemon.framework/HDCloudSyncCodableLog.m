...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)HDCloudSyncCodableLog;
...
- (BOOL)readFrom:(id)a3
{
  return HDCloudSyncCodableLogReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v7 = [(NSString *)self->_event copyWithZone:a3];
...
LABEL_9:
  ...
  if ((unint64_t)event | *((void *)v4 + 2)) {
    char v6 = -[NSString isEqual:](event, "isEqual:");
  }
  else {
    char v6 = 1;
  }
...
- (unint64_t)hash
{
  ...
  return [(NSString *)self->_event hash] ^ v3;
}
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    double v5 = v4;
    -[HDCloudSyncCodableLog setEvent:](self, "setEvent:");
    id v4 = v5;
  }
}
