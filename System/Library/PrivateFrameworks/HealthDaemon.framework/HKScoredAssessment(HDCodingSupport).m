...
+ (id)createWithCodable:()HDCodingSupport
{
  ...
  if (_HKValidDataTypeCode())
  {
    ...
    if ([v8 conformsToProtocol:&unk_1F187D498])
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F29FA8], OS_LOG_TYPE_ERROR))
      {
        ...
        id v17 = v19;
        _os_log_error_impl(&dword_1BCB7D000, v16, OS_LOG_TYPE_ERROR, "Class: %@ must conform to _HKScoredRiskAssessment:", (uint8_t *)&v18, 0xCu);
      }
    }
    id v13 = 0;
LABEL_14:
