...
+ (id)databaseTable
{
  return @"allergy_record_samples";
}

+ (const)columnDefinitionsWithCount:(unint64_t *)a3
{
  *a3 = 12;
  return (const $74B29A3897B97E76C443A7D6635F6E34 *)columnDefinitionsWithCount__columnDefinitions_52;
}
...
+ (id)insertDataObject:(id)a3 withProvenance:(id)a4 inDatabase:(id)a5 persistentID:(id)a6 error:(id *)a7
{
  ...
  if (([v15 isEqual:objc_opt_class()] & 1) == 0)
  {
    ...
    objc_msgSend(v23, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, @"HDAllergyRecordEntity.m", 73, @"Subclasses must override %s", "+[HDAllergyRecordEntity insertDataObject:withProvenance:inDatabase:persistentID:error:]");
  }
  v27[0] = @"data_id";
...
void __87__HDAllergyRecordEntity_insertDataObject_withProvenance_inDatabase_persistentID_error___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  v4 = [*(id *)(a1 + 40) allergyCodingCollection];
  HDSQLiteBindSecureCodingObjectToProperty();

  v5 = [*(id *)(a1 + 40) onsetDate];
  HDSQLiteBindSecureCodingObjectToProperty();

  v6 = [*(id *)(a1 + 40) asserter];
  MEMORY[0x1C1879EC0](a2, @"asserter", v6);

  v7 = [*(id *)(a1 + 40) reactions];
  HDSQLiteBindSecureCodingObjectToProperty();

  v8 = [*(id *)(a1 + 40) criticalityCoding];
  HDSQLiteBindSecureCodingObjectToProperty();

  v9 = [*(id *)(a1 + 40) lastOccurrenceDate];
  HDSQLiteBindSecureCodingObjectToProperty();

  v10 = [*(id *)(a1 + 40) recordedDate];
  HDSQLiteBindSecureCodingObjectToProperty();

  v11 = [*(id *)(a1 + 40) verificationStatusCoding];
  HDSQLiteBindSecureCodingObjectToProperty();

  id v12 = [*(id *)(a1 + 40) clinicalStatusCoding];
  HDSQLiteBindSecureCodingObjectToProperty();

  id v13 = [*(id *)(a1 + 40) allergyTypeCoding];
  HDSQLiteBindSecureCodingObjectToProperty();

  id v14 = [*(id *)(a1 + 40) categoryCoding];
  HDSQLiteBindSecureCodingObjectToProperty();
}
