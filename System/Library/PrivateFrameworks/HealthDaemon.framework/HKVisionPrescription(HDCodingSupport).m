...
- (HDCodableVisionSample)codableRepresentationForSync
{
  ...
  v113.receiver = a1;
  v113.super_class = (Class)&off_1F187DAC8;
  ...
  {
    v7 = [a1 leftSphere];
    v8 = [MEMORY[0x1E4F2B618] diopterUnit];
  ...
  {
    v10 = [a1 rightSphere];
    v11 = [MEMORY[0x1E4F2B618] diopterUnit];
  ...
  {
    v22 = [a1 rightAxis];
    v23 = [MEMORY[0x1E4F2B618] radianAngleUnit];
  ...
  {
    v25 = [a1 leftAddPower];
    v26 = [MEMORY[0x1E4F2B618] diopterUnit];
  ...
  if (v27)
  {
    ...
    v29 = [MEMORY[0x1E4F2B618] diopterUnit];
    [v28 doubleValueForUnit:v29];
    -[HDCodableVisionSample setRightAddPower:](v2, "setRightAddPower:");
  }
  uint64_t v30 = [(HDCodableVisionSample *)v2 prescriptionType];
  if (v30 == 2)
  {
    objc_opt_class();
    ...
    if (v92)
    {
      v93 = [v90 leftEye];
      v94 = [v93 baseCurve];
      v95 = [MEMORY[0x1E4F2B618] meterUnit];
    ...
    if (v97)
    {
      v98 = [v90 rightEye];
      v99 = [v98 baseCurve];
      v100 = [MEMORY[0x1E4F2B618] meterUnit];
    ...
    if (v102)
    {
      v103 = [v90 leftEye];
      v104 = [v103 diameter];
      v105 = [MEMORY[0x1E4F2B618] meterUnit];
  ...
  if (v30 == 1)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      if (v33)
      {
        ...
        v36 = [MEMORY[0x1E4F2B618] meterUnit];
      ...
      if (v44)
      {
        ...
        v46 = [v45 prism];
        v47 = [v46 amount];
        v48 = [MEMORY[0x1E4F2B618] prismDiopterUnit];
      ...
      if (v51)
      {
        ...
        v53 = [v52 prism];
        v54 = [v53 amount];
        v55 = [MEMORY[0x1E4F2B618] prismDiopterUnit];
      ...
      if (v58)
      {
        ...
        v60 = [v59 prism];
        v61 = [v60 angle];
        v62 = [MEMORY[0x1E4F2B618] radianAngleUnit];
      ...
      if (v65)
      {
        ...
        v67 = [v66 prism];
        v68 = [v67 angle];
        v69 = [MEMORY[0x1E4F2B618] radianAngleUnit];
      ...
      if (v71)
      {
        ...
        v74 = [MEMORY[0x1E4F2B618] meterUnit];
      ...
      if (v76)
      {
        ...
        v79 = [MEMORY[0x1E4F2B618] meterUnit];
      ...
      if (v81)
      {
        ...
        v84 = [MEMORY[0x1E4F2B618] meterUnit];
      ...
      v89 = [MEMORY[0x1E4F2B618] meterUnit];
...
+ (id)createWithCodable:()HDCodingSupport
{
  ...
  if (([v6 hasLeftSphere] & 1) == 0 && (objc_msgSend(v6, "hasRightSphere") & 1) == 0)
  {
    v11 = a1;
LABEL_9:
    v12 = (void *)[[v11 alloc] _init];
    if ([v6 applyToObject:v12])
    {
LABEL_10:
      v13 = objc_msgSend(v12, "_validateWithConfiguration:", v7, v9);
      if (v13) {
        v14 = 0;
      }
      else {
...
LABEL_16:
  ...
  uint64_t v10 = [v6 prescriptionType];
  if (v10 == 2)
  {
    v12 = (void *)[objc_alloc(MEMORY[0x1E4F2AE38]) _init];
    if ([v6 applyToObject:v12]) {
      goto LABEL_10;
    }
    goto LABEL_15;
