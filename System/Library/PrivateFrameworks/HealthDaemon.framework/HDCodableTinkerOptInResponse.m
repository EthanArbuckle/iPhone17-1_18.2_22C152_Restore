@interface HDCodableTinkerOptInResponse
- (BOOL)accepted;
- (BOOL)hasAccepted;
- (BOOL)hasError;
...
@implementation HDCodableTinkerOptInResponse
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)HDCodableTinkerOptInResponse;
  v4 = [(HDCodableTinkerOptInResponse *)&v8 description];
  v5 = [(HDCodableTinkerOptInResponse *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    ...
    [v4 setObject:v6 forKey:@"accepted"];
  }
  error = self->_error;
  if (error)
  {
...
- (BOOL)readFrom:(id)a3
{
  return HDCodableTinkerOptInResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)v4 + 2))
  {
    -[HDCodableTinkerOptInResponse setRequestIdentifier:](self, "setRequestIdentifier:");
    uint64_t v4 = v7;
  }
  if (v4[28])
  {
  ...
  else
  {
    ...
    -[HDCodableTinkerOptInResponse setError:](self, "setError:");
  }
  uint64_t v4 = v7;
LABEL_11:
}
