...
+ (id)insertDataObject:(id)a3 withProvenance:(id)a4 inDatabase:(id)a5 persistentID:(id)a6 error:(id *)a7
{
  ...
  if (([v15 isEqual:objc_opt_class()] & 1) == 0)
  {
    ...
    objc_msgSend(v21, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, @"HDCategorySampleEntity.m", 59, @"Subclasses must override %s", "+[HDCategorySampleEntity insertDataObject:withProvenance:inDatabase:persistentID:error:]");
  }
  ...
  id v16 = v12;
  id v17 = v14;
  if ([v13 executeSQL:@"INSERT INTO category_samples (data_id, value) VALUES (?, ?)", a7, v22, 0 error bindingHandler enumerationHandler])v18 = v17; {
  else
  }
    v18 = 0;
  id v19 = v18;
...
uint64_t __88__HDCategorySampleEntity_insertDataObject_withProvenance_inDatabase_persistentID_error___block_invoke(uint64_t a1, sqlite3_stmt *a2)
{
  ...
  sqlite3_int64 v4 = [*(id *)(a1 + 40) value];
