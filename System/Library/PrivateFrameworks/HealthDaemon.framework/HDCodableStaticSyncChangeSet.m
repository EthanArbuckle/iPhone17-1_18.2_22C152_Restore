    ...
    do
    {
      ...
      do
      {
        ...
        if ((objc_opt_isKindOfClass() & 1) == 0)
        {
          ...
          [v13 handleFailureInMethod:a2, a1, @"HDStaticSyncTask.m", 769, @"%@ must be an instance of %@", v12, v6 object file lineNumber description];
        }
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)HDCodableStaticSyncChangeSet;
  id v4 = [(HDCodableStaticSyncChangeSet *)&v8 description];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", -[NSMutableArray count](self->_changes, "count"));
    long long v12 = 0u;
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
...
- (BOOL)readFrom:(id)a3
{
  return HDCodableStaticSyncChangeSetReadFrom(self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v8 clearChanges];
    unint64_t v4 = [(HDCodableStaticSyncChangeSet *)self changesCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(HDCodableStaticSyncChangeSet *)self changesAtIndex:i];
        [v8 addChanges:v7];
      }
    }
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((unint64_t)changes | v4[1]) {
      char v6 = -[NSMutableArray isEqual:](changes, "isEqual:");
    }
    else {
      char v6 = 1;
    }
...
- (unint64_t)hash
{
  return [(NSMutableArray *)self->_changes hash];
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[HDCodableStaticSyncChangeSet addChanges:](self, "addChanges:", *(void *)(*((void *)&v9 + 1) + 8 * v8++), (void)v9);
      }
      while (v6 != v8);
