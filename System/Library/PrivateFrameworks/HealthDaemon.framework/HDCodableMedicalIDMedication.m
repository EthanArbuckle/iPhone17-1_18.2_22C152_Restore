@interface HDCodableMedicalIDMedication
...
@implementation HDCodableMedicalIDMedication
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)HDCodableMedicalIDMedication;
  v4 = [(HDCodableMedicalIDMedication *)&v8 description];
  v5 = [(HDCodableMedicalIDMedication *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return HDCodableMedicalIDMedicationReadFrom((uint64_t)self, (uint64_t)a3);
}
...
{
  if (*((void *)a3 + 1)) {
    -[HDCodableMedicalIDMedication setTextDescription:](self, "setTextDescription:");
  }
}
