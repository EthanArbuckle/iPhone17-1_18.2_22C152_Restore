...
+ (id)databaseTable
{
  return @"diagnostic_test_report_samples";
}
...
+ (id)insertDataObject:(id)a3 withProvenance:(id)a4 inDatabase:(id)a5 persistentID:(id)a6 error:(id *)a7
{
  ...
  if (([v15 isEqual:objc_opt_class()] & 1) == 0)
  {
    ...
    objc_msgSend(v23, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, @"HDDiagnosticTestReportEntity.m", 63, @"Subclasses must override %s", "+[HDDiagnosticTestReportEntity insertDataObject:withProvenance:inDatabase:persistentID:error:]");
  }
  v27[0] = @"data_id";
...
void __94__HDDiagnosticTestReportEntity_insertDataObject_withProvenance_inDatabase_persistentID_error___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  v3 = [*(id *)(a1 + 40) diagnosticTestCodingCollection];
  HDSQLiteBindSecureCodingObjectToProperty();

  v4 = [*(id *)(a1 + 40) results];
  HDSQLiteBindSecureCodingObjectToProperty();

  v5 = [*(id *)(a1 + 40) effectiveStartDate];
  HDSQLiteBindSecureCodingObjectToProperty();

  v6 = [*(id *)(a1 + 40) statusCoding];
  HDSQLiteBindSecureCodingObjectToProperty();

  v7 = [*(id *)(a1 + 40) effectiveEndDate];
  HDSQLiteBindSecureCodingObjectToProperty();

  id v8 = [*(id *)(a1 + 40) issueDate];
  HDSQLiteBindSecureCodingObjectToProperty();
}
...
+ (id)entityEncoderForProfile:(id)a3 transaction:(id)a4 purpose:(int64_t)a5 encodingOptions:(id)a6 authorizationFilter:(id)a7
{
  ...
  id v13 = a4;
  id v14 = a3;
  v15 = [(_HDMedicalRecordEntityEncoder *)[_HDDiagnosticTestReportEntityEncoder alloc] initWithHealthEntityClass:objc_opt_class() profile:v14 transaction:v13 purpose:a5 encodingOptions:v12 authorizationFilter:v11];
