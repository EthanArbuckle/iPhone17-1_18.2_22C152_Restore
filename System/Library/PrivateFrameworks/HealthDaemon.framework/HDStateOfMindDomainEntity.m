  ...
  if (v8)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v9; ++i)
      {
        ...
        v26[4] = a3;
        LODWORD(v12) = [v15 executeCachedStatementForKey:&_insertDomainForObjectID_domain_transaction_error__insertKey error:a6 SQLGenerator:v27 bindingHandler:v26 enumerationHandler:0];
