...
+ (id)databaseTable
{
  return @"account_owner_samples";
}

+ (const)columnDefinitionsWithCount:(unint64_t *)a3
{
  *a3 = 3;
  return (const $74B29A3897B97E76C443A7D6635F6E34 *)columnDefinitionsWithCount__columnDefinitions_76;
}
...
+ (id)insertDataObject:(id)a3 withProvenance:(id)a4 inDatabase:(id)a5 persistentID:(id)a6 error:(id *)a7
{
  ...
  if (([v15 isEqual:objc_opt_class()] & 1) == 0)
  {
    ...
    objc_msgSend(v23, "handleFailureInMethod:object:file:lineNumber:description:", a2, a1, @"HDAccountOwnerEntity.m", 55, @"Subclasses must override %s", "+[HDAccountOwnerEntity insertDataObject:withProvenance:inDatabase:persistentID:error:]");
  }
  v27[0] = @"data_id";
  v27[1] = @"name";
  v27[2] = @"birth_date";
...
void __86__HDAccountOwnerEntity_insertDataObject_withProvenance_inDatabase_persistentID_error___block_invoke(uint64_t a1, uint64_t a2)
{
  ...
  v4 = [*(id *)(a1 + 40) name];
  MEMORY[0x1C1879EC0](a2, @"name", v4);

  id v5 = [*(id *)(a1 + 40) birthDate];
