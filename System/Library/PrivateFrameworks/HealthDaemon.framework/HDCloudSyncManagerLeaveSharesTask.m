@interface HDCloudSyncManagerLeaveSharesTask
...
- (id)pipelineForRepository:(id)a3
{
  ...
  v19 = [(HDCloudSyncOperation *)v17 initWithConfiguration:v18 cloudState:0];
  v20 = [(HDCloudSyncOperation *)v19 asPipelineStage];
  [v10 addStage:v20];
