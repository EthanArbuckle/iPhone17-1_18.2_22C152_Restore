      ...
      if ([(HDJournalableOperation *)v14 didJournal])
      {
        ...
        if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F29FA8], OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v31 = 2114;
          v32 = v20;
          _os_log_impl(&dword_1BCB7D000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@: Journaled device contexts for profile: %{public}@, container identifier: %{public}@", buf, 0x20u);
        }
      }
    }
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F29FA8], OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v29 = 2114;
      v30 = v25;
      _os_log_impl(&dword_1BCB7D000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@: Context sync zone not present for container identifier: %{public}@", buf, 0x16u);
    }
    LOBYTE(v16) = 1;
  }
