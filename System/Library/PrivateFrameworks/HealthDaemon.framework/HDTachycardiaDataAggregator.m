...
- (id)_categoryType
{
  return (id)[MEMORY[0x1E4F2ACB8] tachycardiaType];
}
...
- (BOOL)didPersistObjects:(id)a3 lastDatum:(id)a4 collector:(id)a5 error:(id *)a6
{
  ...
  id v11 = a4;
  id v12 = a3;
  -[HDHeartEventDataAggregator triggerImmediateCloudSyncWithReason:](self, @"New High Heart Rate Notification sample added");
  v14.receiver = self;
  v14.super_class = (Class)HDTachycardiaDataAggregator;
