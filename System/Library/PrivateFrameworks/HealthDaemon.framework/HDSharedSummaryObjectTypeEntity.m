...
+ (id)databaseTable
{
  return @"shared_summary_object_types";
}
...
+ (id)objectTypesForSummaryID:(int64_t)a3 databaseTransaction:(id)a4 error:(id *)a5
{
  ...
  v16[3] = &unk_1E62F3D38;
  id v12 = v10;
  LODWORD(a5) = [v11 executeCachedStatementForKey:&objectTypesForSummaryID_databaseTransaction_error__key error:a5 SQLGenerator:v19 bindingHandler:v18 enumerationHandler:v16];
...
{
  v2 = [MEMORY[0x1E4F2B2C0] dataTypeWithCode:HDSQLiteColumnWithNameAsInt64()];
  if (v2) {
