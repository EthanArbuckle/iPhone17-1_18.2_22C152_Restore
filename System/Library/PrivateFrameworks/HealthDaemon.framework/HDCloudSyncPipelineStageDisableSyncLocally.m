...
void __50__HDCloudSyncPipelineStageDisableSyncLocally_main__block_invoke(uint64_t a1, char a2, void *a3)
{
  ...
  if (a2)
  {
    ...
    v7 = [*(id *)(a1 + 40) cloudSyncManager];
    v8 = [v7 ownerIdentifierManager];
    v10[0] = MEMORY[0x1E4F143A8];
    v10[1] = 3221225472;
    v10[2] = __50__HDCloudSyncPipelineStageDisableSyncLocally_main__block_invoke_277;
    v10[3] = &unk_1E62F2978;
    v10[4] = *(void *)(a1 + 32);
  ...
  else
  {
    ...
    if (os_log_type_enabled((os_log_t)*MEMORY[0x1E4F29FA8], OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138543362;
      id v12 = v5;
      _os_log_error_impl(&dword_1BCB7D000, v9, OS_LOG_TYPE_ERROR, "Failed to disable cloud sync: %{public}@", buf, 0xCu);
    }
    [*(id *)(a1 + 32) finishWithSuccess:0 error:v5];
  }
}

void __50__HDCloudSyncPipelineStageDisableSyncLocally_main__block_invoke_277(uint64_t a1, int a2, void *a3)
{
  uint64_t v13 = *MEMORY[0x1E4F143B8];
  id v5 = a3;
  _HKInitializeLogging();
