...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)HDCodableEmergencyContact;
...
- (BOOL)readFrom:(id)a3
{
  return HDCodableEmergencyContactReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  NSUInteger v4 = a3;
  if (v4[1]) {
    -[HDCodableEmergencyContact setName:](self, "setName:");
  }
  if (v4[2]) {
    -[HDCodableEmergencyContact setNameContactIdentifier:](self, "setNameContactIdentifier:");
  }
  if (v4[3]) {
    -[HDCodableEmergencyContact setPhoneNumber:](self, "setPhoneNumber:");
  }
  if (v4[4]) {
    -[HDCodableEmergencyContact setPhoneNumberContactIdentifier:](self, "setPhoneNumberContactIdentifier:");
  }
  if (v4[5]) {
    -[HDCodableEmergencyContact setPhoneNumberLabel:](self, "setPhoneNumberLabel:");
  }
  if (v4[6]) {
    -[HDCodableEmergencyContact setRelationship:](self, "setRelationship:");
  }
}
