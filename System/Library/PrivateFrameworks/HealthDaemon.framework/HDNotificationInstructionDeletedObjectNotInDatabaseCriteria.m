...
+ (id)criteriaIdentifier
{
  return @"HDNotificationInstructionDeletedObjectNotInDatabaseCriteria";
}
...
- (int64_t)isValidWithDatabaseTransaction:(id)a3 error:(id *)a4
{
  ...
  v11[3] = &unk_1E62F3640;
  v11[4] = &v13;
  if (![v7 executeCachedStatementForKey:&isValidWithDatabaseTransaction_error__lookupKey error:a4 SQLGenerator:&__block_literal_global_191 bindingHandler:v12 enumerationHandler:v11])
  {
LABEL_5:
    int64_t v9 = 0;
    goto LABEL_6;
