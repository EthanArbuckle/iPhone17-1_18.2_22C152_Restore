@interface MoveSpeakerSourceResolutionResult
...
- (MoveSpeakerSourceResolutionResult)initWithJSONDictionary:(id)a3 forIntent:(id)a4
{
  ...
  return (MoveSpeakerSourceResolutionResult *)MoveSpeakerSourceResolutionResult.init(JSONDictionary:intent:)(v5, a4);
}
