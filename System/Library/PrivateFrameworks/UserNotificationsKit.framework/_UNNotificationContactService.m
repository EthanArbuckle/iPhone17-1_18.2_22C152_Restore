...
- (_UNNotificationContactService)initWithResolver:(id)a3
{
  ...
  v6 = [(_UNNotificationContactService *)&v12 init];
  if (v6)
  {
...
- (id)updateServiceWithContact:(id)a3 bundleIdentifier:(id)a4
{
  ...
  if ([v6 handleType])
  {
    v15 = [(_UNCNContactResolver *)resolver resultForContactIdentifier:v8 emailAddress:v11 phoneNumber:v13 userIdentifier:v14 username:0 bundleIdentifier:v7];
  }
  else
  {
    [v6 handle];
    v24 = self;
    v17 = v16 = v8;
    v15 = [(_UNCNContactResolver *)resolver resultForContactIdentifier:v16 emailAddress:v11 phoneNumber:v13 userIdentifier:v14 username:v17 bundleIdentifier:v7];
  ...
  if (v15 && ([v15 isSuggestedContact] & 1) == 0)
  {
    ...
    [(_UNNotificationContactService *)v19 _setResult:v15 forContact:v18 bundleIdentifier:v7];
  }
  else
  {
    [(_UNNotificationContactService *)self _setResult:0 forContact:v6 bundleIdentifier:v7];
    v18 = 0;
  }
...
- (id)curatedContactMatchDetailsForContact:(id)a3 bundleIdentifier:(id)a4
{
  v4 = [(_UNNotificationContactService *)self _matchForContact:a3 bundleIdentifier:a4];
  id v5 = v4;
  if (v4 && ([v4 isSuggestedContact] & 1) == 0)
  {
    id v7 = [_UNNotificationContactServiceMatchDetails alloc];
    v8 = [v5 cnContactIdentifier];
    v9 = [v5 cnContactFullname];
    id v6 = -[_UNNotificationContactServiceMatchDetails initWithCnContactIdentifier:cnContactFullname:isSuggestedContact:](v7, "initWithCnContactIdentifier:cnContactFullname:isSuggestedContact:", v8, v9, [v5 isMatchTypeSuggested]);
  }
  else
  {
    id v6 = 0;
...
- (id)curatedContactForContact:(id)a3 bundleIdentifier:(id)a4 keysToFetch:(id)a5
{
  id v8 = a3;
  id v9 = a5;
  uint64_t v10 = [(_UNNotificationContactService *)self _matchForContact:v8 bundleIdentifier:a4];
  v11 = v10;
...
- (void)confirmCuratedContactSuggestion:(BOOL)a3 forContact:(id)a4 bundleIdentifier:(id)a5
{
  ...
  id v8 = a4;
  id v9 = a5;
  uint64_t v10 = [(_UNNotificationContactService *)self _matchForContact:v8 bundleIdentifier:v9];
  v11 = v10;
  if (v10)
  {
    if ([v10 isMatchTypeSuggested])
    {
      uint64_t v12 = [(_UNCNContactResolver *)self->_resolver confirm:v6 match:v11];
      [(_UNNotificationContactService *)self _setResult:v12 forContact:v8 bundleIdentifier:v9];
    }
...
- (id)newCuratedContactForContact:(id)a3 imageData:(id)a4 bundleIdentifier:(id)a5
{
  ...
  if (!v13)
  {
    ...
    id v16 = (void *)[v18 initWithUrlString:0 username:v19 userIdentifier:v20 service:v21 displayname:v10 teamIdentifier:0 bundleIdentifiers:v22];
...
LABEL_10:
  ...
  if (v13 == 2)
  {
    ...
    v27 = [v7 handle];
    id v16 = (void *)[v26 initWithStringValue:v27];
  ...
  v15 = [v7 handle];
  id v16 = [v14 labeledValueWithLabel:0 value:v15];
...
- (void)didAddToCuratedContactsForContact:(id)a3 bundleIdentifier:(id)a4 cnContactIdentifier:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a5;
  v11 = [(_UNNotificationContactService *)self _matchForContact:v8 bundleIdentifier:v9];
  if ([v11 isMatchTypeSuggested]) {
    id v12 = [(_UNCNContactResolver *)self->_resolver confirm:0 match:v11];
  }
  uint64_t v13 = [(_UNCNContactResolver *)self->_resolver resultForContactIdentifier:v10 emailAddress:0 phoneNumber:0 userIdentifier:0 username:0 bundleIdentifier:v9];
  ...
  [(_UNNotificationContactService *)self _setResult:v13 forContact:v8 bundleIdentifier:v9];
}
...
- (id)_matchForContact:(id)a3 bundleIdentifier:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  id v8 = objc_alloc_init(_UNNotificationContactServiceRecord);
  [(_UNNotificationContactServiceRecord *)v8 setContact:v6];
  [(_UNNotificationContactServiceRecord *)v8 setBundleIdentifier:v7];
  id v9 = self;
  objc_sync_enter(v9);
...
- (void)_setResult:(id)a3 forContact:(id)a4 bundleIdentifier:(id)a5
{
  ...
  id v8 = a4;
  id v9 = a5;
  id v10 = objc_alloc_init(_UNNotificationContactServiceRecord);
  [(_UNNotificationContactServiceRecord *)v10 setContact:v8];
  [(_UNNotificationContactServiceRecord *)v10 setBundleIdentifier:v9];
  v11 = self;
  objc_sync_enter(v11);
...
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_22012C000, v0, v1, "Contact service unable to fetch contact for identifier", v2, v3, v4, v5, v6);
}

- (void)confirmCuratedContactSuggestion:forContact:bundleIdentifier:.cold.1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_22012C000, v0, v1, "Contact service unable to confirm contact. Result not found.", v2, v3, v4, v5, v6);
}

- (void)confirmCuratedContactSuggestion:forContact:bundleIdentifier:.cold.2()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_22012C000, v0, v1, "Contact service unable to confirm an already confirmed contact", v2, v3, v4, v5, v6);
}

- (void)didAddToCuratedContactsForContact:bundleIdentifier:cnContactIdentifier:.cold.1()
{
  OUTLINED_FUNCTION_1();
  OUTLINED_FUNCTION_0(&dword_22012C000, v0, v1, "Contact service can't resolve newly created contact", v2, v3, v4, v5, v6);
}
