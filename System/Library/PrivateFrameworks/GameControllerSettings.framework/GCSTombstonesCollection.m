...
- (GCSTombstonesCollection)initWithSettingsStore:(id)a3 userDefaults:(id)a4
{
  ...
  if (v8)
  {
    ...
    values = v9->_values;
    v9->_values = (NSArray *)&__NSArray0__struct;
    ...
    if (isKindOfClass)
    {
      id v13 = objc_loadWeakRetained((id *)&v9->_settingsStore);
...
- (void)updateTombstones:(id)a3
{
  ...
  if ((objc_opt_isKindOfClass() & 1) != 0
    && [(GCSTombstonesCollection *)self storeVersionIsCompatible])
  {
    v5 = v4;
    if (v5)
    {
      ...
      if (v7)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            long long v13 = -[GCSTombstone initWithJSONObject:](v12, "initWithJSONObject:", v11, (void)v17);
            [v6 addObject:v13];
      ...
      {
        long long v15 = [(GCSTombstonesCollection *)self values];
        *(_DWORD *)buf = 138412290;
        v23 = v15;
        _os_log_impl(&dword_22128F000, v14, OS_LOG_TYPE_INFO, "GCSTombstones.values = %@", buf, 0xCu);
      }
    }
  }
  else
  {
    [(GCSTombstonesCollection *)self setValues:&__NSArray0__struct];
    v5 = getGCSLogger();
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      long long v16 = [(GCSTombstonesCollection *)self values];
      *(_DWORD *)buf = 138412290;
      v23 = v16;
      _os_log_impl(&dword_22128F000, v5, OS_LOG_TYPE_INFO, "GCSTombstones.values = %@", buf, 0xCu);
    }
  }
}
...
- (void)observeValueForKeyPath:(id)a3 ofObject:(id)a4 change:(id)a5 context:(void *)a6
{
  ...
  else
  {
    ...
    uint64_t v13 = [(GCUserDefaults *)self->_userDefaults objectForKey:@"tombstones"];
  }
