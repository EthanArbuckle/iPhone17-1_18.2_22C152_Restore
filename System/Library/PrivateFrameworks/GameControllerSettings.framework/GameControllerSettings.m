uint64_t gcs_isInternalBuild()
{
  if (gcs_isInternalBuild_onceToken != -1) {
    dispatch_once(&gcs_isInternalBuild_onceToken, &__block_literal_global);
  }
...
id getGCSLogger()
{
  if (getGCSLogger_onceToken != -1) {
    dispatch_once(&getGCSLogger_onceToken, &__block_literal_global_3);
  }
  v0 = (void *)gcLogger;
  return v0;
}
...
{
  gcLogger = (uint64_t)os_log_create("com.apple.GameController.Settings", "default");
