...
- (id)createVisibilityPropagationInteraction
{
  ...
  sub_25C20D560((uint64_t)self + OBJC_IVAR____SEGPUProcess_inner, (uint64_t)v4, type metadata accessor for _GPUProcess);
  v5 = self;
  *(void *)atoken.val = MEMORY[0x261180380]();
  ...
  sub_25C209F40((uint64_t)v4, type metadata accessor for _GPUProcess);
  return v14;
}

- (_SEGPUProcess)init
{
  result = (_SEGPUProcess *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
