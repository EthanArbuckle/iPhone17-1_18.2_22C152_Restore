...
- (BOOL)canBeginTransportation
{
  ...
  {
    if (qword_10031B010 != -1) {
      dispatch_once(&qword_10031B010, &stru_1002D4BC0);
    }
    v4 = qword_10031AFF8;
    if (os_log_type_enabled((os_log_t)qword_10031AFF8, OS_LOG_TYPE_ERROR)) {
      sub_10024CDF4((uint64_t)p_databasePath, v4, v5, v6, v7, v8, v9, v10);
    }
  }
  else
  {
    ...
    v18 = qword_10031AFF8;
    if (os_log_type_enabled((os_log_t)qword_10031AFF8, OS_LOG_TYPE_ERROR)) {
      sub_10024CE64((uint64_t)p_databasePath, v18, v19, v20, v21, v22, v23, v24);
    }
  }
  return 0;
}
...
- (BOOL)endTransporationAndRemoveDatabase
{
  if ([(SQLiteConnection *)self->_connection close] && sub_1000153A4(self->_databasePath))
  {
  ...
  else
  {
    ...
    v4 = qword_10031AFF8;
    BOOL v3 = os_log_type_enabled((os_log_t)qword_10031AFF8, OS_LOG_TYPE_ERROR);
    if (v3)
    {
      sub_10024CED4((uint64_t)self, v4, v5, v6, v7, v8, v9, v10);
      LOBYTE(v3) = 0;
    }
  }
  return v3;
...
{
  id v7 = a3;
  os_unfair_lock_lock((os_unfair_lock_t)&unk_10031AFC0);
...
LABEL_6:
  ...
  os_unfair_lock_unlock((os_unfair_lock_t)&unk_10031AFC0);
}
...
+ (BOOL)_isKnownDatabasePath:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v7)
    {
      id v8 = [v7 indexesOfObjectsPassingTest:&stru_1002D4BA0];
      if ([v8 count])
      {
