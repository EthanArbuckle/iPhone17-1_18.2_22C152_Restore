...
- (BOOL)connectionNeedsResetForReopen:(id)a3
{
  ...
  id v5 = (void *)qword_10031B098;
  if (os_log_type_enabled((os_log_t)qword_10031B098, OS_LOG_TYPE_ERROR)) {
    sub_10024D0F8(v5, v4);
  }
...
- (void)_performMigrationIfNeededForStore:(id)a3
{
  ...
  id v6 = (const void *)objc_opt_class();
  if (!NSHashGet(migratedStores, v6))
  {
    ...
    char v25 = 1;
    id v7 = [(id)objc_opt_class() storeDescriptor];
    id v8 = [SQLiteDatabaseStoreSchema alloc];
    connection = self->_connection;
    id v10 = [v7 schemaName];
    id v11 = [(SQLiteDatabaseStoreSchema *)v8 initWithConnection:connection schemaName:v10];
    ...
    else
    {
      ...
      v16 = (id)qword_10031B098;
      if (os_log_type_enabled(v16, OS_LOG_TYPE_FAULT))
      {
        v17 = [v7 schemaName];
        sub_10024D1B8(v17, buf, [(SQLiteDatabaseStoreSchema *)v13 currentSchemaVersion], v16);
      }
    }
