...
- (void)dealloc
{
  if (self->_database)
  {
    ...
    v3 = (void *)qword_1003088C8;
    if (os_log_type_enabled((os_log_t)qword_1003088C8, OS_LOG_TYPE_FAULT)) {
      sub_10024D220((uint64_t)self, v3);
    }
...
- (void)executeQuery:(id)a3 withResults:(id)a4
{
  ...
  id v7 = (void (**)(id, SQLiteQueryResults *, id))a4;
  id v12 = 0;
  uint64_t v8 = [(SQLiteConnection *)self _verifiedStatementForSQL:v6 error:&v12];
  id v9 = v12;
  id v10 = [[SQLitePreparedStatement alloc] initWithConnection:self->_database SQL:v6];
  if (v10) {
    [(NSMapTable *)self->_preparedStatements setObject:v8 forKey:v10];
  }
  if (v8) {
    BOOL v11 = [[SQLiteQueryResults alloc] initWithStatement:v8];
  }
  else {
    BOOL v11 = 0;
  }
...
- (BOOL)executeStatement:(id)a3 error:(id *)a4 bindings:(id)a5
{
  ...
  id v17 = 0;
  id v9 = a3;
  id v10 = [(SQLiteConnection *)self _verifiedStatementForSQL:v9 error:&v17];
  id v11 = v17;
...
- (BOOL)finalizePreparedStatement:(id)a3 error:(id *)a4
{
  ...
  BOOL v9 = sub_100015788([v7 finalizeStatement]);
  if (!v9)
  {
    uint64_t v10 = sub_1000154CC(self->_database);
...
- (BOOL)performSavepoint:(id)a3
{
  ...
  v5 = +[NSUUID UUID];
  id v6 = [v5 UUIDString];
  id v7 = [v6 stringByReplacingOccurrencesOfString:@"-" withString:&stru_1002F48B8];
...
- (id)prepareStatement:(id)a3 error:(id *)a4
{
  ...
  {
    id v11 = 0;
    int64_t v7 = [(SQLiteConnection *)self _prepareStatement:v6 error:&v11];
    id v8 = v11;
    if (v7)
    {
      int64_t v9 = [[SQLitePreparedStatement alloc] initWithConnection:self SQL:v6];
...
- (BOOL)addFunction:(id)a3
{
  ...
  else
  {
    ...
    int v6 = (void *)qword_1003088C8;
    if (os_log_type_enabled((os_log_t)qword_1003088C8, OS_LOG_TYPE_FAULT)) {
      sub_10024D418((uint64_t)self, v6);
    }
  }
...
- (BOOL)removeFunctionNamed:(id)a3 withArgumentCount:(int64_t)a4
{
  ...
  else
  {
    ...
    CFStringRef v10 = (void *)qword_1003088C8;
    if (os_log_type_enabled((os_log_t)qword_1003088C8, OS_LOG_TYPE_ERROR)) {
      sub_10024D4F4((uint64_t)self, v10);
    }
    BOOL v9 = 0;
  }
...
- (BOOL)_close
{
  ...
  id v3 = (void *)qword_1003088C8;
  if (os_log_type_enabled((os_log_t)qword_1003088C8, OS_LOG_TYPE_DEFAULT))
  {
    int v4 = v3;
    v5 = objc_opt_class();
    ...
    if (v10 <= 0x19)
    {
      switch(v10)
      {
        ...
        case 6u:
          ...
          break;
        case 0xAu:
          char v12 = sub_1000154CC(self->_database);
...
LABEL_16:
      uint64_t v13 = sub_1000154CC(self->_database);
LABEL_17:
      char v12 = (void *)v13;
      goto LABEL_18;
    }
...
- (void)_finalizeAllStatements
{
  ...
  long long v12 = 0u;
  long long v13 = 0u;
  id v3 = [(NSMapTable *)self->_preparedStatements objectEnumerator];
...
- (BOOL)_open
{
  ...
  *(void *)db = 0;
  ...
  while (1)
  {
    int v11 = sub_1000155A4((sqlite3 **)db, self->_options);
    BOOL v2 = v11 == 0;
    if (!v11) {
      break;
    }
  ...
  sqlite3_create_function(v14, "timestamp", 0, 1, 0, (void (__cdecl *)(sqlite3_context *, int, sqlite3_value **))sub_100014718, 0, 0);
  return v2;
}
...
- (BOOL)_performResetAfterCorruptionError
{
  ...
  if (v5)
  {
    ...
    uint64_t v6 = (void *)qword_100308898;
    if (os_log_type_enabled((os_log_t)qword_100308898, OS_LOG_TYPE_ERROR)) {
      sub_10024D59C(v6);
    }
...
LABEL_14:
  ...
  if (![(SQLiteConnectionOptions *)self->_options isReadOnly])
  {
    ...
    char v10 = (void *)qword_100308898;
    if (os_log_type_enabled((os_log_t)qword_100308898, OS_LOG_TYPE_ERROR)) {
      sub_10024D650(v10);
    }
    id v7 = [(SQLiteConnectionOptions *)self->_options databasePath];
    unsigned __int8 v8 = sub_1000157A4(v7);
    goto LABEL_14;
  }
  return 0;
}
...
- (id)_prepareStatement:(id)a3 error:(id *)a4
{
  ...
  char v13 = sub_1000149D0;
  id v14 = sub_1000149E0;
  id v15 = 0;
  id v6 = a3;
  v9[0] = _NSConcreteStackBlock;
  v9[1] = 3221225472;
...
- (id)_verifiedStatementForSQL:(id)a3 error:(id *)a4
{
  ...
  {
    id v12 = 0;
    id v7 = [(SQLiteConnection *)self _prepareStatement:v6 error:&v12];
    id v8 = v12;
    if (v7)
    {
      if ([(SQLiteConnectionOptions *)self->_options isReadOnly]
