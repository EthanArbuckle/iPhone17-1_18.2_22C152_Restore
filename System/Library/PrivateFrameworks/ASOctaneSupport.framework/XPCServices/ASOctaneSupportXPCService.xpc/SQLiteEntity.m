...
+ (id)queryOnConnection:(id)a3 predicate:(id)a4 orderingProperties:(id)a5 orderingDirections:(id)a6 entityClass:(Class)a7
{
  ...
  id v13 = a4;
  id v14 = a3;
  id v15 = [[SQLiteQueryDescriptor alloc] initWithEntityClass:a7 memoryEntityClass:[(objc_class *)a7 memoryEntityClass]];
...
+ (id)_aggregateValueForProperty:(id)a3 function:(id)a4 predicate:(id)a5 onConnection:(id)a6
{
  ...
  id v16 = [a1 disambiguatedSQLForProperty:v10];
...
- (BOOL)deleteFromDatabase
{
  ...
  if (*((unsigned char *)v11 + 24))
  {
    ...
    block[1] = 3221225472;
    block[2] = sub_10001616C;
    block[3] = &unk_1002D5588;
    block[4] = v4;
...
+ (BOOL)_insertValues:(id)a3 intoTable:(id)a4 withPersistentID:(int64_t)a5 onConnection:(id)a6
{
  ...
  if (v28)
  {
    if (qword_10031B118 != -1) {
      dispatch_once(&qword_10031B118, &stru_1002D56E8);
    }
    long long v29 = (void *)qword_10031B100;
    if (os_log_type_enabled((os_log_t)qword_10031B100, OS_LOG_TYPE_ERROR)) {
      sub_10024D890(v29, (uint64_t)v31, (uint64_t)v28);
    }
  }
