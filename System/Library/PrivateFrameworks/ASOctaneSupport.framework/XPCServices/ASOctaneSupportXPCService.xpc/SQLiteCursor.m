...
LABEL_8:
  ...
  if (!v6)
  {
    if (qword_10031AF58 != -1) {
      dispatch_once(&qword_10031AF58, &stru_1002D4708);
    }
    uint64_t v8 = (void *)qword_10031AF40;
    if (os_log_type_enabled((os_log_t)qword_10031AF40, OS_LOG_TYPE_ERROR))
    {
