...
- (NAQueue)init;
- (NAQueue)initWithStrategy:(id)a3;
- (NSArray)allObjects;
- (id)dequeue;
- (id)drain;
- (id)peek;
...
{
  id v4 = a3;
  v5 = [[_NAPriorityQueueingStrategy alloc] initWithComparator:v4];
...
- (NAQueue)init
{
  v3 = objc_alloc_init(_NADefaultQueueingStrategy);
  id v4 = [(NAQueue *)self initWithStrategy:v3];
...
+ (id)boundedQueueWithCapacity:(unint64_t)a3
{
  id v4 = [[_NABoundedQueueingStrategy alloc] initWithCapacity:a3];
  id v5 = (void *)[objc_alloc((Class)a1) initWithStrategy:v4];
...
{
  id v6 = a4;
  v7 = [[_NABoundedQueueingStrategy alloc] initWithCapacity:a3 overflowHandler:v6];
