...
- (NAValueThrottler)initWithThrottleInterval:(double)a3
{
  return [(NAValueThrottler *)self initWithThrottleInterval:0 initialValue:a3];
}
...
- (NAValueThrottler)initWithThrottleInterval:(double)a3 initialValue:(id)a4
{
  ...
  if (v8)
  {
    ...
    uint64_t v12 = +[NAScheduler mainThreadScheduler];
...
- (NAValueThrottler)init
{
  return [(NAValueThrottler *)self initWithThrottleInterval:0.0];
}

- (void)dealloc
{
  v3 = [(NAValueThrottler *)self valueUpdateCancelationToken];
  [v3 cancel];

  v4.receiver = self;
  v4.super_class = (Class)NAValueThrottler;
  [(NAValueThrottler *)&v4 dealloc];
}
...
- (void)setValue:(id)a3 notifyObservers:(BOOL)a4
{
  ...
  if (value != v7 && ([value isEqual:v7] & 1) == 0)
  {
    objc_storeStrong(&self->_value, a3);
    if (v4) {
      [(NAValueThrottler *)self _enqueueValueUpdateIfNecessary];
    }
  }
  MEMORY[0x1F41817F8]();
}
...
- (void)setUpdateScheduler:(id)a3
{
  id v7 = (NAScheduler *)a3;
  if (self->_updateScheduler != v7)
  {
    objc_storeStrong((id *)&self->_updateScheduler, a3);
    v5 = [(NAValueThrottler *)self valueUpdateCancelationToken];

    if (v5)
    {
      v6 = [(NAValueThrottler *)self valueUpdateCancelationToken];
      [v6 cancel];

      [(NAValueThrottler *)self setValueUpdateCancelationToken:0];
      [(NAValueThrottler *)self _enqueueValueUpdateIfNecessary];
    }
  }
}
...
- (void)_enqueueValueUpdateIfNecessary
{
  ...
  if (!v3)
  {
    ...
    BOOL v4 = [(NAValueThrottler *)self updateScheduler];
    [(NAValueThrottler *)self throttleInterval];
    double v6 = v5;
    uint64_t v8 = MEMORY[0x1E4F143A8];
    uint64_t v9 = 3221225472;
    uint64_t v10 = __50__NAValueThrottler__enqueueValueUpdateIfNecessary__block_invoke;
    v11 = &unk_1E6109B08;
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        uint64_t v9 = [(NAValueThrottler *)self value];
...
- (id)observeValueChangesWithBlock:(id)a3
{
  ...
  uint64_t v7 = (void *)MEMORY[0x1BA99CF00]();
  [(NSMutableSet *)observerBlocks addObject:v7];
  ...
  id v8 = v5;
  id v12 = v8;
  uint64_t v9 = +[NACancelationToken tokenWithCancelationBlock:v11];
...
void __49__NAValueThrottler_observeValueChangesWithBlock___block_invoke(uint64_t a1)
{
  ...
  v3 = (void *)MEMORY[0x1BA99CF00](*(void *)(a1 + 32));
  [v2 removeObject:v3];
}
...
- (void)flushValueChanges
{
  ...
  if (v3)
  {
    id v4 = [(NAValueThrottler *)self valueUpdateCancelationToken];
    [v4 cancel];

    [(NAValueThrottler *)self setValueUpdateCancelationToken:0];
    [(NAValueThrottler *)self _notifyObserversOfValueUpdate];
  }
}

- (BOOL)hasPendingValueChange
{
  v2 = [(NAValueThrottler *)self valueUpdateCancelationToken];
  BOOL v3 = v2 != 0;
