...
- (NSString)keyPath;
- (_NAKeyValueObserverProxy)initWithWeakObserver:(id)a3 observedObject:(id)a4 keyPath:(id)a5 options:(unint64_t)a6 observerBlock:(id)a7;
- (id)observedObject;
- (id)observerBlock;
- (void)invalidate;
...
@implementation _NAKeyValueObserverProxy
...
- (_NAKeyValueObserverProxy)initWithWeakObserver:(id)a3 observedObject:(id)a4 keyPath:(id)a5 options:(unint64_t)a6 observerBlock:(id)a7
{
  ...
  id v14 = a7;
  v20.receiver = self;
  v20.super_class = (Class)_NAKeyValueObserverProxy;
  v15 = [(_NAObserverProxy *)&v20 initWithWeakObserver:a3];
  v16 = v15;
  if (v15)
  {
    objc_storeWeak(&v15->_observedObject, v12);
    objc_storeStrong((id *)&v16->_keyPath, a5);
    uint64_t v17 = MEMORY[0x1BA99CF00](v14);
...
- (void)observeValueForKeyPath:(id)a3 ofObject:(id)a4 change:(id)a5 context:(void *)a6
{
  ...
  {
    v7 = [(_NAObserverProxy *)self weakObserver];
...
- (void)invalidate
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)_NAKeyValueObserverProxy;
  [(_NAObserverProxy *)&v4 invalidate];
}
