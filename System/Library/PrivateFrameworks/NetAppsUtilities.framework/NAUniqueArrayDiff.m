...
+ (id)diffFromArray:(id)a3 toArray:(id)a4 options:(id)a5
{
  ...
  if (![v8 count])
  {
    v77 = objc_msgSend(MEMORY[0x1E4F28D60], "indexSetWithIndexesInRange:", 0, objc_msgSend(v9, "count"));
...
LABEL_68:
  ...
  if (![v9 count])
  {
    v77 = objc_msgSend(MEMORY[0x1E4F28D60], "indexSetWithIndexesInRange:", 0, objc_msgSend(v8, "count"));
  ...
  id v80 = v16;
  v93 = [MEMORY[0x1E4F28E60] indexSet];
...
LABEL_51:
  ...
  v60 = [v85 allObjects];
  v61 = [v60 sortedArrayUsingComparator:&__block_literal_global_1];

  v62 = [MEMORY[0x1E4F1CA80] set];
...
+ (id)_createContainerSetFromArray:(id)a3 options:(id)a4
{
  id v5 = a3;
  id v6 = a4;
  unint64_t v7 = objc_msgSend(MEMORY[0x1E4F1CA80], "setWithCapacity:", objc_msgSend(v5, "count"));
...
void __58__NAUniqueArrayDiff__createContainerSetFromArray_options___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  id v9 = +[_NASetContainer containerWithObject:v7 atIndex:a3 comparator:v10 hashGenerator:v8];
...
- (unint64_t)numberOfOperations
{
  v3 = [(NAUniqueArrayDiff *)self deletedIndexes];
  uint64_t v4 = [v3 count];
  id v5 = [(NAUniqueArrayDiff *)self insertedIndexes];
  uint64_t v6 = [v5 count] + v4;
  id v7 = [(NAUniqueArrayDiff *)self movedIndexes];
  uint64_t v8 = [v7 count];
  id v9 = [(NAUniqueArrayDiff *)self changedIndexes];
...
{
  id v4 = a3;
  id v5 = [(NAUniqueArrayDiff *)self deletedIndexes];
  v7[0] = MEMORY[0x1E4F143A8];
  v7[1] = 3221225472;
...
{
  id v4 = a3;
  id v5 = [(NAUniqueArrayDiff *)self changedIndexes];
  v7[0] = MEMORY[0x1E4F143A8];
  v7[1] = 3221225472;
...
- (void)enumerateMovesUsingBlock:(id)a3
{
  ...
  id v5 = [(NAUniqueArrayDiff *)self movedIndexes];
  id v6 = [v5 allObjects];
  id v7 = [v6 sortedArrayUsingComparator:&__block_literal_global_76];
