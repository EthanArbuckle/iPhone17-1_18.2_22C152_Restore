...
- (MTLTexture)texture0;
- (MTLTexture)texture1;
- (NUNCalliopeOffscreen)initWithDevice:(id)a3 width:(int)a4 height:(int)a5 pixelFormat0:(unint64_t)a6 pixelFormat1:(unint64_t)a7 mipmaps:(int)a8 loadAction:(unint64_t)a9 clearColor0:(id)a10 clearColor1:(id)a11;
...
- (NUNCalliopeOffscreen)initWithDevice:(id)a3 width:(int)a4 height:(int)a5 texture0:(id)a6 texture1:(id)a7 loadAction:(unint64_t)a8 clearColor0:(id)a9 clearColor1:(id)a10
{
  ...
  id v24 = a7;
  v36.receiver = self;
  v36.super_class = (Class)NUNCalliopeOffscreen;
  ...
  if (v25)
  {
    ...
    if (v27)
    {
      ...
      objc_msgSend(v32, "setStoreAction:", (~objc_msgSend(v27, "resourceOptions") & 0x30) != 0);
    ...
    if (v28)
    {
      ...
      objc_msgSend(v33, "setStoreAction:", (~objc_msgSend(v28, "resourceOptions") & 0x30) != 0);
...
- (NUNCalliopeOffscreen)initWithDevice:(id)a3 width:(int)a4 height:(int)a5 pixelFormat0:(unint64_t)a6 pixelFormat1:(unint64_t)a7 mipmaps:(int)a8 loadAction:(unint64_t)a9 clearColor0:(id)a10 clearColor1:(id)a11
{
  ...
  double v23 = a10.var0;
  id v25 = a3;
  v26 = _NUNCalliopeCreateTexture(v25, v15, v14, a8, a6, 0);
  id v27 = _NUNCalliopeCreateTexture(v25, v15, v14, a8, a7, 0);
  id v28 = -[NUNCalliopeOffscreen initWithDevice:width:height:texture0:texture1:loadAction:clearColor0:clearColor1:](self, "initWithDevice:width:height:texture0:texture1:loadAction:clearColor0:clearColor1:", v25, v15, v14, v26, v27, a9, v23, v22, v21, v20, var0, var1, var2, var3);
