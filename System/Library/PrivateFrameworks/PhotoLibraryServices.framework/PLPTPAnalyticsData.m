...
- (id)description
{
  ...
  v6 = [(PLPTPAnalyticsData *)self cplStateString];
...
- (void)report
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG))
  {
    int v13 = 138412290;
    v14 = self;
    _os_log_impl(&dword_19B3C7000, v3, OS_LOG_TYPE_DEBUG, "PTP Analytics:\n%@", (uint8_t *)&v13, 0xCu);
  }
...
- (id)cplStateString
{
  int64_t cplState = self->_cplState;
  v3 = @"Optimize Storage";
  if (cplState == 2) {
    v3 = @"Keep Originals";
  }
...
- (void)incrementConversionCountForAssetType:(signed __int16)a3
{
  ...
  if ((a3 - 2) < 2)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      v5[0] = 67109120;
      v5[1] = v3;
      _os_log_impl(&dword_19B3C7000, v4, OS_LOG_TYPE_ERROR, "Unexpected asset type for transcode: %d", (uint8_t *)v5, 8u);
    }
  }
  else if (a3 == 1)
  {
