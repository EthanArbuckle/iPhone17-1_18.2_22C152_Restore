...
- (void)dealloc
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_19B3C7000, v3, OS_LOG_TYPE_DEFAULT, "PLCacheMetricsCollectorServer Deallocated on assetsd", buf, 2u);
  }
...
- ($5E5F304956FB491AF6F034FDF0808287)getSharedImageRequestCacheMetrics
{
  ...
  uint64_t v3 = *sharedRegion;
  uint64_t v4 = sharedRegion[1];
  result.var2 = v4;
...
- (PLCacheMetricsCollectorServer)initWithXPCObject:(id)a3
{
  ...
  if (v5)
  {
    if (v4)
    {
      size_t v7 = xpc_shmem_map(v4, &v5->_sharedRegion);
      v6->_bufferSize = v7;
      ...
      if (v7)
      {
        ...
        {
          *(_WORD *)v12 = 0;
          _os_log_impl(&dword_19B3C7000, v9, OS_LOG_TYPE_DEFAULT, "Successfully mapped server-side buffer", v12, 2u);
        }
      ...
      {
        *(_WORD *)v12 = 0;
        _os_log_impl(&dword_19B3C7000, v9, OS_LOG_TYPE_ERROR, "Shmem_map failed in PLCacheMetricsCollectorServer initialization", v12, 2u);
      }
    }
    v10 = 0;
    goto LABEL_12;
