...
- (int64_t)performActionWithManagedObjectContext:(id)a3 error:(id *)a4
{
  ...
  v53[1] = 3221225472;
  v53[2] = __101__PLModelMigrationAction_setInitialIsRecentlySavedValue_performActionWithManagedObjectContext_error___block_invoke;
  v53[3] = &unk_1E586FB88;
  id v17 = v6;
  id v54 = v17;
  v52[0] = MEMORY[0x1E4F143A8];
  v52[1] = 3221225472;
  v52[2] = __101__PLModelMigrationAction_setInitialIsRecentlySavedValue_performActionWithManagedObjectContext_error___block_invoke_2;
  v52[3] = &unk_1E5870290;
  v52[4] = self;
  v52[5] = v59;
  v51[0] = MEMORY[0x1E4F143A8];
  v51[1] = 3221225472;
  v51[2] = __101__PLModelMigrationAction_setInitialIsRecentlySavedValue_performActionWithManagedObjectContext_error___block_invoke_3;
  v51[3] = &unk_1E586B428;
  v51[4] = self;
  v51[5] = &v61;
  v51[6] = &v67;
  ...
  if (v16)
  {
    ...
    if (!v23)
    {
      ...
      objc_msgSend(v27, "logWithMessage:fromCodeLocation:type:", v26, "PLModelMigrationActionBackground.m", 1151, 0);
...
LABEL_12:
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(void *)&buf[4] = v40;
      _os_log_impl(&dword_19B3C7000, v39, OS_LOG_TYPE_DEFAULT, "Set initial isRecentlySaved for %tu assets.", buf, 0xCu);
    }
  }
  else
  {
    ...
    if (!v32)
    {
      ...
      objc_msgSend(v38, "logWithMessage:fromCodeLocation:type:", v37, "PLModelMigrationActionBackground.m", 1154, 16);
