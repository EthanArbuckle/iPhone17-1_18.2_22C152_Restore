...
+ (id)assetsToUseForDayGroupHighlight:(id)a3 withFilter:(unsigned __int16)a4
{
  ...
  switch(v4)
  {
    case 2:
      ...
      uint64_t v8 = [v6 dayGroupAssetsShared];
      goto LABEL_10;
    case 1:
      ...
      uint64_t v8 = [v6 dayGroupAssetsPrivate];
      goto LABEL_10;
    case 0:
...
+ (id)titleForHighlight:(id)a3 filter:(unsigned __int16)a4 dateRangeTitleGenerator:(id)a5 options:(unint64_t)a6
{
  ...
  v15 = [v13 lastObject];
  v16 = [v14 dateCreated];
  v17 = objc_msgSend(v16, "dateByAddingTimeInterval:", (double)(int)objc_msgSend(v9, "startTimeZoneOffset"));

  v18 = [v15 dateCreated];
  v19 = objc_msgSend(v18, "dateByAddingTimeInterval:", (double)(int)objc_msgSend(v9, "endTimeZoneOffset"));

  uint64_t v20 = [v9 category];
  uint64_t v21 = [v9 kind];
