...
- (int64_t)performActionWithManagedObjectContext:(id)a3 error:(id *)a4
{
  ...
  v9 = +[PLInternalResource fetchRequest];
  ...
  if (v8)
  {
    v13 = [MEMORY[0x1E4F28F60] predicateWithFormat:@"%K BEGINSWITH %@", @"compactUTI", @"_"];
    [v9 setPredicate:v13];
  }
  v60[0] = 0;
  v60[1] = v60;
  ...
  v54[1] = 3221225472;
  v54[2] = __107__PLModelMigrationAction_dedupeResourcesWithSimilarCompactUTI_performActionWithManagedObjectContext_error___block_invoke;
  v54[3] = &unk_1E586FB88;
  id v18 = v6;
  id v55 = v18;
  v53[0] = MEMORY[0x1E4F143A8];
  v53[1] = 3221225472;
  v53[2] = __107__PLModelMigrationAction_dedupeResourcesWithSimilarCompactUTI_performActionWithManagedObjectContext_error___block_invoke_2;
  v53[3] = &unk_1E5870290;
  v53[4] = self;
  v53[5] = v60;
  v52[0] = MEMORY[0x1E4F143A8];
  v52[1] = 3221225472;
  v52[2] = __107__PLModelMigrationAction_dedupeResourcesWithSimilarCompactUTI_performActionWithManagedObjectContext_error___block_invoke_3;
  v52[3] = &unk_1E5862318;
  v52[4] = self;
  v52[5] = &v62;
  v52[6] = &v68;
  ...
  if (v17)
  {
    ...
    if (!v24)
    {
      ...
      objc_msgSend(v28, "logWithMessage:fromCodeLocation:type:", v27, "PLModelMigrationActionBackground.m", 962, 0);
...
LABEL_12:
    ...
    if (os_log_type_enabled(v40, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(void *)&buf[4] = v41;
      _os_log_impl(&dword_19B3C7000, v40, OS_LOG_TYPE_DEFAULT, "Deleted %tu resources duplicated by UTI.", buf, 0xCu);
    }
  }
  else
  {
    ...
    if (!v33)
    {
      ...
      objc_msgSend(v39, "logWithMessage:fromCodeLocation:type:", v38, "PLModelMigrationActionBackground.m", 965, 16);
