      ...
      if (!v51[5])
      {
        ...
        if (v17)
        {
          ...
          else
          {
            ...
            objc_msgSend(v23, "logWithMessage:fromCodeLocation:type:", v22, "PLModelMigrationActions_15000.m", 422, 16);
  ...
  else
  {
    ...
    if (v25)
    {
      ...
      else
      {
        ...
        objc_msgSend(v33, "logWithMessage:fromCodeLocation:type:", v32, "PLModelMigrationActions_15000.m", 426, 16);
