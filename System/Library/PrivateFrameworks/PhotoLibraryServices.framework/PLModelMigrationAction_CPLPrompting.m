...
- (int64_t)performActionWithManagedObjectContext:(id)a3 error:(id *)a4
{
  ...
  unsigned int v7 = [(PLModelMigrationActionCore *)self startingSchemaVersion] - 11000;
  v8 = objc_opt_class();
  v9 = v8;
  if (v7 > 0x2D)
  {
...
+ (void)_resetICPLPrompt
{
  v3 = (void *)CFPreferencesCopyAppValue(@"iCloudPhotoLibraryLastResetWelcomePromptDBVersion", @"com.apple.mobileslideshow");
  if (v3)
  {
    v4 = v3;
    if ((int)[v3 intValue] <= 12199)
    {
...
+ (void)_setLastWelcomedDBVersion
{
  v2 = [NSNumber numberWithInt:12200];
...
+ (void)shouldRepromptUserIfNeededWithPathManager:(id)a3
{
  ...
  if ([v4 isSystemPhotoLibraryPathManager])
  {
    ...
    {
      *(_WORD *)v8 = 0;
      _os_log_impl(&dword_19B3C7000, v5, OS_LOG_TYPE_DEFAULT, "Resetting iCPL prompt if needed", v8, 2u);
    }

    v6 = [v4 libraryURL];
    char v7 = PLIsCloudPhotoLibraryEnabledForPhotoLibraryURL(v6);
