@interface PLModelMigrationActionStaged_FixupExistingUserFeedback
...
- (int64_t)performActionWithManagedObjectContext:(id)a3 error:(id *)a4
{
  ...
  if (v12)
  {
    ...
    v45[1] = 3221225472;
    v45[2] = __102__PLModelMigrationActionStaged_FixupExistingUserFeedback_performActionWithManagedObjectContext_error___block_invoke;
    v45[3] = &unk_1E586D928;
    v45[4] = self;
    v47 = &v54;
    v48 = &v50;
      ...
      if (!v55[5])
      {
        ...
        if (v17)
        {
          ...
          else
          {
            ...
            objc_msgSend(v23, "logWithMessage:fromCodeLocation:type:", v22, "PLModelMigrationActionStaged.m", 83, 16);
  ...
  else
  {
    ...
    if (v25)
    {
      ...
      else
      {
        ...
        objc_msgSend(v33, "logWithMessage:fromCodeLocation:type:", v32, "PLModelMigrationActionStaged.m", 87, 16);
