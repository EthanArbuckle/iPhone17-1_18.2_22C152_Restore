...
- (int64_t)performActionWithManagedObjectContext:(id)a3 error:(id *)a4
{
  ...
  id v7 = a3;
  v8 = [v6 predicateWithFormat:@"%K = %@", @"kind", &unk_1EEBEE1D8];
  ...
  if (v10)
  {
    ...
    if (v13)
    {
      ...
      if (v14)
      {
        ...
        objc_msgSend(v17, "logWithMessage:fromCodeLocation:type:", v16, "PLModelMigrationActions_16000.m", 1080, 0);
      ...
      else
      {
        ...
        {
          *(_WORD *)buf = 0;
          _os_log_impl(&dword_19B3C7000, v26, OS_LOG_TYPE_DEFAULT, "Deleted all albums of type NotUploadedAlbum", buf, 2u);
        }
      }
    }
    int64_t v27 = 1;
  ...
  else
  {
    ...
    if (v19)
    {
      ...
      if (v20)
      {
        ...
        objc_msgSend(v25, "logWithMessage:fromCodeLocation:type:", v24, "PLModelMigrationActions_16000.m", 1084, 16);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_WORD *)&buf[12] = 2114;
          *(void *)&buf[14] = v11;
          _os_log_impl(&dword_19B3C7000, v28, OS_LOG_TYPE_ERROR, "Failed to batch delete albums of type NotUploadedAlbum for %{public}@. Error: %{public}@", buf, 0x16u);
        }
      }
    }
    int64_t v27 = 3;
