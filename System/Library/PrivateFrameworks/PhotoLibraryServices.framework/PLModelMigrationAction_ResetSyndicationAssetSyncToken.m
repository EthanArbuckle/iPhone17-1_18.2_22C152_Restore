  ...
  if (v9)
  {
    ...
    if (v12)
    {
      ...
      if (v13)
      {
        ...
        objc_msgSend(v16, "logWithMessage:fromCodeLocation:type:", v15, "PLModelMigrationActions_16000.m", 121, 0);
      ...
      else
      {
        ...
        {
          *(_WORD *)buf = 0;
          _os_log_impl(&dword_19B3C7000, v25, OS_LOG_TYPE_DEFAULT, "Cleared syndication sync tokens for asset sync, full index sync, syndication start date", buf, 2u);
        }
      }
    }
  ...
  else
  {
    ...
    if (v18)
    {
      ...
      if (v19)
      {
        ...
        objc_msgSend(v24, "logWithMessage:fromCodeLocation:type:", v23, "PLModelMigrationActions_16000.m", 118, 16);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_WORD *)&buf[12] = 2112;
          *(void *)&buf[14] = v10;
          _os_log_impl(&dword_19B3C7000, v27, OS_LOG_TYPE_ERROR, "Failed to perform a save operation for %{public}@. Error: %@", buf, 0x16u);
        }
      }
    }
    [(PLModelMigrationActionCore *)self finalizeProgress];
