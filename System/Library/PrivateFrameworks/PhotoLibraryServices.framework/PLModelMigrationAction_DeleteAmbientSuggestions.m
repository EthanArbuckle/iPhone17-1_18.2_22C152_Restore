...
- (int64_t)performActionWithManagedObjectContext:(id)a3 error:(id *)a4
{
  ...
  id v7 = a3;
  v8 = objc_msgSend(v6, "predicateWithFormat:", @"%K = %d", @"type", 8);
  ...
  if (v10)
  {
    ...
    if (v13)
    {
      ...
      if (v14)
      {
        ...
        objc_msgSend(v17, "logWithMessage:fromCodeLocation:type:", v16, "PLModelMigrationActions_18000.m", 1794, 0);
      ...
      else
      {
        ...
        {
          *(_WORD *)buf = 0;
          _os_log_impl(&dword_19B3C7000, v26, OS_LOG_TYPE_DEFAULT, "Deleted all ambient suggestions", buf, 2u);
        }
      }
    }
    int64_t v27 = 1;
  ...
  else
  {
    ...
    if (v19)
    {
      ...
      if (v20)
      {
        ...
        objc_msgSend(v25, "logWithMessage:fromCodeLocation:type:", v24, "PLModelMigrationActions_18000.m", 1798, 16);
