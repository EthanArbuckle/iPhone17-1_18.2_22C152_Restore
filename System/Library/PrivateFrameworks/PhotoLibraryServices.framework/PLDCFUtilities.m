...
+ (id)encodeFileNameFromHash:(unsigned int)a3
{
  uint64_t v3 = *(void *)&a3;
  pl_dispatch_once();
  id v5 = [a1 convertHash:v3 usingPlaceValues:encodeFileNameFromHash__pl_once_object_17];
  v21 = NSString;
...
{
  id v3 = [*(id *)(a1 + 32) placeValuesFromBases:&unk_1EEBF17D8];
  uint64_t v1 = [v3 copy];
...
{
  id v8 = a3;
  uint64_t v9 = objc_msgSend(a1, "encodeFileNameFromHash:", objc_msgSend(a1, "hashForFileName:createDate:fileSize:", v8, a4, a5));
  double v10 = [v8 pathExtension];

  uint64_t v11 = [v10 uppercaseString];
  v12 = (void *)v11;
  uint64_t v13 = &stru_1EEB2EB80;
  if (v11) {
...
+ (BOOL)isSpatialOverCaptureFileName:(id)a3
{
  uint64_t v4 = PLAuxiliaryResourceFilenameMarkerSpatialOverCapture;
  id v5 = a3;
  id v6 = [a1 dcfRegexForAuxiliaryResourceFilenameMarker:v4];
...
+ (id)renderDCFRegex
{
  return (id)[a1 dcfRegexForAuxiliaryResourceFilenameMarker:PLAuxiliaryResourceFilenameMarkerRender];
}
...
+ (id)dcfRegexForAuxiliaryResourceFilenameMarker:(id)a3
{
  ...
  if (!v5)
  {
    ...
    [v8 handleFailureInMethod:a2, a1, @"PLDCFUtilities.m", 75, @"Invalid parameter not satisfying: %@", @"marker" object file lineNumber description];
  }
  pl_dispatch_once();
  ...
  if (!v6)
  {
    ...
    [v9 handleFailureInMethod:a2, a1, @"PLDCFUtilities.m", 98, @"Unknown auxiliary resource type marker: %@", v5 object file lineNumber description];
  }
  return v6;
}
...
void __61__PLDCFUtilities_dcfRegexForAuxiliaryResourceFilenameMarker___block_invoke()
{
  ...
  [MEMORY[0x1E4F1C978] arrayWithObjects:v15 count:4];
  long long v10 = 0u;
  long long v11 = 0u;
  long long v12 = 0u;
  long long v13 = 0u;
...
+ (id)dcfCompliantNameForFileName:(id)a3 createDate:(id)a4 fileSize:(unint64_t)a5 filenameMarker:(id)a6
{
  ...
  if (v10)
  {
    uint64_t v12 = [a1 insertAuxiliaryResourceTypeMarker:v10 intoFileName:v11];
