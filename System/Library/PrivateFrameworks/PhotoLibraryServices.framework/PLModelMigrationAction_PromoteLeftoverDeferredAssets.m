...
- (int64_t)performActionWithManagedObjectContext:(id)a3 error:(id *)a4
{
  ...
  v53 = __Block_byref_object_copy__53410;
  v54 = __Block_byref_object_dispose__53411;
  id v55 = 0;
  v7 = (void *)MEMORY[0x1E4F1C0D0];
  v8 = +[PLInternalResource entityName];
  v9 = [v7 fetchRequestWithEntityName:v8];

  v10 = objc_msgSend(MEMORY[0x1E4F28F60], "predicateWithFormat:", @"%K = %d", @"recipeID", 65944);
  [v9 setPredicate:v10];
      ...
      if (!v51[5])
      {
        ...
        if (v17)
        {
          ...
          else
          {
            ...
            objc_msgSend(v23, "logWithMessage:fromCodeLocation:type:", v22, "PLModelMigrationActions_15000.m", 182, 16);
  ...
  else
  {
    ...
    if (v25)
    {
      ...
      else
      {
        ...
        objc_msgSend(v33, "logWithMessage:fromCodeLocation:type:", v32, "PLModelMigrationActions_15000.m", 186, 16);
