@interface PLModelMigrationAction_RemoveScreenshotAssetsFromDuplicateAlbums
- (int64_t)performActionWithManagedObjectContext:(id)a3 error:(id *)a4;
@end

@implementation PLModelMigrationAction_RemoveScreenshotAssetsFromDuplicateAlbums
