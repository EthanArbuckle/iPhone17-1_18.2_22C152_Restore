...
- (int64_t)performActionWithManagedObjectContext:(id)a3 error:(id *)a4
{
  ...
  id v7 = a3;
  v8 = objc_msgSend(v6, "predicateWithFormat:", @"%K != nil", @"libraryScope");
  uint64_t v65 = 0x1EEB30000;
  v66[0] = &unk_1EEBEE1A8;
  ...
  else
  {
    ...
    if (v16)
    {
      ...
      if (v17)
      {
        ...
        objc_msgSend(v22, "logWithMessage:fromCodeLocation:type:", v21, "PLModelMigrationActions_16000.m", 816, 16);
