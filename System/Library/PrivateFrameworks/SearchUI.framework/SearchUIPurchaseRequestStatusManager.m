...
+ (SearchUIPurchaseRequestStatusManager)sharedManager
{
  ...
  v2 = (void *)sharedManager_sharedObserver_0;
  return (SearchUIPurchaseRequestStatusManager *)v2;
}
...
uint64_t __53__SearchUIPurchaseRequestStatusManager_sharedManager__block_invoke()
{
  ...
  uint64_t v1 = sharedManager_sharedObserver_0;
...
- (void)setupSink
{
  ...
  dispatch_queue_t v4 = dispatch_queue_create("com.apple.SearchUI.SearchUIPurchaseRequestStatusManager.queue", v3);

  v5 = (void *)[objc_alloc(MEMORY[0x1E4F502E8]) initWithIdentifier:@"com.apple.SearchUI.SearchUIPurchaseRequestStatusManager.scheduler" targetQueue:v4 waking:0];
  objc_initWeak(&location, self);
  v6 = BiomeLibrary();
  v7 = [v6 Family];
  objc_super v8 = [v7 AskToBuy];
  v9 = [v8 DSLPublisher];
  ...
  v11 = [v10 sinkWithCompletion:&__block_literal_global_17_0 receiveInput:&v12];
...
- (void)updateWithEvent:(id)a3
{
  ...
  id v7 = [(SearchUIPurchaseRequestStatusManager *)self requestStatuses];
...
- (void)dealloc
{
  id v3 = [(SearchUIPurchaseRequestStatusManager *)self biomeSink];
  [v3 cancel];
