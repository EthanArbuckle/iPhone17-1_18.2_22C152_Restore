...
+ (void)playWithAudioData:(SiriTTSAudioData *)a3 completionHandler:(id)a4
{
  ...
  v14[5] = v13;
  v15 = a3;
  sub_1E4693074((uint64_t)v9, (uint64_t)&unk_1EAE55AC8, (uint64_t)v14);
  swift_release();
}
...
{
  v3.receiver = self;
  v3.super_class = (Class)type metadata accessor for SearchUITTSUtilities();
