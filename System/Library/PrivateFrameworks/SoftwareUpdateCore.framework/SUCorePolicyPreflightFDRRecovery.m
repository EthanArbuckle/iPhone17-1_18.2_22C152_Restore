...
{
  v7.receiver = self;
  v7.super_class = (Class)SUCorePolicyPreflightFDRRecovery;
...
- (SUCorePolicyPreflightFDRRecovery)initWithCoder:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SUCorePolicyPreflightFDRRecovery;
...
{
  id v4 = a3;
  objc_msgSend(v4, "encodeBool:forKey:", -[SUCorePolicyPreflightFDRRecovery performPhase](self, "performPhase"), @"PerformPhase");
}

- (id)copyWithZone:(_NSZone *)a3
{
  v5 = objc_msgSend((id)objc_msgSend((id)objc_opt_class(), "allocWithZone:", a3), "init");
  objc_msgSend(v5, "setPerformPhase:", -[SUCorePolicyPreflightFDRRecovery performPhase](self, "performPhase"));
...
- (BOOL)isEqual:(id)a3
{
  id v4 = (SUCorePolicyPreflightFDRRecovery *)a3;
  if (v4 == self)
  {
    LOBYTE(v6) = 1;
  }
  else
  {
    ...
    {
      BOOL v5 = [(SUCorePolicyPreflightFDRRecovery *)v4 performPhase];
      int v6 = v5 ^ [(SUCorePolicyPreflightFDRRecovery *)self performPhase] ^ 1;
    }
    else
    {
      LOBYTE(v6) = 0;
...
- (id)description
{
  ...
  BOOL v5 = [(SUCorePolicyPreflightFDRRecovery *)self basePreflightOptions];
  if (v5)
  {
    int v6 = [(SUCorePolicyPreflightFDRRecovery *)self basePreflightOptions];
  }
  else
  {
    int v6 = @"none";
  }
  objc_super v7 = [(SUCorePolicyPreflightFDRRecovery *)self additionalOptions];
  if (v7)
  {
    v8 = [(SUCorePolicyPreflightFDRRecovery *)self additionalOptions];
    objc_super v9 = [v3 stringWithFormat:@"SUCorePolicyPreflightFDRRecovery(performPhase:%@|basePreflightOptions:%@|additionalOptions:%@)", v4, v6, v8];
  }
  else
  {
    objc_super v9 = [v3 stringWithFormat:@"SUCorePolicyPreflightFDRRecovery(performPhase:%@|basePreflightOptions:%@|additionalOptions:%@)", v4, v6, @"none"];
  }
...
- (id)summary
{
  ...
  id v4 = [(SUCorePolicyPreflightFDRRecovery *)self basePreflightOptions];
  if (v4) {
