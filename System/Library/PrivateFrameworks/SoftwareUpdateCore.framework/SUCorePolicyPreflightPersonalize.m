...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = [(SUCorePolicyPreflightPersonalize *)self basePreflightOptions];
  objc_super v7 = (void *)[v6 copyWithZone:a3];
  [v5 setBasePreflightOptions:v7];

  v8 = [(SUCorePolicyPreflightPersonalize *)self additionalOptions];
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      BOOL v5 = [(SUCorePolicyPreflightPersonalize *)v4 performPhase];
      int v6 = v5 ^ [(SUCorePolicyPreflightPersonalize *)self performPhase] ^ 1;
    }
    else
    {
      LOBYTE(v6) = 0;
...
- (id)description
{
  ...
  BOOL v5 = [(SUCorePolicyPreflightPersonalize *)self basePreflightOptions];
  if (v5)
  {
    int v6 = [(SUCorePolicyPreflightPersonalize *)self basePreflightOptions];
  }
  else
  {
    int v6 = @"none";
  }
  objc_super v7 = [(SUCorePolicyPreflightPersonalize *)self additionalOptions];
  if (v7)
  {
    v8 = [(SUCorePolicyPreflightPersonalize *)self additionalOptions];
    objc_super v9 = [v3 stringWithFormat:@"SUCorePolicyPreflightPersonalize(performPhase:%@|basePreflightOptions:%@|additionalOptions:%@)", v4, v6, v8];
  }
  else
  {
    objc_super v9 = [v3 stringWithFormat:@"SUCorePolicyPreflightPersonalize(performPhase:%@|basePreflightOptions:%@|additionalOptions:%@)", v4, v6, @"none"];
  }
...
- (id)summary
{
  ...
  id v4 = [(SUCorePolicyPreflightPersonalize *)self basePreflightOptions];
  if (v4) {
