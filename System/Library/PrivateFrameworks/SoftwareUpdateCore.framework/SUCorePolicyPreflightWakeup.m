...
{
  v7.receiver = self;
  v7.super_class = (Class)SUCorePolicyPreflightWakeup;
...
- (SUCorePolicyPreflightWakeup)initWithCoder:(id)a3
{
  id v4 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SUCorePolicyPreflightWakeup;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = [(SUCorePolicyPreflightWakeup *)self basePreflightOptions];
  objc_super v7 = (void *)[v6 copyWithZone:a3];
  [v5 setBasePreflightOptions:v7];

  v8 = [(SUCorePolicyPreflightWakeup *)self additionalOptions];
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      BOOL v5 = [(SUCorePolicyPreflightWakeup *)v4 performPhase];
      int v6 = v5 ^ [(SUCorePolicyPreflightWakeup *)self performPhase] ^ 1;
    }
    else
    {
      LOBYTE(v6) = 0;
...
- (id)description
{
  ...
  BOOL v5 = [(SUCorePolicyPreflightWakeup *)self basePreflightOptions];
  if (v5)
  {
    int v6 = [(SUCorePolicyPreflightWakeup *)self basePreflightOptions];
  }
  else
  {
    int v6 = @"none";
  }
  objc_super v7 = [(SUCorePolicyPreflightWakeup *)self additionalOptions];
  if (v7)
  {
    v8 = [(SUCorePolicyPreflightWakeup *)self additionalOptions];
    objc_super v9 = [v3 stringWithFormat:@"SUCorePolicyPreflightWakeup(performPhase:%@|basePreflightOptions:%@|additionalOptions:%@)", v4, v6, v8];
  }
  else
  {
    objc_super v9 = [v3 stringWithFormat:@"SUCorePolicyPreflightWakeup(performPhase:%@|basePreflightOptions:%@|additionalOptions:%@)", v4, v6, @"none"];
  }
...
- (id)summary
{
  ...
  id v4 = [(SUCorePolicyPreflightWakeup *)self basePreflightOptions];
  if (v4) {
