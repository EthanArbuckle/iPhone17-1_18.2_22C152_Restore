...
{
  v7.receiver = self;
  v7.super_class = (Class)PSDSwitchAssertionManager;
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)PSDSwitchAssertionManager;
...
- (void)scheduler:(id)a3 willStartSyncSession:(id)a4
{
  ...
  if ([v5 syncSessionType] != (id)1)
  {
    ...
    if (v7)
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl((void *)&_mh_execute_header, v8, OS_LOG_TYPE_DEFAULT, "PSDSwitchAssertionManager: Not a reunion sync, enabling switch assertion", buf, 2u);
      }
    }
    ...
    if (v11)
    {
      if (v13)
      {
        ...
        {
          *(_WORD *)buf = 0;
          _os_log_impl((void *)&_mh_execute_header, v14, OS_LOG_TYPE_DEFAULT, "PSDSwitchAssertionManager: Found NRDevice for sync", buf, 2u);
        }
      }
    ...
    else
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl((void *)&_mh_execute_header, v15, OS_LOG_TYPE_DEFAULT, "PSDSwitchAssertionManager: Could not find NRDevice for sync", buf, 2u);
      }
    }
...
- (void)scheduler:(id)a3 didClearSyncSession:(id)a4 withBlock:(id)a5
{
  ...
  if (self->_assertion)
  {
    ...
    if (v8)
    {
      ...
      {
        *(_WORD *)v11 = 0;
        _os_log_impl((void *)&_mh_execute_header, v9, OS_LOG_TYPE_DEFAULT, "PSDSwitchAssertionManager: Releasing switch assertion", v11, 2u);
      }
    }
