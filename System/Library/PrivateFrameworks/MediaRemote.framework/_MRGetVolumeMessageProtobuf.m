...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)_MRGetVolumeMessageProtobuf;
...
- (BOOL)readFrom:(id)a3
{
  return _MRGetVolumeMessageProtobufReadFrom((uint64_t)self, (uint64_t)a3);
}
...
{
  if (*((void *)a3 + 1)) {
    -[_MRGetVolumeMessageProtobuf setOutputDeviceUID:](self, "setOutputDeviceUID:");
  }
}
