...
@implementation _MRDictionaryProtobuf
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)_MRDictionaryProtobuf;
  id v4 = [(_MRDictionaryProtobuf *)&v8 description];
  v5 = [(_MRDictionaryProtobuf *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return _MRDictionaryProtobufReadFrom(self, (uint64_t)a3);
}

- (void)copyTo:(id)a3
{
  id v8 = a3;
  if ([(_MRDictionaryProtobuf *)self pairsCount])
  {
    [v8 clearPairs];
    unint64_t v4 = [(_MRDictionaryProtobuf *)self pairsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(_MRDictionaryProtobuf *)self pairAtIndex:i];
        [v8 addPair:v7];
      }
    }
  }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[_MRDictionaryProtobuf addPair:](self, "addPair:", *(void *)(*((void *)&v9 + 1) + 8 * v8++), (void)v9);
      }
      while (v6 != v8);
