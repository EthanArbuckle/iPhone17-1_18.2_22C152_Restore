...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)_MRUpdateContentItemMessageProtobuf;
  id v4 = [(_MRUpdateContentItemMessageProtobuf *)&v8 description];
...
- (BOOL)readFrom:(id)a3
{
  return _MRUpdateContentItemMessageProtobufReadFrom((id *)&self->super.super.isa, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if ([(_MRUpdateContentItemMessageProtobuf *)self contentItemsCount])
  {
    ...
    unint64_t v4 = [(_MRUpdateContentItemMessageProtobuf *)self contentItemsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(_MRUpdateContentItemMessageProtobuf *)self contentItemsAtIndex:i];
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        -[_MRUpdateContentItemMessageProtobuf addContentItems:](self, "addContentItems:", *(void *)(*((void *)&v12 + 1) + 8 * i), (void)v12);
      }
  ...
  {
    -[_MRUpdateContentItemMessageProtobuf setPlayerPath:](self, "setPlayerPath:");
  }
}
