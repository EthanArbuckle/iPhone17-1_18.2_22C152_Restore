...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)_MRApplicationConnectionMessageHeaderProtobuf;
...
- (BOOL)readFrom:(id)a3
{
  return _MRApplicationConnectionMessageHeaderProtobufReadFrom((uint64_t)self, (uint64_t)a3);
}
