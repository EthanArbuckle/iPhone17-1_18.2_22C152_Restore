...
- (id)description
{
  ...
  v5 = [(_MRPlayerClientPropertiesMessageProtobuf *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = [NSNumber numberWithDouble:self->_lastPlayingTimestamp];
    [v3 setObject:v6 forKey:@"lastPlayingTimestamp"];
  }
...
- (void)copyTo:(id)a3
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    *((void *)v4 + 1) = *(void *)&self->_lastPlayingTimestamp;
...
- (unint64_t)hash
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    ...
    double v6 = -lastPlayingTimestamp;
    if (lastPlayingTimestamp >= 0.0) {
      double v6 = self->_lastPlayingTimestamp;
    }
...
LABEL_7:
  ...
  {
    self->_double lastPlayingTimestamp = *((double *)v4 + 1);
    *(unsigned char *)&self->_has |= 1u;
  }
