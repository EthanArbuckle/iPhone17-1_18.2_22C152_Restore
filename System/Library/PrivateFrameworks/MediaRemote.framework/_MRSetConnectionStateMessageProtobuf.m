...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)_MRSetConnectionStateMessageProtobuf;
  int v4 = [(_MRSetConnectionStateMessageProtobuf *)&v8 description];
  v5 = [(_MRSetConnectionStateMessageProtobuf *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return _MRSetConnectionStateMessageProtobufReadFrom((uint64_t)self, (uint64_t)a3);
}
