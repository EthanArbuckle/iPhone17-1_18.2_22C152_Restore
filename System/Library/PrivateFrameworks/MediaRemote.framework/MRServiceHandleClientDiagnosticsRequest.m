@interface MRServiceHandleClientDiagnosticsRequest
@end

@implementation MRServiceHandleClientDiagnosticsRequest

void ___MRServiceHandleClientDiagnosticsRequest_block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  if (v6)
  {
    ...
    if (reply)
    {
      MRAddDiagnosticToXPCMessage(reply, a2);
