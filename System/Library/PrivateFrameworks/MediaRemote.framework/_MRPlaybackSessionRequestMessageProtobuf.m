...
@implementation _MRPlaybackSessionRequestMessageProtobuf
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)_MRPlaybackSessionRequestMessageProtobuf;
  v4 = [(_MRPlaybackSessionRequestMessageProtobuf *)&v8 description];
  v5 = [(_MRPlaybackSessionRequestMessageProtobuf *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return _MRPlaybackSessionRequestMessageProtobufReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    -[_MRPlaybackSessionRequestMessageProtobuf setRequest:](self, "setRequest:");
  }
  id v4 = v9;
LABEL_7:
  playerPath = self->_playerPath;
  ...
  else
  {
    ...
    playerPath = (_MRNowPlayingPlayerPathProtobuf *)-[_MRPlaybackSessionRequestMessageProtobuf setPlayerPath:](self, "setPlayerPath:");
  }
  id v4 = v9;
LABEL_13:
