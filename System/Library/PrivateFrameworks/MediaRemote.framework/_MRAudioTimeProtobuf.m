...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    v6 = [NSNumber numberWithDouble:self->_sampleRate];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (has)
  {
    *((void *)result + 1) = *(void *)&self->_sampleRate;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((unsigned char *)v4 + 24) & 2) == 0 || self->_timestamp != *((double *)v4 + 2)) {
      goto LABEL_11;
    }
  }
...
LABEL_11:
  ...
  {
    if ((*((unsigned char *)v4 + 24) & 1) == 0 || self->_sampleRate != *((double *)v4 + 1)) {
      goto LABEL_11;
    }
    BOOL v5 = 1;
  }
...
- (unint64_t)hash
{
  ...
  if (has)
  {
    ...
    double v11 = -sampleRate;
    if (sampleRate >= 0.0) {
      double v11 = self->_sampleRate;
    }
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v5)
  {
    self->_double sampleRate = *((double *)v4 + 1);
    *(unsigned char *)&self->_has |= 1u;
  }
}
