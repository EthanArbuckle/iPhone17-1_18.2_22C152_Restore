...
- (NSSet)nodes
{
  return (NSSet *)sub_100319A00((uint64_t)self, (uint64_t)a2, (uint64_t)&OBJC_IVAR___MRIRRouteRecommendationCandidate_nodes, (void (*)(uint64_t))type metadata accessor for RouteRecommendationNode, &qword_10047DAF0, (void (*)(void))type metadata accessor for RouteRecommendationNode);
}
