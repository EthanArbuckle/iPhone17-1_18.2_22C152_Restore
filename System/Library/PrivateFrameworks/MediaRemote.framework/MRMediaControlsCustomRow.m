...
- (MRMediaControlsCustomRow)initWithCoder:(id)a3
{
  id v4 = a3;
  v15.receiver = self;
  v15.super_class = (Class)MRMediaControlsCustomRow;
...
- (BOOL)isEqual:(id)a3
{
  id v4 = (MRMediaControlsCustomRow *)a3;
  if (self == v4)
  {
    LOBYTE(v11) = 1;
  }
  else
  {
    ...
    {
      v5 = v4;
      id v6 = [(MRMediaControlsCustomRow *)v5 type];
      int v7 = [v6 isEqual:self->_type];

      id v8 = [(MRMediaControlsCustomRow *)v5 titleOverride];
