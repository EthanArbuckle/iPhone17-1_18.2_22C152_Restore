...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)_MRSetNowPlayingClientMessageProtobuf;
  v4 = [(_MRSetNowPlayingClientMessageProtobuf *)&v8 description];
  v5 = [(_MRSetNowPlayingClientMessageProtobuf *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return _MRSetNowPlayingClientMessageProtobufReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    -[_MRSetNowPlayingClientMessageProtobuf setClient:](self, "setClient:");
  }
