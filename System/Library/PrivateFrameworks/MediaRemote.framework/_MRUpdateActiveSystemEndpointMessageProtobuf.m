...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v6 = [(_MRUpdateActiveSystemEndpointRequestProtobuf *)self->_request copyWithZone:a3];
  v7 = (void *)v5[1];
  v5[1] = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((unint64_t)request | v4[1]) {
      char v6 = -[_MRUpdateActiveSystemEndpointRequestProtobuf isEqual:](request, "isEqual:");
    }
    else {
      char v6 = 1;
    }
...
- (unint64_t)hash
{
  return [(_MRUpdateActiveSystemEndpointRequestProtobuf *)self->_request hash];
}
