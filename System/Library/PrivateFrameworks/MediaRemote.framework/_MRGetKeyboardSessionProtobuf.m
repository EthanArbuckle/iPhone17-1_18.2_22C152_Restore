...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)_MRGetKeyboardSessionProtobuf;
  v4 = [(_MRGetKeyboardSessionProtobuf *)&v8 description];
  v5 = [(_MRGetKeyboardSessionProtobuf *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return _MRGetKeyboardSessionProtobufReadFrom((uint64_t)self, (uint64_t)a3);
}
