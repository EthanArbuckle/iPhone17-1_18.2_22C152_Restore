...
@implementation _MRUpdatePlayerMessageProtobuf
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    -[_MRUpdatePlayerMessageProtobuf setPlayerPath:](self, "setPlayerPath:");
  }
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)_MRUpdatePlayerMessageProtobuf;
  v4 = [(_MRUpdatePlayerMessageProtobuf *)&v8 description];
  v5 = [(_MRUpdatePlayerMessageProtobuf *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return _MRUpdatePlayerMessageProtobufReadFrom((uint64_t)self, (uint64_t)a3);
}
