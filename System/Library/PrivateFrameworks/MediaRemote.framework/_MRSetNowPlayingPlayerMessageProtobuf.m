...
@implementation _MRSetNowPlayingPlayerMessageProtobuf
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)_MRSetNowPlayingPlayerMessageProtobuf;
  v4 = [(_MRSetNowPlayingPlayerMessageProtobuf *)&v8 description];
  v5 = [(_MRSetNowPlayingPlayerMessageProtobuf *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return _MRSetNowPlayingPlayerMessageProtobufReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    -[_MRSetNowPlayingPlayerMessageProtobuf setPlayerPath:](self, "setPlayerPath:");
  }
