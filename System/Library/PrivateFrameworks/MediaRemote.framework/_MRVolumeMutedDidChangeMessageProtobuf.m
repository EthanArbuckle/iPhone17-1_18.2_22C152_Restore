...
@implementation _MRVolumeMutedDidChangeMessageProtobuf
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)_MRVolumeMutedDidChangeMessageProtobuf;
  v4 = [(_MRVolumeMutedDidChangeMessageProtobuf *)&v8 description];
  v5 = [(_MRVolumeMutedDidChangeMessageProtobuf *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return _MRVolumeMutedDidChangeMessageProtobufReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    *(unsigned char *)(v5 + 16) = self->_isMuted;
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    char v5 = v4;
    -[_MRVolumeMutedDidChangeMessageProtobuf setOutputDeviceUID:](self, "setOutputDeviceUID:");
    id v4 = v5;
  }
}
