...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)_MRSetReadyStateMessageProtobuf;
  v4 = [(_MRSetReadyStateMessageProtobuf *)&v8 description];
  v5 = [(_MRSetReadyStateMessageProtobuf *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return _MRSetReadyStateMessageProtobufReadFrom((uint64_t)self, (uint64_t)a3);
}
