@interface MRServiceHandleVideoThumbnailsRequest
@end

@implementation MRServiceHandleVideoThumbnailsRequest

void ___MRServiceHandleVideoThumbnailsRequest_block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  if (v6)
  {
    ...
    if (reply)
    {
      MRAddVideoThumbnailsToXPCMessage(reply, a2);
