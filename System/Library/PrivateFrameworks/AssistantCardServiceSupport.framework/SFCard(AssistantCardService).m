...
- (void)acs_setInteraction:()AssistantCardService
{
  ...
  if (v4)
  {
    ...
    id v8 = objc_alloc_init(MEMORY[0x263F67978]);
  ...
  if (v13)
  {
    ...
    id v17 = objc_alloc_init(MEMORY[0x263F67978]);
...
- (id)acs_interaction
{
  ...
  id v8 = (void *)[objc_alloc(MEMORY[0x263F0FBD8]) initWithIntent:v4 response:v7];
  return v8;
}
