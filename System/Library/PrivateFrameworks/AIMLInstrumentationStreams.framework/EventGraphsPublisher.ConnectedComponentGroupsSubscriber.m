...
- (int64_t)receiveInput:(id)a3
{
  ...
  int64_t v5 = sub_22A7ABFE8((uint64_t)v7);
...
- (void).cxx_destruct
{
  sub_22A757A2C((uint64_t)self+ OBJC_IVAR____TtCC26AIMLInstrumentationStreams20EventGraphsPublisher34ConnectedComponentGroupsSubscriber_tracker, (uint64_t *)&unk_26838BC90);
  swift_unknownObjectRelease();
  swift_release();
  swift_release();
  swift_release();
