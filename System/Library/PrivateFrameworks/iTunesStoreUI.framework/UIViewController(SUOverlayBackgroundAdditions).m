...
- (uint64_t)dismissOverlayBackgroundViewController
{
  v1 = (__objc2_class *)[a1 parentViewController];
  if (!v1) {
    v1 = SUClientDispatch;
  }
...
- (uint64_t)presentOverlayBackgroundViewController:()SUOverlayBackgroundAdditions
{
  v4 = (__objc2_class *)[a1 parentViewController];
  if (!v4) {
    v4 = SUClientDispatch;
  }
...
- (BOOL)presentOverlayViewController:()SUOverlayBackgroundAdditions withTransition:
{
  v7 = (SUOverlayBackgroundViewController *)[a1 overlayBackgroundViewController];
  if (!v7)
  {
...
- (uint64_t)presentViewController:()SUOverlayBackgroundAdditions inOverlayWithConfiguration:
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0) {
    v7 = (void *)[a3 navigationController];
  }
  ...
  uint64_t v10 = [a1 presentOverlayViewController:v8 withTransition:v9];
