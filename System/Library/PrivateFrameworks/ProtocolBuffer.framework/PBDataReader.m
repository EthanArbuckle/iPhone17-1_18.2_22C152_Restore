...
- (id)readProtoBuffer
{
  unsigned int v3 = [(PBDataReader *)self readBigEndianFixed32];
...
- (id)readBytes:(unsigned int)a3
{
  ...
  else
  {
    ...
    {
      uint64_t v6 = a3;
      unsigned int v3 = -[NSData subdataWithRange:](self->_data, "subdataWithRange:", pos, a3);
      self->_pos += v6;
    }
  }
  return v3;
...
- (PBDataReader)initWithData:(id)a3
{
  ...
  uint64_t v6 = [(PBDataReader *)&v9 init];
  v7 = v6;
  if (v6)
  {
    ...
    v7->_unint64_t pos = 0;
    v7->_error = 0;
    v7->_unint64_t length = [(NSData *)v7->_data length];
...
- (BOOL)hasMoreData
{
  return ![(PBDataReader *)self isAtEnd];
}
...
- (id)readBigEndianShortThenString
{
  unsigned int v3 = [(PBDataReader *)self readBigEndianFixed16];
  if (self->_error)
  {
    char v4 = 0;
  }
  else
  {
    ...
    {
      uint64_t v8 = v3;
      char v9 = [(NSData *)self->_data bytes] + self->_pos;
      char v4 = (void *)[[NSString alloc] initWithBytes:v9 length:v8 encoding:4];
      self->_pos += v8;
    }
  }
  return v4;
...
- (void)updateData:(id)a3
{
  ...
  self->_unint64_t length = [(NSData *)self->_data length];
}
