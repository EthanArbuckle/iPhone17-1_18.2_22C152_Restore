...
+ (BOOL)IMMMSGroupTextOnlyMessagesSendAsMMSForPhoneNumber:(id)a3 simID:(id)a4
{
  ...
  char v8 = [v7 mmsGroupTextOnlyMessagesSendAsMMSForPhoneNumber:v6 simID:v5];
...
+ (id)IMUniqueIdentifierForPhoneNumber:(id)a3 simID:(id)a4
{
  ...
  id v6 = a3;
  v7 = +[IMCTSMSUtilitiesManager sharedManager];
  char v8 = [v7 uniqueIdentifierForPhoneNumber:v6 simID:v5];
...
+ (BOOL)IMReadMMSUserOverrideForPhoneNumber:(id)a3 simID:(id)a4
{
  ...
  id v6 = a3;
  v7 = +[IMCTSMSUtilitiesManager sharedManager];
  char v8 = [v7 readMMSUserOverrideForPhoneNumber:v6 simID:v5];
...
+ (BOOL)IMMMSEnabledForPhoneNumber:(id)a3 simID:(id)a4
{
  ...
  id v6 = a3;
  v7 = +[IMCTSMSUtilitiesManager sharedManager];
  char v8 = [v7 mmsEnabledForPhoneNumber:v6 simID:v5];
...
+ (BOOL)IMReadEnablePreviewTranscodingQualityCarrierValueForPhoneNumber:(id)a3 simID:(id)a4
{
  ...
  id v6 = a3;
  v7 = +[IMCTSMSUtilitiesManager sharedManager];
  char v8 = [v7 readEnablePreviewTranscodingQualityCarrierValueForPhoneNumber:v6 simID:v5];
...
+ (BOOL)IMReadDisablePreviewTranscodingQualityOnWiFiCarrierValueForPhoneNumber:(id)a3 simID:(id)a4
{
  ...
  id v6 = a3;
  v7 = +[IMCTSMSUtilitiesManager sharedManager];
  char v8 = [v7 readDisablePreviewTranscodingQualityOnWiFiCarrierValueForPhoneNumber:v6 simID:v5];
...
+ (BOOL)IMReadDisablePreviewTranscodingQualityOnWRMCarrierValueForPhoneNumber:(id)a3 simID:(id)a4
{
  ...
  id v6 = a3;
  v7 = +[IMCTSMSUtilitiesManager sharedManager];
  char v8 = [v7 readDisablePreviewTranscodingQualityOnWRMCarrierValueForPhoneNumber:v6 simID:v5];
...
+ (BOOL)IMMMSSupportedAndConfiguredForPhoneNumber:(id)a3 simID:(id)a4
{
  ...
  id v6 = a3;
  v7 = +[IMCTSMSUtilitiesManager sharedManager];
  char v8 = [v7 mmsSupportedAndConfiguredForPhoneNumber:v6 simID:v5];
...
+ (unint64_t)IMReadAttachmentPreviewTranscodingQualitySizeCarrierValueForPhoneNumber:(id)a3 simID:(id)a4
{
  ...
  id v6 = a3;
  v7 = +[IMCTSMSUtilitiesManager sharedManager];
  unint64_t v8 = [v7 readAttachmentPreviewTranscodingQualitySizeCarrierValueForPhoneNumber:v6 simID:v5];
...
+ (int)IMMMSMaximumSlideCountForPhoneNumber:(id)a3 simID:(id)a4
{
  ...
  id v6 = a3;
  v7 = +[IMCTSMSUtilitiesManager sharedManager];
  int v8 = [v7 mmsMaximumSlideCountForPhoneNumber:v6 simID:v5];
...
+ (int)IMMMSMaximumMessageByteCountForPhoneNumber:(id)a3 simID:(id)a4
{
  ...
  id v6 = a3;
  v7 = +[IMCTSMSUtilitiesManager sharedManager];
  int v8 = [v7 mmsMaximumMessageByteCountForPhoneNumber:v6 simID:v5];
...
+ (BOOL)IMMMSGroupTextReplicationSupportedForPhoneNumber:(id)a3 simID:(id)a4
{
  ...
  id v6 = a3;
  v7 = +[IMCTSMSUtilitiesManager sharedManager];
  char v8 = [v7 mmsGroupTextReplicationSupportedForPhoneNumber:v6 simID:v5];
...
+ (BOOL)IMMMSGroupTextReplicationSupportsSMILContentLocationForPhoneNumber:(id)a3 simID:(id)a4
{
  ...
  id v6 = a3;
  v7 = +[IMCTSMSUtilitiesManager sharedManager];
  char v8 = [v7 mmsGroupTextReplicationSupportsSMILContentLocationForPhoneNumber:v6 simID:v5];
...
+ (int)IMMMSMaxRecipientsForPhoneNumber:(id)a3 simID:(id)a4
{
  ...
  id v6 = a3;
  v7 = +[IMCTSMSUtilitiesManager sharedManager];
  int v8 = [v7 mmsMaxRecipientsForPhoneNumber:v6 simID:v5];
...
+ (int)IMMMSMaxImageDimensionForPhoneNumber:(id)a3 simID:(id)a4
{
  ...
  id v6 = a3;
  v7 = +[IMCTSMSUtilitiesManager sharedManager];
  int v8 = [v7 mmsMaxImageDimensionForPhoneNumber:v6 simID:v5];
...
+ (BOOL)IMMMSSupportsH264VideoForPhoneNumber:(id)a3 simID:(id)a4
{
  ...
  id v6 = a3;
  v7 = +[IMCTSMSUtilitiesManager sharedManager];
  char v8 = [v7 mmsSupportsH264VideoForPhoneNumber:v6 simID:v5];
...
+ (void)IMiMessageMaxTransferFileSizeForWifiForPhoneNumber:(unint64_t *)a3 cellSize:(unint64_t *)a4 serverConfigurationBag:(id)a5 phoneNumber:(id)a6 simID:(id)a7
{
  ...
  id v12 = a6;
  id v13 = a5;
  id v14 = +[IMCTSMSUtilitiesManager sharedManager];
...
+ (unint64_t)IMiMessageMaxTransferAudioFileSizeForWifiForPhoneNumber:(unint64_t *)a3 cellSize:(unint64_t *)a4 serverConfigurationBag:(id)a5 phoneNumber:(id)a6 simID:(id)a7
{
  ...
  id v13 = a5;
  id v14 = +[IMCTSMSUtilitiesManager sharedManager];
  unint64_t v15 = [v14 iMessageMaxTransferAudioFileSizeForWifiForPhoneNumber:a3 cellSize:a4 serverConfigurationBag:v13 phoneNumber:v12 simID:v11];
...
+ (unint64_t)IMiMessageMaxTransferVideoFileSizeForWifiForPhoneNumber:(unint64_t *)a3 cellSize:(unint64_t *)a4 serverConfigurationBag:(id)a5 phoneNumber:(id)a6 simID:(id)a7
{
  ...
  id v13 = a5;
  id v14 = +[IMCTSMSUtilitiesManager sharedManager];
  unint64_t v15 = [v14 iMessageMaxTransferVideoFileSizeForWifiForPhoneNumber:a3 cellSize:a4 serverConfigurationBag:v13 phoneNumber:v12 simID:v11];
...
+ (id)IMMMSEmailAddressToMatchForPhoneNumber:(id)a3 simID:(id)a4
{
  ...
  id v6 = a3;
  v7 = +[IMCTSMSUtilitiesManager sharedManager];
  double v8 = [v7 mmsEmailAddressToMatchForPhoneNumber:v6 simID:v5];
...
+ (BOOL)IMShouldShowMMSEmailAddress:(id)a3 simID:(id)a4
{
  ...
  id v6 = a3;
  v7 = +[IMCTSMSUtilitiesManager sharedManager];
  char v8 = [v7 shouldShowMMSEmailAddress:v6 simID:v5];
...
+ (BOOL)IMIsEagerUploadEnabledForPhoneNumber:(id)a3 simID:(id)a4
{
  ...
  id v6 = a3;
  v7 = +[IMCTSMSUtilitiesManager sharedManager];
  char v8 = [v7 isEagerUploadEnabledForPhoneNumber:v6 simID:v5];
...
+ (BOOL)IMMMSEagerUploadDisabledInCarrierBundleForPhoneNumber:(id)a3 simID:(id)a4
{
  ...
  id v6 = a3;
  v7 = +[IMCTSMSUtilitiesManager sharedManager];
  char v8 = [v7 mmsEagerUploadDisabledInCarrierBundleForPhoneNumber:v6 simID:v5];
...
+ (BOOL)IMMMSRestrictedModeEnabledForPhoneNumber:(id)a3 simID:(id)a4
{
  ...
  id v6 = a3;
  v7 = +[IMCTSMSUtilitiesManager sharedManager];
  char v8 = [v7 mmsRestrictedModeEnabledForPhoneNumber:v6 simID:v5];
...
{
  BOOL v3 = a3;
  id v4 = +[IMCTSMSUtilitiesManager sharedManager];
  [v4 synchronizeMMSCapabilityToWatch:v3];
}

+ (void)IMSynchronizePreferredSubscriptionMMSCapabilityToWatch
{
  id v2 = +[IMCTSMSUtilitiesManager sharedManager];
...
{
  id v4 = +[IMCTSMSUtilitiesManager sharedManager];
  id v5 = [v4 countryCodeForSimSlot:a3];
...
+ (id)IMCountryCodeForPhoneNumber:(id)a3 simID:(id)a4
{
  ...
  id v6 = a3;
  v7 = +[IMCTSMSUtilitiesManager sharedManager];
  char v8 = [v7 countryCodeForPhoneNumber:v6 simID:v5];
...
{
  id v2 = +[IMCTSMSUtilitiesManager sharedManager];
  char v3 = [v2 messagesFilteringSettingForPreferedSubscription];
...
+ (id)carrierBundleValueForKeyHierarchy:(id)a3 phoneNumber:(id)a4 simID:(id)a5
{
  ...
  id v11 = [v10 carrierBundleValueForKeyHierarchy:v9 phoneNumber:v8 simID:v7];
...
+ (id)carrierNameForPhoneNumber:(id)a3
{
  id v3 = a3;
  id v4 = +[IMCTSMSUtilitiesManager sharedManager];
  id v5 = [v4 carrierNameForPhoneNumber:v3];
...
+ (BOOL)SMSAllowCaseSensitiveSenderIDForPhoneNumber:(id)a3
{
  id v3 = a3;
  id v4 = +[IMCTSMSUtilitiesManager sharedManager];
  char v5 = [v4 smsAllowCaseSensitiveSenderIDForPhoneNumber:v3];
...
+ (BOOL)shouldUploadToMMCS:(id)a3
{
  id v3 = a3;
  id v4 = +[IMCTSMSUtilitiesManager sharedManager];
  char v5 = [v4 shouldUploadToMMCS:v3];
