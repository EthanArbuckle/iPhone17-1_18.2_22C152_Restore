...
- (void)encodeWithCoder:(id)a3
{
  ...
  v5 = [(IMTranscriptSharingItem *)self otherCountryCode];
...
- (BOOL)isEqual:(id)a3
{
  id v4 = (IMTranscriptSharingItem *)a3;
  if (v4 == self)
  {
...
LABEL_23:
      ...
      if (otherCountryCode != v7)
      {
        ...
        objc_super v9 = [(IMTranscriptSharingItem *)v5 otherCountryCode];
      ...
      uint64_t v16 = [(IMTranscriptSharingItem *)v5 otherUnformattedID];
