...
- (int64_t)groupActionType;
- (unint64_t)hash;
- (unsigned)version;
- (void)copyTo:(id)a3;
- (void)dealloc;
- (void)mergeFrom:(id)a3;
- (void)setGroupActionType:(int64_t)a3;
- (void)setHasGroupActionType:(BOOL)a3;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)IMSharedUtilitiesProtoCloudKitEncryptedGroupAction;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = (Class)IMSharedUtilitiesProtoCloudKitEncryptedGroupAction;
  return (id)[NSString stringWithFormat:@"%@ %@", -[IMSharedUtilitiesProtoCloudKitEncryptedGroupAction description](&v3, sel_description), -[IMSharedUtilitiesProtoCloudKitEncryptedGroupAction dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (id)dictionaryRepresentation
{
  ...
  if (has) {
    objc_msgSend(v3, "setObject:forKey:", objc_msgSend(NSNumber, "numberWithLongLong:", self->_groupActionType), @"group_action_type");
  }
...
- (BOOL)readFrom:(id)a3
{
  return IMSharedUtilitiesProtoCloudKitEncryptedGroupActionReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if (has)
  {
    *((void *)a3 + 1) = self->_groupActionType;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (has)
  {
    *(void *)(v5 + 8) = self->_groupActionType;
...
LABEL_16:
    ...
    {
      if ((*((unsigned char *)a3 + 36) & 1) == 0 || self->_groupActionType != *((void *)a3 + 1)) {
        goto LABEL_16;
      }
    }
...
LABEL_3:
  uint64_t v4 = 2654435761 * self->_groupActionType;
LABEL_6:
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v5)
  {
    self->_groupActionType = *((void *)a3 + 1);
    *(unsigned char *)&self->_has |= 1u;
  }
  if (*((void *)a3 + 2)) {
    -[IMSharedUtilitiesProtoCloudKitEncryptedGroupAction setOtherHandle:](self, "setOtherHandle:");
  }
  if (*((void *)a3 + 3))
  {
    -[IMSharedUtilitiesProtoCloudKitEncryptedGroupAction setPadding:](self, "setPadding:");
  }
}
