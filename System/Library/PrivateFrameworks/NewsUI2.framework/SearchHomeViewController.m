...
- (_TtC7NewsUI224SearchHomeViewController)initWithCoder:(id)a3
{
  *(void *)((char *)&self->super.super.super._responderFlags
  ...
  result = (_TtC7NewsUI224SearchHomeViewController *)sub_1DFDFFBB0();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  sub_1DEB1DDEC((uint64_t)self + OBJC_IVAR____TtC7NewsUI224SearchHomeViewController_delegate);
...
- (void)viewWillLayoutSubviews
{
  ...
  id v3 = objc_msgSend(*(id *)&v2[OBJC_IVAR____TtC7NewsUI224SearchHomeViewController_blueprintViewController], sel_view, v15.receiver, v15.super_class);
  if (v3)
  {
    id v4 = v3;
