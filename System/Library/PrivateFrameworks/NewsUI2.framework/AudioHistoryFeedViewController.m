...
- (_TtC7NewsUI230AudioHistoryFeedViewController)initWithCoder:(id)a3
{
  result = (_TtC7NewsUI230AudioHistoryFeedViewController *)sub_1DFDFFBB0();
  __break(1u);
  return result;
}
...
{
  id v4 = a4;
  result = (_TtC7NewsUI230AudioHistoryFeedViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  __swift_destroy_boxed_opaque_existential_1((uint64_t)self + OBJC_IVAR____TtC7NewsUI230AudioHistoryFeedViewController_styler);
  swift_unknownObjectRelease();
  v3 = *(Class *)((char *)&self->super.super.super.isa
                + OBJC_IVAR____TtC7NewsUI230AudioHistoryFeedViewController_blueprintViewController);
}
...
- (void)viewWillLayoutSubviews
{
  ...
  id v3 = objc_msgSend(*(id *)&v2[OBJC_IVAR____TtC7NewsUI230AudioHistoryFeedViewController_blueprintViewController], sel_view, v15.receiver, v15.super_class);
  if (v3)
  {
    id v4 = v3;
