...
- (void)encodeWithCoder:(id)a3
{
  ...
  id v6 = [(SIRINLUUserWantedToProceed *)self reference];
...
- (SIRINLUUserWantedToProceed)initWithCoder:(id)a3
{
  id v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)SIRINLUUserWantedToProceed;
...
- (SIRINLUUserWantedToProceed)initWithTaskId:(id)a3 reference:(id)a4
{
  ...
  id v8 = a4;
  v12.receiver = self;
  v12.super_class = (Class)SIRINLUUserWantedToProceed;
...
- (SIRINLUUserWantedToProceed)initWithReference:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)SIRINLUUserWantedToProceed;
  uint64_t v6 = [(SIRINLUUserWantedToProceed *)&v9 init];
  id v7 = v6;
  if (v6) {
