...
LABEL_15:
      v10 = [v6 localizedStringForKey:v5 value:&stru_1F4097960 table:v8];
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v16 = 2112;
    v17 = v10;
    _os_log_impl(&dword_1E4BFE000, v11, OS_LOG_TYPE_DEFAULT, "HPSProductUtils: getProductSpecificString called with pid %d and descKey %@ value %@", (uint8_t *)v13, 0x1Cu);
  }
...
+ (BOOL)isAirPods:(id)a3
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      _os_log_impl(&dword_1E4BFE000, v7, OS_LOG_TYPE_DEFAULT, "HPSProductUtils: isAirPods:%i productID:%i", (uint8_t *)v16, 0xEu);
    }
  }
  else
  {
...
+ (void)getProductSpecificString:(os_log_t)log descriptionKey:.cold.1(uint64_t a1, int a2, os_log_t log)
{
  ...
  __int16 v4 = 2112;
  uint64_t v5 = a1;
  _os_log_error_impl(&dword_1E4BFE000, log, OS_LOG_TYPE_ERROR, "HPSProductUtils: getProductSpecificString called with invalid pid %d and (or) descKey %@", (uint8_t *)v3, 0x12u);
}
