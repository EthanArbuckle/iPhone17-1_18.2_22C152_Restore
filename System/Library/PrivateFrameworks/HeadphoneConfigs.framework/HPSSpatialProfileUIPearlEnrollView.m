...
- (id)crossHairs
{
  ...
  if (!enrollmentCustomCrossHairs)
  {
    ...
    v5 = -[HPSSpatialProfileCrossHairs initWithView:view:](v4, "initWithView:view:", self, *MEMORY[0x1E4F1DB28], *(double *)(MEMORY[0x1E4F1DB28] + 8), *(double *)(MEMORY[0x1E4F1DB28] + 16), *(double *)(MEMORY[0x1E4F1DB28] + 24));
...
- (void)setCameraBlurAmount:(double)a3 useShade:(BOOL)a4 duration:(double)a5 completion:(id)a6
{
  ...
  {
    *(_DWORD *)buf = 67109888;
    BOOL v15 = [(HPSSpatialProfileUIPearlEnrollView *)self pauseBlur];
    __int16 v16 = 1024;
    BOOL v17 = [(HPSSpatialProfileUIPearlEnrollView *)self forceBlur];
    __int16 v18 = 2048;
    double v19 = a3;
    __int16 v20 = 2048;
    double v21 = a5;
  ...
  if (a3 == 0.0 && [(HPSSpatialProfileUIPearlEnrollView *)self forceBlur])
  {
    LODWORD(v7) = 0;
    a3 = 15.0;
  }
  ...
  BOOL v12 = [(HPSSpatialProfileUIPearlEnrollView *)self pauseBlur];
  uint64_t v7 = v7 & !v12;
  if (v12) {
    a3 = 0.0;
  }
