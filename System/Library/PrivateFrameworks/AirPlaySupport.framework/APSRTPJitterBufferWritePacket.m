...
uint64_t ___APSRTPJitterBufferWritePacket_block_invoke()
{
...
uint64_t ___APSRTPJitterBufferWritePacket_block_invoke_2()
{
  if (gLogCategory_APSRTPJitterBuffer <= 30)
  {
    if (gLogCategory_APSRTPJitterBuffer != -1) {
...
uint64_t ___APSRTPJitterBufferWritePacket_block_invoke_3()
{
  if (gLogCategory_APSRTPJitterBuffer <= 30)
  {
    if (gLogCategory_APSRTPJitterBuffer != -1) {
