...
{
  id v4 = a3;
  id v5 = (void *)[objc_alloc((Class)a1) initWithController:v4];
...
+ (_ANEProgramIOSurfacesMapper)mapperWithProgramHandle:(unint64_t)a3
{
  id v4 = +[_ANEDeviceController controllerWithProgramHandle:a3];
  id v5 = (void *)[objc_alloc((Class)a1) initWithController:v4];
...
- (BOOL)validateRequest:(id)a3 model:(id)a4
{
  ...
  if ([v6 validate])
  {
    ...
    uint64_t v10 = [v6 ioSurfacesCount];
    if ((unint64_t)(v10 - 129) <= 0xFFFFFFFFFFFFFF7FLL)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        [(_ANEProgramIOSurfacesMapper *)v12 validateRequest:v10 model:v11];
      }
    }
    ...
    if (v15)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138412802;
        ...
        _os_log_error_impl(&dword_1DB8AB000, v20, OS_LOG_TYPE_ERROR, "%@: request.inputIndexArray[%u]=%u is invalid", buf, 0x18u);
      }
      BOOL v27 = 0;
    }
    else
      ...
      if (v22)
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138412802;
          ...
          _os_log_error_impl(&dword_1DB8AB000, v28, OS_LOG_TYPE_ERROR, "%@: request.outputIndexArray[%u]=%u is invalid", buf, 0x18u);
        }
        BOOL v27 = 0;
      }
      else
...
- (void)prepareANEMemoryMappingParams:(ANEMemoryMappingParamsStruct *)a3 request:(id)a4
{
  ...
  unint64_t v15 = [v27 outputIndexArray];
  ...
  if (v16)
  {
    ...
    do
    {
      ...
      unint64_t v22 = [v15 objectAtIndexedSubscript:v17];
...
- (BOOL)mapIOSurfacesWithModel:(id)a3 request:(id)a4 cacheInference:(BOOL)a5 error:(id *)a6
{
  ...
  if (v13)
  {
    ...
    {
      unint64_t v15 = NSStringFromSelector(a2);
      *(_DWORD *)buf = 138412290;
      v41 = v15;
      _os_log_impl(&dword_1DB8AB000, v14, OS_LOG_TYPE_INFO, "%@: No support for VirtualClient yet.", buf, 0xCu);
    }
    goto LABEL_5;
  }
  if (+[_ANEDeviceInfo isVirtualMachine])
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      -[_ANEProgramIOSurfacesMapper mapIOSurfacesWithModel:request:cacheInference:error:](v17, buf, v16);
    }
...
LABEL_5:
  ...
  else
  {
    ...
    __int16 v37 = __Block_byref_object_copy__1;
    unsigned int v38 = __Block_byref_object_dispose__1;
    id v39 = 0;
    uint64_t v30 = 0;
    v31 = &v30;
    uint64_t v32 = 0x2020000000;
    char v33 = 0;
    unsigned int v19 = (void *)MEMORY[0x1E0193890]();
    BOOL v20 = [(_ANEProgramIOSurfacesMapper *)self validateRequest:v12 model:v11];
    if (v20)
    {
      [(_ANEProgramIOSurfacesMapper *)self prepareANEMemoryMappingParams:buf request:v12];
      unint64_t v21 = gANEMemoryMapperQueue;
      block[0] = MEMORY[0x1E4F143A8];
      block[1] = 3221225472;
      block[2] = __83___ANEProgramIOSurfacesMapper_mapIOSurfacesWithModel_request_cacheInference_error___block_invoke;
      block[3] = &unk_1E6C1C218;
      BOOL v29 = a5;
      id v27 = buf;
      SEL v28 = a2;
      block[4] = self;
...
- (BOOL)unmapIOSurfacesWithModel:(id)a3 request:(id)a4 error:(id *)a5
{
  ...
  if (v11)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138412290;
      char v33 = v13;
      _os_log_impl(&dword_1DB8AB000, v12, OS_LOG_TYPE_INFO, "%@: No support for VirtualClient yet.", buf, 0xCu);
    }
    goto LABEL_5;
  }
  if (+[_ANEDeviceInfo isVirtualMachine])
  {
    ...
    {
      unint64_t v15 = NSStringFromSelector(a2);
      -[_ANEProgramIOSurfacesMapper mapIOSurfacesWithModel:request:cacheInference:error:](v15, buf, v14);
    }
...
LABEL_5:
  ...
  else
  {
    ...
    BOOL v29 = __Block_byref_object_copy__1;
...
- (void)validateRequest:(uint64_t)a3 model:(os_log_t)log .cold.1(void *a1, uint8_t *buf, uint64_t a3, os_log_t log)
{
  ...
  *((_WORD *)buf + 11) = 1024;
  *((_DWORD *)buf + 6) = 128;
  _os_log_error_impl(&dword_1DB8AB000, log, OS_LOG_TYPE_ERROR, "%@: [request ioSurfacesCount]=%lu is invalid. Expected: (1 - %d)", buf, 0x1Cu);
}
...
- (void)mapIOSurfacesWithModel:(os_log_t)log request:cacheInference:error:.cold.1(void *a1, uint8_t *buf, os_log_t log)
{
  *(_DWORD *)buf = 138412290;
  *(void *)(buf + 4) = a1;
  _os_log_error_impl(&dword_1DB8AB000, log, OS_LOG_TYPE_ERROR, "%@: Virtual Machine environment detected but no virtualClient available.", buf, 0xCu);
}
