...
- (id)description
{
  ...
  unint64_t v6 = [(_ANEPerformanceStats *)self hwExecutionTime];
...
- (_ANEPerformanceStats)initWithRequestPerformanceBuffer:(void *)a3 statsBufferSize:(unsigned int *)a4
{
  ...
  if (!a3 || !a4)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      _os_log_error_impl(&dword_1DB8AB000, v10, OS_LOG_TYPE_ERROR, "%@: Invalid argument. requestPerfStatsBuffer=%p : requestStatsBufferSize=%p", buf, 0x20u);
    }
    v11 = 0;
    goto LABEL_24;
  }
  ...
  if (*a4 >= 0x10)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138412802;
      ...
      _os_log_impl(&dword_1DB8AB000, v12, OS_LOG_TYPE_INFO, "%@: HW Execution time: %llu ns (%.2f ms)", buf, 0x20u);
    }
  }
  else
  {
  ...
  if (a4[2] >= 0xE0)
  {
    id v10 = [MEMORY[0x1E4F1C9B8] dataWithBytes:(char *)a3[2] + 8 length:216];
    v16 = +[_ANELog common];
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
    {
      v17 = NSStringFromSelector(a2);
      -[_ANEPerformanceStats initWithRequestPerformanceBuffer:statsBufferSize:](v17, buf, v16);
    }
...
LABEL_20:
    v15 = [MEMORY[0x1E4F1C9B8] dataWithBytes:a3[1] length:v14];
    v18 = +[_ANELog common];
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
    {
      v19 = NSStringFromSelector(a2);
      -[_ANEPerformanceStats initWithRequestPerformanceBuffer:statsBufferSize:](v19, v22, v18);
    }
...
+ (_ANEPerformanceStats)statsWithRequestPerformanceBuffer:(void *)a3 statsBufferSize:(unsigned int *)a4
{
  v4 = (void *)[objc_alloc((Class)a1) initWithRequestPerformanceBuffer:a3 statsBufferSize:a4];
  return (_ANEPerformanceStats *)v4;
}

+ (_ANEPerformanceStats)statsWithHardwareExecutionNS:(unint64_t)a3
{
  v3 = (void *)[objc_alloc((Class)a1) initWithHardwareExecution:a3 perfCounterData:0 ANEStatsRawData:0];
  return (_ANEPerformanceStats *)v3;
}

+ (_ANEPerformanceStats)statsWithReconstructed:(id)a3 hardwareExecutionNS:(unint64_t)a4
{
  id v6 = a3;
  v7 = (void *)[objc_alloc((Class)a1) initWithReconstructedData:v6 hardwareExecutionNS:a4];
  ...
  if (v3)
  {
    ...
    if (v8 >= 8)
    {
      ...
      do
      {
        ...
        v12 = [NSNumber numberWithUnsignedLongLong:*(void *)(v5 + 8 * v9)];
...
- (void)initWithRequestPerformanceBuffer:(os_log_t)log statsBufferSize:.cold.1(void *a1, uint8_t *buf, os_log_t log)
{
  ...
  *(void *)(buf + 4) = a1;
  _os_log_debug_impl(&dword_1DB8AB000, log, OS_LOG_TYPE_DEBUG, "%@: Write ane stats raw data", buf, 0xCu);
}
...
- (void)initWithRequestPerformanceBuffer:(os_log_t)log statsBufferSize:.cold.2(void *a1, uint8_t *buf, os_log_t log)
{
  *(_DWORD *)buf = 138412290;
  *(void *)(buf + 4) = a1;
  _os_log_debug_impl(&dword_1DB8AB000, log, OS_LOG_TYPE_DEBUG, "%@: Write perf counters", buf, 0xCu);
}
