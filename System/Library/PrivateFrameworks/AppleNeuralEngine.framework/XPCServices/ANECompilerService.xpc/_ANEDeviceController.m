...
+ (void)initialize
{
  if (qword_100057D98 != -1) {
    dispatch_once(&qword_100057D98, &stru_10004C9E8);
  }
}
...
+ (id)sharedPrivilegedConnection
{
  if (qword_100057DA0 != -1) {
    dispatch_once(&qword_100057DA0, &stru_10004CA08);
  }
  v2 = (void *)qword_100057DA8;
  return v2;
}
...
- (void)start
{
  ...
  v2[4] = self;
  v2[5] = a2;
  dispatch_sync((dispatch_queue_t)qword_100057D90, v2);
}
