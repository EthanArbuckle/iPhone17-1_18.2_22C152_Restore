...
{
  id v5 = a4;
  v6 = +[_ANEStrings compilerServiceAccessEntitlement];
  v7 = [v5 valueForEntitlement:v6];
  v8 = v7;
  if (v7 && ([v7 BOOLValue] & 1) != 0)
  {
    v9 = +[NSXPCInterface interfaceWithProtocol:&OBJC_PROTOCOL____ANECompilerServiceProtocol];
