...
+ (id)buildSpecificModelDataVaultDirectory
{
  ...
  block[1] = 3221225472;
  block[2] = sub_10001E4EC;
  block[3] = &unk_10004CE70;
  block[4] = a1;
  if (qword_100057E98 != -1) {
    dispatch_once(&qword_100057E98, block);
  }
  v2 = (void *)qword_100057EA0;
  return v2;
}
...
+ (id)buildSpecificUserModelDataVaultDirectory
{
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_10001E60C;
  block[3] = &unk_10004CE70;
  block[4] = a1;
  if (qword_100057EA8 != -1) {
    dispatch_once(&qword_100057EA8, block);
  }
  v2 = (void *)qword_100057EB0;
  return v2;
}
...
+ (id)tempDirectory
{
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_10001E744;
  block[3] = &unk_10004CE70;
  block[4] = a1;
  if (qword_100057EB8 != -1) {
    dispatch_once(&qword_100057EB8, block);
  }
  v2 = (void *)qword_100057EC0;
  return v2;
}
...
+ (id)cloneDirectory
{
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_10001E844;
  block[3] = &unk_10004CE70;
  block[4] = a1;
  if (qword_100057EC8 != -1) {
    dispatch_once(&qword_100057EC8, block);
  }
  v2 = (void *)qword_100057ED0;
  return v2;
}
...
+ (id)userTempDirectory
{
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_10001E944;
  block[3] = &unk_10004CE70;
  block[4] = a1;
  if (qword_100057ED8 != -1) {
    dispatch_once(&qword_100057ED8, block);
  }
...
+ (id)userCloneDirectory
{
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_10001EA44;
  block[3] = &unk_10004CE70;
  block[4] = a1;
  if (qword_100057EE8 != -1) {
    dispatch_once(&qword_100057EE8, block);
  }
  v2 = (void *)qword_100057EF0;
  return v2;
}
...
+ (id)testing_zeroModelName
{
  if (qword_100057F00 != -1) {
    dispatch_once(&qword_100057F00, &stru_10004CE90);
  }
  v2 = (void *)qword_100057EF8;
  return v2;
}

+ (id)testing_ThreeSixtyModelName
{
  if (qword_100057F10 != -1) {
    dispatch_once(&qword_100057F10, &stru_10004CEB0);
  }
  v2 = (void *)qword_100057F08;
  return v2;
}

+ (id)testing_modelNames
{
  if (qword_100057F20 != -1) {
    dispatch_once(&qword_100057F20, &stru_10004CED0);
  }
  v2 = (void *)qword_100057F18;
  return v2;
}

+ (id)testing_encryptedModelNames
{
  if (qword_100057F30 != -1) {
    dispatch_once(&qword_100057F30, &stru_10004CEF0);
  }
  v2 = (void *)qword_100057F28;
  return v2;
}
...
+ (id)testing_external_precompiledModelPath
{
  if (qword_100057F40 != -1) {
    dispatch_once(&qword_100057F40, &stru_10004CF10);
  }
  v2 = (void *)qword_100057F38;
  return v2;
}
