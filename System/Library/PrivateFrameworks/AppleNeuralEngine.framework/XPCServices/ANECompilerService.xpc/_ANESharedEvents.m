...
+ (id)new;
+ (id)sharedEventsWithSignalEvents:(id)a3 waitEvents:(id)a4;
...
+ (id)sharedEventsWithSignalEvents:(id)a3 waitEvents:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = [objc_alloc((Class)a1) initWithSignalEvents:v7 waitEvents:v6];
...
- (id)description
{
  ...
  v5 = [(_ANESharedEvents *)self signalEvents];
  id v6 = [(_ANESharedEvents *)self waitEvents];
  id v7 = +[NSString stringWithFormat:@"%@: { signalEvents=%@ : waitEvents=%@ } ", v4, v5, v6];
