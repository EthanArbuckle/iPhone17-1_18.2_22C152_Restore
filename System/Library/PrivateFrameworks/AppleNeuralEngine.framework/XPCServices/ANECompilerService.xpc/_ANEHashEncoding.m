...
+ (id)convertToHexString:(char *)a3 length:(unint64_t)a4
{
  for (id i = [&stru_10004D218 mutableCopy]; a4; --a4)
  {
    unsigned int v8 = *a3++;
...
+ (id)hexStringForString:(id)a3
{
  ...
  return [a1 hexStringForBytes:v5 length:v6];
}
...
+ (id)hexStringForDataArray:(id)a3
{
  ...
  long long v16 = 0u;
  id v5 = v4;
  id v6 = [v5 countByEnumeratingWithState:&v13 objects:v20 count:16];
  if (v6)
  {
    id v7 = v6;
    ...
    do
    {
      for (id i = 0; i != v7; id i = (char *)i + 1)
      {
        ...
        CC_SHA256_Update(&c, objc_msgSend(v10, "bytes", (void)v13), (CC_LONG)objc_msgSend(v10, "length"));
      }
      id v7 = [v5 countByEnumeratingWithState:&v13 objects:v20 count:16];
    }
    while (v7);
  }
...
+ (void)copySHA256For:(id)a3 toBuffer:(char *)a4
{
  ...
  if (v6)
  {
    CC_SHA256(v6, (CC_LONG)[v5 length], md);
    long long v7 = v9;
    *(_OWORD *)a4 = *(_OWORD *)md;
    *((_OWORD *)a4 + 1) = v7;
  }
