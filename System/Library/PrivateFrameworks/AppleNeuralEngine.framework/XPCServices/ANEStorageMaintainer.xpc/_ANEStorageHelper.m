...
+ (void)initialize
{
  if (qword_100042DC8 != -1) {
    dispatch_once(&qword_100042DC8, &stru_10003CCA8);
  }
}
...
+ (BOOL)removeDirectoryAtPath:(id)a3
{
  ...
  if ((v6 & 1) == 0)
  {
    v8 = (void *)qword_100042DD8;
    if (os_log_type_enabled((os_log_t)qword_100042DD8, OS_LOG_TYPE_INFO))
    {
      v9 = v8;
...
{
  id v8 = a3;
  v9 = (void *)qword_100042DD8;
  if (os_log_type_enabled((os_log_t)qword_100042DD8, OS_LOG_TYPE_DEBUG)) {
    sub_100027154(v9, a2);
  }
  id v10 = v8;
...
LABEL_22:
  ...
  if (v14)
  {
    ...
    *a5 = (id)ANECCreateModelDictionary();
    ...
    {
      id v17 = (id)qword_100042DD8;
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        char v18 = NSStringFromSelector(a2);
        sub_1000270EC(v18, (uint64_t)v10, buf, v17);
      }
    }
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_10001F1E4;
    block[3] = &unk_10003CCF0;
    block[4] = &v41;
    dispatch_async((dispatch_queue_t)qword_100042DD0, block);
    id v19 = v16;
  }
  else
  {
    v26 = (id)qword_100042DD8;
...
LABEL_12:
  ...
  else if (os_log_type_enabled((os_log_t)qword_100042DD8, OS_LOG_TYPE_ERROR))
  {
    uint64_t v8 = v7;
    id v9 = NSStringFromSelector(a2);
    int v12 = *__error();
...
+ (BOOL)updateAccessTimeForFilePath:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (v11 - v10 <= 86400.0)
    {
      dev_t v14 = (void *)qword_100042DD8;
      if (os_log_type_enabled((os_log_t)qword_100042DD8, OS_LOG_TYPE_DEBUG)) {
        sub_100027354(v14, a2);
      }
      goto LABEL_11;
    }
  }
...
LABEL_11:
  ...
  int v12 = (void *)qword_100042DD8;
  if (os_log_type_enabled((os_log_t)qword_100042DD8, OS_LOG_TYPE_ERROR)) {
    sub_1000272AC(v12, a2);
  }
  BOOL v13 = 0;
LABEL_12:
...
+ (void)removeFilePath:(id)a3 ifDate:(id)a4 olderThanSecond:(id)a5
{
  ...
  if (v10 == (id)-1 || !v11)
  {
    ...
    if ((v13 & 1) == 0)
    {
      int v15 = qword_100042DD8;
      if (os_log_type_enabled((os_log_t)qword_100042DD8, OS_LOG_TYPE_ERROR)) {
        sub_1000274A4((uint64_t)v7, (uint64_t)v14, v15);
      }
    }
  }
}
...
{
  id v4 = a3;
  v5 = &selRef_statsWithHardwareExecutionNS_;
  int v6 = (void *)qword_100042DD8;
  if (os_log_type_enabled((os_log_t)qword_100042DD8, OS_LOG_TYPE_INFO))
  {
    id v7 = v6;
...
{
  id v4 = a3;
  v71[0] = kANEDModelDirectorySizeKey[0];
  ...
  if (v10)
  {
    ...
    [v8 setObject:v13 forKeyedSubscript:kANEDModelDirectorySizeKey[0]];
    ...
    if (a4)
    {
      ...
      if (v17)
      {
        ...
        unsigned int v21 = &selRef_statsWithHardwareExecutionNS_;
        __int16 v22 = &selRef_statsWithHardwareExecutionNS_;
        if (v20)
        {
          id v23 = v20;
          unint64_t v55 = a4 - 1;
          ...
          do
          {
            for (i = 0; i != v23; i = (char *)i + 1)
            {
              ...
              int v28 = [v27 objectForKeyedSubscript:v21[397]];
              id v29 = (char *)[v28 unsignedIntegerValue];

              if (v29)
              {
                int v30 = [aSelectora objectForKeyedSubscript:v21[397]];
                v31 = v21;
                id v32 = [v30 unsignedIntegerValue];

                uint64_t v33 = +[NSNumber numberWithUnsignedInteger:&v29[(void)v32]];
                __int16 v22 = &selRef_statsWithHardwareExecutionNS_;
                [aSelectora setObject:v33 forKeyedSubscript:v31[397]];
        ...
        id v35 = [v50 copy];
        id v8 = aSelectora;
        [aSelectora setObject:v35 forKeyedSubscript:v22[398]];
...
+ (id)createModelCacheDictionary
{
  v5[0] = kANEDModelDirectorySizeKey[0];
...
+ (id)sizeOfModelCacheAtPath:(id)a3 purgeSubdirectories:(BOOL)a4
{
  ...
  if (v9)
  {
    ...
    [v7 setObject:v11 forKeyedSubscript:kANEDModelDirectorySizeKey[0]];
      ...
      if (v15)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            __int16 v22 = [v21 objectForKeyedSubscript:kANEDModelDirectorySizeKey[0]];
            id v23 = (char *)[v22 unsignedIntegerValue];

            if (!v16) {
              goto LABEL_12;
            }
            uint64_t v24 = (void *)qword_100042DD8;
            if (os_log_type_enabled((os_log_t)qword_100042DD8, OS_LOG_TYPE_DEBUG))
            {
              int v30 = v24;
...
LABEL_12:
              if (v23)
              {
                int v25 = [v50 objectForKeyedSubscript:kANEDModelDirectorySizeKey[0]];
                ...
                BOOL v16 = v51;
                [v50 setObject:v28 forKeyedSubscript:kANEDModelDirectorySizeKey[0]];
...
+ (id)mergeModelCacheStorageInformation:(id)a3 with:(id)a4
{
  ...
  id v6 = a4;
  id v7 = [(id)objc_opt_class() createModelCacheDictionary];
  id v8 = [v5 objectForKeyedSubscript:kANEDModelDirectorySizeKey[0]];
  uint64_t v9 = (char *)[v8 unsignedLongLongValue];

  id v10 = [v6 objectForKeyedSubscript:kANEDModelDirectorySizeKey[0]];
  id v11 = &v9[(void)[v10 unsignedLongLongValue]];

  id v12 = +[NSNumber numberWithUnsignedLongLong:v11];
  id v35 = v7;
  [v7 setObject:v12 forKeyedSubscript:kANEDModelDirectorySizeKey[0]];
...
+ (BOOL)_markPurgeablePath:(id)a3 error:(id *)a4
{
  ...
  if (v7 < 0)
  {
    BOOL v16 = (void *)qword_100042DD8;
    if (os_log_type_enabled((os_log_t)qword_100042DD8, OS_LOG_TYPE_ERROR)) {
      sub_10002752C((uint64_t)v6, v16);
    }
  ...
  else
  {
    ...
    {
      if (os_log_type_enabled((os_log_t)qword_100042DD8, OS_LOG_TYPE_DEBUG)) {
        sub_1000275D4((uint64_t)v6, &v22, v11);
      }
      id v15 = 0;
    }
    close(v8);
