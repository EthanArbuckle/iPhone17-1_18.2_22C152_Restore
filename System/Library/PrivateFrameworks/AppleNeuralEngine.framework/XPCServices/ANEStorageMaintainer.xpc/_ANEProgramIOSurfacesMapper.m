...
+ (void)initialize
{
  if (qword_100042CB8 != -1) {
    dispatch_once(&qword_100042CB8, &stru_10003C6F0);
  }
}
  ...
  if ([v6 validate])
  {
    ...
    if ((unint64_t)(v10 - 129) <= 0xFFFFFFFFFFFFFF7FLL)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        sub_10002374C(v12, v39, (uint64_t)v10, v11);
      }
    }
...
LABEL_5:
  ...
  else
  {
    ...
    __int16 v37 = sub_1000057F0;
    unsigned int v38 = sub_100005800;
    id v39 = 0;
    uint64_t v30 = 0;
    v31 = &v30;
    ...
    if (v20)
    {
      ...
      unint64_t v21 = qword_100042CB0;
      block[0] = _NSConcreteStackBlock;
      block[1] = 3221225472;
      block[2] = sub_100005808;
...
LABEL_5:
  ...
  else
  {
    ...
    BOOL v29 = sub_1000057F0;
    uint64_t v30 = sub_100005800;
    id v31 = 0;
    uint64_t v22 = 0;
    uint64_t v23 = &v22;
    ...
    if (v18)
    {
      ...
      void block[5] = &v22;
      block[6] = &v26;
      dispatch_sync((dispatch_queue_t)qword_100042CB0, block);
    }
    if (v18)
    {
      if (a5) {
