...
+ (id)sharedConnection
{
  if (qword_100042D18 != -1) {
    dispatch_once(&qword_100042D18, &stru_10003C8F8);
  }
  v2 = (void *)qword_100042D20;
  return v2;
}
...
- (_ANEVirtualClient)initWithSingletonAccess
{
  ...
  v5 = (void *)qword_100042D10;
  qword_100042D10 = v4;

  if (!+[_ANEDeviceInfo isVirtualMachine])
  {
    if (os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_DEBUG)) {
      sub_100023FE8();
    }
    goto LABEL_8;
  }
  ...
  if (!IOServiceGetMatchingServices(kIOMainPortDefault, v8, &existing))
  {
    ...
    BOOL v13 = os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_DEBUG);
    if ((i & 1) == 0)
    {
      if (v13) {
        sub_100023ED8();
    ...
    if (os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_DEBUG)) {
      sub_100023DF0(v15, v17, v18, v19, v20, v21, v22, v23);
    }
LABEL_32:
...
- (BOOL)compileModel:(id)a3 options:(id)a4 qos:(unsigned int)a5 error:(id *)a6
{
  id v10 = a3;
  id v38 = a4;
  io_service_t v11 = (id)qword_100042D10;
...
LABEL_11:
  ...
  if (os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_ERROR)) {
    sub_1000240A4();
  }
  [(_ANEVirtualClient *)self releaseIOSurfaces:v40];
  BOOL v32 = 0;
...
+ (void)printStruct:(VirtANEModel *)a3
{
  if (a3)
  {
    uint64_t v4 = qword_100042D10;
    if (os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_DEBUG)) {
      sub_100024194((uint64_t)a3, v4);
    }
  }
}
...
- (BOOL)loadModel:(id)a3 options:(id)a4 qos:(unsigned int)a5 error:(id *)a6
{
  ...
  v18 = qword_100042D10;
  if (os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_DEBUG)) {
    sub_100024540((uint64_t)buf, v53, v18);
  }
...
- (BOOL)unloadModel:(id)a3 options:(id)a4 qos:(unsigned int)a5 error:(id *)a6
{
  ...
  if (([(_ANEVirtualClient *)self negotiatedCapabilityMask] & 4) == 0)
  {
    ...
    CFNumberRef v28 = qword_100042D10;
    if (os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_DEBUG))
    {
    ...
    v30 = qword_100042D10;
    if (os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_DEBUG)) {
      sub_100024838(v29, v30, v31, v32, v33, v34, v35, v36);
    }
...
LABEL_35:
  ...
  if (v45)
  {
    __int16 v47 = (id)qword_100042D10;
...
- (BOOL)evaluateWithModel:(id)a3 options:(id)a4 request:(id)a5 qos:(unsigned int)a6 error:(id *)a7
{
  ...
  if (!v18)
  {
    ...
    if (v36)
    {
      ...
      if (!v37 && os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_ERROR)) {
        sub_1000249DC();
      }
      id v19 = objc_opt_new();
      ...
      block[1] = 3221225472;
      block[2] = sub_10000ED88;
      block[3] = &unk_10003C948;
      uint64_t v50 = &v58;
      block[4] = self;
      id v46 = v13;
      id v47 = v14;
    ...
    uint64_t v31 = (id)qword_100042D10;
...
- (BOOL)doEvaluateWithModel:(id)a3 options:(id)a4 request:(id)a5 qos:(unsigned int)a6 completionEvent:(id)a7 error:(id *)a8
{
  ...
  id v294 = a5;
  id v295 = a7;
  v12 = (id)qword_100042D10;
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG)) {
    sub_10002518C();
  }

  id v13 = (id)qword_100042D10;
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG)) {
    sub_100025120();
  }

  id v14 = (id)qword_100042D10;
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG)) {
    sub_1000250B4();
  }

  id v15 = (id)qword_100042D10;
  ...
  if (([(_ANEVirtualClient *)self negotiatedCapabilityMask] & 4) == 0)
  {
    ...
    if (v26)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          uint64_t v32 = (id)qword_100042D10;
          if (os_log_type_enabled(v32, OS_LOG_TYPE_DEBUG))
          {
    ...
    int v374 = (int)v43;
    unsigned int v51 = (id)qword_100042D10;
...
LABEL_204:
  ...
  if (v60)
  {
    ...
    do
    {
      for (char i = 0; i != v60; char i = (char *)i + 1)
      {
        ...
        CFRelease(v66);
        CFRelease(v65);
        __int16 v67 = (id)qword_100042D10;
  ...
  if (v71)
  {
    ...
    do
    {
      for (j = 0; j != v71; j = (char *)j + 1)
      {
        ...
        CFRelease(v78);
        CFRelease(v77);
        __int16 v79 = (id)qword_100042D10;
  ...
  if (v83)
  {
    ...
    do
    {
      for (k = 0; k != v83; k = (char *)k + 1)
      {
        ...
        CFRelease(v89);
        CFRelease(v88);
        uint64_t v90 = (id)qword_100042D10;
  ...
  if (v94)
  {
    ...
    do
    {
      for (m = 0; m != v94; m = (char *)m + 1)
      {
        ...
        CFRelease(v101);
        CFRelease(v100);
        uint64_t v102 = (id)qword_100042D10;
  ...
  else
  {
    ...
    CFRelease(v109);
    v110 = (id)qword_100042D10;
    if (os_log_type_enabled(v110, OS_LOG_TYPE_DEBUG)) {
      sub_100024FA8((uint64_t)&v367, v110, v111, v112, v113, v114, v115, v116);
    }
  }
  ...
  if (v161)
  {
    ...
    if (v261)
    {
      ...
      sub_100024CE4(v265, v291);
    }

    if (v291)
    {
      v266 = (id)qword_100042D10;
    ...
    [(_ANEVirtualClient *)self releaseIOSurfaces:v355];
    CFDictionaryRef v160 = (const __CFDictionary *)(id)qword_100042D10;
    if (os_log_type_enabled((os_log_t)v160, OS_LOG_TYPE_ERROR)) {
      sub_100024C70((uint64_t *)a8, v160, v270);
    }
  }
  else
  {
    v230 = (id)qword_100042D10;
...
{
  id v5 = a3;
  uint64_t v6 = (id)qword_100042D10;
  ...
  if (([(_ANEVirtualClient *)self negotiatedCapabilityMask] & 4) != 0)
  {
    ...
    if (v16)
    {
      ...
      CFMutableArrayRef v21 = (id)qword_100042D10;
...
- (void)purgeCompiledModel:(id)a3
{
  ...
  if (([(_ANEVirtualClient *)self negotiatedCapabilityMask] & 4) != 0)
  {
    ...
    else if (os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_ERROR))
    {
      sub_1000252B4();
    }
  }
...
- (BOOL)compiledModelExistsMatchingHash:(id)a3
{
  ...
  else
  {
    v21[0] = -[_ANEVirtualClient copyToIOSurface:length:ioSID:](self, "copyToIOSurface:length:ioSID:", v7, [v7 length], v23);
    v24[0] = [v7 length];
    CFMutableArrayRef v8 = (id)qword_100042D10;
...
- (BOOL)beginRealTimeTask
{
  uint64_t v4 = (id)qword_100042D10;
...
LABEL_18:
  ...
  uint64_t v37 = qword_100042D10;
  if (os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_ERROR)) {
    sub_1000255A4(v37, v38, v39);
  }
  IOSurfaceID v40 = 0;
LABEL_19:
...
- (void)sendGuestBuildVersion
{
  ...
  id v7 = v6;
  id v8 = [v7 UTF8String];
  unsigned __int8 v9 = (id)qword_100042D10;
  ...
  CFNumberRef v11 = (id)qword_100042D10;
  CFNumberRef v12 = v11;
  if (v10)
  {
...
- (BuildVersionInfo)exchangeBuildVersionInfo
{
  ...
  *(_OWORD *)retstr->var3 = 0u;
  ...
  id v7 = v6;
  if (!v6 || [v6 isEqualToString:&stru_10003CED0])
  {
    id v8 = (id)qword_100042D10;
  ...
  CFNumberRef v10 = v9;
  if (!v9 || [v9 isEqualToString:&stru_10003CED0])
  {
    CFNumberRef v11 = (id)qword_100042D10;
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
...
- (BOOL)doMapIOSurfacesWithModel:(id)a3 request:(id)a4 cacheInference:(BOOL)a5 error:(id *)a6
{
  ...
  id v8 = qword_100042D10;
  if (os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_DEBUG)) {
    sub_10002597C(v6, v8, v9, v10, v11, v12, v13, v14);
  }
  ...
  if (v26)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        CFDictionaryRef v32 = (id)qword_100042D10;
        if (os_log_type_enabled(v32, OS_LOG_TYPE_DEBUG))
        {
          id v33 = [v31 unsignedLongLongValue];
  ...
  if (v36)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        CFNumberRef v42 = qword_100042D10;
        if (os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 67109120;
...
LABEL_74:
  ...
  if (v75)
  {
    ...
    uint64_t v76 = (id)qword_100042D10;
...
- (void)copyModel:(id)a3 options:(id)a4 vmData:(VMData *)a5
{
  ...
  if (a5)
  {
    ...
    if ([v85 isEqual:@"hwx"])
    {
      uint64_t v12 = (id)qword_100042D10;
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
      {
        NSStringFromSelector(a2);
        objc_claimAutoreleasedReturnValue();
      ...
      uint64_t v14 = [v96 stringByReplacingOccurrencesOfString:v13 withString:&stru_10003CED0];

      size_t v15 = (id)qword_100042D10;
      if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
      {
        NSStringFromSelector(a2);
        objc_claimAutoreleasedReturnValue();
    ...
    if ([v85 isEqual:@"net"])
    {
      ...
      if ([v18 length])
      {
        ...
        id v26 = [v96 stringByReplacingOccurrencesOfString:v25 withString:&stru_10003CED0];

        if (v86)
        {
          int v27 = (id)qword_100042D10;
          if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
          {
            NSStringFromSelector(a2);
            objc_claimAutoreleasedReturnValue();
        ...
        uint64_t v40 = [v96 stringByReplacingOccurrencesOfString:v39 withString:&stru_10003CED0];

        IOSurfaceID v41 = (id)qword_100042D10;
    ...
    id v48 = [v87 objectForKey:kANEFEspressoFileResourcesKey];
    id v82 = v48;
    if ([v48 count])
    {
      int v49 = 0;
      ...
      for (unint64_t j = 0; j < (unint64_t)[v48 count]; ++j)
      {
          ...
          && ([v55 isEqual:@"weights"] & 1) == 0)
        {
          ...
          IOSurfaceID v58 = qword_100042D10;
          if (os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_DEBUG))
          {
          ...
          CFStringRef v65 = qword_100042D10;
          if (os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_DEBUG))
          {
...
- (BOOL)copyFilesInDirectoryToIOSurfaces:(id)a3 ioSurfaceRefs:(__CFArray *)a4 ioSurfaceSizes:(id)a5 fileNames:(id)a6
{
  ...
  if (!v64)
  {
    uint64_t v40 = qword_100042D10;
    if (os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_ERROR)) {
      sub_100025C10(v40, v41, v42);
    }
    BOOL v43 = 0;
    goto LABEL_61;
  }
...
LABEL_57:
  int v44 = (id)qword_100042D10;
  if (os_log_type_enabled(v44, OS_LOG_TYPE_DEBUG)) {
    sub_100025C8C((uint64_t)buf, (uint64_t)[v49 count], v44);
  }
...
- (BOOL)copyAllModelFiles:(id)a3 dictionary:(__CFDictionary *)a4 ioSurfaceRefs:(__CFArray *)a5
{
  ...
  if (v49)
  {
    id v51 = qword_100042D10;
    if (os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_ERROR)) {
      sub_100025EEC(v51);
    }
    unsigned int v52 = 0;
    id v71 = &stru_10003CED0;
  }
  else
  {
  ...
  while (2)
  {
    ...
    do
    {
      ...
      if (v84 < 0x20)
      {
        ...
        {
          CFStringRef v22 = qword_100042D10;
          if (os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_ERROR))
          {
            *(_DWORD *)buf = 138412546;
        ...
        int v19 = v77;
        id v20 = qword_100042D10;
        BOOL v21 = os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_DEBUG);
        if (v19)
        {
          if (v21)
          {
...
LABEL_61:
      ...
      uint64_t v13 = qword_100042D10;
      if (os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_ERROR)) {
        sub_100025DF4(v90, &v91, v13);
      }
      int v14 = 1;
LABEL_35:
      if (v14 != 3 && v14)
...
- (void)copyModelMetaData:(id)a3 options:(id)a4 dictionary:(__CFDictionary *)a5 vmData:(VMData *)a6
{
  ...
  if (a6)
  {
    ...
    if (v27)
    {
      ...
      CFRelease(v34);
      id v45 = [v33 length];
      CFStringRef v35 = (id)qword_100042D10;
...
- (id)readWeightFilename:(id)a3
{
  ...
  {
    uint64_t v9 = (id)qword_100042D10;
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      NSStringFromSelector(a2);
      objc_claimAutoreleasedReturnValue();
...
LABEL_23:
  ...
  if (v19 != [v10 length])
  {
    CFNumberRef v20 = (id)qword_100042D10;
...
- (void)copyModelOptionFiles:(id)a3 options:(id)a4 vmData:(VMData *)a5
{
  ...
  if (v10)
  {
    CFNumberRef v12 = [v10 objectForKeyedSubscript:kANEFCompilerOptionsFilenameKey];
    if (v12)
    {
...
- (void)copyModelOptionFiles:(id)a3 options:(id)a4 dictionary:(__CFDictionary *)a5 vmData:(VMData *)a6
{
  ...
  if (v12)
  {
    unint64_t v14 = [v12 objectForKeyedSubscript:kANEFCompilerOptionsFilenameKey];
    if (v14)
    {
...
- (__IOSurface)copyToIOSurface:(id)a3 length:(unint64_t)a4 ioSID:(unsigned int *)a5
{
  ...
  if (!a5)
  {
    CFNumberRef v10 = (id)qword_100042D10;
...
+ (void)printIOSurfaceDataInBytes:(__IOSurface *)a3
{
  ...
  {
    id v12 = qword_100042D10;
    if (os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_ERROR)) {
      sub_1000265D0(v12, v13, v14);
    }
  }
}
...
- (id)getModelAttribute:(VMData *)a3
{
  ...
  else
  {
    ...
    if (!a3->var7 && os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_ERROR)) {
      sub_10002664C();
    }
    id v8 = 0;
...
- (id)getObjectFromIOSurface:(__IOSurface *)a3 classType:(Class)a4 length:(unint64_t)a5
{
  if (a3)
  {
    ...
    {
      __int16 v18 = qword_100042D10;
      if (os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_ERROR)) {
        sub_100026730(v18, v19, v20);
      }
      CFRelease(a3);
      uint64_t v14 = 0;
    }
  ...
  {
    id v15 = qword_100042D10;
    if (os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_ERROR)) {
      sub_1000266B4(v15, v16, v17);
    }
    uint64_t v14 = 0;
  }
  return v14;
    ...
    if (v10)
    {
      ...
      if (v11)
      {
        ...
        else
        {
          ...
          if (v22 && errorString)
          {
            unsigned int v24 = (id)qword_100042D10;
      ...
      __int16 v18 = qword_100042D10;
      if (os_log_type_enabled((os_log_t)qword_100042D10, OS_LOG_TYPE_ERROR)) {
        sub_100026A7C(v18, v19, v20);
      }
    }
    else
    {
      uint64_t v17 = (id)qword_100042D10;
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        NSStringFromSelector(a2);
        objc_claimAutoreleasedReturnValue();
...
- (void)checkKernReturnValue:(int)a3 selector:(unsigned int)a4 outParams:(VirtANEModel *)a5
{
  if (a3)
  {
    ...
    uint64_t v8 = (id)qword_100042D10;
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
...
- (BOOL)updateError:(VMData *)a3 error:(id *)a4
{
  ...
  if (!v4)
  {
    ...
    if (BaseAddress)
    {
      ...
      if (v13)
      {
        __int16 v14 = (id)qword_100042D10;
        if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
        {
          NSStringFromSelector(a2);
          objc_claimAutoreleasedReturnValue();
    ...
    {
      uint64_t v19 = (id)qword_100042D10;
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        NSStringFromSelector(a2);
        objc_claimAutoreleasedReturnValue();
...
- (id)updatePerformanceStats:(VMData *)a3
{
  if (a3->var18.var51 || a3->var18.var49)
  {
    ...
    {
      uint64_t v7 = (id)qword_100042D10;
      if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
      {
        NSStringFromSelector(a2);
        objc_claimAutoreleasedReturnValue();
