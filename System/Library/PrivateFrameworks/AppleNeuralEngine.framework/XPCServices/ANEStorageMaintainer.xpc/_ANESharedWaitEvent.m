...
{
  id v6 = a4;
  id v7 = [objc_alloc((Class)a1) initWithValue:a3 sharedEvent:v6 eventType:0];
...
{
  id v8 = a4;
  id v9 = [objc_alloc((Class)a1) initWithValue:a3 sharedEvent:v8 eventType:a5];
...
- (id)description
{
  ...
  unint64_t v5 = [(_ANESharedWaitEvent *)self value];
  id v6 = [(_ANESharedWaitEvent *)self sharedEvent];
  id v7 = +[NSString stringWithFormat:@"%@: { value=%llu : sharedEvent=%@ } ", v4, v5, v6];
