...
+ (id)reportClient:(id)a3 modelName:(id)a4
{
  ...
  if (v5 && v6)
  {
    id v9 = [&off_10003FB90 objectForKeyedSubscript:v5];
    if (!v9)
    {
      v10 = +[_ANEStrings systemLibraryPath];
      v11 = [v6 stringByReplacingOccurrencesOfString:v10 withString:&stru_10003CED0];

      v12 = [v11 stringByReplacingOccurrencesOfString:@"PrivateFrameworks/" withString:&stru_10003CED0];
      v13 = [v12 stringByReplacingOccurrencesOfString:@"Frameworks/" withString:&stru_10003CED0];
      ...
      if (!v14
        ...
        || (v17 = (void *)v16,
            [&off_10003FBB8 objectForKeyedSubscript:v16],
...
+ (void)reportTelemetryToPPS:(id)a3 playload:(id)a4
{
  ...
  if (!v8)
  {
    if (qword_100042D08 != -1) {
      dispatch_once(&qword_100042D08, &stru_10003C8B0);
    }
    v10 = [(id)qword_100042D00 objectForKey:v5];
    id v9 = v10;
    if (v10)
    {
      uint64_t v14 = 0;
