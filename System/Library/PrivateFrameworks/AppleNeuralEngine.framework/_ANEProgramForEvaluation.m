...
+ (id)programWithController:(id)a3 intermediateBufferHandle:(unint64_t)a4 queueDepth:(char)a5
{
  uint64_t v5 = a5;
  id v8 = a3;
  id v9 = (void *)[objc_alloc((Class)a1) initWithController:v8 intermediateBufferHandle:a4 queueDepth:v5];
...
{
  uint64_t v5 = a5;
  id v8 = +[_ANEDeviceController controllerWithProgramHandle:a3];
  id v9 = (void *)[objc_alloc((Class)a1) initWithController:v8 intermediateBufferHandle:a4 queueDepth:v5];
...
- (id)programInferenceOtherErrorForMessage:(ANENotificationMessageStruct *)a3 model:(id)a4 methodName:(id)a5
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138413058;
    ...
    __int16 v24 = 2112;
    id v25 = v7;
    _os_log_error_impl(&dword_1DB8AB000, v10, OS_LOG_TYPE_ERROR, "%@: ANEProgramProcessRequestDirect() Failed with status=0x%x : statusType=0x%x lModel=%@", buf, 0x22u);
  }
...
- (BOOL)processRequest:(id)a3 model:(id)a4 qos:(unsigned int)a5 qIndex:(unint64_t)a6 modelStringID:(unint64_t)a7 options:(id)a8 returnValue:(unsigned int *)a9 error:(id *)a10
{
  uint64_t v10 = MEMORY[0x1F4188790](self, a2, a3, a4, *(void *)&a5, a6, a7, a8);
  ...
  char v157 = 1;
  context = (void *)MEMORY[0x1E0193890]();
  id v129 = v22;
  char v23 = [v21 validate];
...
LABEL_12:
  ...
  if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&v176[8] = 1024;
    *(_DWORD *)&v176[10] = v124;
    _os_log_debug_impl(&dword_1DB8AB000, v27, OS_LOG_TYPE_DEBUG, "%@ ANEProgramProcessRequestDirect() for lModel %@ waitForResults is %d", (uint8_t *)&v173, 0x1Cu);
  }
  if (!v124)
  {
    ...
    if (!v29)
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        int v115 = [v127 queueDepth];
        uint64_t v116 = [v127 currentAsyncRequestsInFlight];
        int v173 = 138413314;
        id v174 = v114;
        __int16 v175 = 1024;
        *(_DWORD *)v176 = 15;
        ...
        *(void *)&v176[6] = v115;
        ...
        __int16 v179 = 2112;
        id v180 = v129;
        _os_log_error_impl(&dword_1DB8AB000, v30, OS_LOG_TYPE_ERROR, "%@: Async Request could not be queued - timed out ret=0x%xself.queueDepth=%ld : self.currentAsyncRequestsInFlight=%ld lModel=%@", (uint8_t *)&v173, 0x30u);
      }
      goto LABEL_12;
    }
  ...
  int v153 = 0;
  v32 = [v128 objectForKeyedSubscript:kANEFPerformanceStatsMaskKey[0]];
  v121 = v32;
  if (v32)
  {
    if (([v32 unsignedIntValue] & 4) != 0)
    {
      ...
      uint64_t v34 = [v33 countByEnumeratingWithState:&v146 objects:v172 count:16];
      if (v34)
      {
  ...
  *((_DWORD *)v151 + 6) = v32;
  ...
  for (unsigned int j = 0; ; unsigned int j = v42 + 1)
  {
    v41 = [v21 inputArray];
    uint64_t v42 = j;
    BOOL v43 = [v41 count] > (unint64_t)j;
    ...
    *(id *)((char *)&v174 + 24 * v42 + 4) = (id)[v45 ioSurface];
  ...
  for (unsigned int k = 0; ; unsigned int k = v54 + 1)
  {
    v53 = [v21 outputArray];
    uint64_t v54 = k;
    BOOL v55 = [v53 count] > (unint64_t)k;
  ...
  if (!v64)
  {
    ...
    uint64_t v188 = [v65 ioSurface];
  }
  v66 = [v21 procedureIndex];
  int v173 = [v66 unsignedIntegerValue];

  v182[769] = [v127 programHandle];
  int v183 = v16;
  int v185 = v126;
  int v184 = 0;
  v67 = [v128 objectForKeyedSubscript:kANEFDisableIOFencesUseSharedEventsKey[0]];
  v119 = v67;
  if (v67)
  {
    char v186 = [v67 BOOLValue];
    v68 = +[_ANELog common];
  ...
  v69 = [v128 objectForKeyedSubscript:kANEFEnableFWToFWSignal[0]];
  v120 = v69;
  if (v69)
  {
    char v187 = [v69 BOOLValue];
    v70 = +[_ANELog common];
      ...
      do
      {
        ...
        if (v84 >= 6)
        {
          ...
          if (os_log_type_enabled(v85, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_WORD *)&v170[12] = 2048;
            *(void *)&v170[14] = 0;
            _os_log_error_impl(&dword_1DB8AB000, v85, OS_LOG_TYPE_ERROR, "Unknown _ANESignalEventType=%lu using (%lu)", v170, 0x16u);
          }
    ...
    if (v87)
    {
      ...
      do
      {
        ...
        *(v90 - 1) = v92;
        ...
        uint64_t *v90 = [v91 value];
        unint64_t v94 = [v91 eventType];
        if (v94 >= 3)
        {
          v95 = +[_ANELog common];
          if (os_log_type_enabled(v95, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_WORD *)&v170[12] = 2048;
            *(void *)&v170[14] = 0;
            _os_log_error_impl(&dword_1DB8AB000, v95, OS_LOG_TYPE_ERROR, "Unknown _ANEWaitEventType=%lu using (%lu)", v170, 0x16u);
          }
  ...
  *(void *)&v170[16] = 0x2020000000;
  ...
  v105 = v130;
  if (v99 && *(void *)v99) {
    unsigned int v106 = (*(uint64_t (**)(uint64_t, int *, void *, _DWORD *, BOOL, uint64_t, BOOL))(*(void *)v99 + 32))(v99, &v173, v105, v96, v124, v103, v104 != 0);
  }
  else {
    unsigned int v106 = 2;
  }
  ...
  *a9 = v106;
  if (*a9)
  {
    ...
    if (os_log_type_enabled(v108, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v168 = 2112;
      id v169 = v100;
      _os_log_error_impl(&dword_1DB8AB000, v108, OS_LOG_TYPE_ERROR, "%@: Could not process request ret=0x%x lModel=%@", (uint8_t *)&v164, 0x1Cu);
    }
  }
  ...
  for (iuint64_t i = 1018; ii != 506; ii -= 8)
...
- (BOOL)processOutputSet:(id)a3 model:(id)a4 options:(id)a5 error:(id *)a6
{
  ...
  id v10 = a3;
  id v11 = a4;
  dispatch_semaphore_t v12 = (void *)MEMORY[0x1E0193890]();
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_WORD *)&v31[8] = 2112;
    *(void *)&v31[10] = v11;
    _os_log_debug_impl(&dword_1DB8AB000, v13, OS_LOG_TYPE_DEBUG, "-----> %@: processOutputSet() outputSet=%p lModel=%@ : ", buf, 0x20u);
  }
  int v24 = objc_msgSend(v10, "procedureIndex", -[_ANEProgramForEvaluation programHandle](self, "programHandle"));
  int v25 = [v10 setIndex];
  uint64_t v26 = [v10 signalValue];
  ...
  if (v15 && *(void *)v15)
  {
    int v16 = (*(uint64_t (**)(uint64_t, uint64_t *))(*(void *)v15 + 40))(v15, &v23);
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
  {
    ...
    *(void *)&v31[16] = v22;
    __int16 v32 = 2048;
    uint64_t v33 = v26;
    _os_log_error_impl(&dword_1DB8AB000, v18, OS_LOG_TYPE_ERROR, "%@: Could not process output set enqueue request ret=0x%x lModel=%@ programHandle=%llu signalValue=%llu", buf, 0x30u);
  }
  BOOL v17 = 0;
LABEL_11:
  if (a6) {
...
- (BOOL)processInputBuffers:(id)a3 model:(id)a4 options:(id)a5 error:(id *)a6
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(void *)&v54[2] = v8;
    __int16 v55 = 2112;
    id v56 = v44;
    _os_log_debug_impl(&dword_1DB8AB000, v9, OS_LOG_TYPE_DEBUG, "-----> %@: processInputBuffers() inputBuffers=%p lModel=%@ : ", v53, 0x20u);
  }
  ...
  *(_DWORD *)&v53[8] = [v8 procedureIndex];
  ...
  if (v11)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_WORD *)&v50[8] = 1024;
      *(_DWORD *)&v50[10] = 255;
      _os_log_error_impl(&dword_1DB8AB000, v12, OS_LOG_TYPE_ERROR, "%@: inputBuffers inputBufferInfoIndex=%lu exceeds max=%d", buf, 0x1Cu);
    }
  }
  ...
  *(_DWORD *)uint64_t v54 = [v13 count];
  ...
  {
    uint64_t v15 = [v8 inputBufferInfoIndex];
    uint64_t v16 = i;
    BOOL v17 = [v15 count] > (unint64_t)i;
    ...
    int v20 = [v19 unsignedIntegerValue];
    *(_DWORD *)&v54[4 * v16 + 4] = v20;
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v49 = 1024;
      *(_DWORD *)v50 = v20;
      _os_log_debug_impl(&dword_1DB8AB000, v21, OS_LOG_TYPE_DEBUG, "-----> %@: processInputBuffers() inputBufferInfoIndex value is %d ", buf, 0x12u);
    }
  }
  for (unsigned int j = 0; ; unsigned int j = v25 + 1)
  {
    int v24 = [v8 inputFreeValue];
    uint64_t v25 = j;
    BOOL v26 = [v24 count] > (unint64_t)j;
  ...
  if (v30 && *(void *)v30)
  {
    int v31 = (*(uint64_t (**)(uint64_t, unsigned char *))(*(void *)v30 + 48))(v30, v53);
  ...
  if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
  {
    ...
    *(void *)&v50[6] = v44;
    __int16 v51 = 2048;
    unint64_t v52 = v37;
    _os_log_error_impl(&dword_1DB8AB000, v33, OS_LOG_TYPE_ERROR, "%@: Could not process input ready request ret=0x%x lModel=%@ programHandle=%llu", buf, 0x26u);
  }
  BOOL v32 = 0;
LABEL_23:
  if (v41) {
...
- (void)processRequest:model:qos:qIndex:modelStringID:options:returnValue:error:.cold.1()
{
  ...
  _os_log_debug_impl(&dword_1DB8AB000, v5, OS_LOG_TYPE_DEBUG, "-----> %@: ANEProgramProcessRequestDirect() enableFWToFWSignal option not nil value is %d ", v4, 0x12u);
}
...
- (void)processRequest:model:qos:qIndex:modelStringID:options:returnValue:error:.cold.2()
{
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_0_1(v1, v2, v3, 5.778e-34);
  _os_log_debug_impl(&dword_1DB8AB000, v5, OS_LOG_TYPE_DEBUG, "-----> %@: ANEProgramProcessRequestDirect() disableIOFences option not nil value is %d ", v4, 0x12u);
}
