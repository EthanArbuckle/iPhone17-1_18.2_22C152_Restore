  ...
  if (v7)
  {
    ...
    else
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        *(void *)&token.val[1] = v14;
        LOWORD(token.val[3]) = 2112;
        *(void *)((char *)&token.val[3] + 2) = v9;
        _os_log_impl(&dword_1DB8AB000, v12, OS_LOG_TYPE_INFO, "%@: SecTaskCopySigningIdentifier() returned csIdentity=\"%@\"", (uint8_t *)&token, 0x16u);
      }
    }
    CFRelease(v8);
  }
...
+ (id)teamIDFor:(id *)a3 processIdentifier:(int)a4
{
  ...
  *(_OWORD *)token.val = *(_OWORD *)a3->var0;
  *(_OWORD *)&token.val[4] = v6;
  SecTaskRef v7 = SecTaskCreateWithAuditToken(v5, &token);
  if (v7)
  {
    SecTaskRef v8 = v7;
    uint64_t v9 = SecTaskCopyTeamIdentifier();
    if (v9) {
      CFErrorRef v10 = (__CFString *)v9;
    }
    else {
      CFErrorRef v10 = &stru_1F35E5710;
    }
    CFRelease(v8);
    v11 = +[_ANELog daemon];
    v12 = v11;
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(void *)&token.val[1] = v14;
      LOWORD(token.val[3]) = 2112;
      *(void *)((char *)&token.val[3] + 2) = v10;
      _os_log_impl(&dword_1DB8AB000, v12, OS_LOG_TYPE_INFO, "%@: SecTaskCopyTeamIdentifier() returned teamIdentity=\"%@\"", (uint8_t *)&token, 0x16u);
    }
  }
  else
  {
...
- (id)description
{
  ...
  uint64_t v6 = [v3 stringWithFormat:@"%@: { csIdentity=%@ : teamIdentity=%@ }", v5, self->_csIdentity, self->_teamIdentity];
...
+ (void)codeSigningIDFor:processIdentifier:.cold.1()
{
  ...
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1DB8AB000, v2, v3, "%@: client(%d) : SecTaskCreateWithAuditToken() failed", v4, v5, v6, v7, v8);
}
...
+ (void)codeSigningIDFor:processIdentifier:.cold.2()
{
  ...
  v1 = NSStringFromSelector(v0);
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1DB8AB000, v2, v3, "%@: client(%d) : missing signingIdentifier", v4, v5, v6, v7, v8);
}
...
+ (void)teamIDFor:processIdentifier:.cold.2()
{
  ...
  v1 = NSStringFromSelector(v0);
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_1DB8AB000, v2, v3, "%@: client(%d) : missing teamIdentity", v4, v5, v6, v7, v8);
}
