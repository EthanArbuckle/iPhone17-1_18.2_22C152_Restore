...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)BLTPBSetSectionSubtypeParametersIconResponse;
  v4 = [(BLTPBSetSectionSubtypeParametersIconResponse *)&v8 description];
  v5 = [(BLTPBSetSectionSubtypeParametersIconResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return BLTPBSetSectionSubtypeParametersIconResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
