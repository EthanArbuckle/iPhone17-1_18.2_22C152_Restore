...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)BLTPBHandleAcknowledgeActionRequest;
...
- (BOOL)readFrom:(id)a3
{
  return BLTPBHandleAcknowledgeActionRequestReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[2])
  {
    -[BLTPBHandleAcknowledgeActionRequest setPublisherBulletinID:](self, "setPublisherBulletinID:");
    NSUInteger v4 = v7;
  }
  if (v4[3])
  {
    -[BLTPBHandleAcknowledgeActionRequest setRecordID:](self, "setRecordID:");
    NSUInteger v4 = v7;
  }
  if (v4[4])
  {
    -[BLTPBHandleAcknowledgeActionRequest setSectionID:](self, "setSectionID:");
    NSUInteger v4 = v7;
  }
  actionInfo = self->_actionInfo;
  uint64_t v6 = v4[1];
  ...
  {
    -[BLTPBHandleAcknowledgeActionRequest setActionInfo:](self, "setActionInfo:");
  }
  MEMORY[0x270F9A758]();
}
