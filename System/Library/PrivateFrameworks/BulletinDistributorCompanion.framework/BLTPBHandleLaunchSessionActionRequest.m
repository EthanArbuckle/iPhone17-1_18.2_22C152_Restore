@interface BLTPBHandleLaunchSessionActionRequest
...
@implementation BLTPBHandleLaunchSessionActionRequest
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)BLTPBHandleLaunchSessionActionRequest;
  v4 = [(BLTPBHandleLaunchSessionActionRequest *)&v8 description];
  v5 = [(BLTPBHandleLaunchSessionActionRequest *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return BLTPBHandleLaunchSessionActionRequestReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[2])
  {
    -[BLTPBHandleLaunchSessionActionRequest setPublisherBulletinID:](self, "setPublisherBulletinID:");
    NSUInteger v4 = v7;
  }
  if (v4[3])
  {
    -[BLTPBHandleLaunchSessionActionRequest setRecordID:](self, "setRecordID:");
    NSUInteger v4 = v7;
  }
  if (v4[4])
  {
    -[BLTPBHandleLaunchSessionActionRequest setSectionID:](self, "setSectionID:");
    NSUInteger v4 = v7;
  }
  actionInfo = self->_actionInfo;
  uint64_t v6 = v4[1];
  if (actionInfo)
  {
    ...
    actionInfo = (BLTPBActionInformation *)-[BLTPBActionInformation mergeFrom:](actionInfo, "mergeFrom:");
  }
  else
  {
    if (!v6) {
    ...
    actionInfo = (BLTPBActionInformation *)-[BLTPBHandleLaunchSessionActionRequest setActionInfo:](self, "setActionInfo:");
  }
  NSUInteger v4 = v7;
LABEL_13:
  MEMORY[0x270F9A758](actionInfo, v4);
}
