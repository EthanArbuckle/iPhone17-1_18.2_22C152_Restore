@interface BLTPBHandleDismissActionRequest
...
- (id)description
{
  ...
  v4 = [(BLTPBHandleDismissActionRequest *)&v8 description];
  v5 = [(BLTPBHandleDismissActionRequest *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    actionInfo = (BLTPBActionInformation *)-[BLTPBHandleDismissActionRequest setActionInfo:](self, "setActionInfo:");
  }
  NSUInteger v4 = v7;
LABEL_13:
