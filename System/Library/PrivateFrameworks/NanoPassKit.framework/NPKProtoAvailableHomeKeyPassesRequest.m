...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoAvailableHomeKeyPassesRequest;
  v4 = [(NPKProtoAvailableHomeKeyPassesRequest *)&v8 description];
  v5 = [(NPKProtoAvailableHomeKeyPassesRequest *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoAvailableHomeKeyPassesRequestReadFrom((uint64_t)self, (uint64_t)a3);
}
