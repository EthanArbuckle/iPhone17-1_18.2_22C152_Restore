...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoStandalonePaymentProvisioningFlowAcceptTermsRequest;
  v4 = [(NPKProtoStandalonePaymentProvisioningFlowAcceptTermsRequest *)&v8 description];
  v5 = [(NPKProtoStandalonePaymentProvisioningFlowAcceptTermsRequest *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoStandalonePaymentProvisioningFlowAcceptTermsRequestReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    v7 = v4;
    -[NPKProtoStandalonePaymentProvisioningFlowAcceptTermsRequest setRequestHeader:](self, "setRequestHeader:");
  }
  id v4 = v7;
LABEL_7:
}
...
- (void)writeTo:.cold.1()
{
  __assert_rtn("-[NPKProtoStandalonePaymentProvisioningFlowAcceptTermsRequest writeTo:]", "NPKProtoStandalonePaymentProvisioningFlowAcceptTermsRequest.m", 86, "self->_requestHeader != nil");
}
