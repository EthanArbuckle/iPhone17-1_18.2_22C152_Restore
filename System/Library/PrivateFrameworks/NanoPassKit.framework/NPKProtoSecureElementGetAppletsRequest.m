...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoSecureElementGetAppletsRequest;
  v4 = [(NPKProtoSecureElementGetAppletsRequest *)&v8 description];
  v5 = [(NPKProtoSecureElementGetAppletsRequest *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoSecureElementGetAppletsRequestReadFrom((uint64_t)self, (uint64_t)a3);
}
