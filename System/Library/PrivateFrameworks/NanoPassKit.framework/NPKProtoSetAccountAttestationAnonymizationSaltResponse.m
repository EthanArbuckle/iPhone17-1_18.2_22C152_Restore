@interface NPKProtoSetAccountAttestationAnonymizationSaltResponse
- (BOOL)hasErrorData;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (NSData)errorData;
...
- (id)description
{
  ...
  v4 = [(NPKProtoSetAccountAttestationAnonymizationSaltResponse *)&v8 description];
  v5 = [(NPKProtoSetAccountAttestationAnonymizationSaltResponse *)self dictionaryRepresentation];
