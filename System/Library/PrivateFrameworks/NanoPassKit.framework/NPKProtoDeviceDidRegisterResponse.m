@interface NPKProtoDeviceDidRegisterResponse
- (BOOL)hasPending;
- (BOOL)hasSuccess;
- (BOOL)isEqual:(id)a3;
- (BOOL)pending;
...
@implementation NPKProtoDeviceDidRegisterResponse
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoDeviceDidRegisterResponse;
  v4 = [(NPKProtoDeviceDidRegisterResponse *)&v8 description];
  v5 = [(NPKProtoDeviceDidRegisterResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoDeviceDidRegisterResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
