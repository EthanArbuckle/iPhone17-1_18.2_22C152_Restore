...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoPeerPaymentRegistrationResponse;
  v4 = [(NPKProtoPeerPaymentRegistrationResponse *)&v8 description];
  v5 = [(NPKProtoPeerPaymentRegistrationResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoPeerPaymentRegistrationResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v10 = [(NSData *)self->_peerPaymentWebServiceContextData copyWithZone:a3];
  v11 = (void *)v6[3];
  v6[3] = v10;

  uint64_t v12 = [(NSData *)self->_peerPaymentAccountData copyWithZone:a3];
  v13 = (void *)v6[2];
  v6[2] = v12;
...
LABEL_18:
  ...
  peerPaymentWebServiceContextData = self->_peerPaymentWebServiceContextData;
  if ((unint64_t)peerPaymentWebServiceContextData | *((void *)v4 + 3))
  {
  ...
  peerPaymentAccountData = self->_peerPaymentAccountData;
  if ((unint64_t)peerPaymentAccountData | *((void *)v4 + 2)) {
    char v8 = -[NSData isEqual:](peerPaymentAccountData, "isEqual:");
  }
  else {
    char v8 = 1;
  }
...
LABEL_6:
  ...
  uint64_t v6 = [(NSData *)self->_peerPaymentWebServiceContextData hash];
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)v4 + 1))
  {
    -[NPKProtoPeerPaymentRegistrationResponse setErrorData:](self, "setErrorData:");
    uint64_t v4 = v6;
  }
  if (*((void *)v4 + 3))
  {
    -[NPKProtoPeerPaymentRegistrationResponse setPeerPaymentWebServiceContextData:](self, "setPeerPaymentWebServiceContextData:");
    uint64_t v4 = v6;
  }
  if (*((void *)v4 + 2))
  {
    -[NPKProtoPeerPaymentRegistrationResponse setPeerPaymentAccountData:](self, "setPeerPaymentAccountData:");
    uint64_t v4 = v6;
  }
}
