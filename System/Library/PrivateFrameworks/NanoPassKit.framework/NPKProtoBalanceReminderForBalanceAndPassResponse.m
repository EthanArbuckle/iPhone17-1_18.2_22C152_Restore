...
- (id)description
{
  ...
  v5 = [(NPKProtoBalanceReminderForBalanceAndPassResponse *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (balanceReminderBytes) {
    [v3 setObject:balanceReminderBytes forKey:@"balanceReminderBytes"];
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v7 = [(NSData *)self->_balanceReminderBytes copyWithZone:a3];
...
LABEL_10:
  balanceReminderBytes = self->_balanceReminderBytes;
  if ((unint64_t)balanceReminderBytes | *((void *)v4 + 1)
...
- (unint64_t)hash
{
  ...
  uint64_t v4 = [(NSData *)self->_balanceReminderBytes hash] ^ v3;
