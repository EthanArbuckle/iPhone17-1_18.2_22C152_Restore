@interface NPKProtoRemoveSharingInvitationResponse
- (BOOL)hasSuccess;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (BOOL)success;
...
- (id)description
{
  ...
  v4 = [(NPKProtoRemoveSharingInvitationResponse *)&v8 description];
  v5 = [(NPKProtoRemoveSharingInvitationResponse *)self dictionaryRepresentation];
