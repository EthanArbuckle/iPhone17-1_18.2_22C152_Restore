@interface NPKProtoProvisionPeerPaymentPassResponse
- (BOOL)hasErrorData;
- (BOOL)hasPending;
- (BOOL)hasSuccess;
- (BOOL)isEqual:(id)a3;
...
@implementation NPKProtoProvisionPeerPaymentPassResponse
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoProvisionPeerPaymentPassResponse;
  v4 = [(NPKProtoProvisionPeerPaymentPassResponse *)&v8 description];
  v5 = [(NPKProtoProvisionPeerPaymentPassResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoProvisionPeerPaymentPassResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    id v6 = v4;
    -[NPKProtoProvisionPeerPaymentPassResponse setErrorData:](self, "setErrorData:");
    id v4 = v6;
  }
}
