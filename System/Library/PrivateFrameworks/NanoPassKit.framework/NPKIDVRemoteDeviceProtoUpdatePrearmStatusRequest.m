...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKIDVRemoteDeviceProtoUpdatePrearmStatusRequest;
  v4 = [(NPKIDVRemoteDeviceProtoUpdatePrearmStatusRequest *)&v8 description];
  v5 = [(NPKIDVRemoteDeviceProtoUpdatePrearmStatusRequest *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKIDVRemoteDeviceProtoUpdatePrearmStatusRequestReadFrom((uint64_t)self, (uint64_t)a3);
}
