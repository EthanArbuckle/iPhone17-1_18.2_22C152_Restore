...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    v5 = [NSNumber numberWithBool:self->_hasPasscodeSet];
  ...
  if ((has & 2) != 0)
  {
    v6 = [NSNumber numberWithBool:self->_isPasscodeLocked];
...
- (unint64_t)hash
{
  if (*(unsigned char *)&self->_has)
  {
    uint64_t v2 = 2654435761 * self->_hasPasscodeSet;
    if ((*(unsigned char *)&self->_has & 2) != 0) {
      goto LABEL_3;
    }
LABEL_5:
...
LABEL_3:
  uint64_t v3 = 2654435761 * self->_isPasscodeLocked;
  return v3 ^ v2 ^ [(NSData *)self->_errorData hash];
}
