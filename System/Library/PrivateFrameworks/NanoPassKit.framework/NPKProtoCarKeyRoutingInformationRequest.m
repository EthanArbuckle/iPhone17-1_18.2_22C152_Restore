...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoCarKeyRoutingInformationRequest;
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoCarKeyRoutingInformationRequestReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v8 = [(NSString *)self->_transportIdentifier copyWithZone:a3];
  v9 = (void *)v5[2];
  v5[2] = v8;
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSString isEqual:](invitationIdentifier, "isEqual:")))
  {
    ...
    if ((unint64_t)transportIdentifier | v4[2]) {
      char v7 = -[NSString isEqual:](transportIdentifier, "isEqual:");
    }
    else {
      char v7 = 1;
    }
...
- (unint64_t)hash
{
  ...
  return [(NSString *)self->_transportIdentifier hash] ^ v3;
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[1])
  {
    -[NPKProtoCarKeyRoutingInformationRequest setInvitationIdentifier:](self, "setInvitationIdentifier:");
    id v4 = v5;
  }
  if (v4[2])
  {
    -[NPKProtoCarKeyRoutingInformationRequest setTransportIdentifier:](self, "setTransportIdentifier:");
    id v4 = v5;
  }
}
