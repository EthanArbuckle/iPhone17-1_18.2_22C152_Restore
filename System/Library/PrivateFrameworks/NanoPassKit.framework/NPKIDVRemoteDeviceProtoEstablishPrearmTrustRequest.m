...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKIDVRemoteDeviceProtoEstablishPrearmTrustRequest;
  v4 = [(NPKIDVRemoteDeviceProtoEstablishPrearmTrustRequest *)&v8 description];
  v5 = [(NPKIDVRemoteDeviceProtoEstablishPrearmTrustRequest *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKIDVRemoteDeviceProtoEstablishPrearmTrustRequestReadFrom((uint64_t)self, (uint64_t)a3);
}
...
{
  if (*((void *)a3 + 1)) {
    -[NPKIDVRemoteDeviceProtoEstablishPrearmTrustRequest setTrustData:](self, "setTrustData:");
  }
}
