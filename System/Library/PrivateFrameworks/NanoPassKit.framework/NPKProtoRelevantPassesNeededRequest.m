@interface NPKProtoRelevantPassesNeededRequest
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
- (id)description
{
  ...
  v4 = [(NPKProtoRelevantPassesNeededRequest *)&v8 description];
  v5 = [(NPKProtoRelevantPassesNeededRequest *)self dictionaryRepresentation];
