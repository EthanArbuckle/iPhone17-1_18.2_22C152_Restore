@interface NPKProtoCheckPasscodePolicyComplianceResponse
- (BOOL)hasErrorData;
...
- (id)description
{
  ...
  v4 = [(NPKProtoCheckPasscodePolicyComplianceResponse *)&v8 description];
  v5 = [(NPKProtoCheckPasscodePolicyComplianceResponse *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [NSNumber numberWithBool:self->_passcodeMeetsPolicy];
    [v3 setObject:v4 forKey:@"passcodeMeetsPolicy"];
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    *(unsigned char *)(v5 + 16) = self->_passcodeMeetsPolicy;
...
{
  if (*(unsigned char *)&self->_has) {
    uint64_t v2 = 2654435761 * self->_passcodeMeetsPolicy;
  }
  else {
    uint64_t v2 = 0;
  }
