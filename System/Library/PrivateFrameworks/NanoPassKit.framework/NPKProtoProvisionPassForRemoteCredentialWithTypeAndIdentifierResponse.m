...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoProvisionPassForRemoteCredentialWithTypeAndIdentifierResponse;
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoProvisionPassForRemoteCredentialWithTypeAndIdentifierResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    id v6 = v4;
    -[NPKProtoProvisionPassForRemoteCredentialWithTypeAndIdentifierResponse setErrorData:](self, "setErrorData:");
    id v4 = v6;
  }
}
