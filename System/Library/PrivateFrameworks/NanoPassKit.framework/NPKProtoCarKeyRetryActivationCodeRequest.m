...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoCarKeyRetryActivationCodeRequest;
  v4 = [(NPKProtoCarKeyRetryActivationCodeRequest *)&v8 description];
  v5 = [(NPKProtoCarKeyRetryActivationCodeRequest *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoCarKeyRetryActivationCodeRequestReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[2])
  {
    -[NPKProtoCarKeyRetryActivationCodeRequest setInvitationIdentifier:](self, "setInvitationIdentifier:");
    id v4 = v5;
  }
  if (v4[1])
  {
    -[NPKProtoCarKeyRetryActivationCodeRequest setActivationCode:](self, "setActivationCode:");
    id v4 = v5;
  }
}
