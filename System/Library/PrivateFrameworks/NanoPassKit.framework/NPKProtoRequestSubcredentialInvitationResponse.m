...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoRequestSubcredentialInvitationResponse;
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoRequestSubcredentialInvitationResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
{
  if (*((void *)a3 + 1)) {
    -[NPKProtoRequestSubcredentialInvitationResponse setErrorData:](self, "setErrorData:");
  }
}
