@interface NPKProtoResetApplePayManateeViewResponse
- (BOOL)hasErrorData;
- (BOOL)hasPending;
- (BOOL)hasSuccess;
- (BOOL)isEqual:(id)a3;
...
@implementation NPKProtoResetApplePayManateeViewResponse
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoResetApplePayManateeViewResponse;
  v4 = [(NPKProtoResetApplePayManateeViewResponse *)&v8 description];
  v5 = [(NPKProtoResetApplePayManateeViewResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoResetApplePayManateeViewResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    id v6 = v4;
    -[NPKProtoResetApplePayManateeViewResponse setErrorData:](self, "setErrorData:");
    id v4 = v6;
  }
}
