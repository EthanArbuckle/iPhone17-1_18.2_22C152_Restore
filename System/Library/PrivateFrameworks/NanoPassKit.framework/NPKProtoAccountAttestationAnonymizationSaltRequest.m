...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoAccountAttestationAnonymizationSaltRequest;
  v4 = [(NPKProtoAccountAttestationAnonymizationSaltRequest *)&v8 description];
  v5 = [(NPKProtoAccountAttestationAnonymizationSaltRequest *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoAccountAttestationAnonymizationSaltRequestReadFrom((uint64_t)self, (uint64_t)a3);
}
