...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoUpdatePeerPaymentAccountRequest;
  v4 = [(NPKProtoUpdatePeerPaymentAccountRequest *)&v8 description];
  v5 = [(NPKProtoUpdatePeerPaymentAccountRequest *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoUpdatePeerPaymentAccountRequestReadFrom((uint64_t)self, (uint64_t)a3);
}
