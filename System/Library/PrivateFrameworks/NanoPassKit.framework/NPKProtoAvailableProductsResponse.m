@interface NPKProtoAvailableProductsResponse
...
- (id)description
{
  ...
  v4 = [(NPKProtoAvailableProductsResponse *)&v8 description];
  v5 = [(NPKProtoAvailableProductsResponse *)self dictionaryRepresentation];
