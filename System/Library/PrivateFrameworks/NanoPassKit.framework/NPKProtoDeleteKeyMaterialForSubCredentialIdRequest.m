...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoDeleteKeyMaterialForSubCredentialIdRequest;
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoDeleteKeyMaterialForSubCredentialIdRequestReadFrom((uint64_t)self, (uint64_t)a3);
}
...
{
  if (*((void *)a3 + 1)) {
    -[NPKProtoDeleteKeyMaterialForSubCredentialIdRequest setCredentialIdentifier:](self, "setCredentialIdentifier:");
  }
}
