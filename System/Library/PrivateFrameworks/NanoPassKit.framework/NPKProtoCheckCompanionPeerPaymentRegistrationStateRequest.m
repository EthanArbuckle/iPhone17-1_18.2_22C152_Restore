...
@implementation NPKProtoCheckCompanionPeerPaymentRegistrationStateRequest

- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoCheckCompanionPeerPaymentRegistrationStateRequest;
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoCheckCompanionPeerPaymentRegistrationStateRequestReadFrom((uint64_t)self, (uint64_t)a3);
}
