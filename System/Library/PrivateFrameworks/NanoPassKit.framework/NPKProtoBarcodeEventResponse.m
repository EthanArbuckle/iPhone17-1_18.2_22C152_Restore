...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoBarcodeEventResponse;
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoBarcodeEventResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if (self->_responseData)
  {
    objc_msgSend(v4, "setResponseData:");
    id v4 = v5;
  }
  if (self->_errorData)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v6 = [(NSData *)self->_responseData copyWithZone:a3];
  v7 = (void *)v5[2];
  v5[2] = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()]
    && ((responseData = self->_responseData, !((unint64_t)responseData | v4[2]))
     || -[NSData isEqual:](responseData, "isEqual:")))
  {
    errorData = self->_errorData;
...
- (unint64_t)hash
{
  uint64_t v3 = [(NSData *)self->_responseData hash];
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[2])
  {
    -[NPKProtoBarcodeEventResponse setResponseData:](self, "setResponseData:");
    id v4 = v5;
  }
  if (v4[1])
  {
    -[NPKProtoBarcodeEventResponse setErrorData:](self, "setErrorData:");
    id v4 = v5;
  }
}
