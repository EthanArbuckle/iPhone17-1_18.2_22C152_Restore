@interface NPKProtoMatchingInvitationOnDeviceResponse
- (BOOL)hasErrorData;
...
@implementation NPKProtoMatchingInvitationOnDeviceResponse
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoMatchingInvitationOnDeviceResponse;
  v4 = [(NPKProtoMatchingInvitationOnDeviceResponse *)&v8 description];
  v5 = [(NPKProtoMatchingInvitationOnDeviceResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoMatchingInvitationOnDeviceResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[2])
  {
    -[NPKProtoMatchingInvitationOnDeviceResponse setInvitationData:](self, "setInvitationData:");
    id v4 = v5;
  }
  if (v4[1])
  {
    -[NPKProtoMatchingInvitationOnDeviceResponse setErrorData:](self, "setErrorData:");
    id v4 = v5;
  }
}
