...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoPasscodeUpgradeFlowApplyPasscodeRestrictionsResponse;
  v4 = [(NPKProtoPasscodeUpgradeFlowApplyPasscodeRestrictionsResponse *)&v8 description];
  v5 = [(NPKProtoPasscodeUpgradeFlowApplyPasscodeRestrictionsResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoPasscodeUpgradeFlowApplyPasscodeRestrictionsResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    char v5 = v4;
    -[NPKProtoPasscodeUpgradeFlowApplyPasscodeRestrictionsResponse setErrorData:](self, "setErrorData:");
    id v4 = v5;
  }
}
