...
- (void)setHasMissing:(BOOL)a3;
- (void)setHasPending:(BOOL)a3;
- (void)setMissing:(BOOL)a3;
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoCheckTLKsMissingResponse;
  v4 = [(NPKProtoCheckTLKsMissingResponse *)&v8 description];
  v5 = [(NPKProtoCheckTLKsMissingResponse *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    v6 = [NSNumber numberWithBool:self->_missing];
    [v3 setObject:v6 forKey:@"missing"];
  }
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoCheckTLKsMissingResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
LABEL_3:
  uint64_t v3 = 2654435761 * self->_missing;
  return v3 ^ v2 ^ [(NSData *)self->_errorData hash];
}
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    id v6 = v4;
    -[NPKProtoCheckTLKsMissingResponse setErrorData:](self, "setErrorData:");
    id v4 = v6;
  }
}
