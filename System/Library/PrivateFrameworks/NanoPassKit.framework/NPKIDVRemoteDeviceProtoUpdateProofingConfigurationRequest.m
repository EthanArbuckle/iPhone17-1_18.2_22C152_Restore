@interface NPKIDVRemoteDeviceProtoUpdateProofingConfigurationRequest
...
- (id)description
{
  ...
  v4 = [(NPKIDVRemoteDeviceProtoUpdateProofingConfigurationRequest *)&v8 description];
  v5 = [(NPKIDVRemoteDeviceProtoUpdateProofingConfigurationRequest *)self dictionaryRepresentation];
