@interface NPKProtoStandalonePaymentPassListRequest
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
@implementation NPKProtoStandalonePaymentPassListRequest

- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoStandalonePaymentPassListRequest;
  v4 = [(NPKProtoStandalonePaymentPassListRequest *)&v8 description];
  v5 = [(NPKProtoStandalonePaymentPassListRequest *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoStandalonePaymentPassListRequestReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    v7 = v4;
    -[NPKProtoStandalonePaymentPassListRequest setRequestHeader:](self, "setRequestHeader:");
  }
  id v4 = v7;
LABEL_7:
}
...
- (void)writeTo:.cold.1()
{
  __assert_rtn("-[NPKProtoStandalonePaymentPassListRequest writeTo:]", "NPKProtoStandalonePaymentPassListRequest.m", 86, "self->_requestHeader != nil");
}
