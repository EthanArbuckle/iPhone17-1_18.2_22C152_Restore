...
- (id)description
{
  ...
  id v4 = [(NPKProtoPassSharesForCredentialIdentifierResponse *)&v8 description];
  v5 = [(NPKProtoPassSharesForCredentialIdentifierResponse *)self dictionaryRepresentation];
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v8 clearSharesDatas];
    unint64_t v4 = [(NPKProtoPassSharesForCredentialIdentifierResponse *)self sharesDatasCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(NPKProtoPassSharesForCredentialIdentifierResponse *)self sharesDataAtIndex:i];
        [v8 addSharesData:v7];
      }
    }
  }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[NPKProtoPassSharesForCredentialIdentifierResponse addSharesData:](self, "addSharesData:", *(void *)(*((void *)&v9 + 1) + 8 * v8++), (void)v9);
      }
      while (v6 != v8);
