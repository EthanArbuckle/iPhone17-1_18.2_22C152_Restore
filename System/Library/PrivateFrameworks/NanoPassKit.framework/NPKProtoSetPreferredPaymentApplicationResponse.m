...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoSetPreferredPaymentApplicationResponse;
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoSetPreferredPaymentApplicationResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[1])
  {
    -[NPKProtoSetPreferredPaymentApplicationResponse setPassID:](self, "setPassID:");
    id v4 = v5;
  }
  if (v4[2])
  {
    -[NPKProtoSetPreferredPaymentApplicationResponse setPreferredApplicationAID:](self, "setPreferredApplicationAID:");
    id v4 = v5;
  }
}
