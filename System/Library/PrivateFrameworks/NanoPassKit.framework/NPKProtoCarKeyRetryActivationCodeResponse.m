@interface NPKProtoCarKeyRetryActivationCodeResponse
- (BOOL)hasResultData;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (NSData)resultData;
...
- (id)description
{
  ...
  v4 = [(NPKProtoCarKeyRetryActivationCodeResponse *)&v8 description];
  v5 = [(NPKProtoCarKeyRetryActivationCodeResponse *)self dictionaryRepresentation];
