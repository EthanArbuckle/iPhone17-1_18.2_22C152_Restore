...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoWebServiceContextNeededRequest;
  v4 = [(NPKProtoWebServiceContextNeededRequest *)&v8 description];
  v5 = [(NPKProtoWebServiceContextNeededRequest *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoWebServiceContextNeededRequestReadFrom((uint64_t)self, (uint64_t)a3);
}
