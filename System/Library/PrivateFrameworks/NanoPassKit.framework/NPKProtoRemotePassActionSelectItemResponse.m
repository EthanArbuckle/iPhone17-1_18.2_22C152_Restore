...
- (id)description
{
  ...
  int v4 = [(NPKProtoRemotePassActionSelectItemResponse *)&v8 description];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(void *)(v5 + 16) = v8;
  ...
  uint64_t v10 = [(NSData *)self->_serviceProviderDataData copyWithZone:a3];
  v11 = *(void **)(v5 + 40);
  *(void *)(v5 + 40) = v10;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    if ((*((unsigned char *)v4 + 48) & 1) == 0 || self->_incrementAmount != *((void *)v4 + 1)) {
      goto LABEL_14;
    }
  }
...
LABEL_14:
  ...
  serviceProviderDataData = self->_serviceProviderDataData;
  if ((unint64_t)serviceProviderDataData | *((void *)v4 + 5)) {
    char v8 = -[NSData isEqual:](serviceProviderDataData, "isEqual:");
  }
  else {
    char v8 = 1;
  }
