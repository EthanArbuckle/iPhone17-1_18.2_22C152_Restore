...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoAccountWithIdentifierResponse;
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoAccountWithIdentifierResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()]
    && ((accountData = self->_accountData, !((unint64_t)accountData | v4[1]))
     || -[NSData isEqual:](accountData, "isEqual:")))
  {
    errorData = self->_errorData;
...
- (unint64_t)hash
{
  uint64_t v3 = [(NSData *)self->_accountData hash];
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[1])
  {
    -[NPKProtoAccountWithIdentifierResponse setAccountData:](self, "setAccountData:");
    id v4 = v5;
  }
  if (v4[2])
  {
    -[NPKProtoAccountWithIdentifierResponse setErrorData:](self, "setErrorData:");
    id v4 = v5;
  }
}
