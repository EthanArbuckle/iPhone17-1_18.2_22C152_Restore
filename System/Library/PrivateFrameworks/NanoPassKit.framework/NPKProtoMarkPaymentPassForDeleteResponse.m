...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoMarkPaymentPassForDeleteResponse;
  v4 = [(NPKProtoMarkPaymentPassForDeleteResponse *)&v8 description];
  v5 = [(NPKProtoMarkPaymentPassForDeleteResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoMarkPaymentPassForDeleteResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
