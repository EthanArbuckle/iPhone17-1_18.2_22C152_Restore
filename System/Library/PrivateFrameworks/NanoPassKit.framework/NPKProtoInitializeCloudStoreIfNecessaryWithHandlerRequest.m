...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoInitializeCloudStoreIfNecessaryWithHandlerRequest;
  v4 = [(NPKProtoInitializeCloudStoreIfNecessaryWithHandlerRequest *)&v8 description];
  v5 = [(NPKProtoInitializeCloudStoreIfNecessaryWithHandlerRequest *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoInitializeCloudStoreIfNecessaryWithHandlerRequestReadFrom((uint64_t)self, (uint64_t)a3);
}
