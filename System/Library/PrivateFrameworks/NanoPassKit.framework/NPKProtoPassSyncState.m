...
- (id)passSyncStateItemsAtIndex:(unint64_t)a3;
- (unint64_t)hash;
- (unint64_t)passSyncStateItemsCount;
- (unsigned)version;
...
- (void)setPassSyncStateItems:(id)a3;
...
- (unint64_t)passSyncStateItemsCount
{
  return [(NSMutableArray *)self->_passSyncStateItems count];
}

- (id)passSyncStateItemsAtIndex:(unint64_t)a3
{
  return (id)[(NSMutableArray *)self->_passSyncStateItems objectAtIndex:a3];
}
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoPassSyncState;
  id v4 = [(NPKProtoPassSyncState *)&v8 description];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(objc_alloc(MEMORY[0x263EFF980]), "initWithCapacity:", -[NSMutableArray count](self->_passSyncStateItems, "count"));
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
    long long v16 = 0u;
  ...
  {
    v11 = [NSNumber numberWithUnsignedInt:self->_version];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoPassSyncStateReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if ([(NPKProtoPassSyncState *)self passSyncStateItemsCount])
  {
    ...
    unint64_t v4 = [(NPKProtoPassSyncState *)self passSyncStateItemsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(NPKProtoPassSyncState *)self passSyncStateItemsAtIndex:i];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  long long v15 = 0u;
  long long v16 = 0u;
  uint64_t v6 = self->_passSyncStateItems;
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(id)v5 addPassSyncStateItems:v11];
...
- (BOOL)isEqual:(id)a3
{
  ...
  passSyncStateItems = self->_passSyncStateItems;
  if ((unint64_t)passSyncStateItems | *((void *)v4 + 1))
  {
    if (!-[NSMutableArray isEqual:](passSyncStateItems, "isEqual:")) {
      goto LABEL_8;
    }
  }
...
- (unint64_t)hash
{
  uint64_t v3 = [(NSMutableArray *)self->_passSyncStateItems hash];
  if (*(unsigned char *)&self->_has) {
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[NPKProtoPassSyncState addPassSyncStateItems:](self, "addPassSyncStateItems:", *(void *)(*((void *)&v10 + 1) + 8 * v9++), (void)v10);
      }
      while (v7 != v9);
...
- (NSMutableArray)passSyncStateItems
{
  return self->_passSyncStateItems;
}
