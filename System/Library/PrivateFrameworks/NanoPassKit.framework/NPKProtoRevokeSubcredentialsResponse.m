...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoRevokeSubcredentialsResponse;
  v4 = [(NPKProtoRevokeSubcredentialsResponse *)&v8 description];
  v5 = [(NPKProtoRevokeSubcredentialsResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoRevokeSubcredentialsResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
