@interface NPKProtoPerformDeviceCheckInResponse
- (BOOL)hasErrorData;
- (BOOL)hasPending;
- (BOOL)hasSuccess;
- (BOOL)isEqual:(id)a3;
...
@implementation NPKProtoPerformDeviceCheckInResponse
...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoPerformDeviceCheckInResponse;
  v4 = [(NPKProtoPerformDeviceCheckInResponse *)&v8 description];
  v5 = [(NPKProtoPerformDeviceCheckInResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoPerformDeviceCheckInResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    id v6 = v4;
    -[NPKProtoPerformDeviceCheckInResponse setErrorData:](self, "setErrorData:");
    id v4 = v6;
  }
}
