...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoSignWithFidoKeyResponse;
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoSignWithFidoKeyResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if (self->_fidoAttestation)
  {
    objc_msgSend(v4, "setFidoAttestation:");
    id v4 = v5;
  }
  if (self->_errorData)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v6 = [(NSData *)self->_fidoAttestation copyWithZone:a3];
  v7 = (void *)v5[2];
  v5[2] = v6;
...
- (unint64_t)hash
{
  uint64_t v3 = [(NSData *)self->_fidoAttestation hash];
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[2])
  {
    -[NPKProtoSignWithFidoKeyResponse setFidoAttestation:](self, "setFidoAttestation:");
    id v4 = v5;
  }
  if (v4[1])
  {
    -[NPKProtoSignWithFidoKeyResponse setErrorData:](self, "setErrorData:");
    id v4 = v5;
  }
}
