@interface NPKIDVRemoteDeviceProtoCredentialPropertiesRequest
...
@implementation NPKIDVRemoteDeviceProtoCredentialPropertiesRequest
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKIDVRemoteDeviceProtoCredentialPropertiesRequest;
  id v4 = [(NPKIDVRemoteDeviceProtoCredentialPropertiesRequest *)&v8 description];
  v5 = [(NPKIDVRemoteDeviceProtoCredentialPropertiesRequest *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKIDVRemoteDeviceProtoCredentialPropertiesRequestReadFrom(self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  if ([(NPKIDVRemoteDeviceProtoCredentialPropertiesRequest *)self configuredPartitionsIdentifiersCount])
  {
    [v8 clearConfiguredPartitionsIdentifiers];
    unint64_t v4 = [(NPKIDVRemoteDeviceProtoCredentialPropertiesRequest *)self configuredPartitionsIdentifiersCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(NPKIDVRemoteDeviceProtoCredentialPropertiesRequest *)self configuredPartitionsIdentifiersAtIndex:i];
...
- (void)mergeFrom:(id)a3
{
  ...
  id v4 = a3;
  if (*((void *)v4 + 2)) {
    -[NPKIDVRemoteDeviceProtoCredentialPropertiesRequest setCredentialIdentifier:](self, "setCredentialIdentifier:");
  }
  long long v12 = 0u;
  long long v13 = 0u;
  long long v10 = 0u;
  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        -[NPKIDVRemoteDeviceProtoCredentialPropertiesRequest addConfiguredPartitionsIdentifiers:](self, "addConfiguredPartitionsIdentifiers:", *(void *)(*((void *)&v10 + 1) + 8 * i), (void)v10);
      }
