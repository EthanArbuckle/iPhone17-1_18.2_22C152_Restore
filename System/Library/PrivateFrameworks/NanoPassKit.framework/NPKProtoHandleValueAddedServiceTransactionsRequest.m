...
- (id)description
{
  ...
  id v4 = [(NPKProtoHandleValueAddedServiceTransactionsRequest *)&v8 description];
...
- (void)copyTo:(id)a3
{
  ...
  if ([(NPKProtoHandleValueAddedServiceTransactionsRequest *)self transactionsBytesCount])
  {
    ...
    unint64_t v4 = [(NPKProtoHandleValueAddedServiceTransactionsRequest *)self transactionsBytesCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(NPKProtoHandleValueAddedServiceTransactionsRequest *)self transactionsBytesAtIndex:i];
  ...
  if ([(NPKProtoHandleValueAddedServiceTransactionsRequest *)self transactionPassIDsCount])
  {
    ...
    unint64_t v8 = [(NPKProtoHandleValueAddedServiceTransactionsRequest *)self transactionPassIDsCount];
    if (v8)
    {
      unint64_t v9 = v8;
      for (uint64_t j = 0; j != v9; ++j)
      {
        uint64_t v11 = [(NPKProtoHandleValueAddedServiceTransactionsRequest *)self transactionPassIDsAtIndex:j];
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(NPKProtoHandleValueAddedServiceTransactionsRequest *)self addTransactionsBytes:*(void *)(*((void *)&v19 + 1) + 8 * v9++)];
      }
      while (v7 != v9);
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[NPKProtoHandleValueAddedServiceTransactionsRequest addTransactionPassIDs:](self, "addTransactionPassIDs:", *(void *)(*((void *)&v15 + 1) + 8 * v14++), (void)v15);
      }
      while (v12 != v14);
