...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoStandalonePaymentProvisioningFlowIssuerVerificationFieldsStepContext;
  v4 = [(NPKProtoStandalonePaymentProvisioningFlowIssuerVerificationFieldsStepContext *)&v8 description];
  v5 = [(NPKProtoStandalonePaymentProvisioningFlowIssuerVerificationFieldsStepContext *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoStandalonePaymentProvisioningFlowIssuerVerificationFieldsStepContextReadFrom((uint64_t)self, (uint64_t)a3);
}
