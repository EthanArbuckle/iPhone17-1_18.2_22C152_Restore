...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoInitializeCloudStoreIfNecessaryRequest;
  v4 = [(NPKProtoInitializeCloudStoreIfNecessaryRequest *)&v8 description];
  v5 = [(NPKProtoInitializeCloudStoreIfNecessaryRequest *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoInitializeCloudStoreIfNecessaryRequestReadFrom((uint64_t)self, (uint64_t)a3);
}
