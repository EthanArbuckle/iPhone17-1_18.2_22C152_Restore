...
- (id)description
{
  ...
  v5 = [(NPKIDVRemoteDeviceProtoPartitionsCredentialIdentifiersResponse *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (partitionsCredentialIdentifiersData) {
    [v3 setObject:partitionsCredentialIdentifiersData forKey:@"partitionsCredentialIdentifiersData"];
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v6 = [(NSData *)self->_partitionsCredentialIdentifiersData copyWithZone:a3];
  v7 = (void *)v5[2];
  v5[2] = v6;
...
- (unint64_t)hash
{
  uint64_t v3 = [(NSData *)self->_partitionsCredentialIdentifiersData hash];
