...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NPKProtoCanAcceptInvitationResponse;
  v4 = [(NPKProtoCanAcceptInvitationResponse *)&v8 description];
  v5 = [(NPKProtoCanAcceptInvitationResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NPKProtoCanAcceptInvitationResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
{
  if (*((void *)a3 + 1)) {
    -[NPKProtoCanAcceptInvitationResponse setErrorData:](self, "setErrorData:");
  }
}
