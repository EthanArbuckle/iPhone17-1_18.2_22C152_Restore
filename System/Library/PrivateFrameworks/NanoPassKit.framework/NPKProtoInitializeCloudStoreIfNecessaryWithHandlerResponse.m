@interface NPKProtoInitializeCloudStoreIfNecessaryWithHandlerResponse
- (BOOL)hasErrorData;
- (BOOL)hasPending;
- (BOOL)hasSuccess;
- (BOOL)isEqual:(id)a3;
...
- (id)description
{
  ...
  v4 = [(NPKProtoInitializeCloudStoreIfNecessaryWithHandlerResponse *)&v8 description];
  v5 = [(NPKProtoInitializeCloudStoreIfNecessaryWithHandlerResponse *)self dictionaryRepresentation];
