...
+ (id)successWithResolvedAgeDateTime:(id)a3
{
  ...
  id v4 = a3;
  id v5 = static AgeDateTimeResolutionResult.success(with:)((uint64_t)v4);
...
+ (id)disambiguationWithAgeDateTimesToDisambiguate:(id)a3
{
  ...
  swift_getObjCClassMetadata();
  id v4 = static AgeDateTimeResolutionResult.disambiguation(with:)(v3);
...
+ (id)confirmationRequiredWithAgeDateTimeToConfirm:(id)a3
{
  swift_getObjCClassMetadata();
  id v4 = a3;
  id v5 = static AgeDateTimeResolutionResult.confirmationRequired(with:)((uint64_t)a3);
...
- (AgeDateTimeResolutionResult)initWithJSONDictionary:(id)a3 forIntent:(id)a4
{
  ...
  return (AgeDateTimeResolutionResult *)AgeDateTimeResolutionResult.init(JSONDictionary:intent:)(v5, a4);
}
