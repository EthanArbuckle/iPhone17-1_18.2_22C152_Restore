...
+ (id)sharedJetsamInfo
{
  if (sharedJetsamInfo_onceToken != -1) {
    dispatch_once(&sharedJetsamInfo_onceToken, &__block_literal_global_131);
  }
...
- (BOOL)resetIntervalFor:(id)a3
{
  ...
  *(_OWORD *)buffer = 0u;
  ...
  else
  {
    ...
    {
      uint64_t v7 = v6 >> 10;
      v26 = objc_msgSend(MEMORY[0x1E4F1CA48], "arrayWithCapacity:", -[NSMapTable count](self->_fetchers, "count"));
      ...
      if (v17)
      {
        ...
        do
        {
          for (uint64_t j = 0; j != v18; ++j)
          {
            ...
            v23 = objc_msgSend(NSNumber, "numberWithLongLong:", v7, v25);
      ...
      id v4 = v25;
      [(NSMapTable *)self->_fetchers setObject:&unk_1F16E3F18 forKey:v25];
...
- (BOOL)getInfoFor:(id)a3 into:(jetsam_info *)a4
{
  ...
  if (!v7)
  {
    ...
    [(NSLock *)self->_fetchersLock lock];
    uint64_t v9 = [(NSMapTable *)self->_fetchers objectForKey:v6];
    [(NSLock *)self->_fetchersLock unlock];
    if (v9)
    {
