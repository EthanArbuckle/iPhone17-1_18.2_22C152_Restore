...
@implementation NTKRichComplicationCornerCircularSwiftUIView
...
- (id)_circularView
{
  ...
  if (!swiftUIView)
  {
    ...
    v7[1] = 3221225472;
    v7[2] = __61__NTKRichComplicationCornerCircularSwiftUIView__circularView__block_invoke;
    v7[3] = &unk_1E62C20F8;
...
void __61__NTKRichComplicationCornerCircularSwiftUIView__circularView__block_invoke(uint64_t a1, double a2, double a3)
{
...
- (void)setPaused:(BOOL)a3
{
  BOOL v3 = a3;
  v5.receiver = self;
  v5.super_class = (Class)NTKRichComplicationCornerCircularSwiftUIView;
...
{
  v3.receiver = self;
  v3.super_class = (Class)NTKRichComplicationCornerCircularSwiftUIView;
