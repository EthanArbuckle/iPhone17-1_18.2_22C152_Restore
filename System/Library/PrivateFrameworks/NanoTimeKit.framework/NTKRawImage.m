...
+ (id)rawImageWithImage:(id)a3 width:(int)a4 height:(int)a5
{
  ...
  int Height = CGImageGetHeight(v8);
  v11 = 0;
  if (v7 && Width >= 1 && Height >= 1)
  {
    v17 = malloc_type_malloc(16 * (int)v6 * (uint64_t)(int)v5, 0x1000040451B5BE8uLL);
    int v12 = v5 * v6;
    if ((int)v5 * (int)v6 < 1) {
      v13 = 0;
    }
    ...
    v14 = CGColorSpaceCreateWithName((CFStringRef)*MEMORY[0x1E4F1DC98]);
    v15 = CGBitmapContextCreate(v13, (int)v6, (int)v5, 8uLL, (4 * v6), v14, 1u);
    bzero(v13, 4 * v12);
    v19.size.width = (double)(int)v6;
    v19.size.height = (double)(int)v5;
    v19.origin.x = 0.0;
    v19.origin.y = 0.0;
