...
- (void)_processSpline;
- (void)dealloc;
- (void)getControlPoints:(NTKCubicSpline *)self processedPoints:(SEL)a2;
...
- (NTKCubicSpline)initWithNumberOfControlPoints:(int)a3 isClosed:(BOOL)a4
{
  ...
  uint64_t v5 = *(void *)&a3;
  v12.receiver = self;
  v12.super_class = (Class)NTKCubicSpline;
  ...
  if (v6)
  {
    v6->_length = v5;
    v6->_startIndex = -1;
    v6->_processedPoints = ($1162CC34C1E32B87B4666730FB29695F *)NTKSplineVector_new(v5);
    v7->_controlPoints = ($1162CC34C1E32B87B4666730FB29695F *)NTKSplineVector_new(v5);
    v7->_workspace = ($1162CC34C1E32B87B4666730FB29695F *)NTKSplineVector_new(v5);
    v7->_closed = v4;
...
- (void)dealloc
{
  NTKSplineVector_destroy((void **)&self->_processedPoints->var0);
  NTKSplineVector_destroy((void **)&self->_controlPoints->var0);
  NTKSplineVector_destroy((void **)&self->_workspace->var0);
  v3.receiver = self;
  v3.super_class = (Class)NTKCubicSpline;
...
- (void)process
{
  ...
  NTKSplineVector_zero((uint64_t)self->_processedPoints);
  NTKSplineMatrix_times_NTKSplineVector_float((uint64_t)self->_splineMatrix, &self->_workspace->var0, &self->_processedPoints->var0);
  self->_startIndex = -1;
}
  ...
  if ((a3 & 0x80000000) == 0)
  {
    ...
    do
    {
      ...
      *(float *)&long double v10 = v10;
      uint64_t v11 = 0;
      [(NTKCubicSpline *)self interpolateAt:&v11 derivative:(double)v10];
      v6[2](v6, v7);
      uint64_t v7 = (v7 + 1);
    }
    while (v9 != v7);
