...
- (NTKCFaceContainerView)initWithFaceSize:(CGSize)a3 style:(int64_t)a4
{
  ...
  if (v10)
  {
    ...
    v14 = objc_msgSend(objc_alloc(MEMORY[0x1E4FB1EB0]), "initWithFrame:", 0.0, 0.0, v11->_faceSize.width, v11->_faceSize.height);
...
- (void)setFaceView:(id)a3
{
  ...
  v7 = [(UIView *)self->_faceView superview];
  int v8 = [v7 isEqual:self->_faceContainer];
...
uint64_t __40__NTKCFaceContainerView_setHighlighted___block_invoke(uint64_t a1)
{
  ...
  return [*(id *)(*(void *)(a1 + 32) + 504) setAlpha:v1];
}
...
- (CGSize)intrinsicContentSize
{
  -[NTKCFaceContainerView sizeThatFits:](self, "sizeThatFits:", *MEMORY[0x1E4F1DB30], *(double *)(MEMORY[0x1E4F1DB30] + 8));
...
- (void)layoutSubviews
{
  ...
  CGFloat v8 = v7;
  double v10 = v9;
  double v11 = _LayoutConstants_45((uint64_t)v35);
  double v12 = v36;
  double height = self->_faceSize.height;
  v14 = objc_msgSend(MEMORY[0x1E4F19A30], "currentDevice", v11);
  [v14 screenBounds];
  double v15 = v12 * (height / CGRectGetHeight(v38));

  double v16 = [MEMORY[0x1E4F19A30] currentDevice];
  [v16 screenBounds];
  ...
  v24 = [MEMORY[0x1E4F19A30] currentDevice];
  uint64_t v25 = [v24 deviceCategory];
  ...
  {
    CGRect v26 = objc_msgSend(MEMORY[0x1E4FB14C0], "bezierPathWithRoundedRect:cornerRadius:", x, y, width, v23, v12);
  ...
  CGRect v28 = [MEMORY[0x1E4F19A30] currentDevice];
