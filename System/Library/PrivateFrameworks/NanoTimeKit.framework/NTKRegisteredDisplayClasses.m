@interface NTKRegisteredDisplayClasses
@end

@implementation NTKRegisteredDisplayClasses

void ___NTKRegisteredDisplayClasses_block_invoke()
{
  v2[78] = *MEMORY[0x1E4F143B8];
  v2[0] = objc_opt_class();
  v2[1] = objc_opt_class();
  v2[2] = objc_opt_class();
  v2[3] = objc_opt_class();
  ...
  uint64_t v0 = [MEMORY[0x1E4F1C978] arrayWithObjects:v2 count:78];
  v1 = (void *)_NTKRegisteredDisplayClasses_displayClasses;
  _NTKRegisteredDisplayClasses_displayClasses = v0;
}
