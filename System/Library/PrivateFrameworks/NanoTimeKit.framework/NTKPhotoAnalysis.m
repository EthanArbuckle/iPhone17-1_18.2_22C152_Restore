...
+ (BOOL)isValidDictionary:(id)a3
{
  ...
  if ([a1 _dictionaryPassesBasicCheck:v4]) {
    char v5 = [a1 _dictionaryHasValidValues:v4];
  }
  else {
    char v5 = 0;
  }
...
+ (BOOL)_dictionaryHasValidValues:(id)a3
{
  ...
  id v4 = [MEMORY[0x1E4F1C978] arrayWithObjects:v22 count:11];
  int v5 = [NSNumber numberWithFloat:0.0];
  LODWORD(v6) = 1.0;
...
- (NTKPhotoAnalysis)initWithCoder:(id)a3
{
  ...
  int v5 = [(NTKPhotoAnalysis *)&v17 init];
...
- (id)initFromDictionary:(id)a3
{
  ...
  int v5 = [(NTKPhotoAnalysis *)&v28 init];
...
+ (id)defaultAnalysis
{
  ...
  v2 = (void *)[objc_alloc((Class)a1) initWithStructure:v4];
...
+ (id)invalidAnalysis
{
  v4[0] = _NTKInvalidAnalysis;
  v4[1] = *(_OWORD *)algn_1BC8A165C;
  uint64_t v5 = 0;
  v2 = (void *)[objc_alloc((Class)a1) initWithStructure:v4];
...
+ (NTKPhotoAnalysis)analysisWithImage:(id)a3 alignment:(unint64_t)a4 deviceSizeClass:(unint64_t)a5
{
  ...
  else
  {
    ...
    double v14 = dbl_1BC8A1678[v11];
    double v15 = dbl_1BC8A16C8[v11];
    double v16 = dbl_1BC8A16F0[v11];
    double v17 = dbl_1BC8A1718[v11];
    ...
    v34.origin.y = 0.0;
    v34.size.width = dbl_1BC8A1718[v11];
    v34.size.height = dbl_1BC8A1678[v11];
    CGRect v35 = CGRectInset(v34, dbl_1BC8A16A0[v11], dbl_1BC8A16A0[v11]);
    ...
    *(CGFloat *)&v31[2] = v22;
    *(double *)&v31[3] = v15;
    float v23 = objc_msgSend(MEMORY[0x1E4F29238], "valueWithBytes:objCType:", v31, "{CGRect={CGPoint=dd}{CGSize=dd}}", *(void *)&v27, *(void *)&v29);
    v32[0] = v23;
...
{
  id v3 = objc_opt_new();
  [v3 setObject:&unk_1F16E2598 forKeyedSubscript:@"version"];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  return (id)[v4 initWithStructure:v7];
}
