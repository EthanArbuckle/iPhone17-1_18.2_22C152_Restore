...
- (void)setComplicationTemplate:(id)a3 reason:(int64_t)a4
{
  ...
  v6 = [(NTKRichComplicationCircularMonogramView *)self _labelFont];
  [(CLKUIColoringLabel *)self->_textLabel setFont:v6];

  [(NTKRichComplicationCircularMonogramView *)self setNeedsLayout];
}

- (id)_labelFont
{
  id v3 = [(CDRichComplicationView *)self device];
  double v4 = _LayoutConstants_44(v3);
  double v6 = v5;
  double v8 = v7;
...
- (id)_createLabelViewWithFont:(id)a3
{
  ...
  v12[1] = 3221225472;
  v12[2] = __68__NTKRichComplicationCircularMonogramView__createLabelViewWithFont___block_invoke;
  v12[3] = &unk_1E62C0040;
  objc_copyWeak(&v13, &location);
  [v5 setNowProvider:v12];
  v10[0] = MEMORY[0x1E4F143A8];
  v10[1] = 3221225472;
  v10[2] = __68__NTKRichComplicationCircularMonogramView__createLabelViewWithFont___block_invoke_2;
  v10[3] = &unk_1E62C0068;
  objc_copyWeak(&v11, &location);
  [v5 setNeedsResizeHandler:v10];
  double v6 = [(CDRichComplicationView *)self device];
  _LayoutConstants_44(v6);
  [v5 setMaxWidth:v7];
