...
{
  v3.receiver = self;
  v3.super_class = (Class)type metadata accessor for ResumeTimerIntent();
...
{
  v5.receiver = self;
  v5.super_class = (Class)type metadata accessor for ResumeTimerIntent();
  return [(ResumeTimerIntent *)&v5 initWithCoder:a3];
}
...
- (ResumeTimerIntent)initWithIdentifier:(id)a3 backingStore:(id)a4
{
  ...
  v11.receiver = self;
  v11.super_class = (Class)type metadata accessor for ResumeTimerIntent();
...
- (ResumeTimerIntent)initWithDomain:(id)a3 verb:(id)a4 parametersByName:(id)a5
{
  ...
  v12.receiver = self;
  v12.super_class = (Class)type metadata accessor for ResumeTimerIntent();
  v10 = [(ResumeTimerIntent *)&v12 initWithDomain:v7 verb:v8 parametersByName:v9];
