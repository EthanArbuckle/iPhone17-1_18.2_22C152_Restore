...
- (id)process:(id)a3 options:(id)a4
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1C492D000, v6, OS_LOG_TYPE_DEBUG, "CHPruneCandidatesComparingColumnScoresStep is running", buf, 2u);
  }
  ...
  if (v24)
  {
    v192 = objc_msgSend_array(MEMORY[0x1E4F1CA48], v25, v26, v27, v28, v29, v191);
    for (unint64_t i = 0; ; ++i)
    {
      ...
      v193[1] = 3221225472;
      v193[2] = sub_1C493F48C;
      v193[3] = &unk_1E64E0CD8;
      id v90 = v71;
      id v194 = v90;
      ...
      if (i)
      {
        for (uint64_t j = 0; ; ++j)
        {
          ...
          uint64_t v104 = objc_msgSend_tokenColumnCount(v98, v99, v100, v101, v102, v103);
          ...
          uint64_t v123 = objc_msgSend_indexAtPosition_(v118, v119, j, v120, v121, v122);
...
LABEL_8:
    ...
    uint64_t v161 = objc_msgSend_count(v192, v49, v50, v51, v52, v53);
    v167 = objc_msgSend_result(v5, v162, v163, v164, v165, v166);
    v173 = objc_msgSend_transcriptionPaths(v167, v168, v169, v170, v171, v172);
    uint64_t v179 = objc_msgSend_count(v173, v174, v175, v176, v177, v178);

    if (v161 != v179)
    {
      v180 = [CHTokenizedMathResult alloc];
      v185 = objc_msgSend_initWithBestPathTokens_(v180, v181, (uint64_t)v192, v182, v183, v184);
