...
- (CGPoint)center;
- (CGSize)size;
- (CHEllipseRecognitionResult)initWithCoder:(id)a3;
- (CHEllipseRecognitionResult)initWithString:(id)a3 score:(double)a4 rotation:(double)a5 center:(CGPoint)a6 size:(CGSize)a7;
- (void)encodeWithCoder:(id)a3;
@end

@implementation CHEllipseRecognitionResult
...
- (CHEllipseRecognitionResult)initWithString:(id)a3 score:(double)a4 rotation:(double)a5 center:(CGPoint)a6 size:(CGSize)a7
{
  ...
  CGFloat x = a6.x;
  v12.receiver = self;
  v12.super_class = (Class)CHEllipseRecognitionResult;
...
- (CHEllipseRecognitionResult)initWithCoder:(id)a3
{
  id v4 = a3;
  v20.receiver = self;
  v20.super_class = (Class)CHEllipseRecognitionResult;
...
- (void)encodeWithCoder:(id)a3
{
  id v4 = a3;
  v25.receiver = self;
  v25.super_class = (Class)CHEllipseRecognitionResult;
