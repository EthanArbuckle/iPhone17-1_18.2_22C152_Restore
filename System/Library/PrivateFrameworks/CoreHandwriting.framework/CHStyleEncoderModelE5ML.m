@interface CHStyleEncoderModelE5ML
...
+ (id)defaultURLOfModelInThisBundle
{
  ...
  if (v10)
  {
    v11 = objc_msgSend_URLWithString_relativeToURL_(MEMORY[0x1E4F1CB10], v7, @"diffusion_latn_style_encoder.bundle", (uint64_t)v10, v8, v9);
  }
  else
  {
    v11 = 0;
...
+ (id)inputNames
{
  ...
  uint64_t v4 = objc_msgSend_arrayWithObjects_count_(MEMORY[0x1E4F1C978], a2, (uint64_t)v6, 7, v2, v3);
  return v4;
}
...
- (CHStyleEncoderModelE5ML)initWithProgramLibrary:(id)a3 width:(unint64_t)a4
{
  ...
  self = [(CHStyleEncoderModelE5ML *)&v60 init];
  if (!self) {
    goto LABEL_16;
  }
  id v14 = v13;
...
- (id)createExecutionContext
{
  uint64_t v3 = [CHStyleEncoderModelE5MLExecutionContext alloc];
