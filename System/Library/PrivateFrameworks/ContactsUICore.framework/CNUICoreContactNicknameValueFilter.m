...
- (id)contactByFilteringOutPropertyValueOfContact:(id)a3
{
  ...
  if (!v4)
  {
    if (CNGuardOSLog_cn_once_token_0_18 != -1) {
      dispatch_once(&CNGuardOSLog_cn_once_token_0_18, &__block_literal_global_62);
    }
    v5 = CNGuardOSLog_cn_once_object_0_18;
    if (os_log_type_enabled((os_log_t)CNGuardOSLog_cn_once_object_0_18, OS_LOG_TYPE_FAULT)) {
