@interface CNUIUserActionSkypeTextTarget
@end

@implementation CNUIUserActionSkypeTextTarget

id __90___CNUIUserActionSkypeTextTarget_actionsForEmailAddresses_contact_discoveringEnvironment___block_invoke(uint64_t a1, void *a2)
{
  id v3 = a2;
  if ([v3 isSuggested])
  {
  ...
  else
  {
    ...
    v7 = objc_msgSend(NSURL, "_cnui_skypeTextURLFutureWithHandle:", v6);
...
id __88___CNUIUserActionSkypeTextTarget_actionsForPhoneNumbers_contact_discoveringEnvironment___block_invoke(uint64_t a1, void *a2)
{
  id v3 = a2;
  if ([v3 isSuggested])
  {
  ...
  else
  {
    ...
    v8 = objc_msgSend(NSURL, "_cnui_skypeTextURLFutureWithHandle:", v7);
