@interface CNUIUserActionMessagesTextTarget
@end
...
id __93___CNUIUserActionMessagesTextTarget_actionsForEmailAddresses_contact_discoveringEnvironment___block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    v7 = objc_msgSend(NSURL, "_cnui_messagesURLFutureWithHandle:contact:", v6, *(void *)(a1 + 32));
    ...
    v4 = +[CNUIUserActionItem itemWithType:v13 contactProperty:v12 bundleIdentifier:v14 url:v7 group:3 options:0];
  }
  return v4;
}
...
id __91___CNUIUserActionMessagesTextTarget_actionsForPhoneNumbers_contact_discoveringEnvironment___block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    v8 = objc_msgSend(NSURL, "_cnui_messagesURLFutureWithHandle:contact:", v7, *(void *)(a1 + 32));
    ...
    v4 = +[CNUIUserActionItem itemWithType:v14 contactProperty:v13 bundleIdentifier:v15 url:v8 group:3 options:0];
  }
  return v4;
}
