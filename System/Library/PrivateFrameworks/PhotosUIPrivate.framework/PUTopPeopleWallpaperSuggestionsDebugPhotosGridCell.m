@interface PUTopPeopleWallpaperSuggestionsDebugPhotosGridCell
- (NSString)score;
- (void)layoutSubviews;
- (void)setScore:(id)a3;
@end

@implementation PUTopPeopleWallpaperSuggestionsDebugPhotosGridCell
...
{
  v11.receiver = self;
  v11.super_class = (Class)PUTopPeopleWallpaperSuggestionsDebugPhotosGridCell;
  ...
  if (!self->_scoreLabel)
  {
    ...
    [(PUTopPeopleWallpaperSuggestionsDebugPhotosGridCell *)self addSubview:self->_scoreLabel];
  }
  [(PUTopPeopleWallpaperSuggestionsDebugPhotosGridCell *)self bounds];
  -[UILabel setFrame:](self->_scoreLabel, "setFrame:", v9 + -40.0, v10 + -20.0, 35.0, 15.0);
}
