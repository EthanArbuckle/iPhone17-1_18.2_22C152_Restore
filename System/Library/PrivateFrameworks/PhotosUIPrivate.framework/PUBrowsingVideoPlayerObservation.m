...
- (PUBrowsingVideoPlayerObservation)initWithViewModel:(id)a3 changeHandler:(id)a4
{
  ...
  id v12 = v6;
  v10.receiver = self;
  v10.super_class = (Class)PUBrowsingVideoPlayerObservation;
  id v7 = v6;
...
uint64_t __68__PUBrowsingVideoPlayerObservation_initWithViewModel_changeHandler___block_invoke(uint64_t a1)
{
