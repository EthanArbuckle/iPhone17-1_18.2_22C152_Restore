...
LABEL_4:
        ...
        [v7 executeWithUndoManager:v8 completionHandler:&__block_literal_global_756];
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1AE9F8000, v9, OS_LOG_TYPE_INFO, "No valid assets to apply audio mix, aborting.", buf, 2u);
  }
...
void __94__PUPXPhotoKitAudioMixModeActionPerformer_canPerformWithSelectionSnapshot_person_socialGroup___block_invoke(uint64_t a1, void *a2, unsigned char *a3)
{
  id v6 = a2;
