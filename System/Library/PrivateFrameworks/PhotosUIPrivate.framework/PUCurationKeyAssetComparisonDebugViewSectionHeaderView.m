@interface PUCurationKeyAssetComparisonDebugViewSectionHeaderView
- (NSString)subtitle;
- (NSString)title;
...
- (void)layoutSubviews
{
  ...
  [(PUCurationKeyAssetComparisonDebugViewSectionHeaderView *)&v7 layoutSubviews];
  [(PUCurationKeyAssetComparisonDebugViewSectionHeaderView *)self bounds];
  double v4 = v3;
...
- (PUCurationKeyAssetComparisonDebugViewSectionHeaderView)initWithFrame:(CGRect)a3
{
  ...
  double v3 = -[PUCurationKeyAssetComparisonDebugViewSectionHeaderView initWithFrame:](&v17, sel_initWithFrame_, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  double v4 = v3;
  if (v3)
  {
    [(PUCurationKeyAssetComparisonDebugViewSectionHeaderView *)v3 bounds];
    double v6 = v5;
    [(PUCurationKeyAssetComparisonDebugViewSectionHeaderView *)v4 bounds];
    v8 = objc_msgSend(objc_alloc(MEMORY[0x1E4FB1EB0]), "initWithFrame:", 0.0, 3.0, v6, v7 + -4.0);
    v9 = [MEMORY[0x1E4FB1618] lightGrayColor];
    [v8 setBackgroundColor:v9];

    [(PUCurationKeyAssetComparisonDebugViewSectionHeaderView *)v4 addSubview:v8];
    ...
    [(PUCurationKeyAssetComparisonDebugViewSectionHeaderView *)v4 addSubview:v4->_titleLabel];
    ...
    [(PUCurationKeyAssetComparisonDebugViewSectionHeaderView *)v4 addSubview:v4->_subtitleLabel];
  }
  return v4;
}
