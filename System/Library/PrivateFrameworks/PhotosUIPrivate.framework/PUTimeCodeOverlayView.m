...
- (void)updateTimeDisplay
{
  ...
  int v4 = [v3 showFrameNumberOnVideoScrubber];
...
- (void)didMoveToSuperview
{
  ...
  int v4 = objc_opt_new();
  id v5 = [MEMORY[0x1E4FB14C8] effectWithStyle:6];
  v6 = (void *)[objc_alloc(MEMORY[0x1E4FB1F00]) initWithEffect:v5];
  ...
  v11 = (objc_class *)MEMORY[0x1E4FB1930];
  id v12 = v6;
  ...
  [MEMORY[0x1E4F28DC8] activateConstraints:self->_overlayConstraints];
  [(PUTimeCodeOverlayView *)self updateTimeDisplay];
}
