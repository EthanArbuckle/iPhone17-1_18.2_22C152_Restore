...
- (unint64_t)hash
{
  ...
  float pommesProbability = self->_pommesProbability;
  float v4 = -pommesProbability;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((unsigned char *)v4 + 12) & 1) != 0 && self->_pommesProbability == *((float *)v4 + 2))
    {
      BOOL v5 = 1;
      goto LABEL_7;
    }
...
- (id)dictionaryRepresentation
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    *(float *)&double v4 = self->_pommesProbability;
...
- (id)description
{
  ...
  double v4 = [(SIRINLUINTERNALPSCPSCServiceResponse *)&v8 description];
  BOOL v5 = [(SIRINLUINTERNALPSCPSCServiceResponse *)self dictionaryRepresentation];
...
{
  *(unsigned char *)&self->_has |= 1u;
  self->_float pommesProbability = a3;
}
