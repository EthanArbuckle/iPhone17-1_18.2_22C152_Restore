...
- (void)setHasContextualReference:(BOOL)a3;
...
- (unint64_t)hash
{
  ...
  {
    uint64_t v2 = 2654435761 * self->_contextualReference;
...
LABEL_3:
  uint64_t v3 = 2654435761 * self->_disambiguationNeeded;
  return v3 ^ v2;
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (has)
  {
    *((unsigned char *)result + 8) = self->_contextualReference;
    *((unsigned char *)result + 12) |= 1u;
    char has = (char)self->_has;
  }
  if ((has & 2) != 0)
  {
    *((unsigned char *)result + 9) = self->_disambiguationNeeded;
...
- (BOOL)readFrom:(id)a3
{
  return SIRINLUEXTERNALReferenceContextReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    BOOL v5 = [NSNumber numberWithBool:self->_contextualReference];
  ...
  if ((has & 2) != 0)
  {
    id v6 = [NSNumber numberWithBool:self->_disambiguationNeeded];
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SIRINLUEXTERNALReferenceContext;
  id v4 = [(SIRINLUEXTERNALReferenceContext *)&v8 description];
  BOOL v5 = [(SIRINLUEXTERNALReferenceContext *)self dictionaryRepresentation];
