@interface SIRINLUEXTERNALUserWantedToUndo
- (BOOL)hasReference;
- (BOOL)hasTaskId;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
@implementation SIRINLUEXTERNALUserWantedToUndo
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    -[SIRINLUEXTERNALUserWantedToUndo setTaskId:](self, "setTaskId:");
  }
  v4 = v9;
LABEL_7:
  ...
  {
    -[SIRINLUEXTERNALUserWantedToUndo setReference:](self, "setReference:");
  }
  MEMORY[0x1F41817F8]();
}
...
- (BOOL)readFrom:(id)a3
{
  return SIRINLUEXTERNALUserWantedToUndoReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SIRINLUEXTERNALUserWantedToUndo;
  id v4 = [(SIRINLUEXTERNALUserWantedToUndo *)&v8 description];
  id v5 = [(SIRINLUEXTERNALUserWantedToUndo *)self dictionaryRepresentation];
