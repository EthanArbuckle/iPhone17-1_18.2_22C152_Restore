...
- (void)mergeFrom:(id)a3
{
  ...
  {
    -[SIRINLUINTERNALITFMITFMParserRequest setRequestId:](self, "setRequestId:");
  }
  ...
  {
    -[SIRINLUINTERNALITFMITFMParserRequest setTokenisedUtterance:](self, "setTokenisedUtterance:");
  }
  ...
  {
    -[SIRINLUINTERNALITFMITFMParserRequest setEmbeddings:](self, "setEmbeddings:");
  }
  long long v24 = 0u;
  long long v25 = 0u;
  long long v22 = 0u;
  ...
  if (v12)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v13; ++i)
      {
        ...
        -[SIRINLUINTERNALITFMITFMParserRequest addMatchingSpans:](self, "addMatchingSpans:", *(void *)(*((void *)&v22 + 1) + 8 * i), (void)v22);
      }
  ...
  {
    -[SIRINLUINTERNALITFMITFMParserRequest setTurnInput:](self, "setTurnInput:");
  }
  parser = self->_parser;
  ...
  {
    -[SIRINLUINTERNALITFMITFMParserRequest setParser:](self, "setParser:");
  }
  ...
  {
    -[SIRINLUINTERNALITFMITFMParserRequest setNluRequestId:](self, "setNluRequestId:");
  }
}
...
- (unint64_t)hash
{
  ...
  unint64_t v8 = v7 ^ [(SIRINLUEXTERNALParser *)self->_parser hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()]
    ...
    && ((parser = self->_parser, !((unint64_t)parser | v4[4]))
     || -[SIRINLUEXTERNALParser isEqual:](parser, "isEqual:")))
  {
    nluRequestId = self->_nluRequestId;
    if ((unint64_t)nluRequestId | v4[3]) {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v20 = [(SIRINLUEXTERNALParser *)self->_parser copyWithZone:a3];
...
- (void)copyTo:(id)a3
{
  ...
  if ([(SIRINLUINTERNALITFMITFMParserRequest *)self matchingSpansCount])
  {
    ...
    unint64_t v4 = [(SIRINLUINTERNALITFMITFMParserRequest *)self matchingSpansCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        unint64_t v7 = [(SIRINLUINTERNALITFMITFMParserRequest *)self matchingSpansAtIndex:i];
...
- (BOOL)readFrom:(id)a3
{
  return SIRINLUINTERNALITFMITFMParserRequestReadFrom((id *)&self->super.super.super.isa, (uint64_t)a3);
}
...
- (id)dictionaryRepresentation
{
  ...
  if (parser)
  {
    id v20 = [(SIRINLUEXTERNALParser *)parser dictionaryRepresentation];
    [v3 setObject:v20 forKey:@"parser"];
  }
  nluRequestId = self->_nluRequestId;
  if (nluRequestId)
  {
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SIRINLUINTERNALITFMITFMParserRequest;
  id v4 = [(SIRINLUINTERNALITFMITFMParserRequest *)&v8 description];
  unint64_t v5 = [(SIRINLUINTERNALITFMITFMParserRequest *)self dictionaryRepresentation];
