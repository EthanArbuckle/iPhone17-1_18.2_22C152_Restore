...
- (BOOL)readFrom:(id)a3
{
  return SIRINLUINTERNALMentionDetectorSpanDataReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)SIRINLUINTERNALMentionDetectorSpanData;
  id v4 = [(SIRINLUINTERNALMentionDetectorSpanData *)&v8 description];
  BOOL v5 = [(SIRINLUINTERNALMentionDetectorSpanData *)self dictionaryRepresentation];
