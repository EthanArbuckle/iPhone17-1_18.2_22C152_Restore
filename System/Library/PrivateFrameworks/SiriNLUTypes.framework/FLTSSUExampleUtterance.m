...
- (FLTSSUExampleUtterance)initWithFlatbuffData:(id)a3;
- (FLTSSUExampleUtterance)initWithFlatbuffData:(id)a3 root:(const SSUExampleUtterance *)a4;
...
- (Offset<SSUExampleUtterance>)addObjectToBuffer:(void *)a3
{
  ...
  *((unsigned char *)a3 + 70) = 1;
  ...
  return (Offset<SSUExampleUtterance>)apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable((apple::aiml::flatbuffers2::FlatBufferBuilder *)a3, v8);
}
...
- (FLTSSUExampleUtterance)initWithFlatbuffData:(id)a3 root:(const SSUExampleUtterance *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FLTSSUExampleUtterance;
  uint64_t v10 = [(FLTSSUExampleUtterance *)&v26 init];
  if (!v10) {
    goto LABEL_14;
  }
  if (!v9 || ![v9 length]) {
  ...
  if (!a4)
  {
    ...
    a4 = (const SSUExampleUtterance *)v12 + *v12;
  }
  v10->_root = a4;
  if (!v5) {
    goto LABEL_14;
  ...
  v19 = (SSUExampleUtterance *)v10->_root;
  if (v19 && !SSUExampleUtterance::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_15:
  }
    v20 = 0;
  else {
...
- (FLTSSUExampleUtterance)initWithFlatbuffData:(id)a3 root:(const SSUExampleUtterance *)a4
{
  return [(FLTSSUExampleUtterance *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FLTSSUExampleUtterance *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FLTSSUExampleUtterance)initWithFlatbuffData:(id)a3
{
  return [(FLTSSUExampleUtterance *)self initWithFlatbuffData:a3 root:0 verify:0];
}
