@interface SIRINLUEXTERNALUserWantedToPause
- (BOOL)hasReference;
- (BOOL)hasTaskId;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
...
@implementation SIRINLUEXTERNALUserWantedToPause
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    -[SIRINLUEXTERNALUserWantedToPause setTaskId:](self, "setTaskId:");
  }
  v4 = v9;
LABEL_7:
  ...
  {
    -[SIRINLUEXTERNALUserWantedToPause setReference:](self, "setReference:");
  }
  MEMORY[0x1F41817F8]();
}
...
- (BOOL)readFrom:(id)a3
{
  return SIRINLUEXTERNALUserWantedToPauseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SIRINLUEXTERNALUserWantedToPause;
  id v4 = [(SIRINLUEXTERNALUserWantedToPause *)&v8 description];
  id v5 = [(SIRINLUEXTERNALUserWantedToPause *)self dictionaryRepresentation];
