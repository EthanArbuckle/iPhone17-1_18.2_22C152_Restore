  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SIRINLUINTERNALNLV4_PARSERNLv4ParserResponse addHypotheses:](self, "addHypotheses:", *(void *)(*((void *)&v9 + 1) + 8 * v8++), (void)v9);
      }
      while (v6 != v8);
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v8 clearHypotheses];
    unint64_t v4 = [(SIRINLUINTERNALNLV4_PARSERNLv4ParserResponse *)self hypothesesCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(SIRINLUINTERNALNLV4_PARSERNLv4ParserResponse *)self hypothesesAtIndex:i];
        [v8 addHypotheses:v7];
      }
    }
  }
...
- (id)description
{
  ...
  id v4 = [(SIRINLUINTERNALNLV4_PARSERNLv4ParserResponse *)&v8 description];
  unint64_t v5 = [(SIRINLUINTERNALNLV4_PARSERNLv4ParserResponse *)self dictionaryRepresentation];
