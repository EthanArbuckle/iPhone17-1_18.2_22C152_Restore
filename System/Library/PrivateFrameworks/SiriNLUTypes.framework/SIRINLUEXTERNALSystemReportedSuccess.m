...
- (unint64_t)hash
{
  ...
  return [(SIRINLUEXTERNALUsoGraph *)self->_task hash] ^ v3;
}
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[SIRINLUEXTERNALUUID isEqual:](taskId, "isEqual:")))
  {
    ...
    if ((unint64_t)task | v4[1]) {
      char v7 = -[SIRINLUEXTERNALUsoGraph isEqual:](task, "isEqual:");
    }
    else {
      char v7 = 1;
    }
...
- (id)dictionaryRepresentation
{
  ...
  if (task)
  {
    char v7 = [(SIRINLUEXTERNALUsoGraph *)task dictionaryRepresentation];
...
- (id)description
{
  ...
  id v4 = [(SIRINLUEXTERNALSystemReportedSuccess *)&v8 description];
  id v5 = [(SIRINLUEXTERNALSystemReportedSuccess *)self dictionaryRepresentation];
