...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    -[SIRINLUEXTERNALUserAccepted setOfferId:](self, "setOfferId:");
  }
  v4 = v9;
LABEL_7:
  ...
  {
    -[SIRINLUEXTERNALUserAccepted setReference:](self, "setReference:");
  }
  MEMORY[0x1F41817F8]();
}
...
- (unint64_t)hash
{
  unint64_t v3 = [(SIRINLUEXTERNALUUID *)self->_offerId hash];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v6 = [(SIRINLUEXTERNALUUID *)self->_offerId copyWithZone:a3];
  char v7 = (void *)v5[1];
  v5[1] = v6;
...
- (BOOL)readFrom:(id)a3
{
  return SIRINLUEXTERNALUserAcceptedReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)dictionaryRepresentation
{
  ...
  if (offerId)
  {
    id v5 = [(SIRINLUEXTERNALUUID *)offerId dictionaryRepresentation];
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SIRINLUEXTERNALUserAccepted;
  id v4 = [(SIRINLUEXTERNALUserAccepted *)&v8 description];
  id v5 = [(SIRINLUEXTERNALUserAccepted *)self dictionaryRepresentation];
