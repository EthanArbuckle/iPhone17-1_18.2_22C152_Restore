...
- (void)mergeFrom:(id)a3
{
  ...
  {
    -[SIRINLUINTERNALSNLP_INTERMEDIATEContextFeaturizerResponse setTensor:](self, "setTensor:");
  }
  MEMORY[0x1F41817F8]();
}
...
- (BOOL)readFrom:(id)a3
{
  return SIRINLUINTERNALSNLP_INTERMEDIATEContextFeaturizerResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)SIRINLUINTERNALSNLP_INTERMEDIATEContextFeaturizerResponse;
  v4 = [(SIRINLUINTERNALSNLP_INTERMEDIATEContextFeaturizerResponse *)&v8 description];
  v5 = [(SIRINLUINTERNALSNLP_INTERMEDIATEContextFeaturizerResponse *)self dictionaryRepresentation];
