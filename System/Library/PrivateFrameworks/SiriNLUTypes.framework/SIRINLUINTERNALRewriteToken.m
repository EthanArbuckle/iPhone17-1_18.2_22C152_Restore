...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)v4 + 5))
  {
    -[SIRINLUINTERNALRewriteToken setValue:](self, "setValue:");
    id v4 = v6;
  }
...
LABEL_7:
  if (*((void *)v4 + 3))
  {
    -[SIRINLUINTERNALRewriteToken setPhoneSequence:](self, "setPhoneSequence:");
    id v4 = v6;
  }
...
- (BOOL)readFrom:(id)a3
{
  return SIRINLUINTERNALRewriteTokenReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SIRINLUINTERNALRewriteToken;
  id v4 = [(SIRINLUINTERNALRewriteToken *)&v8 description];
  uint64_t v5 = [(SIRINLUINTERNALRewriteToken *)self dictionaryRepresentation];
