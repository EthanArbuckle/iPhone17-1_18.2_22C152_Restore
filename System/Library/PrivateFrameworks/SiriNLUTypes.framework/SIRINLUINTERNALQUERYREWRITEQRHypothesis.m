...
- (id)description
{
  ...
  id v4 = [(SIRINLUINTERNALQUERYREWRITEQRHypothesis *)&v8 description];
  uint64_t v5 = [(SIRINLUINTERNALQUERYREWRITEQRHypothesis *)self dictionaryRepresentation];
...
+ (id)options
{
  if (options_once_3363 != -1) {
    dispatch_once(&options_once_3363, &__block_literal_global_3364);
  }
  v2 = (void *)options_sOptions_3365;
  return v2;
}

void __50__SIRINLUINTERNALQUERYREWRITEQRHypothesis_options__block_invoke()
{
  v0 = (void *)options_sOptions_3365;
  options_sOptions_3365 = (uint64_t)&unk_1F234AA10;
}
