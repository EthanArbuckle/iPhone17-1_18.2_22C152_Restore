...
- (void)mergeFrom:(id)a3
{
  ...
  {
    -[SIRINLUINTERNALSNLCSNLCParserRequest setRequestId:](self, "setRequestId:");
  }
  ...
  {
    -[SIRINLUINTERNALSNLCSNLCParserRequest setTokenisedUtterance:](self, "setTokenisedUtterance:");
  }
  ...
  {
    -[SIRINLUINTERNALSNLCSNLCParserRequest setEmbeddings:](self, "setEmbeddings:");
  }
  long long v24 = 0u;
  long long v25 = 0u;
  long long v22 = 0u;
  ...
  if (v12)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v13; ++i)
      {
        ...
        -[SIRINLUINTERNALSNLCSNLCParserRequest addMatchingSpans:](self, "addMatchingSpans:", *(void *)(*((void *)&v22 + 1) + 8 * i), (void)v22);
      }
  ...
  {
    -[SIRINLUINTERNALSNLCSNLCParserRequest setTurnInput:](self, "setTurnInput:");
  }
  ...
  {
    -[SIRINLUINTERNALSNLCSNLCParserRequest setLegacyContext:](self, "setLegacyContext:");
  }
  ...
  {
    -[SIRINLUINTERNALSNLCSNLCParserRequest setNluRequestId:](self, "setNluRequestId:");
  }
}
...
- (void)copyTo:(id)a3
{
  ...
  if ([(SIRINLUINTERNALSNLCSNLCParserRequest *)self matchingSpansCount])
  {
    ...
    unint64_t v4 = [(SIRINLUINTERNALSNLCSNLCParserRequest *)self matchingSpansCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        unint64_t v7 = [(SIRINLUINTERNALSNLCSNLCParserRequest *)self matchingSpansAtIndex:i];
...
- (BOOL)readFrom:(id)a3
{
  return SIRINLUINTERNALSNLCSNLCParserRequestReadFrom((id *)&self->super.super.super.isa, (uint64_t)a3);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SIRINLUINTERNALSNLCSNLCParserRequest;
  id v4 = [(SIRINLUINTERNALSNLCSNLCParserRequest *)&v8 description];
  unint64_t v5 = [(SIRINLUINTERNALSNLCSNLCParserRequest *)self dictionaryRepresentation];
