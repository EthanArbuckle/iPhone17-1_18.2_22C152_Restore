...
- (unint64_t)hash
{
  return [(SIRINLUINTERNALSNLP_INTERMEDIATEContextFeaturizerResponse *)self->_response hash];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((unint64_t)response | v4[1]) {
      char v6 = -[SIRINLUINTERNALSNLP_INTERMEDIATEContextFeaturizerResponse isEqual:](response, "isEqual:");
    }
    else {
      char v6 = 1;
    }
...
- (id)description
{
  ...
  v5 = [(SIRINLUINTERNALSNLP_INTERMEDIATENLv4ContextFeaturizerResponse *)self dictionaryRepresentation];
