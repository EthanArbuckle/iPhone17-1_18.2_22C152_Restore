...
- (BOOL)readFrom:(id)a3
{
  return SIRICOMMONBoolValueReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)SIRICOMMONBoolValue;
  v4 = [(SIRICOMMONBoolValue *)&v8 description];
  BOOL v5 = [(SIRICOMMONBoolValue *)self dictionaryRepresentation];
