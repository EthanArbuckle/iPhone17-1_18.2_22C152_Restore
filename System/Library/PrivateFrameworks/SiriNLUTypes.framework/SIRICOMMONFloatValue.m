...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((unsigned char *)v4 + 12) & 1) != 0 && self->_value == *((float *)v4 + 2))
    {
      BOOL v5 = 1;
      goto LABEL_7;
    }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (*(unsigned char *)&self->_has)
  {
    *((_DWORD *)result + 2) = LODWORD(self->_value);
...
- (void)copyTo:(id)a3
{
  if (*(unsigned char *)&self->_has)
  {
    *((_DWORD *)a3 + 2) = LODWORD(self->_value);
...
- (BOOL)readFrom:(id)a3
{
  return SIRICOMMONFloatValueReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)SIRICOMMONFloatValue;
  double v4 = [(SIRICOMMONFloatValue *)&v8 description];
  BOOL v5 = [(SIRICOMMONFloatValue *)self dictionaryRepresentation];
