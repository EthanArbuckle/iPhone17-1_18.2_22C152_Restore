...
- (FLTSSUIntent)initWithFlatbuffData:(id)a3;
- (FLTSSUIntent)initWithFlatbuffData:(id)a3 root:(const SSUIntent *)a4;
...
- (Offset<SSUIntent>)addObjectToBuffer:(void *)a3
{
  ...
  uint64_t v5 = [(FLTSSUIntent *)self name];
  char v6 = v5;
  if (!v5) {
  ...
  long long v9 = [(FLTSSUIntent *)self parameters];
  ...
  long long v71 = 0u;
  long long v72 = 0u;
  v14 = [(FLTSSUIntent *)self parameters];
  ...
  if (v17 == v11) {
    v29 = (char *)&apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<SSUIntentParameter>,std::allocator<apple::aiml::flatbuffers2::Offset<SSUIntentParameter>>>(std::vector<apple::aiml::flatbuffers2::Offset<SSUIntentParameter>> const&)::t;
  }
  else {
    v29 = v11;
  }
...
- (void)examples_enumerateObjectsUsingBlock:(id)a3
{
  ...
  uint64_t v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"examples"];
  char v6 = v5;
  if (v5)
  {
...
- (id)examples_objectAtIndex:(unint64_t)a3
{
  unint64_t v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"examples"];
  char v6 = v5;
  if (v5)
  {
...
- (NSArray)examples
{
  id v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"examples"];
  if (!v3)
  {
...
uint64_t __24__FLTSSUIntent_examples__block_invoke(uint64_t a1, uint64_t a2)
{
...
- (void)parameters_enumerateObjectsUsingBlock:(id)a3
{
  v4 = (void (**)(id, FLTSSUIntentParameter *, uint64_t, unsigned __int8 *))a3;
  unint64_t v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"parameters"];
  char v6 = v5;
  if (v5)
  {
    [v5 enumerateObjectsUsingBlock:v4];
    ...
    if (*(unsigned __int16 *)v8->var0 >= 7u)
    {
      ...
      if (v9)
      {
        ...
        if (v12)
        {
          ...
          do
          {
            uint64_t v16 = [[FLTSSUIntentParameter alloc] initWithFlatbuffData:self->_data root:&v13[*(unsigned int *)v13->var0] verify:0];
            v4[2](v4, v16, v14, &v19);
            int v17 = v19;
...
- (unint64_t)parameters_count
{
  id v3 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"parameters"];
  v4 = v3;
  if (v3)
  {
    unint64_t v5 = [v3 count];
...
LABEL_3:
  ...
  if (*(unsigned __int16 *)v10->var0 >= 7u)
  {
    ...
    if (v11)
    {
      ...
      id v7 = [[FLTSSUIntentParameter alloc] initWithFlatbuffData:self->_data root:&v12[4 * a3 + 4 + *(unsigned int *)v12[4 * a3 + 4].var0] verify:0];
      goto LABEL_3;
    }
  }
  uint64_t v8 = 0;
...
uint64_t __26__FLTSSUIntent_parameters__block_invoke(uint64_t a1, uint64_t a2)
{
  return [*(id *)(a1 + 32) addObject:a2];
}
...
- (FLTSSUIntent)initWithFlatbuffData:(id)a3 root:(const SSUIntent *)a4 verify:(BOOL)a5
{
  ...
  id v9 = a3;
  v26.receiver = self;
  v26.super_class = (Class)FLTSSUIntent;
  unint64_t v10 = [(FLTSSUIntent *)&v26 init];
  if (!v10) {
    goto LABEL_14;
  }
  if (!v9 || ![v9 length]) {
  ...
  unsigned __int8 v19 = (SSUIntent *)v10->_root;
  if (v19 && !SSUIntent::Verify(v19, (apple::aiml::flatbuffers2::Verifier *)v22)) {
LABEL_15:
  }
    int v20 = 0;
  else {
...
- (FLTSSUIntent)initWithFlatbuffData:(id)a3 root:(const SSUIntent *)a4
{
  return [(FLTSSUIntent *)self initWithFlatbuffData:a3 root:a4 verify:0];
}

- (id)initAndVerifyWithFlatbuffData:(id)a3
{
  return [(FLTSSUIntent *)self initWithFlatbuffData:a3 root:0 verify:1];
}

- (FLTSSUIntent)initWithFlatbuffData:(id)a3
{
  return [(FLTSSUIntent *)self initWithFlatbuffData:a3 root:0 verify:0];
}
