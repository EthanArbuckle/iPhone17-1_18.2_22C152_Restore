...
- (void)mergeFrom:(id)a3
{
  ...
  {
    -[SIRINLUINTERNALMENTION_RESOLVERMentionResolverResponse setRequestId:](self, "setRequestId:");
  }
  long long v14 = 0u;
  long long v15 = 0u;
  long long v12 = 0u;
  ...
  if (v8)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v9; ++i)
      {
        ...
        -[SIRINLUINTERNALMENTION_RESOLVERMentionResolverResponse addMentions:](self, "addMentions:", *(void *)(*((void *)&v12 + 1) + 8 * i), (void)v12);
      }
  ...
  if (*((void *)v4 + 3)) {
    -[SIRINLUINTERNALMENTION_RESOLVERMentionResolverResponse setRewrittenUtterance:](self, "setRewrittenUtterance:");
  }
}
...
- (unint64_t)hash
{
  ...
  uint64_t v4 = [(NSMutableArray *)self->_mentions hash] ^ v3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()]
    ...
    && ((mentions = self->_mentions, !((unint64_t)mentions | v4[1]))
     || -[NSMutableArray isEqual:](mentions, "isEqual:")))
  {
    rewrittenUtterance = self->_rewrittenUtterance;
    if ((unint64_t)rewrittenUtterance | v4[3]) {
      char v8 = -[NSString isEqual:](rewrittenUtterance, "isEqual:");
    }
    else {
      char v8 = 1;
    }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  uint64_t v14 = [(NSString *)self->_rewrittenUtterance copyWithZone:a3];
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v8 clearMentions];
    unint64_t v4 = [(SIRINLUINTERNALMENTION_RESOLVERMentionResolverResponse *)self mentionsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        id v7 = [(SIRINLUINTERNALMENTION_RESOLVERMentionResolverResponse *)self mentionsAtIndex:i];
        [v8 addMentions:v7];
      }
    }
  }
  if (self->_rewrittenUtterance) {
    objc_msgSend(v8, "setRewrittenUtterance:");
  }
}
...
- (BOOL)readFrom:(id)a3
{
  return SIRINLUINTERNALMENTION_RESOLVERMentionResolverResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SIRINLUINTERNALMENTION_RESOLVERMentionResolverResponse;
  id v4 = [(SIRINLUINTERNALMENTION_RESOLVERMentionResolverResponse *)&v8 description];
  unint64_t v5 = [(SIRINLUINTERNALMENTION_RESOLVERMentionResolverResponse *)self dictionaryRepresentation];
