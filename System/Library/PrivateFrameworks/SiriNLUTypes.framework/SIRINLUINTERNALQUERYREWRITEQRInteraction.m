...
- (void)mergeFrom:(id)a3
{
  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        [(SIRINLUINTERNALQUERYREWRITEQRInteraction *)self addOriginalUtterances:*(void *)(*((void *)&v20 + 1) + 8 * i)];
      }
  ...
  if (v11)
  {
    ...
    do
    {
      for (uint64_t j = 0; j != v12; ++j)
      {
        ...
        -[SIRINLUINTERNALQUERYREWRITEQRInteraction addSiriResponse:](self, "addSiriResponse:", *(void *)(*((void *)&v16 + 1) + 8 * j), (void)v16);
      }
  ...
  if (*((void *)v4 + 2)) {
    -[SIRINLUINTERNALQUERYREWRITEQRInteraction setLocale:](self, "setLocale:");
  }
...
- (void)copyTo:(id)a3
{
  ...
  if ([(SIRINLUINTERNALQUERYREWRITEQRInteraction *)self originalUtterancesCount])
  {
    ...
    unint64_t v4 = [(SIRINLUINTERNALQUERYREWRITEQRInteraction *)self originalUtterancesCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(SIRINLUINTERNALQUERYREWRITEQRInteraction *)self originalUtterancesAtIndex:i];
  ...
  if ([(SIRINLUINTERNALQUERYREWRITEQRInteraction *)self siriResponsesCount])
  {
    ...
    unint64_t v8 = [(SIRINLUINTERNALQUERYREWRITEQRInteraction *)self siriResponsesCount];
    if (v8)
    {
      unint64_t v9 = v8;
      for (uint64_t j = 0; j != v9; ++j)
      {
        uint64_t v11 = [(SIRINLUINTERNALQUERYREWRITEQRInteraction *)self siriResponseAtIndex:j];
...
- (BOOL)readFrom:(id)a3
{
  return SIRINLUINTERNALQUERYREWRITEQRInteractionReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SIRINLUINTERNALQUERYREWRITEQRInteraction;
  id v4 = [(SIRINLUINTERNALQUERYREWRITEQRInteraction *)&v8 description];
  unint64_t v5 = [(SIRINLUINTERNALQUERYREWRITEQRInteraction *)self dictionaryRepresentation];
...
+ (id)options
{
  if (options_once_16588 != -1) {
    dispatch_once(&options_once_16588, &__block_literal_global_16589);
  }
  v2 = (void *)options_sOptions_16590;
  return v2;
}

void __51__SIRINLUINTERNALQUERYREWRITEQRInteraction_options__block_invoke()
{
  v0 = (void *)options_sOptions_16590;
  options_sOptions_16590 = (uint64_t)&unk_1F234AA60;
}
