...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    -[SIRINLUINTERNALSNLP_INTERMEDIATEITFMSpanFeaturizerResponse setResponse:](self, "setResponse:");
  }
  v4 = v7;
LABEL_7:
  if (v4[1]) {
    -[SIRINLUINTERNALSNLP_INTERMEDIATEITFMSpanFeaturizerResponse setModelType:](self, "setModelType:");
  }
  MEMORY[0x1F41817F8]();
}
...
- (unint64_t)hash
{
  unint64_t v3 = [(SIRINLUINTERNALSNLP_INTERMEDIATESpanFeaturizerResponse *)self->_response hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()]
    && ((response = self->_response, !((unint64_t)response | v4[2]))
     || -[SIRINLUINTERNALSNLP_INTERMEDIATESpanFeaturizerResponse isEqual:](response, "isEqual:")))
  {
...
- (BOOL)readFrom:(id)a3
{
  return SIRINLUINTERNALSNLP_INTERMEDIATEITFMSpanFeaturizerResponseReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)dictionaryRepresentation
{
  ...
  if (response)
  {
    id v5 = [(SIRINLUINTERNALSNLP_INTERMEDIATESpanFeaturizerResponse *)response dictionaryRepresentation];
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)SIRINLUINTERNALSNLP_INTERMEDIATEITFMSpanFeaturizerResponse;
  id v4 = [(SIRINLUINTERNALSNLP_INTERMEDIATEITFMSpanFeaturizerResponse *)&v8 description];
  id v5 = [(SIRINLUINTERNALSNLP_INTERMEDIATEITFMSpanFeaturizerResponse *)self dictionaryRepresentation];
