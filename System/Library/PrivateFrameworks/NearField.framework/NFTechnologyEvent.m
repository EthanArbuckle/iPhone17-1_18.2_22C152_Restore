...
- (id)description
{
  ...
  if ((technology & 4) != 0)
  {
    ...
    uint64_t v14 = [v4 initWithFormat:@"%@ { A=%d B=%d, F=%d SystemCode=0x%04x, VAS=%d, VAS Mode=0x%04x, VAS Supported=%s, TerminalType=%d, TouchIDRequired=%s }", v6, v16, v17, v18, self->_systemCode, v19, self->_valueAddedServiceMode, v21, self->_terminalType, v20];
  }
  else
  {
    v25.receiver = self;
    ...
    uint64_t v14 = [v4 initWithFormat:@"%@ { A=%d B=%d, F=%d, ECP=%d, VAS Mode=0x%04x, VAS Supported=%s, TerminalType=%d, TouchIDRequired=%s }", v5, v8, v9, v10, v11, self->_valueAddedServiceMode, v13, self->_terminalType, v12, v24];
  }
  v22 = (void *)v14;
