...
- (id)description
{
  ...
  v5 = (void *)[v3 initWithFormat:@"%@ { applet=%@ endpoint=%@ select=0x%04x mode=0x%04x spid=%@ background=%d }", v4, self->_appletIdentifier, self->_keyIdentifier, self->_selectStatus, self->_paymentMode, self->_spIdentifier, self->_background];
...
- (id)asDictionary
{
  ...
  v10 = objc_msgSend(v3, "initWithObjectsAndKeys:", appletIdentifier, @"applet", keyIdentifier, @"endpoint", v6, @"selectStatus", v7, @"mode", spIdentifier, @"spIdentifier", v9, @"background", 0);
