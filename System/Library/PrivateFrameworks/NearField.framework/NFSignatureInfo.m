...
- (id)description
{
  ...
  v5 = (void *)v4;
  jsblCounter = &stru_1EEF24A78;
  seid = (__CFString *)self->_seid;
  platformId = (__CFString *)self->_platformId;
  if (!seid) {
    seid = &stru_1EEF24A78;
  }
  if (!platformId) {
    platformId = &stru_1EEF24A78;
  }
  if (self->_jsblCounter) {
    jsblCounter = (__CFString *)self->_jsblCounter;
  }
  v9 = (void *)[v3 initWithFormat:@"%@ { seid=%@ platformId=%@ jsblCounter=%@ certificateVersion=%lu }", v4, seid, platformId, jsblCounter, self->_certificateVersion];
