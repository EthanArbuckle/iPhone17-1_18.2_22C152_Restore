...
- (id)description
{
  ...
  v5 = (void *)[v3 initWithFormat:@"%@ { merchantID=%@ type=%d token=%@ passData=%@ userInterventionRequired=%d }", v4, self->_identifier, self->_type, self->_token, self->_data, self->_userInterventionRequired];
...
- (id)asDictionary
{
  ...
  v9 = objc_msgSend(v3, "initWithObjectsAndKeys:", identifier, @"merchantID", v5, @"type", token, @"token", data, @"passData", v8, @"userInterventionRequired", 0);
