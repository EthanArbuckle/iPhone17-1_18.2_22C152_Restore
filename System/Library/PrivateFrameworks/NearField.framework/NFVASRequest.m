...
- (id)description
{
  ...
  v5 = (void *)[v3 initWithFormat:@"%@ protocol=0x%04x capability=0x%04x merchantId=%@ url=%@ filter=%@", v4, -[NSNumber unsignedIntValue](self->_terminalProtocol, "unsignedIntValue"), -[NSNumber unsignedIntValue](self->_terminalCap, "unsignedIntValue"), self->_merchantId, self->_signupUrl, self->_filter];
