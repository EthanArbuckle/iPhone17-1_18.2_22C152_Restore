...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (v5)
  {
    uint64_t v6 = [(NSString *)self->_uri copyWithZone:a3];
...
- (id)description
{
  ...
  id v5 = (void *)[v3 initWithFormat:@"{uri=%@, Nwait=%d, twait=%d, maxMsgSize=%d}", v4, -[NFTNEPService maxWaitTimeExtension](self, "maxWaitTimeExtension"), -[NFTNEPService minWaitTime](self, "minWaitTime"), -[NFTNEPService maxMessageSize](self, "maxMessageSize")];
