...
- (NFHardwareControllerInfo)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    objc_super v7 = [v4 objectForKeyedSubscript:@"siliconName"];
...
{
  v3 = objc_opt_new();
  id v4 = objc_msgSend([NSString alloc], "initWithFormat:", @"0x%04x", self->_siliconVersion);
  [v3 setObject:v4 forKeyedSubscript:@"siliconVersion"];

  id v5 = objc_msgSend([NSString alloc], "initWithFormat:", @"0x%04x", self->_siliconName);
  [v3 setObject:v5 forKeyedSubscript:@"siliconName"];

  v6 = objc_msgSend([NSString alloc], "initWithFormat:", @"0x%04x", self->_ROMVersion);
  [v3 setObject:v6 forKeyedSubscript:@"ROMVersion"];

  objc_super v7 = objc_msgSend([NSString alloc], "initWithFormat:", @"0x%04x", self->_firmwareVersion);
  [v3 setObject:v7 forKeyedSubscript:@"firmwareVersion"];

  v8 = objc_msgSend([NSString alloc], "initWithFormat:", @"0x%04x", self->_firmwareRevision);
  [v3 setObject:v8 forKeyedSubscript:@"firmwareRevision"];

  v9 = objc_msgSend([NSString alloc], "initWithFormat:", @"0x%04x", self->_middlewareVersion);
