...
- (id)description
{
  ...
  v12 = (void *)[v4 initWithFormat:@"<%s: tech=%@ sc=0x%X, oda=%d, terminalMode=%d, terminalType=%d, date=%@, cached=%d>", ClassName, v3, v8, odaRequired, terminalMode, terminalType, v11, -[NFFieldNotification cachedBeforeRFReset](self, "cachedBeforeRFReset")];
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      uint64_t v5 = v4;
      BOOL v6 = [(NFFieldNotificationECP1_0 *)v5 odaRequired];
      ...
      unsigned __int8 v11 = objc_msgSendSuper2((objc_super *)v10, *v9, v5, v13);
    }
    else
    {
