...
- (_TtC26DeepThoughtBiomeFoundation18ConversationStream)init;
...
- (_TtC26DeepThoughtBiomeFoundation18ConversationStream)init
{
  return (_TtC26DeepThoughtBiomeFoundation18ConversationStream *)sub_24C9D8D04(self, (uint64_t)a2, type metadata accessor for ConversationStream);
}
...
- (void)streamConversationsWithBookmark:(_TtC26DeepThoughtBiomeFoundation15StreamsBookmark *)a3 completionHandler:(id)a4
{
  ...
  v15 = a3;
  v16 = self;
  sub_24C9DCEF0((uint64_t)v9, (uint64_t)&unk_269804940, (uint64_t)v14);
  swift_release();
}
