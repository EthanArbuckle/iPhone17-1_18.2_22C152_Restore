...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    int v5 = [v4 keepInBackground];
    int v6 = v5 ^ [(UISScenePreservedPlacementConfiguration *)self keepInBackground] ^ 1;
  }
  else
  {
    LOBYTE(v6) = 0;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend(v4, "encodeBool:forKey:", -[UISScenePreservedPlacementConfiguration keepInBackground](self, "keepInBackground", v5.receiver, v5.super_class), @"kKeepInBackgroundKey");
}
...
{
  return (id)objc_msgSend(*(id *)(a1 + 32), "appendBool:withName:", objc_msgSend(*(id *)(a1 + 40), "keepInBackground"), @"keepInBackground");
}
