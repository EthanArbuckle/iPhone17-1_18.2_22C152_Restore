...
+ (id)zhuyinCharacterSet
{
  if (zhuyinCharacterSet___onceToken != -1) {
    dispatch_once(&zhuyinCharacterSet___onceToken, &__block_literal_global_23_16698);
  }
...
+ (id)zhuyinPhonemeCharacterSet
{
  if (zhuyinPhonemeCharacterSet___onceToken != -1) {
    dispatch_once(&zhuyinPhonemeCharacterSet___onceToken, &__block_literal_global_13_16706);
  }
...
+ (id)zhuyinVowelCharacterSet
{
  if (zhuyinVowelCharacterSet___onceToken != -1) {
    dispatch_once(&zhuyinVowelCharacterSet___onceToken, &__block_literal_global_8_16711);
  }
...
+ (id)zhuyinMedialCharacterSet
{
  if (zhuyinMedialCharacterSet___onceToken != -1) {
    dispatch_once(&zhuyinMedialCharacterSet___onceToken, &__block_literal_global_3_16716);
  }
...
+ (id)zhuyinConsonantCharacterSet
{
  if (zhuyinConsonantCharacterSet___onceToken != -1) {
    dispatch_once(&zhuyinConsonantCharacterSet___onceToken, &__block_literal_global_16721);
  }
