...
- (BOOL)_clientConnect:(id *)a3
{
  objc_msgSend(-[GTSharedMemoryTransport_tools_diagnostics _getSharedMemoryNameWithSuffix:](self, "_getSharedMemoryNameWithSuffix:", @"c"), "getCString:maxLength:encoding:", self->_sendName, 64, 1);
  objc_msgSend(-[GTSharedMemoryTransport_tools_diagnostics _getSharedMemoryNameWithSuffix:](self, "_getSharedMemoryNameWithSuffix:", @"s"), "getCString:maxLength:encoding:", self->_receiveName, 64, 1);
...
- (BOOL)_serverConnect:(id *)a3
{
  objc_msgSend(-[GTSharedMemoryTransport_tools_diagnostics _getSharedMemoryNameWithSuffix:](self, "_getSharedMemoryNameWithSuffix:", @"s"), "getCString:maxLength:encoding:", self->_sendName, 64, 1);
  objc_msgSend(-[GTSharedMemoryTransport_tools_diagnostics _getSharedMemoryNameWithSuffix:](self, "_getSharedMemoryNameWithSuffix:", @"c"), "getCString:maxLength:encoding:", self->_receiveName, 64, 1);
