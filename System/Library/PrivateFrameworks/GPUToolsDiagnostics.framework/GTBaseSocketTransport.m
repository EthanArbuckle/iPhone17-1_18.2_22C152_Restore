...
unsigned char *__63__GTBaseSocketTransport_createNewSharedMemoryTransportWithURL___block_invoke(uint64_t a1)
{
  ...
  if (!result[52])
  {
    ...
    v3 = [GTSharedMemoryTransport_tools_diagnostics alloc];
    uint64_t v4 = atomic_load((unsigned int *)(*(void *)(a1 + 32) + 40));
    *(void *)(*(void *)(a1 + 32) + 248) = [(GTSharedMemoryTransport_tools_diagnostics *)v3 initWithMode:2 initialMessageSerial:v4];
    if (*(void *)(a1 + 40)) {
    ...
    if ([*(id *)(a1 + 32) connected]) {
      objc_msgSend(objc_msgSend(*(id *)(*(void *)(a1 + 32) + 248), "connect"), "waitUntilResolved");
    }
