...
LABEL_16:
    ...
    return objc_msgSend(*(id *)(a1 + 40), "setResult:", +[NSNumber numberWithBool:](NSNumber, "numberWithBool:", v11));
  }
  objc_msgSend(*(id *)(a1 + 40), "setError:", +[GTError_tools_diagnostics errorWithDomain:code:userInfo:](GTError_tools_diagnostics, "errorWithDomain:code:userInfo:", @"DYErrorDomain", 32, 0));
  uint64_t v3 = 0;
LABEL_3:
  ...
  *(unsigned char *)(*(void *)(a1 + 32) + 304) = 0;
  ...
  if (result)
  {
    ...
    do
    {
      ...
      v13.receiver = v6;
      v13.super_class = (Class)GTSharedMemoryTransport_tools_diagnostics;
