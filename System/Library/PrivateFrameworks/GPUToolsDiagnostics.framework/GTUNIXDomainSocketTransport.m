...
id __38__GTUNIXDomainSocketTransport_connect__block_invoke(uint64_t a1)
{
  ...
  if (v2[52])
  {
    uint64_t v3 = 32;
LABEL_3:
    objc_msgSend(*(id *)(a1 + 40), "setError:", +[GTError_tools_diagnostics errorWithDomain:code:userInfo:](GTError_tools_diagnostics, "errorWithDomain:code:userInfo:", @"DYErrorDomain", v3, 0));
    uint64_t v4 = 0;
LABEL_6:
