...
- (NSData)jsonData
{
  v2 = [(RRSchemaProvisionalRREntityPoolResolveContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    id v4 = [(RRSchemaProvisionalRREntityPoolResolveContext *)self ended];
  ...
  if (self->_failed)
  {
    uint64_t v7 = [(RRSchemaProvisionalRREntityPoolResolveContext *)self failed];
  ...
  {
    v10 = [(RRSchemaProvisionalRREntityPoolResolveContext *)self startedOrChanged];
  ...
  [(RRSchemaProvisionalRREntityPoolResolveContext *)self willProduceDictionaryRepresentation:v3];
  return v3;
}

- (unint64_t)hash
{
  unint64_t v3 = [(RRSchemaProvisionalRREntityPoolResolveStarted *)self->_startedOrChanged hash];
  unint64_t v4 = [(RRSchemaProvisionalRREntityPoolResolveEnded *)self->_ended hash] ^ v3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  v6 = [(RRSchemaProvisionalRREntityPoolResolveContext *)self startedOrChanged];
  uint64_t v7 = [v4 startedOrChanged];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_17;
  }
  uint64_t v8 = [(RRSchemaProvisionalRREntityPoolResolveContext *)self startedOrChanged];
  if (v8)
  {
    v9 = (void *)v8;
    v10 = [(RRSchemaProvisionalRREntityPoolResolveContext *)self startedOrChanged];
  ...
  v6 = [(RRSchemaProvisionalRREntityPoolResolveContext *)self ended];
  uint64_t v7 = [v4 ended];
  if ((v6 == 0) == (v7 != 0)) {
    goto LABEL_17;
  }
  uint64_t v13 = [(RRSchemaProvisionalRREntityPoolResolveContext *)self ended];
  if (v13)
  {
    objc_super v14 = (void *)v13;
    v15 = [(RRSchemaProvisionalRREntityPoolResolveContext *)self ended];
    v16 = [v4 ended];
  ...
  v6 = [(RRSchemaProvisionalRREntityPoolResolveContext *)self failed];
  uint64_t v7 = [v4 failed];
  if ((v6 == 0) != (v7 != 0))
  {
    uint64_t v18 = [(RRSchemaProvisionalRREntityPoolResolveContext *)self failed];
    if (!v18)
    {
...
LABEL_21:
    ...
    v19 = (void *)v18;
    v20 = [(RRSchemaProvisionalRREntityPoolResolveContext *)self failed];
    v21 = [v4 failed];
...
{
  id v10 = a3;
  id v4 = [(RRSchemaProvisionalRREntityPoolResolveContext *)self startedOrChanged];

  if (v4)
  {
    v5 = [(RRSchemaProvisionalRREntityPoolResolveContext *)self startedOrChanged];
  ...
  if (v6)
  {
    uint64_t v7 = [(RRSchemaProvisionalRREntityPoolResolveContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
  uint64_t v8 = [(RRSchemaProvisionalRREntityPoolResolveContext *)self failed];

  if (v8)
  {
    v9 = [(RRSchemaProvisionalRREntityPoolResolveContext *)self failed];
    PBDataWriterWriteSubmessage();
  }
}
...
- (void)setFailed:(id)a3
{
  id v4 = (RRSchemaProvisionalRREntityPoolResolveFailed *)a3;
...
- (void)setEnded:(id)a3
{
  id v4 = (RRSchemaProvisionalRREntityPoolResolveEnded *)a3;
  startedOrChanged = self->_startedOrChanged;
  self->_startedOrChanged = 0;
...
- (void)setStartedOrChanged:(id)a3
{
  id v4 = (RRSchemaProvisionalRREntityPoolResolveStarted *)a3;
  ended = self->_ended;
  self->_ended = 0;
