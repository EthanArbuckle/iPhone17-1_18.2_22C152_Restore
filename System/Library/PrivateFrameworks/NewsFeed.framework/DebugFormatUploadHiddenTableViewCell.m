...
- (_TtC8NewsFeed36DebugFormatUploadHiddenTableViewCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  return (_TtC8NewsFeed36DebugFormatUploadHiddenTableViewCell *)sub_1C1303ACC(v4, v5);
}

- (_TtC8NewsFeed36DebugFormatUploadHiddenTableViewCell)initWithCoder:(id)a3
{
  uint64_t v5 = OBJC_IVAR____TtC8NewsFeed36DebugFormatUploadHiddenTableViewCell_button;
  v6 = self;
  id v7 = a3;
  *(Class *)((char *)&self->super.super.super.super.isa + v5) = (Class)objc_msgSend(v6, sel_buttonWithType_, 0);
  uint64_t v8 = OBJC_IVAR____TtC8NewsFeed36DebugFormatUploadHiddenTableViewCell_onTap;
  sub_1BFD22278();
  *(Class *)((char *)&self->super.super.super.super.isa + v8) = (Class)objc_msgSend(objc_allocWithZone(v9), sel_init);

  result = (_TtC8NewsFeed36DebugFormatUploadHiddenTableViewCell *)sub_1C152040C();
  __break(1u);
  return result;
}
...
- (void)prepareForReuse
{
  ...
  id v2 = v4.receiver;
  [(DebugFormatUploadHiddenTableViewCell *)&v4 prepareForReuse];
  v3 = (void *)sub_1C151C84C();
}
