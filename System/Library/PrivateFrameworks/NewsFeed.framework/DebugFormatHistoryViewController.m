...
- (_TtC8NewsFeed32DebugFormatHistoryViewController)initWithCoder:(id)a3
{
  *(Class *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC8NewsFeed32DebugFormatHistoryViewController_sections) = (Class)MEMORY[0x1E4FBC860];
  uint64_t v5 = OBJC_IVAR____TtC8NewsFeed32DebugFormatHistoryViewController_tableView;
  ...
  *(Class *)((char *)&self->super.super.super.isa + v5) = (Class)objc_msgSend(v6, sel_initWithFrame_style_, 1, 0.0, 0.0, 0.0, 0.0);
  ...
  result = (_TtC8NewsFeed32DebugFormatHistoryViewController *)sub_1C152040C();
  __break(1u);
  return result;
}
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  ...
  {
    uint64_t v4 = *(void *)(self + OBJC_IVAR____TtC8NewsFeed32DebugFormatHistoryViewController_sections);
