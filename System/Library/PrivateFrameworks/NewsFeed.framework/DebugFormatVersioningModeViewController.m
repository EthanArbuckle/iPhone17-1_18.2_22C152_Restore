...
- (void)viewWillLayoutSubviews
{
  ...
  id v3 = *(void **)&v2[OBJC_IVAR____TtC8NewsFeed39DebugFormatVersioningModeViewController_tableView];
...
{
  id v4 = a4;
  result = (_TtC8NewsFeed39DebugFormatVersioningModeViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  objc_release(*(id *)((char *)&self->super.super.super.isa
                     + OBJC_IVAR____TtC8NewsFeed39DebugFormatVersioningModeViewController_tableView));
  swift_release();
...
- (int64_t)numberOfSectionsInTableView:(id)a3
{
  return (*(void **)((char *)&self->super.super.super.isa
                     + OBJC_IVAR____TtC8NewsFeed39DebugFormatVersioningModeViewController_sections))[2];
}
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  ...
  {
    uint64_t v4 = *(void *)(self + OBJC_IVAR____TtC8NewsFeed39DebugFormatVersioningModeViewController_sections);
...
- (id)tableView:(id)a3 titleForHeaderInSection:(int64_t)a4
{
  ...
  uint64_t v4 = *(void *)((char *)self + OBJC_IVAR____TtC8NewsFeed39DebugFormatVersioningModeViewController_sections);
  if (*(void *)(v4 + 16) <= (unint64_t)a4)
  {
LABEL_10:
    __break(1u);
