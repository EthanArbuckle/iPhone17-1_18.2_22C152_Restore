...
- (_TtC8NewsFeed38DebugFormatAccessibilityViewController)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.isa
  ...
  result = (_TtC8NewsFeed38DebugFormatAccessibilityViewController *)sub_1C152040C();
  __break(1u);
  return result;
}
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  ...
  {
    uint64_t v4 = *(void *)(self + OBJC_IVAR____TtC8NewsFeed38DebugFormatAccessibilityViewController_sections);
...
- (id)tableView:(id)a3 titleForHeaderInSection:(int64_t)a4
{
  ...
  if (*(void *)(*(void *)((char *)self + OBJC_IVAR____TtC8NewsFeed38DebugFormatAccessibilityViewController_sections)
                 + 16) <= (unint64_t)a4)
  {
LABEL_7:
    __break(1u);
