...
{
  v7.receiver = self;
  v7.super_class = (Class)NCOpenCameraResponse;
  id v3 = [(NCOpenCameraResponse *)&v7 description];
  int v4 = [(NCOpenCameraResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return sub_100020494((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    -[NCOpenCameraResponse setInternalState:](self, "setInternalState:");
  }
  _objc_release_x1();
}
