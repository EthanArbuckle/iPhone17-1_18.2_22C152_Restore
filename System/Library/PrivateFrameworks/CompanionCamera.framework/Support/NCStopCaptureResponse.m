@interface NCStopCaptureResponse
- (BOOL)hasSuccess;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (BOOL)success;
...
@implementation NCStopCaptureResponse
...
{
  v7.receiver = self;
  v7.super_class = (Class)NCStopCaptureResponse;
  v3 = [(NCStopCaptureResponse *)&v7 description];
  v4 = [(NCStopCaptureResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return sub_1000077CC((uint64_t)self, (uint64_t)a3);
}
