...
{
  v7.receiver = self;
  v7.super_class = (Class)NCSetHDRModeRequest;
  id v3 = [(NCSetHDRModeRequest *)&v7 description];
  int v4 = [(NCSetHDRModeRequest *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return sub_100022B58((uint64_t)self, (uint64_t)a3);
}
