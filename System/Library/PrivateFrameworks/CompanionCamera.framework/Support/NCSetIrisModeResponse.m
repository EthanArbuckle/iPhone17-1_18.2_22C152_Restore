...
{
  v7.receiver = self;
  v7.super_class = (Class)NCSetIrisModeResponse;
  id v3 = [(NCSetIrisModeResponse *)&v7 description];
  int v4 = [(NCSetIrisModeResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return sub_10002140C((uint64_t)self, (uint64_t)a3);
}
