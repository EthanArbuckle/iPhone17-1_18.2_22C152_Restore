@interface NCStartCaptureResponse
- (BOOL)hasSuccess;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (BOOL)success;
...
@implementation NCStartCaptureResponse
...
{
  v7.receiver = self;
  v7.super_class = (Class)NCStartCaptureResponse;
  v3 = [(NCStartCaptureResponse *)&v7 description];
  v4 = [(NCStartCaptureResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return sub_100005914((uint64_t)self, (uint64_t)a3);
}
