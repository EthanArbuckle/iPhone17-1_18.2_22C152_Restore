...
{
  v7.receiver = self;
  v7.super_class = (Class)NCSetFlashModeRequest;
  id v3 = [(NCSetFlashModeRequest *)&v7 description];
  int v4 = [(NCSetFlashModeRequest *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return sub_10001FDAC((uint64_t)self, (uint64_t)a3);
}
