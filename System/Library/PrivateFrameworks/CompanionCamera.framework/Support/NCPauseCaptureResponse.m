@interface NCPauseCaptureResponse
- (BOOL)hasSuccess;
- (BOOL)isEqual:(id)a3;
- (BOOL)readFrom:(id)a3;
- (BOOL)success;
...
@implementation NCPauseCaptureResponse
...
{
  v7.receiver = self;
  v7.super_class = (Class)NCPauseCaptureResponse;
  v3 = [(NCPauseCaptureResponse *)&v7 description];
  v4 = [(NCPauseCaptureResponse *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return sub_1000224A4((uint64_t)self, (uint64_t)a3);
}
