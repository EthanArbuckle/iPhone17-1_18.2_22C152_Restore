...
{
  v7.receiver = self;
  v7.super_class = (Class)NCSetCaptureModeRequest;
  id v3 = [(NCSetCaptureModeRequest *)&v7 description];
  int v4 = [(NCSetCaptureModeRequest *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return sub_10000B8B4((uint64_t)self, (uint64_t)a3);
}
