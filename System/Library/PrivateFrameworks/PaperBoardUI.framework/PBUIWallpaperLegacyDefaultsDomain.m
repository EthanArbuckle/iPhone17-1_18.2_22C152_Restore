@interface PBUIWallpaperLegacyDefaultsDomain
- (PBUIWallpaperLegacyDefaultsDomain)init;
- (void)_bindAndRegisterDefaults;
@end

@implementation PBUIWallpaperLegacyDefaultsDomain

- (PBUIWallpaperLegacyDefaultsDomain)init
{
  return (PBUIWallpaperLegacyDefaultsDomain *)[(BSAbstractDefaultDomain *)self _initWithDomain:@"com.apple.springboard"];
}
...
- (void)_bindAndRegisterDefaults
{
  ...
  [(BSAbstractDefaultDomain *)self _bindProperty:v10 withDefaultKey:@"SBWallpaperParallaxFactorHomeScreen" toDefaultValue:&unk_1F162C720 options:1];

  v11 = [NSString stringWithUTF8String:"homeScreenZoomScale"];
  [(BSAbstractDefaultDomain *)self _bindProperty:v11 withDefaultKey:@"SBWallpaperZoomScaleHomeScreen" toDefaultValue:&unk_1F162C720 options:1];
  ...
  [(BSAbstractDefaultDomain *)self _bindProperty:v19 withDefaultKey:@"SBWallpaperParallaxFactorLockScreen" toDefaultValue:&unk_1F162C720 options:1];

  v20 = [NSString stringWithUTF8String:"lockScreenZoomScale"];
  [(BSAbstractDefaultDomain *)self _bindProperty:v20 withDefaultKey:@"SBWallpaperZoomScaleLockScreen" toDefaultValue:&unk_1F162C720 options:1];
  ...
  [(BSAbstractDefaultDomain *)self _bindProperty:v26 withDefaultKey:@"SBWallpaperStillTimeInVideoKey" toDefaultValue:&unk_1F162C678 options:1];
