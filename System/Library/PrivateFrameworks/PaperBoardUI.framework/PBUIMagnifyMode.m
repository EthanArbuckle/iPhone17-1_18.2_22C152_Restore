...
+ (PBUIMagnifyMode)magnifyModeWithSize:(CGSize)a3 name:(id)a4;
...
+ (id)currentMagnifyMode
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR)) {
    +[PBUIMagnifyMode currentMagnifyMode](v8);
  }
...
{
  v3.receiver = self;
  v3.super_class = (Class)PBUIMagnifyMode;
...
- (NSString)description
{
  return (NSString *)[(PBUIMagnifyMode *)self descriptionWithMultilinePrefix:@"\t"];
}

- (id)descriptionWithMultilinePrefix:(id)a3
{
  unint64_t v3 = [(PBUIMagnifyMode *)self descriptionBuilderWithMultilinePrefix:a3];
  id v4 = [v3 build];
...
- (id)descriptionBuilderWithMultilinePrefix:(id)a3
{
  ...
  id v5 = [(PBUIMagnifyMode *)self name];
...
- (id)succinctDescription
{
  v2 = [(PBUIMagnifyMode *)self succinctDescriptionBuilder];
...
+ (void)currentMagnifyMode
{
  ...
  int v3 = 136315650;
  id v4 = "IOMobileFramebufferRef PBUICreateMobileFrameBuffer(void)";
  __int16 v5 = 2114;
  uint64_t v6 = a1;
  __int16 v7 = 1024;
  int v8 = a2;
  _os_log_error_impl(&dword_1BC4B3000, log, OS_LOG_TYPE_ERROR, "%s Returning NULL framebuffer because IOMobileFramebufferOpenByName() gave us a NULL framebuffer. display: %{public}@, ioResult: %x", (uint8_t *)&v3, 0x1Cu);
}
