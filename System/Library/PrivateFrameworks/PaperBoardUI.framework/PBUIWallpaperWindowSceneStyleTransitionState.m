...
- (PBUIWallpaperWindowSceneStyleTransitionState)init
{
  ...
  result = [(PBUIWallpaperWindowSceneStyleTransitionState *)&v4 init];
  if (result)
  {
...
- (NSString)description
{
  return (NSString *)[(PBUIWallpaperWindowSceneStyleTransitionState *)self descriptionWithMultilinePrefix:0];
}
...
{
  id v4 = a3;
  long long v5 = [(PBUIWallpaperWindowSceneStyleTransitionState *)self init];
  if (v5)
  {
    id v18 = v4;
      ...
      if (count)
      {
        ...
        for (size_t i = 0; i != v9; ++i)
        {
          ...
          if (v11)
          {
            ...
            v19[1] = v15;
            *(double *)&v19[2] = v16;
            [(PBUIWallpaperWindowSceneStyleTransitionState *)v5 setWallpaperStyleTransitionState:v19 forPriority:uint64];
          }
        }
      }
    }
...
- (id)descriptionWithMultilinePrefix:(id)a3
{
  uint64_t v3 = [(PBUIWallpaperWindowSceneStyleTransitionState *)self descriptionBuilderWithMultilinePrefix:a3];
  id v4 = [v3 build];
...
- (id)descriptionBuilderWithMultilinePrefix:(id)a3
{
  ...
  id v4 = a3;
  uint64_t v5 = [(PBUIWallpaperWindowSceneStyleTransitionState *)self succinctDescriptionBuilder];
  unint64_t v6 = 0;
