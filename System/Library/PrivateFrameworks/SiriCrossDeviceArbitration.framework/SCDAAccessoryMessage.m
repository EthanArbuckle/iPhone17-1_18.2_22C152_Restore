...
- (id)description
{
  ...
  v27[0] = @"iSane";
  v26 = [NSNumber numberWithBool:self->_isSane];
  v28[0] = v26;
  v27[1] = @"ACK";
  ...
  v24 = [NSNumber numberWithBool:self->_serializedProtocol];
  v28[2] = v24;
  v27[3] = @"Version";
  v23 = [NSNumber numberWithUnsignedChar:self->_message.version];
  v28[3] = v23;
  v27[4] = @"RequestType";
  v4 = NSString;
  ...
  v28[4] = v21;
  v27[5] = @"Session";
  v20 = [NSNumber numberWithUnsignedLongLong:self->_message.session];
  v28[5] = v20;
  v27[6] = @"VoiceTrigger endtime";
  v19 = [NSNumber numberWithDouble:self->_message.voiceTriggerEndTime];
  v28[6] = v19;
  v27[7] = @"AudioHash";
  v6 = objc_msgSend(NSString, "stringWithFormat:", @"hash=%#04x", self->_message.audioHash);
  v28[7] = v6;
  v27[8] = @"GoodnessScore";
  v7 = [NSNumber numberWithUnsignedChar:self->_message.goodnessScore];
  v28[8] = v7;
  v27[9] = @"UserConfidence";
  v8 = [NSNumber numberWithUnsignedChar:self->_message.userConfidenceScore];
  v28[9] = v8;
  v27[10] = @"TieBreaker";
  v9 = [NSNumber numberWithUnsignedChar:self->_message.tieBreaker];
  v28[10] = v9;
  v27[11] = @"DeviceClass";
  v10 = [NSNumber numberWithUnsignedChar:self->_message.deviceClass];
  v28[11] = v10;
  v27[12] = @"DeviceGroup";
  v11 = [NSNumber numberWithUnsignedChar:self->_message.deviceGroup];
  v28[12] = v11;
  v27[13] = @"ProductType";
  v12 = [NSNumber numberWithUnsignedChar:self->_message.productType];
  v28[13] = v12;
  v27[14] = @"ElectionDecision";
  v13 = [NSNumber numberWithUnsignedChar:self->_message.electionDecision];
  v28[14] = v13;
  v27[15] = @"EmergencyHandled";
  v14 = [NSNumber numberWithUnsignedChar:self->_message.emergencyHandled];
  v28[15] = v14;
  v15 = [NSDictionary dictionaryWithObjects:v28 forKeys:v27 count:16];
...
- (SCDAAccessoryMessage)initWithAccessoryMessageAsDictionary:(id)a3 accessoryId:(id)a4
{
  ...
  id v7 = a4;
  v11.receiver = self;
  v11.super_class = (Class)SCDAAccessoryMessage;
...
- (id)initElectionDecisionMessageWithSessionId:(unint64_t)a3 decision:(BOOL)a4 accessoryId:(id)a5
{
  id v9 = a5;
  v13.receiver = self;
  v13.super_class = (Class)SCDAAccessoryMessage;
...
- (SCDAAccessoryMessage)initWithRequestType:(unint64_t)a3 session:(unint64_t)a4 voiceTriggerEndTime:(double)a5 audioHash:(unsigned __int16)a6 goodnessScore:(unsigned __int8)a7 userConfidenceScore:(unsigned __int8)a8 tieBreaker:(unsigned __int8)a9 deviceClass:(unsigned __int8)a10 deviceGroup:(unsigned __int8)a11 productType:(unsigned __int8)a12 electionDecision:(unsigned __int8)a13 emergencyHandled:(unsigned __int8)a14 ack:(unsigned __int8)a15 accessoryId:(id)a16
{
  id v24 = a16;
  v28.receiver = self;
  v28.super_class = (Class)SCDAAccessoryMessage;
  ...
  return (SCDAAccessoryMessage *)v26;
}
...
- (void)_initializeMessageObjFromDictionary:(id)a3
{
  ...
  id v7 = +[SCDAAccessoryMessage sessionIdKey];
  v8 = [v4 objectForKeyedSubscript:v7];

  id v9 = +[SCDAAccessoryMessage requestTypeKey];
  v10 = [v4 objectForKeyedSubscript:v9];

  objc_super v11 = +[SCDAAccessoryMessage messageKey];
  ...
  if (v12)
  {
    ...
    {
      [(SCDAAccessoryMessage *)self _initializeMessageObj:v12];
      goto LABEL_31;
    }
  }
  objc_opt_class();
      ...
      if (v14)
      {
        ...
        switch(v17)
        {
          case 10:
            ...
            self->_isSane = 1;
            v19 = +[SCDAAccessoryMessage electionDecisionKey];
          ...
          case 9:
            p_message = &self->_message;
            self->_isSane = 1;
            v22 = +[SCDAAccessoryMessage emergencyHandledKey];
        ...
        [(SCDAAccessoryMessage *)self _initWithMessage:p_message];
...
LABEL_18:
      ...
      if (os_log_type_enabled((os_log_t)SCDALogContextCore, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 136315650;
        ...
        __int16 v30 = 2112;
        v31 = accessoryId;
        _os_log_debug_impl(&dword_25C707000, v18, OS_LOG_TYPE_DEBUG, "%s Unknown request type %@ for accessory id: %@, Ignoring.", buf, 0x20u);
      }
      self->_isSane = 0;
      goto LABEL_30;
    }
  ...
  if (os_log_type_enabled((os_log_t)SCDALogContextCore, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 136315906;
    ...
    __int16 v32 = 2112;
    v33 = v16;
    _os_log_impl(&dword_25C707000, v15, OS_LOG_TYPE_INFO, "%s Received a payload %@ with session id %@ for accessory id: %@, Ignoring.", buf, 0x2Au);
  }
  self->_isSane = 0;
LABEL_31:
}
    ...
    if ([v4 length])
    {
      ...
      if (v14)
      {
        ...
        else
        {
          ...
          {
            self->_isSane = 0;
            objc_super v13 = SCDALogContextCore;
            if (os_log_type_enabled((os_log_t)SCDALogContextCore, OS_LOG_TYPE_ERROR))
            {
              *(_DWORD *)buf = 136315650;
              ...
              __int16 v19 = 2048;
              unint64_t v20 = v7;
              _os_log_error_impl(&dword_25C707000, v13, OS_LOG_TYPE_ERROR, "%s Wedged message received with version: %hhu and message length: %zu", buf, 0x1Cu);
            }
            goto LABEL_13;
          }
          uint64_t v9 = [v5 bytes];
...
{
  id v3 = a3;
  id v4 = +[SCDAAccessoryMessage acknowledgeRequestKey];
  ...
  {
    unint64_t v7 = +[SCDAAccessoryMessage requestTypeKey];
    ...
    {
      uint64_t v9 = +[SCDAAccessoryMessage messageKey];
