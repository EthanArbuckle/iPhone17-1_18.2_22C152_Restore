...
void __69__SCDAAdvertisementContextManager_triggerABCForType_subType_context___block_invoke(uint64_t a1)
{
  ...
  [v2 triggerABCForType:*(void *)(a1 + 40) subType:*(void *)(a1 + 48) context:*(void *)(a1 + 56) completionHandler:&__block_literal_global_1197];
}
...
void __69__SCDAAdvertisementContextManager_triggerABCForType_subType_context___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled((os_log_t)SCDALogContextCore, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v6 = 2112;
      id v7 = v2;
      _os_log_error_impl(&dword_25C707000, v3, OS_LOG_TYPE_ERROR, "%s #scda triggerABCForSubType failed: %@", (uint8_t *)&v4, 0x16u);
    }
  }
}
...
void __82__SCDAAdvertisementContextManager_pushSCDAAdvertisementContext_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled((os_log_t)SCDALogContextCore, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 136315394;
    id v9 = "-[SCDAAdvertisementContextManager pushSCDAAdvertisementContext:completionHandler:]_block_invoke";
    __int16 v10 = 2112;
    uint64_t v11 = v3;
    _os_log_impl(&dword_25C707000, v2, OS_LOG_TYPE_INFO, "%s #myriad Pushing Myriad advertisement context %@", buf, 0x16u);
  }
...
void __82__SCDAAdvertisementContextManager_pushSCDAAdvertisementContext_completionHandler___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  {
    id v5 = [v4 performSelector:sel_scdaAdvertisementContext];
    if (v5)
    {
      id v6 = [[SCDAAdvertisementContextRecord alloc] initWithMyriadAdvertisementContextRecordData:v5];
      id v7 = v6;
      if (v6)
      {
        id v8 = [(SCDAAdvertisementContextRecord *)v6 deviceID];
        if (v8)
        {
        ...
        {
          uint64_t v9 = (id)SCDALogContextCore;
          if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
          {
            ...
            int v12 = 136315650;
            id v13 = "-[SCDAAdvertisementContextManager pushSCDAAdvertisementContext:completionHandler:]_block_invoke_2";
            __int16 v14 = 2112;
            v15 = v7;
            __int16 v16 = 2112;
            id v17 = v11;
            _os_log_error_impl(&dword_25C707000, v9, OS_LOG_TYPE_ERROR, "%s #scda Dropped %@ from %@ because there's no device ID.", (uint8_t *)&v12, 0x20u);
            if (!v10) {
          }
            }
        }
...
- (id)_settingsConnection
{
  ...
  {
    int v4 = (AFSettingsConnection *)objc_alloc_init(MEMORY[0x263F285E0]);
...
- (SCDAAdvertisementContextManager)initWithQueue:(id)a3
{
  ...
  if (v5)
  {
    ...
    id v6 = [(SCDAAdvertisementContextManager *)&v10 init];
    id v7 = v6;
    if (v6) {
