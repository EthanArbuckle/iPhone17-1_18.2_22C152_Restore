void sub_1000029F8()
{
  ...
  {
    sub_100002FB0((uint64_t)v3);
  }
}

void sub_100002B68(id a1)
{
  dispatch_workloop_t inactive = dispatch_workloop_create_inactive("com.apple.replicatord.workloop");
...
int main(int argc, const char **argv, const char **envp)
{
  ...
  if (os_log_type_enabled(v7, v8))
  {
    ...
    *(_WORD *)v9 = 0;
    _os_log_impl((void *)&_mh_execute_header, v7, v8, "SetPatch >NIL:", v9, 2u);
    swift_slowDealloc();
  }
...
uint64_t Daemon.init(workloop:)()
{
  return Daemon.init(workloop:)();
}
...
uint64_t static Notifications.daemonStartup.getter()
{
  return static Notifications.daemonStartup.getter();
}
...
id objc_msgSend_sharedWorkloop(void *a1, const char *a2, ...)
{
  return _[a1 sharedWorkloop];
}