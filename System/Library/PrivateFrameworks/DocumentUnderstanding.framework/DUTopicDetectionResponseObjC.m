@interface DUTopicDetectionResponseObjC
...
- (void)setPersonalTopics:(id)a3
{
  ...
  if (v8)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v15 = objc_msgSend_topicResultForObjCTopicResult_(DUObjCCompatibilityUtils, v9, *(void *)(*((void *)&v22 + 1) + 8 * v14), v10, v11, (void)v22);
  ...
  objc_msgSend_setPersonalTopics_(self->_underlying, v19, (uint64_t)v5, v20, v21);
}
...
- (NSArray)personalTopics
{
  ...
  long long v24 = 0u;
  long long v25 = 0u;
  uint64_t v8 = objc_msgSend_personalTopics(self->_underlying, v4, v5, v6, v7, 0);
  ...
  if (v10)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v14; ++i)
      {
        ...
        uint64_t v17 = objc_msgSend_objCTopicResultForTopicResult_(DUObjCCompatibilityUtils, v11, *(void *)(*((void *)&v22 + 1) + 8 * i), v12, v13);
...
- (void)setGlobalTopics:(id)a3
{
  ...
  if (v8)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        uint64_t v15 = objc_msgSend_topicResultForObjCTopicResult_(DUObjCCompatibilityUtils, v9, *(void *)(*((void *)&v22 + 1) + 8 * v14), v10, v11, (void)v22);
        objc_msgSend_addObject_(v5, v16, (uint64_t)v15, v17, v18);
  ...
  objc_msgSend_setGlobalTopics_(self->_underlying, v19, (uint64_t)v5, v20, v21);
}
...
- (NSArray)globalTopics
{
  ...
  long long v24 = 0u;
  long long v25 = 0u;
  uint64_t v8 = objc_msgSend_globalTopics(self->_underlying, v4, v5, v6, v7, 0);
  uint64_t v10 = objc_msgSend_countByEnumeratingWithState_objects_count_(v8, v9, (uint64_t)&v22, (uint64_t)v26, 16);
  if (v10)
  {
    uint64_t v14 = v10;
...
{
  v7.receiver = self;
  v7.super_class = (Class)DUTopicDetectionResponseObjC;
  uint64_t v2 = [(DUTopicDetectionResponseObjC *)&v7 init];
  if (v2)
  {
    uint64_t v3 = objc_alloc_init(_TtC21DocumentUnderstanding24DUTopicDetectionResponse);
