...
- (AAOBInvitationSentModel)initWithType:(int64_t)a3 recipientHandle:(id)a4
{
  ...
  v8 = [(AAOBInvitationSentModel *)&v26 init];
  if (v8)
  {
    ...
    if (a3)
    {
      uint64_t v11 = [v9 localizedStringForKey:@"CUSTODIAN_INVITATION_SENT_TITLE" value:0 table:@"Localizable"];
      title = v8->_title;
      v8->_title = (NSString *)v11;

      v13 = [MEMORY[0x1E4F28B50] bundleWithIdentifier:@"com.apple.AppleAccount"];
      v14 = v13;
      v15 = @"CUSTODIAN_INVITATION_SENT_DETAIL_TEXT";
    }
    else
    {
      uint64_t v16 = [v9 localizedStringForKey:@"CUSTODIAN_INVITATION_SENT_FAMILY_TITLE" value:0 table:@"Localizable"];
      v17 = v8->_title;
      v8->_title = (NSString *)v16;

      v13 = [MEMORY[0x1E4F28B50] bundleWithIdentifier:@"com.apple.AppleAccount"];
      v14 = v13;
      v15 = @"CUSTODIAN_INVITATION_SENT_FAMILY_DETAIL_TEXT";
    }
    ...
    uint64_t v21 = [v20 localizedStringForKey:@"DONE" value:0 table:@"Localizable"];
...
- (AAOBInvitationSentModel)initWithCoder:(id)a3
{
  ...
  id v5 = [(AAOBInvitationSentModel *)&v25 init];
  if (v5)
  {
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = objc_alloc_init(AAOBInvitationSentModel);
...
{
  v3 = NSString;
  id v4 = [(AAOBInvitationSentModel *)self imageName];
  uint64_t v5 = [(AAOBInvitationSentModel *)self title];
  uint64_t v6 = [(AAOBInvitationSentModel *)self detailText];
  uint64_t v7 = [(AAOBInvitationSentModel *)self primaryButton];
  uint64_t v8 = [(AAOBInvitationSentModel *)self secondaryButton];
  uint64_t v9 = [(AAOBInvitationSentModel *)self helpLinkTitle];
  uint64_t v10 = [(AAOBInvitationSentModel *)self helpLinkURL];
  uint64_t v11 = [(AAOBInvitationSentModel *)self ownerHandle];
  uint64_t v12 = [(AAOBInvitationSentModel *)self recipientHandle];
