...
- (ASKResourceCache)initWithGroupOfCache:(id)a3
{
  ...
  if (v5)
  {
    ...
    uint64_t v8 = [(_ASKResourceCacheGroup *)v5->_group makeMemberContents];
...
- (ASKResourceCache)init
{
  return [(ASKResourceCache *)self initWithGroupOfCache:0];
}

- (void)dealloc
{
  v3 = [(ASKResourceCache *)self group];
  id v4 = [(ASKResourceCache *)self contents];
...
- (BOOL)isGroupMember
{
  v2 = [(ASKResourceCache *)self group];
...
- (unint64_t)limit
{
  v2 = [(ASKResourceCache *)self contents];
...
- (id)resourcesForKey:(id)a3
{
  ...
  id v4 = a3;
  objc_super v5 = [(ASKResourceCache *)self group];
  ...
  if (v6)
  {
    ...
    long long v18 = 0u;
    long long v19 = 0u;
    v7 = [(ASKResourceCache *)self group];
  ...
  {
    v15 = [(ASKResourceCache *)self group];
...
- (void)replaceResourcesForKey:(id)a3 withResource:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v9 = [(ASKResourceCache *)self contents];
...
- (void)removeAllResources
{
  id v2 = [(ASKResourceCache *)self contents];
  [v2 removeAllObjects];
}
