...
- (void)updateProgressDownloadedByteCount:(int64_t)a3 totalByteCount:(int64_t)a4
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138413058;
    ...
    __int16 v20 = 2048;
    int64_t v21 = a4;
    _os_log_impl(&dword_1C8854000, v7, OS_LOG_TYPE_DEBUG, "Download of attachment UUID %@ for accountID %@ progress: %lld bytes of %lld", buf, 0x2Au);
  }
...
- (void)finishedWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138412546;
    ...
    _os_log_impl(&dword_1C8854000, v5, OS_LOG_TYPE_DEBUG, "Download of attachment UUID %@ for account %@ completed.", buf, 0x16u);
  }
