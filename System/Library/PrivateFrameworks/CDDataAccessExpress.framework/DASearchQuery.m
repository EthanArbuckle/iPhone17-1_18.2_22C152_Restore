...
- (DASearchQuery)initWithSearchString:(id)a3 consumer:(id)a4
{
  ...
  if (v8)
  {
    ...
    [(DASearchQuery *)v9 setSearchID:&stru_1F2322E58];
...
- (DASearchQuery)initWithSearchString:(id)a3 predicate:(id)a4 consumer:(id)a5
{
  ...
  if (v11)
  {
    ...
    [(DASearchQuery *)v12 setSearchID:&stru_1F2322E58];
...
- (id)dictionaryRepresentation
{
  ...
  id v5 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", -[DASearchQuery range](self, "range"));
  ...
  id v9 = objc_msgSend(NSNumber, "numberWithInt:", -[DASearchQuery timeLimit](self, "timeLimit"));
