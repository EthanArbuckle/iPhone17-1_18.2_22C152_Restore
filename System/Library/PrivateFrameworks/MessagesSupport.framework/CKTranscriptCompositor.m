...
{
  id v4 = a3;
  id v5 = [(CKTranscriptCompositor *)self representedObject];
  [v5 setDelegate:v4];
}
...
{
  v2 = [(CKTranscriptCompositor *)self representedObject];
  int64_t v3 = [v2 collectionViewLayout];
...
- (void)setScrollDirection:(int64_t)a3
{
  id v4 = [(CKTranscriptCompositor *)self representedObject];
...
{
  v2 = [(CKTranscriptCompositor *)self representedObject];
  double v3 = [v2 boundarySupplementaryItems];
...
{
  v2 = [(CKTranscriptCompositor *)self representedObject];
  int64_t v3 = [v2 contentsInsetReference];
