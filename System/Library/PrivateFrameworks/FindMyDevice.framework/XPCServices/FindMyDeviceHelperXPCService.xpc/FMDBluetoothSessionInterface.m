  ...
  *(void *)&buf[16] = 0x3032000000;
  ...
  if (dispatch_semaphore_wait(*(dispatch_semaphore_t *)(*(void *)&buf[8] + 40), v10))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      sub_1000106E4(v13, (uint64_t)v26, v12);
    }
...
- (BTDeviceImpl)deviceWithAddress:(id)a3
{
  ...
  if (!v4 || (v7 = v6, [v4 isEqualToString:&stru_10001FD10]))
  {
    objc_super v8 = sub_10000D03C();
...
LABEL_5:
  ...
  LODWORD(v14) = 0;
  id v10 = v4;
  objc_msgSend(v10, "UTF8String", v14);
  if (BTDeviceAddressFromString())
  {
    id v11 = sub_10000D03C();
