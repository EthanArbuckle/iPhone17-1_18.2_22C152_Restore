...
+ (id)classes
{
  if (qword_267C58BE8 == -1)
  {
    v2 = (void *)qword_267C58BE0;
  }
  else
  {
    dispatch_once(&qword_267C58BE8, &unk_26CB5E3B8);
    v2 = (void *)qword_267C58BE0;
  }
  return v2;
}
...
{
  v6.receiver = self;
  v6.super_class = (Class)CVACMCompassData;
  v2 = [(CVACMCompassData *)&v6 init];
  if (v2)
  {
    uint64_t v3 = objc_opt_new();
    fieldValues = v2->_fieldValues;
    v2->_fieldValues = (CVACLMotionTypeVector3 *)v3;
  }
  return v2;
}
...
- (CVACMCompassData)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    [v6 floatValue];
    -[CVACLMotionTypeVector3 setX:](v5->_fieldValues, "setX:");

    v7 = [v4 objectForKeyedSubscript:@"y"];
    [v7 floatValue];
    -[CVACLMotionTypeVector3 setY:](v5->_fieldValues, "setY:");

    v8 = [v4 objectForKeyedSubscript:@"z"];
    [v8 floatValue];
    -[CVACLMotionTypeVector3 setZ:](v5->_fieldValues, "setZ:");
...
- (id)debugDescription
{
  ...
  double v5 = [(CVACMCompassData *)self dictionary];
