...
{
  BOOL v4 = a4;
  *(Class *)((char *)&self->super.super.isa + OBJC_IVAR____TtC30com_apple_MLKit_MLModelPreview15QLModelDocument_error) = (Class)a3;
  id v6 = a3;
  v7 = self;
  swift_errorRelease();
  id v8 = (void *)sub_100024B60();
  v9.receiver = v7;
...
- (_TtC30com_apple_MLKit_MLModelPreview15QLModelDocument)initWithFileURL:(id)a3
{
  ...
  sub_100024BD0();
  id v8 = (NSURL *)OBJC_IVAR____TtC30com_apple_MLKit_MLModelPreview15QLModelDocument_error;
  *(Class *)((char *)&self->super.super.isa + OBJC_IVAR____TtC30com_apple_MLKit_MLModelPreview15QLModelDocument_error) = 0;
  sub_100024BC0(v8);
  uint64_t v10 = v9;
