...
- (_UIDocumentPickerModalManagementViewController)initWithFileTypes:(id)a3 mode:(unint64_t)a4
{
  ...
  if (v8)
  {
    v9 = (void *)[objc_alloc(MEMORY[0x263F1C468]) initWithBarButtonSystemItem:0 target:v8 action:sel__donePressed_];
...
- (void)_donePressed:(id)a3
{
  id v3 = [(_UIDocumentPickerModalManagementViewController *)self presentingViewController];
