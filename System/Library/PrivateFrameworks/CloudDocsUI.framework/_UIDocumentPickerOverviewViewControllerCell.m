...
- (_UIDocumentPickerOverviewViewControllerCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  if (v4)
  {
    ...
    v19 = [v16 constraintsWithVisualFormat:@"H:[_newlyAddedView]-(dotDistance)-[label]-(menuLabelDistance)-[_iconView(menuIconSize)]-(menuIconInset)-|" options:1024 metrics:&unk_26E02D760 views:v18];
    ...
    v53[3] = v27;
    v28 = [MEMORY[0x263EFF8C0] arrayWithObjects:v53 count:4];
...
- (id)_dotImage
{
  ...
  objc_super v5 = [(_UIDocumentPickerOverviewViewControllerCell *)self traitCollection];
...
- (void)setShowNewlyAdded:(BOOL)a3
{
  if (a3)
  {
    id v5 = [(_UIDocumentPickerOverviewViewControllerCell *)self _dotImage];
    v4 = [(_UIDocumentPickerOverviewViewControllerCell *)self newlyAddedView];
    [v4 setImage:v5];
  }
  else
  {
    id v5 = [(_UIDocumentPickerOverviewViewControllerCell *)self newlyAddedView];
    [v5 setImage:0];
  }
}
