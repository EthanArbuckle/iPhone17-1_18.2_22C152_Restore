...
{
  v10.receiver = self;
  v10.super_class = (Class)BRModalProgressController;
  v2 = [(BRModalProgressController *)&v10 init];
  if (v2)
  {
    uint64_t v3 = +[NSTimer scheduledTimerWithTimeInterval:v2 target:"_showSpinner:" selector:0 userInfo:0 repeats:2.0];
    displayTimer = v2->_displayTimer;
    v2->_displayTimer = (NSTimer *)v3;

    v5 = [_BRModalProgressTouchStealingView alloc];
    v6 = [(BRModalProgressController *)v2 view];
    [v6 bounds];
    v7 = -[_BRModalProgressTouchStealingView initWithFrame:](v5, "initWithFrame:");
...
- (void)_showSpinner:(id)a3
{
  id v41 = +[UIBlurEffect effectWithStyle:4];
  v4 = +[UIColor systemBackgroundColor];
  v5 = [(BRModalProgressController *)self view];
  [v5 setBackgroundColor:v4];

  id v6 = [objc_alloc((Class)UIVisualEffectView) initWithEffect:v41];
