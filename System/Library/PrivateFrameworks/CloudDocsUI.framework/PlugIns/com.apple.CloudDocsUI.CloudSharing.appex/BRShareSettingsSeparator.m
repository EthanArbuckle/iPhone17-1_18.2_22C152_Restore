...
{
  v11.receiver = self;
  v11.super_class = (Class)BRShareSettingsSeparator;
  v3 = -[BRShareSettingsSeparator initWithFrame:](&v11, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  if (v3)
  {
