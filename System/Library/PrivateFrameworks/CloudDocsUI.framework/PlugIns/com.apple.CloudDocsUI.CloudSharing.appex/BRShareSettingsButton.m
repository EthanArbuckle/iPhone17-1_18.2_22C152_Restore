...
{
  v60.receiver = self;
  v60.super_class = (Class)BRShareSettingsButton;
  v3 = -[BRShareSettingsButton initWithFrame:](&v60, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  v5 = v3;
  if (v3)
  {
    ...
    objc_msgSend(v7, "setDirectionalLayoutMargins:", 12.0, 16.0, 12.0, 16.0);
    [v7 setAxis:0];
    ...
    id v56 = objc_alloc_init((Class)UIStackView);
    [v56 setAxis:1];
...
- (void)setHighlighted:(BOOL)a3
{
  BOOL v3 = a3;
  v6.receiver = self;
  v6.super_class = (Class)BRShareSettingsButton;
  -[BRShareSettingsButton setHighlighted:](&v6, "setHighlighted:");
  if (v3) {
...
- (void).cxx_destruct
{
  objc_storeStrong((id *)&self->_hContainer, 0);
