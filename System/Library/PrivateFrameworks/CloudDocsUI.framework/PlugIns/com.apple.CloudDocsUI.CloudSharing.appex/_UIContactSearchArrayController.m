...
- (MFContactsSearchManager)searchManager
{
  ...
  if (!searchManager)
  {
    v4 = (MFContactsSearchManager *)[objc_alloc((Class)MFContactsSearchManager) initWithAutocompleteSearchType:5];
    v5 = self->_searchManager;
    self->_searchManager = v4;

    [(MFContactsSearchManager *)self->_searchManager setIncludeUpcomingEventMembers:1];
    searchManager = self->_searchManager;
  }
