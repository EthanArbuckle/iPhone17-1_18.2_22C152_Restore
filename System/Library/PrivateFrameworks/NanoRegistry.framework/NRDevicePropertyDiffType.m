...
LABEL_7:
      id v10 = v9;
      uint64_t v11 = [(NRDevicePropertyDiff *)v8 initWithProtobuf:v10];
      diff = v6->_diff;
...
- (NRDevicePropertyDiffType)initWithCoder:(id)a3
{
  ...
  if (!v6)
  {
    uint64_t v10 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"propertyDiff"];
    diff = v5->_diff;
...
{
  id v4 = a3;
  id v6 = [(NRDevicePropertyDiffType *)self protobuf];
  v5 = [v6 data];
...
- (id)copyWithZone:(_NSZone *)a3
{
  id v4 = [+[NRDevicePropertyDiffType allocWithZone:a3] init];
...
- (unint64_t)hash
{
  unint64_t v3 = [(NRDevicePropertyDiff *)self->_diff hash];
...
- (BOOL)isEqual:(id)a3
{
  id v4 = (NRDevicePropertyDiffType *)a3;
  objc_opt_class();
  ...
  if (v4)
  {
    ...
    if (self->_changeType == v5->_changeType)
    {
      ...
      if ((unint64_t)diff | (unint64_t)v5->_diff) {
        char v7 = -[NRDevicePropertyDiff isEqual:](diff, "isEqual:");
      }
      else {
        char v7 = 1;
      }
