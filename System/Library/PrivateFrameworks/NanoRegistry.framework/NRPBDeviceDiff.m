...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NRPBDeviceDiff;
  id v4 = [(NRPBDeviceDiff *)&v8 description];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v6 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", -[NSMutableArray count](self->_diffs, "count"));
    long long v14 = 0u;
    long long v15 = 0u;
    long long v16 = 0u;
    long long v17 = 0u;
...
- (BOOL)readFrom:(id)a3
{
  return NRPBDeviceDiffReadFrom((uint64_t)self, (uint64_t)a3);
}
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[NRPBDeviceDiff addNames:]((uint64_t)v5, v11);
  ...
  if (v13)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[NRPBDeviceDiff addDiffs:]((uint64_t)v5, v17);
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()]
    && ((names = self->_names, !((unint64_t)names | v4[2]))
     || -[NSMutableArray isEqual:](names, "isEqual:")))
  {
    diffs = self->_diffs;
    if ((unint64_t)diffs | v4[1]) {
      char v7 = -[NSMutableArray isEqual:](diffs, "isEqual:");
    }
    else {
      char v7 = 1;
    }
...
- (unint64_t)hash
{
  ...
  return [(NSMutableArray *)self->_diffs hash] ^ v3;
}
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_diffs, 0);
}
