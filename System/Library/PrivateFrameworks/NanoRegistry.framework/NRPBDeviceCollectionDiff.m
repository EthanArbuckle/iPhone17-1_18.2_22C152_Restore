...
- (uint64_t)addPairingIDs:(uint64_t)a1;
- (unint64_t)hash;
- (void)setDiffs:(uint64_t)a1;
- (void)setPairingIDs:(uint64_t)a1;
- (void)writeTo:(id)a3;
@end
...
- (id)description
{
  id v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)NRPBDeviceCollectionDiff;
  id v4 = [(NRPBDeviceCollectionDiff *)&v8 description];
  v5 = [(NRPBDeviceCollectionDiff *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return NRPBDeviceCollectionDiffReadFrom((uint64_t)self, (uint64_t)a3);
}
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[NRPBDeviceCollectionDiff addPairingIDs:]((uint64_t)v5, v11);
  ...
  if (v13)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[NRPBDeviceCollectionDiff addDiffs:]((uint64_t)v5, v17);
