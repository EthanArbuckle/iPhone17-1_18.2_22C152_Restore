...
- (unint64_t)pairingIDsCount
{
  return [(NSMutableArray *)self->_pairingIDs count];
}

- (id)pairingIDsAtIndex:(unint64_t)a3
{
  return (id)[(NSMutableArray *)self->_pairingIDs objectAtIndex:a3];
}
...
- (id)description
{
  ...
  id v4 = [(NRPBMutableDeviceCollection *)&v8 description];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", -[NSMutableArray count](self->_devices, "count"));
    long long v14 = 0u;
    long long v15 = 0u;
    long long v16 = 0u;
    long long v17 = 0u;
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v12 clearPairingIDs];
    unint64_t v4 = [(NRPBMutableDeviceCollection *)self pairingIDsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(NRPBMutableDeviceCollection *)self pairingIDsAtIndex:i];
  ...
  {
    [v12 clearDevices];
    unint64_t v8 = [(NRPBMutableDeviceCollection *)self devicesCount];
    if (v8)
    {
      unint64_t v9 = v8;
      for (uint64_t j = 0; j != v9; ++j)
      {
        uint64_t v11 = [(NRPBMutableDeviceCollection *)self devicesAtIndex:j];
        [v12 addDevices:v11];
      }
    }
  }
...
- (BOOL)isEqual:(id)a3
{
     ...
     || -[NSMutableArray isEqual:](pairingIDs, "isEqual:")))
  {
    ...
    if ((unint64_t)devices | v4[1]) {
      char v7 = -[NSMutableArray isEqual:](devices, "isEqual:");
    }
    else {
      char v7 = 1;
    }
...
- (unint64_t)hash
{
  uint64_t v3 = [(NSMutableArray *)self->_pairingIDs hash];
  return [(NSMutableArray *)self->_devices hash] ^ v3;
}
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(NRPBMutableDeviceCollection *)self addPairingIDs:*(void *)(*((void *)&v19 + 1) + 8 * v9++)];
      }
      while (v7 != v9);
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[NRPBMutableDeviceCollection addDevices:](self, "addDevices:", *(void *)(*((void *)&v15 + 1) + 8 * v14++), (void)v15);
      }
      while (v12 != v14);
