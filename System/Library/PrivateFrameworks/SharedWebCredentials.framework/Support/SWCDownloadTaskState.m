...
- (SWCDownloadTaskState)initWithDownloader:(id)a3 domain:(id)a4 downloadRoute:(unsigned __int8)a5
{
  ...
  if (v10)
  {
    ...
    v12 = (NSString *)objc_msgSend(objc_alloc((Class)NSString), "initWithFormat:", @"AASA-%s", v20);
...
- (void)resumeTask
{
  ...
  if (!self->_task)
  {
    ...
    if (v6)
    {
      ...
      v10 = objc_msgSend(v7, "_URLRequestWithDomain:downloadRoute:", v9, -[SWCDownloadTaskState downloadRoute](self, "downloadRoute"));
...
- (id)description
{
  ...
  v7 = sub_10000792C(self->_downloadRoute);
