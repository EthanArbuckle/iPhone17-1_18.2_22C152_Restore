...
+ (SWCSecurityGuard)sharedSecurityGuard
{
  if (qword_1000328F8 != -1) {
    dispatch_once(&qword_1000328F8, &stru_10002CFE8);
  }
  v2 = (void *)qword_1000328F0;
...
- (optional<SecTrustResultType>)_evaluateTrust:(__SecTrust *)a3 error:(id *)a4
{
  ...
  if (v18)
  {
    ...
    id v23 = (__CFError *)objc_msgSend(v21, "initWithDomain:code:userInfo:", v22, -[__CFError code](error, "code"), v18);
    CFErrorRef v24 = error;
    CFErrorRef error = v23;
  }
  if (qword_100032908 != -1) {
    dispatch_once(&qword_100032908, &stru_10002D008);
  }
  v25 = qword_100032900;
  if (os_log_type_enabled((os_log_t)qword_100032900, OS_LOG_TYPE_ERROR))
  {
...
LABEL_3:
  ...
  CFDictionaryRef v19 = qword_100032900;
  if (os_log_type_enabled((os_log_t)qword_100032900, OS_LOG_TYPE_DEBUG))
  {
    CFStringRef v20 = @"NOT ";
    *(_DWORD *)buf = 138412802;
    v25 = a3;
    if (v6) {
      CFStringRef v20 = &stru_10002E180;
    }
    __int16 v26 = 2114;
    CFStringRef v27 = v20;
    __int16 v28 = 2048;
