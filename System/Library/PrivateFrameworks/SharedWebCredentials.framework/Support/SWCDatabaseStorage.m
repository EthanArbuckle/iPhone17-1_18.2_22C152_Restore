...
- (SWCDatabaseStorage)initWithCoder:(id)a3
{
  ...
  v12 = objc_msgSend(a3, "swc_decodeObjectOfClasses:forKey:", v9, @"entries");
  v13 = objc_msgSend(a3, "swc_decodeObjectOfClasses:forKey:", v37, @"settings");
  objc_msgSend(a3, "swc_decodeObjectOfClass:forKey:", objc_opt_class(), @"launchServicesDatabaseGeneration");
  v14 = (NSNumber *)objc_claimAutoreleasedReturnValue();
  uint64_t v35 = objc_msgSend(a3, "swc_decodeObjectOfClass:forKey:", objc_opt_class(), @"enterpriseState");
  if (v12)
  {
    objc_opt_class();
