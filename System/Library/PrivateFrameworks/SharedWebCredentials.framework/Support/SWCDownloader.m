...
LABEL_28:
    ...
    if (!v19)
    {
      ...
      v28 = qword_100032860;
      if (os_log_type_enabled((os_log_t)qword_100032860, OS_LOG_TYPE_ERROR))
      {
    ...
    if (v23)
    {
      ...
      if (v25)
      {
        ...
        v26 = qword_100032860;
        if (os_log_type_enabled((os_log_t)qword_100032860, OS_LOG_TYPE_INFO))
        {
          *(_DWORD *)buf = 138412546;
          id v41 = v10;
          __int16 v42 = 2112;
...
- (void)URLSession:(id)a3 dataTask:(id)a4 didReceiveResponse:(id)a5 completionHandler:(id)a6
{
  ...
  if (v15)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      unsigned int v18 = (id)qword_100032860;
    ...
    if (v25)
    {
      if (v26 <= 0x63)
      {
        ...
        uint64_t v32 = (id)qword_100032860;
        if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
        {
          id v45 = [v18 URL];
          sub_10000792C((uint64_t)[(__CFString *)v15 downloadRoute]);
...
LABEL_49:
      ...
      v38 = qword_100032860;
      if (os_log_type_enabled((os_log_t)qword_100032860, OS_LOG_TYPE_DEBUG))
      {
...
LABEL_43:
    ...
    else
    {
      if (v26 < 0xC8)
      {
        ...
        id v34 = objc_msgSend(v33, "initWithDomain:code:userInfo:", @"HTTP", v52);
        v66[3] = v34;
...
- (void)URLSession:(id)a3 dataTask:(id)a4 didReceiveData:(id)a5
{
  ...
  if (v12)
  {
    ...
    if ((unint64_t)v15 > 0x20000)
    {
      ...
      id v17 = objc_msgSend(objc_alloc((Class)NSString), "initWithFormat:", @"Data exceeded maximum length of %zu bytes.", 0x20000);
      unsigned int v18 = [v12 task];
      id v19 = [v18 response];

      if (v19 && (uint64_t)[v19 expectedContentLength] >= 1)
      {
        id v20 = objc_msgSend(objc_alloc((Class)NSString), "initWithFormat:", @"Data exceeded maximum length of %zu bytes (server said it would be %lld bytes.)", 0x20000, objc_msgSend(v19, "expectedContentLength"));
...
- (unint64_t)_maximumActiveTaskCountForSessionID:(unsigned __int8)a3
{
  if (a3 > 3u) {
    ...
    return qword_100024208[(char)a3];
  }
}
...
- (id)_taskStateForDomain:(id)a3 downloadRoute:(unsigned __int8)a4
{
  ...
  unsigned int v18 = sub_100005584;
  id v19 = sub_100005594;
  id v20 = 0;
...
- (void)_processDownloadedDataForState:(id)a3
{
  ...
  id v6 = (id)qword_100032860;
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    id v20 = [v4 domain];
    id v21 = sub_10000792C((uint64_t)[v4 downloadRoute]);
    int __buf = 138412546;
    id v24 = v20;
    __int16 v25 = 2114;
    id v26 = v21;
  ...
  if (v8)
  {
          ...
          v14))
    {
      ...
      id v15 = objc_msgSend(objc_alloc((Class)NSMutableData), "initWithCapacity:", (char *)objc_msgSend(v8, "length") + 128);
