...
+ (SWCDatabase)sharedDatabase
{
  ...
  if (qword_1000328C8 != -1) {
    dispatch_once(&qword_1000328C8, &stru_10002CE98);
  }
  v3 = (void *)qword_1000328C0;
...
+ (OS_dispatch_queue)queue
{
  if (qword_1000328D8 != -1) {
    dispatch_once(&qword_1000328D8, &stru_10002CEB8);
  }
  v2 = (void *)qword_1000328D0;
...
- (id)entryMatchingService:(id)a3 domain:(id)a4 appID:(id)a5
{
  ...
  long long v11 = sub_1000186BC;
  long long v12 = sub_1000186CC;
  id v13 = 0;
...
- (void)removeAllEntries
{
  ...
  id v5 = qword_1000328E0;
  if (os_log_type_enabled((os_log_t)qword_1000328E0, OS_LOG_TYPE_INFO))
  {
    *(_WORD *)buf = 0;
...
- (void)updateEntriesForDomain:(id)a3 canonicalEntries:(id)a4
{
  ...
  long long v12 = sub_100018DC8;
  id v13 = &unk_10002CF30;
  id v9 = v7;
  id v14 = v9;
  id v15 = a4;
...
- (BOOL)saveReturningError:(id *)a3
{
  ...
  else
  {
    ...
    id v6 = qword_1000328E0;
    if (os_log_type_enabled((os_log_t)qword_1000328E0, OS_LOG_TYPE_DEBUG))
    {
      *(_WORD *)buf = 0;
    ...
    if (v8)
    {
      ...
      if (v11)
      {
        ...
        else
        {
          ...
          long long v25 = (id)qword_1000328E0;
...
- (void)_scheduleSave
{
  if (*((unsigned char *)self + 40))
  {
    ...
    *(void *)buf = 0x402E000000000000;
    ...
    sub_10001C5F4((dispatch_object_t *)&self->_saveTimer, (uint64_t)buf, v4);
    objc_destroyWeak(&v5);
    ...
    *(void *)&long long v9 = 138412290;
    ...
    do
    {
      ...
      do
      {
        ...
        id v14 = objc_msgSend(v13, "serviceType", v19, (void)v20);
