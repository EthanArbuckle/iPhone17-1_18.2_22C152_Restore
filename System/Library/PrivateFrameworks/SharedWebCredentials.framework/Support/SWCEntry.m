...
LABEL_14:
  ...
  if (v28)
  {
    ...
    else
    {
      ...
      v30 = [v28 domain];
      id v31 = [v29 initWithFormat:@"%@ %lli", v30, objc_msgSend(v28, "code")];
      _SWCLogValueForKey();
    }
  }
      ...
      do
      {
        ...
        do
        {
          ...
          if (objc_opt_isKindOfClass())
          {
            ...
            objc_msgSend(v9, "canonicalizeWithObjectCache:", v5, (void)v10);
          }
          id v8 = (char *)v8 + 1;
        }
        while (v6 != v8);
...
LABEL_5:
  ...
  objc_super v21 = (id)qword_100032898;
  ...
  if (self->_lastErrorJSON)
  {
    ...
    if (v4 && _NSIsNSDictionary())
    {
      ...
      if (_NSIsNSString() && _NSIsNSNumber() && (!v7 || _NSIsNSDictionary())) {
        id v8 = objc_msgSend(objc_alloc((Class)NSError), "initWithDomain:code:userInfo:", v5, objc_msgSend(v6, "integerValue"), v7);
      }
      else {
        id v8 = 0;
      }
...
- (void)setLastError:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (v9 && [v9 count])
    {
      ...
      v15[2] = sub_1000099FC;
      v15[3] = &unk_10002C950;
      id v11 = objc_msgSend(objc_alloc((Class)NSMutableDictionary), "initWithCapacity:", objc_msgSend(v10, "count"));
      id v16 = v11;
...
{
  id v4 = a3;
  id v6 = objc_msgSend(v4, "swc_decodeObjectOfClass:forKey:", objc_opt_class(), @"appID");
  uint64_t v7 = objc_msgSend(v4, "swc_decodeObjectOfClass:forKey:", objc_opt_class(), @"service");
  uint64_t v8 = objc_msgSend(v4, "swc_decodeObjectOfClass:forKey:", objc_opt_class(), @"domain");
  id v9 = (void *)v8;
  if (v6 && v7 && v8)
  {
    ...
    if (v10)
    {
      uint64_t v11 = objc_msgSend(v4, "swc_decodeObjectOfClass:forKey:", objc_opt_class(), @"applicationVersion");
      applicationVersion = v10->_applicationVersion;
      v10->_applicationVersion = (NSString *)v11;

      uint64_t v13 = objc_msgSend(v4, "swc_decodeObjectOfClass:forKey:", objc_opt_class(), @"applicationPersistentIdentifier");
      ...
      *(_WORD *)&v10->_fields = v15;
      ...
      uint64_t v16 = objc_msgSend(v4, "swc_decodeObjectOfClass:forKey:", objc_opt_class(), @"patternList");
      patterns = v10->_patterns;
      v10->_patterns = (_SWCPatternList *)v16;

      uint64_t v18 = objc_msgSend(v4, "swc_decodeObjectOfClass:forKey:", objc_opt_class(), @"substitutionVariableList");
      substitutionVariables = v10->_substitutionVariables;
      v10->_substitutionVariables = (_SWCSubstitutionVariableList *)v18;

      uint64_t v20 = objc_msgSend(v4, "swc_decodeObjectOfClass:forKey:", objc_opt_class(), @"lastCheckedDate");
      ...
      uint64_t v24 = objc_msgSend(v4, "swc_decodeObjectOfClass:forKey:", objc_opt_class(), @"lastErrorJSON");
      lastErrorJSON = v10->_lastErrorJSON;
      v10->_lastErrorJSON = (NSData *)v24;

      uint64_t v26 = objc_msgSend(v4, "swc_decodeObjectOfClass:forKey:", objc_opt_class(), @"retryCount");
...
+ (id)entriesForBundleRecord:(id)a3 enterpriseContext:(id)a4 developerModeEnabled:(BOOL)a5
{
  ...
  if (v58)
  {
    ...
    if ([v57 count])
    {
      ...
      uint64_t v15 = (id)qword_100032898;
    ...
    else
    {
      ...
      v17 = qword_100032898;
      if (os_log_type_enabled((os_log_t)qword_100032898, OS_LOG_TYPE_DEBUG))
      {
        ...
        !v46))
  {
    ...
    if ([v47 count])
    {
      ...
      v55 = qword_100032898;
      if (os_log_type_enabled((os_log_t)qword_100032898, OS_LOG_TYPE_INFO))
      {
        *(_DWORD *)buf = 138412546;
        id v85 = v8;
        __int16 v86 = 2112;
...
LABEL_33:
  ...
  uint64_t v22 = (id)qword_100032898;
    ...
    do
    {
      ...
      do
      {
        ...
        else
        {
          ...
          __int16 v44 = (id)qword_100032898;
...
LABEL_34:
      ...
      else
      {
        ...
        unsigned int v24 = qword_100032898;
...
+ (id)_associatedDomainsFromEntitlementForBundleRecord:(id)a3 applicationIdentifier:(id)a4 developerModeEnabled:(BOOL)a5 enterpriseContext:(id)a6
{
  ...
  if (v32)
  {
    ...
    if (v20)
    {
      ...
      do
      {
        for (i = 0; i != v20; i = (char *)i + 1)
        {
          ...
          unsigned int v24 = objc_msgSend(v23, "SWCDomain", context);
    ...
    v36[2] = sub_10000D440;
    v36[3] = &unk_10002C9F0;
    id v28 = objc_msgSend(objc_alloc((Class)NSMutableDictionary), "initWithCapacity:", objc_msgSend(v27, "count"));
    id v37 = v28;
...
+ (void)_enumerateJSONFilesForBundleRecord:(id)a3 applicationIdentifier:(id)a4 block:(id)a5
{
  ...
  if (v11)
  {
    ...
    id v20 = sub_10000DD6C;
    uint64_t v21 = &unk_10002CA58;
    id v22 = v10;
    uint64_t v23 = &v24;
    unsigned int v12 = objc_retainBlock(&v18);
    objc_msgSend(a1, "enumerateJSONResourceURLsForBundleURL:block:", v11, v12, v18, v19, v20, v21);
...
+ (id)_entriesFromBuiltInJSONForBundleRecord:(id)a3 applicationIdentifier:(id)a4
{
  ...
  id v25 = sub_10000E280;
  uint64_t v26 = sub_10000E290;
  id v27 = 0;
    ...
    if (v8)
    {
      ...
      do
      {
        for (i = 0; i != v8; i = (char *)i + 1)
        {
          ...
          objc_msgSend(*(id *)(*((void *)&v14 + 1) + 8 * i), "setLastCheckedDate:", v6, (void)v14);
        }
        id v8 = [v7 countByEnumeratingWithState:&v14 objects:v28 count:16];
      }
      while (v8);
