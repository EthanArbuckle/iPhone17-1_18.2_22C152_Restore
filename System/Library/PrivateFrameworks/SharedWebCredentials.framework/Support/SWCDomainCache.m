    ...
    if (v9)
    {
      ...
      do
      {
        for (i = 0; i != v10; i = (char *)i + 1)
        {
          ...
          v14 = objc_msgSend(v13, "domain", v22);
...
LABEL_13:
      ...
      else
      {
        ...
        while (1)
        {
          ...
          v14 = objc_msgSend(v8, "objectAtIndexedSubscript:", (char *)objc_msgSend(v8, "count") - 1);
          v15 = [(__CFString *)v10 stringByAppendingFormat:@"%@", v14];

          id v16 = objc_alloc((Class)_SWCDomain);
          id v17 = [v4 port];
          id v18 = objc_msgSend(v16, "initWithHost:port:wildcard:modeOfOperation:", v15, v17, 1, objc_msgSend(v4, "modeOfOperation"));
