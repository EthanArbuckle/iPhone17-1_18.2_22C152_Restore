...
- (void)setStrength:(float)a3
{
  if (self->super._isPresentationObject || *((float *)&self->super._enabled + 1) != a3)
  {
    *((float *)&self->super._enabled + 1) = a3;
    ...
    v9[4] = self;
    float v10 = a3;
    objc_msgSend_postCommandWithContext_object_key_applyBlock_(VFXTransaction, v8, v7, (uint64_t)self, @"strength", v9);
  }
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *(float *)&double v9 = self->_strength;
...
- (void)_syncObjCModel
{
  ...
  *((float *)&self->super._enabled + 1) = sub_1B6529878((uint64_t)self->super._cameraEffect, v3, v4, v5, v6, v7, v8, v9);
  self->_strength = sub_1B6529330((uint64_t)self->super._cameraEffect, v10, v11, v12, v13, v14, v15, v16);
}
...
- (void)encodeWithCoder:(id)a3
{
  ...
  *(float *)&double v8 = self->_strength;
...
- (double)createCFXObject
{
  ...
  uint64_t v0 = sub_1B63C8D44(qword_1EB995308, 0x40uLL);
