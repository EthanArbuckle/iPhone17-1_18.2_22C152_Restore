...
- (void)customizeNotificationContent:(id)a3 withCompletionBlock:(id)a4
{
  ...
  id v13 = v7;
  v10.receiver = self;
  v10.super_class = (Class)STAskToManageContactsRequestReceivedUserNotificationContext;
  id v8 = v7;
  id v9 = v6;
...
{
  v2 = [NSString localizedUserNotificationStringForKey:@"AskToManageContactsRequestReceivedNotificationTitle" arguments:0];
  [*(id *)(a1 + 32) setTitle:v2];

  objc_super v3 = [NSString localizedUserNotificationStringForKey:@"AskToManageContactsRequestReceivedNotificationBody" arguments:0];
  [*(id *)(a1 + 32) setBody:v3];

  [*(id *)(a1 + 32) setCategoryIdentifier:@"com.apple.screentime.manage-contacts-request"];
