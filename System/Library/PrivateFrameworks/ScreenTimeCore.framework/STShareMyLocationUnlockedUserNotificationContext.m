...
{
  v3.receiver = self;
  v3.super_class = (Class)STShareMyLocationUnlockedUserNotificationContext;
...
{
  v4.receiver = self;
  v4.super_class = (Class)STShareMyLocationUnlockedUserNotificationContext;
...
- (void)customizeNotificationContent:(id)a3 withCompletionBlock:(id)a4
{
  ...
  id v13 = v7;
  v10.receiver = self;
  v10.super_class = (Class)STShareMyLocationUnlockedUserNotificationContext;
  id v8 = v7;
  id v9 = v6;
...
{
  v2 = [NSString localizedUserNotificationStringForKey:@"ShareMyLocationUnlockedUserNotificationTitle" arguments:0];
  [*(id *)(a1 + 32) setTitle:v2];

  objc_super v3 = [NSString localizedUserNotificationStringForKey:@"ShareMyLocationUnlockedUserNotificationBody" arguments:0];
  [*(id *)(a1 + 32) setBody:v3];
