...
{
  v3.receiver = self;
  v3.super_class = (Class)STLocationServicesLockedUserNotificationContext;
...
{
  v4.receiver = self;
  v4.super_class = (Class)STLocationServicesLockedUserNotificationContext;
...
- (void)customizeNotificationContent:(id)a3 withCompletionBlock:(id)a4
{
  ...
  id v13 = v7;
  v10.receiver = self;
  v10.super_class = (Class)STLocationServicesLockedUserNotificationContext;
  id v8 = v7;
  id v9 = v6;
  [(STUserNotificationContext *)&v10 customizeNotificationContent:v9 withCompletionBlock:v11];
}

uint64_t __100__STLocationServicesLockedUserNotificationContext_customizeNotificationContent_withCompletionBlock___block_invoke(uint64_t a1)
{
  v2 = [NSString localizedUserNotificationStringForKey:@"LocationServicesLockedUserNotificationTitle" arguments:0];
  [*(id *)(a1 + 32) setTitle:v2];

  objc_super v3 = [NSString localizedUserNotificationStringForKey:@"LocationServicesLockedUserNotificationBody" arguments:0];
  [*(id *)(a1 + 32) setBody:v3];
