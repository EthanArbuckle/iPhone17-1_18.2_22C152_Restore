...
- (void)customizeNotificationContent:(id)a3 withCompletionBlock:(id)a4
{
  ...
  id v13 = v7;
  v10.receiver = self;
  v10.super_class = (Class)STLocationServicesUnlockedUserNotificationContext;
  id v8 = v7;
  id v9 = v6;
...
{
  v2 = [NSString localizedUserNotificationStringForKey:@"LocationServicesUnlockedUserNotificationTitle" arguments:0];
  [*(id *)(a1 + 32) setTitle:v2];

  objc_super v3 = [NSString localizedUserNotificationStringForKey:@"LocationServicesUnlockedUserNotificationBody" arguments:0];
  [*(id *)(a1 + 32) setBody:v3];
