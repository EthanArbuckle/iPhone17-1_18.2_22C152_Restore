...
- (void)customizeNotificationContent:(id)a3 withCompletionBlock:(id)a4
{
  ...
  id v14 = v7;
  v10.receiver = self;
  v10.super_class = (Class)STAskToManageContactsApprovedResponseReceivedUserNotificationContext;
  id v8 = v7;
  id v9 = v6;
...
uint64_t __121__STAskToManageContactsApprovedResponseReceivedUserNotificationContext_customizeNotificationContent_withCompletionBlock___block_invoke(uint64_t a1)
{
  ...
  objc_super v5 = [v2 localizedUserNotificationStringForKey:@"AskToManageContactsApprovedResponseReceivedNotificationTitle" arguments:v4];
  ...
  id v9 = [v6 localizedUserNotificationStringForKey:@"AskToManageContactsApprovedResponseReceivedNotificationBody" arguments:v8];
  [*(id *)(a1 + 32) setBody:v9];
