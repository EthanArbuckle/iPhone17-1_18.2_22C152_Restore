...
- (int64_t)copyComponentStatus
{
  if ((objc_msgSend_isFDRDataClassSupported_(MEMORY[0x1E4F5CD58], a2, @"bcrt", v2) & 1) == 0
    && !objc_msgSend_isFDRDataClassSupported_(MEMORY[0x1E4F5CD58], v5, @"vcrt", v6))
  {
    return 0;
  }
...
LABEL_24:
            v67 = handleForCategory();
            if (os_log_type_enabled(v67, OS_LOG_TYPE_DEFAULT))
            {
              *(_WORD *)buf = 0;
              _os_log_impl(&dword_1D9666000, v67, OS_LOG_TYPE_DEFAULT, "component failed preflight proceeding", buf, 2u);
            }
