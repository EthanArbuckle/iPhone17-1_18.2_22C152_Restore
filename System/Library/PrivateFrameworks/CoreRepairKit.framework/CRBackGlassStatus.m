...
- (int64_t)copyComponentStatus
{
  if ((objc_msgSend_isFDRDataClassSupported_(MEMORY[0x1E4F5CD58], a2, @"bCfg", v2) & 1) != 0
    || objc_msgSend_isFDRDataClassSupported_(MEMORY[0x1E4F5CD58], v6, @"LCfg", v7))
  {
...
LABEL_21:
            v69 = handleForCategory();
            if (os_log_type_enabled(v69, OS_LOG_TYPE_DEFAULT))
            {
              *(_WORD *)buf = 0;
              _os_log_impl(&dword_1D9666000, v69, OS_LOG_TYPE_DEFAULT, "component failed preflight proceeding", buf, 2u);
            }
