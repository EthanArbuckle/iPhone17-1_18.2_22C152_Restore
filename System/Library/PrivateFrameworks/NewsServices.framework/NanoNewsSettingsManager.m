...
+ (id)preferredRefreshDates
{
  ...
  else
  {
    ...
    long long v19 = 0u;
    long long v20 = 0u;
    id v12 = [&off_100010DC0 countByEnumeratingWithState:&v19 objects:v23 count:16];
    if (v12)
    {
      id v13 = v12;
      ...
      do
      {
        ...
        {
          if (*(void *)v20 != v14) {
            objc_enumerationMutation(&off_100010DC0);
          }
          objc_msgSend(v11, "setHour:", objc_msgSend(*(id *)(*((void *)&v19 + 1) + 8 * i), "integerValue"));
          v16 = [v8 dateFromComponents:v11];
          [v9 addObject:v16];
        }
        id v13 = [&off_100010DC0 countByEnumeratingWithState:&v19 objects:v23 count:16];
      }
      while (v13);
    }
    id v6 = [v9 copy];
