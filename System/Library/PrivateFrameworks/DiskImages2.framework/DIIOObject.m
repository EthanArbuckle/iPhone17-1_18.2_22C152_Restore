...
- (DIIOObject)initWithRegistryEntryID:(unint64_t)a3 error:(id *)a4
{
  ...
  CFDictionaryRef v8 = IORegistryEntryIDMatching(a3);
  ...
  {
    v11 = objc_msgSend(NSString, "stringWithFormat:", @"Cannot find registry entry ID 0x%llx", a3);
    objc_super v10 = +[DIError nilWithEnumValue:153 verboseInfo:v11 error:a4];
  }
  return v10;
}
...
- (DIIOObject)initWithClassName:(id)a3 error:(id *)a4
{
  ...
  mach_port_t v7 = *MEMORY[0x263F0EC88];
  id v8 = v6;
  CFDictionaryRef v9 = IOServiceMatching((const char *)[v8 UTF8String]);
  ...
  {
    v12 = [NSString stringWithFormat:@"Cannot find IO object of class %@", v8];
...
{
  unsigned int v10 = 0;
  uint64_t v5 = MEMORY[0x223C24360]([(DIIOObject *)self ioObj], "IOService", *(void *)&a3, &v10);
  if (v5)
  {
    id v6 = [NSString stringWithFormat:@"Failed creating IO iterator, err code %d", v5];
    mach_port_t v7 = +[DIError nilWithEnumValue:153 verboseInfo:v6 error:a4];
  }
  else
  {
    id v8 = [DIIOIterator alloc];
...
- (DIIOObject)ioObjectWithClassName:(id)a3 iterateParent:(BOOL)a4 error:(id *)a5
{
  BOOL v6 = a4;
  id v8 = a3;
  CFDictionaryRef v9 = (const char *)[v8 UTF8String];
  if (v6) {
    uint64_t v10 = 3;
  }
  else {
...
- (id)copyPropertyWithClass:(Class)a3 key:(id)a4
{
  ...
  io_registry_entry_t v6 = [(DIIOObject *)self ioObj];
...
- (id)copyParentWithError:(id *)a3
{
  ...
  if (ParentEntry)
  {
    ...
    io_registry_entry_t v6 = +[DIError nilWithEnumValue:153 verboseInfo:v5 error:a3];
  }
  else
  {
    mach_port_t v7 = [DIIOObject alloc];
...
+ (id)copyDiskImagesControllerWithError:(id *)a3
{
  ...
  if (v4)
  {
    io_registry_entry_t v6 = v4;
  }
  else
  {
    io_registry_entry_t v6 = +[DIError nilWithEnumValue:153 verboseInfo:@"Failed to find DiskImages2 controller, driver might not be installed" error:a3];
  }
  mach_port_t v7 = v6;
