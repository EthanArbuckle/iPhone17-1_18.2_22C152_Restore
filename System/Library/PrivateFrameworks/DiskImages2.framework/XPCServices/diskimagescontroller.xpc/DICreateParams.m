...
- (void)createDiskImageParamsXPC
{
  ...
  v3 = (void *)sub_100002B24((uint64_t)exception, (uint64_t)"Invalid argument, please use one of the DICreateParams derived classes instead", 0x16u);
}
