...
- (CryptoBackendXPC)initWithFormat:(const void *)a3 baseBackendXPC:(id)a4
{
  ...
  if (v8)
  {
    ...
    sub_1000D757C((uint64_t)&v12, (uint64_t)a3, &v14);
    long long v15 = v14;
    long long v14 = 0uLL;
    ...
    if (*((void *)&v14 + 1)) {
      sub_100004944(*((std::__shared_weak_count **)&v14 + 1));
    }
    if (v13) {
      sub_100004944(v13);
    }
...
- (CryptoBackendXPC)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    sub_1000D2CCC(v4, (uint64_t *)[(BackendXPC *)v5 cryptoHeader], &v17);
    if (!v17)
    {
    ...
    sub_1000D7664((uint64_t)&v13, (uint64_t)&v17, &v15);
    long long v16 = v15;
    long long v15 = 0uLL;
