...
+ (id)getAuthValueWithBackend:(shared_ptr<Backend>)a3 authTableNumEntries:(int)a4 mechanism:(int)a5 error:(id *)a6
{
  ...
  if (v19)
  {
    ...
    v22[3] = v22;
    v20 = v9;
    sub_10004A2B0((uint64_t)v21, (uint64_t)v22);
    sub_10004A330(v22);
    uint64_t v10 = sub_1000496D0(*ptr, (uint64_t)v20, *(void *)(v19 + 12), *(void *)(v19 + 4));
    if ((v10 & 0x80000000) != 0)
    {
...
LABEL_6:
  ...
  if (v21)
  {
    ...
    sub_10004A2B0((uint64_t)v26, (uint64_t)&v22);
    sub_10004A330(&v22);
    uint64_t v13 = sub_1000496D0(v10, v25, 564, *(void *)(v21 + 4));
    if (v13 == 564)
    {
      sub_10013DFC4(&v22, v25, v13);
      sub_100049E90((uint64_t)a4, (uint64_t)&v22);
      BOOL v14 = 1;
    }
    else
    {
