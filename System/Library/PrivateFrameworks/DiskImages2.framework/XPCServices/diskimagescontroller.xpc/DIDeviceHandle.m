  ...
  if (v5)
  {
    ...
    if (v9)
    {
      ...
      if (RunLoopSource)
      {
        ...
        if (!IOServiceAddMatchingNotification(v10, "IOServiceMatched", v14, (IOServiceMatchingCallback)sub_100034BB0, refCon, &notification))
        {
          CFRunLoopMode v18 = kCFRunLoopDefaultMode;
          sub_100034BB0((uint64_t)refCon, notification);
          while (!v21)
          {
