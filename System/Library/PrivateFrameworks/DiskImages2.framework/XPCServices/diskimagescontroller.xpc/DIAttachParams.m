...
- (BOOL)reOpenIfWritableWithError:(id *)a3
{
  ...
  if (!v9)
  {
    ...
    if (*(void *)v43) {
      sub_100004944(*(std::__shared_weak_count **)v43);
    }
    if ((v10 & 1) == 0)
    {
...
- (BOOL)updateStatFSWithError:(id *)a3
{
  ...
  {
    [(DIBaseParams *)self backend];
    sub_1001493EC((uint64_t)&v17, &v19);
    uint64_t v7 = sub_10012AF1C((uint64_t)&v19);
    if (v20) {
      sub_100004944(v20);
    }
    if (v18) {
