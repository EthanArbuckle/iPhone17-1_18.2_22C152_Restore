...
- (PluginBackendXPC)initWithURL:(id)a3 openMode:(int)a4
{
  ...
  if (v8)
  {
    ...
    v11 = [v7 pluginParams];
    v17 = v11;
    sub_1000D7DCC(&v20, (uint64_t *)&v17, &v22, &v18);

    sub_1000D800C(&v18, &v15);
    long long v16 = v15;
    long long v15 = 0uLL;
    -[BackendXPC setBackend:](v8, "setBackend:", &v16, 0);
    if (*((void *)&v16 + 1)) {
      sub_100004944(*((std::__shared_weak_count **)&v16 + 1));
    }
    if (*((void *)&v15 + 1)) {
      sub_100004944(*((std::__shared_weak_count **)&v15 + 1));
    }
...
- (PluginBackendXPC)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    long long v22 = *(_OWORD *)off_1001B61A8;
    v23 = j__free_0;
    id v13 = [(DIURL *)v5->_URL pluginName];
    uint64_t v18 = 0;
    v19 = (char *)[v13 UTF8String];
    v17 = v12;
    sub_1000D8314(&v19, (uint64_t)&v18, (uint64_t)&unk_100174297, (uint64_t)&v22, &v17, &v20);

    sub_1000D800C(&v20, &v15);
    long long v16 = v15;
    long long v15 = 0uLL;
