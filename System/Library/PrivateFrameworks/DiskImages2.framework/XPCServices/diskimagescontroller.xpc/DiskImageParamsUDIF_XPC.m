...
- (unique_ptr<DiskImage,)createSinkDiskImage
{
  ...
  if ((*(unsigned int (**)(void))(*(void *)v11 + 48))(v11))
  {
    ...
    if (v6)
    {
      ...
      sub_1000ABB50((uint64_t)&v11, &v10, &v9);
      long long v7 = v9;
      long long v9 = 0uLL;
...
- (DiskImageParamsUDIF_XPC)initWithCoder:(id)a3
{
  ...
  if ([(DiskImageParamsXPC *)&v9 initWithCoder:v4])
  {
    ...
    sub_1000039A0(v7, (uint64_t)"Unexpected UDIF header length (", 31);
    std::ostream::operator<<();
    sub_1000039A0(v7, (uint64_t)")", 1);
    sub_10000550C((uint64_t)exception, (uint64_t)v7, 0x9Au);
  }
...
- (id)instanceID
{
  ...
  [v3 getUUIDBytes:v10];
  sub_1001153E0((uint64_t)self->_header.__ptr_.__value_, (uint64_t)&v11);
  id v4 = objc_alloc((Class)NSUUID);
  v9[0] = sub_10014B6F0(v10, 528);
  v9[1] = v5;
