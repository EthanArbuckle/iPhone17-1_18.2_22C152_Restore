...
- (PluginDiskImageGraphNode)initWithPluginName:(id)a3 pluginParams:(id)a4 tag:(id)a5 UUID:(id)a6 parentNode:(id)a7 metadata:(id)a8 isCache:(BOOL)a9
{
  ...
  if (v18)
  {
    ...
    uint64_t v20 = [objc_alloc(NSDictionary) initWithDictionary:v17 copyItems:1];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 68157954;
      ...
      __int16 v11 = 2080;
      v12 = "-[PluginDiskImageGraphNode(Append) validateAppendedImageWithInfo:error:]";
      _os_log_impl(&dword_21E237000, v7, OS_LOG_TYPE_DEFAULT, "%.*s: Appending to plugin node, skipping validation.", buf, 0x12u);
    }
  }
  *__error() = v4;
  return 1;
