...
- (AAS3DownloadSession)initWithURL:(id)a3 streamBase:(id *)a4 maxAttempts:(unsigned int)a5 pauseInterval:(float)a6 maxRequestsInFlight:(unsigned int)a7
{
  ...
  if (v14)
  {
    ...
    unsigned int v55 = a7;
    id v57 = v13;
    id v56 = (id)[MEMORY[0x263EFC648] ephemeralSessionConfiguration];
    ...
    v35 = (NSURLSession *)(id)[MEMORY[0x263EFC640] sessionWithConfiguration:v56];
    ...
    v39 = (NSLock *)objc_alloc_init(MEMORY[0x263F08958]);
    ...
    v46 = (NSLock *)objc_alloc_init(MEMORY[0x263F08958]);
...
LABEL_2:
  ...
  switch(v14)
  {
    ...
    case 206:
      ...
      v32 = (const void *)[v10 bytes];
LABEL_29:
      if ([v9 buf]) {
        memcpy((void *)[v9 buf], v32, v30);
      }
      if ([v9 stream])
      {
        [v9 stream];
  ...
  if (v12 && (id v34 = (id)[v12 description]) != 0)
  {
    id v35 = v34;
    [v35 UTF8String];
  ...
  if ([v9 remainingAttempts])
  {
    ...
    dispatch_semaphore_t v44 = (void *)MEMORY[0x263F08B88];
    [v9 pauseInterval];
    [v44 sleepForTimeInterval:v45];
    [v9 pauseInterval];
    *(float *)&double v47 = v46 + v46;
    [v9 setPauseInterval:v47];
