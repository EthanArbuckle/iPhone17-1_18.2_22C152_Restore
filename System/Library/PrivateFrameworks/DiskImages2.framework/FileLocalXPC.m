...
- (FileLocalXPC)initWithURL:(id)a3 fileOpenFlags:(int)a4
{
  ...
  if (v7)
  {
    ...
    std::allocate_shared[abi:ne180100]<FileLocal,std::allocator<FileLocal>,char const*,int &,void>(&v9, &v13, &v10);
    long long v11 = v10;
    long long v10 = 0uLL;
...
- (FileLocalXPC)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    BOOL v12 = [v4 decodeBoolForKey:@"is_writable"];
    char v11 = [v4 decodeBoolForKey:@"is_locked"];
    int v10 = dup([v6 fileDescriptor]);
    std::allocate_shared[abi:ne180100]<FileLocal,std::allocator<FileLocal>,int &,BOOL &,BOOL &,void>(&v10, &v12, &v11, &v8);
    long long v9 = v8;
    long long v8 = 0uLL;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v7 = (void *)[objc_alloc(MEMORY[0x263F08840]) initWithFileDescriptor:(*(uint64_t (**)(FileLocal *))(*(void *)v6 + 176))(v6)];
