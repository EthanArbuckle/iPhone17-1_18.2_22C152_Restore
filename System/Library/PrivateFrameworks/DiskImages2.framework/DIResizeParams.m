...
LABEL_14:
    ...
    *(void *)buf = 0;
    ...
    if ((*(uint64_t (**)(uint64_t))(*(void *)v37 + 40))(v37))
    {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)&buf[4] = 34;
            __int16 v39 = 2080;
            v40 = "-[DIResizeParams resizeWithError:]";
            _os_log_impl(&dword_21E237000, v26, OS_LOG_TYPE_DEFAULT, "%.*s: New disk image size is the same as previous", buf, 0x12u);
          }
        }
        *__error() = v20;
        BOOL v8 = 1;
        ...
        else
        {
          ...
          if (os_log_type_enabled(v33, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)&buf[4] = 34;
            ...
            _os_log_impl(&dword_21E237000, v33, OS_LOG_TYPE_DEFAULT, "%.*s: Disk image resized to %llu bytes", buf, 0x1Cu);
          }
        }
        *__error() = v29;
      ...
      BOOL v23 = +[DIError failWithPOSIXCode:v25 verboseInfo:@"Failed to resize the image" error:a3];
    }
    else
    {
      BOOL v23 = +[DIError failWithPOSIXCode:45 verboseInfo:@"Image doesn't support resizing" error:a3];
    }
    BOOL v8 = v23;
LABEL_30:
    uint64_t v27 = v37;
...
- (uint64_t)resizeWithError:(uint64_t)a1 .cold.1(uint64_t a1)
{
