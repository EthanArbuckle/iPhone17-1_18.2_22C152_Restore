...
LABEL_3:
  ...
  v13 = [v7 scheme];
  int v14 = [v13 isEqualToString:@"knox"];
  ...
  {
    v18 = [v7 scheme];
    int v19 = [v18 isEqualToString:@"plugin"];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(void *)&v30[2] = "+[DiskImageParamsXPC newWithURL:fileOpenFlags:error:]";
      ...
      __int16 v33 = 1024;
      int v34 = (int)v6;
      _os_log_impl(&dword_21E237000, v21, OS_LOG_TYPE_DEFAULT, "%.*s: Image file %{private}@ opened with flags %d", buf, 0x22u);
    }
  }
  *__error() = v15;
  [(BackendXPC *)v10 backend];
  std::dynamic_pointer_cast[abi:ne180100]<FileLocal,Backend>(&v27, (void **)buf);
  if (v28) {
    std::__shared_weak_count::__release_shared[abi:ne180100](v28);
  }
  if (*(void *)buf && FileDescriptor::is_device(*(FileDescriptor **)(*(void *)buf + 40)))
  {
...
+ (BOOL)getAEAKeyWithHelper:(void *)a3 keyBuffer:(char *)a4 bufferSize:(unint64_t)a5 error:(id *)a6
{
  ...
  v13 = v8;
  return ((uint64_t (*)(void **, char *))off_26CF1FAB8[v6])(&v13, (char *)a3 + 8);
}
...
+ (id)tryCreateAEABackendWithBackendXPC:(id)a3 error:(id *)a4
{
  ...
  std::dynamic_pointer_cast[abi:ne180100]<FileLocal,Backend>(&v13, &v15);
  if (v14) {
  ...
  AEAwrapper::ByteStream::ByteStream(&v13, &v17);
  if (AEAwrapper::ByteStream::pread((AAByteStream *)&v13, &v17, 4uLL, 0) < 0)
  {
  ...
  int v8 = (int)v17;
  AEAwrapper::ByteStream::~ByteStream((AAByteStream *)&v13);
  if (v8 == 826361153)
  {
...
- (BOOL)makeNewImageEncryptedWithCertificate:(id)a3 error:(id *)a4
{
  ...
  int v8 = (void *)[v7 newUnlockedBackendXPCWithPassphrase:0 certificate:v6 isNewImage:1 error:a4];
...
- (BOOL)makeNewImageEncryptedWithPassphrase:(const char *)a3 certificate:(id)a4 error:(id *)a5
{
  id v8 = a4;
  CC_LONG v9 = [(DiskImageParamsXPC *)self backendXPC];
  uint64_t v10 = (void *)[v9 newUnlockedBackendXPCWithPassphrase:a3 certificate:v8 isNewImage:1 error:a5];
...
- (shared_ptr<DiskImage>)createShadowDiskImageWithBackend:(shared_ptr<Backend>)a3 numBlocks:(unint64_t)a4 sinkDiskImage:(const void *)a5 cache_only:(BOOL)a6 stack_size:(unint64_t)a7
{
  ...
  *(_DWORD *)&v32[3] = (v14 - (v8 > 3)) & ~((v14 - (v8 > 3)) >> 31);
  ...
  {
    unint64_t v30 = 0;
    unint64_t v18 = (*(uint64_t (**)(unint64_t))(*(void *)a4 + 24))(a4);
    unint64_t v19 = 0x10000000000000 / v18;
    v29 = 0;
    unint64_t v30 = 0x10000000000000 / v18;
    if (!cntrl)
    {
      unint64_t v18 = (*(uint64_t (**)(unint64_t))(*(void *)a4 + 32))(a4);
  ...
  di_asif::header::header((di_asif::header *)v36, *(Backend **)ptr);
  int v15 = (DiskImage *)std::allocate_shared[abi:ne180100]<DiskImageASIF,std::allocator<DiskImageASIF>,std::shared_ptr<Backend> &,di_asif::header &,di_asif::options &,void>((DiskImageASIF **)ptr, (Backend *)v36, (uint64_t)&v31, &identifier);
  if (((((*(unsigned char *)(identifier + 44) & 1) == 0) ^ v9) & 1) == 0)
  {
    char v24 = __cxa_allocate_exception(0x40uLL);
    *char v24 = &unk_26CF39EE0;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 68157954;
        ...
        __int16 v12 = 2080;
        v13 = "-[DiskImageParamsXPC allowOnDiskCacheWithSinkDiskImage:]";
        _os_log_impl(&dword_21E237000, v8, OS_LOG_TYPE_DEFAULT, "%.*s: On disk cache is not supported on embedded systems", buf, 0x12u);
      }
    }
    *__error() = v5;
  }
...
- (unique_ptr<DiskImage,)createDiskImageWithCache:(BOOL)a3 shadowValidation:(BOOL)a4
{
  ...
  BOOL v52 = v5 && [(DiskImageParamsXPC *)self allowOnDiskCacheWithSinkDiskImage:&v70];
...
LABEL_6:
    ...
    uint64_t v11 = [obj countByEnumeratingWithState:&v63 objects:v77 count:16];
    if (v11)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v11; ++i)
        {
          ...
          uint64_t v18 = [v15 numBlocks];
          uint64_t v19 = [v15 isCache];
          v20 = [(DiskImageParamsXPC *)self shadowChain];
          uint64_t v21 = [v20 nodes];
          ...
          v75.n128_u64[0] = v23;
          v75.n128_u64[1] = *(void *)&buf[8];
          *(void *)buf = 0;
          *(void *)&uint8_t buf[8] = 0;
          int v76 = v24;
          std::vector<std::tuple<std::shared_ptr<DiskImage>,DiskImageStackable::role>>::insert(&v67, v67, &v75);
          if (v75.n128_u64[1]) {
            std::__shared_weak_count::__release_shared[abi:ne180100]((std::__shared_weak_count *)v75.n128_u64[1]);
          }
          if (*(void *)&buf[8]) {
    ...
    if (v52)
    {
      if (!confstr(65538, (char *)&v75, 0x400uLL))
      {
        exception = __cxa_allocate_exception(0x40uLL);
        void *exception = &unk_26CF39EE0;
      ...
      uint64_t v74 = 0;
      uint64_t identifier = di_stackable::get_identifier(0, v27);
      uint64_t v74 = v28;
      *(void *)buf = 0;
      *(void *)&uint8_t buf[8] = 0;
      if (identifier | v28)
      {
        v29 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDBytes:&identifier];
      }
      else
      {
        v29 = [(DiskImageParamsXPC *)self instanceID];
      }
      unint64_t v30 = [v29 UUIDString];

      char v31 = [NSString stringWithFormat:@"%@%@.%@", @"diskimage_", v30, @"cache"];
      v32 = [NSURL fileURLWithFileSystemRepresentation:&v75 isDirectory:1 relativeToURL:0];
      char v33 = [v32 URLByAppendingPathComponent:v31];
      [(DiskImageParamsXPC *)self setCacheURL:v33];

      int v34 = *__error();
      if (DIForwardLogs())
      {
        uint64_t v59 = 0;
        uint64_t v35 = getDIOSLog();
        os_log_type_enabled(v35, OS_LOG_TYPE_DEFAULT);
        v36 = [(DiskImageParamsXPC *)self cacheURL];
        v37 = [v36 path];
        *(_DWORD *)buf = 68158210;
      ...
      else
      {
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_WORD *)&buf[18] = 2114;
          v72 = v41;
          _os_log_impl(&dword_21E237000, v39, OS_LOG_TYPE_DEFAULT, "%.*s: On disk cache path: %{public}@", buf, 0x1Cu);
        }
      }
      *__error() = v34;
      id v42 = [(DiskImageParamsXPC *)self cacheURL];
      *(void *)buf = [v42 fileSystemRepresentation];
      std::allocate_shared[abi:ne180100]<PurgeableFileBackend,std::allocator<PurgeableFileBackend>,char const*,void>((char **)buf, &v59);
      ...
      v43 = [(DiskImageParamsXPC *)self shadowChain];
      v44 = [v43 nodes];
      -[DiskImageParamsXPC createShadowDiskImageWithBackend:numBlocks:sinkDiskImage:cache_only:stack_size:](self, "createShadowDiskImageWithBackend:numBlocks:sinkDiskImage:cache_only:stack_size:", &v56, 0, 0, 1, [v44 count] + 1);
      ...
      *(_OWORD *)buf = v58;
      long long v58 = 0uLL;
      *(_DWORD *)&buf[16] = 2;
      std::vector<std::tuple<std::shared_ptr<DiskImage>,DiskImageStackable::role>>::emplace_back<std::tuple<std::shared_ptr<DiskImage>,DiskImageStackable::role>>(&v67, (uint64_t)buf);
      if (*(void *)&buf[8]) {
        std::__shared_weak_count::__release_shared[abi:ne180100](*(std::__shared_weak_count **)&buf[8]);
      }
      if (*((void *)&v58 + 1)) {
    ...
    int v45 = (*(uint64_t (**)(void))(MEMORY[0] + 40))(0) ^ 1;
    if (v67 != v68) {
      int v45 = 1;
    }
    __n128 v75 = (__n128)(unint64_t)v50;
    atomic_fetch_add_explicit((atomic_ullong *volatile)8, 1uLL, memory_order_relaxed);
    int v76 = v45;
    std::vector<std::tuple<std::shared_ptr<DiskImage>,DiskImageStackable::role>>::emplace_back<std::tuple<std::shared_ptr<DiskImage>,DiskImageStackable::role>>(&v67, (uint64_t)&v75);
    if (v75.n128_u64[1]) {
      std::__shared_weak_count::__release_shared[abi:ne180100]((std::__shared_weak_count *)v75.n128_u64[1]);
    }
    operator new();
...
- (BOOL)lockBackendsWithWritableOnly:(BOOL)a3 error:(id *)a4
{
  ...
  else
  {
    ...
    if (v10)
    {
      ...
      long long v19 = 0u;
      long long v20 = 0u;
      uint64_t v11 = [(DiskImageParamsXPC *)self shadowChain];
...
- (id)description
{
  ...
  uint64_t v6 = [(DiskImageParamsXPC *)self backendXPC];
...
- (DiskImageParamsXPC)initWithCoder:(id)a3
{
  ...
  int v9 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"instanceID"];
...
- (BOOL)mountedOnAPFS
{
  ...
  std::dynamic_pointer_cast[abi:ne180100]<FileLocal,Backend>(&v8, (void **)&v10);
  if (v9) {
  ...
  if (v10) {
    BOOL is_mounted_on_apfs = FileDescriptor::is_mounted_on_apfs(v10[5]);
  }
  else {
