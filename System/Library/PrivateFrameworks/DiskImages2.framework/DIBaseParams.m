...
- (void)encodeWithCoder:(id)a3
{
  ...
  uint64_t v6 = [(DIBaseParams *)self shadowChain];
  ...
  uint64_t v7 = [(DIBaseParams *)self deserializationError];
...
- (DIBaseParams)initWithURL:(id)a3 error:(id *)a4
{
  ...
  uint64_t v7 = [(DIBaseParams *)&v17 init];
  if (v7)
  {
    ...
    char v10 = objc_alloc_init(DIShadowChain);
    shadowChain = v7->_shadowChain;
    v7->_shadowChain = v10;

    v12 = [(DIURL *)v7->_inputURL path];
    if (!v12
      || ([MEMORY[0x263F08BA0] componentsWithURL:v6 resolvingAgainstBaseURL:1],
...
- (BOOL)openExistingImageWithFlags:(int)a3 error:(id *)a4
{
  ...
  uint64_t v7 = [(DIBaseParams *)self diskImageParamsXPC];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 68157954;
        ...
        __int16 v19 = 2080;
        objc_super v20 = "-[DIBaseParams openExistingImageWithFlags:error:]";
        _os_log_impl(&dword_21E237000, v15, OS_LOG_TYPE_DEFAULT, "%.*s: Using existing disk image params", buf, 0x12u);
      }
    }
    *__error() = v8;
    return 1;
...
- (BOOL)tryResolvePstackChain:(id *)a3
{
  ...
  id v35 = 0;
  id v36 = 0;
  BOOL v6 = +[DiskImageGraph loadPlistDictFromURL:v5 dict:&v36 error:&v35];
  id v7 = v36;
  id v8 = v35;
  ...
  if (v6)
  {
    ...
    if (!v10)
    {
      ...
      {
        v34 = v13;
        BOOL v14 = [MEMORY[0x263EFF980] array];
        ...
        uint64_t v21 = [(DIBaseParams *)self shadowChain];
      ...
      if (!DIForwardLogs())
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 68157954;
          ...
          _os_log_impl(&dword_21E237000, v31, OS_LOG_TYPE_DEBUG, "%.*s: Not a pstack", buf, 0x12u);
        }
        ...
        if (!DIForwardLogs())
        {
          ...
          if (os_log_type_enabled(v32, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = 68157954;
            ...
            __int16 v39 = 2080;
            v40 = "-[DIBaseParams tryResolvePstackChain:]";
            _os_log_impl(&dword_21E237000, v32, OS_LOG_TYPE_DEBUG, "%.*s: Not a pstack", buf, 0x12u);
          }
...
- (BOOL)checkBeforeSetWithIsPassphrase:(BOOL)a3 error:(id *)a4
{
  ...
  if (![(DIBaseParams *)self hasUnlockedBackend])
  {
    if ([(DIBaseParams *)self RAMdisk])
    {
      ...
      BOOL v10 = +[DIError failWithEnumValue:150 verboseInfo:v9 error:a4];
    }
    else
    {
      ...
      if (!DIForwardLogs())
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = 68157954;
          ...
          _os_log_impl(&dword_21E237000, v14, OS_LOG_TYPE_DEFAULT, "%.*s: Passphrase is correct", buf, 0x12u);
        }
      ...
      if (!DIForwardLogs())
      {
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = 68157954;
          ...
          __int16 v21 = 2080;
          char v22 = "-[DIBaseParams setPassphrase:error:]";
          _os_log_impl(&dword_21E237000, v15, OS_LOG_TYPE_DEFAULT, "%.*s: Found certificate in keychain", buf, 0x12u);
        }
...
- (NSUUID)encryptionUUID
{
  if (*(void *)[(DIBaseParams *)self cryptoHeader]) {
    v3 = objc_msgSend(objc_alloc(MEMORY[0x263F08C38]), "initWithUUIDBytes:", *(void *)-[DIBaseParams cryptoHeader](self, "cryptoHeader") + 36);
  }
  else {
    v3 = 0;
  }
...
- (id)description
{
  ...
  BOOL v6 = [(DIBaseParams *)self diskImageParamsXPC];
...
- (BOOL)prepareImageWithXpcHandler:(id)a3 fileMode:(int64_t)a4 error:(id *)a5
{
  id v8 = a3;
  if (!*(void *)[(DIBaseParams *)self cryptoHeader]
    || (v9 = [(DIEncryptionFrontend *)[DIEncryptionUnlocker alloc] initWithParams:self], BOOL v10 = [(DIEncryptionUnlocker *)v9 unlockWithXpcHandler:v8 error:a5], v9, v10))
  {
    ...
    else
    {
      ...
      if (v20)
      {
        ...
        char v22 = [(DIBaseParams *)self shadowChain];
        uint64_t v23 = [(DIBaseParams *)self diskImageParamsXPC];
...
- (BOOL)requiresRootDaemon
{
  ...
  get_sink_backend((uint64_t)&v10, &lpsrc);
  if (v11) {
  ...
  if (!v3)
  {
    if (v7)
    {
      ...
      char is_mounted_on_smb = FileDescriptor::is_mounted_on_smb((FileDescriptor *)(v7 + 24));
      goto LABEL_13;
    }
LABEL_15:
    BOOL v8 = 0;
  ...
  if (!FileDescriptor::is_mounted_on_smb(v3[5]))
  {
    BOOL v8 = 0;
    if (!v5) {
      goto LABEL_18;
  ...
  char is_mounted_on_smb = (*((uint64_t (**)(FileDescriptor **))*v4 + 6))(v4);
LABEL_13:
  BOOL v8 = is_mounted_on_smb;
  if (v5) {
LABEL_17:
  }
...
{
  v2 = [(DIBaseParams *)self diskImageParamsXPC];
  unint64_t v3 = [v2 backendXPC];
  id v4 = (void *)[v3 cryptoHeader];
