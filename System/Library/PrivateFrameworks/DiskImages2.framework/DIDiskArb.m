...
LABEL_4:
  ...
  DASessionScheduleWithRunLoop(daSession, Current, (CFStringRef)*MEMORY[0x263EFFE88]);
LABEL_5:
  v8 = v5;
LABEL_8:
  v9 = v8;
...
- (void)stop
{
  ...
  if (daSession)
  {
    ...
    {
      MEMORY[0x223C24280](obj->_daSession, _diskDisappearedCallback);
      daSession = obj->_daSession;
    }
    Current = CFRunLoopGetCurrent();
    DASessionUnscheduleFromRunLoop(daSession, Current, (CFStringRef)*MEMORY[0x263EFFE88]);
...
- (void)onDiskDisappearedWithDisk:(__DADisk *)a3
{
  ...
  if ([(DIDiskArb *)self daSession])
  {
    ...
    v6 = [(__CFDictionary *)v5 objectForKey:*MEMORY[0x263F3A3C8]];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 68158210;
          ...
          __int16 v51 = 2114;
          v52 = v6;
          _os_log_impl(&dword_21E237000, v14, OS_LOG_TYPE_DEBUG, "%.*s: Reached with diskURL=%{public}@", buf, 0x1Cu);
        }
      }
      *__error() = v7;
    }
      ...
      if (v15)
      {
        ...
        if (v18)
        {
          ...
          if (DIForwardLogs())
          {
            ...
            v21 = objc_msgSend(v6, "path", v39, v40);
            *(_DWORD *)buf = 68158211;
            int v48 = 39;
            __int16 v49 = 2080;
            v50 = "-[DIDiskArb onDiskDisappearedWithDisk:]";
          ...
          else
          {
            ...
            if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 68158211;
              ...
              __int16 v51 = 2113;
              v52 = v24;
              _os_log_impl(&dword_21E237000, v23, OS_LOG_TYPE_ERROR, "%.*s: Mount point %{private}@ disappeared", buf, 0x1Cu);
            }
          }
          *__error() = v19;
                ...
                else
                {
                  ...
                  if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_DWORD *)buf = 68158211;
                    ...
                    __int16 v51 = 2113;
                    v52 = v37;
                    _os_log_impl(&dword_21E237000, v36, OS_LOG_TYPE_ERROR, "%.*s: Mount point %{private}@ disappeared (shadow's mount point)", buf, 0x1Cu);
                  }
                }
                *__error() = v32;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 68157954;
        ...
        __int16 v49 = 2080;
        v50 = "-[DIDiskArb onDiskDisappearedWithDisk:]";
        _os_log_impl(&dword_21E237000, v13, OS_LOG_TYPE_DEFAULT, "%.*s: Ignoring, during shutdown", buf, 0x12u);
      }
    }
    *__error() = v10;
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 68157954;
      ...
      __int16 v20 = 2080;
      v21 = "-[DIDiskArb waitForDAIdleWithError:]";
      _os_log_impl(&dword_21E237000, v7, OS_LOG_TYPE_DEFAULT, "%.*s: Waiting for disk arbitration idle", buf, 0x12u);
    }
  }
  *__error() = v4;
  ...
  if (![(DIDiskArb *)self callbackReached])
  {
    ...
    do
    {
      int v10 = objc_msgSend(MEMORY[0x263EFF910], "dateWithTimeIntervalSinceNow:", 1.0, v16, v17);
      [v8 runMode:v9 beforeDate:v10];
    }
    while (![(DIDiskArb *)self callbackReached]);
  }
  MEMORY[0x223C24280]([(DIDiskArb *)self daSession], _idleCallback, self);
  int v11 = *__error();
  if (DIForwardLogs())
  {
    v12 = getDIOSLog();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 68157954;
      ...
      __int16 v20 = 2080;
      v21 = "-[DIDiskArb waitForDAIdleWithError:]";
      _os_log_impl(&dword_21E237000, v14, OS_LOG_TYPE_DEFAULT, "%.*s: Disk arbitration idle callback received", buf, 0x12u);
    }
  }
  *__error() = v11;
...
- (void)addDisappearedCallbackWithMountPoint:(id)a3 shadowMountPoints:(id)a4 delegate:(id)a5
{
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 68158211;
        ...
        __int16 v47 = 2113;
        int v48 = v16;
        _os_log_impl(&dword_21E237000, v15, OS_LOG_TYPE_DEFAULT, "%.*s: Registering DiskDisappearedCallback for %{private}@", buf, 0x1Cu);
      }
    }
    id v36 = v8;
    *__error() = v11;
  ...
  long long v38 = 0u;
  v35 = self;
  uint64_t v17 = [(DIDiskArb *)self shadowMountedOnURLs];
    ...
    do
    {
      for (uint64_t i = 0; i != v19; ++i)
      {
        ...
        if (DIForwardLogs())
        {
          ...
          v25 = objc_msgSend(v22, "path", v30, v32);
          *(_DWORD *)buf = 68158211;
          int v44 = 77;
          __int16 v45 = 2080;
          v46 = "-[DIDiskArb addDisappearedCallbackWithMountPoint:shadowMountPoints:delegate:]";
        ...
        else
        {
          ...
          if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 68158211;
            ...
            __int16 v47 = 2113;
            int v48 = v28;
            _os_log_impl(&dword_21E237000, v27, OS_LOG_TYPE_DEFAULT, "%.*s: Registering DiskDisappearedCallback for %{private}@ (shadow's mount point)", buf, 0x1Cu);
          }
        }
        *__error() = v23;
      }
  ...
  DARegisterDiskDisappearedCallback([(DIDiskArb *)v35 daSession], 0, (DADiskDisappearedCallback)_diskDisappearedCallback, v35);
  id v8 = v36;
  id v10 = v33;
  id v9 = v34;
LABEL_25:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 68158210;
      ...
      __int16 v30 = 2112;
      id v31 = v6;
      _os_log_impl(&dword_21E237000, v10, OS_LOG_TYPE_DEFAULT, "%.*s: Ejecting %@", buf, 0x1Cu);
    }
  }
  *__error() = v7;
  ...
  if (v13)
  {
    ...
    if (![(DIDiskArb *)self callbackReached])
    {
      ...
      do
      {
        v16 = objc_msgSend(MEMORY[0x263EFF910], "dateWithTimeIntervalSinceNow:", 1.0, v24, v25);
        [v14 runMode:v15 beforeDate:v16];
      }
      while (![(DIDiskArb *)self callbackReached]);
    }
    uint64_t v17 = [(DIDiskArb *)self operationError];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = 68158210;
          ...
          __int16 v30 = 2112;
          id v31 = v12;
          _os_log_impl(&dword_21E237000, v22, OS_LOG_TYPE_DEFAULT, "%.*s: %@ ejected successfully", buf, 0x1Cu);
        }
      }
      *__error() = v19;
    }
  ...
  {
    BOOL v18 = +[DIError failWithEnumValue:156 verboseInfo:@"Failed to create DADisk during eject" error:a4];
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 68158211;
      ...
      __int16 v29 = 2113;
      id v30 = v6;
      _os_log_impl(&dword_21E237000, v10, OS_LOG_TYPE_DEFAULT, "%.*s: Unmounting %{private}@", buf, 0x1Cu);
    }
  }
  *__error() = v7;
  ...
  if (v12)
  {
    ...
    v13 = [MEMORY[0x263EFF9F0] currentRunLoop];
    if (![(DIDiskArb *)self callbackReached])
    {
      uint64_t v14 = *MEMORY[0x263EFF478];
      do
      {
        uint64_t v15 = objc_msgSend(MEMORY[0x263EFF910], "dateWithTimeIntervalSinceNow:", 1.0, v23, v24);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = 68158211;
          ...
          __int16 v29 = 2113;
          id v30 = v6;
          _os_log_impl(&dword_21E237000, v21, OS_LOG_TYPE_DEFAULT, "%.*s: %{private}@ unmounted successfully", buf, 0x1Cu);
        }
      }
      *__error() = v18;
    }
  ...
  {
    BOOL v17 = +[DIError failWithEnumValue:156 verboseInfo:@"Failed to create DADisk during unmount" error:a4];
  }
