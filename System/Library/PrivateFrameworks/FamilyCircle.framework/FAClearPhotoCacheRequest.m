...
void __62__FAClearPhotoCacheRequest_startRequestWithCompletionHandler___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    int v5 = 138412290;
    id v6 = v3;
    _os_log_impl(&dword_1D252C000, v4, OS_LOG_TYPE_DEFAULT, "FAClearPhotoCacheRequest: Error from service - %@", (uint8_t *)&v5, 0xCu);
  }
...
void __62__FAClearPhotoCacheRequest_startRequestWithCompletionHandler___block_invoke_17(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    int v6 = 138412290;
    id v7 = v3;
    _os_log_impl(&dword_1D252C000, v4, OS_LOG_TYPE_DEFAULT, "Cleared photos cache with error: %@", (uint8_t *)&v6, 0xCu);
  }
