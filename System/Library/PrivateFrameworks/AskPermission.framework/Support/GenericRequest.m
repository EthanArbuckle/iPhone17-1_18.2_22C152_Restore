...
- (GenericRequest)initWithDate:(id)a3 requestIdentifier:(id)a4 uniqueIdentifier:(id)a5 itemIdentifier:(id)a6 localizations:(id)a7 offerName:(id)a8 status:(int64_t)a9
{
  ...
  id v18 = a8;
  v25.receiver = self;
  v25.super_class = (Class)GenericRequest;
...
- (id)compile
{
  ...
  id v4 = [(GenericRequest *)self date];
  objc_msgSend(v3, "ap_setNullableObject:forKey:", v4, @"createdTimeInterval");

  v5 = [(GenericRequest *)self requestIdentifier];
  objc_msgSend(v3, "ap_setNullableObject:forKey:", v5, @"identifier");

  id v6 = [(GenericRequest *)self uniqueIdentifier];
  ...
  id v11 = +[NSNumber numberWithInteger:[(GenericRequest *)self status]];
...
- (NSString)description
{
  id v3 = [(GenericRequest *)self compile];
  id v4 = [(GenericRequest *)self ap_generateDescriptionWithSubObjects:v3];
