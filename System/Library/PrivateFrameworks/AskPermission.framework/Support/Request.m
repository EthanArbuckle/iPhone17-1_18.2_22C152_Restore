...
- (id)compile
{
  ...
  objc_msgSend(v3, "ap_setNullableObject:forKey:", v7, @"itemBundleIdentifier");

  v8 = [(Request *)self itemIdentifier];
  objc_msgSend(v3, "ap_setNullableObject:forKey:", v8, @"itemIdentifier");

  v9 = [(Request *)self localizations];
  id v10 = [v9 compile];
  objc_msgSend(v3, "ap_setNullableObject:forKey:", v10, @"localizations");

  v11 = +[NSNumber numberWithBool:[(Request *)self isMocked]];
  objc_msgSend(v3, "ap_setNullableObject:forKey:", v11, @"mocked");

  id v12 = [(Request *)self offerName];
  objc_msgSend(v3, "ap_setNullableObject:forKey:", v12, @"offerName");

  v13 = [(Request *)self previewURL];
  v14 = [v13 absoluteString];
  objc_msgSend(v3, "ap_setNullableObject:forKey:", v14, @"previewURL");

  id v15 = [(Request *)self productType];
  objc_msgSend(v3, "ap_setNullableObject:forKey:", v15, @"productType");

  v16 = [(Request *)self productTypeName];
  objc_msgSend(v3, "ap_setNullableObject:forKey:", v16, @"productTypeName");

  id v17 = [(Request *)self productURL];
  v18 = [v17 absoluteString];
  objc_msgSend(v3, "ap_setNullableObject:forKey:", v18, @"productURL");

  id v19 = [(Request *)self requestInfo];
  objc_msgSend(v3, "ap_setNullableObject:forKey:", v19, @"requestInfo");

  v20 = +[NSNumber numberWithInteger:[(Request *)self status]];
  objc_msgSend(v3, "ap_setNullableObject:forKey:", v20, @"status");
