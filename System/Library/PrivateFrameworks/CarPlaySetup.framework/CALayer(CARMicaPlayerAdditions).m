...
- (uint64_t)car_basicPropertiesToCopy;
...
- (void)car_deepCopyLayer
{
  ...
  if (v2)
  {
      ...
      if (v5)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            v11 = objc_msgSend(v7, "car_deepCopyLayer");
            if (v11) {
              [v2 addSublayer:v11];
            }
    ...
    if (v12)
    {
      v14 = objc_msgSend(v12, "car_deepCopyLayer");
      if (v14) {
        [v2 setMask:v14];
      }
    }
    ...
    long long v37 = 0u;
    long long v38 = 0u;
    v15 = objc_msgSend(a1, "car_propertiesToCopy", v13);
...
- (id)car_propertiesToCopy
{
  if (!car_propertiesToCopy_sCAShapeLayerClass) {
    car_propertiesToCopy_sCAShapeLayerClass = (uint64_t)NSClassFromString(&cfstr_Cashapelayer.isa);
  }
  v2 = objc_msgSend(a1, "car_basicPropertiesToCopy");
  objc_opt_class();
...
- (id)car_allLayersInTree
{
  ...
  objc_msgSend(a1, "car_addLayerAndSublayersToArray:allowHiddenLayers:", v2, 1);
  return v2;
}
...
- (void)car_addLayerAndSublayersToArray:()CARMicaPlayerAdditions allowHiddenLayers:
{
  ...
  if ((a4 & 1) != 0 || ([a1 isHidden] & 1) == 0)
  {
    ...
    {
      uint64_t v8 = [a1 mask];
      objc_msgSend(v8, "car_addLayerAndSublayersToArray:allowHiddenLayers:", v6, a4);
    }
    long long v16 = 0u;
    long long v17 = 0u;
    long long v14 = 0u;
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          objc_msgSend(*(id *)(*((void *)&v14 + 1) + 8 * v13++), "car_addLayerAndSublayersToArray:allowHiddenLayers:", v6, a4);
        }
        while (v11 != v13);
...
- (id)car_allLayersWhoseNamesContainString:()CARMicaPlayerAdditions
{
  ...
  id v4 = a3;
  uint64_t v5 = objc_msgSend(a1, "car_allLayersInTree");
...
- (id)car_allLayersWithKindOfClass:()CARMicaPlayerAdditions
{
  ...
  v1 = objc_msgSend(a1, "car_allLayersInTree");
  v2 = [MEMORY[0x263EFF980] array];
  long long v10 = 0u;
  long long v11 = 0u;
  long long v12 = 0u;
...
- (void)car_setFillOfAllShapeLayersToColor:()CARMicaPlayerAdditions
{
  ...
  uint64_t v4 = objc_msgSend(a1, "car_allLayersWithKindOfClass:", objc_opt_class());
  long long v9 = 0u;
  long long v10 = 0u;
  long long v11 = 0u;
  long long v12 = 0u;
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [*(id *)(*((void *)&v9 + 1) + 8 * v8++) setFillColor:a3];
      }
      while (v6 != v8);
