...
{
  v4.receiver = self;
  v4.super_class = (Class)HKOrganDonationDeleteSuccessViewController;
...
- (id)titleString
{
  ...
  v3 = [v2 localizedStringForKey:@"OD_DELETE_SUCCESS_TITLE" value:&stru_1F3B9CF20 table:@"HealthUI-Localizable"];
...
{
  v2 = [MEMORY[0x1E4F28B50] bundleWithIdentifier:@"com.apple.HealthUI"];
  v3 = [v2 localizedStringForKey:@"OD_DELETE_SUCCESS_BODY" value:&stru_1F3B9CF20 table:@"HealthUI-Localizable"];
