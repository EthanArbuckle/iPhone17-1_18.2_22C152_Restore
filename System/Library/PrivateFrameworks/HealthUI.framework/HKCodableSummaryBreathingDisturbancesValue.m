...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)HKCodableSummaryBreathingDisturbancesValue;
...
- (BOOL)readFrom:(id)a3
{
  return HKCodableSummaryBreathingDisturbancesValueReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    -[HKCodableSummaryBreathingDisturbancesValue setQuantity:](self, "setQuantity:");
  }
  uint64_t v4 = v9;
LABEL_7:
  if (v4[4])
  ...
  else
  {
    ...
    levelViewDataConfiguration = (HKCodableLevelViewDataConfiguration *)-[HKCodableSummaryBreathingDisturbancesValue setLevelViewDataConfiguration:](self, "setLevelViewDataConfiguration:");
  }
  uint64_t v4 = v9;
LABEL_15:
