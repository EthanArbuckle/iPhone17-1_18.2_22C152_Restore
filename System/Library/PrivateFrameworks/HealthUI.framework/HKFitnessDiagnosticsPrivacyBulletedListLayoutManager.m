@interface HKFitnessDiagnosticsPrivacyBulletedListLayoutManager
@end

@implementation HKFitnessDiagnosticsPrivacyBulletedListLayoutManager

void __89___HKFitnessDiagnosticsPrivacyBulletedListLayoutManager_drawGlyphsForGlyphRange_atPoint___block_invoke(uint64_t a1, CGFloat a2, CGFloat a3, CGFloat a4, CGFloat a5, CGFloat a6, CGFloat a7, CGFloat a8, CGFloat a9, uint64_t a10, uint64_t a11)
{
