...
- (id)titleString
{
  ...
  v3 = [v2 localizedStringForKey:@"OD_REGISTERED_TITLE" value:&stru_1F3B9CF20 table:@"HealthUI-Localizable"];
...
{
  v2 = [MEMORY[0x1E4F28B50] bundleWithIdentifier:@"com.apple.HealthUI"];
  v3 = [v2 localizedStringForKey:@"OD_REGISTERED_BODY" value:&stru_1F3B9CF20 table:@"HealthUI-Localizable"];
...
{
  v2 = [MEMORY[0x1E4F28B50] bundleWithIdentifier:@"com.apple.HealthUI"];
  v3 = [v2 localizedStringForKey:@"OD_LEARN_MORE" value:&stru_1F3B9CF20 table:@"HealthUI-Localizable"];
...
- (id)bottomAnchoredButtons
{
  ...
  v2 = [MEMORY[0x1E4F28B50] bundleWithIdentifier:@"com.apple.HealthUI"];
  v3 = [v2 localizedStringForKey:@"OD_SIGN_UP" value:&stru_1F3B9CF20 table:@"HealthUI-Localizable"];
  v8[0] = v3;
  v4 = [MEMORY[0x1E4F28B50] bundleWithIdentifier:@"com.apple.HealthUI"];
  v5 = [v4 localizedStringForKey:@"OD_NOT_NOW" value:&stru_1F3B9CF20 table:@"HealthUI-Localizable"];
  v8[1] = v5;
