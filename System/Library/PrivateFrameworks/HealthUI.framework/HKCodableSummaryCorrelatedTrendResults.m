...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)HKCodableSummaryCorrelatedTrendResults;
  id v4 = [(HKCodableSummaryCorrelatedTrendResults *)&v8 description];
...
- (BOOL)readFrom:(id)a3
{
  return HKCodableSummaryCorrelatedTrendResultsReadFrom(self, (uint64_t)a3);
}
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v9 clearTrendValues];
    unint64_t v4 = [(HKCodableSummaryCorrelatedTrendResults *)self trendValuesCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(HKCodableSummaryCorrelatedTrendResults *)self trendValuesAtIndex:i];
  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        -[HKCodableSummaryCorrelatedTrendResults addTrendValues:](self, "addTrendValues:", *(void *)(*((void *)&v11 + 1) + 8 * i), (void)v11);
      }
