...
@implementation HKCodableQuantity
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)HKCodableQuantity;
  v4 = [(HKCodableQuantity *)&v8 description];
  v5 = [(HKCodableQuantity *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return HKCodableQuantityReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    double v5 = v4;
    -[HKCodableQuantity setUnitString:](self, "setUnitString:");
    id v4 = v5;
  }
}
