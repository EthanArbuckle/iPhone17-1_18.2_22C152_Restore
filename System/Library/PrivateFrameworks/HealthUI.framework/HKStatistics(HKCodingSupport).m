...
+ (id)statisticsWithCodableStatistics:()HKCodingSupport
{
  ...
  {
    v4 = objc_msgSend(MEMORY[0x1E4F2B2C0], "dataTypeWithCode:", objc_msgSend(v3, "dataType"));
    if ([v3 hasStartDate])
    {
      [v3 startDate];
    ...
    v6 = (void *)[objc_alloc(MEMORY[0x1E4F2B5B0]) initWithDataType:v4 startDate:v5 endDate:v7];
