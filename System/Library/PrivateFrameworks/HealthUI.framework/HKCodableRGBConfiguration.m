...
LABEL_11:
  v9 = [NSNumber numberWithDouble:self->_blue];
  [v3 setObject:v9 forKey:@"blue"];

  if (*(unsigned char *)&self->_has)
  {
LABEL_5:
    v5 = [NSNumber numberWithDouble:self->_alpha];
...
LABEL_11:
  v4[2] = *(void *)&self->_blue;
  *((unsigned char *)v4 + 40) |= 2u;
  if (*(unsigned char *)&self->_has)
  {
LABEL_5:
    v4[1] = *(void *)&self->_alpha;
...
LABEL_3:
  ...
  *((void *)result + 3) = *(void *)&self->_green;
...
LABEL_9:
  *((void *)result + 2) = *(void *)&self->_blue;
  *((unsigned char *)result + 40) |= 2u;
  if ((*(unsigned char *)&self->_has & 1) == 0) {
    return result;
  }
LABEL_5:
  *((void *)result + 1) = *(void *)&self->_alpha;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((unsigned char *)v4 + 40) & 8) == 0 || self->_red != *((double *)v4 + 4)) {
      goto LABEL_21;
    }
  }
...
LABEL_21:
  ...
  {
    if ((*((unsigned char *)v4 + 40) & 4) == 0 || self->_green != *((double *)v4 + 3)) {
      goto LABEL_21;
    }
  }
  ...
  {
    if ((*((unsigned char *)v4 + 40) & 2) == 0 || self->_blue != *((double *)v4 + 2)) {
      goto LABEL_21;
    }
  }
  ...
  if (*(unsigned char *)&self->_has)
  {
    if ((*((unsigned char *)v4 + 40) & 1) == 0 || self->_alpha != *((double *)v4 + 1)) {
      goto LABEL_21;
    }
    BOOL v5 = 1;
  }
...
LABEL_3:
  ...
  self->_double green = *((double *)v4 + 3);
  *(unsigned char *)&self->_has |= 4u;
  char v5 = *((unsigned char *)v4 + 40);
  if ((v5 & 2) == 0)
  {
...
LABEL_11:
  self->_double blue = *((double *)v4 + 2);
  *(unsigned char *)&self->_has |= 2u;
  if (*((unsigned char *)v4 + 40))
  {
LABEL_5:
    self->_double alpha = *((double *)v4 + 1);
    *(unsigned char *)&self->_has |= 1u;
  }
LABEL_6:
}
