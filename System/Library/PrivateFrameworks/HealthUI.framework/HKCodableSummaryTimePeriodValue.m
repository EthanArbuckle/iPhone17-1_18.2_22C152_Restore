...
- (id)description
{
  char v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)HKCodableSummaryTimePeriodValue;
...
- (BOOL)readFrom:(id)a3
{
  return HKCodableSummaryTimePeriodValueReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 2) != 0)
  {
    *((void *)result + 2) = *(void *)&self->_timeInterval;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((unsigned char *)v4 + 24) & 2) == 0 || self->_timeInterval != *((double *)v4 + 2)) {
      goto LABEL_11;
    }
  }
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v5 & 2) != 0)
  {
    self->_double timeInterval = *((double *)v4 + 2);
    *(unsigned char *)&self->_has |= 2u;
    char v5 = *((unsigned char *)v4 + 24);
  }
  if (v5)
