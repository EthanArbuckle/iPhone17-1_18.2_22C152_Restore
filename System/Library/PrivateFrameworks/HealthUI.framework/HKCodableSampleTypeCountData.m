...
LABEL_3:
  ...
  {
LABEL_4:
    v5 = [NSNumber numberWithLongLong:self->_count];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 4) != 0)
  {
    *((void *)result + 3) = *(void *)&self->_startDate;
...
LABEL_3:
  ...
  *((void *)result + 2) = *(void *)&self->_endDate;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if ((*((unsigned char *)v4 + 32) & 4) == 0 || self->_startDate != *((double *)v4 + 3)) {
      goto LABEL_16;
    }
  }
...
LABEL_16:
  ...
  {
    if ((*((unsigned char *)v4 + 32) & 2) == 0 || self->_endDate != *((double *)v4 + 2)) {
      goto LABEL_16;
    }
  }
