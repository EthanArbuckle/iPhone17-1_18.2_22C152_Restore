...
- (HKDataMetadataDeviceSection)initWithSample:(id)a3
{
  return [(HKDataMetadataDeviceSection *)self initWithSample:a3 regulatedFeatureInfoProvider:0];
}
...
- (HKDataMetadataDeviceSection)initWithSample:(id)a3 regulatedFeatureInfoProvider:(id)a4
{
  ...
  v9 = [v8 localizedStringForKey:@"DEVICE_DETAILS" value:&stru_1F3B9CF20 table:@"HealthUI-Localizable"];
  v13.receiver = self;
...
- (void)_loadDetailsForSample:(id)a3 regulatedFeatureInfoProvider:(id)a4
{
  ...
  if (v10)
  {
    ...
    objc_super v13 = [v12 localizedStringForKey:@"DEVICE_NAME" value:&stru_1F3B9CF20 table:@"HealthUI-Localizable"];
    v74[0] = v9;
    v74[1] = @"DeviceName";
    v14 = [MEMORY[0x1E4F1C978] arrayWithObjects:v74 count:2];
  ...
  if (v16)
  {
    ...
    v19 = [v18 localizedStringForKey:@"DEVICE_MANUFACTURER" value:&stru_1F3B9CF20 table:@"HealthUI-Localizable"];
    v73[0] = v9;
  ...
  if (v22)
  {
    ...
    v28 = [v27 localizedStringForKey:@"DEVICE_MODEL" value:&stru_1F3B9CF20 table:@"HealthUI-Localizable"];
    v72[0] = v9;
    v72[1] = @"DeviceModel";
    v29 = [MEMORY[0x1E4F1C978] arrayWithObjects:v72 count:2];
  ...
  if (v31)
  {
    ...
    v34 = [v33 localizedStringForKey:@"DEVICE_HARDWARE_VERS" value:&stru_1F3B9CF20 table:@"HealthUI-Localizable"];
    v71[0] = v9;
    v71[1] = @"DeviceHardwareVersion";
    v35 = [MEMORY[0x1E4F1C978] arrayWithObjects:v71 count:2];
  ...
  if (v37)
  {
    ...
    v40 = [v39 localizedStringForKey:@"DEVICE_FIRMWARE_VERS" value:&stru_1F3B9CF20 table:@"HealthUI-Localizable"];
    v70[0] = v9;
  ...
  if (v43)
  {
    ...
    v45 = [MEMORY[0x1E4F28B50] bundleWithIdentifier:@"com.apple.HealthUI"];
    v46 = [v45 localizedStringForKey:@"DEVICE_SOFTWARE_VERS" value:&stru_1F3B9CF20 table:@"HealthUI-Localizable"];
    v69[0] = v9;
    v69[1] = @"DeviceSoftwareVersion";
    v47 = [MEMORY[0x1E4F1C978] arrayWithObjects:v69 count:2];
  ...
  if (v49)
  {
    ...
    v52 = [v51 localizedStringForKey:@"DEVICE_FDA_UDI" value:&stru_1F3B9CF20 table:@"HealthUI-Localizable"];
    v68[0] = v9;
    v68[1] = @"DeviceUDI";
    v53 = [MEMORY[0x1E4F1C978] arrayWithObjects:v68 count:2];
  ...
  if (v55)
  {
    ...
    v57 = [v56 localizedStringForKey:@"DEVICE_REGULATED_FEATURE_VERS" value:&stru_1F3B9CF20 table:@"HealthUI-Localizable"];
    v67[0] = v9;
    v67[1] = @"DeviceFeatureVersion";
    v58 = [MEMORY[0x1E4F1C978] arrayWithObjects:v67 count:2];
  ...
  if (v60)
  {
    ...
    v62 = [v61 localizedStringForKey:@"DEVICE_REGULATED_UPDATE_VERS" value:&stru_1F3B9CF20 table:@"HealthUI-Localizable"];
    v66[0] = v9;
    v66[1] = @"DeviceUpdateVersion";
    v63 = [MEMORY[0x1E4F1C978] arrayWithObjects:v66 count:2];
