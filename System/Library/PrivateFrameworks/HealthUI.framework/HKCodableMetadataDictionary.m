@interface HKCodableMetadataDictionary
...
@implementation HKCodableMetadataDictionary
...
- (id)description
{
  v3 = NSString;
  v8.receiver = self;
  v8.super_class = (Class)HKCodableMetadataDictionary;
  id v4 = [(HKCodableMetadataDictionary *)&v8 description];
  v5 = [(HKCodableMetadataDictionary *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return HKCodableMetadataDictionaryReadFrom(self, (uint64_t)a3);
}
...
{
  id v8 = a3;
  if ([(HKCodableMetadataDictionary *)self keyValuePairsCount])
  {
    [v8 clearKeyValuePairs];
    unint64_t v4 = [(HKCodableMetadataDictionary *)self keyValuePairsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(HKCodableMetadataDictionary *)self keyValuePairsAtIndex:i];
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[HKCodableMetadataDictionary addKeyValuePairs:](self, "addKeyValuePairs:", *(void *)(*((void *)&v9 + 1) + 8 * v8++), (void)v9);
      }
      while (v6 != v8);
