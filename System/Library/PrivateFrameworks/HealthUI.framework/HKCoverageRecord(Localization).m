...
- (id)sortDateTitle
{
  ...
  if (v4)
  {
    ...
    v6 = v5;
    v7 = @"COVERAGE_RECORD_SORT_DATE_TITLE_MODIFIED_DATE";
LABEL_7:
  ...
  v8 = [a1 sortDate];
  v9 = [v8 keyPath];
  int v10 = [v9 isEqualToString:*MEMORY[0x1E4F29968]];

  if (v10)
  {
    v5 = [MEMORY[0x1E4F28B50] bundleWithIdentifier:@"com.apple.HealthUI"];
    v6 = v5;
    v7 = @"COVERAGE_RECORD_SORT_DATE_TITLE_PERIOD_START_DATE";
    goto LABEL_7;
  }
  v11 = [a1 sortDate];
  v12 = [v11 keyPath];
  int v13 = [v12 isEqualToString:*MEMORY[0x1E4F29960]];

  if (v13)
  {
    v5 = [MEMORY[0x1E4F28B50] bundleWithIdentifier:@"com.apple.HealthUI"];
    v6 = v5;
    v7 = @"COVERAGE_RECORD_SORT_DATE_TITLE_PERIOD_END_DATE";
    goto LABEL_7;
  }
  v14 = 0;
LABEL_8:
