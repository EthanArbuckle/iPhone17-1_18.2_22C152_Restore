...
- (id)title
{
  ...
  v3 = [v2 localizedStringForKey:@"allergies_and_reactions" value:&stru_1F3B9CF20 table:@"HealthUI-Localizable"];
...
{
  v2 = [MEMORY[0x1E4F28B50] bundleWithIdentifier:@"com.apple.HealthUI"];
  v3 = [v2 localizedStringForKey:@"allergies_and_reactions_none_listed" value:&stru_1F3B9CF20 table:@"HealthUI-Localizable"];
