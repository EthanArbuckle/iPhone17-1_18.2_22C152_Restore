...
- (CoreDAVDenyItem)init
{
  return [(CoreDAVItem *)self initWithNameSpace:@"DAV:" andName:@"deny"];
}
...
- (id)description
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)CoreDAVDenyItem;
...
- (void)write:(id)a3
{
  ...
  long long v14 = 0u;
  long long v15 = 0u;
  objc_super v7 = [(CoreDAVDenyItem *)self privileges];
...
- (void)addPrivilege:(id)a3
{
  ...
  id v7 = [(CoreDAVDenyItem *)self privileges];
  [v7 addObject:v4];
}
