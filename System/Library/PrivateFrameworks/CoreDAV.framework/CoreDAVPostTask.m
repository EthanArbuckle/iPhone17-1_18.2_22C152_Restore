...
{
  v10.receiver = self;
  v10.super_class = (Class)CoreDAVPostTask;
  v7 = -[CoreDAVPostOrPutTask initWithDataPayload:dataContentType:atURL:previousETag:](&v10, sel_initWithDataPayload_dataContentType_atURL_previousETag_, a3, a4, a5);
  v8 = v7;
  if (v7) {
...
LABEL_10:
  ...
  v17.receiver = self;
  v17.super_class = (Class)CoreDAVPostTask;
