...
+ (id)URLOfModelInThisBundle
{
  ...
  else
  {
    if (os_log_type_enabled(MEMORY[0x263EF8438], OS_LOG_TYPE_ERROR)) {
      +[easy_engage URLOfModelInThisBundle]();
    }
    v4 = 0;
  }
...
+ (void)loadContentsOfURL:(id)a3 configuration:(id)a4 completionHandler:(id)a5
{
  ...
  v10[1] = 3221225472;
  v10[2] = __65__easy_engage_loadContentsOfURL_configuration_completionHandler___block_invoke;
  v10[3] = &unk_2645A6F98;
  id v11 = v7;
  id v9 = v7;
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  id v9 = [(easy_engage *)self predictionFromFeatures:v7 options:v8 error:a4];
...
- (void)predictionFromFeatures:(id)a3 completionHandler:(id)a4
{
  ...
  v10[0] = MEMORY[0x263EF8330];
  v10[1] = 3221225472;
  v10[2] = __56__easy_engage_predictionFromFeatures_completionHandler___block_invoke;
  v10[3] = &unk_2645A6FC0;
  id v11 = v6;
  id v9 = v6;
...
- (void)predictionFromFeatures:(id)a3 options:(id)a4 completionHandler:(id)a5
{
  ...
  v13[1] = 3221225472;
  v13[2] = __64__easy_engage_predictionFromFeatures_options_completionHandler___block_invoke;
  v13[3] = &unk_2645A6FC0;
  id v14 = v8;
  id v12 = v8;
...
{
  *(_WORD *)v0 = 0;
  _os_log_error_impl(&dword_22135E000, MEMORY[0x263EF8438], OS_LOG_TYPE_ERROR, "Could not load easy_engage.mlmodelc in the bundle resource", v0, 2u);
}
