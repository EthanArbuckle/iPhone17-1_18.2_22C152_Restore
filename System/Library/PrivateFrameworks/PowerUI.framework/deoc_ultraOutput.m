...
- (NSSet)featureNames;
- (deoc_ultraOutput)initWithTarget:(int64_t)a3 classProbability:(id)a4;
...
- (deoc_ultraOutput)initWithTarget:(int64_t)a3 classProbability:(id)a4
{
  id v7 = a4;
  v11.receiver = self;
  v11.super_class = (Class)deoc_ultraOutput;
...
- (NSSet)featureNames
{
  return (NSSet *)[MEMORY[0x263EFFA08] setWithArray:&unk_26D385CD8];
}
...
- (id)featureValueForName:(id)a3
{
  ...
  {
    v5 = objc_msgSend(MEMORY[0x263F00D50], "featureValueWithInt64:", -[deoc_ultraOutput target](self, "target"));
  }
  else if ([v4 isEqualToString:@"classProbability"])
  {
    v6 = (void *)MEMORY[0x263F00D50];
    id v7 = [(deoc_ultraOutput *)self classProbability];
