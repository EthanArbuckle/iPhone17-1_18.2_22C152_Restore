...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  id v9 = [(base_duration *)self predictionFromFeatures:v7 options:v8 error:a4];
...
{
  *(_WORD *)v0 = 0;
  _os_log_error_impl(&dword_22135E000, MEMORY[0x263EF8438], OS_LOG_TYPE_ERROR, "Could not load base_duration.mlmodelc in the bundle resource", v0, 2u);
}
