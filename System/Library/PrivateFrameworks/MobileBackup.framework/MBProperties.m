...
- (void)addAppleIDsFromSet:(id)a3 dataClass:(id)a4
{
  ...
  {
    id v10 = v8;
    double v11 = ATClientController_ptr;
    double v12 = ATClientController_ptr;
...
LABEL_31:
  ...
  if (v11)
  {
    ...
    objc_msgSend(v17, "setObject:forKeyedSubscript:", v11, @"dsid", v29, v31);
  }
  if (v12)
  {
    ...
    objc_msgSend(v17, "setObject:forKeyedSubscript:", v12, @"altDsid", v29, v31);
  }
  if (v13)
  {
