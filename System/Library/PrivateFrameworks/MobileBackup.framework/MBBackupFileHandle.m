...
- (BOOL)recordMetadataWithSHA256Data:(id)a3 error:(id *)a4
{
  ...
  LODWORD(v7) = [[(MBFileHandleProxy *)self fileHandle] statWithBuffer:v35 error:a4];
  if (v7)
  {
    uint64_t v34 = 0;
    long long v32 = 0u;
    ...
    long long v30 = 0u;
    long long v31 = 0u;
    LODWORD(v7) = MBBackwardsCompatibleMBNodeFromStat((uint64_t)v35, (uint64_t)&v30, a4);
    if (v7)
    {
      [(MBFile *)self->_file setNode:&v30];
      if (self->_shouldCheckForModifications
        && [(MBBackupFileHandle *)self _isModifiedSince:*((void *)&v31 + 1) error:a4])
      {
        goto LABEL_20;
      }
        ...
        if (v7)
        {
          ...
          if (v10 >= 0x801)
          {
            ...
            if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(void *)&v39[6] = v13;
              ...
              uint64_t v26 = 2048;
              v27 = [(MBFile *)self->_file absolutePath];
              v25 = (MBDomain *)v11;
              _MBLog();
            }
            -[MBFile setExtendedAttributes:](self->_file, "setExtendedAttributes:", &__NSDictionary0__struct, v25, v26, v27);
          }
          if (MBIsInternalInstall())
          {
            ...
            if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
            {
              ...
              v18 = MBNodeAsString((unsigned int *)&v30);
              uint64_t v19 = (v14 >> 30) & 1;
              v20 = [(MBManifestDB *)[(MBDriveBackupEngine *)self->_engine snapshotManifestDB] path];
              ...
              *(void *)&v39[10] = v18;
              ...
              v21 = [(MBFile *)self->_file domain];
              v22 = [(MBFile *)self->_file relativePath];
              v23 = MBNodeAsString((unsigned int *)&v30);
              uint64_t v28 = v19;
              v29 = [(MBManifestDB *)[(MBDriveBackupEngine *)self->_engine snapshotManifestDB] path];
...
- (int64_t)readWithBytes:(void *)a3 length:(unint64_t)a4 error:(id *)a5
{
  if (!IsDatalessFault([[(MBFileHandleProxy *)self fileHandle] fd]))
  {
