...
+ (id)containerWithPropertyList:(id)a3 volumeMountPoint:(id)a4
{
  ...
  int v8 = sub_1002A9A50(v7);

  id v9 = [objc_alloc(*off_1004180E0[v8]) initWithPropertyList:v5 volumeMountPoint:v6];
  return v9;
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if (qword_1004828F8 != -1) {
          dispatch_once(&qword_1004828F8, &stru_100417F78);
        }
        if ([(id)qword_1004828F0 containsObject:v9]) {
