...
- (BOOL)_invalidate:(id *)a3
{
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_1001DEAD4;
  block[3] = &unk_100415F48;
  block[4] = &v25;
  block[5] = &v15;
  block[6] = &v19;
...
- (void)_removeCorruptDatabaseWithError:(id)a3
{
  id v4 = a3;
  if (!v4) {
    __assert_rtn("-[MBSQLiteDB _removeCorruptDatabaseWithError:]", "MBSQLiteDB.m", 154, "error");
  }
  v5 = v4;
  dispatch_assert_queue_V2((dispatch_queue_t)self->_sharedQueue);
  uint64_t v6 = [(MBSQLiteDB *)self path];
  if (!v6) {
    __assert_rtn("-[MBSQLiteDB _removeCorruptDatabaseWithError:]", "MBSQLiteDB.m", 157, "path");
  }
  id v7 = v6;
  v8 = MBGetDefaultLog();
...
LABEL_23:
  ...
  if (!v9) {
    __assert_rtn("-[MBSQLiteDB _removeCorruptDatabaseWithError:]", "MBSQLiteDB.m", 164, "dir");
  }
  id v10 = (void *)v9;
  ...
  if (!v14) {
    __assert_rtn("-[MBSQLiteDB _removeCorruptDatabaseWithError:]", "MBSQLiteDB.m", 166, "destinationPath");
  }
  id v31 = 0;
  ...
  id v30 = 0;
  unsigned __int8 v19 = objc_msgSend(v18, "mb_moveAsideAndMarkPurgeableDBFilesAtPath:error:", v7, &v30);
  v20 = v30;
...
- (BOOL)_openWithFlags:(int)a3 usePQLBatching:(BOOL)a4 error:(id *)a5
{
  ...
  while (1)
  {
    ...
    if (!v8) {
      __assert_rtn("-[MBSQLiteDB _openWithFlags:usePQLBatching:error:]", "MBSQLiteDB.m", 243, "localError");
    }
    char v11 = 0;
    uint64_t v9 = 1;
    if ((v12 & 1) == 0) {
...
LABEL_37:
    if (!v8) {
      __assert_rtn("-[MBSQLiteDB _openWithFlags:usePQLBatching:error:]", "MBSQLiteDB.m", 251, "localError");
    }
LABEL_38:
    if (a5)
    {
...
{
  if (!a5) {
    __assert_rtn("-[MBSQLiteDB _makePQLConnectionWithFlags:usePQLBatching:error:]", "MBSQLiteDB.m", 260, "error");
  }
  BOOL v6 = a4;
  uint64_t v7 = *(void *)&a3;
  dispatch_assert_queue_V2((dispatch_queue_t)self->_sharedQueue);
    ...
    && (int)v12 < [(MBSQLiteDB *)self schemaMinDatabaseVersionForUpgrade])
  {
    ...
    if (!v15) {
      __assert_rtn("-[MBSQLiteDB _makePQLConnectionWithFlags:usePQLBatching:error:]", "MBSQLiteDB.m", 278, "path");
    }
    uint64_t v16 = (sqlite3 *)[v9 dbHandle];
    if (!v16) {
      __assert_rtn("-[MBSQLiteDB _makePQLConnectionWithFlags:usePQLBatching:error:]", "MBSQLiteDB.m", 280, "dbHandle");
    }
...
{
  if (!a4) {
    __assert_rtn("-[MBSQLiteDB _openPQLConnectionWithFlags:error:]", "MBSQLiteDB.m", 337, "error");
  }
  uint64_t v5 = *(void *)&a3;
  dispatch_assert_queue_V2((dispatch_queue_t)self->_sharedQueue);
  uint64_t v7 = self->_path;
  if (!v7) {
    __assert_rtn("-[MBSQLiteDB _openPQLConnectionWithFlags:error:]", "MBSQLiteDB.m", 342, "path");
  }
  v8 = v7;
  uint64_t v9 = +[NSURL fileURLWithPath:v7];
  if (!v9) {
    __assert_rtn("-[MBSQLiteDB _openPQLConnectionWithFlags:error:]", "MBSQLiteDB.m", 344, "url");
  }
  int v10 = (void *)v9;
  ...
  id v16 = objc_msgSend(v14, "initWithFormat:", @"%s-%p", class_getName(v15), self);
  [v11 setLabel:v16];

  unsigned __int8 v17 = +[MBBehaviorOptions sharedOptions];
  objc_msgSend(v11, "setTraced:", objc_msgSend(v17, "sqlTrace"));
...
- (BOOL)_removeDatabaseAtPath:(id)a3 error:(id *)a4
{
  id v6 = a3;
  if (!v6) {
    __assert_rtn("-[MBSQLiteDB _removeDatabaseAtPath:error:]", "MBSQLiteDB.m", 422, "path");
  }
  if (!a4) {
    __assert_rtn("-[MBSQLiteDB _removeDatabaseAtPath:error:]", "MBSQLiteDB.m", 423, "error");
  }
  uint64_t v7 = v6;
  dispatch_assert_queue_V2((dispatch_queue_t)self->_sharedQueue);
  v8 = MBGetDefaultLog();
  ...
  if (v18)
  {
    ...
    while (2)
    {
      for (i = 0; i != v19; i = (char *)i + 1)
      {
        ...
        int v22 = objc_msgSend(v7, "stringByAppendingString:", *(void *)(*((void *)&v32 + 1) + 8 * i), v29);
...
- (BOOL)performWithConnection:(id)a3 error:(id *)a4
{
  ...
  BOOL v16 = sub_1001DE418;
  id v17 = sub_1001DE428;
  id v18 = 0;
...
- (id)fetchObjectOfClass:(Class)a3 error:(id *)a4 sql:(id)a5
{
  ...
  uint64_t v20 = sub_1001DE418;
  uint64_t v21 = sub_1001DE428;
  id v22 = 0;
  BOOL v16 = &v24;
...
- (unint64_t)fetchCountWithError:(id *)a3 sql:(id)a4
{
  ...
  uint64_t v21 = sub_1001DE418;
  id v22 = sub_1001DE428;
  id v23 = 0;
  uint64_t v17 = &v24;
  id v10 = _NSConcreteStackBlock;
  uint64_t v11 = 3221225472;
  id v12 = sub_1001E1458;
  uint64_t v13 = &unk_100416058;
  uint64_t v15 = &v18;
  id v6 = a4;
  id v14 = v6;
  BOOL v16 = &v17;
  if ([(MBSQLiteDB *)self performWithConnection:&v10 error:a3]
    && (id v7 = (void *)v19[5]) != 0)
  {
    unint64_t v8 = (unint64_t)objc_msgSend(v7, "unsignedIntegerValue", v10, v11, v12, v13);
  }
  else
  {
