...
- (id)dataAtPath:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  if ([(MBDrive *)self downloadFileAtPath:a3 toPath:v9 options:a4 error:a5])
  {
    ...
    unsigned int v11 = objc_msgSend(objc_msgSend(a4, "objectForKeyedSubscript:", @"MemoryMapped"), "BOOLValue");
    ...
    if (v11)
    {
      ...
      *(_DWORD *)buf = 138412546;
      uint64_t v21 = v9;
      __int16 v22 = 2048;
      id v23 = objc_msgSend(-[NSDictionary objectForKeyedSubscript:](v10, "objectForKeyedSubscript:", NSFileSize), "unsignedIntegerValue");
    ...
    uint64_t v18 = v9;
    id v19 = objc_msgSend(-[NSDictionary objectForKeyedSubscript:](v10, "objectForKeyedSubscript:", v14), "unsignedIntegerValue");
    _MBLog();
LABEL_11:
