...
+ (id)statusWithDrive:(id)a3 path:(id)a4 error:(id *)a5
{
  id v5 = objc_msgSend(a3, "propertyListAtPath:options:error:", a4, 0);
  if (v5) {
...
- (MBStatus)initWithPropertyList:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        id v18 = objc_msgSend(objc_alloc((Class)MBException), "initWithCode:format:", 203, @"Unsupported status version: %0.1f", *(void *)&v5->_version);
LABEL_26:
