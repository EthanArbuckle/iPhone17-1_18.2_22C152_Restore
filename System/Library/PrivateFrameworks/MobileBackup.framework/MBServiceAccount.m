...
- (NSURL)serviceURL;
- (id)appleID;
- (id)createChunkStoreWithPath:(id)a3;
- (id)description;
- (id)reloaded;
...
{
  id v4 = a3;
  if ([(MBServiceAccount *)self useMockChunkStore]) {
    v5 = [[MBMockChunkStore alloc] initWithAccount:self];
  }
  else {
    v5 = [[MBMobileMeChunkStore alloc] initWithAccount:self path:v4];
  }
  v6 = v5;
...
+ (OS_dispatch_queue)accountsQueue
{
  ...
  block[1] = 3221225472;
  block[2] = sub_100239988;
  block[3] = &unk_100411038;
  block[4] = a1;
  if (qword_100482758 != -1) {
    dispatch_once(&qword_100482758, block);
  }
  v2 = (void *)qword_100482750;
...
+ (id)serviceAccountFromPreferences
{
  ...
  if (!v6) {
    __assert_rtn("+[MBServiceAccount serviceAccountFromPreferences]", "MBServiceAccount.m", 123, "accountID");
  }
  v7 = (void *)v6;
  CFPropertyListRef v8 = CFPreferencesCopyAppValue(@"ServiceURL", @"com.apple.MobileBackup");
  if (!v8) {
    __assert_rtn("+[MBServiceAccount serviceAccountFromPreferences]", "MBServiceAccount.m", 126, "servicePath");
  }
  v9 = (void *)v8;
  ...
  if (!v11) {
    __assert_rtn("+[MBServiceAccount serviceAccountFromPreferences]", "MBServiceAccount.m", 130, "chunkStorePath");
  }
  v12 = (void *)v11;
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 67109120;
    int v26 = v4;
    _os_log_impl((void *)&_mh_execute_header, v14, OS_LOG_TYPE_INFO, "Loaded account properties from preferences, enabled:%d", buf, 8u);
    _MBLog();
  }
...
+ (NSArray)allServiceAccounts
{
  ...
  v29 = v2;
  BOOL v3 = [v2 accountsWithAccountType:v28];
  int v4 = MBGetDefaultLog();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 134217984;
    v38 = [v3 count];
    _os_log_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_DEFAULT, "Found %ld system accounts", buf, 0xCu);
    int v26 = [v3 count];
    _MBLog();
  }
  ...
  long long v36 = 0u;
  id obj = v3;
  id v5 = [obj countByEnumeratingWithState:&v33 objects:v41 count:16];
  if (v5)
  {
    id v6 = v5;
    ...
    do
    {
      ...
      do
      {
        ...
        {
          id v13 = v12;
          uint64_t v14 = +[UMUserPersonaAttributes personaAttributesForIdentifier:v12];
          if (v14)
          {
            v15 = (void *)v14;
            ...
            {
LABEL_19:
              uint64_t v17 = @"/private/var/mobile";
            }
            else
            {
              ...
              id v16 = [v15 personaLayoutPathURL];
              ...
              if (!v17)
              {
                ...
                if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
                {
                  *(_DWORD *)buf = 138543362;
                  v38 = v13;
                  _os_log_impl((void *)&_mh_execute_header, v18, OS_LOG_TYPE_ERROR, "nil volumeMountPoint for %{public}@", buf, 0xCu);
                  int v26 = v13;
                  _MBLog();
                }
                uint64_t v17 = 0;
            ...
            uint64_t v18 = +[MBPersona personaWithAttributes:volumeMountPoint:](MBPersona, "personaWithAttributes:volumeMountPoint:", v15, v17, v26, v27);
            id v20 = [objc_alloc((Class)a1) initWithPersona:v18 account:v10 options:0];
            if (v20) {
              [v30 addObject:v20];
            }
            goto LABEL_28;
          ...
          {
            v21 = objc_msgSend(v10, "aa_accountClass");
            *(_DWORD *)buf = 138543618;
            v38 = v13;
            __int16 v39 = 2112;
            v40 = v21;
            _os_log_impl((void *)&_mh_execute_header, v17, OS_LOG_TYPE_ERROR, "Failed to fetch the attributes for persona %{public}@ accountClass %@", buf, 0x16u);

            uint64_t v18 = objc_msgSend(v10, "aa_accountClass");
            int v26 = v13;
            v27 = v18;
            _MBLog();
            goto LABEL_26;
...
LABEL_28:
          ...
          id v19 = +[UMUserPersonaAttributes personaAttributesForPersonaType:0];
          if (!v19)
          {
            uint64_t v18 = MBGetDefaultLog();
            if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
            {
              *(_WORD *)buf = 0;
              _os_log_impl((void *)&_mh_execute_header, v18, OS_LOG_TYPE_ERROR, "Failed to fetch the attributes for personal persona", buf, 2u);
              _MBLog();
            }
            goto LABEL_25;
          }
          v15 = v19;
          id v13 = [v19 userPersonaUniqueString];
          if (v13) {
            goto LABEL_19;
          }
          id v20 = 0;
...
LABEL_29:
      ...
      while (v6 != v9);
      id v22 = [obj countByEnumeratingWithState:&v33 objects:v41 count:16];
      id v6 = v22;
    }
    while (v22);
  }
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 134217984;
    v38 = v24;
    _os_log_impl((void *)&_mh_execute_header, v23, OS_LOG_TYPE_DEBUG, "Found %lu service accounts", buf, 0xCu);
    [v30 count];
    _MBLog();
  }
...
- (MBServiceAccount)initWithPersona:(id)a3 error:(id *)a4
{
  ...
  if (v8)
  {
    ...
    if ([v9 isPersonalPersona])
    {
      ...
      uint64_t v12 = (MBServiceAccount *)objc_claimAutoreleasedReturnValue();
    }
    else
    {
      if (![v9 isEnterprisePersona])
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        {
          *(_DWORD *)buf = 138543362;
          v28 = v10;
          _os_log_impl((void *)&_mh_execute_header, v22, OS_LOG_TYPE_ERROR, "Found an unexpected persona type for persona %{public}@", buf, 0xCu);
          _MBLog();
        }
            ...
            (v18 & 1) == 0))
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v29 = 2114;
          id v30 = v10;
          _os_log_impl((void *)&_mh_execute_header, v23, OS_LOG_TYPE_ERROR, "Persona identifier mismatch: %{public}@ != %{public}@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
        {
          *(_DWORD *)buf = 138412802;
          ...
          __int16 v31 = 2112;
          v32 = v19;
          _os_log_impl((void *)&_mh_execute_header, v20, OS_LOG_TYPE_INFO, "Found personaIdentifier:%@, options:0x%lx, volumeMountPoint:\"%@\"", buf, 0x20u);
          _MBLog();
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 138543362;
        v28 = v10;
        _os_log_impl((void *)&_mh_execute_header, v21, OS_LOG_TYPE_ERROR, "Failed to find the account for persona %{public}@", buf, 0xCu);
        _MBLog();
      }
  ...
  if (v20)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138545666;
      ...
      _os_log_impl((void *)&_mh_execute_header, v22, OS_LOG_TYPE_INFO, "Loaded properties for account %{public}@, persona:%{public}@, dsid:%@, enabled:%d, enabledForBackup:%d, emailVerified:%d, authenticated:%d, options:0x%lx, volume:%{public}@, isBackupOnCellularEnabled:%d", buf, 0x52u);
...
- (void)_reloadAccountPropertiesFromACAccount:(id)a3
{
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138545154;
    ...
    _os_log_impl((void *)&_mh_execute_header, v19, OS_LOG_TYPE_INFO, "Reloaded properties for account %{public}@, dsid:%@, enabled:%d, enabledForBackup:%d, emailVerified:%d, authenticated:%d, options:0x%lx, isBackupOnCellularEnabled:%d", buf, 0x3Eu);
...
+ (void)_setBackupEnabled:(BOOL)a3 account:(id)a4 completion:(id)a5
{
  ...
  id v8 = a5;
  if (!v7) {
    __assert_rtn("+[MBServiceAccount _setBackupEnabled:account:completion:]", "MBServiceAccount.m", 434, "account");
  }
  char v9 = (void (**)(void, void))v8;
  if (!v8) {
    __assert_rtn("+[MBServiceAccount _setBackupEnabled:account:completion:]", "MBServiceAccount.m", 435, "completion");
  }
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
  {
    *(_DWORD *)buf = 136315906;
    ...
    __int16 v30 = 1024;
    BOOL v31 = v6;
    _os_log_impl((void *)&_mh_execute_header, v12, OS_LOG_TYPE_DEFAULT, "%s \"%{public}@\" on account %{public}@ : %d", buf, 0x26u);
    _MBLog();
  }
  ...
  if (v15)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v26 = 2114;
      id v27 = v11;
      _os_log_impl((void *)&_mh_execute_header, v16, OS_LOG_TYPE_DEFAULT, "Not changing the \"%{public}@\" state on account %{public}@ since the device is in EDU mode", buf, 0x16u);
      _MBLog();
    }
  ...
  {
    if (qword_100482768 != -1) {
      dispatch_once(&qword_100482768, &stru_100416DE8);
    }
    id v17 = qword_100482760;
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_10023B7A0;
    block[3] = &unk_100416E38;
    BOOL v23 = v6;
    id v19 = v7;
    id v20 = v11;
    id v21 = v10;
...
+ (void)setBackupEnabled:(BOOL)a3 completion:(id)a4
{
  ...
  id v6 = a4;
  if (!v6) {
    __assert_rtn("+[MBServiceAccount setBackupEnabled:completion:]", "MBServiceAccount.m", 476, "completion");
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      *(_WORD *)unint64_t v12 = 0;
      _os_log_impl((void *)&_mh_execute_header, v10, OS_LOG_TYPE_ERROR, "Failed to fetch the primary account", v12, 2u);
      _MBLog();
    }
...
- (void)setBackupEnabled:(BOOL)a3 completion:(id)a4
{
  ...
  id v6 = a4;
  if (!v6) {
    __assert_rtn("-[MBServiceAccount setBackupEnabled:completion:]", "MBServiceAccount.m", 489, "completion");
  }
  id v7 = (void (**)(void, void))v6;
  uint64_t v8 = [(MBServiceAccount *)self accountIdentifier];
  if (!v8) {
    __assert_rtn("-[MBServiceAccount setBackupEnabled:completion:]", "MBServiceAccount.m", 491, "accountIdentifier");
  }
  char v9 = (void *)v8;
...
- (void)renewCredentials
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl((void *)&_mh_execute_header, v3, OS_LOG_TYPE_DEFAULT, "Renewing account credentials", buf, 2u);
    _MBLog();
  }
...
- (void)updateAppleAccount:(id)a3
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl((void *)&_mh_execute_header, v5, OS_LOG_TYPE_DEBUG, "Updating Apple Account", buf, 2u);
    _MBLog();
  }
...
- (id)updateAppleAccountSync
{
  ...
  uint64_t v13 = sub_10023C850;
  id v14 = sub_10023C860;
  id v15 = 0;
...
- (id)appleID
{
  if ([(MBServiceAccount *)self hasAppleAccount])
  {
    ...
    uint64_t v10 = sub_10023C850;
    id v11 = sub_10023C860;
    id v12 = 0;
...
- (id)updateApplePasswordSync:(id)a3
{
  ...
  id v15 = sub_10023C850;
  id v16 = sub_10023C860;
  id v17 = 0;
...
- (BOOL)verifyAppleAccountCredentialsWithContext:(BOOL)a3
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_DEFAULT, "Verifying account credentials", buf, 2u);
    _MBLog();
  }
  ...
  *(void *)buf = 0;
  ...
  __int16 v30 = sub_10023C850;
  BOOL v31 = sub_10023C860;
  id v32 = 0;
  uint64_t v21 = 0;
  unsigned int v22 = &v21;
  uint64_t v23 = 0x3032000000;
  unsigned int v24 = sub_10023C850;
  unsigned int v25 = sub_10023C860;
  id v26 = 0;
  ...
  if (!*((void *)v28 + 5))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)unsigned int v33 = 138412290;
      uint64_t v34 = v14;
      _os_log_impl((void *)&_mh_execute_header, v12, OS_LOG_TYPE_ERROR, "Account credential verification failed to get password: %@", v33, 0xCu);
      _MBLog();
    }
    goto LABEL_9;
  }
  ...
  if (v22[5])
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)unsigned int v33 = 138412290;
      uint64_t v34 = v13;
      _os_log_impl((void *)&_mh_execute_header, v12, OS_LOG_TYPE_ERROR, "Account credential verification failed: %@", v33, 0xCu);
      _MBLog();
    }
LABEL_9:
    BOOL v15 = 0;
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
  {
    *(_WORD *)unsigned int v33 = 0;
    _os_log_impl((void *)&_mh_execute_header, v12, OS_LOG_TYPE_DEFAULT, "Account credential verification succeeded", v33, 2u);
    _MBLog();
  }
  BOOL v15 = 1;
LABEL_13:
