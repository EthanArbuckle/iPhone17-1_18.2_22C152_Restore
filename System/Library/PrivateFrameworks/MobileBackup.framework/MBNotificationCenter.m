...
+ (id)sharedNotificationCenter
{
  if (qword_100482878 != -1) {
    dispatch_once(&qword_100482878, &stru_100417DA8);
  }
  return (id)qword_100482870;
}
...
- (void)_postNotification:(id)a3
{
  ...
  {
    char v5 = i;
    uint32_t v6 = notify_post((const char *)objc_msgSend(a3, "UTF8String", v9, v10));
    if (!v6) {
      break;
    }
    uint32_t v7 = v6;
    ...
    if ((v5 & 1) == 0) {
      objc_exception_throw(objc_msgSend(objc_alloc((Class)MBException), "initWithCode:format:", 1, @"notify_post failed: %lu", v7));
    }
  }
}
...
- (int)_tokenForName:(id)a3
{
  ...
  block[1] = 3221225472;
  block[2] = sub_10029DA8C;
  block[3] = &unk_100416A98;
  block[4] = self;
  block[5] = a3;
  block[6] = &v8;
  block[7] = &v12;
  ...
  if (*((_DWORD *)v13 + 6))
  {
    ...
    objc_exception_throw(objc_msgSend(v6, "initWithCode:format:", 1, @"notify_register_check failed: %lu", *((unsigned int *)v13 + 6)));
  }
  int v4 = *((_DWORD *)v9 + 6);
...
- (unint64_t)_stateForToken:(int)a3
{
  for (char i = 1; ; char i = 0)
  {
    ...
    if ((v5 & 1) == 0) {
      objc_exception_throw(objc_msgSend(objc_alloc((Class)MBException), "initWithCode:format:", 1, @"notify_get_state failed: %lu", v7));
    }
  }
  return state64;
}
...
- (void)_setState:(unint64_t)a3 forToken:(int)a4
{
  for (char i = 1; ; char i = 0)
  {
    ...
    if ((v7 & 1) == 0) {
      objc_exception_throw(objc_msgSend(objc_alloc((Class)MBException), "initWithCode:format:", 1, @"notify_set_state failed: %lu", v9));
    }
  }
}
