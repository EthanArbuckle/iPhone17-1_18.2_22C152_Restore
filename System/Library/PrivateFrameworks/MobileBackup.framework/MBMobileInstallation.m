...
- (id)userAppWithBundleID:(id)a3 placeholder:(BOOL)a4 persona:(id)a5 error:(id *)a6
{
  ...
  unsigned int v13 = sub_1001BA9FC(v11, v12);
...
LABEL_29:
                  ...
                  *(void *)&v82[8] = v38;
                  ...
                  v40 = sub_1001BDB98(v39);
                  *(void *)&v82[16] = v40;
                  v81[3] = @"Container";
                  v41 = [v15 dataContainerURL];
                  id v42 = sub_1001BDB98(v41);
                  v83 = v42;
                  double v43 = v66;
...
- (id)systemContainersWithError:(id *)a3
{
  ...
  else
  {
    ...
    id v7 = v12;
    uint64_t v9 = (void *)qword_100482648;
    qword_100482648 = v8;
  }
  if (a3) {
    *a3 = v7;
  }
  id v10 = (id)qword_100482648;
...
- (id)systemSharedContainersWithError:(id *)a3
{
  ...
  else
  {
    ...
    id v7 = v12;
    uint64_t v9 = (void *)qword_100482650;
    qword_100482650 = v8;
  }
  if (a3) {
    *a3 = v7;
  }
  id v10 = (id)qword_100482650;
...
+ (id)defaultSubdirectoriesForMBContainerType:(int)a3 withNestedSubdirectories:(BOOL)a4
{
  ...
  if (!qword_100482658)
  {
    ...
    uint64_t v8 = (void *)qword_100482658;
    qword_100482658 = v7;
  }
  ...
  else
  {
    ...
    __int16 v12 = [(id)qword_100482658 objectForKeyedSubscript:v10];
    if (!v12)
    {
      __int16 v12 = [v6 _defaultSubdirectoriesForMCMContainerType:v9 withError:0];
      [(id)qword_100482658 setObject:v12 forKeyedSubscript:v10];
    }
    if (v4)
    {
...
- (BOOL)registerSafeHarborWithIdentifier:(id)a3 path:(id)a4 type:(int)a5 error:(id *)a6
{
  ...
  if ((a5 - 1) > 2) {
    ...
    uint64_t v11 = qword_1003B3670[a5 - 1];
  }
...
- (BOOL)removeSafeHarborWithIdentifier:(id)a3 type:(int)a4 error:(id *)a5
{
  ...
  if (a4 > 3) {
    ...
    uint64_t v8 = qword_1003B3688[a4];
  }
...
+ (id)displayNameForDomain:(id)a3 isSystemDomain:(BOOL)a4
{
  ...
  if (v5)
  {
    ...
    else
    {
      ...
      uint64_t v8 = [&off_10043B0D0 objectForKeyedSubscript:v7];
      int v9 = v8;
      if (v8)
      {
        id v10 = v8;
