...
- (MBLockdown)init
{
  ...
  if (v2)
  {
    if (qword_100482788 != -1) {
      dispatch_once(&qword_100482788, &stru_1004171C8);
    }
...
- (BOOL)connect
{
  ...
  v4[4] = self;
  v4[5] = &v5;
  dispatch_sync((dispatch_queue_t)qword_100482790, v4);
...
- (void)disconnect
{
  ...
  block[1] = 3221225472;
  block[2] = sub_10024B884;
  block[3] = &unk_1004149C0;
  block[4] = self;
  dispatch_sync((dispatch_queue_t)qword_100482790, block);
}
...
- (id)objectForDomain:(id)a3 andKey:(id)a4
{
  ...
  v6[6] = a4;
  v6[7] = &v7;
  dispatch_sync((dispatch_queue_t)qword_100482790, v6);
...
- (BOOL)setObject:(id)a3 forDomain:(id)a4 andKey:(id)a5 withError:(id *)a6
{
  ...
  v8[8] = &v9;
  v8[9] = a6;
  dispatch_sync((dispatch_queue_t)qword_100482790, v8);
...
- (BOOL)removeObjectWithDomain:(id)a3 andKey:(id)a4 withError:(id *)a5
{
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_10024BC9C;
  block[3] = &unk_100417240;
  block[4] = a3;
  void block[5] = a4;
  block[7] = &v8;
  block[8] = a5;
