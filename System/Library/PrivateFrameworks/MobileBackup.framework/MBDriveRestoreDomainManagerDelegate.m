...
+ (id)domainForName:(id)a3 containerID:(id)a4 engine:(id)a5
{
  ...
  if (!v10) {
    __assert_rtn("+[MBDriveRestoreDomainManagerDelegate domainForName:containerID:engine:]", "MBDriveRestoreDomainManagerDelegate.m", 19, "persona");
  }
  if (!v8) {
    __assert_rtn("+[MBDriveRestoreDomainManagerDelegate domainForName:containerID:engine:]", "MBDriveRestoreDomainManagerDelegate.m", 20, "containerID");
  }
  v11 = (void *)v10;
...
LABEL_11:
    ...
    v19 = +[NSSet setWithObject:&stru_100418BA8];
