...
- (id)_preparingBackupWithDriveEngine:(id)a3
{
  ...
  if (v8)
  {
    ...
    v12 = objc_msgSend(v10, "dataUsingEncoding:", 4, v23);
    BOOL v13 = WriteKeychainToDisk(@"/var/Keychains/keychain-backup.plist");
    id v14 = v11;
...
LABEL_19:
        ...
        {
          id v45 = v11;
          BOOL v29 = WriteKeychainToDisk(@"/var/Keychains/keychain-ota-backup.plist");
          id v30 = v11;
          ...
          if (v29)
          {
            ...
            v37 = objc_msgSend(v7, "fileModificationDate", v40, v41);
            v49 = v37;
...
- (id)_endingRestoreWithDriveEngine:(id)a3
{
  ...
  if (+[MBRestoreDirectoryAnnotator isRestoredPath:v7])
  {
    ...
    id v30 = v12;
    BOOL v14 = RestoreKeychainFromDisk(v7, (uint64_t)v11, (uint64_t)v13, &v30);
    id v15 = v30;
...
LABEL_24:
      objc_msgSend(v11, "fileDescriptor", v30, v31);
...
- (void)_endingRestoreWithServicePolicy:(id)a3 engine:(id)a4
{
  ...
  if (+[MBRestoreDirectoryAnnotator isRestoredPath:v10])
  {
    ...
    {
      id v28 = 0;
      id v11 = +[MBKeychain allPasswordItemsForServices:&off_10043B430 error:&v28];
      id v12 = v28;
      if (!v11)
      {
