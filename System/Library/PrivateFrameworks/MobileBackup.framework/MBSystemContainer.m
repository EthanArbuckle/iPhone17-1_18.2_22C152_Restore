...
- (id)domain
{
  ...
  if (qword_100482908 != -1) {
    dispatch_once(&qword_100482908, &stru_100417F98);
  }
  [v7 setRelativePathsToBackupAndRestore:qword_100482900];
  if (qword_100482918 != -1) {
    dispatch_once(&qword_100482918, &stru_100417FB8);
  }
  [v7 setRelativePathsNotToBackup:qword_100482910];
  if (qword_100482928 != -1) {
    dispatch_once(&qword_100482928, &stru_100417FD8);
  }
  [v7 setRelativePathsNotToRestore:qword_100482920];
