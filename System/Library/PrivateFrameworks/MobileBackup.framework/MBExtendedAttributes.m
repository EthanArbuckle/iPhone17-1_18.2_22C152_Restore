...
+ (BOOL)hasAttributesForPath:(id)a3 error:(id *)a4
{
  ssize_t v6 = listxattr((const char *)[a3 fileSystemRepresentation], 0, 0, (int)objc_msgSend(a1, "xattrOptionsForPathFSR:", objc_msgSend(a3, "fileSystemRepresentation")));
  if (v6 < 0 && *__error() != 2)
  {
    if (a4)
    {
...
+ (id)keysForPathFSR:(const char *)a3 error:(id *)a4
{
  int v6 = objc_msgSend(a1, "xattrOptionsForPathFSR:");
...
+ (id)keysForFD:(int)a3 error:(id *)a4
{
  int v6 = objc_msgSend(a1, "xattrOptionsForFD:");
...
+ (BOOL)setValue:(id)a3 forKey:(id)a4 forPathFSR:(const char *)a5 error:(id *)a6
{
  int v8 = setxattr(a5, (const char *)[a4 UTF8String], objc_msgSend(a3, "bytes"), (size_t)objc_msgSend(a3, "length"), 0, 1);
  int v9 = v8;
  if (a6 && v8) {
...
+ (BOOL)setValue:(id)a3 forKey:(id)a4 forFD:(int)a5 error:(id *)a6
{
  int v7 = fsetxattr(a5, (const char *)[a4 UTF8String], objc_msgSend(a3, "bytes"), (size_t)objc_msgSend(a3, "length"), 0, 0);
  int v8 = v7;
  if (a6 && v7) {
  ...
  if (v8)
  {
    ...
    while (2)
    {
      for (i = 0; i != v9; i = (char *)i + 1)
      {
        ...
        id v13 = objc_msgSend(a3, "objectForKeyedSubscript:", v12, v20, v22, v24, v26);
  ...
  if (v8)
  {
    ...
    while (2)
    {
      for (i = 0; i != v9; i = (char *)i + 1)
      {
        ...
        id v13 = objc_msgSend(a3, "objectForKeyedSubscript:", v12, v18, v19, v20, v21);
...
+ (unint64_t)sizeOfAttributes:(id)a3
{
  ...
  do
  {
    for (i = 0; i != v5; i = (char *)i + 1)
    {
      ...
      int v6 = (char *)objc_msgSend(objc_msgSend(a3, "objectForKeyedSubscript:", v9), "length") + (void)v10;
    }
