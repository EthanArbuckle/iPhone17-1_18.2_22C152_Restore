...
@implementation BackupStatusRequest
...
- (id)messagesAtIndex:(unint64_t)a3
{
  return [(NSMutableArray *)self->_messages objectAtIndex:a3];
}
...
{
  v7.receiver = self;
  v7.super_class = (Class)BackupStatusRequest;
  v3 = [(BackupStatusRequest *)&v7 description];
  id v4 = [(BackupStatusRequest *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(objc_alloc((Class)NSMutableArray), "initWithCapacity:", -[NSMutableArray count](self->_messages, "count"));
    long long v12 = 0u;
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
    ...
    [v3 setObject:v4 forKey:@"messages"];
  }
  return v3;
}
...
LABEL_13:
    ...
    if ((v7 >> 3) == 1)
    {
      long long v13 = objc_alloc_init(BackupStatusMessage);
      [(BackupStatusRequest *)self addMessages:v13];
      if (!PBReaderPlaceMark() || !BackupStatusMessageReadFrom(v13, (uint64_t)a3))
      {
...
{
  id v8 = a3;
  if ([(BackupStatusRequest *)self messagesCount])
  {
    [v8 clearMessages];
    unint64_t v4 = [(BackupStatusRequest *)self messagesCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        unint64_t v7 = [(BackupStatusRequest *)self messagesAtIndex:i];
        [v8 addMessages:v7];
      }
    }
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  long long v15 = 0u;
  long long v16 = 0u;
  unsigned int v6 = self->_messages;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    messages = self->_messages;
    if ((unint64_t)messages | v4[1]) {
      unsigned __int8 v6 = -[NSMutableArray isEqual:](messages, "isEqual:");
    }
    else {
...
- (unint64_t)hash
{
  return (unint64_t)[(NSMutableArray *)self->_messages hash];
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[BackupStatusRequest addMessages:](self, "addMessages:", *(void *)(*((void *)&v9 + 1) + 8 * (void)v8), (void)v9);
        id v8 = (char *)v8 + 1;
      }
      while (v6 != v8);
