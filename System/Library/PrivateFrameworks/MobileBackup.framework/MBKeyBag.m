...
+ (__MKBAssertion)holdLockAssertion:(id)a3
{
  ...
  *(_OWORD *)keys = *(_OWORD *)&off_100417B28;
  values[0] = @"Other";
  values[1] = v4;
...
+ (id)sharedOTAKeyBag
{
  if (qword_100482840 != -1) {
    dispatch_once(&qword_100482840, &stru_100417B38);
  }
  v2 = (void *)qword_100482838;
  return v2;
}
...
+ (id)OTAKeybagUUIDStringWithVolume:(id)a3 error:(id *)a4
{
  id v5 = a3;
  if (!v5) {
    __assert_rtn("+[MBKeyBag OTAKeybagUUIDStringWithVolume:error:]", "MBKeyBag.m", 410, "volumeMountPoint");
  }
  if (!a4) {
    __assert_rtn("+[MBKeyBag OTAKeybagUUIDStringWithVolume:error:]", "MBKeyBag.m", 411, "error");
  }
  uint64_t v6 = v5;
  uint64_t v7 = +[MBFileSystemManager volumeUUIDWithVolumeMountPoint:v5 error:a4];
  id v8 = v7;
  if (v7)
  {
    ...
    v17[1] = 0;
    [v8 getUUIDBytes:v17];
    uint64_t v10 = +[NSData dataWithBytes:v17 length:16];
    if (!v10) {
      __assert_rtn("+[MBKeyBag OTAKeybagUUIDStringWithVolume:error:]", "MBKeyBag.m", 422, "volumeUUIDData");
    }
    uint64_t v11 = (void *)v10;
    uint64_t v12 = MKBBackupCopyBackupBagUUIDForVolume();
    objc_super v13 = MBGetDefaultLog();
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v20 = 1024;
      LODWORD(v21) = v12;
      _os_log_impl((void *)&_mh_execute_header, v13, OS_LOG_TYPE_DEFAULT, "MKBBackupCopyBackupBagUUIDForVolume(%{public}@): %d", buf, 0x12u);
      _MBLog();
    }

    if (!v12) {
      __assert_rtn("+[MBKeyBag OTAKeybagUUIDStringWithVolume:error:]", "MBKeyBag.m", 432, "keybagUUIDDataRef");
    }
    *a4 = +[MBKeyBag errorWithReturnCode:v12 path:v6 description:@"MKBBackupCopyBackupBagUUIDForVolume error"];
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v20 = 1024;
      LODWORD(v21) = v12;
      _os_log_impl((void *)&_mh_execute_header, v14, OS_LOG_TYPE_ERROR, "MKBBackupCopyBackupBagUUIDForVolume failed for %{public}@: %d", buf, 0x12u);
      _MBLog();
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v20 = 2112;
      id v21 = v15;
      _os_log_impl((void *)&_mh_execute_header, v9, OS_LOG_TYPE_ERROR, "Failed to fetch the volume UUID for %{public}@: %@", buf, 0x16u);
      _MBLog();
    }
  }
...
+ (id)registerOTAKeyBagWithVolume:(id)a3 secret:(id)a4 keybagUUIDData:(id *)a5 error:(id *)a6
{
  ...
  id v10 = a4;
  if (!v9) {
    __assert_rtn("+[MBKeyBag registerOTAKeyBagWithVolume:secret:keybagUUIDData:error:]", "MBKeyBag.m", 442, "volumeMountPoint");
  }
  uint64_t v11 = v10;
  if (!v10) {
    __assert_rtn("+[MBKeyBag registerOTAKeyBagWithVolume:secret:keybagUUIDData:error:]", "MBKeyBag.m", 443, "secret");
  }
  if (!a5) {
    __assert_rtn("+[MBKeyBag registerOTAKeyBagWithVolume:secret:keybagUUIDData:error:]", "MBKeyBag.m", 444, "keybagUUIDDataPtr");
  }
  if (!a6) {
    __assert_rtn("+[MBKeyBag registerOTAKeyBagWithVolume:secret:keybagUUIDData:error:]", "MBKeyBag.m", 445, "error");
  }
  uint64_t v12 = +[MBFileSystemManager volumeUUIDWithVolumeMountPoint:v9 error:a6];
  objc_super v13 = v12;
  if (v12)
  {
    ...
    uint64_t v15 = +[NSData dataWithBytes:v28 length:16];
    if (!v15) {
      __assert_rtn("+[MBKeyBag registerOTAKeyBagWithVolume:secret:keybagUUIDData:error:]", "MBKeyBag.m", 456, "volumeUUIDData");
    }
    CFStringRef v16 = (void *)v15;
    int v17 = MKBBackupDisableForVolume();
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v26 = 1024;
      int v27 = v17;
      _os_log_impl((void *)&_mh_execute_header, v18, OS_LOG_TYPE_DEFAULT, "MKBBackupDisableForVolume(%{public}@): %d", buf, 0x12u);
      _MBLog();
    }
    ...
    if (v17)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v26 = 1024;
        int v27 = v17;
        _os_log_impl((void *)&_mh_execute_header, v19, OS_LOG_TYPE_ERROR, "MKBBackupDisableForVolume failed for %{public}@: %d", buf, 0x12u);
        _MBLog();
      }
    }
    uint64_t v20 = MKBBackupEnableForVolume();
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v26 = 1024;
      int v27 = v20;
      _os_log_impl((void *)&_mh_execute_header, v21, OS_LOG_TYPE_DEFAULT, "MKBBackupEnableForVolume(%{public}@): %d", buf, 0x12u);
      _MBLog();
    }

    if (!v20) {
      __assert_rtn("+[MBKeyBag registerOTAKeyBagWithVolume:secret:keybagUUIDData:error:]", "MBKeyBag.m", 475, "keybagDataRef");
    }
    *a6 = +[MBKeyBag errorWithReturnCode:v20 path:v9 description:@"MKBBackupEnableForVolume error"];
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v26 = 1024;
      int v27 = v20;
      _os_log_impl((void *)&_mh_execute_header, v22, OS_LOG_TYPE_ERROR, "MKBBackupEnableForVolume failed for %{public}@: %d", buf, 0x12u);
      _MBLog();
    }
  }
  return 0;
...
{
  id v5 = a3;
  uint64_t v6 = +[MBFileSystemManager volumeUUIDWithVolumeMountPoint:v5 error:a4];
  uint64_t v7 = v6;
  if (v6)
  {
    id v8 = [v6 UUIDString];
    ...
    v20[1] = 0;
    [v7 getUUIDBytes:v20];
    uint64_t v9 = +[NSData dataWithBytes:v20 length:16];
    if (!v9) {
      __assert_rtn("+[MBKeyBag unregisterOTAKeyBagForVolume:error:]", "MBKeyBag.m", 494, "volumeUUIDData");
    }
    id v10 = (void *)v9;
    uint64_t v11 = MKBBackupDisableForVolume();
    BOOL v12 = v11 == 0;
    objc_super v13 = MBGetDefaultLog();
    id v14 = v13;
    if (v11)
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v18 = 1024;
        int v19 = v11;
        _os_log_impl((void *)&_mh_execute_header, v14, OS_LOG_TYPE_ERROR, "MKBBackupDisableForVolume failed for %{public}@: %d", buf, 0x12u);
        _MBLog();
      }
    ...
    else
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138543362;
        int v17 = v8;
        _os_log_impl((void *)&_mh_execute_header, v14, OS_LOG_TYPE_DEFAULT, "MKBBackupDisableForVolume succeeded for %{public}@", buf, 0xCu);
        _MBLog();
      }
    }
  }
...
+ (id)OTAKeyBagWithData:(id)a3 secret:(id)a4 error:(id *)a5
{
  ...
  id v10 = a4;
  if (!v9) {
    __assert_rtn("+[MBKeyBag OTAKeyBagWithData:secret:error:]", "MBKeyBag.m", 508, "data");
  }
  uint64_t v11 = v10;
  if (!v10) {
    __assert_rtn("+[MBKeyBag OTAKeyBagWithData:secret:error:]", "MBKeyBag.m", 509, "secret");
  }
  uint64_t v12 = MKBOTABackupBagOpen();
  objc_super v13 = MBGetDefaultLog();
  id v14 = v13;
  if (v12)
  {
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 134218496;
      ...
      __int16 v22 = 1024;
      int v23 = v12;
      _os_log_impl((void *)&_mh_execute_header, v14, OS_LOG_TYPE_ERROR, "MKBOTABackupBagOpen(%lu, %lu): %d", buf, 0x1Cu);
      [v9 length];
      [v11 length];
      _MBLog();
    }
  ...
  else
  {
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)buf = 134218752;
      ...
      __int16 v24 = 2048;
      uint64_t v25 = 0;
      _os_log_impl((void *)&_mh_execute_header, v14, OS_LOG_TYPE_INFO, "MKBOTABackupBagOpen(%lu, %lu): %d, %p", buf, 0x26u);
      [v9 length];
      [v11 length];
      _MBLog();
    }

    int v17 = +[NSAssertionHandler currentHandler];
    [v17 handleFailureInMethod:a2 object:a1 file:@"MBKeyBag.m" lineNumber:521 description:@"MKBOTABackupBagOpen succeeded but handle is null"];

    uint64_t v15 = [[MBKeyBag alloc] initWithOTAHandle:0 keyBagData:v9];
  }
