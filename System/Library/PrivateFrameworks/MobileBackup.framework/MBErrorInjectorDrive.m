...
+ (id)keysFromDictionary:(id)a3 toIndex:(unint64_t)a4
{
  ...
  id v8 = objc_msgSend(objc_msgSend(a3, "allKeys"), "sortedArrayUsingSelector:", "compare:");
  return objc_msgSend(v8, "subarrayWithRange:", 0, a4);
}
...
- (BOOL)uploadFilesAtPaths:(id)a3 options:(id)a4 results:(id *)a5 error:(id *)a6
{
  if ([(MBDriveScript *)self->_script index] == self->_index)
  {
    ...
    id v13 = objc_msgSend(objc_msgSend(a3, "allKeys"), "sortedArrayUsingSelector:", "compare:");
    id v14 = +[MBErrorInjectorDrive subdictionary:withKeys:](MBErrorInjectorDrive, "subdictionary:withKeys:", a3, objc_msgSend(v13, "subarrayWithRange:", 0, self->_subindex >> 1));
...
- (BOOL)removeItemsAtPaths:(id)a3 options:(id)a4 results:(id *)a5 error:(id *)a6
{
  ...
  unsigned int v18 = -[MBDrive removeItemsAtPaths:options:results:error:](self->_delegate, "removeItemsAtPaths:options:results:error:", objc_msgSend(a3, "subarrayWithRange:", 0, self->_subindex), a4, a5, a6);
  BOOL result = 0;
  if (a6)
  {
    if (v18)
