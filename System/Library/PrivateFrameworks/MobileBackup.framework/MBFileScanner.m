...
- (id)scanDomain:(id)a3 snapshotMountPoint:(id)a4
{
  ...
  if ((atomic_exchange((atomic_uchar *volatile)&self->_started, 1u) & 1) == 0)
  {
    ...
    *(_OWORD *)&self->_totalStats.uint64_t minFileSize = xmmword_1003B36F0;
  ...
  buf[0].i64[0] = 0;
  memset(&buf[1], 0, 56);
  *(int64x2_t *)((char *)buf + 8) = (int64x2_t)xmmword_1003B36F0;
  v13 = MBGetDefaultLog();
...
- (id)_scanDomain:(id)a3 snapshotPath:(id)a4 stats:(_MBFileScannerDomainStats *)a5
{
  ...
  else
  {
    ...
    unsigned int v14 = [v13 containsObject:&stru_100418BA8];

    if (v14)
    {
      id v12 = [(MBFileScanner *)self _scanFilesForDomain:v8 snapshotPath:v9 relativePath:&stru_100418BA8 stats:a5];
    }
    else
    {
      ...
      id v12 = [(MBFileScanner *)self _scanTree:v16 forDomain:v8 snapshotPath:v9 relativePath:&stru_100418BA8 stats:a5];
    }
        ...
        if (v10)
        {
          ...
          while (2)
          {
            ...
            do
            {
              ...
              v16 = objc_msgSend(v14, "objectForKeyedSubscript:", v15, v20);
              if (v16)
              {
                id v8 = v16;
                if (![v16 count])
...
- (BOOL)_shouldNotBackupFile:(id)a3 domain:(id)a4
{
    ...
    || ([WeakRetained fileScanner:self shouldExcludeFile:v6] & 1) == 0)
  {
    unint64_t policy = self->_policy;
    if ((policy & 0x21) == 0x20) {
      __assert_rtn("-[MBFileScanner _shouldNotBackupFile:domain:]", "MBFileScanner.m", 272, "!isMegaBackupPolicy || _isCloudKitEngine(_policy)");
    }
...
LABEL_43:
    ...
    v22 = objc_msgSend(v6, "domain", v93, v95);
...
LABEL_98:
        ...
        id v57 = objc_msgSend(v6, "isDirectory", v94);
        v58 = +[NSURL fileURLWithPath:v39 isDirectory:v57];
        id v118 = 0;
        id v117 = 0;
        unsigned int v59 = objc_msgSend(v58, "getResourceValue:forKey:error:", &v118);
        v60 = v118;
        id v61 = v117;
...
LABEL_127:
                    if (objc_msgSend(v6, "isRegularFile", v94, v96, v97))
                    {
                      ...
                      {
                        v82 = objc_msgSend(v39, "substringFromIndex:");
...
- (id)_scanTree:(id)a3 forDomain:(id)a4 snapshotPath:(id)a5 relativePath:(id)a6 stats:(_MBFileScannerDomainStats *)a7
{
  ...
  id v56 = 0;
  char v23 = MBNodeForPath(v22, (uint64_t)v57, &v56);
  id v24 = v56;
...
LABEL_19:
  ...
  if (![(MBFileScanner *)self _shouldNotBackupFile:v21 domain:v14])
  {
    ...
    if (v33)
    {
      ...
      long long v36 = [v35 sortedArrayUsingComparator:&stru_1004162A8];
...
LABEL_38:
  ...
  if (([v14 isEqualToString:@"Library/Application Support/CloudDocs/backup"] & 1) == 0)
  {
    id v16 = v71;
    if ([v14 hasPrefix:@"Library/Application Support/CloudDocs/backup/"] & 1) != 0|| ([v14 isEqualToString:@"Library/Application Support/FileProvider/backup"] & 1) != 0|| ([v14 hasPrefix:@"Library/Application Support/FileProvider/backup/"])
    {
      ssize_t v18 = 0;
LABEL_22:
      id v24 = v70;
    ...
    if (([v14 isEqualToString:@"Library/Application Support/CloudDocs"] & 1) != 0|| [v14 isEqualToString:@"Library/Application Support/FileProvider"])
    {
      id v21 = [v14 stringByAppendingPathComponent:@"backup"];
...
LABEL_39:
    ...
    v72 = v17;
    char v34 = MBNodeForRelativePathAt((int)v19, v14, (uint64_t)buf, &v72);
    long long v35 = v72;
...
LABEL_64:
    ...
    else
    {
        ...
        || ![v37 fileScanner:self failedToStatFile:v70 withErrno:v36])
      {
        ...
        MBDiagnoseUnavailableiCloudBackupFile(v55, v13, v57, (int)v36, (uint64_t)"MBNodeForRelativePathAt");
        MBDiagnoseUnavailableiTunesBackupFile(v55, v13, v57, (int)v36, (uint64_t)"MBNodeForRelativePathAt");
      ...
      MBDiagnoseUnavailableiCloudBackupFile(v42, v13, v44, (int)v36, (uint64_t)"MBNodeForRelativePathAt");
      MBDiagnoseUnavailableiTunesBackupFile(v42, v13, v44, (int)v36, (uint64_t)"MBNodeForRelativePathAt");
    }
...
- (id)_scanDirectory:(id)a3 domain:(id)a4 domainDirFd:(int)a5 snapshotPath:(id)a6 relativePath:(id)a7 depth:(int)a8 stats:(_MBFileScannerDomainStats *)a9
{
  ...
  if (v17 < 0)
  {
    ...
    char v34 = [(MBFileScanner *)self delegate];
    if (v33 == 2)
    {
      long long v35 = MBGetDefaultLog();
      if (os_log_type_enabled(v35, OS_LOG_TYPE_DEFAULT))
      {
        id v36 = [v14 absolutePath];
        LODWORD(v121.d_ino) = 138412290;
        *(__uint64_t *)((char *)&v121.d_ino + 4) = (__uint64_t)v36;
        _os_log_impl((void *)&_mh_execute_header, v35, OS_LOG_TYPE_DEFAULT, "=scanning= Modification error when opening directory \"%@\" while scanning", (uint8_t *)&v121, 0xCu);

        v92 = [v14 absolutePath];
        _MBLog();
      }
      unsigned int v37 = v110;
      [(NSMutableSet *)self->_modifiedDomains addObject:v110];
      id v38 = 0;
    }
    else
    {
      if ((objc_opt_respondsToSelector() & 1) != 0
        && [v34 fileScanner:self failedToOpenFile:v14 withErrno:v33])
      {
        id v44 = MBGetDefaultLog();
        if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
        {
          unsigned int v45 = [v14 absolutePath];
          LODWORD(v121.d_ino) = 138412802;
          *(__uint64_t *)((char *)&v121.d_ino + 4) = (__uint64_t)v45;
          WORD2(v121.d_seekoff) = 2080;
          *(__uint64_t *)((char *)&v121.d_seekoff + 6) = (__uint64_t)v16;
          *(_WORD *)&v121.d_name[1] = 1024;
          *(_DWORD *)&v121.d_name[3] = v33;
          _os_log_impl((void *)&_mh_execute_header, v44, OS_LOG_TYPE_INFO, "=scanning= Skipping file with openat failure %@ (%s): %{errno}d", (uint8_t *)&v121, 0x1Cu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
        {
          ...
          LODWORD(v121.d_ino) = 138412802;
          *(__uint64_t *)((char *)&v121.d_ino + 4) = (__uint64_t)v52;
          WORD2(v121.d_seekoff) = 2080;
          *(__uint64_t *)((char *)&v121.d_seekoff + 6) = (__uint64_t)v16;
          *(_WORD *)&v121.d_name[1] = 1024;
          *(_DWORD *)&v121.d_name[3] = v33;
          _os_log_impl((void *)&_mh_execute_header, v51, OS_LOG_TYPE_ERROR, "=scanning= openat failed at %@ (%s): %{errno}d", (uint8_t *)&v121, 0x1Cu);

          CFErrorRef v96 = [v14 absolutePath];
          _MBLog();
        }
        long long v53 = [v14 absolutePath];
        id v38 = +[MBError errorWithErrno:v33 code:101 path:v53 format:@"open error"];

        long long v54 = [v14 absolutePath];
        MBDiagnoseFile(v54);
      }
      unsigned int v37 = v110;
    }
  ...
  {
    memset(&v121, 0, 144);
    if (!fstat(v17, (stat *)&v121))
    {
      id d_seekoff = (id)v121.d_seekoff;
      if (d_seekoff != [v14 inodeNumber])
      {
        ...
        if (os_log_type_enabled(v73, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138412290;
          *(void *)v123 = v74;
          _os_log_impl((void *)&_mh_execute_header, v73, OS_LOG_TYPE_DEFAULT, "=scanning= Modification error when opening directory \"%@\" while scanning", buf, 0xCu);
    ...
    v40 = [(MBFileScanner *)self delegate];
    unsigned int v37 = v110;
    if (v39 == 2)
    {
      ...
      {
        unsigned int v42 = [v14 absolutePath];
        *(_DWORD *)buf = 138412290;
        *(void *)v123 = v42;
        _os_log_impl((void *)&_mh_execute_header, v41, OS_LOG_TYPE_DEFAULT, "=scanning= Modification error when stating directory \"%@\" while scanning", buf, 0xCu);
    ...
    {
      if ((objc_opt_respondsToSelector() & 1) == 0
        || ![v40 fileScanner:self failedToStatFile:v14 withErrno:v39])
      {
        int v79 = MBGetDefaultLog();
        if (os_log_type_enabled(v79, OS_LOG_TYPE_ERROR))
        {
          v80 = [v14 absolutePath];
          *(_DWORD *)buf = 138412802;
          *(void *)v123 = v80;
          *(_WORD *)&v123[8] = 2080;
          *(void *)&v123[10] = v16;
          *(_WORD *)&v123[18] = 1024;
          *(_DWORD *)&v123[20] = v39;
          _os_log_impl((void *)&_mh_execute_header, v79, OS_LOG_TYPE_ERROR, "=scanning= fstat failed at %@ (%s): %{errno}d", buf, 0x1Cu);

          v101 = [v14 absolutePath];
          _MBLog();
        }
        long long v81 = [v14 absolutePath];
        uint64_t v43 = +[MBError errorWithErrno:v39 code:101 path:v81 format:@"stat error"];

        goto LABEL_105;
      }
      unsigned int v77 = MBGetDefaultLog();
      if (os_log_type_enabled(v77, OS_LOG_TYPE_INFO))
      {
        __int16 v78 = [v14 absolutePath];
        *(_DWORD *)buf = 138412802;
        *(void *)v123 = v78;
        *(_WORD *)&v123[8] = 2080;
        *(void *)&v123[10] = v16;
        *(_WORD *)&v123[18] = 1024;
        *(_DWORD *)&v123[20] = v39;
        _os_log_impl((void *)&_mh_execute_header, v77, OS_LOG_TYPE_INFO, "=scanning= Skipping file with fstat failure %@ (%s): %{errno}d", buf, 0x1Cu);
...
LABEL_6:
  ...
  if (!v19)
  {
    ...
    if (v46 == 2)
    {
      ...
      {
        v49 = [v14 absolutePath];
        LODWORD(v121.d_ino) = 138412290;
        *(__uint64_t *)((char *)&v121.d_ino + 4) = (__uint64_t)v49;
        _os_log_impl((void *)&_mh_execute_header, v48, OS_LOG_TYPE_DEFAULT, "=scanning= Modification error when opening directory \"%@\" while scanning", (uint8_t *)&v121, 0xCu);
    ...
    else
    {
      ...
      {
        v75 = [v14 absolutePath];
        LODWORD(v121.d_ino) = 138412802;
        *(__uint64_t *)((char *)&v121.d_ino + 4) = (__uint64_t)v75;
        WORD2(v121.d_seekoff) = 2080;
        *(__uint64_t *)((char *)&v121.d_seekoff + 6) = (__uint64_t)v16;
        *(_WORD *)&v121.d_name[1] = 1024;
        *(_DWORD *)&v121.d_name[3] = v46;
        _os_log_impl((void *)&_mh_execute_header, v48, OS_LOG_TYPE_ERROR, "=scanning= fdopendir failed at %@ (%s): %{errno}d", (uint8_t *)&v121, 0x1Cu);

        v99 = [v14 absolutePath];
        _MBLog();
      }
      __int16 v76 = [v14 absolutePath];
      SEL v50 = +[MBError errorWithErrno:v46 code:101 path:v76 format:@"fdopendir error"];
...
LABEL_106:
  ...
  unsigned int v21 = 0;
  v109 = 0;
  unsigned int v111 = a8 + 1;
  while (1)
  {
    memset(&v121, 0, 512);
    long long v119 = 0;
    int v23 = readdir_r(v20, &v121, &v119);
    if (v23) {
      break;
    }
    if (!v119) {
    ...
    if (*(unsigned __int16 *)v121.d_name != 46
      && *(unsigned __int16 *)v121.d_name ^ 0x2E2E | v121.d_name[2])
    {
      ++v21;
      id v24 = +[NSString mb_stringWithFileSystemRepresentation:v121.d_name];
      if (v24)
      {
        if (v121.d_type == 4)
        {
          uint64_t v25 = [v112 stringByAppendingPathComponent:v24];
          uint64_t v26 = [(MBFileScanner *)self _scanFilesUsingReaddirForDomain:v110 snapshotPath:v114 relativePath:v25 depth:v111 stats:a9];
...
LABEL_34:
        ...
        HIDWORD(v31) = 989560465 * v21;
        LODWORD(v31) = 989560465 * v21;
        if ((v31 >> 4) > 0x68DB8)
        {
          int v27 = 0;
          goto LABEL_34;
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_WORD *)&v123[14] = 2114;
          *(void *)&v123[16] = v32;
          _os_log_impl((void *)&_mh_execute_header, v28, OS_LOG_TYPE_DEFAULT, "=scanning= Found %u items under %{public}s (%{public}@)", buf, 0x1Cu);

          long long v30 = [v110 name];
          _MBLog();
          int v27 = 0;
LABEL_32:
        }
...
LABEL_33:
      ...
      BOOL v28 = +[NSData dataWithBytes:v121.d_name length:v121.d_namlen];
      uint64_t v29 = MBGetDefaultLog();
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 138412290;
        *(void *)v123 = v28;
        _os_log_impl((void *)&_mh_execute_header, v29, OS_LOG_TYPE_ERROR, "=scanning= Unexpected file name: %@", buf, 0xCu);
        _MBLog();
      }
      ...
      if (MBIsInternalInstall())
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_FAULT))
        {
          *(_DWORD *)buf = 138412290;
          *(void *)v123 = v28;
          _os_log_impl((void *)&_mh_execute_header, v30, OS_LOG_TYPE_FAULT, "=scanning= Unexpected file name: %@", buf, 0xCu);
          goto LABEL_22;
        }
      }
      else
      {
        ...
        if (atomic_fetch_add_explicit(&dword_100482698, 1u, memory_order_relaxed))
        {
          int v27 = 38;
          goto LABEL_33;
        }
        ...
        {
          *(_WORD *)buf = 0;
          _os_log_impl((void *)&_mh_execute_header, v30, OS_LOG_TYPE_FAULT, "=scanning= =scanning= Unexpected file name", buf, 2u);
LABEL_22:
          _MBLog();
        }
      }
...
LABEL_35:
  ...
  if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_WORD *)&v123[8] = 1024;
    *(_DWORD *)&v123[10] = v55;
    _os_log_impl((void *)&_mh_execute_header, v56, OS_LOG_TYPE_ERROR, "=scanning= readdir_r failed at %@: %d", buf, 0x12u);

    id v97 = [v14 absolutePath];
    _MBLog();
  }
  uint64_t v58 = *__error();
  unsigned int v59 = [v14 absolutePath];
  uint64_t v60 = +[MBError errorWithErrno:v58 code:101 path:v59 format:@"readdir error"];
...
LABEL_70:
  ...
  if (v21 >> 4 >= 0x271)
  {
    ...
    {
      __int16 v62 = [v110 name];
      LODWORD(v121.d_ino) = 67109634;
      HIDWORD(v121.d_ino) = v21;
      LOWORD(v121.d_seekoff) = 2082;
      *(__uint64_t *)((char *)&v121.d_seekoff + 2) = (__uint64_t)v106;
      v121.d_namlen = 2114;
      *(void *)&v121.d_type = v62;
      _os_log_impl((void *)&_mh_execute_header, v61, OS_LOG_TYPE_DEFAULT, "=scanning= Found a total of %u items under %{public}s (%{public}@)", (uint8_t *)&v121, 0x1Cu);
  ...
  [v108 sortUsingComparator:&stru_1004162C8];
  long long v117 = 0u;
  long long v118 = 0u;
  long long v115 = 0u;
  long long v116 = 0u;
  id v63 = v108;
  id v64 = [v63 countByEnumeratingWithState:&v115 objects:v120 count:16];
  if (v64)
  {
    id v65 = v64;
    ...
    while (2)
    {
      for (i = 0; i != v65; i = (char *)i + 1)
      {
        ...
        uint64_t v68 = *(void *)(*((void *)&v115 + 1) + 8 * i);
        v70 = [v112 stringByAppendingPathComponent:v68];
        unint64_t v71 = [(MBFileScanner *)self _scanFilesUsingReaddirForDomain:v110 snapshotPath:v114 relativePath:v70 depth:v111 stats:a9];
        if (v71)
        {
          id v38 = v71;
      ...
      id v65 = [v63 countByEnumeratingWithState:&v115 objects:v120 count:16];
      if (v65) {
        continue;
      }
      break;
  ...
  if (!v114)
  {
    memset(&v121, 0, 144);
    id v15 = v112;
    if (!fstatat(v107, v106, (stat *)&v121, 32))
    {
      id v85 = (id)v121.d_seekoff;
      if (v85 == [v14 inodeNumber])
      {
        [(MBFileScanner *)self _detectModifiedDomain:v110 relativePath:v112 lastModified:*(void *)&v121.d_name[27]];
LABEL_89:
        id v38 = 0;
        goto LABEL_107;
      }
LABEL_115:
      ...
      if (os_log_type_enabled(v86, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138412290;
        *(void *)v123 = v87;
        _os_log_impl((void *)&_mh_execute_header, v86, OS_LOG_TYPE_DEFAULT, "=scanning= Deleted/modified while scanning: %@", buf, 0xCu);

        unsigned int v102 = [v14 absolutePath];
        _MBLog();
      }
      [(MBDebugContext *)self->_debugContext setFlag:@"FileDeletedWhileScanning"];
      [(NSMutableSet *)self->_modifiedDomains addObject:v110];
    ...
    v84 = [(MBFileScanner *)self delegate];
    char v34 = v84;
    if (v83 == 2)
    {
    ...
    if ((objc_opt_respondsToSelector() & 1) != 0
      && [v34 fileScanner:self failedToStatFile:v14 withErrno:v83])
    {
      CFBooleanRef v88 = MBGetDefaultLog();
      if (os_log_type_enabled(v88, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&v123[18] = 1024;
        *(_DWORD *)&v123[20] = v83;
        _os_log_impl((void *)&_mh_execute_header, v88, OS_LOG_TYPE_INFO, "=scanning= Skipping file with fstat failure %@ (%s): %{errno}d", buf, 0x1Cu);

        v103 = [v14 absolutePath];
        _MBLog();
      }
      id v38 = 0;
    }
    else
    {
      ...
      if (os_log_type_enabled(v90, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&v123[18] = 1024;
        *(_DWORD *)&v123[20] = v83;
        _os_log_impl((void *)&_mh_execute_header, v90, OS_LOG_TYPE_ERROR, "=scanning= fstatat failed at %@ (%s): %{errno}d", buf, 0x1Cu);

        id v104 = [v14 absolutePath];
        _MBLog();
      }
      CFBooleanRef v88 = [v14 absolutePath];
      id v38 = +[MBError errorWithErrno:v83 code:101 path:v88 format:@"stat error"];
    }
...
- (id)_scanFilesUsingGetattrlistbulkForDomain:(id)a3 snapshotPath:(id)a4 relativePath:(id)a5 stats:(_MBFileScannerDomainStats *)a6
{
  ...
  memset(buf, 0, sizeof(buf));
  id v72 = v15;
  char v17 = MBNodeForRelativePathAt(v14, v12, (uint64_t)buf, &v72);
  id v18 = v72;
  ...
  if (![(MBFileScanner *)self _shouldNotBackupFile:v19 domain:v10])
  {
    ...
    if ([v19 isDirectory])
    {
      ...
      uint64_t v66 = +[NSMutableData dataWithLength:0x4000];
      uint64_t v26 = 0;
      while (1)
      {
        ...
        uint64_t v68 = v27;
        long long v30 = [v70 lastObject];
        [v70 removeLastObject];
        unint64_t v31 = [v67 lastObject];
        ...
        if ((v35 & 0x80000000) != 0)
        {
          ...
          uint64_t v39 = [(MBFileScanner *)self delegate];
...
- (id)_performSinglePassEnumerationForDomain:(id)a3 snapshotPath:(id)a4 relativePath:(id)a5 buffer:(id)a6 dirFd:(int)a7 direntCount:(unsigned int)a8 directoryPathStack:(id)a9 directoryCountStack:(id)a10 stats:(_MBFileScannerDomainStats *)a11
{
  ...
  id v22 = v19;
  id v61 = v22;
  MBEnumerateDirectoryNodes(a7, v48, v55);
...
- (id)_performTwoPassEnumerationForDomain:(id)a3 snapshotPath:(id)a4 relativePath:(id)a5 buffer:(id)a6 dirFd:(int)a7 direntCount:(unsigned int)a8 directoryPathStack:(id)a9 directoryCountStack:(id)a10 stats:(_MBFileScannerDomainStats *)a11
{
  ...
  uint64_t v74 = sub_1001EF478;
  uint64_t v75 = sub_1001EF488;
  id v76 = 0;
  ...
  id v66 = v22;
  id v69 = a11;
  MBEnumerateDirectoryNodes(a7, v19, v62);
...
LABEL_9:
  ...
  id v52 = v44;
  id v53 = v45;
  MBEnumerateDirectoryNodes(a7, v19, v47);
  ...
  while (2)
  {
    for (i = 0; i != v15; i = (char *)i + 1)
    {
      ...
      if (v20)
      {
        ...
        id v24 = objc_msgSend(v22, "substringToIndex:", (unsigned char *)objc_msgSend(v23, "length") - (unsigned char *)objc_msgSend(v18, "length"));

        uint64_t v25 = [v8 domain];
        uint64_t v26 = [v25 rootPath];
...
LABEL_22:
                ...
                memset(buf, 0, sizeof(buf));
                int v107 = v36;
                char v53 = MBNodeForPath(v30, (uint64_t)buf, &v107);
...
LABEL_98:
                  ...
                  if (os_log_type_enabled(v78, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)long long v115 = 67109378;
                    *(_DWORD *)long long v116 = v80;
                    *(_WORD *)&v116[4] = 2112;
                    *(void *)&v116[6] = v30;
...
LABEL_97:
                ...
                else
                {
                    ...
                    || ![v78 fileScanner:self failedToStatFile:v52 withErrno:v77])
                  {
                    ...
                    {
                      *(_DWORD *)long long v115 = 138412546;
                      *(void *)long long v116 = v30;
                      *(_WORD *)&v116[8] = 2114;
                      *(void *)&v116[10] = v21;
                  ...
                  if (os_log_type_enabled(v81, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)long long v115 = 138412802;
...
LABEL_61:
  lastModifiedDateBySQLiteFileID = self->_lastModifiedDateBySQLiteFileID;
  id v59 = objc_msgSend(v8, "fileID", v88, v92, v94);
  ...
  if ([v8 size] > v65)
  {
    ...
    MBDiagnoseiCloudBackupFileAtPath(v69);
  }
LABEL_70:
  unsigned int v70 = v21;
  unsigned int v21 = ((void (*)(id, const char *, MBFileScanner *, id))self->_delegateImpOfFileScannerDidFindFile)(WeakRetained, "fileScanner:didFindFile:", self, v8);
...
- (void)_detectModifiedDomain:(id)a3 relativePath:(id)a4 lastModified:(int64_t)a5
{
  ...
  if (self->_startTime <= a5 && (uint64_t)[(MBDebugContext *)self->_debugContext time] >= a5)
  {
    ...
    if (v11)
    {
      ...
      while (1)
      {
        uint64_t v16 = objc_msgSend(v12, "subarrayWithRange:", 0, v14);
