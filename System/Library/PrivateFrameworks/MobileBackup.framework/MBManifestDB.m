...
- (BOOL)openWithError:(id *)a3
{
  if (!self->_pdb)
  {
    v4 = objc_msgSend(objc_alloc((Class)NSString), "initWithFormat:", @"ManifestDB-%lu", -[MBManifestDB hash](self, "hash"));
...
- (BOOL)checkWithError:(id *)a3
{
  ...
  id v15 = sub_1002791E8;
  id v16 = sub_1002791F8;
  id v17 = 0;
  uint64_t v8 = 0;
  v9 = &v8;
...
- (id)_newConnection:(id)a3
{
  ...
  [v4 setSqliteErrorHandler:&stru_1004179C8];
...
LABEL_22:
          ...
          objc_msgSend(v31, "useBatchingWithDelay:changeCount:", objc_msgSend(v35, "sqlBatchCount"), v34);
...
- (id)_executeSQL:(id)a3
{
  ...
  uint64_t v13 = &v12;
  uint64_t v14 = 0x3032000000;
  unsigned __int8 v15 = sub_1002791E8;
  id v16 = sub_1002791F8;
  id v17 = 0;
  id v11 = &v19;
...
- (id)_enumerateObjectsOfClass:(Class)a3 withCallback:(id)a4 format:(id)a5
{
  ...
  unsigned __int8 v23 = sub_1002791E8;
  id v24 = sub_1002791F8;
  id v25 = 0;
  uint64_t v19 = &v27;
...
- (id)_fetchObjectOfClass:(Class)a3 withError:(id *)a4 format:(id)a5
{
  ...
  uint64_t v27 = sub_1002791E8;
  id v28 = sub_1002791F8;
  id v29 = 0;
  uint64_t v18 = 0;
  uint64_t v19 = &v18;
  uint64_t v20 = 0x3032000000;
  int v21 = sub_1002791E8;
  uint64_t v22 = sub_1002791F8;
  id v23 = 0;
  id v17 = &v31;
...
- (BOOL)_checkPassword:(id)a3 withPasswordHash:(id)a4 andSalt:(id)a5
{
  ...
  if (v8 | v9)
  {
    if (!v8 || v9)
    {
      if (v8 || !v9)
      {
        uint64_t v13 = [(id)v8 dataUsingEncoding:4];
        id v11 = [(MBManifestDB *)self _passwordHashWithPassword:v13 salt:v10];

        if ([(id)v9 isEqualToData:v11])
        {
          BOOL v12 = 1;
LABEL_18:
        ...
        {
          Class v15 = [(id)v9 base64EncodedStringWithOptions:0];
          id v16 = [v11 base64EncodedStringWithOptions:0];
          *(_DWORD *)buf = 138412546;
          int v21 = v15;
          __int16 v22 = 2112;
          id v23 = v16;
          _os_log_impl((void *)&_mh_execute_header, v14, OS_LOG_TYPE_INFO, "Password does not match password hash (%@ != %@)", buf, 0x16u);

          id v17 = [(id)v9 base64EncodedStringWithOptions:0];
...
LABEL_42:
  ...
  id v11 = (void *)v10;
  BOOL v12 = [(MBManifestDB *)self salt];
...
- (BOOL)containsFileID:(id)a3 error:(id *)a4
{
  ...
  id v20 = sub_1002791E8;
  int v21 = sub_1002791F8;
  id v22 = 0;
  uint64_t v13 = 0;
  uint64_t v14 = &v13;
...
- (id)fetchFileWithID:(id)a3 error:(id *)a4
{
  ...
  uint64_t v13 = &v12;
  uint64_t v14 = 0x3032000000;
  uint64_t v15 = sub_1002791E8;
  char v16 = sub_1002791F8;
  id v17 = 0;
  v7[0] = _NSConcreteStackBlock;
  v7[1] = 3221225472;
  v7[2] = sub_10027CC04;
...
- (BOOL)hasUnverifiedFilesWithError:(id *)a3
{
  ...
  char v16 = sub_1002791E8;
  id v17 = sub_1002791F8;
  id v18 = 0;
  uint64_t v9 = 0;
  id v10 = &v9;
...
- (id)enumerateFiles:(id)a3 includeUninstalled:(BOOL)a4
{
  ...
  id v28 = sub_1002791E8;
  id v29 = sub_1002791F8;
  id v30 = 0;
  [(MBManifestDB *)self flush];
  id v6 = objc_msgSend(objc_alloc((Class)NSString), "initWithFormat:", @"ManifestDB-%lu-enumerator", -[MBManifestDB hash](self, "hash"));
  ...
  if (v10)
  {
    ...
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_10027D9A0;
    block[3] = &unk_100417AC0;
    id v12 = v7;
    id v20 = v12;
    int v21 = self;
    uint64_t v23 = &v25;
...
- (id)fetchPropertyWithName:(id)a3 class:(Class)a4 error:(id *)a5
{
  ...
  id v29 = sub_1002791E8;
  id v30 = sub_1002791F8;
  id v31 = 0;
  uint64_t v20 = 0;
  int v21 = &v20;
  uint64_t v22 = 0x3032000000;
  uint64_t v23 = sub_1002791E8;
  uint64_t v24 = sub_1002791F8;
  id v25 = 0;
  uint64_t v9 = [(MBManifestDB *)self pql_database];
  unsigned __int8 v10 = [v9 serialQueue];
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_10027E238;
  block[3] = &unk_100417AE8;
  void block[4] = self;
  id v11 = v8;
  id v16 = v11;
  id v17 = &v20;
