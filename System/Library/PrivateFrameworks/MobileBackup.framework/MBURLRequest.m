...
- (id)NSURLRequest
{
  ...
  if (MBIsInternalInstall()
    && [(NSURL *)self->_URL user]
    && [(NSURL *)self->_URL password])
  {
  ...
  uint64_t v5 = MBProductVersion();
  uint64_t v6 = MBBuildVersion();
  v7 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"%@/%@ (%@; %@)",
         @"MobileBackup",
         v5,
         v6,
         MBProductType());
  ...
  id v8 = [objc_alloc((Class)AKAppleIDSession) initWithIdentifier:@"com.apple.MobileBackup"];
  id v9 = [v8 appleIDHeadersForRequest:v3];
  long long v17 = 0u;
  long long v18 = 0u;
  long long v19 = 0u;
  long long v20 = 0u;
