...
{
  v7.receiver = self;
  v7.super_class = (Class)BackupClientConfigurationSetting;
  v3 = [(BackupClientConfigurationSetting *)&v7 description];
  v4 = [(BackupClientConfigurationSetting *)self dictionaryRepresentation];
...
- (BOOL)readFrom:(id)a3
{
  return BackupClientConfigurationSettingReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[1])
  {
    -[BackupClientConfigurationSetting setKey:](self, "setKey:");
    id v4 = v5;
  }
  if (v4[2])
  {
    -[BackupClientConfigurationSetting setValue:](self, "setValue:");
    id v4 = v5;
  }
}
