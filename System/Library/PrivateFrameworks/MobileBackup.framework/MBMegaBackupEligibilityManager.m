...
- (id)_queue
{
  if (qword_1004827B0 != -1) {
    dispatch_once(&qword_1004827B0, &stru_100417478);
  }
  v2 = (void *)qword_1004827A8;
  return v2;
}
...
- (int64_t)_entryMethodForEntryPoint:(int64_t)a3
{
  ...
  [v5 handleFailureInMethod:a2 object:self file:@"MBMegaBackupEligibilityManager.m" lineNumber:49 description:@"Should not be here."];
