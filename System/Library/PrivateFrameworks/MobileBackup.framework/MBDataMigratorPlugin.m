...
- (id)_setDMContextWithPolicy:(id)a3 engine:(id)a4
{
  ...
  {
    if (v16) {
      __assert_rtn("-[MBDataMigratorPlugin _setDMContextWithPolicy:engine:]", "MBDataMigratorPlugin.m", 121, "!restoredFromCloudBackup");
    }
    if (v18) {
      __assert_rtn("-[MBDataMigratorPlugin _setDMContextWithPolicy:engine:]", "MBDataMigratorPlugin.m", 122, "!restoredFromiTunesBackup");
    }
  ...
  {
    if ((v16 & v18) == 1) {
      __assert_rtn("-[MBDataMigratorPlugin _setDMContextWithPolicy:engine:]", "MBDataMigratorPlugin.m", 130, "!restoredFromCloudBackup || !restoredFromiTunesBackup");
    }
    id v20 = v14;
    if (v16)
    {
...
LABEL_38:
        ...
        __assert_rtn("-[MBDataMigratorPlugin _setDMContextWithPolicy:engine:]", "MBDataMigratorPlugin.m", 139, "backupType");
    }
  ...
  if (!v19) {
    __assert_rtn("-[MBDataMigratorPlugin _setDMContextWithPolicy:engine:]", "MBDataMigratorPlugin.m", 142, "reason");
  }
  v38 = (void *)v13;
  v49[0] = @"Reason";
...
- (id)_updateMobileBackupPreferencesWithEngine:(id)a3
{
  ...
  if (!v6) {
    __assert_rtn("-[MBDataMigratorPlugin _updateMobileBackupPreferencesWithEngine:]", "MBDataMigratorPlugin.m", 198, "persona");
  }
  id v7 = (void *)v6;
  v67 = self;
  v70 = (void *)v6;
...
LABEL_17:
  ...
  if (v25)
  {
    ...
    do
    {
      for (i = 0; i != v26; i = (char *)i + 1)
      {
        ...
        unsigned int v30 = objc_msgSend(v20, "containsObject:", v29, v65);
        v31 = MBGetDefaultLog();
    ...
    if ([v71 conformsToProtocol:&OBJC_PROTOCOL___MBHasServiceAccount])
    {
      ...
      if (v34)
      {
        ...
        if (objc_msgSend(v69, "fileExistsAtPath:", v37, v65))
        {
          ...
          id v75 = 0;
          unsigned __int8 v53 = objc_msgSend(v69, "removeItemAtPath:error:", v45, &v75, v66);
          id v54 = v75;
          if ((v53 & 1) == 0)
          {
            v55 = MBGetDefaultLog();
  ...
  objc_msgSend(v56, "setWasCloudRestore:", objc_msgSend(v71, "isServiceEngine"));
  v58 = [v71 properties];
...
+ (BOOL)setUpMobileBackupPreferencesForBackgroundRestoreWithAccount:(id)a3 restoreSession:(id)a4 cloudFormatInfo:(id)a5 performanceStatistics:(id)a6 backupPolicy:(int64_t)a7 error:(id *)a8
{
  ...
  id v16 = a6;
  if (!v13) {
    __assert_rtn("+[MBDataMigratorPlugin setUpMobileBackupPreferencesForBackgroundRestoreWithAccount:restoreSession:cloudFormatInfo:performanceStatistics:backupPolicy:error:]", "MBDataMigratorPlugin.m", 345, "account");
  }
  uint64_t v17 = v16;
  id v18 = [v13 persona];
  if ([v18 isEnterprisePersona])
  {
    [v18 setPreferencesValue:v15 forKey:@"RestoreCloudFormatInfo"];
    uint64_t v19 = [v14 propertyList];
    [v18 setPreferencesValue:v19 forKey:@"RestoreSession"];

    id v20 = MBGetDefaultLog();
    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
    {
      *(_WORD *)buf = 0;
      _os_log_impl((void *)&_mh_execute_header, v20, OS_LOG_TYPE_DEFAULT, "Modified MobileBackup preferences at in-place for EDS Background Restore", buf, 2u);
      _MBLog();
    }
    LOBYTE(v21) = 1;
  }
  else
  {
    id v41 = a8;
    v44 = v14;
    id v20 = [v18 userIncompleteRestoreDirectory];
    v42 = [v20 stringByAppendingPathComponent:@"/var/mobile/Library/Preferences/com.apple.MobileBackup.plist"];
    unsigned __int8 v22 = objc_opt_new();
    [v22 setObject:v17 forKeyedSubscript:@"ForegroundRestorePerformance"];
    char v45 = 0;
    id v23 = [v18 getBooleanValueForKey:@"UseInheritBackupEndpoint" keyExists:&v45];
    if (v45)
    {
      gid_t v24 = +[NSNumber numberWithUnsignedChar:v23];
      [v22 setObject:v24 forKeyedSubscript:@"UseInheritBackupEndpoint"];
    }
    unsigned __int8 v43 = v17;
    char v45 = 0;
    unsigned int v25 = [v18 getBooleanValueForKey:@"BackgroundRestoreTimeoutTTRInterval" keyExists:&v45];
    if (v45)
    {
      id v26 = +[NSNumber numberWithInteger:v25];
      [v22 setObject:v26 forKeyedSubscript:@"BackgroundRestoreTimeoutTTRInterval"];
    }
    id v27 = [v18 copyPreferencesValueForKey:@"ForegroundRestoreCellularAccess" class:objc_opt_class()];
    if (v27) {
      [v22 setObject:v27 forKeyedSubscript:@"ForegroundRestoreCellularAccess"];
    }
    id v28 = [v18 copyPreferencesValueForKey:@"BackgroundRestoreCellularAccess" class:objc_opt_class()];
    ...
    if (a7 == 1)
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl((void *)&_mh_execute_header, v29, OS_LOG_TYPE_DEFAULT, "Set restored device in mega backup mode.", buf, 2u);
        _MBLog();
      }

      [v22 setObject:&__kCFBooleanTrue forKeyedSubscript:@"IsMegaBackupMode"];
      id v30 = [v18 copyPreferencesValueForKey:@"MegaBackupFlowStartDate" class:objc_opt_class()];
      id v31 = [v18 copyPreferencesValueForKey:@"RestoreFinishedAfterMegaBackupDateDelta" class:objc_opt_class()];
      long long v32 = v31;
      if (v30 && !v31)
      {
        long long v33 = +[NSDate now];
        [v33 timeIntervalSinceDate:v30];
        v35 = +[NSNumber numberWithInt:(int)v34];
        [v18 setPreferencesValue:v35 forKey:@"RestoreFinishedAfterMegaBackupDateDelta"];
      }
      __int16 v36 = +[MBCKManager sharedInstance];
      [v36 submitMegaLifeCycleTelemetriesWithAccount:v13];
    }
    [v22 setObject:v15 forKeyedSubscript:@"RestoreCloudFormatInfo"];
    id v14 = v44;
    v37 = [v44 propertyList];
    [v22 setObject:v37 forKeyedSubscript:@"RestoreSession"];

    __int16 v38 = +[NSFileManager defaultManager];
    unsigned int v21 = objc_msgSend(v38, "mb_savePlistAtPath:addingItems:removing:error:", v42, v22, &off_10043B400, v41);
    ...
    if (v21)
    {
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        v47 = v42;
        _os_log_impl((void *)&_mh_execute_header, v39, OS_LOG_TYPE_DEFAULT, "Modified restored MobileBackup preferences at %@ for Background Restore", buf, 0xCu);
        _MBLog();
      }
