...
+ (void)_persistDisabledDomainNames:(id)a3 forPersona:(id)a4
{
  id v9 = a3;
  id v5 = a4;
  uint64_t v6 = sub_1001ACFF4();
  dispatch_assert_queue_V2(v6);

  if (!v9) {
    __assert_rtn("+[MBAppManager _persistDisabledDomainNames:forPersona:]", "MBAppManager.m", 114, "names");
  }
  id v7 = [v9 allObjects];
...
- (id)allDisabledDomainNamesForPersona:(id)a3
{
  ...
  v15 = sub_1001AD39C;
  id v16 = sub_1001AD3AC;
  id v17 = 0;
  id v5 = sub_1001ACFF4();
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_1001AD3B4;
...
- (void)_syncDisabledDomainsWithAllInstalledAppDomains:(id)a3 persona:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  uint64_t v8 = sub_1001ACFF4();
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_1001AD4D8;
...
+ (id)_volumesToBackUpForPersona:(id)a3
{
  ...
  id v4 = [v3 allObjects];
  uint64_t v5 = [v4 sortedArrayUsingComparator:&stru_100415840];
  ...
  if (v86)
  {
    ...
    do
    {
      for (i = 0; i != v86; i = (char *)i + 1)
      {
        ...
        long long v107 = 0u;
        long long v108 = 0u;
        long long v21 = objc_msgSend(v20, "containers", v63, v64, v65);
        ...
        if (v22)
        {
          ...
          do
          {
            for (j = 0; j != v22; j = (char *)j + 1)
            {
              ...
              v30 = MBStringForContainerType(v27);
              v31 = MBGetDefaultLog();
              ...
              if (v41)
              {
                ...
                do
                {
                  for (k = 0; k != v41; k = (char *)k + 1)
                  {
                    ...
                    v45 = objc_msgSend(v44, "identifier", v63, v64, v65);
...
- (id)_copyAppsWithPlists:(id)a3 volumeMountPoints:(id)a4 safeHarbor:(BOOL)a5 error:(id *)a6
{
  id v7 = a3;
  id v32 = a4;
  id v29 = objc_msgSend(objc_alloc((Class)NSMutableArray), "initWithCapacity:", objc_msgSend(v7, "count"));
  long long v33 = 0u;
  long long v34 = 0u;
  long long v35 = 0u;
  long long v36 = 0u;
  ...
  if (v8)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        id v14 = sub_1001AF0B4(v12, v32);
        if (v14)
        {
          id v15 = [(MBContainer *)[MBApp alloc] initWithPropertyList:v12 volumeMountPoint:v14];
          if (!v15) {
            __assert_rtn("-[MBAppManager _copyAppsWithPlists:volumeMountPoints:safeHarbor:error:]", "MBAppManager.m", 396, "app");
          }
          id v16 = v15;
          ...
          {
LABEL_11:
            long long v20 = objc_msgSend(v16, "containerDir", v25, v26, v27, v28);
...
- (id)_copySystemPluginsWithPlists:(id)a3 volumeMountPoints:(id)a4 error:(id *)a5
{
  ...
  if (v10)
  {
    ...
    p_cache = &OBJC_METACLASS___MBSFileReference.cache;
    while (2)
    {
      id v14 = 0;
      id v30 = v11;
      do
      {
        ...
        uint64_t v16 = sub_1001AF0B4(v15, v7);
        if (v16)
        {
          id v17 = (void *)v16;
          uint64_t v18 = [objc_alloc((Class)(p_cache + 113)) initWithPropertyList:v15 volumeMountPoint:v16];
          if (!v18)
          {
  ...
  if (v10)
  {
    ...
    while (2)
    {
      for (i = 0; i != v11; i = (char *)i + 1)
      {
        ...
        uint64_t v15 = sub_1001AF0B4(v14, v7);
        if (v15)
        {
...
- (id)allApps
{
  ...
  id v3 = +[NSPredicate predicateWithBlock:&stru_100415880];
...
{
  v2 = [(NSMutableDictionary *)self->_containersByID allValues];
  id v3 = +[NSPredicate predicateWithBlock:&stru_1004158A0];
  id v4 = [v2 filteredArrayUsingPredicate:v3];
...
- (id)fetchAppWithIdentifier:(id)a3 persona:(id)a4 error:(id *)a5
{
  ...
  if (v11)
  {
    ...
    if (v13)
    {
      ...
      uint64_t v15 = sub_1001AF0B4(v11, v14);
      if (v15)
      {
        ...
        if (v18)
        {
          ...
          do
          {
            for (i = 0; i != v19; i = (char *)i + 1)
            {
              ...
              long long v27 = MBStringForContainerType(v24);
...
- (void)removeStaleStateForUninstalledAppsForPersona:(id)a3
{
  ...
  id v71 = 0;
  v52 = v51 = v4;
  uint64_t v5 = [v4 contentsOfDirectoryAtPath:v52 error:&v71];
  id v53 = v71;
  id v44 = (void *)v5;
  if (v5)
  {
  ...
  if (v18)
  {
    ...
    do
    {
      for (j = 0; j != v19; j = (char *)j + 1)
      {
        ...
        long long v23 = objc_msgSend(v22, "domain", v42);
        int v24 = [v23 name];
  ...
  if (v33)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        long long v38 = objc_msgSend(v52, "stringByAppendingPathComponent:", *(void *)(*((void *)&v55 + 1) + 8 * (void)v36), v42, v43);
...
- (id)createSafeHarborForContainer:(id)a3 withPersona:(id)a4 usingIntermediateRestoreDir:(BOOL)a5 error:(id *)a6
{
  id v9 = a3;
  id v10 = a4;
  if (qword_100482620 != -1) {
    dispatch_once(&qword_100482620, &stru_1004158C0);
  }
  ...
  id v71 = sub_1001AD39C;
  id v72 = sub_1001AD3AC;
  id v73 = 0;
  uint64_t v62 = 0;
  long long v63 = &v62;
  uint64_t v64 = 0x3032000000;
  long long v65 = sub_1001AD39C;
  long long v66 = sub_1001AD3AC;
  id v67 = 0;
  uint64_t v58 = 0;
  long long v59 = &v58;
  ...
  long long v55 = sub_1001AD39C;
  long long v56 = sub_1001AD3AC;
  id v57 = 0;
  id v13 = qword_100482618;
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_1001B1848;
  block[3] = &unk_1004158E8;
  id v14 = v10;
  id v42 = v14;
  id v43 = self;
  BOOL v51 = a5;
    ...
    if (v13)
    {
      ...
      if (v17)
      {
        ...
        if (v65)
        {
          ...
          {
            BOOL v12 = 1;
            id v71 = [(id)objc_opt_class() defaultSubdirectoriesForMBContainerType:1 withNestedSubdirectories:0];
            long long v72 = 0u;
            long long v73 = 0u;
            long long v74 = 0u;
            long long v75 = 0u;
            ...
            if (v25)
            {
              ...
              while (2)
              {
                for (i = 0; i != v26; i = (char *)i + 1)
                {
                  ...
                  uid_t v31 = objc_msgSend(v30, "pathComponents", v56);
