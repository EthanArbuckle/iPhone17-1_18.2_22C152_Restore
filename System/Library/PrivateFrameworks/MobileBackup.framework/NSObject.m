...
- (BOOL)removeFailedAssetFromDestination:(id)a3 withError:(id *)a4
{
  ...
  if (([self conformsToProtocol:&OBJC_PROTOCOL___MBRestorable] & 1) == 0)
  {
    ...
    objc_msgSend(v19, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"MBRestorable.m", 102, @"%s is not MBRestorable", class_getName(v20));
  }
  id v8 = v7;
...
- (BOOL)restoreOwnershipToDestination:(id)a3 withUserID:(unsigned int)a4 withGroupID:(unsigned int)a5 withError:(id *)a6
{
  ...
  if (([self conformsToProtocol:&OBJC_PROTOCOL___MBRestorable] & 1) == 0)
  {
    ...
    objc_msgSend(v17, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"MBRestorable.m", 136, @"%s is not MBRestorable", class_getName(v18));
  }
...
- (BOOL)restoreAttributesToDestination:(id)a3 error:(id *)a4
{
  ...
  if (([self conformsToProtocol:&OBJC_PROTOCOL___MBRestorable] & 1) == 0)
  {
    ...
    objc_msgSend(v26, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"MBRestorable.m", 149, @"%s is not MBRestorable", class_getName(v27));
  }
  id v8 = self;
  uint64_t v31 = 0;
  ...
  if (!v9)
  {
    ...
    [v28 handleFailureInMethod:a2 object:v8 file:@"MBRestorable.m" lineNumber:155 description:@"Null domain"];
  }
  if ([v9 adjustNodeOwnershipAndPermissionsForDataMigratorPlugIn:v30 path:v7])
  {
    v10 = MBGetDefaultLog();
  ...
  uint64_t v11 = DWORD1(v30[0]);
  uint64_t v12 = DWORD2(v30[0]);
  __int16 v13 = WORD2(v31);
  int v14 = HIDWORD(v30[0]);
  if ((WORD2(v31) & 0xF000) == 0xA000) {
    int v15 = 0;
  }
  else {
    int v15 = BYTE12(v30[0]) & 0x80;
  }
  id v16 = (void *)(v15 | WORD6(v30[0]) & 0x8040u);
  if (v16)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)v33 = v16;
      _os_log_impl((void *)&_mh_execute_header, v17, OS_LOG_TYPE_INFO, "Restoring BSD flags: 0x%x", buf, 8u);
      id v29 = v16;
      _MBLog();
    }

    id v18 = v7;
    if (lchflags((const char *)[v18 fileSystemRepresentation], (__uint32_t)v16))
    {
      int v19 = *__error();
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        *(void *)&v33[6] = v18;
        __int16 v34 = 1024;
        int v35 = v19;
        _os_log_impl((void *)&_mh_execute_header, v20, OS_LOG_TYPE_ERROR, "Failed to restore BSD flags (0x%x) at %@: %{errno}d", buf, 0x18u);
        _MBLog();
      }

      if (a4)
      {
        +[MBError posixErrorWithCode:102 path:v18 format:@"lchflags error"];
  ...
  uint64_t v22 = v13 & 0xFFF;
  if ((v14 & 0x40000000) != 0)
  {
    id v23 = [v8 extendedAttributes];
    __int16 v24 = [v23 objectForKeyedSubscript:@"com.apple.decmpfs"];

    sub_10010D50C(v7, v24, 0);
  }
  unsigned __int8 v21 = -[NSObject restoreAttributesToDestination:withUserID:groupID:permissions:error:](v8, "restoreAttributesToDestination:withUserID:groupID:permissions:error:", v7, v11, v12, v22, a4, v29);
LABEL_24:
...
- (BOOL)restoreAttributesToDestination:(id)a3 withUserID:(unsigned int)a4 groupID:(unsigned int)a5 permissions:(unsigned __int16)a6 error:(id *)a7
{
  ...
  if (([self conformsToProtocol:&OBJC_PROTOCOL___MBRestorable] & 1) == 0)
  {
    unsigned __int8 v21 = +[NSAssertionHandler currentHandler];
    uint64_t v22 = (objc_class *)objc_opt_class();
    objc_msgSend(v21, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"MBRestorable.m", 197, @"%s is not MBRestorable", class_getName(v22));
  }
  uint64_t v33 = 0;
  long long v31 = 0u;
  long long v32 = 0u;
...
- (id)moveFileFromSource:(id)a3 destination:(id)a4 destinationSize:(unint64_t)a5 conflictResolution:(int64_t)a6 error:(id *)a7
{
  ...
  if (([self conformsToProtocol:&OBJC_PROTOCOL___MBRestorable] & 1) == 0)
  {
    ...
    objc_msgSend(v45, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"MBRestorable.m", 234, @"%s is not MBRestorable", class_getName(v46));
  }
  time_t v15 = self;
...
- (BOOL)restoreProtectionClassToDestination:(id)a3 unspecifiedDirectoryProtectionClass:(unsigned __int8)a4 logger:(id)a5 error:(id *)a6
{
  ...
  if (([self conformsToProtocol:&OBJC_PROTOCOL___MBRestorable] & 1) == 0)
  {
    CFStringRef v32 = +[NSAssertionHandler currentHandler];
    unsigned __int8 v33 = (objc_class *)objc_opt_class();
    objc_msgSend(v32, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"MBRestorable.m", 308, @"%s is not MBRestorable", class_getName(v33));
  }
  id v13 = self;
  uint64_t v40 = 0;
  memset(v39, 0, sizeof(v39));
  [v13 getNode:v39];
  int v14 = WORD2(v40) & 0xF000;
  uint64_t v15 = BYTE6(v40);
  if (v14 == 0x4000 && BYTE6(v40) == 255)
  {
    id v16 = MBGetDefaultLog();
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)stat buf = 138412546;
      *(void *)__int16 v42 = v13;
      *(_WORD *)&v42[8] = 1024;
      *(_DWORD *)&v42[10] = v8;
      _os_log_impl((void *)&_mh_execute_header, v16, OS_LOG_TYPE_INFO, "Unspecified data class for %@ -> defaulting to %d", buf, 0x12u);
      id v34 = v13;
      unint64_t v35 = v8;
      _MBLog();
    }
  ...
  else
  {
    ...
    if (v14 != 0x4000 && v14 != 0x8000)
    {
      ...
      {
        *(_DWORD *)stat buf = 138412290;
        *(void *)__int16 v42 = v11;
        _os_log_impl((void *)&_mh_execute_header, v20, OS_LOG_TYPE_DEBUG, "Not restoring protection class for symlink at %@", buf, 0xCu);
        _MBLog();
      }
      goto LABEL_34;
    }
  ...
  if ((v8 & 0xFFFFFFFB) != 0)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&v42[4] = 2112;
      *(void *)&v42[6] = v11;
      _os_log_impl((void *)&_mh_execute_header, v17, OS_LOG_TYPE_INFO, "Restoring protection class %d at %@", buf, 0x12u);
      id v34 = v8;
  ...
  if (v8) {
    ...
    uint64_t v18 = 4 * (v14 == 0x8000);
  }
  id v38 = 0;
  unsigned int v19 = +[MBProtectionClassUtils setWithPath:value:error:](MBProtectionClassUtils, "setWithPath:value:error:", v11, v18, &v38, v34, v35);
  id v20 = v38;
  if (!v19)
  {
    if ((+[MBError isError:v20 withCode:208] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_WORD *)&v42[14] = 2112;
        *(void *)&v42[16] = v20;
        _os_log_impl((void *)&_mh_execute_header, v21, OS_LOG_TYPE_FAULT, "Failed to set protection class %d at %@: %@", buf, 0x1Cu);
        goto LABEL_30;
      }
LABEL_31:
    ...
    if (+[MBProtectionClassUtils canOpenWhenLocked:v18])
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_FAULT))
      {
        *(_DWORD *)stat buf = 67109120;
        *(_DWORD *)__int16 v42 = v18;
        _os_log_impl((void *)&_mh_execute_header, v21, OS_LOG_TYPE_FAULT, "Unexpected device lock error for pc:%d", buf, 8u);
LABEL_30:
        _MBLog();
        goto LABEL_31;
      }
    ...
    id v37 = 0;
    uint64_t v24 = +[MBProtectionClassUtils getWithPath:v11 error:&v37];
    id v25 = v37;
    id v26 = v25;
    if (v24 == 255)
    {
      ...
      if (MBIsInternalInstall())
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_FAULT))
        {
          ...
          *(_WORD *)&v42[8] = 2112;
          *(void *)&v42[10] = v26;
          _os_log_impl((void *)&_mh_execute_header, v30, OS_LOG_TYPE_FAULT, "Failed to fetch the protection class for %@: %@", buf, 0x16u);
          _MBLog();
        }
      }
    }
    else if (+[MBProtectionClassUtils canOpenWhenLocked:v24])
    {
      uint64_t v27 = MBGetDefaultLog();
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        *(_DWORD *)stat buf = 67109634;
        *(_DWORD *)__int16 v42 = 2;
        *(_WORD *)&v42[4] = 1024;
        *(_DWORD *)&v42[6] = v18;
        *(_WORD *)&v42[10] = 2112;
        *(void *)&v42[12] = v11;
        _os_log_impl((void *)&_mh_execute_header, v27, OS_LOG_TYPE_INFO, "Restoring protection class %d instead of %d for: %@", buf, 0x18u);
        _MBLog();
      }

      id v36 = v26;
      unsigned __int8 v28 = +[MBProtectionClassUtils setWithPath:v11 value:2 error:&v36];
      id v29 = v36;
      ...
      else
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_WORD *)&v42[20] = 2112;
          *(void *)&v42[22] = v29;
          _os_log_impl((void *)&_mh_execute_header, v31, OS_LOG_TYPE_ERROR, "Failed to restore protection class %d instead of %d at %@: %@", buf, 0x22u);
          _MBLog();
        }
...
LABEL_55:
  ...
  [v12 logSetClassForRestorable:v13 state:5 absolutePath:v11 value:v18];
LABEL_34:
  BOOL v22 = 1;
LABEL_35:
...
- (id)restoreLastModifiedWithFD:(int)a3
{
  if (([self conformsToProtocol:&OBJC_PROTOCOL___MBRestorable] & 1) == 0)
  {
    ...
    objc_msgSend(v12, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"MBRestorable.m", 381, @"%s is not MBRestorable", class_getName(v13));
  }
  v6 = self;
  uint64_t v19 = 0;
  long long v17 = 0u;
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(void *)BOOL v22 = v6;
    ...
    int v14 = +[NSDate dateWithTimeIntervalSince1970:(double)*((uint64_t *)&v16 + 1)];
    _MBLog();
  }
...
- (id)_setProtectionClassWithPathFSR:(const char *)a3
{
  if (([self conformsToProtocol:&OBJC_PROTOCOL___MBRestorable] & 1) == 0)
  {
    ...
    objc_msgSend(v13, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"MBRestorable.m", 398, @"%s is not MBRestorable", class_getName(v14));
  }
  uint64_t v17 = 0;
...
- (id)_setProtectionClassWithFD:(int)a3
{
  ...
  if (([self conformsToProtocol:&OBJC_PROTOCOL___MBRestorable] & 1) == 0)
  {
    id v12 = +[NSAssertionHandler currentHandler];
    id v13 = (objc_class *)objc_opt_class();
    objc_msgSend(v12, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"MBRestorable.m", 420, @"%s is not MBRestorable", class_getName(v13));
  }
  uint64_t v16 = 0;
...
- (id)restoreSymbolicLinkAtPath:(id)a3 withTarget:(id)a4 settingOwnershipAndFlags:(BOOL)a5
{
  ...
  if (([self conformsToProtocol:&OBJC_PROTOCOL___MBRestorable] & 1) == 0)
  {
    BOOL v22 = +[NSAssertionHandler currentHandler];
    int v23 = (objc_class *)objc_opt_class();
    objc_msgSend(v22, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"MBRestorable.m", 442, @"%s is not MBRestorable", class_getName(v23));
  }
  id v11 = self;
  uint64_t v46 = 0;
  long long v44 = 0u;
...
LABEL_7:
  ...
  long long v30 = v16;
  id v31 = 0;
  unsigned __int8 v17 = objc_msgSend(v15, "mb_openatWithFlags:error:setupDir:itemAccessor:", 0x200000, &v41, v38, v28);
  id v18 = v41;
  int v19 = v18;
  id v20 = 0;
  if ((v17 & 1) == 0) {
...
- (id)restoreDirectoryAtPath:(id)a3 settingDataProtection:(BOOL)a4 settingOwnershipAndFlags:(BOOL)a5
{
  ...
  if (([self conformsToProtocol:&OBJC_PROTOCOL___MBRestorable] & 1) == 0)
  {
    ...
    objc_msgSend(v20, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"MBRestorable.m", 530, @"%s is not MBRestorable", class_getName(v21));
  }
  id v10 = self;
  if (!v9)
  {
  ...
  unsigned __int8 v15 = objc_msgSend(v13, "mb_openatWithFlags:error:setupDir:itemAccessor:", 256, &v43, v36, v25);
  id v16 = v43;
...
- (id)restoreEmptyRegularFileAtPath:(id)a3 settingAttributes:(BOOL)a4
{
  ...
  if (([self conformsToProtocol:&OBJC_PROTOCOL___MBRestorable] & 1) == 0)
  {
    ...
    objc_msgSend(v14, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"MBRestorable.m", 650, @"%s is not MBRestorable", class_getName(v15));
  }
  id v8 = self;
  if (!v7)
  {
...
- (id)restoreRegularFileAtPath:(id)a3 settingAttributes:(BOOL)a4
{
  ...
  if (([self conformsToProtocol:&OBJC_PROTOCOL___MBRestorable] & 1) == 0)
  {
    ...
    objc_msgSend(v39, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"MBRestorable.m", 677, @"%s is not MBRestorable", class_getName(v40));
  }
  id v8 = self;
  if (!v7)
  {
    long long v41 = +[NSAssertionHandler currentHandler];
    [v41 handleFailureInMethod:a2 object:v8 file:@"MBRestorable.m" lineNumber:678 description:@"Null path"];
  }
  uint64_t v56 = 0;
  long long v54 = 0u;
  long long v55 = 0u;
  ...
  long long v53 = 0u;
  [v8 getNode:&v52];
  if ((WORD2(v56) & 0xF000) != 0x8000)
  {
    uint64_t v42 = +[NSAssertionHandler currentHandler];
    [v42 handleFailureInMethod:a2 object:v8 file:@"MBRestorable.m" lineNumber:682 description:@"Not a regular file"];
  }
  id v9 = v7;
  ...
  if (v4)
  {
    ...
    if (!v11)
    {
      ...
      [v43 handleFailureInMethod:a2 object:v8 file:@"MBRestorable.m" lineNumber:688 description:@"Null domain"];
    }
    if ([v11 adjustNodeOwnershipAndPermissionsForDataMigratorPlugIn:&v52 path:v9])
    {
      id v12 = MBGetDefaultLog();
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
      {
    ...
    id v13 = (void *)DWORD1(v52);
    uint64_t v14 = DWORD2(v52);
  ...
  id v51 = 0;
  unsigned __int8 v23 = +[MBExtendedAttributes setAttributes:forPathFSR:error:](MBExtendedAttributes, "setAttributes:forPathFSR:error:", v17, v10, &v51, v45, v47);
  id v11 = v51;
  if (v23)
  {
LABEL_30:
    ...
    {
      int v24 = HIDWORD(v52);
      if ((WORD2(v56) & 0xF000) == 0xA000) {
        int v25 = 0;
      }
      else {
        int v25 = BYTE12(v52) & 0x80;
      }
      id v26 = (void *)(v25 | WORD6(v52) & 0x8040u);
      if (v26)
      {
        uint64_t v27 = MBGetDefaultLog();
        if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
        {
          ...
          *(_WORD *)&buf[8] = 2112;
          *(void *)&buf[10] = v9;
          _os_log_impl((void *)&_mh_execute_header, v27, OS_LOG_TYPE_INFO, "Restoring regular file BSD flags: 0x%x at %@", buf, 0x12u);
          id v45 = v26;
          id v47 = v9;
          _MBLog();
        }

        if (lchflags(v10, (__uint32_t)v26))
        {
          ...
          if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_WORD *)&buf[18] = 1024;
            *(_DWORD *)&buf[20] = v28;
            _os_log_impl((void *)&_mh_execute_header, v29, OS_LOG_TYPE_ERROR, "Failed to restore regular file BSD flags (0x%x) at %@: %{errno}d", buf, 0x18u);
            id v47 = v9;
            uint64_t v49 = v28;
            id v45 = v26;
            _MBLog();
          ...
          CFStringRef v30 = @"lchflags error";
          goto LABEL_54;
        }
        int v24 = HIDWORD(v52);
      }
      ...
      {
        id v50 = v11;
        BOOL v32 = sub_10010D50C(v9, v20, &v50);
        id v33 = v50;
...
LABEL_57:
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&buf[8] = 2112;
        *(void *)&buf[10] = v9;
        _os_log_impl((void *)&_mh_execute_header, v35, OS_LOG_TYPE_INFO, "Restoring regular file permissions: 0%3o at %@", buf, 0x12u);
        id v45 = v34;
        id v47 = v9;
        _MBLog();
      }

      if (lchmod(v10, (mode_t)v34))
      {
        CFStringRef v30 = @"lchmod error";
LABEL_54:
        +[MBError posixErrorWithCode:path:format:](MBError, "posixErrorWithCode:path:format:", 102, v9, v30, v45, v47, v49);
      ...
      {
        id v37 = +[NSDate dateWithTimeIntervalSince1970:(double)*((uint64_t *)&v53 + 1)];
        *(_DWORD *)stat buf = 138412546;
        *(void *)&uint8_t buf[4] = v37;
        *(_WORD *)&unsigned char buf[12] = 2112;
        *(void *)&buf[14] = v9;
        _os_log_impl((void *)&_mh_execute_header, v36, OS_LOG_TYPE_INFO, "Restoring last modified time (%@) at %@", buf, 0x16u);

        id v45 = +[NSDate dateWithTimeIntervalSince1970:(double)*((uint64_t *)&v53 + 1)];
        id v47 = v9;
        _MBLog();
      }
      *(void *)stat buf = time(0);
      *(_DWORD *)&buf[8] = 0;
      *(void *)&buf[16] = *((void *)&v53 + 1);
      int v58 = 0;
      if (lutimes(v10, (const timeval *)buf))
      {
        CFStringRef v30 = @"lutimes error";
        goto LABEL_54;
      }
    }
    id v16 = -[NSObject _setProtectionClassWithPathFSR:](v8, "_setProtectionClassWithPathFSR:", v10, v45, v47);
  ...
  id v31 = +[MBError errorWithCode:102 error:v11 format:@"setxattr error"];
LABEL_58:
  id v16 = v31;
LABEL_59:
