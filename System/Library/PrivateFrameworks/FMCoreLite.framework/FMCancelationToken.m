...
@implementation FMCancelationToken

+ (id)tokenWithCancelationBlock:(id)a3
{
  id v3 = a3;
  v4 = objc_alloc_init(FMCancelationToken);
  [(FMCancelationToken *)v4 addCancelationBlock:v3];
...
+ (id)tokenWrappingCancelable:(id)a3
{
  ...
  v8[1] = 3221225472;
  v8[2] = __46__FMCancelationToken_tokenWrappingCancelable___block_invoke;
  v8[3] = &unk_1E60193F0;
  id v9 = v4;
  id v5 = v4;
...
uint64_t __46__FMCancelationToken_tokenWrappingCancelable___block_invoke(uint64_t a1)
{
...
{
  v7.receiver = self;
  v7.super_class = (Class)FMCancelationToken;
  v2 = [(FMCancelationToken *)&v7 init];
  if (v2)
  {
...
- (void)cancel
{
  v2 = self;
  objc_sync_enter(v2);
  id v3 = [(FMCancelationToken *)v2 nts_cancel];
  objc_sync_exit(v2);

  [(FMCancelationToken *)v2 callCancelationBlocks:v3];
}
...
- (void)addCancelable:(id)a3
{
  ...
  v6[1] = 3221225472;
  v6[2] = __36__FMCancelationToken_addCancelable___block_invoke;
  v6[3] = &unk_1E60193F0;
  id v7 = v4;
  id v5 = v4;
  [(FMCancelationToken *)self addCancelationBlock:v6];
}

uint64_t __36__FMCancelationToken_addCancelable___block_invoke(uint64_t a1)
{
  return [*(id *)(a1 + 32) cancel];
}
