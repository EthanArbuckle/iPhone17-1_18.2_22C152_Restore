...
- (void)performObserverBlock
{
  ...
  {
    id v3 = [(_FMObserverProxy *)self weakObserver];
...
- (void)invalidate
{
  ...
  [(_FMObserverProxy *)&v5 invalidate];
}
