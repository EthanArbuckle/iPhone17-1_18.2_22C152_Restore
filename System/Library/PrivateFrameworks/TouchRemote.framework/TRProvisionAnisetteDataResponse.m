...
- (BOOL)didSucceed;
- (TRProvisionAnisetteDataResponse)initWithCoder:(id)a3;
- (id)description;
...
- (void)encodeWithCoder:(id)a3
{
  id v4 = a3;
  v5.receiver = self;
  v5.super_class = (Class)TRProvisionAnisetteDataResponse;
...
- (TRProvisionAnisetteDataResponse)initWithCoder:(id)a3
{
  id v4 = a3;
  v7.receiver = self;
  v7.super_class = (Class)TRProvisionAnisetteDataResponse;
...
- (id)description
{
  ...
  v9.receiver = self;
  v9.super_class = (Class)TRProvisionAnisetteDataResponse;
