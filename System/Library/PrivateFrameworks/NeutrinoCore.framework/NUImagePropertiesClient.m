...
- (void)submitPropertiesRequestForComposition:(id)a3 completion:(id)a4
{
  ...
  if (!v40)
  {
    ...
    _NUAssertFailHandler((uint64_t)"-[NUImagePropertiesClient submitPropertiesRequestForComposition:completion:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Render/NUImagePropertiesRequest.m", 29, @"Invalid parameter not satisfying: %s", v27, v28, v29, v30, (uint64_t)"composition != nil");
  }
  if (!v6)
  {
    v15 = NUAssertLogger_21543();
    ...
    _NUAssertFailHandler((uint64_t)"-[NUImagePropertiesClient submitPropertiesRequestForComposition:completion:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Render/NUImagePropertiesRequest.m", 30, @"Invalid parameter not satisfying: %s", v36, v37, v38, v39, (uint64_t)"completionBlock != nil");
  }
