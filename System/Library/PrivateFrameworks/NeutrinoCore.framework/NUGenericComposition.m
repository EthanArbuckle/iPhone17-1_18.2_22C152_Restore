...
- (void)setContents:(id)a3
{
  ...
  if (!v4)
  {
    ...
    {
      v6 = objc_msgSend(NSString, "stringWithFormat:", @"Invalid parameter not satisfying: %s", "contents");
    ...
    _NUAssertFailHandler((uint64_t)"-[NUGenericComposition setContents:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Adjustments/NUComposition.m", 199, @"Invalid parameter not satisfying: %s", v17, v18, v19, v20, (uint64_t)"contents");
  }
  id v21 = v4;
