...
- (NSString)description
{
  return (NSString *)objc_msgSend(NSString, "stringWithFormat:", @"{fill %ldx%ld}", self->_size.width, self->_size.height);
}

- (NSString)debugDescription
{
  return (NSString *)[NSString stringWithFormat:@"<%@:%p> fillInSize=(%ld, %ld)", objc_opt_class(), self, self->_size.width, self->_size.height];
}
...
- ($0AC6E346AE4835514AAA8AC86D8F4844)scaleForImageSize:(id)a3
{
  ...
  if (!a3.var0 || !a3.var1)
  {
    ...
    _NUAssertFailHandler((uint64_t)"-[NUFillScalePolicy scaleForImageSize:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Render/NUScalePolicy.m", 186, @"Invalid parameter not satisfying: %s", v21, v22, v23, v24, (uint64_t)"!NUPixelSizeIsEmpty(imageSize)");
  }
  uint64_t v3 = NUScaleToFillSizeInSize(a3.var0, a3.var1, self->_size.width, self->_size.height);
  int64_t v5 = v4;
...
- (NUFillScalePolicy)initWithTargetPixelSize:(id)a3
{
  ...
  if (!a3.var0 || (int64_t var1 = a3.var1) == 0)
  {
    ...
    _NUAssertFailHandler((uint64_t)"-[NUFillScalePolicy initWithTargetPixelSize:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Render/NUScalePolicy.m", 175, @"Invalid parameter not satisfying: %s", v18, v19, v20, v21, (uint64_t)"!NUPixelSizeIsEmpty(size)");
  }
  int64_t var0 = a3.var0;
  v22.receiver = self;
  v22.super_class = (Class)NUFillScalePolicy;
  $0AC6E346AE4835514AAA8AC86D8F4844 result = [(NUFillScalePolicy *)&v22 init];
...
LABEL_15:
  ...
  _NUAssertFailHandler((uint64_t)"-[NUFillScalePolicy init]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Render/NUScalePolicy.m", 165, @"Initializer not available: -[%@ %@], use designated initializer instead.", v24, v25, v26, v27, v23);
}
