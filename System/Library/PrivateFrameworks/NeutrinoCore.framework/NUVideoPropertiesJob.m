...
- (BOOL)prepare:(id *)a3
{
  ...
  if (!a3)
  {
    ...
    _NUAssertFailHandler((uint64_t)"-[NUVideoPropertiesJob prepare:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Render/NUVideoPropertiesRequest.m", 70, @"Invalid parameter not satisfying: %s", v22, v23, v24, v25, (uint64_t)"error != NULL");
  }
  v44.receiver = self;
  ...
  if (v5)
  {
    ...
    if (!v6)
    {
      ...
      _NUAssertFailHandler((uint64_t)"-[NUVideoPropertiesJob prepare:]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Render/NUVideoPropertiesRequest.m", 76, @"Missing prepare node", v38, v39, v40, v41, v43);
    }
