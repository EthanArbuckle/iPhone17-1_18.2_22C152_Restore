...
{
  v8.receiver = self;
  v8.super_class = (Class)NURAWGeometryResetNode;
...
- (id)_evaluateImageGeometry:(id *)a3
{
  ...
  v5 = -[NUFilterNode _evaluateImageGeometry:](&v18, sel__evaluateImageGeometry_);
  if (v5)
  {
    ...
    if (v6)
    {
      objc_super v8 = [NUImageGeometry alloc];
      ...
      uint64_t v13 = objc_msgSend(v5, "renderScale", v19[0], v19[1]);
