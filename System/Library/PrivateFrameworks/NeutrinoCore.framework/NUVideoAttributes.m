...
{
  v6.receiver = self;
  v6.super_class = (Class)NUVideoAttributes;
...
- (NUVideoAttributes)init
{
  ...
  if (_NULogOnceToken != -1) {
    dispatch_once(&_NULogOnceToken, &__block_literal_global_11057);
  }
...
LABEL_15:
  ...
  _NUAssertFailHandler((uint64_t)"-[NUVideoAttributes init]", (uint64_t)"/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Geometry/NUVideoAttributes.m", 17, @"Initializer not available: -[%@ %@], use designated initializer instead.", v24, v25, v26, v27, v23);
}
