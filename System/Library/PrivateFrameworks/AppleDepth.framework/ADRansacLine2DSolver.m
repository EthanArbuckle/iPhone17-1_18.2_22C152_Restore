...
- (void).cxx_destruct
{
  value = self->_model2D.__ptr_.__value_;
  self->_model2D.__ptr_.__value_ = 0;
  if (value) {
    (*(void (**)(RansacLine2DModel *, SEL))(*(void *)value + 8))(value, a2);
  }
...
LABEL_66:
  ...
  float v46 = (*(float (**)(RansacLine2DModel *))(*(void *)self->_model2D.__ptr_.__value_ + 48))(self->_model2D.__ptr_.__value_);
  double v47 = (*(double (**)(RansacLine2DModel *))(*(void *)self->_model2D.__ptr_.__value_ + 56))(self->_model2D.__ptr_.__value_);
...
- (ADRansacLine2DSolver)initWithParameters:(id)a3
{
  id v4 = a3;
  v6.receiver = self;
  v6.super_class = (Class)ADRansacLine2DSolver;
