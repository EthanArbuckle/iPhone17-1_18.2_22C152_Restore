  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[CPLSocialGroupPersonList addPerson:](self, "addPerson:", *(void *)(*((void *)&v10 + 1) + 8 * v9++), (void)v10);
      }
      while (v7 != v9);
...
- (unint64_t)hash
{
  uint64_t v3 = [(NSMutableArray *)self->_persons hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((unint64_t)persons | *((void *)v4 + 1))
  {
    if (!-[NSMutableArray isEqual:](persons, "isEqual:")) {
      goto LABEL_8;
    }
  }
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v8 clearPersons];
    unint64_t v4 = [(CPLSocialGroupPersonList *)self personsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(CPLSocialGroupPersonList *)self personAtIndex:i];
        [v8 addPerson:v7];
      }
    }
  }
...
- (BOOL)readFrom:(id)a3
{
  return CPLSocialGroupPersonListReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(objc_alloc(MEMORY[0x1E4F1CA48]), "initWithCapacity:", -[NSMutableArray count](self->_persons, "count"));
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
    long long v16 = 0u;
  ...
  if (*(unsigned char *)&self->_has)
  {
    long long v11 = [NSNumber numberWithUnsignedInt:self->_version];
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)CPLSocialGroupPersonList;
  id v4 = [(CPLSocialGroupPersonList *)&v8 description];
  unint64_t v5 = [(CPLSocialGroupPersonList *)self dictionaryRepresentation];
