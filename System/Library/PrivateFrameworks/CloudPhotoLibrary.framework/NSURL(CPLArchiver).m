...
- (uint64_t)initWithCPLArchiver:()CPLArchiver
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    [v12 handleFailureInMethod:a2, a1, v13, 1129, @"Incorrect string for NSUUID. Found %@: '%@'", objc_opt_class(), v5[2] object file lineNumber description];

    abort();
  }
  uint64_t v6 = [a1 initWithString:v5[2]];
...
- (id)plistArchiveWithCPLArchiver:()CPLArchiver
{
  if ([a3 forDisplay] && objc_msgSend(a1, "isFileURL"))
  {
    v4 = [a1 path];
  }
  else
