...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v5 & 4) != 0)
  {
    self->_defaultHEVC = *((unsigned char *)v4 + 20);
...
LABEL_7:
  ...
  uint64_t v2 = 2654435761 * self->_defaultHEVC;
  if ((*(unsigned char *)&self->_has & 2) == 0) {
    goto LABEL_6;
  }
LABEL_3:
...
LABEL_10:
  if ((*(unsigned char *)&self->_has & 2) != 0)
  {
    if ((*((unsigned char *)v4 + 24) & 2) == 0 || self->_reason != *((_DWORD *)v4 + 4)) {
      goto LABEL_19;
    }
  }
  else if ((*((unsigned char *)v4 + 24) & 2) != 0)
  ...
  if (*(unsigned char *)&self->_has)
  {
    if ((*((unsigned char *)v4 + 24) & 1) == 0 || self->_version != *((void *)v4 + 1)) {
      goto LABEL_19;
    }
    BOOL v5 = 1;
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if ((has & 4) != 0)
  {
    *((unsigned char *)result + 20) = self->_defaultHEVC;
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 4) != 0)
  {
    v7 = [NSNumber numberWithBool:self->_defaultHEVC];
...
LABEL_4:
  BOOL v5 = [NSNumber numberWithLongLong:self->_version];
...
- (id)description
{
  ...
  id v4 = [(CPLAccountFlags *)&v8 description];
  BOOL v5 = [(CPLAccountFlags *)self dictionaryRepresentation];
