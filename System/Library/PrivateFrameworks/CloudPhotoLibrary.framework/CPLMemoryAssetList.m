  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[CPLMemoryAssetList addAsset:](self, "addAsset:", *(void *)(*((void *)&v10 + 1) + 8 * v9++), (void)v10);
      }
      while (v7 != v9);
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v8 clearAssets];
    unint64_t v4 = [(CPLMemoryAssetList *)self assetsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(CPLMemoryAssetList *)self assetAtIndex:i];
        [v8 addAsset:v7];
      }
    }
  }
...
- (BOOL)readFrom:(id)a3
{
  return CPLMemoryAssetListReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)CPLMemoryAssetList;
  id v4 = [(CPLMemoryAssetList *)&v8 description];
  unint64_t v5 = [(CPLMemoryAssetList *)self dictionaryRepresentation];
