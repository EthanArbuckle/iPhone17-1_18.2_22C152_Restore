...
{
  v7.receiver = self;
  v7.super_class = (Class)CPLCKFeatureAvailabilityResponse;
  v3 = [(CPLCKFeatureAvailabilityResponse *)&v7 description];
  id v4 = [(CPLCKFeatureAvailabilityResponse *)self dictionaryRepresentation];
...
{
  id v8 = a3;
  if ([(CPLCKFeatureAvailabilityResponse *)self featuresCount])
  {
    [v8 clearFeatures];
    unint64_t v4 = [(CPLCKFeatureAvailabilityResponse *)self featuresCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        id v7 = [(CPLCKFeatureAvailabilityResponse *)self featuresAtIndex:i];
        [v8 addFeatures:v7];
      }
    }
  }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[CPLCKFeatureAvailabilityResponse addFeatures:](self, "addFeatures:", *(void *)(*((void *)&v9 + 1) + 8 * (void)v8), (void)v9);
        id v8 = (char *)v8 + 1;
      }
      while (v6 != v8);
