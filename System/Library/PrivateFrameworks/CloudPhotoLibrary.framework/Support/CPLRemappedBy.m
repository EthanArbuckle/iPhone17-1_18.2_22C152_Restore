...
{
  v7.receiver = self;
  v7.super_class = (Class)CPLRemappedBy;
...
- (id)dictionaryRepresentation
{
  ...
  if ([(NSMutableArray *)self->_remappedBys count])
  {
    id v4 = objc_msgSend(objc_alloc((Class)NSMutableArray), "initWithCapacity:", -[NSMutableArray count](self->_remappedBys, "count"));
    long long v12 = 0u;
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((unint64_t)remappedBys | v4[1]) {
      unsigned __int8 v6 = -[NSMutableArray isEqual:](remappedBys, "isEqual:");
    }
    else {
...
- (unint64_t)hash
{
  return (unint64_t)[(NSMutableArray *)self->_remappedBys hash];
}
