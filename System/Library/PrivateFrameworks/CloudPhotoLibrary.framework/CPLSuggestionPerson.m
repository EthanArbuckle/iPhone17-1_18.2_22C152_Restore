...
- (void)mergeFrom:(id)a3
{
  ...
  if (*((void *)v4 + 3))
  {
    -[CPLSuggestionPerson setPersonIdentifier:](self, "setPersonIdentifier:");
    v4 = v6;
  }
  ...
  if (*((void *)v4 + 1))
  {
    -[CPLSuggestionPerson setContext:](self, "setContext:");
    v4 = v6;
  }
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((unint64_t)personIdentifier | *((void *)v4 + 3))
  {
...
- (BOOL)readFrom:(id)a3
{
  return CPLSuggestionPersonReadFrom((uint64_t)self, (uint64_t)a3);
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)CPLSuggestionPerson;
  id v4 = [(CPLSuggestionPerson *)&v8 description];
  uint64_t v5 = [(CPLSuggestionPerson *)self dictionaryRepresentation];
