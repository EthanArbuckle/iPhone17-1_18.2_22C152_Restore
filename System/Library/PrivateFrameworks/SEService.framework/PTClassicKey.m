...
LABEL_13:
    ...
    else if (DERParseSequenceSpec())
    {
      if (a4)
      {
        ...
        v11 = [MEMORY[0x263EFF8F8] dataWithDERItem:&v21];
        v17 = [v11 base64];
        SESCreateAndLogError();
        *a4 = (id)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      if (a4)
      {
        ...
        v13 = [MEMORY[0x263EFF8F8] dataWithDERItem:&v19];
        v18 = [v13 base64];
        SESCreateAndLogError();
        *a4 = (id)objc_claimAutoreleasedReturnValue();
    ...
    else
    {
      ...
      *(unsigned char *)(v9 + 120) = 1;
      if (DERParseSequenceSpec())
      {
        ...
        v10 = SESDefaultLogObject();
        v13 = [MEMORY[0x263EFF8F8] dataWithDERItem:v22 + 4];
      ...
      unint64_t v14 = DERLengthOfEncodedSequence() + 32;
      unint64_t v15 = v22[5];
      BOOL v16 = v15 >= v14;
...
uint64_t __40__PTClassicKey__withExportedBlob_error___block_invoke(uint64_t a1, uint64_t a2, unsigned char *a3)
{
...
{
  v3 = NSString;
  uint64_t v4 = [(PTClassicKey *)self keyNumber];
  id v5 = [(PTClassicKey *)self keyIdentifier];
  id v6 = [v5 asHexString];
  uint64_t v7 = [v3 stringWithFormat:@"Key: keyNumber 0x%X keyIdentifier %@ isExported %d", v4, v6, self->_isExportedData];
...
- (NSData)publicKey
{
  return (NSData *)[MEMORY[0x263EFF8F8] dataWithDERItem:&self->_ptKeyBlob.publicKey];
}

- (NSData)keyIdentifier
{
  v3 = [MEMORY[0x263EFF990] dataWithLength:32];
...
- (NSData)assetACL
{
  return (NSData *)[MEMORY[0x263EFF8F8] dataWithDERItem:&self->_assetACLItem];
}

- (NSData)assetACLAttestation
{
  return (NSData *)[MEMORY[0x263EFF8F8] dataWithDERItem:&self->_assetACLAttestationItem];
}

- (NSData)accessControlConstraints
{
  return (NSData *)[MEMORY[0x263EFF8F8] dataWithDERItem:&self->_accessControlConstraintsItem];
}
