...
+ (id)edDifferentialStyleFromXmlDifferentialStyleElement:(_xmlNode *)a3 state:(id)a4
{
  ...
  if (a3)
  {
    ...
    uint64_t v8 = OCXFindChild(a3, v7, "numFmt");
    ...
    uint64_t v11 = OCXFindChild(a3, v10, "font");
    ...
    uint64_t v14 = OCXFindChild(a3, v13, "border");
    ...
    uint64_t v17 = OCXFindChild(a3, v16, "fill");
