...
- (OITSUCustomCallBackDictionary)init
{
  return [(OITSUCustomCallBackDictionary *)self initWithCapacity:0 keyCallBacks:MEMORY[0x263EFFF88] valueCallBacks:MEMORY[0x263EFFF90]];
}
...
- (OITSUCustomCallBackDictionary)initWithCapacity:(unint64_t)a3
{
  return [(OITSUCustomCallBackDictionary *)self initWithCapacity:a3 keyCallBacks:MEMORY[0x263EFFF88] valueCallBacks:MEMORY[0x263EFFF90]];
}
...
- (id)objectEnumerator
{
  id v2 = [(OITSUCustomCallBackDictionary *)self allValues];
...
- (id)keyEnumerator
{
  id v2 = [(OITSUCustomCallBackDictionary *)self allKeys];
  return (id)[v2 objectEnumerator];
}
