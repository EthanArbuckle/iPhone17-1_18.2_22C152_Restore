...
+ (id)readFromParentNode:(_xmlNode *)a3 drawingState:(id)a4
{
  ...
  if ([v8 targetMode] == 1)
  {
    ...
    if (v13)
    {
      ...
      xmlFreeTextReader(v16);
      v20 = OCXFirstPartWithRelationshipOfTypeToPartWithFallback(v13, v6, (objc_selector *)sel_OCXThemeRelationshipType);
      if (v20)
      {
...
+ (id)chartPartWithParentNode:(_xmlNode *)a3 drawingState:(id)a4
{
  ...
  v9 = CXRequiredStringAttribute(v7, v8, (xmlChar *)"id");
...
+ (id)readFromXmlDocument:(_xmlDoc *)a3 chartStyleId:(int)a4 drawingState:(id)a5
{
  uint64_t v5 = *(void *)&a4;
  id v7 = a5;
  uint64_t v8 = MEMORY[0x23EC9A170]();
...
+ (id)externalDataRelationshipWithChartPart:(id)a3 drawingState:(id)a4
{
  id v5 = a3;
  id v6 = a4;
  id v7 = (_xmlDoc *)[v5 xmlDocument];
  if (!v7) {
    +[TCMessageException raise:TCInvalidFileFormatMessage];
  }
  uint64_t v8 = OCXGetRootElement(v7);
  ...
  if (v10)
  {
    ...
    v12 = CXRequiredStringAttribute(v10, v11, (xmlChar *)"id");
