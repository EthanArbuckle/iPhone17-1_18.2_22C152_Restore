...
+ (id)mapDiagram:(id)a3 drawingTheme:(id)a4
{
  ...
  [v27 rotation];
  int v38 = v37;
  uint64_t v39 = [v27 flipX];
  uint64_t v40 = [v27 flipY];
  LODWORD(v41) = v38;
...
+ (void)mapLayoutTypeId:(id)a3 state:(id)a4
{
  ...
  {
    id v6 = @"urn:microsoft.com/office/officeart/2005/8/layout/";
  }
  else
  {
    ...
    id v6 = @"urn:microsoft.com/office/officeart/2008/layout/";
  }
  uint64_t v7 = [v12 rangeOfString:@"#"];
  if (v8)
  {
    uint64_t v9 = [v12 substringToIndex:v7];

    id v12 = (id)v9;
  }
  v10 = objc_msgSend(v12, "substringFromIndex:", -[__CFString length](v6, "length"));
  ...
  v10 = v11;
LABEL_17:
  if (!+[ODIBending mapIdentifier:v10 state:v5]
    && !+[ODILinear mapIdentifier:v10 state:v5]
    && !+[ODICycle mapIdentifier:v10 state:v5]
    && !+[ODIVenn mapIdentifier:v10 state:v5]
    && !+[ODIPyramid mapIdentifier:v10 state:v5]
    && !+[ODIHierarchy mapIdentifier:v10 state:v5]
    && !+[ODIArrow mapIdentifier:v10 state:v5]
    && !+[ODIArrow3 mapIdentifier:v10 state:v5]
    && !+[ODIArrow4 mapIdentifier:v10 state:v5]
    && !+[ODIHorizonalList3 mapIdentifier:v10 state:v5])
  {
    +[ODILinear mapUnknownWithState:v5];
  }
