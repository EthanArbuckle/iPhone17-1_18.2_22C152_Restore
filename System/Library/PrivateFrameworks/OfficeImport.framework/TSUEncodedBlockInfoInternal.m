...
- (BOOL)isEqual:(id)a3
{
  v9 = TSUProtocolCast(a3, 1, (uint64_t)a3, v3, v4, v5, v6, v7, (uint64_t)&unk_26EC95138);
  if (v9) {
...
- (NSString)description
{
  return (NSString *)objc_msgSend(NSString, "stringWithFormat:", @"[EncodedLength=%zu; DecodedLength=%zu]",
