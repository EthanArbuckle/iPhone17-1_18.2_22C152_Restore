...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)OITSUPointerSet;
...
{
  v9.receiver = self;
  v9.super_class = (Class)OITSUPointerSet;
...
{
  v7.receiver = self;
  v7.super_class = (Class)OITSUPointerSet;
  objc_super v4 = [(OITSUPointerSet *)&v7 init];
  v5 = v4;
  if (a3 && v4) {
...
- (id)allObjects
{
  ...
  unint64_t v3 = [(OITSUPointerSet *)self count];
  if (v3)
  {
    unint64_t v4 = v3;
    if (v3 >= 0x41) {
...
- (id)setByAddingObject:(id)a3
{
  ...
  unint64_t v5 = [(OITSUPointerSet *)self count];
  unint64_t v6 = v5;
  unint64_t v7 = v5 + 1;
  uint64_t v8 = 1;
  if (v5 + 1 < 0x41) {
