...
+ (id)readFromXmlNode:(_xmlNode *)a3 inNamespace:(id)a4 drawingState:(id)a5
{
  ...
  uint64_t v11 = OCXFindChild(a3, v8, "grpSpPr");
...
+ (void)applyGroupFill:(id)a3 toChildrenOfGroup:(id)a4
{
  id v14 = a3;
  id v6 = a4;
  for (unint64_t i = 0; i < [v6 childCount]; ++i)
  {
    ...
    else
    {
      ...
      uint64_t v11 = [v8 shapeProperties];
      v12 = [v11 fill];
      objc_opt_class();
