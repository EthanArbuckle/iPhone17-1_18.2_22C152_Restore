...
+ (id)initWithData:(id)a3
{
  CGImageSourceRef v4 = CGImageSourceCreateWithData((CFDataRef)a3, MEMORY[0x263EFFA78]);
  v5 = (void *)[a1 initWithImageSourceRef:v4];
  if (v4) {
    CFRelease(v4);
  }
  return v5;
...
+ (id)initWithContentsOfFile:(id)a3
{
  CGImageSourceRef v4 = [OITSUUIImage alloc];
