...
+ (id)readFromPackagePart:(id)a3 presentationState:(id)a4
{
  ...
  v12 = OCXFirstPartWithRelationshipOfTypeToPartWithFallback(v5, v6, (objc_selector *)sel_OCXThemeRelationshipType);
  if (!v12) {
    +[TCMessageException raise:TCInvalidFileFormatMessage];
  }
  ...
  uint64_t v15 = OCXFindChild(v10, v14, "clrMap");
  ...
  uint64_t v18 = OCXFindChild(v10, v17, "notesStyle");
