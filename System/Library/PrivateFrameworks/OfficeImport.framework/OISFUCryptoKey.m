...
- (id)initAes128KeyFromPassphrase:(id)a3 iterationCount:(unsigned int)a4
{
  ...
  size_t v7 = strlen(v6);
  id v8 = +[OISFUCryptoUtils generateRandomSaltWithLength:16];
  return [(OISFUCryptoKey *)self initAes128KeyFromPassphrase:v6 length:v7 iterationCount:v4 saltData:v8];
}
...
- (id)initAes128KeyFromPassphrase:(id)a3 withIterationCountAndSaltDataFromCryptoKey:(id)a4
{
  ...
  return [(OISFUCryptoKey *)self initAes128KeyFromPassphrase:v6 length:v7 iterationCount:v8 saltData:v9];
}

- (id)initAes128KeyFromPassphrase:(const char *)a3 length:(unsigned int)a4 iterationCount:(unsigned int)a5
{
  return [(OISFUCryptoKey *)self initAes128KeyFromPassphrase:a3 length:*(void *)&a4 iterationCount:*(void *)&a5 saltData:0];
}
...
- (id)initAes128KeyFromPassphrase:(id)a3 iterationCount:(unsigned int)a4 saltData:(id)a5
{
  ...
  return [(OISFUCryptoKey *)self initAes128KeyFromPassphrase:v9 length:v10 iterationCount:v6 saltData:a5];
}

- (id)initAes128KeyFromPassphrase:(const char *)a3 length:(unsigned int)a4 iterationCount:(unsigned int)a5 saltData:(id)a6
{
  v14.receiver = self;
  v14.super_class = (Class)OISFUCryptoKey;
  size_t v10 = [(OISFUCryptoKey *)&v14 init];
  v11 = v10;
  if (v10)
  {
    v10->mIterationCount = a5;
    v10->mKeyLength = 16;
    v10->mKey = (char *)malloc_type_calloc(1uLL, 0x10uLL, 0xA7E3E8DuLL);
...
{
  v10.receiver = self;
  v10.super_class = (Class)OISFUCryptoKey;
  size_t v7 = [(OISFUCryptoKey *)&v10 init];
  uint64_t v8 = v7;
  if (v7)
  {
    ...
    if (a4 == 16)
    {
      v7->mKey = (char *)malloc_type_calloc(1uLL, 0x10uLL, 0xEA1EF8FAuLL);
      __memcpy_chk();
    }
    else
    {
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)OISFUCryptoKey;
