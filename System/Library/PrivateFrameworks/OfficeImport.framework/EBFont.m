...
+ (id)edFontFromXlFont:(XlFont *)a3 edResources:(id)a4
{
  ...
  if (a3)
  {
    ...
    if (var2)
    {
      v9 = [NSString stringWithOcText:(char *)var2 + 8];
      [(EDFont *)v7 setName:v9];
    }
    [(EDFont *)v7 setHeight:(double)a3->var3];
...
+ (id)edFontFromXlDXfFont:(XlDXfFont *)a3 edResources:(id)a4
{
  ...
  if (a3)
  {
    ...
    if (!a3->var14)
    {
      BOOL v10 = (a3->var3 & 1) != 0 || a3->var4 == 700;
