...
LABEL_5:
  ...
  if ([v4 length] == 3)
  {
    ...
    if (!v13)
    {
      v14 = [MEMORY[0x263EFF960] ISOCurrencyCodes];
...
- (id)xlCurrencyCodeFromLasso:(id)a3
{
  ...
  if (([v4 isEqualToString:v6] & 1) != 0
    || ([v4 isEqualToString:@"KRW"] & 1) != 0
    || ([v4 isEqualToString:@"JPY"] & 1) != 0
    || ([v4 isEqualToString:@"TWD"] & 1) != 0
    || ([v4 isEqualToString:@"USD"] & 1) != 0
    || ([v4 isEqualToString:@"THB"] & 1) != 0
    || ([v4 isEqualToString:@"INR"] & 1) != 0
    || ([v4 isEqualToString:@"EUR"] & 1) != 0
    || ([v4 isEqualToString:@"GBP"] & 1) != 0
    || [v4 isEqualToString:@"BRL"])
  {
    uint64_t v7 = [(NSMutableDictionary *)self->mLassoToXlCurrencyCode objectForKey:v4];
...
- (void)populateDictionaries
{
  ...
  v3 = [NSString stringWithFormat:@"Kč"];
  ...
  for (uint64_t i = 0; i != 138; ++i)
  {
    ...
    if (*((unsigned char *)v17 + 32))
    {
      ...
      {
        uint64_t v18 = [NSString stringWithFormat:@"\"%@\"", v17[3]];
      }
      else
      {
        uint64_t v18 = [NSString stringWithFormat:@"%@-%@", v17[3], v17[2]];
      }
      v19 = (void *)v18;
      ...
      if (*((unsigned char *)v17 + 32))
      {
        if (!*((_DWORD *)v17 + 9)
          || (v20 = self->mXlAccountingFormat,
              ...
              [(NSMutableDictionary *)v20 setValue:v21 forKey:v17[1]],
              v21,
...
- (id)lassoCurrencyCodeForDollar
{
  ...
  id v4 = +[OITSUNumberFormatter currencySymbolForCurrencyCode:v3];
  if ([v4 rangeOfString:@"$"] == 0x7FFFFFFFFFFFFFFFLL) {
    v5 = @"USD";
  }
  else {
