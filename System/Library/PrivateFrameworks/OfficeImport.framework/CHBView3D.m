...
+ (id)readFrom:(const XlChart3D *)a3
{
  if (a3)
  {
    ...
    [(CHDView3D *)v4 setRightAngleAxes:XlChart3D::isPerspective((XlChart3D *)a3) ^ 1];
    [(CHDView3D *)v4 setDepthPercent:a3->var6];
    [(CHDView3D *)v4 setGapDepthPercent:a3->var7];
    [(CHDView3D *)v4 setHeightPercent:a3->var5];
    [(CHDView3D *)v4 setAutoscale:XlChart3D::is3DScaling((XlChart3D *)a3)];
    [(CHDView3D *)v4 setCluster:XlChart3D::isCluster((XlChart3D *)a3)];
  }
  else
  {
    v4 = 0;
