...
{
  v6.receiver = self;
  v6.super_class = (Class)OITSUProgressGroup;
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)OITSUProgressGroup;
...
{
  v8.receiver = self;
  v8.super_class = (Class)OITSUProgressGroup;
  ...
  if (v4)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v5; ++i)
      {
        ...
        objc_msgSend((id)objc_msgSend(*(id *)(*(void *)(a1 + 32) + 32), "objectAtIndex:", v6 + i), "removeProgressObserver:", *(void *)(*((void *)&v28 + 1) + 8 * i));
      }
    ...
    if (v14)
    {
      ...
      do
      {
        for (uint64_t j = 0; j != v15; ++j)
        {
          ...
          v23[1] = 3221225472;
          v23[2] = __55__OITSUProgressGroup_p_updateChildrenProgressObservers__block_invoke_2;
          v23[3] = &unk_264D60B18;
          v23[4] = v20;
          objc_msgSend(v12, "addObject:", objc_msgSend(v18, "addProgressObserverWithValueInterval:queue:handler:", v21, v23, v19));
        }
