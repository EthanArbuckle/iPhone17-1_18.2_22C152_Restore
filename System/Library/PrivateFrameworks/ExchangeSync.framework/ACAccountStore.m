...
{
  _esAccountsWithAccountTypeIdentifiers_enabledForDADataclasses_filterOnDataclasses_withCompletion__statusReportQueue = (uint64_t)dispatch_queue_create("com.apple.dataaccess.statusreport", 0);
...
void __129__ACAccountStore_ESExtensions___esAccountsWithAccountTypeIdentifiers_enabledForDADataclasses_filterOnDataclasses_withCompletion___block_invoke_3(uint64_t a1)
{
  ...
  long long v12 = 0u;
  long long v13 = 0u;
  id v2 = objc_msgSend(MEMORY[0x263F38D60], "sharedMonitor", 0);
...
void __129__ACAccountStore_ESExtensions___esAccountsWithAccountTypeIdentifiers_enabledForDADataclasses_filterOnDataclasses_withCompletion___block_invoke_7(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v11)
  {
    uint64_t v10 = +[ESAccount esAccountSubclassWithBackingAccountInfo:](ESAccount, "esAccountSubclassWithBackingAccountInfo:");
    if (v10) {
...
void __129__ACAccountStore_ESExtensions___esAccountsWithAccountTypeIdentifiers_enabledForDADataclasses_filterOnDataclasses_withCompletion___block_invoke_3_12(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    v13[1] = 3221225472;
    v13[2] = __129__ACAccountStore_ESExtensions___esAccountsWithAccountTypeIdentifiers_enabledForDADataclasses_filterOnDataclasses_withCompletion___block_invoke_4_13;
    v13[3] = &unk_264DA1BD0;
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        id v15 = +[ESAccount esAccountSubclassWithBackingAccountInfo:](ESAccount, "esAccountSubclassWithBackingAccountInfo:", *(void *)(*((void *)&v16 + 1) + 8 * v14), (void)v16);
        if (v15) {
