...
- (MADSceneClassificationVideoEntry)initWithCoder:(id)a3
{
  ...
  long long v5 = [(MADSceneClassificationVideoEntry *)&v15 init];
  if (v5)
  {
    if (v4)
    {
...
- (id)description
{
  ...
  *(_OWORD *)&range.duration.timescale = *(_OWORD *)&self->_timeRange.duration.timescale;
  ...
  [v3 appendFormat:@"%@: %-.4fs-%-.4fs, ", @"TimeRange", *(void *)&Seconds, CMTimeGetSeconds(&v13)];
  [(MADSceneClassificationVideoEntry *)self boundingBox];
  if (v8 != 0.0)
  {
    [(MADSceneClassificationVideoEntry *)self boundingBox];
    CGFloat v9 = NSStringFromRect(v16);
