@interface MADVideoResultsPayload
+ (BOOL)supportsSecureCoding;
- (MADVideoResultsPayload)initWithCoder:(id)a3;
- (NSArray)results;
- (NSError)error;
- (id)description;
...
@implementation MADVideoResultsPayload
...
- (MADVideoResultsPayload)initWithCoder:(id)a3
{
  ...
  id v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)MADVideoResultsPayload;
  v5 = [(MADVideoResultsPayload *)&v14 init];
  if (v5)
  {
