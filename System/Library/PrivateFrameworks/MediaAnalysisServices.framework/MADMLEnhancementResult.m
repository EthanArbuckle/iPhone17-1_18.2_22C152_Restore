...
- (MADMLEnhancementResult)initWithSurface:(id)a3
{
  id v5 = a3;
  v9.receiver = self;
  v9.super_class = (Class)MADMLEnhancementResult;
...
- (void)encodeWithCoder:(id)a3
{
  id v4 = a3;
  v5.receiver = self;
  v5.super_class = (Class)MADMLEnhancementResult;
...
- (CGImage)image
{
  ...
  if (!result)
  {
    ...
    }
    {
      ...
      CGDataProviderDirectCallbacks callbacks = *(CGDataProviderDirectCallbacks *)byte_1F381E850;
