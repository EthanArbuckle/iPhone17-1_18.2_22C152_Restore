@interface MADMultiModalRequest
+ (BOOL)supportsSecureCoding;
- (MADMultiModalRequest)initWithCoder:(id)a3;
- (NSArray)results;
- (NSError)error;
- (id)description;
...
@implementation MADMultiModalRequest
...
- (MADMultiModalRequest)initWithCoder:(id)a3
{
  ...
  id v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)MADMultiModalRequest;
  v5 = [(MADMultiModalRequest *)&v14 init];
  if (v5)
  {
