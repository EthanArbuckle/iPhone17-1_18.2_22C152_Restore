@interface MADTextResultsPayload
+ (BOOL)supportsSecureCoding;
- (MADTextResultsPayload)initWithCoder:(id)a3;
- (NSArray)results;
- (NSError)error;
- (id)description;
...
@implementation MADTextResultsPayload
...
- (MADTextResultsPayload)initWithCoder:(id)a3
{
  ...
  id v4 = a3;
  v14.receiver = self;
  v14.super_class = (Class)MADTextResultsPayload;
  v5 = [(MADTextResultsPayload *)&v14 init];
  if (v5)
  {
