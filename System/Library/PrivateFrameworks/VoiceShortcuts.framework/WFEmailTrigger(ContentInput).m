@interface WFEmailTrigger(ContentInput)
...
- (id)contentCollectionWithEventInfo:()ContentInput
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 136315394;
    ...
    __int16 v19 = 2112;
    id v20 = v3;
    _os_log_impl(&dword_1C7D7E000, v4, OS_LOG_TYPE_INFO, "%s Creating EmailContentItem from eventinfo: %@", buf, 0x16u);
  }
  ...
  if (v5 && (objc_opt_class(), char isKindOfClass = objc_opt_isKindOfClass(), v5, (isKindOfClass & 1) != 0))
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      v15 = [v14 if_map:&__block_literal_global_7862];
