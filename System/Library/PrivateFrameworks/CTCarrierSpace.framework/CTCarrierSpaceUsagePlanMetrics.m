...
{
  v11.receiver = self;
  v11.super_class = (Class)CTCarrierSpaceUsagePlanMetrics;
...
- (BOOL)isEqual:(id)a3
{
  v7 = (CTCarrierSpaceUsagePlanMetrics *)a3;
  if (v7 == self)
  {
    char v10 = 1;
  }
  else
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      int64_t v11 = [(CTCarrierSpaceUsagePlanMetrics *)self planCategory];
      if (v11 != [(CTCarrierSpaceUsagePlanMetrics *)v7 planCategory]
        || (BOOL v12 = [(CTCarrierSpaceUsagePlanMetrics *)self currentUsedPlan],
            v12 != [(CTCarrierSpaceUsagePlanMetrics *)v7 currentUsedPlan]))
      {
        char v10 = 0;
        goto LABEL_43;
      }
      ...
      uint64_t v16 = [(CTCarrierSpaceUsagePlanMetrics *)self messages];
      uint64_t v17 = [(CTCarrierSpaceUsagePlanMetrics *)v7 messages];
      v55 = v13;
      v56 = (void *)v16;
      BOOL v18 = v16 == v17;
      v19 = (void *)v17;
      ...
      else
      {
        ...
        v51 = [(CTCarrierSpaceUsagePlanMetrics *)v7 messages];
        v52 = v21;
...
LABEL_41:
      ...
      uint64_t v22 = [(CTCarrierSpaceUsagePlanMetrics *)self voice];
      uint64_t v49 = [(CTCarrierSpaceUsagePlanMetrics *)v7 voice];
      v50 = (void *)v22;
      v48 = v14;
      if (v22 != v49)
      {
...
LABEL_38:
      ...
      uint64_t v28 = [(CTCarrierSpaceUsagePlanMetrics *)self remainingBalance];
      uint64_t v46 = [(CTCarrierSpaceUsagePlanMetrics *)v7 remainingBalance];
      v47 = (void *)v28;
      if (v28 == v46)
      {
        v43 = v5;
      ...
      BOOL v32 = [(CTCarrierSpaceUsagePlanMetrics *)self throttled];
      if (v32 == [(CTCarrierSpaceUsagePlanMetrics *)v7 throttled])
      {
        v33 = [(CTCarrierSpaceUsagePlanMetrics *)self lastUpdatedAt];
        uint64_t v34 = [(CTCarrierSpaceUsagePlanMetrics *)v7 lastUpdatedAt];
        if (v33 == (void *)v34)
        {
...
- (CTCarrierSpaceUsagePlanMetrics)initWithCoder:(id)a3
{
  id v4 = a3;
  v19.receiver = self;
  v19.super_class = (Class)CTCarrierSpaceUsagePlanMetrics;
  id v5 = [(CTCarrierSpaceUsagePlanMetrics *)&v19 init];
  if (v5)
  {
