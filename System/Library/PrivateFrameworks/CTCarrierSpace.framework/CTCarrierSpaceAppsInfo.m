...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      objc_super v7 = [(CTCarrierSpaceAppsInfo *)self appsList];
      v8 = [(CTCarrierSpaceAppsInfo *)v6 appsList];
      if (v7 == v8
        || ([(CTCarrierSpaceAppsInfo *)self appsList],
            v3 = objc_claimAutoreleasedReturnValue(),
            [(CTCarrierSpaceAppsInfo *)v6 appsList],
...
- (CTCarrierSpaceAppsInfo)initWithCoder:(id)a3
{
  ...
  id v5 = [(CTCarrierSpaceAppsInfo *)&v14 init];
  if (v5)
  {
