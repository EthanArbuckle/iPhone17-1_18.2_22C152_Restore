...
- (id)description
{
  ...
  v4 = [(CTCarrierSpaceUsagePlanItemData *)self capacity];
  [v3 appendFormat:@", capacity=%@", v4];

  v5 = [(CTCarrierSpaceUsagePlanItemData *)self maxDataBeforeThrottling];
  [v3 appendFormat:@", maxDataBeforeThrottling=%@", v5];

  v6 = [(CTCarrierSpaceUsagePlanItemData *)self thisDeviceDataUsed];
  [v3 appendFormat:@", used=%@", v6];

  v7 = [(CTCarrierSpaceUsagePlanItemData *)self sharedDataUsed];
  [v3 appendFormat:@", sharedDataUsed=%@", v7];

  v8 = [(CTCarrierSpaceUsagePlanItemData *)self sharedPlanIdentifier];
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      int64_t v8 = [(CTCarrierSpaceUsagePlanItemData *)self units];
      if (v8 == [(CTCarrierSpaceUsagePlanItemData *)v7 units])
      {
        v9 = [(CTCarrierSpaceUsagePlanItemData *)self capacity];
        objc_super v10 = [(CTCarrierSpaceUsagePlanItemData *)v7 capacity];
        if (v9 != v10)
        {
          v11 = [(CTCarrierSpaceUsagePlanItemData *)self capacity];
          [(CTCarrierSpaceUsagePlanItemData *)v7 capacity];
          v39 = v38 = v11;
        ...
        v13 = [(CTCarrierSpaceUsagePlanItemData *)self maxDataBeforeThrottling];
        v14 = [(CTCarrierSpaceUsagePlanItemData *)v7 maxDataBeforeThrottling];
        if (v13 != v14)
        {
          v5 = [(CTCarrierSpaceUsagePlanItemData *)self maxDataBeforeThrottling];
          v3 = [(CTCarrierSpaceUsagePlanItemData *)v7 maxDataBeforeThrottling];
...
LABEL_32:
        ...
        uint64_t v15 = [(CTCarrierSpaceUsagePlanItemData *)self thisDeviceDataUsed];
        uint64_t v36 = [(CTCarrierSpaceUsagePlanItemData *)v7 thisDeviceDataUsed];
        v37 = (void *)v15;
        if (v15 == v36)
        {
          v35 = v3;
        ...
        {
          v16 = [(CTCarrierSpaceUsagePlanItemData *)self thisDeviceDataUsed];
          v33 = [(CTCarrierSpaceUsagePlanItemData *)v7 thisDeviceDataUsed];
          v34 = v16;
...
LABEL_29:
        ...
        v17 = [(CTCarrierSpaceUsagePlanItemData *)self sharedDataUsed];
        v18 = [(CTCarrierSpaceUsagePlanItemData *)v7 sharedDataUsed];
        if (v17 == v18)
        {
          v30 = v5;
          v31 = v14;
        ...
        {
          v4 = [(CTCarrierSpaceUsagePlanItemData *)self sharedDataUsed];
          v32 = [(CTCarrierSpaceUsagePlanItemData *)v7 sharedDataUsed];
        ...
        v21 = [(CTCarrierSpaceUsagePlanItemData *)self sharedPlanIdentifier];
        uint64_t v22 = [(CTCarrierSpaceUsagePlanItemData *)v7 sharedPlanIdentifier];
        if (v21 == (void *)v22)
        {
        ...
        {
          v23 = (void *)v22;
          [(CTCarrierSpaceUsagePlanItemData *)self sharedPlanIdentifier];
          v24 = v28 = v4;
          [(CTCarrierSpaceUsagePlanItemData *)v7 sharedPlanIdentifier];
          v29 = v13;
          v26 = v25 = v17;
...
- (CTCarrierSpaceUsagePlanItemData)initWithCoder:(id)a3
{
  ...
  id v5 = [(CTCarrierSpaceUsagePlanItemData *)&v17 init];
  if (v5)
  {
