...
- (BOOL)open:(id *)a3
{
  ...
  if (!v5)
  {
    int v7 = [(ICArchiveWriter *)self usesCompression]
       ? archive_write_set_format_pax()
       : archive_write_set_format_zip();
    int v6 = v7;
    if (!v7)
    {
      uint64_t v8 = [(ICArchiveWriter *)self destinationURL];
      id v9 = [v8 path];
...
- (BOOL)writeURL:(id)a3 isDirectory:(BOOL)a4 error:(id *)a5
{
  ...
  id v7 = a3;
  id v44 = 0;
  [v7 getResourceValue:&v44 forKey:*MEMORY[0x263EFF700] error:a5];
  id v8 = v44;
  int v9 = [v8 BOOLValue];
  id v43 = 0;
  [v7 getResourceValue:&v43 forKey:*MEMORY[0x263EFF6A8] error:a5];
  id v10 = v43;
  if (!-[ICArchiveWriter flatten](self, "flatten") || ([v10 BOOLValue] & 1) == 0)
  {
    ...
    id v14 = v13;
    if (lstat((const char *)[v14 fileSystemRepresentation], &v42))
    {
      if (a5)
      {
...
LABEL_23:
    ...
    {
      char v17 = [(ICArchiveWriter *)self flattenFolderName];
      ...
      uint64_t v25 = [(__CFString *)v23 stringByAppendingPathComponent:v24];
    ...
    {
      long long v26 = [(ICArchiveWriter *)self basePath];
      int v27 = [v14 hasPrefix:v26];
...
LABEL_16:
        ...
        if (v9)
        {
          char v41 = v9;
          id v28 = [v7 path];
          ssize_t v29 = readlink((const char *)[v28 fileSystemRepresentation], v47, 0x3FFuLL);
        ...
        int v30 = archive_write_header();
        if (!v30)
        {
          if ((v9 & 1) == 0)
          {
            id v37 = [v7 path];
            int v38 = open((const char *)[v37 fileSystemRepresentation], 0);
        ...
        if (a5)
        {
          ...
          v46[0] = @"Unable to write archive header";
          uint64_t v34 = *MEMORY[0x263F08338];
          v45[0] = v33;
          v45[1] = v34;
          v35 = objc_msgSend(NSString, "stringWithFormat:", @"%s", archive_error_string());
          v46[1] = v35;
          v36 = [NSDictionary dictionaryWithObjects:v46 forKeys:v45 count:2];
          *a5 = [v31 errorWithDomain:@"com.apple.notes" code:v32 userInfo:v36];
        }
        goto LABEL_23;
      }
      v18 = [(ICArchiveWriter *)self basePath];
      uint64_t v25 = objc_msgSend(v14, "substringFromIndex:", -[__CFString length](v18, "length"));
    }
