...
- (id)ic_loggingDescription
{
  if ([a1 conformsToProtocol:&unk_26C149A60]) {
    objc_msgSend((id)objc_opt_class(), "ic_loggingDescriptionFromLoggable:isPretty:", a1, 0);
  }
  else {
  v2 = [a1 description];
  }
...
{
  if ([a1 conformsToProtocol:&unk_26C149A60]) {
    objc_msgSend((id)objc_opt_class(), "ic_loggingDescriptionFromLoggable:isPretty:", a1, 1);
  }
  else {
  v2 = [a1 description];
  }
...
+ (id)ic_loggingDescriptionFromLoggable:()ICLoggable isPretty:
{
  ...
  v10 = objc_msgSend(v5, "ic_loggingIdentifier");
  if (!v10)
  {
...
LABEL_3:
  ...
  v11 = @"\t%@ = %@\n";
LABEL_6:
  v12 = objc_msgSend(v5, "ic_loggingValues");
