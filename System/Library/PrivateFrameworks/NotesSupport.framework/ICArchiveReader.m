...
- (ICArchiveReader)initWithSourceURL:(id)a3 destinationURL:(id)a4
{
  ...
  id v7 = a4;
  v14.receiver = self;
  v14.super_class = (Class)ICArchiveReader;
...
- (BOOL)unarchiveResultURLs:(id *)a3 error:(id *)a4
{
  ...
  if (v9)
  {
    ...
    if (v10
      && [v7 createDirectoryAtPath:v10 withIntermediateDirectories:1 attributes:0 error:a4])
    {
      uint64_t v11 = [(ICArchiveReader *)self sourcePath];
      BOOL v12 = [(ICArchiveReader *)self unarchiveSourcePath:v11 toDestinationPath:v10 error:a4];

      if (v12)
      {
        v13 = [(ICArchiveReader *)self destinationPath];
        BOOL v14 = [(ICArchiveReader *)self moveContentsOfDirectory:v10 toDirectory:v13 resultURLs:a3 error:a4];
      }
      else
      {
        BOOL v14 = 0;
...
- (id)temporaryDirectoryWithError:(id *)a3
{
  ...
  {
    id v7 = [(ICArchiveReader *)self destinationPath];
  ...
  else
  {
    ...
    v10 = NSURL;
    v8 = [(ICArchiveReader *)self destinationPath];
    uint64_t v11 = [v10 fileURLWithPath:v8];
    BOOL v12 = [v7 URLForDirectory:99 inDomain:1 appropriateForURL:v11 create:1 error:a3];
    int v9 = [v12 path];
  }
  return v9;
}
...
- (BOOL)unarchiveSourcePath:(id)a3 toDestinationPath:(id)a4 error:(id *)a5
{
  ...
  BOOL v8 = [(ICArchiveReader *)self skipsInvisibleHeaders];
  id v9 = v7;
  ...
  if (open_filename)
  {
    ...
    uint64_t v17 = [v12 errorWithDomain:@"com.apple.notes" code:v13 userInfo:v16];
    ...
    while (1)
    {
      ...
      else
      {
        ...
        if (v24)
        {
          ...
          uint64_t v30 = [v25 errorWithDomain:@"com.apple.notes" code:v27 userInfo:v29];
        ...
        else
        {
          while (1)
          {
            ...
            if (archive_write_data_block())
            {
              ...
              uint64_t v47 = [v46 errorWithDomain:@"com.apple.notes" code:-25 userInfo:v33];
...
LABEL_18:
            uint64_t v43 = [v40 errorWithDomain:@"com.apple.notes" code:v41 userInfo:v39];
