...
- (id)formatAddressCurrentFormatWithFallback:(BOOL)a3
{
  ...
  _os_log_debug_impl(&dword_1D24AE000, v13, OS_LOG_TYPE_DEBUG, v12, (uint8_t *)&v16, v14);
...
- (id)formatAddressParkingDisplayNameWithFallback:(BOOL)a3
{
  ...
  int v7 = _mo_log_facility_get_os_log(MOLogFacilityEventData);
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v20 = 1024;
    BOOL v21 = v3;
    _os_log_debug_impl(&dword_1D24AE000, v7, OS_LOG_TYPE_DEBUG, "%@, parkingDisplayName output string, %@, fallback, %i", (uint8_t *)&v16, 0x1Cu);
  }
  if ([v6 length]) {
    BOOL v8 = 1;
  }
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v20 = 1024;
    BOOL v21 = v3;
    _os_log_debug_impl(&dword_1D24AE000, v12, OS_LOG_TYPE_DEBUG, "%@, output string, %@, fallback, %i", (uint8_t *)&v16, 0x1Cu);
  }
  return v9;
}
...
LABEL_7:
  ...
  char v10 = [v5 isEqualToString:@"aboveDoorShortAddress"];
  int v7 = [(GEOAddressObject *)self->_geoAddressObject aboveDoorShortAddress];
  if ((v10 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v18 = 2112;
      double v19 = v7;
      _os_log_error_impl(&dword_1D24AE000, v11, OS_LOG_TYPE_ERROR, "%@, unrecognized format option, %@, will use default, %@", (uint8_t *)&v14, 0x20u);
    }
  }
LABEL_8:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v18 = 2112;
    double v19 = v7;
    _os_log_debug_impl(&dword_1D24AE000, v8, OS_LOG_TYPE_DEBUG, "%@, format option, %@, output string, %@", (uint8_t *)&v14, 0x20u);
  }
  return v7;
}
...
LABEL_13:
    ...
    __int16 v14 = 2112;
    uint64_t v15 = v6;
    _os_log_debug_impl(&dword_1D24AE000, v7, OS_LOG_TYPE_DEBUG, "%@, format option, %@, output string, %@", (uint8_t *)&v10, 0x20u);
    goto LABEL_14;
  }
  ...
  __int16 v14 = 2112;
  uint64_t v15 = v6;
  _os_log_error_impl(&dword_1D24AE000, v7, OS_LOG_TYPE_ERROR, "%@, unrecognized format option, %@, will use default, %@", (uint8_t *)&v10, 0x20u);
LABEL_14:
...
- (id)formatAdministrativeAreaWithFormatOption:(id)a3
{
    ...
    && ![v5 isEqualToString:@"aboveDoorShortAddress"])
  {
    ...
    __int16 v15 = 2112;
    uint64_t v16 = v6;
    _os_log_error_impl(&dword_1D24AE000, v7, OS_LOG_TYPE_ERROR, "%@, unrecognized format option, %@, will use default, %@", (uint8_t *)&v11, 0x20u);
    goto LABEL_16;
  }
  BOOL v8 = _mo_log_facility_get_os_log(MOLogFacilityEventData);
...
LABEL_15:
    ...
    __int16 v15 = 2112;
    uint64_t v16 = v6;
    _os_log_debug_impl(&dword_1D24AE000, v7, OS_LOG_TYPE_DEBUG, "%@, format option, %@, output string, %@", (uint8_t *)&v11, 0x20u);
LABEL_16:
  }
LABEL_10:
...
LABEL_14:
  _os_log_debug_impl(&dword_1D24AE000, v7, OS_LOG_TYPE_DEBUG, v10, (uint8_t *)&v11, 0x20u);
...
- (void)formatAddressParkingDisplayNameWithFallback:(NSObject *)a3 .cold.1(const char *a1, uint64_t a2, NSObject *a3)
{
  ...
  __int16 v6 = 1024;
  int v7 = 1;
  _os_log_debug_impl(&dword_1D24AE000, a3, OS_LOG_TYPE_DEBUG, "%@, shortAddress output string, %@, fallback, %i", v5, 0x1Cu);
}
...
- (void)formatAdministrativeAreaWithFormatOption:(NSObject *)a3 .cold.1(const char *a1, uint64_t a2, NSObject *a3)
{
  ...
  id v4 = NSStringFromSelector(a1);
  OUTLINED_FUNCTION_0_2();
  _os_log_error_impl(&dword_1D24AE000, a3, OS_LOG_TYPE_ERROR, "%@, short address format doesn't support the administrative area (state), option, %@, will use default", v5, 0x16u);
}
