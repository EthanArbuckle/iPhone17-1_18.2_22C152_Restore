...
{
  id v4 = a3;
  char v5 = [(MOEventBundleLabelCondition *)self keyword];
  BOOL v6 = [v4 objectForKey:v5];

  if ([(MOEventBundleLabelCondition *)self templateOperator] != 9)
  {
    BOOL v11 = [(MOEventBundleLabelCondition *)self yieldConditionForValueData:v6];
    goto LABEL_10;
  }
  if (!v6)
  {
LABEL_9:
  ...
  if (!v7
    || (v8 = (void *)v7,
        ...
        char v10 = [v9 isEqualToString:@"_ANY_"],
        v9,
        v8,
        (v10 & 1) == 0))
  {
...
{
  id v4 = a3;
  char v5 = [(MOEventBundleLabelCondition *)self value];
...
LABEL_46:
        ...
        if ([(MOEventBundleLabelCondition *)self templateOperator] == 1
        ...
        {
          if ([(MOEventBundleLabelCondition *)self templateOperator] != 2
            || [(MOEventBundleLabelCondition *)self valueType])
          {
            goto LABEL_9;
          }
        ...
        if ([(MOEventBundleLabelCondition *)self valueType] == 1)
        {
          switch([(MOEventBundleLabelCondition *)self templateOperator])
          {
            case 1uLL:
              ...
              LOBYTE(self) = self == (MOEventBundleLabelCondition *)[v9 integerValue];
              break;
            case 2uLL:
              self = (MOEventBundleLabelCondition *)[v10 integerValue];
              LOBYTE(self) = self != (MOEventBundleLabelCondition *)[v9 integerValue];
            ...
            case 3uLL:
              self = (MOEventBundleLabelCondition *)[v10 integerValue];
              LOBYTE(self) = (uint64_t)self < [v9 integerValue];
              break;
            case 4uLL:
              self = (MOEventBundleLabelCondition *)[v10 integerValue];
              LOBYTE(self) = (uint64_t)self <= [v9 integerValue];
            ...
            case 5uLL:
              ...
              BOOL v16 = v15 <= [v9 integerValue];
              goto LABEL_37;
            case 6uLL:
              uint64_t v17 = [v10 integerValue];
              BOOL v18 = v17 < [v9 integerValue];
              goto LABEL_41;
            default:
              goto LABEL_24;
          }
LABEL_44:
        ...
        if ([(MOEventBundleLabelCondition *)self valueType] == 2
          || ![(MOEventBundleLabelCondition *)self valueType])
        {
          switch([(MOEventBundleLabelCondition *)self templateOperator])
          {
...
{
  id v3 = NSString;
  id v4 = [(MOEventBundleLabelCondition *)self keyword];
  char v5 = +[MOEventBundleLabelCondition stringFromTemplateOperator:[(MOEventBundleLabelCondition *)self templateOperator]];
  id v6 = [(MOEventBundleLabelCondition *)self value];
  uint64_t v7 = +[MOEventBundleLabelCondition stringFromValueType:[(MOEventBundleLabelCondition *)self valueType]];
  v8 = [v3 stringWithFormat:@"keyword, %@, operator, %@, value, %@, value type, %@", v4, v5, v6, v7];
...
{
  *(_WORD *)v1 = 0;
  _os_log_error_impl(&dword_1D24AE000, log, OS_LOG_TYPE_ERROR, "Invalid parameter not satisfying: keyword", v1, 2u);
}
