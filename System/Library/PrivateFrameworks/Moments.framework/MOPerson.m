...
- (id)description
{
  ...
  BOOL v7 = [(MOPerson *)self isPHPersonTypeImportant];
  BOOL v8 = [(MOPerson *)self isMePerson];
  BOOL v9 = [(MOPerson *)self mePersonIdentified];
...
- (MOPerson)initWithCoder:(id)a3
{
  ...
  BOOL v7 = [v3 decodeObjectOfClass:objc_opt_class() forKey:@"family"];
  uint64_t v8 = [v3 decodeBoolForKey:@"isPHPersonTypeImportant"];
  uint64_t v9 = [v3 decodeBoolForKey:@"isMePerson"];
  char v10 = [v3 decodeBoolForKey:@"mePersonIdentified"];
  double v11 = (void *)MEMORY[0x1E4F1CAD0];
  uint64_t v12 = objc_opt_class();
  uint64_t v13 = objc_msgSend(v11, "setWithObjects:", v12, objc_opt_class(), 0);
  uint64_t v14 = [v3 decodeObjectOfClasses:v13 forKey:@"personRelationships"];

  [v3 decodeDoubleForKey:@"priorityScore"];
  double v16 = v15;
  [v3 decodeDoubleForKey:@"significanceScore"];
  LOBYTE(v21) = v10;
  uint64_t v18 = [(MOPerson *)self initWithLocalIdentifier:v4 name:v5 contactIdentifier:v6 family:v7 isPHPersonTypeImportant:v8 isMePerson:v9 mePersonIdentified:v16 personRelationships:v17 priorityScore:v21 significanceScore:v14];
  if (v18)
  {
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v6 = v4;
    BOOL v7 = [(MOPerson *)self localIdentifier];
    if (v7)
    {
      uint64_t v8 = [(MOPerson *)v6 localIdentifier];
      LODWORD(v9) = v8 != 0;
    }
    else
    {
    ...
    double v11 = [(MOPerson *)self contactIdentifier];
    if (v11)
    {
    ...
    if (v9)
    {
      uint64_t v14 = [(MOPerson *)self localIdentifier];
    ...
    double v17 = [(MOPerson *)self name];
    if (v17)
    {
      uint64_t v18 = [(MOPerson *)v6 name];
      if (v18)
      {
        [(MOPerson *)self name];
        uint64_t v9 = v27 = v9;
        ...
        int v19 = v16;
        v21 = BOOL v20 = v13;
        char v22 = [(id)v9 isEqualToString:v21];
