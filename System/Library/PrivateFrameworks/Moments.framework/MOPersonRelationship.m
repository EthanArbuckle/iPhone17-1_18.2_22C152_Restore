...
{
  v3 = NSString;
  unint64_t v4 = [(MOPersonRelationship *)self relationship];
  [(MOPersonRelationship *)self score];
  uint64_t v6 = v5;
  v7 = [(MOPersonRelationship *)self source];
  id v8 = [v3 stringWithFormat:@"<MOPersonRelationship relationship, %lu, score, %.1f, source, %@>", v4, v6, v7];
...
{
  id v4 = a3;
  uint64_t v5 = [v4 decodeInt64ForKey:@"relationship"];
