...
- (MOEventPhoto)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v5->_photoMemoryRelevanceScore = (double)[v4 decodeIntegerForKey:@"photoMemoryRelevanceScore"];
