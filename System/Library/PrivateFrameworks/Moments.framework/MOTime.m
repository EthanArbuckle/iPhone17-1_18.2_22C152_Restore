...
- (MOTime)initWithIdentifier:(id)a3
{
  ...
  if (!v5)
  {
    ...
    objc_msgSend(v7, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"MOTime.m", 102, @"Invalid parameter not satisfying: identifier (in %s:%d)", "-[MOTime initWithIdentifier:]", 102);
  }
  v8 = [MEMORY[0x1E4F1C9C8] date];
  [v8 timeIntervalSinceReferenceDate];
  v9 = -[MOTime initWithIdentifier:timestamp:timeString:timeZone:timeTag:](self, "initWithIdentifier:timestamp:timeString:timeZone:timeTag:", v5, @"today", @"Unknown", 0);
...
+ (id)localTimeOfDate:(id)a3 timeZone:(id)a4
{
  ...
  if (v5)
  {
    if (v6)
    {
      ...
      {
        uint64_t v10 = [v7 secondsFromGMTForDate:v5];
        uint64_t v11 = v10 - [v8 secondsFromGMTForDate:v5];
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
        {
          ...
          __int16 v22 = 2112;
          id v23 = v9;
          _os_log_debug_impl(&dword_1D24AE000, v12, OS_LOG_TYPE_DEBUG, "localTime, object date, %@, object timezone, %@, system timezone, %@, timezone diff, %ld, adjusted date, %@", (uint8_t *)&v14, 0x34u);
        }
      }
    }
    else
...
+ (id)timeFromStartDate:(id)a3 endDate:(id)a4 timeZoneManager:(id)a5
{
  ...
  if (v7)
  {
    uint64_t v10 = [v7 timeZoneAtDate:v6];
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v20 = 2112;
      id v21 = v7;
      _os_log_debug_impl(&dword_1D24AE000, v11, OS_LOG_TYPE_DEBUG, "timeZone, date, %@, timeZone, %@, source, timeZoneManager, %@", (uint8_t *)&v16, 0x20u);
    }
  }
  else
  {
...
+ (id)dateFromDate:(id)a3 hour:(int64_t)a4
{
  ...
  double v8 = [v7 components:60 fromDate:v6];
...
+ (id)buildTimeTagIntervalsForDate:(id)a3
{
  ...
  double v8 = (void *)[v6 initWithStartDate:v7 duration:10800.0];
  double v9 = [(MOTimeTagInterval *)v5 initWithTimeTag:8 dateInterval:v8];
  [v4 addObject:v9];

  uint64_t v10 = [MOTimeTagInterval alloc];
  id v11 = objc_alloc(MEMORY[0x1E4F28C18]);
  id v12 = +[MOTime dateFromDate:v3 hour:3];
  id v13 = (void *)[v11 initWithStartDate:v12 duration:21600.0];
  ...
  __int16 v18 = (void *)[v16 initWithStartDate:v17 duration:10800.0];
  ...
  uint64_t v22 = +[MOTime dateFromDate:v3 hour:12];
  id v23 = (void *)[v21 initWithStartDate:v22 duration:10800.0];
  uint64_t v24 = [(MOTimeTagInterval *)v20 initWithTimeTag:4 dateInterval:v23];
  [v4 addObject:v24];

  v25 = [MOTimeTagInterval alloc];
  id v26 = objc_alloc(MEMORY[0x1E4F28C18]);
  v27 = +[MOTime dateFromDate:v3 hour:15];
  v28 = (void *)[v26 initWithStartDate:v27 duration:10800.0];
  ...
  v33 = (void *)[v31 initWithStartDate:v32 duration:10800.0];
  ...
  v38 = (void *)[v36 initWithStartDate:v37 duration:10800.0];
...
+ (id)buildSimpleTimeTagIntervalsForDate:(id)a3
{
  ...
  double v8 = (void *)[v6 initWithStartDate:v7 duration:32400.0];
  double v9 = [(MOTimeTagInterval *)v5 initWithTimeTag:2 dateInterval:v8];
  [v4 addObject:v9];

  uint64_t v10 = [MOTimeTagInterval alloc];
  id v11 = objc_alloc(MEMORY[0x1E4F28C18]);
  id v12 = +[MOTime dateFromDate:v3 hour:12];
  id v13 = (void *)[v11 initWithStartDate:v12 duration:21600.0];
  ...
  __int16 v20 = [MOTimeTagInterval alloc];
  id v21 = objc_alloc(MEMORY[0x1E4F28C18]);
  uint64_t v22 = +[MOTime dateFromDate:v3 hour:21];
  id v23 = (void *)[v21 initWithStartDate:v22 duration:21600.0];
  uint64_t v24 = [(MOTimeTagInterval *)v20 initWithTimeTag:7 dateInterval:v23];
  [v4 addObject:v24];
  ...
  v28 = (void *)[v26 initWithStartDate:v27 duration:21600.0];
...
+ (unint64_t)timetagFromStartDate:(id)a3 endDate:(id)a4
{
    ...
    || ([v6 timeIntervalSinceDate:v5], v7 <= 43200.0))
  {
    ...
    uint64_t v10 = [v8 countByEnumeratingWithState:&v39 objects:v52 count:16];
    if (v10)
    {
      uint64_t v12 = v10;
...
LABEL_9:
      ...
      while (1)
      {
        ...
        if (v16 > 0.0)
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = v33;
            ...
            __int16 v50 = 2048;
            double v51 = v17;
            _os_log_debug_impl(&dword_1D24AE000, v18, OS_LOG_TYPE_DEBUG, "timeOfDay, startDate, %@, endDate, %@, interval, %@, score, %f", buf, 0x2Au);
          }
        }
        if (v17 > 0.7) {
          break;
        ...
        if (v12 == ++v14)
        {
          uint64_t v12 = [v8 countByEnumeratingWithState:&v39 objects:v52 count:16];
          if (v12) {
            goto LABEL_9;
          }
          goto LABEL_19;
...
LABEL_19:
      ...
      long long v36 = 0u;
      double v8 = v19;
      uint64_t v20 = [v8 countByEnumeratingWithState:&v35 objects:v43 count:16];
      if (!v20)
      {
LABEL_31:
        unint64_t v9 = 0;
...
LABEL_21:
      ...
      while (1)
      {
        ...
        if (v25 > 0.0)
        {
          ...
          if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
          {
            *(_DWORD *)buf = v34;
            ...
            __int16 v50 = 2048;
            double v51 = v26;
            _os_log_debug_impl(&dword_1D24AE000, v27, OS_LOG_TYPE_DEBUG, "timeOfDay, startDate, %@, endDate, %@, interval, %@, score, %f", buf, 0x2Au);
          }
        }
        if (v26 > 0.7) {
          break;
        ...
        if (v22 == ++v24)
        {
          uint64_t v22 = [v8 countByEnumeratingWithState:&v35 objects:v43 count:16];
          if (v22) {
            goto LABEL_21;
          }
          goto LABEL_31;
    ...
    _os_log_debug_impl(&dword_1D24AE000, v28, OS_LOG_TYPE_DEBUG, "timeOfDay, startDate, %@, endDate, %@, timetag, %lu(%@)", buf, 0x2Au);

LABEL_35:
    unint64_t v9 = [v15 timetag];
    goto LABEL_36;
  }
      ...
      while (2)
      {
        for (uint64_t i = 0; i != v12; ++i)
        {
          ...
          if (v17 > 0.7)
          {
            ...
            {
              uint64_t v21 = [v15 timetag];
              uint64_t v22 = +[MOTime timeStringFromTimeTag:](MOTime, "timeStringFromTimeTag:", [v15 timetag]);
              *(_DWORD *)buf = v23;
              id v29 = v5;
              __int16 v30 = 2112;
              id v31 = v6;
              ...
              _os_log_debug_impl(&dword_1D24AE000, v19, OS_LOG_TYPE_DEBUG, "timeOfDay, startDate, %@, endDate, %@, timetag, %lu(%@)", buf, 0x2Au);
            }
            unint64_t v9 = [v15 timetag];
            goto LABEL_23;
          }
        }
        uint64_t v12 = [v8 countByEnumeratingWithState:&v24 objects:v36 count:16];
        if (v12) {
          continue;
        }
        break;
...
+ (id)buildSimpleMealTagIntervalsForDate:(id)a3
{
  ...
  double v8 = (void *)[v6 initWithStartDate:v7 duration:18000.0];
  unint64_t v9 = [(MOTimeTagInterval *)v5 initWithTimeTag:2000 dateInterval:v8];
  [v4 addObject:v9];

  uint64_t v10 = [MOTimeTagInterval alloc];
  id v11 = objc_alloc(MEMORY[0x1E4F28C18]);
  uint64_t v12 = +[MOTime dateFromDate:v3 hour:11];
  uint64_t v13 = (void *)[v11 initWithStartDate:v12 duration:10800.0];
  ...
  __int16 v18 = (void *)[v16 initWithStartDate:v17 duration:14400.0];
          ...
          if (v16 > 0.0)
          {
            ...
            if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
            {
              *(_DWORD *)buf = v23;
              ...
              __int16 v34 = 2048;
              double v35 = v17;
              _os_log_debug_impl(&dword_1D24AE000, v18, OS_LOG_TYPE_DEBUG, "mealType, startDate, %@, endDate, %@, interval, %@, score, %f", buf, 0x2Au);
            }
          }
          if (v17 > 0.7)
          {
            ...
            if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = v23;
              ...
              __int16 v34 = 2112;
              double v35 = *(double *)&v22;
              _os_log_debug_impl(&dword_1D24AE000, v19, OS_LOG_TYPE_DEBUG, "mealType, startDate, %@, endDate, %@, timetag, %lu(%@)", buf, 0x2Au);
            }
            unint64_t v8 = [v15 timetag];
            goto LABEL_21;
          }
        }
        uint64_t v12 = [v9 countByEnumeratingWithState:&v24 objects:v36 count:16];
        if (v12) {
          continue;
        }
        break;
...
+ (id)timeOfDayPrefixFromStartDate:(id)a3 endDate:(id)a4
{
  ...
  unint64_t v8 = _mo_log_facility_get_os_log(MOLogFacilityEventBundleManager);
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    __int16 v18 = +[MOTime timeStringFromTimeTag:v7];
    int v19 = 138413058;
    id v20 = v5;
    __int16 v21 = 2112;
    id v22 = v6;
    ...
    __int16 v25 = 2112;
    long long v26 = v18;
    _os_log_debug_impl(&dword_1D24AE000, v8, OS_LOG_TYPE_DEBUG, "timeOfDay, startDate, %@, endDate, %@, timeTag, %lu(%@)", (uint8_t *)&v19, 0x2Au);
  }
...
+ (id)dayOfWeekFromStartDate:(id)a3 endDate:(id)a4 timeZoneManager:(id)a5
{
  ...
  if (!v9)
  {
    double v11 = [MEMORY[0x1E4F1CAF0] systemTimeZone];
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v33 = 2112;
    __int16 v34 = v10;
    _os_log_debug_impl(&dword_1D24AE000, v12, OS_LOG_TYPE_DEBUG, "timeZone, startDate, %@, timeZone, %@, source, timeZoneManager, %@", (uint8_t *)&v29, 0x20u);
  }
...
LABEL_13:
    ...
    if (v22)
    {
      ...
      uint64_t v27 = [(MOTime *)v25 initWithTimestamp:v22 timeString:v26 timeZone:v21 timeTag:v24];
    }
    else
    {
      uint64_t v27 = 0;
...
+ (id)localizedDateStringFromDate:(id)a3
{
  return (id)[MEMORY[0x1E4F28C10] localizedStringFromDate:a3 dateStyle:2 timeStyle:0];
}
    ...
    if (v8 && [v8 isBeforeDate:v7])
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        *(void *)&uint8_t buf[4] = v7;
        ...
        __int16 v31 = 2112;
        id v32 = v9;
        _os_log_impl(&dword_1D24AE000, v10, OS_LOG_TYPE_INFO, "typeOfDayTagFromStartDate, startDate, %@, endDate, %@, timeZone, %@, the timestamps are inverted.", buf, 0x20u);
      }
    ...
    if ([v8 isBeforeDate:v11])
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        *(void *)&uint8_t buf[4] = v11;
        ...
        __int16 v31 = 2112;
        id v32 = v9;
        _os_log_impl(&dword_1D24AE000, v14, OS_LOG_TYPE_INFO, "typeOfDayTagFromStartDate, startDate, %@, endDate, %@, timeZone, %@, the timestamps are inverted after time zone shifting.", buf, 0x20u);
      }
...
LABEL_17:
    ...
    id v27 = 0;
    *(void *)buf = 0;
    int v16 = [v15 rangeOfWeekendStartDate:&v27 interval:buf containingDate:v11];
    id v17 = v27;
    BOOL v18 = v17;
    if (!v8)
    {
...
LABEL_34:
    ...
    int v19 = (void *)[objc_alloc(MEMORY[0x1E4F28C18]) initWithStartDate:v11 endDate:v8];
    [v19 duration];
    if (v20 == 0.0)
    {
      unint64_t v13 = 0;
LABEL_33:
    ...
    id v21 = objc_alloc(MEMORY[0x1E4F28C18]);
    id v22 = (void *)[v21 initWithStartDate:v18 duration:*(double *)buf];
...
+ (unint64_t)dateReferenceTagFromStartDate:(id)a3 endDate:(id)a4
{
  ...
  id v7 = a3;
  id v8 = [v5 date];
  unint64_t v9 = +[MOTime dateReferenceTagFromStartDate:v7 endDate:v6 nowDate:v8 timeZone:0];
...
+ (unint64_t)dateReferenceTagFromStartDate:(id)a3 endDate:(id)a4 timeZone:(id)a5
{
  ...
  id v10 = a3;
  double v11 = [v7 now];
  unint64_t v12 = +[MOTime dateReferenceTagFromStartDate:v10 endDate:v9 nowDate:v11 timeZone:v8];
...
- (id)description
{
  ...
  [(MOTime *)self timestamp];
  uint64_t v6 = v5;
  id v7 = [(MOTime *)self timeString];
  id v8 = [(MOTime *)self timeZone];
  id v9 = [(MOTime *)self localTime];
  id v10 = [v3 stringWithFormat:@"<MOTime identifier, %@, timestamp, %f, timeString, %@, timeZone, %@, localTime, %@, timeTag, %lu, dateReferenceTag, %lu>", v4, v6, v7, v8, v9, -[MOTime timeTag](self, "timeTag"), -[MOTime dateReferenceTag](self, "dateReferenceTag")];
...
- (MOTime)initWithCoder:(id)a3
{
  ...
  uint64_t v10 = [v4 decodeInt64ForKey:@"timeTag"];
  uint64_t v11 = [v4 decodeInt64ForKey:@"dateReferenceTag"];
  ...
  else
  {
    if (v5)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        if (v8 || ([(MOTime *)v7 identifier], (unint64_t v3 = objc_claimAutoreleasedReturnValue()) != 0))
        {
          id v9 = [(MOTime *)self identifier];
          uint64_t v10 = [(MOTime *)v7 identifier];
...
+ (void)timeFromStartDate:endDate:timeZoneManager:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1_1(&dword_1D24AE000, v0, v1, "timeZone, date, %@, timeZone, %@, source, system");
}

+ (void)timetagFromStartDate:endDate:.cold.1()
{
  OUTLINED_FUNCTION_0_1();
  OUTLINED_FUNCTION_1_1(&dword_1D24AE000, v0, v1, "timeOfDay, startDate, %@, endDate, %@, skip");
}

+ (void)dayOfWeekFromStartDate:endDate:timeZoneManager:.cold.1()
{
  OUTLINED_FUNCTION_0_1();
  OUTLINED_FUNCTION_1_1(&dword_1D24AE000, v0, v1, "timeZone, startDate, %@, timeZone, %@, source, system");
}

+ (void)dayOfWeekFromStartDate:endDate:timeZoneManager:.cold.2()
{
  OUTLINED_FUNCTION_0_1();
  OUTLINED_FUNCTION_1_1(&dword_1D24AE000, v0, v1, "timeZone crossing, timeZone, %@, endTimeZone, %@");
}

+ (void)dayOfWeekFromStartDate:endDate:timeZoneManager:.cold.3()
{
  OUTLINED_FUNCTION_0_1();
  OUTLINED_FUNCTION_1_1(&dword_1D24AE000, v0, v1, "timeZone, endDate, %@, timeZone, %@, source, system");
}
...
+ (void)dayOfWeekTagFromDate:(NSObject *)a3 .cold.1(uint64_t a1, void *a2, NSObject *a3)
{
  ...
  _os_log_error_impl(&dword_1D24AE000, a3, OS_LOG_TYPE_ERROR, "dayOfWeekTagFromDate, cannot read weekday, date, %@, weekday, %lu", v4, 0x16u);
}
...
+ (void)dayOfWeekTagFromDate:(NSObject *)a3 .cold.2(uint64_t a1, void *a2, NSObject *a3)
{
  ...
  [a2 weekday];
  OUTLINED_FUNCTION_2_0();
  _os_log_debug_impl(&dword_1D24AE000, a3, OS_LOG_TYPE_DEBUG, "dayOfWeekTagFromDate, date, %@, weekday, %lu", v4, 0x16u);
}
