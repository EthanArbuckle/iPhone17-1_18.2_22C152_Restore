...
- (MOWatchDog)initWithName:(id)a3 cadenceInSeconds:(float)a4 andHandler:(id)a5
{
  ...
  if (v10)
  {
    ...
    *((void *)v10 + 4) = v16;
    ...
    dispatch_source_t v18 = dispatch_source_create(MEMORY[0x1E4F14490], 0, 0, *((dispatch_queue_t *)v10 + 4));
    v19 = (void *)*((void *)v10 + 3);
    *((void *)v10 + 3) = v18;
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 134218754;
      ...
      __int16 v24 = 1024;
      int v25 = v8;
      _os_log_impl(&dword_1D24AE000, v5, OS_LOG_TYPE_DEFAULT, "Watch dog [0x%p:%s] was not petted on time; [%f] seconds elapsed, this happened %i time(s) before!",
        buf,
        0x26u);
    }

    ++*((_DWORD *)v2 + 5);
    id v9 = objc_msgSend(v2[1], "copy", @"Name");
    v17[0] = v9;
    ...
    v17[1] = v10;
    v17[2] = &unk_1F2932368;
    uint64_t v11 = [MEMORY[0x1E4F1C9E8] dictionaryWithObjects:v17 forKeys:v16 count:3];
    AnalyticsSendEvent();
...
- (void)dealloc
{
  ...
  OUTLINED_FUNCTION_1_3(&dword_1D24AE000, v1, v2, "Watch dog [0x%p:%s] destructing", v3, v4, v5, v6, v7);
}
...
- (void)_pet
{
  ...
  if (self->_failureCount)
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
    {
      ...
      _os_log_impl(&dword_1D24AE000, v3, OS_LOG_TYPE_DEFAULT, "Watch dog [0x%p:%s] recovered from %i earlier failures!", (uint8_t *)&v10, 0x1Cu);
    }
  }
...
- (void)_cancel
{
  ...
  OUTLINED_FUNCTION_3_0(v0);
  OUTLINED_FUNCTION_0_8();
  OUTLINED_FUNCTION_1_3(&dword_1D24AE000, v1, v2, "Watch dog [0x%p:%s] canceling check-in callback", v3, v4, v5, v6, v7);
}
...
void __55__MOWatchDog_initWithName_cadenceInSeconds_andHandler___block_invoke_cold_1()
{
  ...
  OUTLINED_FUNCTION_0_8();
  _os_log_fault_impl(&dword_1D24AE000, v0, OS_LOG_TYPE_FAULT, "Watch dog [0x%p:%s] died of no petting - Exiting process!", v2, 0x16u);
}
...
- (void)setCadenceSeconds:(os_log_t)log .cold.1(os_log_t log, float a2)
{
  ...
  int v2 = 134217984;
  double v3 = a2;
  _os_log_error_impl(&dword_1D24AE000, log, OS_LOG_TYPE_ERROR, "Invalid cadence value %f", (uint8_t *)&v2, 0xCu);
}
...
- (double)_pet
{
  ...
  uint64_t v3 = [*(id *)(v2 + 8) UTF8String];
  ...
  __int16 v10 = 2048;
  double v11 = v4;
  _os_log_debug_impl(&dword_1D24AE000, v0, OS_LOG_TYPE_DEBUG, "Watch dog [0x%p:%s] scheduling check-in callback (%f seconds timeout)", (uint8_t *)&v6, 0x20u);
  return result;
}
