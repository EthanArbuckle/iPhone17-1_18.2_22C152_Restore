...
- (id)runBlockStarted:(id)a3 withConnectionError:(id)a4
{
  ...
  if (v6)
  {
    ...
    v14[0] = @"requestBlock";
    id v10 = (void *)MEMORY[0x1D26067D0](v6);
    v14[1] = @"interruptionBlock";
    v15[0] = v10;
    id v11 = (void *)MEMORY[0x1D26067D0](v7);
    v15[1] = v11;
...
- (id)onConnectionInterrupted
{
  ...
  v2 = (void *)MEMORY[0x1D26067D0](v8);
  id v6 = (void *)MEMORY[0x1D26067D0](v2, v3, v4, v5);
...
void __39__MOConnection_onConnectionInterrupted__block_invoke_cold_1(uint64_t a1, uint64_t a2, NSObject *a3)
{
  ...
  __int16 v8 = 2048;
  uint64_t v9 = a2;
  _os_log_fault_impl(&dword_1D24AE000, a3, OS_LOG_TYPE_FAULT, "[%s] The connection has been interrupted with %lu pending tasks", (uint8_t *)&v6, 0x16u);
}
...
void __39__MOConnection_onConnectionInterrupted__block_invoke_cold_2(uint64_t a1, NSObject *a2)
{
  ...
  int v4 = 136315138;
  uint64_t v5 = v3;
  _os_log_error_impl(&dword_1D24AE000, a2, OS_LOG_TYPE_ERROR, "[%s] The connection has been interrupted with zero pending tasks", (uint8_t *)&v4, 0xCu);
}
