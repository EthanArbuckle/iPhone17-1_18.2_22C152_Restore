...
void __49__TPSBatteryUIValidation_validateWithCompletion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  id v5 = a3;
...
- (BOOL)getCurrentState
{
  return MEMORY[0x1F4145DD8](self, a2);
}
...
- (void)getCurrentStateWithCompletion:(id)a3
{
  id v5 = NSNumber;
  id v6 = a3;
  objc_msgSend(v5, "numberWithBool:", -[TPSBatteryUIValidation getCurrentState](self, "getCurrentState"));
