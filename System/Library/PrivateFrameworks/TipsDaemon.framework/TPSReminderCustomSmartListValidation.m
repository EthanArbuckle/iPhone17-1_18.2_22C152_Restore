@interface TPSReminderCustomSmartListValidation
- (void)validateWithCompletion:(id)a3;
@end

@implementation TPSReminderCustomSmartListValidation
...
- (void)validateWithCompletion:(id)a3
{
  ...
  id v11 = 0;
  int v7 = [v6 containsCustomSmartListForTipKitWithError:&v11];
  id v8 = v11;
