...
- (void)validateWithCompletion:(id)a3
{
  ...
  v5 = (uint64_t (*)(void))getPKPeerPaymentIsSetupSymbolLoc_ptr;
  v14 = getPKPeerPaymentIsSetupSymbolLoc_ptr;
  if (!getPKPeerPaymentIsSetupSymbolLoc_ptr)
  {
    v10[0] = MEMORY[0x1E4F143A8];
    v10[1] = 3221225472;
    v10[2] = __getPKPeerPaymentIsSetupSymbolLoc_block_invoke;
    v10[3] = &unk_1E6E6AE20;
    v10[4] = &v11;
    __getPKPeerPaymentIsSetupSymbolLoc_block_invoke((uint64_t)v10);
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG)) {
    [(TPSAppleCashValidation *)self validateWithCompletion:v8];
  }
