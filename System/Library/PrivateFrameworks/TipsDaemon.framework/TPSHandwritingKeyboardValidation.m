    ...
    if (v7)
    {
      ...
      while (2)
      {
        for (i = 0; i != v7; i = ((char *)i + 1))
        {
          ...
          if (+[TPSKeyboardUtilities isHandwritingEnabledForInputMode:](TPSKeyboardUtilities, "isHandwritingEnabledForInputMode:", v10, (void)v13))
          {
            v7 = [MEMORY[0x1E4FAF480] default];
            if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
            {
              *(_DWORD *)buf = 138412290;
              uint64_t v18 = v10;
              _os_log_impl(&dword_1E4492000, v7, OS_LOG_TYPE_DEFAULT, "Handwriting keyboard enabled: %@", buf, 0xCu);
            }
