...
- (void)validateWithCompletion:(id)a3
{
  ...
  v5 = (uint64_t (*)(void))getPKPeerPaymentHasCashFamilyAccountsSymbolLoc_ptr;
  v14 = getPKPeerPaymentHasCashFamilyAccountsSymbolLoc_ptr;
  if (!getPKPeerPaymentHasCashFamilyAccountsSymbolLoc_ptr)
  {
    v10[0] = MEMORY[0x1E4F143A8];
    v10[1] = 3221225472;
    v10[2] = __getPKPeerPaymentHasCashFamilyAccountsSymbolLoc_block_invoke;
    v10[3] = &unk_1E6E6AE20;
    v10[4] = &v11;
    __getPKPeerPaymentHasCashFamilyAccountsSymbolLoc_block_invoke((uint64_t)v10);
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG)) {
    [(TPSAppleCashFamilyValidation *)self validateWithCompletion:v8];
  }
