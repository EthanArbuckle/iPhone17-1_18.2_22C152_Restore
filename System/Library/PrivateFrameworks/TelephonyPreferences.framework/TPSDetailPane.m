...
- (TPSDetailPane)initWithFrame:(CGRect)a3
{
  ...
  if (v7)
  {
    uint64_t v8 = objc_msgSend(objc_alloc(MEMORY[0x1E4FB1D00]), "initWithFrame:style:", 1, x, y, width, height);
    ...
    uint64_t v10 = [objc_alloc(MEMORY[0x1E4FB1D08]) initWithStyle:0 reuseIdentifier:@"TPSDetailTableViewCell"];
