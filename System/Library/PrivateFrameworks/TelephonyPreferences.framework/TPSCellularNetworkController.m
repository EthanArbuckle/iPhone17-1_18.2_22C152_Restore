...
- (TPSCellularNetworkController)initWithSubscriptionContext:(id)a3
{
  ...
  if (v6)
  {
    ...
    [(TPSController *)v7->_registrationController addDelegate:v7 queue:MEMORY[0x1E4F14428]];
...
- (void)setNetworkItems:(id)a3
{
  ...
  MEMORY[0x1F41817F8](p_networkItems, v5);
}
...
- (void)setSelectedNetworkItem:(id)a3
{
  ...
  MEMORY[0x1F41817F8](p_selectedNetworkItem, v5);
}
...
- (void)setNetworks:(id)a3
{
  ...
  if (self->_networks != v5)
  {
    ...
    if (v5)
    {
      id v6 = objc_msgSend(MEMORY[0x1E4F1CA48], "arrayWithCapacity:", -[NSArray count](v5, "count"));
      long long v13 = 0u;
      long long v14 = 0u;
      long long v15 = 0u;
      long long v16 = 0u;
...
- (id)networkItemAtIndex:(int64_t)a3
{
  ...
  if (a3 < 0 || [v4 count] <= (unint64_t)a3)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR)) {
      -[TPSCellularNetworkController networkItemAtIndex:](a3, v7);
    }
...
- (void)selectNetworkItemAtIndex:(unint64_t)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      int v9 = 138412290;
      uint64_t v10 = v6;
      _os_log_impl(&dword_1E4DD4000, v7, OS_LOG_TYPE_DEFAULT, "Requesting manual selection of network %@.", (uint8_t *)&v9, 0xCu);
    }

    uint64_t v8 = [(TPSCellularNetworkController *)self registrationController];
    [v8 selectNetwork:v6];
  }
}
...
- (id)networkItemForNetwork:(id)a3
{
  ...
  uint64_t v8 = [(TPSCellularNetworkItem *)v4 initWithIdentifier:v5 name:v6 localizedName:v7];
  return v8;
}
...
- (void)networksChangedForRegistrationController:(id)a3
{
  ...
  if (v5 == v4)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      id v7 = v10;
      _os_log_impl(&dword_1E4DD4000, v6, OS_LOG_TYPE_DEFAULT, "%@ is handling networks changed delegate callback.", (uint8_t *)&v9, 0xCu);
    }
    uint64_t v8 = [v4 networks];
...
- (void)networkSelectionInfoChangedForRegistrationController:(id)a3
{
  ...
  if (v5 == v4)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      id v10 = (id)objc_opt_class();
      id v7 = v10;
      _os_log_impl(&dword_1E4DD4000, v6, OS_LOG_TYPE_DEFAULT, "%@ is handling networks selection information changed delegate callback.", (uint8_t *)&v9, 0xCu);
    }
    uint64_t v8 = [v4 networkSelectionInfo];
...
- (void)networkItemAtIndex:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  int v2 = 134217984;
  uint64_t v3 = a1;
  _os_log_error_impl(&dword_1E4DD4000, a2, OS_LOG_TYPE_ERROR, "Could not find network item at index %ld", (uint8_t *)&v2, 0xCu);
}
