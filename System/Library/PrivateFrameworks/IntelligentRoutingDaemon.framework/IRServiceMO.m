...
+ (void)setPropertiesOfServiceMO:(id)a3 withServiceDO:(id)a4
{
  ...
  uint64_t v9 = [v5 servicePackage];
  [v10 setServicePackage:v9];
}

+ (id)fetchRequest
{
  return (id)[MEMORY[0x263EFF260] fetchRequestWithEntityName:@"IRServiceMO"];
}
...
+ (id)MOService:(id)a3 inManagedObjectContext:(id)a4
{
  ...
  uint64_t v9 = [(IRServiceMO *)v7 candidatesContainer];
  [v9 setService:v7];

  id v10 = [[IRHistoryEventsContainerMO alloc] initWithContext:v5];
