...
+ (id)fetchRequest
{
  return (id)[MEMORY[0x263EFF260] fetchRequestWithEntityName:@"IRNodeMO"];
}
...
+ (void)setPropertiesOfNodeMO:(id)a3 withNodeDO:(id)a4
{
  id v15 = a3;
  id v5 = a4;
  id v6 = [v5 avOutputDevice];

  if (v6)
  {
    id v7 = [v15 avOutputDevice];
  ...
  objc_msgSend(v15, "setIsLocal:", objc_msgSend(v5, "isLocal"));
}
...
- (id)convert
{
  ...
  id v5 = [(IRNodeMO *)self rapportIdentifier];
  id v6 = [(IRNodeMO *)self idsIdentifier];
  id v7 = [(IRNodeMO *)self avOutputDevice];
  v8 = [v7 convert];
