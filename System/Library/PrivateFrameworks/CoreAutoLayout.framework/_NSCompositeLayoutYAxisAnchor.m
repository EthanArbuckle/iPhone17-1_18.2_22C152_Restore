@interface _NSCompositeLayoutYAxisAnchor
...
- (_NSCompositeLayoutYAxisAnchor)initWithAnchor:(id)a3 plusDimension:(id)a4 times:(double)a5 plus:(double)a6
{
  ...
  if (v10)
  {
    v10->_yAxisAnchor = (NSLayoutYAxisAnchor *)[a3 copy];
...
- (_NSCompositeLayoutYAxisAnchor)initWithAnchor:(id)a3
{
  ...
  if (v4)
  {
    v4->_yAxisAnchor = (NSLayoutYAxisAnchor *)[*((id *)a3 + 8) copy];
...
- (_NSCompositeLayoutYAxisAnchor)initWithCoder:(id)a3
{
  ...
  if (v4)
  {
    ...
    v4->_yAxisAnchor = (NSLayoutYAxisAnchor *)[v5 copy];
...
- (void)encodeWithCoder:(id)a3
{
  ...
  [a3 encodeObject:self->_yAxisAnchor forKey:@"NSLayoutAnchor_firstChildAnchor"];
  if (dimension)
  {
...
- (id)_expressionInContext:(id *)a3
{
  ...
  id v17 = var2;
  id v8 = [(NSLayoutAnchor *)yAxisAnchor _expressionInContext:&v16];
  objc_super v9 = v8;
  if (dimension)
  {
    long long v16 = v15;
    id v17 = var2;
    dimension = [(NSLayoutAnchor *)dimension _expressionInContext:&v16];
    uint64_t v10 = [v9 variableCount];
    if (dimension)
    {
      uint64_t v11 = [(NSLayoutDimension *)dimension variableCount];
      char v12 = 0;
      goto LABEL_6;
    }
  }
  ...
  {
    uint64_t v10 = [v8 variableCount];
  }
  uint64_t v11 = 0;
  char v12 = 1;
LABEL_6:
  id v13 = +[NSISLinearExpression newExpressionWithCapacity:v11 + v10 engine:var2];
  [v13 addExpression:v9 times:1.0];
  if ((v12 & 1) == 0) {
    [v13 addExpression:dimension times:dimensionMultiplier];
  }
  [v13 incrementConstant:constant];
  return v13;
}
...
- (id)equationDescription
{
  ...
  double dimensionMultiplier = self->_dimensionMultiplier;
  double constant = self->_constant;
  v5 = objc_msgSend(MEMORY[0x1E4F28E78], "stringWithFormat:", @"(%@"), -[NSLayoutAnchor _equationDescriptionInParent](self->_yAxisAnchor, "_equationDescriptionInParent");
  objc_super v6 = v5;
  if (dimension)
  {
