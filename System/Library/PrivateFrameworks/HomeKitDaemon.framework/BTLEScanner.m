...
- (void)_checkCanScan
{
  ...
  if ([(BTLEScanner *)self countForQueue:@"ScanQueue"])
  {
    ...
    id v14 = objc_alloc_init(MEMORY[0x263F38528]);
    v15 = v14;
    if (v2)
    {
...
void __28__BTLEScanner__checkCanScan__block_invoke_3(uint64_t a1)
{
  ...
  v23 = __Block_byref_object_copy__75473;
  v24 = __Block_byref_object_dispose__75474;
  id v25 = 0;
  uint64_t v16 = 0;
  v17 = &v16;
...
uint64_t __28__BTLEScanner__checkCanScan__block_invoke_20(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v30 = 2112;
    v31 = v15;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Scan result -- looking for %@ found %@", buf, 0x20u);
...
void __32__BTLEScanner_sharedBTLEScanner__block_invoke(uint64_t a1)
{
  ...
  uint64_t v2 = (void *)sharedBTLEScanner_sharedScanner;
