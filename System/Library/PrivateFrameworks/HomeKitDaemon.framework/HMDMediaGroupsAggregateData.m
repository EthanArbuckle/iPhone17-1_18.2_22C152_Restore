...
- (id)sentinelGroup
{
  ...
  id v3 = objc_alloc(MEMORY[0x263F0E4D8]);
  v4 = (void *)[v3 initWithIdentifier:v2 parentIdentifier:v2 name:&stru_26E2EB898 defaultName:0 destinationIdentifiers:MEMORY[0x263EFFA68] associatedGroupIdentifier:0];
...
{
  v2 = [(HMDMediaGroupsAggregateData *)self sentinelIdentifier];
  id v3 = (void *)[objc_alloc(MEMORY[0x263F0E4C0]) initWithUniqueIdentifier:v2 parentIdentifier:v2 supportedOptions:0];
...
{
  v2 = [(HMDMediaGroupsAggregateData *)self sentinelIdentifier];
  id v3 = objc_alloc(MEMORY[0x263F0E4D0]);
  v4 = (void *)[v3 initWithIdentifier:v2 parentIdentifier:v2 destinationIdentifier:0 supportedOptions:0 availableDestinationIdentifiers:MEMORY[0x263EFFA68]];
...
- (id)encodedMediaGroupEvents
{
    ...
    if (v9)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v10; ++i)
        {
          ...
          id v14 = objc_alloc(MEMORY[0x263F0E4F8]);
  ...
  else
  {
    ...
    id v17 = objc_alloc(MEMORY[0x263F0E4F8]);
...
- (id)encodedDestinationControllerEvents
{
  ...
  {
    v5 = [(HMDMediaGroupsAggregateData *)self destinationControllersData];
    unint64_t v6 = objc_msgSend(v5, "na_map:", &__block_literal_global_20);
  }
  else
  {
    v5 = [(HMDMediaGroupsAggregateData *)self sentinelDestinationControllerData];
    id v7 = objc_alloc(MEMORY[0x263F0E4F0]);
    v8 = [v5 encodeToProtoBufferData];
    uint64_t v9 = (void *)[v7 initWithData:v8];
    v11[0] = v9;
    unint64_t v6 = [MEMORY[0x263EFF8C0] arrayWithObjects:v11 count:1];
  }
  return v6;
}
...
{
  v2 = (objc_class *)MEMORY[0x263F0E4F0];
  id v3 = a2;
  id v4 = [v2 alloc];
...
- (id)encodedDestinationEvents
{
  ...
  {
    v5 = [(HMDMediaGroupsAggregateData *)self destinations];
    unint64_t v6 = objc_msgSend(v5, "na_map:", &__block_literal_global_16);
  }
  else
  {
    v5 = [(HMDMediaGroupsAggregateData *)self sentinelDestination];
    id v7 = objc_alloc(MEMORY[0x263F0E4E0]);
    v8 = [v5 encodeToProtoBufferData];
    uint64_t v9 = (void *)[v7 initWithData:v8];
    v11[0] = v9;
    unint64_t v6 = [MEMORY[0x263EFF8C0] arrayWithObjects:v11 count:1];
...
{
  v2 = (objc_class *)MEMORY[0x263F0E4E0];
  id v3 = a2;
  id v4 = [v2 alloc];
  v5 = [v3 encodeToProtoBufferData];
...
- (id)encodeToProtoBufferData
{
  id v3 = objc_alloc_init(MEMORY[0x263F0E4E8]);
...
- (id)decodeMediaGroupsWithEncodedMediaGroups:(id)a3
{
  id v4 = objc_msgSend(a3, "na_map:", &__block_literal_global_10);
  if ([v4 count] == 1
    && ([v4 firstObject],
...
{
  v2 = (objc_class *)MEMORY[0x263F0E4D8];
  id v3 = a2;
  id v4 = [v2 alloc];
  v5 = [v3 data];
...
- (id)decodeDestinationControllersWithEncodedDestinationControllers:(id)a3
{
  ...
  id v4 = a3;
  v5 = objc_msgSend(v4, "na_map:", &__block_literal_global_6_79839);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v18 = 2112;
      id v19 = v4;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode destination controllers data in proto data: %@", (uint8_t *)&v16, 0x16u);
    }
    id v10 = 0;
  }
...
{
  v2 = (objc_class *)MEMORY[0x263F0E4D0];
  id v3 = a2;
  id v4 = [v2 alloc];
  v5 = [v3 data];
...
- (id)decodeDestinationsWithEncodedDestinations:(id)a3
{
  uint64_t v20 = *MEMORY[0x263EF8340];
  id v4 = a3;
  v5 = objc_msgSend(v4, "na_map:", &__block_literal_global_79843);
  uint64_t v6 = [v5 count];
  if (v6 == [v4 count])
  {
    if ([v5 count] == 1
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v18 = 2112;
      id v19 = v4;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode destinations in proto data: %@", (uint8_t *)&v16, 0x16u);
    }
    id v10 = 0;
  }
...
{
  v2 = (objc_class *)MEMORY[0x263F0E4C0];
  id v3 = a2;
  id v4 = [v2 alloc];
  v5 = [v3 data];
...
- (HMDMediaGroupsAggregateData)initWithProtoBufferData:(id)a3
{
  ...
  id v4 = a3;
  v5 = (void *)[objc_alloc(MEMORY[0x263F0E4E8]) initWithData:v4];
  uint64_t v6 = v5;
  if (v5)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v4;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode event data: %@", (uint8_t *)&v19, 0x16u);
    }
    id v14 = 0;
  }
...
- (HMDMediaGroupsAggregateData)initWithDestinations:(id)a3 destinationControllersData:(id)a4
{
  return [(HMDMediaGroupsAggregateData *)self initWithDestinations:a3 destinationControllersData:a4 groups:MEMORY[0x263EFFA68]];
}
