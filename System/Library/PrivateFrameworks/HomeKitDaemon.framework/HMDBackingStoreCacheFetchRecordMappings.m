...
- (id)mainReturningError
{
  ...
  v24 = __Block_byref_object_copy__23660;
  v25 = __Block_byref_object_dispose__23661;
  id v26 = 0;
...
LABEL_5:
  ...
  if (v11)
  {
    ...
    uint64_t v21 = objc_msgSend(MEMORY[0x263F425D0], "hmf_cachedInstanceForNSString:", v12);
    v22 = objc_msgSend(MEMORY[0x263F425D0], "hmf_cachedInstanceForNSString:", v13);
