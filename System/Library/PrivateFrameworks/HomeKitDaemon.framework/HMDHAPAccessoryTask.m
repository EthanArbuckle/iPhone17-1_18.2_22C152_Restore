...
void __42__HMDHAPAccessoryTask__updatedCompletion___block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v12 = 138543362;
      v13 = v10;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Lost self reference for fallback task completion handler", (uint8_t *)&v12, 0xCu);
    }
...
void __59__HMDHAPAccessoryTask_addCharacteristicResponses_isRemote___block_invoke(uint64_t a1, void *a2)
{
  ...
  id v3 = [*(id *)(a1 + 32) requestToResponseMap];
  id v4 = [v5 request];
...
- (void)finishTaskWithCharacteristicResponses:(id)a3 completion:(id)a4
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v21 = 2112;
      v22 = v15;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] associated context is already completed: %@", (uint8_t *)&v17, 0x20u);
    }
...
- (void)sendCharacteristicNotificationsForCompletedTask:(id)a3 completion:(id)a4
{
  ...
  id v6 = a3;
  id v27 = a4;
  id v7 = (void *)MEMORY[0x230FBD990](objc_msgSend(v6, "na_each:", &__block_literal_global_145_265183));
  v8 = self;
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v37 = 2112;
    v38 = v8;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@[%@] Sending characteristic notifications for completed task", buf, 0x16u);
  }
  ...
  v18 = objc_msgSend(v17, "na_map:", &__block_literal_global_149_265185);
...
void __82__HMDHAPAccessoryTask_sendCharacteristicNotificationsForCompletedTask_completion___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    v8 = [MEMORY[0x263F087E8] hmErrorWithCode:54];
  }
...
uint64_t __82__HMDHAPAccessoryTask_sendCharacteristicNotificationsForCompletedTask_completion___block_invoke_146(uint64_t a1, void *a2)
{
  return [a2 accessory];
}
...
- (void)_sendCharacteristicNotificationsForTaskInProgress:(id)a3 completion:(id)a4
{
  ...
  id v8 = a4;
  v51 = v7;
  int v9 = objc_msgSend(v7, "na_filter:", &__block_literal_global_131_265190);
  if ([v9 count])
  {
    ...
    if ([v11 isRemote])
    {
      uint64_t v15 = objc_msgSend(v9, "na_map:", &__block_literal_global_142_265197);
    ...
    else
    {
      ...
      uint64_t v26 = [NSDictionary dictionaryWithObjects:v69 forKeys:v68 count:3];

      id v14 = v49;
      id v27 = objc_alloc(MEMORY[0x263F42570]);
      v28 = [v49 uuid];
      uint64_t v29 = [v27 initWithTarget:v28];

      id v30 = objc_alloc(MEMORY[0x263F42590]);
      ...
      v35 = (void *)MEMORY[0x230FBD990](objc_msgSend(v33, "setRequiresSPIEntitlement:", objc_msgSend(v11, "requiresSPIEntitlement")));
      v36 = self;
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v66 = 2112;
        v67 = v40;
        _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] Sending the multi-part responses[%ld] to local client: %@", buf, 0x2Au);

        id v8 = v46;
        __int16 v19 = v45;
      }

      objc_msgSend(v9, "na_each:", &__block_literal_global_137_265196);
      ...
      {
        v44 = [MEMORY[0x263F087E8] hmErrorWithCode:54];
...
void __84__HMDHAPAccessoryTask__sendCharacteristicNotificationsForTaskInProgress_completion___block_invoke_135(uint64_t a1, void *a2)
{
  id v2 = [a2 request];
  [v2 setCompleted:1];
}
...
- (void)sendCharacteristicNotificationsForTaskInProgress:(id)a3 completion:(id)a4
{
  ...
  id v6 = a3;
  id v7 = a4;
  id v8 = objc_msgSend(v6, "na_filter:", &__block_literal_global_127_265202);
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@[%@] Sending characteristic notifications (%ld) for task in progress.", buf, 0x20u);
  }
  if ([v8 count])
  {
    ...
    block[0] = MEMORY[0x263EF8330];
    block[1] = 3221225472;
    block[2] = __83__HMDHAPAccessoryTask_sendCharacteristicNotificationsForTaskInProgress_completion___block_invoke_128;
    block[3] = &unk_264A2EE80;
    void block[4] = v10;
    id v17 = v8;
    id v18 = v7;
...
uint64_t __83__HMDHAPAccessoryTask_sendCharacteristicNotificationsForTaskInProgress_completion___block_invoke_128(uint64_t a1)
{
...
- (unint64_t)completedRequestsCount
{
  ...
  id v3 = objc_msgSend(v2, "na_filter:", &__block_literal_global_265234);
