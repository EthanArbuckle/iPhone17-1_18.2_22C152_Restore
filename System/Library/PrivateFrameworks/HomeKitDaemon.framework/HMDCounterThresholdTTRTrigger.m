...
LABEL_10:
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v33 = 2048;
    int64_t v34 = a5;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@TTR threshold trigger: eventName=%{public}@, radarTitle=%{public}@, value=%lu", (uint8_t *)&v27, 0x2Au);
  }
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
  {
    ...
    int v27 = 138543362;
    v28 = v26;
    _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@Device needs to be primary, but is not; skipping TTR.",
      (uint8_t *)&v27,
      0xCu);
  }
LABEL_15:
