...
- (id)_createReadWriteRequestsForAccessCodeIdentifiers:(id)a3
{
  ...
  id v4 = a3;
  v28 = [MEMORY[0x263F08968] mapTableWithStrongToStrongObjects];
  v29 = v4;
  long long v32 = 0u;
  long long v33 = 0u;
  long long v34 = 0u;
        ...
        if (!v12)
        {
          ...
          if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = v26;
            ...
            __int16 v38 = 2112;
            v39 = v9;
            _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Could not create read write requests because failed to find hap accessory with UUID: %@", buf, 0x16u);
          }
LABEL_19:
        ...
        else
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = v26;
            ...
            __int16 v38 = 2112;
            v39 = v12;
            _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Could not create read write requests because failed to find access code control point characteristic on accessory: %@", buf, 0x16u);
          }
        }
...
- (id)_characteristicsOfType:(id)a3 fromAccessoriesWithUUIDs:(id)a4
{
  ...
  if (v12 == [v10 count])
  {
    ...
    v28 = __86__HMDAccessoryAccessCodeReaderWriter__characteristicsOfType_fromAccessoriesWithUUIDs___block_invoke_126;
    v29 = &unk_264A15158;
    id v13 = v6;
    id v30 = v13;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v39 = 2112;
        v40 = v14;
        _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Could not find access code control point characteristics of type: %@ for all accessories: %@. Found characteristics: %@", buf, 0x2Au);
      }
      id v16 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v37 = 2112;
      __int16 v38 = v11;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Could not find all accessories with UUIDs: %@. Only found the subset of accessories: %@", buf, 0x20u);
    }
    id v16 = 0;
  }
...
uint64_t __86__HMDAccessoryAccessCodeReaderWriter__characteristicsOfType_fromAccessoriesWithUUIDs___block_invoke_126(uint64_t a1, void *a2)
{
...
- (id)_createConstraintsReadRequestsForAccessoriesWithUUIDs:(id)a3
{
  ...
  if (v3)
  {
    uint64_t v5 = objc_msgSend(v3, "na_map:", &__block_literal_global_123);
  }
  else
  {
    uint64_t v5 = 0;
...
- (id)_fetchResponseFromCredentialUserTuples:(id)a3 accessory:(id)a4 doorLock:(id)a5
{
  ...
  id v10 = objc_alloc(MEMORY[0x263F0DF18]);
...
id __96__HMDAccessoryAccessCodeReaderWriter__fetchResponseFromCredentialUserTuples_accessory_doorLock___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v52 = 2112;
    v53 = v9;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Creating fetch response from credential: %@, user: %@", buf, 0x20u);
  }
  id v10 = [v3 user];
  ...
  if ((v15 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      __int16 v56 = 2112;
      v57 = v34;
      _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_INFO, "%{public}@Dropping userUniqueId because the user's creatorFabricIndex does not match the currentFabricIndex. credential: %@, creatorFabricIndex: %@, currentFabricIndex: %@, accessory: %@", buf, 0x34u);
  ...
  int v18 = [v17 isEqualToNumber:*MEMORY[0x263F497C0]];
...
LABEL_11:
    ...
    __int16 v38 = (void *)[objc_alloc(MEMORY[0x263F0DEF8]) initWithStringValue:v37];
    id v39 = objc_alloc(MEMORY[0x263F0DF20]);
    v40 = [*(id *)(a1 + 40) uuid];
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v52 = 2112;
    v53 = v24;
    _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Dropping credential because it is the COTA home user: %@, accessory: %@", buf, 0x20u);
  }
  v25 = 0;
LABEL_12:
...
- (id)_readAccessCodesFromAccessory_Matter:(id)a3 withRetries:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v24 = 2112;
    id v25 = v5;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Reading access codes from Matter accessory: %@", buf, 0x16u);
  }
  id v10 = [MEMORY[0x263F42530] untrackedPlaceholderFlow];
...
id __87__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessory_Matter_withRetries___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Failed to read access codes from Matter accessory: %@, with error: %@", (uint8_t *)&v15, 0x20u);
  }
  id v9 = objc_alloc(MEMORY[0x263F0DF18]);
  ...
  id v13 = [MEMORY[0x263F58190] futureWithResult:v12];
  ...
  if (_os_feature_enabled_impl() && !objc_msgSend(v6, "hmf_isEmpty"))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v20 = 2112;
      id v21 = v6;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Reading access codes from Matter accessories with UUIDs: %@", buf, 0x16u);
    }
    ...
    v16[4] = v9;
    BOOL v17 = a4;
    id v12 = objc_msgSend(v6, "na_map:", v16);
    id v13 = (void *)MEMORY[0x263F58190];
    uint64_t v14 = [MEMORY[0x263F581B8] immediateScheduler];
    id v7 = [v13 combineAllFutures:v12 scheduler:v14];
  }
  else
  {
...
id __98__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_Matter_withRetries___block_invoke(uint64_t a1, void *a2)
{
  ...
  id v4 = a2;
  id v5 = [v3 context];
  id v6 = [v5 hapAccessoryWithUUID:v4];

  id v7 = objc_msgSend(*(id *)(a1 + 32), "_readAccessCodesFromAccessory_Matter:withRetries:", v6, *(unsigned __int8 *)(a1 + 40));
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v26 = 2112;
      id v27 = v6;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Reading access codes from HAP accessories with UUIDs: %@", buf, 0x16u);
    }
    ...
    if (v12)
    {
      ...
      v21[1] = 3221225472;
      v21[2] = __95__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries___block_invoke_107;
      v21[3] = &unk_264A14EE8;
      v21[4] = v9;
    ...
    else
    {
      ...
      id v13 = [MEMORY[0x263F087E8] hmfErrorWithCode:11 reason:@"Failed to create list write requests"];
...
id __95__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v11 = 138543362;
    id v12 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Got list responses", (uint8_t *)&v11, 0xCu);
  }
  id v8 = +[HMDAccessoryAccessCodeReaderWriter identifiersFromListWriteResponses:v3 ofWriteRequests:*(void *)(a1 + 40)];
  id v9 = [MEMORY[0x263F58190] futureWithResult:v8];

  return v9;
}

id __95__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries___block_invoke_107(uint64_t a1, uint64_t a2)
{
  v2 = [*(id *)(a1 + 32) _createReadWriteRequestsForAccessCodeIdentifiers:a2];
  id v3 = (void *)MEMORY[0x263F58190];
  if (v2)
  {
    BOOL v4 = [MEMORY[0x263F58190] futureWithResult:v2];
  }
  else
  {
    id v5 = [MEMORY[0x263F087E8] hmfErrorWithCode:11 reason:@"Failed to create read write requests"];
...
id __95__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v21 = 2112;
    uint64_t v22 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Access code fetch responses from read: %@", buf, 0x16u);
  }
  id v9 = *(void **)(a1 + 48);
  v17[0] = MEMORY[0x263EF8330];
  v17[1] = 3221225472;
  v17[2] = __95__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries___block_invoke_108;
  v17[3] = &unk_264A2F348;
  id v18 = v4;
  id v10 = v4;
  id v11 = objc_msgSend(v9, "na_filter:", v17);
  uint64_t v12 = objc_msgSend(v11, "na_map:", &__block_literal_global_113);
  id v13 = (void *)MEMORY[0x263F58190];
...
BOOL __95__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries___block_invoke_108(uint64_t a1, void *a2)
{
  id v3 = a2;
  BOOL v4 = *(void **)(a1 + 32);
  v9[0] = MEMORY[0x263EF8330];
  v9[1] = 3221225472;
  v9[2] = __95__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries___block_invoke_2_109;
  v9[3] = &unk_264A15070;
  id v10 = v3;
  id v5 = v3;
...
id __95__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries___block_invoke_3_111(uint64_t a1, void *a2)
{
...
uint64_t __95__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries___block_invoke_2_109(uint64_t a1, void *a2)
{
  v2 = [a2 accessoryUUID];
...
- (id)_readAccessCodesFromAccessoriesWithUUIDs:(id)a3 withRetries:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v28 = 2112;
    id v29 = v6;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Reading access codes from accessories with UUIDs: %@", buf, 0x16u);
  }
  if (objc_msgSend(v6, "hmf_isEmpty"))
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v27 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Caller submitted empty array of accessory UUIDs", buf, 0xCu);
    }
    int v15 = [MEMORY[0x263F58190] futureWithResult:MEMORY[0x263EFFA68]];
  }
  else
  {
    ...
    v23[3] = &unk_264A2F348;
    v23[4] = v8;
    BOOL v17 = objc_msgSend(v6, "na_filter:", v23);
    ...
    BOOL v20 = (void *)MEMORY[0x263F58190];
    v25[0] = v18;
    v25[1] = v19;
    __int16 v21 = [MEMORY[0x263EFF8C0] arrayWithObjects:v25 count:2];
...
- (id)_readConstraintsFromAccessory_Matter:(id)a3 withRetries:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v27 = 2112;
    id v28 = v6;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Reading constraints from accessory: %@", buf, 0x16u);
  }
  if (v4) {
    uint64_t v11 = 8;
  }
  ...
  v20[0] = MEMORY[0x263EF8330];
  v20[1] = 3221225472;
  v20[2] = __87__HMDAccessoryAccessCodeReaderWriter__readConstraintsFromAccessory_Matter_withRetries___block_invoke_103;
  v20[3] = &unk_264A14FF8;
  v20[4] = v8;
  id v21 = v15;
  id v17 = v15;
...
id __87__HMDAccessoryAccessCodeReaderWriter__readConstraintsFromAccessory_Matter_withRetries___block_invoke_103(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    id v18 = v8;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@All retries failed to read constraint from accessory: %@", (uint8_t *)&v15, 0x16u);
  }
  int8x16_t v9 = (void *)[objc_alloc(MEMORY[0x263F0DEB8]) initWithAllowedCharacterSets:1 minimumLength:4 maximumLength:8 maximumAllowedAccessCodes:50];
  id v10 = objc_alloc(MEMORY[0x263F0DF10]);
...
id __87__HMDAccessoryAccessCodeReaderWriter__readConstraintsFromAccessory_Matter_withRetries___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v5)
  {
    ...
    {
      id v8 = v7;
      int8x16_t v9 = objc_msgSend(objc_alloc(MEMORY[0x263F0DEB8]), "initWithAllowedCharacterSets:minimumLength:maximumLength:maximumAllowedAccessCodes:", 1, objc_msgSend(v7, "integerValue"), objc_msgSend(v5, "integerValue"), 50);
      id v10 = objc_alloc(MEMORY[0x263F0DF10]);
      int8x16_t v11 = [*(id *)(a1 + 40) uuid];
      uint64_t v12 = (void *)[v10 initWithAccessory:v11 constraints:v9 error:0];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        int v26 = 138543362;
        __int16 v27 = v22;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Failed to read min pin code length constraint from accessory", (uint8_t *)&v26, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      int v26 = 138543362;
      __int16 v27 = v17;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Failed to read max pin code length constraint from accessory", (uint8_t *)&v26, 0xCu);
    }
...
- (id)_readConstraintsFromAccessoriesWithUUIDs_Matter:(id)a3 withRetries:(BOOL)a4
{
  ...
  {
LABEL_8:
    id v15 = [MEMORY[0x263F58190] futureWithResult:MEMORY[0x263EFFA68]];
    goto LABEL_10;
  }
  BOOL v7 = (void *)MEMORY[0x230FBD990]();
  id v8 = self;
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v24 = 2112;
    id v25 = v6;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Reading constraints from Matter accessories with UUIDs: %@", buf, 0x16u);
  }
  if (objc_msgSend(v6, "hmf_isEmpty"))
  {
    int8x16_t v11 = (void *)MEMORY[0x230FBD990]();
    uint64_t v12 = v8;
    id v13 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
  ...
  v20[4] = v8;
  BOOL v21 = a4;
  id v16 = objc_msgSend(v6, "na_map:", v20);
  __int16 v17 = (void *)MEMORY[0x263F58190];
  id v18 = [MEMORY[0x263F581B8] immediateScheduler];
  id v15 = [v17 combineAllFutures:v16 scheduler:v18];
...
id __98__HMDAccessoryAccessCodeReaderWriter__readConstraintsFromAccessoriesWithUUIDs_Matter_withRetries___block_invoke(uint64_t a1, void *a2)
{
  ...
  BOOL v7 = objc_msgSend(*(id *)(a1 + 32), "_readConstraintsFromAccessory_Matter:withRetries:", v6, *(unsigned __int8 *)(a1 + 40));
...
- (id)_readConstraintsFromAccessoriesWithUUIDs_HAP:(id)a3 withRetries:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v24 = 2112;
    id v25 = v6;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Reading constraints from HAP accessories with UUIDs: %@", buf, 0x16u);
  }
  if (objc_msgSend(v6, "hmf_isEmpty"))
  {
    int8x16_t v11 = (void *)MEMORY[0x230FBD990]();
  ...
  else
  {
    ...
    {
      id v18 = (void *)MEMORY[0x263F58190];
      __int16 v17 = [MEMORY[0x263F087E8] hmfErrorWithCode:11 reason:@"Failed to create constraints read requests"];
...
- (id)_readConstraintsFromAccessoriesWithUUIDs:(id)a3 withRetries:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v28 = 2112;
    id v29 = v6;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Reading constraints from accessories with UUIDs: %@", buf, 0x16u);
  }
  if (objc_msgSend(v6, "hmf_isEmpty"))
  {
    int8x16_t v11 = (void *)MEMORY[0x230FBD990]();
  ...
  else
  {
    ...
    v25[0] = v18;
    v25[1] = v19;
    id v21 = [MEMORY[0x263EFF8C0] arrayWithObjects:v25 count:2];
...
- (id)performModificationRequest_Matter:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v81 = 2112;
    id v82 = v4;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Performing access code modification request Matter: %@", buf, 0x16u);
  }
...
LABEL_16:
      ...
      __int16 v37 = v36;
      __int16 v38 = (void *)&unk_2303E3000;
      if (v36)
      {
        id v39 = v36;
      }
  ...
  else
  {
    ...
    long long v33 = [MEMORY[0x263F42530] untrackedPlaceholderFlow];
    v60 = v30;
    ...
    if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v80 = v49;
      _os_log_impl(&dword_22F52A000, v48, OS_LOG_TYPE_ERROR, "%{public}@Found HMAccessCodeModificationRequestValue of unknown type", buf, 0xCu);
    }
    __int16 v50 = (void *)MEMORY[0x263F58190];
    v45 = [MEMORY[0x263F087E8] hmErrorWithCode:52];
...
LABEL_24:
  ...
  uint64_t v67 = v38[326];
  uint64_t v52 = v67;
  v68 = __72__HMDAccessoryAccessCodeReaderWriter_performModificationRequest_Matter___block_invoke_87;
  v69 = &unk_264A14FD0;
  id v70 = v26;
  id v71 = v42;
  id v53 = v20;
  ...
  v64[1] = v52;
  v64[2] = __72__HMDAccessoryAccessCodeReaderWriter_performModificationRequest_Matter___block_invoke_3_91;
  v64[3] = &unk_264A14FF8;
  v64[4] = v8;
  id v65 = v53;
  id v57 = v53;
...
id __72__HMDAccessoryAccessCodeReaderWriter_performModificationRequest_Matter___block_invoke_87(uint64_t a1)
{
  v7[0] = MEMORY[0x263EF8330];
  v7[1] = 3221225472;
  v7[2] = __72__HMDAccessoryAccessCodeReaderWriter_performModificationRequest_Matter___block_invoke_2_88;
  v7[3] = &unk_264A14FA8;
  v2 = *(void **)(a1 + 32);
  id v8 = *(id *)(a1 + 40);
  id v3 = *(id *)(a1 + 48);
...
id __72__HMDAccessoryAccessCodeReaderWriter_performModificationRequest_Matter___block_invoke_3_91(uint64_t a1, void *a2)
{
  id v3 = (void *)MEMORY[0x263F58190];
  id v4 = a2;
...
id __72__HMDAccessoryAccessCodeReaderWriter_performModificationRequest_Matter___block_invoke_2_88(uint64_t a1, void *a2)
{
  id v3 = (objc_class *)MEMORY[0x263F0DEF8];
  id v4 = a2;
  id v5 = (void *)[[v3 alloc] initWithStringValue:*(void *)(a1 + 32)];
  id v6 = objc_alloc(MEMORY[0x263F0DF20]);
  ...
  id v9 = objc_alloc(MEMORY[0x263F0DEC8]);
  ...
  id v12 = [MEMORY[0x263F58190] futureWithResult:v11];
...
- (id)performAccessCodeModificationRequests_Matter:(id)a3 withRetries:(BOOL)a4
{
  ...
  id v6 = [(HMDAccessoryAccessCodeReaderWriter *)self context];
  BOOL v7 = [v6 workQueue];
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    int8x16_t v11 = HMFGetLogIdentifier();
    *(_DWORD *)buf = 138543618;
    unint64_t v19 = v11;
    __int16 v20 = 2112;
    id v21 = v5;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Performing access code modification requests Matter: %@", buf, 0x16u);
  }
  if (!objc_msgSend(v5, "hmf_isEmpty"))
  {
    ...
    v17[3] = &unk_264A14F80;
    void v17[4] = v9;
    id v13 = objc_msgSend(v5, "na_map:", v17);
    id v14 = (void *)MEMORY[0x263F58190];
    id v15 = [MEMORY[0x263F581B8] immediateScheduler];
    id v12 = [v14 combineAllFutures:v13 scheduler:v15];
  }
  else
  {
LABEL_5:
    id v12 = [MEMORY[0x263F58190] futureWithResult:MEMORY[0x263EFFA68]];
  }
...
- (id)performAccessCodeModificationRequests_HAP:(id)a3 withRetries:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v27 = 2112;
    id v28 = v6;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Performing access code modification requests HAP: %@", buf, 0x16u);
  }
  if (objc_msgSend(v6, "hmf_isEmpty"))
  {
    id v13 = [MEMORY[0x263F58190] futureWithResult:MEMORY[0x263EFFA68]];
  }
  else
  {
    id v14 = [(HMDAccessoryAccessCodeReaderWriter *)v10 _createWriteRequestsForModificationRequests:v6];
    id v15 = objc_msgSend(v14, "na_map:", &__block_literal_global_82);
    if (objc_msgSend(v15, "hmf_isEmpty"))
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        uint64_t v26 = v19;
        _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Did not find any valid write requests to perform", buf, 0xCu);
      }
      __int16 v20 = (void *)MEMORY[0x263F58190];
    ...
    else
    {
      ...
      v23[0] = MEMORY[0x263EF8330];
      v23[1] = 3221225472;
      v23[2] = __92__HMDAccessoryAccessCodeReaderWriter_performAccessCodeModificationRequests_HAP_withRetries___block_invoke_83;
      v23[3] = &unk_264A14F58;
      v23[4] = v10;
      id v24 = v14;
...
id __92__HMDAccessoryAccessCodeReaderWriter_performAccessCodeModificationRequests_HAP_withRetries___block_invoke_83(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Received modification responses: %@", (uint8_t *)&v11, 0x16u);
  }
  id v9 = [MEMORY[0x263F58190] futureWithResult:v4];
...
- (id)performAccessCodeModificationRequests:(id)a3 withRetries:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v30 = 2112;
    id v31 = v6;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Performing access code modification requests: %@", buf, 0x16u);
  }
  if (objc_msgSend(v6, "hmf_isEmpty"))
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v29 = v16;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Caller submitted empty modification requests", buf, 0xCu);
    }
    id v17 = [MEMORY[0x263F58190] futureWithResult:MEMORY[0x263EFFA68]];
  }
  else
  {
    ...
    __int16 v20 = [(HMDAccessoryAccessCodeReaderWriter *)v10 performAccessCodeModificationRequests_Matter:v18 withRetries:v4];
...
- (void)_readConstraintsAndAccessCodesFromAccessoriesWithUUIDs:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v23 = 2112;
    id v24 = v6;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Reading constraints and access codes from accessories with UUIDs: %@", buf, 0x16u);
  }
  if (objc_msgSend(v6, "hmf_isEmpty"))
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v22 = v15;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Caller submitted empty array of accessory UUIDs", buf, 0xCu);
    }
...
void __104__HMDAccessoryAccessCodeReaderWriter__readConstraintsAndAccessCodesFromAccessoriesWithUUIDs_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v30 = 2112;
      id v31 = v6;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to read constraints from accessories with uuids: %@, error: %@", buf, 0x20u);
    }
  }
  id v12 = [*(id *)(a1 + 32) _readAccessCodesFromAccessoriesWithUUIDs:*(void *)(a1 + 40) withRetries:1];
  __int16 v13 = (void *)MEMORY[0x263F581B8];
  ...
  v22[0] = MEMORY[0x263EF8330];
  v22[1] = 3221225472;
  v22[2] = __104__HMDAccessoryAccessCodeReaderWriter__readConstraintsAndAccessCodesFromAccessoriesWithUUIDs_completion___block_invoke_77;
  v22[3] = &unk_264A2D9F0;
  id v18 = *(void **)(a1 + 40);
...
void __104__HMDAccessoryAccessCodeReaderWriter__readConstraintsAndAccessCodesFromAccessoriesWithUUIDs_completion___block_invoke_77(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v16 = 2112;
      id v17 = v6;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to read access codes from accessories with uuids: %@, error: %@", (uint8_t *)&v12, 0x20u);
    }
  }
...
- (id)_readAccessCodeWithIdentifier:(id)a3 accessoryUUID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v32 = 2112;
    id v33 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Reading access code for identifier: %@ from accessoryUUID: %@", buf, 0x20u);
  }
  int v12 = (void *)[objc_alloc(MEMORY[0x263F35AF0]) initWithValue:v6];
  id v25 = v12;
  id v26 = v7;
  __int16 v13 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v25 count:1];
  __int16 v27 = v13;
  __int16 v14 = [NSDictionary dictionaryWithObjects:&v27 forKeys:&v26 count:1];
  ...
  else
  {
    ...
    __int16 v16 = [MEMORY[0x263F087E8] hmfErrorWithCode:11 reason:@"Failed to create read write requests"];
...
id __82__HMDAccessoryAccessCodeReaderWriter__readAccessCodeWithIdentifier_accessoryUUID___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    uint64_t v11 = [MEMORY[0x263F087E8] hmfErrorWithCode:15 reason:@"Response without access code value"];
...
- (id)removeAccessCodeWithValue_Matter:(id)a3 fromAccessory:(id)a4 withUserUUID:(id)a5 guestName:(id)a6
{
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v47 = 2112;
    v48 = v20;
    _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@removeAllAccessCodesWithValue_Matter fromAccessory: %@", buf, 0x16u);
  }
...
{
  id v3 = (objc_class *)MEMORY[0x263F0DF20];
  id v4 = a2;
  id v5 = [v3 alloc];
  ...
  id v8 = objc_alloc(MEMORY[0x263F0DEC8]);
  id v9 = [*(id *)(a1 + 32) uuid];
...
- (id)removeAllAccessCodesWithValue_Matter:(id)a3 withUserUUID:(id)a4 guestName:(id)a5
{
  ...
  if (_os_feature_enabled_impl())
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v31 = v16;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@removeAllAccessCodesWithValue_Matter", buf, 0xCu);
    }
    id v17 = [(HMDAccessoryAccessCodeReaderWriter *)v14 context];
    uint64_t v18 = [v17 UUIDsOfMatterAccessoriesSupportingAccessCodes];
    uint64_t v22 = MEMORY[0x263EF8330];
    uint64_t v23 = 3221225472;
    id v24 = __98__HMDAccessoryAccessCodeReaderWriter_removeAllAccessCodesWithValue_Matter_withUserUUID_guestName___block_invoke;
    id v25 = &unk_264A14E48;
    id v26 = v14;
    id v27 = v8;
    id v28 = v9;
    id v29 = v10;
    id v19 = objc_msgSend(v18, "na_map:", &v22);

    id v20 = objc_msgSend(MEMORY[0x263F58190], "combineAllFuturesIgnoringEmptyResults:", v19, v22, v23, v24, v25, v26);
  }
  else
  {
    id v20 = [MEMORY[0x263F58190] futureWithResult:MEMORY[0x263EFFA68]];
  }
...
id __98__HMDAccessoryAccessCodeReaderWriter_removeAllAccessCodesWithValue_Matter_withUserUUID_guestName___block_invoke(uint64_t a1, void *a2)
{
  ...
  id v4 = a2;
  id v5 = [v3 context];
  uint64_t v6 = [v5 hapAccessoryWithUUID:v4];

  id v7 = objc_msgSend(*(id *)(a1 + 32), "removeAccessCodeWithValue_Matter:fromAccessory:withUserUUID:guestName:", *(void *)(a1 + 40), v6, *(void *)(a1 + 48), *(void *)(a1 + 56));
...
- (id)removeAllHAPAccessCodesWithValue:(id)a3 forSpecificAccessory:(id)a4
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v30 = v13;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@removeAllHAPAccessCodesWithValue", buf, 0xCu);
  }
  if (!v7)
  {
...
LABEL_11:
    ...
    uint64_t v23 = [(HMDAccessoryAccessCodeReaderWriter *)v11 _readAccessCodesFromAccessoriesWithUUIDs:v21 withRetries:1];
    v25[0] = MEMORY[0x263EF8330];
    v25[1] = 3221225472;
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v31 = 2112;
    id v32 = v7;
    _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@removeAccessCodeWithValue for HAP was passed a non HAP accessory or does not support access codes: %@", buf, 0x16u);
  }
  id v20 = (void *)MEMORY[0x263F58190];
  id v21 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F0C710] code:48 userInfo:0];
...
id __92__HMDAccessoryAccessCodeReaderWriter_removeAllHAPAccessCodesWithValue_forSpecificAccessory___block_invoke(uint64_t a1, void *a2)
{
  ...
  id v7 = objc_msgSend(v6, "na_map:", &__block_literal_global_4956);
...
id __92__HMDAccessoryAccessCodeReaderWriter_removeAllHAPAccessCodesWithValue_forSpecificAccessory___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v4)
  {
    id v5 = objc_alloc(MEMORY[0x263F0DEC8]);
...
{
  uint64_t v2 = (objc_class *)MEMORY[0x263F0DED8];
  id v3 = a2;
...
- (id)removeAllAccessCodesWithValue:(id)a3 withUserUUID:(id)a4 guestName:(id)a5
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v25 = v16;
    _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@removeAllAccessCodesWithValue", buf, 0xCu);
  }
  ...
  v23[0] = v17;
  v23[1] = v18;
  id v20 = [MEMORY[0x263EFF8C0] arrayWithObjects:v23 count:2];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t77 != -1) {
    dispatch_once(&logCategory__hmf_once_t77, &__block_literal_global_180);
  }
...
void __49__HMDAccessoryAccessCodeReaderWriter_logCategory__block_invoke()
{
  ...
  logCategory__hmf_once_id v78 = v0;
}
...
+ (id)createWriteRequestForRemoveRequests:(id)a3 characteristic:(id)a4
{
  ...
  {
    objc_super v9 = (void *)[objc_alloc(MEMORY[0x263F35850]) initWithValue:5];
    id v10 = objc_msgSend(v6, "na_map:", &__block_literal_global_177);
    id v11 = (void *)[objc_alloc(MEMORY[0x263F35830]) initWithOperationType:v9 accessCodeControlRequest:v10 accessCodeControlResponse:0];
    id v20 = 0;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v27 = 2112;
        id v28 = v13;
        _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize access code control write request: %@, for update requests: %@, with error: %@", buf, 0x2Au);
...
{
  uint64_t v2 = (objc_class *)MEMORY[0x263F35AF0];
  id v3 = a2;
  id v4 = [v2 alloc];
  ...
  id v8 = (void *)[objc_alloc(MEMORY[0x263F35838]) initWithIdentifier:v7 accessCode:0];
  return v8;
}
...
+ (id)createWriteRequestForUpdateRequests:(id)a3 characteristic:(id)a4
{
  ...
  {
    objc_super v9 = (void *)[objc_alloc(MEMORY[0x263F35850]) initWithValue:4];
...
id __89__HMDAccessoryAccessCodeReaderWriter_createWriteRequestForUpdateRequests_characteristic___block_invoke(uint64_t a1, void *a2)
{
  ...
  id v8 = objc_alloc(MEMORY[0x263F35838]);
...
+ (id)createWriteRequestForAddRequests:(id)a3 characteristic:(id)a4
{
  ...
  {
    objc_super v9 = (void *)[objc_alloc(MEMORY[0x263F35850]) initWithValue:3];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v27 = 2112;
        id v28 = v13;
        _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize access code control write request: %@, for add requests: %@, with error: %@", buf, 0x2Au);
...
{
  uint64_t v2 = (objc_class *)MEMORY[0x263F35838];
  id v3 = a2;
  id v4 = [v2 alloc];
  ...
  if (v8)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v9; ++i)
      {
        ...
        {
          id v15 = [MEMORY[0x263EFF980] arrayWithObject:v12];
    ...
    *(void *)&long long v19 = 138543618;
    ...
    while (2)
    {
      for (uint64_t j = 0; j != v53; ++j)
      {
        ...
        v57[3] = &unk_264A28A10;
        v57[4] = v21;
        uint64_t v22 = objc_msgSend(v18, "na_firstObjectPassingTest:", v57, v48);
        if (!v22)
        {
          ...
          if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = v48;
            ...
            __int16 v68 = 2112;
            v69 = v21;
            _os_log_impl(&dword_22F52A000, v45, OS_LOG_TYPE_ERROR, "%{public}@Not submitting modification requests because did not find an accessory with UUID: %@", buf, 0x16u);
          }
LABEL_35:

          id v42 = (void *)MEMORY[0x263EFFA68];
          id v17 = v56;
          goto LABEL_36;
        }
        __int16 v23 = v22;
        ...
        if (v24)
        {
          ...
          uint64_t v26 = objc_msgSend(v25, "na_map:", &__block_literal_global_161);
          ...
          id v30 = objc_msgSend(v29, "na_map:", &__block_literal_global_165);
          ...
          __int16 v35 = objc_msgSend(v34, "na_map:", &__block_literal_global_168);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = v48;
            ...
            __int16 v68 = 2112;
            v69 = v23;
            _os_log_impl(&dword_22F52A000, v40, OS_LOG_TYPE_ERROR, "%{public}@Not submitting modification requests because did not find an access code control point on accessory: %@", buf, 0x16u);
...
id __96__HMDAccessoryAccessCodeReaderWriter_createWriteRequestsForModificationRequests_hapAccessories___block_invoke_158(uint64_t a1, void *a2)
{
  id v2 = a2;
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
...
+ (int64_t)hmPrivateErrorCodeForHAPAccessCodeError:(int64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@Encountered an error type that likely indicates a bug: %@", (uint8_t *)&v11, 0x16u);
  }
  return 2607;
}
...
+ (id)modificationResponseForControlResponse:(id)a3 operationType:(int64_t)a4 accessoryUUID:(id)a5
{
  ...
  id v11 = objc_alloc(MEMORY[0x263F0DEF8]);
  ...
  if (v15)
  {
    id v16 = objc_alloc(MEMORY[0x263F0DF20]);
...
LABEL_14:
  ...
  __int16 v23 = (void *)MEMORY[0x263F087E8];
...
LABEL_15:
  ...
  id v28 = (void *)[objc_alloc(MEMORY[0x263F0DEC8]) initWithAccessoryUUID:v9 accessoryAccessCodeValue:v19 accessCodeValue:v10 operationType:v27 error:v20];
...
+ (id)modificationResponseForFailedMatterRequest:(id)a3 error:(id)a4
{
  ...
  id v12 = [v6 domain];
  __int16 v13 = v12;
  if (v12 == (void *)*MEMORY[0x263F497B8])
  {
    ...
    if (v14 == 8)
    {
      if (v8)
      {
        id v15 = objc_alloc(MEMORY[0x263F0DEC8]);
        id v16 = [v8 accessoryUUID];
        id v17 = [v8 accessCodeValue];
        uint64_t v18 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2602];
        long long v19 = v15;
        id v20 = v16;
        id v21 = 0;
        uint64_t v22 = v17;
      ...
      else
      {
        ...
        id v24 = objc_alloc(MEMORY[0x263F0DEC8]);
...
+ (id)genericModificationResponseForFailedRequest:(id)a3
{
  ...
  if (v5)
  {
    id v12 = objc_alloc(MEMORY[0x263F0DEC8]);
  ...
  {
    id v21 = objc_alloc(MEMORY[0x263F0DEC8]);
    if (v8)
    {
      ...
      do
      {
        ...
        if (!v13)
        {
          ...
          if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v36;
            ...
            __int16 v52 = 2112;
            uint64_t v53 = v12;
            _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_INFO, "%{public}@Failed to extract HAPAccessCodeControl from write responses: %@, for write request: %@", buf, 0x20u);
          }
              ...
              v18))
        {
          ...
          if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            uint64_t v49 = v22;
            _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Received HAPAccessCodeControl object that does not contain any HAPAccessCodeControlResponses", buf, 0xCu);
          }
          uint64_t v23 = [v11 modificationRequests];
          id v24 = v23;
          __int16 v25 = &__block_literal_global_153;
LABEL_15:
...
id __98__HMDAccessoryAccessCodeReaderWriter_createModificationResponsesForWriteResponses_ofRequestPairs___block_invoke_151(uint64_t a1, uint64_t a2)
{
...
+ (id)_accessCodeControlFromWriteResponses:(id)a3 forWriteRequest:(id)a4
{
  ...
  if (v9)
  {
    ...
    {
      id v32 = v10;
      uint64_t v14 = [MEMORY[0x263F35830] parsedFromData:v11 error:&v32];
      id v15 = v32;
      ...
      else
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v36 = 2112;
          id v37 = v11;
          _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse HAPAccessCodeControl from NSData: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v36 = 2112;
        id v37 = v11;
        _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Characteristic response value: %@ is not of expected type NSData", buf, 0x16u);
      }
      uint64_t v14 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v40 = 2112;
      id v41 = v10;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Failed to parse characteristic response for characteristic: %@, in payload: %@, with error: %@", buf, 0x2Au);
    }
    uint64_t v14 = 0;
  }
...
{
  id v6 = a3;
  id v7 = objc_msgSend(a4, "na_map:", &__block_literal_global_145);
  v11[0] = MEMORY[0x263EF8330];
  v11[1] = 3221225472;
...
id __86__HMDAccessoryAccessCodeReaderWriter_createConstraintsFromReadResponses_readRequests___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  id v5 = (void *)[objc_alloc(MEMORY[0x263F0DEB8]) initWithAllowedCharacterSets:1 minimumLength:4 maximumLength:8 maximumAllowedAccessCodes:200];
  id v6 = *(void **)(a1 + 32);
  id v49 = 0;
  ...
  if (v7)
  {
    ...
    {
      id v48 = v8;
      id v12 = [MEMORY[0x263F35828] parsedFromData:v9 error:&v48];
      id v44 = v48;
      ...
      if (v12)
      {
        ...
        BOOL v42 = v14 == 1;
        id v41 = objc_alloc(MEMORY[0x263F0DEB8]);
        ...
        id v24 = (void *)[objc_alloc(MEMORY[0x263F0DF10]) initWithAccessory:v47 constraints:v22 error:0];
        id v5 = v46;
      }
      else
      {
        ...
        if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v52 = 2112;
          id v53 = v9;
          _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse HAPAccessCodeControl from NSData: %@", buf, 0x16u);
        }
        id v39 = objc_alloc(MEMORY[0x263F0DF10]);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v52 = 2112;
        id v53 = v9;
        _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_ERROR, "%{public}@Characteristic response value: %@ is not of expected type NSData", buf, 0x16u);
      }
      id v34 = objc_alloc(MEMORY[0x263F0DF10]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v56 = 2112;
      id v57 = v8;
      _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse characteristic response for characteristic: %@, in payload: %@, with error: %@", buf, 0x2Au);
    }
    uint64_t v23 = (void *)v47;
    id v24 = (void *)[objc_alloc(MEMORY[0x263F0DF10]) initWithAccessory:v47 constraints:v5 error:v8];
  }
    ...
    do
    {
      for (uint64_t i = 0; i != v9; ++i)
      {
        ...
        if (v13)
        {
          ...
          uint64_t v16 = objc_msgSend(v15, "na_map:", &__block_literal_global_142);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = v26;
            ...
            __int16 v38 = 2112;
            id v39 = v12;
            _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to extract HAPAccessCodeControl from write responses: %@, for write request: %@", buf, 0x20u);
          }
        }
      }
...
+ (id)accessCodeFetchResponsesForReadWriteResponses:(id)a3 ofWriteRequests:(id)a4
{
  ...
  id v45 = a3;
  id v6 = a4;
  BOOL v42 = [MEMORY[0x263EFF980] array];
  long long v49 = 0u;
  long long v50 = 0u;
  long long v51 = 0u;
  long long v52 = 0u;
      ...
      do
      {
        ...
        if (v16)
        {
          ...
          if (v17)
          {
            ...
            id v24 = objc_msgSend(v23, "na_firstObjectPassingTest:", &__block_literal_global_138);
            ...
            uint64_t v9 = v44;
            uint64_t v29 = (void *)[objc_alloc(MEMORY[0x263F0DF18]) initWithAccessoryUUID:v21 accessoryAccessCodeValues:v22 error:v26];
            [v42 addObject:v29];
          ...
          else
          {
            ...
            if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = v40;
              ...
              __int16 v57 = 2112;
              uint64_t v58 = v12;
              _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_ERROR, "%{public}@Failed to extract HAPAccessCodeControl from write responses: %@, for write request: %@", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v55 = 2112;
            id v56 = v12;
            _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_ERROR, "%{public}@Failed to find accessory UUID for write request: %@", buf, 0x16u);
          }
        }
...
LABEL_10:
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, v21, (uint8_t *)&v24, 0x20u);
    }
LABEL_11:
  ...
  id v8 = objc_alloc(MEMORY[0x263F0DF20]);
...
BOOL __100__HMDAccessoryAccessCodeReaderWriter_accessCodeFetchResponsesForReadWriteResponses_ofWriteRequests___block_invoke_135(uint64_t a1, void *a2)
{
  id v2 = [a2 statusCode];
  BOOL v3 = [v2 value] != 0;
  ...
  if (v25)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v25; ++i)
      {
        ...
        id v6 = (void *)[objc_alloc(MEMORY[0x263F35850]) initWithValue:2];
        uint64_t v7 = [v3 objectForKey:v5];
        id v8 = objc_msgSend(v7, "na_map:", &__block_literal_global_132);
        uint64_t v9 = (void *)[objc_alloc(MEMORY[0x263F35830]) initWithOperationType:v6 accessCodeControlRequest:v8 accessCodeControlResponse:0];
        id v26 = 0;
        ...
        else
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138544386;
            ...
            __int16 v39 = 2112;
            id v40 = v11;
            _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize access code control write request: %@, to read access codes with identifiers: %@, from characteristic: %@, with error: %@", buf, 0x34u);
          }
          id v3 = v19;
        }
...
{
  id v2 = (objc_class *)MEMORY[0x263F35838];
  id v3 = a2;
...
id __81__HMDAccessoryAccessCodeReaderWriter__createListWriteRequestsForCharacteristics___block_invoke(uint64_t a1, void *a2)
{
  uint64_t v21 = *MEMORY[0x263EF8340];
  id v3 = a2;
  id v4 = (void *)[objc_alloc(MEMORY[0x263F35850]) initWithValue:1];
  uint64_t v5 = (void *)[objc_alloc(MEMORY[0x263F35830]) initWithOperationType:v4 accessCodeControlRequest:0 accessCodeControlResponse:0];
  id v14 = 0;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v19 = 2112;
      id v20 = v7;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize access code control list request: %@, with error: %@", buf, 0x20u);
    }
    id v8 = 0;
  }
