...
- (void)sessionEnded:(id)a3 withReason:(unsigned int)a4 error:(id)a5
{
  ...
  if (v9)
  {
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      uint32_t v19 = 38;
LABEL_6:
      _os_log_impl(&dword_22F52A000, v17, v18, v16, (uint8_t *)&v21, v19);
    }
  }
  ...
  v20 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1030 underlyingError:v9];
...
- (void)_receivedIDSSession:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v36 = 2112;
    id v37 = v4;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Received invitation for session %@", buf, 0x16u);
  }
  ...
  if (v15)
  {
    ...
    uint64_t v32 = *MEMORY[0x263F49FC8];
    v33 = v17;
    uint32_t v19 = [NSDictionary dictionaryWithObjects:&v33 forKeys:&v32 count:1];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v36 = 2112;
      id v37 = v24;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Could not find any mach UUIDs for session %@", buf, 0x16u);
    }
  }
  ...
  if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v36 = 2112;
    id v37 = v29;
    _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Accepting invitation for session %@", buf, 0x16u);
  }
...
- (void)service:(id)a3 account:(id)a4 inviteReceivedForSession:(id)a5 fromID:(id)a6 withContext:(id)a7
{
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v59 = 2112;
    id v60 = v15;
    _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Received invitation for session %@ from %@", buf, 0x20u);
  }
  ...
  if (!v22)
  {
    ...
    if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v57 = 2112;
      id v58 = v15;
      _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_ERROR, "%{public}@Could not determine device handle for fromID: %@", buf, 0x16u);
    }
    goto LABEL_17;
  }
  ...
  if ((v24 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v57 = 2112;
      id v58 = v22;
      _os_log_impl(&dword_22F52A000, v38, OS_LOG_TYPE_INFO, "%{public}@Ignoring invitation from %@", buf, 0x16u);
    }
LABEL_17:

    goto LABEL_26;
  }
  __int16 v25 = (void *)MEMORY[0x263F08928];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v47, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v57 = 2112;
        id v58 = v31;
        _os_log_impl(&dword_22F52A000, v47, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring invitation for camera session ID: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v57 = 2112;
      id v58 = v53;
      _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive request id from context: %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t14_193028 != -1) {
    dispatch_once(&logCategory__hmf_once_t14_193028, &__block_literal_global_193029);
  }
  v2 = (void *)logCategory__hmf_once_v15_193030;
  return v2;
}
...
void __42__HMDCameraIDSSessionReceiver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v15_193030;
  logCategory__hmf_once_v15_193030 = v0;
}
