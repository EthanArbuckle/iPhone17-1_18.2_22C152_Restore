...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v4 encodeObject:v5 forKey:*MEMORY[0x263F0B9A8]];
  ...
  [v4 encodeObject:v6 forKey:*MEMORY[0x263F0B9B8]];
}
...
- (HMDAppleMediaAccessoryPowerAction)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    id v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0B9A8]];
    objc_super v7 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0B9B8]];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v22 = 2112;
      id v23 = v17;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode base class: %@", buf, 0x16u);
    }
    v13 = 0;
  }
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v38 = 2112;
      id v39 = v30;
      _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Unknown accessory saved in object model %@: %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      id v25 = v39;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Unknown model object (%@) sent to [%@ transactionObjectUpdated]", buf, 0x20u);
    }
    ...
    if (!v15)
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v50 = v36;
        _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_ERROR, "%{public}@Parent is not an actionset", buf, 0xCu);
      }
      if (a5)
      {
    ...
    if (!v18)
    {
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_22F52A000, v38, OS_LOG_TYPE_ERROR, "%{public}@Unable to find accessory with UUID: %@", buf, 0x16u);
    ...
    if (v20)
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v51 = 2048;
        uint64_t v52 = v23;
        _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Invalid target sleep wake state: %lu", buf, 0x16u);
...
LABEL_42:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v51 = 2112;
        uint64_t v52 = 0;
        _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_ERROR, "%{public}@Accessory is not an Apple Media Accessory: %@", buf, 0x16u);
      }
      if (a5)
      {
        v28 = (void *)MEMORY[0x263F087E8];
  ...
  if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v50 = v32;
    _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@Action model does not exist", buf, 0xCu);
  }
  if (a5)
  {
    [MEMORY[0x263F087E8] hmErrorWithCode:22];
...
- (void)executeWithSource:(unint64_t)a3 clientName:(id)a4 completionHandler:(id)a5
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v26 = v12;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Executing Apple TV Power Action", buf, 0xCu);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v27 = 2048;
      uint64_t v28 = v19;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Invalid target sleep wake state set: %tu", buf, 0x16u);
    }
  }
}
...
- (id)dictionaryRepresentation
{
  ...
  id v6 = [v5 uuid];
  id v7 = [v6 UUIDString];
  [v4 setObject:v7 forKeyedSubscript:*MEMORY[0x263F0B9B0]];
  ...
  [v4 setObject:v8 forKeyedSubscript:*MEMORY[0x263F0B9C0]];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t26_236563 != -1) {
    dispatch_once(&logCategory__hmf_once_t26_236563, &__block_literal_global_236564);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v27_236565;
  return v2;
}
...
void __48__HMDAppleMediaAccessoryPowerAction_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v27_236565;
  logCategory__hmf_once_v27_236565 = v0;
}
...
+ (id)actionWithDictionaryRepresentation:(id)a3 home:(id)a4
{
  ...
  if ([v8 unsignedIntegerValue] == 4)
  {
    ...
    objc_super v11 = [MEMORY[0x263F08C38] UUID];
    id v12 = [v7 uuid];
    ...
    if (v18)
    {
      ...
      if ((unint64_t)(v20 - 3) > 0xFFFFFFFFFFFFFFFDLL)
      {
        ...
        {
          id v38 = [MEMORY[0x263F08C38] UUID];
        }
        id v39 = v38;
      ...
      uint64_t v21 = MEMORY[0x230FBD990]();
      id v22 = a1;
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v45 = 2048;
        uint64_t v46 = v20;
        _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Invalid power state: %tu", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_ERROR, "%{public}@Couldn't find an Apple TV in the home with UUID: %@", buf, 0x16u);
...
LABEL_22:
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Invalid action type: %@", buf, 0x16u);
  }
  v30 = 0;
LABEL_23:
