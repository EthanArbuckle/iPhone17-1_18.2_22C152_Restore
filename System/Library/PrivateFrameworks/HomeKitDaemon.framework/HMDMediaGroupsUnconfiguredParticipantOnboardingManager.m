...
- (id)mediaDestinationManagerWithParticipantAccessoryUUID:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v15 = 2112;
      id v16 = v4;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get media destination manager with participant accessory uuid: %@ due to no data source", (uint8_t *)&v13, 0x16u);
    }
    v7 = 0;
  }
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v20 = 2112;
        v21 = v11;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Sending request to update audio group identifier: %@ for participant accessory identifier: %@ destination: %@", buf, 0x2Au);
      }
  ...
  if ([v3 count])
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Attempting onboarding for participant accessory uuids: %@", buf, 0x16u);
    }
...
- (void)queueOnboardingParticipantWithAccessoryUUID:(id)a3 withAssociatedGroupIdentifier:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v16 = 2112;
    id v17 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Queueing onboarding for participant accessory uuid: %@ associated group identifier: %@", (uint8_t *)&v12, 0x20u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_219306 != -1) {
    dispatch_once(&logCategory__hmf_once_t9_219306, &__block_literal_global_219307);
  }
  v2 = (void *)logCategory__hmf_once_v10_219308;
  return v2;
}
...
void __69__HMDMediaGroupsUnconfiguredParticipantOnboardingManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v10_219308;
  logCategory__hmf_once_v10_219308 = v0;
}
