        ...
        *(_OWORD *)&time1.value = v31;
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
        {
          ...
          *(void *)((char *)&range.start.flags + 2) = v10;
          ...
          _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Selecting variant fragment: %@, overlapsFullFragment: %@", (uint8_t *)&range, 0x20u);
        }
...
- (void)handleVariantFragment:(id)a3
{
  ...
  if (v7 >= 4)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v25 = 2112;
      CMTimeRange v26 = v5;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Selecting non-overlapping variant fragment: %@", (uint8_t *)&v23, 0x16u);
    }
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v27 = 2048;
    uint64_t v28 = v21 + 1;
    _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Buffering variant fragment: %@, count: %lu", (uint8_t *)&v23, 0x20u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_164120 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_164120, &__block_literal_global_164121);
  }
  v2 = (void *)logCategory__hmf_once_v4_164122;
  return v2;
}
...
void __62__HMDCameraRecordingSessionVariantFragmentManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_164122;
  logCategory__hmf_once_v4_164122 = v0;
}
