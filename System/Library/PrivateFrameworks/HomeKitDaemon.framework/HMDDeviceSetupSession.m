...
- (void)_sendRequestData:(id)a3
{
  ...
  uint64_t v18 = *MEMORY[0x263F0C688];
  v19[0] = v4;
  unint64_t v5 = [NSDictionary dictionaryWithObjects:v19 forKeys:&v18 count:1];
  int64_t v6 = [MEMORY[0x263F42568] entitledMessageWithName:*MEMORY[0x263F0C6A8] messagePayload:v5];
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v16 = 2112;
    v17 = v6;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Sending data : %@", (uint8_t *)&v14, 0x16u);
  }
}
...
void __44__HMDDeviceSetupSession__handleReceiveData___block_invoke(uint64_t a1)
{
  ...
  v2 = (void *)MEMORY[0x230FBD990]([*(id *)(*(void *)(a1 + 32) + 8) markWithReason:@"Received data"]);
  id v3 = *(id *)(a1 + 32);
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v45 = 2112;
    id v46 = v6;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Received receive data request : %@", buf, 0x16u);
  }
  uint64_t v7 = *MEMORY[0x263F0C688];
  id v8 = [*(id *)(a1 + 40) dataForKey:*MEMORY[0x263F0C688]];
  if (v8)
  {
      ...
      if (v30)
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v45 = 2112;
          id v46 = v33;
          _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_INFO, "%{public}@Going to close the session as the state is now complete: [isOpen : %@]", buf, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v45 = 2112;
        id v46 = v15;
        _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to process session data with error: %@", buf, 0x16u);
      }
...
LABEL_21:
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v44 = v22;
    _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Missing session data", buf, 0xCu);
  }
  v23 = *(void **)(a1 + 40);
...
- (void)close:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v14 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Called to close session", buf, 0xCu);
  }
...
- (void)_handleClose:(id)a3
{
  ...
  id v4 = a3;
  unint64_t v5 = (void *)MEMORY[0x230FBD990]([(HMFActivity *)self->_activity begin]);
  id v6 = self;
  uint64_t v7 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v15 = 2112;
    __int16 v16 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Received close request : %@, [isOpen = %@]", (uint8_t *)&v11, 0x20u);
  }
  id v10 = [v4 errorForKey:*MEMORY[0x263F0C690]];
...
- (void)_closeWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v44 = 2112;
    id v45 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@CloseWithError: [isOpen: %@] [error: %@]", buf, 0x20u);
  }
  if ([(HMDDeviceSetupSession *)v6 isOpen])
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v42 = 2112;
      id v43 = v4;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Closing the session with error:%@", buf, 0x16u);
    }
    ...
    if (v4)
    {
      ...
      uint64_t v36 = *MEMORY[0x263F0C690];
      id v37 = v19;
...
LABEL_11:
    ...
    id v25 = [MEMORY[0x263F42568] entitledMessageWithName:*MEMORY[0x263F0C680] messagePayload:v20];
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v44 = 2112;
      id v45 = v25;
      _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_INFO, "%{public}@Going to call the delegate with error:%@, Also sending the close message to client: %@", buf, 0x20u);
    }
...
void __29__HMDDeviceSetupSession_open__block_invoke(uint64_t a1)
{
  ...
  id v3 = (void *)MEMORY[0x230FBD990]([*(id *)(a1 + 40) markWithReason:@"Opening"]);
  id v4 = *(id *)(a1 + 32);
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v43 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Opening", buf, 0xCu);
  }
  uint64_t v7 = *(void **)(a1 + 40);
  uint64_t v46 = @"HomeManagerUUID";
  id v8 = v7;
  id v9 = [v2 uuid];
  ...
  v47[0] = v13;
  id v14 = (id)[NSDictionary dictionaryWithObjects:v47 forKeys:&v46 count:1];

  [*(id *)(a1 + 40) markWithReason:@"HMDDeviceSetupSession.open"];
  [*(id *)(a1 + 32) setOpen:1];
  if (![*(id *)(a1 + 32) role])
  {
    __int16 v15 = [*(id *)(a1 + 32) internal];
    id v40 = 0;
    id v41 = 0;
    id v38 = 0;
    id v39 = 0;
    char v16 = [v15 processSessionData:0 outAccessoryUUID:&v41 outAccessoryCategory:&v40 outAccessoryIDSIdentifier:&v39 error:&v38];
    id v17 = v41;
    id v18 = v40;
    id v19 = v39;
    id v20 = v38;
    ...
    if (v16)
    {
      [*(id *)(a1 + 32) updateAccessoryUUIDAndNotifyDelegate:v17 accessoryIDSIdentifier:v19 accessoryCategory:v18];
      v21 = [*(id *)(a1 + 32) internal];
      ...
      {
        v29 = [v23 internal];
        BOOL v30 = [v29 sessionData];

        if (v30)
        {
          [*(id *)(a1 + 32) _sendRequestData:v30];
          int v28 = 0;
        }
        else
        {
          ...
          if (os_log_type_enabled(v33, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543362;
            id v43 = v34;
            _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_DEFAULT, "%{public}@Missing session data", buf, 0xCu);

            id v31 = v37;
          }

          v35 = *(void **)(a1 + 32);
          uint64_t v36 = [MEMORY[0x263F087E8] hmErrorWithCode:56];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v44 = 2112;
        id v45 = v20;
        _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to send initial session data with error: %@", buf, 0x16u);
      }
      [*(id *)(a1 + 32) _closeWithError:v20];
      [*(id *)(a1 + 32) updateAccessoryUUIDAndNotifyDelegate:v17 accessoryIDSIdentifier:v19 accessoryCategory:v18];
    }
    int v28 = 1;
    goto LABEL_20;
...
- (void)__registerForMessages
{
  ...
  uint64_t v5 = *MEMORY[0x263F0C680];
  v10[0] = v4;
  ...
  uint64_t v7 = *MEMORY[0x263F0C6A8];
  id v9 = v4;
...
LABEL_10:
      _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_INFO, v38, buf, 0xCu);
    }
LABEL_11:
  ...
  char v16 = [(HMDDeviceSetupSession *)&v43 init];
  id v17 = v16;
  if (v16)
  {
    ...
    id v25 = objc_alloc(MEMORY[0x263F424F0]);
    v26 = NSString;
    v27 = [(NSUUID *)v17->_identifier UUIDString];
    int v28 = [v26 stringWithFormat:@"Device Setup Session (%@)", v27];
    ...
    id v41 = [(HMDDeviceSetupSession *)v17 upSecondsFactory];
...
- (HMDDeviceSetupSession)initWithIdentifier:(id)a3 role:(int64_t)a4 homeManager:(id)a5
{
  ...
  id v12 = [(HMDDeviceSetupSession *)self initWithIdentifier:v10 role:a4 homeManager:v9 upSecondsFactory:&__block_literal_global_36463 userDefaults:v11];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t19_36472 != -1) {
    dispatch_once(&logCategory__hmf_once_t19_36472, &__block_literal_global_81);
  }
  v2 = (void *)logCategory__hmf_once_v20_36473;
  return v2;
}
...
void __36__HMDDeviceSetupSession_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v20_36473;
  logCategory__hmf_once_v20_36473 = v0;
}
...
+ (BOOL)isRoleSupported:(int64_t)a3
{
  if (!a3)
  {
    uint64_t v3 = off_264A12438;
    return [(__objc2_class *)*v3 isSupported];
  }
  if (a3 == 1)
  {
    uint64_t v3 = off_264A12440;
    return [(__objc2_class *)*v3 isSupported];
  }
  return 0;
}
