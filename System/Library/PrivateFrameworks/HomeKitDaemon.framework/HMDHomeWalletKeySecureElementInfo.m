...
- (id)attributeDescriptions
{
  ...
  v20 = [(HMDHomeWalletKeySecureElementInfo *)self deviceCredentialKey];
  ...
  v16 = (void *)[v14 initWithName:@"Paired Reader Identifier" value:v15];
  v21[4] = v16;
  v17 = [MEMORY[0x263EFF8C0] arrayWithObjects:v21 count:5];
...
- (HMDHomeWalletKeySecureElementInfo)initWithPaymentApplication:(id)a3 flow:(id)a4
{
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138545154;
    ...
    __int16 v48 = 2112;
    v49 = v24;
    _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] PKPass is missing data. paymentApplication: %@, subcredential: %@, paymentApplication.applicationIdentifier: %@, subcredential.identifier: %@, secureElementIdentifier: %@, subcredential.pairedReaderIdentifier: %@", buf, 0x52u);
...
- (HMDHomeWalletKeySecureElementInfo)initWithDeviceCredentialKey:(id)a3 applicationIdentifier:(id)a4 subCredentialIdentifier:(id)a5 secureElementIdentifier:(id)a6 pairedReaderIdentifier:(id)a7 paymentCredentialType:(int64_t)a8
{
  ...
  BOOL v19 = [(HMDHomeWalletKeySecureElementInfo *)&v31 init];
  if (v19)
  {
...
{
  id v3 = a3;
  id v4 = [[HMDHomeWalletKeySecureElementInfo alloc] initWithDeviceCredentialKey:0 applicationIdentifier:@"A00000085801010100000001" subCredentialIdentifier:@"50306AC7BE75749DA5F104397B29933A78E71B59" secureElementIdentifier:v3 pairedReaderIdentifier:0 paymentCredentialType:0];
...
+ (id)createForEasyProvisioning
{
  v2 = [[HMDHomeWalletKeySecureElementInfo alloc] initWithDeviceCredentialKey:0 applicationIdentifier:&stru_26E2EB898 subCredentialIdentifier:&stru_26E2EB898 secureElementIdentifier:&stru_26E2EB898 pairedReaderIdentifier:0 paymentCredentialType:0];
  return v2;
}
...
LABEL_7:
  ...
  if (a3 != 1004)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v18 = 2048;
      unint64_t v19 = a3;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Unrecognized paymentType, defaulting to HMDPaymentCredentialType0. paymentType: %lu", (uint8_t *)&v14, 0x20u);
    }
    goto LABEL_7;
  }
  int64_t v7 = 1;
