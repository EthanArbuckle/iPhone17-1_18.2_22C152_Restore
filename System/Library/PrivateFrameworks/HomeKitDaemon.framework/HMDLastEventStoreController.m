...
- (void)didRemoveAccessory:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v15 = 2112;
    id v16 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Removing accessory events, accessory: %@", buf, 0x16u);
  }
...
- (void)didRemoveMediaSystem:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v15 = 2112;
    id v16 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Removing media system events, media system: %@", buf, 0x16u);
  }
  v9 = [(HMDLastEventStoreController *)v6 eventStore];
  v10 = NSString;
  v11 = [v4 UUIDString];
...
- (void)didRemoveHome:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v15 = 2112;
    id v16 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Removing home events, home: %@", buf, 0x16u);
  }
  v9 = [(HMDLastEventStoreController *)v6 eventStore];
  v10 = NSString;
  v11 = [v4 UUIDString];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_246475 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_246475, &__block_literal_global_246476);
  }
  v2 = (void *)logCategory__hmf_once_v4_246477;
  return v2;
}
...
void __42__HMDLastEventStoreController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_246477;
  logCategory__hmf_once_v4_246477 = v0;
}
