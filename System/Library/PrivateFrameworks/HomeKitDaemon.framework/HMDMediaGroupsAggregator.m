...
- (void)timerDidFire:(id)a3
{
  ...
  if (v5 == v4)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      int v12 = 138543362;
      v13 = v11;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Warm up timer fired", (uint8_t *)&v12, 0xCu);
    }
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      int v12 = 138543362;
      v13 = v10;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Skipping warmUp debounce refresh due to miss matched timer when fired", (uint8_t *)&v12, 0xCu);
    }
  }
}
...
- (id)roomForAllDestinationParentIdentifiers:(id)a3 mediaSystemsAggregateDataGenerator:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v18 = 2112;
      id v19 = v6;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to get room name for destination parent identifiers: %@ due to no data source", (uint8_t *)&v16, 0x16u);
    }
    v10 = 0;
  }
...
- (void)removeGroupWithIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Removing group with identifier: %@", (uint8_t *)&v11, 0x16u);
  }
...
- (void)updateGroup:(id)a3 participantAccessoryUUIDs:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v18 = 2112;
    id v19 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating group: %@ for participant accessory uuids: %@", (uint8_t *)&v14, 0x20u);
  }
...
- (void)updateGroup:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating group: %@", (uint8_t *)&v11, 0x16u);
  }
  id v9 = [(HMDMediaGroupsAggregator *)v6 groupLocalDataStorage];
  [v9 updateGroup:v4];
...
- (BOOL)updateAssociatedGroupIdentifier:(id)a3 forGroupIdentifier:(id)a4 error:(id *)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v28 = 2112;
    id v29 = v9;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Updating associated group identifier: %@ for group identifier: %@", (uint8_t *)&v24, 0x20u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v26 = 2112;
      id v27 = v9;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to find an local group with identifier: %@", (uint8_t *)&v24, 0x16u);
    }
    if (a5)
    {
      *a5 = [MEMORY[0x263F087E8] hmfErrorWithCode:2];
    }
  }
...
- (void)handleParticipantDataEvent:(id)a3 accessoryUUID:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      id v18 = v6;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to deserialize participant event data from event: %@", (uint8_t *)&v15, 0x16u);
    }
  }
}
...
- (id)participantAccessoryUUIDFromTopic:(id)a3
{
  ...
  id v4 = a3;
  id v5 = [MEMORY[0x263F0E300] decodeTopic:v4];
  id v6 = v5;
  if (v5)
  {
...
LABEL_14:
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v25 = 2112;
        __int16 v26 = v6;
        _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Received unexpected topic id: %@ topic: %@", (uint8_t *)&v21, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v23 = 2112;
        id v24 = v6;
        _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to convert to parsed accessory topic using topic: %@", (uint8_t *)&v21, 0x16u);
LABEL_12:
      }
    }
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v23 = 2112;
    id v24 = v4;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse topic: %@", (uint8_t *)&v21, 0x16u);
  }
  id v10 = 0;
LABEL_15:
...
- (void)didReceiveEvent:(id)a3 topic:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v21 = 2112;
    id v22 = v6;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Received topic: %@ event: %@", (uint8_t *)&v17, 0x20u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v7;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to get participant accessory uuid from topic: %@", (uint8_t *)&v17, 0x16u);
    }
  }
}
...
- (void)clearCachedDataForParticipantAccessoryUUID:(id)a3
{
  ...
  if ((v5 & 1) != 0 || v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v13 = 2112;
      id v14 = v4;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Refreshing aggregate data due to cleared cached data for participant uuid: %@", (uint8_t *)&v11, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v17 = 2112;
      id v18 = v6;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to update destination with identifier: %@ due to no destination manager", buf, 0x16u);
    }
  }
}
...
void __81__HMDMediaGroupsAggregator_updateDestinationWithIdentifier_audioGroupIdentifier___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v13 = 2112;
      id v14 = v3;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to update destination with identifier: %@ due to request error: %@", (uint8_t *)&v9, 0x20u);
    }
  }
}
          ...
          if (v14)
          {
            ...
            if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              __int16 v36 = 2112;
              id v37 = v10;
              _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Fixing up destination: %@ on removed media system: %@ due to removed destination: %@", buf, 0x2Au);
            }
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v19 = 2112;
      id v20 = v7;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Removed destination controller data: %@", buf, 0x16u);
    }
  }
  else
  {
...
- (void)setDestinationControllerData:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Setting destination controller data: %@", (uint8_t *)&v12, 0x16u);
  }
  p_lock = &v6->_lock;
  os_unfair_lock_lock_with_options();
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v19 = 2112;
      id v20 = v7;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Removed destination: %@", buf, 0x16u);
    }
  }
  else
  {
...
- (void)setDestination:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Setting destination: %@", (uint8_t *)&v12, 0x16u);
  }
  p_lock = &v6->_lock;
  os_unfair_lock_lock_with_options();
...
- (void)stop
{
  ...
  if ([(HMDMediaGroupsAggregator *)self setState:0])
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      int v8 = 138543362;
      int v9 = v6;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Stopping destination controller aggregator", (uint8_t *)&v8, 0xCu);
    }
...
- (void)startWarmUpTimer
{
  ...
  if ([(HMDMediaGroupsAggregator *)self shouldWarmUp])
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      int v11 = 138543362;
      int v12 = v6;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting warmup timer", (uint8_t *)&v11, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v19 = 2112;
      id v20 = v13;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Updated state: %@", buf, 0x16u);
    }
  }
  return state != a3;
}
...
- (id)appleMediaAccessories
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      int v11 = 138543362;
      id v12 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to get apple media accessories due to no data source", (uint8_t *)&v11, 0xCu);
    }
    uint64_t v5 = 0;
  }
...
- (id)participantDataTopicForAccessory:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      int v13 = 138543362;
      __int16 v14 = v11;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get destination topic due to no data source", (uint8_t *)&v13, 0xCu);
    }
    id v7 = 0;
  }
...
- (id)aggregateDataTopic
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      int v11 = 138543362;
      id v12 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to get aggregated data topic due to no data source", (uint8_t *)&v11, 0xCu);
    }
    uint64_t v5 = 0;
  }
...
- (BOOL)shouldWarmUp
{
    ...
    if (v5)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v26 = 2112;
          id v27 = v5;
          _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode last cached event participant data: %@ from event: %@", (uint8_t *)&v22, 0x20u);
        }
        BOOL v10 = 0;
      }
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      int v22 = 138543362;
      uint64_t v23 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to get last cached event participant data due to missing topic name", (uint8_t *)&v22, 0xCu);
    }
    BOOL v10 = 0;
  }
  ...
  if (!v3)
  {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          id v27 = v24;
          _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to get event source to forward data", buf, 0xCu);
        }
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v27 = v20;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to get topic name to forward data", buf, 0xCu);
      }
    }
  }
}
...
void __48__HMDMediaGroupsAggregator_forwardAggregateData__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v10 = 2112;
      id v11 = v3;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Forwarding event resulted in error: %@", (uint8_t *)&v8, 0x16u);
    }
  }
}
...
- (void)notifyOfStoppedState
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      int v9 = 138543362;
      __int16 v10 = v8;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Failed to notify of stopped state due to no delegate", (uint8_t *)&v9, 0xCu);
    }
  }
}
    ...
    if (v19)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v34 = 2112;
        v35 = v7;
        _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Refresh resulted in no change to aggregate data: %@", buf, 0x16u);
      }
    }
    else
    {
      __int16 v24 = (void *)MEMORY[0x230FBD990]([(HMDMediaGroupsAggregator *)self setAggregateData:v7]);
      __int16 v25 = self;
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v34 = 2112;
        v35 = v7;
        _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@Updated aggregate data: %@", buf, 0x16u);
      }
    ...
    if (v5)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v19 = 2112;
        id v20 = v4;
        _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Unregistering destination topic: %@ for accessory: %@", buf, 0x20u);
      }
...
void __60__HMDMediaGroupsAggregator_unregisterForEventsForAccessory___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v13 = 2112;
      id v14 = v3;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Unregister for destination topic: %@ resulted in error: %@", (uint8_t *)&v9, 0x20u);
    }
  }
}
...
- (void)unregisterForAllEvents
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v10 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Unregister for all events", buf, 0xCu);
  }
...
void __50__HMDMediaGroupsAggregator_unregisterForAllEvents__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v10 = 2112;
      id v11 = v3;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Unregistering for all events returned with error: %@", (uint8_t *)&v8, 0x16u);
    }
  }
}
    ...
    if (v5)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v19 = 2112;
        id v20 = v4;
        _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Registering participant data topic: %@ for accessory: %@", buf, 0x20u);
      }
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v20 = 2112;
      id v21 = v6;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Register for destination topic: %@ resulted in error: %@", buf, 0x20u);
    }
  }
...
- (void)registerForEvents
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v11 = v8;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to register for events due to no accessories", buf, 0xCu);
    }
  }
}
...
- (void)handleAccessoryChangedRoomNotification:(id)a3
{
  ...
  if ([(HMDMediaGroupsAggregator *)self isRunning])
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      int v9 = 138543362;
      __int16 v10 = v8;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Refreshing aggregate data due to change room notification", (uint8_t *)&v9, 0xCu);
    }
    [(HMDMediaGroupsAggregator *)v6 refreshAggregateData];
  }
}
...
- (void)handlePrimaryResidentDeviceChangeNotification:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v4;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get primary resident change monitor from notification: %@", (uint8_t *)&v12, 0x16u);
    }
  }
}
...
- (void)handleMediaSystemAddedNotification:(id)a3
{
  ...
  if ([(HMDMediaGroupsAggregator *)self isRunning])
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      int v9 = 138543362;
      __int16 v10 = v8;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Refreshing aggregate data due to added media system notification", (uint8_t *)&v9, 0xCu);
    }
    [(HMDMediaGroupsAggregator *)v6 refreshAggregateData];
  }
}
...
- (void)handleHomeRemovedAccessoryNotification:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v4;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to get removed accessory from notification: %@", (uint8_t *)&v17, 0x16u);
    }
  }
}
...
- (void)handleHomeAddedAccessoryNotification:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      id v18 = v4;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to get added accessory from notification: %@", (uint8_t *)&v15, 0x16u);
    }
  }
}
...
- (void)configureWithHome:(id)a3 messageDispatcher:(id)a4 notificationCenter:(id)a5 primaryResidentChangeMonitor:(id)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    int v19 = 138543362;
    id v20 = v17;
    _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Configuring media groups aggregator", (uint8_t *)&v19, 0xCu);
  }
...
LABEL_19:
  ...
  if (v22)
  {
    ...
    uint64_t v30 = [(HMDMediaGroupsAggregateData *)v29 initWithDestinations:MEMORY[0x263EFFA68] destinationControllersData:MEMORY[0x263EFFA68]];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t67_149542 != -1) {
    dispatch_once(&logCategory__hmf_once_t67_149542, &__block_literal_global_149543);
  }
  v2 = (void *)logCategory__hmf_once_v68_149544;
  return v2;
}
...
void __39__HMDMediaGroupsAggregator_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v68_149544;
  logCategory__hmf_once_v68_149544 = v0;
}
