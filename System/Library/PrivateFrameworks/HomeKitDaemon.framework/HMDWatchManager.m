...
- (void)service:(id)a3 connectedDevicesChanged:(id)a4
{
  ...
  if (v8 == v6)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v15 = 2112;
      id v16 = v7;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Connected devices changed: %@", (uint8_t *)&v13, 0x16u);
    }
  ...
  if (v8 == v6)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v27 = 2112;
      id v28 = v7;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Devices changed: %@", buf, 0x16u);
    }
    int v13 = objc_msgSend(MEMORY[0x263EFF980], "arrayWithCapacity:", objc_msgSend(v7, "count"));
    long long v20 = 0u;
    long long v21 = 0u;
    long long v22 = 0u;
    long long v23 = 0u;
...
- (NSArray)watches
{
  ...
  long long v17 = objc_msgSend(MEMORY[0x263EFF980], "arrayWithCapacity:", objc_msgSend(v5, "count"));
  long long v18 = 0u;
  long long v19 = 0u;
  long long v20 = 0u;
  long long v21 = 0u;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7_218098 != -1) {
    dispatch_once(&logCategory__hmf_once_t7_218098, &__block_literal_global_218099);
  }
  v2 = (void *)logCategory__hmf_once_v8_218100;
  return v2;
}
...
void __30__HMDWatchManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v8_218100;
  logCategory__hmf_once_v8_218100 = v0;
}
...
+ (id)sharedManager
{
  if (+[HMDDeviceCapabilities isCompanionCapable])
  {
    ...
    block[4] = a1;
    if (sharedManager_onceToken_218109 != -1) {
      dispatch_once(&sharedManager_onceToken_218109, block);
    }
