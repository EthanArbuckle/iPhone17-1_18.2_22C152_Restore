...
- (void)_handleUnsubscribeMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling unsubscribe message: %@", (uint8_t *)&v22, 0x16u);
  }
  v11 = [v4 transport];
  objc_opt_class();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v26 = 2112;
      v27 = v20;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Unsubscribing transport was not of expected class %@: %@", (uint8_t *)&v22, 0x20u);
    }
    v21 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
...
- (void)_handleSubscribeMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v24 = 2112;
    uint64_t v25 = (uint64_t)v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling subscribe message: %@", (uint8_t *)&v22, 0x16u);
  }
  v11 = [v4 transport];
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v26 = 2112;
      v27 = v20;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Subscribing transport was not of expected class %@: %@", (uint8_t *)&v22, 0x20u);
    }
    v21 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
    [v4 respondWithError:v21];
  }
...
- (void)_handleInitiateFixMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v26 = 2112;
    v27 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling initiate fix message: %@", buf, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v26 = 2112;
      v27 = v19;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Cannot initiate fix for non-Apple-media accessory %@", buf, 0x16u);
    }
    v20 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
...
void __56__HMDAccessorySymptomHandler__handleInitiateFixMessage___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v16 = 2112;
      id v17 = v3;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to initiate fix for accessory %@: %@", (uint8_t *)&v12, 0x20u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v14 = 2112;
      uint64_t v15 = v11;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Successfully initiated fix for accessory: %@", (uint8_t *)&v12, 0x16u);
    }
...
- (void)_notifySubscribedClientConnections:(id)a3
{
  ...
  [v6 setObject:v8 forKeyedSubscript:*MEMORY[0x263F0DB18]];

  uint64_t v9 = [(HMDAccessorySymptomHandler *)self sfDeviceIdentifier];
  [v6 setObject:v9 forKeyedSubscript:*MEMORY[0x263F0DB00]];
  ...
  if (v10)
  {
    ...
    uint64_t v13 = *MEMORY[0x263F0DB10];
    do
    {
      uint64_t v14 = 0;
      do
      {
        ...
        __int16 v16 = [MEMORY[0x263F42590] entitledMessageWithName:v13 messagePayload:v6];
        [v16 setTransport:v15];
        id v17 = objc_alloc(MEMORY[0x263F42570]);
...
- (void)_notifySubscribedClientConnection:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v4;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Notifying subscribed client of updated symptom state: %@", (uint8_t *)&v11, 0x16u);
  }
...
- (void)_notifyAllSubscribedClientConnections
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Notifying all %lu subscribed clients of updated symptom state", (uint8_t *)&v13, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      int v13 = 138543362;
      id v14 = v12;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_DEBUG, "%{public}@No subscribed clients to notify of updated symptom state", (uint8_t *)&v13, 0xCu);
    }
  }
}
...
LABEL_18:
    ...
    *(_OWORD *)buf = *MEMORY[0x263F42330];
    uint64_t v22 = *(void *)(MEMORY[0x263F42330] + 16);
...
- (id)_filteredSymptomsForSymptoms:(id)a3
{
  ...
  if (v9)
  {
    uint64_t v10 = (void *)[objc_alloc(MEMORY[0x263F0E828]) initWithType:11];
    ...
    if (([v11 supportsCaptiveNetworks] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v21 = 2112;
        id v22 = v9;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Remove NeedCaptiveLeaseRenewal symptom as accessory %@ does not support captive networks", (uint8_t *)&v19, 0x16u);
      }
      uint64_t v16 = (void *)[objc_alloc(MEMORY[0x263F0E828]) initWithType:19];
      [v6 removeObject:v16];
    }
  }
...
- (void)_registerMessages
{
  ...
  uint64_t v4 = *MEMORY[0x263F0DAF8];
  ...
  uint64_t v11 = *MEMORY[0x263F0DB08];
  uint64_t v12 = +[HMDXPCMessagePolicy policyWithEntitlements:5];
  int v19 = v12;
  int v13 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v19 count:1];
  ...
  uint64_t v15 = *MEMORY[0x263F0DB20];
...
- (void)updateSymptoms:(id)a3
{
  ...
  if (v7)
  {
    if (v11)
    {
      ...
      __int16 v18 = 2112;
      int v19 = v13;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Not updating accessory symptoms from %@", (uint8_t *)&v16, 0x16u);
    }
  }
  else
  {
    if (v11)
    {
      ...
      __int16 v20 = 2112;
      id v21 = v4;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating accessory symptoms from %@ to %@", (uint8_t *)&v16, 0x20u);
    }
...
- (HMDAccessorySymptomHandler)initWithAccessory:(id)a3 logIdentifier:(id)a4 symptomManager:(id)a5 activeClientConnectionsManager:(id)a6
{
  ...
  if (v14)
  {
    ...
    uint64_t v24 = [MEMORY[0x263F0E830] symptomsHandlerUUIDFromAccessoryUUID:v15->_accessoryUUID];
    uuid = v15->_uuid;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t24_21421 != -1) {
    dispatch_once(&logCategory__hmf_once_t24_21421, &__block_literal_global_21422);
  }
  id v2 = (void *)logCategory__hmf_once_v25_21423;
  return v2;
}
...
void __41__HMDAccessorySymptomHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v25_21423;
  logCategory__hmf_once_v25_21423 = v0;
}
