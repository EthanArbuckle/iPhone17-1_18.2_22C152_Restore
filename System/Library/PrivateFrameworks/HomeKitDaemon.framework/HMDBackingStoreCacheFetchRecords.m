...
- (id)mainReturningError
{
  ...
  v36 = __Block_byref_object_copy__23660;
  v37 = __Block_byref_object_dispose__23661;
  id v38 = 0;
  objc_initWeak(&location, self);
  aBlock[0] = MEMORY[0x263EF8330];
  aBlock[1] = 3221225472;
  aBlock[2] = __54__HMDBackingStoreCacheFetchRecords_mainReturningError__block_invoke;
  aBlock[3] = &unk_264A17F40;
...
BOOL __54__HMDBackingStoreCacheFetchRecords_mainReturningError__block_invoke(uint64_t a1, void *a2, uint64_t a3, void *a4, void *a5, void *a6)
{
  ...
  {
    id v28 = v11;
    id v18 = (void *)[objc_alloc(MEMORY[0x263F08928]) initForReadingFromData:v11 error:0];
    v19 = objc_msgSend(MEMORY[0x263F425D0], "hmf_cachedInstanceForNSString:", v13);
    v27 = *(void **)(a1 + 32);
    v20 = [HMDBackingStoreCacheFetchRecordResult alloc];
    uint64_t v21 = [WeakRetained group];
    uint64_t v22 = [objc_alloc(MEMORY[0x263EFD7C8]) initWithCoder:v18];
    uint64_t v23 = a3;
    v24 = (void *)v22;
