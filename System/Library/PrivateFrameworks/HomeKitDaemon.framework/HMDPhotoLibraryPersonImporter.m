...
LABEL_10:
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, v9, (uint8_t *)&v10, 0xCu);
    }
LABEL_11:
...
- (void)_handleFMFDeviceChanged
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    uint64_t v12 = v8;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@FMF device changed, isThisDesignatedFMFDevice: %@", (uint8_t *)&v9, 0x16u);
  }
...
- (void)_handleUpdatedCloudPhotosSetting
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v12 = 2112;
    uint64_t v13 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Cloud photos enabled changed to %@", (uint8_t *)&v10, 0x16u);
  }
...
- (void)_unconfigure
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    int v10 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Unconfiguring photo library person importer", (uint8_t *)&v9, 0xCu);
  }
...
- (void)_configure
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v12 = 138543362;
    uint64_t v13 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Configuring photo library person importer", (uint8_t *)&v12, 0xCu);
  }
...
- (void)_submitLogEventsForUpdatedPersonsWithCurrentPersons:(id)a3 previousPersons:(id)a4
{
  ...
  id v9 = objc_msgSend(v6, "na_map:", &__block_literal_global_121_139039);
...
- (void)_updateFaceCropsWithCurrentPhotoLibraryFaceCrops:(id)a3 forPersonWithUUID:(id)a4 usingBatchChange:(id)a5
{
  ...
  v62 = v8;
  uint64_t v11 = (void *)MEMORY[0x230FBD990]([(HMDPhotoLibraryPersonImporter *)self _submitLogEventForFaceCrops:v8]);
  int v12 = self;
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v77 = 2112;
    id v78 = v9;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Updating face crops for person with uuid: %@", buf, 0x16u);
  }
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v81 = 2048;
    uint64_t v82 = v22;
    _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Person with uuid: %@ has %lu current photos face crops, and %lu previous face crops in homekit", buf, 0x2Au);
  }
  v64 = v9;
  ...
  if (v27)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v28; ++i)
      {
        ...
        if (v34)
        {
          id v35 = objc_alloc(MEMORY[0x263F0E5C8]);
          ...
          v39 = (void *)MEMORY[0x230FBD990]([v38 setSource:1]);
          v40 = v18;
          ...
          if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_INFO, "%{public}@Adding new face crop for person with uuid %@: %@", buf, 0x20u);
          }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            _os_log_impl(&dword_22F52A000, v45, OS_LOG_TYPE_INFO, "%{public}@Did not receive a valid face crop from HomeAI for photos face crop with uuid: %@ for person with uuid: %@", buf, 0x20u);
          }
        }
      }
      ...
      for (uint64_t j = 0; j != v48; ++j)
      {
        ...
        if (os_log_type_enabled(v54, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          _os_log_impl(&dword_22F52A000, v54, OS_LOG_TYPE_INFO, "%{public}@Removing old face crop for person with uuid %@: %@", buf, 0x20u);
        }
...
- (void)_updateFaceCropsForPersons:(id)a3 usingBatchChange:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v37 = 2112;
    id v38 = v6;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating face crops for persons: %@", buf, 0x16u);
  }
  long long v32 = 0u;
  long long v33 = 0u;
  long long v30 = 0u;
        ...
        else
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v37 = 2112;
            id v38 = v16;
            _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@Photo library query returned nil when querying face crops for person %@, so not modifying their face crops.", buf, 0x16u);
          }
          uint64_t v14 = v22;
          uint64_t v13 = v27;
        }
...
- (void)_updateFaceCropsForPersonsWithUpdatedPhotosFaceCropsUsingCurrentPersons:(id)a3 batchChange:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v16 = v12;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Updating face crops for persons with updated Photos face crops", buf, 0xCu);
  }
...
BOOL __117__HMDPhotoLibraryPersonImporter__updateFaceCropsForPersonsWithUpdatedPhotosFaceCropsUsingCurrentPersons_batchChange___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v24 = 2048;
    uint64_t v25 = v10;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Person: %@ has %lu face crops in homekit, and there are %lu face crops in photos", (uint8_t *)&v18, 0x2Au);
  }
...
- (void)_updateFaceCropsForAllPersonsUsingCurrentPersons:(id)a3 batchChange:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    int v13 = 138543362;
    uint64_t v14 = v12;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Updating face crops for all photos persons", (uint8_t *)&v13, 0xCu);
  }
...
- (id)_updatePersonsUsingBatchChange:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v103 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating persons from photos", buf, 0xCu);
  }
  ...
  if (v11)
  {
    if (v15)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v104 = 2112;
      v105 = v11;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Current Photo Library persons: %@", buf, 0x16u);
    }
    uint64_t v17 = [MEMORY[0x263EFF9A0] dictionary];
    int v18 = [MEMORY[0x263EFF9C0] set];
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v104 = 2112;
      v105 = v27;
      _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@Previous HomeKit persons: %@", buf, 0x16u);
    }
    uint64_t v80 = v24;
    [(HMDPhotoLibraryPersonImporter *)v24 _submitLogEventsForUpdatedPersonsWithCurrentPersons:v11 previousPersons:v21];
    uint64_t v28 = objc_msgSend(MEMORY[0x263EFF9C0], "setWithCapacity:", objc_msgSend(v11, "count"));
    long long v90 = 0u;
    long long v91 = 0u;
    long long v92 = 0u;
    long long v93 = 0u;
      ...
      do
      {
        for (uint64_t i = 0; i != v30; ++i)
        {
          ...
          if (v35)
          {
            ...
            id v38 = (void *)MEMORY[0x230FBD990]([v28 addObject:v36]);
            uint64_t v39 = v80;
...
LABEL_20:
              _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_INFO, v43, buf, 0x16u);
...
LABEL_22:
    ...
    v44 = objc_msgSend(obj, "na_map:", &__block_literal_global_139067);
    long long v86 = 0u;
    long long v87 = 0u;
    long long v88 = 0u;
    long long v89 = 0u;
          ...
          if ((v52 & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v55, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v104 = 2112;
              v105 = v49;
              _os_log_impl(&dword_22F52A000, v55, OS_LOG_TYPE_INFO, "%{public}@Removing person: %@", buf, 0x16u);
            }
            v57 = [v49 UUID];
        ...
        for (uint64_t k = 0; k != v60; ++k)
        {
          ...
          if (os_log_type_enabled(v66, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v104 = 2112;
            v105 = v63;
            _os_log_impl(&dword_22F52A000, v66, OS_LOG_TYPE_INFO, "%{public}@Removing duplicate person: %@", buf, 0x16u);
          }
  ...
  else
  {
    if (v15)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v103 = v70;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Photo library query returned nil when querying current photo library persons, so aborting import process", buf, 0xCu);
    }
    long long v69 = 0;
  }
  ...
  if (v7)
  {
    ...
    if (v10 == 1)
    {
      if (v14)
      {
        ...
        __int16 v25 = 2112;
        id v26 = v3;
        _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Ignoring person with duplicate external person UUID: %@", (uint8_t *)&v23, 0x16u);
      }
      BOOL v16 = *(void **)(a1 + 56);
      id v17 = v3;
    }
...
- (void)_updatePersonsAndFaceCrops:(BOOL)a3
{
  ...
  if (v7)
  {
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v25 = 2112;
      id v26 = v7;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Updating persons and face crops from Photos using shouldUpdateAllFaceCrops: %@ batchChange: %@", (uint8_t *)&v21, 0x20u);
    }
    ...
    if (v14)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v23 = 2112;
        __int16 v24 = v7;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Committing batch change: %@", (uint8_t *)&v21, 0x16u);
      }
      [v7 commit];
    }
  }
  else
  {
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      int v21 = 138543362;
      id v22 = v16;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to create batch data operation for person and face crop update", (uint8_t *)&v21, 0xCu);
    }
  }
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t29_139092 != -1) {
    dispatch_once(&logCategory__hmf_once_t29_139092, &__block_literal_global_133_139093);
  }
  v2 = (void *)logCategory__hmf_once_v30_139094;
  return v2;
}
...
void __44__HMDPhotoLibraryPersonImporter_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v30_139094;
  logCategory__hmf_once_v30_139094 = v0;
}
