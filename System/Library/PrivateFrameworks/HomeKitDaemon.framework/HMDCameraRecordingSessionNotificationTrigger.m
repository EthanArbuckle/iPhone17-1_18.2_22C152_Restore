...
- (void)listener:(id)a3 didUpdateAvailableCharacteristics:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v7;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Enabling notification for characteristics: %@", (uint8_t *)&v17, 0x16u);
  }
  ...
  if ([v13 isReachable]) {
    [(HMDCameraRecordingSessionNotificationTrigger *)v10 _handleObservedCharacteristicsValueUpdate:MEMORY[0x263EFFA68]];
  }
}
...
{
  return [*(id *)(a1 + 32) _handleObservedCharacteristicsValueUpdate:MEMORY[0x263EFFA68]];
}
...
- (void)_handleObservedCharacteristicsValueUpdate:(id)a3
{
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    if ([v4 count])
    {
      ...
      uint64_t v68 = *MEMORY[0x263F0C288];
      uint64_t v67 = *MEMORY[0x263F0C208];
              ...
              if (v18)
              {
                ...
                if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v86 = 2112;
                  id v87 = v24;
                  _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Motion characteristic isActive changed to %@", buf, 0x16u);
                }
                uint64_t v25 = 0;
LABEL_27:
                uint64_t v8 = v70;
              ...
              else
              {
                ...
                if (v34)
                {
                  ...
                  if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)buf = 138543362;
                    v85 = v37;
                    uint64_t v25 = 1;
                    _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Doorbell event detected", buf, 0xCu);
                ...
                if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v86 = 2112;
                  id v87 = v10;
                  _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Unsupported characteristics type: %@", buf, 0x16u);
                }
                uint64_t v8 = v70;
              }
            }
            else
            {
              ...
              if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                __int16 v86 = 2112;
                id v87 = v32;
                _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Expected a number for characteristic value, was %@", buf, 0x16u);
...
LABEL_31:
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v85 = v46;
      _os_log_impl(&dword_22F52A000, v45, OS_LOG_TYPE_INFO, "%{public}@No changed characteristics provided, only evaluating motion detected for triggers", buf, 0xCu);
    }
    long long v81 = 0u;
    long long v82 = 0u;
    long long v79 = 0u;
    ...
    if (v49)
    {
      ...
      uint64_t v52 = *MEMORY[0x263F0C288];
      v69 = v44;
      v71 = v48;
      do
      {
            ...
            else
            {
              ...
              if (os_log_type_enabled(v62, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138544130;
                ...
                v91 = v54;
                id v65 = v64;
                _os_log_impl(&dword_22F52A000, v62, OS_LOG_TYPE_INFO, "%{public}@Received unhandled value %@ of type %@ for characteristic: %@", buf, 0x2Au);
...
LABEL_55:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v85 = v42;
      _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_INFO, "%{public}@No delegate to notify", buf, 0xCu);
    }
  }
}
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Deallocating recording session notification trigger: %@", buf, 0x16u);
  }
...
- (HMDCameraRecordingSessionNotificationTrigger)initWithCamera:(id)a3 workQueue:(id)a4
{
  ...
  v20[0] = v10;
  v19[1] = *MEMORY[0x263F0D6C0];
  id v11 = [MEMORY[0x263EFFA08] setWithObject:*MEMORY[0x263F0C208]];
  v20[1] = v11;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t11_239570 != -1) {
    dispatch_once(&logCategory__hmf_once_t11_239570, &__block_literal_global_239571);
  }
  v2 = (void *)logCategory__hmf_once_v12_239572;
  return v2;
}
...
void __59__HMDCameraRecordingSessionNotificationTrigger_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v12_239572;
  logCategory__hmf_once_v12_239572 = v0;
}
