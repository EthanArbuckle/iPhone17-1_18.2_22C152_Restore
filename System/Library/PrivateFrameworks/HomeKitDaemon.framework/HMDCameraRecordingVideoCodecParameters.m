...
- (BOOL)_parseFromTLVData
{
  ...
  v3 = [MEMORY[0x263F358B8] wrappertlv:1 name:@"kVideoCodecParametersProfileID" objectCreator:&__block_literal_global_196336];
  id v4 = [MEMORY[0x263F358B8] wrappertlv:2 name:@"kVideoCodecParametersLevel" objectCreator:&__block_literal_global_184];
  v5 = [MEMORY[0x263F35A58] wrappertlv:3 name:@"kVideoCodecParameters"];
  id v6 = [MEMORY[0x263F35A58] wrappertlv:4 name:@"kVideoCodecParameters"];
  v20[0] = v3;
  v20[1] = v4;
