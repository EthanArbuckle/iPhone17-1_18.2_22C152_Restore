...
- (id)setVolumeOnEndpoint:(id)a3 outputDeviceUID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v38 = 2112;
    id v39 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Begin setMRAVOutputDeviceVolume on outputDeviceUID %@", buf, 0x16u);
  }
...
{
  id v3 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2972 underlyingError:a2];
...
void __71__HMDMRSetEndpointVolumeOperation_setVolumeOnEndpoint_outputDeviceUID___block_invoke_3(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v28 = 2112;
    id v29 = v13;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Complete setMRAVOutputDeviceVolume on outputDeviceUID %@", buf, 0x16u);
  }
...
- (id)getVolumeCapabilitiesForEndpoint:(id)a3 outputDeviceUID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v27 = 2112;
    id v28 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Begin getMRAVEndpointOutputDeviceUIDVolumeControlCapabilitiesForEndpoint on outputDeviceUID %@", buf, 0x16u);
  }
  v12 = [(HMFOperation *)v9 activity];
  ...
  v19 = [v18 recover:&__block_literal_global_171_32816];
...
void __84__HMDMRSetEndpointVolumeOperation_getVolumeCapabilitiesForEndpoint_outputDeviceUID___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v23 = 2112;
      id v24 = v6;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Unable to determine if volume control is supported on endpoint %@ : %@", buf, 0x20u);
    }
  }
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v21 = 2112;
    uint64_t v22 = v17;
    _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Complete getMRAVEndpointOutputDeviceUIDVolumeControlCapabilitiesForEndpoint on outputDeviceUID %@", buf, 0x16u);
  }
...
{
  v2 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2970 underlyingError:a2];
  id v3 = [MEMORY[0x263F58190] futureWithError:v2];
...
- (id)connectToEndpoint:(id)a3 connection:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v29 = 2112;
    id v30 = v6;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Begin connect to endpoint %@", buf, 0x16u);
  }
  ...
  v19 = [v18 recover:&__block_literal_global_161_32828];
...
void __64__HMDMRSetEndpointVolumeOperation_connectToEndpoint_connection___block_invoke_3(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v23 = 2112;
      id v24 = v6;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Unable to connect to endpoint %@, %@", buf, 0x20u);
    }
  }
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v21 = 2112;
    uint64_t v22 = v18;
    _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Complete connect to endpoint %@", buf, 0x16u);
  }
}

id __64__HMDMRSetEndpointVolumeOperation_connectToEndpoint_connection___block_invoke_159(uint64_t a1, uint64_t a2)
{
  v2 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2971 underlyingError:a2];
  id v3 = [MEMORY[0x263F58190] futureWithError:v2];
...
- (id)discoverRemoteControlEndpointsForUIDs:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v18 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Begin discoverRemoteControlEndpointsMatchingUIDs", buf, 0xCu);
  }
...
void __73__HMDMRSetEndpointVolumeOperation_discoverRemoteControlEndpointsForUIDs___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v28 = 2112;
    id v29 = v6;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Operation endpoints %@ : output devices %@", (uint8_t *)&v24, 0x20u);
  }
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    int v24 = 138543362;
    uint64_t v25 = v16;
    _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Completed discoverRemoteControlEndpointsMatchingUIDs", (uint8_t *)&v24, 0xCu);
  }
  if ([v5 count])
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      int v24 = 138543362;
      uint64_t v25 = v22;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@No endpoints found for volume operation", (uint8_t *)&v24, 0xCu);
    }
    uint64_t v23 = *(void *)(a1 + 32);
    id v17 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2973 description:@"Could not find endpoints" underlyingError:0];
...
- (BOOL)cancelOnSetup
{
      ...
      for (uint64_t i = 0; i != v5; ++i)
      {
        ...
        if (v9)
        {
          ...
          if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v43 = v14;
            _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Volume Operation canceled by dependency failure", buf, 0xCu);
          }
  ...
  if (!v24 && v25)
  {
    ...
    __int16 v32 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:v30 description:v29 underlyingError:0];
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v44 = 2112;
      v45 = v29;
      _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_ERROR, "%{public}@%@", buf, 0x16u);
    }
  }
...
- (void)generateOverallResultAndFinishWithDeviceStatuses:(id)a3 overallError:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v101 = v13;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Volume futures completed", buf, 0xCu);
  ...
  uint64_t v22 = objc_msgSend(v17, "na_map:", &__block_literal_global_102_32872);
  ...
  if (([v20 isEqualToSet:v23] & 1) == 0)
  {
    ...
    int v25 = (void *)MEMORY[0x230FBD990]([v24 minusSet:v23]);
    char v26 = v10;
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v102 = 2112;
      v103 = v24;
      _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_ERROR, "%{public}@Couldn't discover these endpoints to set their volume: %@", buf, 0x16u);
    ...
    if (v29)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v30; ++i)
        {
          ...
          id v35 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2966];
  ...
  id obja = objc_alloc_init(MEMORY[0x263EFF9A0]);
  v37 = [MEMORY[0x263EFF9A0] dictionary];
  long long v38 = [MEMORY[0x263EFF9C0] set];
  long long v89 = 0u;
  long long v90 = 0u;
  long long v91 = 0u;
  long long v92 = 0u;
  ...
  v51 = objc_msgSend(v39, "na_map:", &__block_literal_global_112_32876);
  v52 = v51;
  if (v7)
  {
    id v53 = v7;
  ...
  v54 = v53;
  [obja setObject:v53 forKeyedSubscript:*MEMORY[0x263F08608]];
  ...
  if (v63)
  {
    ...
    if (os_log_type_enabled(v69, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v102 = 2112;
      v103 = v60;
      _os_log_impl(&dword_22F52A000, v69, OS_LOG_TYPE_DEFAULT, "%{public}@Operation finished with partial success <%@>", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v74, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v102 = 2112;
      v103 = v60;
      _os_log_impl(&dword_22F52A000, v74, OS_LOG_TYPE_ERROR, "%{public}@Operation canceled due to failure <%@>", buf, 0x16u);
...
void __39__HMDMRSetEndpointVolumeOperation_main__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  float v23 = [MEMORY[0x263EFF980] array];
  long long v33 = 0u;
  long long v34 = 0u;
  long long v31 = 0u;
  long long v32 = 0u;
...
id __39__HMDMRSetEndpointVolumeOperation_main__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  id v39 = objc_msgSend(MEMORY[0x263EFF980], "arrayWithCapacity:", objc_msgSend(v4, "count"));
  long long v56 = 0u;
  long long v57 = 0u;
  long long v54 = 0u;
  long long v55 = 0u;
        ...
        if (v8)
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            __int16 v64 = 2112;
            id v65 = v11;
            _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Found %@ matching route IDs (%@) on the output device: %@", buf, 0x2Au);
          }
          if ([v12 count])
          {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v60 = 2112;
            id v61 = v6;
            _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Got nil output device from outputDeviceRef %@", buf, 0x16u);
          }
        }
      }
      uint64_t v42 = [obj countByEnumeratingWithState:&v54 objects:v66 count:16];
  ...
  uint64_t v29 = (void *)MEMORY[0x263F581B8];
  ...
  long long v33 = [v32 flatMap:&__block_literal_global_32901];
...
id __39__HMDMRSetEndpointVolumeOperation_main__block_invoke_83(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v18 = 2112;
      id v19 = v3;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Skipping setMRAVOutputDeviceVolume on outputDeviceUID %@. Volume not controllable with given capabilities: %@", (uint8_t *)&v14, 0x20u);
    }
...
- (HMDMRSetEndpointVolumeOperation)initWithRouteIDs:(id)a3 volume:(id)a4 externalObjectInterface:(id)a5
{
  ...
  if (v11)
  {
    ...
    *(float *)&double v14 = v13 / 100.0;
    ...
    id v19 = (void *)[objc_alloc(MEMORY[0x263F424F0]) initWithName:@"HMDMRSetEndpointVolumeOperation"];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t24_32923 != -1) {
    dispatch_once(&logCategory__hmf_once_t24_32923, &__block_literal_global_190);
  }
  id v2 = (void *)logCategory__hmf_once_v25_32924;
  return v2;
}
...
void __46__HMDMRSetEndpointVolumeOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v25_32924;
  logCategory__hmf_once_v25_32924 = v0;
}
