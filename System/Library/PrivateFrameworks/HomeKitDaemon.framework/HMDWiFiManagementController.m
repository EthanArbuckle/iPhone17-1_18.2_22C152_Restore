      ...
      if (!v16)
      {
        if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v50 = 2112;
          id v51 = v17;
          _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize Wi-Fi Configuration Control request for %@: %@", buf, 0x20u);
        }
        if (!v15)
        {
          v16 = 0;
        ...
        v23 = [MEMORY[0x263F087E8] hmErrorWithCode:-1];
...
LABEL_16:
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v50 = 2112;
        id v51 = v8;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Writing Wi-Fi Configuration Control request for %@: %@", buf, 0x20u);
      }
      v23 = +[HMDCharacteristicWriteRequest writeRequestWithCharacteristic:v13 value:v16 authorizationData:0 type:0];
      v45 = v23;
      v24 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v45 count:1];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v48 = 2112;
        v49 = v14;
        _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_INFO, "%{public}@Reading Wi-Fi Configuration Control for %@", buf, 0x16u);
      }
      id v17 = +[HMDCharacteristicRequest requestWithCharacteristic:v13];
      id v44 = v17;
      v16 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v44 count:1];
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@Missing required characteristic: %@", buf, 0x16u);
  }
  if (v10)
  {
...
void __98__HMDWiFiManagementController__performWiFiConfigurationControlRequest_withDescription_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!v6)
  {
    ...
    {
      id v32 = 0;
      v18 = [MEMORY[0x263F35B08] parsedFromData:v17 error:&v32];
      id v14 = v32;
      if (v18)
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v37 = 2112;
          id v38 = v18;
          _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Received Wi-Fi Configuration Control response for %@: %@", buf, 0x20u);
        }
...
LABEL_23:
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v37 = 2112;
      id v38 = v14;
      _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse Wi-Fi Configuration Control response for %@: %@", buf, 0x20u);
    }
    ...
    if (v30)
    {
      ...
      {
        v31 = [MEMORY[0x263F087E8] hmErrorWithCode:43];
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v37 = 2112;
    id v38 = v12;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Wi-Fi Configuration Control request for %@ failed: %@", buf, 0x20u);
  }
...
- (void)_reconfigurationCompletedWithSuccess:(BOOL)a3 error:(id)a4
{
  ...
  if (v7)
  {
    ...
    else
    {
      ...
      if (!v14)
      {
        id v9 = [MEMORY[0x263F087E8] hmErrorWithCode:52];
        [v7 setError:v9];
...
- (void)_commitConfigurationUpdate
{
  ...
  id v5 = objc_alloc(MEMORY[0x263F35AF0]);
...
LABEL_12:
    ...
    && [*(id *)(a1 + 32) reconfigurationCookie] == v11)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      int v26 = 138543362;
      v27 = v15;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Fail-safe Wi-Fi reconfiguration successful", (uint8_t *)&v26, 0xCu);
    }
    v16 = *(void **)(a1 + 32);
    uint64_t v17 = 1;
    id v18 = 0;
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v32 = 1024;
    int v33 = v23;
    _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to commit fail-safe Wi-Fi reconfiguration (cookie: %04x, status: %08x, expected cookie: %04x)", (uint8_t *)&v26, 0x1Eu);
  }
  uint64_t v24 = *(void **)(a1 + 32);
  v25 = [MEMORY[0x263F087E8] hmErrorWithCode:52];
  ...
  if (v6 == v4)
  {
    ...
    if (v7 == 2)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        int v13 = 138543362;
        id v14 = v11;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Fail-safe Wi-Fi reconfiguration failed - timed out waiting for accessory reconnection", (uint8_t *)&v13, 0xCu);
      }
      v12 = [MEMORY[0x263F087E8] hmErrorWithCode:100];
...
void __60__HMDWiFiManagementController__accessoryDidBecomeReachable___block_invoke_3(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      int v9 = 138543362;
      id v10 = v6;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Fail-safe Wi-Fi reconfiguration connection verification failed", (uint8_t *)&v9, 0xCu);
    }
    int64_t v7 = *(void **)(a1 + 32);
    int v8 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1081];
...
LABEL_9:
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v21 = 2112;
    uint64_t v22 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Performing fail-safe Wi-Fi reconfiguration with SSID '%@'", buf, 0x16u);
  }
  ...
  v16[1] = 3221225472;
  v16[2] = __102__HMDWiFiManagementController_safelyReconfigureWithSSID_PSK_verificationCallback_logEvent_completion___block_invoke_24;
  v16[3] = &unk_264A1CC40;
  v16[4] = v14;
  id v17 = *(id *)(a1 + 40);
  id v18 = *(id *)(a1 + 56);
...
void __102__HMDWiFiManagementController_safelyReconfigureWithSSID_PSK_verificationCallback_logEvent_completion___block_invoke_24(id *a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    {
      id v37 = a1[4];
      id v38 = [MEMORY[0x263F087E8] hmErrorWithCode:15];
    ...
    else
    {
      ...
      if (v22 != v20)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v46 = 2048;
          uint64_t v47 = v22;
          _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Configured %@ value %ld is out of range, using %ld", buf, 0x2Au);
        }
      }
      id v27 = objc_alloc_init(MEMORY[0x263F35B08]);
      id v28 = (void *)[objc_alloc(MEMORY[0x263F35B10]) initWithValue:3];
      [v27 setOperationType:v28];

      id v29 = objc_alloc(MEMORY[0x263F35AF0]);
      ...
      id v33 = objc_alloc(MEMORY[0x263F35AF0]);
      ...
      v39[1] = 3221225472;
      v39[2] = __102__HMDWiFiManagementController_safelyReconfigureWithSSID_PSK_verificationCallback_logEvent_completion___block_invoke_32;
      v39[3] = &unk_264A1CC18;
      v39[4] = v36;
      v39[5] = v22;
    ...
    && [*(id *)(a1 + 32) reconfigurationCookie] == (unsigned __int16)v8)
  {
    ...
    if ((v8 & 0x20000) != 0)
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v30 = 2048;
        *(void *)int v31 = v23;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Fail-safe Wi-Fi reconfiguration initiated, awaiting accessory disconnect/reconnect with timeout of %ld seconds", (uint8_t *)&v28, 0x16u);
      }
      ...
      id v26 = (void *)[objc_alloc(MEMORY[0x263F42658]) initWithTimeInterval:1 options:(double)*(uint64_t *)(a1 + 40)];
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      int v28 = 138543362;
      id v29 = v13;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Wi-Fi reconfiguration without session restart is not supported", (uint8_t *)&v28, 0xCu);
    }
    id v14 = *(void **)(a1 + 32);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)int v31 = v8;
      v31[2] = 1024;
      *(_DWORD *)&v31[3] = v20;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to initiate fail-safe Wi-Fi reconfiguration (status: %08x, expected cookie: %04x)", (uint8_t *)&v28, 0x18u);
    }
    id v14 = *(void **)(a1 + 32);
    uint64_t v15 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1080];
  }
...
LABEL_9:
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v26 = 2112;
    uint64_t v27 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Performing simple Wi-Fi reconfiguration with SSID '%@'", buf, 0x16u);
  }
  id v10 = *(void **)(a1 + 48);
  if (v10) {
    id v11 = v10;
  ...
  id v15 = (void *)[objc_alloc(MEMORY[0x263F35AF0]) initWithValue:&unk_26E471350];
  [v14 setCookie:v15];
  ...
  v20[1] = 3221225472;
  v20[2] = __75__HMDWiFiManagementController_reconfigureWithSSID_PSK_logEvent_completion___block_invoke_17;
  v20[3] = &unk_264A1CBF0;
  id v21 = v12;
  id v22 = v17;
  id v23 = *(id *)(a1 + 64);
...
LABEL_5:
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      int v17 = 138543362;
      id v18 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Simple Wi-Fi reconfiguration successful", (uint8_t *)&v17, 0xCu);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t23_78294 != -1) {
    dispatch_once(&logCategory__hmf_once_t23_78294, &__block_literal_global_78295);
  }
  v2 = (void *)logCategory__hmf_once_v24_78296;
  return v2;
}
...
void __42__HMDWiFiManagementController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v24_78296;
  logCategory__hmf_once_v24_78296 = v0;
}
...
+ (id)sharedPSKForNetworkWithSSID:(id)a3
{
  ...
  id v23 = @"ssid";
  v24[0] = v3;
  int64_t v4 = [NSDictionary dictionaryWithObjects:v24 forKeys:&v23 count:1];
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v19 = 2112;
      id v20 = v3;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@No password available for Wi-Fi network '%@", buf, 0x16u);
    }
    id v8 = 0;
  }
  else
  {
    id v8 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F08410] code:0 userInfo:0];
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v21 = 2112;
      id v22 = v8;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to retrieve Wi-Fi network information for '%@': %@", buf, 0x20u);
    }
  }
  id v9 = 0;
LABEL_11:
