...
+ (id)reverseTransformedValue:(id)a3 error:(id *)a4
{
  ...
  if (v4)
  {
    v6 = objc_msgSend(v4, "hmf_UUIDForKey:", @"HMDCSEFC.ck.UUID");
    if (v6)
    {
      v7 = objc_msgSend(v5, "hmf_UUIDForKey:", @"HMDCSEFC.ck.personManagerUUID");
      if (v7)
      {
        v8 = objc_msgSend(v5, "hmf_UUIDForKey:", @"HMDCSEFC.ck.personUUID");
        v9 = [v5 valueForKey:@"HMDCSEFC.ck.personName"];
        v10 = objc_msgSend(v5, "hmf_UUIDForKey:", @"HMDCSEFC.ck.unassociatedFaceCropUUID");
