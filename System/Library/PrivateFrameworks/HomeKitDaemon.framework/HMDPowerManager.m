...
LABEL_24:
    ...
    v6 = Mutable;
    CFStringRef NetworkInterfaceEntity = SCDynamicStoreKeyCreateNetworkInterfaceEntity(0, (CFStringRef)*MEMORY[0x263F1BC10], (CFStringRef)*MEMORY[0x263F1BBF0], (CFStringRef)*MEMORY[0x263F1BC70]);
