...
- (void)_handleHH2CloudKitOperationEvent:(id)a3;
...
- (void)start
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    uint64_t v11 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting", (uint8_t *)&v10, 0xCu);
  }
  v7 = [(HMDPowerLogObserver *)v4 context];
  v8 = [v7 logEventDispatcher];
...
- (void)_handleHH2CloudKitOperationEvent:(id)a3
{
  if ([a3 operationType] == 1)
  {
    id v5 = [(HMDPowerLogObserver *)self context];
    v4 = [v5 powerLogger];
    [v4 reportIncomingCloudPush:@"HH2 CloudKit Import"];
  }
}
...
- (void)_reportCameraSettingsConfiguration:(id)a3
{
  ...
  [v40 setObject:@"HomeKit Camera Configuration" forKeyedSubscript:*MEMORY[0x263F42018]];
  ...
  v36 = [v35 powerLogger];
  uint64_t v37 = *MEMORY[0x263F42020];
  v38 = (void *)[v40 copy];
...
- (void)_reportConfiguration:(id)a3
{
  ...
  [v29 setObject:@"HomeKit Home Configuration" forKeyedSubscript:*MEMORY[0x263F42018]];
  ...
  [v29 setObject:MEMORY[0x263EFFA88] forKeyedSubscript:@"isCurrentDeviceHH2Enabled"];
  v25 = [(HMDPowerLogObserver *)self context];
  v26 = [v25 powerLogger];
  uint64_t v27 = *MEMORY[0x263F42028];
  v28 = (void *)[v29 copy];
...
- (HMDPowerLogObserver)initWithLogEventDispatcher:(id)a3
{
  ...
  id v6 = [MEMORY[0x263F425F8] sharedPowerLogger];
...
+ (id)supportedEventClasses
{
  if (supportedEventClasses_onceToken != -1) {
    dispatch_once(&supportedEventClasses_onceToken, &__block_literal_global_42654);
  }
