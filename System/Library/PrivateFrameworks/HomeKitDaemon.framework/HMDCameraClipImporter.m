...
- (id)importClipsWithImportData:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v116 = 2112;
    v117 = v75;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Importing clips using import data: %@", buf, 0x16u);

    id v4 = v75;
  }

  v9 = objc_msgSend(v4, "na_map:", &__block_literal_global_219598);
  v10 = (void *)MEMORY[0x263F581B8];
          ...
          if (v38)
          {
            ...
            do
            {
              for (uint64_t i = 0; i != v39; ++i)
              {
                ...
                {
                  uint64_t v52 = MEMORY[0x230FBD990]();
                  v53 = v6;
                  v54 = (void *)v52;
                  v55 = v53;
                  ...
                  if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_DWORD *)buf = 138543874;
                    ...
                    __int16 v118 = 2112;
                    id v119 = v47;
                    _os_log_impl(&dword_22F52A000, v56, OS_LOG_TYPE_ERROR, "%{public}@Could not load data from %@: %@", buf, 0x20u);
                  }
                  v6 = v82;
                }
              }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v66, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v116 = 2112;
            v117 = v70;
            _os_log_impl(&dword_22F52A000, v66, OS_LOG_TYPE_ERROR, "%{public}@First fragment in clip %@ is not header, skipping", buf, 0x16u);
          }
          v6 = v82;
        }
        ++v15;
...
void __51__HMDCameraClipImporter_importClipsWithImportData___block_invoke_43(id *a1, void *a2)
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v26 = 2112;
      v27 = v13;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Loaded %lu bytes of hero frame data from %@", (uint8_t *)&v22, 0x20u);
    }
    ...
    v17 = [a1[6] addNotificationForSignificantEvent:v16];
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Could not load data from %@", (uint8_t *)&v22, 0x16u);
    }
    v16 = [MEMORY[0x263F087E8] hmfErrorWithCode:3];
...
void __51__HMDCameraClipImporter_importClipsWithImportData___block_invoke_49(id *a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    uint64_t v15 = v8;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Found new video init data: %@", (uint8_t *)&v12, 0x16u);
  }
...
void __51__HMDCameraClipImporter_importClipsWithImportData___block_invoke_50(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v19 = 2112;
    v20 = v9;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Loaded %lu bytes from %@", (uint8_t *)&v15, 0x20u);
  }
  v10 = *(void **)(a1 + 56);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_219752 != -1) {
    dispatch_once(&logCategory__hmf_once_t9_219752, &__block_literal_global_54_219753);
  }
  id v2 = (void *)logCategory__hmf_once_v10_219754;
  return v2;
}
...
void __36__HMDCameraClipImporter_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v10_219754;
  logCategory__hmf_once_v10_219754 = v0;
}
