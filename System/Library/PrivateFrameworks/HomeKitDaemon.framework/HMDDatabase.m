...
- (void)cloudZone:(id)a3 didEncounterZoneDisabledError:(id)a4
{
  ...
  id v8 = v7;
  id v9 = v6;
  v10 = objc_msgSend(v9, "localZone", v11, 3221225472, __55__HMDDatabase_cloudZone_didEncounterZoneDisabledError___block_invoke, &unk_264A20CD0);
...
- (void)cloudZone:(id)a3 didRemoveParticipantWithClientIdentifier:(id)a4
{
  ...
  id v8 = v7;
  id v9 = v6;
  v10 = objc_msgSend(v9, "localZone", v11, 3221225472, __66__HMDDatabase_cloudZone_didRemoveParticipantWithClientIdentifier___block_invoke, &unk_264A20CD0);
  [(HMDDatabase *)self performZoneDelegateCallback:&v11 forLocalZone:v10];
}
...
- (void)cloudZone:(id)a3 didUpdateParticipantWithClientIdentifier:(id)a4
{
  ...
  id v8 = v7;
  id v9 = v6;
  v10 = objc_msgSend(v9, "localZone", v11, 3221225472, __66__HMDDatabase_cloudZone_didUpdateParticipantWithClientIdentifier___block_invoke, &unk_264A20CD0);
  [(HMDDatabase *)self performZoneDelegateCallback:&v11 forLocalZone:v10];
}
...
- (void)cloudDatabase:(id)a3 didReceiveMessageWithUserInfo:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v19 = 2112;
    id v20 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Cloud database %@ received message with user info %@", buf, 0x20u);
  }
...
- (void)cloudDatabase:(id)a3 didRemoveZoneWithID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v20 = 2112;
    id v21 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Cloud database %@ removed zone with zone ID %@", buf, 0x20u);
  }
  v13[0] = MEMORY[0x263EF8330];
  v13[1] = 3221225472;
...
- (id)cloudDatabase:(id)a3 willRemoveZoneWithID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v25 = 2112;
    id v26 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Cloud database %@ will remove zone with zone ID %@", buf, 0x20u);
  }
  ...
  v15 = [MEMORY[0x263F58190] chainFutures:v13];
...
- (void)cloudDatabase:(id)a3 didCreateZoneWithID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v20 = 2112;
    id v21 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Cloud database %@ created zone with zone ID %@", buf, 0x20u);
  }
  v13[0] = MEMORY[0x263EF8330];
  v13[1] = 3221225472;
...
- (void)localDatabase:(id)a3 willRemoveZoneWithID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v16 = 2112;
    id v17 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Local database %@ will remove zone with ID: %@", (uint8_t *)&v12, 0x20u);
  }
}

- (id)mergedActionFutureForActionFutures:(id)a3
{
  uint64_t v3 = (objc_class *)MEMORY[0x263F58190];
  id v4 = a3;
  id v5 = objc_alloc_init(v3);
  id v6 = (void *)MEMORY[0x263F58190];
  id v7 = [MEMORY[0x263F581B8] immediateScheduler];
...
{
  uint64_t v3 = (objc_class *)MEMORY[0x263F492E8];
  id v4 = a2;
  id v6 = objc_alloc_init(v3);
  uint64_t v5 = objc_msgSend(v4, "na_any:", &__block_literal_global_133989);
...
- (void)addZoneDelegate:(id)a3 forLocalZone:(id)a4
{
  ...
  if (!v9)
  {
    id v9 = [MEMORY[0x263F088B0] weakObjectsHashTable];
    uint64_t v10 = [(HMDDatabase *)self zoneDelegatesByLocalZone];
...
- (id)removeZonesWithID:(id)a3 isPrivate:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v44 = 2112;
    id v45 = v6;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Removing %@ zones with ID %@", buf, 0x20u);
  }
  id v12 = objc_alloc_init(MEMORY[0x263F49270]);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v46 = 2112;
        id v47 = v22;
        _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_ERROR, "%{public}@Failed to open %@ local zone with zoneID %@: %@", buf, 0x2Au);

        v30 = v36;
      }

      uint64_t v23 = [MEMORY[0x263F58190] futureWithError:v22];
    }
    v29 = (void *)v23;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v46 = 2112;
      id v47 = v18;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to open %@ cloud zone with zoneID %@: %@", buf, 0x2Au);
    }
    v29 = [MEMORY[0x263F58190] futureWithError:v18];
  }
...
- (id)zonesWithID:(id)a3 isPrivate:(BOOL)a4 shouldCreate:(BOOL)a5 configuration:(id)a6 delegate:(id)a7 error:(id *)a8
{
  ...
  {
    id v42 = v14;
    id v21 = objc_alloc_init(MEMORY[0x263F49308]);
    ...
    if (v23)
    {
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v55 = 2112;
        id v56 = v44;
        _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_INFO, "%{public}@Successfully opened %@ zones with zoneID: %@, delegate: %@", buf, 0x2Au);
      }
      v31 = v44;
      if (v44) {
    ...
    else
    {
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v55 = 2112;
        id v56 = v24;
        _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to open %@ local zone with zoneID %@: %@", buf, 0x2Au);
      }
      v32 = 0;
      if (a8) {
        *a8 = v24;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v55 = 2112;
      id v56 = v20;
      _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_ERROR, "%{public}@Failed to open %@ cloud zone with zoneID %@: %@", buf, 0x2Au);
...
- (id)acceptInvitation:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Accepting sharing invitation %@", (uint8_t *)&v12, 0x16u);
  }
...
- (id)removeLocalAndCloudDataForLocalZone:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v18 = 2112;
    id v19 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Removing local and cloud data for local zone %@", buf, 0x16u);
  }
...
- (id)removeSharedZonesWithName:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v20 = 2112;
    id v21 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Removing shared zones with name %@", (uint8_t *)&v18, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v20 = 2112;
      id v21 = v4;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Attempted to remove a non-existing shared zone with name: %@", (uint8_t *)&v18, 0x16u);
    }
...
- (id)removePrivateZonesWithName:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    id v16 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Removing private zones with name %@", (uint8_t *)&v13, 0x16u);
  }
  id v9 = objc_alloc(MEMORY[0x263EFD808]);
  BOOL v10 = (void *)[v9 initWithZoneName:v4 ownerName:*MEMORY[0x263EFD488]];
...
- (id)synchronizeSharedZones
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    id v11 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Synchronizing shared zones", (uint8_t *)&v10, 0xCu);
  }
...
- (id)sharedZonesWithID:(id)a3 configuration:(id)a4 delegate:(id)a5 error:(id *)a6
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v22 = 2112;
    id v23 = v10;
    _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Fetching shared zones with zone ID %@", (uint8_t *)&v20, 0x16u);
  }
...
- (id)existingSharedZoneIDWithName:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v26 = 2112;
    id v27 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Finding shared zone ID with zone name %@", buf, 0x16u);
  }
  [(HMDDatabase *)v6 start];
  long long v21 = 0u;
  long long v22 = 0u;
...
- (id)privateZonesWithName:(id)a3 configuration:(id)a4 delegate:(id)a5 error:(id *)a6
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v23 = 2112;
    id v24 = v10;
    _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Fetching private zones with name %@", (uint8_t *)&v21, 0x16u);
  }
  [(HMDDatabase *)v14 start];
  id v17 = objc_alloc(MEMORY[0x263EFD808]);
  int v18 = (void *)[v17 initWithZoneName:v10 ownerName:*MEMORY[0x263EFD488]];
...
- (id)existingPrivateZonesWithName:(id)a3 configuration:(id)a4 delegate:(id)a5 error:(id *)a6
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v23 = 2112;
    id v24 = v10;
    _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Fetching existing private zones with name %@", (uint8_t *)&v21, 0x16u);
  }
  [(HMDDatabase *)v14 start];
  id v17 = objc_alloc(MEMORY[0x263EFD808]);
  int v18 = (void *)[v17 initWithZoneName:v10 ownerName:*MEMORY[0x263EFD488]];
...
- (id)unregisterSharedSubscriptionForExternalRecordType:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Unregistering shared subscription for external record type %@", (uint8_t *)&v12, 0x16u);
  }
  [(HMDDatabase *)v6 start];
  id v9 = [(HMDDatabase *)v6 cloudDatabase];
...
- (id)registerSharedSubscriptionForExternalRecordType:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Registering shared subscription for external record type %@", (uint8_t *)&v12, 0x16u);
  }
  [(HMDDatabase *)v6 start];
  id v9 = [(HMDDatabase *)v6 cloudDatabase];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      int v13 = v7;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Starting database", buf, 0xCu);
    }
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v9 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Deallocating database", buf, 0xCu);
  }
  v7.receiver = v4;
...
- (HMDDatabase)initWithLocalDatabase:(id)a3 cloudDatabase:(id)a4 logEventSubmitter:(id)a5
{
  ...
  if (v12)
  {
    ...
    uint64_t v16 = [MEMORY[0x263F08968] weakToStrongObjectsMapTable];
...
- (HMDDatabase)initWithFileURL:(id)a3 cloudConfiguration:(id)a4
{
  ...
  id v9 = (void *)[objc_alloc(MEMORY[0x263F492B0]) initWithDataVersion:v8 legacyDataVersion:v8];
  id v10 = objc_alloc_init(MEMORY[0x263F49300]);
  [v10 setModelContainer:v9];
  id v11 = (void *)[objc_alloc(MEMORY[0x263F49288]) initWithDatastorePath:v6 configuration:v10];
  if (v11)
  {
    int v12 = (void *)[objc_alloc(MEMORY[0x263F49258]) initWithLocalDatabase:v11 configuration:v7];
    if (v12)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v25 = 2112;
        id v26 = v7;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to create cloud database with configuration %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v27 = 2112;
      id v28 = v7;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to create local database with file URL %@ and cloud configuration %@", buf, 0x20u);
    }
    uint64_t v14 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t41_134066 != -1) {
    dispatch_once(&logCategory__hmf_once_t41_134066, &__block_literal_global_83_134067);
  }
  v2 = (void *)logCategory__hmf_once_v42_134068;
  return v2;
}
...
void __26__HMDDatabase_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v42_134068;
  logCategory__hmf_once_v42_134068 = v0;
}
...
+ (HMDDatabase)hindsightDatabase
{
  ...
  os_unfair_lock_lock_with_options();
  id WeakRetained = objc_loadWeakRetained(&hindsightDatabase_hindsightDatabase);
  if (WeakRetained)
  {
    id v4 = WeakRetained;
  }
  ...
  {
    id v5 = HMVConfigurationCloudKitContainerID();
    id v6 = (void *)[objc_alloc(MEMORY[0x263F492F0]) initWithContainerID:v5];
    [v6 setManateeContainer:1];
    id v7 = objc_alloc((Class)a1);
    id v8 = +[HMDDatabase defaultLocalDatabaseFileURL];
    id v9 = (void *)[v7 initWithFileURL:v8 cloudConfiguration:v6];
  ...
  else
  {
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v22 = 2112;
        __int16 v23 = v11;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Overriding camera clips container identifier to %@", (uint8_t *)&v20, 0x16u);
      }
    ...
    id v13 = objc_alloc(MEMORY[0x263EFD620]);
    uint64_t v14 = (void *)[v13 initWithContainerIdentifier:v12 environment:cloudKitContainerEnvironment];
    id v15 = (void *)[objc_alloc(MEMORY[0x263F492F0]) initWithContainerID:v14];
...
void __30__HMDDatabase_defaultDatabase__block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v19 = 2112;
      int v20 = v8;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Overriding default container identifier to %@", (uint8_t *)&v17, 0x16u);
    }
  ...
  int v12 = (void *)[objc_alloc(MEMORY[0x263F492F0]) initWithContainerID:v11];
