...
LABEL_6:
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, v16, (uint8_t *)&v21, 0x16u);
    }
  }
  else
  {
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_247434 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_247434, &__block_literal_global_247435);
  }
  v2 = (void *)logCategory__hmf_once_v1_247436;
  return v2;
}
...
void __42__HMDNotificationRegistration_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_247436;
  logCategory__hmf_once_v1_247436 = v0;
}
