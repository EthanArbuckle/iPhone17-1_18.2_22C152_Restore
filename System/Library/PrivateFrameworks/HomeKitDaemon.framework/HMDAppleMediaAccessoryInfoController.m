  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v18 = 2112;
      v19 = v5;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Trying to notify with invalid WiFi info: %@", buf, 0x16u);
    }
  }
}
...
uint64_t __71__HMDAppleMediaAccessoryInfoController__notifyDelegateWifiInfoUpdated___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2112;
    uint64_t v11 = v6;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Notifying delegate to update WiFi info: %@ ", (uint8_t *)&v8, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v13 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@Error posting software version update: object is nil", buf, 0xCu);
    }
  }
}
...
void __78__HMDAppleMediaAccessoryInfoController__postUpdateSoftwareVersionIfDifferent___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v41 = 2112;
    v42 = v7;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Posting updated software version: %@ (%@)", buf, 0x20u);
  }
...
LABEL_15:
    ...
    double v27 = v26;
    v28 = (void *)[objc_alloc(MEMORY[0x263F0DFF0]) initWithSoftwareVersion:*(void *)(a1 + 40)];
    v29 = (void *)[objc_alloc(MEMORY[0x263F49390]) initWithSource:v25 cachePolicy:2 combineType:2 timestamp:v27];
    id v30 = objc_alloc(MEMORY[0x263F49380]);
    v31 = [v28 protoData];
  ...
  id v12 = objc_alloc(MEMORY[0x263F0DFF0]);
  v13 = [v11 encodedData];
  ...
  if (!v14)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v41 = 2112;
      v42 = 0;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Error reading stored software version for topic %@, error: %@", buf, 0x20u);
    }
    v34 = v10;
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v38 = v20;
    _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Skip sending event update for software version as it matches stored", buf, 0xCu);
  }
LABEL_16:
}
...
void __78__HMDAppleMediaAccessoryInfoController__postUpdateSoftwareVersionIfDifferent___block_invoke_10(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v10 = 2112;
      id v11 = v3;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error in forwarding the software version info event: %@", (uint8_t *)&v8, 0x16u);
    }
  }
}
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v16 = 2112;
      v17 = v5;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Trying to post invalid WiFi info: %@", buf, 0x16u);
    }
  }
}
...
void __78__HMDAppleMediaAccessoryInfoController__postUpdateWifiNetworkInfoIfDifferent___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v43 = 2112;
    v44 = v8;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Posting updated WiFi: SSID: %@, MAC: %@", buf, 0x20u);
  }
...
LABEL_15:
    ...
    [MEMORY[0x263EFF910] timeIntervalSinceReferenceDate];
    double v29 = v28;
    id v30 = (void *)[objc_alloc(MEMORY[0x263F0DFF8]) initWithWifiNetworkInfo:*(void *)(a1 + 40)];
    v31 = (void *)[objc_alloc(MEMORY[0x263F49390]) initWithSource:v27 cachePolicy:2 combineType:2 timestamp:v29];
    id v32 = objc_alloc(MEMORY[0x263F49380]);
    v33 = [v30 protoData];
  ...
  id v13 = objc_alloc(MEMORY[0x263F0DFF8]);
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v40 = v22;
    _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Skip sending event update for WiFi as it matches stored", buf, 0xCu);
  }
LABEL_16:
}
...
void __78__HMDAppleMediaAccessoryInfoController__postUpdateWifiNetworkInfoIfDifferent___block_invoke_7(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v10 = 2112;
      id v11 = v3;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error in forwarding the WiFi network info event: %@", (uint8_t *)&v8, 0x16u);
    }
  }
}
...
- (id)currentWifiNetworkInfo
{
  ...
  id v9 = objc_alloc(MEMORY[0x263F42688]);
...
- (void)handleCurrentNetworkChangedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v21 = 2112;
    id v22 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Received current network changed notification: %@", (uint8_t *)&v19, 0x16u);
  }
...
- (void)configure
{
  ...
  uint64_t v9 = *MEMORY[0x263F424E8];
  [v8 removeObserver:self name:*MEMORY[0x263F424E8] object:0];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t13_119647 != -1) {
    dispatch_once(&logCategory__hmf_once_t13_119647, &__block_literal_global_119648);
  }
  v2 = (void *)logCategory__hmf_once_v14_119649;
  return v2;
}
...
void __51__HMDAppleMediaAccessoryInfoController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v14_119649;
  logCategory__hmf_once_v14_119649 = v0;
}
