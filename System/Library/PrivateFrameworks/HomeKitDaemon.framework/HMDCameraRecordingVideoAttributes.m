...
- (BOOL)_parseFromTLVData
{
  ...
  v3 = [MEMORY[0x263F35A58] wrappertlv:1 name:@"kVideoAttributesImageWidth"];
  id v4 = [MEMORY[0x263F35A58] wrappertlv:2 name:@"kVideoAttributesImageHeight"];
  v5 = [MEMORY[0x263F35A58] wrappertlv:3 name:@"kVideoAttributesFrameRate"];
  v15[0] = v3;
  v15[1] = v4;
  v15[2] = v5;
...
- (HMDCameraRecordingVideoAttributes)initWithResolution:(int64_t)a3 frameRate:(id)a4
{
  ...
  if (v8)
  {
    ...
    {
      id v11 = (NSNumber *)qword_264A25C08[v10];
      v12 = (NSNumber *)qword_264A25C90[v10];
    }
