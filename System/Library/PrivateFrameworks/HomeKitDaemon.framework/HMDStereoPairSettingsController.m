...
- (void)didReceiveCachedEvent:(id)a3 topic:(id)a4 source:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v9;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Process cached event: %@ topic: %@", (uint8_t *)&v15, 0x20u);
  }
  ...
  if (!v9)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v30 = 2112;
      id v31 = v7;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse topic: %@", buf, 0x16u);
LABEL_8:
    }
LABEL_9:
  ...
  if (!v12)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v34 = 2112;
      v35 = v22;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Received event: %@ topic: %@, failed to find media system with accessory: %@", buf, 0x2Au);
...
uint64_t __57__HMDStereoPairSettingsController_didReceiveEvent_topic___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v7;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Process event: %@ topic: %@", (uint8_t *)&v9, 0x20u);
  }
  ...
  if ([v9 isEqual:v8])
  {
    if (a3 != 3 || a4 == 3)
    {
      if (a3 != 3 && a4 == 3)
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
        {
          ...
          int v18 = 138543362;
          __int16 v19 = v17;
          _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_DEBUG, "%{public}@State change from primary to non-primary: subscribe to the group owner", (uint8_t *)&v18, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
      {
        ...
        int v18 = 138543362;
        __int16 v19 = v13;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEBUG, "%{public}@State change from primary to non-primary: unsubscribe to the group owner", (uint8_t *)&v18, 0xCu);
      }
    ...
    if (v8 && [v8 count])
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v31 = 2112;
        __int16 v32 = v9;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@unsubscribing to home: %@, (owner) accessory: %@ topics: %@", buf, 0x2Au);
      }
      ...
      v24[3] = &unk_264A2E660;
      v24[4] = v11;
      [v15 changeRegistrationsForConsumer:v11 topicFilterAdditions:MEMORY[0x263EFFA68] topicFilterRemovals:v9 completion:v24];
    }
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v29 = 2112;
        __int16 v30 = v7;
        _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@No topics for home: %@ accessory: %@", buf, 0x20u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v27 = 2112;
      id v28 = v4;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Media system %@ does not have an owner", buf, 0x16u);
    }
  }
}
...
LABEL_4:
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, v11, (uint8_t *)&v12, 0x16u);
          ...
          if (!v12)
          {
            ...
            if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v39 = 2112;
              id v40 = v30;
              _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Component is nil for media system %@", buf, 0x16u);
            }
            id v6 = obj;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v39 = 2112;
      id v40 = 0;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Ask to compute owner for media system: %@", buf, 0x16u);
    }
    v23 = 0;
  }
...
- (void)_postAsStereoPairEventsIfDifferentForHome:(id)a3 mediaSystem:(id)a4 keyPath:(id)a5 setting:(id)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v53 = 2112;
    id v54 = v11;
    _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Forward media system %@ keypath: %@", buf, 0x20u);
  ...
  v45 = (void *)v19;
  uint64_t v44 = [objc_alloc(MEMORY[0x263F0E3F8]) initWithSetting:v12 eventSource:v19 eventTimestamp:v20];
  ...
  id v48 = 0;
  id v25 = [MEMORY[0x263F0E3F8] decodeSettingFromEvent:v24 error:&v48];
  id v26 = v48;
  if (v26)
  {
    id v40 = v12;
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v53 = 2112;
      id v54 = v26;
      _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@Error reading stored setting for topic %@, error: %@", buf, 0x20u);
...
LABEL_15:
    ...
    v37 = (void *)v44;
    [v38 forwardEvent:v44 topic:v21 completion:&__block_literal_global_14_264706];
  ...
  if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v51 = 2114;
    id v52 = v36;
    _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_INFO, "%{public}@Skip sending event for keyPath: %{public}@ as it matches stored", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v37 = 2112;
          id v38 = v34;
          _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_DEBUG, "%{public}@Language List:%@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v39 = 2112;
            id v40 = v11;
            _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_ERROR, "%{public}@Received unknown event type: %@ topic: %@", buf, 0x20u);
    ...
    if (v8 && [v8 count])
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v35 = 2112;
        uint64_t v36 = v9;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Subscribing to home: %@, (owner) accessory: %@ topics: %@", buf, 0x2Au);
      }
      ...
      id v27 = v5;
      id v28 = v4;
      [v15 changeRegistrationsForConsumer:v11 topicFilterAdditions:v25 topicFilterRemovals:MEMORY[0x263EFFA68] completion:v24];
    }
    else
    {
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v27 = 2112;
      id v28 = v6;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Error in subscribing to topics %@ error: %@", buf, 0x20u);
    }
  }
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v25 = 2112;
      uint64_t v26 = v14;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Successfully subscribed to (owner) accessory: %@", buf, 0x16u);
    }
      ...
      for (uint64_t i = 0; i != v4; ++i)
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = v16;
          ...
          __int16 v26 = 2112;
          uint64_t v27 = v7;
          _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Process cached event: %@ topic: %@", buf, 0x20u);
        }
        id v13 = *(void **)(a1 + 40);
        uint64_t v14 = *(void *)(a1 + 48);
...
- (id)_groupOwnerTopicsForMediaSystem:(id)a3
{
  ...
  if (v5 && v6)
  {
    id v8 = [MEMORY[0x263F0E048] defaultSettingsAllKeyPaths];
    ...
    uint64_t v12 = [MEMORY[0x263F0E048] languageKeyPaths];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v31 = 2112;
      id v32 = v4;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Media system %@ does not have an owner", buf, 0x16u);
    }
    uint64_t v14 = 0;
  }
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v25 = v8;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@Ask to stop subscription on primary resident", buf, 0xCu);
    }
  }
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v25 = v9;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Primary resident changed and unsubscribe all", buf, 0xCu);
    }
  ...
  if ([(HMDStereoPairSettingsController *)self _currentDevicePrimaryResident])
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v24 = 2112;
      id v25 = v8;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Current device for home %@ is primary resident", buf, 0x16u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t26_264730 != -1) {
    dispatch_once(&logCategory__hmf_once_t26_264730, &__block_literal_global_16_264731);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v27_264732;
  return v2;
}
...
void __46__HMDStereoPairSettingsController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v27_264732;
  logCategory__hmf_once_v27_264732 = v0;
}
