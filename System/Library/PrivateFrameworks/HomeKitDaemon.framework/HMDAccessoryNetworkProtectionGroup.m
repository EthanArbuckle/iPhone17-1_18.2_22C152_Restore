  ...
  else
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      id v39 = v47;
      _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_ERROR, "%{public}@Unknown model object (%@) sent to [%@ transactionObjectUpdated]", buf, 0x20u);
    }
...
- (void)transactionObjectRemoved:(id)a3 message:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    id v12 = v19;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Unknown model object (%@) sent to [%@ transactionObjectRemoved]", (uint8_t *)&v14, 0x20u);
  }
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if ((objc_msgSend(v13, "hmd_isForRemoteGatewayCoder") & 1) == 0)
  {
    ...
    {
      id v6 = [(HMDAccessoryNetworkProtectionGroup *)self uuid];
      [v13 encodeObject:v6 forKey:*MEMORY[0x263F0B428]];

      id v7 = [(HMDAccessoryNetworkProtectionGroup *)self manufacturer];
      [v13 encodeObject:v7 forKey:*MEMORY[0x263F0B3F8]];

      int64_t v8 = [(HMDAccessoryNetworkProtectionGroup *)self targetProtectionMode];
      [v13 encodeInteger:v8 forKey:*MEMORY[0x263F0B408]];
    }
    if (v4)
    {
      if (!v5) {
      ...
      id v10 = [(HMDAccessoryNetworkProtectionGroup *)self category];
      id v11 = [v9 categoryWithCategoryIdentifier:v10];

      id v12 = (__CFString *)*MEMORY[0x263F0B3F0];
    }
    else
    {
      id v11 = [(HMDAccessoryNetworkProtectionGroup *)self category];
      id v12 = @"HMDAccessoryNetworkProtectionGroupCategoryCodingKey";
    }
...
{
  id v4 = a3;
  int v5 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0B428]];
  id v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0B3F8]];
  id v7 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"HMDAccessoryNetworkProtectionGroupCategoryCodingKey"];
  uint64_t v8 = [v4 decodeIntegerForKey:*MEMORY[0x263F0B408]];
