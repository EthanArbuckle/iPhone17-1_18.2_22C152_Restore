...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_94551 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_94551, &__block_literal_global_94552);
  }
  v2 = (void *)logCategory__hmf_once_v1_94553;
  return v2;
}
...
void __55__HMDCameraIDSSessionInviterDeviceVerifier_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_94553;
  logCategory__hmf_once_v1_94553 = v0;
}
