...
- (id)attributeDescriptions
{
  ...
  v17 = (void *)[v15 initWithName:@"Value" value:v16];
  v48[4] = v17;
  ...
  v48[7] = v26;
  v27 = [MEMORY[0x263EFF8C0] arrayWithObjects:v48 count:8];
...
- (id)characteristicUpdateDictionary
{
  ...
  if (v5 && v6)
  {
    v27[0] = @"kAccessoryUUID";
    id v9 = [v6 uuid];
    v10 = [v9 UUIDString];
    v28[0] = v10;
    v27[1] = @"kServiceInstanceID";
    id v11 = [v5 instanceID];
    v28[1] = v11;
    v27[2] = @"kCharacteristicInstanceID";
    v12 = [v4 instanceID];
    v28[2] = v12;
    ...
    if (self->_remote)
    {
      ...
      [v14 setObject:v15 forKeyedSubscript:@"HMDCharacteristicRequestIsRemoteKey"];
    }
    os_unfair_lock_unlock(&self->_lock);
    v16 = [(HMDCharacteristicResponse *)self error];

    if (v16)
    {
      v17 = (void *)MEMORY[0x263F08910];
      id v18 = [(HMDCharacteristicResponse *)self error];
      v19 = [v17 archivedDataWithRootObject:v18 requiringSecureCoding:1 error:0];

      [v14 setObject:v19 forKeyedSubscript:@"kCharacteristicErrorDataKey"];
    }
    else
    {
      ...
      v19 = [(HMDCharacteristicResponse *)self notificationContext];
      if (v19)
      {
        [v14 setObject:v19 forKeyedSubscript:@"kCharacteristicNotificationContextKey"];
      }
      else
      {
        v25 = [v4 notificationContext];
        [v14 setObject:v25 forKeyedSubscript:@"kCharacteristicNotificationContextKey"];
...
- (HMDCharacteristicResponse)initWithRequest:(id)a3 error:(id)a4
{
  ...
  id v9 = [(HMDCharacteristicResponse *)&v15 init];
  v10 = v9;
  if (v9)
  {
    ...
    if (!v7)
    {
      if ([v53 count] == 1)
      {
        ...
        if (v7 && v9)
        {
          ...
          {
            objc_super v15 = [v10 characteristic];
            [v15 instanceID];
            id v17 = v16 = a1;
            ...
            if (v64)
            {
              ...
              v91[0] = v18;
              v19 = [MEMORY[0x263EFF8C0] arrayWithObjects:v91 count:1];
  ...
  if (v54)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v26 = [MEMORY[0x263F08968] strongToStrongObjectsMapTable];
                      ...
                      else
                      {
                        ...
                        if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
                        {
                          ...
                          *(_DWORD *)buf = 138543874;
                          ...
                          __int16 v86 = 2112;
                          v87 = v47;
                          _os_log_impl(&dword_22F52A000, v45, OS_LOG_TYPE_ERROR, "%{public}@Invalid characteristic update for request: %@. Update Dict: %@", buf, 0x20u);
