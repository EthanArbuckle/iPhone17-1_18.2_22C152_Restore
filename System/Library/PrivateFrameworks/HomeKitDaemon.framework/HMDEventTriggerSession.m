...
- (BOOL)sendMessage:(id)a3 payload:(id)a4 device:(id)a5 target:(id)a6 responseHandler:(id)a7
{
  ...
  if (!v22)
  {
    ...
    v32 = [v24 identifier];
    context = (void *)MEMORY[0x230FBD990]([v24 setResponseHandler:v16]);
    v25 = self;
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v37 = 2112;
      v38 = v32;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@Sending message %@ with identifier %@", buf, 0x20u);
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v15 = 2112;
    id v16 = v8;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Deallocating the %@ session", buf, 0x16u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_100648 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_100648, &__block_literal_global_100649);
  }
  v2 = (void *)logCategory__hmf_once_v2_100650;
  return v2;
}
...
void __37__HMDEventTriggerSession_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_100650;
  logCategory__hmf_once_v2_100650 = v0;
}
