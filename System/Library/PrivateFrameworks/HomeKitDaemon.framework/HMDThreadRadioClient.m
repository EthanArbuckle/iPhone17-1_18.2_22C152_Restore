      ...
      case 0:
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(void *)&buf[14] = v13;
          __int16 v55 = 2112;
          v56 = v14;
          _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Successfully informed Thread layer of primary resident change (isPrimary=%@ primaryThreadCapable=%@)", buf, 0x20u);
        }
...
LABEL_20:
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(void *)&buf[14] = LODWORD(v48[0]);
          __int16 v55 = 2048;
          v56 = (void *)v8;
          _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_DEBUG, "%{public}@CoreThreadRadio result code %lu mapped to HMErrorCode %lu", buf, 0x20u);
        }
        v20 = NSString;
        uint64_t v21 = MEMORY[0x263F8C340] + 64;
        v63[0] = MEMORY[0x263F8C340] + 64;
        v22 = (void *)MEMORY[0x263F8C2C8];
        uint64_t v23 = *(void *)(MEMORY[0x263F8C2C8] + 16);
        ...
        *(void *)&buf[*(void *)(*(void *)buf - 24)] = v23;
        ...
        uint64_t v47 = v8;
        uint64_t v25 = MEMORY[0x263F8C340] + 24;
        v24[1].__vftable = 0;
        v24[1].__fmtflags_ = -1;
        *(void *)buf = v25;
        v63[0] = v21;
        std::streambuf::basic_streambuf();
        uint64_t v26 = MEMORY[0x263F8C318] + 16;
        *(void *)&buf[8] = MEMORY[0x263F8C318] + 16;
        ...
        if (LODWORD(v48[0]) > 0xE) {
          ...
          v27 = off_264A22A40[LODWORD(v48[0])];
        }
...
LABEL_58:
        ...
        *(void *)&buf[8] = v26;
        ...
        v42 = [MEMORY[0x263F087E8] hmErrorWithCode:v41 description:0 reason:v40 suggestion:0];
        ...
        if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_WORD *)&buf[12] = 2112;
          *(void *)&buf[14] = v42;
          _os_log_impl(&dword_22F52A000, v45, OS_LOG_TYPE_ERROR, "%{public}@Failed to inform Thread layer of primary resident update: %@", buf, 0x16u);
        }
...
LABEL_68:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(void *)&buf[4] = v7;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Not informing Thread layer of primary resident change as state has not changed.", buf, 0xCu);
    }
  }
}
...
- (void)_unregisterForThreadNetworkEvents
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
  {
    ...
    int v14 = 138543362;
    uint64_t v15 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_ERROR, "%{public}@registerForThreadNetworkEvents", (uint8_t *)&v14, 0xCu);
  }
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      int v14 = 138543362;
      uint64_t v15 = v13;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Thread radio client is not available on this device", (uint8_t *)&v14, 0xCu);
    }
  }
  else
  {
...
- (void)_registerForThreadNetworkEvents
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      *(void *)&buf[4] = v23;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Thread radio client is not available on this device", buf, 0xCu);
    }
  }
}
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v23 = 2112;
      uint64_t v24 = v10;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Received thread event: event name - %s, value =%@", buf, 0x20u);
      if (v18 < 0) {
        operator delete(__p[0]);
      }
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v18 = 2080;
        v19 = v11;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Ignoring thread event: event name - %s", buf, 0x16u);
        if (v13 < 0) {
          operator delete(__p[0]);
        }
      }
  ...
  if (LODWORD(__p[0]))
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(void *)&uint8_t buf[4] = v11;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@failed to fetch kWPANTUNDProperty_NCPState", buf, 0xCu);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(void *)&buf[14] = v5;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEBUG, "%{public}@fetched kWPANTUNDProperty_NCPState got value =%@", buf, 0x16u);
    }
  ...
  if (__pa)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(void *)&uint8_t buf[4] = v24;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@failed to fetch kWPANTUNDEvent_NetworkNodeType", buf, 0xCu);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_WORD *)&unsigned char buf[12] = 2112;
      *(void *)&buf[14] = v5;
      _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_DEBUG, "%{public}@fetched kWPANTUNDEvent_NetworkNodeType got value =%@", buf, 0x16u);
    }
...
- (id)_WEDStateChangeEventFromThreadEvent:(shared_ptr<CtrXPC::Event>)a3
{
  ...
  uint64_t v37 = *MEMORY[0x263EF8340];
  xpc_object_t v5 = (void *)MEMORY[0x230FBD990](self, a2, a3.var0, a3.var1);
  uint64_t v25 = self;
  HMFGetOSLogHandle();
  id v6 = (id)objc_claimAutoreleasedReturnValue();
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v35 = 2080;
    id v36 = v8;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Received thread event: event name - %s", buf, 0x16u);
    if (v32 < 0) {
  ...
  if (count)
  {
    ...
    *(void *)&long long v10 = 138543618;
    ...
    while (1)
    {
      ...
      {
        long long v16 = [v15 stringByReplacingOccurrencesOfString:@":" withString:&stru_26E2EB898];
        ...
        if (![v14 isEqualToString:@"wed_unsolicted_disconnect"])
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(void *)&__p[4] = v20;
            __int16 v30 = 2112;
            v31 = v14;
            _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring key: %@", __p, 0x16u);
          }
          goto LABEL_17;
        }
        long long v16 = v26;
...
- (void)registerForThreadNetworkEvents:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      int v14 = 138543362;
      long long v15 = v11;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@registerForThreadNetworkEvents - events already setup, reading and notifying current state", (uint8_t *)&v14, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      int v14 = 138543362;
      long long v15 = v13;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@registerForThreadNetworkEvents - setting up events for first observer", (uint8_t *)&v14, 0xCu);
    }
...
- (void)stopThreadNetworkWithCompletion:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v27 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Scheduling an attempt to stop the thread network", buf, 0xCu);
    }
    ...
    if (v11)
    {
      size_t v12 = [MEMORY[0x263F42628] defaultScheduler];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v27 = v20;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@ThreadClient did not respond to selector - threadStopWithCompletion:", buf, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v27 = v15;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Thread radio client is not available on this device", buf, 0xCu);
    }
...
void __56__HMDThreadRadioClient_stopThreadNetworkWithCompletion___block_invoke_196(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    long long v10 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Attempting to stop thread network", buf, 0xCu);
  }
...
void __56__HMDThreadRadioClient_stopThreadNetworkWithCompletion___block_invoke_197(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v11 = 2112;
      id v12 = v3;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to stop thread network: %@", (uint8_t *)&v9, 0x16u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v9 = 138543362;
      long long v10 = v8;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Successfully stopped thread network", (uint8_t *)&v9, 0xCu);
    }
  }
...
- (void)_updateThreadMessageReliabilityParametersWithUserDefinedValues:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v21 = 2112;
    __int16 v22 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Should use user defined values for thread message reliability parameters: %@", (uint8_t *)&v19, 0x16u);
  }
  if (v3)
  {
    LOBYTE(v19) = 0;
    CFStringRef v10 = (const __CFString *)*MEMORY[0x263EFFE60];
    __int16 v11 = &unk_26E472358;
    CFIndex AppIntegerValue = CFPreferencesGetAppIntegerValue(@"matter.thread.idleRetransmitMs", (CFStringRef)*MEMORY[0x263EFFE60], (Boolean *)&v19);
    if ((_BYTE)v19 && AppIntegerValue)
    {
      __int16 v11 = [NSNumber numberWithLong:AppIntegerValue];
    }
    uint64_t v13 = &unk_26E472358;
...
- (void)setThreadMessageReliabilityParameters:(id)a3 activeRetransmitMs:(id)a4 activeThresholdMs:(id)a5 additionalRetransmitDelayMs:(id)a6
{
  ...
  id v12 = a5;
  id v13 = a6;
  CFIndex v14 = (void *)MEMORY[0x230FBD990]();
  long long v15 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v32 = 2112;
    id v33 = v13;
    _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Updating thread message reliability parameters, idleRetransmitMs=%@, activeRetransmitMs=%@, activeThresholdMs=%@, additionalRetransmitDelayMs=%@", (uint8_t *)&v24, 0x34u);
  }
  ...
  if (v19)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      int v24 = 138543362;
      id v25 = v23;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Thread radio client is not available on this device, not setting thread reliability parameters", (uint8_t *)&v24, 0xCu);
    }
  }
  else
  {
...
- (void)stopFirmwareUpdateWithCompletion:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v7)
    {
      ...
      aBlock[3] = &unk_264A2F870;
      aBlock[4] = self;
      id v22 = v4;
      id v8 = _Block_copy(aBlock);
      int v9 = [MEMORY[0x263F42628] defaultScheduler];
      id v10 = (id)[v9 performWithQualityOfService:17 block:v8];
    }
    else
    {
      CFIndex v16 = (void *)MEMORY[0x230FBD990]();
      CFIndex v17 = self;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        __int16 v26 = v19;
        _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@ThreadClient did not respond to selector - stopFWUpdate:", buf, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v26 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Thread radio client is not available on this device", buf, 0xCu);
    }
...
void __57__HMDThreadRadioClient_stopFirmwareUpdateWithCompletion___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v10 = 2112;
      id v11 = v3;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error while informing thread sw of stopFWUpdate, error: %@", (uint8_t *)&v8, 0x16u);
    }
  }
  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}
...
- (void)startFirmwareUpdateWithExtendedMACAddress:(id)a3 isWedDevice:(BOOL)a4 completion:(id)a5
{
  ...
  if (v10)
  {
    ...
    if (v12)
    {
      ...
      aBlock[3] = &unk_264A2B340;
      aBlock[4] = self;
      id v27 = v8;
      BOOL v29 = a4;
      id v28 = v9;
      id v13 = _Block_copy(aBlock);
      CFIndex v14 = [MEMORY[0x263F42628] defaultScheduler];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v33 = v24;
        _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@ThreadClient did not respond to selector - startFWUpdate:isWedDevice:completion", buf, 0xCu);
      }
      id v25 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v33 = v19;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Thread radio client is not available on this device", buf, 0xCu);
    }
...
void __89__HMDThreadRadioClient_startFirmwareUpdateWithExtendedMACAddress_isWedDevice_completion___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v16 = 2112;
      id v17 = v3;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error while informing thread sw of startFWUpdate (emac: %@, isWed: %@), error: %@", (uint8_t *)&v10, 0x2Au);
    }
  }
  ...
  if (v5)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        __int16 v26 = v19;
        _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@ThreadClient did not respond to selector - stopPairing:", buf, 0xCu);
      }
      int v20 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
      (*((void (**)(id, void *))v4 + 2))(v4, v20);
    }
...
void __56__HMDThreadRadioClient_stopThreadPairingWithCompletion___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v10 = 2112;
      id v11 = v3;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error while informing thread sw of pairing stop, error: %@", (uint8_t *)&v8, 0x16u);
    }
  }
  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}
...
- (void)startThreadPairingWithExtendedMACAddress:(id)a3 isWedDevice:(BOOL)a4 completion:(id)a5
{
  ...
  if (v10)
  {
    ...
    if (v12)
    {
      ...
      __int16 v14 = [MEMORY[0x263F42628] defaultScheduler];
      id v15 = (id)[v14 performWithQualityOfService:17 block:v13];
    }
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v33 = v24;
        _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@ThreadClient did not respond to selector - startPairingForExtendedMACAddress:isWedDevice:completion", buf, 0xCu);
      }
      id v25 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
      (*((void (**)(id, void *))v9 + 2))(v9, v25);
    }
...
void __88__HMDThreadRadioClient_startThreadPairingWithExtendedMACAddress_isWedDevice_completion___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v10 = 2112;
      id v11 = v3;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error while informing thread sw of pairing start, error: %@", (uint8_t *)&v8, 0x16u);
    }
  }
  (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
}
...
- (void)connectToExtendedMACAddress:(id)a3 completion:(id)a4
{
  ...
  if (v8)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        uint64_t v37 = v26;
        _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@ThreadClient did not respond to selector - provideExtendedMACAddress:completion", buf, 0xCu);
      }
      id v22 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v37 = v20;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Thread radio client is not available on this device", buf, 0xCu);
    }
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v17 = 2112;
      uint64_t v18 = v7;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Attempting to connect to device with eMAC address %@", buf, 0x16u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v16 = v8;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Received nil eMAC, disconnecting from current device", buf, 0xCu);
    }
  }
...
void __63__HMDThreadRadioClient_connectToExtendedMACAddress_completion___block_invoke_168(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v13 = 2112;
      id v14 = v3;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error while trying to connect to emac address: %@ error: %@", (uint8_t *)&v9, 0x20u);
    }
  }
  (*(void (**)(void))(*(void *)(a1 + 48) + 16))();
}
...
- (void)startThreadNetworkWithOperationalDataset:(id)a3 isOwnerUser:(BOOL)a4 completion:(id)a5
{
  ...
  if (v10)
  {
    ...
    __int16 v21 = [MEMORY[0x263F42628] defaultScheduler];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v32 = v17;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Thread radio client is not available on this device", buf, 0xCu);
    }
...
void __88__HMDThreadRadioClient_startThreadNetworkWithOperationalDataset_isOwnerUser_completion___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v15 = 2112;
    uint64_t v16 = v6;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Attempting to start thread network with operation data set: %@", buf, 0x16u);
  }
...
void __88__HMDThreadRadioClient_startThreadNetworkWithOperationalDataset_isOwnerUser_completion___block_invoke_163(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v11 = 2112;
      id v12 = v3;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to start thread network: %@", (uint8_t *)&v9, 0x16u);
    }
  }
  else
  {
    *(unsigned char *)(*(void *)(a1 + 32) + 13) = 1;
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v9 = 138543362;
      uint64_t v10 = v8;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Successfully started thread network", (uint8_t *)&v9, 0xCu);
    }
  }
...
- (void)startThreadNetwork:(id)a3 completion:(id)a4
{
  ...
  if (v8)
  {
    if (v6)
    {
      id v9 = (id)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v6];
      uint64_t v10 = (void *)MEMORY[0x230FBD990]();
      __int16 v11 = self;
      if (v9)
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543362;
          uint64_t v38 = v13;
          _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Scheduling an attempt to join an existing thread network", buf, 0xCu);
        }
        id v14 = (void *)MEMORY[0x230FBD990]();
        __int16 v15 = v11;
        HMFGetOSLogHandle();
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v39 = 2112;
          id v40 = v9;
          _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Thread networkID: %@", buf, 0x16u);
        }
        goto LABEL_17;
      }
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v39 = 2112;
        id v40 = v6;
        _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@NetworkID is not valid for thread unique id: %@", buf, 0x16u);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        uint64_t v38 = v26;
        _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Scheduling an attempt to create a new thread network", buf, 0xCu);
      }
    }
...
LABEL_17:
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v38 = v31;
      _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_ERROR, "%{public}@Incorrect startThread API used", buf, 0xCu);
    }
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v38 = v21;
    _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Thread radio client is not available on this device", buf, 0xCu);
  }
...
- (HMDThreadRadioClient)init
{
  ...
  if ((isFeatureMatteriPhoneOnlyPairingControlForThreadEnabled() & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v32 = v26;
      _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@Thread service not enabled", buf, 0xCu);
    }
    goto LABEL_10;
  }
  ...
  if ((v4 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v32 = v28;
      _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@This device doesn't support thread service", buf, 0xCu);
    }
LABEL_10:
  ...
  if (objc_opt_class())
  {
    uint64_t v5 = [objc_alloc(MEMORY[0x263F382F0]) init:"HomeD"];
    ...
    uint64_t v15 = [(HMDThreadCommandTimer *)v11 initWithQueue:v14 delayInSecs:&unk_26E472370];
...
+ (id)logCategory
{
  if (+[HMDThreadRadioClient logCategory]::_hmf_once_t1 != -1) {
    dispatch_once(&+[HMDThreadRadioClient logCategory]::_hmf_once_t1, &__block_literal_global_161733);
  }
...
void __35__HMDThreadRadioClient_logCategory__block_invoke()
{
  ...
  uint64_t v1 = (void *)+[HMDThreadRadioClient logCategory]::_hmf_once_v2;
