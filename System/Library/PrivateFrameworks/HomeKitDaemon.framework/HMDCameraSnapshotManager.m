...
void __70__HMDCameraSnapshotManager_handleCameraSettingsDidChangeNotification___block_invoke(uint64_t a1)
{
  ...
  if (v5)
  {
    ...
    {
      v6 = [MEMORY[0x263F087E8] hmErrorWithCode:10];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      int v11 = 138543362;
      v12 = v10;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Camera profile settings are not initialized, skipping cancelling pending snapshot requests", (uint8_t *)&v11, 0xCu);
    }
  }
}
    ...
    if (*(void *)(a1 + 32))
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v67 = 2112;
        id v68 = v3;
        _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failing current local session %@:%@", buf, 0x20u);
      }
    ...
    if ([*(id *)(a1 + 40) count])
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v67 = 2112;
        id v68 = v3;
        _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failing current remote sessions %@:%@", buf, 0x20u);
      }
      long long v58 = 0u;
      long long v59 = 0u;
      long long v56 = 0u;
    ...
    if ([*(id *)(a1 + 104) count])
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v67 = 2112;
        id v68 = v3;
        _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failing pending snapshot request during stream set up %@:%@", buf, 0x20u);
      }
      long long v54 = 0u;
      long long v55 = 0u;
      long long v52 = 0u;
      ...
      if (v28)
      {
        ...
        do
        {
          for (uint64_t j = 0; j != v29; ++j)
          {
            ...
            v33 = [v32 responseHandler];

            if (v33)
            {
              v34 = [v32 responseHandler];
    ...
    if ([*(id *)(a1 + 112) count])
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v67 = 2112;
        id v68 = v3;
        _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_ERROR, "%{public}@Failing pending remote snapshot request during stream set up %@:%@", buf, 0x20u);
      }
      long long v50 = 0u;
      long long v51 = 0u;
      long long v48 = 0u;
  ...
  if (!a4)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v36 = v10;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Received call back that stream setup is not in progress anymore", buf, 0xCu);
    }
    if (v8)
    {
    ...
    if (v8)
    {
      v18 = (void *)[(NSMutableArray *)v8->_pendingRemoteSnapshotRequestDuringStreamSetup copy];
...
- (void)streamSnapshotHandler:(id)a3 didGetLastSnapshot:(id)a4
{
  ...
  v10 = [(HMDSnapshotFile *)v8 initWithImageDirectory:imageCacheDirectory snapshotData:v7];
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v10;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Received the last snapshot from stream %@", (uint8_t *)&v17, 0x16u);
    }
    if (self) {
    ...
    id v16 = [(HMDSnapshotSlotManager *)snapshotSlotManager createSlotForSnapshotFile:v10 requestMessages:MEMORY[0x263EFFA68] shouldNotifyClients:1];
  }
}
...
- (void)streamSnapshotHandler:(id)a3 didGetNewSnapshot:(id)a4
{
  ...
  if (v10)
  {
    if (v14)
    {
      ...
      __int16 v27 = 2112;
      long long v28 = v10;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Received a new snapshot from stream %@", (uint8_t *)&v25, 0x16u);
    }
    if (self) {
    ...
    v18 = [(HMDSnapshotSession *)v17 sessionID];
  ...
  else
  {
    if (v14)
    {
      ...
      int v25 = 138543362;
      long long v26 = v23;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@New snapshot capture has resulted in failure", (uint8_t *)&v25, 0xCu);
    }
    v18 = [MEMORY[0x263F087E8] hmErrorWithCode:52];
    if (self) {
...
- (void)_sendResponse:(void *)a3 error:(void *)a4 sessionID:
{
  ...
  if (a1)
  {
    v10 = -[HMDCameraSnapshotManager _sessionWithID:]((id *)a1, v9);
    int v11 = v10;
    if (v10)
    {
      uint64_t v29 = v10;
      ...
      else
      {
        ...
        long long v28 = [v26 createSlotForSnapshotFile:v7 requestMessages:v27 shouldNotifyClients:1];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v38 = 2112;
        id v39 = v9;
        _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Received a delegate call back for an unknown session ID: %@", buf, 0x16u);
      }
    }
  }
}
  ...
  if (a1)
  {
    ...
    if (v9)
    {
      if (v13)
      {
        ...
        __int16 v19 = 2112;
        id v20 = v5;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Resetting local session %@", (uint8_t *)&v17, 0x16u);
      }
    ...
    else
    {
      if (v13)
      {
        ...
        __int16 v19 = 2112;
        id v20 = v5;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Resetting remote session %@", (uint8_t *)&v17, 0x16u);
      }
...
- (void)snapshotRelayStream:(id)a3 didCompleteSendImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v9;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteRelayStreamDelegate call back that the image transfer has completed with error %@", (uint8_t *)&v15, 0x20u);
  }
...
- (void)snapshotRelayStream:(id)a3 didStartCaptureImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v9;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteRelayStreamDelegate call back that the image transfer has started with error %@", (uint8_t *)&v15, 0x20u);
  }
  ...
  if (a1)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        uint32_t v14 = 22;
LABEL_10:
        _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, v12, (uint8_t *)&v15, v14);
      }
    }
...
- (void)snapshotStreamSender:(id)a3 didCompleteSendImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v9;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteStreamSenderDelegate call back that the image transfer has completed with error %@", (uint8_t *)&v15, 0x20u);
  }
  -[HMDCameraSnapshotManager _endSession:error:]((id *)&v12->super.super.isa, v10, v9);
}
...
- (void)snapshotStreamSender:(id)a3 didStartCaptureImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v9;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteStreamSenderDelegate call back that the image transfer has started with error %@", (uint8_t *)&v15, 0x20u);
  }
  -[HMDCameraSnapshotManager _sendRemoteResponse:sessionID:]((id *)&v12->super.super.isa, v9, v10);
}
...
- (void)snapshotStreamReceiver:(id)a3 didSaveSnapshotFile:(id)a4 error:(id)a5 sessionID:(id)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v22 = 2112;
    id v23 = v12;
    _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteStreamReceiverDelegate call back that the image has been saved after relay with error %@", (uint8_t *)&v18, 0x20u);
  }
...
- (void)snapshotStreamReceiver:(id)a3 didStartGettingImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v9;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteStreamReceiverDelegate call back that the image get has started after relay with error %@", (uint8_t *)&v15, 0x20u);
  }
}
...
- (void)snapshotRelaySender:(id)a3 didSaveSnapshotFile:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v26 = 2112;
    __int16 v27 = v15;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteRelaySenderDelegate call back that snapshotFile:%@ has been saved for snapshotCharacteristicEventUUID:%@", (uint8_t *)&v20, 0x2Au);
  }
...
- (void)snapshotRelaySender:(id)a3 didCompleteSendImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v9;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteRelaySenderDelegate call back that the image transfer has completed with error %@", (uint8_t *)&v15, 0x20u);
  }
  -[HMDCameraSnapshotManager _endSession:error:]((id *)&v12->super.super.isa, v10, v9);
}
...
- (void)snapshotRelaySender:(id)a3 didStartCaptureImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v9;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteRelaySenderDelegate call back that the image transfer has started with error %@", (uint8_t *)&v15, 0x20u);
  }
  -[HMDCameraSnapshotManager _sendRemoteResponse:sessionID:]((id *)&v12->super.super.isa, v9, v10);
}
...
- (void)snapshotRelayReceiver:(id)a3 didSaveSnapshotFile:(id)a4 error:(id)a5 sessionID:(id)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v22 = 2112;
    id v23 = v12;
    _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteRelayReceiverDelegate call back that the image has been saved after relay with error %@", (uint8_t *)&v18, 0x20u);
  }
  -[HMDCameraSnapshotManager _sendResponse:error:sessionID:]((uint64_t)v15, v11, v12, v13);
}
...
- (void)snapshotRelayReceiver:(id)a3 didStartGettingImage:(id)a4 sessionID:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v9;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotRemoteRelayReceiverDelegate call back that the image get has started after relay with error %@", (uint8_t *)&v15, 0x20u);
  }
}
...
- (void)snapshotLocal:(id)a3 didSaveSnapshotFile:(id)a4 error:(id)a5 sessionID:(id)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v22 = 2112;
    id v23 = v12;
    _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@%@ Received HMDCameraSnapshotLocalDelegate call back that the image has been saved %@", (uint8_t *)&v18, 0x20u);
  }
  -[HMDCameraSnapshotManager _sendResponse:error:sessionID:]((uint64_t)v15, v11, v12, v13);
}
...
- (void)_handleTakeRemoteSnapshotFailureMessage:(id)a3
{
  ...
  if (v7)
  {
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v35 = 2112;
      v36 = v7;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Received message that remote snapshot failed for session ID: %@", (uint8_t *)&v33, 0x16u);
    }
    ...
    if (v13)
    {
      ...
      if ([v15 conformsToProtocol:&unk_26E525030]) {
        id v16 = v15;
      }
      else {
        id v16 = 0;
      ...
      if (v17)
      {
        int v18 = [(HMDCameraSnapshotSessionID *)v4 messagePayload];
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v35 = 2112;
          v36 = v19;
          _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Handling remote snapshot failure: %@", (uint8_t *)&v33, 0x16u);
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
        {
          ...
          int v33 = 138543362;
          long long v34 = v32;
          _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@Cannot handle remote snapshot failure for session without a receiver", (uint8_t *)&v33, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v35 = 2112;
        v36 = v7;
        _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_ERROR, "%{public}@Cannot handle remote snapshot failure for unknown session ID: %@", (uint8_t *)&v33, 0x16u);
      }
  ...
  else
  {
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v35 = 2112;
      v36 = v4;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to create snapshot session ID from remote snapshot failure message: %@", (uint8_t *)&v33, 0x16u);
    }
    uint32_t v14 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
...
- (void)_handleRemoteSnapshotReceivedMessage:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (v8)
    {
      ...
      int v11 = [v10 conformsToProtocol:&unk_26E4AF770];
      ...
      if (v11)
      {
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
        {
          ...
          int v27 = 138543362;
          uint64_t v28 = v16;
          _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Sending snapshot received confirmation to the sender", (uint8_t *)&v27, 0xCu);
        }
        [v12 snapShotTransferComplete];
      }
      id v17 = [MEMORY[0x263F424F0] currentActivity];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v29 = 2112;
        id v30 = v7;
        _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Cannot handle remote snapshot received for unknown session ID: %@", (uint8_t *)&v27, 0x16u);
      }
      __int16 v26 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v29 = 2112;
      id v30 = v4;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to create snapshot session ID from remote snapshot received message: %@", (uint8_t *)&v27, 0x16u);
    }
    id v9 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
  ...
  if (v8)
  {
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v18 = 2112;
        __int16 v19 = v9;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@%@ has timed out", (uint8_t *)&v16, 0x16u);
      }
      uint32_t v14 = [MEMORY[0x263F087E8] hmErrorWithCode:8];
...
- (void)_handleTakeRemoteSnapshotMessage:(id)a3
{
  ...
  {
    id v13 = [MEMORY[0x263F424F0] currentActivity];
    ...
    if (v16)
    {
      ...
      if (v17)
      {
        if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v113 = v22;
          _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Accessory is reachable and this is remote gateway capable device", buf, 0xCu);
        }
        id v23 = v4;
        id v24 = v5;
        id v25 = v24;
        if (self)
        {
          ...
          v102 = [v23 numberForKey:@"kCameraStreamingTierType"];
          id v108 = v23;
          ...
          long long v34 = [(HMDCameraSnapshotManager *)v19 uniqueIdentifier];
          v93 = (void *)v27;
          ...
          if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v114 = 2112;
            v115 = v36;
            _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_INFO, "%{public}@Creating a snapshot session %@ with HMDCameraSnapshotRemoteRelaySender", buf, 0x16u);
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v113 = v60;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Accessory is not reachable and this is a remote gateway capable device", buf, 0xCu);
      }
      ...
      if (isiOSDevice())
      {
        ...
        if (v41)
        {
          if (v45)
          {
            ...
            *(_DWORD *)buf = 138543362;
            v113 = v46;
            _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_INFO, "%{public}@Accessory is reachable and this is iOS device", buf, 0xCu);
          }
          v106 = v14;
          ...
          if (self)
          {
            ...
            if (os_log_type_enabled(v58, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v114 = 2112;
              v115 = v55;
              _os_log_impl(&dword_22F52A000, v58, OS_LOG_TYPE_INFO, "%{public}@Creating a snapshot session %@ with HMDCameraSnapshotRemoteStreamSender", buf, 0x16u);
            }
        ...
        else
        {
          if (v45)
          {
            ...
            *(_DWORD *)buf = 138543362;
            v113 = v63;
            _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_INFO, "%{public}@Accessory is not reachable and this is iOS device, ", buf, 0xCu);
          }
          id v23 = v4;
          id v64 = v5;
          if (self)
          {
            __int16 v65 = (void *)MEMORY[0x230FBD990]();
            id v66 = v43;
            ...
            if (os_log_type_enabled(v67, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v113 = v68;
              _os_log_impl(&dword_22F52A000, v67, OS_LOG_TYPE_INFO, "%{public}@Creating a snapshot session with HMDCameraSnapshotRemoteRelayStream", buf, 0xCu);
            }
            v104 = [v64 streamingTier];
            ...
            if (v107)
            {
              ...
              else
              {
                ...
                if (os_log_type_enabled(v87, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543362;
                  v113 = v88;
                  _os_log_impl(&dword_22F52A000, v87, OS_LOG_TYPE_ERROR, "%{public}@Failed to create snapshot session with HMDCameraSnapshotRemoteRelayStream: no remote access device", buf, 0xCu);
                }
                v77 = [MEMORY[0x263F087E8] hmErrorWithCode:91];
                id v23 = v110;
            ...
            else
            {
              ...
              if (os_log_type_enabled(v81, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v113 = v84;
                _os_log_impl(&dword_22F52A000, v81, OS_LOG_TYPE_ERROR, "%{public}@Failed to create snapshot session with HMDCameraSnapshotRemoteRelayStream: accessory reference is nil", buf, 0xCu);

                uint32_t v14 = v83;
                id v64 = v82;
              }

              uint64_t v69 = [MEMORY[0x263F087E8] hmErrorWithCode:20];
...
LABEL_37:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v113 = v11;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Stream setup is in progress, adding this to remote pending request queue", buf, 0xCu);
  }
  if (self) {
...
- (id)_createSnapshotSessionIDWithMessage:(void *)a3 error:
{
  ...
  if (a1)
  {
    ...
    id v7 = [[HMDCameraSnapshotSessionID alloc] initWithAccessory:WeakRetained message:v5];
    if (!v7)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v27 = 2112;
        id v28 = v5;
        _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Unable to create snapshot session identifier for: %@", (uint8_t *)&v25, 0x16u);
      }
      if (a3)
      {
    ...
    id v8 = [WeakRetained cameraProfiles];
    id v9 = [v8 anyObject];
    id v10 = [v9 currentSettings];
    ...
    if (v10)
    {
      ...
      if ((HMAreSnapshotsAllowedForCameraAccessMode() & 1) == 0)
      {
        ...
        {
          uint32_t v14 = HMFGetLogIdentifier();
          int v15 = HMCameraAccessModeAsString();
          int v25 = 138543618;
          uint64_t v26 = v14;
          __int16 v27 = 2112;
          id v28 = v15;
          _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Snapshots are not allowed for camera access mode: %@", (uint8_t *)&v25, 0x16u);
        }
        if (a3)
        {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        int v25 = 138543362;
        uint64_t v26 = v23;
        _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Camera profile settings is not initialized, skipping controller side checks to disallow snapshot requests", (uint8_t *)&v25, 0xCu);
      }
    }
    a1 = v7;
LABEL_17:
...
- (void)_issueGetSnapshot:(void *)a1
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    if (v10 == 1)
    {
      int v11 = @"HMDCameraSnapshotReasonEvent";
    }
    else if (v10)
    {
    ...
    {
      int v11 = @"HMDCameraSnapshotReasonPeriodic";
    }
    *(_DWORD *)buf = 138543618;
    __int16 v18 = v8;
    __int16 v19 = 2112;
    uint64_t v20 = v11;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Issuing get snapshot request for reason: %@", buf, 0x16u);
  }
  id v12 = [v3 snapshotGetter];
  objc_msgSend(v12, "getSnapshot:", objc_msgSend(v3, "streamingTierType"));

  id v13 = [v3 snapshotCompletionTimer];
  [v13 setDelegate:v6];

  uint32_t v14 = [v6 workQueue];
  int v15 = [v3 snapshotCompletionTimer];
  [v15 setDelegateQueue:v14];

  int v16 = [v3 snapshotCompletionTimer];
  [v16 resume];
}
...
- (void)_handleTakeSnapshotMessage:(id)a3
{
  ...
  id v4 = a3;
  id v5 = [MEMORY[0x263F424F0] currentActivity];
      ...
      if (self->_currentLocalSession)
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@There is already a local session %@ in progress, adding this request to that", buf, 0x16u);
        }
...
LABEL_67:
    ...
    int v41 = snapshotSlotManager;
    uint64_t v42 = [(HMDSnapshotSlotManager *)v41 encodedMostRecentSnapshotForMessage:v4];
    ...
    if (v42)
    {
      ...
      if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v102 = 2112;
        v103 = v42;
        _os_log_impl(&dword_22F52A000, v45, OS_LOG_TYPE_INFO, "%{public}@Most recent snapshot is still valid, sending it with payload %@", buf, 0x16u);
      }
...
LABEL_11:
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v101 = v18;
          _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Stream setup is in progress, adding this to pending request queue", buf, 0xCu);
        }
        if (self) {
...
LABEL_17:
      if ([(HMDCameraStreamSnapshotHandler *)streamSnapshotHandler isStreamAvailable])
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v101 = v24;
          _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Taking snapshot through available camera stream", buf, 0xCu);
        }
        id v97 = v4;
        id v25 = v6;
        if (self)
        {
          ...
          int v33 = v22->_currentLocalSession;
          ...
          __int16 v35 = (void *)MEMORY[0x230FBD990](v34);
          v36 = v22;
          ...
          if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v102 = 2112;
            v103 = v39;
            _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_INFO, "%{public}@Creating a snapshot session %@ with HMDCameraStreamSnapshot", buf, 0x16u);
          }
      ...
      id v47 = -[HMDCameraSnapshotManager accessory]((id *)&self->super.super.isa);
      ...
      if (v48)
      {
        ...
        if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v101 = v52;
          _os_log_impl(&dword_22F52A000, v51, OS_LOG_TYPE_INFO, "%{public}@Taking local snapshot because accessory is reachable", buf, 0xCu);
        }
        id v53 = v4;
        id v54 = v6;
        if (self)
        {
          ...
          long long v56 = v50->_dataSource;
          long long v57 = [(HMDCameraSnapshotManager *)v50 workQueue];
          [(HMDCameraSnapshotManager *)v50 workQueue];
          long long v58 = v96 = v53;
          long long v59 = [(HMDCameraSnapshotManagerDataSource *)v56 createSnapshotLocalWithSessionID:v98 workQueue:v57 accessory:v94 delegate:v50 delegateQueue:v58 snapshotRequestHandler:v50->_snapshotRequestHandler];

          dataSource = v50->_dataSource;
          v61 = v50->_networkMonitor;
          uint64_t v62 = dataSource;
          LOBYTE(v90) = v92;
          ...
          id v64 = v50->_currentLocalSession;
          ...
          id v66 = (void *)MEMORY[0x230FBD990](v65);
          __int16 v67 = v50;
          ...
          if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v102 = 2112;
            v103 = v70;
            _os_log_impl(&dword_22F52A000, v68, OS_LOG_TYPE_INFO, "%{public}@Creating a snapshot session %@ with HMDCameraSnapshotLocal", buf, 0x16u);
          }
...
LABEL_47:
          ...
          if ([(HMDCameraSnapshotManagerDataSource *)v72 isWatchDevice])
          {
            ...
            if (v74)
            {
              ...
              if (os_log_type_enabled(v77, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v101 = v78;
                _os_log_impl(&dword_22F52A000, v77, OS_LOG_TYPE_INFO, "%{public}@Taking remote snapshot via stream because accessory is unreachable", buf, 0xCu);
              }
          ...
          if (os_log_type_enabled(v81, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v101 = v82;
            _os_log_impl(&dword_22F52A000, v81, OS_LOG_TYPE_INFO, "%{public}@Taking remote snapshot via relay because accessory is unreachable", buf, 0xCu);
          }
      ...
      if (os_log_type_enabled(v87, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v101 = v88;
        _os_log_impl(&dword_22F52A000, v87, OS_LOG_TYPE_ERROR, "%{public}@Cannot take snapshot because accessory is unreachable remote and remote snapshots are unsupported", buf, 0xCu);
      }
      id v89 = [MEMORY[0x263F087E8] hmErrorWithCode:4];
...
- (void)_sendSnapshotRequestStreamReceiver:(void *)a3 snapshotSessionID:
{
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v36 = v10;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Creating a snapshot session with HMDCameraSnapshotRemoteStreamReceiver", buf, 0xCu);
    }
    ...
    if (WeakRetained)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v36 = v32;
          _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@Failed to create snapshot session with HMDCameraSnapshotRemoteStreamReceiver: no remote access device", buf, 0xCu);
        }
        __int16 v19 = [MEMORY[0x263F087E8] hmErrorWithCode:91];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v36 = v28;
        _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to create snapshot session with HMDCameraSnapshotRemoteStreamReceiver: accessory reference is nil", buf, 0xCu);
      }
...
- (void)_sendSnapshotRequestRelayReceiver:(void *)a3 snapshotSessionID:
{
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v44 = v10;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Creating a snapshot session with HMDCameraSnapshotRemoteRelayReceiver", buf, 0xCu);
    }
    id WeakRetained = objc_loadWeakRetained(v8 + 6);
    if (WeakRetained)
    {
      ...
      if (v12)
      {
        ...
        __int16 v27 = [v25 createLocalSnapshotSessionWithID:v6 accessory:v42 snapshotGetter:v21 message:v5 waitPeriod:v26 reachabilityPath:0 cameraLocallyReachable:60.0 snapshotForNotification:v41];
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v45 = 2112;
          v46 = v32;
          _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_INFO, "%{public}@Creating a snapshot session %@ with HMDCameraSnapshotRemoteRelayReceiver", buf, 0x16u);
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v44 = v40;
          _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_ERROR, "%{public}@Failed to create snapshot session with HMDCameraSnapshotRemoteRelayReceiver: no remote access device", buf, 0xCu);
        }
        id v21 = [MEMORY[0x263F087E8] hmErrorWithCode:91];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v44 = v36;
        _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_ERROR, "%{public}@Failed to create snapshot session with HMDCameraSnapshotRemoteRelayReceiver: accessory reference is nil", buf, 0xCu);
      }
      id v12 = [MEMORY[0x263F087E8] hmErrorWithCode:20];
      [v5 respondWithError:v12];
    }
...
- (NSDictionary)encodedMostRecentSnapshot
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    uint32_t v14 = v5;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Responding to most recent snapshot with payload: %@", (uint8_t *)&v11, 0x16u);
  }
...
- (void)_handleCreateSnapshotFromBulletinContextMessage:(id)a3
{
  ...
  id v7 = [v4 stringForKey:*MEMORY[0x263F0EBB0]];
  uint64_t v8 = [v4 dateForKey:*MEMORY[0x263F0EBA8]];
  id v9 = (void *)v8;
  if (!v6 || (v7 ? (BOOL v10 = v8 == 0) : (BOOL v10 = 1), v10))
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v35 = 2112;
      v36 = v27;
      _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@Snapshot session ID or path or capture date is not present in request: %@", (uint8_t *)&v33, 0x16u);
    }
    __int16 v13 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
  ...
  else
  {
    ...
    __int16 v13 = [(HMDSnapshotFile *)v11 initWithImageDirectory:imageCacheDirectory externalFilePath:v7 snapshotTimestamp:v9];
    if (v13)
    {
      if (self) {
        snapshotSlotManager = self->_snapshotSlotManager;
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v37 = 2112;
        __int16 v38 = v7;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Created a slot %@ for the snapshot file %@", (uint8_t *)&v33, 0x20u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v35 = 2112;
        v36 = v32;
        _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to create snapshot file for request %@", (uint8_t *)&v33, 0x16u);
      }
...
void __56__HMDCameraSnapshotManager_handleAccessoryUnconfigured___block_invoke(uint64_t a1)
{
  ...
  id v2 = [MEMORY[0x263F087E8] hmErrorWithCode:4];
...
void __62__HMDCameraSnapshotManager_releaseSnapshotWithSlotIdentifier___block_invoke(uint64_t a1)
{
  ...
  uint64_t v5 = *MEMORY[0x263F0D9C0];
  v6[0] = v2;
  id v3 = [NSDictionary dictionaryWithObjects:v6 forKeys:&v5 count:1];
  id v4 = [MEMORY[0x263F42568] messageWithName:*MEMORY[0x263F0BD68] messagePayload:v3 responseHandler:&__block_literal_global_54];
...
- (void)registerForMessages
{
  ...
  if (self)
  {
    ...
    uint64_t v55 = v7;
    long long v56 = v5;
    BOOL v10 = (void *)MEMORY[0x263EFF8C0];
    ...
    __int16 v13 = self->_msgDispatcher;
  }
  else
  {
    uint64_t v55 = v7;
    long long v56 = v5;
    int v48 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v55 count:2];
  ...
  v54[0] = v8;
  v54[1] = v5;
  uint32_t v14 = (void *)MEMORY[0x263EFF8C0];
  uint64_t v15 = v13;
  ...
  uint64_t v26 = *MEMORY[0x263F0BD70];
  v52[0] = v23;
  v52[1] = v5;
  __int16 v27 = (void *)MEMORY[0x263EFF8C0];
  id v28 = v25;
  uint64_t v29 = [v27 arrayWithObjects:v52 count:2];
  [(HMFMessageDispatcher *)v28 registerForMessage:v26 receiver:self policies:v29 selector:sel__handleTakeSnapshotMessage_];

  if (self) {
    id v30 = self->_msgDispatcher;
  }
  else {
    id v30 = 0;
  }
  uint64_t v31 = *MEMORY[0x263F0BD68];
  v51[0] = v24;
  v51[1] = v5;
  ...
  uint64_t v36 = *MEMORY[0x263F0BD50];
  v50[0] = v24;
  v50[1] = v5;
  __int16 v37 = (void *)MEMORY[0x263EFF8C0];
  __int16 v38 = v35;
  ...
  if (self) {
    uint64_t v40 = self->_msgDispatcher;
  }
  else {
    uint64_t v40 = 0;
  }
  uint64_t v41 = *MEMORY[0x263F0BD48];
  v49[0] = v24;
  v49[1] = v5;
  id v42 = (void *)MEMORY[0x263EFF8C0];
  uint64_t v43 = v40;
  ...
  __int16 v45 = [MEMORY[0x263F08A00] defaultCenter];
...
- (void)dealloc
{
  id v3 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1039];
...
- (HMDCameraSnapshotManager)initWithAccessory:(id)a3 workQueue:(id)a4 streamSnapshotHandler:(id)a5 uniqueIdentifier:(id)a6 msgDispatcher:(id)a7 networkMonitor:(id)a8
{
  ...
  id v30 = [[HMDCameraResidentMessageHandler alloc] initWithAccessory:v18 logIdentifier:v22];
  __int16 v27 = [[HMDSnapshotSlotManager alloc] initWithAccessory:v18 workQueue:v17 imageCacheDirectory:v26 logID:v22 uniqueIdentifier:v15 msgDispatcher:v14];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t74 != -1) {
    dispatch_once(&logCategory__hmf_once_t74, &__block_literal_global_121_152324);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v75;
  return v2;
}
...
void __39__HMDCameraSnapshotManager_logCategory__block_invoke()
{
  ...
  uint64_t v1 = (void *)logCategory__hmf_once_v75;
...
+ (void)cleanStaleSnapshotDirectoriesUsingCurrentAccessories:(id)a3
{
  ...
  id v29 = v3;
  objc_super v5 = objc_msgSend(v3, "na_map:", &__block_literal_global_152330);
        ...
        if (([v6 containsObject:v14] & 1) == 0)
        {
          ...
          if (v18)
          {
            if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v27 = "%{public}@Removed snapshot directory at path: %@";
              uint32_t v28 = 22;
              goto LABEL_12;
            }
          }
          else if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v27 = "%{public}@Failed to remove snapshot directory at path %@: %@";
            uint32_t v28 = 32;
LABEL_12:
            _os_log_impl(&dword_22F52A000, v25, v26, v27, buf, v28);
          }
