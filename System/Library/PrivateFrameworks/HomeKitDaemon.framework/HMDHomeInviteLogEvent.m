...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  v21[14] = v11;
  v12 = [NSDictionary dictionaryWithObjects:v21 forKeys:v20 count:15];
      ...
      default:
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v17 = v12;
          _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@No home invitation event to log. Invitation was cancelled or is pending.", buf, 0xCu);
        }
        v13 = 0;
        goto LABEL_14;
    }
...
+ (id)updateWithInvitationState:(int64_t)a3 isFMFDevice:(BOOL)a4
{
  if ((unint64_t)(a3 - 3) > 4) {
    ...
    uint64_t v4 = qword_2303E43E8[a3 - 3];
  }
