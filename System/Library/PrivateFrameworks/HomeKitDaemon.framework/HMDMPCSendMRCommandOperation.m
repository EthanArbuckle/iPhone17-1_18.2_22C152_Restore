...
- (int64_t)errorCodeForCurrentOperation
{
  ...
  if (!v3)
  {
    ...
    if (v8)
    {
      ...
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Unhandled MR command case %u", (uint8_t *)&v19, 0x12u);
    }
    else
    {
      v14 = (void *)MEMORY[0x230FBD990]();
...
LABEL_19:
      ...
      int v19 = 138543362;
      v20 = v17;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Generic MR command error", (uint8_t *)&v19, 0xCu);
    }
...
- (void)main
{
  ...
  if (!v20)
  {
    id v3 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2962 description:@"No command or queue in SendCommandOperation" underlyingError:0];
...
void __72__HMDMPCSendMRCommandOperation_sendPlaybackArchive_destination_options___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@[HMDMPCSendMRCommandOperation] %s", (uint8_t *)&v11, 0x16u);
  }
...
- (void)generateMPCErrorOrFinishWithError:(void *)a3 statuses:
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v43 = 2112;
    id v44 = v6;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@[HMDMPCSendMRCommandOperation] error %@ statuses %@", buf, 0x20u);
  }
...
LABEL_16:
    if (v13 & [v6 containsObject:&unk_26E4735E8])
    {
      id v5 = 0;
      goto LABEL_18;
    }
    if ([v6 containsObject:&unk_26E473600])
    {
      id v5 = 0;
LABEL_24:
      [v8 finish];
    ...
    v38 = v27;
    long long v28 = [NSDictionary dictionaryWithObjects:&v38 forKeys:&v37 count:1];
  ...
  if ([v30 isEqualToString:*MEMORY[0x263F54760]]) {
  ...
  if ((v13 & ([v6 containsObject:&unk_26E4735E8] | v31)) == 1)
  {
LABEL_18:
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v41 = 2112;
      id v42 = v5;
      _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@[HMDMPCSendMRCommandOperation] discarding pause media remote error and assuming success as there is no now playing application (%@)", buf, 0x16u);
    }
    goto LABEL_24;
  }
  id v29 = v5;
  id v5 = v29;
LABEL_32:
  v32 = objc_msgSend(MEMORY[0x263F087E8], "hmPrivateErrorWithCode:description:underlyingError:", objc_msgSend(v8, "errorCodeForCurrentOperation"), @"Media remote MPC command failure", v29);
  ...
  if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v43 = 2112;
    id v44 = v29;
    _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_ERROR, "%{public}@[HMDMPCSendMRCommandOperation] Cancel with error %@, underlying error: %@", buf, 0x20u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_230943 != -1) {
    dispatch_once(&logCategory__hmf_once_t9_230943, &__block_literal_global_230944);
  }
  v2 = (void *)logCategory__hmf_once_v10_230945;
  return v2;
}
...
void __43__HMDMPCSendMRCommandOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v10_230945;
  logCategory__hmf_once_v10_230945 = v0;
}
