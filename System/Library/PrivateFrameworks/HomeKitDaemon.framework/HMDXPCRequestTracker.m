        ...
        for (uint64_t i = 0; i != v8; ++i)
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v47 = 2112;
            uint64_t v48 = v10;
            _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Checking if request %@ (%@) timed out after watchdog timer fired", buf, 0x20u);
          }
          v18 = [v12 timeoutDate];
          ...
          if (v19)
          {
            ...
            if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              __int16 v49 = 2112;
              v50 = clientName;
              _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Reaping timed out pending request %@ (%@) from client '%@' that expects a response", buf, 0x2Au);
            }
            v26 = [MEMORY[0x263F087E8] hmErrorWithCode:8];
            ...
            if (v27)
            {
              ...
              if (os_log_type_enabled(v31, OS_LOG_TYPE_DEBUG))
              {
                ...
                *(_DWORD *)buf = 138543362;
                id v44 = v32;
                _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_DEBUG, "%{public}@Suspending watchdog timer after handling timeout", buf, 0xCu);
              }
...
- (void)cancelAllRequests
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v28 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Canceling all pending requests", buf, 0xCu);
  }
  os_unfair_lock_lock_with_options();
  long long v25 = 0u;
  long long v26 = 0u;
  long long v23 = 0u;
  long long v24 = 0u;
  v6 = [(HMDXPCRequestTracker *)v22 pendingRequests];
  ...
  if (v7)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        id v10 = [(HMDXPCRequestTracker *)v22 pendingRequests];
        ...
        if (v11)
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            __int16 v33 = 2112;
            v34 = clientName;
            _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Canceling pending request %@ (%@) from client '%@' that expects a response", buf, 0x2Au);
          }
          v18 = [MEMORY[0x263F087E8] hmErrorWithCode:23];
  ...
  id v19 = [(HMDXPCRequestTracker *)v22 pendingRequests];
...
- (NSSet)requestIdentifiers
{
  ...
  v5 = [(HMDXPCRequestTracker *)self pendingRequests];
  id v6 = [v5 allKeys];
...
- (void)respondToRequestWithIdentifier:(id)a3 withPayload:(id)a4 error:(id)a5
{
  ...
  p_os_unfair_lock_t lock = &self->_lock;
  os_unfair_lock_lock_with_options();
  v12 = [(HMDXPCRequestTracker *)self pendingRequests];
  ...
  if (v13)
  {
    ...
    if (v10)
    {
      __int16 v33 = [NSString stringWithFormat:@" with error %@", v10];
    }
    else
    {
      __int16 v33 = &stru_26E2EB898;
    }
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      long long v39 = v8;
      __int16 v40 = 2114;
      long long v41 = clientName;
      __int16 v42 = 2114;
      v43 = v33;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Answering incoming message %{public}@ (%{public}@) from client '%{public}@' that expects a response%{public}@", buf, 0x34u);
    }
    long long v25 = [(HMDXPCRequestTracker *)v20 pendingRequests];
    [v25 setObject:0 forKeyedSubscript:v8];

    long long v26 = [(HMDXPCRequestTracker *)v20 pendingRequests];
    ...
    if (v27)
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v35 = v31;
        _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_DEBUG, "%{public}@Suspending timer after last request was removed", buf, 0xCu);
      }
  ...
  else
  {
    ...
    id v15 = self;
    HMFGetOSLogHandle();
    dispatch_block_t v16 = (id)objc_claimAutoreleasedReturnValue();
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v38 = 2114;
      long long v39 = v18;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Unable to find request with identifier %{public}@ for client '%{public}@' to remove from request tracker", buf, 0x20u);
    }
  }
...
- (void)addRequestWithIdentifier:(id)a3 name:(id)a4 qualityOfService:(int64_t)a5 isTimeoutDisabled:(BOOL)a6 responseHandler:(id)a7
{
  ...
  os_unfair_lock_t lock = &self->_lock;
  os_unfair_lock_lock_with_options();
  id v14 = [(HMDXPCRequestTracker *)self pendingRequests];
  uint64_t v15 = [v14 count];

  if (!v15)
  {
    dispatch_block_t v16 = (void *)MEMORY[0x230FBD990]();
    v17 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v35 = v19;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Starting watchdog timer", buf, 0xCu);
    }
    id v20 = [(HMDXPCRequestTracker *)v17 watchdogTimer];
    [v20 resume];
  }
  uint64_t v21 = (void *)MEMORY[0x263EFF910];
  id v22 = [(HMDXPCRequestTracker *)self watchdogTimer];
  [v22 timeInterval];
  long long v23 = objc_msgSend(v21, "dateWithTimeIntervalSinceNow:");
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v38 = 2112;
      id v39 = v11;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@Disabling timeout for message %@(%@)", buf, 0x20u);
    }
    uint64_t v28 = [MEMORY[0x263EFF910] distantFuture];

    long long v23 = (void *)v28;
  }
  __int16 v29 = [[HMDXPCRequest alloc] initWithName:v12 qualityOfService:v32 timeoutDate:v23 responseHandler:v13];
...
- (HMDXPCRequestTracker)initWithQueue:(id)a3
{
  id v4 = (objc_class *)MEMORY[0x263F42658];
  id v5 = a3;
  id v6 = (void *)[[v4 alloc] initWithTimeInterval:4 options:300.0];
  id v7 = [(HMDXPCRequestTracker *)self initWithQueue:v5 watchdogTimer:v6];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t17_261696 != -1) {
    dispatch_once(&logCategory__hmf_once_t17_261696, &__block_literal_global_261697);
  }
  v2 = (void *)logCategory__hmf_once_v18_261698;
  return v2;
}
...
void __35__HMDXPCRequestTracker_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v18_261698;
  logCategory__hmf_once_v18_261698 = v0;
}
