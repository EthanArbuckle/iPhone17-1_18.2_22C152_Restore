        ...
        else
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = v24;
            ...
            __int16 v31 = 2048;
            uint64_t v32 = v22;
            _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Unhandled linkType: %tu", buf, 0x16u);
...
- (void)identifyWithCompletionHandler:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v15 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Identify by /identify URL or unpaired BTLE characteristic write", buf, 0xCu);
    }
  ...
  {
    long long v10 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F0C710] code:4 userInfo:0];
...
void __57__HMDUnpairedHAPAccessory_identifyWithCompletionHandler___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v12 = 2112;
    id v13 = v3;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Identify by /identify URL completed with error: %@", (uint8_t *)&v10, 0x16u);
  }
...
- (id)dumpDescription
{
  ...
  id v6 = [v4 objectForKeyedSubscript:*MEMORY[0x263F41FA8]];
  ...
  int v10 = (void *)MEMORY[0x263EFF980];
  ...
  if (v14)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v15; ++i)
      {
        ...
        if (v19 <= 2) {
          unint64_t v20 = off_264A1CE08[v19];
        }
        v21 = v20;
  ...
  if ([v12 count]) {
    [v24 setObject:v12 forKey:*MEMORY[0x263F41E88]];
  }
...
{
  id v6 = a3;
  uint64_t v7 = (void *)MEMORY[0x263F0DF40];
  id v8 = a4;
