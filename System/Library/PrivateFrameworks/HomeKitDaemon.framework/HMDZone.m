  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      id v19 = v29;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Unknown model object (%@) sent to [%@ transactionObjectUpdated]", buf, 0x20u);
    }
...
- (BOOL)_handleSetRoomsTransactionWithRoomUUIDStrings:(id)a3 error:(id *)a4
{
  ...
  v16 = (void *)MEMORY[0x230FBD990]([v42 removeObjectsInArray:obj]);
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    __int16 v65 = 2112;
    v66 = v21;
    _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@About to update the zone from %@ to %@ in zone with name (%@) from home %@", buf, 0x34u);
  }
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v59 = 2112;
    v60 = v42;
    _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@Removing Rooms: %@", buf, 0x16u);
  }
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v59 = 2112;
    v60 = v13;
    _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Adding Rooms: %@", buf, 0x16u);
  }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v61 = 2112;
            id v62 = v39;
            _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_ERROR, "%{public}@_handleSetRoomsZoneTransaction:message: Couldn't find the room with UUID %@ in home %@.", buf, 0x20u);
          }
          if (a4)
          {
...
- (void)_handleRename:(id)a3
{
  ...
  else
  {
    ...
    id v11 = [MEMORY[0x263F087E8] hmErrorWithCode:46];
...
- (id)_checkForAddValidity:(id)a3
{
  ...
  if (v11)
  {
    uint64_t v8 = 24;
LABEL_9:
    id v19 = [MEMORY[0x263F087E8] hmErrorWithCode:v8];
    goto LABEL_10;
  }
  v12 = [v7 home];
  id v13 = [v12 uuid];
  ...
  if (v21 >= maximumRoomsPerZone)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v34 = 2112;
      v35 = v27;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Can't add room %@ to zone %@ in home %@; already at maximum rooms for zone",
        (uint8_t *)&v28,
        0x2Au);
    }
    uint64_t v8 = 49;
...
- (void)_registerForMessages
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v25 = v20;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Not going to register for messages as home is nil", buf, 0xCu);
    }
  }
}
...
- (id)_initWithCoder:(id)a3
{
  ...
  uint64_t v7 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v6];
  ...
  if (v9)
  {
    ...
    id v13 = [MEMORY[0x263EFF8C0] arrayWithObjects:v40 count:2];
...
- (id)dumpState
{
  ...
  if (v11)
  {
    ...
    [v3 setObject:v14 forKeyedSubscript:*MEMORY[0x263F41F78]];
  }
...
- (NSDictionary)assistantObject
{
  ...
  if (v4 && v3)
  {
    ...
    if (v6)
    {
      ...
      v20[4] = v10;
      v20[5] = self;
      uint64_t v11 = [NSDictionary dictionaryWithObjects:v20 forKeys:v19 count:6];
