...
- (void)submitCloudShareTrustStatusDailyEvent
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(void *)&buf[4] = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to submit daily trust status event due to no data source", buf, 0xCu);
    }
  }
}
...
- (void)submitTrustActivityEvent:(int64_t)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      int v17 = 138543362;
      v18 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to submit daily trust status event due to no data source", (uint8_t *)&v17, 0xCu);
    }
  }
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2 != -1) {
    dispatch_once(&logCategory__hmf_once_t2, &__block_literal_global_7920);
  }
...
void __62__HMDCloudShareTrustManagerMetricsEventDispatcher_logCategory__block_invoke()
{
  ...
  logCategory__hmf_once_id v3 = v0;
}
