...
- (HMDCapabilityFlags)initWithCapabilities:(id)a3
{
  ...
  if (v9 >= 9)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v29 = v12;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Ran over 64 bits, you sure this is expected?", buf, 0xCu);
    }
  }
  ...
  v20 = [MEMORY[0x263EFF8F8] dataWithBytesNoCopy:v13 length:v9 freeWhenDone:1];
...
- (HMDCapabilityFlags)initWithCapabilityOptions:(unint64_t)a3
{
  ...
  id v14 = [MEMORY[0x263EFF8F8] dataWithBytesNoCopy:v11 length:v10 freeWhenDone:1];
