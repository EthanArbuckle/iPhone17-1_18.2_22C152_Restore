...
- (void)sessionEnded:(id)a3 withReason:(unsigned int)a4 error:(id)a5
{
  ...
  v15 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1030 underlyingError:v9];
...
- (void)session:(id)a3 receivedInvitationCancelFromID:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v18 = 2112;
    id v19 = v7;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Invitation for IDSSession %@ was canceled by: %@", (uint8_t *)&v14, 0x20u);
  }
  __int16 v13 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1029];
...
- (void)session:(id)a3 receivedInvitationDeclineFromID:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v18 = 2112;
    id v19 = v7;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Invitation for IDSSession %@ has been declined by: %@", (uint8_t *)&v14, 0x20u);
  }
  __int16 v13 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1028];
  [(HMDCameraSnapshotIDSRelayInitiator *)v10 _callFileTransferFailed:v13];
}
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v12 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting the HMDCameraSnapshotIDSRelayInitiator", buf, 0xCu);
  }
...
- (void)_startDataTransfer
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Total number of bytes to send: %tu", buf, 0x16u);
  }
  objc_super v10 = [(HMDCameraSnapshotIDSRelayInitiator *)v6 idsSession];
  int v11 = [v10 socket];
  v12 = [(HMDCameraSnapshotIDSRelay *)v6 workQueue];
  dispatch_source_t v13 = dispatch_source_create(MEMORY[0x263EF8418], v11, 0, v12);
  ...
  if (WeakRetained)
  {
    ...
    if (v9 == -1)
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v28 = 2048;
        size_t v29 = v5;
        _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to send the data of size %tu", (uint8_t *)&v26, 0x16u);
      }
      id v24 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1025];
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v28 = 2048;
      size_t v29 = v9;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Sent %lu bytes", (uint8_t *)&v26, 0x16u);
    }
    ...
    if (!v17)
    {
      id v18 = (void *)MEMORY[0x230FBD990]([v11[6] markWithReason:@"Transfer completed"]);
      uint64_t v19 = v11;
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        int v26 = 138543362;
        v27 = v21;
        _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@File transfer is complete with total transferred bytes", (uint8_t *)&v26, 0xCu);
      }
...
- (void)sendIDSInvitation
{
  ...
  {
    int v7 = (void *)v6;
    uint64_t v8 = *MEMORY[0x263F49FE0];
    v38[0] = *MEMORY[0x263F49FE8];
    v38[1] = v8;
    v39[0] = &unk_26E473750;
    v39[1] = MEMORY[0x263EFFA80];
    v38[2] = *MEMORY[0x263F49FD0];
    v39[2] = &unk_26E473768;
    ssize_t v9 = [NSDictionary dictionaryWithObjects:v39 forKeys:v38 count:3];
    objc_super v10 = (void *)MEMORY[0x263F4A0D8];
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v36 = 2112;
      v37 = v9;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Sending out invitation for IDSSession %@ to device %@ with options: %@", buf, 0x2Au);
    }
  ...
  {
    int v7 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1024];
...
- (void)sendData:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(void *)&v14[4] = v10;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Data send already in progress", v14, 0xCu);
    }
  }
  else
  {
    *(void *)int v14 = [v4 length];
    int v11 = [MEMORY[0x263EFF8F8] dataWithBytes:v14 length:8];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_241003 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_241003, &__block_literal_global_241004);
  }
  v2 = (void *)logCategory__hmf_once_v1_241005;
  return v2;
}
...
void __49__HMDCameraSnapshotIDSRelayInitiator_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_241005;
  logCategory__hmf_once_v1_241005 = v0;
}
