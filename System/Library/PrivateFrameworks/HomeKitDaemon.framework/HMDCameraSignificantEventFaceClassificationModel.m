...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_145358 != -1) {
    dispatch_once(&hmbProperties_onceToken_145358, &__block_literal_global_145359);
  }
  v2 = (void *)hmbProperties__properties_145360;
  return v2;
}
...
void __65__HMDCameraSignificantEventFaceClassificationModel_hmbProperties__block_invoke()
{
  ...
  v0 = [MEMORY[0x263F49310] fieldWithClass:objc_opt_class()];
  ...
  v7 = (void *)hmbProperties__properties_145360;
  hmbProperties__properties_145360 = v6;
}
...
- (id)createFaceClassification
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      v20 = v15;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Cannot create face classification from model: %@", (uint8_t *)&v17, 0x16u);
    }
    v10 = 0;
  }
