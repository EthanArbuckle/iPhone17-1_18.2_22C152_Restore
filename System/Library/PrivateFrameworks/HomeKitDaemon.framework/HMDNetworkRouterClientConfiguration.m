...
LABEL_9:
          ...
          if (v14)
          {
            v15 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:@"5FA86C71-D9DE-4FE8-80BB-823164245F58"];
            v5 = objc_msgSend(MEMORY[0x263F08C38], "hmf_UUIDWithNamespace:data:", v15, v14);
          }
          else
          {
            v5 = 0;
...
+ (id)configurationWithClientIdentifier:(id)a3 lanIdentifier:(int64_t)a4
{
  ...
  if (v5)
  {
    BOOL v7 = (void *)[objc_alloc(MEMORY[0x263F35AF0]) initWithValue:v5];
...
LABEL_23:
  ...
  v19 = objc_msgSend(MEMORY[0x263EFF8F8], "dataWithBytes:length:", v28);
  id v8 = 0;
LABEL_27:
  TLV8BufferFree();
...
- (BOOL)parseFromData:(id)a3 error:(id *)a4
{
  ...
  if (v9)
  {
    ...
    while (1)
    {
      ...
      {
        case 1:
          id v16 = objc_msgSend(MEMORY[0x263EFF8F8], "dataWithBytesNoCopy:length:freeWhenDone:");
          id v31 = v10;
          v17 = &v31;
          [MEMORY[0x263F35AF0] parsedFromData:v16 error:&v31];
        ...
        case 3:
          ...
          id v30 = v10;
          v17 = &v30;
          [MEMORY[0x263F35AF0] parsedFromData:v16 error:&v30];
          v14 = v18 = v14;
          goto LABEL_14;
        case 4:
          id v16 = objc_msgSend(MEMORY[0x263EFF8F8], "dataWithBytesNoCopy:length:freeWhenDone:");
