...
- (id)payloadCopy
{
  ...
  uint64_t v6 = *MEMORY[0x263F0B840];
  v2 = [(HMDAppleMediaAccessoryModelIdentifierResponseMessagePayload *)self modelIdentifier];
  id v3 = [v2 UUIDString];
  v7[0] = v3;
...
- (HMDAppleMediaAccessoryModelIdentifierResponseMessagePayload)initWithPayload:(id)a3
{
  ...
  id v4 = a3;
  v5 = objc_msgSend(v4, "hmf_UUIDForKey:", *MEMORY[0x263F0B840]);
  if (v5)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v4;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to derive message due to no model identifier in payload: %@", (uint8_t *)&v12, 0x16u);
    }
    v7 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_79585 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_79585, &__block_literal_global_79586);
  }
  v2 = (void *)logCategory__hmf_once_v2_79587;
  return v2;
}
...
void __74__HMDAppleMediaAccessoryModelIdentifierResponseMessagePayload_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_79587;
  logCategory__hmf_once_v2_79587 = v0;
}
