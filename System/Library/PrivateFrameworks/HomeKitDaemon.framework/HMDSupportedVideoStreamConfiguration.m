...
- (BOOL)_parseFromTLVData
{
  ...
  v3 = [MEMORY[0x263F358B8] wrappertlv:1 name:@"kSupportedVideoStreamConfiguration_VideoCodecConfigurations" objectCreator:&__block_literal_global_333];
  v25[0] = v3;
  id v4 = [MEMORY[0x263EFF8C0] arrayWithObjects:v25 count:1];
