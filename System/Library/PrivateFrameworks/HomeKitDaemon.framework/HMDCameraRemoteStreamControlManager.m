  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v24 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Sending updated configuration", buf, 0xCu);
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v24 = v21;
        _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Reselected config failed to extract", buf, 0xCu);
      }
...
- (void)updateMaximumVideoResolutionQuality:(int64_t)a3 completionHandler:(id)a4
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v25 = v15;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Dispatching the video resolution quality update request to resident", buf, 0xCu);
  }
  v16 = [(HMDCameraRemoteStreamControlManager *)v13 residentMessageHandler];
  uint64_t v17 = *MEMORY[0x263F0BDA8];
...
void __93__HMDCameraRemoteStreamControlManager_updateMaximumVideoResolutionQuality_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    int v16 = 138543362;
    uint64_t v17 = v10;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Received reply for update video resolution quality request for remote stream session.", (uint8_t *)&v16, 0xCu);
  }
  if (v5)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v18 = 2112;
      id v19 = v5;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Relayed update video resolution quality request to resident failed: %@", (uint8_t *)&v16, 0x16u);
    }
...
- (void)_dispatchReconfigureToResident:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v17 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Dispatching the reconfigure request to resident", buf, 0xCu);
  }
  ...
  if (WeakRetained)
  {
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        int v18 = 138543362;
        id v19 = v13;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Received reply for reconfigure remote stream session", (uint8_t *)&v18, 0xCu);
      }
      if (v5)
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v20 = 2112;
          id v21 = v5;
          _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Relayed reconfigure remote stream session request to resident failed: %@", (uint8_t *)&v18, 0x16u);
        }
...
- (void)streamManagerDidStopStream:(id)a3 error:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      int v15 = 138543362;
      int v16 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Session stopped before starting; cleaning up the stream",
        (uint8_t *)&v15,
        0xCu);
    }
...
- (void)streamManagerDidStartStream:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v18 = 138543362;
    uint64_t v19 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Stream manager did start stream", (uint8_t *)&v18, 0xCu);
  }
...
- (void)deviceConnectionSender:(id)a3 didEndSessionWithError:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
  {
    ...
    int v13 = 138543362;
    uint64_t v14 = v12;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Received a callback that IDS initiator session has ended, stopping the stream", (uint8_t *)&v13, 0xCu);
  }
...
- (void)deviceConnectionSender:(id)a3 didSetUpWithError:(id)a4
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      int v13 = 138543362;
      uint64_t v14 = v12;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to set up IDSDeviceConnection for stream", (uint8_t *)&v13, 0xCu);
    }
...
- (void)deviceConnectionReceiver:(id)a3 didEndSessionWithError:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
  {
    ...
    int v13 = 138543362;
    uint64_t v14 = v12;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Received a callback that IDS session has ended, stopping the stream", (uint8_t *)&v13, 0xCu);
  }
  [(HMDCameraRemoteStreamControlManager *)v10 stopStreamWithError:v7];
}
...
- (void)_cleanUpStreamSessionWithError:(id)a3
{
  ...
  if (v6)
  {
    if (v10)
    {
      ...
      int v15 = 138543362;
      int v16 = v11;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Cleaning up the stream", (uint8_t *)&v15, 0xCu);
    }
  ...
  else
  {
    if (v10)
    {
      ...
      int v15 = 138543362;
      int v16 = v14;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@No current stream session to clean up", (uint8_t *)&v15, 0xCu);
    }
  }
}
...
- (void)_sendStopMessageToResident
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    int v18 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Sending stop stream message to resident", buf, 0xCu);
  }
  ...
  [v11 sendMessageWithName:@"kStopRemoteStreamRequestKey" cameraSessionID:v12 payload:v10 target:v13 responseQueue:v14 responseHandler:&__block_literal_global_47523];
}
...
- (void)stopStreamWithError:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      int v13 = 138543362;
      uint64_t v14 = v12;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@No current stream session to stop", (uint8_t *)&v13, 0xCu);
    }
  }
}
...
- (void)setUpRemoteConnectionWithDevice:(id)a3
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      int v15 = 138543362;
      int v16 = v11;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Remote side has been setup", (uint8_t *)&v15, 0xCu);
    }
    BOOL v12 = [(HMDCameraRemoteStreamControlManager *)v8 streamSession];
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      int v15 = 138543362;
      int v16 = v14;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@No current stream session to remotely set up", (uint8_t *)&v15, 0xCu);
    }
  }
}
...
- (void)reconfigureStream:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v18 = 2112;
    uint64_t v19 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Received request to stop the stream with session ID %@", (uint8_t *)&v16, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      int v16 = 138543362;
      uint64_t v17 = v15;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@No current stream session to reconfigure", (uint8_t *)&v16, 0xCu);
    }
...
- (void)_dispatchStartRequestToResidentWithVideoSSRC:(id)a3 audioSSRC:(id)a4
{
  ...
  if (v6 && v7)
  {
    ...
    v36[2] = v10;
    id v11 = [NSDictionary dictionaryWithObjects:v36 forKeys:v35 count:3];
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v38 = v23;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Dispatching the start request to resident", buf, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v38 = v32;
      _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@No SSRC, cannot start the stream", buf, 0xCu);
    }
  ...
  if (WeakRetained)
  {
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        int v18 = 138543362;
        uint64_t v19 = v13;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Received reply for start remote stream session for session", (uint8_t *)&v18, 0xCu);
      }
      if (v5)
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v20 = 2112;
          id v21 = v5;
          _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Relayed start remote stream session request to resident failed: %@", (uint8_t *)&v18, 0x16u);
        }
        [v15 _cleanUpStreamSessionWithError:v5];
      }
      else
...
- (void)startStreamWithRemoteSettings:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v57 = v11;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Stream sender is set, redispatching the start request to resident", buf, 0xCu);
    }
...
LABEL_5:
  ...
  if (v38)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v57 = v52;
        _os_log_impl(&dword_22F52A000, v51, OS_LOG_TYPE_ERROR, "%{public}@Could not extract a configuration from the given parameters", buf, 0xCu);
      }
  ...
  if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v57 = v48;
    _os_log_impl(&dword_22F52A000, v47, OS_LOG_TYPE_ERROR, "%{public}@Failed to create stream manager for remote stream", buf, 0xCu);
  }
...
- (void)_relaySessionStarted:(id)a3
{
  ...
  if (v6)
  {
    if (v4)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v19 = 2112;
        id v20 = v4;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Relay session failed to start: %@", (uint8_t *)&v17, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      int v17 = 138543362;
      uint64_t v18 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Stream session is no longer valid, stopping the IDS session", (uint8_t *)&v17, 0xCu);
    }
...
- (void)_idsSessionCreatedAndConfigNegotiated
{
  ...
  if ([v4 containsState:2])
  {
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        int v19 = 138543362;
        id v20 = v10;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Negotiation is completed", (uint8_t *)&v19, 0xCu);
      }
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v21 = 2112;
    uint64_t v22 = v18;
    _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Current state: %@, waiting", (uint8_t *)&v19, 0x16u);
  }
}
...
- (void)_setParametersSelected:(id)a3
{
  ...
  {
    id v67 = 0;
    BOOL v10 = [MEMORY[0x263F08928] unarchivedObjectOfClass:objc_opt_class() fromData:v7 error:&v67];
    id v11 = v67;
    if (v10)
    {
      id v66 = v11;
      id v12 = [MEMORY[0x263F08928] unarchivedObjectOfClass:objc_opt_class() fromData:v9 error:&v66];
      id v13 = v66;
      ...
      if (v12)
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v70 = 2112;
          id v71 = v33;
          _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_INFO, "%{public}@Received protocol parameters with Setup Endpoint Write %@", buf, 0x16u);
        }
        ...
        if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v70 = 2112;
          id v71 = v38;
          _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_INFO, "%{public}@Setup Endpoint Read %@", buf, 0x16u);
        }
        ...
        if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v70 = 2112;
          id v71 = v43;
          _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_INFO, "%{public}@Selected stream config %@", buf, 0x16u);
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v54, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v70 = 2112;
          id v71 = v13;
          _os_log_impl(&dword_22F52A000, v54, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive camera video tier parameters from video parameters data: %@", buf, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v70 = 2112;
        id v71 = v11;
        _os_log_impl(&dword_22F52A000, v50, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive camera protocol parameters from protocol parameters data: %@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v69 = v47;
      _os_log_impl(&dword_22F52A000, v46, OS_LOG_TYPE_ERROR, "%{public}@Did not get protocol or tier parameters data", buf, 0xCu);
    }
...
- (void)negotiateStream
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v29 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Received a request to relay start stream to resident", buf, 0xCu);
  }
  ...
  v27[2] = v15;
  int v16 = [NSDictionary dictionaryWithObjects:v27 forKeys:v26 count:3];
  ...
  if (WeakRetained)
  {
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        int v18 = 138543362;
        int v19 = v13;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Received reply for negotiate remote stream session", (uint8_t *)&v18, 0xCu);
      }
      if (v5)
      {
        uint64_t v14 = (void *)MEMORY[0x230FBD990]();
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v20 = 2112;
          id v21 = v5;
          _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Relayed negotiate remote stream session request to resident failed: %@", (uint8_t *)&v18, 0x16u);
        }
        [v15 _cleanUpStreamSessionWithError:v5];
      }
      else
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t28 != -1) {
    dispatch_once(&logCategory__hmf_once_t28, &__block_literal_global_50_47603);
  }
