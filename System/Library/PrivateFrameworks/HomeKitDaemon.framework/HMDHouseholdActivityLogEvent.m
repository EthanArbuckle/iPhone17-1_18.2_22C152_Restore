...
- (HMDHouseholdActivityLogEvent)initWithDictionary:(id)a3 contributors:(id)a4
{
  ...
  if (v10)
  {
    long long v11 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v10];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v30 = v22;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Household activity is missing home UUID. Assuming from original SkyG seed and ignoring.", buf, 0xCu);
    }
    v19 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5 != -1) {
    dispatch_once(&logCategory__hmf_once_t5, &__block_literal_global_18913);
  }
        ...
        if ((v22 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = v39;
            ...
            __int16 v66 = 2112;
            v67 = v43;
            _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@Source household data log event home UUID doesn't match new event's home UUID: %@, %@", buf, 0x20u);
          }
        }
        long long v50 = 0u;
        long long v51 = 0u;
