...
void __65__HMDCameraPowerAssertionHandler_deregisterRemoteRequestHandler___block_invoke(uint64_t a1)
{
  ...
  if ((v3 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v27 = 2112;
      v28 = v22;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Cannot find session %@ in current assertion holders %@", (uint8_t *)&v23, 0x20u);
    }
    goto LABEL_13;
  }
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v27 = 2112;
    v28 = v10;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Deregistering power assertion holder %@, current camera power assertion holders: %@", (uint8_t *)&v23, 0x20u);
  }
  ...
  if (!v12)
  {
    if ([*(id *)(a1 + 32) powerAssertion])
    {
      ...
      v13 = (void *)MEMORY[0x230FBD990]([*(id *)(a1 + 32) setPowerAssertion:0]);
      id v14 = *(id *)(a1 + 32);
      v15 = HMFGetOSLogHandle();
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
...
LABEL_12:
        _os_log_impl(&dword_22F52A000, v18, v19, v17, (uint8_t *)&v23, 0xCu);
      }
    }
    else
    {
...
void __76__HMDCameraPowerAssertionHandler_registerRemoteRequestHandler_forSessionID___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v23 = 2112;
    v24 = v6;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Registering power assertion holder for session %@", (uint8_t *)&v21, 0x16u);
  }
...
LABEL_9:
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v23 = 2112;
    v24 = v20;
    _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Current camera power assertion holders: %@", (uint8_t *)&v21, 0x16u);
  }
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_179828 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_179828, &__block_literal_global_21_179829);
  }
  v2 = (void *)logCategory__hmf_once_v1_179830;
  return v2;
}
...
void __45__HMDCameraPowerAssertionHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_179830;
  logCategory__hmf_once_v1_179830 = v0;
}

+ (id)sharedHandler
{
  if (sharedHandler_onceToken_179835 != -1) {
    dispatch_once(&sharedHandler_onceToken_179835, &__block_literal_global_179836);
  }
