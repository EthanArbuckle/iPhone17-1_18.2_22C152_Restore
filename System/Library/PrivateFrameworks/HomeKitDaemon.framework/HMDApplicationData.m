...
- (HMDApplicationData)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v12 = [MEMORY[0x263EFF8C0] arrayWithObjects:v19 count:8];
    v13 = [v11 setWithArray:v12];
    v14 = [v4 decodeObjectOfClasses:v13 forKey:@"HM.appData"];
...
- (void)updateParentUUIDIfNil:(id)a3
{
        ...
        v7))
  {
    ...
    objc_msgSend(MEMORY[0x263F08C38], "hm_deriveUUIDFromBaseUUID:identifierSalt:withSalts:", self->_parentUUID, 0, &unk_26E473E58);
...
- (void)updateWithModel:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v21 = 2112;
      v22 = v13;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Updating the application data from transaction: %@ / %@", (uint8_t *)&v17, 0x20u);
...
LABEL_6:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v19 = 2112;
      v20 = v16;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Removing entire app data for container: %@", (uint8_t *)&v17, 0x16u);
...
- (id)dumpState
{
  ...
  [MEMORY[0x263EFF9A0] dictionaryWithCapacity:2];
  v24 = self;
...
- (id)applicationDataForIdentifier:(id)a3
{
  ...
  int v7 = objc_msgSend(MEMORY[0x263EFF9A0], "dictionaryWithCapacity:", objc_msgSend(v6, "count"));
...
- (void)setApplicationData:(id)a3 forIdentifier:(id)a4
{
  ...
  if (v6)
  {
    if (v5)
    {
      ...
      v44 = objc_msgSend(MEMORY[0x263EFF9A0], "dictionaryWithCapacity:", objc_msgSend(v5, "count"));
      long long v50 = 0u;
      long long v51 = 0u;
      long long v52 = 0u;
      long long v53 = 0u;
                ...
                if (v45)
                {
                  ...
                  do
                  {
                    for (uint64_t i = 0; i != v45; ++i)
                    {
                      ...
                      long long v21 = objc_msgSend(v18, "hmf_dictionaryForKey:", v20);
                      long long v22 = objc_msgSend(v21, "hmf_stringForKey:", @"kIdentifierKey");
                      long long v23 = objc_msgSend(v21, "hmf_stringForKey:", @"kAssetURLKey");
                      v24 = objc_msgSend(v21, "hmf_dictionaryForKey:", @"kAssetMetadataKey");
                      if (v23)
                      {
                        uint64_t v25 = [NSURL URLWithString:v23];
                      }
                      else
                      {
                        uint64_t v25 = 0;
              ...
              else
              {
                ...
                if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  __int16 v59 = 2112;
                  id v60 = v15;
                  _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_INFO, "%{public}@%@ is not a dictionary, but %@", buf, 0x20u);
...
- (NSUUID)uuid
{
  ...
  if (!uuid
    || ([MEMORY[0x263F08C38] zeroUUID],
        ...
        v5))
  {
    id v6 = objc_msgSend(MEMORY[0x263F08C38], "hm_deriveUUIDFromBaseUUID:identifierSalt:withSalts:", self->_parentUUID, 0, &unk_26E473E40);
    int v7 = v6;
    if (v6)
    {
      id v8 = v6;
    ...
    {
      id v8 = [MEMORY[0x263F08C38] zeroUUID];
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_15604 != -1) {
    dispatch_once(&logCategory__hmf_once_t6_15604, &__block_literal_global_15605);
  }
  v2 = (void *)logCategory__hmf_once_v7_15606;
  return v2;
}
...
void __33__HMDApplicationData_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_15606;
  logCategory__hmf_once_v7_15606 = v0;
}
