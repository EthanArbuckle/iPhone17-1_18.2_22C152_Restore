...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = [+[HMDCHIPControllerNonResidentNodeStorage allocWithZone:a3] init];
  uint64_t v5 = [(HMDCHIPControllerNonResidentNodeStorage *)self keyValueStore];
...
- (NSDictionary)debugDictionaryRepresentation
{
  ...
  id v4 = [(HMDCHIPControllerNonResidentNodeStorage *)self keyValueStore];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_268382 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_268382, &__block_literal_global_268383);
  }
  v2 = (void *)logCategory__hmf_once_v4_268384;
  return v2;
}
...
void __54__HMDCHIPControllerNonResidentNodeStorage_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_268384;
  logCategory__hmf_once_v4_268384 = v0;
}
