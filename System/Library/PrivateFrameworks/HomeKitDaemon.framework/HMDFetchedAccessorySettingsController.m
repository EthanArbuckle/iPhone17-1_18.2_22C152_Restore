  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v33 = 2112;
      id v34 = v10;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Did not find driver in list %@", buf, 0x16u);
    }
  }
}
  ...
  if (a1)
  {
    ...
    while (1)
    {
      for (uint64_t i = 0; i != v47; ++i)
      {
          ...
          if (v13)
          {
            ...
            if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v56 = 2114;
              v57 = v18;
              _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Removing keyPath %{public}@ from pending fetch", buf, 0x16u);
        ...
        v48 = v25;
        id v49 = 0;
        id v27 = [MEMORY[0x263F0E3F8] decodeSettingFromEvent:v26 error:&v49];
        id v28 = v49;
        if (v28)
        {
        ...
        if (!v27 || ![v27 isEqual:v9])
        {
          id v25 = v48;
LABEL_24:
          v38 = (void *)[objc_alloc(MEMORY[0x263F0E3F8]) initWithSetting:v9 eventSource:v45 eventTimestamp:v7];
          v39 = [a1 dataSource];
          v40 = [v39 eventForwarder];
          [v40 forwardEvent:v38 topic:v23 completion:&__block_literal_global_84_107592];
        ...
        if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v56 = 2114;
          v57 = v37;
          _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_INFO, "%{public}@Skip sending event for keyPath: %{public}@ as it matches stored", buf, 0x16u);
    ...
    if (v3)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v18[1] = v10;
          long long v11 = [NSDictionary dictionaryWithObjects:v18 forKeys:v17 count:2];
...
- (void)driver:(id)a3 didUpdatePrimaryUserInfo:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    int v12 = 138543362;
    long long v13 = v11;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Primary user is not supported", (uint8_t *)&v12, 0xCu);
  }
}
...
- (void)driver:(id)a3 didUpdateSettings:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v42 = v12;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Received setting updates", buf, 0xCu);
  }
  ...
  if ([v20 count])
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v43 = 2112;
      id v44 = v20;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@Ignoring updates for unknown keypaths: %@", buf, 0x16u);
  ...
  if (objc_msgSend(v21, "count", v33, v34, v35, v36, v37))
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v45 = 2112;
      uint64_t v46 = v21;
      _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_DEFAULT, "%{public}@Received update for keyPaths: %{public}@ settings: %@", buf, 0x20u);
...
void __90__HMDFetchedAccessorySettingsController_updateSettingWithKeyPath_settingValue_completion___block_invoke(uint64_t a1)
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v38 = 2114;
      uint64_t v39 = v11;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Got setting update request keyPath: %{public}@", (uint8_t *)&v36, 0x16u);
    }
    id v12 = *(id *)(a1 + 48);
    objc_opt_class();
    ...
    else
    {
      if (!v20)
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v40 = 2112;
          id v41 = v34;
          _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@Do not support provided type for update keypath: %{public}@ settingValue: %@", (uint8_t *)&v36, 0x20u);
        }
...
LABEL_23:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v40 = 2114;
    id v41 = v27;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Provided keypath: %{public}@ not in available keypaths: %{public}@", (uint8_t *)&v36, 0x20u);
  }
...
void __77__HMDFetchedAccessorySettingsController_fetchSettingsForKeyPaths_completion___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v93 = 2114;
    v94 = v6;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Received fetch request for keyPaths: %{public}@", buf, 0x16u);
  }
  ...
  v71 = [MEMORY[0x263EFFA08] setWithArray:*(void *)(a1 + 40)];
  v66 = (void *)v9;
  if (([v71 isSubsetOfSet:v9] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v95 = 2114;
      v96 = v17;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Some provided keypaths: %{public}@ not in available keypaths: %{public}@", buf, 0x20u);
    }
  ...
  if (v20)
  {
    ...
    v26 = [MEMORY[0x263EFFA08] setWithArray:v23];
    v62 = v25;
    ...
    if (v30)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          int v36 = (void *)MEMORY[0x263EFFA08];
          if (v35) {
  ...
  if (v46)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v47; ++i)
      {
        ...
        long long v51 = (void *)MEMORY[0x263EFFA08];
...
void __77__HMDFetchedAccessorySettingsController_fetchSettingsForKeyPaths_completion___block_invoke_2(uint64_t a1)
{
  ...
  if ([*(id *)(a1 + 32) count])
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
    {
      ...
      int v13 = 138543362;
      id v14 = v5;
      _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEBUG, "%{public}@At least one of the driver's returned an error setting error on completion", (uint8_t *)&v13, 0xCu);
    }
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    uint64_t v18 = v12;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Finishing fetch request for keyPaths: %{public}@ restuls: %@", (uint8_t *)&v13, 0x20u);
  }
...
- (void)start
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_signpost_emit_with_name_impl(&dword_22F52A000, logger, OS_SIGNPOST_INTERVAL_BEGIN, 0xEEEEB0B5B2B2EEEELL, "LocalSettingsFetch", "", buf, 2u);
  }
  ...
  else
  {
    ...
    id v10 = MEMORY[0x230FBBCF0](self, a2);
    uint64_t v11 = [v9 stringWithFormat:@"%@, %s:%ld", v10, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables/Sources/homed/Media/Media Accessory/Apple/Settings/Fetched Settings/HMDFetchedAccessorySettingsController.m", 184];
...
void __46__HMDFetchedAccessorySettingsController_start__block_invoke(uint64_t a1)
{
  ...
  v42[1] = v42;
  v42[2] = 0x3032000000;
  v42[3] = __Block_byref_object_copy__107625;
  v42[4] = __Block_byref_object_dispose__107626;
  id v43 = 0;
  long long v38 = 0u;
  long long v39 = 0u;
  long long v40 = 0u;
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      for (uint64_t i = 0; i != v24; ++i)
      {
        ...
        __int16 v45 = v10;
        id v16 = (id)[NSDictionary dictionaryWithObjects:&v45 forKeys:&v44 count:1];
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v44 = 2112;
      __int16 v45 = v19;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Fetched at startup: keyPaths: %{public}@ settings from driver: %@", buf, 0x20u);
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v42 = 2112;
      id v43 = v5;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Fetched at startup: settings: %@", buf, 0x16u);
    }
    ...
    id v29 = (void *)v28;
    uint64_t v30 = &stru_26E2EB898;
    if (v28) {
      uint64_t v30 = (__CFString *)v28;
    }
    v39[2] = v30;
    id v31 = (id)[NSDictionary dictionaryWithObjects:v39 forKeys:v38 count:3];
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v42 = 2112;
        id v43 = v6;
        _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_ERROR, "%{public}@Driver error on start %@", buf, 0x16u);
...
void __46__HMDFetchedAccessorySettingsController_start__block_invoke_68(uint64_t a1)
{
  ...
  if (v5)
  {
    ...
    v38[1] = v11;
    id v12 = (id)[NSDictionary dictionaryWithObjects:v38 forKeys:v37 count:2];
    ...
    {
      *(_WORD *)buf = 0;
      _os_signpost_emit_with_name_impl(&dword_22F52A000, v14, OS_SIGNPOST_INTERVAL_END, v4, "LocalSettingsFetch", "", buf, 2u);
    }

    id v15 = (void *)MEMORY[0x230FBD990]([v6 end]);
    id v16 = v5;
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v35 = 2048;
      double v36 = v20;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Setup start timestamp %f", buf, 0x16u);
    }
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v35 = 2048;
      double v36 = v29;
      _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Settings creation latency %f", buf, 0x16u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_107657 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_107657, &__block_literal_global_36_107658);
  }
  v2 = (void *)logCategory__hmf_once_v1_107659;
  return v2;
}
...
void __52__HMDFetchedAccessorySettingsController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_107659;
  logCategory__hmf_once_v1_107659 = v0;
}
