...
void __61__HMDRemoteLoginReceiver_didCompleteAuthentication_response___block_invoke(uint64_t a1)
{
  ...
  if (v3 == v4)
  {
    if (v8)
    {
      ...
      __int16 v18 = 2112;
      uint64_t v19 = v13;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@%@ has completed with response %@", (uint8_t *)&v14, 0x20u);
    }
  ...
  else
  {
    if (v8)
    {
      ...
      __int16 v16 = 2112;
      uint64_t v17 = v10;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Received completion from unknown remote authentication with error %@", (uint8_t *)&v14, 0x16u);
    }
  }
}
...
- (void)_handleACAccountDidChangeNotification:(id)a3
{
  ...
  id v4 = a3;
  v5 = [v4 userInfo];
  id v6 = [v5 objectForKey:*MEMORY[0x263EFAD50]];

  id v7 = [v4 userInfo];
  BOOL v8 = [v7 objectForKey:*MEMORY[0x263EFAF38]];
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    __int16 v36 = 2112;
    v37 = v19;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Got account change notification type:%@ identifier:%@ current:%@ currentIdentifier:%@", buf, 0x34u);
  ...
  if (v6)
  {
    if ([v8 isEqualToString:*MEMORY[0x263EFB000]])
    {
      ...
      if (v21)
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v29 = v25;
          _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@Performing account audit on detecting iTunes account change with active account present.", buf, 0xCu);
        }
...
- (void)_callCompletion:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    id v18 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Login session has ended with response %@", (uint8_t *)&v15, 0x16u);
  }
...
- (void)_auditLoggedInAccountFor:(id)a3
{
  ...
  if (HMFEqualObjects())
  {
    ...
    if (v12)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v27 = 2112;
        id v28 = v4;
        _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@homed knowledge of logged in iTunes account %@ matches with account store: %@", (uint8_t *)&v23, 0x20u);
      }
      goto LABEL_10;
    }
  }
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v27 = 2112;
    id v28 = v4;
    _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@homed knowledge of logged in iTunes account %@ is different than in account store: %@", (uint8_t *)&v23, 0x20u);
  }
    ...
    if (!v12)
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        *(void *)&uint8_t buf[4] = v29;
        _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Signout request is missing", buf, 0xCu);
      }
...
LABEL_36:
    ...
    objc_msgSend(MEMORY[0x263EFB210], "ams_sharedAccountStoreForMediaType:", 0);
    uint64_t v13 = (void (**)(void, void, void))objc_claimAutoreleasedReturnValue();
    int v15 = [v13 accountTypeWithAccountTypeIdentifier:*MEMORY[0x263EFB000]];
    if (!v15)
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
      {
        ...
        *(void *)&uint8_t buf[4] = v34;
        _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_ERROR, "%{public}@Unable to determine store account type for iTunesStore", buf, 0xCu);
      }
      ...
      if (v35)
      {
        ...
        __int16 v36 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
        ((void (**)(void, void *, void))v54)[2](v54, v36, 0);
      }
      else
      {
        int v15 = 0;
    ...
    *(void *)&buf[16] = 0x3032000000;
    v72 = __Block_byref_object_copy__241406;
    v73 = __Block_byref_object_dispose__241407;
    id v74 = 0;
    __int16 v16 = [(HMDRemoteLoginBase *)self remoteLoginHandler];
    __int16 v17 = [v16 loggedInAccount];
    v52 = [v17 username];
    ...
    if (v52)
    {
      ...
      v62[3] = &unk_264A2AFA0;
      id v18 = v52;
      v63 = (void (**)(void, void, void))v18;
      v64 = buf;
      uint64_t v19 = objc_msgSend(v53, "hmf_enumerateWithAutoreleasePoolUsingBlock:", v62);
      ...
      if (v20)
      {
        ...
        if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)v65 = 138543618;
          ...
          __int16 v67 = 2112;
          id v68 = v18;
          _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_ERROR, "%{public}@Unable to determine store account from request username %@", v65, 0x16u);
        }
        ...
        if (v46)
        {
          ...
          v48 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          v49 = [MEMORY[0x263F42610] defaultFormatter];
          id v23 = [v49 stringForObjectValue:*(void *)(*(void *)&buf[8] + 40)];
          v24 = [MEMORY[0x263F42610] defaultFormatter];
          ...
          *(_DWORD *)v65 = 138543874;
          ...
          __int16 v69 = 2112;
          v70 = v25;
          _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Will signout of account %@ using store %@", v65, 0x20u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)v65 = 138543618;
        ...
        __int16 v67 = 2112;
        id v68 = 0;
        _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_ERROR, "%{public}@Cannot sign out of an account with username: %@", v65, 0x16u);
      }
      ...
      v43 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
      ((void (**)(void, void *, void))v42)[2](v42, v43, 0);
    }
LABEL_32:
...
LABEL_34:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_WORD *)&buf[12] = 2112;
    *(void *)&buf[14] = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@Login session %@ is still in progress", buf, 0x16u);
  }
  ...
  if (v11)
  {
    ...
    uint64_t v13 = [MEMORY[0x263F087E8] hmErrorWithCode:15];
    v12[2](v12, v13, 0);
LABEL_35:
...
void __48__HMDRemoteLoginReceiver__handleSignoutRequest___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    id v6 = [MEMORY[0x263F42610] defaultFormatter];
    long long v7 = [v6 stringForObjectValue:*(void *)(*(void *)(*(void *)(a1 + 48) + 8) + 40)];
    *(_DWORD *)buf = 138543618;
    char v12 = v5;
    __int16 v13 = 2112;
    int v14 = v7;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Succeeded in save of account: %@", buf, 0x16u);
  }
...
void __48__HMDRemoteLoginReceiver__handleSignoutRequest___block_invoke_2_57(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    int v8 = [MEMORY[0x263F42610] defaultFormatter];
    ...
    __int16 v16 = 2112;
    id v17 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to save account %@: %@", (uint8_t *)&v12, 0x20u);
  }
...
- (void)_authenticate:(id)a3 message:(id)a4
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v23 = 2112;
    v24 = v18;
    _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Started authentication for session %@", buf, 0x16u);
  }
}
...
- (void)_handleProxyAuthenticationRequest:(id)a3
{
  ...
  if (!v5)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        int v35 = 138543362;
        __int16 v36 = v32;
        _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@Proxy Authentication request is missing", (uint8_t *)&v35, 0xCu);
      }
      ...
      if (v12)
      {
        ...
        __int16 v34 = [MEMORY[0x263F087E8] hmfErrorWithCode:3];
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v37 = 2112;
    uint64_t v38 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@Login session %@ is still in progress", (uint8_t *)&v35, 0x16u);
  }
  ...
  {
    int v12 = [v4 responseHandler];
    __int16 v13 = [MEMORY[0x263F087E8] hmErrorWithCode:15];
  ...
  if (!v5)
  {
    ...
    if (!v12)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        int v27 = 138543362;
        id v28 = v24;
        _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Proxy device request is missing", (uint8_t *)&v27, 0xCu);
      }
      int v12 = [v4 responseHandler];
      ...
      if (v12)
      {
        ...
        id v26 = [MEMORY[0x263F087E8] hmfErrorWithCode:3];
    ...
    __int16 v13 = [MEMORY[0x263F291C0] currentDevice];
    [v13 setLinkType:3];
...
LABEL_11:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v29 = 2112;
    __int16 v30 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@Login session %@ is still in progress", (uint8_t *)&v27, 0x16u);
  }
  id v11 = [v4 responseHandler];
  ...
  if (!v5)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        int v35 = 138543362;
        __int16 v36 = v32;
        _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@Companion Authentication request is missing", (uint8_t *)&v35, 0xCu);
      }
      int v12 = [v4 responseHandler];
...
- (void)registerForNotifications
{
  ...
  if (v4)
  {
    ...
    [v5 addObserver:self selector:sel__handleACAccountDidChangeNotification_ name:*MEMORY[0x263EFB060] object:0];
  }
}
...
- (void)registerForMessages
{
  ...
  v21[0] = v5;
  v21[1] = v6;
  int v12 = [MEMORY[0x263EFF8C0] arrayWithObjects:v21 count:2];
  ...
  v20[0] = v5;
  v20[1] = v6;
  uint64_t v15 = [MEMORY[0x263EFF8C0] arrayWithObjects:v20 count:2];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_241448 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_241448, &__block_literal_global_241449);
  }
  v2 = (void *)logCategory__hmf_once_v1_241450;
  return v2;
}
...
void __37__HMDRemoteLoginReceiver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_241450;
  logCategory__hmf_once_v1_241450 = v0;
}
