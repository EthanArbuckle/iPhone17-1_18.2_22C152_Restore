...
- (void)repairDevice:(id)a3 flags:(unsigned int)a4 completion:(id)a5
{
  uint64_t v5 = *(void *)&a4;
  id v7 = a5;
  v8 = (objc_class *)MEMORY[0x263F6C1F0];
  id v9 = a3;
...
- (void)start
{
  ...
  [v2 activateWithCompletion:&__block_literal_global_109269];
}
...
- (void)setDiscoveryFlags:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2048;
    unint64_t v12 = a3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Setting device discovery flags to %ld", (uint8_t *)&v9, 0x16u);
  }
...
- (SFDeviceDiscovery)deviceDiscovery
{
  ...
  if (!deviceDiscovery)
  {
    id v4 = (SFDeviceDiscovery *)objc_alloc_init(MEMORY[0x263F6C230]);
