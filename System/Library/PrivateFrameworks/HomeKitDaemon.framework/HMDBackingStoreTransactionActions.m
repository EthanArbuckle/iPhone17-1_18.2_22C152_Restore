...
- (BOOL)addPostApplyActionIfNotPresent:(id)a3 usingBlock:(id)a4
{
  ...
  {
    uint64_t v10 = [MEMORY[0x263EFF9C0] setWithObject:v6];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_69836 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_69836, &__block_literal_global_226_69837);
  }
  v2 = (void *)logCategory__hmf_once_v4_69838;
  return v2;
}
...
void __48__HMDBackingStoreTransactionActions_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_69838;
  logCategory__hmf_once_v4_69838 = v0;
}
