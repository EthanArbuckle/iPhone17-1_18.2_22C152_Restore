...
- (void)resetEventCounters
{
  ...
  long long v21 = 0u;
  long long v22 = 0u;
  v4 = [(NSMutableDictionary *)self->_mutableEventCounters allKeys];
  int v5 = 0;
  ...
  v9 = NSNumber;
  v10 = [(HMDEventCounterGroup *)self uptimeProvider];
  [v10 uptime];
  ...
  if (v5)
  {
    v16 = [(HMDEventCounterGroup *)self context];
    [v16 counterChanged];
  }
}
      ...
      else
      {
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          long long v23 = v16;
          _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Can't call observers; context has been deallocated",
            buf,
            0xCu);
        }
      }
...
- (unint64_t)maxCounterName:(id *)a3
{
  ...
  v16 = __Block_byref_object_copy__26624;
  long long v17 = __Block_byref_object_dispose__26625;
  id v18 = 0;
  uint64_t v9 = 0;
  v10 = &v9;
...
- (void)_incrementEventCounterForEventName:(id)a3 withValue:(unint64_t)a4
{
  ...
  if (v9)
  {
    ...
    id WeakRetained = objc_loadWeakRetained((id *)&self->_context);
    long long v13 = [WeakRetained workQueue];
...
- (id)_getOrCreateEventCounterForEventName:(id)a3
{
  ...
  if (!v5)
  {
    ...
    {
      unint64_t v7 = [MEMORY[0x263EFF9A0] dictionary];
      uint64_t v8 = self->_mutableEventCounters;
...
- (HMDEventCounterGroup)initWithContext:(id)a3 serializedEventCounters:(id)a4 uptimeProvider:(id)a5
{
  ...
  if (v11)
  {
    ...
    if ([v9 count])
    {
      uint64_t v13 = objc_msgSend(objc_alloc(MEMORY[0x263EFF9A0]), "initWithCapacity:", objc_msgSend(v9, "count"));
