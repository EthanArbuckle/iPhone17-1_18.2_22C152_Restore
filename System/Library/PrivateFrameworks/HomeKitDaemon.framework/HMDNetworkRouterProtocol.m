...
{
  v2 = NSString;
  int64_t v3 = [(HMDNetworkRouterProtocol *)self protocol];
  if (v3)
  {
    if (v3 == 1)
    {
    ...
    {
      objc_msgSend(NSString, "stringWithFormat:", @"Unknown HMDNetworkRouterProtocolType %ld", v3);
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      v5 = v4;
      int64_t v6 = [(HMDNetworkRouterProtocol *)self protocol];
      uint64_t v7 = [(HMDNetworkRouterProtocol *)v5 protocol];
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[HMDNetworkRouterProtocol allocWithZone:a3];
  int64_t v5 = [(HMDNetworkRouterProtocol *)self protocol];
  return [(HMDNetworkRouterProtocol *)v4 initWithProtocol:v5];
}
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HMDNetworkRouterProtocol);
  uint64_t v7 = v6;
  if (v6)
  {
    id v10 = 0;
    [(HMDNetworkRouterProtocol *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
