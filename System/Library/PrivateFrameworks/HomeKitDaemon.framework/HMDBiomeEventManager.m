  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v22 = v6;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Deleting all events in biome", buf, 0xCu);
    }
    long long v18 = 0u;
    long long v19 = 0u;
    long long v16 = 0u;
    ...
    if (v11)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          -[HMDBiomeEventManager _deleteEventFromStartDate:toEndDate:stream:passingDeleteEventTest:](v4, *(void **)(*((void *)&v16 + 1) + 8 * v14++), &__block_literal_global_37_116525);
        }
        while (v12 != v14);
...
- (void)_deleteEventFromStartDate:(void *)a3 toEndDate:stream:passingDeleteEventTest:
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v46 = 2112;
    id v47 = v5;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Deleting matching biome events from: (%@) to: (%@) in stream: %@", buf, 0x2Au);
  }
  ...
  long long v18 = (void *)MEMORY[0x263F29E88];
  ...
  if (v20)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544642;
      ...
      __int16 v50 = 2112;
      id v51 = v23;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@Deleted matching biome events from: (%@) to: (%@) in stream: %@ with success: %@ (%@)", buf, 0x3Eu);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v44 = 2112;
      id v45 = v5;
      _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@Unable to find public stream to prune for stream identifier: %@ of stream: %@", buf, 0x20u);
    }
  }
}
...
void __114__HMDBiomeEventManager_fetchMostRecentEventWithCharacteristicType_serviceType_homeSPIClientIdentifier_completion___block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    id v39 = __Block_byref_object_copy__116534;
    v40 = __Block_byref_object_dispose__116535;
    id v41 = 0;
    ...
    if (v37[5])
    {
      ...
      v47[1] = v26;
      v27 = [NSDictionary dictionaryWithObjects:v47 forKeys:v46 count:2];
    }
    else
    {
  ...
  if (*(void *)(*(void *)(*(void *)(a1 + 64) + 8) + 40) && [v3 state])
  {
    ...
    *(void *)(v5 + 40) = 0;
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v20 = 2112;
      uint64_t v21 = v13;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Error fetching most revnet event of characeristic type: %@, service type: %@, in home with unique Identifier: %@", (uint8_t *)&v14, 0x2Au);
    }
  }
}
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v26 = 2112;
        id v27 = v8;
        _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@No home found for emptied action set notification: %@ for action set: %@", buf, 0x20u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v24 = 2112;
      id v25 = v4;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@No action set found for emptied action set notification: %@", buf, 0x16u);
    }
  }
}
...
void __60__HMDBiomeEventManager__handleActionSetEmptiedNotification___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&v18[10] = 2112;
      *(void *)&v18[12] = v9;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Deleting matching biome events for action set with uniqueIdentifier: %@, uuid: %@, in home with uniqueIdentifier: %@ uuid %@", buf, 0x34u);
    }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v35 = 2112;
          uint64_t v36 = v10;
          _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@No home found for removed service notification: %@ for service: %@ on accessory: %@", buf, 0x2Au);
        }
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v33 = 2112;
        id v34 = v8;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@No accessory found for removed service notification: %@ for service: %@", buf, 0x20u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v31 = 2112;
      id v32 = v4;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@No service found for removed service notification: %@", buf, 0x16u);
    }
  }
}
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(void *)&v22[22] = v12;
      __int16 v23 = 2112;
      id v24 = v13;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Deleting matching biome events for accessory's (uniqueIdentifier: %@ uuid: %@) service with uniqueIdentifier: %@, uuid: %@, in home with uniqueIdentifier: %@ uuid %@", buf, 0x48u);
    }
    *(void *)buf = MEMORY[0x263EF8330];
    *(void *)&buf[8] = 3221225472;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v28 = 2112;
        id v29 = v8;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@No home found for removed accessory notification: %@ for accessory: %@", buf, 0x20u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v26 = 2112;
      id v27 = v4;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@No accessory found for removed accessory notification: %@", buf, 0x16u);
    }
  }
}
...
void __60__HMDBiomeEventManager__handleAccessoryRemovedNotification___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&v23[10] = 2112;
      *(void *)&v23[12] = v9;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Deleting matching biome events for accessory with uniqueIdentifier: %@, uuid: %@, in home with uniqueIdentifier: %@ uuid %@", buf, 0x34u);
    }
    *(void *)buf = MEMORY[0x263EF8330];
    *(void *)&buf[8] = 3221225472;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v18 = 2112;
      id v19 = v4;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@No home found for home accessory notification: %@", buf, 0x16u);
    }
  }
}
...
void __55__HMDBiomeEventManager__handleHomeRemovedNotification___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[22] = 2112;
      id v19 = v5;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Deleting matching biome events for home with uniqueIdentifier: %@, uuid: %@", buf, 0x20u);
    }
    *(void *)buf = MEMORY[0x263EF8330];
    *(void *)&buf[8] = 3221225472;
    *(void *)&buf[16] = __73__HMDBiomeEventManager__deleteAllEventsForHomeUniqueIdentifier_homeUUID___block_invoke;
    id v19 = &unk_264A1F628;
    id v11 = v13;
    id v20 = v11;
...
- (HMDBiomeEventManager)init
{
  ...
  id v9 = objc_alloc_init(MEMORY[0x263F2A7B8]);
  id v10 = objc_alloc_init(MEMORY[0x263F2A7D0]);
  id v11 = objc_alloc_init(MEMORY[0x263F2A7A8]);
  id v12 = [(HMDBiomeEventManager *)self initWithNotificationCenter:v8 actionSetStream:v9 mediaAccessoryStream:v10 accessoryStream:v11 prunableStreamFactory:&__block_literal_global_116567 workQueue:v7];
...
{
  v2 = (void *)[objc_alloc(MEMORY[0x263F2A990]) initWithPublicStream:a2];
  return v2;
}
