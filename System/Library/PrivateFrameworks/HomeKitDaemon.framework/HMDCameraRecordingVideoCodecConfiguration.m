...
- (BOOL)_parseFromTLVData
{
  ...
  v3 = [MEMORY[0x263F35A58] wrappertlv:1 name:@"VideoCodecConfigurationCodec"];
  id v4 = [MEMORY[0x263F35990] wrappertlv:2 name:@"VideoCodecConfigurationCodecParameters"];
  v5 = [MEMORY[0x263F358B8] wrappertlv:3 name:@"VideoCodecConfigurationAttributes" objectCreator:&__block_literal_global_295_196431];
  v19[0] = v3;
  v19[1] = v4;
  v19[2] = v5;
  id v6 = [MEMORY[0x263EFF8C0] arrayWithObjects:v19 count:3];
