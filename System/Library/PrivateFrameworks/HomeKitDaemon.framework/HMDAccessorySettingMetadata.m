...
- (id)modelWithParentIdentifier:(id)a3
{
  ...
  [(HMDAccessorySettingModel *)v7 setConfigurationVersion:&unk_26E4710B0];
  return v7;
}
...
LABEL_41:
        _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEFAULT, v13, buf, 0x16u);
      }
LABEL_42:
...
LABEL_30:
            ...
            if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v44 = 2112;
              id v45 = v19;
              _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid item with title '%@', constraints: %@", buf, 0x20u);
            }
            id v15 = 0;
            goto LABEL_34;
          }
      ...
      objc_super v31 = (void *)MEMORY[0x230FBD990]();
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v42 = 2112;
        id v43 = v16;
        _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid string value: %@", buf, 0x16u);
      }
      id v15 = 0;
LABEL_38:
