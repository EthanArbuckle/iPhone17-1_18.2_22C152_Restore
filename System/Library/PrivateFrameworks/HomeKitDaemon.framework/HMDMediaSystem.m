...
- (BOOL)componentsSupportsHomeLevelLocationServiceSetting
{
  ...
  if (v5 == [v3 count])
  {
    char v6 = objc_msgSend(v4, "na_all:", &__block_literal_global_109_141261);
  }
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v14 = 2112;
      v15 = v3;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Unable to determine supports home level location services setting for all components: %@", (uint8_t *)&v12, 0x16u);
    }
    char v6 = 0;
  }
...
uint64_t __67__HMDMediaSystem_componentsSupportsHomeLevelLocationServiceSetting__block_invoke_106(uint64_t a1, void *a2)
{
...
- (void)accessorySettingsController:(id)a3 saveWithReason:(id)a4
{
  ...
  uint64_t v7 = [(HMDMediaSystem *)self uuid];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v42 = v29;
      _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Cannot load settings metadata", buf, 0xCu);
    }
    v25 = 0;
  }
          ...
          if (v18)
          {
            ...
            if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v49 = 2112;
              id v50 = v15;
              _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Merging root group of %@", buf, 0x16u);
            }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v49 = 2112;
            id v50 = v15;
            _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Took first group from %@", buf, 0x16u);
          }
...
LABEL_26:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v48 = v36;
      _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_ERROR, "%{public}@Cannot load settings metadata", buf, 0xCu);
    }
    id v32 = 0;
  }
LABEL_28:
...
- (void)removeManagedConfigurationProfileWithProfileData:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    int v13 = 138543362;
    __int16 v14 = v11;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Remove managed configuration profile not supported", (uint8_t *)&v13, 0xCu);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v29 = 2112;
      v30 = v20;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to derive media system model with change type: %@ due to no provided model for media system", buf, 0x16u);
    }
  }
...
- (void)mergeMediaSystemData:(id)a3
{
  ...
  if ((v6 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v13 = 2112;
      id v14 = v4;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Merging media system data: %@", (uint8_t *)&v11, 0x16u);
    }
...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v15 encodeObject:v5 forKey:*MEMORY[0x263F0EA90]];

  char v6 = [(HMDMediaSystem *)self configuredName];
  [v15 encodeObject:v6 forKey:*MEMORY[0x263F0EA80]];

  id v7 = [(HMDMediaSystem *)self uuid];
  [v15 encodeObject:v7 forKey:*MEMORY[0x263F0EAA8]];

  uint64_t v8 = [(HMDMediaSystem *)self components];
  [v15 encodeObject:v8 forKey:*MEMORY[0x263F0EA78]];

  if (objc_msgSend(v15, "hmd_isForLocalStore"))
  {
    uint64_t v9 = [(HMDMediaSystem *)self data];
    uint64_t v10 = [MEMORY[0x263F0E558] codingKey];
    [v15 encodeObject:v9 forKey:v10];
  }
    ...
    || objc_msgSend(v15, "hmd_isForXPCTransportEntitledForSPIAccess"))
  {
    ...
    [v15 encodeObject:v11 forKey:*MEMORY[0x263F0D228]];
  }
  [v15 encodeConditionalObject:v4 forKey:@"home"];
  int v12 = objc_msgSend(v15, "hmd_isForXPCTransport");
  __int16 v13 = [(HMDMediaSystem *)self appData];
  id v14 = v13;
  if (v12) {
    [v13 encodeForXPCTransportWithCoder:v15 key:@"HM.appData"];
  }
  else {
    [v15 encodeObject:v13 forKey:@"HM.appDataRepository"];
  }
}
...
- (HMDMediaSystem)initWithCoder:(id)a3
{
  ...
  id v4 = a3;
  id v5 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0EAA8]];
  char v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0EA80]];
  id v7 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"home"];
  uint64_t v8 = (void *)MEMORY[0x263EFFA08];
  v24[0] = objc_opt_class();
  v24[1] = objc_opt_class();
  uint64_t v9 = [MEMORY[0x263EFF8C0] arrayWithObjects:v24 count:2];
  uint64_t v10 = [v8 setWithArray:v9];
  int v11 = [v4 decodeObjectOfClasses:v10 forKey:*MEMORY[0x263F0EA78]];

  uint64_t v12 = objc_opt_class();
  __int16 v13 = [MEMORY[0x263F0E558] codingKey];
  id v14 = [v4 decodeObjectOfClass:v12 forKey:v13];

  id v15 = [(HMDMediaSystem *)self initWithUUID:v5 configuredName:v6 home:v7 data:v14 components:v11];
  if (v15)
  {
    uint64_t v16 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0EA90]];
    ...
    uint64_t v21 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0D228]];
...
- (void)_appDataRemoved:(id)a3 message:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    int v13 = 138543362;
    id v14 = v11;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling removal of app data", (uint8_t *)&v13, 0xCu);
  }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        id v18 = v25;
        _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Unknown model object (%@) sent to [%@ transactionObjectRemoved]", buf, 0x20u);
      }
...
void __51__HMDMediaSystem_transactionObjectRemoved_message___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      int v8 = 138543362;
      id v9 = v7;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error removing root group.", (uint8_t *)&v8, 0xCu);
    }
  }
}
...
- (void)_transactionMediaSystemUpdated:(id)a3 message:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v55 = v11;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Applying the changes", buf, 0xCu);
  }
  if (isFeatureHomeTheaterQFAEnabledForTests
    && ![(id)isFeatureHomeTheaterQFAEnabledForTests BOOLValue])
  {
    uint64_t v16 = [v6 setProperties];
    ...
    if (v20)
    {
            ...
            if (!v29)
            {
              ...
              if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                __int16 v56 = 2112;
                v57 = v27;
                _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_ERROR, "%{public}@Unable to initialize a mediaSystemComponent from %@", buf, 0x16u);
              }
              long long v46 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v58 = 2112;
        v59 = v21;
        _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_INFO, "%{public}@Updated the media system %@ components to %@", buf, 0x20u);
      }
      v34 = (void *)[v21 copy];
    ...
    uint64_t v52 = *MEMORY[0x263F0EA58];
    v35 = [(HMDMediaSystem *)v9 serialize];
    v53 = v35;
    long long v36 = [NSDictionary dictionaryWithObjects:&v53 forKeys:&v52 count:1];
    ...
    id v39 = [MEMORY[0x263F42568] entitledMessageWithName:*MEMORY[0x263F0EAB0] messagePayload:v38];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v55 = v15;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Skipping transaction update due to Home Theater QFA enabled", buf, 0xCu);
    }
  }
LABEL_26:
}
...
void __40__HMDMediaSystem_reevaluateSettingOwner__block_invoke(uint64_t a1)
{
  ...
  if (v3 != v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v14 = 2112;
      uint64_t v15 = v2;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Target accessory sorting order has changed updating setting owner to %@", (uint8_t *)&v12, 0x16u);
    }
...
LABEL_4:
    ...
    long long v16 = *MEMORY[0x263F42068];
    uint64_t v17 = *(void *)(MEMORY[0x263F42068] + 16);
...
- (void)transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v34 = v14;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Received transaction object updated", buf, 0xCu);
  }
  id v15 = v9;
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
      ...
      if (v22)
      {
        if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v35 = 2112;
          id v36 = v22;
          _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@Handling add of root settings %@", buf, 0x16u);
        }
      ...
      else
      {
        if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          id v38 = v30;
          id v31 = v30;
          _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Unknown model object (%@) sent to [%@ transactionObjectUpdated]", buf, 0x20u);
        }
...
void __61__HMDMediaSystem_transactionObjectUpdated_newValues_message___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      int v8 = 138543362;
      id v9 = v7;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error adding root group.", (uint8_t *)&v8, 0xCu);
    }
  }
}
    ...
    while (1)
    {
      ...
      if (!v10)
      {
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v34 = v21;
          _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Missing accessory cannot determine target.", buf, 0xCu);
        }
        goto LABEL_27;
      }
      ...
      if (!v11)
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v34 = v25;
          _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@Missing serial cannot determine target.", buf, 0xCu);
        }
...
LABEL_4:
    ...
    id v13 = objc_alloc(MEMORY[0x263F0E560]);
    uint64_t v14 = 1;
    goto LABEL_13;
  }
...
- (NSString)configuredName
{
  ...
  else
  {
    ...
    {
      id v6 = [(HMDMediaSystem *)self data];
      id v5 = [v6 name];
    }
  }
  return (NSString *)v5;
...
- (id)serialize
{
  ...
  {
    id v5 = [(HMDMediaSystem *)self name];
    [v3 setObject:v5 forKeyedSubscript:*MEMORY[0x263F0EA90]];
  }
  ...
  if (v6)
  {
    ...
    [v3 setObject:v7 forKeyedSubscript:*MEMORY[0x263F0EA80]];
  }
  uint64_t v8 = [(HMDMediaSystem *)self uuid];
  int v9 = [v8 UUIDString];
  [v3 setObject:v9 forKeyedSubscript:*MEMORY[0x263F0EAA8]];

  [v3 setObject:MEMORY[0x263EFFA88] forKeyedSubscript:*MEMORY[0x263F0EA60]];
  ...
  [v3 setObject:v10 forKeyedSubscript:*MEMORY[0x263F0EA78]];
  id v17 = (void *)[v3 copy];
...
- (void)relayMessage:(id)a3
{
  ...
  if ([v4 isRemote])
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v35 = 2112;
      id v36 = v4;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@Cannot relay remote message: %@", (uint8_t *)&v33, 0x16u);
    }
    int v9 = [MEMORY[0x263F087E8] hmErrorWithCode:52];
  ...
  else
  {
    ...
    if (v9)
    {
      ...
      if (v11)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
          {
            ...
            __int16 v35 = 2112;
            id v36 = v4;
            _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to get message destination to relay message: %@", (uint8_t *)&v33, 0x16u);
          }
          long long v32 = [MEMORY[0x263F087E8] hmErrorWithCode:54];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v35 = 2112;
          id v36 = v4;
          _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to get target device to relay message: %@", (uint8_t *)&v33, 0x16u);
        }
        uint64_t v14 = [MEMORY[0x263F087E8] hmErrorWithCode:54];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v35 = 2112;
        id v36 = v4;
        _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to get message dispatcher to relay message: %@", (uint8_t *)&v33, 0x16u);
      }
      int v11 = [MEMORY[0x263F087E8] hmErrorWithCode:54];
...
- (void)_updateAppData:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v26 = 2112;
    id v27 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating app data with message: %@", (uint8_t *)&v24, 0x16u);
  }
  ...
  uint64_t v18 = [(HMDApplicationData *)v16 modelObjectWithChangeType:v17];
  if (!v18)
  {
LABEL_13:
  ...
  long long v20 = [v19 backingStore];
...
- (void)_handleAppData:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v4;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to pre process update media system app data message: %@", (uint8_t *)&v12, 0x16u);
    }
  }
}
...
- (void)_registerForNotifications
{
  ...
  [v3 addObserver:self selector:sel_handleRemovedAccessory_ name:@"HMDHomeAccessoryRemovedNotification" object:0];

  id v4 = [(HMDMediaSystem *)self notificationCenter];
  [v4 addObserver:self selector:sel_handleAccessorySoftwareUpdated_ name:@"HMDAppleMediaAccessorySoftwareVersionUpdatedNotification" object:0];
}
...
- (void)_registerForMessages
{
  ...
  v16[3] = v9;
  id v10 = [MEMORY[0x263EFF8C0] arrayWithObjects:v16 count:4];

  [v3 registerForMessage:*MEMORY[0x263F0EBC0] receiver:self policies:v10 selector:sel__routeUpdateMediaSystem_];
  ...
  v15[3] = v13;
  __int16 v14 = [MEMORY[0x263EFF8C0] arrayWithObjects:v15 count:4];

  [v3 registerForMessage:*MEMORY[0x263F0EAA0] receiver:self policies:v14 selector:sel__handleAppData_];
}
...
- (void)auditMediaComponents
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v10 = v6;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Skipping audit due to Home Theater QFA enabled", buf, 0xCu);
    }
  }
}
...
void __38__HMDMediaSystem_auditMediaComponents__block_invoke(uint64_t a1)
{
  ...
  if (([*(id *)(a1 + 32) isValid] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      int v16 = 138543362;
      uint64_t v17 = v5;
      _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Media system isn't valid anymore, removing it", (uint8_t *)&v16, 0xCu);
    }
    id v6 = [*(id *)(a1 + 32) home];
    uint64_t v7 = -[HMDMediaSystem _modelForMediaSystem](*(HMDMediaSystemModel **)(a1 + 32));
    int v8 = v7;
    if (v7)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        int v16 = 138543362;
        uint64_t v17 = v15;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@Did not obtain media system model, not deleting.", (uint8_t *)&v16, 0xCu);
      }
    }
  }
}
...
- (HMDMediaSystemModel)_modelForMediaSystem
{
  ...
  if (a1)
  {
    uint64_t v2 = [HMDMediaSystemModel alloc];
    id v3 = [(HMDBackingStoreModelObject *)v1 uuid];
    id v4 = [(HMDMediaSystemModel *)v1 home];
    id v5 = [v4 uuid];
    v1 = [(HMDBackingStoreModelObject *)v2 initWithUUID:v3 parentUUID:v5];
  }
  return v1;
}
...
- (void)mediaDestinationsManager:(id)a3 didUpdateDestination:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v18 = 2112;
    id v19 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating home and siri sync data due to updated destination: %@", (uint8_t *)&v16, 0x16u);
  }
  int v12 = [(HMDMediaSystem *)v9 home];
  id v13 = [v12 homeManager];

  uint64_t v14 = *MEMORY[0x263F0D0C0];
...
- (id)mediaGroupsAggregatorMessengerForMediaDestinationsManager:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      uint64_t v20 = v6;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to get messenger from dependencies home: %@ aggregator: %@", (uint8_t *)&v15, 0x20u);
    }
  }
...
{
  uint64_t v2 = [(HMDMediaSystem *)self components];
  char v3 = objc_msgSend(v2, "na_any:", &__block_literal_global_64_141361);
      ...
      || ([(HMDMediaSystem *)self destinationControllerGroupedWithAssociatedDestination], (uint64_t v5 = objc_claimAutoreleasedReturnValue()) != 0))
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v17 = 2112;
        uint64_t v18 = v5;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Repairing existing audio group with destination controller: %@", buf, 0x16u);
      }
...
void __49__HMDMediaSystem_repairAnyPreExistingAudioGroups__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v3;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Repair existing audio group request completed with error: %@", (uint8_t *)&v12, 0x16u);
    }
  }
  id v8 = (void *)MEMORY[0x230FBD990]();
  id v9 = *(id *)(a1 + 32);
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    int v12 = 138543362;
    long long v13 = v11;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Repair existing audio group request completed", (uint8_t *)&v12, 0xCu);
  }
}
...
- (id)createNewAudioDestination
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v12 = 138543362;
    long long v13 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Creating new audio destination", (uint8_t *)&v12, 0xCu);
  }
...
- (NSArray)associatedAudioDestinationManagers
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v15 = v11;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get associated destination managers due to invalid media system", buf, 0xCu);
    }
    id v7 = 0;
  }
  return (NSArray *)v7;
...
id __52__HMDMediaSystem_associatedAudioDestinationManagers__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v20 = 2112;
      id v21 = v7;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@No audio destination manager found for component: %@ accessory: %@ apple media accessory: %@", (uint8_t *)&v14, 0x2Au);
    }
  }
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        int v14 = 138543362;
        id v15 = v12;
        _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to get audio destination data due to no data source set", (uint8_t *)&v14, 0xCu);
      }
      id v8 = 0;
    }
  }
...
- (id)audioDestinationIdentifier
{
  id v3 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:@"222AA6C0-21DB-4EE6-8E62-019974477350"];
...
- (void)configureWithMessageDispatcher:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v39 = 2112;
    v40 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Configuring media system with components: %@", buf, 0x16u);
  }
  long long v31 = v4;
...
- (BOOL)supportsUserMediaSettings
{
  ...
  int v4 = objc_msgSend(v3, "na_any:", &__block_literal_global_58_141373);
...
- (BOOL)isValid
{
  ...
  if (v4 <= 1)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      id v11 = v8;
      __int16 v12 = 2112;
      uint64_t v13 = &unk_26E471D28;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@There are fewer than %@ components, not valid", (uint8_t *)&v10, 0x16u);
    }
  }
  return v4 > 1;
}
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v9 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Dealloc-ing MediaSystem", buf, 0xCu);
  }
  v7.receiver = v4;
...
- (id)attributeDescriptions
{
  ...
  unint64_t v4 = objc_msgSend(v19, "na_map:", &__block_literal_global_26_141383);
  uint64_t v5 = objc_msgSend(v19, "na_map:", &__block_literal_global_28_141384);
  ...
  id v9 = [(HMDMediaSystem *)self name];
  uint64_t v10 = (void *)[v8 initWithName:@"name" value:v9];
  v20[1] = v10;
  id v11 = objc_alloc(MEMORY[0x263F424F8]);
  __int16 v12 = [(HMDMediaSystem *)self configuredName];
  uint64_t v13 = (void *)[v11 initWithName:@"configuredName" value:v12];
  v20[2] = v13;
  uint64_t v14 = (void *)[objc_alloc(MEMORY[0x263F424F8]) initWithName:@"componentUUIDs" value:v4];
  v20[3] = v14;
  id v15 = (void *)[objc_alloc(MEMORY[0x263F424F8]) initWithName:@"accessoryUUIDs" value:v5];
  v20[4] = v15;
  uint64_t v16 = [MEMORY[0x263EFF8C0] arrayWithObjects:v20 count:5];
...
- (id)modelForMediaSystem
{
  ...
  if ([v4 count])
  {
    uint64_t v5 = -[HMDMediaSystem _modelForMediaSystem]((HMDMediaSystemModel *)self);
  }
  else
  {
    uint64_t v5 = 0;
...
- (HMDMediaSystem)initWithMediaSystemModel:(id)a3 home:(id)a4
{
  ...
  long long v21 = 0u;
  long long v22 = 0u;
  id v9 = objc_msgSend(v6, "mediaSystemComponents", 0);
...
- (HMDMediaSystem)initWithUUID:(id)a3 configuredName:(id)a4 home:(id)a5 data:(id)a6 components:(id)a7 settingsControllerCreator:(id)a8
{
  ...
  if (v18)
  {
    ...
    if (v22)
    {
      ...
      uint64_t v39 = (*((void (**)(void *, void *, HMDMediaSystem *, HMDMediaSystem *, void *, void))v24 + 2))(v24, v37, v22, v22, v38, *MEMORY[0x263F0EA98]);
      ...
      v22->_id audioDestinationsManagerFactory = &__block_literal_global_141401;
...
- (HMDMediaSystem)initWithUUID:(id)a3 configuredName:(id)a4 home:(id)a5 data:(id)a6 components:(id)a7
{
  ...
  if (!v15)
  {
    ...
    {
      id v18 = [MEMORY[0x263F0E558] roomNameSentinel];
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v30 = 2112;
      id v31 = v15;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_DEBUG, "%{public}@Initializing with derived data: %@", buf, 0x16u);
    }
  }
...
- (HMDMediaSystem)initWithMediaSystemData:(id)a3 home:(id)a4
{
  ...
  id v8 = [v7 identifier];
  id v9 = [v7 name];
  id v10 = [(HMDMediaSystem *)self initWithUUID:v8 configuredName:v9 home:v6 data:v7 components:MEMORY[0x263EFFA68]];
...
uint64_t __38__HMDMediaSystem_sortMediaComponents___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v33 = 2112;
      id v34 = v12;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Unexpected media accessory not found for components %@, acc1: %@, acc2: %@", (uint8_t *)&v27, 0x2Au);
    }
    if (v9) {
      uint64_t v21 = 1;
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_141426 != -1) {
    dispatch_once(&logCategory__hmf_once_t2_141426, &__block_literal_global_48_141427);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v3_141428;
  return v2;
}
...
void __29__HMDMediaSystem_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_141428;
  logCategory__hmf_once_v3_141428 = v0;
}
...
+ (id)initalizeDataWithIdentifier:(id)a3 parentIdentifier:(id)a4 name:(id)a5 defaultName:(BOOL)a6 components:(id)a7
{
  ...
  {
    long long v15 = [MEMORY[0x263F0E558] unknownDestinationSentinel];
    if (v16) {
      goto LABEL_3;
    }
  }
  long long v16 = [MEMORY[0x263F0E558] unknownDestinationSentinel];
LABEL_3:
  long long v17 = (void *)[objc_alloc(MEMORY[0x263F0E558]) initWithIdentifier:v14 parentIdentifier:v13 name:v12 defaultName:v7 associatedGroupIdentifier:0 leftDestinationIdentifier:v15 rightDestinationIdentifier:v16];
...
- (id)assistantObject
{
  ...
  if (v4 && v3)
  {
    ...
    if (v6)
    {
      id v7 = (id)*MEMORY[0x263F65678];
      uint64_t v8 = [(HMDMediaSystem *)self components];
      uint64_t v9 = [v8 count];

      if (v9 == 2)
      {
        id v10 = (id)*MEMORY[0x263F65680];

        id v7 = v10;
      }
      v58[0] = *MEMORY[0x263F655C8];
      v57[0] = @"objectType";
      v57[1] = @"objectName";
      ...
      v58[6] = *MEMORY[0x263F657C8];
      v58[7] = v7;
      v57[7] = @"objectServiceSubType";
      v57[8] = @"objectGroupType";
      v58[8] = *MEMORY[0x263F65600];
      long long v15 = [NSDictionary dictionaryWithObjects:v58 forKeys:v57 count:9];
      ...
      long long v17 = objc_msgSend(v16, "na_map:", &__block_literal_global_38_166631);
      ...
      if (v19)
      {
        ...
        v55 = v32;
        id v34 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v55 count:1];
        [v45 setObject:v34 forKey:@"objectGroups"];

        v54 = v48;
        uint64_t v35 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v54 count:1];
...
LABEL_26:
  ...
  if (os_log_type_enabled(v37, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v65 = 2112;
    v66 = v3;
    _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_DEFAULT, "%{public}@Skipping because attribute(s) is nil self %@/%@  self.home %@", buf, 0x2Au);
  }
  uint64_t v42 = 0;
LABEL_27:
