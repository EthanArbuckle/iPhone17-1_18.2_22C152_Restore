...
- (BOOL)exportFromLocalModel:(id)a3 updatedProperties:(id)a4 context:(id)a5
{
  ...
  BOOL v10 = [(MKFCKPerson *)&v26 exportFromLocalModel:v8 updatedProperties:a4 context:v9];
  if (v10)
  {
    v11 = [v8 home];
    v12 = +[MKFCKModel fetchWithLocalModel:v11 context:v9];
    if (!v12)
    {
LABEL_14:
    ...
    if (v15)
    {
      ...
      if (v18)
      {
        v19 = +[MKFCKModel fetchWithLocalModel:v16 context:v9];
        if (v19)
        {
...
+ (id)fetchRequest
{
  return (id)[MEMORY[0x263EFF260] fetchRequestWithEntityName:@"MKFCKHomePerson"];
}
