...
- (void)didTriggerQueuedOutgoingMessage:(id)a3
{
  ...
  if (v6)
  {
    v7 = [MEMORY[0x263F087E8] hmfErrorWithCode:13];
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      v18 = v7;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Unable to send queued outgoing message: %@ error: %@", (uint8_t *)&v13, 0x20u);
    }
...
- (void)didTriggerQueuedIncomingMessage:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      v18 = v7;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Unable to send queued incoming message: %@ error: %@", (uint8_t *)&v13, 0x20u);
    }
    [v6 respondWithError:v7];
    v12 = [(HMDMessageHandler *)v9 metricsDispatcher];
  ...
  else
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v15 = 2112;
        id v16 = v4;
        _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Dropping unknown triggered queued message: %@", (uint8_t *)&v13, 0x16u);
      }
    }
  }
}
...
- (void)handleAccountAddedDeviceNotification:(id)a3
{
      ...
      if (objc_msgSend(v12, "hmf_isEqualToUUID:", v13))
      {
        ...
        if (v14)
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
          {
            ...
            int v23 = 138543362;
            v24 = v18;
            _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Sending queued outgoing messages due to new account device added", (uint8_t *)&v23, 0xCu);
          }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v25 = 2112;
      id v26 = v4;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to get new device from notification: %@", (uint8_t *)&v23, 0x16u);
    }
  }
}
...
- (BOOL)isReadyForOutgoingMessaging
{
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v12 = 2112;
      long long v13 = v3;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Not ready for outgoing messaging due to no device for account manager: %@", (uint8_t *)&v10, 0x16u);
    }
  }
...
- (id)deviceForMessage:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      int v13 = 138543362;
      uint64_t v14 = v11;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get remote device message destination due to no data source", (uint8_t *)&v13, 0xCu);
    }
    id v7 = 0;
  }
...
LABEL_21:
    _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_ERROR, v34, buf, 0x20u);
  ...
  if (([v25 isEqualToString:@"v"] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v40 = 2112;
      v41 = v19;
      _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to route message due to unsafe return type on handler for name: %@ selector: %@", buf, 0x20u);
    }
    v21 = 0;
  }
...
- (void)routeQueuedIncomingMessages
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v20 = 2112;
    v21 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Routing queued incoming messages: %@", buf, 0x16u);
  }
  long long v15 = 0u;
  long long v16 = 0u;
  long long v13 = 0u;
...
- (void)sendQueuedOutgoingMessages:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v21 = 2112;
    id v22 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Sending queued messages: %@", buf, 0x16u);
  }
  long long v16 = 0u;
  long long v17 = 0u;
  long long v14 = 0u;
...
- (BOOL)shouldRelayIncomingMessage:(id)a3 error:(id *)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v18 = 2112;
      uint64_t v19 = v7;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to get relay preference from data source: %@", (uint8_t *)&v16, 0x16u);
    }
    if (a4)
    {
...
- (BOOL)isReadyForIncomingMessage:(id)a3 error:(id *)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      int v14 = 138543362;
      long long v15 = v12;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to get is ready for message value due to no data source", (uint8_t *)&v14, 0xCu);
    }
    if (a4)
    {
      [MEMORY[0x263F087E8] hmfErrorWithCode:15];
...
- (void)relayMessage:(id)a3 shouldQueue:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v45 = 2112;
    v46 = v11;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Relaying message: %@ should queue: %@", (uint8_t *)&v41, 0x20u);
  }
  if ([v6 isRemote])
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v43 = 2112;
      id v44 = v6;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to relay remote message: %@", (uint8_t *)&v41, 0x16u);
    }
    uint64_t v16 = [MEMORY[0x263F087E8] hmfErrorWithCode:5];
  ...
  else
  {
    ...
    if (v18)
    {
      ...
      if ([(HMDMessageHandler *)v8 isReadyForOutgoingMessaging])
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
          {
            ...
            int v41 = 138543362;
            uint64_t v42 = v40;
            _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_INFO, "%{public}@Skipping relaying of message due to message already being dequeued on different thread", (uint8_t *)&v41, 0xCu);
          }
          id v6 = 0;
        }
      }
      else
      {
        ...
        if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v43 = 2112;
          id v44 = v6;
          _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_INFO, "%{public}@Leaving message in queue until ready for outgoing message: %@", (uint8_t *)&v41, 0x16u);
        }
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v43 = 2112;
        id v44 = v6;
        _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_INFO, "%{public}@Leaving message in queue until device is found for message: %@", (uint8_t *)&v41, 0x16u);
      }
      uint64_t v16 = 0;
    }
  }
...
- (void)_logMediaDestinationControllerUpdateMetricsUsingMessage:(id)a3
{
  ...
  if (v5 && v6)
  {
    ...
    {
      char v10 = [v9 objectForKeyedSubscript:*MEMORY[0x263F0D0C8]];
      objc_opt_class();
      if (objc_opt_isKindOfClass()) {
        uint64_t v11 = v10;
      }
      ...
      uint64_t v13 = [objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v12];
      ...
      if (v18)
      {
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v44 = 2112;
          id v45 = v38;
          _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Destination UUID string %@ or UUID %@ is nil", buf, 0x20u);
        }
      }
      else
      {
        if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v44 = 2112;
          id v45 = v12;
          _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Received request to update controller %@ with destination identifier %@", buf, 0x20u);

          int v14 = v36;
        }

        if ([v12 isEqualToString:*MEMORY[0x263F0D0D0]])
        {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v42 = 2112;
            id v43 = v29;
            _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_INFO, "%{public}@Found associated setup session identifier %@ during home theater grouping", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      int v41 = v23;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to log media destination controller update metrics due to either no home or metric dispatcher", buf, 0xCu);
    }
  }
}
...
- (void)routeMessage:(id)a3 shouldQueue:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v44 = 2112;
    id v45 = v5;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Routing message: %@", buf, 0x16u);
  }
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v44 = 2112;
      id v45 = v5;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to route message due to no response handler from message: %@", buf, 0x16u);
    }
    uint64_t v13 = [MEMORY[0x263F087E8] hmfErrorWithCode:8];
    goto LABEL_11;
  }
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v44 = 2112;
      id v45 = v13;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to route message due to ready preference error: %@", buf, 0x16u);
    }
LABEL_11:
    ...
    if (v24)
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v44 = 2112;
        id v45 = v25;
        _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to route message due to relay preference error: %@", buf, 0x16u);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v44 = 2112;
        id v45 = v22;
        _os_log_impl(&dword_22F52A000, v38, OS_LOG_TYPE_ERROR, "%{public}@Failed to route message due to no handler available for message: %@", buf, 0x16u);
      }
      uint64_t v25 = [MEMORY[0x263F087E8] hmfErrorWithCode:15];
    }
...
LABEL_27:
  ...
  if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v43 = v33;
    _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_INFO, "%{public}@Skipping routing message since message was already dequeued on another thread", buf, 0xCu);
  }
  id v5 = 0;
LABEL_12:
}
...
- (id)queuedOutgoingMessages
{
  ...
  id v4 = [(NSMutableDictionary *)self->_messageNameToQueuedOutgoingMessage allValues];
  os_unfair_lock_unlock(p_lock);
  id v5 = objc_msgSend(v4, "na_map:", &__block_literal_global_48_248730);
...
- (id)dequeueOutgoingMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v21 = 2112;
    id v22 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Dequeueing outgoing message: %@", buf, 0x16u);
  }
  p_lock = &v6->_lock;
  os_unfair_lock_lock_with_options();
...
- (void)associateDevice:(id)a3 withOutgoingMessage:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v20 = 2112;
    id v21 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Associating device: %@ with outgoing message: %@", (uint8_t *)&v16, 0x20u);
  }
  p_lock = &v9->_lock;
  os_unfair_lock_lock_with_options();
...
- (void)queueOutgoingMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v24 = 2112;
    id v25 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Queueing outgoing message: %@", (uint8_t *)&v22, 0x16u);
  }
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v24 = 2112;
      id v25 = v19;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Canceling queued outgoing message due to duplicate message name for message: %@", (uint8_t *)&v22, 0x16u);
    }
    [v12 setDelegate:0];
    [v12 suspendTimer];
    __int16 v20 = [MEMORY[0x263F087E8] hmfErrorWithCode:12];
    id v21 = [v12 message];
...
- (id)dequeueQueuedIncomingMessages
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v7;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Dequeueing incoming messages: %@", (uint8_t *)&v11, 0x16u);
  }
  os_unfair_lock_lock_with_options();
  ...
  BOOL v9 = objc_msgSend(v8, "na_map:", &__block_literal_global_45_248741);
...
- (id)dequeueIncomingMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v21 = 2112;
    id v22 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Dequeueing incoming message: %@", buf, 0x16u);
  }
  p_lock = &v6->_lock;
  os_unfair_lock_lock_with_options();
...
- (void)queueIncomingMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v24 = 2112;
    id v25 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Queueing incoming message: %@", (uint8_t *)&v22, 0x16u);
  }
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v24 = 2112;
      id v25 = v19;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Canceling queued incoming message due to duplicate message name for message: %@", (uint8_t *)&v22, 0x16u);
    }
    [v12 setDelegate:0];
    [v12 suspendTimer];
    __int16 v20 = [MEMORY[0x263F087E8] hmfErrorWithCode:12];
...
- (id)queuedIncomingMessages
{
  ...
  id v4 = [(NSMutableDictionary *)self->_messageNameToQueuedIncomingMessages allValues];
  os_unfair_lock_unlock(p_lock);
  uint64_t v5 = objc_msgSend(v4, "na_map:", &__block_literal_global_248746);
...
- (void)registerForNotifications
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v31 = 2112;
    v32 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Register for notifications: %@ notifications to objects: %@", buf, 0x20u);
  }
  BOOL v9 = [v4 allKeys];
  __int16 v21 = v3;
  ...
  if (v6 && (isInternalBuild() & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v36 = 2112;
      id v37 = v9;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Skipping registration for internal build messages: %@", buf, 0x16u);
    }
  }
  else
  {
      ...
      do
      {
        for (uint64_t i = 0; i != v13; ++i)
        {
          ...
          if ([(HMDMessageHandler *)self selectorForName:v16])
          {
            ...
            v32[1] = v10;
            v32[2] = v25;
            uint64_t v18 = [MEMORY[0x263EFF8C0] arrayWithObjects:v32 count:3];
...
- (void)registerForMessagesWithHome:(id)a3
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v18 = 2112;
    id v19 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Registering for messages owner: %@, admin: %@, internal: %@", (uint8_t *)&v12, 0x2Au);
  }
...
- (void)configureWithHome:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    id v11 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Configuring", (uint8_t *)&v10, 0xCu);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t59_248792 != -1) {
    dispatch_once(&logCategory__hmf_once_t59_248792, &__block_literal_global_69_248793);
  }
  id v2 = (void *)logCategory__hmf_once_v60_248794;
  return v2;
}
...
void __32__HMDMessageHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v60_248794;
  logCategory__hmf_once_v60_248794 = v0;
}
