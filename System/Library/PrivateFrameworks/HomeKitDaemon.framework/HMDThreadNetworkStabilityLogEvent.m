...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  v48[19] = v23;
  id v25 = [NSDictionary dictionaryWithObjects:v48 forKeys:v47 count:20];
...
- (HMDThreadNetworkStabilityLogEvent)initWithDictionary:(id)a3
{
  ...
  v72 = v6;
  if (v6) {
    v88 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v6];
  }
  else {
    v88 = 0;
  }
