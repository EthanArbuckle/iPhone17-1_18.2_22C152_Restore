...
- (void)delegatingRouter:(id)a3 fetchCachedEventsForTopics:(id)a4 forRouter:(id)a5 cachedEventCollection:(id)a6
{
  ...
  if ([(HMDHomeRemoteEventRouterClientController *)self isCurrentDevicePrimaryResident])
  {
    ...
    if (v14)
    {
      id v16 = self ? objc_getProperty(self, v15, 88, 1) : 0;
      id v17 = [v16 eventRouterClient];

      if (v14 != v17)
      {
        uint64_t v18 = objc_msgSend(v9, "na_filter:", &__block_literal_global_87_107054);
...
void __120__HMDHomeRemoteEventRouterClientController_delegatingRouter_fetchCachedEventsForTopics_forRouter_cachedEventCollection___block_invoke_2(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      uint64_t v20 = v14;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch events from router: %@", (uint8_t *)&v17, 0x16u);
    }
  }
  v15 = *(void **)(a1 + 48);
  id v16 = objc_msgSend(v8, "na_map:", &__block_literal_global_91);
...
{
  v4 = (objc_class *)MEMORY[0x263F49388];
  id v5 = a3;
  id v6 = a2;
...
{
  v2 = [MEMORY[0x263F0E300] decodeTopic:a2];
...
LABEL_19:
  ...
  if (v11 != v13)
  {
    ...
    long long v30 = 0u;
    if (self) {
      id v15 = objc_getProperty(self, v14, 96, 1);
    }
    else {
      id v15 = 0;
    }
  ...
  if (self && (id v26 = objc_getProperty(self, v14, 104, 1)) != 0)
  {
    id v16 = v26;
    id v23 = +[HMDAccessoryEventsGenerated topicsRemovingAccessoryTopics:v7 accessoryUUID:objc_getProperty(self, v27, 104, 1)];
LABEL_24:
  }
  else
  {
...
- (id)primaryResidentChangeMonitorForRouterClient:(id)a3
{
  ...
  char v5 = [WeakRetained primaryResidentChangeMonitorForRemoteEventRouterClientController:self];
...
- (id)routerClientPrimaryResidentDeviceIdentifier:(id)a3
{
  ...
  char v5 = [WeakRetained primaryResidentDeviceIdentifierForRemoteEventRouterClientController:self];
...
- (id)routerClientMessageDestination:(id)a3 serverIdentifier:(id *)a4
{
  ...
  if (self)
  {
    id Property = objc_getProperty(self, v6, 24, 1);
    ...
    if (objc_getProperty(self, v11, 88, 1) != v7)
    {
      ...
      long long v31 = 0u;
      long long v32 = 0u;
      id v13 = objc_getProperty(self, v12, 96, 1);
      goto LABEL_4;
    }
  }
  else
...
LABEL_21:
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v37 = 2112;
    id v38 = v7;
    _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Unable to determine destination for event router client: %@", buf, 0x16u);
  }
  id v23 = 0;
LABEL_24:
...
void __72__HMDHomeRemoteEventRouterClientController_fetchWithFilters_completion___block_invoke(uint64_t a1)
{
  ...
  if (v1)
  {
    ...
    if ([v1 isCurrentDevicePrimaryResident])
    {
      ...
      v36[1] = v36;
      v36[2] = 0x3032000000;
      v36[3] = __Block_byref_object_copy__107065;
      v36[4] = __Block_byref_object_dispose__107066;
      id v37 = 0;
      long long v32 = 0u;
      long long v33 = 0u;
      long long v34 = 0u;
      long long v35 = 0u;
      id obj = objc_getProperty(v1, v7, 96, 1);
      ...
      if (v8)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            uint64_t v16 = objc_msgSend(v15, "na_filter:", &__block_literal_global_107067);
      ...
      uint64_t v19 = objc_getProperty(v1, v18, 24, 1);
      block[0] = MEMORY[0x263EF8330];
      block[1] = 3221225472;
    ...
    {
      id v20 = objc_getProperty(v1, v5, 88, 1);
      uint64_t v22 = objc_msgSend(objc_getProperty(v1, v21, 88, 1), "eventRouterClient");
...
void __73__HMDHomeRemoteEventRouterClientController__fetchWithFilters_completion___block_invoke_3(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v21 = 2112;
      uint64_t v22 = v18;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch events from router: %@", (uint8_t *)&v19, 0x16u);
    }
  }
...
- (id)dumpStateDescription
{
  ...
  char v4 = [MEMORY[0x263F089D8] stringWithString:@"[HMDHomeRemoteEventRouterClientController"];
  if (self)
  {
    char v5 = objc_msgSend(objc_getProperty(self, v3, 88, 1), "dumpStateDescription");
...
- (BOOL)isPrimaryResidentClientConnected
{
  if (self)
  {
    self = (HMDHomeRemoteEventRouterClientController *)objc_getProperty(self, a2, 88, 1);
    uint64_t v2 = vars8;
  }
...
- (void)networkAvailabilityDidChange:(BOOL)a3
{
  char v4 = self;
  if (self) {
    self = (HMDHomeRemoteEventRouterClientController *)objc_getProperty(self, a2, 24, 1);
  }
...
uint64_t __73__HMDHomeRemoteEventRouterClientController_networkAvailabilityDidChange___block_invoke(uint64_t result, const char *a2)
{
  ...
  if (v2)
  {
    ...
    id Property = objc_getProperty(*(id *)(result + 32), a2, 24, 1);
    dispatch_assert_queue_V2(Property);
    long long v14 = 0u;
    long long v15 = 0u;
    long long v12 = 0u;
    ...
    return objc_msgSend(objc_getProperty(v2, v11, 88, 1), "networkAvailabilityDidChange:", v3 != 0);
  }
  return result;
}
...
void __81__HMDHomeRemoteEventRouterClientController_removeResidentRouterForAccessoryUUID___block_invoke(uint64_t a1)
{
  ...
  if (v1)
  {
    ...
    dispatch_assert_queue_V2(Property);
    id WeakRetained = objc_loadWeakRetained(v1 + 8);
    id v6 = WeakRetained;
    if (WeakRetained)
    {
        ...
        && [v6 isCurrentDeviceResidentCapableForRemoteEventRouterClientController:v1])
      {
        ...
        long long v28 = 0u;
        long long v29 = 0u;
        uint64_t v8 = objc_msgSend(objc_getProperty(v1, v7, 96, 1), "copy");
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)long long v32 = 138543874;
          ...
          __int16 v36 = 2112;
          id v37 = v3;
          _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@Removing %@ client resident event router(s) for accessory: %@", v32, 0x20u);
        }
        objc_msgSend(objc_getProperty(v23, v26, 96, 1), "removeObject:", v11);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v40 = 2112;
        id v41 = v3;
        _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Cannot create resident router for accessory: %@ due to nil datasource", buf, 0x16u);
      }
    }
  }
}
  ...
  if (v1)
  {
    ...
    if (WeakRetained)
    {
        ...
        && [v6 isCurrentDeviceResidentCapableForRemoteEventRouterClientController:v1])
      {
        ...
        long long v55 = 0u;
        long long v56 = 0u;
        id v8 = objc_getProperty(v1, v7, 96, 1);
              ...
              if (v14)
              {
                ...
                if (os_log_type_enabled(v50, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v61 = 2112;
                  id v62 = v3;
                  _os_log_impl(&dword_22F52A000, v50, OS_LOG_TYPE_INFO, "%{public}@Not creating resident router for accessory (%@) as it already exists.", buf, 0x16u);
                }
        ...
        id v18 = objc_getProperty(v1, v17, 80, 1);
        id v20 = objc_getProperty(v1, v19, 32, 1);
        id v22 = objc_getProperty(v1, v21, 24, 1);
        id v24 = objc_getProperty(v1, v23, 40, 1);
        id v26 = objc_getProperty(v1, v25, 48, 1);
        v52 = (void *)v15;
        long long v28 = objc_msgSend(v18, "residentClientWithAccessoryUUID:homeUUID:queue:dataSource:messageDispatcher:notificationCenter:requestMessageName:updateMessageName:multiHopFetchResponseMessageName:storeReadHandle:storeWriteHandle:", v3, v20, v22, v1, v54, v53, v24, v26, objc_getProperty(v1, v27, 56, 1), v15, v16);

        uint64_t v29 = [v1 isCurrentDevicePrimaryResident];
        uint64_t v30 = [v1 isNetworkAvailable];
        id v65 = objc_getProperty(v1, v31, 72, 1);
        ...
        uint64_t v39 = objc_msgSend(objc_getProperty(v1, v38, 96, 1), "addObject:", v28);
        __int16 v40 = (void *)MEMORY[0x230FBD990](v39);
        id v41 = v1;
        ...
        if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v63 = 2112;
          v64 = v28;
          _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_INFO, "%{public}@Created resident router for accessory: %@, client: %@", buf, 0x20u);
        }
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)v66 = 138543618;
        ...
        __int16 v68 = 2112;
        id v69 = v3;
        _os_log_impl(&dword_22F52A000, v46, OS_LOG_TYPE_ERROR, "%{public}@Cannot create resident router for accessory: %@ due to nil datasource", v66, 0x16u);
      }
    }
LABEL_22:
  }
...
- (void)_sendNetworkAvailableOnStartingMessaging:(uint64_t)a1
{
  ...
  v9[1] = v9;
  v9[2] = 0x3032000000;
  v9[3] = __Block_byref_object_copy__107065;
  v9[4] = __Block_byref_object_dispose__107066;
  id v4 = *(id *)(a1 + 112);
  id v10 = v4;
  ...
  if (!v6)
  {
    ...
    if (v10)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v20 = 2112;
        uint64_t v21 = v15;
        _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Mark network as available on transport start %@", (uint8_t *)&v18, 0x16u);
      }
...
void __71__HMDHomeRemoteEventRouterClientController_updateCurrentAccessoryUUID___block_invoke(uint64_t a1, const char *a2)
{
  ...
  if (Property) {
    id Property = objc_getProperty(Property, a2, 104, 1);
  }
...
- (HMDHomeRemoteEventRouterClientController)initWithMessageTargetUUID:(id)a3 workQueue:(id)a4 dataSource:(id)a5 routerClientFactory:(id)a6 requestMessageName:(id)a7 updateMessageName:(id)a8 multiHopFetchResponseMessageName:(id)a9 clientUserMessagePolicy:(id)a10 currentAccessoryUUID:(id)a11 assertionController:(id)a12 remoteTransportStartFuture:(id)a13 delegatingRouterFactory:(id)a14
{
  ...
  if (v22)
  {
    ...
    v63[0] = objc_getProperty(v23, v37, 72, 1);
    SEL v38 = (void *)MEMORY[0x263EFF8C0];
    uint64_t v39 = v21;
    id v40 = v63[0];
...
id __226__HMDHomeRemoteEventRouterClientController_initWithMessageTargetUUID_workQueue_dataSource_requestMessageName_updateMessageName_multiHopFetchResponseMessageName_clientUserMessagePolicy_currentAccessoryUUID_assertionController___block_invoke(uint64_t a1, void *a2)
{
  ...
  id v7 = objc_alloc(MEMORY[0x263F49378]);
