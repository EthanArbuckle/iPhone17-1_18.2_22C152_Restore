...
- (HMDAccessorySettingsMetadata)initWithURL:(id)a3
{
  v4 = [NSDictionary dictionaryWithContentsOfURL:a3];
  if (v4)
  {
    v16.receiver = self;
    ...
    if (v5)
    {
      ...
      uint64_t v7 = *MEMORY[0x263F0B5C0];
...
- (HMDAccessorySettingsMetadata)init
{
  ...
  uint64_t v7 = [MEMORY[0x263F42620] productInfo];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v23 = 2112;
      v24 = v11;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot find setting resource at: %@", buf, 0x16u);
    }
    objc_super v16 = 0;
  }
