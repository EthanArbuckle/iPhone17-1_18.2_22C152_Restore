...
+ (id)identifier8BytesForKey:(id)a3
{
  ...
  id v3 = a3;
  CC_SHA256_Init(&v8);
  v4 = objc_msgSend(MEMORY[0x263EFF990], "dataWithBytes:length:", "key-identifier", 14, *(_OWORD *)v8.count, *(_OWORD *)&v8.hash[2], *(_OWORD *)&v8.hash[6], *(_OWORD *)&v8.wbuf[2], *(_OWORD *)&v8.wbuf[6], *(_OWORD *)&v8.wbuf[10], *(void *)&v8.wbuf[14]);
  [v4 appendData:v3];

  id v5 = v4;
  CC_SHA256_Update(&v8, (const void *)[v5 bytes], objc_msgSend(v5, "length"));
  CC_SHA256_Final(md, &v8);
  v6 = [MEMORY[0x263EFF8F8] dataWithBytes:md length:8];
...
+ (id)identifier16BytesForKey:(id)a3
{
  ...
  CC_SHA256_Update(&v8, (const void *)[v5 bytes], objc_msgSend(v5, "length"));
  CC_SHA256_Final(md, &v8);
  v6 = [MEMORY[0x263EFF8F8] dataWithBytes:md length:16];
...
+ (id)privateKeyFromKeyPairExternalRepresentation:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Unexpected NIST256 key pair external representation length %lu", (uint8_t *)&v9, 0x16u);
    }
    v4 = 0;
  }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v21 = 2112;
        CFErrorRef v22 = v9;
        _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to copy NIST256 key external representation: %@", buf, 0x16u);
      }
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v21 = 2112;
      CFErrorRef v22 = v7;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to create NIST256 key: %@", buf, 0x16u);
    }
    CFDataRef v8 = 0;
  }
