...
- (HMDAppleAccountManagerDefaultDataSource)initWithQueue:(id)a3
{
  ...
  if (v6)
  {
    ...
    uint64_t v9 = [v8 initWithEnvironmentName:*MEMORY[0x263F280D0] namedDelegatePort:*MEMORY[0x263F280B8] queue:v5];
    ...
    v13 = (HMDACAccountStore *)objc_alloc_init(MEMORY[0x263EFB210]);
