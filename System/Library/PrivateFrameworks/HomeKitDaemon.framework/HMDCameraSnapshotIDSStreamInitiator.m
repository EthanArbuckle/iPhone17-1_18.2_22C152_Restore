    ...
    if (v18)
    {
      ...
      if (v14)
      {
        if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v29 = 2112;
          id v30 = v14;
          _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Received confirmation from IDS that the file send failed for identifier %@: %@", (uint8_t *)&v25, 0x20u);
        }
      ...
      else
      {
        if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v27 = 2112;
          id v28 = v13;
          _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Received confirmation from IDS that the file send succeeded for identifier: %@", (uint8_t *)&v25, 0x16u);
        }
      }
    }
  }
...
- (void)_sendFile:(id)a3
{
  ...
  v46[0] = v9;
  id v10 = [MEMORY[0x263EFF8C0] arrayWithObjects:v46 count:1];
  id v11 = [v8 setWithArray:v10];

  uint64_t v44 = *MEMORY[0x263F49EF8];
  uint64_t v45 = MEMORY[0x263EFFA88];
  id v12 = [NSDictionary dictionaryWithObjects:&v45 forKeys:&v44 count:1];
  v42[0] = @"kCameraSessionID";
  id v13 = [(HMDCameraSnapshotIDSStream *)self sessionID];
  id v14 = [v13 sessionID];
  v43[0] = v14;
  v42[1] = *MEMORY[0x263F0EBA8];
  ...
  if (v20)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v40 = 2112;
      id v41 = v20;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Sending file %@ failed with error %@", buf, 0x20u);
    }
  ...
  {
    __int16 v27 = (void *)MEMORY[0x230FBD990]([(HMDCameraSnapshotIDSStreamInitiator *)self setSendFileIdentifier:v19]);
    id v28 = self;
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v40 = 2112;
      id v41 = v19;
      _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_INFO, "%{public}@Sent the resource transfer request for %@ with identifier %@", buf, 0x20u);
    }
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v9 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting the HMDCameraSnapshotIDSStreamInitiator", buf, 0xCu);
  }
  v7.receiver = v4;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_271110 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_271110, &__block_literal_global_271111);
  }
  v2 = (void *)logCategory__hmf_once_v4_271112;
  return v2;
}
...
void __50__HMDCameraSnapshotIDSStreamInitiator_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_271112;
  logCategory__hmf_once_v4_271112 = v0;
}
