...
- (HMDCloudPairedMetadataDiagnostics)initWithAccessoryIdentifier:(id)a3 jsonDictionary:(id)a4
{
  *(void *)&v38[13] = *MEMORY[0x263EF8340];
  id v6 = a3;
  id v7 = a4;
...
LABEL_18:
    ...
    if (v13)
    {
      ...
      if (v17)
      {
        ...
        if (!v19)
        {
          v29 = [NSURL URLWithString:v10];
          v30 = [NSURL URLWithString:v12];
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)v38 = v20;
          v38[2] = 2112;
          *(void *)&v38[3] = v6;
          _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Invalid uploadType: %u received in JSON for accessory: %@", buf, 0x1Cu);
        }
      }
      v24 = 0;
    }
...
LABEL_17:
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v37 = 2112;
    *(void *)v38 = v6;
    _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Version configuration must contain firmware version: %@", buf, 0x16u);
  }
  v24 = 0;
LABEL_20:
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_174987 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_174987, &__block_literal_global_174988);
  }
  v2 = (void *)logCategory__hmf_once_v1_174989;
  return v2;
}
...
void __48__HMDCloudPairedMetadataDiagnostics_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_174989;
  logCategory__hmf_once_v1_174989 = v0;
}
