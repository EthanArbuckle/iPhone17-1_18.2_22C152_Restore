    ...
    if (v7)
    {
      if (v11)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v22 = 2114;
        v23 = v13;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@HAP session TTR timer fired. Initiating radar for allowed accessory: %{public}@", buf, 0x16u);
      }
    ...
    else
    {
      if (v11)
      {
        ...
        *(_DWORD *)buf = 138543362;
        v21 = v19;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Accessory reference is nil when handling HAP session TTR timer", buf, 0xCu);
      }
    }
  }
}
...
LABEL_10:
        _os_log_impl(&dword_22F52A000, v10, v11, v9, (uint8_t *)&v29, 0x16u);
...
LABEL_17:
      _os_log_impl(&dword_22F52A000, v27, v28, v26, (uint8_t *)&v29, 0x16u);
    }
  }
  else
  {
...
- (void)_resetSessionMetric
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v15 = 2114;
    v16 = v9;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Resetting session metric - accessory: %{public}@", (uint8_t *)&v13, 0x16u);
  }
...
- (void)_submitMetric
{
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v42 = 2114;
    v43 = v24;
    _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Submitting SessionMetric for accessory: %@/%{public}@ - %{public}@", (uint8_t *)&v36, 0x2Au);
  }
  ...
  os_log_type_t v28 = (void *)MEMORY[0x230FBD990]();
  int v29 = v19;
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v40 = 2114;
    v41 = v33;
    _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_INFO, "%{public}@Skipped Submitting SessionMetric for %@/%{public}@", (uint8_t *)&v36, 0x20u);
  }
LABEL_14:
}
...
- (void)_updateSessionState:(BOOL)a3 linkLayerType:(int64_t)a4 sessionInfo:(id)a5 bookkeeping:(id)a6 withError:(id)a7
{
    ...
    if (v15)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v122 = 2112;
        id v123 = v23;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Session was already started on %@ for: %@", buf, 0x20u);
  ...
  if (v9)
  {
    if (v34)
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v124 = 2112;
      v125 = v41;
      _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_INFO, "%{public}@Session started on %{public}@ for accessory: %{public}@ discovered by %@", buf, 0x2Au);
  ...
  if (v34)
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v124 = 2112;
    v125 = v47;
    _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_INFO, "%{public}@Session ended on %{public}@ with error: %{public}@ for accessory: %@", buf, 0x2Au);
  }
  id v48 = v12;
      ...
      if (v79)
      {
        ...
        if (v81)
        {
          if (v85)
          {
            ...
            *(_DWORD *)buf = 138543362;
            v119 = v86;
            _os_log_impl(&dword_22F52A000, v84, OS_LOG_TYPE_INFO, "%{public}@Not starting timer to initiate radar for accessory because one is already running", buf, 0xCu);
          }
        }
        else
        {
          if (v85)
          {
            ...
            *(_DWORD *)buf = 138543362;
            v119 = v87;
            _os_log_impl(&dword_22F52A000, v84, OS_LOG_TYPE_INFO, "%{public}@Starting timer to initiate radar for accessory", buf, 0xCu);
          }
...
- (NSError)topError
{
  ...
  id v4 = [v3 keysSortedByValueUsingComparator:&__block_literal_global_220105];
...
- (id)attributeDescriptions
{
  ...
  v63[14] = v35;
  id v37 = [MEMORY[0x263EFF8C0] arrayWithObjects:v63 count:15];
...
- (HMDAccessorySessionMetric)initWithAccessory:(id)a3 workQueue:(id)a4 hapSessionTTRTimer:(id)a5 hapSessionTTRAllowList:(id)a6 radarInitiator:(id)a7
{
  ...
  if (v17)
  {
    ...
    uint64_t v24 = [objc_alloc(MEMORY[0x263F35800]) initWithNumIPs:0 numIPsTried:0 numBonjourNames:0];
...
- (HMDAccessorySessionMetric)initWithAccessory:(id)a3 workQueue:(id)a4
{
  ...
  id v14 = (void *)[objc_alloc(MEMORY[0x263F42658]) initWithTimeInterval:0 options:30.0];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t20_220190 != -1) {
    dispatch_once(&logCategory__hmf_once_t20_220190, &__block_literal_global_102_220191);
  }
  v2 = (void *)logCategory__hmf_once_v21_220192;
  return v2;
}
...
void __40__HMDAccessorySessionMetric_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v21_220192;
  logCategory__hmf_once_v21_220192 = v0;
}
