...
- (void)_checkIfThreadNetworkIsRunningWithCompletion:(id)a3
{
  ...
  v14 = __Block_byref_object_copy__193634;
  v15 = __Block_byref_object_dispose__193635;
  id v16 = (id)[objc_alloc(MEMORY[0x263F1BF88]) initWithKeychainAccessGroup:@"com.apple.thread.network"];
  v6 = (void *)v12[5];
  if (v6)
  {
  ...
  {
    v7 = [MEMORY[0x263F087E8] hmErrorWithCode:58];
...
- (void)_removePreferredNetworkWithCompletion:(id)a3
{
  ...
  v18 = __Block_byref_object_copy__193634;
  v19 = __Block_byref_object_dispose__193635;
  id v20 = (id)[objc_alloc(MEMORY[0x263F1BF88]) initWithKeychainAccessGroup:@"com.apple.thread.network"];
  id v6 = (void *)v16[5];
  if (v6)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v22 = v10;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@CoreThreadCommissionerService is not reachable - cannot clear preferred thread credentials", buf, 0xCu);
    }
...
- (void)_triggerPreferredNetworkUpdateWithCompletion:(id)a3
{
  ...
  uint32_t v12 = __Block_byref_object_copy__193634;
  uint64_t v13 = __Block_byref_object_dispose__193635;
  id v14 = (id)[objc_alloc(MEMORY[0x263F1BF88]) initWithKeychainAccessGroup:@"com.apple.thread.network"];
  id v4 = (void *)v10[5];
  if (v4)
  {
...
uint64_t __78__HMDThreadNetworkMetadataStore__triggerPreferredNetworkUpdateWithCompletion___block_invoke(uint64_t a1, int a2)
{
  ...
  {
    id v4 = [MEMORY[0x263F087E8] hmErrorWithCode:52];
...
void __86__HMDThreadNetworkMetadataStore__scheduleTriggerPreferredNetworkUpdateWithCompletion___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    id v5 = [MEMORY[0x263F087E8] hmErrorWithCode:15];
...
- (void)_retrievePreferredNetwork:(id)a3 completion:(id)a4
{
  ...
  if (isFeatureMatteriPhoneOnlyPairingControlForThreadEnabled())
  {
    ...
    *((void *)&buf + 1) = &buf;
    ...
    v33 = __Block_byref_object_copy__193634;
    v34 = __Block_byref_object_dispose__193635;
    id v35 = (id)[objc_alloc(MEMORY[0x263F1BF88]) initWithKeychainAccessGroup:@"com.apple.thread.network"];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)v29 = 138543362;
        v30 = v20;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@CoreThreadCommissionerService is not reachable.", v29, 0xCu);
      }
      v21 = [MEMORY[0x263F087E8] hmErrorWithCode:58];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(void *)((char *)&buf + 4) = v15;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@Control flow: Cannot retrieve or generate thread preferred network on this platform", (uint8_t *)&buf, 0xCu);
    }
  ...
  if (!v8 || v9)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543618;
      ...
      __int16 v40 = 2112;
      id v41 = v9;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Control flow: Failed to retrieve preferred thread network credentials record : %@", buf, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)long long buf = 138543874;
      ...
      __int16 v42 = 2112;
      id v43 = v8;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Control flow: retrievePreferredNetworkInternallyOnMdnsAndSig returned THCredential:%@, uuid %@", buf, 0x20u);
    }
    id v15 = objc_alloc(MEMORY[0x263F0E850]);
  ...
  if (!v8 || v9)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543618;
      ...
      __int16 v37 = 2112;
      id v38 = v9;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Control flow: retrievePreferredNetworkWithNoScan failed : %@", buf, 0x16u);
    }
    uint64_t v28 = *(void *)(a1 + 40);
    if (v28)
    {
  ...
  else
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)long long buf = 138543874;
      ...
      __int16 v39 = 2112;
      id v40 = v8;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Control flow: retrievePreferredNetworkWithNoScan returned THCredential:%@, uuid %@", buf, 0x20u);
    }
    id v15 = objc_alloc(MEMORY[0x263F0E850]);
    id v16 = [v7 networkName];
    uint64_t v17 = [v7 channel];
  ...
  if (!v5 || v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543874;
      ...
      __int16 v32 = 2112;
      id v33 = v5;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Unexpected, operational dataset validation failed. Error: %@, credentials: %@", buf, 0x20u);
    }
    (*(void (**)(void))(*(void *)(a1 + 56) + 16))();
  }
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)long long buf = 138543874;
      ...
      __int16 v32 = 2112;
      id v33 = v5;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Operational dataset validation passed, store cached AOD: %@, THCredential:%@", buf, 0x20u);
    }
    id v13 = objc_alloc(MEMORY[0x263F0E850]);
...
void __118__HMDThreadNetworkMetadataStore__validateOperationalDatasetWithTHClient_operationalDataset_storeCachedAOD_completion___block_invoke_24(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      uint32_t v11 = 22;
LABEL_6:
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, v9, (uint8_t *)&v13, v11);
    }
  }
  else if (v7)
  {
...
- (void)_retrieveBorderRouterPreferredNetworkWithCompletion:(id)a3
{
  ...
  id v16 = &v15;
  uint64_t v17 = 0x3032000000;
  id v18 = __Block_byref_object_copy__193634;
  id v19 = __Block_byref_object_dispose__193635;
  id v20 = (id)[objc_alloc(MEMORY[0x263F1BF88]) initWithKeychainAccessGroup:@"com.apple.thread.network"];
  id v6 = (void *)v16[5];
  if (v6)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      v22 = v10;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@CoreThreadCommissionerService is not reachable.", buf, 0xCu);
    }
    uint32_t v11 = [MEMORY[0x263F087E8] hmErrorWithCode:58];
...
void __85__HMDThreadNetworkMetadataStore__retrieveBorderRouterPreferredNetworkWithCompletion___block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (!v8 || v9)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543618;
      ...
      __int16 v27 = 2112;
      uint64_t v28 = v10;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to retrieve preferred thread network credentials record : %@", buf, 0x16u);
    }
    (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
    [*(id *)(*(void *)(*(void *)(a1 + 48) + 8) + 40) invalidate];
  }
  ...
  {
    id v24 = objc_alloc(MEMORY[0x263F0E850]);
    v22 = [v7 networkName];
...
- (void)_retrieveMetadataOnController:(id)a3 homeHasResident:(BOOL)a4 completion:(id)a5
{
  ...
  uint64_t v29 = __Block_byref_object_copy__193634;
  __int16 v30 = __Block_byref_object_dispose__193635;
  id v31 = (id)[objc_alloc(MEMORY[0x263F1BF88]) initWithKeychainAccessGroup:@"com.apple.thread.network"];
  if (v27[5])
  {
    if (isFeatureMatteriPhoneOnlyPairingControlForThreadEnabled()
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      id v33 = v18;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@CoreThreadCommissionerService is not reachable.", buf, 0xCu);
    }
    id v19 = [MEMORY[0x263F087E8] hmErrorWithCode:58];
  ...
  if (!v8 || v9)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543618;
      ...
      __int16 v27 = 2112;
      uint64_t v28 = v10;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Pairing flow: retrievePreferredCredentialsInternally failed : %@", buf, 0x16u);
    }
    (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
    [*(id *)(*(void *)(*(void *)(a1 + 48) + 8) + 40) invalidate];
  }
...
void __116__HMDThreadNetworkMetadataStore__retrieveMetadataOnThreadCapableController_threadClient_homeHasResident_completion___block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  if (!v8 || v9)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543618;
      ...
      __int16 v44 = 2112;
      v45 = v10;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Pairing flow: retrievePreferredNetworkWithNoScan failed : %@", buf, 0x16u);
    }
    ...
    if (v24)
    {
      if (v28)
      {
        ...
        *(_DWORD *)long long buf = 138543362;
        id v43 = v29;
        _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Pairing flow: Using cached AOD, validating operational dataset", buf, 0xCu);
      }
    ...
    else
    {
      if (v28)
      {
        ...
        *(_DWORD *)long long buf = 138543362;
        id v43 = v35;
        _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Pairing flow: No cached AOD, calling retrieveOrGeneratePreferredNetworkInternally", buf, 0xCu);
      }
  ...
  {
    id v11 = objc_alloc(MEMORY[0x263F0E850]);
  ...
  if (!v8 || v9)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543618;
      ...
      __int16 v29 = 2112;
      id v30 = v9;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Pairing flow: retrieveOrGeneratePreferredNetworkInternally failed : %@", buf, 0x16u);
    }
    (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
  }
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)long long buf = 138543874;
      ...
      __int16 v31 = 2112;
      id v32 = v8;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Pairing flow: retrieveOrGeneratePreferredNetworkInternally returned THCredential:%@, uuid %@", buf, 0x20u);
    }
    id v15 = objc_alloc(MEMORY[0x263F0E850]);
    id v16 = [v7 networkName];
    uint64_t v17 = [v7 channel];
...
+ (HMDThreadNetworkMetadataStore)_testOnlyStore
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      ...
      int v11 = 138543362;
      id v12 = v7;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Reusing existing store", (uint8_t *)&v11, 0xCu);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      int v11 = 138543362;
      id v12 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Creating new store", (uint8_t *)&v11, 0xCu);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_193699 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_193699, &__block_literal_global_193700);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v1_193701;
  return v2;
}
...
void __44__HMDThreadNetworkMetadataStore_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_193701;
  logCategory__hmf_once_v1_193701 = v0;
}
