...
- (id)connectionForEndpointUUID:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
  {
    ...
    int v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@Device does not support siri endpoint history deletion", (uint8_t *)&v10, 0xCu);
  }
...
- (void)deleteSiriHistoryWithEndpointUUID:(id)a3 completionHandler:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v31 = 2112;
    id v32 = v6;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Deleting siri history for endpoint with uuid: %@", buf, 0x16u);
  }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v33 = 2112;
        v34 = v12;
        _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to get a delete operation for endpoint uuid: %@ datasource: %@", buf, 0x20u);
      }
      v25 = [MEMORY[0x263F087E8] hmfErrorWithCode:15];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v33 = 2112;
      v34 = v12;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to get a connection for endpoint uuid: %@ datasource: %@", buf, 0x20u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_41398 != -1) {
    dispatch_once(&logCategory__hmf_once_t6_41398, &__block_literal_global_41399);
  }
  v2 = (void *)logCategory__hmf_once_v7_41400;
  return v2;
}
...
void __45__HMDAssistantSettingsConnection_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_41400;
  logCategory__hmf_once_v7_41400 = v0;
}
