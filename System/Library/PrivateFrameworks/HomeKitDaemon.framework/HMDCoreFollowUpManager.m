...
- (void)_stopAdvertising:(int64_t)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v41 = 2048;
    int64_t v42 = a3;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Stopping advertising for followup mode: %ld", buf, 0x16u);
  }
  if (a3 != 1)
  {
    if (a3 != 3)
...
LABEL_10:
        ...
        if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v40 = v34;
          _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_ERROR, "%{public}@Unexpectedly called stop advertising for tvos update mode on non-atv device", buf, 0xCu);
        }
        v25 = (void *)v31;
      }
      else
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v41 = 2048;
          int64_t v42 = a3;
          _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Unknown followup mode passed to stop advertising: %ld", buf, 0x16u);
        }
        v25 = (void *)v21;
      }
    ...
    uint64_t v35 = *MEMORY[0x263F0D4E0];
    v12 = (void *)MEMORY[0x263EFF8C0];
    v13 = (__CFString **)&v35;
    goto LABEL_10;
  }
  uint64_t v14 = *MEMORY[0x263F0C670];
  uint64_t v36 = *MEMORY[0x263F0C668];
  uint64_t v37 = v14;
  v12 = (void *)MEMORY[0x263EFF8C0];
  v13 = (__CFString **)&v36;
  uint64_t v15 = 2;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Unable to get followup controller from data source: %@", buf, 0x16u);
    }
  }
...
- (void)removeAllFollowUpItemsWithCompletion:(id)a3
{
  ...
  {
    v8 = [MEMORY[0x263F087E8] hmErrorWithCode:20];
...
- (void)_startAdvertising:(int64_t)a3
{
  ...
  switch(a3)
  {
    case 2:
      ...
      goto LABEL_7;
    case 3:
      [v7 setUniqueIdentifier:*MEMORY[0x263F0D4E0]];
...
LABEL_14:
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v38 = v22;
          _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Checking existing follow up setup items", buf, 0xCu);
        }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@Unable to get followup controller from datasource: %@", buf, 0x16u);
          }
        }
...
LABEL_13:
      ...
      goto LABEL_13;
    case 1:
      [v7 setUniqueIdentifier:*MEMORY[0x263F0C668]];
  ...
  if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v39 = 2048;
    int64_t v40 = a3;
    _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_ERROR, "%{public}@Unexpected setup mode to start advertising: %ld", buf, 0x16u);
  }
LABEL_22:
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7_73053 != -1) {
    dispatch_once(&logCategory__hmf_once_t7_73053, &__block_literal_global_73054);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v8_73055;
  return v2;
}
...
void __37__HMDCoreFollowUpManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v8_73055;
  logCategory__hmf_once_v8_73055 = v0;
}

+ (NSArray)allPossibleFollowUpItemIdentifiers
{
  v5[4] = *MEMORY[0x263EF8340];
  v5[0] = *MEMORY[0x263F0C670];
  v5[1] = @"com.apple.HomeKit.UpdateTvOS";
  uint64_t v2 = *MEMORY[0x263F0D4E0];
  v5[2] = *MEMORY[0x263F0C668];
  v5[3] = v2;
  id v3 = [MEMORY[0x263EFF8C0] arrayWithObjects:v5 count:4];
  return (NSArray *)v3;
}
