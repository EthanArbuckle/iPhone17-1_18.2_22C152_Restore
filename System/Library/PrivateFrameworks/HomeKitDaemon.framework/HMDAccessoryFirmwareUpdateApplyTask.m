...
- (BOOL)shouldRun
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v24 = 2112;
      v25 = v14;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Apply task shouldn't run - readyForApply:%@ needsApply:%@ (%@) policyCheck: %@", (uint8_t *)&v16, 0x34u);
    }
    BOOL v4 = 0;
  }
...
- (id)criteria
{
  ...
  if (v3 == 4)
  {
    ...
    xpc_dictionary_set_string(v4, (const char *)*MEMORY[0x263EF81D0], "com.apple.homed.firmwareUpdate.threadAccessory.apply.group");
    char v5 = (const char *)*MEMORY[0x263EF81C8];
  ...
  {
    xpc_object_t v4 = xpc_dictionary_create(0, 0, 0);
    xpc_dictionary_set_string(v4, (const char *)*MEMORY[0x263EF81D0], "com.apple.homed.firmwareUpdate.bleAccessory.apply.group");
    v8 = (const char *)*MEMORY[0x263EF81C8];
...
LABEL_6:
  ...
  xpc_object_t v4 = xpc_dictionary_create(0, 0, 0);
  xpc_dictionary_set_string(v4, (const char *)*MEMORY[0x263EF81D0], "com.apple.homed.firmwareUpdate.ipAccessory.apply.group");
  char v5 = (const char *)*MEMORY[0x263EF81C8];
