...
void __47__HMDUserNotificationCenter__showNotification___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v12 = 2112;
      uint64_t v13 = v7;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_ERROR, "%{public}@Error adding notification request. Error: %@. Request: %@.", (uint8_t *)&v8, 0x20u);
    }
  }
}
...
- (id)showNotificationWithTitle:(id)a3 body:(id)a4 threadIdentifier:(id)a5 categoryIdentifier:(id)a6 requestIdentifier:(id)a7 date:(id)a8 attachments:(id)a9 userInfo:(id)a10 shouldIgnoreDoNotDisturb:(BOOL)a11 interruptionLevel:(unint64_t)a12 logEventTopic:(int64_t)a13
{
  ...
  id v24 = a9;
  id v25 = a10;
  id v26 = objc_alloc_init(MEMORY[0x263F1DEF0]);
  v46 = v18;
  [v26 setTitle:v18];
  v45 = v19;
  [v26 setBody:v19];
  v27 = [MEMORY[0x263F1DF68] defaultSound];
  [v26 setSound:v27];
  ...
  if (_os_feature_enabled_impl())
  {
    ...
    if (a12 == 3)
    {
      v32 = [MEMORY[0x263F1DF68] defaultCriticalSound];
      [v26 setSound:v32];
    }
  }
  v33 = v22;
  v34 = [MEMORY[0x263F1DF48] requestWithIdentifier:v22 content:v26 trigger:0];
  ...
  if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v49 = 2112;
    v50 = v34;
    _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_INFO, "%{public}@Adding bulletin: %@", buf, 0x16u);
  }
...
- (void)updateContent:(id)a3 forNotificationWithRequestIdentifier:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v20 = 2112;
    id v21 = v6;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating notification with request identifier %@ with content: %@", buf, 0x20u);
  }
...
void __80__HMDUserNotificationCenter_updateContent_forNotificationWithRequestIdentifier___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v13 = 2112;
      id v14 = v3;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to update notification with request identifier %@: %@", (uint8_t *)&v9, 0x20u);
    }
  }
}
...
- (HMDUserNotificationCenter)initWithBundleIdentifier:(id)a3 logEventSubmitter:(id)a4
{
  ...
  if (v8)
  {
    uint64_t v9 = [objc_alloc(MEMORY[0x263F1DFB0]) initWithBundleIdentifier:v6];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_246850 != -1) {
    dispatch_once(&logCategory__hmf_once_t6_246850, &__block_literal_global_246851);
  }
  v2 = (void *)logCategory__hmf_once_v7_246852;
  return v2;
}
...
void __40__HMDUserNotificationCenter_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_246852;
  logCategory__hmf_once_v7_246852 = v0;
}
