...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_33276 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_33276, &__block_literal_global_33277);
  }
  v2 = (void *)logCategory__hmf_once_v1_33278;
  return v2;
}
...
void __41__HMDDelegatingMessageRouter_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_33278;
  logCategory__hmf_once_v1_33278 = v0;
}
