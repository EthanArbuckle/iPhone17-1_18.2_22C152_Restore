...
LABEL_11:
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v35 = v30;
      _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to create relay objects", buf, 0xCu);
    }
    id v22 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1017];
    goto LABEL_14;
  }
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    __int16 v42 = 1024;
    int v43 = [v15 socket];
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Creating audio relay between %@:%tu (%d,%d)", buf, 0x2Cu);
  }
  id v16 = objc_alloc_init(MEMORY[0x263F20FA0]);
  [v16 setIp:v8];
  [v16 setPort:(unsigned __int16)a5];
  v17 = [MEMORY[0x263F20FB8] connectionWithSocket:(unsigned __int16)a3 remoteAddress:v16];
  v18 = (void *)MEMORY[0x263F20FB8];
  ...
  id v33 = 0;
  v21 = (void *)[objc_alloc(MEMORY[0x263F20FB0]) initWithConnection:v17 connection:v20 error:&v33];
  id v22 = v33;
  ...
  if (v22)
  {
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v36 = 2112;
      id v37 = v22;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to create audio packet relay with error %@", buf, 0x16u);
    }
LABEL_14:
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v35 = v31;
    _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@Starting packet relay for audio", buf, 0xCu);
  }
...
LABEL_11:
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    __int16 v42 = 1024;
    int v43 = [v15 socket];
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Creating video relay between %@:%tu (%d,%d)", buf, 0x2Cu);
  }
  id v16 = objc_alloc_init(MEMORY[0x263F20FA0]);
  [v16 setIp:v8];
  [v16 setPort:(unsigned __int16)a5];
  ...
  if (v22)
  {
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v36 = 2114;
      id v37 = v22;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to create video packet relay with error %{public}@", buf, 0x16u);
    }
LABEL_14:
    [(HMDCameraIDSDeviceConnectionSender *)v24 _callSessionEndedWithError:v22];
    goto LABEL_15;
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v35 = v31;
    _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@Starting packet relay for video", buf, 0xCu);
  }
...
- (void)startPacketRelayWithVideoSocket:(int)a3 videoNetworkConfig:(id)a4 cameraVideoSSRC:(unsigned int)a5 audioSocket:(int)a6 audioNetworkConfig:(id)a7 cameraAudioSSRC:(unsigned int)a8
{
  ...
  uint64_t v15 = (void *)[objc_alloc(MEMORY[0x263F425C0]) initWithName:@"com.apple.homed.packet-connection-relay"];
...
- (void)startPacketRelayWithIDSDeviceSession:(id)a3 cameraVideoSSRC:(unsigned int)a4 cameraAudioSSRC:(unsigned int)a5
{
  ...
  v9 = (void *)[objc_alloc(MEMORY[0x263F425C0]) initWithName:@"com.apple.homed.packet-relay"];
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v51 = v13;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@IDS Session is present", buf, 0xCu);
  }
  id v14 = (void *)[objc_alloc(MEMORY[0x263F20FA8]) initWithIncomingSSRC:v6 acceptPacketType:0];
  uint64_t v15 = (void *)MEMORY[0x263F20FB8];
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v52 = 1024;
    LODWORD(v53) = v6;
    _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Creating video relay connection with SSRC %08x", buf, 0x12u);
  }
  id v22 = (void *)[objc_alloc(MEMORY[0x263F20FA8]) initWithIncomingSSRC:v5 acceptPacketType:0];
  v23 = (void *)MEMORY[0x263F20FB8];
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v52 = 1024;
    LODWORD(v53) = v5;
    _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_INFO, "%{public}@Creating audio relay connection with SSRC %08x", buf, 0x12u);
  }
  v30 = (void *)MEMORY[0x263F20FB8];
  v31 = v48;
  v32 = [v48 destination];
  ...
  if (!v17 || !v25 || !v33)
  {
    ...
    if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v51 = v45;
      _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_ERROR, "%{public}@Failed to create relay objects", buf, 0xCu);
    }
    id v37 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1017];
    goto LABEL_17;
  }
  id v34 = objc_alloc(MEMORY[0x263F20FB0]);
  v54[0] = v17;
  v54[1] = v25;
  v35 = [MEMORY[0x263EFF8C0] arrayWithObjects:v54 count:2];
  id v49 = 0;
  ...
  if (v37)
  {
    if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v52 = 2114;
      id v53 = v37;
      _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_ERROR, "%{public}@Failed to create video packet relay with error %{public}@", buf, 0x16u);
...
LABEL_17:
  ...
  if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v51 = v46;
    _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_INFO, "%{public}@Starting packet relay", buf, 0xCu);
  }
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    int v11 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting the IDS connection sender", buf, 0xCu);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t17_154271 != -1) {
    dispatch_once(&logCategory__hmf_once_t17_154271, &__block_literal_global_154272);
  }
  v2 = (void *)logCategory__hmf_once_v18_154273;
  return v2;
}
...
void __49__HMDCameraIDSDeviceConnectionSender_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v18_154273;
  logCategory__hmf_once_v18_154273 = v0;
}
