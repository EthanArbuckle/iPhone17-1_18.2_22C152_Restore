...
- (void)assertionDidBecomeInactive:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v16 = 2112;
    id v17 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Event router active assertion became inactive: %@", buf, 0x16u);
  }
...
- (id)takeEventRouterAssertion
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v16 = 2112;
    id v17 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Did take event router active assertion: %@", buf, 0x16u);
  }
  os_unfair_lock_lock_with_options();
  if (v5) {
...
- (void)configure
{
  ...
  if (self)
  {
    ...
    [v6 setObject:v7 forKeyedSubscript:*MEMORY[0x263F0C7A8]];

    uint64_t v8 = [NSNumber numberWithDouble:30.0];
    [v6 setObject:v8 forKeyedSubscript:*MEMORY[0x263F0D238]];

    BOOL v9 = [NSNumber numberWithDouble:300.0];
    [v6 setObject:v9 forKeyedSubscript:*MEMORY[0x263F0C748]];

    if (isInternalBuild())
    {
      id v10 = [NSNumber numberWithDouble:300.0];
      [v6 setObject:v10 forKeyedSubscript:*MEMORY[0x263F0C740]];
    }
    else
    {
      [v6 setObject:0 forKeyedSubscript:*MEMORY[0x263F0C740]];
    }
    if (isInternalBuild())
    {
      long long v11 = [NSNumber numberWithDouble:300.0];
      [v6 setObject:v11 forKeyedSubscript:*MEMORY[0x263F0C938]];
    }
    else
    {
      [v6 setObject:0 forKeyedSubscript:*MEMORY[0x263F0C938]];
    }
    if (isInternalBuild())
    {
      long long v12 = [NSNumber numberWithDouble:300.0];
      [v6 setObject:v12 forKeyedSubscript:*MEMORY[0x263F0C940]];
    }
    else
    {
      [v6 setObject:0 forKeyedSubscript:*MEMORY[0x263F0C940]];
    }
    if (isInternalBuild())
    {
      uint64_t v13 = [NSNumber numberWithDouble:300.0];
      [v6 setObject:v13 forKeyedSubscript:*MEMORY[0x263F0DB38]];
    }
    else
    {
      [v6 setObject:0 forKeyedSubscript:*MEMORY[0x263F0DB38]];
    }
    ...
    if ((*(unsigned char *)(v3 + 12) != 0) != v4)
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v21 = 2114;
        v22 = v9;
        _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Plugged in state changed to %{public}@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      id v16 = v27;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_FAULT, "%{public}@%@ notification object was not a HMDXPCClientConnection: %@ (%@)", buf, 0x2Au);
    }
  }
}
...
void __90__HMDRemoteEventRouterAssertionController_handleConnectionActiveStateUpdatedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 1024;
    int v18 = v5;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Received notification that connection active state is now %{BOOL}d", (uint8_t *)&v15, 0x12u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t8_211490 != -1) {
    dispatch_once(&logCategory__hmf_once_t8_211490, &__block_literal_global_211491);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v9_211492;
  return v2;
}
...
void __54__HMDRemoteEventRouterAssertionController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v9_211492;
  logCategory__hmf_once_v9_211492 = v0;
}
