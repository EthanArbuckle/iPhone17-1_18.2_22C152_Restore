...
void __64__HMDCameraRemoteStreamTracker_stopTrackingStreamWithSessionID___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      __int16 v15 = 2112;
      uint64_t v16 = v9;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@No longer tracking stream with session ID: %@", (uint8_t *)&v13, 0x16u);
    }
  ...
  else
  {
    if (v7)
    {
      ...
      __int16 v15 = 2112;
      uint64_t v16 = v12;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Cannot find stream to stop tracking: %@", (uint8_t *)&v13, 0x16u);
    }
  }
}
...
void __59__HMDCameraRemoteStreamTracker_startTrackingStreamSession___block_invoke(uint64_t a1)
{
  ...
  if (v3 >= v4)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Cannot start tracking stream session: %@. Already tracking maximum number of stream sessions: %@", (uint8_t *)&v23, 0x20u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Started tracking stream session: %@. Total count is now %lu", (uint8_t *)&v23, 0x20u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_148044 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_148044, &__block_literal_global_5_148045);
  }
  v2 = (void *)logCategory__hmf_once_v5_148046;
  return v2;
}
...
void __43__HMDCameraRemoteStreamTracker_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_148046;
  logCategory__hmf_once_v5_148046 = v0;
}

+ (HMDCameraRemoteStreamTracker)sharedTracker
{
  if (sharedTracker_onceToken_148051 != -1) {
    dispatch_once(&sharedTracker_onceToken_148051, &__block_literal_global_148052);
  }
