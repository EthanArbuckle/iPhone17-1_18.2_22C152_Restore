...
- (void)zoneManagerDidStop:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    v11 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@User Action zone manager stopped", (uint8_t *)&v10, 0xCu);
  }
...
- (void)zoneManagerDidStart:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v56 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@User Action zone manager started", buf, 0xCu);
  }
  id v10 = objc_alloc(MEMORY[0x263F424F0]);
  v11 = NSString;
  uint64_t v12 = MEMORY[0x230FBBCF0](v7, a2);
  ...
  id v54 = 0;
  v19 = [v18 fetchModelsOfType:objc_opt_class() error:&v54];
  id v46 = v54;
  ...
  long long v51 = 0u;
  id obj = v19;
  uint64_t v20 = [obj countByEnumeratingWithState:&v50 objects:v60 count:16];
  if (v20)
  {
    uint64_t v21 = v20;
    ...
    do
    {
      for (uint64_t i = 0; i != v21; ++i)
      {
        ...
        v28 = [v24 hmbModelID];
        v59 = v28;
        v29 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v59 count:1];
        v30 = [v27 setWithArray:v29];
        v31 = [MEMORY[0x263F49318] optionsWithLabel:@"Remove no longer used user action prediction"];
        id v32 = (id)[v25 removeModelIDs:v30 options:v31];

        v7 = v26;
      }
      uint64_t v21 = [obj countByEnumeratingWithState:&v50 objects:v60 count:16];
    }
    while (v21);
  }
  ...
  if (v46)
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v57 = 2112;
      id v58 = v46;
      _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_ERROR, "%{public}@User Action model fetch failed: %@", buf, 0x16u);
    }
  }
  ...
  if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v57 = 2112;
    id v58 = v41;
    _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_INFO, "%{public}@Startup User Action model fetch of %@ existing models is complete", buf, 0x16u);
  }
  v42 = (void *)MEMORY[0x230FBD990]([v47 invalidate]);
  v43 = v38;
  ...
  if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v56 = v45;
    _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_INFO, "%{public}@Removing user action prediction zone as its no longer needed in roar", buf, 0xCu);
  }
...
- (id)_removeZones
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v11 = 138543362;
    uint64_t v12 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Removing all user action prediction manager data", (uint8_t *)&v11, 0xCu);
  }
...
- (HMDUserActionPredictionManager)initWithHome:(id)a3
{
  ...
  {
    id v7 = v6;
    id v8 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:@"9A1A9B9D-BE90-4E26-A5EC-70FE027E74EA"];
    v9 = (void *)MEMORY[0x263F08C38];
