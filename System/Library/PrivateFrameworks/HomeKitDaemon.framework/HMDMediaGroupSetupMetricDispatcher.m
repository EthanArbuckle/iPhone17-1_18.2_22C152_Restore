...
- (void)timerDidFire:(id)a3
{
  ...
  if (v6)
  {
    v7 = [MEMORY[0x263F087E8] hmfErrorWithCode:13 reason:@"Timeout in getting commited group"];
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v26 = 2112;
      v27 = v7;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Timer fired, submitting log event with duration: %llu error: %@", (uint8_t *)&v22, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      int v22 = 138543362;
      v23 = v17;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Timer fired but no active metric type being tracked.", (uint8_t *)&v22, 0xCu);
    }
...
- (void)_submitLogEvent:(id)a3 error:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v16 = 2112;
    id v17 = v12;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Submitting log event: %@", (uint8_t *)&v14, 0x16u);
  }
  ...
  if (v9)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v26 = 2112;
      id v27 = v8;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Submitting log event: %llu error: %@", buf, 0x20u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v23 = v21;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to get data source for metric event submission", buf, 0xCu);
    }
      ...
      if ([(NSUUID *)activeGroupIdentifier hmf_isEqualToUUID:v8])
      {
        ...
        if (metricType == a4)
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
          {
            ...
            if (a4 > 4) {
              ...
              uint64_t v18 = off_264A1E198[a4 - 1];
            }
            int v44 = 138543874;
            uint64_t v45 = v15;
            __int16 v46 = 2112;
            ...
            __int16 v48 = 2112;
            v49 = v18;
            _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Request committed for group identifier %@ metric type: %@", (uint8_t *)&v44, 0x20u);
          }
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          if (v34 > 3) {
            ...
            v35 = off_264A1E198[v34];
          }
          if (a4 > 4) {
            v43 = @"Unknown Metric Type";
          }
          else {
            v43 = off_264A1E198[a4 - 1];
          }
          int v44 = 138543874;
          uint64_t v45 = v32;
          __int16 v46 = 2112;
          ...
          __int16 v48 = 2112;
          v49 = v43;
          _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Dispatcher is tracking metric type %@ but ask to mark metric type %@", (uint8_t *)&v44, 0x20u);
        }
      }
      else
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v48 = 2112;
          v49 = v31;
          _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Tracking different group identifier: %@ active group identifier: %@", (uint8_t *)&v44, 0x20u);
        }
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        if (v27 > 3) {
          ...
          uint64_t v28 = off_264A1E198[v27];
        }
        int v44 = 138543618;
        uint64_t v45 = v25;
        __int16 v46 = 2112;
        id v47 = v28;
        _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@No active setup tracking for metric type: %@", (uint8_t *)&v44, 0x16u);
      }
    }
...
LABEL_38:
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
  {
    ...
    _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Dispatcher cannot track unknown metric type for committed request", (uint8_t *)&v44, 0xCu);
  }
LABEL_39:
}
...
- (void)markRequestReceivedForGroupIdentifier:(id)a3 metricType:(unint64_t)a4 setupSessionIdentifier:(id)a5 setupSessionStartTimeMS:(unint64_t)a6
{
  ...
  if (a4)
  {
    ...
    {
      BOOL v13 = (void *)MEMORY[0x230FBD990](v12);
      int v14 = self;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v51 = 2112;
        v52 = v20;
        _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Already has active setup tracking for metric identifier: %@ group type: %@", buf, 0x20u);
      }
    }
    else
    {
      ...
      if (!metricType)
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544386;
          ...
          _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_INFO, "%{public}@Request received for group identifier %@ metric type: %@ session identifier: %@ setup start time: %llu", buf, 0x34u);
        }
        ...
        if (submissionTimer)
        {
          ...
          if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            uint64_t v48 = v38;
            v43 = (void *)v38;
            _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_INFO, "%{public}@Resetting the submission timer", buf, 0xCu);
          }
        }
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        if (v29 > 3) {
          ...
          v30 = off_264A1E198[v29];
        }
        *(_DWORD *)buf = 138543618;
        uint64_t v48 = v27;
        __int16 v49 = 2112;
        id v50 = v30;
        _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Dispatcher already tracking metric type: %@", buf, 0x16u);
      }
    }
...
LABEL_21:
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    ...
    _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Dispatcher cannot track unknown metric type for request", buf, 0xCu);
  }
LABEL_22:
}
...
- (void)_resetActiveTracking
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Reset active tracking for group identifier: %@", (uint8_t *)&v11, 0x16u);
  }
...
- (HMDMediaGroupSetupMetricDispatcher)initWithDataSource:(id)a3 logEventSubmitter:(id)a4
{
  return [(HMDMediaGroupSetupMetricDispatcher *)self initWithDataSource:a3 logEventSubmitter:a4 currentUpTicksFactory:&__block_literal_global_93898 submissionTimerFactory:&__block_literal_global_25];
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t19_93907 != -1) {
    dispatch_once(&logCategory__hmf_once_t19_93907, &__block_literal_global_36_93908);
  }
  v2 = (void *)logCategory__hmf_once_v20_93909;
  return v2;
}
...
void __49__HMDMediaGroupSetupMetricDispatcher_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v20_93909;
  logCategory__hmf_once_v20_93909 = v0;
}
