  ...
  if (v6 == v4)
  {
    ...
    if (self->_internalState == 4)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v21 = 2112;
        v22 = v13;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Resuming a backed-off state: %@ for %@", (uint8_t *)&v17, 0x20u);
      }
  ...
  else
  {
    ...
    if (v7 == v4)
    {
      ...
      if (v8)
      {
        ...
        if (v9)
        {
          v10 = [MEMORY[0x263F087E8] hapErrorWithCode:24];
  ...
  if (a3 == 2)
  {
    ...
    if (v12)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v20 = 2112;
        __int16 v21 = v14;
        _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Stopping wait for wake timer for %@", (uint8_t *)&v18, 0x16u);
      }
  ...
  else if (a3 == 1)
  {
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v20 = 2112;
        __int16 v21 = v8;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Stopping backoff timer for %@", (uint8_t *)&v18, 0x16u);
      }
...
- (void)_startTimerForType:(unint64_t)a3
{
  ...
  {
    [v9 doubleValue];
    uint64_t v11 = (void *)[objc_alloc(MEMORY[0x263F42658]) initWithTimeInterval:1 options:v10];
    ...
    if (a3 == 2)
    {
      v13 = (void *)MEMORY[0x230FBD990]([(HMDLowPowerModeProfile *)self setWaitForWakeTimer:v11]);
      int v18 = self;
      v15 = HMFGetOSLogHandle();
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
    ...
    {
      v13 = (void *)MEMORY[0x230FBD990]([(HMDLowPowerModeProfile *)self setBackoffTimer:v11]);
      v14 = self;
      v15 = HMFGetOSLogHandle();
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
...
LABEL_11:
        _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, v17, (uint8_t *)&v19, 0x16u);
      }
    }
...
- (id)newHAPSuspendedAccessoryFromAccessoryConnectivityInfoWithType:(unint64_t)a3
{
  ...
  if (v7)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v8; ++i)
      {
        ...
        {
          id v12 = objc_alloc(MEMORY[0x263F358B0]);
  ...
  if ([v26 count])
  {
    id v17 = objc_alloc(MEMORY[0x263F35AC8]);
...
- (void)handleAccessoryConfigurationChanged:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v23 = 2112;
    v24 = v6;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling notification: %@ received by %@", buf, 0x20u);
  }
  double v10 = [v4 name];
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v24 = 2112;
      uint64_t v25 = v15;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Reading from characteristic: %@/%@ failed with error: %@", buf, 0x2Au);
  ...
  if ([v3 count])
  {
    ...
    if (v5)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v22 = 2112;
        __int16 v23 = v5;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Writing to the characteristic: %@/%@ failed with error: %@", (uint8_t *)&v16, 0x2Au);
      }
    }
    else
    {
...
- (void)_processSelectedSleepConfigurationParametersWithCharacteristic:(id)a3
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v28 = 2112;
      long long v29 = v15;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Processing selected sleep configuration with status: '%@' for %@", (uint8_t *)&v24, 0x20u);
    }
    if (v13 <= 2)
    {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v26 = 2112;
      id v27 = v8;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse selected sleep configuration with data: %@", (uint8_t *)&v24, 0x16u);
    }
  }
}
...
- (void)_processSupportedSleepConfigurationParametersWithCharacteristic:(id)a3
{
  ...
  if ([(HMDLowPowerModeProfile *)self _shouldManageAccessoryLPM])
  {
    ...
    if (v10)
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v23 = 2112;
        int v24 = v12;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Processing supported sleep configuration for %@.", (uint8_t *)&v21, 0x16u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v23 = 2112;
        int v24 = v8;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse supported sleep configuration with data: %@", (uint8_t *)&v21, 0x16u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v23 = 2112;
      int v24 = v17;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Skipping processing characteristic update since a resident is present for %@", (uint8_t *)&v21, 0x16u);
    }
  }
}
...
- (void)_queryAccessoryWithOperation:(int64_t)a3 completion:(id)a4
{
  ...
  if ((unint64_t)(a3 - 1) >= 3)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v47 = 2112;
      v48 = v21;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Received invalid operation type: '%@' for %@", buf, 0x20u);
    }
  ...
  if (v8)
  {
    ...
    id v12 = v9;
    if ([(HMDSelectedSleepConfigurationTLV *)v12 conformsToProtocol:&unk_26E4B1878])
    {
      id v42 = 0;
      ...
      if (v14 || !v13)
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v47 = 2112;
          v48 = v14;
          _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize object: %@ with error: %@", buf, 0x20u);
    ...
    if (v19)
    {
      if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v47 = 2112;
        v48 = v32;
        _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_DEBUG, "%{public}@Requesting response to operation type: '%@' from accessory: %@", buf, 0x20u);
    ...
    else
    {
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v47 = 2112;
        v48 = v38;
        _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize selected sleep configuration value for charactersitic %@/%@", buf, 0x20u);

        uint64_t v11 = v37;
      }

      v34 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
      v6[2](v6, v34, 0);
    }
        ...
        if (v13)
        {
          if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v45 = v22;
            __int16 v46 = 2112;
            __int16 v47 = &unk_26E4715D8;
            _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Accessory's supported LPM version: %@ is greater than the current version: %@.", buf, 0x20u);
          }
          uint64_t v23 = *(void *)(a1 + 32);
          int v24 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
        ...
        else
        {
          if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v46 = 2112;
            __int16 v47 = v37;
            _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Attempting to update WoWLANInfo: '%@' -> '%@'", buf, 0x20u);
          }
          v38[0] = MEMORY[0x263EF8330];
          v38[1] = 3221225472;
          v38[2] = __60__HMDLowPowerModeProfile__configureAccessoryWithCompletion___block_invoke_70;
          v38[3] = &unk_264A1DB60;
      ...
      else
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v44 = 2112;
          __int16 v45 = v10;
          _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to create WoWLANInfo from supported sleep config: %@", buf, 0x16u);
        }
        uint64_t v31 = *(void *)(a1 + 32);
        uint64_t v32 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
...
void __60__HMDLowPowerModeProfile__configureAccessoryWithCompletion___block_invoke_70(uint64_t a1, void *a2, void *a3)
{
  id v11 = a2;
  id v5 = a3;
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&v25[22] = 2112;
      ...
      __int16 v27 = 2112;
      id v28 = v5;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Did unconfigure %@ with status: '%@' and error: %@", v25, 0x2Au);
    }
    id v12 = [v8 delegate];
    if (a3)
    {
...
LABEL_14:
          ...
          *(_WORD *)&v25[22] = 2112;
          __int16 v26 = v17;
          _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_DEBUG, "%{public}@Need to backoff and retry unconfiguring of %@. Retry count: %@", v25, 0x20u);
        }
LABEL_15:
...
LABEL_20:
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&v25[22] = 2112;
        ...
        __int16 v27 = 2112;
        id v28 = v5;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Received invalid status: %@ to operation: %@ with error: %@", v25, 0x2Au);
      }
    }
    else
    {
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v36 = 2112;
      id v37 = v7;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Did configure %@ with status: '%@' and error: %@", buf, 0x2Au);
    }
      ...
      if (a4 != 1)
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v36 = 2112;
          id v37 = v7;
          _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Received invalid status: %@ to operation: %@ with error: %@", buf, 0x2Au);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v34 = 2112;
        v35 = v21;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Need to backoff and retry configuring of %@. Retry count: %@", buf, 0x20u);
...
void __66__HMDLowPowerModeProfile__stateMachine_readAccessoryConfiguration__block_invoke(uint64_t a1, void *a2, unint64_t a3)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v44 = 2112;
      id v45 = v5;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Did read configuration of %@ with status: '%@' and error: %@", (uint8_t *)&v38, 0x2Au);
    }
    if (a3 == 3)
    {
      uint64_t v19 = (void *)MEMORY[0x230FBD990]();
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v42 = 2112;
        v43 = v23;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_DEBUG, "%{public}@Need to backoff and retry reading configuration for %@. Retry count: %@", (uint8_t *)&v38, 0x20u);
      }
      uint64_t v18 = 4;
    }
    else if (a3 == 1)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v34, OS_LOG_TYPE_DEBUG))
        {
          ...
          __int16 v42 = 2112;
          v43 = 0;
          _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_DEBUG, "%{public}@Need to reconfigure the accessory: %@. Accessory has stale WoWLANInfo: %@.", (uint8_t *)&v38, 0x20u);
        }
        uint64_t v18 = 2;
      }
    }
    else if (a3)
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v44 = 2112;
        id v45 = v5;
        _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Received invalid status: '%@' to operation: '%@' with error: %@", (uint8_t *)&v38, 0x2Au);
      }
      uint64_t v18 = 0;
    }
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v40 = 2112;
        id v41 = v17;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Need to configure the accessory: %@. Accessory is unconfigured.", (uint8_t *)&v38, 0x16u);
      }
      uint64_t v18 = 2;
    }
    [v8 enterState:v18];
...
- (void)_enterState:(unint64_t)a3
{
  ...
  if ([(HMDLowPowerModeProfile *)self _canEnterNewState:a3])
  {
    ...
    if (retryCount > [v9 unsignedIntegerValue])
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v29 = 2112;
        uint64_t v30 = v12;
        _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Resetting state machine. Tried '%@' times for operation: '%@' for %@", (uint8_t *)&v23, 0x2Au);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v27 = 2112;
      id v28 = v22;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Invalid machine state: %@ -> %@", (uint8_t *)&v23, 0x20u);
    }
  }
}
...
- (void)_runStateMachine
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v26 = 2112;
    __int16 v27 = v5;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEBUG, "%{public}@LPM running state: '%@' -> '%@' for %@", (uint8_t *)&v20, 0x2Au);
  }
  if (v5->_internalState)
  {
    ...
    if ((v10 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v22 = 2112;
        int v23 = v12;
        _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Skipping processing state machine update since a resident is present for %@", (uint8_t *)&v20, 0x16u);
      }
    ...
    switch(v5->_internalState)
    {
      ...
      default:
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v24 = 2112;
          __int16 v25 = v16;
          _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Invalid LPM state: %@ for %@", (uint8_t *)&v20, 0x20u);
        }
        break;
    }
  }
...
- (void)_wakeSuspendedAccessory:(id)a3 activity:(id)a4 completion:(id)a5
{
  ...
  v16[1] = 3221225472;
  v16[2] = __70__HMDLowPowerModeProfile__wakeSuspendedAccessory_activity_completion___block_invoke_59;
  v16[3] = &unk_264A2C348;
...
void __70__HMDLowPowerModeProfile__wakeSuspendedAccessory_activity_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    if (v6)
    {
      ...
      BOOL v7 = (void *)MEMORY[0x230FBD990]([v5 _stopBackoffTimerForType:2]);
      id v8 = v5;
      id v9 = HMFGetOSLogHandle();
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v16 = 2112;
        uint64_t v17 = v11;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Pending wake block was called with error: %@ for %@", (uint8_t *)&v12, 0x20u);
      }
...
void __70__HMDLowPowerModeProfile__wakeSuspendedAccessory_activity_completion___block_invoke_59(uint64_t a1, void *a2)
{
  id v5 = a2;
  id WeakRetained = objc_loadWeakRetained((id *)(a1 + 40));
  id v4 = WeakRetained;
...
- (void)wakeAccessoryWithType:(unint64_t)a3 completion:(id)a4
{
  ...
  int v12 = [v10 stringWithFormat:@"%@, %s:%ld", v11, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables/Sources/homed/PowerManagement/WakeOnLAN/HMDLowPowerModeProfile.m", 177];
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v86 = 2112;
      v87 = v19;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Wake operation is in progress for %@ with suspended accessory: %@", buf, 0x20u);
    }
...
LABEL_9:
  ...
  if (a3 >= 2)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v86 = 2112;
      v87 = v23;
      _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Invalid wake type is used '%@' for accessory %@", buf, 0x20u);
    }
    id v20 = (void *)MEMORY[0x263F087E8];
    uint64_t v21 = 3;
    goto LABEL_9;
  ...
  if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544642;
    ...
    __int16 v92 = 2112;
    v93 = v38;
    _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_INFO, "%{public}@Waking suspended accessory: %@, wakeType: %@, version: %@, wakePacketType: %@, numBSP: %@", buf, 0x3Eu);
  ...
  if ([v49 wakeNumber])
  {
    ...
    v53 = v74;
    v54 = (void *)MEMORY[0x230FBD990]([v49 setSuspendedAccessory:v74]);
    v55 = v33;
    ...
    if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544642;
      ...
      __int16 v92 = 2112;
      v93 = v60;
      _os_log_impl(&dword_22F52A000, v56, OS_LOG_TYPE_INFO, "%{public}@Found accessory server for %@. Returning the HAPAccessory: %@. Wake will be via suspended accessory: %@, wakeType: %@, numBSP: %@", buf, 0x3Eu);
...
- (void)registerForMessages
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v18 = 2112;
    uint64_t v19 = v7;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Registering for messages with home: %@ for %@", buf, 0x20u);
  }
  ...
  int8x16_t v11 = [MEMORY[0x263F08A00] defaultCenter];
...
- (HMDLowPowerModeProfile)initWithAccessory:(id)a3 powerManagementservice:(id)a4 workQueue:(id)a5
{
  ...
  if (HMDLowPowerModeUUIDFromAccessory_onceToken != -1) {
    dispatch_once(&HMDLowPowerModeUUIDFromAccessory_onceToken, &__block_literal_global_251);
  }
  int8x16_t v11 = [MEMORY[0x263EFF990] dataWithLength:16];
  id v12 = [v8 uuid];
  id v13 = v11;
  objc_msgSend(v12, "getUUIDBytes:", objc_msgSend(v13, "mutableBytes"));

  id v14 = objc_msgSend(MEMORY[0x263F08C38], "hmf_UUIDWithNamespace:data:", HMDLowPowerModeUUIDFromAccessory_namespace, v13);
  ...
  if (v16)
  {
    ...
    __int16 v18 = [MEMORY[0x263F08C38] UUID];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t46 != -1) {
    dispatch_once(&logCategory__hmf_once_t46, &__block_literal_global_87_89398);
  }
...
void __37__HMDLowPowerModeProfile_logCategory__block_invoke()
{
  ...
  id v1 = (void *)logCategory__hmf_once_v47;
