...
void __83__HMDHAPAccessoryRemoteOperationWithLocalFallbackTask__remoteTaskCompletionHandler__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    v44[1] = 3221225472;
    v44[2] = __83__HMDHAPAccessoryRemoteOperationWithLocalFallbackTask__remoteTaskCompletionHandler__block_invoke_368;
    v44[3] = &unk_264A2E980;
    id v18 = v16;
    id v45 = v18;
    v46 = v6;
    ...
    if ([v19 count])
    {
      ...
      v42[1] = 3221225472;
      v42[2] = __83__HMDHAPAccessoryRemoteOperationWithLocalFallbackTask__remoteTaskCompletionHandler__block_invoke_370;
      v42[3] = &unk_264A2E720;
      id v43 = v20;
    ...
    if ([v18 count] && (objc_msgSend(v6, "supportsMultiPartResponse") & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v56 = 2112;
        id v57 = v3;
        _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@[%@] Missing remote responses. Falling back to locally processing requests: %@ -> %@", buf, 0x2Au);
      }
    ...
    if ([v22 count])
    {
      ...
      v40[1] = 3221225472;
      v40[2] = __83__HMDHAPAccessoryRemoteOperationWithLocalFallbackTask__remoteTaskCompletionHandler__block_invoke_371;
      v40[3] = &unk_264A2E9A8;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v51 = v36;
      _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_DEFAULT, "%{public}@Lost self reference for HMDHAPAccessoryRemoteOperationWithLocalFallbackTask remote task completion handler", buf, 0xCu);
    }
  }
}

id __83__HMDHAPAccessoryRemoteOperationWithLocalFallbackTask__remoteTaskCompletionHandler__block_invoke_368(uint64_t a1, void *a2)
{
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v40 = 2112;
      id v41 = v3;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] Lost reference to accessory for response: %@", buf, 0x20u);
    }
  ...
  if (v25)
  {
    if (v29)
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v40 = 2112;
      id v41 = v3;
      _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_INFO, "%{public}@[%@] Skip falling back to locally processing accessory for response: %@", buf, 0x20u);
    }
    v22 = 0;
  }
  else
  {
    if (v29)
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v42 = 2112;
      id v43 = v3;
      _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_INFO, "%{public}@[%@] Falling back to locally processing request: %@ -> %@", buf, 0x2Au);
    }
    if (v13) {
...
void __83__HMDHAPAccessoryRemoteOperationWithLocalFallbackTask__remoteTaskCompletionHandler__block_invoke_370(uint64_t a1, void *a2)
{
  id v3 = [a2 request];
  v4 = [v3 accessory];
  id v5 = [v4 uuid];
...
void __83__HMDHAPAccessoryRemoteOperationWithLocalFallbackTask__remoteTaskCompletionHandler__block_invoke_371(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v10 = 138543362;
      v11 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Lost self reference for fallback local task completion", (uint8_t *)&v10, 0xCu);
    }
  }
}
...
void __65__HMDHAPAccessoryRemoteOperationWithLocalFallbackTask_completion__block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v11 = 138543362;
      uint64_t v12 = v10;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Lost self reference for HMDHAPAccessoryRemoteOperationWithLocalFallbackTask completion", (uint8_t *)&v11, 0xCu);
    }
  }
}
...
- (BOOL)_shouldFallbackLocallyWithError:(id)a3 accessory:(id)a4
{
  ...
  id v8 = [(HMDHAPAccessoryTask *)self context];
  id v9 = [v8 user];
  int v10 = [v9 isLocalAccessoryCommunicationAllowed];
  ...
  else
  {
    ...
    {
      id v18 = [v6 domain];
      char v19 = [v18 isEqual:*MEMORY[0x263F10BB0]];

      char v12 = v19 ^ 1;
      goto LABEL_39;
    }
    unint64_t v17 = [v6 code];
    if (v17 > 0x20)
    {
LABEL_35:
      if ([v7 canWakeViaCustomWoBLE])
      {
        v24 = [v6 underlyingErrors];
        v25 = [v24 firstObject];

        if ([v25 isHMError]) {
          char v12 = [v25 code] != 2400;
        }
        else {
          char v12 = 1;
        }
...
LABEL_38:
    ...
    uint64_t v11 = qword_2303E47F0[v17];
  }
  char v12 = 1;
  switch(v11)
  {
    ...
    case 4:
      if (isFeatureMatteriPhoneOnlyPairingControlEnabled())
      {
        ...
        if ([v7 supportsCHIP])
        {
          ...
          int v16 = [v15 supportsThreadBorderRouter] ^ 1;
        }
        else
        {
          LOBYTE(v16) = 0;
        }
        v22 = [v7 supportedLinkLayerTypes];
        char v23 = [v22 unsignedIntegerValue];

        if (![v7 hasBTLELink]
          || ([v7 isReachable] & 1) == 0 && !objc_msgSend(v7, "isBLELinkConnected"))
        {
          if ((v23 & 2) != 0) {
            char v21 = 0;
          }
      ...
      if (![v7 hasBTLELink]
        || ([v7 isReachable] & 1) == 0 && (objc_msgSend(v7, "isBLELinkConnected") & 1) == 0)
      {
        goto LABEL_35;
      }
      goto LABEL_39;
    ...
    default:
      if (v11 == 54)
      {
        id v20 = [v6 underlyingErrors];
        uint64_t v13 = [v20 firstObject];

        if ([v13 isHMError] && objc_msgSend(v13, "code") == 3203)
        {
LABEL_29:
...
LABEL_34:
        ...
        char v21 = [v7 canWakeViaCustomWoBLE];
LABEL_33:
...
void __105__HMDHAPAccessoryRemoteOperationWithLocalFallbackTask__startScanningForSuspendedAccessoriesWithRequests___block_invoke(uint64_t a1, void *a2)
{
  ...
  if ([v3 canWakeViaCustomWoBLE])
  {
    ...
    [v7 addObject:v9];
    id v8 = [*(id *)(a1 + 32) objectForKey:v3];
...
void __105__HMDHAPAccessoryRemoteOperationWithLocalFallbackTask__startScanningForSuspendedAccessoriesWithRequests___block_invoke_4(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v32 = 2112;
    uint64_t v33 = v10;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] Scanning locally for suspended accessory (%@/%@/%@) completed with error: %@.", (uint8_t *)&v22, 0x3Eu);
  }
  if (!*(void *)(a1 + 64) && [*(id *)(a1 + 56) count])
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v32 = 2048;
      uint64_t v33 = v20;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] Adding responses for suspended accessory %@/%@/%@ with %ld requests", (uint8_t *)&v22, 0x3Eu);
    }
    [*(id *)(a1 + 32) addCharacteristicResponses:*(void *)(a1 + 56) isRemote:0];
    if ([*(id *)(a1 + 32) supportsMultiPartResponse])
    {
      char v21 = [*(id *)(a1 + 32) completion];
...
- (void)execute
{
  ...
  if ([v6 count])
  {
    ...
    unint64_t v17 = [(HMDHAPAccessoryRemoteOperationWithLocalFallbackTask *)self _makeRemoteTaskWithRequests:v14 delegateDevice:v15 completion:v16];
