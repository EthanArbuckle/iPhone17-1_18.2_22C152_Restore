  ...
  if (!a3)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v15 = 2112;
      id v16 = v6;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: %@", buf, 0x16u);
    }
...
- (id)createMessageHandlerWithQueue:(id)a3 delegate:(id)a4
{
  id v5 = a4;
  id v6 = a3;
  v7 = [[HMDAccessorySettingsMessageHandlerRoar alloc] initWithQueue:v6 delegate:v5];
...
- (id)timerWithReason:(int64_t)a3 interval:(double)a4
{
  v4 = (void *)[objc_alloc(MEMORY[0x263F42658]) initWithTimeInterval:16 options:a4];
  return v4;
}
