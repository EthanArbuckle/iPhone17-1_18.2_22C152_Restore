...
- (void)didReceiveEvent:(id)a3 topic:(id)a4
{
  ...
  id v6 = a3;
  id v7 = a4;
  v8 = [MEMORY[0x263F0E300] decodeTopic:v7];
  v9 = [v8 asAccessoryTopic];

  if (v9 && (uint64_t v10 = [v9 accessoryEventTopicSuffixID], v10 == *MEMORY[0x263F0B330]))
  {
    id v11 = v6;
    if (self)
    {
      id v12 = objc_alloc(MEMORY[0x263F0DFF8]);
      v13 = [v11 encodedData];
      ...
      if (v14)
      {
              ...
              (v17 & 1) == 0))
        {
          ...
          if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&buf[22] = 2112;
            v41 = v15;
            _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_INFO, "%{public}@Updating received wifi info from: %@ to: %@", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&buf[22] = 2112;
            v41 = v22;
            _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Received wifi info: %@ saved wifi info: %@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
        {
          ...
          *(void *)&buf[4] = v30;
          _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@Error decoding the event to wifi info object", buf, 0xCu);
        }
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(void *)&buf[14] = v7;
      _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@Do not handle topic: %@", buf, 0x16u);
    }
  }
}
...
- (void)subscribeToWiFiInfoUpdate
{
  ...
  if (v4)
  {
    ...
    v11[4] = self;
    id v12 = v4;
    [v5 changeRegistrationsForConsumer:self topicFilterAdditions:v6 topicFilterRemovals:MEMORY[0x263EFFA68] completion:v11];
  }
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v14 = v10;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@wifi info topic is nil", buf, 0xCu);
    }
  }
}
      ...
      for (uint64_t i = 0; i != v21; ++i)
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v41 = 2112;
          id v42 = v24;
          _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_INFO, "%{public}@Received cached event: %@ topic: %@ during subscription", buf, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t8_80419 != -1) {
    dispatch_once(&logCategory__hmf_once_t8_80419, &__block_literal_global_80420);
  }
  v2 = (void *)logCategory__hmf_once_v9_80421;
  return v2;
}
...
void __51__HMDAppleMediaAccessoryInfoSubscriber_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v9_80421;
  logCategory__hmf_once_v9_80421 = v0;
}
