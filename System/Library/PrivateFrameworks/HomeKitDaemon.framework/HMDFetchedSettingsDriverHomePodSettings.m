...
void __83__HMDFetchedSettingsDriverHomePodSettings_serviceDidInitializeForCurrentAccessory___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@homepod settings did initialize", (uint8_t *)&v7, 0xCu);
  }
...
void __55__HMDFetchedSettingsDriverHomePodSettings_didReconnect__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@homepod settings did reconnect", (uint8_t *)&v7, 0xCu);
  }
  v6 = [*(id *)(a1 + 32) delegate];
  [v6 driverDidReload:*(void *)(a1 + 32)];
}
...
void __71__HMDFetchedSettingsDriverHomePodSettings_didUpdateSetting_forKeyPath___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v27 = 2112;
      v28 = v6;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Got primaryUserInfo update for keyPath: %{public}@, %@", (uint8_t *)&v23, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v25 = 2114;
      uint64_t v26 = v16;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Got Setting Update for keyPath: %{public}@", (uint8_t *)&v23, 0x16u);
    }
    if (v6)
    {
      v29[0] = v6;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v25 = 2112;
        uint64_t v26 = v22;
        _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Unable to transform %@ to immutable setting", (uint8_t *)&v23, 0x16u);
      }
      id v6 = 0;
    }
  }
...
- (void)_writeSetting:(id)a3 keyPath:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v26 = 2112;
    id v27 = v8;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Updating %{public}@ to %@", buf, 0x20u);
  }
...
void __76__HMDFetchedSettingsDriverHomePodSettings__writeSetting_keyPath_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v16 = 2112;
    id v17 = v6;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Update %{public}@ completion error: %@", (uint8_t *)&v12, 0x20u);
  }
...
- (void)_processReadResults:(id)a3 error:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v49 = 2112;
    id v50 = v9;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Fetched settings: %@, error: %@", buf, 0x20u);
  }
          ...
          else
          {
            ...
            if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v47 = 2112;
              id v48 = v24;
              _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Returned value %@ not of expected type.", buf, 0x16u);
            ...
            {
              id v33 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
            }
            id v20 = v33;
...
- (void)_readSettingsAtKeyPaths:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v21 = 2112;
    uint64_t v22 = v12;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Fetch setting keyPaths: %{public}@ on service: %@", buf, 0x20u);
  }
...
- (id)_transformPreferredMediaUserEvent:(id)a3
{
  ...
  id v6 = (void *)[objc_alloc(MEMORY[0x263F0DFC0]) initWithUUIDString:v5 selectionType:v5 != 0];
  id v7 = (void *)MEMORY[0x230FBD990]();
  id v8 = self;
  id v9 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v6;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Transform hpSetting to primaryUserInfo: %@", (uint8_t *)&v12, 0x16u);
  }
...
- (id)_transformToImmutableSetting:(id)a3
{
  ...
  if (+[HMDHPSAPIConformanceProviding objectRespondsToHPSBooleanSettingProtocolMethods:v4])
  {
    ...
    {
      id v6 = v5;
      id v7 = objc_alloc(MEMORY[0x263F0E130]);
      id v8 = [v6 keyPath];
...
LABEL_9:
  ...
  if (+[HMDHPSAPIConformanceProviding objectRespondsToHPSConstrainedNumberSettingProtocolMethods:v4])
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v55 = 2048;
      uint64_t v56 = v25;
      _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_INFO, "%{public}@Transform constrained number setting (after scaling up) with value: %ld, max: %ld, min: %ld, step: %ld", (uint8_t *)&v47, 0x34u);
    }
    id v30 = objc_alloc(MEMORY[0x263F0E138]);
    id v31 = [v6 keyPath];
  ...
  if (+[HMDHPSAPIConformanceProviding objectRespondsToHPSSiriAvailableLanguagesProtocolMethods:v4])
  {
    ...
    if (v33)
    {
      ...
      {
        id v6 = v34;
        id v35 = objc_alloc(MEMORY[0x263F0E420]);
        id v8 = [v6 keyPath];
        id v36 = [v6 languages];
  ...
  if (+[HMDHPSAPIConformanceProviding objectRespondsToHPSSiriLanguageSettingProtocolMethods:v4])
  {
    ...
    if (v6)
    {
      if (v38)
      {
        id v39 = objc_alloc(MEMORY[0x263F0E418]);
      ...
      if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
      {
        ...
        int v47 = 138543362;
        id v48 = v45;
        _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_ERROR, "%{public}@Nil Language Value", (uint8_t *)&v47, 0xCu);
      }
    }
  }
  id v9 = 0;
...
- (void)updateSettingWithKeyPath:(id)a3 primaryUserInfo:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v28 = 2112;
    id v29 = v9;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Updating Primary User setting %{public}@ to %@", (uint8_t *)&v24, 0x20u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v26 = 2112;
      id v27 = v9;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Could not create homepod Setting from setting value %@", (uint8_t *)&v24, 0x16u);
    }
...
- (void)updateSettingWithKeyPath:(id)a3 integerSettingValue:(id)a4 completion:(id)a5
{
  ...
  int v12 = (void *)MEMORY[0x263F0E048];
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v33 = 2112;
    id v34 = v19;
    _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Updating %{public}@ to %@ (integer value: %@)", (uint8_t *)&v27, 0x2Au);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v29 = 2112;
      id v30 = v9;
      _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Could not create homepod Setting from setting value %@", (uint8_t *)&v27, 0x16u);
    }
...
- (void)updateSettingWithKeyPath:(id)a3 BOOLSettingValue:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v27 = 2112;
    id v28 = v9;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Updating %{public}@ to %@", (uint8_t *)&v23, 0x20u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v25 = 2112;
      id v26 = v9;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Could not create homepod Setting from setting value %@", (uint8_t *)&v23, 0x16u);
    }
...
- (void)updateSettingWithKeyPath:(id)a3 languageSettingValue:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v33 = 2112;
    id v34 = v9;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Updating %{public}@ to %@", buf, 0x20u);
  }
  uint64_t v16 = [(HMDFetchedSettingsDriverHomePodSettings *)v13 hmdhpsObjectFactory];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v31 = 2112;
      id v32 = v9;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Could not create homepod Setting from setting value %@", buf, 0x16u);
    }
    int v24 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
...
- (void)fetchSettingsForKeyPaths:(id)a3 completion:(id)a4
{
  ...
  v26[1] = v26;
  v26[2] = 0x3032000000;
  v26[3] = __Block_byref_object_copy__236893;
  v26[4] = __Block_byref_object_dispose__236894;
  id v27 = (id)MEMORY[0x263EFFA68];
  v24[0] = 0;
  v24[1] = v24;
  v24[2] = 0x3032000000;
  v24[3] = __Block_byref_object_copy__236893;
  v24[4] = __Block_byref_object_dispose__236894;
  id v25 = 0;
  ...
  if ([v6 count])
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v30 = 2112;
      id v31 = v6;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Fetching settings using local api keyPaths: %@", buf, 0x16u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_236903 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_236903, &__block_literal_global_236904);
  }
  id v2 = (void *)logCategory__hmf_once_v1_236905;
  return v2;
}
...
void __54__HMDFetchedSettingsDriverHomePodSettings_logCategory__block_invoke()
{
  ...
  uint64_t v1 = (void *)logCategory__hmf_once_v1_236905;
  logCategory__hmf_once_v1_236905 = v0;
}
