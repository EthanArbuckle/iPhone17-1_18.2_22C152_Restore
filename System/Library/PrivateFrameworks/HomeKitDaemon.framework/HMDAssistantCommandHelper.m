...
- (void)addActionSetRequest:(id)a3 actionSet:(id)a4 completionHandler:(id)a5
{
  ...
  v13 = NSString;
  v14 = MEMORY[0x230FBBCF0](self, a2);
  v15 = [v13 stringWithFormat:@"%@, %s:%ld", v14, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables/Sources/homed/Assistant/HMDAssistantCommandHelper.m", 516];
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v47 = 2112;
    id v48 = v9;
    _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Sending execute action set %@ with id %@ to home %@", buf, 0x2Au);
  }
  v40[0] = &unk_26E4710E0;
  v39[0] = @"sourceType";
...
void __77__HMDAssistantCommandHelper_addActionSetRequest_actionSet_completionHandler___block_invoke_3(uint64_t a1)
{
  ...
  if (v4)
  {
    if (*(void *)(a1 + 48))
    {
      v3 = objc_msgSend(objc_alloc(MEMORY[0x263EFF8C0]), "initWithObjects:", *(void *)(a1 + 48), 0);
      v2 = (void (**)(void, void, void))v4;
    }
    else
    {
...
- (void)addWriteRequests:(id)a3 home:(id)a4 completion:(id)a5
{
  ...
  if ([v8 count])
  {
    ...
    id v12 = (void *)MEMORY[0x230FBD990]([(HMDAssistantCommandHelper *)self _register]);
    id v13 = self;
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v32 = 2112;
      id v33 = v8;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Sending write request with id %@ to home %@ with write request tupes: %@", buf, 0x2Au);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v28 = 2112;
      id v29 = v9;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Received write request to home %@ with no request tuples, reporting invalid parameters error", buf, 0x16u);
    }
    v23 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F0C710] code:3 userInfo:0];
    v10[2](v10, v23, 0);
  }
}
  ...
  if (v5 && WeakRetained)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v23 = 2112;
      id v24 = v5;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Write request with id %@ to home failed with error: %@", buf, 0x20u);
    }
    v15 = [v8 queue];
  ...
  if ([v8 count])
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v32 = 2112;
      id v33 = v8;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Sending read request with id %@ to home %@ with characteristics: %@", buf, 0x2Au);
    }
    [(HMDAssistantCommandHelper *)v13 setRequests:v8];
    objc_initWeak((id *)buf, v13);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v28 = 2112;
      id v29 = v9;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Received read request to home %@ with no characteristics, reporting invalid parameters error", buf, 0x16u);
    }
    __int16 v23 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F0C710] code:3 userInfo:0];
    v10[2](v10, v23, 0);
  }
}
  ...
  if (v5 && WeakRetained)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v23 = 2112;
      id v24 = v5;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Read request with id %@ failed with error: %@", buf, 0x20u);
    }
    v15 = [v10 queue];
    v16[0] = MEMORY[0x263EF8330];
    v16[1] = 3221225472;
...
- (void)addMediaWriteRequests:(id)a3 withRequestProperty:(id)a4 completion:(id)a5
{
  ...
  if ([v8 count])
  {
    ...
    *((void *)&v56 + 1) = &v56;
    ...
    if (v11)
    {
      ...
      uint64_t v34 = *MEMORY[0x263F0C710];
      do
      {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v53 = 2112;
              v54 = v26;
              _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Media Profile (%@) does not contain HMDAppleMediaAccessory type accessory, something went wrong.", buf, 0x16u);
            }
            v27 = [MEMORY[0x263F087E8] errorWithDomain:v34 code:22 userInfo:0];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
    {
      ...
      *(void *)((char *)&v56 + 4) = v31;
      _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_INFO, "%{public}@Received write request with no apple media accessory, reporting invalid parameters error", (uint8_t *)&v56, 0xCu);
    }
    __int16 v32 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F0C710] code:3 userInfo:0];
...
- (void)__handleAccessoryCharacteristicsChanged:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v115 = 2112;
    id v116 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Processing characteristic reponses for Siri: %@", buf, 0x16u);
  }
  v66 = v4;
      ...
      if (v68)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            v87 = v13;
            id v16 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v13];
...
LABEL_38:
                        ...
                        if (os_log_type_enabled(v39, OS_LOG_TYPE_DEFAULT))
                        {
                          ...
                          *(_DWORD *)buf = 138543874;
                          ...
                          __int16 v117 = 2112;
                          v118 = v85;
                          _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_DEFAULT, "%{public}@Could not find a request corresponding to %@/%@ - creating a dummy request", buf, 0x20u);
                        }
                        id v41 = +[HMDCharacteristicWriteRequest writeRequestWithCharacteristic:v83 value:&unk_26E4710C8 authorizationData:0 type:0];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v61, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v117 = 2112;
        v118 = v64;
        _os_log_impl(&dword_22F52A000, v61, OS_LOG_TYPE_INFO, "%{public}@Characteristic change notification '%@' too late for request %@", buf, 0x20u);
      }
    }
  }
}
...
- (void)_reportOperationStartedForAccessory:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v58 = 2112;
    id v59 = v6;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Reporting operation started for accessory: %@", buf, 0x16u);
  }
  long long v54 = 0u;
  long long v55 = 0u;
  long long v52 = 0u;
        ...
        if (v20)
        {
          ...
          if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v60 = 2112;
            v61 = v18;
            _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_INFO, "%{public}@No response for requests with characteristic %@/%@ - inserting operation started error response", buf, 0x20u);
          }
          __int16 v21 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2404];
...
- (void)_reportResponses
{
  ...
  if (v3)
  {
    ...
    {
      uint64_t v7 = [MEMORY[0x263F087E8] hmErrorWithCode:15];
    }
    else
    {
          ...
          do
          {
            for (uint64_t i = 0; i != v65; ++i)
            {
              ...
              if ([v24 isSuspendCapable]
                && (uint64_t v82 = v66,
                    [MEMORY[0x263EFF8C0] arrayWithObjects:&v82 count:1],
                    ...
                    v37))
              {
                ...
                if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  __int16 v80 = 2112;
                  uint64_t v81 = v23;
                  _os_log_impl(&dword_22F52A000, v40, OS_LOG_TYPE_INFO, "%{public}@No response for wakeable write requests with characteristic %@/%@ - for suspeded accessory inserting operation started error response", buf, 0x20u);

                  uint64_t v38 = v60;
                }

                uint64_t v43 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2404];
              }
              else
              {
                ...
                if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  __int16 v80 = 2112;
                  uint64_t v81 = v23;
                  _os_log_impl(&dword_22F52A000, v47, OS_LOG_TYPE_INFO, "%{public}@No response for requests with characteristic %@/%@ - inserting an in-progress error response", buf, 0x20u);

                  uint64_t v34 = v66;
                }

                uint64_t v43 = [MEMORY[0x263F087E8] hmErrorWithCode:15];
              }
...
LABEL_43:
        ...
        if (os_log_type_enabled(v55, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v78 = 2112;
          v79 = v58;
          _os_log_impl(&dword_22F52A000, v55, OS_LOG_TYPE_INFO, "%{public}@Calling response handler for the id %@", buf, 0x16u);
        }
      ...
      uint64_t v7 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F0C710] code:v51 userInfo:0];
    }
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v78 = 2112;
    v79 = v13;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Results already reported for Siri command %@ - ignoring the notification/timer", buf, 0x16u);
  }
}
...
LABEL_20:
              ...
              if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                __int16 v52 = 2112;
                long long v53 = v23;
                _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_INFO, "%{public}@No response for requests for media profile %@ - inserting an in-progress error response", buf, 0x16u);
              }
              uint64_t v34 = [MEMORY[0x263F087E8] hmErrorWithCode:15];
              uint64_t v24 = +[HMDMediaPropertyResponse responseWithRequest:v20 error:v34];

              long long v49 = v24;
              char v35 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v49 count:1];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v51 = v16;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Media results already reported for Siri command - ignoring the notification/timer", buf, 0xCu);
    }
  }
}
...
uint64_t __52__HMDAssistantCommandHelper_timeoutAndReportResults__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    uint64_t v11 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Timeout current requests execution - reporting results", (uint8_t *)&v10, 0xCu);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_52870 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_52870, &__block_literal_global_52871);
  }
  id v2 = (void *)logCategory__hmf_once_v1_52872;
  return v2;
}
...
void __40__HMDAssistantCommandHelper_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_52872;
  logCategory__hmf_once_v1_52872 = v0;
}
