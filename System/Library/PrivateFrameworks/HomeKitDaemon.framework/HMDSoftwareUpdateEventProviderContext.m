...
- (id)lastEventForTopicSuffixID:(unint64_t)a3
{
  ...
  if (v6 && v8)
  {
    v10 = [MEMORY[0x263F0DFA8] topicFromSuffixID:a3 homeUUID:v8 accessoryUUID:v6];
    if (v10)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v23 = 2112;
        v24 = v6;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to get topic with suffix: %ld, homeUUID: %@, accessoryUUID: %@", (uint8_t *)&v17, 0x2Au);
      }
      v9 = 0;
    }
  }
...
- (void)forwardEvent:(id)a3 withTopicSuffixID:(unint64_t)a4
{
  ...
  if (v8 && v10)
  {
    v11 = [MEMORY[0x263F0DFA8] topicFromSuffixID:a4 homeUUID:v10 accessoryUUID:v8];
    if (v11)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v28 = 2112;
        v29 = v8;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to get topic with suffix: %ld, homeUUID: %@, accessoryUUID: %@", buf, 0x2Au);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v26 = 2112;
      v27 = v8;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Unexpected nil value in homeUUID: %@, accessoryUUID: %@", buf, 0x20u);
    }
  }
}
...
void __72__HMDSoftwareUpdateEventProviderContext_forwardEvent_withTopicSuffixID___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v10 = 2112;
      id v11 = v3;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error in forwarding the event: %@", (uint8_t *)&v8, 0x16u);
    }
  }
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_85367 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_85367, &__block_literal_global_85368);
  }
  v2 = (void *)logCategory__hmf_once_v5_85369;
  return v2;
}
...
void __52__HMDSoftwareUpdateEventProviderContext_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_85369;
  logCategory__hmf_once_v5_85369 = v0;
}
