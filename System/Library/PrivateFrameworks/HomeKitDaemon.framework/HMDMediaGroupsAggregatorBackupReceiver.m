...
- (void)handleGroupsBackupDataMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v29 = 2112;
    id v30 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling backup group data message: %@", (uint8_t *)&v27, 0x16u);
  }
  ...
  if (v9)
  {
    ...
    if (v11)
    {
      ...
      {
        v22 = [MEMORY[0x263F087E8] hmfErrorWithCode:8];
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v29 = 2112;
          id v30 = v22;
          _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify delegate of received backup due to unconfigured delegate error: %@", (uint8_t *)&v27, 0x16u);
        }
    ...
    {
      v13 = [MEMORY[0x263F087E8] hmfErrorWithCode:8];
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v31 = 2112;
        v32 = v13;
        _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Failed to decode group backup data payload: %@ error: %@", (uint8_t *)&v27, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v31 = 2112;
      v32 = v11;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to get message payload from group backup data message: %@ error: %@", (uint8_t *)&v27, 0x20u);
    }
...
- (HMDMediaGroupsAggregatorBackupReceiver)init
{
  ...
  if (v2)
  {
    uint64_t v3 = [objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:@"00000000-0000-0000-0000-000000000000"];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_6218 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_6218, &__block_literal_global_6219);
  }
  v2 = (void *)logCategory__hmf_once_v5_6220;
  return v2;
}
...
void __53__HMDMediaGroupsAggregatorBackupReceiver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_6220;
  logCategory__hmf_once_v5_6220 = v0;
}
