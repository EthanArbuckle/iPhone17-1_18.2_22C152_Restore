  ...
  if (!self->super.submitted)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v18 = 2112;
      v19 = v9;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Submitting shared user accept latency log event %@ error:%@", buf, 0x20u);
    }
    v13.receiver = v4;
...
- (void)markResidentSyncEnd
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v21 = 138543362;
    v22 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markResidentSyncEnd", (uint8_t *)&v21, 0xCu);
  }
...
- (void)markResidentSyncBegin
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v10 = 138543362;
    v11 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markResidentSyncBegin", (uint8_t *)&v10, 0xCu);
  }
...
- (void)markDiscoverPrimaryResidentEnd
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v15 = 138543362;
    uint64_t v16 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markDiscoverPrimaryResidentEnd", (uint8_t *)&v15, 0xCu);
  }
  os_unfair_lock_lock_with_options();
  if (!v4->super.submitted)
  {
...
- (void)markDiscoverPrimaryResidentBegin
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v10 = 138543362;
    v11 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markDiscoverPrimaryResidentBegin", (uint8_t *)&v10, 0xCu);
  }
  p_lock = &v4->super._lock;
  os_unfair_lock_lock_with_options();
...
- (void)markCreatedHome
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v15 = 138543362;
    uint64_t v16 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markCreatedHome", (uint8_t *)&v15, 0xCu);
  }
  os_unfair_lock_lock_with_options();
  if (!v4->super.submitted)
  {
...
- (void)markSendAcceptanceToOwnerEnd
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v21 = 138543362;
    v22 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markSendAcceptanceToOwnerEnd", (uint8_t *)&v21, 0xCu);
  }
  os_unfair_lock_lock_with_options();
  if (!v4->super.submitted)
  {
...
- (void)markSendAcceptanceToOwnerBegin
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v10 = 138543362;
    v11 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markSendAcceptanceToOwnerBegin", (uint8_t *)&v10, 0xCu);
  }
  p_lock = &v4->super._lock;
  os_unfair_lock_lock_with_options();
...
- (void)markCreateReverseShareEnd
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v15 = 138543362;
    uint64_t v16 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markCreateReverseShareEnd", (uint8_t *)&v15, 0xCu);
  }
  os_unfair_lock_lock_with_options();
  if (!v4->super.submitted)
  {
...
- (void)markCreateReverseShareBegin
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v10 = 138543362;
    v11 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markCreateReverseShareBegin", (uint8_t *)&v10, 0xCu);
  }
  p_lock = &v4->super._lock;
  os_unfair_lock_lock_with_options();
...
- (void)markCreateMKFCKSharedUserDataRootEnd
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v15 = 138543362;
    uint64_t v16 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markCreateMKFCKSharedUserDataRootEnd", (uint8_t *)&v15, 0xCu);
  }
  os_unfair_lock_lock_with_options();
  if (!v4->super.submitted)
  {
...
- (void)markCreateMKFCKSharedUserDataRootBegin
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v10 = 138543362;
    v11 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markCreateMKFCKSharedUserDataRootBegin", (uint8_t *)&v10, 0xCu);
  }
  p_lock = &v4->super._lock;
  os_unfair_lock_lock_with_options();
...
- (void)markJoinOwnerShareEnd
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v15 = 138543362;
    uint64_t v16 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markJoinOwnerShareEnd", (uint8_t *)&v15, 0xCu);
  }
  os_unfair_lock_lock_with_options();
  if (!v4->super.submitted)
  {
...
- (void)markJoinOwnerShareBegin
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v10 = 138543362;
    v11 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@markJoinOwnerShareBegin", (uint8_t *)&v10, 0xCu);
  }
  p_lock = &v4->super._lock;
  os_unfair_lock_lock_with_options();
...
- (HMDSharedUserInviteAcceptLogEventBuilder)initWithHomeUUID:(id)a3 homeManager:(id)a4 sessionIdentifier:(id)a5 invitationType:(unint64_t)a6 wifiManager:(id)a7
{
  ...
  uint64_t v17 = [(HMDSharedUserInviteAcceptLogEventBuilder *)self initWithHomeUUID:v15 homeManager:v14 sessionIdentifier:v13 invitationType:a6 logEventSubmitter:v16 wifiManager:v12 currentUpTicksBlock:&__block_literal_global_245653 submissionTimerFactory:&__block_literal_global_4_245654];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t31_245664 != -1) {
    dispatch_once(&logCategory__hmf_once_t31_245664, &__block_literal_global_12_245665);
  }
  v2 = (void *)logCategory__hmf_once_v32_245666;
  return v2;
}
...
void __55__HMDSharedUserInviteAcceptLogEventBuilder_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v32_245666;
  logCategory__hmf_once_v32_245666 = v0;
}
