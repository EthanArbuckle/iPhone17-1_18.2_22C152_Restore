...
- (void)_handleSubmitClipsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v73 = 2112;
    v74 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling submit clips message payload: %@", buf, 0x16u);
  }
  v11 = [v4 setForKey:*MEMORY[0x263F0BBD0]];
  if (!v11)
  {
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v73 = 2112;
      v74 = v55;
      _os_log_impl(&dword_22F52A000, v53, OS_LOG_TYPE_ERROR, "%{public}@Could not find clip UUIDs in message payload: %@", buf, 0x16u);
    }
...
LABEL_27:
                  _os_log_impl(&dword_22F52A000, v40, OS_LOG_TYPE_INFO, v41, buf, 0x16u);
                }
LABEL_28:
              ...
              case 0:
                ...
                if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v73 = 2112;
                  v74 = v26;
                  _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_INFO, "%{public}@Marking clip for upload: %@", buf, 0x16u);
                }
...
LABEL_31:
            ...
            if ([v58 count])
            {
              ...
              v43 = [MEMORY[0x263F49318] optionsWithLabel:@"Marking clips for upload"];
  ...
  if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v75 = 2112;
    id v76 = v21;
    _os_log_impl(&dword_22F52A000, v48, OS_LOG_TYPE_ERROR, "%{public}@Failing request to submit because no clip model could be found for UUID %@: %@", buf, 0x20u);
  }
  v50 = [MEMORY[0x263F087E8] hmfErrorWithCode:2];
  id v4 = v57;
...
- (void)_handleFindAndUploadSubmittedClipsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling find and upload submitted clips message: %@", (uint8_t *)&v11, 0x16u);
  }
...
void __72__HMDCameraClipFeedbackManager_handlePrimaryResidentUpdateNotification___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    if (v6)
    {
      ...
      int v9 = 138543362;
      v10 = v7;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@The current device is the confirmed primary resident", (uint8_t *)&v9, 0xCu);
    }
  ...
  else
  {
    if (v6)
    {
      ...
      int v9 = 138543362;
      v10 = v8;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@The current device is not the confirmed primary resident", (uint8_t *)&v9, 0xCu);
    }
  }
}
  ...
  else
  {
    ...
    if (v5)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v25 = 2112;
        v26 = v5;
        _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Sending message %@ that clips were submitted to %@", (uint8_t *)&v21, 0x20u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        int v21 = 138543362;
        uint64_t v22 = v20;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Could not find primary resident to send notifications to", (uint8_t *)&v21, 0xCu);
      }
    }
  }
}
  ...
  if (v7 == 2)
  {
    if (v11)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v33 = 2112;
      v34 = v6;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Clip %@ was already uploaded", buf, 0x16u);
    }
  ...
  else
  {
    if (v11)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v33 = 2112;
      v34 = v6;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Uploading clip %@", buf, 0x16u);
    }
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v27 = 2112;
      id v28 = v3;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to upload clip %@: %@", buf, 0x20u);
    }
  }
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v25 = 2112;
      id v26 = v11;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Marking clip as uploaded: %@", buf, 0x16u);
    }
    ...
    v17 = [MEMORY[0x263EFFA08] setWithObject:v15];
    v18 = [MEMORY[0x263F49318] optionsWithLabel:@"Marking clip as uploaded"];
...
- (void)_findAndUploadSubmittedClips
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v12 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Current device is not a confirmed primary resident, will not upload clips", buf, 0xCu);
    }
  }
}
...
- (id)_performCloudPull
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v19 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Performing cloud pull", buf, 0xCu);
  }
  id v8 = [MEMORY[0x263F49318] optionsWithLabel:@"Explicit fetch"];
...
- (void)configureWithIsCurrentDeviceResidentCapable:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v32 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Configuring clip feedback manager", buf, 0xCu);
  }
  ...
  if (v10)
  {
    ...
    uint64_t v14 = *MEMORY[0x263F0BC58];
    v30[0] = v11;
    v30[1] = v12;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v32 = v28;
        _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Current device is not resident capable, clip uploading is not available", buf, 0xCu);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v32 = v24;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot configure clip feedback manager because home reference is nil", buf, 0xCu);
    }
  }
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t23_247709 != -1) {
    dispatch_once(&logCategory__hmf_once_t23_247709, &__block_literal_global_247710);
  }
  int v2 = (void *)logCategory__hmf_once_v24_247711;
  return v2;
}
...
void __43__HMDCameraClipFeedbackManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v24_247711;
  logCategory__hmf_once_v24_247711 = v0;
}
