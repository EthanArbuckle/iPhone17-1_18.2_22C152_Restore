...
- (void)handleTimerFiredNotification:(id)a3
{
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v16 = 2112;
      v17 = v13;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Timer Trigger fired : %@", (uint8_t *)&v14, 0x16u);
    }
...
- (void)_transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      int v18 = 138543362;
      v19 = v17;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Received unknown model object", (uint8_t *)&v18, 0xCu);
    }
  }
}
...
- (void)_closestDatesForStartDate:(id)a3 earliestDate:(id)a4 timeZone:(id)a5 deliveryRepeatInterval:(id)a6 returnDateBefore:(id *)a7 returnDateAfter:(id *)a8
{
  ...
  v83 = [MEMORY[0x263EFFA18] localTimeZone];
  int v18 = [MEMORY[0x263EFF910] date];
  ...
  if (v19 != 1)
  {
    if (v15)
    {
      ...
      id v33 = [MEMORY[0x263EFF910] dateWithTimeInterval:v13 sinceDate:(double)(v31 - v32)];
    }
    else
    {
      id v33 = v13;
          ...
          *a8 = v28;
          ...
          if (os_log_type_enabled(v55, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v88 = 2112;
            v89 = v57;
            _os_log_impl(&dword_22F52A000, v55, OS_LOG_TYPE_INFO, "%{public}@(d) Timer fires next at %@; current time (GMT): %@",
              buf,
              0x20u);
          }
        }
          ...
          *a7 = (id)objc_claimAutoreleasedReturnValue();
          ...
          if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v88 = 2112;
            v89 = v61;
            _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@(e) Timer fires next at %@; current time (GMT): %@",
              buf,
              0x20u);
          }
          id v13 = v70;
      ...
      else
      {
        ...
        if (!v46)
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v88 = 2112;
          v89 = v65;
          _os_log_impl(&dword_22F52A000, v82, OS_LOG_TYPE_INFO, "%{public}@(f) Timer fires next at %@; current time (GMT): %@",
            buf,
            0x20u);
            ...
            *a7 = v28;
            ...
            if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v88 = 2112;
              v89 = v80;
              _os_log_impl(&dword_22F52A000, v47, OS_LOG_TYPE_INFO, "%{public}@(b) Timer fires next at %@; current time (GMT): %@",
                buf,
                0x20u);
            }
            id v13 = v70;
            ...
            *a8 = (id)objc_claimAutoreleasedReturnValue();
            ...
            if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v88 = 2112;
              v89 = v53;
              _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@(c) Timer fires next at %@; current time (GMT): %@",
                buf,
                0x20u);
...
LABEL_23:
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v88 = 2112;
          v89 = v45;
          _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@(g) Timer fires next at %@; current time (GMT): %@",
            buf,
            0x20u);
    ...
    *a8 = v13;
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v88 = 2112;
      v89 = v27;
      _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@(a) Timer fires next at %@; current time (GMT): %@",
        buf,
        0x20u);
...
- (void)_timerTriggered
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      *(_DWORD *)buf = 138543362;
      objc_super v12 = v8;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Going to execute the Action set.", buf, 0xCu);
    }
  ...
  else
  {
    if (v7)
    {
      ...
      *(_DWORD *)buf = 138543362;
      objc_super v12 = v9;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Should execute action set returned NO, going ahead to reactivate trigger", buf, 0xCu);
    }
  }
      ...
      for (uint64_t i = 0; i != v11; ++i)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v37 = 2112;
          unint64_t v38 = v9;
          _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Comparing date components iter: %@, now: %@", buf, 0x20u);
        }
        ...
        if (v19 == [v14 weekday])
        {
          ...
          if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v34 = v24;
            _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Current week day matches with a recurring instance, allowing execution of action set", buf, 0xCu);
          }
          BOOL v20 = 1;
          goto LABEL_18;
        }
...
- (id)_nextFireDate
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v16 = 2112;
    id v17 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Next Fire Date : [%@]", buf, 0x16u);
  }
  return v7;
}
  ...
  if (WeakRetained)
  {
    if (v3)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
      {
        ...
        int v22 = 138543362;
        v23 = v9;
        _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@Activate on super class failed, bailing out", (uint8_t *)&v22, 0xCu);
      }
...
LABEL_19:
    ...
    else
    {
      ...
      else if ([v5 active])
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          int v22 = 138543362;
          v23 = v20;
          _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Looks like the timer is already running. Stopping it.", (uint8_t *)&v22, 0xCu);
        }
        [v18 _stopTimer];
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      int v22 = 138543362;
      v23 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@TimerTrigger instance is gone. Doing Nothing.", (uint8_t *)&v22, 0xCu);
    }
...
- (BOOL)_reactivateSignificantEventTrigger
{
  ...
  id v5 = self;
  objc_super v6 = HMFGetOSLogHandle();
  BOOL v7 = os_log_type_enabled(v6, OS_LOG_TYPE_INFO);
  if (v3)
  {
    if (v7)
    {
      ...
      __int16 v14 = 2112;
      uint64_t v15 = v9;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Starting timer based on significant event with %@", (uint8_t *)&v12, 0x16u);
    }
  ...
  else
  {
    if (v7)
    {
      ...
      int v12 = 138543362;
      id v13 = v10;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@No valid next significant fire date, disabling the timer", (uint8_t *)&v12, 0xCu);
    }
...
- (BOOL)_reactivateFireDateTrigger
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      int v9 = 138543362;
      uint64_t v10 = v7;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@No valid next fire date, disabling the timer", (uint8_t *)&v9, 0xCu);
    }
    [(HMDTimerTrigger *)v5 _disableTimerOffReactivationFailure];
  }
...
- (id)_serializeForAdd
{
  ...
  char v4 = [(HMDTimerTrigger *)self fireDate];
  ...
  if (v6)
  {
    BOOL v7 = (void *)MEMORY[0x263F08910];
  ...
  {
    [v3 setObject:MEMORY[0x263EFFA88] forKeyedSubscript:@"kTimerTriggerResetTimeZoneDataKey"];
  }
  uint64_t v10 = [(HMDTimerTrigger *)self fireRepeatInterval];

  if (v10)
  {
    uint64_t v11 = (void *)MEMORY[0x263F08910];
  ...
  {
    [v3 setObject:MEMORY[0x263EFFA88] forKeyedSubscript:@"kTimerTriggerResetRecurrenceDataKey"];
  }
  ...
  {
    [v3 setObject:MEMORY[0x263EFFA88] forKeyedSubscript:@"kTimerTriggerResetRecurrencesKey"];
  }
  ...
  {
    [v3 setObject:MEMORY[0x263EFFA88] forKeyedSubscript:@"kTimerTriggerResetSignificantEventKey"];
  }
  BOOL v20 = [(HMDTimerTrigger *)self significantEventOffset];

  if (v20)
  {
    uint64_t v21 = (void *)MEMORY[0x263F08910];
  ...
  {
    [v3 setObject:MEMORY[0x263EFFA88] forKeyedSubscript:@"kTimerTriggerResetSignificantEventOffsetKey"];
  }
  return v3;
}
...
- (id)modelObjectWithChangeType:(unint64_t)a3
{
  ...
  objc_super v6 = [(HMDTrigger *)self uuid];
  ...
  uint64_t v10 = [(HMDTimerTrigger *)self fireDate];
...
- (void)_handleUpdateTimerTriggerPropertiesModel:(id)a3 message:(id)a4
{
  ...
  uint64_t v10 = [v33 setProperties];
...
{
  id v14 = a3;
  char v4 = [(HMDTimerTrigger *)self emptyModelObject];
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
    id v5 = v4;
  }
...
- (void)_registerForMessages
{
  ...
  id v3 = [(HMDTrigger *)self home];
  char v4 = [v3 administratorHandler];
  ...
  v10[2] = v7;
  int v8 = [MEMORY[0x263EFF8C0] arrayWithObjects:v10 count:3];
...
- (void)_stopTimer
{
  ...
  char v4 = [(HMDTimerTrigger *)self timerID];
...
- (void)_startTimer:(id)a3
{
      ...
      if (v8)
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v31 = 2112;
          id v32 = v8;
          _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to start timer %@ with error %@", buf, 0x20u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v29 = 2112;
        long long v30 = v18;
        _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Trigger %@ not activated on local device - skipping scheduling the trigger", buf, 0x16u);
      }
    }
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v31 = 2112;
    id v32 = v25;
    _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@%@/%@: Home reference is nil", buf, 0x20u);
  }
LABEL_15:
}
...
- (void)_startTimerWithFireDate:(id)a3
{
  ...
  if (v6 <= 0.0)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v22 = 2112;
      int v23 = v14;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Revised Next Fire Date %@", (uint8_t *)&v20, 0x16u);
    }
  }
  else
  {
  ...
  int v15 = (void *)MEMORY[0x230FBD990](v5);
  uint64_t v16 = self;
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v22 = 2112;
    int v23 = v19;
    _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Next fire date %@", (uint8_t *)&v20, 0x16u);
  }
...
- (void)invalidate
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    int v11 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Invalidating the trigger", buf, 0xCu);
  }
...
- (void)timerTriggered
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    int v11 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Timer Triggered", buf, 0xCu);
  }
...
- (void)configure:(id)a3 messageDispatcher:(id)a4 queue:(id)a5
{
  ...
  if (!v11)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v31 = 2112;
      id v32 = v19;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Null timerID -- initializing with %@", buf, 0x16u);
    }
  }
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v35 = 2080;
    uint64_t v36 = v27;
    _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Configuring with firedate %@ and timezone %@ for %s", buf, 0x2Au);
  }
...
- (id)dumpState
{
  ...
  if (v5)
  {
    objc_super v6 = [MEMORY[0x263EFF8F0] currentCalendar];
  ...
  [v4 setObject:v21 forKeyedSubscript:*MEMORY[0x263F41FB8]];
  return v4;
}
...
+ (id)validateWholeMinuteDate:(id)a3 onCalendar:(id)a4
{
  ...
  if ([v8 second])
  {
    uint64_t v9 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F0C710] code:70 userInfo:0];
  }
  else
  {
    ...
    uint64_t v9 = [MEMORY[0x263F087E8] hmErrorWithCode:28];
  }
  id v10 = (void *)v9;
LABEL_11:
...
LABEL_9:
    ...
    if (v22)
    {
      uint64_t v24 = [MEMORY[0x263F08910] archivedDataWithRootObject:v22 requiringSecureCoding:1 error:0];
      ...
      if (v14)
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          ...
          _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@Not a valid recurrence", buf, 0xCu);
        }
...
LABEL_60:
      ...
      __int16 v35 = [MEMORY[0x263F08910] archivedDataWithRootObject:v26 requiringSecureCoding:1 error:0];
      ...
      if (v39)
      {
        ...
        if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          ...
          _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_ERROR, "%{public}@Invalid recurrence instances", buf, 0xCu);
        }
...
LABEL_59:
      ...
      [MEMORY[0x263F08910] archivedDataWithRootObject:v38 requiringSecureCoding:1 error:0];
        ...
        if ((HMIsValidSignificantEvent() & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v57, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            ...
            _os_log_impl(&dword_22F52A000, v57, OS_LOG_TYPE_ERROR, "%{public}@Significant event is not valid", buf, 0xCu);
          }
          uint64_t v48 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
      ...
      if (v48)
      {
        ...
        if (v49)
        {
          ...
          if (os_log_type_enabled(v52, OS_LOG_TYPE_ERROR))
          {
            ...
            v63 = v50;
            v53 = (void *)v70;
            _os_log_impl(&dword_22F52A000, v52, OS_LOG_TYPE_ERROR, "%{public}@Invalid significant event offset", buf, 0xCu);
        ...
        v61 = [MEMORY[0x263F08910] archivedDataWithRootObject:v48 requiringSecureCoding:1 error:0];
...
LABEL_33:
  ...
  id v15 = v8;
  objc_super v16 = (void *)MEMORY[0x230FBD990]();
  id v17 = a1;
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    ...
    _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Fire date is not valid", buf, 0xCu);
        ...
        for (uint64_t i = 0; i != v9; ++i)
        {
          ...
          if ((v13 & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v45 = v25;
              _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Calendars are not matching in the recurrence instances", buf, 0xCu);
            }
          ...
          if (![v19 weekday])
          {
            ...
            if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v46 = 2112;
              v47 = v19;
              _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_ERROR, "%{public}@Invalid values for week day: %@", buf, 0x16u);
            }
          ...
          if (([v19 isEqual:v20] & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v46 = 2112;
              v47 = v19;
              _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_ERROR, "%{public}@Miscellaneous fields have been set recurrence instances: %@", buf, 0x16u);
            }
            uint64_t v21 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
...
+ (id)validateRecurrence:(id)a3 calendar:(id)a4 fireDate:(id)a5
{
  ...
  if (v7)
  {
      ...
      && ([v7 nanosecond] == 0x7FFFFFFFFFFFFFFFLL || !objc_msgSend(v7, "nanosecond")))
    {
      ...
      {
        uint64_t v10 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F0C710] code:42 userInfo:0];
      }
    }
    else
    {
      uint64_t v10 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F0C710] code:69 userInfo:0];
    }
  }
  else
  {
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_40267 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_40267, &__block_literal_global_40268);
  }
  v2 = (void *)logCategory__hmf_once_v1_40269;
  return v2;
}
...
void __30__HMDTimerTrigger_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_40269;
  logCategory__hmf_once_v1_40269 = v0;
}
