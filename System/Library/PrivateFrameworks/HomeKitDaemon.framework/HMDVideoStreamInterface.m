...
void __48__HMDVideoStreamInterface_streamDidRTCPTimeOut___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v6 = 138543362;
    v7 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Video stream RTCP has timed out", (uint8_t *)&v6, 0xCu);
  }
}
...
void __47__HMDVideoStreamInterface_streamDidRTPTimeOut___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
  {
    ...
    int v8 = 138543362;
    v9 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_ERROR, "%{public}@Video stream RTP has timed out", (uint8_t *)&v8, 0xCu);
  }
  int v6 = *(void **)(a1 + 32);
  v7 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1012];
  [v6 _callStopped:v7];
}
...
void __46__HMDVideoStreamInterface_streamDidServerDie___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
  {
    ...
    int v8 = 138543362;
    v9 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_ERROR, "%{public}@Video stream server died", (uint8_t *)&v8, 0xCu);
  }
  int v6 = *(void **)(a1 + 32);
...
uint64_t __41__HMDVideoStreamInterface_streamDidStop___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    int v8 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@streamDidStop", (uint8_t *)&v7, 0xCu);
  }
...
uint64_t __68__HMDVideoStreamInterface_stream_didUpdateVideoConfiguration_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v7;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Video stream did update video configuration: %@ error: %@", (uint8_t *)&v9, 0x20u);
  }
...
uint64_t __49__HMDVideoStreamInterface_stream_didStart_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v7;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Video stream did start: %@ error: %@", (uint8_t *)&v9, 0x20u);
  }
...
- (void)_callDidGetLastDecodedFrame:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    int v21 = 138543362;
    v22 = v10;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Calling delegate videoStream:didGetLastDecodedFrame:", (uint8_t *)&v21, 0xCu);
  }
...
- (void)_callDidUpdateConfiguration
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    uint64_t v10 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Calling delegate videoStreamDidUpdateConfiguration", (uint8_t *)&v9, 0xCu);
  }
...
- (void)_callNetworkDeteriorated
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    uint64_t v10 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Calling delegate videoStreamDidNetworkDeteriorate", (uint8_t *)&v9, 0xCu);
  }
  int v8 = [(HMDVideoStreamInterface *)v5 delegate];
  if (objc_opt_respondsToSelector()) {
...
- (void)_callNetworkImproved
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    uint64_t v10 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Calling delegate videoStreamDidNetworkImprove", (uint8_t *)&v9, 0xCu);
  }
  int v8 = [(HMDVideoStreamInterface *)v5 delegate];
  if (objc_opt_respondsToSelector()) {
...
- (void)_callStopped:(id)a3
{
  ...
  int v6 = (void *)MEMORY[0x230FBD990]([(HMDStreamInterface *)self setState:3]);
  uint64_t v7 = self;
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v11 = 138543362;
    BOOL v12 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Calling delegate videoStream:didStop", (uint8_t *)&v11, 0xCu);
  }
...
- (void)_callStarted:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v11 = 138543362;
    BOOL v12 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Calling delegate videoStream:didStart", (uint8_t *)&v11, 0xCu);
  }
  uint64_t v10 = [(HMDVideoStreamInterface *)v7 delegate];
  if (objc_opt_respondsToSelector()) {
...
- (void)captureSnapshot
{
  ...
  id v4 = (void *)[objc_alloc(MEMORY[0x263F425C0]) initWithName:@"com.apple.homed.snapshot-last-decoded-frame"];
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    int v11 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Requesting last decoded frame", (uint8_t *)&v10, 0xCu);
  }
...
- (void)stopStream
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    int v10 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Stopping video stream", (uint8_t *)&v9, 0xCu);
  }
...
- (void)updateStreamConfiguration:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    uint64_t v16 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Updating video stream with video configuration: %@", (uint8_t *)&v13, 0x16u);
  }
...
- (void)startStreamWithConfig:(id)a3
{
  ...
  if (!v6)
  {
    if (v10)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v24 = v20;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Failed to load misc fields to video config", buf, 0xCu);
    }
  ...
  if (v10)
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v25 = 2112;
    id v26 = v4;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Configuring video stream with configuration: %@", buf, 0x16u);
  }
  ...
  if ((v13 & 1) == 0)
  {
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v25 = 2112;
      id v26 = v14;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to configure video stream: %@", buf, 0x16u);
    }
LABEL_14:
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v24 = v18;
    _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Starting video stream", buf, 0xCu);
  }
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    int v9 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Deallocating HMDVideoStreamInterface object", buf, 0xCu);
  }
  v7.receiver = v4;
...
- (HMDVideoStreamInterface)initWithSessionID:(id)a3 workQueue:(id)a4 delegate:(id)a5 sessionHandler:(id)a6 localNetworkConfig:(id)a7
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v31 = v24;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to create video stream interface", buf, 0xCu);
  ...
  else
  {
    if (v11)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v29 = 1024;
      LODWORD(v30) = v7;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Creating local video stream with socket %d", buf, 0x12u);
    }
    xpc_object_t v13 = xpc_dictionary_create(0, 0, 0);
    xpc_dictionary_set_fd(v13, (const char *)*MEMORY[0x263F21008], v7);
    id v26 = 0;
    id v14 = (void *)[objc_alloc(MEMORY[0x263F20FE8]) initWithNetworkSockets:v13 callID:0 error:&v26];
    id v15 = v26;
    if (v14)
    {
      *a3 = v7;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v29 = 2112;
        id v30 = v15;
        _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to create local AVCVideoStream: %@", buf, 0x16u);
      }
      close(v7);
    }
  }
...
+ (id)_createStreamWithRemoteSocketReceiver:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Creating video stream with socket %d", buf, 0x12u);
  }
  xpc_object_t v9 = xpc_dictionary_create(0, 0, 0);
  xpc_dictionary_set_fd(v9, (const char *)*MEMORY[0x263F21008], [v4 remoteVideoSocket]);
  id v18 = 0;
  id v10 = (void *)[objc_alloc(MEMORY[0x263F20FE8]) initWithNetworkSockets:v9 callID:0 error:&v18];
  id v11 = v18;
  if (v10)
  {
    id v12 = v10;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v21 = 2112;
      id v22 = v11;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to create remote socket receiver AVCVideoStream: %@", buf, 0x16u);
    }
  }
...
+ (id)_createStreamWithRemoteDestinationReceiver:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v23 = 2112;
    id v24 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Creating video stream with destination: %@", buf, 0x16u);
  }
  id v10 = objc_alloc(MEMORY[0x263F20FE8]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v23 = 2112;
      id v24 = v13;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to create remote destination receiver AVCVideoStream: %@", buf, 0x16u);
    }
  }
...
+ (id)_createVideoStreamWithSessionHandler:(id)a3 localNetworkConfig:(id)a4 localRTPSocket:(int *)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    int v26 = 138543362;
    id v27 = v13;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Creating the video stream", (uint8_t *)&v26, 0xCu);
  }
  id v14 = v8;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_22203 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_22203, &__block_literal_global_22204);
  }
  id v2 = (void *)logCategory__hmf_once_v2_22205;
  return v2;
}
...
void __38__HMDVideoStreamInterface_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_22205;
  logCategory__hmf_once_v2_22205 = v0;
}
