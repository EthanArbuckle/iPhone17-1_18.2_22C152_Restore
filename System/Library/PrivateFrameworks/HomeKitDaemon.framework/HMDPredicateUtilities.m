    ...
    if ([v13 expressionType] == 4)
    {
      ...
      if (v16)
      {
        ...
        if (![v21 expressionType])
        {
          ...
          {
            v24 = [v14 keyPath];
            if ([v24 isEqualToString:*MEMORY[0x263F0D8F8]])
            {
            ...
            {
              v47 = [v14 keyPath];
              int v49 = [v47 isEqualToString:*MEMORY[0x263F0D908]];
...
LABEL_46:
               ...
               v29))
    {
      ...
      {
        v30 = [v14 keyPath];
        if ([v30 isEqualToString:*MEMORY[0x263F0D8F8]])
        {
        ...
        {
          v45 = [v14 keyPath];
          int v46 = [v45 isEqualToString:*MEMORY[0x263F0D908]];
    ...
    else
    {
      if ([v14 expressionType] != 3
        || ([v14 keyPath],
            ...
            int v32 = [v31 isEqualToString:*MEMORY[0x263F0BE30]],
            v31,
            !v32))
      {
        if ([v14 expressionType] == 3)
        {
          v33 = [v14 keyPath];
          int v34 = [v33 isEqualToString:*MEMORY[0x263F0D4A8]];
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      if ([v13 expressionType] == 3
        && ([v13 keyPath],
            ...
            int v15 = [v14 isEqualToString:*MEMORY[0x263F0D4A8]],
            v14,
            v15)
        && ![v12 expressionType])
      {
...
- (id)rewritePredicate:(id)a3 forDaemon:(BOOL)a4 message:(id)a5
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    {
      long long v18 = v36;
      id v19 = (id)objc_msgSend(objc_alloc(MEMORY[0x263F08730]), "initWithType:subpredicates:", objc_msgSend(v36, "compoundPredicateType"), v11);
    }
    else
    {
      id v19 = 0;
  ...
  else
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      if ([v22 expressionType] == 3)
      {
        ...
        int v24 = [v23 isEqualToString:*MEMORY[0x263F0D4A8]];
        ...
        if (v24)
        {
          ...
          if (![v25 expressionType])
          {
            ...
            if (isKindOfClass)
            {
              ...
              v30 = (void *)MEMORY[0x263F087F0];
              v31 = [(HMDPresenceEvent *)v29 createPresenceEventPayload:v6];
              int v32 = [v30 expressionForConstantValue:v31];

              id v19 = (id)objc_msgSend(objc_alloc(MEMORY[0x263F08720]), "initWithLeftExpression:rightExpression:modifier:type:options:", v22, v32, objc_msgSend(v20, "comparisonPredicateModifier"), v37, objc_msgSend(v20, "options"));
              goto LABEL_24;
            }
          }
        }
...
- (id)rewriteNowAdjustedForHomeTimeZone:(id)a3
{
  ...
  [v5 setTimeZone:v4];
  id v10 = [MEMORY[0x263F087F0] expressionWithFormat:@"FUNCTION($THIS_OBJECT, 'dateTodayMatchingComponents:', %@)", v5];
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      if ([v24 expressionType] == 3
        && ([v24 keyPath],
            v25 = objc_claimAutoreleasedReturnValue(),
            int v26 = [v25 isEqualToString:*MEMORY[0x263F0BE30]],
            v25,
            v26))
      {
              ...
              if (!v34)
              {
                ...
                if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v57 = 2112;
                  id v58 = v22;
                  _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_INFO, "%{public}@Removing predicate %@ because referenced characteristic no longer exists", buf, 0x16u);
      ...
      else if ([v24 expressionType] == 3)
      {
        ...
        int v42 = [v41 isEqualToString:*MEMORY[0x263F0C5D0]];
...
LABEL_30:
  ...
  {
    id v20 = v47;
    id v21 = (id)objc_msgSend(objc_alloc(MEMORY[0x263F08730]), "initWithType:subpredicates:", objc_msgSend(v47, "compoundPredicateType"), v13);
  }
  else
  {
    id v21 = 0;
...
- (id)updatePredicate:(id)a3 removedUser:(id)a4 conditionModified:(BOOL *)a5
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if ([v12 count]) {
      id v19 = (id)objc_msgSend(objc_alloc(MEMORY[0x263F08730]), "initWithType:subpredicates:", objc_msgSend(v11, "compoundPredicateType"), v12);
    }
    else {
      id v19 = 0;
    }
...
LABEL_26:
  ...
  if ([v21 expressionType] != 3
    || ([v21 keyPath],
        ...
        int v23 = [v22 isEqualToString:*MEMORY[0x263F0D4A8]],
        v22,
        !v23))
  {
LABEL_25:
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v61 = 2112;
    v62 = v48;
    _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_INFO, "%{public}@presence event dictionary: %@", buf, 0x16u);
  ...
  else
  {
    ...
    long long v40 = (void *)MEMORY[0x263F087F0];
    long long v41 = v39;
    int v42 = [(HMDPresenceEvent *)v39 createPresenceEventPayload:1];
    uint64_t v43 = [v40 expressionForConstantValue:v42];

    id v19 = (id)objc_msgSend(objc_alloc(MEMORY[0x263F08720]), "initWithLeftExpression:rightExpression:modifier:type:options:", v21, v43, objc_msgSend(v20, "comparisonPredicateModifier"), v51, objc_msgSend(v20, "options"));
    if (a5) {
      *a5 = 1;
    }
...
LABEL_24:
    if ([v29 expressionType] != 3
      || ([v29 keyPath],
          ...
          int v43 = [v42 isEqualToString:*MEMORY[0x263F0BE30]],
          v42,
          !v43))
    {
      if ([v29 expressionType] == 3)
      {
        ...
        int v58 = [v57 isEqualToString:*MEMORY[0x263F0C5D0]];
        ...
        if (v61)
        {
          ...
          if (os_log_type_enabled(v54, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v81 = 2112;
            id v82 = v74;
            _os_log_impl(&dword_22F52A000, v54, OS_LOG_TYPE_INFO, "%{public}@Char %@ has been removed, and it has reference in the condition, updating the condition", buf, 0x16u);
...
LABEL_51:
  ...
  id v69 = v14;
  id v17 = v14;
  long long v18 = [MEMORY[0x263EFF980] array];
  long long v75 = 0u;
  long long v76 = 0u;
  long long v77 = 0u;
  long long v78 = 0u;
  ...
  {
    v25 = v65;
    id v26 = (id)objc_msgSend(objc_alloc(MEMORY[0x263F08730]), "initWithType:subpredicates:", objc_msgSend(v65, "compoundPredicateType"), v18);
  }
  else
  {
    id v26 = 0;
...
- (id)comparePresence:(id)a3 operatorType:(id)a4 homePresence:(id)a5
{
  ...
  if (v11 && [v9 unsignedIntegerValue] == 4)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v24 = 2112;
      id v25 = v8;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Checking whether the homePresence %@ agree with the presence events in condition: %@", (uint8_t *)&v20, 0x20u);
    }
...
LABEL_43:
        ...
        if (![v35 expressionType])
        {
          ...
          id v82 = (void *)MEMORY[0x263F087F0];
          uint64_t v35 = v86;
...
LABEL_22:
    ...
    if (![v27 expressionType])
    {
      ...
      if (v40)
      {
        uint64_t v41 = (void *)MEMORY[0x263F087F0];
    ...
    {
      v44 = [v28 keyPath];
      int v45 = [v44 isEqualToString:*MEMORY[0x263F0BE30]];
...
LABEL_59:
    ...
    {
      v47 = [v28 keyPath];
      int v48 = [v47 isEqualToString:*MEMORY[0x263F0C5D0]];
      ...
      if (v48)
      {
        ...
        long long v52 = (void *)MEMORY[0x263F087F0];
        ...
        id v27 = [MEMORY[0x263F087F0] expressionForConstantValue:MEMORY[0x263EFFA88]];
    ...
    int v58 = [v57 isEqualToString:*MEMORY[0x263F0D4A8]];
    ...
    if (v58)
    {
      ...
      if (![v59 expressionType])
      {
        ...
        if (v74)
        {
          ...
          long long v76 = (void *)MEMORY[0x263F087F0];
...
LABEL_61:
    uint64_t v50 = objc_msgSend(objc_alloc(*(Class *)(v24 + 1824)), "initWithLeftExpression:rightExpression:modifier:type:options:", v28, v27, objc_msgSend(v23, "comparisonPredicateModifier"), v56, objc_msgSend(v23, "options"));
    int v46 = v27;
LABEL_62:
  ...
  {
    __int16 v22 = v85;
    id v23 = objc_msgSend(objc_alloc(MEMORY[0x263F08730]), "initWithType:subpredicates:", objc_msgSend(v85, "compoundPredicateType"), v15);
    uint64_t v13 = v94;
  }
  else
  {
...
- (id)sunset
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    uint64_t v16 = v11;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Sunset time: %@", (uint8_t *)&v13, 0x16u);
  }
  return v6;
}
...
- (id)sunrise
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    uint64_t v16 = v11;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Sunrise time: %@", (uint8_t *)&v13, 0x16u);
  }
  return v6;
}
...
- (HMDPredicateUtilities)initWithHome:(id)a3 logIdentifier:(id)a4
{
  return [(HMDPredicateUtilities *)self initWithHome:a3 logIdentifier:a4 homePresenceProvider:&__block_literal_global_194185];
}
...
+ (id)unarchiveFromData:(id)a3 error:(id *)a4
{
  ...
  id v18 = 0;
  id v10 = [MEMORY[0x263F08928] unarchivedObjectOfClasses:v9 fromData:v6 error:&v18];
  id v11 = v18;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v21 = 2112;
      id v22 = v11;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive predicate: %@", buf, 0x16u);
    }
    id v12 = 0;
    if (a4) {
      *a4 = v11;
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (v11)
    {
      ...
      if (v13)
      {
        ...
        id v18 = (id)objc_msgSend(objc_alloc(MEMORY[0x263F08730]), "initWithType:subpredicates:", objc_msgSend(v36, "compoundPredicateType"), v9);
LABEL_25:
        id v34 = v18;
LABEL_26:
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if ([v9 expressionType] == 3)
    {
      ...
      int v20 = [v19 isEqualToString:*MEMORY[0x263F0D4A8]];
            ...
            if ([v25 count])
            {
              ...
              if (v27 < [v25 count])
              {
                if ([v26 count])
                {
                  ...
                  char v37 = (void *)MEMORY[0x263F087F0];
                  v28 = (void *)[v40 copy];
                  uint64_t v38 = [v37 expressionForConstantValue:v28];

                  id v29 = objc_alloc(MEMORY[0x263F08720]);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_194205 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_194205, &__block_literal_global_12_194206);
  }
  v2 = (void *)logCategory__hmf_once_v2_194207;
  return v2;
}
...
void __36__HMDPredicateUtilities_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_194207;
  logCategory__hmf_once_v2_194207 = v0;
}
...
+ (id)encodePredicate:(id)a3 error:(id *)a4
{
  if (a3)
  {
    id v5 = [MEMORY[0x263F08910] archivedDataWithRootObject:a3 requiringSecureCoding:1 error:a4];
  }
  else
  {
    id v5 = 0;
