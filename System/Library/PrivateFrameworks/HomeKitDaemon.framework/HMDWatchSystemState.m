...
- (void)_callDidUpdateReachabilityChangeForCompanion:(BOOL)a3 forDelegate:(id)a4
{
  BOOL v4 = a3;
  id v5 = a4;
  if [v5 conformsToProtocol:&unk_26E586618] && (objc_opt_respondsToSelector()) {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v26 = 2112;
      v27 = v11;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@[HMDWatchState] companion reachability is changing from %@ to %@", buf, 0x20u);
    }
