...
- (id)dumpState
{
  ...
  v74 = [MEMORY[0x263F08968] mapTableWithStrongToStrongObjects];
  long long v114 = 0u;
  long long v115 = 0u;
  long long v116 = 0u;
  long long v117 = 0u;
    ...
    do
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        if (v11)
        {
          ...
          if (!v13)
          {
            v13 = [MEMORY[0x263EFF980] arrayWithCapacity:1];
            v14 = [v11 device];
  ...
  v70 = objc_msgSend(MEMORY[0x263EFF9A0], "dictionaryWithCapacity:", objc_msgSend(v74, "count"));
  long long v110 = 0u;
  long long v111 = 0u;
  long long v112 = 0u;
  long long v113 = 0u;
  ...
  if (v72)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v84 = objc_msgSend(MEMORY[0x263EFF980], "arrayWithCapacity:", objc_msgSend(v16, "count"));
        long long v106 = 0u;
        long long v107 = 0u;
        long long v108 = 0u;
        long long v109 = 0u;
        ...
        if (v17)
        {
          ...
          do
          {
            for (uint64_t j = 0; j != v18; ++j)
            {
              ...
              v125[0] = v29;
              v125[1] = v21;
              v30 = [NSDictionary dictionaryWithObjects:v125 forKeys:v124 count:2];
              [v84 addObject:v30];
            }
  ...
  v75 = [MEMORY[0x263F08968] mapTableWithStrongToStrongObjects];
  long long v98 = 0u;
  long long v99 = 0u;
  long long v100 = 0u;
  long long v101 = 0u;
    ...
    do
    {
      for (uint64_t m = 0; m != v35; ++m)
      {
        ...
        if (v40)
        {
          ...
          if (!v42)
          {
            v42 = [MEMORY[0x263EFF980] arrayWithCapacity:1];
            v43 = [v40 account];
  ...
  v71 = objc_msgSend(MEMORY[0x263EFF9A0], "dictionaryWithCapacity:", objc_msgSend(v75, "count"));
  long long v94 = 0u;
  long long v95 = 0u;
  long long v96 = 0u;
  long long v97 = 0u;
  ...
  if (v73)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v85 = objc_msgSend(MEMORY[0x263EFF980], "arrayWithCapacity:", objc_msgSend(v45, "count"));
        long long v90 = 0u;
        long long v91 = 0u;
        long long v92 = 0u;
        long long v93 = 0u;
        ...
        if (v46)
        {
          ...
          do
          {
            for (uint64_t n = 0; n != v47; ++n)
            {
              ...
              v119[0] = v58;
              v119[1] = v50;
              v59 = [NSDictionary dictionaryWithObjects:v119 forKeys:v118 count:2];
              [v85 addObject:v59];
            }
...
uint64_t __28__HMDIdentityRegistry_reset__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v18 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Resetting", buf, 0xCu);
  }
  long long v14 = 0u;
  long long v15 = 0u;
  long long v12 = 0u;
...
void __49__HMDIdentityRegistry_deregisterIdentity_object___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v40 = 2112;
    uint64_t v41 = v7;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Deregistering identity, %@, for object: %@", buf, 0x20u);
  }
  long long v32 = 0u;
  long long v33 = 0u;
  long long v30 = 0u;
  ...
  if (v8 && v9 && v10)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v30 = 2112;
      long long v31 = v11;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Registering identity, %@, for account, %@, for object: %@", buf, 0x2Au);
    }
    uint64_t v17 = (void *)[objc_alloc(MEMORY[0x263F425D8]) initWithObservedObject:v11];
...
LABEL_12:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v26 = 2112;
    id v27 = v17;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Adding identity, %@, for account: %@", buf, 0x20u);
  }
  ...
  if (v8 && v9 && v10)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v30 = 2112;
      long long v31 = v11;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Registering identity, %@, for device, %@, for object: %@", buf, 0x2Au);
    }
    uint64_t v17 = (void *)[objc_alloc(MEMORY[0x263F425D8]) initWithObservedObject:v11];
...
LABEL_12:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v26 = 2112;
    id v27 = v17;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Adding identity, %@, for device: %@", buf, 0x20u);
  }
...
- (id)accountsForIdentity:(id)a3
{
  ...
  if (v4)
  {
    ...
    int v14 = __Block_byref_object_copy__15121;
    long long v15 = __Block_byref_object_dispose__15122;
    id v16 = 0;
...
void __43__HMDIdentityRegistry_accountsForIdentity___block_invoke(uint64_t a1)
{
  ...
  id v2 = [MEMORY[0x263EFF9B0] orderedSet];
  long long v20 = 0u;
  long long v21 = 0u;
  long long v22 = 0u;
  long long v23 = 0u;
...
- (id)identitiesForAccountIdentifier:(id)a3
{
  ...
  if (v4)
  {
    ...
    uint64_t v13 = 0x3032000000;
    int v14 = __Block_byref_object_copy__15121;
    uint64_t v15 = __Block_byref_object_dispose__15122;
    id v16 = 0;
    uint64_t v5 = [(HMDIdentityRegistry *)self lock];
    v8[0] = MEMORY[0x263EF8330];
    v8[1] = 3221225472;
...
void __54__HMDIdentityRegistry_identitiesForAccountIdentifier___block_invoke(void *a1)
{
  ...
  id v16 = [MEMORY[0x263EFF9B0] orderedSet];
  long long v18 = 0u;
  long long v19 = 0u;
  long long v20 = 0u;
  long long v21 = 0u;
...
- (id)identitiesForAccount:(id)a3
{
  ...
  if (v4)
  {
    ...
    id v12 = &v11;
    uint64_t v13 = 0x3032000000;
    uint64_t v14 = __Block_byref_object_copy__15121;
    uint64_t v15 = __Block_byref_object_dispose__15122;
    id v16 = 0;
    uint64_t v5 = [(HMDIdentityRegistry *)self lock];
    v8[0] = MEMORY[0x263EF8330];
...
- (id)identitiesForDevice:(id)a3
{
  ...
  if (v4)
  {
    ...
    long long v18 = __Block_byref_object_copy__15121;
    long long v19 = __Block_byref_object_dispose__15122;
    id v20 = 0;
...
- (id)identityForIdentifier:(id)a3
{
  ...
  if (v4)
  {
    ...
    char v12 = &v11;
    uint64_t v13 = 0x3032000000;
    long long v14 = __Block_byref_object_copy__15121;
    long long v15 = __Block_byref_object_dispose__15122;
    id v16 = 0;
    uint64_t v5 = [(HMDIdentityRegistry *)self lock];
    v8[0] = MEMORY[0x263EF8330];
...
- (NSArray)registeredIdentities
{
  ...
  id v10 = __Block_byref_object_copy__15121;
  uint64_t v11 = __Block_byref_object_dispose__15122;
  id v12 = 0;
...
- (HMDIdentityRegistry)init
{
  ...
  if (v2)
  {
    id v3 = (NSRecursiveLock *)objc_alloc_init(MEMORY[0x263F08AE0]);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t27_15133 != -1) {
    dispatch_once(&logCategory__hmf_once_t27_15133, &__block_literal_global_15134);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v28_15135;
  return v2;
}
...
void __34__HMDIdentityRegistry_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v28_15135;
  logCategory__hmf_once_v28_15135 = v0;
}
...
void __37__HMDIdentityRegistry_sharedRegistry__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v8 = 138543362;
    uint64_t v9 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Creating HMDIdentity Registry", (uint8_t *)&v8, 0xCu);
  }
}
