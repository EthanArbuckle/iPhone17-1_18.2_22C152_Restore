...
- (void)sendMessage:(id)a3 toDevice:(id)a4 withPayload:(id)a5 responseHandler:(id)a6
{
  ...
  v17 = (void *)[objc_alloc(MEMORY[0x263F42590]) initWithName:v13 destination:v19 payload:v11];
  [v17 setTimeout:0.0];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_61913 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_61913, &__block_literal_global_61914);
  }
  v2 = (void *)logCategory__hmf_once_v1_61915;
  return v2;
}
...
void __51__HMDHouseholdMetricsMessagingProvider_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_61915;
  logCategory__hmf_once_v1_61915 = v0;
}
