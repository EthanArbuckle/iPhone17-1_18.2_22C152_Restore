...
{
  v2 = NSString;
  int64_t v3 = [(HMDNetworkRouterIPProtocolVersion *)self protocol];
  if (v3)
  {
    if (v3 == 1)
    {
    ...
    {
      objc_msgSend(NSString, "stringWithFormat:", @"Unknown HMDNetworkRouterIPProtocolVersionType %ld", v3);
...
- (BOOL)isEqual:(id)a3
{
  v4 = (HMDNetworkRouterIPProtocolVersion *)a3;
  if (self == v4)
  {
    BOOL v8 = 1;
  }
  else
  {
    ...
    {
      v5 = v4;
      int64_t v6 = [(HMDNetworkRouterIPProtocolVersion *)self protocol];
      uint64_t v7 = [(HMDNetworkRouterIPProtocolVersion *)v5 protocol];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  int64_t v5 = [(HMDNetworkRouterIPProtocolVersion *)self protocol];
...
{
  v5.receiver = self;
  v5.super_class = (Class)HMDNetworkRouterIPProtocolVersion;
...
{
  v3.receiver = self;
  v3.super_class = (Class)HMDNetworkRouterIPProtocolVersion;
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HMDNetworkRouterIPProtocolVersion);
  uint64_t v7 = v6;
  if (v6)
  {
    id v10 = 0;
    [(HMDNetworkRouterIPProtocolVersion *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
