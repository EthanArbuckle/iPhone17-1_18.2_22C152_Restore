...
LABEL_16:
    ...
    {
      v23 = obj;
      v24 = objc_msgSend(MEMORY[0x263EFF980], "arrayWithCapacity:", objc_msgSend(obj, "count") + 1);
      if (v11 == a3)
      {
        v25 = (void *)[objc_alloc(MEMORY[0x263F35AF0]) initWithValue:&unk_26E4716C8];
        v26 = v21;
        id v27 = objc_alloc(MEMORY[0x263F358F8]);
        v28 = [v26 scale];
        v29 = [v26 offset];
      ...
      else if (v16)
      {
        ...
        id v46 = objc_alloc(MEMORY[0x263F35AF0]);
        v47 = [NSNumber numberWithLongLong:v22];
        uint64_t v48 = [v46 initWithValue:v47];

        unint64_t v77 = v45;
        v49 = [MEMORY[0x263F358F8] transitionPointWithPreviousTransitionPoint:v16 nextTransitionPoint:v21 timeElapsedSincePreviousTransitionPoint:v45 minimumBrightness:v74 maximumBrightness:v73];
        objc_msgSend(v24, "addObject:");
        id v50 = objc_alloc(MEMORY[0x263F358F8]);
        v51 = [v21 scale];
        v52 = [v21 offset];
        v79 = (void *)v48;
        ...
        id v60 = objc_alloc(MEMORY[0x263F358F8]);
        v61 = v49;
        v62 = [v49 scale];
        v63 = [v49 offset];
        id v64 = objc_alloc(MEMORY[0x263F35AF0]);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v70, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v88 = 2048;
          unint64_t v89 = a3;
          _os_log_impl(&dword_22F52A000, v70, OS_LOG_TYPE_ERROR, "%{public}@Next transition point for current time: %llums not found", buf, 0x16u);
        }
        v23 = obj;
      }
      v37 = (void *)[v24 copy];
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v88 = 2048;
      unint64_t v89 = v22;
      _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_ERROR, "%{public}@Time to reach next transiton point is negative: %lldms", buf, 0x16u);
    }
  }
  else
  {
...
LABEL_23:
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v88 = 2048;
      unint64_t v89 = a3;
      _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_ERROR, "%{public}@Next transition point for current time: %llums not found", buf, 0x16u);
    }
  }
  v37 = (void *)MEMORY[0x263EFFA68];
  v23 = obj;
LABEL_46:
...
LABEL_8:
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v20 = 2112;
    id v21 = v8;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Transition point for milliseconds elapsed since start of day %llums is %@", (uint8_t *)&v16, 0x20u);
  }
...
- (id)attributeDescriptions
{
  ...
  v41[10] = v23;
  v24 = [MEMORY[0x263EFF8C0] arrayWithObjects:v41 count:11];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t19_98950 != -1) {
    dispatch_once(&logCategory__hmf_once_t19_98950, &__block_literal_global_98951);
  }
  v2 = (void *)logCategory__hmf_once_v20_98952;
  return v2;
}
...
void __38__HMDNaturalLightingCurve_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v20_98952;
  logCategory__hmf_once_v20_98952 = v0;
}
        ...
        if (!v12)
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v27 = 2112;
            id v28 = v13;
            _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize transition point %@:%@", buf, 0x20u);
          }
...
- (HMDNaturalLightingCurve)initWithCoder:(id)a3
{
  ...
  if (v5 != 1)
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    uint32_t v22 = 32;
LABEL_14:
    _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, v20, buf, v22);
  ...
  if (v7 >= (unint64_t)v6)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v61 = 2048;
      uint64_t v62 = v6;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Minimum brightness is greater than equal to maximum brightness (%ld:%ld)", buf, 0x20u);
    }
    goto LABEL_25;
  }
  ...
  if (v9 > v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      uint32_t v17 = 32;
LABEL_24:
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, v15, buf, v17);
    }
LABEL_25:
  ...
  __int16 v27 = [MEMORY[0x263EFF8C0] arrayWithObjects:v56 count:2];
    ...
    if (v30)
    {
      ...
      while (2)
      {
        for (uint64_t i = 0; i != v31; ++i)
        {
          ...
          id v50 = 0;
          v35 = [MEMORY[0x263F358F8] parsedFromData:v34 error:&v50];
          id v36 = v50;
          if (!v35)
          {
            ...
            if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse encoded transition point %@:%@", buf, 0x20u);
            }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v58 = v43;
      _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode transition points", buf, 0xCu);
    }
    v24 = 0;
  }
