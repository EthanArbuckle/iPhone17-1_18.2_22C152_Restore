...
- (id)attributeDescriptions
{
  ...
  if (v14)
  {
    ...
    v17 = [MEMORY[0x263F42610] defaultFormatter];
...
- (HMDCameraSignificantEventFaceClassification)initWithUUID:(id)a3 personManagerUUID:(id)a4
{
  ...
  if (v8)
  {
    v9 = v8;
    v17.receiver = self;
    v17.super_class = (Class)HMDCameraSignificantEventFaceClassification;
  ...
  else
  {
    ...
    return (HMDCameraSignificantEventFaceClassification *)+[HMDCameraSignificantEventFaceClassificationDictionaryTransformer reverseTransformedValue:v15 error:v16];
  }
}
