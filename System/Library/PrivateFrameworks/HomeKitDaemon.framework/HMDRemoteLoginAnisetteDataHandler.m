...
- (void)_handleLegacyAnisetteDataRequestMessage:(id)a3
{
  ...
  id v4 = a3;
  v5 = [MEMORY[0x263F0E428] objWithMessage:v4];
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v19 = 2112;
    v20 = v5;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling legacy anisette data request: %@", buf, 0x16u);
  }
...
{
  v3 = (objc_class *)MEMORY[0x263F0E430];
  id v4 = a2;
  id v5 = [v3 alloc];
...
- (void)_handleFetchAnisetteDataRequestMessage:(id)a3
{
  ...
  id v4 = a3;
  id v5 = [MEMORY[0x263F0E368] objWithMessage:v4];
  v6 = (void *)MEMORY[0x230FBD990]();
  v7 = self;
  v8 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v18 = 2112;
    __int16 v19 = v5;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch anisette data request: %@", buf, 0x16u);
  }
  v10 = [(HMDRemoteLoginAnisetteDataHandler *)v7 provisioningController];
...
{
  v3 = (objc_class *)MEMORY[0x263F0E370];
  id v4 = a2;
  id v5 = [v3 alloc];
  v6 = [*(id *)(a1 + 32) sessionID];
  id v9 = (id)[v5 initWithSessionID:v6];
...
- (void)_handleEraseAnisetteDataRequestMessage:(id)a3
{
  uint64_t v20 = *MEMORY[0x263EF8340];
  id v4 = a3;
  id v5 = [MEMORY[0x263F0E2E0] objWithMessage:v4];
  v6 = (void *)MEMORY[0x230FBD990]();
  v7 = self;
  v8 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v18 = 2112;
    __int16 v19 = v5;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling erase anisette data request: %@", buf, 0x16u);
  }
  v10 = [(HMDRemoteLoginAnisetteDataHandler *)v7 provisioningController];
  v13[0] = MEMORY[0x263EF8330];
  v13[1] = 3221225472;
...
{
  id v4 = objc_alloc(MEMORY[0x263F0E2E8]);
...
- (void)_handleSyncAnisetteDataRequestMessage:(id)a3
{
  uint64_t v21 = *MEMORY[0x263EF8340];
  id v4 = a3;
  id v5 = [MEMORY[0x263F0E838] objWithMessage:v4];
  v6 = (void *)MEMORY[0x230FBD990]();
  v7 = self;
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v19 = 2112;
    uint64_t v20 = v5;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling sync anisette data request: %@", buf, 0x16u);
  }
  v10 = [(HMDRemoteLoginAnisetteDataHandler *)v7 provisioningController];
  id v11 = [v5 simData];
  v14[0] = MEMORY[0x263EF8330];
...
{
  id v4 = objc_alloc(MEMORY[0x263F0E840]);
  id v5 = [*(id *)(a1 + 32) sessionID];
  id v8 = (id)[v4 initWithSessionID:v5];
...
- (void)_handleProvisionAnisetteDataRequestMessage:(id)a3
{
  uint64_t v20 = *MEMORY[0x263EF8340];
  id v4 = a3;
  id v5 = [MEMORY[0x263F0E688] objWithMessage:v4];
  v6 = (void *)MEMORY[0x230FBD990]();
  v7 = self;
  id v8 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v18 = 2112;
    __int16 v19 = v5;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling provision anisette data request: %@", buf, 0x16u);
  }
  v10 = [(HMDRemoteLoginAnisetteDataHandler *)v7 provisioningController];
  v13[0] = MEMORY[0x263EF8330];
  v13[1] = 3221225472;
...
{
  id v4 = objc_alloc(MEMORY[0x263F0E690]);
  id v5 = [*(id *)(a1 + 32) sessionID];
  id v8 = (id)[v4 initWithSessionID:v5];
...
- (void)registerForMessages
{
  ...
  id v8 = [MEMORY[0x263F0E688] messageName];
  v26[0] = v5;
  v26[1] = v6;
  ...
  id v11 = [MEMORY[0x263F0E838] messageName];
  v25[0] = v5;
  v25[1] = v6;
  ...
  id v14 = [MEMORY[0x263F0E2E0] messageName];
  v24[0] = v5;
  v24[1] = v6;
  id v15 = [MEMORY[0x263EFF8C0] arrayWithObjects:v24 count:2];
  ...
  v17 = [MEMORY[0x263F0E368] messageName];
  v23[0] = v5;
  v23[1] = v6;
  __int16 v18 = [MEMORY[0x263EFF8C0] arrayWithObjects:v23 count:2];
  ...
  uint64_t v20 = [MEMORY[0x263F0E428] messageName];
  v22[0] = v5;
  v22[1] = v6;
  uint64_t v21 = [MEMORY[0x263EFF8C0] arrayWithObjects:v22 count:2];
...
- (HMDRemoteLoginAnisetteDataHandler)initWithUUID:(id)a3 accessory:(id)a4
{
  ...
  if (v9)
  {
    ...
    id v11 = (AKAnisetteProvisioningController *)objc_alloc_init(MEMORY[0x263F29108]);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5_162008 != -1) {
    dispatch_once(&logCategory__hmf_once_t5_162008, &__block_literal_global_162009);
  }
  v2 = (void *)logCategory__hmf_once_v6_162010;
  return v2;
}
...
void __48__HMDRemoteLoginAnisetteDataHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v6_162010;
  logCategory__hmf_once_v6_162010 = v0;
}
