...
- (HMDCameraHomeSettingsConfiguration)initWithHome:(id)a3
{
  ...
  if (v5)
  {
    ...
    uint64_t v19 = [MEMORY[0x263EFF8C0] arrayWithArray:v7];
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v68 = 2112;
      v69 = v25;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Camera accessory settings: %@", buf, 0x16u);
    }
    ...
    uint64_t v33 = [MEMORY[0x263EFF8C0] arrayWithArray:v26];
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v68 = 2112;
      v69 = v39;
      _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_DEBUG, "%{public}@Camera user settings: %@", buf, 0x16u);
    }
    id v4 = v50;
