...
- (void)handleUploadReasonLogEvent:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@[HMDCloudSyncLogEventsAnalyzer] Received upload reason: %{public}@ Count for legacy: %ld homeZone: %ld homeManager: %ld", (uint8_t *)&v15, 0x34u);
    }
...
- (void)didReceiveEventFromDispatcher:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@[CloudSyncLogEventsAnalyzer] Processing Cloud Event: %@", buf, 0x16u);
  }
  id v9 = v4;
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
              ...
              else
              {
                ...
                if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v37 = 2112;
                  uint64_t v38 = v31;
                  _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_ERROR, "%{public}@Event class: %@ matched none of the handlers in HMDCloudSyncLogEventsAnalyzer", buf, 0x16u);
                }
              }
            }
          }
...
- (HMDCloudSyncLogEventsAnalyzer)initWithDataSource:(id)a3
{
  ...
  if (v5)
  {
    ...
    id v17 = [MEMORY[0x263EFF8C0] arrayWithObjects:v20 count:10];
