...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_59685 != -1) {
    dispatch_once(&hmbProperties_onceToken_59685, &__block_literal_global_59686);
  }
  v2 = (void *)hmbProperties_properties_59687;
  return v2;
}
...
void __45__HMDUserActionPredictionModel_hmbProperties__block_invoke()
{
  ...
  v36 = [MEMORY[0x263F492C8] excludeFromCloudStorage];
  v43 = v36;
  v35 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v43 count:1];
  v34 = [v0 fieldWithClass:v1 options:v35];
  v45[0] = v34;
  v44[1] = @"targetServiceUUID";
  v2 = (void *)MEMORY[0x263F492C0];
  uint64_t v3 = objc_opt_class();
  v33 = [MEMORY[0x263F492C8] excludeFromCloudStorage];
  v42 = v33;
  v32 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v42 count:1];
  v31 = [v2 fieldWithClass:v3 options:v32];
  v45[1] = v31;
  v44[2] = @"targetServiceGroupUUID";
  v4 = (void *)MEMORY[0x263F492C0];
  uint64_t v5 = objc_opt_class();
  v30 = [MEMORY[0x263F492C8] excludeFromCloudStorage];
  v41 = v30;
  ...
  v27 = [MEMORY[0x263F492C8] excludeFromCloudStorage];
  v40 = v27;
  v26 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v40 count:1];
  v25 = [v6 fieldWithClass:v7 options:v26];
  v45[3] = v25;
  v44[4] = @"type";
  v8 = (void *)MEMORY[0x263F492C0];
  uint64_t v9 = objc_opt_class();
  v10 = [MEMORY[0x263F492C8] excludeFromCloudStorage];
  v39 = v10;
  v11 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v39 count:1];
  v12 = [v8 fieldWithClass:v9 options:v11];
  v45[4] = v12;
  v44[5] = @"groupType";
  v13 = (void *)MEMORY[0x263F492C0];
  uint64_t v14 = objc_opt_class();
  v15 = [MEMORY[0x263F492C8] excludeFromCloudStorage];
  v38 = v15;
  v16 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v38 count:1];
  v17 = [v13 fieldWithClass:v14 options:v16];
  v45[5] = v17;
  v44[6] = @"predictionScore";
  v18 = (void *)MEMORY[0x263F492C0];
  uint64_t v19 = objc_opt_class();
  v20 = [MEMORY[0x263F492C8] excludeFromCloudStorage];
  v37 = v20;
  v21 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v37 count:1];
  v22 = [v18 fieldWithClass:v19 options:v21];
  v45[6] = v22;
  uint64_t v23 = [NSDictionary dictionaryWithObjects:v45 forKeys:v44 count:7];
  v24 = (void *)hmbProperties_properties_59687;
  hmbProperties_properties_59687 = v23;
}

- (id)userActionPrediction
{
  id v3 = objc_alloc(MEMORY[0x263F0E8B0]);
...
- (HMDUserActionPredictionModel)initWithUserActionPrediction:(id)a3
{
  ...
  if (v6)
  {
    uint64_t v14 = (void *)MEMORY[0x263F08C38];
    v15 = [v6 UUIDString];
  ...
  v18 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:@"D73F97DF-5711-4EAA-9CA4-EB5C028A5EE8"];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v45 = 2112;
      v46 = v30;
      _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@User Action Prediction: %@, resulted in nil hmbModelID for prediction model: %@", (uint8_t *)&v41, 0x20u);
    }
    ...
    if (!v33)
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_FAULT))
      {
        ...
        int v41 = 138543362;
        v42 = v38;
        _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: User Action Prediction ModelID should not be nil", (uint8_t *)&v41, 0xCu);
      }
