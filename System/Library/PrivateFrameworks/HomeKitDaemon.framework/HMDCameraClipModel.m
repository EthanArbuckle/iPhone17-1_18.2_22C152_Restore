...
void __62__HMDCameraClipModel_countOfClipsWithQualityBetweenDatesQuery__block_invoke(uint64_t a1)
{
  ...
  v4 = (void *)MEMORY[0x263F492B8];
  v11[0] = @"quality";
  v5 = [MEMORY[0x263F492D8] argumentWithPropertyName:@"qualityField"];
  v12[0] = v5;
  v11[1] = @"dateAfter";
  v6 = [MEMORY[0x263F492D8] argumentWithPropertyName:@"startDate"];
  v12[1] = v6;
  v11[2] = @"dateBefore";
  v7 = [MEMORY[0x263F492D8] argumentWithPropertyName:@"startDate"];
  v12[2] = v7;
  v8 = [NSDictionary dictionaryWithObjects:v12 forKeys:v11 count:3];
  uint64_t v9 = [v4 queryWithSQLPredicate:v3 indexedProperties:&unk_26E4745D8 arguments:v8];
...
void __65__HMDCameraClipModel_clipsWithQualityBetweenDatesDescendingQuery__block_invoke(uint64_t a1)
{
  ...
  v12[2] = v7;
  v8 = [NSDictionary dictionaryWithObjects:v12 forKeys:v11 count:3];
  uint64_t v9 = [v4 queryWithSQLPredicate:v3 sequenceArgumentName:@"dateBefore" indexedProperties:&unk_26E4745C0 arguments:v8];
...
void __64__HMDCameraClipModel_clipsWithQualityBetweenDatesAscendingQuery__block_invoke(uint64_t a1)
{
  ...
  v12[2] = v7;
  v8 = [NSDictionary dictionaryWithObjects:v12 forKeys:v11 count:3];
  uint64_t v9 = [v4 queryWithSQLPredicate:v3 sequenceArgumentName:@"dateAfter" indexedProperties:&unk_26E4745A8 arguments:v8];
...
+ (HMBModelInfiniteQuery)clipsBeforeDateQuery
{
  if (clipsBeforeDateQuery_onceToken != -1) {
    dispatch_once(&clipsBeforeDateQuery_onceToken, &__block_literal_global_81_269363);
  }
...
void __42__HMDCameraClipModel_clipsBeforeDateQuery__block_invoke()
{
  ...
  v5 = @"dateBefore";
  v1 = [MEMORY[0x263F492D8] argumentWithPropertyName:@"startDate"];
  v6[0] = v1;
  v2 = [NSDictionary dictionaryWithObjects:v6 forKeys:&v5 count:1];
  uint64_t v3 = [v0 queryWithSQLPredicate:@"startDate <= :dateBefore ORDER BY startDate DESC" sequenceArgumentName:@"dateBefore" indexedProperties:&unk_26E474590 arguments:v2];
...
+ (HMBModelInfiniteQuery)clipsWithNeedsUploadFeedbackStatusQuery
{
  if (clipsWithNeedsUploadFeedbackStatusQuery_onceToken != -1) {
    dispatch_once(&clipsWithNeedsUploadFeedbackStatusQuery_onceToken, &__block_literal_global_72_269368);
  }
...
void __61__HMDCameraClipModel_clipsWithNeedsUploadFeedbackStatusQuery__block_invoke()
{
  ...
  v1 = [MEMORY[0x263F492D8] argumentWithPropertyName:@"feedbackStatusField" defaultValue:&unk_26E473C90];
  v6[0] = v1;
  v2 = [NSDictionary dictionaryWithObjects:v6 forKeys:&v5 count:1];
  uint64_t v3 = [v0 queryWithSQLPredicate:@"feedbackStatusField == :feedbackStatusField" sequenceArgumentName:@"feedbackStatusField" indexedProperties:&unk_26E474578 arguments:v2];
...
+ (HMBModelInfiniteQuery)incompleteClipsQuery
{
  if (incompleteClipsQuery_onceToken != -1) {
    dispatch_once(&incompleteClipsQuery_onceToken, &__block_literal_global_65_269380);
  }
...
void __42__HMDCameraClipModel_incompleteClipsQuery__block_invoke()
{
  ...
  v0 = (void *)MEMORY[0x263F492D0];
  v8[0] = @"isComplete";
  v1 = objc_msgSend(MEMORY[0x263F492D8], "argumentWithPropertyName:defaultValue:");
  v8[1] = @"startDate";
  v9[0] = v1;
  v2 = (void *)MEMORY[0x263F492D8];
  ...
  uint64_t v6 = [v0 queryWithSQLPredicate:@"isComplete == :isComplete AND startDate <= :startDate ORDER BY startDate DESC" sequenceArgumentName:@"startDate" indexedProperties:&unk_26E474560 arguments:v5];
...
+ (NSUUID)sentinelParentUUID
{
  if (sentinelParentUUID_onceToken_269392 != -1) {
    dispatch_once(&sentinelParentUUID_onceToken_269392, &__block_literal_global_59_269393);
  }
  v2 = (void *)sentinelParentUUID_sentinelParentUUID_269394;
  return (NSUUID *)v2;
}

void __40__HMDCameraClipModel_sentinelParentUUID__block_invoke()
{
  uint64_t v0 = [objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:@"C795FE32-95CB-4EE4-9197-6E572C6C2365"];
  v1 = (void *)sentinelParentUUID_sentinelParentUUID_269394;
  sentinelParentUUID_sentinelParentUUID_269394 = v0;
}
...
+ (id)hmbQueries
{
  ...
  v11[5] = v8;
  uint64_t v9 = [MEMORY[0x263EFF8C0] arrayWithObjects:v11 count:6];
...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_269404 != -1) {
    dispatch_once(&hmbProperties_onceToken_269404, &__block_literal_global_269405);
  }
  v2 = (void *)hmbProperties_properties_269406;
  return v2;
}
...
void __35__HMDCameraClipModel_hmbProperties__block_invoke()
{
  ...
  v43 = [MEMORY[0x263F492C8] queryableField];
  v50 = v43;
  v42 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v50 count:1];
  v41 = [v0 fieldWithClass:v1 options:v42];
  v52[0] = v41;
  v51[1] = @"isComplete";
  v2 = (void *)MEMORY[0x263F492C0];
  uint64_t v3 = objc_opt_class();
  v40 = [MEMORY[0x263F492C8] queryableField];
  v49 = v40;
  ...
  v4 = (void *)MEMORY[0x263F492C0];
  uint64_t v5 = objc_opt_class();
  v34 = [MEMORY[0x263F492C8] excludeFromCloudStorage];
  v48 = v34;
  v33 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v48 count:1];
  ...
  uint64_t v6 = (void *)MEMORY[0x263F492C0];
  uint64_t v7 = objc_opt_class();
  v28 = [MEMORY[0x263F492C8] externalRecordField:@"sa00"];
  v47 = v28;
  v27 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v47 count:1];
  ...
  v8 = (void *)MEMORY[0x263F492C0];
  uint64_t v9 = objc_opt_class();
  v10 = [MEMORY[0x263F492C8] encryptedExternalRecordField:@"ebl00"];
  v46 = v10;
  v11 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v46 count:1];
  v12 = [v8 fieldWithClass:v9 options:v11];
  v52[11] = v12;
  v51[12] = @"feedbackStatusField";
  v13 = (void *)MEMORY[0x263F492C0];
  uint64_t v14 = objc_opt_class();
  v15 = [MEMORY[0x263F492C8] queryableField];
  v45 = v15;
  v16 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v45 count:1];
  v17 = [v13 fieldWithClass:v14 options:v16];
  v52[12] = v17;
  v51[13] = @"qualityField";
  v18 = (void *)MEMORY[0x263F492C0];
  uint64_t v19 = objc_opt_class();
  v20 = [MEMORY[0x263F492C8] queryableField];
  v44 = v20;
  v21 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v44 count:1];
  v22 = [v18 fieldWithClass:v19 options:v21];
  v52[13] = v22;
  uint64_t v23 = [NSDictionary dictionaryWithObjects:v52 forKeys:v51 count:14];
  v24 = (void *)hmbProperties_properties_269406;
  hmbProperties_properties_269406 = v23;
}
...
- (id)createClipWithSignificantEvents:(id)a3
{
  ...
  if (v4 && v5 && v6 && v7 && v8 && v9 && v10)
  {
    v43 = v7;
    v45 = v6;
    uint64_t v12 = objc_msgSend(objc_alloc(MEMORY[0x263F0E1A0]), "initWithKey:scheme:", v4, objc_msgSend(v5, "unsignedIntegerValue"));
    ...
    id v27 = objc_alloc(MEMORY[0x263F0E190]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v53 = 2112;
      v54 = v23;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Cannot create clip from model: %@", buf, 0x16u);
...
id __54__HMDCameraClipModel_createClipWithSignificantEvents___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4)
  {
    ...
    {
      id v6 = objc_alloc(MEMORY[0x263F0E1C8]);
    ...
    {
      uint64_t v12 = objc_msgSend(objc_alloc(MEMORY[0x263F0E1D0]), "initWithByteLength:byteOffset:", -[HMDCameraClipSegmentMetadata byteLength](v5, "byteLength"), -[HMDCameraClipSegmentMetadata byteOffset](v5, "byteOffset"));
    }
    v18 = (void *)v12;
  }
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v22 = 2112;
      uint64_t v23 = v17;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode video segment metadata for clip %@", (uint8_t *)&v20, 0x16u);
    }
    v18 = 0;
  }
