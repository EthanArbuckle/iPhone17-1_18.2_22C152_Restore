...
+ (id)properties
{
  ...
  block[4] = a1;
  if (properties_onceToken_154764 != -1) {
    dispatch_once(&properties_onceToken_154764, block);
  }
  v2 = (void *)properties__properties_154765;
  return v2;
}
...
void __55__HMDCharacteristicThresholdRangeEventModel_properties__block_invoke(uint64_t a1)
{
  ...
  v4 = (void *)properties__properties_154765;
  properties__properties_154765 = v3;

  v5 = (void *)properties__properties_154765;
  v10[0] = @"min";
