    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v22 = 2112;
        v23 = v5;
        _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to get language constraints from language setting: %@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v22 = 2112;
      v23 = v3;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to get language setting from root group: %@", buf, 0x16u);
    }
    v9 = (void *)MEMORY[0x263EFFA68];
  }
...
id __51__HMDAccessorySettingsController_languageValueList__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v6)
  {
    ...
    if ((unint64_t)[v8 count] > 2)
    {
      ...
      v13 = (void *)[objc_alloc(MEMORY[0x263F0E740]) initWithInputLanguageCode:v18 outputVoiceLanguageCode:v19 outputVoiceGenderCode:v20 voiceName:v21];
    }
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v25 = 2112;
        id v26 = v7;
        _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to get expected language code count from legacy language setting encoding: %@", (uint8_t *)&v23, 0x16u);
      }
      v13 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v25 = 2112;
      id v26 = v3;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to get legacy langage setting encoding from language constaint: %@", (uint8_t *)&v23, 0x16u);
    }
    v13 = 0;
  }
...
- (void)legacySettingsAdaptor:(id)a3 didUpdateSettingKeyPath:(id)a4 selectedLanguageValue:(id)a5 availableLanguageList:(id)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v24 = 2112;
    id v25 = v13;
    _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Did update setting from keyPath:%@ value = %@, availableLanguageList = %@", (uint8_t *)&v18, 0x2Au);
  }
}
...
- (void)legacySettingsAdaptor:(id)a3 didUpdateSettingKeyPath:(id)a4 numberValue:(id)a5
{
  ...
  if (v11)
  {
    ...
    if ((v14 & 1) == 0)
    {
      id v15 = (void *)MEMORY[0x263F0E048];
      v16 = objc_msgSend(NSNumber, "numberWithInteger:", objc_msgSend(v10, "integerValue"));
      v17 = [v15 scaleDownNumberSettingValue:v16];

      if ([MEMORY[0x263F0E048] isKeyPathForTapAssistanceSelectionSettingType:v9])
      {
        uint64_t v18 = [v17 integerValue];
        v19 = [MEMORY[0x263F0E048] tapAssistanceSelectionItemWithIndex:v18];
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v43 = 2114;
          v44 = v19;
          _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Updated setting keyPath: %{public}@ to %{public}@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v43 = 2114;
          v44 = v17;
          _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_DEFAULT, "%{public}@Updating setting keyPath: %{public}@ on notification from adaptor to %{public}@", buf, 0x20u);
        }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v41 = 2114;
      id v42 = v9;
      _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_ERROR, "%{public}@Did not find setting with keyPath: %{public}@ on update from fetched settings adaptor", buf, 0x16u);
    }
  }
}
...
void __92__HMDAccessorySettingsController_legacySettingsAdaptor_didUpdateSettingKeyPath_numberValue___block_invoke(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v17 = 2112;
    id v18 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Updated setting keyPath: %{public}@ with error %@", (uint8_t *)&v13, 0x20u);
  }
}
...
void __92__HMDAccessorySettingsController_legacySettingsAdaptor_didUpdateSettingKeyPath_numberValue___block_invoke_196(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v15 = 2114;
    v16 = v12;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Updated setting keyPath: %{public}@", (uint8_t *)&v13, 0x16u);
  }
}
    ...
    if ((v13 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v29 = 2114;
        v30 = v11;
        _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Updating setting keyPath: %{public}@ on notification from adaptor to %{public}@", buf, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v27 = 2114;
      id v28 = v9;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Did not find setting with keyPath: %{public}@ on update from fetched settings adaptor", buf, 0x16u);
    }
  }
}
    ...
    if (!v2)
    {
      ...
      if (v3)
      {
        if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
        {
          ...
          int v10 = 138543362;
          id v11 = v8;
          _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Already initiated settings creation for older software counterpart. Will not attempt again", (uint8_t *)&v10, 0xCu);
        }
      }
      else
      {
        if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
        {
          ...
          int v10 = 138543362;
          id v11 = v9;
          _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Detected no settings with older software counterpart. Will create settings.", (uint8_t *)&v10, 0xCu);
        }
...
uint64_t __53__HMDAccessorySettingsController_updateSettingOwner___block_invoke(uint64_t a1)
{
  ...
  {
    int v3 = (void *)MEMORY[0x230FBD990]();
    id v4 = *(id *)(a1 + 32);
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v10 = 2112;
      id v11 = v7;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Updating setting owner to %@", (uint8_t *)&v8, 0x16u);
    }
...
- (id)modelObjectsForSettings
{
  ...
  {
    int v3 = (void *)MEMORY[0x263EFFA68];
  }
...
- (void)configureIsSettingOwner:(BOOL)a3 migrationOwner:(BOOL)a4 home:(id)a5 legacySettingsAdaptor:(id)a6
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v42 = 2112;
    __int16 v43 = v19;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Configuring settingOwner: %@, migrationOwner: %@, rootGroup: %@", buf, 0x2Au);
...
- (NSString)siriLanguage
{
  ...
  if (v3)
  {
    ...
    if (objc_msgSend(v9, "hmf_isEmpty"))
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        int v20 = 138543362;
        id v21 = v13;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse siri language componenets", (uint8_t *)&v20, 0xCu);
      }
      char v14 = 0;
    }
    else
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      int v20 = 138543362;
      id v21 = v18;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch siri language because the HMDAccessorySetting was nil", (uint8_t *)&v20, 0xCu);
    }
    char v14 = 0;
  }
...
- (void)decodeWithCoder:(id)a3
{
  ...
  BOOL v8 = (void *)MEMORY[0x230FBD990]([(HMDAccessorySettingsController *)self setNestedGroupsDataSourcesWithGroup:v7]);
  long long v9 = self;
  id v10 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v16 = 2112;
    uint64_t v17 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Assigning root group on decode. %@", (uint8_t *)&v14, 0x16u);
  }
...
void __83__HMDAccessorySettingsController_didChangeDependantSettings_ownerSettingsKeyPaths___block_invoke(uint64_t a1)
{
  ...
  v2 = (void *)MEMORY[0x230FBD990]([*(id *)(a1 + 32) setOwnerController:*(void *)(a1 + 40)]);
  id v3 = *(id *)(a1 + 32);
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v31 = 2112;
    long long v32 = v7;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Evaluating dependents from %@ to current %@", buf, 0x20u);
  }
  long long v24 = 0u;
  long long v25 = 0u;
  long long v22 = 0u;
      ...
      if (v15 && ([v15 isReflected] & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = v21;
          ...
          __int16 v29 = 2112;
          long long v30 = v16;
          _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Setting %@ became reflected", buf, 0x16u);
        }
        char v12 = 1;
        [v16 setReflected:1];
      }
  ...
  if (self && v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v13 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Accessory settings languages did change, resuming language change timer", buf, 0xCu);
    }
...
- (void)handleLanguageChangeTimerFired
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v8 = 138543362;
    uint64_t v9 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Accessory settings language change timer did fire, notifying delegate", (uint8_t *)&v8, 0xCu);
  }
...
- (void)handleRemovedSettingConstraintModel:(id)a3 completion:(id)a4
{
  ...
  if (v10)
  {
    ...
    if (v12)
    {
      if (v16)
      {
        ...
        __int16 v30 = 2112;
        id v31 = v14;
        _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Removed constraint: %@ from setting: %@", (uint8_t *)&v26, 0x20u);
      }
    ...
    else
    {
      if (v16)
      {
        ...
        __int16 v30 = 2112;
        id v31 = v14;
        _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Constraint already removed: %@ from setting: %@", (uint8_t *)&v26, 0x20u);
      }
      v7[2](v7, 0);
      char v12 = 0;
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v30 = 2112;
      id v31 = v6;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Setting %@ to remove constraint %@ not found", (uint8_t *)&v26, 0x20u);
    }
    char v12 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
...
- (void)handleUpdatedSettingConstraintModel:(id)a3 completion:(id)a4
{
  ...
  if (v10)
  {
    id v11 = (void *)[objc_alloc(MEMORY[0x263F0E038]) initWithModel:v6];
    if (v11)
    {
      ...
      if (v13)
      {
        if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v39 = 2112;
          __int16 v40 = v11;
          _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Constraint already exists and is not mutable: %@", buf, 0x16u);
        }
      }
      else
      {
        if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v39 = 2112;
          __int16 v40 = v11;
          _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Added accessory settings constraint: %@", buf, 0x16u);
        }
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v41 = 2112;
          id v42 = v31;
          _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_INFO, "%{public}@Added accessory settings constraint: %@, setting: %@", buf, 0x20u);
    ...
    {
      long long v24 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v41 = 2112;
      id v42 = v6;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Setting %@ to add constraint %@ not found", buf, 0x20u);
    }
...
- (void)handleRemovedSettingModel:(id)a3 completion:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v24 = 2112;
      long long v25 = v20;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Setting with id %@ not found", (uint8_t *)&v22, 0x16u);
    }
    long long v21 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
...
LABEL_10:
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v24 = 2112;
    long long v25 = v8;
    _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Parent group %@ to add setting %@ not found", (uint8_t *)&v20, 0x20u);
  }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v37 = 2112;
          id v38 = v25;
          _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@Setting changed %@ value", buf, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v37 = 2112;
        id v38 = v19;
        _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive accessory setting supported value from model's value: %@", buf, 0x16u);
      }
      id v18 = 0;
      uint64_t v23 = 0;
    }
  ...
  if (v10)
  {
    ...
    if (v17)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v30 = 2112;
        id v31 = v22;
        _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Root group model %@ was removed %@", (uint8_t *)&v26, 0x20u);
      }
...
- (void)handleUpdatedGroupModel:(id)a3 completion:(id)a4
{
  ...
  if (!v8)
  {
    id v25 = (void *)MEMORY[0x230FBD990](v9);
    int v26 = self;
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v47 = 2112;
      v48 = v6;
      _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_ERROR, "%{public}@Unable to decode group from model %@", (uint8_t *)&v45, 0x16u);
    }
  ...
  if (!v12)
  {
    id v31 = [(HMDAccessorySettingsController *)self groupsMap];
    uint64_t v32 = [(HMDAccessorySettingGroup *)v6 parentUUID];
    uint64_t v33 = [v31 objectForKey:v32];

    if (v33)
    {
      id v34 = (void *)MEMORY[0x230FBD990]([(HMDAccessorySettingGroup *)v33 addGroup:v8]);
      char v35 = self;
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v49 = 2112;
        v50 = v33;
        _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_INFO, "%{public}@Added group %@ to %@", (uint8_t *)&v45, 0x20u);
      }
    ...
    if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
    {
      ...
      uint64_t v44 = [(HMDAccessorySettingGroup *)v6 parentUUID];
      int v45 = 138543874;
      v46 = v43;
      __int16 v47 = 2112;
      v48 = v44;
      __int16 v49 = 2112;
      v50 = v8;
      _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_ERROR, "%{public}@Parent group %@ to add group %@ not found", (uint8_t *)&v45, 0x20u);
    }
    id v29 = (void *)MEMORY[0x263F087E8];
    uint64_t v30 = 2;
LABEL_24:
    uint64_t v39 = [v29 hmErrorWithCode:v30];
    v7[2](v7, v39);
    goto LABEL_25;
  }
  uint64_t v13 = (void *)MEMORY[0x230FBD990]();
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v49 = 2112;
    v50 = v17;
    _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Assigning root group from transaction model: %@ id: %@.", (uint8_t *)&v45, 0x20u);
  }
  id v18 = [(HMDAccessorySettingsController *)v14 rootGroup];
  ...
  if (v19)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v24 = [(HMDAccessorySettingsController *)v21 rootGroup];
      int v45 = 138543874;
      v46 = v23;
      __int16 v47 = 2112;
      v48 = v24;
      __int16 v49 = 2112;
      v50 = v8;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@RootGroup changing unexpectedly %@ / %@.", (uint8_t *)&v45, 0x20u);
    }
  }
...
LABEL_19:
  [(HMDAccessorySettingsController *)self settingsHierarchyDidChange];
  v7[2](v7, 0);
  id v38 = [(HMDAccessorySettingsController *)self ownerController];
  uint64_t v39 = v38;
  if (v38) {
    [v38 scheduleAuditWithReason:4 from:self];
  }
LABEL_25:
}
...
- (void)_removeManagedConfigurationProfile:(id)a3 completion:(id)a4
{
  ...
  if (v6)
  {
    ...
    if (v8)
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        int v22 = 138543362;
        uint64_t v23 = v13;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Remove managed configuration profile", (uint8_t *)&v22, 0xCu);
      }
    ...
    else
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        int v22 = 138543362;
        uint64_t v23 = v19;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Nil datasource.", (uint8_t *)&v22, 0xCu);
      }
      int v20 = (void (**)(void *, void *))_Block_copy(v7);
      if (v20)
      {
        long long v21 = [MEMORY[0x263F087E8] hmErrorWithCode:20];
        v20[2](v20, v21);
      }
      id v8 = 0;
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      int v22 = 138543362;
      uint64_t v23 = v17;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Managed configuration profile data is nil", (uint8_t *)&v22, 0xCu);
    }
...
- (BOOL)canUser:(id)a3 editConstraintsForSetting:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v7;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@User %@ cannot edit accessory setting with UUID %@ because it does not exist.", (uint8_t *)&v17, 0x20u);
    }
    BOOL v11 = 0;
  }
...
- (BOOL)canUser:(id)a3 editConstraintsForSettingWithKeyPath:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v7;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@User %@ cannot edit accessory setting at key path %@ because it does not exist.", (uint8_t *)&v17, 0x20u);
    }
    BOOL v11 = 0;
  }
...
- (void)_replaceConstraintsOnMessageToChildWithAdditions:(id)a3 removedChildConstraints:(id)a4 settingKeyPath:(id)a5 senderProductClass:(int64_t)a6 completion:(id)a7
{
  ...
  if (v16)
  {
    ...
    id v54 = v14;
    id v56 = v12;
    int v17 = objc_msgSend(objc_alloc(MEMORY[0x263EFF980]), "initWithCapacity:", objc_msgSend(v13, "count"));
    long long v57 = 0u;
    long long v58 = 0u;
    long long v59 = 0u;
    long long v60 = 0u;
          ...
          if (!v24)
          {
            ...
            if (os_log_type_enabled(v36, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v64 = 2112;
              id v65 = v23;
              _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_DEFAULT, "%{public}@Didn't find constraints to remove in Owner Controller %@", buf, 0x16u);
            }
            id v38 = [MEMORY[0x263F087E8] hmErrorWithCode:2 description:@"Constraint not found in owner controller" reason:@"Did not find constraint in owner controller" suggestion:0];
            v15[2](v15, v38);
    ...
    id v12 = v56;
    int v26 = (void *)[objc_alloc(MEMORY[0x263EFF8C0]) initWithArray:v56 copyItems:1];
    ...
    if (v27 == [v18 count])
    {
      if ([(HMDAccessorySettingsController *)self isProxy])
      {
        if (v53 != 6)
        {
          v48 = objc_msgSend(v17, "na_map:", &__block_literal_global_179);
          __int16 v49 = [(HMDAccessorySettingsController *)self messageHandler];
          v50 = [(HMDAccessorySettingsController *)self delegate];
          uint64_t v51 = [v16 identifier];
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v64 = 2112;
          id v65 = v16;
          _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_ERROR, "%{public}@Cannot relay constraint replacement to child for setting(%@) to a second AudioAccessory", buf, 0x16u);
        }
        ...
        uint64_t v33 = [MEMORY[0x263F087E8] hmErrorWithCode:-1 description:@"Cannot relay to an AudioAccessory multiple times" reason:@"Failed to handle relay." suggestion:0];
        v15[2](v15, v33);
...
LABEL_28:
    ...
    else
    {
      ...
      uint64_t v44 = self;
      int v45 = HMFGetOSLogHandle();
      if (os_log_type_enabled(v45, OS_LOG_TYPE_DEFAULT))
      {
        v46 = HMFGetLogIdentifier();
        *(_DWORD *)buf = 138543362;
        v63 = v46;
        _os_log_impl(&dword_22F52A000, v45, OS_LOG_TYPE_DEFAULT, "%{public}@Didn't find same number of constraints to remove", buf, 0xCu);
      }
      __int16 v47 = [MEMORY[0x263F087E8] hmErrorWithCode:2 description:@"Constraints don't match" reason:@"Didn't find same number of constraints to remove in media system" suggestion:0];
      v15[2](v15, v47);
    }
LABEL_26:
    id v13 = v55;
  ...
  if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v64 = 2112;
    id v65 = v14;
    _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_ERROR, "%{public}@Setting not found for keyPath %@", buf, 0x16u);
  }
  int v17 = [MEMORY[0x263F087E8] hmfErrorWithCode:2];
  v15[2](v15, v17);
LABEL_29:
}
...
- (void)_replaceConstraintsOnSetting:(id)a3 additions:(id)a4 removals:(id)a5 completion:(id)a6
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v117 = 2112;
    id v118 = v11;
    _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Replacing constraints, %@, with constraint, %@", buf, 0x20u);
  }
  uint64_t v19 = (void *)MEMORY[0x230FBD990]();
  uint64_t v20 = v16;
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v115 = 2112;
    id v116 = v12;
    _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Removing constraints: %@", buf, 0x16u);
  }
      ...
      if (v36)
      {
        ...
        if (os_log_type_enabled(v77, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v115 = 2112;
          id v116 = v28;
          _os_log_impl(&dword_22F52A000, v77, OS_LOG_TYPE_ERROR, "%{public}@Constraint has already been removed %@", buf, 0x16u);
        }
...
LABEL_45:
    ...
    if (os_log_type_enabled(v70, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v114 = v71;
      _os_log_impl(&dword_22F52A000, v70, OS_LOG_TYPE_ERROR, "%{public}@Didn't find same number of constraints to remove", buf, 0xCu);
    }
    v72 = (void *)MEMORY[0x263F087E8];
...
LABEL_14:
  ...
  if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v115 = 2112;
    id v116 = v11;
    _os_log_impl(&dword_22F52A000, v40, OS_LOG_TYPE_INFO, "%{public}@Adding constraints: %@", buf, 0x16u);
  }
  long long v103 = 0u;
  long long v104 = 0u;
  long long v101 = 0u;
  ...
  if (v43)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        __int16 v47 = *(void **)(*((void *)&v101 + 1) + 8 * v46);
        v48 = [v10 identifier];
        __int16 v49 = [v47 modelWithParentIdentifier:v48];
  ...
  if (!*(void *)(a1 + 48))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v24 = 2112;
      uint64_t v25 = v14;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Successfully replaced %@ constraints with %@ constraints.", buf, 0x20u);
    }
  }
          ...
          if (!v26)
          {
                  ...
                  (int v26 = objc_claimAutoreleasedReturnValue()) == 0))
            {
              ...
              if (os_log_type_enabled(v44, OS_LOG_TYPE_DEFAULT))
              {
                ...
                __int16 v47 = [v18 constraintsForCodingXPC];
                *(_DWORD *)buf = 138544130;
                long long v95 = v45;
                __int16 v96 = 2112;
                id v97 = v25;
                ...
                __int16 v100 = 2112;
                long long v101 = v47;
                _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to find constraint identifier: %@, currentConstraints: %@, allConstraints: %@", buf, 0x2Au);
              }
              v48 = [MEMORY[0x263F087E8] hmErrorWithCode:2 description:@"Constraint not found" reason:@"Failed to find constraint" suggestion:0];
              id v16 = v78;
      ...
      if (v30)
      {
        ...
        if (os_log_type_enabled(v33, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v98 = 2112;
          long long v99 = v28;
          _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_DEFAULT, "%{public}@Forwarding replace constraints for %@ to owner controller. %@", buf, 0x20u);
        }
    ...
    if ([(HMDAccessorySettingsController *)self isProxy])
    {
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v96 = 2112;
        id v97 = v77;
        _os_log_impl(&dword_22F52A000, v51, OS_LOG_TYPE_ERROR, "%{public}@Cannot relay constraint replacement(%@) to a second AudioAccessory", buf, 0x16u);
      ...
      id v54 = [MEMORY[0x263F087E8] hmErrorWithCode:-1 description:@"Cannot relay to an AudioAccessory multiple times" reason:@"Failed to handle relay." suggestion:0];
...
LABEL_48:
        ...
        v72 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
      ...
      if ([v19 count] == 1)
      {
        ...
        if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v96 = 2112;
          id v97 = v65;
          _os_log_impl(&dword_22F52A000, v68, OS_LOG_TYPE_INFO, "%{public}@Remove managed configuration profile for constraint: %@", buf, 0x16u);
        }
        v70 = [v65 value];
        v71 = [v70 value];
    ...
    _os_log_impl(&dword_22F52A000, v57, OS_LOG_TYPE_ERROR, v59, buf, 0x16u);
  ...
  if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v96 = 2112;
    id v97 = v15;
    _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_ERROR, "%{public}@Setting not found for key path %@", buf, 0x16u);

    id v16 = v40;
  }

  long long v19 = [MEMORY[0x263F087E8] hmfErrorWithCode:2];
...
void __144__HMDAccessorySettingsController_onMessageReplaceConstraintsWithAdditions_constraintIdsToRemove_keyPath_senderProductClass_isRemote_completion___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v8;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Got response from owner failing current %@.", (uint8_t *)&v11, 0x16u);
  }
...
- (void)_cacheConstraintAdditions:(id)a3 removals:(id)a4 setting:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v21 = 2112;
    id v22 = v9;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@%@ caching additions %@, removals %@", (uint8_t *)&v15, 0x2Au);
  }
  ...
  if (!v11)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v55 = 2112;
      id v56 = v9;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Setting not found for key path %@", buf, 0x16u);
    }
    uint64_t v19 = [MEMORY[0x263F087E8] hmfErrorWithCode:2];
    goto LABEL_9;
  }
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v55 = 2112;
      id v56 = v12;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Cannot update constraints on atomic setting %@", buf, 0x16u);
    }
    uint64_t v19 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
LABEL_9:
  ...
  if (v24)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v54 = v28;
      _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Ignoring owner controller for updating constraint.", buf, 0xCu);
    }
  }
  if ([(HMDAccessorySettingsController *)self isProxy])
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v54 = v32;
      _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@Only the setting owner is allowed to remove constraints.", buf, 0xCu);
    }
    id v33 = [MEMORY[0x263F087E8] hmErrorWithCode:10];
  ...
  else
  {
    ...
    if ([v33 count])
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v54 = v37;
        _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_INFO, "%{public}@Updating constraints", buf, 0xCu);
      }
      id v38 = [(HMDAccessorySettingsController *)v35 dataSource];
      uint64_t v39 = [v38 backingStore];
...
- (void)onMessageRemoveConstraint:(id)a3 keyPath:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[22] = 2112;
    id v33 = v9;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Received remove constraint request %@ for setting %@", buf, 0x20u);
  }
  *(void *)buf = 0;
  *(void *)&buf[8] = buf;
  *(void *)&buf[16] = 0x3032000000;
  id v33 = __Block_byref_object_copy__219043;
  id v34 = __Block_byref_object_dispose__219044;
...
void __79__HMDAccessorySettingsController_onMessageRemoveConstraint_keyPath_completion___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v50 = 2112;
    long long v51 = v2;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Executing remove constraint request %@ for setting %@", buf, 0x20u);
  }
  if (!v2)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v48 = 2112;
      long long v49 = v20;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Setting not found for key path %@", buf, 0x16u);
    }
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v48 = 2112;
      long long v49 = v2;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Cannot remove constraint on atomic setting %@", buf, 0x16u);
    }
    uint64_t v14 = *(void *)(a1 + 56);
    uint64_t v15 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
LABEL_11:
  ...
  if (v21)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v47 = v25;
      _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@Ignoring owner controller for removing constraint.", buf, 0xCu);
    }
  }
  if ([*(id *)(a1 + 32) isProxy])
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v47 = v29;
      _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Only the setting owner is allowed to remove constraints.", buf, 0xCu);
    }
    uint64_t v30 = *(void *)(a1 + 56);
    id v31 = [MEMORY[0x263F087E8] hmErrorWithCode:10];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v50 = 2112;
      long long v51 = v2;
      _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_INFO, "%{public}@Removing constraint %@ from setting %@", buf, 0x20u);
    }
    __int16 v37 = [HMDAccessorySettingConstraintModel alloc];
    id v38 = [*(id *)(a1 + 48) identifier];
    uint64_t v39 = [v2 identifier];
...
- (void)onMessageAddConstraint:(id)a3 keyPath:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[22] = 2112;
    id v33 = v9;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Received add constraint request %@ for setting %@", buf, 0x20u);
  }
  *(void *)buf = 0;
  *(void *)&buf[8] = buf;
  *(void *)&buf[16] = 0x3032000000;
...
void __76__HMDAccessorySettingsController_onMessageAddConstraint_keyPath_completion___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v56 = 2112;
    uint64_t v57 = v2;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Executing add constraint request %@ for setting %@", buf, 0x20u);
  }
  if (!v2)
  {
    id v16 = (void *)MEMORY[0x230FBD990]();
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v54 = 2112;
      __int16 v55 = v2;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Cannot add constraint on atomic setting %@", buf, 0x16u);
    }
    uint64_t v14 = *(void *)(a1 + 56);
    uint64_t v15 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
LABEL_11:
  ...
  if (v21)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      int64_t v53 = v25;
      _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@Ignoring owner controller for adding constraint.", buf, 0xCu);
    }
  }
  if ([*(id *)(a1 + 32) isProxy])
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      int64_t v53 = v29;
      _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Only the setting owner is allowed to add constraints.", buf, 0xCu);
    }
    uint64_t v30 = *(void *)(a1 + 56);
    id v31 = [MEMORY[0x263F087E8] hmErrorWithCode:10];
    ...
    if (v33)
    {
      if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v56 = 2112;
        uint64_t v57 = v2;
        _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_INFO, "%{public}@Adding constraint %@ on setting %@", buf, 0x20u);
      }
      id v40 = *(void **)(a1 + 48);
    ...
    else
    {
      if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v58 = 2112;
        id v59 = v31;
        _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_ERROR, "%{public}@Constraint %@ cannot be added to setting %@. error: %@", buf, 0x2Au);
      }
...
- (void)_runUpdateTransactionWithValue:(id)a3 setting:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v47 = 2112;
    id v48 = v8;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Updating %@ value from %@ to %@", buf, 0x2Au);
  }
  ...
  if (v16)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v42 = v21;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Will remove owner from access control on language change.", buf, 0xCu);
    }
    ...
    if ([(HMDAccessorySettingsController *)self isProxy])
    {
      if (a6 == 6)
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v71 = 2112;
          id v72 = v13;
          _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Cannot relay update value on setting(%@) to a second AudioAccessory", buf, 0x16u);
        }
        ...
        id v31 = [MEMORY[0x263F087E8] hmErrorWithCode:-1 description:@"Cannot relay to an AudioAccessory multiple times" reason:@"Failed to handle relay." suggestion:0];
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v71 = 2112;
        id v72 = v31;
        _os_log_impl(&dword_22F52A000, v43, OS_LOG_TYPE_INFO, "%{public}@Forwarding update value message to owner device %@.", buf, 0x16u);
      }
    ...
    else
    {
      ...
      if (!v32)
      {
        ...
        else
        {
          ...
          {
            id v51 = [MEMORY[0x263F087E8] hmErrorWithCode:10];
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v71 = 2114;
        id v72 = v37;
        _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_INFO, "%{public}@Delegating update for %{public}@ to adaptor", buf, 0x16u);
      }
      id v38 = [v13 keyPath];
...
LABEL_19:
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v73 = 2112;
    uint64_t v74 = v17;
    _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Forwarding update value for %@ to owner controller. %@", buf, 0x20u);
  }
  ...
  else
  {
    if ([*(id *)(a1 + 32) configurationVersion] >= a3)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v30 = 2048;
        uint64_t v31 = v22;
        _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Not changing locally as the new config version isnt higher %tu (current %tu)", (uint8_t *)&v26, 0x20u);
      }
    }
    else
    {
      ...
      if (v11)
      {
        if (v15)
        {
          ...
          _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Not updating the value from %@ as the new value is same", (uint8_t *)&v26, 0x16u);
        }
      }
      else
      {
        if (v15)
        {
          ...
          _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Updating the value locally from %@ to %@", (uint8_t *)&v26, 0x20u);
        }
...
void __102__HMDAccessorySettingsController__updateValue_forSetting_senderVersion_senderProductClass_completion___block_invoke_122(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    id v16 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Adaptor update result keyPath:%{public}@ error: %@", (uint8_t *)&v11, 0x20u);
  }
  if (v3)
  {
...
- (void)_onMessageUpdateValue:(id)a3 settingKeyPath:(id)a4 senderVersion:(id)a5 senderProductClass:(int64_t)a6 completion:(id)a7
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v25 = 2112;
      id v26 = v13;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Setting not found for keyPath %@", (uint8_t *)&v23, 0x16u);
    }
    uint64_t v22 = [MEMORY[0x263F087E8] hmfErrorWithCode:2];
...
- (void)onMessageUpdateValue:(id)a3 settingKeyPath:(id)a4 senderVersion:(id)a5 senderProductClass:(int64_t)a6 completion:(id)a7
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v25 = 2112;
      id v26 = v13;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Setting not found for key path %@", (uint8_t *)&v23, 0x16u);
    }
    uint64_t v22 = [MEMORY[0x263F087E8] hmfErrorWithCode:2];
    (*((void (**)(id, void, void, void *))v15 + 2))(v15, 0, 0, v22);
  }
...
- (void)onMessageUpdateValue:(id)a3 settingIdentifier:(id)a4 senderVersion:(id)a5 senderProductClass:(int64_t)a6 completion:(id)a7
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v26 = 2112;
      id v27 = v13;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Setting not found for identifier %@", (uint8_t *)&v24, 0x16u);
    }
    int v23 = [MEMORY[0x263F087E8] hmfErrorWithCode:2];
...
void __58__HMDAccessorySettingsController_owner_didUpdateSettings___block_invoke(id *a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v52 = 2112;
    id v53 = v6;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Owner %@ sent fix settings request", buf, 0x16u);
  }
          ...
          if ((v20 & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138544386;
              ...
              __int16 v58 = 2112;
              id v59 = v16;
              _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Comparing between %@ and owner %@, Values are not matching: %@, %@", buf, 0x34u);
            ...
            if ([v34 count])
            {
              ...
              if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = v40;
                ...
                __int16 v56 = 2112;
                id v57 = v39;
                _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_INFO, "%{public}@Added constraints %@ in fixup %@ and owner %@.", buf, 0x2Au);
              }
              [v43 addObjects:v34];
              char v12 = 1;
              id v10 = v42;
...
void __56__HMDAccessorySettingsController_scheduleDependantFixup__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v19 = 2112;
    char v20 = v6;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Received request to fix settings for dependents: %@", (uint8_t *)&v17, 0x16u);
  }
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      int v17 = 138543362;
      int v18 = v11;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@There is already an fix setting request in queue, kicking it again", (uint8_t *)&v17, 0xCu);
    }
...
- (void)_performDependantFixup
{
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v36 = 2112;
    __int16 v37 = v6;
    _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Performing dependent fixup with %@", buf, 0x16u);
  }
  long long v27 = 0u;
  long long v28 = 0u;
  long long v25 = 0u;
...
- (void)_migrateSettingsWithCompletion:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    char v33 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Check if migration is required.", buf, 0xCu);
  }
  ...
  if (v11 && [v11 count])
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v34 = 2112;
      id v35 = v12;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Have settings to migrate. %@", buf, 0x16u);
    }
...
void __65__HMDAccessorySettingsController__migrateSettingsWithCompletion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v9 = 138543362;
    uint64_t v10 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Finished migrating settings.", (uint8_t *)&v9, 0xCu);
  }
  uint64_t v8 = *(void *)(a1 + 40);
  if (v8) {
...
- (void)_createSettings
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v39 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Is setting migration owner will create settings.", buf, 0xCu);
  }
  ...
  if (v10)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_signpost_emit_with_name_impl(&dword_22F52A000, logger, OS_SIGNPOST_INTERVAL_BEGIN, 0xEEEEB0B5B2B2EEEELL, "SettingsCreate", "", buf, 2u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v39 = v29;
      _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Did not find any models to create settings.", buf, 0xCu);
    }
  }
}
...
void __49__HMDAccessorySettingsController__createSettings__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v34 = 138543362;
    long long v35 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Finished creating settings.", (uint8_t *)&v34, 0xCu);
  }
  ...
  char v12 = &stru_26E2EB898;
  if (v10) {
    char v12 = (__CFString *)v10;
  }
  v39[1] = v12;
  id v13 = (id)[NSDictionary dictionaryWithObjects:v39 forKeys:v38 count:2];
  ...
  {
    LOWORD(v34) = 0;
    _os_signpost_emit_with_name_impl(&dword_22F52A000, v16, OS_SIGNPOST_INTERVAL_END, v17, "SettingsCreate", "", (uint8_t *)&v34, 2u);
  }
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v36 = 2048;
    double v37 = v22;
    _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Setup start timestamp %f", (uint8_t *)&v34, 0x16u);
  }
  __uint64_t v23 = clock_gettime_nsec_np(_CLOCK_MONOTONIC_RAW);
  uint64_t v24 = [*(id *)(a1 + 40) setupStartTimestamp];
  double v26 = v25;
  long long v27 = (void *)MEMORY[0x230FBD990](v24);
  id v28 = *(id *)(a1 + 32);
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v36 = 2048;
    double v37 = v31;
    _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_INFO, "%{public}@Settings creation latency %f", (uint8_t *)&v34, 0x16u);
  }
...
void __47__HMDAccessorySettingsController_timerDidFire___block_invoke(uint64_t a1)
{
  ...
  if (v2 == v3)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      int v14 = 138543362;
      id v15 = v13;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Fix settings timer has fired, issuing fix settings", (uint8_t *)&v14, 0xCu);
    }
  ...
  else
  {
    ...
    if (v4 == v5)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        int v14 = 138543362;
        id v15 = v9;
        _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Audit settings timer has fired, issuing audit for settings", (uint8_t *)&v14, 0xCu);
      }
...
LABEL_8:
    _os_log_impl(&dword_22F52A000, v9, v10, v8, buf, 0xCu);
...
uint64_t __63__HMDAccessorySettingsController_scheduleAuditWithReason_from___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v7;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Received audit with reason %@ from %@", (uint8_t *)&v9, 0x20u);
  }
...
- (void)_scheduleAuditWithReason:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v25 = 2112;
    double v26 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Received audit with reason %@", (uint8_t *)&v23, 0x16u);
  }
  if ([(HMDAccessorySettingsController *)v6 hasCreatedUnprocessedRootGroup])
  {
    os_log_type_t v10 = (void *)MEMORY[0x230FBD990]();
    __int16 v11 = v6;
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      int v23 = 138543362;
      uint64_t v24 = v13;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Not scheduling audit as the root group has been created but not processed yet", (uint8_t *)&v23, 0xCu);
    }
  }
  else
  {
    ...
    if (v14)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        int v23 = 138543362;
        uint64_t v24 = v18;
        _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@There is already an fix setting request in queue, kicking it again", (uint8_t *)&v23, 0xCu);
      }
...
- (void)settingsHierarchyDidChange
{
  ...
  v18[1] = v18;
  v18[2] = 0x3032000000;
  v18[3] = __Block_byref_object_copy__219043;
  v18[4] = __Block_byref_object_dispose__219044;
  id v19 = 0;
  v16[0] = 0;
  v16[1] = v16;
  v16[2] = 0x3032000000;
  void v16[3] = __Block_byref_object_copy__219043;
  v16[4] = __Block_byref_object_dispose__219044;
  id v17 = 0;
  v14[0] = 0;
  v14[1] = v14;
  v14[2] = 0x3032000000;
  v14[3] = __Block_byref_object_copy__219043;
  v14[4] = __Block_byref_object_dispose__219044;
  id v15 = 0;
  v12[0] = 0;
  v12[1] = v12;
  v12[2] = 0x3032000000;
  v12[3] = __Block_byref_object_copy__219043;
  v12[4] = __Block_byref_object_dispose__219044;
  id v13 = 0;
  p_lock = &self->_lock;
...
void __60__HMDAccessorySettingsController_settingsHierarchyDidChange__block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    __int16 v40 = 2112;
    uint64_t v41 = v9;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Added groups: %@, settings: %@. Removed groups: %@, settings: %@", buf, 0x34u);
  }
  long long v29 = 0u;
  long long v30 = 0u;
  long long v27 = 0u;
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v38 = 2112;
    uint64_t v39 = v26;
    _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Current root:%@, settings: %@, groups: %@", buf, 0x2Au);
  }
}
...
LABEL_11:
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v27 = 2112;
      long long v28 = v19;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Filtering out keyPath = %@, filtered? = %@", (uint8_t *)&v23, 0x20u);
    }
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v25 = 2112;
    uint64_t v26 = v5;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to encode xpc settings for controller due to no home for data source: %@", (uint8_t *)&v23, 0x16u);
  }
  LOBYTE(self) = 0;
LABEL_14:
...
{
  BOOL v3 = [a3 keyPath];
  char v4 = [&unk_26E474458 containsObject:v3];
...
- (HMDAccessorySettingsController)initWithParentUUID:(id)a3 codingKey:(id)a4
{
  ...
  uint64_t v9 = *MEMORY[0x263F0B5C0];
  BOOL v10 = [MEMORY[0x263F08C38] UUID];
...
- (HMDAccessorySettingsController)initWithQueue:(id)a3 delegate:(id)a4 dataSource:(id)a5 parentUUID:(id)a6 codingKey:(id)a7 logEventSubmitter:(id)a8 settingOwner:(BOOL)a9 migrationOwner:(BOOL)a10 factory:(id)a11 rootGroup:(id)a12 notificationCenter:(id)a13
{
  ...
  if (v24)
  {
    ...
    uint64_t v27 = [MEMORY[0x263F08968] strongToWeakObjectsMapTable];
    ...
    uint64_t v41 = (NSOperationQueue *)objc_alloc_init(MEMORY[0x263F08A48]);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_219178 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_219178, &__block_literal_global_219179);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v4_219180;
  return v2;
}
...
void __45__HMDAccessorySettingsController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_219180;
  logCategory__hmf_once_v4_219180 = v0;
}
