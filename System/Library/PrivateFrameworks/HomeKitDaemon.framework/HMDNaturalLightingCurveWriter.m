    ...
    if (v14)
    {
      if (v18)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v24 = 2112;
        id v25 = v4;
        _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Rewriting the characteristic because timer: %@ fired", buf, 0x16u);
      }
    ...
    else
    {
      if (v18)
      {
        ...
        *(_DWORD *)buf = 138543362;
        v23 = v21;
        _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Canceling periodic characteristic writer timer because natural lighting is no longer enabled", buf, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v26 = 2112;
      id v27 = v4;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Received timer did fire callback for unknown timer. Expected: %@ received: %@", buf, 0x20u);
    }
  }
}
...
- (void)synchronizeCurveWithActiveTransitionContext:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v27 = 138543362;
    uint64_t v28 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Synchronizing curve...", (uint8_t *)&v27, 0xCu);
  }
...
LABEL_14:
      _os_log_impl(&dword_22F52A000, v24, v25, v23, (uint8_t *)&v27, 0xCu);
...
LABEL_13:
  ...
  if (v21)
  {
    ...
    int v27 = 138543362;
    uint64_t v28 = v26;
    _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Start sychronizing curve", (uint8_t *)&v27, 0xCu);
  }
...
- (void)writeWithNaturalLightingEnabled:(BOOL)a3 reason:(id)a4 completion:(id)a5
{
  ...
  if ([(HMDNaturalLightingCurveWriter *)self isCurrentDevicePrimaryResident])
  {
    ...
    {
      uint64_t v18 = [MEMORY[0x263F087E8] hmfErrorWithCode:4];
      v9[2](v9, v18);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v8;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Skipping curve write with reason because current device is not a primary resident: %@", (uint8_t *)&v19, 0x16u);
    }
...
- (void)handleCurrentDevicePrimaryResidentChangedWithReason:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v16 = 2112;
    id v17 = v4;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling current device primary resident changed: %@ with reason: %@", (uint8_t *)&v12, 0x20u);
  }
...
void __73__HMDNaturalLightingCurveWriter_handlePrimaryResidentUpdateNotification___block_invoke(uint64_t a1)
{
  ...
  if (v5 != [*(id *)(a1 + 32) isCurrentDevicePrimaryResident])
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v18 = 2112;
      int v19 = v11;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Current device primary changed from: (%@->%@)", (uint8_t *)&v14, 0x20u);
    }
    ...
    if (v4)
    {
      ...
      if (v12 >= 0.0)
      {
        ...
        if (v28 - v12 <= 0.0)
        {
          ...
          if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
          {
            ...
            __int16 v55 = 2048;
            double v56 = v28;
            _os_log_impl(&dword_22F52A000, v46, OS_LOG_TYPE_INFO, "%{public}@Updating curve since time elapsed since transition start is greater than curve update interval %f:%f", (uint8_t *)&v51, 0x20u);
          }
        ...
        else
        {
          ...
          if (v31 < v34)
          {
            if (v37)
            {
              ...
              __int16 v53 = 2048;
              double v54 = v29;
              _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_INFO, "%{public}@Starting timer for natural lighting curve update: %fs", (uint8_t *)&v51, 0x16u);
            }
          ...
          if (v37)
          {
            ...
            __int16 v59 = 2048;
            uint64_t v60 = v50;
            _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_INFO, "%{public}@Updating curve because accessory time (%fs) and controller time (%fs) difference (%fs) is greater than threshold (%fs)", (uint8_t *)&v51, 0x34u);
          }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
        {
          ...
          _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Updating curve because transition start date is ahead of the current date %@:%@", (uint8_t *)&v51, 0x20u);
        }
...
LABEL_25:
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v53 = 2112;
      double v54 = 0.0;
      _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@Stopping characteristic write timer because active transition context is not set: %@", (uint8_t *)&v51, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      int v51 = 138543362;
      v52 = v21;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Skipping active transition context update because current device is not primary resident", (uint8_t *)&v51, 0xCu);
    }
  }
LABEL_26:
}
...
- (void)configureWithLightProfile:(id)a3
{
  ...
  id v8 = (void *)MEMORY[0x230FBD990]([(HMDNaturalLightingCurveWriter *)self setLightProfile:v4]);
  uint64_t v9 = self;
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v19 = 2112;
    uint64_t v20 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Configuring with home: %@", buf, 0x16u);
  }
...
- (HMDNaturalLightingCurveWriter)initWithUUID:(id)a3 workQueue:(id)a4 logIdentifier:(id)a5
{
  ...
  uint32_t v12 = [MEMORY[0x263F08A00] defaultCenter];
  int v13 = [(HMDNaturalLightingCurveWriter *)self initWithUUID:v10 workQueue:v9 logIdentifier:v8 dataSource:v11 notificationCenter:v12 timerFactory:&__block_literal_global_267523];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t19_267529 != -1) {
    dispatch_once(&logCategory__hmf_once_t19_267529, &__block_literal_global_22_267530);
  }
  v2 = (void *)logCategory__hmf_once_v20_267531;
  return v2;
}
...
void __44__HMDNaturalLightingCurveWriter_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v20_267531;
  logCategory__hmf_once_v20_267531 = v0;
}
