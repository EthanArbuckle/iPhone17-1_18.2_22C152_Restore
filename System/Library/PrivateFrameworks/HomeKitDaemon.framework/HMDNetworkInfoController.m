...
- (HMDNetworkInfoController)init
{
  ...
  v3 = (HMDNetworkInfoController *)sub_22F6AF9B8(v2);
  swift_release();
  swift_getObjectType();
...
- (void)start
{
  ...
  v7 = self;
  uint64_t v8 = v6(0xD000000000000015, 0x80000002303D3650, sub_22F6AFB08, v10, v4, v5);
...
- (id)obtainNetworkInfoProto
{
  ...
  __swift_instantiateConcreteTypeFromMangledName(&qword_2686DA618);
