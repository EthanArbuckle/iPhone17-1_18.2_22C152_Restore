...
- (void)associateToHome:(id)a3 completionHandler:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v59 = v11;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Starting association", buf, 0xCu);
  }
    ...
    if (v16)
    {
      ...
      if (([v17 isCurrentUser] & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v59 = v31;
          _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_DEFAULT, "%{public}@Only the owner of the home can perform association", buf, 0xCu);
        }
        if (v7)
        {
          v42 = [MEMORY[0x263F087E8] hmErrorWithCode:17];
          v7[2](v7, v42);
        }
        goto LABEL_33;
      }
      ...
      if (v41)
      {
        char v40 = objc_msgSend(MEMORY[0x263EFA7C0], "shouldRestrictConnectionWithUserPrivilege:", objc_msgSend(v6, "minimumMediaUserPrivilege"));
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v60 = 2112;
        v61 = v17;
        _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_DEFAULT, "%{public}@Missing authorized peer for user: %@", buf, 0x16u);
      }
      if (v7)
      {
        id v36 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
        v7[2](v7, v36);
LABEL_31:
...
LABEL_33:
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v59 = v27;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Missing output device", buf, 0xCu);
    }
    if (v7)
    {
...
LABEL_34:
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v59 = v23;
    _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Missing advertisement", buf, 0xCu);
  }
  if (v7)
  {
    v16 = [MEMORY[0x263F087E8] hmErrorWithCode:54];
    v7[2](v7, v16);
    goto LABEL_34;
  }
LABEL_35:
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v71 = 2112;
      id v72 = v9;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to update configuration while associating to home with error: %@, %@", buf, 0x20u);
    }
    uint64_t v23 = [MEMORY[0x263F087E8] hmErrorWithCode:54 description:@"Communication failure" reason:@"Failed to set administration password." suggestion:0 underlyingError:v10];
    goto LABEL_16;
  }
...
LABEL_14:
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_DEFAULT, v28, buf, 0xCu);
    }
LABEL_15:
...
LABEL_16:
  ...
  if (v13 && v14)
  {
    id v15 = objc_alloc(MEMORY[0x263F425E8]);
    uint64_t v16 = (void *)[objc_alloc(MEMORY[0x263F425F0]) initWithPairingKeyData:v14];
  ...
  {
    id v18 = [MEMORY[0x263F087E8] hmErrorWithCode:48 description:@"Not supported." reason:@"Accessory missing pairing identity" suggestion:0];
    v17 = 0;
  }
    ...
    if (v32)
    {
      ...
      if (v34 < 2)
      {
        ...
        if (v54)
        {
          ...
          id v55 = (void *)MEMORY[0x230FBD990]([v52 setAssociated:1]);
          id v56 = WeakRetained;
          ...
          if (os_log_type_enabled(v57, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v68 = v58;
            _os_log_impl(&dword_22F52A000, v57, OS_LOG_TYPE_INFO, "%{public}@Successfully associated", buf, 0xCu);
        ...
        if (os_log_type_enabled(v61, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v68 = v62;
          _os_log_impl(&dword_22F52A000, v61, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to set media password", buf, 0xCu);
        }
        char v40 = (void *)MEMORY[0x263F087E8];
        uint64_t v41 = 54;
      }
      else
      {
        ...
        if (os_log_type_enabled(v37, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v69 = 2112;
          id v70 = v39;
          _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_DEFAULT, "%{public}@Unexpected peers found: %@", buf, 0x16u);
...
LABEL_42:
    ...
    if (os_log_type_enabled(v50, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v68 = v51;
      _os_log_impl(&dword_22F52A000, v50, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to add ourselves as a peer", buf, 0xCu);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v44, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v68 = v45;
      _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid or missing pairing identity", buf, 0xCu);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t20 != -1) {
    dispatch_once(&logCategory__hmf_once_t20, &__block_literal_global_54360);
  }
