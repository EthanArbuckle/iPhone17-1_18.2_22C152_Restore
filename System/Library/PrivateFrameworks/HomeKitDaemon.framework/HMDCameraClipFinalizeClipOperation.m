...
id __42__HMDCameraClipFinalizeClipOperation_main__block_invoke(uint64_t a1, void *a2)
{
  ...
  id v3 = a2;
  [v3 setIsComplete:MEMORY[0x263EFFA88]];
  v4 = [v3 duration];
  [v4 doubleValue];
  double v6 = v5;
  ...
  if (v10 <= 0.0)
  {
    if (v14)
    {
      ...
      __int16 v28 = 2048;
      uint64_t v29 = v19;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Finalized clip has duration %fs, deleting", (uint8_t *)&v26, 0x16u);
    }
    v20 = (void *)[objc_alloc(MEMORY[0x263F49318]) initWithLabel:@"delete empty clip"];
  ...
  else
  {
    if (v14)
    {
      ...
      int v26 = 138543362;
      v27 = v15;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Marking clip complete", (uint8_t *)&v26, 0xCu);
    }
...
void __42__HMDCameraClipFinalizeClipOperation_main__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v8 = 138543362;
    double v9 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully finalized clip", (uint8_t *)&v8, 0xCu);
  }
  [*(id *)(a1 + 32) finish];
}
...
void __42__HMDCameraClipFinalizeClipOperation_main__block_invoke_5(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v10 = 2112;
    id v11 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to update clip model: %@", (uint8_t *)&v8, 0x16u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_83288 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_83288, &__block_literal_global_83289);
  }
  v2 = (void *)logCategory__hmf_once_v5_83290;
  return v2;
}
...
void __49__HMDCameraClipFinalizeClipOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_83290;
  logCategory__hmf_once_v5_83290 = v0;
}
