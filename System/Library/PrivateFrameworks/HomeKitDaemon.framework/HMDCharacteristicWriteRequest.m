...
+ (id)writeRequestForTransitionFetchWithLightProfile:(id)a3
{
  ...
  id v4 = a3;
  v5 = [v4 service];
  v6 = (__CFString *)*MEMORY[0x263F0BFF8];
  ...
  if (v7)
  {
    ...
    if (v8)
    {
      id v9 = objc_alloc(MEMORY[0x263F35930]);
      id v10 = objc_alloc(MEMORY[0x263F35AF0]);
      v11 = [v7 instanceID];
      v12 = (void *)[v10 initWithValue:v11];
      v13 = (void *)[v9 initWithHAPInstanceID:v12];

      v14 = (void *)[objc_alloc(MEMORY[0x263F35910]) initWithTransitionFetch:v13 transitionStart:0];
      id v36 = 0;
      ...
      if (v15)
      {
        if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v39 = 2112;
          v40 = v21;
          _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Writing value to transition control characteristic: %@", buf, 0x16u);
      ...
      else
      {
        if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v41 = 2112;
          v42 = v16;
          _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize transition control write request %@:%@", buf, 0x20u);
        }
        v22 = 0;
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@Service doesn't support Value Transition Control Characteristic %@:%@", buf, 0x20u);
      }
      v22 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v41 = 2112;
      v42 = v6;
      _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@Service doesn't support Color Temperature Characteristic %@:%@", buf, 0x20u);
    }
    v22 = 0;
  }
...
+ (id)writeRequestForTransitionStartWithLightProfile:(id)a3 naturalLightingEnabled:(BOOL)a4 startDate:(id)a5 type:(unint64_t)a6 dataSource:(id)a7
{
  ...
  if (v16)
  {
    id v17 = [MEMORY[0x263F35908] naturalLightingValueTransitionWithLightProfile:v12 naturalLightingEnabled:v10 startDate:v13 dataSource:v14];
    if (v17)
    {
      unint64_t v41 = a6;
      id v18 = objc_alloc_init(MEMORY[0x263F35910]);
      id v19 = objc_alloc(MEMORY[0x263F35938]);
      v47 = v17;
      v20 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v47 count:1];
      ...
      if (v22)
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v50 = 2112;
          id v51 = v27;
          _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_DEBUG, "%{public}@Writing value to transition control characteristic: %@", buf, 0x16u);
        }
      ...
      else
      {
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v52 = 2112;
          v53 = v45;
          _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize transition control write request %@:%@", buf, 0x20u);
        }
        v29 = 0;
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v50 = 2112;
        id v51 = v12;
        _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_ERROR, "%{public}@Failed to create natural lighting transition for light profile: %@", buf, 0x16u);
      }
      v29 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_ERROR, "%{public}@Service doesn't support Value Transition Control Characteristic %@:%@", buf, 0x20u);
    }
    v29 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_269975 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_269975, &__block_literal_global_113_269976);
  }
  v2 = (void *)logCategory__hmf_once_v4_269977;
  return v2;
}
...
void __44__HMDCharacteristicWriteRequest_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_269977;
  logCategory__hmf_once_v4_269977 = v0;
}
