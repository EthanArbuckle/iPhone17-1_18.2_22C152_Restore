...
- (void)encodeWithCoder:(id)a3
{
  ...
  if (objc_msgSend(v4, "hmd_isForXPCTransport"))
  {
    ...
    [v4 encodeObject:v6 forKey:*MEMORY[0x263F0B540]];

    v7 = [(HMDSettingGroup *)self name];
    [v4 encodeObject:v7 forKey:*MEMORY[0x263F0B548]];

    v8 = [(HMDSettingGroup *)self groups];
    [v4 encodeObject:v8 forKey:*MEMORY[0x263F0B538]];

    v9 = [(HMDSettingGroup *)self settings];
    [v4 encodeObject:v9 forKey:*MEMORY[0x263F0B550]];
  }
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      int v14 = 138543362;
      v15 = v13;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Did not encode group as transport is not XPC.", (uint8_t *)&v14, 0xCu);
    }
  }
}
...
- (HMDSettingGroup)initWithIdentifier:(id)a3 parentIdentifier:(id)a4 name:(id)a5 groups:(id)a6 settings:(id)a7
{
  ...
  if (v17)
  {
    ...
    uint64_t v27 = [MEMORY[0x263EFF9C0] setWithArray:v15];
    groupsInternal = v18->_groupsInternal;
    v18->_groupsInternal = (NSMutableSet *)v27;

    uint64_t v29 = [MEMORY[0x263EFF9C0] setWithArray:v16];
...
- (HMDSettingGroup)initWithModel:(id)a3
{
  ...
  id v9 = [v4 name];
  id v10 = [(HMDSettingGroup *)self initWithIdentifier:v5 parentIdentifier:v8 name:v9 groups:MEMORY[0x263EFFA68] settings:MEMORY[0x263EFFA68]];
