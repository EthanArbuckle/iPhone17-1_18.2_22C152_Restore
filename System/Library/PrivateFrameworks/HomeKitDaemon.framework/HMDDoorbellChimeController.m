  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v16 = v12;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring characteristic value updated notification since we are not the primary resident", buf, 0xCu);
    }
  }
}
...
- (unint64_t)_numHomePodsWithDoorbellChimeEnabled
{
  ...
  char v6 = objc_msgSend(v5, "na_map:", &__block_literal_global_42_142045);

  v7 = objc_msgSend(v6, "na_filter:", &__block_literal_global_45_142046);
...
- (void)notifyAccessoriesViaCoordinationFreePathWithDelay:(double)a3 home:(id)a4 shouldPlayChime:(BOOL)a5 personIdentificationText:(id)a6 accessoriesToNotify:(id)a7 logEvent:(id)a8 accessoryUUID:(id)a9
{
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v37 = 2112;
    id v38 = v18;
    _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Taking HomeKit path to notify: %@", buf, 0x16u);
  }
...
void __169__HMDDoorbellChimeController_notifyAccessoriesViaCoordinationFreePathWithDelay_home_shouldPlayChime_personIdentificationText_accessoriesToNotify_logEvent_accessoryUUID___block_invoke(uint64_t a1, void *a2)
{
  ...
  int v4 = [v3 accessorySupportsCoordinationFreeDoorbellChime:v10];
  ...
  if (v4)
  {
    ...
    unint64_t v8 = [v10 doorbellChimeProfile];
    id v9 = [MEMORY[0x263EFF910] dateWithTimeIntervalSinceNow:*(double *)(a1 + 56)];
    [v8 sendDoorbellChimeMessageWithChimeMode:v7 chimeDate:v9 personIdentificationText:*(void *)(a1 + 40) accessoryUUID:*(void *)(a1 + 48)];
...
- (void)_notifyAllAccessoriesForDoorbellPressAndPlayChimeSound:(BOOL)a3 attemptCloudPullIfNoPersonsFound:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v98 = 2112;
    v99 = v14;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Notifying accessories for doorbell press with shouldPlayChime: %@, attemptCloudPullIfNoPersonsFound: %@", buf, 0x20u);
  }
  if (a3) {
    goto LABEL_11;
  }
  ...
  if (v15)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v98 = 2048;
      v99 = v24;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@It has been %lfs since the last unidentified chime, and our maximum allowed announce delay is %lfs", buf, 0x20u);
    }
    ...
    if (v27 < v18)
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v95 = v31;
        _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_INFO, "%{public}@Not notifying accessories since we have exceeded our maximum allowed announce delay", buf, 0xCu);
      }
...
LABEL_11:
      ...
      if (!v44 && v4)
      {
        ...
        if (v45)
        {
          ...
          if (os_log_type_enabled(v48, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v95 = v49;
            _os_log_impl(&dword_22F52A000, v48, OS_LOG_TYPE_INFO, "%{public}@Did not find person identification text, so performing cloud pull", buf, 0xCu);
          }
          v50 = [v45 performCloudPull];
          v51 = (void *)MEMORY[0x263F581B8];
    ...
    if (!v44)
    {
      ...
      if (os_log_type_enabled(v59, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v95 = v60;
        _os_log_impl(&dword_22F52A000, v59, OS_LOG_TYPE_INFO, "%{public}@Not playing chime and found no persons to announce, so doing nothing", buf, 0xCu);
      }
      goto LABEL_38;
    }
LABEL_29:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v78, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_22F52A000, v78, OS_LOG_TYPE_INFO, "%{public}@Nothing to notify for chime from %@", buf, 0x16u);
      }
    }
...
LABEL_38:
  ...
  if (os_log_type_enabled(v74, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v95 = v75;
    _os_log_impl(&dword_22F52A000, v74, OS_LOG_TYPE_INFO, "%{public}@Ignoring updated person information because there was not a recent doorbell press", buf, 0xCu);
  }
}
...
void __118__HMDDoorbellChimeController__notifyAllAccessoriesForDoorbellPressAndPlayChimeSound_attemptCloudPullIfNoPersonsFound___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v8 = 138543362;
    id v9 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Cloud pull succeeded; attempting to announce without playing chime",
      (uint8_t *)&v8,
      0xCu);
  }
...
- (void)_handleCharacteristicsValueUpdatedNotification:(id)a3
{
  ...
  v21 = v10;
  objc_msgSend(v10, "na_filter:", &__block_literal_global_142065);
  long long v23 = 0u;
  long long v24 = 0u;
  long long v25 = 0u;
  long long v26 = 0u;
      ...
      for (uint64_t i = 0; i != v13; ++i)
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v29 = 2112;
          uint64_t v30 = v16;
          _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Handling doorbell input event characteristic: %@", buf, 0x16u);
        }
...
- (void)handleUpdatedPersonIdentificationInformation
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v13 = v10;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Ignoring new significant event since we are not the primary resident", buf, 0xCu);
    }
  }
}
...
- (HMDDoorbellChimeController)initWithContext:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v7)
    {
      ...
      uint64_t v9 = (NSSet *)objc_alloc_init(MEMORY[0x263EFF9C0]);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t14_142087 != -1) {
    dispatch_once(&logCategory__hmf_once_t14_142087, &__block_literal_global_47_142088);
  }
  id v2 = (void *)logCategory__hmf_once_v15_142089;
  return v2;
}
...
void __41__HMDDoorbellChimeController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v15_142089;
  logCategory__hmf_once_v15_142089 = v0;
}
