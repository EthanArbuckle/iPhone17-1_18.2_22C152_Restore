...
- (void)submitPreferencesSizeLogEventsForApplicationID:(id)a3 submissionTrigger:(unint64_t)a4
{
  ...
  if (isInternalBuild())
  {
    ...
    CFArrayRef v9 = CFPreferencesCopyKeyList(v6, (CFStringRef)*MEMORY[0x263EFFE70], (CFStringRef)*MEMORY[0x263EFFE68]);
    long long v30 = 0u;
    long long v31 = 0u;
    long long v32 = 0u;
    long long v33 = 0u;
        ...
        for (uint64_t i = 0; i != v26; ++i)
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            __int16 v40 = 2112;
            CFTypeRef v41 = cf;
            _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Preferences Key: %{public}@ Size of value: %ld Description: %@", buf, 0x2Au);
