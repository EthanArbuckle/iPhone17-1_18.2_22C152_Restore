...
- (void)__activeSelectionReset:(id)a3
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v34 = 2112;
    v35 = v14;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Received notification that controller %@ service %@ reset its active selection", buf, 0x20u);
  }
  ...
  if ([v15 containsObject:v8])
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v34 = 2112;
      v35 = v21;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Received notification that a configured controller %@ service %@ has reset its active selection", buf, 0x20u);
    }
    ...
    if ([v22 containsObject:v7])
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v34 = 2112;
        v35 = v28;
        _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@Received notification that a configured controller %@ service %@ has deselected this target accessory", buf, 0x20u);
...
- (void)__activeSelectionChanged:(id)a3
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    __int16 v69 = 2112;
    v70 = v60;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Received notification that controller %@ service %@ changed active selection - configuredControllers %@  identifier %@", buf, 0x34u);
  ...
  if ([v9 containsObject:v8] && v60)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v67 = 2112;
      v68 = v60;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Received notification that a configured controller %@ service %@ changed active selection to %@", buf, 0x2Au);
    }
    id v59 = v4;
      ...
      if (v31 == v28)
      {
        ...
        if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_INFO, "%{public}@Received notification that a configured controller %@ service %@ has selected this target accessory", buf, 0x20u);
      ...
      else if ([v32 containsObject:v7])
      {
        ...
        if (os_log_type_enabled(v49, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          _os_log_impl(&dword_22F52A000, v49, OS_LOG_TYPE_INFO, "%{public}@Received notification that a configured controller %@ service %@ has deselected this target accessory", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        uint64_t v66 = v45;
        v46 = (void *)v45;
        _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_INFO, "%{public}@Attempting to process active selection change for a target %@/%@ that is not configured with a home", buf, 0x20u);
...
- (void)_handleTargetControlServiceDeselection:(id)a3
{
  ...
  v6 = [v4 type];
  if ([v6 isEqualToString:*MEMORY[0x263F0D838]])
  {
  }
  else
  {
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v20 = 2112;
    v21 = v14;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Received notification that control service %@/%@  is not actively controlling this target accessory", (uint8_t *)&v16, 0x20u);
  }
...
- (void)_handleTargetControlServiceSelection:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    __int16 v18 = v11;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Tracking controller %@ service %@ for active selection", (uint8_t *)&v13, 0x20u);
  }
...
- (void)_handleControllerDisconnected:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v31 = 2112;
    __int16 v32 = v11;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Received notification that controller %@ for target accessory %@ is disconnected - marking as deselected for target control", buf, 0x20u);
  }
  long long v24 = 0u;
  long long v25 = 0u;
  long long v22 = 0u;
  ...
  if (v13)
  {
    ...
    uint64_t v16 = *MEMORY[0x263F0D838];
    do
    {
  ...
  if (v6)
  {
    if (v9)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v54 = 2112;
      v55 = v11;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Removing controller %@ from list of controllers", buf, 0x16u);
    }
  ...
  else
  {
    if (v9)
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v56 = 2112;
      v57 = v15;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Controller %@ is not configured for controlling target accessory %@", buf, 0x20u);
    }
  }
          ...
          if ([v25 identifier] == v19)
          {
            ...
            if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v54 = 2112;
              v55 = v34;
              _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_INFO, "%{public}@Removing receiver %@ from list of receivers", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v56 = 2112;
      v57 = v41;
      _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_ERROR, "%{public}@Attempting to lookup or create an event receiver for a %@/%@ that is not configured with a home", buf, 0x20u);
    }
  }
}
...
- (void)_targetAccessoryConfiguredWithController:(id)a3
{
  ...
  if (v6)
  {
    if (v10)
    {
      ...
      __int16 v22 = 2112;
      uint64_t v23 = v14;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Controller %@ already configured for controlling target accessory %@", (uint8_t *)&v18, 0x20u);
    }
  }
  else
  {
    if (v10)
    {
      ...
      __int16 v20 = 2112;
      uint64_t v21 = v16;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Adding controller %@ to the list of configuredControllers and registering for notifications ", (uint8_t *)&v18, 0x16u);
    }
...
- (void)__characteristicsEventsReceived:(id)a3
{
  ...
  id v4 = objc_msgSend(v30, "hmf_arrayForKey:", *MEMORY[0x263F35428]);
  v5 = [(HMDTargetControlManager *)self activeControlServices];
  v38 = self;
  ...
  if (v6)
  {
    ...
    uint64_t v39 = *MEMORY[0x263F0BF70];
    v37 = v5;
    do
    {
            ...
            else
            {
              ...
              if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138544130;
                ...
                _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@Button event data not NSData but %@ from control service %@/%@", buf, 0x2Au);
...
- (void)_handleButtonEvent:(id)a3 fromControlService:(id)a4
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544898;
    ...
    __int16 v125 = 2112;
    v126 = v22;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Button %lu changed to '%@' with timestamp %lu for target %lu from control service %@/%@", buf, 0x48u);
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      _os_log_impl(&dword_22F52A000, v48, OS_LOG_TYPE_ERROR, "%{public}@Attempting to lookup or create an event receiver for a configured controller %@/%@ that is not configured with a home", buf, 0x20u);
...
LABEL_31:
    ...
    if (os_log_type_enabled(v57, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      _os_log_impl(&dword_22F52A000, v57, OS_LOG_TYPE_INFO, "%{public}@No event receiver set up for controller %@/%@", buf, 0x20u);
  ...
  if (v37 != v98)
  {
    ...
    if (os_log_type_enabled(v65, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v117 = 2048;
      uint64_t v118 = v37;
      _os_log_impl(&dword_22F52A000, v65, OS_LOG_TYPE_INFO, "%{public}@Event targetID %lu does not match our target identifier %lu - treating as deselection to avoid receiving additional events", buf, 0x20u);
    }
  ...
  if (v97 >= 2)
  {
    ...
    if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      _os_log_impl(&dword_22F52A000, v40, OS_LOG_TYPE_INFO, "%{public}@Invalid buttonState %lu for controller %@/%@", buf, 0x2Au);
...
LABEL_56:
    ...
    if (v54)
    {
      ...
      if (os_log_type_enabled(v80, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v117 = 2048;
        uint64_t v118 = v84;
        _os_log_impl(&dword_22F52A000, v80, OS_LOG_TYPE_INFO, "%{public}@Received an event for button with ID %lu/type %lu - consuming in HomeKit layer", buf, 0x20u);
      }
      BOOL v9 = v77;
      goto LABEL_38;
    }
  ...
  if (os_log_type_enabled(v87, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v119 = 2048;
    uint64_t v120 = v72;
    _os_log_impl(&dword_22F52A000, v87, OS_LOG_TYPE_INFO, "%{public}@Received an event from control service %@/%@ for a button id %lu that is not mapped into the receiver's selected buttons", buf, 0x2Au);
...
LABEL_17:
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v50 = 2112;
        __int16 v51 = v32;
        _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Creating an event receiver (supportsSiri: %@) to handle events from controller %@/%@", buf, 0x2Au);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v48 = 2112;
      __int16 v49 = v23;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Attempting to lookup or create an event receiver for a configured controller %@/%@ that is not configured with a home", buf, 0x20u);
    }
    v12 = 0;
  }
LABEL_20:
...
void __44__HMDTargetControlManager___serviceRemoved___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    __int16 v53 = 2112;
    uint64_t v54 = v16;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Received notification that a service %@/%@ has been removed from the accessory %@/%@", buf, 0x34u);
  ...
  id v17 = [v5 type];
  int v18 = [v17 isEqualToString:*MEMORY[0x263F0D840]];
    ...
    if (v20)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v51 = 2112;
        v52 = v28;
        _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Received notification target configuration service %@ of controller %@/%@ has been removed - treating as unconfiguration", buf, 0x2Au);
  ...
  {
    id v29 = [v5 type];
    int v30 = [v29 isEqualToString:*MEMORY[0x263F0D838]];
      ...
      if (v32)
      {
        ...
        if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v51 = 2112;
          v52 = v40;
          _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_INFO, "%{public}@Received notification target control service %@ of controller %@/%@ has been removed - treating as deselection", buf, 0x2Au);
    ...
    if (v17)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v66 = 2112;
        __int16 v67 = v24;
        _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Received notification that controller %@/%@ has been removed", buf, 0x20u);
      }
      ...
      if (!v25)
      {
        ...
        if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v66 = 2112;
          __int16 v67 = v55;
          _os_log_impl(&dword_22F52A000, v51, OS_LOG_TYPE_ERROR, "%{public}@Removed controller %@/%@ is not configured with a home", buf, 0x20u);
        }
        goto LABEL_34;
      }
      v26 = [v15 uuid];
    ...
    if (v41)
    {
      ...
      if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v66 = 2112;
        __int16 v67 = v48;
        _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_INFO, "%{public}@Received notification that this target accessory  %@/%@ has been removed - invalidating...", buf, 0x20u);
      }
      [*(id *)(a1 + 40) invalidate];
    }
  }
...
void __44__HMDTargetControlManager___accessoryAdded___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v20 = 2112;
    int v21 = v13;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Received notification that an accessory %@/%@ (supportsTargetController %@) has been added to the home", (uint8_t *)&v14, 0x2Au);
  }
}
...
void __51__HMDTargetControlManager___accessoryDisconnected___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v28 = 2112;
    id v29 = v11;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Disconnected from accessory %@/%@", (uint8_t *)&v24, 0x20u);
  }
  id v12 = v4;
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
  ...
  if (v14)
  {
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v28 = 2112;
        id v29 = v23;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Disconnected from controller %@ for target accessory %@", (uint8_t *)&v24, 0x20u);
      }
...
void __48__HMDTargetControlManager___accessoryConnected___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v29 = 2112;
    uint64_t v30 = v11;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Connected to accessory %@/%@", (uint8_t *)&v25, 0x20u);
  }
  id v12 = v4;
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
  ...
  if (v14)
  {
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v29 = 2112;
        uint64_t v30 = v23;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Connected to controller %@ for target accessory %@", (uint8_t *)&v25, 0x20u);
      }
...
void __50__HMDTargetControlManager___accessoryNameUpdated___block_invoke(uint64_t a1)
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v33 = 2112;
      id v34 = v23;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Attempting to process name update for a controller %@/%@ that is not configured with a home", (uint8_t *)&v29, 0x20u);
    }
    goto LABEL_17;
  }
  ...
  if ((v7 & 1) == 0)
  {
    if (v11)
    {
      ...
      __int16 v35 = 2112;
      id v36 = v28;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Controller %@/%@ that has updated its name not one of the configured controllers %@", (uint8_t *)&v29, 0x2Au);
    }
LABEL_17:
    goto LABEL_18;
  }
  if (v11)
  {
    ...
    __int16 v33 = 2112;
    id v34 = v15;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Received notification that the name of a controller %@/%@ has been updated", (uint8_t *)&v29, 0x20u);
  }
...
void __62__HMDTargetControlManager___controllerRefreshedConfiguration___block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v31 = 2112;
      int v32 = v12;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Received notification that a controller %@/%@ has refreshed its configuration - userInfo %@", (uint8_t *)&v25, 0x2Au);
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v31 = 2112;
        int v32 = v24;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Controller %@/%@ that has refreshed its configuration not one of the configured controllers %@", (uint8_t *)&v25, 0x2Au);
      }
    }
  }
}
...
- (void)_targetAccessoryRefreshConfigurationWithController:(id)a3 userInfo:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    __int16 v90 = 2112;
    id v91 = v7;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Handling configuration refresh from controller (supportsSiri %@) %@/%@: %@", buf, 0x34u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v59, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v86 = 2112;
          v87 = v40;
          _os_log_impl(&dword_22F52A000, v59, OS_LOG_TYPE_INFO, "%{public}@Target name in the controller configuration %@ is stale - updating to %@", buf, 0x20u);
        }
      }
      id v18 = v67;
      v62 = (void *)MEMORY[0x263EFFA08];
...
LABEL_15:
      ...
      int v21 = v76;
LABEL_19:
      int v41 = (void *)MEMORY[0x230FBD990]();
      id v42 = v66;
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v86 = 2112;
        v87 = v47;
        _os_log_impl(&dword_22F52A000, v43, OS_LOG_TYPE_INFO, "%{public}@Target %@/%@ does not exist in controller configuration - for now, not adding", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v86 = 2112;
      v87 = v56;
      _os_log_impl(&dword_22F52A000, v50, OS_LOG_TYPE_ERROR, "%{public}@Attempting to process configuration refresh for target accessory %@/%@ that is not configured with a home", buf, 0x20u);
  ...
  if (v7 && v8)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v60 = 2112;
      v61 = v10;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Supported button configuration %@  Mapped supported button set: %@", buf, 0x20u);
    }
    if (v10)
    {
      id v51 = v6;
      ...
      id v17 = v16;
      id v18 = objc_msgSend(MEMORY[0x263EFF9C0], "setWithCapacity:", objc_msgSend(v17, "count"));
      long long v52 = 0u;
      long long v53 = 0u;
      long long v54 = 0u;
      long long v55 = 0u;
...
LABEL_24:
      ...
      if (os_log_type_enabled(v45, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v60 = 2112;
        v61 = v48;
        _os_log_impl(&dword_22F52A000, v45, OS_LOG_TYPE_DEBUG, "%{public}@Selected button set %@, Mapped and augmented button configuration: %@", buf, 0x20u);
      }
      id v9 = (void *)[v42 copy];
...
void __67__HMDTargetControlManager___targetAccessoryUnconfiguredForControl___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v22 = 2112;
    uint64_t v23 = v11;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Received notification that target accessories %@ have been unconfigured for control by controller %@", (uint8_t *)&v18, 0x20u);
  }
...
void __65__HMDTargetControlManager___targetAccessoryConfiguredForControl___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v30 = 2112;
    uint64_t v31 = v13;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Received notification that target accessories %@ have been configured for control by controller %@/%@", (uint8_t *)&v24, 0x2Au);
  }
  if (v4)
  {
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v28 = 2112;
        uint64_t v29 = v23;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Received notification that this target has been configured for control by controller %@/%@", (uint8_t *)&v24, 0x20u);
      }
        ...
        if (v9)
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138544386;
            ...
            __int16 v54 = 2112;
            long long v55 = v23;
            _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Adding target %@ to controller %@/%@ with button configuration %@", buf, 0x34u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v32;
            ...
            __int16 v50 = 2112;
            id v51 = v31;
            _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Attempt to add a target controller %@/%@ that is not a HAP accessory", buf, 0x20u);
...
- (void)invalidate
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    long long v32 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Invalidating target control manager", buf, 0xCu);
  }
  ...
  if (v8)
  {
    ...
    [v9 setTargetableAccessory:v10 withControllers:MEMORY[0x263EFFA68]];
...
- (HMDTargetControlManager)initWithTargetAccessory:(id)a3 controllers:(id)a4
{
  ...
  if (v8)
  {
    ...
    uint64_t v15 = [MEMORY[0x263EFF980] arrayWithArray:v14];
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v74 = 2112;
      id v75 = v7;
      _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_INFO, "%{public}@Initializing target control manager with controllers %@", buf, 0x16u);
    }
    ...
    long long v32 = [MEMORY[0x263F08A00] defaultCenter];
    ...
    char v35 = [MEMORY[0x263F08A00] defaultCenter];
    ...
    uint64_t v37 = [MEMORY[0x263F08A00] defaultCenter];
    ...
    [v39 addObserver:v28 selector:sel___characteristicsEventsReceived_ name:*MEMORY[0x263F35420] object:0];

    uint64_t v40 = [MEMORY[0x263F08A00] defaultCenter];
    [v40 addObserver:v28 selector:sel___accessoryAdded_ name:@"HMDNotificationHomeAddedAccessory" object:0];

    int v41 = [MEMORY[0x263F08A00] defaultCenter];
    [v41 addObserver:v28 selector:sel___accessoryRemoved_ name:@"HMDHomeAccessoryRemovedNotification" object:0];

    long long v42 = [MEMORY[0x263F08A00] defaultCenter];
            ...
            && ([v7 containsObject:v50] & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v52, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v76 = 2112;
              long long v77 = v58;
              _os_log_impl(&dword_22F52A000, v52, OS_LOG_TYPE_INFO, "%{public}@Adding %@/%@ as a configured controller", buf, 0x20u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_131441 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_131441, &__block_literal_global_131442);
  }
  v2 = (void *)logCategory__hmf_once_v5_131443;
  return v2;
}
...
void __38__HMDTargetControlManager_logCategory__block_invoke()
{
  ...
  uint64_t v1 = (void *)logCategory__hmf_once_v5_131443;
  logCategory__hmf_once_v5_131443 = v0;
}
