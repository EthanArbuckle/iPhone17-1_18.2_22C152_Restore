...
- (id)mainReturningError
{
  ...
  v43 = __Block_byref_object_copy__23660;
  v44 = __Block_byref_object_dispose__23661;
  id v45 = 0;
  ...
  uint64_t v18 = [MEMORY[0x263EFF910] timeIntervalSinceReferenceDate];
  double v20 = v19;
  v21 = (void *)MEMORY[0x230FBD990](v18);
  v22 = self;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v52 = 2048;
    double v53 = v20 - v8;
    _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@time to fetch migrated records: %.4f s", buf, 0x16u);
  }
  if (v41[5])
  {
          ...
          if (!v8 || ([v8 isEqual:v20] & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v29 = 2048;
              uint64_t v30 = v25;
              _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@detected migrations is need for %lu", buf, 0x16u);
    ...
    if (v50 || !v26)
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v58 = 2112;
        id v59 = v17;
        _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_ERROR, "%{public}@unable to decode object for %lu / %@", buf, 0x20u);
      }
      uint64_t v25 = 0;
      v26 = v49;
      goto LABEL_21;
      ...
      if (!v21 || ([v21 isEqual:v46] & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138544642;
          ...
          v65 = v46;
          id v30 = v29;
          _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_DEFAULT, "%{public}@detected a schema change for %lu / %@/%@ from %@ to %@", buf, 0x3Eu);
        }
        v26 = v48;
