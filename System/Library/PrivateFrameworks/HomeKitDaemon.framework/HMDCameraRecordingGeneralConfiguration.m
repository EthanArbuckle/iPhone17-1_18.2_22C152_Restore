...
- (BOOL)_parseFromTLVData
{
  ...
  v3 = [MEMORY[0x263F35A58] wrappertlv:1 name:@"kGeneralConfigurationPrebufferLength"];
  id v4 = [MEMORY[0x263F35A58] wrappertlv:2 name:@"kGeneralConfigurationEventTriggerOptions"];
  v5 = [MEMORY[0x263F358B8] wrappertlv:3 name:@"kGeneralConfigurationMediaContainerConfigurations" objectCreator:&__block_literal_global_131171];
  v14[0] = v3;
  v14[1] = v4;
  v14[2] = v5;
  id v6 = [MEMORY[0x263EFF8C0] arrayWithObjects:v14 count:3];
