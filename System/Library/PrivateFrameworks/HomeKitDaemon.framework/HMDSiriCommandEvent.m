...
LABEL_12:
      _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_DEFAULT, v31, buf, 0xCu);
    }
LABEL_13:
  ...
  if (v21)
  {
    v33 = [MEMORY[0x263F424F0] currentActivity];
    ...
    if (v24)
    {
      unint64_t v25 = [MEMORY[0x263F087E8] errorWithDomain:@"HMDSiriCommandEventErrorDomain" code:v24 userInfo:0];
...
+ (unint64_t)generateErrorCodeWithNumberOfFailures:(unint64_t)a3 numberOfIncompletions:(unint64_t)a4 commandOutcome:(id)a5
{
  id v7 = a5;
  v8 = v7;
  if (a4 || ([v7 isEqualToString:*MEMORY[0x263F65578]] & 1) != 0)
  {
    unint64_t v9 = 2;
  }
  else if (a3)
  ...
  {
    unint64_t v9 = [v8 isEqualToString:*MEMORY[0x263F65548]] ^ 1;
  }
