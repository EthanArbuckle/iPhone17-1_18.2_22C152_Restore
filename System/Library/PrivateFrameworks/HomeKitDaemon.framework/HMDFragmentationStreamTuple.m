...
- (void)setLastMessage:(id)a3
{
  ...
  id v7 = a3;
  v5 = [MEMORY[0x263EFF910] dateWithTimeIntervalSinceNow:300.0];
...
- (HMDFragmentationStreamTuple)initWithFragmentationStreamForObject:(id)a3 delegate:(id)a4
{
  ...
  if (v9)
  {
    ...
    v11 = (HAPFragmentationStream *)objc_alloc_init(MEMORY[0x263F359B8]);
    ...
    uint64_t v13 = [MEMORY[0x263EFF910] dateWithTimeIntervalSinceNow:300.0];
