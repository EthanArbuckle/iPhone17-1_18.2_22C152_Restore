...
- (void)_startTimer
{
  ...
  if (!v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v30 = 2112;
      v31 = v7;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Preference for reader interval is missing, using default value: %@", buf, 0x16u);
    }
  }
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v32 = 2112;
    id v33 = v19;
    _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Starting the next timer (%@) to fire at %@", buf, 0x20u);
  }
  ...
  if ((v21 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v32 = 2112;
      id v33 = v22;
      _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to start timer %@ with error %@", buf, 0x20u);
    }
  }
}
      ...
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = v20;
          ...
          __int16 v28 = 2112;
          v29 = v10;
          _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Issuing a periodic read for %@", buf, 0x16u);
        ...
        [v10 readCharacteristicValues:v11 source:7 queue:v19 completionHandler:&__block_literal_global_28_123893];
      }
...
- (void)_checkToIssueRead
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    v14 = v7;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Stopping the timer with ID: %@", (uint8_t *)&v11, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      int v11 = v8;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@Object not configured yet", buf, 0xCu);
    }
  }
}
...
void __39__HMDHomePeriodicReader_startReadTimer__block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      int v7 = 138543362;
      uint64_t v8 = v6;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting periodic read timer", (uint8_t *)&v7, 0xCu);
    }
...
- (id)_characteristicsToRead
{
  ...
  if (v5)
  {
    long long v6 = [MEMORY[0x263EFF9C0] set];
    long long v65 = 0u;
    long long v66 = 0u;
    long long v67 = 0u;
    long long v68 = 0u;
    ...
    v48 = [MEMORY[0x263F08968] strongToStrongObjectsMapTable];
    long long v57 = 0u;
    long long v58 = 0u;
    long long v59 = 0u;
    long long v60 = 0u;
    ...
    if (v47)
    {
      ...
      uint64_t v24 = *MEMORY[0x263F35500];
      do
      {
        long long v25 = 0;
        do
...
LABEL_50:
  ...
  if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v74 = v42;
    _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_INFO, "%{public}@This device is not the resident, not issuing the periodic read", buf, 0xCu);
  }
  id v38 = 0;
LABEL_51:
...
- (void)residentUpdated
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    uint64_t v8 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Resident updated, issuing a read", (uint8_t *)&v7, 0xCu);
  }
...
- (void)handleTimerFiredNotification:(id)a3
{
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v15 = 2112;
      uint64_t v16 = v6;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Issuing read for fired timer with ID: %@", (uint8_t *)&v13, 0x16u);
    }
...
- (void)handleCharacteristicBasedEventAdded:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    uint64_t v10 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Received characteristic event added notification", (uint8_t *)&v9, 0xCu);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_123923 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_123923, &__block_literal_global_123924);
  }
  v2 = (void *)logCategory__hmf_once_v1_123925;
  return v2;
}
...
void __36__HMDHomePeriodicReader_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_123925;
  logCategory__hmf_once_v1_123925 = v0;
}
