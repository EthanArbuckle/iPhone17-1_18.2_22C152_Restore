...
- (void)logRateTrigger:(id)a3 triggerValue:(unint64_t)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@EWS rate trigger: trigger=%{public}@, counter=%{public}@, value=%lu, windowSize=%lu", buf, 0x34u);
  }
  ...
  v19[2] = v16;
  v17 = [NSDictionary dictionaryWithObjects:v19 forKeys:v18 count:3];
...
- (HMDCounterRateLoggingTrigger)initWithThreshold:(int64_t)a3 windowSize:(int64_t)a4 counterName:(id)a5 uploadImmediately:(BOOL)a6 ewsLogger:(id)a7
{
  return [(HMDCounterRateLoggingTrigger *)self initWithThreshold:a3 windowSize:a4 counterName:a5 uploadImmediately:a6 ewsLogger:a7 timeSourceBlock:&__block_literal_global_32228];
}
