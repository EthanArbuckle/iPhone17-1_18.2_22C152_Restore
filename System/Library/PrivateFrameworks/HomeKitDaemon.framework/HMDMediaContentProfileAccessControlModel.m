...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_60299 != -1) {
    dispatch_once(&hmbProperties_onceToken_60299, &__block_literal_global_60300);
  }
  v2 = (void *)hmbProperties__properties_60301;
  return v2;
}
...
void __57__HMDMediaContentProfileAccessControlModel_hmbProperties__block_invoke()
{
  ...
  v2 = (void *)hmbProperties__properties_60301;
  hmbProperties__properties_60301 = v1;
}
