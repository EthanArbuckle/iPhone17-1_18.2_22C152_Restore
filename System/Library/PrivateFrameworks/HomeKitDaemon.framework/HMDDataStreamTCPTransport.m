...
- (void)setTrafficClass:(unint64_t)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v13 = 2048;
      unint64_t v14 = a3;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Setting traffic class to %lu", (uint8_t *)&v11, 0x16u);
    }
...
- (void)sendRawFrame:(id)a3 completion:(id)a4
{
  ...
  uint64_t v12 = *MEMORY[0x263F14440];
...
void __53__HMDDataStreamTCPTransport_sendRawFrame_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v12 = 2112;
      id v13 = v3;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@DataStream Socket write error (%@)", (uint8_t *)&v10, 0x16u);
    }
  }
  else if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v10 = 138543362;
    int v11 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEBUG, "%{public}@DataStream Socket wrote bytes.", (uint8_t *)&v10, 0xCu);
  }
...
- (void)_closeWithError:(id)a3
{
  ...
  if (v5)
  {
    if (v9)
    {
      ...
      int v15 = 138543362;
      v16 = v10;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@DataStream Socket closing socket.", (uint8_t *)&v15, 0xCu);
    }
  ...
  else
  {
    if (v9)
    {
      ...
      int v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@DataStream Socket invoked closed but nothing to clean up.", (uint8_t *)&v15, 0xCu);
    }
  }
}
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v16 = v8;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@DataStream has encountered irrecoverable framing issue. Closing socket.", buf, 0xCu);
    }
    BOOL v9 = [MEMORY[0x263F087E8] hmErrorWithCode:19];
  ...
  if (WeakRetained)
  {
    if (v8)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
      {
        ...
        _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_DEBUG, "%{public}@DataStream Socket read %zd bytes", (uint8_t *)&v21, 0x16u);
      }
      id WeakRetained = (id)[v14 _consumeReceivedData:v8];
    }
    if (v10)
    {
      uint64_t v17 = (void *)MEMORY[0x230FBD990](WeakRetained);
      id v18 = v12;
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@DataStream Socket read error (%@)", (uint8_t *)&v21, 0x16u);
      }
...
- (void)_handleReadClose
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    v8 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@DataStream Socket read-end closed (half-close scenario)", (uint8_t *)&v7, 0xCu);
  }
}
  ...
  if (v3)
  {
    ...
    if (v4)
    {
      if (v8)
      {
        ...
        *(_DWORD *)buf = 138543362;
        v35 = v22;
        _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@Connect called on an already-connecting transport", buf, 0xCu);
      }
    }
    else if (v8)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v35 = v9;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@Connect called on an already-running transport", buf, 0xCu);
    }
  }
  else
  {
    ...
    if (v11)
    {
      ...
      uint64_t v17 = (void *)MEMORY[0x230FBD990](v13, v14, v15, v16);
      id v18 = self;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v35 = v20;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@DataStream Socket starting", buf, 0xCu);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v35 = v26;
        _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to create TCP connection (out of memory?)", buf, 0xCu);
      }
      v27 = [MEMORY[0x263F087E8] hmErrorWithCode:-1];
  ...
  if (WeakRetained)
  {
    if (v5)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v24 = 2112;
        id v25 = v5;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@DataStream Socket disconnected with failure in state %s: %@", (uint8_t *)&v20, 0x20u);
      }
    ...
    if ((a2 - 4) >= 2)
    {
      if (a2 == 3)
      {
        uint64_t v16 = (void *)MEMORY[0x230FBD990](WeakRetained);
        id v17 = v7;
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
        {
          ...
          int v20 = 138543362;
          int v21 = v19;
          _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@DataStream Socket connected", (uint8_t *)&v20, 0xCu);
        }
        [v17 _start];
      }
    }
    ...
    {
      char v12 = (void *)MEMORY[0x230FBD990](WeakRetained);
      id v13 = v7;
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        int v20 = 138543362;
        int v21 = v15;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@DataStream Socket disconnected", (uint8_t *)&v20, 0xCu);
      }
...
- (id)_createTcpConnection
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Creating TCP connection with scheduling mode %ld", (uint8_t *)&v18, 0x16u);
  }
  nw_parameters_t secure_tcp = nw_parameters_create_secure_tcp((nw_parameters_configure_protocol_block_t)*MEMORY[0x263F14478], (nw_parameters_configure_protocol_block_t)*MEMORY[0x263F14470]);
