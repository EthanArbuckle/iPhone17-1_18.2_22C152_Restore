...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v4 encodeObject:v5 forKey:*MEMORY[0x263F0D930]];

  uint64_t v6 = [(HMDSiriEndpointProfileAssistant *)self name];
  [v4 encodeObject:v6 forKey:*MEMORY[0x263F0D938]];

  id v7 = [(HMDSiriEndpointProfileAssistant *)self active];
  [v4 encodeObject:v7 forKey:*MEMORY[0x263F0D928]];
}
...
- (BOOL)updateCharacteristic:(id)a3 value:(id)a4
{
  ...
  v8 = [v6 type];
  int v9 = [v8 isEqualToString:*MEMORY[0x263F0C1D8]];
  ...
  v13 = [v6 type];
  int v14 = [v13 isEqualToString:*MEMORY[0x263F0C298]];
  ...
  v17 = [v6 type];
  int v18 = [v17 isEqualToString:*MEMORY[0x263F0BEF8]];
...
- (NSArray)allCharacteristics
{
  v3 = (void *)[objc_alloc(MEMORY[0x263EFF980]) initWithCapacity:3];
...
- (NSArray)characteristicsToMonitor
{
  v3 = (void *)[objc_alloc(MEMORY[0x263EFF980]) initWithCapacity:1];
...
- (id)_activeCharacteristic
{
  ...
  v3 = [v2 findCharacteristicWithType:*MEMORY[0x263F0BEF8]];
...
{
  v2 = [(HMDSiriEndpointProfileAssistant *)self service];
  v3 = [v2 findCharacteristicWithType:*MEMORY[0x263F0C298]];
...
{
  v2 = [(HMDSiriEndpointProfileAssistant *)self service];
  v3 = [v2 findCharacteristicWithType:*MEMORY[0x263F0C1D8]];
