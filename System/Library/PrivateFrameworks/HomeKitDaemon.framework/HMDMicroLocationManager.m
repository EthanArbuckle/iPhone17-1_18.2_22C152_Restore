...
- (void)triggerThrottledMicroLocationLocalizationScanWithMetadata:(id)a3 triggerType:(unint64_t)a4
{
  ...
  if (a4 >= 3)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v36 = 2112;
      v37 = v12;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Invalid HMDMicroLocationScanTriggerType: %@ for Localization Scan", (uint8_t *)&v34, 0x16u);
    }
    goto LABEL_16;
  }
  if (self) {
  ...
  else
  {
    ...
    if (v21 >= 2.22044605e-16)
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
      {
        ...
        v26 = off_264A2E5C8[a4];
        int v34 = 138543618;
        v35 = v25;
        __int16 v36 = 2112;
        v37 = v26;
        _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@Skipping microlocation localization scan for event: %@, throttling in effect", (uint8_t *)&v34, 0x16u);
      }
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    v32 = off_264A2E5C8[a4];
    int v34 = 138543618;
    v35 = v31;
    __int16 v36 = 2112;
    v37 = v32;
    _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_INFO, "%{public}@Performing microlocation localization scan for event: %@", (uint8_t *)&v34, 0x16u);
  }
...
- (void)triggerThrottledMicroLocationRecordingScanWithMetadata:(id)a3 triggerType:(unint64_t)a4
{
  ...
  if (a4 >= 3)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v36 = 2112;
      v37 = v12;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Invalid HMDMicroLocationScanTriggerType: %@ for Recording Scan", (uint8_t *)&v34, 0x16u);
    }
    goto LABEL_16;
  }
  if (self) {
  ...
  else
  {
    ...
    if (v21 >= 2.22044605e-16)
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v36 = 2112;
        v37 = v26;
        _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@Skipping microlocation recording scan for event type: %@, throttling in effect", (uint8_t *)&v34, 0x16u);
      }
      os_unfair_lock_unlock(p_lock);
      goto LABEL_16;
    }
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v36 = 2112;
    v37 = v32;
    _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_INFO, "%{public}@Performing microlocation recording scan for event: %@", (uint8_t *)&v34, 0x16u);
  }
...
- (HMDMicroLocationManager)initWithLocationManager:(id)a3
{
  return [(HMDMicroLocationManager *)self initWithLocationManager:a3 dateFactory:&__block_literal_global_7_264367];
}
...
- (HMDMicroLocationManager)initWithLocationManager:(id)a3 dateFactory:(id)a4
{
  ...
  if (v9)
  {
    ...
    uint64_t v11 = objc_msgSend(MEMORY[0x263EFF980], "na_arrayByRepeatingWithCount:generatorBlock:", 3, &__block_literal_global_264373);
    lastRecordingScanTimes = v10->_lastRecordingScanTimes;
    v10->_lastRecordingScanTimes = (NSMutableArray *)v11;

    uint64_t v13 = objc_msgSend(MEMORY[0x263EFF980], "na_arrayByRepeatingWithCount:generatorBlock:", 3, &__block_literal_global_4_264374);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t8_264386 != -1) {
    dispatch_once(&logCategory__hmf_once_t8_264386, &__block_literal_global_22_264387);
  }
  v2 = (void *)logCategory__hmf_once_v9_264388;
  return v2;
}
...
void __38__HMDMicroLocationManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v9_264388;
  logCategory__hmf_once_v9_264388 = v0;
}
