...
- (id)database:(id)a3 willRemoveZoneWithName:(id)a4 isPrivate:(BOOL)a5
{
  ...
  id v8 = a3;
  id v9 = a4;
  if ([v9 hasPrefix:*MEMORY[0x263F0BCA0]] && a5)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v9;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Disabling cloud storage before removing zone with name %@", (uint8_t *)&v17, 0x16u);
    }
...
id __86__HMDCameraClipsQuotaManager__addCodeOperationWithFunctionName_request_responseClass___block_invoke(uint64_t a1, void *a2)
{
  ...
  v4 = [MEMORY[0x263F58190] futureWithError:v3];
...
- (id)disableCloudStorageForZoneWithName:(id)a3
{
  ...
  v6 = (void *)MEMORY[0x230FBD990]([(HMDCameraClipsQuotaDisableCameraMessage *)v5 setZoneName:v4]);
  v7 = self;
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v20 = 2112;
    id v21 = v4;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Sending disable camera message %@ for zone with name %@", buf, 0x20u);
  }
...
id __65__HMDCameraClipsQuotaManager_disableCloudStorageForZoneWithName___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v12 = 2112;
    id v13 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully disabled camera with response: %@", (uint8_t *)&v10, 0x16u);
  }
...
id __65__HMDCameraClipsQuotaManager_disableCloudStorageForZoneWithName___block_invoke_28(uint64_t a1, void *a2)
{
  ...
  {
LABEL_7:
    uint64_t v10 = [MEMORY[0x263F58190] futureWithError:v3];
    goto LABEL_8;
  }
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v13 = 138543362;
    uint64_t v14 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Assuming success for disable camera request because zone does not exist", (uint8_t *)&v13, 0xCu);
  }
...
- (id)enableCloudStorageForZoneWithName:(id)a3
{
  ...
  v6 = (void *)MEMORY[0x230FBD990]([(HMDCameraClipsQuotaEnableCameraMessage *)v5 setZoneName:v4]);
  id v7 = self;
  id v8 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v18 = 2112;
    id v19 = v4;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Sending enable camera message %@ for zone with name %@", buf, 0x20u);
  }
...
id __64__HMDCameraClipsQuotaManager_enableCloudStorageForZoneWithName___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v12 = 2112;
    id v13 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully enabled camera with response: %@", (uint8_t *)&v10, 0x16u);
  }
  id v8 = [MEMORY[0x263F58190] futureWithNoResult];
...
- (id)fetchNamesForZonesWithEnabledCloudStorage
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v14 = 2112;
    uint64_t v15 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Sending get active cameras message %@", buf, 0x16u);
  }
...
id __71__HMDCameraClipsQuotaManager_fetchNamesForZonesWithEnabledCloudStorage__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Successfully got active cameras with zone names: %@", (uint8_t *)&v23, 0x16u);
    }
    __int16 v14 = (void *)MEMORY[0x263F58190];
    uint64_t v15 = [MEMORY[0x263EFFA08] setWithArray:v9];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v27 = 2112;
      id v28 = v3;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Received get active cameras response of unexpected type %@: %@", (uint8_t *)&v23, 0x20u);
    }
...
void __41__HMDCameraClipsQuotaManager_synchronize__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v11 = 138543362;
    __int16 v12 = v10;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Finished initial cloud sync for camera clips quota manager cloud database", (uint8_t *)&v11, 0xCu);
  }
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t15_60693 != -1) {
    dispatch_once(&logCategory__hmf_once_t15_60693, &__block_literal_global_60694);
  }
  id v2 = (void *)logCategory__hmf_once_v16_60695;
  return v2;
}
...
void __41__HMDCameraClipsQuotaManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v16_60695;
  logCategory__hmf_once_v16_60695 = v0;
}
...
+ (id)_quotaErrorFromServerError:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v16 = 2112;
      int v17 = v5;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Determining quota error based on underlying quota server error: %@", (uint8_t *)&v14, 0x16u);
    }
  ...
  __int16 v12 = [MEMORY[0x263F087E8] errorWithDomain:@"HMDCameraClipsQuotaErrorDomain" code:v11 userInfo:0];
...
+ (id)_quotaServerErrorFromServerError:(id)a3
{
  ...
  id v5 = [v3 objectForKeyedSubscript:*MEMORY[0x263F08608]];
