...
- (void)executeSessionWithSessionData:(id)a3 completion:(id)a4
{
  ...
  id v6 = a3;
  obuint64_t j = a4;
  v86 = (void *)[objc_alloc(MEMORY[0x263F424F0]) initWithName:@"HMDMPCSessionCreation"];
  v84 = self;
  v82 = v6;
  if (self)
  {
    id v7 = v6;
    v8 = [v7 mediaProfiles];
    v9 = objc_msgSend(v8, "na_map:", &__block_literal_global_273443);
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v119 = 2112;
    v120 = v80;
    _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Running MPC media session with sessionUUID: %@", buf, 0x16u);
  }
  aBlock[0] = MEMORY[0x263EF8330];
  aBlock[1] = 3221225472;
  aBlock[2] = __68__HMDMPCSessionController_executeSessionWithSessionData_completion___block_invoke;
  aBlock[3] = &unk_264A2F6E8;
  id v79 = v86;
  id v104 = v79;
  v105 = val;
  v78 = self;
  ...
  if (v84)
  {
    v85 = objc_msgSend(MEMORY[0x263EFF980], "arrayWithCapacity:", objc_msgSend(v20, "count"));
    long long v110 = 0u;
    long long v111 = 0u;
    long long v108 = 0u;
    long long v109 = 0u;
            ...
            else
            {
              ...
              if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)v113 = 138543618;
                ...
                __int16 v115 = 2112;
                v116 = v24;
                _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_ERROR, "%{public}@Nil hashed route id for media profile: %@", v113, 0x16u);
              }
            }
          }
          else
          {
            ...
            if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)v113 = 138543618;
              ...
              __int16 v115 = 2112;
              v116 = v24;
              _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_ERROR, "%{public}@No hashed route id for media profile: %@", v113, 0x16u);
            }
          }
        }
        uint64_t v21 = [obja countByEnumeratingWithState:&v108 objects:buf count:16];
  ...
  if ([v37 count])
  {
    ...
    else
    {
      ...
      if (v42)
      {
        uint64_t v40 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2952];
        goto LABEL_45;
      }
    }
...
LABEL_35:
        uint64_t v40 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2953];
        goto LABEL_45;
      }
    ...
    if (v49)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          if (!v53)
          {
            uint64_t v40 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2954];
            goto LABEL_45;
          }
        }
      }
...
LABEL_43:
  ...
  uint64_t v40 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2951];
LABEL_45:
  v54 = (void *)v40;
LABEL_46:
...
void __68__HMDMPCSessionController_executeSessionWithSessionData_completion___block_invoke_2(id *a1, void *a2)
{
  ...
  if (v57)
  {
    ...
    *(void *)&aBlock[16] = __138__HMDMPCSessionController_generateMRCommandOperationsForDestination_playbackArchive_playbackVolumeNumber_playbackStateNumber_sessionUUID___block_invoke;
    ...
    location[0] = *(id *)MEMORY[0x263F54C90];
    v16 = [v12 UUIDString];

    location[1] = *(id *)MEMORY[0x263F54C70];
    *(void *)&long long v64 = v16;
    *((void *)&v64 + 1) = MEMORY[0x263EFFA88];
    v17 = [NSDictionary dictionaryWithObjects:&v64 forKeys:location count:2];
...
LABEL_20:
      ...
      if (val)
      {
        id v45 = objc_alloc_init(MEMORY[0x263F42500]);
    ...
    if ((unint64_t)(v22 - 1) >= 3)
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
      {
        ...
        *(void *)&buf[14] = v22;
        v35 = (void *)v34;
        _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_ERROR, "%{public}@Unknown HMMediaPlaybackState: %ld", buf, 0x16u);
      }
      uint64_t v23 = 3;
      if (v8) {
        goto LABEL_10;
    ...
    {
      uint64_t v23 = dword_2303E4A58[v22 - 1];
      if (v8)
      {
LABEL_10:
        objc_msgSend(MEMORY[0x263F547D0], "nowPlayingApplicationDestination", context);
...
LABEL_18:
  ...
  v25 = a1;
  v26 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2950, @"MPC Session Creation Failed, Unable to resolve destination", 0 description underlyingError];
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
  {
    ...
    *(void *)&aBlock[14] = v31;
    _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@MPC Session Creation Failed, Unable to resolve destination for sessionUUID: %@", aBlock, 0x16u);
  }
  (*((void (**)(void))v25[8] + 2))();
        ...
        if (v11)
        {
          ...
          if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v43 = 2112;
            id v44 = v24;
            _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@MPC Session Creation Failed at Command (%@) : %@", buf, 0x20u);
          }
          ...
          if (v15)
          {
            ...
            if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v43 = 2112;
              id v44 = v31;
              _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@MPC Session Creation Failed at Command (%@) : partial success %@", buf, 0x20u);
            }
...
LABEL_23:
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v40 = v19;
    _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@MPC Session Created Successfully", buf, 0xCu);
  }
  (*(void (**)(void))(*(void *)(a1 + 56) + 16))();
  [v3 finish];
LABEL_24:
...
- (HMDMPCSessionController)initWithLogEventSubmitter:(id)a3
{
  ...
  if (v6)
  {
    uint64_t v7 = (NSOperationQueue *)objc_alloc_init(MEMORY[0x263F08A48]);
