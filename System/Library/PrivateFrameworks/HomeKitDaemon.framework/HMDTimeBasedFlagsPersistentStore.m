...
- (id)unarchive
{
  ...
  v5 = [MEMORY[0x263EFF8C0] arrayWithObjects:v21 count:3];
  ...
  if (v8)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v19 = 2112;
      v20 = v8;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Unarchived flags store: %@", (uint8_t *)&v17, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v17 = 138543362;
      v18 = v15;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@No time-based flag archive found", (uint8_t *)&v17, 0xCu);
    }
    v14 = 0;
  }
