  ...
  if (v5 == v4)
  {
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      {
        ...
        int v12 = 138543362;
        v13 = v10;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Timed out waiting for load balancing message response", (uint8_t *)&v12, 0xCu);
      }
      v11 = [MEMORY[0x263F087E8] hmErrorWithCode:8 description:@"Timed out waiting for load balancing message response" reason:0 suggestion:0];
...
- (HMDCameraRecordingLoadBalancingAttempt)initWithLocalResponseTimeout:(double)a3 logIdentifier:(id)a4
{
  v6 = (objc_class *)MEMORY[0x263F42658];
  id v7 = a4;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_268824 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_268824, &__block_literal_global_268825);
  }
  v2 = (void *)logCategory__hmf_once_v2_268826;
  return v2;
}
...
void __53__HMDCameraRecordingLoadBalancingAttempt_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_268826;
  logCategory__hmf_once_v2_268826 = v0;
}
