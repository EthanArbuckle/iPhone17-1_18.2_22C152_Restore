...
- (BOOL)_parseFromTLVData
{
  ...
  v3 = [MEMORY[0x263F35990] wrappertlv:2 name:@"kSRTPParameters_SRTPMasterKey"];
  id v4 = [MEMORY[0x263F35990] wrappertlv:3 name:@"kSRTPParameters_SRTPMasterSalt"];
  v5 = [MEMORY[0x263F35A58] wrappertlv:1 name:@"kSRTPParameters_SRTPCryptoSuite"];
  v19[0] = v3;
  v19[1] = v4;
  v19[2] = v5;
...
LABEL_6:
    ...
    if (v9 == 2)
    {
      ...
      uint64_t v14 = [MEMORY[0x263EFF8F8] data];
      goto LABEL_6;
    }
  }
LABEL_7:
