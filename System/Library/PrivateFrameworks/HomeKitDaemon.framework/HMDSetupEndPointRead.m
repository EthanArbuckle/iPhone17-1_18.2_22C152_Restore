...
- (HMDSetupEndPointRead)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    objc_super v7 = [MEMORY[0x263EFF8C0] arrayWithObjects:v19 count:1];
...
- (BOOL)_parseFromTLVDataOnSuccess
{
  ...
  objc_super v3 = [MEMORY[0x263F35A58] wrappertlv:6 name:@"kSetupEndPointRead__VideoSSRC"];
  id v4 = [MEMORY[0x263F35A58] wrappertlv:7 name:@"kSetupEndPointRead__AudioSSRC"];
  v14[0] = v3;
  v14[1] = v4;
...
- (BOOL)_parseFromTLVData
{
  ...
  objc_super v3 = [MEMORY[0x263F35B00] wrappertlv:1 name:@"kSetupEndPoint__SessionIdentifier"];
  id v4 = [MEMORY[0x263F35A58] wrappertlv:2 name:@"kSetupEndPointRead__Status"];
  v11[0] = v3;
  v11[1] = v4;
