...
- (HMDBulletinBoardNotificationServiceGroup)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      ...
      v8 = [MEMORY[0x263EFF8C0] arrayWithObjects:v26 count:2];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v29 = 2112;
      uint64_t v30 = 0;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Could not initialize from decoded bulletinBoardNotification: %@", buf, 0x16u);
    }
    v20 = 0;
  }
...
- (id)actionContextForCameraProfileID:(id)a3
{
  ...
  if (v5)
  {
    ...
    char v12 = [v11 isEqualToString:*MEMORY[0x263F35768]];
    ...
    if ((v12 & 1) == 0)
    {
      ...
      v99[2] = @"title";
      v100[2] = v18;
      v20 = [NSDictionary dictionaryWithObjects:v100 forKeys:v99 count:3];
      [v7 addObject:v20];
    }
    else
    {
LABEL_4:
    ...
    uint64_t v23 = *MEMORY[0x263F35708];
    v24 = [v22 objectForKeyedSubscript:*MEMORY[0x263F35708]];
    v74 = v5;
    id v82 = v4;
    v83 = v7;
    v84 = v22;
...
LABEL_26:
          ...
          uint64_t v47 = *MEMORY[0x263F35728];
          v48 = [v22 objectForKeyedSubscript:*MEMORY[0x263F35728]];
          uint64_t v49 = [v48 count];

          uint64_t v50 = *MEMORY[0x263F35710];
          v51 = [v22 objectForKeyedSubscript:*MEMORY[0x263F35710]];
...
LABEL_45:
            ...
            v69 = [MEMORY[0x263F1DF10] actionWithIdentifier:@"DISMISS" title:v68 options:0];
            v93[0] = @"categoryID";
            v93[1] = @"bulletinActionButtonDescription";
            v94[0] = @"HomeAppBulletinCategory";
            v94[1] = v55;
            v93[2] = *MEMORY[0x263F0BAA8];
            ...
            v94[2] = v72;
            v94[3] = v69;
            uint64_t v17 = [*(id *)(v56 + 2352) dictionaryWithObjects:v94 forKeys:v93 count:4];
...
LABEL_44:
                ...
                v96[2] = v46;
                v96[3] = v54;
                v67 = [*(id *)(v65 + 2352) dictionaryWithObjects:v96 forKeys:v95 count:4];
                [v55 addObject:v67];
...
LABEL_43:
      ...
      v76 = v43;
      unint64_t v8 = 0x263EFF000uLL;
      v75 = [NSDictionary dictionaryWithObjects:v98 forKeys:v97 count:4];
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v103 = 2112;
    id v104 = v4;
    _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Could not find the camera profile with unique id %@, not providing any context", buf, 0x16u);
  }
  uint64_t v17 = 0;
LABEL_46:
  ...
  if (v7 == 0x7FFFFFFFFFFFFFFFLL)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v18 = 2112;
      id v19 = v6;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find the camera profile with unique id %@", buf, 0x16u);
    }
    char v12 = 0;
  }
  else
...
- (id)dumpState
{
  ...
  [v3 setObject:v4 forKeyedSubscript:*MEMORY[0x263F41EC0]];
  ...
  [v3 setObject:v11 forKeyedSubscript:*MEMORY[0x263F41EB0]];
  return v3;
}
...
- (void)_updateAssociatedServices:(id)a3 associatedCameras:(id)a4
{
  ...
  {
    long long v19 = (void *)MEMORY[0x230FBD990]([(HMDBulletinBoardNotificationServiceGroup *)self setAssociatedServiceUUIDs:v13]);
    long long v20 = self;
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v61 = 2112;
      v62 = v13;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Updating associated services with %@", buf, 0x16u);
...
LABEL_8:
  long long v23 = [MEMORY[0x263F088B0] weakObjectsHashTable];
  long long v54 = 0u;
  long long v55 = 0u;
  long long v56 = 0u;
  long long v57 = 0u;
  uint64_t v49 = v7;
  long long v24 = [v7 allValues];
  ...
  if (v25)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v26; ++i)
      {
        ...
        uint64_t v29 = [*(id *)(*((void *)&v54 + 1) + 8 * i) cameraProfile];
        [v23 addObject:v29];
      }
  ...
  if ((v32 & 1) == 0)
  {
    BOOL v41 = (void *)MEMORY[0x230FBD990]();
    v42 = self;
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v61 = 2112;
      v62 = v10;
      _os_log_impl(&dword_22F52A000, v43, OS_LOG_TYPE_INFO, "%{public}@Updating associated cameras with %@", buf, 0x16u);
    }
    [(HMDBulletinBoardNotificationServiceGroup *)v42 setCameraProfileUUIDs:v10];
    [(HMDBulletinBoardNotificationServiceGroup *)v42 setCameraProfilesTable:v23];
  ...
  {
LABEL_25:
    uint64_t v45 = [v30 service];
    id v46 = [v45 accessory];
    uint64_t v47 = [v46 home];

    [v47 saveWithReason:@"HMDBulletinBoardNotificationServiceGroupUpdatedSaveReason" postSyncNotification:0];
    v48 = [v47 accessoryBulletinNotificationManager];
    ...
    id v52 = v13;
    id v53 = v10;
    [v48 updateServiceGroup:self completion:v51];

    goto LABEL_26;
  }
  double v37 = (void *)MEMORY[0x230FBD990](v35);
  double v38 = self;
  ...
  if (os_log_type_enabled(v39, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v60 = v40;
    _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_DEBUG, "%{public}@No change in service and camera associations", buf, 0xCu);
  }
LABEL_26:
}
...
void __88__HMDBulletinBoardNotificationServiceGroup__updateAssociatedServices_associatedCameras___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v23 = 2112;
      id v24 = v3;
      long long v11 = "%{public}@Error updating bulletin notification manager with associated services: %@ and cameras: %@, error: %@";
      long long v12 = v7;
...
LABEL_6:
  ...
  else if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v21 = 2112;
    uint64_t v22 = v16;
    long long v11 = "%{public}@Updated bulletin notification manager with associated services: %@ and cameras: %@";
    long long v12 = v7;
...
- (void)_configureServices
{
  ...
  if (v5)
  {
    ...
    if (v71)
    {
      ...
      if (v70)
      {
        ...
        if ([(HMDBulletinBoardNotificationServiceGroup *)self _isDefaultRoom:v5 ofHome:v71])
        {
          id v6 = v70;
          v111[0] = v70;
          id v7 = [MEMORY[0x263EFF8C0] arrayWithObjects:v111 count:1];
        }
        else
        {
                      ...
                      if ([(HMDBulletinBoardNotificationServiceGroup *)self _isSupportedAssociationService:v33])
                      {
                        ...
                        if (os_log_type_enabled(v36, OS_LOG_TYPE_DEBUG))
                        {
                          ...
                          *(_DWORD *)buf = 138543874;
                          ...
                          __int16 v107 = 2112;
                          v108 = v38;
                          _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_DEBUG, "%{public}@Service %@ with type %@ is a supported service for association", buf, 0x20u);
                      ...
                      if ([(HMDBulletinBoardNotificationServiceGroup *)self _isAlarmService:v49])
                      {
                        ...
                        if (os_log_type_enabled(v52, OS_LOG_TYPE_DEBUG))
                        {
                          ...
                          *(_DWORD *)buf = 138543874;
                          ...
                          __int16 v107 = 2112;
                          v108 = v54;
                          _os_log_impl(&dword_22F52A000, v52, OS_LOG_TYPE_DEBUG, "%{public}@Service %@ with type %@ contains an alarm system, adding it to association", buf, 0x20u);

                          __int16 v23 = v83;
                        }

                        long long v55 = [v49 serviceIdentifier];
        ...
        if (os_log_type_enabled(v58, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v105 = 2112;
          v106 = v67;
          _os_log_impl(&dword_22F52A000, v58, OS_LOG_TYPE_DEBUG, "%{public}@Camera Notification Services %@", buf, 0x16u);
        }
        if ([v67 count])
        {
          v60 = v57;
        ...
        else
        {
          ...
          if (os_log_type_enabled(v65, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            id v104 = v66;
            _os_log_impl(&dword_22F52A000, v65, OS_LOG_TYPE_INFO, "%{public}@There are no cameras, no association of services", buf, 0xCu);
          }
          __int16 v61 = (void *)MEMORY[0x263EFFA78];
          v60 = v64;
          v62 = (void *)MEMORY[0x263EFFA78];
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          id v104 = v22;
          _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@No accessory, bailing out", buf, 0xCu);
        }
      }
      __int16 v18 = v71;
    }
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v104 = v17;
        _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@No home, bailing out", buf, 0xCu);
      }
      __int16 v18 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v104 = v13;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@No room, bailing out", buf, 0xCu);
    }
  }
}
    ...
    if (v29)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          os_log_type_t v13 = [v12 uniqueIdentifier];
          ...
          if (v17)
          {
            ...
            do
            {
              for (uint64_t i = 0; i != v18; ++i)
              {
                ...
                {
                  uint64_t v22 = [(HMDBulletinBoardCameraNotificationAssociation *)v9 notificationGeneratingServicesWithCamera];
                  [v22 addObject:v21];
                }
              }
  ...
  if (v8)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v9; ++i)
      {
        ...
        os_log_type_t v13 = [v12 room];
        uint32_t v14 = [v13 uuid];
        id v15 = [v5 uuid];
...
- (void)configureBulletinNotification
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      int v9 = 138543362;
      uint64_t v10 = v8;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@configureBulletinNotification called before configure", (uint8_t *)&v9, 0xCu);
    }
  }
}
...
- (BOOL)_isNotificationGeneratingService:(id)a3
{
  ...
  uint64_t v3 = *MEMORY[0x263F35768];
  v9[0] = *MEMORY[0x263F356D0];
  v9[1] = v3;
...
- (BOOL)_isAlarmService:(id)a3
{
  uint64_t v3 = [a3 findCharacteristicWithType:*MEMORY[0x263F35550]];
...
- (BOOL)_isSupportedAssociationService:(id)a3
{
  ...
  uint64_t v3 = *MEMORY[0x263F356C8];
  v10[0] = *MEMORY[0x263F35708];
  v10[1] = v3;
  uint64_t v4 = *MEMORY[0x263F35710];
  v10[2] = *MEMORY[0x263F356E8];
  void v10[3] = v4;
...
- (void)_handleBulletinBoardNotificationServiceGroupRequest:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v6;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Responding to a request for notification service group with payload %@", (uint8_t *)&v12, 0x16u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t29_13651 != -1) {
    dispatch_once(&logCategory__hmf_once_t29_13651, &__block_literal_global_13652);
  }
  v2 = (void *)logCategory__hmf_once_v30_13653;
  return v2;
}
...
void __55__HMDBulletinBoardNotificationServiceGroup_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v30_13653;
  logCategory__hmf_once_v30_13653 = v0;
}
