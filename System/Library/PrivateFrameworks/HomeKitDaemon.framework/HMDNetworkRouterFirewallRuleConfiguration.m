...
- (NSDictionary)prettyJSONDictionary
{
  ...
  long long v19 = objc_msgSend(v20, "na_map:", &__block_literal_global_51_255948);
  ...
  int v9 = objc_msgSend(v8, "na_map:", &__block_literal_global_61_255953);
  ...
  v24[5] = v15;
  id v18 = [NSDictionary dictionaryWithObjects:v24 forKeys:v23 count:6];
  if (!v14) {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v27 = 2112;
      id v28 = v6;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Network declaration must contain firmware version: %@", buf, 0x16u);
    }
    long long v17 = 0;
  }
        ...
        while (2)
        {
          for (uint64_t i = 0; i != v19; ++i)
          {
            ...
            if (!v25)
            {
              ...
              if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                __int16 v60 = 2112;
                id v61 = v49;
                _os_log_impl(&dword_22F52A000, v43, OS_LOG_TYPE_ERROR, "%{public}@Network declaration contains an invalid rule in '%@' value: %@", buf, 0x20u);
              }
              id v33 = 0;
              v39 = v17;
              goto LABEL_41;
            ...
            if (v26)
            {
              ...
              {
                v20 = [MEMORY[0x263EFF980] arrayWithObject:v26];
              }
            }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v60 = 2112;
        id v61 = v10;
        _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_ERROR, "%{public}@Network declaration contains an invalid '%@' value: %@", buf, 0x20u);
      }
      id v33 = 0;
    }
  }
  else if (v6)
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v60 = 2112;
      id v61 = v10;
      _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@Network declaration contains no '%@' value: %@", buf, 0x20u);
    }
    id v33 = 0;
  }
  else
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v25 = 2112;
      id v26 = v8;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Network declaration contains an invalid '%@' value: %@", buf, 0x20u);
    }
    goto LABEL_9;
  }
  BOOL v14 = 1;
...
LABEL_11:
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, v18, (uint8_t *)&v21, 0x20u);
    }
LABEL_12:
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_256036 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_256036, &__block_literal_global_256037);
  }
  v2 = (void *)logCategory__hmf_once_v1_256038;
  return v2;
}
...
void __56__HMDNetworkRouterFirewallRuleConfiguration_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_256038;
  logCategory__hmf_once_v1_256038 = v0;
}
