  ...
  if (v5 == v4)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        int v12 = 138543362;
        v13 = v11;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of triggered timer due to no delegate", (uint8_t *)&v12, 0xCu);
      }
    }
  }
}
...
- (void)startRetryTimer
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v22 = 2112;
    v23 = v7;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting timer with attempts: %@", (uint8_t *)&v20, 0x16u);
  }
  if ([(HMDMediaGroupsAggregateBackupMessageTimer *)v4 attemptCount] < 0x24)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        int v20 = 138543362;
        v21 = v19;
        _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to start new timer due to no timer provider", (uint8_t *)&v20, 0xCu);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v22 = 2112;
      v23 = &unk_26E472448;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to create retry timer due to reaching the max attempt count: %@", (uint8_t *)&v20, 0x16u);
    }
  }
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_171589 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_171589, &__block_literal_global_171590);
  }
  unint64_t v2 = (void *)logCategory__hmf_once_v5_171591;
  return v2;
}
...
void __56__HMDMediaGroupsAggregateBackupMessageTimer_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_171591;
  logCategory__hmf_once_v5_171591 = v0;
}
