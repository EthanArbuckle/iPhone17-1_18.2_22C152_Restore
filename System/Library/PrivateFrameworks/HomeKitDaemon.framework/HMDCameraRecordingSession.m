...
- (HMDCameraRecordingSession)initWithWorkQueue:(id)a3 camera:(id)a4 hapAccessory:(id)a5 home:(id)a6 localZone:(id)a7 configuredFragmentDuration:(double)a8 timelineManager:(id)a9;
- (HMDCameraRecordingSession)initWithWorkQueue:(id)a3 camera:(id)a4 hapAccessory:(id)a5 home:(id)a6 localZone:(id)a7 configuredFragmentDuration:(double)a8 timelineManager:(id)a9 factory:(id)a10;
...
- (HMIVideoAnalyzerFragmentResult)introAnalyzerResult
{
  return (HMIVideoAnalyzerFragmentResult *)objc_getProperty(self, a2, 168, 1);
}
...
- (HMIVideoFragment)introFragment
{
  return (HMIVideoFragment *)objc_getProperty(self, a2, 160, 1);
}
...
- (HMDDataStreamFragment)cameraVideoInitFragment
{
  return (HMDDataStreamFragment *)objc_getProperty(self, a2, 152, 1);
}
...
- (HMDCameraClipUploader)clipUploader
{
  return (HMDCameraClipUploader *)objc_getProperty(self, a2, 136, 1);
}
...
- (HMDCameraRecordingSessionVariantFragmentManager)timelapseFragmentManager
{
  return (HMDCameraRecordingSessionVariantFragmentManager *)objc_getProperty(self, a2, 120, 1);
}

- (HMDCameraRecordingSessionSignificantEventManager)significantEventManager
{
  return (HMDCameraRecordingSessionSignificantEventManager *)objc_getProperty(self, a2, 112, 1);
}

- (HMFActivity)sessionActivity
{
  return (HMFActivity *)objc_getProperty(self, a2, 104, 1);
}

- (HMDCameraRecordingSessionVideoAnalyzer)videoAnalyzer
{
  return (HMDCameraRecordingSessionVideoAnalyzer *)objc_getProperty(self, a2, 96, 1);
}

- (HMDCameraRecordingSessionFactory)factory
{
  return (HMDCameraRecordingSessionFactory *)objc_getProperty(self, a2, 88, 1);
}

- (HMBLocalZone)localZone
{
  return (HMBLocalZone *)objc_getProperty(self, a2, 80, 1);
}
...
- (HMDCameraProfile)camera
{
  return (HMDCameraProfile *)objc_getProperty(self, a2, 64, 1);
}
...
- (HMDCameraRecordingSessionTimelineManager)timelineManager
{
  return (HMDCameraRecordingSessionTimelineManager *)objc_getProperty(self, a2, 40, 1);
}
...
LABEL_4:
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v9;
    _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Skipping upload for placeholder fragment because the timelapse clip uploader is not created yet, fragment: %@", (uint8_t *)&v17, 0x16u);
  }
LABEL_9:
}
...
- (void)uploaderDidFailUpload:(id)a3
{
  ...
  if (v6 == v4)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      int v19 = 138543362;
      id v20 = v17;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Current clip uploader did fail upload", (uint8_t *)&v19, 0xCu);
    }
  ...
  else
  {
    ...
    if (v7 == v4)
    {
      if (v11)
      {
        ...
        int v19 = 138543362;
        id v20 = v18;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Timelapse clip uploader did fail upload", (uint8_t *)&v19, 0xCu);
      }
    ...
    else
    {
      if (v11)
      {
        ...
        int v19 = 138543362;
        id v20 = v12;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Previous clip uploader did fail upload", (uint8_t *)&v19, 0xCu);
      }
      id v13 = (id)[v4 finish];
    }
  }
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v16 = 2112;
      int v17 = v9;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Finishing timelapse clip uploader: %@", buf, 0x16u);
    }
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v17 = 2112;
      uint64_t v18 = v9;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Finishing clip uploader: %@", buf, 0x16u);
    }
...
- (void)_writeEvent:(id)a3
{
    ...
    && [(HMDCameraRecordingSession *)self _createSessionDirectory])
  {
    ...
    char v7 = [MEMORY[0x263EFFA18] localTimeZone];
    [v6 setTimeZone:v7];
    ...
    id v38 = 0;
    id v11 = [MEMORY[0x263F08900] dataWithJSONObject:v8 options:0 error:&v38];
    id v12 = v38;
    if (!v11)
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v43 = 2112;
        id v44 = v12;
        _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize log event: %@ error: %@", buf, 0x20u);
      }
      goto LABEL_17;
    }
    ...
    id v20 = [MEMORY[0x263F08840] fileHandleForWritingAtPath:v19];
    uint64_t v21 = v20;
    if (v20)
    {
      [v20 seekToEndOfFile];
...
LABEL_14:
          _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, v26, buf, 0x20u);
...
- (void)_writeFragment:(id)a3
{
  ...
  BOOL v6 = [MEMORY[0x263F42608] sharedPreferences];
  ...
  if (v8 && [(HMDCameraRecordingSession *)self _createSessionDirectory])
  {
    ...
    uint64_t v14 = [MEMORY[0x263F08840] fileHandleForWritingAtPath:v13];
    v15 = v14;
    if (v14)
    {
      [v14 seekToEndOfFile];
...
LABEL_10:
          _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, v23, buf, 0x20u);
...
- (BOOL)_createSessionDirectory
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v28 = 2112;
    v29 = v15;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Writing session data to directory: %@", buf, 0x16u);
  }
  ...
  if ((v5 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v30 = 2112;
      id v31 = v18;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to create directory at path: %@ error: %@", buf, 0x20u);
    }
  }
...
LABEL_6:
        ...
        uint32_t v13 = 12;
LABEL_19:
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, v11, buf, v13);
      }
LABEL_20:
      BOOL v15 = 0;
      goto LABEL_21;
    ...
    if (v22)
    {
      char v7 = (void *)MEMORY[0x230FBD990](v23, v24, v25, v26, v27, v28);
      v29 = self;
      id v9 = HMFGetOSLogHandle();
      if (!os_log_type_enabled(v9, OS_LOG_TYPE_INFO)) {
        goto LABEL_20;
...
LABEL_18:
    ...
    if (v33)
    {
      char v7 = (void *)MEMORY[0x230FBD990](v34, v35, v36, v37, v38, v39);
      v40 = self;
      id v9 = HMFGetOSLogHandle();
      if (!os_log_type_enabled(v9, OS_LOG_TYPE_INFO)) {
        goto LABEL_20;
    ...
    if (v42)
    {
      ...
      if ((v50 & 1) == 0)
      {
        char v7 = (void *)MEMORY[0x230FBD990](v42, v43, v44, v45, v46, v47);
        v52 = self;
        id v9 = HMFGetOSLogHandle();
        if (!os_log_type_enabled(v9, OS_LOG_TYPE_INFO)) {
          goto LABEL_20;
...
LABEL_26:
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, v17, buf, 0xCu);
...
- (BOOL)_shouldRecordFragmentWithAnalyzerResult:(id)a3 sequenceNumber:(unint64_t)a4 recordingEventTriggers:(unint64_t)a5 fragmentAnalyzedEvent:(id)a6
{
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v62 = 2048;
    double v63 = Seconds;
    _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Doorbell is active: %@ for fragment at time offset: %f and duration: %f", buf, 0x2Au);
  }
  if (v19)
  {
    uint64_t v25 = (void *)MEMORY[0x230FBD990]([v10 setRecordingReason:2]);
    uint64_t v26 = v21;
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v57 = v28;
      _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_DEFAULT, "%{public}@Doorbell event detected, starting recording", buf, 0xCu);
    }
    goto LABEL_25;
  }
  ...
  if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v62 = 2048;
    double v63 = Seconds;
    _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_INFO, "%{public}@Motion is active: %@ for fragment at time offset: %f and duration: %f", buf, 0x2Au);
  }
  ...
  if ((v37 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      _os_log_impl(&dword_22F52A000, v43, OS_LOG_TYPE_DEFAULT, "%{public}@Fragment analysis was skipped, recordingTriggerEvent is %@ and motion is %@", buf, 0x20u);
    }
    if (a5) {
      int v47 = v30;
    }
...
LABEL_29:
  ...
  if (!v39)
  {
    ...
    if (os_log_type_enabled(v50, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v57 = v51;
      _os_log_impl(&dword_22F52A000, v50, OS_LOG_TYPE_DEFAULT, "%{public}@No user recording trigger events match any detected significant events", buf, 0xCu);
    }
    goto LABEL_29;
  }
  BOOL v40 = 1;
...
void __50__HMDCameraRecordingSession__endSessionWithError___block_invoke_2(uint64_t a1)
{
  ...
  if (*(void *)(a1 + 32))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v23 = 2112;
      uint64_t v24 = v6;
      _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_ERROR, "%{public}@Video analyzer finished with error: %@", (uint8_t *)&v21, 0x16u);
    }
  }
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      int v21 = 138543362;
      __int16 v22 = v12;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Timelapse clip uploader is still expecting a timelapse fragment", (uint8_t *)&v21, 0xCu);
    }
  }
  os_log_type_t v13 = (void *)MEMORY[0x230FBD990]();
  id v14 = *(id *)(a1 + 40);
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v23 = 2112;
    uint64_t v24 = v17;
    _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Finishing timelapse clip uploader: %@", (uint8_t *)&v21, 0x16u);
  }
...
- (void)_handleDidFailAnalysisWithError:(id)a3
{
  ...
  BOOL v6 = (void *)MEMORY[0x230FBD990]([(HMDCameraRecordingSession *)self setPendingFragmentsCount:[(HMDCameraRecordingSession *)self pendingFragmentsCount] - 1]);
  id v7 = self;
  int v8 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v4;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@Analysis failed with error: %@", (uint8_t *)&v11, 0x16u);
  }
  id v10 = [MEMORY[0x263F087E8] errorWithDomain:@"HMDCameraRecordingSessionErrorDomain" code:2 userInfo:0];
...
- (void)_notifyForSignificantEvent:(id)a3 recordingEventTriggers:(unint64_t)a4 fragmentNumber:(unint64_t)a5
{
  ...
  int v11 = [v10 addNotificationForSignificantEvent:v8];
...
{
  v2 = [*(id *)(a1 + 32) camera];
  id v3 = [v2 hapAccessory];
  id v4 = [v3 home];
  uint64_t v5 = [v4 cameraBulletinNotificationManager];
  uint64_t v6 = *(void *)(a1 + 40);
  id v7 = [*(id *)(a1 + 32) camera];
  [v5 handleSignificantEvent:v6 cameraProfile:v7];

  id v8 = *(void **)(a1 + 32);
  uint64_t v9 = *(void *)(a1 + 48);
  uint64_t v10 = *(void *)(a1 + 56);
  return [v8 _submitNotificationSuccessMetricWithRecordingEventTriggers:v9 fragmentNumber:v10];
}
...
- (void)_notifyForAnalyzerResult:(id)a3 fragment:(id)a4 timeOffsetWithinClip:(double)a5 recordingEventTriggers:(unint64_t)a6
{
  ...
  *(_OWORD *)&time.value = v26;
  ...
  id v15 = [(HMDCameraRecordingSession *)self significantEventManager];
  unint64_t v16 = [v15 significantEventsForAnalyzerFragmentResult:v10 dateOfOccurrence:v14 timeOffsetWithinClip:a6 recordingEventTriggers:a5];
...
- (void)_uploadTimelapseFragment:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v59 = 2112;
    id v60 = v4;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Uploading timelapse fragment: %@", buf, 0x16u);
  }
  ...
  if (!v10)
  {
    ...
    id v15 = [(HMDCameraRecordingSession *)v7 localZone];
    unint64_t v16 = [(HMDCameraRecordingSession *)v7 workQueue];
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v59 = 2112;
      id v60 = v24;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Created new timelapse clip uploader: %@", buf, 0x16u);
    }
        ...
        (v30 & 1) == 0))
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v61 = 2112;
      __int16 v62 = v28;
      _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_INFO, "%{public}@Analysis timelapse video init fragment changed from %@ to %@", buf, 0x20u);
    }
...
- (void)_uploadFragment:(id)a3 withDuration:(double)a4 clipFinalizedBecauseMaxDurationExceeded:(BOOL)a5
{
  ...
  id v8 = a3;
  uint64_t v9 = [(HMDCameraRecordingSession *)self analysisVideoInitData];
        ...
        (v12 & 1) == 0))
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v34 = 2112;
      uint64_t v35 = v10;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Analysis video init fragment changed from %@ to %@", buf, 0x20u);
    }
...
- (void)_handleFragmentResult:(id)a3
{
  ...
  if (Seconds > v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      unint64_t v16 = [(HMDCameraRecordingSession *)v12 factory];
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v132 = 2048;
      double v133 = v17;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Finishing current clip upload because segment would exceed max duration (%.2f > %.2f)", buf, 0x20u);
    }
...
LABEL_10:
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v130 = 2112;
    Float64 v131 = v24;
    _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Comparing fragment with recording event triggers: %@", buf, 0x16u);
  }
    ...
    if (v39 <= 0.0)
    {
      if (v43)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v130 = 2112;
        Float64 v131 = v48;
        _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_INFO, "%{public}@Flagging fragment for recording because remaining recording extension duration is %@s. Extension duration will be cleared", buf, 0x16u);
      }
    ...
    else
    {
      if (v43)
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v132 = 2048;
        double v133 = v39;
        _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_INFO, "%{public}@Flagging fragment for recording because remaining recording extension duration is %@s. New extension duration will be %fs", buf, 0x20u);
      }
...
LABEL_31:
  ...
  v127[3] = v53;
  long long v54 = [NSDictionary dictionaryWithObjects:v127 forKeys:v126 count:4];
  ...
  if (!v38)
  {
    if (v58)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v57, OS_LOG_TYPE_INFO, "%{public}@Fragment %lu was not flagged for recording", buf, 0x16u);
    }
  ...
  if (v58)
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_22F52A000, v57, OS_LOG_TYPE_INFO, "%{public}@Fragment %lu was flagged for recording", buf, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v82, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v130 = 2112;
      Float64 v131 = v84;
      _os_log_impl(&dword_22F52A000, v82, OS_LOG_TYPE_INFO, "%{public}@Created new clip uploader: %@", buf, 0x16u);
    }
...
LABEL_50:
  *(_OWORD *)&v108.value = v105;
  ...
  if (v61 && v62)
  {
    v86 = (void *)MEMORY[0x230FBD990](v85);
    v87 = v56;
    ...
    if (os_log_type_enabled(v88, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v88, OS_LOG_TYPE_INFO, "%{public}@Uploading intro fragment %lu", buf, 0x16u);
    }
    v91 = [v62 fragment];
    v92 = v91;
    if (v91) {
...
void __65__HMDCameraRecordingSession_analyzer_didCreateTimelapseFragment___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v10 = 2112;
    uint64_t v11 = v6;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Timelapse fragment was created: %@", (uint8_t *)&v8, 0x16u);
  }
...
uint64_t __67__HMDCameraRecordingSession_analyzer_didAnalyzeFragmentWithResult___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v10 = 2112;
    uint64_t v11 = v6;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Fragment was analyzed: %@", (uint8_t *)&v8, 0x16u);
  }
...
- (void)handleNoMoreFragmentsAvailable
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v12 = 138543362;
    id v13 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Accessory has no more fragments available for analysis", (uint8_t *)&v12, 0xCu);
  }
    ...
    && [(HMDCameraRecordingSession *)v5 isActive])
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      int v12 = 138543362;
      id v13 = v11;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Finalizing session because all fragments have been analyzed", (uint8_t *)&v12, 0xCu);
    }
...
- (void)handleFragment:(id)a3
{
  ...
  if (!v7)
  {
    if ([(HMDCameraRecordingSession *)self _isValidFirstSessionFragment:v4])
    {
      ...
      id v13 = [MEMORY[0x263EFF9A0] dictionaryWithDictionary:&unk_26E474D28];
...
LABEL_17:
      _os_log_impl(&dword_22F52A000, v47, OS_LOG_TYPE_ERROR, v49, buf, 0x16u);
    }
LABEL_18:

    id v13 = [MEMORY[0x263F087E8] errorWithDomain:@"HMDCameraRecordingSessionErrorDomain" code:1 userInfo:0];
  ...
  if ([(HMDCameraRecordingSession *)self isActive])
  {
    ...
    {
      id v8 = objc_alloc(MEMORY[0x263F47D30]);
      id v9 = [v7 data];
      __int16 v10 = [v4 data];
      ...
      CMTime v50 = v11;
      int v12 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v50 count:1];
      ...
      Float64 v15 = (void *)MEMORY[0x230FBD990]([(HMDCameraRecordingSession *)self setPendingFragmentsCount:[(HMDCameraRecordingSession *)self pendingFragmentsCount] + 1]);
      unint64_t v16 = self;
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(void *)&buf[14] = v13;
        _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Requesting analysis for fragment: %@", buf, 0x16u);
      }
      id v19 = objc_alloc_init(MEMORY[0x263F47CF8]);
  ...
  if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
  {
    ...
    *(void *)&uint8_t buf[4] = v44;
    _os_log_impl(&dword_22F52A000, v43, OS_LOG_TYPE_INFO, "%{public}@Dropping fragment for analysis as session is no longer active", buf, 0xCu);
  }
...
- (void)configure
{
  ...
  if (v5)
  {
    ...
    int v12 = [v5 users];
    id v13 = objc_msgSend(v12, "na_map:", &__block_literal_global_227920);
    ...
    unint64_t v16 = [v5 analysisStatePublisher];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      int v23 = 138543362;
      double v24 = v22;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Can't configure recording session because home reference is nil", (uint8_t *)&v23, 0xCu);
    }
  }
}
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v10 = 2112;
    uint64_t v11 = v4;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Deallocating recording session: %@", buf, 0x16u);
  }
  v7.receiver = v4;
...
LABEL_19:
  ...
  {
LABEL_20:
    long long v55 = (HMDCameraRecordingSession *)_HMFPreconditionFailure();
    return [(HMDCameraRecordingSession *)v55 initWithWorkQueue:v57 camera:v58 hapAccessory:v59 home:v60 localZone:v61 configuredFragmentDuration:v63 timelineManager:v62];
  }
  v67 = v22;
  v76.receiver = self;
  v76.super_class = (Class)HMDCameraRecordingSession;
  int v23 = [(HMDCameraRecordingSession *)&v76 init];
  double v24 = v23;
  if (v23)
  {
    objc_storeStrong((id *)&v23->_workQueue, a3);
    objc_storeStrong((id *)&v24->_camera, a4);
    objc_storeStrong((id *)&v24->_localZone, a7);
    v24->_configuredFragmentDuration = a8;
    objc_storeStrong((id *)&v24->_timelineManager, a9);
    objc_storeStrong((id *)&v24->_factory, a10);
    uint64_t v25 = [MEMORY[0x263F08C38] UUID];
    identifier = v24->_identifier;
    v24->_identifier = (NSUUID *)v25;

    v24->_active = 1;
    long long v27 = (long long *)MEMORY[0x263F01090];
    int64_t v28 = *(void *)(MEMORY[0x263F01090] + 16);
    v24->_clipStartTime.epoch = v28;
    long long v29 = *v27;
    *(_OWORD *)&v24->_clipStartTime.value = *v27;
    *(_OWORD *)&v24->_timelapseClipStartTime.value = v29;
    v24->_timelapseClipStartTime.epoch = v28;
    char v30 = NSString;
    uint64_t v31 = [v20 name];
    uint64_t v32 = [v30 stringWithFormat:@"%@/%@", v31, v24->_identifier];
    logIdentifier = v24->_logIdentifier;
    v24->_logIdentifier = (NSString *)v32;

    __int16 v34 = [v21 personManagerSettings];
    unsigned int v64 = [v34 isFaceClassificationEnabled];

    v65 = [[HMDAccessoryMetricVendorDetails alloc] initWithAccessory:v20];
    id v35 = objc_alloc(MEMORY[0x263F47C78]);
    double v36 = [v19 uniqueIdentifier];
    [v20 name];
    double v37 = v66 = v19;
    [(HMDAccessoryMetricVendorDetails *)v65 manufacturer];
    v39 = id v38 = v18;
    BOOL v40 = [(HMDAccessoryMetricVendorDetails *)v65 model];
    id v41 = [(HMDAccessoryMetricVendorDetails *)v65 firmwareVersion];
    uint64_t v42 = objc_msgSend(v35, "initWithIdentifier:name:manufacturer:model:firmwareVersion:hasBattery:", v36, v37, v39, v40, v41, objc_msgSend(v20, "hasBattery"));

    id v18 = v38;
    id v43 = objc_alloc_init(MEMORY[0x263F47CF0]);
    [v43 setMaxFragmentAnalysisDuration:20.0];
    CMTimeMakeWithSeconds(&v75, a8 * 2.5, 1000);
    CMTime v74 = v75;
    [v43 setMaxFragmentDuration:&v74];
    [v43 setCamera:v42];
    [v43 setTranscode:v64];
    long long v44 = [v21 uuid];
    [v43 setHomeUUID:v44];

    CMTimeMake(&v73, 1, 1);
    CMTime v72 = v73;
    [v43 setTimelapseInterval:&v72];
    CMTimeMakeWithSeconds(&v71, 60.0, 1000);
    CMTime v70 = v71;
    [v43 setTimelapsePreferredFragmentDuration:&v70];
    uint64_t v45 = [(HMDCameraRecordingSessionFactory *)v24->_factory createTimelapseFragmentManagerWithLogIdentifier:v24->_logIdentifier];
    timelapseFragmentManager = v24->_timelapseFragmentManager;
    v24->_timelapseFragmentManager = (HMDCameraRecordingSessionVariantFragmentManager *)v45;

    uint64_t v47 = [(HMDCameraRecordingSessionFactory *)v24->_factory createVideoAnalyzerWithConfiguration:v43 identifier:v24->_identifier];
    videoAnalyzer = v24->_videoAnalyzer;
    v24->_videoAnalyzer = (HMDCameraRecordingSessionVideoAnalyzer *)v47;

    uint64_t v49 = [objc_alloc(MEMORY[0x263F424F0]) initWithName:@"Recording Session" parent:0 options:3];
    sessionActivity = v24->_sessionActivity;
    v24->_sessionActivity = (HMFActivity *)v49;

    v51 = [[HMDCameraSignificantEventFaceClassificationResolver alloc] initWithHome:v21];
    uint64_t v52 = [(HMDCameraRecordingSessionFactory *)v24->_factory createSignificantEventManagerWithWorkQueue:v38 faceClassificationResolver:v51 logIdentifier:v24->_logIdentifier];
    significantEventManager = v24->_significantEventManager;
    v24->_significantEventManager = (HMDCameraRecordingSessionSignificantEventManager *)v52;
...
- (HMDCameraRecordingSession)initWithWorkQueue:(id)a3 camera:(id)a4 hapAccessory:(id)a5 home:(id)a6 localZone:(id)a7 configuredFragmentDuration:(double)a8 timelineManager:(id)a9
{
  ...
  id v20 = a4;
  id v21 = a3;
  id v22 = objc_alloc_init(HMDCameraRecordingSessionFactory);
  int v23 = [(HMDCameraRecordingSession *)self initWithWorkQueue:v21 camera:v20 hapAccessory:v19 home:v18 localZone:v17 configuredFragmentDuration:v16 timelineManager:a8 factory:v22];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t52 != -1) {
    dispatch_once(&logCategory__hmf_once_t52, &__block_literal_global_147_227983);
  }
