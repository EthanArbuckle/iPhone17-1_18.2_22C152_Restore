...
- (void)_authenticateAccount:(id)a3 alreadyExists:(BOOL)a4 withCompanionDevice:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v30 = 2112;
    id v31 = v9;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Authenticating the account %@, service type %@, with companion device: %@", (uint8_t *)&v24, 0x2Au);
  }
  id v16 = objc_alloc_init(MEMORY[0x263F29110]);
  v17 = [v8 username];
  [v16 setUsername:v17];
...
void __62__HMDRemoteLoginReceiverCompanionAuthentication__authenticate__block_invoke(uint64_t a1, char a2, uint64_t a3, void *a4)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v18 = 2112;
      id v19 = v7;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Save-remote-verified-account failed with error %@", (uint8_t *)&v16, 0x16u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_80346 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_80346, &__block_literal_global_80347);
  }
  v2 = (void *)logCategory__hmf_once_v2_80348;
  return v2;
}
...
void __60__HMDRemoteLoginReceiverCompanionAuthentication_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_80348;
  logCategory__hmf_once_v2_80348 = v0;
}
