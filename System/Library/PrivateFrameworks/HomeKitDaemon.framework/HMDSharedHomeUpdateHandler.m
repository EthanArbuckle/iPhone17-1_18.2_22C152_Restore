...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_107828 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_107828, &__block_literal_global_107829);
  }
  v2 = (void *)logCategory__hmf_once_v1_107830;
  return v2;
}
...
void __41__HMDSharedHomeUpdateHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_107830;
  logCategory__hmf_once_v1_107830 = v0;
}
...
- (id)dumpState
{
  ...
  v5 = [v4 dumpState];
  [v3 setObject:v5 forKeyedSubscript:*MEMORY[0x263F41FA0]];
...
- (void)didCompleteHomeUpdateSession:(id)a3 withError:(id)a4
{
  ...
  if (v8 == v6)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v17 = 2112;
      id v18 = v7;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@%@ is complete with error %@, stopping", (uint8_t *)&v13, 0x20u);
    }
...
- (void)_receivedHomeDataFromSourceVersion:(id)a3 forceUpdateVersion:(BOOL)a4 completion:(id)a5
{
    ...
    || [v8 isGreaterThanVersion:v10])
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v36 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Remote version is greater than or equal to local version", buf, 0xCu);
    }
    __int16 v15 = v10;
  }
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v36 = v17;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Remote version is less than local version", buf, 0xCu);
    }
    __int16 v15 = v8;
  }
    ...
    && ([v18 isEqualToVersion:v20] || !v6))
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v37 = 2112;
      id v38 = v18;
      _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_INFO, "%{public}@Leaving shared home source version to %@", buf, 0x16u);
    }
    if (v9) {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v37 = 2112;
      id v38 = v18;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Updating shared home source version to %@", buf, 0x16u);
    }
...
- (void)_evaluateNeedForSync
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v37 = v7;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Sync session already running", buf, 0xCu);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v40 = 2112;
      v41 = v9;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Current source version %@, device version is %@", buf, 0x20u);
    }
    if ([v9 isGreaterThanVersion:v10])
    {
      if ([(HMDSharedHomeUpdateHandler *)v12 firstFetchComplete])
      {
        ...
        if (v15)
        {
          if (v19)
          {
            ...
            *(_DWORD *)buf = 138543362;
            __int16 v37 = v20;
            _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Pending request is set to YES, starting request for data sync", buf, 0xCu);
          }
        ...
        else
        {
          if (v19)
          {
            ...
            *(_DWORD *)buf = 138543362;
            __int16 v37 = v33;
            _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Current user is nil, cannot continue", buf, 0xCu);
          }
        }
      }
      else
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          __int16 v37 = v32;
          _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_INFO, "%{public}@Waiting for first fetch to complete", buf, 0xCu);
        }
      }
    }
  }
...
uint64_t __49__HMDSharedHomeUpdateHandler_requestHomeDataSync__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    id v8 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Received sync request", (uint8_t *)&v7, 0xCu);
  }
...
void __47__HMDSharedHomeUpdateHandler_residentsChanged___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    if (v6)
    {
      ...
      int v9 = 138543362;
      v10 = v7;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Ignoring resident changed/updated notifications during home merge", (uint8_t *)&v9, 0xCu);
    }
  }
  else
  {
    if (v6)
    {
      ...
      int v9 = 138543362;
      v10 = v8;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Received residents changed/updated notification", (uint8_t *)&v9, 0xCu);
    }
...
uint64_t __36__HMDSharedHomeUpdateHandler_resume__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    id v12 = v7;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Resuming update handler for home %@", (uint8_t *)&v9, 0x16u);
  }
...
uint64_t __35__HMDSharedHomeUpdateHandler_pause__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    id v12 = v7;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Pausing update handler for home %@", (uint8_t *)&v9, 0x16u);
  }
...
- (void)registerForMessages
{
  ...
  id v5 = [v3 residentDeviceManager];
