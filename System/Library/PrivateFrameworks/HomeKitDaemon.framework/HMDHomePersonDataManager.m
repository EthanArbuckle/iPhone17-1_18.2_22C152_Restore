...
- (void)handleUpdateSettingsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v37 = 2112;
    v38 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling update person manager settings message payload: %@", buf, 0x16u);
  }
  v11 = [(HMDHomePersonDataManager *)v7 home];
  if (v11)
  {
    uint64_t v12 = *MEMORY[0x263F0CD48];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v37 = 2112;
        v38 = v28;
        _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Could not find person manager settings in message payload: %@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v36 = v23;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Home reference is nil", buf, 0xCu);
    }
...
void __56__HMDHomePersonDataManager_handleUpdateSettingsMessage___block_invoke(uint64_t a1)
{
  ...
  [v8 setObject:v3 forKeyedSubscript:*MEMORY[0x263F0CD48]];

  id v4 = [*(id *)(a1 + 32) personManagerZoneUUID];
  v5 = [v4 UUIDString];
  [v8 setObject:v5 forKeyedSubscript:*MEMORY[0x263F0CD60]];
...
- (void)removeCloudDataDueToHomeGraphObjectRemoval:(BOOL)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      int v18 = 138543362;
      v19 = v10;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Removing home person cloud data", (uint8_t *)&v18, 0xCu);
    }
    v11 = [(HMDHomePersonDataManager *)v8 personManager];
    id v12 = objc_alloc_init(MEMORY[0x263F0E3D8]);
...
- (void)configurePersonManagerWithZoneUUID:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v22 = 2112;
      v23 = v14;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Configuring home person manager: %@", (uint8_t *)&v20, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v20 = 138543362;
      v21 = v19;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Home reference is nil", (uint8_t *)&v20, 0xCu);
    }
  }
}
...
- (void)handleUpdatedSettingsModel:(id)a3 previousSettingsModel:(id)a4 message:(id)a5
{
  ...
  v15 = (void *)MEMORY[0x230FBD990]((id)[v14 merge:v8]);
  id v16 = self;
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v60 = 2112;
    v61 = v19;
    _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Handling updated home person manager settings model: %@", buf, 0x16u);
  }
      ...
      if ((v23 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v62 = 2112;
          v63 = v50;
          _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@Updating home person manager settings from %@ to %@", buf, 0x20u);
...
LABEL_23:
      ...
      else
      {
        ...
        if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v62 = 2112;
          v63 = v29;
          _os_log_impl(&dword_22F52A000, v40, OS_LOG_TYPE_INFO, "%{public}@Updating home person manager zone UUID from %@ to %@", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v36, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v59 = v37;
      _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_DEFAULT, "%{public}@Home reference is nil", buf, 0xCu);
    }
  }
LABEL_24:
}
...
LABEL_4:
    if (*(void *)(a1 + 40))
    {
      ...
      if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
      {
        ...
        int v14 = 138543362;
        v15 = v5;
        _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Home person manager zone UUID is now nil. Removing home person manager", (uint8_t *)&v14, 0xCu);
      }
...
LABEL_8:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v18 = 2112;
    v19 = v12;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Home person manager zone UUID changed from %@ to %@. Configuring home person manager", (uint8_t *)&v14, 0x20u);
  }
  [*(id *)(a1 + 48) removeCloudDataDueToHomeGraphObjectRemoval:0];
...
- (id)updateSettingsModelWithSettings:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v47 = 2112;
    id v48 = v5;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Updating home person manager settings: %@", buf, 0x16u);
  }
          ...
          !v15))
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v47 = 2112;
        id v48 = v32;
        _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_INFO, "%{public}@Face Classification is now enabled. Updating settings with new home person manager zone UUID: %@", buf, 0x16u);
      }
    }
    else if (([v5 isFaceClassificationEnabled] & 1) == 0)
    {
      ...
      if (v16)
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          id v46 = v20;
          _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Face Classification is now disabled. Updating settings to remove zone UUID", buf, 0xCu);
        }
        [v14 setZoneUUID:0];
      }
    }
    id v33 = objc_alloc_init(MEMORY[0x263F58190]);
    id v34 = objc_alloc(MEMORY[0x263F42590]);
    v35 = NSStringFromSelector(a2);
    v36 = [MEMORY[0x263F42570] allMessageDestinations];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v46 = v24;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@Home reference is nil", buf, 0xCu);
    }
    v25 = (void *)MEMORY[0x263F58190];
    int v14 = [MEMORY[0x263F087E8] hmfErrorWithCode:8];
...
- (void)configure
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v28 = 2112;
      v29 = v10;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Initialized home person manager settings: %@, home person manager zone UUID: %@", buf, 0x20u);
    }
    uint64_t v11 = [v3 personManagerZoneUUID];
    id v12 = [v3 administratorHandler];
    uint64_t v13 = *MEMORY[0x263F0CF00];
    int v14 = +[HMDXPCMessagePolicy policyWithEntitlements:8197];
    v23[0] = v14;
    v15 = +[HMDConfigurationMessagePolicy policyWithOperationTypes:2];
    v23[1] = v15;
    __int16 v16 = [MEMORY[0x263EFF8C0] arrayWithObjects:v23 count:2];
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v25 = v19;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Home reference is nil", buf, 0xCu);
    }
  }
}
...
LABEL_7:
  ...
  if (v9)
  {
    ...
    v10->_id personManagerFactory = &__block_literal_global_187684;
  }
  return v10;
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t18_187696 != -1) {
    dispatch_once(&logCategory__hmf_once_t18_187696, &__block_literal_global_30);
  }
  v2 = (void *)logCategory__hmf_once_v19_187697;
  return v2;
}
...
void __39__HMDHomePersonDataManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v19_187697;
  logCategory__hmf_once_v19_187697 = v0;
}
