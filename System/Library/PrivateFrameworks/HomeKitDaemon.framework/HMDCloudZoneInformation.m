...
- (HMDCloudZoneInformation)initWithOwnerName:(id)a3 uuid:(id)a4
{
  ...
  if (v8)
  {
    ...
    v12 = (void *)v11;
    uint64_t v13 = objc_msgSend(MEMORY[0x263F425D0], "hmf_cachedInstanceForNSUUID:", v11);
    uuid = v8->_uuid;
    v8->_uuid = (NSUUID *)v13;
        ...
        if (v15)
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = v24;
            ...
            __int16 v34 = 2112;
            v35 = v10;
            _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Cannot convert zone information to zone information dictionary, %@", buf, 0x16u);
  ...
  if (v5)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        uint64_t v11 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v9];
