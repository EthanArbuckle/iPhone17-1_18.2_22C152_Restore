  ...
  if ([v6 count])
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v64 = 2112;
      v65 = v7;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Overriding the video resolution capabilities with %@", buf, 0x16u);
    }
...
LABEL_27:
        ...
        if (os_log_type_enabled(v45, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v64 = 2112;
          v65 = v34;
          _os_log_impl(&dword_22F52A000, v45, OS_LOG_TYPE_DEFAULT, "%{public}@Overriding the audio codec group capabilities with %@", buf, 0x16u);
        }
...
- (id)_supportedResolutionsWithOverrides
{
  v2 = [MEMORY[0x263EFF9C0] setWithSet:supportedHMDVideoResolutions];
  BOOL v3 = isWatch();
...
- (HMDStreamingCapabilities)initWithStreamPreference:(id)a3
{
  ...
  if (v5)
  {
    if (initWithStreamPreference__onceToken != -1) {
      dispatch_once(&initWithStreamPreference__onceToken, &__block_literal_global_94858);
    }
    ...
    id v9 = +[HMDH264Profile arrayWithProfiles:&unk_26E474098];
    ...
    v21 = +[HMDBitRateSetting arrayWithSettings:&unk_26E4740E0];
    ...
    id v25 = +[HMDAudioSampleRate arrayWithRates:&unk_26E4740F8];
...
void __53__HMDStreamingCapabilities_initWithStreamPreference___block_invoke()
{
  ...
  v0 = [MEMORY[0x263F20F80] capabilities];
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    uint64_t v12 = v0;
    _os_log_impl(&dword_22F52A000, v2, OS_LOG_TYPE_INFO, "%{public}@Audio streaming capabilities as reported by AVCAudioStream: %@", (uint8_t *)&v9, 0x16u);
  }
  id v4 = [MEMORY[0x263F20FE8] capabilities];
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    uint64_t v12 = v4;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Video streaming capabilities as reported by AVCVideoStream: %@", (uint8_t *)&v9, 0x16u);
  }
...
+ (unint64_t)aspectRatioOfResolution:(id)a3
{
  ...
  if (v5 >= 0x1D)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Resolution: %@ is not handled, returning default aspect ratio: %@", (uint8_t *)&v12, 0x20u);
    }
    unint64_t v6 = 1;
  }
  else
  {
    unint64_t v6 = qword_2303E4150[v5];
  }
...
LABEL_18:
  ...
  v44 = v3;
  uint64_t v19 = [v3 objectForKeyedSubscript:*MEMORY[0x263F21018]];
  v20 = objc_msgSend(MEMORY[0x263EFF9C0], "setWithCapacity:", objc_msgSend(v19, "count"));
  long long v49 = 0u;
  long long v50 = 0u;
  long long v51 = 0u;
  long long v52 = 0u;
  ...
  if (isWatch())
  {
    objc_super v29 = (void *)MEMORY[0x263EFFA08];
    uint64_t v30 = [[HMDVideoResolution alloc] initWithResolution:1];
    v60 = v30;
    uint64_t v31 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v60 count:1];
  ...
  {
    id v42 = v8;
    v34 = [v44 objectForKeyedSubscript:*MEMORY[0x263F21020]];
    uint64_t v31 = objc_msgSend(MEMORY[0x263EFF9C0], "setWithCapacity:", objc_msgSend(v34, "count"));
    long long v45 = 0u;
    long long v46 = 0u;
    long long v47 = 0u;
    long long v48 = 0u;
