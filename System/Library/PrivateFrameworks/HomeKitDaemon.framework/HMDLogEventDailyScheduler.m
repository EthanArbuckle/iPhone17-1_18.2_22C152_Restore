        ...
        if (v8)
        {
          if (v12)
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v24 = 2112;
            uint64_t v25 = v14;
            _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Running daily QA task for '%@'", buf, 0x16u);
          }
          [v7 runHomeutilTask];
        }
        else
        {
          if (v12)
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v24 = 2112;
            uint64_t v25 = v16;
            _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Running daily task for '%@'", buf, 0x16u);
          }
          [v7 runDailyTask];
        }
      }
...
- (void)_runActivity:(id)a3
{
  ...
  if (v7 >= 72000.0)
  {
    ...
    if (v18)
    {
      long long v19 = [MEMORY[0x263EFFA40] standardUserDefaults];
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v29 = 2112;
      v30 = v25;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Running activity '%@'", (uint8_t *)&v27, 0x16u);
    }
...
- (void)_handleCheckInForActivity:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      uint32_t v14 = 32;
LABEL_6:
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, v12, (uint8_t *)&v18, v14);
    }
  }
  else
  {
...
- (void)_registerActivity
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v14 = 2112;
    long long v15 = v7;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Registering XPC activity %@", buf, 0x16u);
  }
  ...
  [v8 registerXPCActivityWithActivityIdentifier:v9 criteria:*MEMORY[0x263EF8188] activityBlock:v10];
...
void __46__HMDLogEventDailyScheduler__registerActivity__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!WeakRetained)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      int v18 = v11;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Activity '%@' handler ran after scheduler was deallocated", (uint8_t *)&v15, 0x16u);
    }
    goto LABEL_11;
  }
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2048;
      uint64_t v20 = v7;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Activity '%@' callback with unhandled state: %ld", (uint8_t *)&v15, 0x20u);
    }
LABEL_11:
...
- (id)_criteriaForActivity
{
  ...
  xpc_dictionary_set_BOOL(v2, (const char *)*MEMORY[0x263EF8270], 1);
  xpc_dictionary_set_string(v2, (const char *)*MEMORY[0x263EF8280], (const char *)*MEMORY[0x263EF8290]);
  xpc_dictionary_set_BOOL(v2, (const char *)*MEMORY[0x263EF82E8], 1);
  return v2;
}
...
- (HMDLogEventDailyScheduler)initWithIdentifier:(id)a3 preferencesKey:(id)a4 logEventSubmitter:(id)a5 xpcActivityInterface:(id)a6 dateFactory:(id)a7
{
  ...
  if (v17)
  {
    ...
    if (v13)
    {
      a5 = [MEMORY[0x263EFFA40] standardUserDefaults];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t11_29453 != -1) {
    dispatch_once(&logCategory__hmf_once_t11_29453, &__block_literal_global_23_29454);
  }
  xpc_object_t v2 = (void *)logCategory__hmf_once_v12_29455;
  return v2;
}
...
void __40__HMDLogEventDailyScheduler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v12_29455;
  logCategory__hmf_once_v12_29455 = v0;
}
...
void __66__HMDLogEventDailyScheduler_createSchedulerWithLogEventSubmitter___block_invoke(uint64_t a1)
{
  ...
  uint64_t v4 = [(HMDLogEventDailyScheduler *)v2 initWithIdentifier:@"com.apple.homed.logEvent.dailyScheduler" preferencesKey:@"HMDLogEventDailySchedulerLastRunTimeKey" logEventSubmitter:v3 xpcActivityInterface:v6 dateFactory:&__block_literal_global_29464];
