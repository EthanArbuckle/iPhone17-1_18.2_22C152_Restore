      ...
      for (uint64_t i = 0; i != v67; ++i)
      {
        ...
        if (v12)
        {
          ...
          if (v13)
          {
            ...
            if (!v15)
            {
              ...
              if (v32)
              {
                ...
                if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_WORD *)&buf[12] = 2112;
                  *(void *)&buf[14] = v11;
                  _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_INFO, "%{public}@Adding new significant event: %@", buf, 0x16u);
              ...
              {
                v45 = (void *)MEMORY[0x230FBD990]([v68 removeObject:v12]);
                v46 = self;
                ...
                if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(void *)&buf[20] = &v79;
                  __int16 v82 = 2112;
                  v83 = (long long *)v11;
                  _os_log_impl(&dword_22F52A000, v47, OS_LOG_TYPE_INFO, "%{public}@Updating existing significant event with UUID %{uuid_t}.16P using new significant event: %@", buf, 0x26u);
            ...
            if ([v19 count])
            {
              v20 = (void *)MEMORY[0x230FBD990]([v68 removeObject:v18]);
              id v21 = self;
              ...
              if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)&buf[24] = 16;
                __int16 v82 = 2096;
                v83 = &v80;
                _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Adding new face classifications %@ to existing significant event with UUID: %{uuid_t}.16P", buf, 0x26u);
...
LABEL_37:
          ...
          unint64_t v39 = (void *)MEMORY[0x230FBD990]();
          id v40 = self;
          ...
          if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
          {
            ...
            *(_WORD *)&buf[18] = 2096;
            *(void *)&buf[20] = &v78;
            _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_INFO, "%{public}@Skipping already-represented significant event with UUID: %{uuid_t}.16P", buf, 0x1Cu);
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
        {
          ...
          *(_WORD *)&buf[12] = 2112;
          *(void *)&buf[14] = v11;
          _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_INFO, "%{public}@Adding new significant event: %@", buf, 0x16u);
        }
...
- (id)_significantEventsForEmptyAnalyzerResult:(id)a3 dateOfOccurrence:(id)a4 timeOffsetWithinClip:(double)a5
{
  ...
  id v18 = [MEMORY[0x263EFFA08] setWithObject:v12];
  ...
  if (v17 >= 3)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v40 = 2048;
      unint64_t v41 = v18;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Unknown analyzer event confidence level: %ld", buf, 0x16u);
    }
    uint64_t v19 = 100;
  }
  else
  {
    uint64_t v19 = qword_2303E40B8[v17];
  }
...
- (id)_significantEventsForFrameResult:(id)a3 analyzerResult:(id)a4 dateOfOccurrence:(id)a5 timeOffsetWithinClip:(double)a6 recordingEventTriggers:(unint64_t)a7
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v64 = 2112;
    id v65 = v18;
    _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Finding significant events for frame result %@ with analyzer events: %@", buf, 0x20u);
  }
  ...
  if (!v21)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v64 = 2112;
      id v65 = v45;
      _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to create hero frame from frame %@: %@", buf, 0x20u);
    }
  }
  v27 = v14;
...
BOOL __113__HMDCameraRecordingSessionSignificantEventManager__isAnyEventInAnalyzerEvents_includedInRecordingEventTriggers___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v18 = 2112;
      id v19 = v3;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Recording fragment due to recording trigger event: %@", (uint8_t *)&v16, 0x16u);
    }
  }
...
- (void)resetState
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    uint64_t v10 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Resetting state", (uint8_t *)&v9, 0xCu);
  }
...
- (id)significantEventsForAnalyzerFragmentResult:(id)a3 dateOfOccurrence:(id)a4 timeOffsetWithinClip:(double)a5 recordingEventTriggers:(unint64_t)a6
{
  ...
  if (v13)
  {
    ...
    if ([v14 count])
    {
      id v37 = (void *)MEMORY[0x263EFFA08];
      v38 = [v14 allValues];
...
- (HMDCameraRecordingSessionSignificantEventManager)initWithWorkQueue:(id)a3 faceClassificationResolver:(id)a4 logIdentifier:(id)a5
{
  ...
  if (v9)
  {
    ...
    if (v13)
    {
      ...
      v14->_id significantEventUUIDFactory = &__block_literal_global_81865;

      id faceClassificationUUIDFactory = v14->_faceClassificationUUIDFactory;
      v14->_id faceClassificationUUIDFactory = &__block_literal_global_5_81866;
    }
    return v14;
  }
  else
...
{
  return [MEMORY[0x263F08C38] UUID];
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t13_81878 != -1) {
    dispatch_once(&logCategory__hmf_once_t13_81878, &__block_literal_global_28);
  }
  v2 = (void *)logCategory__hmf_once_v14_81879;
  return v2;
}
...
void __63__HMDCameraRecordingSessionSignificantEventManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v14_81879;
  logCategory__hmf_once_v14_81879 = v0;
}
