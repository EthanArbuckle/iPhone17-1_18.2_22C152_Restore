...
- (void)_callStreamStoppedWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v16 = 2112;
    id v17 = v4;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Stream with session ID %@ stopped with error %@", (uint8_t *)&v12, 0x20u);
  }
...
- (void)_callStreamReconfigured
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    v10 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Stream reconfigured", (uint8_t *)&v9, 0xCu);
  }
...
- (void)_callStreamFirstFrameReceived
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    v10 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@First frame received", (uint8_t *)&v9, 0xCu);
  }
  v7 = [(HMDCameraStreamControlManager *)v4 managerProtocol];
  v8 = [(HMDCameraStreamControlManager *)v4 delegate];
  if (objc_opt_respondsToSelector()) {
...
- (void)_callStreamStarted
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    v10 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Stream started", (uint8_t *)&v9, 0xCu);
  }
  v7 = [(HMDCameraStreamControlManager *)v4 managerProtocol];
  v8 = [(HMDCameraStreamControlManager *)v4 delegate];
  if (objc_opt_respondsToSelector()) {
...
- (void)_callStreamRemoteConnectionSetup
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    v10 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Stream remote connection setup", (uint8_t *)&v9, 0xCu);
  }
  v7 = [(HMDCameraStreamControlManager *)v4 managerProtocol];
  v8 = [(HMDCameraStreamControlManager *)v4 delegate];
  if (objc_opt_respondsToSelector()) {
...
- (void)_callStreamNegotiated:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v11 = 138543362;
    int v12 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Stream negotiated", (uint8_t *)&v11, 0xCu);
  }
...
- (id)managerProtocol
{
  if ([(HMDCameraStreamControlManager *)self conformsToProtocol:&unk_26E4DF698]) {
    v3 = self;
  }
  else {
    v3 = 0;
...
- (void)_reportInternalErrorCode:(int64_t)a3
{
  id v4 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:a3];
  [(HMDCameraStreamControlManager *)self _cleanUpStreamSessionWithError:v4];
}

- (void)_reportErrorCode:(int64_t)a3
{
  id v4 = [MEMORY[0x263F087E8] hmErrorWithCode:a3];
  [(HMDCameraStreamControlManager *)self _cleanUpStreamSessionWithError:v4];
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_206378 != -1) {
    dispatch_once(&logCategory__hmf_once_t6_206378, &__block_literal_global_206379);
  }
  v2 = (void *)logCategory__hmf_once_v7_206380;
  return v2;
}
...
void __44__HMDCameraStreamControlManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_206380;
  logCategory__hmf_once_v7_206380 = v0;
}
