...
- (BOOL)shouldRun
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v24 = 2112;
      v25 = v14;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Staging task shouldn't run - runOnCurrentDevice:%@ readyForStaging:%@ needsStaging:%@ (%@)", (uint8_t *)&v16, 0x34u);
    }
    BOOL v4 = 0;
  }
