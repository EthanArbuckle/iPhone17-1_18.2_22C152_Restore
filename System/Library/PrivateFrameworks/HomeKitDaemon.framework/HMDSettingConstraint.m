...
- (void)encodeWithCoder:(id)a3
{
  ...
  if (objc_msgSend(v4, "hmd_isForXPCTransport"))
  {
    ...
    [v4 encodeObject:v5 forKey:*MEMORY[0x263F0D8C8]];

    uint64_t v6 = [(HMDSettingConstraint *)self type];
    [v4 encodeObject:v6 forKey:*MEMORY[0x263F0D8D0]];

    v7 = [(HMDSettingConstraint *)self value];
    [v4 encodeObject:v7 forKey:*MEMORY[0x263F0D8D8]];
  }
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      int v12 = 138543362;
      v13 = v11;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Did not encode setting constraint as transport is not XPC.", (uint8_t *)&v12, 0xCu);
    }
  }
}
