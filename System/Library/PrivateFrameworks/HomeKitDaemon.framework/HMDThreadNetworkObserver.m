...
- (id)_keyOfLargestCountInHistogram:(id)a3
{
  ...
  v10 = __Block_byref_object_copy__208890;
  v11 = __Block_byref_object_dispose__208891;
  id v12 = 0;
...
- (void)_runLoggingForDate:(id)a3 isDailySummary:(BOOL)a4
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v18 = 2112;
      uint64_t v19 = v14;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Submitting HMDThreadNetworkStabilityLogEvent: %@", (uint8_t *)&v16, 0x16u);
    }
...
- (void)start
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v11 = 138543362;
    int v12 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting", (uint8_t *)&v11, 0xCu);
  }
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
  {
    ...
    int v11 = 138543362;
    int v12 = v10;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@This device does not support Thread network stability reporting", (uint8_t *)&v11, 0xCu);
  }
  v8->_started = 1;
}
...
- (HMDThreadNetworkObserver)initWithLogEventDispatcher:(id)a3 countersManager:(id)a4 dailyScheduler:(id)a5 currentHomeDataSource:(id)a6 dateProvider:(id)a7 notificationCenter:(id)a8
{
  ...
  if (v18)
  {
    ...
    *(_OWORD *)&v19->_curReport_reportDuration = 0u;
    ...
    unint64_t v22 = (NSMutableDictionary *)objc_alloc_init(MEMORY[0x263EFF9A0]);
...
- (HMDThreadNetworkObserver)initWithLogEventDispatcher:(id)a3 countersManager:(id)a4 dailyScheduler:(id)a5 currentHomeDataSource:(id)a6 dateProvider:(id)a7
{
  int v12 = (void *)MEMORY[0x263F08A00];
  id v13 = a7;
  id v14 = a6;
  id v15 = a5;
  id v16 = a4;
...
+ (id)supportedEventClasses
{
  if (supportedEventClasses_onceToken_208949 != -1) {
    dispatch_once(&supportedEventClasses_onceToken_208949, &__block_literal_global_208950);
  }
  v2 = (void *)supportedEventClasses_supportedEventClasses_208951;
  return v2;
}
...
void __49__HMDThreadNetworkObserver_supportedEventClasses__block_invoke()
{
  ...
  v1 = (void *)supportedEventClasses_supportedEventClasses_208951;
  supportedEventClasses_supportedEventClasses_208951 = v0;
}
