...
- (void)setHome:(id)a3;
- (void)setIdsInvitationUUID:(id)a3;
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_idsInvitationUUID, 0);
...
- (NSUUID)idsInvitationUUID
{
  return self->_idsInvitationUUID;
}
...
- (id)describeWithFormat
{
  ...
  v8 = objc_msgSend(MEMORY[0x263F0E3B0], "homeInvitationStateDescription:", -[HMDHomeInvitation invitationState](self, "invitationState"));
    ...
    else
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(void *)&location[4] = v10;
        __int16 v16 = 2112;
        v17 = v11;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Not calling invitation (%@) resolution handler, no client queue set", location, 0x16u);
      }
...
- (void)_configureTimer
{
  ...
  {
    v7 = (void *)[objc_alloc(MEMORY[0x263F42658]) initWithTimeInterval:1 options:v6];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(void *)&location[4] = v7;
        __int16 v12 = 2112;
        id v13 = v8;
        _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Not calling invitation (%@) expiration handler, no client queue set", location, 0x16u);
      }
      [(HMDHomeInvitation *)self _clearTimer];
    }
  }
...
void __27__HMDHomeInvitation_expire__block_invoke(uint64_t a1)
{
        ...
        v4))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v16 = 2112;
      v17 = v8;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Calling invitation (%@) expiration handler", (uint8_t *)&v14, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v16 = 2112;
      v17 = v13;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Not calling invitation (%@) expiration handler, not set", (uint8_t *)&v14, 0x16u);
    }
  }
  [*(id *)(a1 + 32) _clearTimer];
}
...
- (void)updateTimer:(unint64_t)a3 clientQueue:(id)a4
{
  ...
  [(HMDHomeInvitation *)self _clearTimer];
  v8 = [MEMORY[0x263EFF910] dateWithTimeIntervalSinceNow:(double)a3];
...
- (HMDHomeInvitation)initWithCoder:(id)a3 invitationData:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  id v8 = [v6 decodeObjectOfClass:objc_opt_class() forKey:@"home"];
  id v9 = [(HMDHomeInvitation *)self initWithInvitationData:v7 forHome:v8];

  if (v9 && [v6 containsValueForKey:@"idsInvitationUUID"])
  {
    uint64_t v10 = [v6 decodeObjectOfClass:objc_opt_class() forKey:@"idsInvitationUUID"];
    idsInvitationUUID = v9->_idsInvitationUUID;
    v9->_idsInvitationUUID = (NSUUID *)v10;
  }
  return v9;
}
