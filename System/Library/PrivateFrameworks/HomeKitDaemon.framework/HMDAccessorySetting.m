...
- (void)_encodeWithCoder:(id)a3
{
  ...
  [v4 encodeObject:v7 forKey:*MEMORY[0x263F0B558]];

  unint64_t v8 = [(HMDAccessorySetting *)self properties];
  [v4 encodeInteger:v8 forKey:*MEMORY[0x263F0B568]];
  v9 = [(HMDAccessorySetting *)self name];
  [v4 encodeObject:v9 forKey:*MEMORY[0x263F0B560]];
  ...
  if ((v6 & 1) == 0)
  {
    ...
    [v4 encodeObject:v24 forKey:*MEMORY[0x263F0B530]];
...
LABEL_20:
  ...
  v22 = (void *)[v11 copy];
  id v4 = v28;
  [v28 encodeObject:v22 forKey:*MEMORY[0x263F0B530]];
...
LABEL_21:
  if (objc_msgSend(v4, "hmd_isForXPCTransport"))
  {
    ...
    [v4 encodeBool:v25 forKey:*MEMORY[0x263F0B570]];
  }
  if (v5) {
  ...
  [v4 encodeInteger:Type forKey:*MEMORY[0x263F0B588]];
}
...
- (id)constraintsForCodingXPC
{
  ...
  uint64_t v15 = __Block_byref_object_copy__251169;
  uint64_t v16 = __Block_byref_object_dispose__251170;
  id v17 = 0;
  p_lock = &self->_lock;
...
{
  id v4 = a3;
  id v5 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0B558]];
  uint64_t v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0B560]];
  v7 = [(HMDAccessorySetting *)self initWithIdentifier:v5 name:v6];
  if (v7)
  {
    v7->_type = [v4 decodeIntegerForKey:*MEMORY[0x263F0B588]];
    v7->_properties = [v4 decodeIntegerForKey:*MEMORY[0x263F0B568]];
    unint64_t v8 = [(id)objc_opt_class() supportedConstraintClasses];
    v9 = [v4 decodeObjectOfClasses:v8 forKey:*MEMORY[0x263F0B530]];
    ...
    uint64_t v14 = [v4 decodeObjectOfClasses:v13 forKey:*MEMORY[0x263F0B5A0]];
    id value = v7->_value;
    v7->_id value = (id)v14;
  ...
  if ((objc_msgSend(v7, "hmf_isEmpty") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v55 = 2112;
      v56 = v9;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@will remove %@ from %@", buf, 0x20u);
    }
  ...
  if ((objc_msgSend(v25, "hmf_isEmpty") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v55 = 2112;
      v56 = v27;
      _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_INFO, "%{public}@will add %@ to %@", buf, 0x20u);
    }
  ...
  if ([v5 count])
  {
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v53 = 2112;
      v54 = v5;
      _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_DEBUG, "%{public}@fixing up accessory constraints %@", buf, 0x16u);
    }
  }
    ...
    if ((unint64_t)[v23 count] < 4)
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        long long v47 = v36;
        _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_ERROR, "%{public}@Unable to deserialize selected language.", buf, 0xCu);
              ...
              v27))
        {
          ...
          if (os_log_type_enabled(log, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v50 = 2112;
            v51 = v30;
            _os_log_impl(&dword_22F52A000, log, OS_LOG_TYPE_INFO, "%{public}@Language changing from %@ to %@ and both are supported.", buf, 0x20u);
          }
          BOOL v31 = 0;
        }
        else
        {
          ...
          if (os_log_type_enabled(log, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v48 = 2112;
            long long v49 = v25;
            _os_log_impl(&dword_22F52A000, log, OS_LOG_TYPE_INFO, "%{public}@Found recognition language %@ in supported languages need to turn off personal requests.", buf, 0x16u);
          }
        }
...
- (BOOL)shouldBlockSettingUpdateFromVersion:(id)a3 isMultiUserEnabled:(BOOL)a4
{
  ...
  id v6 = a3;
  v7 = (void *)[objc_alloc(MEMORY[0x263F42670]) initWithVersionString:@"6.0"];
...
LABEL_5:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v18 = 2112;
    id v19 = v6;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Settings update blocked due to attempting language setting update with homekit version: %@", (uint8_t *)&v16, 0x16u);
  }
  BOOL v10 = 1;
LABEL_6:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v59 = 2112;
      id v60 = v4;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Updating constraints: %@", buf, 0x16u);
    }
    ...
    id v45 = v4;
    uint64_t v14 = [MEMORY[0x263EFFA08] setWithArray:v4];
    v46 = v13;
    id v15 = (void *)[v13 mutableCopy];
    v44 = (void *)v14;
    int v16 = (void *)MEMORY[0x230FBD990]([v15 minusSet:v14]);
    id v17 = v8;
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v59 = 2112;
      id v60 = v15;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Removing constraints: %@", buf, 0x16u);
    }
    long long v53 = 0u;
    long long v54 = 0u;
    long long v51 = 0u;
    ...
    BOOL v31 = (void *)MEMORY[0x230FBD990]([v30 minusSet:v46]);
    long long v32 = v17;
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v59 = 2112;
      id v60 = v30;
      _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_INFO, "%{public}@Adding constraints: %@", buf, 0x16u);
    }
    long long v49 = 0u;
    long long v50 = 0u;
    long long v47 = 0u;
  ...
  if ((objc_msgSend(v6, "hmf_isEmpty") & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v23 = 2112;
      uint64_t v24 = v6;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@found constraints that are not present adding, %@", buf, 0x16u);
    }
    long long v18 = 0u;
    long long v19 = 0u;
    long long v16 = 0u;
...
- (id)replicatedMissingConstraintsFrom:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v15 = 2112;
      long long v16 = v6;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@found constraints that are not present returning, %@", (uint8_t *)&v13, 0x16u);
    }
          ...
          if (v12 && [v5 isEqual:v12])
          {
            ...
            if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v31 = 2112;
              id v32 = v4;
              _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_DEBUG, "%{public}@Found counterpart constraint %@ for %@", buf, 0x20u);
            }
            id v13 = v11;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v29 = 2112;
      id v30 = v4;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Can't decode constraint %@", buf, 0x16u);
    }
    id v13 = 0;
  }
...
- (BOOL)canRemoveConstraint:(id)a3
{
  ...
  if ((v6 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v4;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Missing Constraint: %@", (uint8_t *)&v12, 0x16u);
    }
  }
...
- (BOOL)canAddConstraint:(id)a3 error:(id *)a4
{
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v24 = 2112;
      id v25 = v18;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Invalid constraint, %@, with error: %@", (uint8_t *)&v20, 0x20u);
    }
LABEL_11:
    BOOL v13 = 0;
    goto LABEL_12;
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v22 = 2112;
    id v23 = v6;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Duplicate constraint: %@", (uint8_t *)&v20, 0x16u);
  }
  if (!a4) {
    goto LABEL_11;
  }
              ...
              case 3:
                ...
                if (v33)
                {
                  ...
                  if (v39 > 0.00000011920929)
                  {
                    ...
                    {
                      v70 = (void *)MEMORY[0x230FBD990](v40);
                      v71 = v22;
                      ...
                      if (os_log_type_enabled(v72, OS_LOG_TYPE_DEFAULT))
                      {
                        ...
                        *(_DWORD *)buf = 138544130;
                        ...
                        __int16 v105 = 2112;
                        id v106 = v27;
                        _os_log_impl(&dword_22F52A000, v72, OS_LOG_TYPE_DEFAULT, "%{public}@Value, %@, does not conform to step, %@, from current value: %@", buf, 0x2Au);
...
LABEL_90:
                        long long v11 = v78;
                        id v12 = v77;
                        *a3 = [MEMORY[0x263F087E8] hmErrorWithCode:v64];
LABEL_92:
...
LABEL_91:
                  ...
                  if ([v23 compare:v43] == 1)
                  {
                    ...
                    if (os_log_type_enabled(v67, OS_LOG_TYPE_DEFAULT))
                    {
                      ...
                      *(_DWORD *)buf = 138543874;
                      ...
                      __int16 v103 = 2112;
                      id v104 = v43;
                      _os_log_impl(&dword_22F52A000, v67, OS_LOG_TYPE_DEFAULT, "%{public}@Value, %@, more than maximum value: %@", buf, 0x20u);
                  ...
                  if ([v23 compare:v31] == -1)
                  {
                    ...
                    if (os_log_type_enabled(v61, OS_LOG_TYPE_DEFAULT))
                    {
                      ...
                      *(_DWORD *)buf = 138543874;
                      ...
                      __int16 v103 = 2112;
                      id v104 = v31;
                      _os_log_impl(&dword_22F52A000, v61, OS_LOG_TYPE_DEFAULT, "%{public}@Value, %@, less than minimum value: %@", buf, 0x20u);
              ...
              default:
                ...
                if (os_log_type_enabled(v46, OS_LOG_TYPE_DEFAULT))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v101 = 2112;
                  id v102 = v24;
                  _os_log_impl(&dword_22F52A000, v46, OS_LOG_TYPE_DEFAULT, "%{public}@Ignoring numeric constraint: %@", buf, 0x16u);
            ...
            _os_log_impl(&dword_22F52A000, v53, OS_LOG_TYPE_DEFAULT, v54, buf, 0x16u);
...
LABEL_75:
          ...
          *(_DWORD *)v95 = 138543618;
          ...
          v98 = v57;
          id v58 = v57;
          _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Unexpected value class: %@", v95, 0x16u);
        }
LABEL_76:
...
- (HMDAccessorySetting)initWithModel:(id)a3
{
  ...
  if (v9)
  {
    ...
    if (!v9->_value)
    {
      objc_super v19 = (void *)MEMORY[0x230FBD990]();
      uint64_t v20 = v9;
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v27 = 2112;
        id v28 = v17;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive supported value from the model's value data: %@", buf, 0x16u);
      }
    }
  }
  return v9;
...
+ (id)supportedConstraintClasses
{
  if (supportedConstraintClasses_onceToken != -1) {
    dispatch_once(&supportedConstraintClasses_onceToken, &__block_literal_global_55_251261);
  }
...
+ (id)supportedValueClasses
{
  if (supportedValueClasses_onceToken != -1) {
    dispatch_once(&supportedValueClasses_onceToken, &__block_literal_global_50_251264);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t58 != -1) {
    dispatch_once(&logCategory__hmf_once_t58, &__block_literal_global_251266);
  }
