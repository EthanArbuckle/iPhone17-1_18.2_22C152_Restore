...
void __44__HMDTimeEvent__reactivateTriggerAfterDelay__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    v10 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Reactivated trigger after timer fired", (uint8_t *)&v9, 0xCu);
  }
}
...
- (void)handleTimerFiredNotification:(id)a3
{
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v28 = 2112;
      v29 = v13;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Timer has fired %@, current activation state: %@", (uint8_t *)&v24, 0x20u);
    }
      ...
      if ([(HMDTimeEvent *)v10 repetitive])
      {
        ...
        if (v17)
        {
          if (v21)
          {
            ...
            int v24 = 138543362;
            v25 = v22;
            _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Not-Reactivating the event as it does not have recurrences", (uint8_t *)&v24, 0xCu);
          }
        }
        else
        {
          if (v21)
          {
            ...
            int v24 = 138543362;
            v25 = v23;
            _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Reactivating the event as it does have some recurrences", (uint8_t *)&v24, 0xCu);
          }
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v42 = 2112;
        id v43 = v14;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Starting the next timer (%@) set to [%@]", buf, 0x20u);
      }
      ...
      if ((v16 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v42 = 2112;
          id v43 = v17;
          _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to activate time trigger %@ with error %@", buf, 0x20u);
        }
      }
      v22 = _Block_copy(v6);
      v23 = v22;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v39 = v34;
        _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_ERROR, "%{public}@Failed to get next time date", buf, 0xCu);
      }
      int v9 = (void (**)(void, void))_Block_copy(v6);
      if (!v9) {
        goto LABEL_22;
      }
      id v17 = [MEMORY[0x263F087E8] hmErrorWithCode:52];
...
LABEL_22:
  ...
  int v24 = [(HMDTimeEvent *)self backgroundTaskManager];
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v40 = 2112;
    v41 = v8;
    _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_INFO, "%{public}@Stopping the already scheduled timer with ID: %@", buf, 0x16u);
  }
LABEL_23:
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t14_182408 != -1) {
    dispatch_once(&logCategory__hmf_once_t14_182408, &__block_literal_global_182409);
  }
  v2 = (void *)logCategory__hmf_once_v15_182410;
  return v2;
}
...
void __27__HMDTimeEvent_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v15_182410;
  logCategory__hmf_once_v15_182410 = v0;
}
  ...
  if (v4)
  {
    ...
    if ((v6 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v14 = 2112;
        id v15 = v4;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Given date component contains non supported fields set: %@", (uint8_t *)&v12, 0x16u);
      }
    }
  }
  else
...
+ (BOOL)isValidAbsoluteDateComponents:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      uint32_t v12 = 22;
LABEL_8:
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, v10, (uint8_t *)&v15, v12);
    }
  }
  else
  {
