  ...
  if (objc_msgSend(v12, "hmf_isEqualToUUID:", v13))
  {
    ...
    if (v16)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v24 = 2112;
        v25 = v21;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Target device added to account: %@", (uint8_t *)&v22, 0x16u);
      }
    ...
    if (v10)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v19 = 2112;
        v20 = v15;
        _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Account added containing target device: %@", buf, 0x16u);
      }
    ...
    if ([v16 BOOLValue])
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v30 = v20;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Registry is available", buf, 0xCu);
      }
      ...
      if (v23)
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v30 = v27;
          _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@Device present in registry, updating", buf, 0xCu);
        }
...
- (void)updateWithDevice:(id)a3 completionHandler:(id)a4
{
  ...
  if (v8)
  {
    ...
    id v10 = [v9 deviceForDevice:v8 exists:&v29];
      ...
      if ((objc_opt_respondsToSelector() & 1) == 0 || [v8 shouldMergeObject:v6])
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v32 = 2112;
          id v33 = v6;
          _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Merging with device: %@", buf, 0x16u);
        }
        if ([v8 mergeObject:v6])
        {
          ...
          if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            uint64_t v31 = v24;
            _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Updated device", buf, 0xCu);
          }
        }
      }
      id v16 = 0;
    ...
    {
      id v16 = [v8 account];
      if ([v16 isCurrentAccount])
      {
        v15 = [MEMORY[0x263F087E8] hmErrorWithCode:48 description:@"Not supported." reason:@"Cannot update device on current account." suggestion:0];
      }
      else
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v32 = 2112;
          id v33 = v6;
          _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Updating with device: %@", buf, 0x16u);
        }
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v34 = 2112;
      v35 = v10;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Backed Device not equal to device: %@ != %@", buf, 0x20u);
    }
    v15 = [MEMORY[0x263F087E8] hmErrorWithCode:48 description:@"Not supported." reason:@"Backed Device unexpected value." suggestion:0];
  }
  else
  {
    v15 = [MEMORY[0x263F087E8] hmErrorWithCode:2 description:@"Device not found." reason:@"Unknown device." suggestion:0];
    id v10 = 0;
  }
  id v16 = 0;
  if (v7) {
