...
- (HMFConnectivityInfo)initWithCoder:(id)a3
{
  ...
  v11 = [MEMORY[0x263EFF8C0] arrayWithObjects:v23 count:3];
  ...
  v15 = [MEMORY[0x263EFF8C0] arrayWithObjects:v22 count:2];
...
- (HMFConnectivityInfo)initWithAccessoryIdentifier:(id)a3 woBLEInfo:(id)a4 woWLANInfos:(id)a5
{
  ...
  if (v9 && (v10 || [v11 count]))
  {
    ...
    if (v13)
    {
      ...
      if (v12)
      {
        char v15 = [MEMORY[0x263EFF980] array];
        long long v29 = 0u;
        long long v30 = 0u;
        long long v31 = 0u;
        long long v32 = 0u;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v37 = 2112;
      id v38 = v9;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Returning nil for the invalid woBLEInfo and woWLANInfo of accessory: %@", buf, 0x16u);
    }
    v24 = 0;
  }
