...
- (BOOL)exportFromLocalModel:(id)a3 updatedProperties:(id)a4 context:(id)a5
{
  ...
  if (v10)
  {
    ...
    v15 = [v14 objectForKeyedSubscript:@"rooms_"];

    v16 = [(MKFCKModel *)self relationshipForLocalName:@"rooms_" localModel:v12];
...
+ (id)fetchRequest
{
  return (id)[MEMORY[0x263EFF260] fetchRequestWithEntityName:@"MKFCKZone"];
}
