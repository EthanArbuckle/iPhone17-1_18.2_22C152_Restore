...
+ (NSSet)allOtherHomesSingleAccessorySecurityFetchSpecifications
{
  ...
  v2 = [MEMORY[0x263EFFA08] setWithObject:@"com.apple.Home.widget.security.singleAccessory"];
  v18 = (void *)MEMORY[0x263EFFA08];
  id v3 = [HMDWidgetFetchSpecification alloc];
  uint64_t v21 = [MEMORY[0x263EFFA08] setWithObject:*MEMORY[0x263F0D6F8]];
  v20 = [MEMORY[0x263EFFA08] set];
  uint64_t v19 = [MEMORY[0x263EFFA08] setWithObject:*MEMORY[0x263F0C040]];
  ...
  v16 = [MEMORY[0x263EFFA08] setWithObject:*MEMORY[0x263F0D798]];
  v5 = [MEMORY[0x263EFFA08] set];
  id v6 = [MEMORY[0x263EFFA08] setWithObject:*MEMORY[0x263F0C0B0]];
  ...
  id v9 = [MEMORY[0x263EFFA08] setWithObject:*MEMORY[0x263F0D7D8]];
  v10 = [MEMORY[0x263EFFA08] set];
  id v11 = [MEMORY[0x263EFFA08] setWithObject:*MEMORY[0x263F0C0E8]];
  ...
  v22[2] = v12;
  id v13 = [MEMORY[0x263EFF8C0] arrayWithObjects:v22 count:3];
...
+ (NSSet)mainHomeSecurityFetchSpecifications
{
  ...
  id v3 = [MEMORY[0x263EFF8C0] arrayWithObjects:v48 count:2];
  ...
  v5 = [MEMORY[0x263EFF8C0] arrayWithObjects:v47 count:3];
  id v6 = [v4 setWithArray:v5];

  id v36 = (id)MEMORY[0x263EFFA08];
  v7 = [HMDWidgetFetchSpecification alloc];
  uint64_t v8 = *MEMORY[0x263F0D6F8];
  v43 = [MEMORY[0x263EFFA08] setWithObject:*MEMORY[0x263F0D6F8]];
  v42 = [MEMORY[0x263EFFA08] set];
  v41 = [MEMORY[0x263EFFA08] setWithObject:*MEMORY[0x263F0C040]];
  ...
  uint64_t v12 = *MEMORY[0x263F0D8A8];
  v45[0] = *MEMORY[0x263F0D6A8];
  uint64_t v11 = v45[0];
  v45[1] = v12;
  v39 = [MEMORY[0x263EFF8C0] arrayWithObjects:v45 count:2];
  v35 = [v10 setWithArray:v39];
  v34 = [MEMORY[0x263EFFA08] set];
  v33 = [MEMORY[0x263EFFA08] setWithObject:*MEMORY[0x263F0C320]];
  ...
  v30 = [MEMORY[0x263EFFA08] setWithObject:*MEMORY[0x263F0D698]];
  id v14 = (void *)MEMORY[0x263EFFA08];
  v44[0] = v8;
  v44[1] = v11;
  v44[2] = v12;
  v31 = [MEMORY[0x263EFF8C0] arrayWithObjects:v44 count:3];
  v29 = [v14 setWithArray:v31];
  objc_super v28 = [MEMORY[0x263EFFA08] setWithObject:*MEMORY[0x263F0C008]];
  ...
  v18 = [MEMORY[0x263EFFA08] setWithObject:*MEMORY[0x263F0C0B0]];
  ...
  uint64_t v21 = [MEMORY[0x263EFFA08] setWithObject:*MEMORY[0x263F0D7D8]];
  v22 = [MEMORY[0x263EFFA08] set];
  uint64_t v23 = [MEMORY[0x263EFFA08] setWithObject:*MEMORY[0x263F0C0E8]];
  ...
  v46[4] = v24;
  uint64_t v25 = [MEMORY[0x263EFF8C0] arrayWithObjects:v46 count:5];
...
+ (NSSet)lightsFetchSpecifications
{
  ...
  id v3 = [MEMORY[0x263EFF8C0] arrayWithObjects:v26 count:2];
  v4 = [v2 setWithArray:v3];

  uint64_t v21 = (void *)MEMORY[0x263EFFA08];
  v5 = [HMDWidgetFetchSpecification alloc];
  uint64_t v6 = *MEMORY[0x263F0D780];
  uint64_t v23 = [MEMORY[0x263EFFA08] setWithObject:*MEMORY[0x263F0D780]];
  v22 = [MEMORY[0x263EFFA08] set];
  uint64_t v7 = *MEMORY[0x263F0C328];
  v20 = [MEMORY[0x263EFFA08] setWithObject:*MEMORY[0x263F0C328]];
  ...
  id v9 = [HMDWidgetFetchSpecification alloc];
  v10 = (void *)MEMORY[0x263EFFA08];
  uint64_t v11 = *MEMORY[0x263F0D828];
  v24[0] = *MEMORY[0x263F0D7D0];
  v24[1] = v11;
  uint64_t v12 = [MEMORY[0x263EFF8C0] arrayWithObjects:v24 count:2];
  id v13 = [v10 setWithArray:v12];
  id v14 = [MEMORY[0x263EFFA08] setWithObject:v6];
  id v15 = [MEMORY[0x263EFFA08] setWithObject:v7];
  ...
  v25[1] = v16;
  uint64_t v17 = [MEMORY[0x263EFF8C0] arrayWithObjects:v25 count:2];
