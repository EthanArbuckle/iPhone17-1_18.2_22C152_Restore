  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v21 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Returning nil because home reference is nil", buf, 0xCu);
    }
    id v10 = 0;
  }
      ...
      while (1)
      {
        ...
        if (v13)
        {
          ...
          if (v14)
          {
            ...
            {
              v48 = (void *)v15;
              id v49 = objc_alloc(MEMORY[0x263F0E350]);
        ...
        if (v20 && ([v16 personWithUUID:v20], (uint64_t v21 = objc_claimAutoreleasedReturnValue()) != 0))
        {
          ...
          id v23 = objc_alloc(MEMORY[0x263F0E350]);
        ...
        else
        {
          ...
          {
            v27 = (void *)v26;
            id v28 = objc_alloc(MEMORY[0x263F0E350]);
...
LABEL_25:
              ...
              if (v20 && v34)
              {
                v35 = (void *)[objc_alloc(MEMORY[0x263F0E5C0]) initWithUUID:v20];
                [v35 setName:v22];
                id v36 = objc_alloc(MEMORY[0x263F0E350]);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v41, OS_LOG_TYPE_DEFAULT))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v72 = 2112;
                  v73 = v9;
                  _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_DEFAULT, "%{public}@Could not determine face classification for significant event face classification: %@", buf, 0x16u);
            ...
            id v33 = objc_alloc(MEMORY[0x263F0E350]);
...
LABEL_41:
    v53 = v60;
    if (v62) {
      objc_msgSend(MEMORY[0x263EFF980], "arrayWithObject:");
    }
    else {
    v54 = [MEMORY[0x263EFF980] array];
    }
    id v6 = v57;
    v55 = [v60 sortedArrayUsingComparator:&__block_literal_global_128549];
    [v54 addObjectsFromArray:v55];
    [v54 sortWithOptions:16 usingComparator:&__block_literal_global_4_128550];
    v47 = [v54 firstObject];
...
LABEL_45:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v71 = v46;
      _os_log_impl(&dword_22F52A000, v45, OS_LOG_TYPE_DEFAULT, "%{public}@Not returning a face classification because home reference is nil", buf, 0xCu);
    }
    v47 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_128560 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_128560, &__block_literal_global_8_128561);
  }
  v2 = (void *)logCategory__hmf_once_v4_128562;
  return v2;
}
...
void __66__HMDCameraSignificantEventFaceClassificationResolver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_128562;
  logCategory__hmf_once_v4_128562 = v0;
}
