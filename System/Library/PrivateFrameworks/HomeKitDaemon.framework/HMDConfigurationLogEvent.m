...
- (HMDConfigurationLogEvent)initWithHomeConfigurations:(id)a3 widgetDataSource:(id)a4 isFMFDevice:(BOOL)a5
{
  ...
  if (v11)
  {
    ...
    os_unfair_lock_unlock((os_unfair_lock_t)&_lock_34378);
    id v19 = v10;
      ...
      do
      {
        for (uint64_t i = 0; i != v14; ++i)
        {
          ...
          if ([v17 numAccessories])
          {
            ...
            v11->_isResidentSelectionEnabledAnyHome |= [v17 isResidentSelectionEnabled];
            v11->_isResidentSelectionModeAutoAnyHome |= [v17 residentSelectionMode] == 3;
            v11->_isResidentSelectionModeCoordinationAnyHome |= [v17 residentSelectionMode] == 1;
            v11->_isResidentSelectionModeManualAnyHome |= [v17 residentSelectionMode] == 2;
          }
        }
