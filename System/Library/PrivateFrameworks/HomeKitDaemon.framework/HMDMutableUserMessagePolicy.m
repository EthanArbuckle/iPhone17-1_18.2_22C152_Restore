...
+ (id)userMessagePolicyWithHome:(id)a3 userPrivilege:(unint64_t)a4 remoteAccessRequired:(BOOL)a5
{
  return (id)[a1 userMessagePolicyWithHome:a3 userPrivilege:a4 remoteAccessRequired:a5 requiresCameraStreamingAccess:0 useProofOfLocality:0];
}
...
+ (id)userMessagePolicyWithHome:(id)a3 userPrivilege:(unint64_t)a4 remoteAccessRequired:(BOOL)a5 requiresCameraStreamingAccess:(BOOL)a6
{
  ...
  v12 = [v10 uuid];
  v13 = objc_msgSend(v11, "__initWithHome:homeUUID:userPrivilege:remoteAccessRequired:requiresCameraStreamingAccess:useProofOfLocality:", v10, v12, a4, v7, v6, 0);
