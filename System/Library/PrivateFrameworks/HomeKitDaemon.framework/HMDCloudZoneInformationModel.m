...
- (id)dependentUUIDs
{
  v3 = [MEMORY[0x263EFF9C0] setWithCapacity:1];
...
+ (id)properties
{
  if (properties_onceToken_128401 != -1) {
    dispatch_once(&properties_onceToken_128401, &__block_literal_global_128402);
  }
  v2 = (void *)properties__properties_128403;
  return v2;
}
...
void __42__HMDCloudZoneInformationModel_properties__block_invoke()
{
  ...
  v2 = (void *)properties__properties_128403;
  properties__properties_128403 = v1;
}
