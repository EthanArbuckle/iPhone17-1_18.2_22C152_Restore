...
- (void)__handleDeviceUpdated:(id)a3
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v16 = 2112;
    v17 = v13;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Received notification device updated: %@", (uint8_t *)&v14, 0x16u);
  }
...
- (void)updateWithDevice:(id)a3 completionHandler:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    int v13 = 138543362;
    int v14 = v11;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating the current device is not supported", (uint8_t *)&v13, 0xCu);
  }
  if (v7)
  {
    v12 = [MEMORY[0x263F087E8] hmErrorWithCode:48 description:0 reason:@"Updating the current device is not supported" suggestion:0];
    v7[2](v7, v12);
  }
}
