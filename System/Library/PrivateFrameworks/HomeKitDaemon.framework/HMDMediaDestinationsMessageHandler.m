...
- (void)handleMediaDestinationUpdatedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v31 = 138543362;
    v32 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling media destination updated notification", (uint8_t *)&v31, 0xCu);
  }
  ...
  if (v9)
  {
    ...
    if (v10)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v33 = 2112;
          id v34 = v4;
          _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to get destination from media destination updated notification: %@", (uint8_t *)&v31, 0x16u);
        }
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v33 = 2112;
        id v34 = v4;
        _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to get notification object from media destination updated notification: %@", (uint8_t *)&v31, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      int v31 = 138543362;
      v32 = v22;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to handle destination updated notification due to no delegate", (uint8_t *)&v31, 0xCu);
    }
  }
}
...
LABEL_7:
  ...
  v17 = v16;
  v22[0] = *MEMORY[0x263F0D0F0];
  char v18 = [MEMORY[0x263EFF8C0] arrayWithObjects:v22 count:1];
  v21.receiver = self;
