...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_100098 != -1) {
    dispatch_once(&logCategory__hmf_once_t6_100098, &__block_literal_global_100099);
  }
  v2 = (void *)logCategory__hmf_once_v7_100100;
  return v2;
}
...
void __34__HMDCompanionManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_100100;
  logCategory__hmf_once_v7_100100 = v0;
}
...
+ (id)sharedManager
{
  ...
  if (v4 == 3)
  {
    ...
    block[4] = a1;
    if (sharedManager_onceToken_100109 != -1) {
      dispatch_once(&sharedManager_onceToken_100109, block);
    }
