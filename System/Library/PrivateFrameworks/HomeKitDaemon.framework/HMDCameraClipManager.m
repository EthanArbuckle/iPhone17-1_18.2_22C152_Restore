  ...
  if (v13)
  {
    ...
    if (v15 == 1)
    {
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        int v22 = 138543362;
        v23 = v20;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Received all storage disabled notification", (uint8_t *)&v22, 0xCu);
      }
    ...
    else
    {
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v24 = 2112;
        v25 = v9;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Received unknown notification: %@", (uint8_t *)&v22, 0x16u);
      }
    }
  }
}
...
- (void)zoneManagerDidStop:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v11 = 138543362;
    v12 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Camera clips zone manager stopped", (uint8_t *)&v11, 0xCu);
  }
...
- (void)zoneManagerDidStart:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v48 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Camera clips zone manager started", buf, 0xCu);
  }
  v10 = [v4 localZone];
  ...
  if ((v15 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v49 = 2112;
      v50 = v21;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Suppressing all clip-related notifications before %@", buf, 0x16u);
    }
  }
  int v22 = [(HMDCameraClipManager *)v7 cloudZone];
  v23 = [v22 startUp];
  __int16 v24 = (void *)MEMORY[0x263F581B8];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v48 = v44;
      _os_log_impl(&dword_22F52A000, v43, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot create feedback manager because home reference is nil", buf, 0xCu);
    }
  }
}
...
void __44__HMDCameraClipManager_zoneManagerDidStart___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    int v11 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Camera clips cloud zone finished starting up", (uint8_t *)&v10, 0xCu);
  }
...
void __58__HMDCameraClipManager_localZone_didProcessModelDeletion___block_invoke(uint64_t a1)
{
    ...
    if (v13)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)&buf[14] = 16;
        __int16 v43 = 2098;
        v44 = &v40;
        _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Significant event notification deleted with UUID: %{public,uuid_t}.16P", buf, 0x1Cu);
      }
      v35 = *(void **)(a1 + 40);
      ...
      if (v22)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)&buf[14] = 16;
          __int16 v43 = 2098;
          v44 = &v39;
          _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_DEBUG, "%{public}@Significant event face classification deleted with UUID: %{public,uuid_t}.16P", buf, 0x1Cu);
        }
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)&buf[14] = 16;
    __int16 v43 = 2098;
    v44 = &v41;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Clip deleted with UUID: %{public,uuid_t}.16P", buf, 0x1Cu);
  }
  v29 = *(void **)(a1 + 40);
  v30 = [MEMORY[0x263EFFA08] set];
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)&buf[14] = 16;
      __int16 v35 = 2098;
      v36 = &v33;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Clip updated with UUID: %{public,uuid_t}.16P", buf, 0x1Cu);
    }
    v29 = *(void **)(a1 + 40);
    ...
    if (v13)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)&buf[14] = 16;
        __int16 v35 = 2098;
        v36 = &v32;
        _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Significant event notification updated with UUID: %{public,uuid_t}.16P", buf, 0x1Cu);
      }
      v30 = *(void **)(a1 + 40);
      ...
      if (v22)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)&buf[14] = 16;
          __int16 v35 = 2098;
          v36 = &v31;
          _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@Face classification updated with UUID: %{public,uuid_t}.16P", buf, 0x1Cu);
        }
        [*(id *)(a1 + 40) _handleChangedFaceClassificationModel:v22];
      }
    }
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)&buf[14] = 16;
      __int16 v35 = 2098;
      v36 = &v33;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@New clip received with UUID: %{public,uuid_t}.16P", buf, 0x1Cu);
    }
    v29 = *(void **)(a1 + 40);
    id v13 = [*(id *)(a1 + 32) mirrorOutputFuture];
    ...
    if (v13)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)&buf[14] = 16;
        __int16 v35 = 2098;
        v36 = &v32;
        _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@New significant event notification received with UUID: %{public,uuid_t}.16P", buf, 0x1Cu);
      }
      v30 = *(void **)(a1 + 40);
      id v22 = [*(id *)(a1 + 32) mirrorOutputFuture];
      [v30 _handleChangedSignificantEventNotificationModel:v13 mirrorOutputFuture:v22];
      ...
      if (v22)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)&buf[14] = 16;
          __int16 v35 = 2098;
          v36 = &v31;
          _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@New face classification received with UUID: %{public,uuid_t}.16P", buf, 0x1Cu);
        }
      }
    }
  }
  ...
  if (v4)
  {
    ...
    if ((v7 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        int v12 = 138543362;
        id v13 = v11;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Home person manager face classification is disabled; removing all face classification models",
          (uint8_t *)&v12,
          0xCu);
      }
...
- (void)handleUpdateCloudStorageMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v27 = 2114;
    id v28 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling update cloud storage message: %{public}@", buf, 0x16u);
  }
  int v11 = [(HMDCameraClipManager *)v7 cloudZone];

  if (v11)
  {
    if ([v4 BOOLForKey:*MEMORY[0x263F0BC00]])
    {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v26 = v18;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Cannot update cloud storage because zones are not ready", buf, 0xCu);
    }
...
- (void)handleFetchIsCloudStorageEnabledMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v40 = 2114;
    long long v41 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch is cloud storage enabled message: %{public}@", buf, 0x16u);
  }
  int v11 = [(HMDCameraClipManager *)v7 cloudZone];
  ...
  if (!v11)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v39 = v27;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch is cloud storage enabled because zones are not ready", buf, 0xCu);
    }
    uint64_t v28 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
    goto LABEL_12;
  }
  ...
  if ((v14 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v39 = v32;
      _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_DEFAULT, "%{public}@User is not the zone owner; cannot fetch is cloud storage enabled",
        buf,
        0xCu);
    }
    uint64_t v28 = [MEMORY[0x263F087E8] hmfErrorWithCode:5];
LABEL_12:
  ...
  v34[1] = 3221225472;
  v34[2] = __64__HMDCameraClipManager_handleFetchIsCloudStorageEnabledMessage___block_invoke_220;
  v34[3] = &unk_264A2F370;
  v34[4] = v7;
  id v35 = v21;
...
void __64__HMDCameraClipManager_handleFetchIsCloudStorageEnabledMessage___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v19 = 2112;
    id v20 = v11;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Fetched is cloud storage enabled: %@", buf, 0x16u);
  }
  int v12 = *(void **)(a1 + 40);
  id v13 = objc_msgSend(NSNumber, "numberWithBool:", v6, *MEMORY[0x263F0BC00]);
  v16 = v13;
  char v14 = [NSDictionary dictionaryWithObjects:&v16 forKeys:&v15 count:1];
  [v12 respondWithPayload:v14];
}

void __64__HMDCameraClipManager_handleFetchIsCloudStorageEnabledMessage___block_invoke_220(uint64_t a1, void *a2)
{
  uint64_t v12 = *MEMORY[0x263EF8340];
  id v3 = a2;
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v10 = 2112;
    id v11 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch is cloud storage enabled: %@", (uint8_t *)&v8, 0x16u);
  }
...
- (void)handleImportClipsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v44 = 2114;
    id v45 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling import clips message: %{public}@", buf, 0x16u);
  }
  id v11 = [(HMDCameraClipManager *)v7 localZone];

  if (v11)
  {
    uint64_t v12 = [v4 dataForKey:*MEMORY[0x263F0BBC0]];
    if (v12)
    {
      id v13 = (void *)MEMORY[0x263F08928];
      char v14 = (void *)MEMORY[0x263EFFA08];
      v41[0] = objc_opt_class();
      v41[1] = objc_opt_class();
      v41[2] = objc_opt_class();
      v41[3] = objc_opt_class();
      uint64_t v15 = [MEMORY[0x263EFF8C0] arrayWithObjects:v41 count:4];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v44 = 2112;
          id v45 = v18;
          _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive camera clips import dictionary from clip data: %@", buf, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v44 = 2112;
        id v45 = v33;
        _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@Could not find serialized import data in message payload: %@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v43 = v28;
      _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_ERROR, "%{public}@Cannot import clips because zones are not ready", buf, 0xCu);
    }
...
- (void)handleRemoteHandleFaceMisclassificationMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[12] = 2114;
    *(void *)&buf[14] = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling remote handle face misclassification message: %{public}@", buf, 0x16u);
  }
  id v11 = [(HMDCameraClipManager *)v7 localZone];
  ...
  if (v11)
  {
    ...
    if (v12 && v14 && v13)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
        {
          ...
          *(void *)&buf[20] = &v32;
          _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@Could not find person manager with UUID %{public,uuid_t}.16P to handle misclassified person", buf, 0x1Cu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(void *)&buf[14] = v26;
        _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Could not find all face misclassification information in message payload: %@", buf, 0x16u);
      }
      v17 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(void *)&uint8_t buf[4] = v21;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to handle face misclassification because zones are not ready", buf, 0xCu);
    }
    uint64_t v12 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
    [v4 respondWithError:v12];
  }
...
- (void)handleHandleFaceMisclassificationMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[12] = 2114;
    *(void *)&buf[14] = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling handle face misclassification message: %{public}@", buf, 0x16u);
  }
  id v11 = [(HMDCameraClipManager *)v7 localZone];

  if (v11)
  {
    uint64_t v12 = *MEMORY[0x263F0BC38];
    v67[0] = objc_opt_class();
    v67[1] = objc_opt_class();
    id v13 = [MEMORY[0x263EFF8C0] arrayWithObjects:v67 count:2];
    ...
    if (v15)
    {
      ...
      if (v17)
      {
        ...
        if (v19)
        {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v49, OS_LOG_TYPE_ERROR))
            {
              ...
              *(void *)&buf[30] = v23;
              _os_log_impl(&dword_22F52A000, v49, OS_LOG_TYPE_ERROR, "%{public}@Could not find significant event model with UUID %{public,uuid_t}.16P: %@", buf, 0x26u);

              v47 = v55;
            }

            v52 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
        ...
        else
        {
          ...
          if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_WORD *)&buf[12] = 2112;
            *(void *)&buf[14] = v18;
            _os_log_impl(&dword_22F52A000, v45, OS_LOG_TYPE_ERROR, "%{public}@Cannot handle misclassification for face classification without a person: %@", buf, 0x16u);
          }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_WORD *)&buf[12] = 2112;
          *(void *)&buf[14] = v16;
          _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_ERROR, "%{public}@Could not find face classification on significant event: %@", buf, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[22] = 2112;
        *(void *)&buf[24] = v38;
        _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_ERROR, "%{public}@Could not find significant event in decoded significant events %@ in message payload: %@", buf, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(void *)&uint8_t buf[4] = v33;
      _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_ERROR, "%{public}@Failed to handle face misclassification because zones are not ready", buf, 0xCu);
    }
    uint64_t v14 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
    [v4 respondWithError:v14];
  }
...
- (void)handleDeleteAllClipsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v27 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling delete all clips message", buf, 0xCu);
  }
  ...
  if (v10)
  {
    ...
    uint64_t v12 = [MEMORY[0x263EFF8C0] arrayWithObjects:v25 count:2];
    id v13 = (void *)MEMORY[0x263F49318];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v27 = v22;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Cannot delete clips because zones are not ready", buf, 0xCu);
    }
...
- (void)handleDeleteClipMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v33 = 2114;
    uint64_t v34 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling delete clip message: %{public}@", buf, 0x16u);
  }
  id v11 = [(HMDCameraClipManager *)v7 localZone];

  if (v11)
  {
    uint64_t v12 = [v4 uuidForKey:*MEMORY[0x263F0BBC8]];
    if (v12)
    {
      id v13 = [MEMORY[0x263EFFA08] setWithObject:v12];
      uint64_t v14 = (void *)MEMORY[0x263F49318];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v33 = 2112;
        uint64_t v34 = v28;
        _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Could not find clip UUID in message payload: %@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v32 = v23;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Cannot delete clip because zones are not ready", buf, 0xCu);
    }
    uint64_t v12 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
    [v4 respondWithError:v12];
  }
...
- (void)handleFetchSignificantEventsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v57 = 2114;
    id v58 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch significant event message: %{public}@", buf, 0x16u);
  }
  id v11 = [(HMDCameraClipManager *)v7 localZone];

  if (v11)
  {
    uint64_t v12 = [v4 setForKey:*MEMORY[0x263F0BC30]];
    id v13 = v12;
    if (v12)
    {
      ...
      uint64_t v53 = *MEMORY[0x263F0BC38];
    ...
    else
    {
      ...
      if (v15)
      {
        v16 = [v4 dateForKey:*MEMORY[0x263F0BBE8]];
        id v23 = [v4 dateForKey:*MEMORY[0x263F0BBF0]];
        id v24 = [v4 numberForKey:*MEMORY[0x263F0BC08]];
        uint64_t v25 = [v4 numberForKey:*MEMORY[0x263F0BC28]];
        uint64_t v26 = (void *)v25;
        v47 = v24;
        if (v16 && v23 && v24 && v25)
        {
          id v27 = (void *)[objc_alloc(MEMORY[0x263F08798]) initWithStartDate:v16 endDate:v23];
          ...
          if (v28)
          {
            ...
            v48[1] = 3221225472;
            v48[2] = __60__HMDCameraClipManager_handleFetchSignificantEventsMessage___block_invoke_214;
            v48[3] = &unk_264A2F7F8;
            id v49 = v4;
          ...
          else
          {
            ...
            if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v57 = 2112;
              id v58 = v45;
              _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch significant event models from local zone: %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v57 = 2112;
            id v58 = v39;
            _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_ERROR, "%{public}@Could not find required value in message payload: %@", buf, 0x16u);

            id v23 = v46;
          }

          id v27 = [MEMORY[0x263F087E8] hmErrorWithCode:20];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v57 = 2112;
          id v58 = v4;
          _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_ERROR, "%{public}@Failed to create fetch server from message: %@", buf, 0x16u);
        }
        v16 = [MEMORY[0x263F087E8] hmErrorWithCode:20];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v56 = v21;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch significant events because zones are not ready", buf, 0xCu);
    }
...
uint64_t __60__HMDCameraClipManager_handleFetchSignificantEventsMessage___block_invoke_214(uint64_t a1)
{
  return [*(id *)(a1 + 32) respondWithSuccess];
}
...
- (void)handleFetchFaceCropURLMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[12] = 2114;
    *(void *)&buf[14] = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch face crop for message: %{public}@", buf, 0x16u);
  }
  id v11 = [(HMDCameraClipManager *)v7 localZone];
  ...
  if (v11)
  {
    ...
    if (v13)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_WORD *)&unsigned char buf[28] = 2112;
          *(void *)&buf[30] = v16;
          _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_ERROR, "%{public}@Could not find significant event model with UUID %{public,uuid_t}.16P: %@", buf, 0x26u);
        }
        uint64_t v21 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[22] = 2112;
        *(void *)&buf[24] = v30;
        _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Could not find significant event UUID in decoded UUIDs %@ in message payload: %@", buf, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      *(void *)&uint8_t buf[4] = v25;
      _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch face crop url because zones are not ready", buf, 0xCu);
    }
    uint64_t v12 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
    [v4 respondWithError:v12];
  }
...
void __54__HMDCameraClipManager_handleFetchFaceCropURLMessage___block_invoke(uint64_t a1, void *a2)
{
  ...
  id v2 = *(void **)(a1 + 32);
  uint64_t v5 = *MEMORY[0x263F0BBF8];
...
- (void)handleFetchFaceCropDataRepresentationMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[12] = 2114;
    *(void *)&buf[14] = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch face crop data representation with message: %{public}@", buf, 0x16u);
  }
  id v11 = [(HMDCameraClipManager *)v7 localZone];
  ...
  if (v11)
  {
    ...
    if (v13)
    {
      ...
      if (v15)
      {
        ...
        v38[0] = MEMORY[0x263EF8330];
        v38[1] = 3221225472;
        v38[2] = __69__HMDCameraClipManager_handleFetchFaceCropDataRepresentationMessage___block_invoke_213;
        v38[3] = &unk_264A26C88;
        id v19 = v4;
        id v39 = v19;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      *(void *)&uint8_t buf[4] = v25;
      _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch face crop data representation because zones are not ready", buf, 0xCu);
    }
    uint64_t v12 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
    [v4 respondWithError:v12];
  }
...
id __69__HMDCameraClipManager_handleFetchFaceCropDataRepresentationMessage___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v5)
  {
    char v7 = [MEMORY[0x263F58190] futureWithResult:v5];
  }
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v20 = 2112;
      id v21 = v6;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to get data from URL %@: %@", buf, 0x20u);
    }
...
void __69__HMDCameraClipManager_handleFetchFaceCropDataRepresentationMessage___block_invoke_213(uint64_t a1, void *a2)
{
  v7[1] = *MEMORY[0x263EF8340];
  id v2 = *(void **)(a1 + 32);
  uint64_t v6 = *MEMORY[0x263F0BBE0];
  v7[0] = a2;
  id v3 = NSDictionary;
  id v4 = a2;
...
- (void)handleFetchHeroFrameURLMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[12] = 2112;
    *(void *)&buf[14] = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch hero frame URL message with payload: %@", buf, 0x16u);
  }
  id v11 = [(HMDCameraClipManager *)v7 localZone];
    ...
    if (v12)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_WORD *)&unsigned char buf[18] = 2098;
          *(void *)&buf[20] = &v38;
          _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@Failed requesting to fetch hero frame url because no clip could be found for UUID %{public,uuid_t}.16P", buf, 0x1Cu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(void *)&uint8_t buf[4] = v28;
        _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch hero frame url because clip uuid cannot be found in message payload", buf, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(void *)&uint8_t buf[4] = v24;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch hero frame url because zones are not ready", buf, 0xCu);
    }
    uint64_t v12 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
    [v4 respondWithError:v12];
  }
...
- (void)handleFetchHeroFrameDataRepresentationMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v43 = 2114;
    uint64_t v44 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch hero frame data representation with message: %{public}@", buf, 0x16u);
  }
  id v11 = [(HMDCameraClipManager *)v7 localZone];
  ...
  if (v11)
  {
    ...
    if (v12)
    {
      ...
      if (v14)
      {
        ...
        v37[0] = MEMORY[0x263EF8330];
        v37[1] = 3221225472;
        v37[2] = __70__HMDCameraClipManager_handleFetchHeroFrameDataRepresentationMessage___block_invoke_210;
        v37[3] = &unk_264A26C88;
        id v18 = v4;
        id v38 = v18;
      ...
      else
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v45 = 2112;
          id v46 = v15;
          _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_ERROR, "%{public}@Could not find clip with UUID %@: %@", buf, 0x20u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v43 = 2112;
        uint64_t v44 = v29;
        _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_ERROR, "%{public}@Cannot find clip UUID in message payload: %@", buf, 0x16u);
      }
      id v15 = [MEMORY[0x263F087E8] hmErrorWithCode:20];
      [v4 respondWithError:v15];
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v42 = v24;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch hero frame data representation because zones are not ready", buf, 0xCu);
    }
    uint64_t v12 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
    [v4 respondWithError:v12];
  }
...
void __70__HMDCameraClipManager_handleFetchHeroFrameDataRepresentationMessage___block_invoke_210(uint64_t a1, void *a2)
{
  v7[1] = *MEMORY[0x263EF8340];
  id v2 = *(void **)(a1 + 32);
  uint64_t v6 = *MEMORY[0x263F0BBE0];
...
- (void)handleFetchVideoSegmentsAssetContextMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v15 = 138543362;
    id v16 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch video segments asset context message", (uint8_t *)&v15, 0xCu);
  }
...
- (void)handleFetchCountOfClipsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v49 = 2114;
    id v50 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch count of clips message: %{public}@", buf, 0x16u);
  }
  id v11 = [(HMDCameraClipManager *)v7 localZone];

  if (v11)
  {
    uint64_t v12 = [v4 dateForKey:*MEMORY[0x263F0BBE8]];
    id v13 = [v4 dateForKey:*MEMORY[0x263F0BBF0]];
    uint64_t v14 = [v4 numberForKey:*MEMORY[0x263F0BC10]];
    int v15 = v14;
    if (v12 && v13 && v14)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v51 = 2112;
        id v52 = v13;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Fetching count of clips between %@ and %@", buf, 0x20u);
      }
      v45[0] = @"dateAfter";
      v45[1] = @"dateBefore";
      v46[0] = v12;
      ...
      v46[2] = v21;
      uint64_t v22 = [NSDictionary dictionaryWithObjects:v46 forKeys:v45 count:3];
      ...
      if (v25)
      {
        uint64_t v43 = *MEMORY[0x263F0BBD8];
        uint64_t v44 = v25;
        id v27 = [NSDictionary dictionaryWithObjects:&v44 forKeys:&v43 count:1];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v49 = 2112;
          id v50 = v26;
          _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch count of clip models from local zone: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v49 = 2112;
        id v50 = v36;
        _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_ERROR, "%{public}@Could not find required value in message payload: %@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v48 = v31;
      _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch count of clips because zones are not ready", buf, 0xCu);
    }
    uint64_t v12 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
    [v4 respondWithError:v12];
  }
...
- (void)handleFetchClipForSignificantEventMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[12] = 2114;
    *(void *)&buf[14] = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch clip for significant event message: %{public}@", buf, 0x16u);
  }
  id v11 = [(HMDCameraClipManager *)v7 localZone];
  ...
  if (v11)
  {
    ...
    if (!v13)
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[22] = 2112;
        *(void *)&buf[24] = v34;
        _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_ERROR, "%{public}@Could not find significant event UUID in decoded UUIDs %@ in message payload: %@", buf, 0x20u);
      }
      id v16 = [MEMORY[0x263F087E8] hmErrorWithCode:20];
      [v4 respondWithError:v16];
      goto LABEL_40;
    ...
    if (!v15)
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&unsigned char buf[28] = 2112;
        *(void *)&buf[30] = v16;
        _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_ERROR, "%{public}@Could not find significant event with UUID %{public,uuid_t}.16P: %@", buf, 0x26u);
      }
...
LABEL_8:
      ...
      uint64_t v65 = *MEMORY[0x263F0BBB8];
      id v24 = encodeRootObjectForIncomingXPCMessage(v23, 0);
      v66 = v24;
      uint64_t v25 = [NSDictionary dictionaryWithObjects:&v66 forKeys:&v65 count:1];
...
LABEL_40:
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_WORD *)&unsigned char buf[18] = 2098;
      *(void *)&buf[20] = &v68;
      _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_DEFAULT, "%{public}@Could not find clip model with UUID %{public,uuid_t}.16P. Falling back to using the associated clip", buf, 0x1Cu);
    ...
    if (v19)
    {
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(void *)&buf[14] = v19;
        _os_log_impl(&dword_22F52A000, v47, OS_LOG_TYPE_INFO, "%{public}@Fetching clip model using associated clip reference: %@", buf, 0x16u);
      }
...
LABEL_37:
      ...
      *(_WORD *)&unsigned char buf[28] = 2112;
      *(void *)&buf[30] = v16;
      _os_log_impl(&dword_22F52A000, v47, OS_LOG_TYPE_ERROR, "%{public}@Could not find clip with UUID %{public,uuid_t}.16P: %@", buf, 0x26u);
    }
    else
    {
      if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(void *)&buf[14] = v15;
        _os_log_impl(&dword_22F52A000, v47, OS_LOG_TYPE_ERROR, "%{public}@No associatedClip found for significant event model: %@", buf, 0x16u);
      }
      id v16 = v20;
    }
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    *(void *)&uint8_t buf[4] = v29;
    _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch clip for significant event because zones are not ready", buf, 0xCu);
  }
  uint64_t v12 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
  [v4 respondWithError:v12];
LABEL_41:
...
- (void)handleFetchClipsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v57 = 2114;
    id v58 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch clips message: %{public}@", buf, 0x16u);
  }
  id v11 = [(HMDCameraClipManager *)v7 localZone];
  ...
  if (v11)
  {
    ...
    if (v13)
    {
      uint64_t v14 = [v4 dateForKey:*MEMORY[0x263F0BBE8]];
      int v15 = [v4 dateForKey:*MEMORY[0x263F0BBF0]];
      id v16 = [v4 numberForKey:*MEMORY[0x263F0BC08]];
      uint64_t v17 = [v4 numberForKey:*MEMORY[0x263F0BC28]];
      uint64_t v18 = [v4 numberForKey:*MEMORY[0x263F0BC10]];
      id v19 = (void *)v18;
      if (v14 && v15 && v16 && v17 && v18)
      {
        v48 = v15;
        id v20 = (void *)[objc_alloc(MEMORY[0x263F08798]) initWithStartDate:v14 endDate:v15];
        id v21 = v16;
        ...
        if (v22)
        {
          v50[0] = MEMORY[0x263EF8330];
          v50[1] = 3221225472;
          v50[2] = __48__HMDCameraClipManager_handleFetchClipsMessage___block_invoke_204;
          v50[3] = &unk_264A2F7F8;
          id v51 = v4;
        ...
        else
        {
          ...
          if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v57 = 2112;
            id v58 = v25;
            _os_log_impl(&dword_22F52A000, v43, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch clip models from local zone: %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v57 = 2112;
          id v58 = v40;
          _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_ERROR, "%{public}@Could not find required value in message payload: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v57 = 2112;
        id v58 = v4;
        _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_ERROR, "%{public}@Failed to create fetch server from message: %@", buf, 0x16u);
      }
      uint64_t v14 = [MEMORY[0x263F087E8] hmErrorWithCode:20];
      [v4 respondWithError:v14];
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v56 = v29;
      _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch clips because zones are not ready", buf, 0xCu);
    }
    id v13 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
    [v4 respondWithError:v13];
  }
...
uint64_t __48__HMDCameraClipManager_handleFetchClipsMessage___block_invoke_204(uint64_t a1)
{
  return [*(id *)(a1 + 32) respondWithSuccess];
}
...
- (void)handleFetchClipMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v39 = 2114;
    id v40 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling fetch clip message: %{public}@", buf, 0x16u);
  }
  id v11 = [(HMDCameraClipManager *)v7 localZone];
  ...
  if (v11)
  {
    ...
    if (v12)
    {
      ...
      if (v14)
      {
        ...
        uint64_t v35 = *MEMORY[0x263F0BBB8];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v39 = 2112;
        id v40 = v29;
        _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_ERROR, "%{public}@Could not find clip UUID in message payload: %@", buf, 0x16u);
      }
      id v15 = [MEMORY[0x263F087E8] hmErrorWithCode:20];
      [v4 respondWithError:v15];
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v38 = v24;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch clip because zones are not ready", buf, 0xCu);
    }
    uint64_t v12 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
    [v4 respondWithError:v12];
  }
...
- (void)handleUnsubscribeMessage:(id)a3
{
  ...
  else
  {
    ...
    id v20 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
    [v4 respondWithError:v20];
  }
}
...
- (void)handleSubscribeMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v27 = 138543362;
    uint64_t v28 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling subscribe message", (uint8_t *)&v27, 0xCu);
  }
  __int16 v10 = [v4 transport];
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
  ...
  if (v12)
  {
    ...
    if (!v14)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
      {
        ...
        int v27 = 138543362;
        uint64_t v28 = v18;
        _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Asked to subscribe to changes when no cloud zone exists; Restarting zone manager",
          (uint8_t *)&v27,
          0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v31 = 2112;
      long long v32 = v25;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Subscribing transport was not of expected class %@: %@", (uint8_t *)&v27, 0x20u);
    }
...
- (id)_disableCloudStorage
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v25 = 138543362;
    id v26 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Disabling cloud storage", (uint8_t *)&v25, 0xCu);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v25 = 138543362;
      id v26 = v22;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@User is not the zone owner; cannot disable cloud storage",
        (uint8_t *)&v25,
        0xCu);
    }
    __int16 v23 = (void *)MEMORY[0x263F58190];
...
- (id)_enableCloudStorage
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v22 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Enabling cloud storage", buf, 0xCu);
  }
  int v8 = [(HMDCameraClipManager *)v5 zoneManager];
  id v9 = [v8 defaultConfiguration];
  char v10 = [v9 isZoneOwner];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v22 = v17;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@User is not the zone owner; cannot enable cloud storage",
        buf,
        0xCu);
    }
    uint64_t v18 = (void *)MEMORY[0x263F58190];
    id v11 = [MEMORY[0x263F087E8] hmfErrorWithCode:5];
...
id __43__HMDCameraClipManager__enableCloudStorage__block_invoke(uint64_t a1)
{
  ...
  uint64_t v6 = (void *)MEMORY[0x263F581B8];
...
- (void)_removeAllFaceClassificationModels
{
  ...
  id v4 = [MEMORY[0x263F49318] optionsWithLabel:@"Remove all face classification models"];
...
- (id)_removeClipsWithUUIDs:(id)a3 options:(id)a4
{
  ...
  char v10 = [v9 flatMap:&__block_literal_global_197];
...
- (void)_notifyPrimaryResidentAboutFaceMisclassificationForFaceCropData:(id)a3 personUUID:(id)a4 personManagerUUID:(id)a5
{
  ...
  if (v13)
  {
    ...
    v41[2] = v19;
    id v20 = [NSDictionary dictionaryWithObjects:v41 forKeys:v40 count:3];
    ...
    if (v22)
    {
      if (v26)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v38 = 2112;
        __int16 v39 = v21;
        _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@Directly handling face misclassification message because we are the primary resident: %@", buf, 0x16u);
      }
    ...
    else
    {
      if (v26)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v38 = 2112;
        __int16 v39 = v21;
        _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@Sending remote handle face misclassification message to primary resident: %@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v37 = v31;
      _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_ERROR, "%{public}@Could not find primary resident to send face misclassification message to", buf, 0xCu);
    }
  }
}
...
- (id)_handleFaceMisclassificationForFaceCropURL:(id)a3 personUUID:(id)a4 personManagerUUID:(id)a5 significantEventModel:(id)a6
{
  ...
  {
    id v35 = v17;
    __int16 v18 = (void *)MEMORY[0x230FBD990]([(HMDCameraClipManager *)self _notifyPrimaryResidentAboutFaceMisclassificationForFaceCropData:v16 personUUID:v11 personManagerUUID:v12]);
    id v19 = self;
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v43 = 2112;
      id v44 = v13;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Removing all face classifications for significant event model: %@", buf, 0x16u);
    }
    int v22 = [MEMORY[0x263F49318] optionsWithLabel:@"Remove all face classifications from significant event"];
    ...
    v36[0] = MEMORY[0x263EF8330];
    v36[1] = 3221225472;
    v36[2] = __118__HMDCameraClipManager__handleFaceMisclassificationForFaceCropURL_personUUID_personManagerUUID_significantEventModel___block_invoke_184;
    v36[3] = &unk_264A26BF0;
    void v36[4] = v19;
    id v37 = v13;
    uint64_t v27 = [v26 flatMap:v36];
    uint64_t v28 = [v27 flatMap:&__block_literal_global_192_207794];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v45 = 2112;
      id v46 = v17;
      _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@Could not load face crop data at URL %@: %@", buf, 0x20u);
    }
    uint64_t v33 = (void *)MEMORY[0x263F58190];
    int v22 = [MEMORY[0x263F087E8] hmErrorWithCode:-1];
...
id __118__HMDCameraClipManager__handleFaceMisclassificationForFaceCropURL_personUUID_personManagerUUID_significantEventModel___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v12 = 138543362;
    id v13 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Adding unassociated face crop to home person dataset for misclassified face classification", (uint8_t *)&v12, 0xCu);
  }
  id v8 = [*(id *)(a1 + 32) home];
...
id __118__HMDCameraClipManager__handleFaceMisclassificationForFaceCropURL_personUUID_personManagerUUID_significantEventModel___block_invoke_184(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v23 = 2112;
    id v24 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Creating face classification to use unassociated face crop: %@", (uint8_t *)&v21, 0x16u);
  }
  ...
  int v16 = [MEMORY[0x263F49318] optionsWithLabel:@"Create face classification with unassociated face crop"];
  id v17 = [*(id *)(a1 + 32) localZone];
  __int16 v18 = [MEMORY[0x263EFFA08] setWithObject:v11];
  id v19 = [v17 createModels:v18 options:v16];

  return v19;
}

uint64_t __118__HMDCameraClipManager__handleFaceMisclassificationForFaceCropURL_personUUID_personManagerUUID_significantEventModel___block_invoke_190()
{
  return [MEMORY[0x263F58190] futureWithNoResult];
}
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v24 = 2112;
      id v25 = v7;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Waiting for mirror output future to complete: %@", buf, 0x16u);
    }
    id v13 = (void *)MEMORY[0x263F581B8];
    uint64_t v14 = [(HMDCameraClipManager *)v10 workQueue];
    uint32_t v15 = [v13 schedulerWithDispatchQueue:v14];
    int v16 = [v7 reschedule:v15];
    id v17 = [v16 flatMap:&__block_literal_global_176];
  }
  else
  {
...
void __82__HMDCameraClipManager__notifyForChangedSignificantEventModel_mirrorOutputFuture___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (!v7)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v26 = 2112;
      uint64_t v27 = v21;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to create significant event from model: %@", (uint8_t *)&v24, 0x16u);
LABEL_12:
    }
LABEL_13:
  ...
  if (v13 == -1)
  {
    ...
    {
      uint64_t v20 = HMFGetLogIdentifier();
      int v22 = [v7 dateOfOccurrence];
      __int16 v23 = [*(id *)(a1 + 32) suppressNotificationsBeforeDate];
      int v24 = 138543874;
      id v25 = v20;
      __int16 v26 = 2112;
      uint64_t v27 = v22;
      __int16 v28 = 2112;
      __int16 v29 = v23;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring significant event with date of occurrence %@ because it is before %@", (uint8_t *)&v24, 0x20u);
  ...
  if (v17)
  {
    ...
    __int16 v26 = 2112;
    uint64_t v27 = v7;
    _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_DEBUG, "%{public}@Notifying delegate about updated significant event: %@", (uint8_t *)&v24, 0x16u);
  }
  id v19 = [*(id *)(a1 + 32) delegate];
  if (objc_opt_respondsToSelector()) {
    [v19 clipManager:*(void *)(a1 + 32) didUpdateSignificantEvent:v7];
  }
...
- (void)_handleChangedFaceClassificationModel:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v18 = 2112;
      id v19 = v4;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring changed face classification model because its associated significant event does not exist: %@", (uint8_t *)&v16, 0x16u);
    }
  }
}
...
- (void)_handleChangedSignificantEventNotificationModel:(id)a3 mirrorOutputFuture:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v18 = 2112;
      id v19 = v6;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring changed significant event notification model because its associated clip model does not exist: %@", (uint8_t *)&v16, 0x16u);
    }
  }
}
...
- (void)_handleChangedClipModel:(id)a3 wasCreated:(BOOL)a4 mirrorOutputFuture:(id)a5
{
        ...
        for (uint64_t i = 0; i != v14; ++i)
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v44 = 2112;
            __int16 v45 = v33;
            _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_DEBUG, "%{public}@Found existing significant event model %@ associated with new clip model %@", buf, 0x20u);
  ...
  int v24 = [v33 createClipWithSignificantEvents:v23];
  if (v24)
  {
    id v25 = [MEMORY[0x263EFFA08] setWithObject:v24];
    __int16 v26 = [MEMORY[0x263EFFA08] set];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v42 = 2112;
      __int16 v43 = v33;
      _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to create clip from clip model: %@", buf, 0x16u);
    }
    id v9 = v27;
  }
}
...
- (void)_fetchAssetContextForMessage:(id)a3 propertyName:(id)a4
{
  ...
  if (v9)
  {
    uint64_t v10 = [v6 uuidForKey:*MEMORY[0x263F0BBC8]];
    if (v10)
    {
      id v11 = (void *)v10;
    ...
    else
    {
      ...
      {
        __int16 v23 = HMFGetLogIdentifier();
        int v24 = [v6 messagePayload];
        *(_DWORD *)buf = 138543618;
        __int16 v31 = v23;
        __int16 v32 = 2112;
        id v33 = v24;
        _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failing request to fetch asset context because message has no clip UUID: %@", buf, 0x16u);
      }
      id v25 = [MEMORY[0x263F087E8] hmfErrorWithCode:3];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v32 = 2112;
      id v33 = v6;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch asset context for message because zones are not ready: %@", buf, 0x16u);
    }
  ...
  if (v5)
  {
    ...
    if (v8)
    {
      ...
      if (v9)
      {
        ...
        {
          id v63 = v6;
          id v11 = (void *)MEMORY[0x263F0E190];
          int v12 = [v5 streamingAssetVersion];
          uint64_t v13 = [v11 requiredHTTPHeadersForStreamingAssetVersion:v12];

          id v14 = (void *)[objc_alloc(MEMORY[0x263F0E198]) initWithURL:v9 expirationDate:v10 requiredHTTPHeaders:v13];
          id v15 = (void *)MEMORY[0x230FBD990]();
          id v16 = *(id *)(a1 + 32);
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)&buf[24] = 16;
            ...
            id v14 = v64;
            v73 = v64;
            _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Successfully fetched streaming asset with property name %@ for clip UUID %{public,uuid_t}.16P with context %@", buf, 0x30u);

            id v15 = v61;
          }

          id v62 = *(void **)(a1 + 48);
          v66[0] = *MEMORY[0x263F0BBB0];
          __int16 v49 = encodeRootObjectForIncomingXPCMessage(v14, 0);
          v67[0] = v49;
          v66[1] = *MEMORY[0x263F0BBB8];
          ...
          v67[1] = v52;
          [NSDictionary dictionaryWithObjects:v67 forKeys:v66 count:2];
          id v53 = v9;
          id v54 = v10;
          v56 = v55 = (void *)v13;
        ...
        else
        {
          ...
          if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)&buf[24] = 16;
            __int16 v70 = 2098;
            uint64_t v71 = &v74;
            _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_ERROR, "%{public}@Could not find content download URL expiration date on streaming asset %@ for clip with UUID: %{public,uuid_t}.16P", buf, 0x26u);

            id v40 = v65;
          }

          uint64_t v59 = *(void **)(a1 + 48);
          __int16 v57 = [MEMORY[0x263F087E8] hmfErrorWithCode:15];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)&buf[24] = 16;
          __int16 v70 = 2098;
          uint64_t v71 = &v75;
          _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_ERROR, "%{public}@Could not find content download URL on streaming asset %@ for clip with UUID: %{public,uuid_t}.16P", buf, 0x26u);
        }
        id v58 = *(void **)(a1 + 48);
        uint64_t v10 = [MEMORY[0x263F087E8] hmfErrorWithCode:15];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)&buf[24] = 16;
        __int16 v70 = 2098;
        uint64_t v71 = &v76;
        _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Could not find streaming asset on property named %@ for clip with UUID: %{public,uuid_t}.16P", buf, 0x26u);

        id v6 = v29;
      }

      uint64_t v47 = *(void **)(a1 + 48);
      id v9 = [MEMORY[0x263F087E8] hmfErrorWithCode:15];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(void *)&buf[20] = &v77;
      __int16 v70 = 2112;
      uint64_t v71 = v6;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch complete model for clip UUID %{public,uuid_t}.16P: %@", buf, 0x26u);
    }
    id v46 = *(void **)(a1 + 48);
  ...
  if (v11)
  {
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Notifying %lu subscribed transports of %lu updated significant events, %lu removed significant events", buf, 0x2Au);
    }
    v43[0] = *MEMORY[0x263F0BC48];
    id v36 = v6;
    id v19 = encodeRootObjectForIncomingXPCMessage(v6, 0);
    v43[1] = *MEMORY[0x263F0BC20];
    v44[0] = v19;
    id v35 = v7;
    v44[1] = v7;
    uint64_t v20 = [NSDictionary dictionaryWithObjects:v44 forKeys:v43 count:2];
    ...
    if (v23)
    {
      ...
      uint64_t v26 = *MEMORY[0x263F0BB40];
      do
      {
        uint64_t v27 = 0;
        do
        {
          ...
          id v29 = [MEMORY[0x263F42590] entitledMessageWithName:v26 messagePayload:v20];
          [v29 setTransport:v28];
          id v30 = objc_alloc(MEMORY[0x263F42570]);
  ...
  else
  {
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_DEBUG, "%{public}@No subscribed transports to notify of %lu updated significant events, %lu removed significant events", buf, 0x20u);
    }
  }
}
  ...
  if (v11)
  {
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v51 = 2048;
      uint64_t v52 = [v7 count];
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Notifying %lu subscribed transports of %lu updated clips, %lu removed clips", buf, 0x2Au);
    }
    v43[0] = *MEMORY[0x263F0BC40];
    id v36 = v6;
    id v19 = encodeRootObjectForIncomingXPCMessage(v6, 0);
    v43[1] = *MEMORY[0x263F0BC18];
    v44[0] = v19;
    id v35 = v7;
    v44[1] = v7;
    uint64_t v20 = [NSDictionary dictionaryWithObjects:v44 forKeys:v43 count:2];
    ...
    if (v23)
    {
      uint64_t v24 = v23;
      uint64_t v25 = *(void *)v39;
      uint64_t v26 = *MEMORY[0x263F0BB38];
      do
      {
        uint64_t v27 = 0;
        do
  ...
  else
  {
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v49 = 2048;
      uint64_t v50 = [v7 count];
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_DEBUG, "%{public}@No subscribed transports to notify of %lu updated clips, %lu removed clips", buf, 0x20u);
    }
  }
}
...
- (void)_cleanUpExpiredClips
{
  ...
  id v4 = [MEMORY[0x263EFF910] dateWithTimeIntervalSinceNow:-*MEMORY[0x263F0BCB8]];
  uint64_t v26 = @"dateBefore";
  v27[0] = v4;
  id v5 = [NSDictionary dictionaryWithObjects:v27 forKeys:&v26 count:1];
  id v6 = objc_msgSend(MEMORY[0x263EFF9C0], "setWithCapacity:", -[HMDCameraClipManager fetchBatchLimit](self, "fetchBatchLimit"));
  id v7 = [MEMORY[0x263F49318] optionsWithLabel:@"Remove expired clips"];
  ...
  if ([v11 count])
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v24 = 2048;
      uint64_t v25 = v17;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Removing %lu expired clips", buf, 0x16u);
    }
...
void __44__HMDCameraClipManager__cleanUpExpiredClips__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Removing expired clip: %@", (uint8_t *)&v18, 0x16u);
  }
  id v9 = *(void **)(a1 + 40);
  ...
  if (v11 >= [*(id *)(a1 + 32) fetchBatchLimit])
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v20 = 2048;
      uint64_t v21 = v16;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Removing %lu expired clips", (uint8_t *)&v18, 0x16u);
    }
  ...
  if ([v13 count])
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v37 = 2112;
      id v38 = v13;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Completing incomplete clips: %@", buf, 0x16u);

      unint64_t v16 = 0x263F49000uLL;
    }

    uint64_t v21 = [(HMDCameraClipManager *)v18 localZone];
    uint64_t v22 = [*(id *)(v16 + 792) optionsWithLabel:@"Complete Incomplete Clips"];
  ...
  if ([v14 count])
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v37 = 2112;
      id v38 = v14;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Removing incomplete 0-duration clip UUIDs: %@", buf, 0x16u);
    }
    uint64_t v28 = [*(id *)(v16 + 792) optionsWithLabel:@"Remove 0-duration Incomplete Clips"];
...
void __65__HMDCameraClipManager__cleanUpIncompleteClipsForInitialStartup___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v49 = 2112;
    uint64_t v50 = v8;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Cleaning up incomplete clip: %@", (uint8_t *)&v47, 0x16u);
  }
  id v9 = *(void **)(a1 + 40);
  ...
  else
  {
    ...
    [(HMDCameraClipModel *)v22 setIsComplete:MEMORY[0x263EFFA88]];
    id v23 = *(void **)(a1 + 48);
  }
  [v23 addObject:v22];
  ...
  if (v27 >= [*(id *)(a1 + 32) fetchBatchLimit])
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v49 = 2112;
      uint64_t v50 = v32;
      _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_DEFAULT, "%{public}@Completing batch of incomplete clips: %@", (uint8_t *)&v47, 0x16u);
    }
    id v33 = [*(id *)(a1 + 32) localZone];
    uint64_t v34 = *(void *)(a1 + 48);
    id v35 = [MEMORY[0x263F49318] optionsWithLabel:@"Complete Incomplete Clips"];
  ...
  if (v37 >= [*(id *)(a1 + 32) fetchBatchLimit])
  {
    ...
    if (os_log_type_enabled(v40, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v49 = 2112;
      uint64_t v50 = v42;
      _os_log_impl(&dword_22F52A000, v40, OS_LOG_TYPE_DEFAULT, "%{public}@Removing batch of incomplete 0-duration clip UUIDs: %@", (uint8_t *)&v47, 0x16u);
    }
    __int16 v43 = *(void **)(a1 + 32);
    uint64_t v44 = *(void *)(a1 + 56);
    __int16 v45 = [MEMORY[0x263F49318] optionsWithLabel:@"Remove 0-duration Incomplete Clips"];
...
- (id)_performCloudPull
{
  ...
  if (v4)
  {
    id v5 = [MEMORY[0x263F49318] optionsWithLabel:@"Explicit fetch"];
    id v6 = [(HMDCameraClipManager *)self cloudZone];
    id v7 = [v6 performCloudPullWithOptions:v5];
    BOOL v8 = (void *)MEMORY[0x263F581B8];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v21 = v16;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Cannot perform cloud pull because zones are not ready", buf, 0xCu);
    }
    double v17 = (void *)MEMORY[0x263F58190];
...
void __41__HMDCameraClipManager__performCloudPull__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v10 = 2112;
    id v11 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to perform cloud pull due to cloud zone fetch timer firing: %@", (uint8_t *)&v8, 0x16u);
  }
}
        ...
        v8))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v26 = 2112;
      unint64_t v27 = v6;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Using existing cached face crop URL: %@", buf, 0x16u);
    }
    id v13 = [MEMORY[0x263F58190] futureWithResult:v6];
  }
  else
  {
    ...
    unint64_t v16 = (void *)MEMORY[0x263F581B8];
...
id __66__HMDCameraClipManager__fetchFaceCropURLForSignificantEventModel___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v19 = 2112;
      __int16 v20 = v5;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Successfully fetched face crop URL: %@", (uint8_t *)&v17, 0x16u);
    }
    id v11 = [MEMORY[0x263F58190] futureWithResult:v5];
  }
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      __int16 v20 = v13;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Could not find face crop file URL on fetched asset: %@", (uint8_t *)&v17, 0x16u);
    }
...
void __66__HMDCameraClipManager__fetchFaceCropURLForSignificantEventModel___block_invoke_153(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v10 = 2112;
    id v11 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch complete significant event notification model: %@", (uint8_t *)&v8, 0x16u);
  }
}
        ...
        v8))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)&buf[14] = 16;
      ...
      __int16 v34 = 2112;
      id v35 = v6;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Using existing cached hero frame URL for significant event with UUID %{public,uuid_t}.16P: %@", buf, 0x26u);
    }
    __int16 v26 = [MEMORY[0x263F58190] futureWithResult:v6];
  }
  else
  {
    id v15 = (void *)MEMORY[0x230FBD990]();
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      *(void *)&uint8_t buf[4] = v18;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Force fetching significant event model from cloud for hero frame url", buf, 0xCu);
    }
    __int16 v19 = [(HMDCameraClipManager *)v16 cloudZone];
    __int16 v20 = [v19 fetchCompleteModel:v4];

    uint64_t v21 = (void *)MEMORY[0x263F581B8];
...
id __67__HMDCameraClipManager__fetchHeroFrameURLForSignificantEventModel___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v19 = 2112;
      __int16 v20 = v5;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Successfully fetched hero frame URL: %@", (uint8_t *)&v17, 0x16u);
    }
    id v11 = [MEMORY[0x263F58190] futureWithResult:v5];
  }
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      __int16 v20 = v13;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Could not find hero frame file URL on fetched asset: %@", (uint8_t *)&v17, 0x16u);
    }
    id v14 = (void *)MEMORY[0x263F58190];
    id v15 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
    id v11 = [v14 futureWithError:v15];
...
- (id)_fetchCanonicalHeroFrameURLForClipModel:(id)a3
{
  ...
  id v9 = [v8 sortedArrayUsingComparator:&__block_literal_global_148_207868];
      ...
      for (uint64_t i = 0; i != v12; ++i)
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v46 = 2112;
          id v47 = v20;
          _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch significant event notification model: %@", buf, 0x16u);
  ...
  if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v46 = 2112;
    id v47 = v37;
    _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Could not find hero frame on any significant event for clip model: %@", buf, 0x16u);
  }
  long long v30 = (void *)MEMORY[0x263F58190];
  id v31 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
...
- (BOOL)_fetchClipsWithDateInterval:(id)a3 quality:(int64_t)a4 isAscending:(BOOL)a5 error:(id *)a6 handler:(id)a7
{
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v45 = 2112;
    id v46 = v12;
    _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Fetching clips with date interval: %@", buf, 0x16u);
  }
  if (v9) {
  ...
  v42[2] = v23;
  __int16 v24 = [NSDictionary dictionaryWithObjects:v42 forKeys:v41 count:3];
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v44 = v31;
    _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_DEBUG, "%{public}@Finished fetching clips", buf, 0xCu);
  }
...
void __86__HMDCameraClipManager__fetchClipsWithDateInterval_quality_isAscending_error_handler___block_invoke(uint64_t a1, void *a2, unsigned char *a3)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v16 = 2112;
      id v17 = v5;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch significant events for clip model %@", (uint8_t *)&v14, 0x16u);
    }
...
- (BOOL)_fetchSignificantEventsWithDateInterval:(id)a3 isAscending:(BOOL)a4 error:(id *)a5 handler:(id)a6
{
  ...
  id v33 = &unk_264A26A90;
  __int16 v34 = self;
  id v12 = v11;
  id v35 = v12;
  id v13 = _Block_copy(&v30);
  uint64_t v18 = (void *)MEMORY[0x230FBD990](v13, v14, v15, v16, v17);
  __int16 v19 = self;
  id v20 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v40 = 2112;
    id v41 = v10;
    _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Fetching significant events with date interval: %@", buf, 0x16u);
  }
...
{
  id v3 = [*(id *)(a1 + 32) _significantEventFromSignificantEventModel:a2];
  if (v3)
  {
    id v4 = v3;
    (*(void (**)(void))(*(void *)(a1 + 40) + 16))();
...
- (id)_faceClassificationsForSignificantEventWithUUID:(id)a3
{
  ...
  if (v6)
  {
    uint64_t v8 = objc_msgSend(v6, "na_map:", &__block_literal_global_132_207879);
  }
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)&buf[14] = 16;
      ...
      __int16 v20 = 2112;
      id v21 = v7;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch face classification models for significant event UUID %{public,uuid_t}.16P: %@", buf, 0x26u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)&buf[14] = 16;
      ...
      __int16 v20 = 2112;
      id v21 = v7;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch significant events for clip UUID %{public,uuid_t}.16P: %@", buf, 0x26u);
    }
...
- (id)_significantEventModelsWithUUIDs:(id)a3
{
  uint64_t v39 = *MEMORY[0x263EF8340];
  id v4 = a3;
  __int16 v26 = objc_msgSend(MEMORY[0x263EFF980], "arrayWithCapacity:", objc_msgSend(v4, "count"));
  long long v28 = 0u;
  long long v29 = 0u;
  long long v30 = 0u;
  long long v31 = 0u;
        ...
        else
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)&buf[14] = 16;
            ...
            __int16 v36 = 2112;
            id v37 = v14;
            _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch significant notification model with UUID %{public,uuid_t}.16P: %@", buf, 0x26u);
          }
          uint64_t v8 = v15;
          self = v17;
          uint64_t v7 = v24;
...
- (id)significantEventsForClipContainingDate:(id)a3
{
  ...
  if (v5)
  {
    ...
    *((void *)&buf + 1) = &buf;
    ...
    uint64_t v39 = __Block_byref_object_copy__207886;
    __int16 v40 = __Block_byref_object_dispose__207887;
    id v41 = 0;
      ...
      else
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)long long v31 = 138543874;
          ...
          __int16 v35 = 2112;
          id v36 = v4;
          _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@Clip: %@, does not contain date: %@", v31, 0x20u);
        }
    ...
    {
      __int16 v20 = (void *)MEMORY[0x230FBD990](v9);
      id v21 = self;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)long long v31 = 138543618;
        ...
        __int16 v33 = 2112;
        id v34 = v4;
        _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Did not find any clips before date: %@", v31, 0x16u);
      }
      __int16 v19 = [MEMORY[0x263EFFA08] set];
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(void *)((char *)&buf + 4) = v18;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch significant events clip containing date because zones are not ready", (uint8_t *)&buf, 0xCu);
    }
    __int16 v19 = [MEMORY[0x263EFFA08] set];
  }
...
- (id)remove
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v11 = 138543362;
    double v12 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Asked to remove clip manager zones", (uint8_t *)&v11, 0xCu);
  }
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(void *)&buf[8] = 0;
      if (v4) {
        ...
        *(_OWORD *)long long buf = *MEMORY[0x263F42690];
      }
      ...
      *(_DWORD *)&buf[14] = 16;
      ...
      __int16 v22 = 2112;
      id v23 = v8;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch significant notification model with UUID %{public,uuid_t}.16P: %@", buf, 0x26u);
    }
    uint64_t v14 = (void *)MEMORY[0x263F58190];
    uint64_t v15 = [MEMORY[0x263F087E8] hmfErrorWithCode:2];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)&buf[14] = 16;
      ...
      __int16 v21 = 2112;
      id v22 = v8;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch significant notification model with UUID %{public,uuid_t}.16P: %@", buf, 0x26u);
    }
    id v10 = 0;
  }
...
- (void)configure
{
  ...
  if (v5)
  {
    ...
    id v7 = +[HMDXPCMessagePolicy policyWithEntitlements:133];
    uint64_t v8 = +[HMDUserMessagePolicy userMessagePolicyWithHome:v5 userPrivilege:0 remoteAccessRequired:0];
    uint64_t v9 = +[HMDUserMessagePolicy userMessagePolicyWithHome:v5 userPrivilege:4 remoteAccessRequired:0];
    +[HMDUserMessagePolicy userMessagePolicyWithHome:v5 userPrivilege:3 remoteAccessRequired:0];
    __int16 v45 = v44 = (void *)v8;
    v51[0] = v7;
    v51[1] = v8;
    id v10 = [MEMORY[0x263EFF8C0] arrayWithObjects:v51 count:2];
    [v6 registerForMessage:*MEMORY[0x263F0BB98] receiver:self policies:v10 selector:sel_handleFetchVideoSegmentsAssetContextMessage_];
    [v6 registerForMessage:*MEMORY[0x263F0BC60] receiver:self policies:v10 selector:sel_handleSubscribeMessage_];
    [v6 registerForMessage:*MEMORY[0x263F0BC68] receiver:self policies:v10 selector:sel_handleUnsubscribeMessage_];
    [v6 registerForMessage:*MEMORY[0x263F0BC50] receiver:self policies:v10 selector:sel_handlePerformCloudPullMessage_];
    [v6 registerForMessage:*MEMORY[0x263F0BB50] receiver:self policies:v10 selector:sel_handleFetchClipMessage_];
    [v6 registerForMessage:*MEMORY[0x263F0BB58] receiver:self policies:v10 selector:sel_handleFetchClipsMessage_];
    [v6 registerForMessage:*MEMORY[0x263F0BB48] receiver:self policies:v10 selector:sel_handleFetchClipForSignificantEventMessage_];
    [v6 registerForMessage:*MEMORY[0x263F0BB60] receiver:self policies:v10 selector:sel_handleFetchCountOfClipsMessage_];
    [v6 registerForMessage:*MEMORY[0x263F0BB78] receiver:self policies:v10 selector:sel_handleFetchHeroFrameDataRepresentationMessage_];
    [v6 registerForMessage:*MEMORY[0x263F0BB80] receiver:self policies:v10 selector:sel_handleFetchHeroFrameURLMessage_];
    [v6 registerForMessage:*MEMORY[0x263F0BB68] receiver:self policies:v10 selector:sel_handleFetchFaceCropDataRepresentationMessage_];
    [v6 registerForMessage:*MEMORY[0x263F0BB70] receiver:self policies:v10 selector:sel_handleFetchFaceCropURLMessage_];
    [v6 registerForMessage:*MEMORY[0x263F0BB90] receiver:self policies:v10 selector:sel_handleFetchSignificantEventsMessage_];
    int v11 = +[HMDConfigurationMessagePolicy policyWithOperationTypes:4];
    v50[0] = v7;
    v50[1] = v9;
    v50[2] = v11;
    double v12 = [MEMORY[0x263EFF8C0] arrayWithObjects:v50 count:3];
    [v6 registerForMessage:*MEMORY[0x263F0BB30] receiver:self policies:v12 selector:sel_handleDeleteClipMessage_];
    [v6 registerForMessage:*MEMORY[0x263F0BB28] receiver:self policies:v12 selector:sel_handleDeleteAllClipsMessage_];
    [v6 registerForMessage:*MEMORY[0x263F0BBA0] receiver:self policies:v12 selector:sel_handleHandleFaceMisclassificationMessage_];
    uint64_t v42 = +[HMDRemoteMessagePolicy defaultSecurePolicy];
    long long v43 = (void *)v9;
    v49[0] = v9;
    v49[1] = v11;
    v49[2] = v42;
    id v41 = [MEMORY[0x263EFF8C0] arrayWithObjects:v49 count:3];
    ...
    if (isInternalBuild())
    {
      ...
      uint64_t v14 = *MEMORY[0x263F0BBA8];
      v48[0] = v7;
      v48[1] = v45;
      v48[2] = v13;
      uint64_t v15 = [MEMORY[0x263EFF8C0] arrayWithObjects:v48 count:3];
      [v6 registerForMessage:v14 receiver:self policies:v15 selector:sel_handleImportClipsMessage_];

      uint64_t v16 = *MEMORY[0x263F0BB88];
      v47[0] = v7;
      v47[1] = v45;
      long long v17 = [MEMORY[0x263EFF8C0] arrayWithObjects:v47 count:2];
      [v6 registerForMessage:v16 receiver:self policies:v17 selector:sel_handleFetchIsCloudStorageEnabledMessage_];

      uint64_t v18 = *MEMORY[0x263F0BC70];
      v46[0] = v7;
      v46[1] = v45;
      __int16 v19 = [MEMORY[0x263EFF8C0] arrayWithObjects:v46 count:2];
    ...
    uint64_t v25 = [v24 defaultConfiguration];
    __int16 v26 = (void *)[(id)v25 mutableCopy];

    objc_msgSend(v26, "setZoneOwner:", objc_msgSend(v5, "isOwnerUser"));
    id v27 = [(HMDCameraClipManager *)self featuresDataSource];
    LOBYTE(v25) = [v27 isPersistentBulletinRegistrationsFeatureEnabled];

    if ((v25 & 1) == 0)
    {
      long long v28 = (void *)MEMORY[0x263EFFA08];
      long long v29 = +[HMDCameraSignificantEventNotificationModel hmbExternalRecordType];
    ...
    __int16 v35 = [(HMDCameraClipManager *)self zoneManager];
    [v35 start];

    id v36 = [(HMDCameraClipManager *)self clientConnectionsTimer];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      uint64_t v53 = v40;
      _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_ERROR, "%{public}@Skipping camera clip manager configure because home reference is nil", buf, 0xCu);
    }
  }
}
...
{
  v8[1] = *MEMORY[0x263EF8340];
  id v7 = @"Subscribed Clients";
  id v2 = [(HMDCameraClipManager *)self clientConnectionsTimer];
  id v3 = [v2 clientConnections];
  id v4 = objc_msgSend(v3, "na_map:", &__block_literal_global_207924);
  v8[0] = v4;
...
- (void)setHasWriteAccess:(BOOL)a3
{
  ...
  if (self->_hasWriteAccess != v3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v17 = 2112;
      uint64_t v18 = v11;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Updating has write access from %@ to %@", (uint8_t *)&v13, 0x20u);
    }
    self->_hasWriteAccess = v3;
    if (v3)
    {
      double v12 = [(HMDCameraClipManager *)v7 zoneManager];
...
- (id)significantEventsWithDateInterval:(id)a3
{
  char v4 = (void *)MEMORY[0x263EFF980];
  id v5 = a3;
  id v6 = [v4 array];
...
LABEL_19:
  ...
  uint64_t v24 = v17;
  uint64_t v25 = [(HMDCameraClipManager *)&v60 init];
  __int16 v26 = v25;
  id v27 = v21;
  if (v25)
  {
    ...
    uint64_t v33 = [MEMORY[0x263EFF910] distantPast];
...
{
  BOOL v3 = (objc_class *)MEMORY[0x263F0E1E0];
  id v4 = a2;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t149 != -1) {
    dispatch_once(&logCategory__hmf_once_t149, &__block_literal_global_222_207983);
  }
...
void __35__HMDCameraClipManager_logCategory__block_invoke()
{
  ...
  id v1 = (void *)logCategory__hmf_once_v150;
