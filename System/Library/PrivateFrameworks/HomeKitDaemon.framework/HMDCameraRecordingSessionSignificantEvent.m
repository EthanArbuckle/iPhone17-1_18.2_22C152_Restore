...
- (HMDCameraRecordingSessionSignificantEvent)initWithUUID:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (v6)
    {
      uint64_t v7 = objc_msgSend(MEMORY[0x263F425D0], "hmf_cachedInstanceForNSUUID:", v5);
      UUID = v6->_UUID;
      v6->_UUID = (NSUUID *)v7;
  ...
  else
  {
    ...
    return (HMDCameraRecordingSessionSignificantEvent *)+[_MKFBulletinRegistration fetchRequest];
  }
}
