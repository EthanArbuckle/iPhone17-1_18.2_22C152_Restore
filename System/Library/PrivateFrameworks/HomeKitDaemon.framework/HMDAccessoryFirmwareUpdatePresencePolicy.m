...
LABEL_11:
          _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, v12, (uint8_t *)&v32, 0x16u);
...
LABEL_20:
    ...
    if (v15 != 1)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v36 = 2112;
        v37 = v29;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Bad configuration -- (presenceNeeded, non-resident, missing presenceFeeder %@ or presenceRegionStatus %@", (uint8_t *)&v32, 0x20u);
...
LABEL_19:
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, v17, (uint8_t *)&v32, 0xCu);
    goto LABEL_20;
  }
...
LABEL_33:
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, v21, (uint8_t *)&v32, 0xCu);
      goto LABEL_34;
    }
LABEL_35:
    char v6 = 0;
...
uint64_t __65__HMDAccessoryFirmwareUpdatePresencePolicy_handlePresenceChange___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2112;
    v11 = v6;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Handling %@ -- presence has changed, updating policy status", (uint8_t *)&v8, 0x16u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_154572 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_154572, &__block_literal_global_154573);
  }
  v2 = (void *)logCategory__hmf_once_v1_154574;
  return v2;
}
...
void __55__HMDAccessoryFirmwareUpdatePresencePolicy_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_154574;
  logCategory__hmf_once_v1_154574 = v0;
}
