      ...
      if (v7)
      {
        ...
        if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v14 = v11;
          _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to unregister for ProxSetup notifications", buf, 0xCu);
        }
      }
      else
      {
...
- (HMDDeviceSetupManager)initWithNotificationCenter:(id)a3 followUpManager:(id)a4 darwinNotificationProvider:(id)a5
{
  ...
  if (v12)
  {
    ...
    if (*p_proxSetupNotificationToken == -1)
    {
      ...
      int v20 = [v17 notifyRegisterDispatch:v18 outToken:&v13->_proxSetupNotificationToken queue:MEMORY[0x263EF83A0] handler:v27];
      ...
      if (v20)
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v31 = v24;
          _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to register for ProxSetup notifications", buf, 0xCu);
        }
...
+ (id)sharedManager
{
  if (sharedManager_onceToken_223433 != -1) {
    dispatch_once(&sharedManager_onceToken_223433, &__block_literal_global_223434);
  }
  v2 = (void *)sharedManager_sharedManager_223435;
  return v2;
}
...
void __38__HMDDeviceSetupManager_sharedManager__block_invoke()
{
  ...
  id v2 = objc_alloc_init(MEMORY[0x263F0E2C0]);
  uint64_t v3 = [(HMDDeviceSetupManager *)v0 initWithNotificationCenter:v1 followUpManager:v5 darwinNotificationProvider:v2];
  v4 = (void *)sharedManager_sharedManager_223435;
  sharedManager_sharedManager_223435 = v3;
}
