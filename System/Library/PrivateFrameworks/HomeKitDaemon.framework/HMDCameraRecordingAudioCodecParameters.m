...
- (HMDCameraRecordingAudioCodecParameters)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v9 = [MEMORY[0x263EFF8C0] arrayWithObjects:v23 count:2];
...
- (BOOL)_parseFromTLVData
{
  ...
  v3 = [MEMORY[0x263F35A58] wrappertlv:1 name:@"kAudioCodecParametersChannels"];
  id v4 = [MEMORY[0x263F358B8] wrappertlv:2 name:@"kAudioCodecParametersBitRateModes" objectCreator:&__block_literal_global_264237];
  v5 = [MEMORY[0x263F358B8] wrappertlv:3 name:@"kAudioCodecParametersSampleRates" objectCreator:&__block_literal_global_118_264238];
  id v6 = [MEMORY[0x263F35A58] wrappertlv:4 name:@"kAudioCodecParametersMaxAudioBitrate"];
  v20[0] = v3;
  v20[1] = v4;
  v20[2] = v5;
