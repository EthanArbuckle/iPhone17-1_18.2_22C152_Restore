...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_92818 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_92818, &__block_literal_global_92819);
  }
  v2 = (void *)logCategory__hmf_once_v2_92820;
  return v2;
}
...
void __56__HMDRemoteLoginReceiverProxyAuthentication_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_92820;
  logCategory__hmf_once_v2_92820 = v0;
}
