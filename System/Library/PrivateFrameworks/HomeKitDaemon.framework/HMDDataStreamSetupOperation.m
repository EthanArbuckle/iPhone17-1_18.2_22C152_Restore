...
- (void)continueStreamSetupWithResponse:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v62 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEBUG, "%{public}@[Start Stream] Parsing accessory response", buf, 0xCu);
  }
  v55 = v6;
    ...
    if (v20)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v63 = 2112;
        id v64 = v25;
        _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@[Start Stream] The setup transfer write reply errored out: %@", buf, 0x16u);
      }
      v26 = [v19 error];
    ...
    if (v34 || !v33)
    {
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v63 = 2112;
        id v64 = v34;
        _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_ERROR, "%{public}@[Start Stream] The setup transfer write reply could not be parsed (error=%@)", buf, 0x16u);
      }
      v43 = [MEMORY[0x263F087E8] hmErrorWithCode:50];
...
LABEL_43:
        ...
        id v34 = [MEMORY[0x263F087E8] hmErrorWithCode:50];
LABEL_44:
...
LABEL_42:
      _os_log_impl(&dword_22F52A000, v46, OS_LOG_TYPE_ERROR, v48, buf, 0xCu);
...
LABEL_46:
    ...
    id v34 = [MEMORY[0x263F087E8] hmErrorWithCode:v38];
    ...
    if (v34)
    {
      ...
      if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v63 = 2112;
        id v64 = v53;
        _os_log_impl(&dword_22F52A000, v50, OS_LOG_TYPE_ERROR, "%{public}@[Start Stream] The setup transfer write failed with status %@", buf, 0x16u);
      }
      goto LABEL_44;
    }
    goto LABEL_38;
...
LABEL_17:
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v62 = v30;
    _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@[Start Stream] The setup transfer write reply does not contain a response", buf, 0xCu);
  }
  id v19 = [MEMORY[0x263F087E8] hmErrorWithCode:50];
