...
- (id)biomeEventsRepresentationForLogObserver:(id)a3
{
  ...
  v5 = objc_msgSend(v4, "na_firstObjectPassingTest:", &__block_literal_global_1239);
  v6 = [v5 home];
  ...
  if (v6)
  {
    if (v90)
    {
      v7 = (objc_class *)MEMORY[0x263F08798];
      id v8 = v6;
      id v9 = [v7 alloc];
        ...
        for (uint64_t i = 0; i != v89; ++i)
        {
          ...
          if (v37)
          {
            ...
            if (v39)
            {
              ...
              v43 = [MEMORY[0x263EFF9A0] dictionaryWithCapacity:2];
              ...
              if ([v43 count])
              {
                id v77 = objc_alloc(MEMORY[0x263F2A7C8]);
                ...
                v56 = (void *)v84;
                v55 = (void *)v85;
                v57 = (void *)[v77 initWithBase:v74 accessoryUniqueIdentifier:v76 accessoryStateString:MEMORY[0x263EFFA78] accessoryStateNumber:v49 accessoryStateData:MEMORY[0x263EFFA78] accessoryMediaRouteIdentifier:v50 zoneUniqueIdentifiers:v85 roomUniqueIdentifier:v51 accessoryName:v52 roomName:v53 zoneNames:v84 homeName:v54];
                [v73 addObject:v57];
              ...
              else
              {
                ...
                if (os_log_type_enabled(v69, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v99 = 2112;
                  v100 = v36;
                  _os_log_impl(&dword_22F52A000, v69, OS_LOG_TYPE_ERROR, "%{public}@Unable to log event metadata to biome, no media state for media accessory: %@", buf, 0x16u);
                }
                uint64_t v34 = v75;
                v55 = (void *)v85;
                v58 = v42;
            ...
            else
            {
              ...
              if (os_log_type_enabled(v65, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                __int16 v99 = 2112;
                v100 = v36;
                _os_log_impl(&dword_22F52A000, v65, OS_LOG_TYPE_ERROR, "%{public}@Unable to log event metadata to biome, no media profile for media accessory: %@", buf, 0x16u);
              }
            }
          }
          else
          {
            ...
            if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v99 = 2112;
              v100 = v36;
              _os_log_impl(&dword_22F52A000, v61, OS_LOG_TYPE_ERROR, "%{public}@Unable to log media event metadata to biome, no room for accessory: %@", buf, 0x16u);
            }
          }
        }
        uint64_t v89 = [obj countByEnumeratingWithState:&v93 objects:v101 count:16];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v98 = v24;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Unable to log media event metadata to biome, no home", buf, 0xCu);
    }
...
- (id)microLocationMetadataForLogEventObserver:(id)a3
{
  ...
  v18 = [v17 UUIDString];
  unint64_t v19 = [v12 metadataForHomekitAccessoryControlEventWithUUID:v14 stateString:v8 serviceUUID:v9 serviceType:v9 characteristicType:v9 serviceGroupUUID:&stru_26E2EB898 source:v15 roomUUID:v18];
...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  {
    [v3 setObject:&unk_26E472148 forKeyedSubscript:@"volume"];
  }
...
- (HMDMediaPlaybackActionEvent)initWithIsPlaybackArchivePresent:(BOOL)a3 playbackStateNumber:(id)a4 volumeNumber:(id)a5 sourceNumber:(id)a6 sourceClientName:(id)a7 accessories:(id)a8
{
  ...
  if (v19)
  {
    [MEMORY[0x263F424F0] currentActivity];
    v20 = id v31 = v15;
    ...
    v29 = objc_msgSend(v28, "na_filter:", &__block_literal_global_145270);
