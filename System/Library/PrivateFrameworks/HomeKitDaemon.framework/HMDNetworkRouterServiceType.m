...
LABEL_9:
    v12 = objc_msgSend(MEMORY[0x263EFF8F8], "dataWithBytes:length:", v15);
    id v8 = 0;
    goto LABEL_12;
  }
...
LABEL_20:
    ...
    if (!v25)
    {
      uint64_t v18 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F41FD8] code:3 userInfo:0];
...
LABEL_19:
    ...
    if (v26 == 1)
    {
      v13 = objc_msgSend(MEMORY[0x263EFF8F8], "dataWithBytesNoCopy:length:freeWhenDone:");
      id v21 = v11;
