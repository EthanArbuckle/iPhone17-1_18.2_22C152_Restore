...
- (id)attributeDescriptions
{
  ...
  v19 = [(HMDAccessoryMetricVendorDetails *)self manufacturer];
  v4 = (void *)[v3 initWithName:@"manufacturer" value:v19];
  v20[0] = v4;
  ...
  v16 = (void *)[v14 initWithName:@"differentiationNumber" value:v15];
  v20[4] = v16;
...
- (HMDAccessoryMetricVendorDetails)initWithAccessory:(id)a3
{
  ...
  if ([v6 communicationProtocol] == 2)
  {
    ...
    if (v9)
    {
      ...
      id v11 = [v10 vendorMetadataStore];
      v12 = [v6 matterVendorID];
      v13 = [v6 matterProductID];
      id v14 = [v11 retrieveVendorMetadataForVendorID:v12 productID:v13];

      id v15 = [v6 matterProductID];
      id v16 = [v14 productWithID:v15];
