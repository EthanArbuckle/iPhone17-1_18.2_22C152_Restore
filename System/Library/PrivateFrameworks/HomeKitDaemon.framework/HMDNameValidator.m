  ...
  if (![v12 count])
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v28 = 2112;
      id v29 = v11;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Empty set of namespace UUIDs in operation to replace %@ with %@", buf, 0x20u);
    }
...
LABEL_11:
  ...
  {
    v19 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2300];
    uint64_t v22 = *MEMORY[0x263F08608];
    v23 = v19;
    v20 = [NSDictionary dictionaryWithObjects:&v23 forKeys:&v22 count:1];
    v14 = [MEMORY[0x263F087E8] hmErrorWithCode:95 userInfo:v20];
  }
  else
  {
...
- (id)removeName:(id)a3 namespace:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v17 = 2112;
      id v18 = v6;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Namespace UUID is nil in operation to remove %@", (uint8_t *)&v15, 0x16u);
    }
    uint64_t v13 = [MEMORY[0x263F087E8] hmErrorWithCode:20];
  }
  v9 = (void *)v13;
  ...
  if (!v9)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v23 = 2112;
      id v24 = v8;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Namespace UUID is nil in operation to add %@", buf, 0x16u);
    }
...
LABEL_10:
  ...
  {
    v16 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2300];
    uint64_t v19 = *MEMORY[0x263F08608];
    v20 = v16;
    __int16 v17 = [NSDictionary dictionaryWithObjects:&v20 forKeys:&v19 count:1];
    id v11 = [MEMORY[0x263F087E8] hmErrorWithCode:95 userInfo:v17];
  }
  else
  {
...
- (id)removeNamespace:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v11 = 138543362;
      id v12 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Namespace UUID is nil in operation to remove namespace", (uint8_t *)&v11, 0xCu);
    }
    id v6 = [MEMORY[0x263F087E8] hmErrorWithCode:20];
  }
...
- (id)addNamespace:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v11 = 138543362;
      id v12 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Namespace UUID is nil in operation to add namespace", (uint8_t *)&v11, 0xCu);
    }
    id v6 = [MEMORY[0x263F087E8] hmErrorWithCode:20];
  }
  ...
  if ([v7 isEqual:v8])
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v85 = 2112;
      id v86 = v9;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Attempting to replace %@ with same entry in namespaces %@ - skipping...", buf, 0x20u);
    }
    uint64_t v13 = 0;
  }
  else
          ...
          if (v20)
          {
            ...
            if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              __int16 v87 = 2112;
              v88 = v20;
              _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to remove existing name %@ from namespace %@ error %@", buf, 0x2Au);
            }
          }
          else
          {
            ...
            if (v31)
            {
              ...
              if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138544130;
                ...
                __int16 v87 = 2112;
                v88 = v55;
                _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_ERROR, "%{public}@Failed to add new name %@ from namespace %@  error %@", buf, 0x2Au);
              }
                    ...
                    if (v41)
                    {
                      ...
                      if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
                      {
                        ...
                        *(_DWORD *)buf = 138544130;
                        ...
                        __int16 v87 = 2112;
                        v88 = v41;
                        _os_log_impl(&dword_22F52A000, v43, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove new name %@ to namespace %@ error %@", buf, 0x2Au);
                    ...
                    if (v50)
                    {
                      ...
                      if (os_log_type_enabled(v52, OS_LOG_TYPE_ERROR))
                      {
                        ...
                        *(_DWORD *)buf = 138544130;
                        ...
                        __int16 v87 = 2112;
                        v88 = v50;
                        _os_log_impl(&dword_22F52A000, v52, OS_LOG_TYPE_ERROR, "%{public}@Failed to add existing name %@ to namespace %@ error %@", buf, 0x2Au);
                      }
                    }
                  }
...
- (id)_removeName:(id)a3 namespace:(id)a4
{
  ...
  if (v9)
  {
    ...
    {
      int v11 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F0C710] code:2 userInfo:0];
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v20 = 2112;
      id v21 = v6;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to look up namespace %@ to remove name %@", (uint8_t *)&v16, 0x20u);
    }
    int v11 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F0C710] code:2 userInfo:0];
  }
  ...
  if (!v8)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v23 = 2112;
        id v24 = v6;
        _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to look up namespace %@ to remove name %@", (uint8_t *)&v19, 0x20u);
      }
      id v12 = (void *)MEMORY[0x263F087E8];
      uint64_t v13 = *MEMORY[0x263F0C710];
      uint64_t v14 = 2;
...
- (id)_checkForConflict:(id)a3 namespace:(id)a4
{
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v7;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to look up namespace %@", (uint8_t *)&v17, 0x16u);
    }
    uint64_t v11 = 2;
    goto LABEL_7;
  }
  if ([v10 containsObject:v8])
  {
    uint64_t v11 = 31;
LABEL_7:
    uint64_t v15 = [MEMORY[0x263F087E8] hmErrorWithCode:v11];
    goto LABEL_9;
  }
  uint64_t v15 = 0;
LABEL_9:
...
- (id)trimNotAllowedCharactersFromName:(id)a3 error:(id *)a4
{
  ...
  if (v6)
  {
    id v8 = [MEMORY[0x263F089C0] alphanumericCharacterSet];
    id v9 = [MEMORY[0x263F08708] whitespaceCharacterSet];
    ...
    id v12 = [v11 componentsJoinedByString:&stru_26E2EB898];
  }
  else
  {
    uint64_t v13 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v18 = 2112;
      id v19 = v5;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Name %@ is empty", (uint8_t *)&v16, 0x16u);
    }
    if (a4)
    {
...
- (id)_validateName:(id)a3
{
  ...
  if (v4)
  {
    uint64_t v6 = [MEMORY[0x263F089C0] alphanumericCharacterSet];
    if ([v3 rangeOfCharacterFromSet:v6 options:129])
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v26 = 2112;
        id v27 = v3;
        _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Name %@ does not start with allowed characters", (uint8_t *)&v24, 0x16u);
      }
      uint64_t v10 = 36;
LABEL_15:

      id v19 = [MEMORY[0x263F087E8] hmErrorWithCode:v10];
    ...
    if (v14 != [v3 length] - 1)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v26 = 2112;
        id v27 = v3;
        _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Name %@ does not end with allowed characters", (uint8_t *)&v24, 0x16u);
      }
      uint64_t v10 = 60;
      goto LABEL_15;
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v26 = 2112;
        id v27 = v3;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Name %@ contains disallowed characters", (uint8_t *)&v24, 0x16u);
      }
      int v17 = [MEMORY[0x263F087E8] hmErrorWithCode:35];
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v26 = 2112;
      id v27 = v3;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Name %@ is empty", (uint8_t *)&v24, 0x16u);
    }
...
- (HMDNameValidator)initWithUUID:(id)a3
{
  ...
  if (v6)
  {
    ...
    uint64_t v9 = [MEMORY[0x263F08A98] predicateWithFormat:@"length != 0"];
