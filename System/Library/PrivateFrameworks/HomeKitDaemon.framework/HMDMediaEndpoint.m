...
void __56__HMDMediaEndpoint__setPlaybackState_completionHandler___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v31 = 2112;
      id v32 = v3;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Attempt to connect to the endpoint to set the playback state failed with error %@", buf, 0x16u);
    }
  ...
  else
  {
    ...
    unsigned int v11 = (void *)MEMORY[0x230FBD990]();
    id v12 = v5;
    ...
    if (v10)
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v30 = v15;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Attempting to locally set the playback state command with mediaRemote", buf, 0xCu);
      }
      v16 = [v12 workQueue];
      id v28 = *(id *)(a1 + 32);
      ...
      if (!v17)
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v31 = 2112;
          id v32 = v18;
          _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Sending the command to mediaremote failed for media endpoint %@", buf, 0x16u);
        }
        if (v18) {
          CFRelease(v18);
        }
        v23 = [MEMORY[0x263F087E8] hmErrorWithCode:2005];
        v24 = [MEMORY[0x263F087E8] hmErrorWithCode:74 description:@"Media remote command send failure " reason:@"Media remote command send failure" suggestion:0 underlyingError:v23];
        (*(void (**)(void))(*(void *)(a1 + 32) + 16))();
      }
    }
    else
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v30 = v25;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot look up origin for mediaSession to set playback state after connection", buf, 0xCu);
      }
      if (*(void *)(a1 + 32))
      {
        v26 = [MEMORY[0x263F087E8] hmErrorWithCode:2005];
        v27 = [MEMORY[0x263F087E8] hmErrorWithCode:4 description:@"Cannot lookup origin" reason:@"Cannot lookup origin" suggestion:0 underlyingError:v26];
        (*(void (**)(void))(*(void *)(a1 + 32) + 16))();
      }
    }
  }
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v24 = 2112;
      id v25 = v3;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Attempt to connect to the endpoint to get the playback state failed with error %@", buf, 0x16u);
    }
    (*(void (**)(void))(*(void *)(a1 + 32) + 16))();
  }
  else
  {
    ...
    if (v10)
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v23 = v15;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Endpoint Attempting to locally read the playback state from media remote", buf, 0xCu);
      }
      v16 = [v12 workQueue];
    ...
    else
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v23 = v17;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot look up origin for mediaSession to get playback state after connection", buf, 0xCu);
      }
      if (*(void *)(a1 + 32))
      {
        v18 = [MEMORY[0x263F087E8] hmErrorWithCode:2005];
        v19 = [MEMORY[0x263F087E8] hmErrorWithCode:4 description:@"Cannot lookup origin" reason:@"Cannot lookup origin" suggestion:0 underlyingError:v18];
        (*(void (**)(void))(*(void *)(a1 + 32) + 16))();
      }
    }
  }
...
void __59__HMDMediaEndpoint__getPlaybackStateWithCompletionHandler___block_invoke_24(uint64_t a1, uint64_t a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    if (a2 > 5) {
      ...
      uint64_t v8 = qword_2303E49F0[a2];
    }
    id v9 = HMFGetLogIdentifier();
    int v11 = 138543618;
    id v12 = v9;
    __int16 v13 = 2048;
    uint64_t v14 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Locally read the playback state as: %tu", (uint8_t *)&v11, 0x16u);
  }
...
- (void)registerForNowPlayingUpdates:(BOOL)a3
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v16 = 2112;
      int v17 = v12;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@%@ for playback state changes", (uint8_t *)&v14, 0x16u);
    }
    CFRetain(v5);
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot look up external device for endpoint to register for playback state updates", (uint8_t *)&v14, 0xCu);
    }
  }
}
...
- (void)_connectWithCompletionHandler:(id)a3
{
  ...
  if (v7)
  {
    ...
    {
      long long v12 = (void *)MEMORY[0x230FBD990](v10);
      long long v13 = self;
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v25 = v15;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Already in the process of connecting to the external device...", buf, 0xCu);
      }
      CFRelease(v8);
    }
    ...
    {
      __int16 v16 = (void *)MEMORY[0x230FBD990](v10);
      int v17 = self;
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v25 = v19;
        _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@No connection to external device - setting up connection state callback and attempting to connect...", buf, 0xCu);
      }
  ...
  {
    long long v11 = [MEMORY[0x263F087E8] hmErrorWithCode:54];
    ...
    if (a2 != 1 && v8 != a2)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)&v26[6] = v8;
        ...
        __int16 v29 = 2112;
        v30 = a3;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Connection state changed to %u (from %u) for endpoint %@ with error %@", (uint8_t *)&v23, 0x2Cu);
      }
      if (v9) {
        CFRelease(v9);
      }
      ...
      if (a2 == 3 && v8 == 2)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          *(void *)uint64_t v26 = v19;
          _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Attempting to refresh the session for the accessories on endpoint (%@) disconnect", (uint8_t *)&v23, 0x16u);
        }
        id v20 = [v16 browser];
        ...
        if (!v14)
        {
          id v14 = [MEMORY[0x263F087E8] hmErrorWithCode:4];
        }
      }
  ...
  if (result)
  {
    ...
    if (!result)
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
      {
        ...
        int v8 = 138543362;
        uint64_t v9 = v7;
        _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Cannot look up origin from external device", (uint8_t *)&v8, 0xCu);
      }
      return 0;
    }
  }
...
- (void)externalDevice
{
  ...
  if (v3)
  {
    ...
    if (!ExternalDevice)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v17 = 2112;
        uint64_t v18 = v4;
        _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Cannot look up the external device for endpoint %@", (uint8_t *)&v15, 0x16u);
      }
    }
    CFRelease(v4);
  }
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      int v15 = 138543362;
      id v16 = v13;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@No endpoint to look up origin", (uint8_t *)&v15, 0xCu);
    }
    return 0;
  }
...
- (void)_updateOutputDeviceIdentifiers
{
  ...
  if (v3)
  {
    ...
    if (v5)
    {
      ...
      BOOL v8 = [MEMORY[0x263EFF9C0] setWithCapacity:Count];
      if (Count >= 1)
      {
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t28_123268 != -1) {
    dispatch_once(&logCategory__hmf_once_t28_123268, &__block_literal_global_123269);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v29_123270;
  return v2;
}
...
void __31__HMDMediaEndpoint_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v29_123270;
  logCategory__hmf_once_v29_123270 = v0;
}
