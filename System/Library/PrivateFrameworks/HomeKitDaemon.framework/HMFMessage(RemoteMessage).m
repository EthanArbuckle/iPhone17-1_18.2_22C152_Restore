...
{
  v1 = [a1 userInfo];
  v2 = [v1 objectForKey:@"HMD.remoteDisallowsIDSRacing"];
...
{
  v1 = [a1 userInfo];
  v2 = objc_msgSend(v1, "hmf_numberForKey:", @"HMD.remoteTransportResponseRestriction");
...
{
  v1 = [a1 userInfo];
  v2 = objc_msgSend(v1, "hmf_numberForKey:", @"HMD.remoteTransportRestriction");
...
{
  v1 = [a1 userInfo];
  v2 = objc_msgSend(v1, "hmf_stringForKey:", @"kRemoteMessageIDSToIDKey");
