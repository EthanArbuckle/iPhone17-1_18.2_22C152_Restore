...
- (void)_sendImageSendFailure:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v26 = 2112;
    v27 = v6;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Sending image send failure to %@", buf, 0x16u);
  }
  ...
  if (v4)
  {
    v17 = [MEMORY[0x263F08910] archivedDataWithRootObject:v4 requiringSecureCoding:1 error:0];
    [v14 setObject:v17 forKeyedSubscript:@"kCameraSessionError"];
  }
  v18 = [MEMORY[0x263F42590] internalMessageWithName:@"kTakeSnapshotSendFailedNotificationKey" messagePayload:v14];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_83154 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_83154, &__block_literal_global_83155);
  }
  v2 = (void *)logCategory__hmf_once_v1_83156;
  return v2;
}
...
void __38__HMDCameraSnapshotSender_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_83156;
  logCategory__hmf_once_v1_83156 = v0;
}
