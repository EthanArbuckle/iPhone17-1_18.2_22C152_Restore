...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v17 encodeObject:v4 forKey:*MEMORY[0x263F0DA48]];

  v5 = [(HMDSoftwareUpdate *)self version];
  [v17 encodeObject:v5 forKey:*MEMORY[0x263F0DAD8]];

  v6 = [(HMDSoftwareUpdate *)self displayableVersion];
  [v17 encodeObject:v6 forKey:*MEMORY[0x263F0DA10]];

  int64_t v7 = [(HMDSoftwareUpdate *)self state];
  [v17 encodeInteger:v7 forKey:*MEMORY[0x263F0DAB0]];
  unint64_t v8 = [(HMDSoftwareUpdate *)self downloadSize];
  [v17 encodeInt64:v8 forKey:*MEMORY[0x263F0DA40]];
  [(HMDSoftwareUpdate *)self installDuration];
  [v17 encodeInteger:(uint64_t)v9 forKey:*MEMORY[0x263F0DA50]];
  v10 = [(HMDSoftwareUpdate *)self documentationMetadata];
  [v17 encodeObject:v10 forKey:*MEMORY[0x263F0DA28]];

  v11 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", -[HMDSoftwareUpdate updateType](self, "updateType"));
  [v17 encodeObject:v11 forKey:*MEMORY[0x263F0DAD0]];

  v12 = [(HMDSoftwareUpdate *)self releaseDate];
  [v17 encodeObject:v12 forKey:*MEMORY[0x263F0DA98]];
  ...
  if (objc_msgSend(v17, "hmd_isForXPCTransportEntitledForSPIAccess"))
  {
    ...
    [v17 encodeObject:v16 forKey:*MEMORY[0x263F0DA18]];
  }
}
...
{
  id v4 = a3;
  v5 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0DAD8]];
  v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0DA10]];
  if (!v6)
  {
    v6 = [v5 shortVersionString];
  }
  uint64_t v7 = [v4 decodeInt64ForKey:*MEMORY[0x263F0DA40]];
  uint64_t v8 = [v4 decodeIntegerForKey:*MEMORY[0x263F0DAB0]];
  double v9 = (double)[v4 decodeIntegerForKey:*MEMORY[0x263F0DA50]];
  v10 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0DA28]];
  v11 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0DA98]];
  ...
  if (v12)
  {
    uint64_t v13 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0DA48]];
...
- (void)transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
      ...
      if (v19 != [(HMDSoftwareUpdate *)v14 state])
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          *(void *)&buf[4] = v23;
          __int16 v82 = 2112;
          v83 = v24;
          _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Updating state: %@", buf, 0x16u);
        }
        [(HMDSoftwareUpdate *)v21 setState:v19];
        v25 = (void *)MEMORY[0x263F42590];
        uint64_t v26 = *MEMORY[0x263F0DAC8];
        v27 = v21;
        v28 = [v16 identifier];
        v86[0] = *MEMORY[0x263F0DAB8];
        v29 = objc_msgSend(NSNumber, "numberWithInteger:", -[HMDSoftwareUpdate state](v27, "state"));
        *(void *)buf = v29;
        v30 = [NSDictionary dictionaryWithObjects:buf forKeys:v86 count:1];
      ...
      if ((v37 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
        {
          ...
          *(void *)&buf[4] = v44;
          __int16 v82 = 2112;
          v83 = v35;
          _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_INFO, "%{public}@Updating documentation metadata: %@", buf, 0x16u);
        ...
        id v45 = v35;
        v46 = (void *)MEMORY[0x263F42590];
        uint64_t v68 = *MEMORY[0x263F0DAC0];
        v47 = v41;
        v48 = [v16 identifier];
        v86[0] = *MEMORY[0x263F0DA30];
        v70 = v45;
        id v72 = v10;
        if (v45) {
        ...
        *(void *)buf = v51;
        v52 = objc_msgSend(NSDictionary, "dictionaryWithObjects:forKeys:count:", buf, v86, 1, v68);
      ...
      if ((v60 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v63, OS_LOG_TYPE_INFO))
        {
          ...
          *(void *)&buf[4] = v64;
          ...
          __int16 v84 = 2112;
          v85 = v58;
          _os_log_impl(&dword_22F52A000, v63, OS_LOG_TYPE_INFO, "%{public}@Updating releaseDate from %@ to %@", buf, 0x20u);
  ...
  else
  {
    ...
    v50 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
...
- (id)transactionWithObjectChangeType:(unint64_t)a3 forAccessoryUUID:(id)a4
{
  ...
  id v8 = [(HMDSoftwareUpdate *)self accessory];
  id v9 = [v8 uuid];
...
- (id)transactionWithObjectChangeType:(unint64_t)a3
{
  ...
  v6 = [v5 uuid];
  uint64_t v7 = [(HMDSoftwareUpdate *)self transactionWithObjectChangeType:a3 forAccessoryUUID:v6];
...
- (HMDSoftwareUpdateModel)model
{
  ...
  v6 = objc_msgSend(NSNumber, "numberWithInteger:", -[HMDSoftwareUpdate state](self, "state"));
  [v3 setState:v6];
...
- (void)_handleNeedsAttentionReasonsRequest:(id)a3
{
  ...
  if (v5)
  {
    uint64_t v21 = *MEMORY[0x263F0DA88];
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      uint64_t v12 = *MEMORY[0x263F0DAA8];
      int v15 = 138543874;
      id v16 = v11;
      __int16 v17 = 2112;
      uint64_t v18 = v12;
      __int16 v19 = 2112;
      v20 = v7;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Sending %@ reply with payload %@", (uint8_t *)&v15, 0x20u);
    }
...
- (void)setNeedsAttentionReasons:(unint64_t)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v25 = 2112;
      uint64_t v26 = v10;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@NeedsAttentionReasons updated to %@", (uint8_t *)&v23, 0x16u);
    }
    uint64_t v29 = *MEMORY[0x263F0DA88];
    ...
    id v16 = (void *)*MEMORY[0x263F0DA80];
    __int16 v17 = [MEMORY[0x263F42590] messageWithName:*MEMORY[0x263F0DA80] destination:v15 payload:v12];
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v27 = 2112;
      v28 = v15;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Sending message %@ to %@", (uint8_t *)&v23, 0x20u);
    }
    ...
    if (v9 && [v9 integerValue] == 4)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        __int16 v27 = v13;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Received notification documentation is available, notifying clients", buf, 0xCu);
      }
      v14 = (void *)[objc_alloc(MEMORY[0x263F425C0]) initWithName:@"SUDocumentation"];
      int v15 = [v4 documentation];
      id v16 = v15;
      if (v15)
      {
        uint64_t v24 = *MEMORY[0x263F0DA20];
        ...
        __int16 v19 = objc_msgSend(MEMORY[0x263F42590], "entitledMessageWithName:messagePayload:", *MEMORY[0x263F0DA38], v18, v24);
  ...
  if (v5)
  {
    ...
    if (!v7)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        __int16 v27 = v19;
        _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Missing asset", buf, 0xCu);
      }
      int v7 = [v4 responseHandler];

      if (v7)
      {
        v20 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
    ...
    {
      id v9 = objc_msgSend(v7, "nextPermittedDownloadDate", *MEMORY[0x263F0DA90]);
      __int16 v25 = v9;
      v22 = [NSDictionary dictionaryWithObjects:&v25 forKeys:&v24 count:1];
      int v23 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:3201];
...
LABEL_12:
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v27 = v14;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot get documentation without documentation metadata", buf, 0xCu);
  }
  int v15 = [v4 responseHandler];

  if (v15)
  {
    int v7 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
    id v9 = [v4 responseHandler];
    id v10 = (void (*)(void))v9[2];
    goto LABEL_11;
  }
...
- (void)_handleUpdateDocumentationMetadata:(id)a3
{
  ...
  {
    uint64_t v5 = *MEMORY[0x263F0DA30];
    id v6 = [v4 nullForKey:*MEMORY[0x263F0DA30]];
    ...
    if (v22)
    {
      ...
      id v39 = 0;
      int v7 = [MEMORY[0x263F08928] unarchivedObjectOfClass:objc_opt_class() fromData:v22 error:&v39];
      id v23 = v39;
      uint64_t v24 = v23;
      if (v7)
      {
...
LABEL_4:
        ...
        if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v42 = 2112;
          id v43 = v7;
          _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Updating with documentation metadata: %@", buf, 0x16u);
        }
...
LABEL_23:
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v42 = 2112;
        id v43 = v24;
        _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive software update documentation metadata from metadata data: %@", buf, 0x16u);
      }
      v36 = [v4 responseHandler];

      if (v36)
      {
        char v37 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v42 = 2112;
        id v43 = v29;
        _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_ERROR, "%{public}@Missing documentation metadata from message payload: %@", buf, 0x16u);
      }
      ...
      int v15 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
...
void __46__HMDSoftwareUpdate_setDocumentationMetadata___block_invoke(id *a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v10 = 2112;
    id v11 = v6;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Updated documentation metadata: %@", (uint8_t *)&v8, 0x16u);
  }
  id v7 = a1[4];
  if (a1[5])
  {
...
- (void)_handleUpdateState:(id)a3
{
  ...
  if (__shouldAcceptMessage(self, v4))
  {
    id v5 = [v4 numberForKey:*MEMORY[0x263F0DAB8]];
    id v6 = v5;
    if (v5)
    {
...
LABEL_15:
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v25 = 2048;
        unint64_t v26 = v7;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid state: %ld", (uint8_t *)&v23, 0x16u);
      }
      uint64_t v21 = [v4 responseHandler];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Missing state from message payload: %@", (uint8_t *)&v23, 0x16u);
      }
      v14 = [v4 responseHandler];
...
- (void)_updateState:(int64_t)a3 message:(id)a4 options:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v32 = 2112;
    v33 = v15;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Updating state: %@ from current state: %@", (uint8_t *)&v28, 0x20u);
  }
...
- (void)registerForMessages
{
  ...
  if (([v3 isCurrentAccessory] & 1) != 0 || objc_msgSend(v3, "supportsFirmwareUpdate"))
  {
    ...
    [v5 registerForMessage:*MEMORY[0x263F0DAC8] receiver:self policies:v9 selector:sel__handleUpdateState_];
    [v5 registerForMessage:*MEMORY[0x263F0DAC0] receiver:self policies:v9 selector:sel__handleUpdateDocumentationMetadata_];
  }
  ...
  [v5 registerForMessage:*MEMORY[0x263F0DAA0] receiver:self policies:v11 selector:sel__handleDocumentationRequest_];
  [v5 registerForMessage:*MEMORY[0x263F0DAA8] receiver:self policies:v11 selector:sel__handleNeedsAttentionReasonsRequest_];
}
...
LABEL_15:
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, v22, (uint8_t *)&v32, 0xCu);
    }
LABEL_16:
...
- (HMDSoftwareUpdate)initWithModel:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v31 = v27;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Software version is required", buf, 0xCu);
    }
    id v24 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t40 != -1) {
    dispatch_once(&logCategory__hmf_once_t40, &__block_literal_global_125506);
  }
