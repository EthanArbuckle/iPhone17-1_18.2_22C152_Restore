  ...
  if (![(__HMDPrimaryElectionCandidate *)self matchesPreferredPrimaryIdentifier:v5])
  {
    if ([v4 matchesPreferredPrimaryIdentifier:v5])
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v24 = 2112;
        int v25 = v5;
        _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Preferring %@ over %@ in resident election due to preferred primary: %@", (uint8_t *)&v18, 0x2Au);
      }
      int64_t v12 = -1;
      goto LABEL_10;
    }
...
- (BOOL)matchesPreferredPrimaryIdentifier:(id)a3
{
  ...
  {
    id v8 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v4];
    if (!v8) {
      goto LABEL_8;
    }
...
+ (id)fromMessagePayload:(id)a3
{
  ...
  {
    id v18 = 0;
    id v5 = [MEMORY[0x263F08928] unarchivedObjectOfClass:objc_opt_class() fromData:v4 error:&v18];
    id v6 = v18;
    if (v5)
    {
      id v7 = v5;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v21 = 2112;
        id v22 = v6;
        _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode election parameters: %@", buf, 0x16u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v21 = 2112;
      id v22 = v12;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Unable to find election parameters in payload (keys: %@)", buf, 0x16u);
    }
    id v5 = 0;
  }
