...
+ (id)_parseOverridePairedMetadataWithProductGroup:(id)a3 productNumber:(id)a4 productNumberDictionary:(id)a5 accessoryIdentifier:(id)a6
{
  ...
  {
    id v35 = 0;
    v16 = [MEMORY[0x263F08900] dataWithJSONObject:v15 options:0 error:&v35];
    id v17 = v35;
    if (v16)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v42 = 2112;
          v43 = v11;
          _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@JSON dictionary for '%@':'%@' did not parse correctly: %@", buf, 0x2Au);
        }
        id v19 = 0;
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544386;
        ...
        __int16 v44 = 2112;
        id v45 = v17;
        _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@JSON dictionary for '%@':'%@' failed to convert to JSON: %@: %@", buf, 0x34u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      __int16 v44 = 2112;
      id v45 = v13;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@JSON for '%@':'%@' contains an invalid '%@' value: %@", buf, 0x34u);
    }
    id v19 = 0;
  }
...
+ (id)parseFromData:(id)a3
{
  ...
  id v4 = a3;
  id v36 = 0;
  v5 = [MEMORY[0x263F08900] JSONObjectWithData:v4 options:0 error:&v36];
  id v6 = v36;
  v7 = v6;
  if (v5) {
    BOOL v8 = v6 == 0;
  ...
  if (v8)
  {
        ...
        if (!objc_msgSend(v19, "count", v29, v30, v31, v32))
        {
          ...
          if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)v37 = 138543618;
            ...
            __int16 v39 = 2112;
            id v40 = v14;
            _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@JSON contains no overrides: %@", v37, 0x16u);
          }
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(void *)&buf[14] = v14;
        _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@JSON is not a dictionary: %@", buf, 0x16u);
      }
      id v13 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(void *)&buf[14] = v7;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse JSON: %@", buf, 0x16u);
    }
    id v13 = 0;
  }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v28 = 2112;
        id v29 = v10;
        _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@JSON value for '%@' is not a dictionary: %@", buf, 0x20u);
      }
    ...
    if (!+[HMDAccessory validateProductData:v9])
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v53 = 2112;
        v54 = v9;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Computed product data is invalid: %@", buf, 0x16u);
      }
    ...
    if (v11)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v55 = 2112;
        id v56 = v7;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@Overrides contain multiple entries for '%@':'%@'", buf, 0x20u);
      }
      *(unsigned char *)(*(void *)(*(void *)(a1 + 48) + 8) + 24) = 1;
      goto LABEL_38;
    }
    ...
    if (!v23)
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v57 = 2112;
        id v58 = v21;
        _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_ERROR, "%{public}@JSON value for '%@':'%@' is not a dictionary: %@", buf, 0x2Au);
...
LABEL_34:
          _os_log_impl(&dword_22F52A000, v38, OS_LOG_TYPE_ERROR, v41, buf, 0x2Au);
        ...
        *(unsigned char *)(*(void *)(*(void *)(a1 + 48) + 8) + 24) = 1;
        ...
        if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v57 = 2112;
          id v58 = v23;
          _os_log_impl(&dword_22F52A000, v43, OS_LOG_TYPE_ERROR, "%{public}@JSON dictionary for '%@':'%@' did not have network declaration or pairedMetadata: %@", buf, 0x2Au);
        }
      }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_17773 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_17773, &__block_literal_global_17774);
  }
  v2 = (void *)logCategory__hmf_once_v1_17775;
  return v2;
}
...
void __64__HMDNetworkRouterFirewallRuleManagerOverrideParser_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_17775;
  logCategory__hmf_once_v1_17775 = v0;
}
