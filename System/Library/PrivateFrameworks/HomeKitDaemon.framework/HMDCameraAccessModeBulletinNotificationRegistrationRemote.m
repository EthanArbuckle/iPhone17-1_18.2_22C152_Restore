...
- (HMDCameraAccessModeBulletinNotificationRegistration)registration;
...
- (HMDCameraAccessModeBulletinNotificationRegistration)registration
{
  return (HMDCameraAccessModeBulletinNotificationRegistration *)objc_getProperty(self, a2, 8, 1);
}
...
- (HMDCameraAccessModeBulletinNotificationRegistrationRemote)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    id v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"HMDCAMBNRR.ck.s"];
    if (v6)
    {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  id v6 = [(HMDCameraAccessModeBulletinNotificationRegistrationRemote *)self source];
...
LABEL_7:
    ...
    return (HMDCameraAccessModeBulletinNotificationRegistrationRemote *)+[HMDCameraAccessModeBulletinNotificationRegistrationRemote supportsSecureCoding];
  }
  v15.receiver = self;
  v15.super_class = (Class)HMDCameraAccessModeBulletinNotificationRegistrationRemote;
