...
void __111__HMDAccessoryDiagnosticsManagerInternal_notifyClientsOfDiagnosticsTransferSupport_supportDiagnosticsTransfer___block_invoke(uint64_t a1)
{
  ...
  uint64_t v10 = *MEMORY[0x263F0B2A8];
  ...
  {
    v5 = encodeRootObject();
    [v4 setObject:v5 forKeyedSubscript:*MEMORY[0x263F0B710]];
  }
  id v6 = [MEMORY[0x263F42568] messageWithName:*MEMORY[0x263F0B2B0] messagePayload:v4];
...
- (void)_handleDiagnosticsTransferRequest:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v25 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Received message to start diagnostics transfer", buf, 0xCu);
  }
  ...
  if (v10)
  {
    ...
    {
      id v23 = 0;
      id v13 = [MEMORY[0x263F08928] unarchivedObjectOfClass:objc_opt_class() fromData:v12 error:&v23];
      id v14 = v23;
    }
    else
    {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v26 = 2112;
      id v27 = v14;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Decoded diagnostics options with error %@", buf, 0x16u);
    }
    if (v14) {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v26 = 2112;
      id v27 = v4;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Diagnostics transfer request message: %@ when accessory is not reachable", buf, 0x16u);
    }
...
- (void)_registerForMessages
{
  ...
  uint64_t v4 = *MEMORY[0x263F0B298];
  ...
  void v11[2] = v9;
  char v10 = [MEMORY[0x263EFF8C0] arrayWithObjects:v11 count:3];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_209100 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_209100, &__block_literal_global_209101);
  }
  v2 = (void *)logCategory__hmf_once_v4_209102;
  return v2;
}
...
void __53__HMDAccessoryDiagnosticsManagerInternal_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_209102;
  logCategory__hmf_once_v4_209102 = v0;
}
