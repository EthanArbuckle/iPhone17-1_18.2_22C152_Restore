...
- (BOOL)_parseFromTLVData
{
  ...
  v3 = [MEMORY[0x263F35A58] wrappertlv:1 name:@"kVideoParameters_Codec"];
  id v4 = [MEMORY[0x263F35990] wrappertlv:2 name:@"kVideoParameters_CodecParameters"];
  v5 = [MEMORY[0x263F35990] wrappertlv:3 name:@"kVideoParameters_Attributes"];
  id v6 = [MEMORY[0x263F35990] wrappertlv:4 name:@"kVideoParameters_RTPParameter"];
  v33[0] = v3;
  v33[1] = v4;
  v33[2] = v5;
  v33[3] = v6;
  id v7 = [MEMORY[0x263EFF8C0] arrayWithObjects:v33 count:4];
