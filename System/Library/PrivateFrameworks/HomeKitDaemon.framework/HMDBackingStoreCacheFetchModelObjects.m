...
- (id)mainReturningError
{
  ...
  v27 = __Block_byref_object_copy__23660;
  v28 = __Block_byref_object_dispose__23661;
  id v29 = 0;
  aBlock[0] = MEMORY[0x263EF8330];
  aBlock[1] = 3221225472;
  aBlock[2] = __59__HMDBackingStoreCacheFetchModelObjects_mainReturningError__block_invoke;
  aBlock[3] = &unk_264A17F68;
  v23 = &v24;
  aBlock[4] = self;
  id v4 = v3;
  id v22 = v4;
      ...
      if (v19)
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v30 = 2112;
          uint64_t v31 = v24;
          _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@unable to decode result (%@)", buf, 0x16u);
