        ...
        do
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            __int16 v45 = 2048;
            uint64_t v46 = v30;
            _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@Matter pairing state %ld: %@ for %lu msec", buf, 0x2Au);
...
- (void)processStateChange:(id)a3
{
  ...
  id v4 = a3;
  v5 = [v4 tagData];
  uint64_t v6 = *MEMORY[0x263F496F0];
  v7 = [v5 objectForKeyedSubscript:*MEMORY[0x263F496F0]];
...
LABEL_27:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v22 = 2112;
      uint64_t v23 = v6;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@Missing tag field %@, or not an NSNumber", (uint8_t *)&v20, 0x16u);
    }
  }
}
...
- (void)processLongestPairingState:(id)a3
{
  id v4 = a3;
  v5 = [v4 tagData];
  uint64_t v6 = [v5 objectForKeyedSubscript:*MEMORY[0x263F496A8]];
  ...
  v11 = [v10 objectForKeyedSubscript:*MEMORY[0x263F496B0]];
...
- (void)processCredentialsToClientEvent:(id)a3
{
  ...
  [v3 setCredentialsSentToClient:MEMORY[0x263EFFA88]];
}

- (void)processWiFiScanResultsEvent:(id)a3
{
  id v3 = [(HMDMatterThirdPartyPairingTagProcessor *)self logEvent];
  [v3 setProvidedWiFiScanResults:MEMORY[0x263EFFA88]];
}

- (void)processThreadScanResultsEvent:(id)a3
{
  id v3 = [(HMDMatterThirdPartyPairingTagProcessor *)self logEvent];
  [v3 setProvidedThreadScanResults:MEMORY[0x263EFFA88]];
}

- (void)processFirmwareVersionEvent:(id)a3
{
  id v4 = [a3 tagData];
  v5 = [v4 objectForKeyedSubscript:*MEMORY[0x263F49728]];
...
{
  id v4 = [a3 tagData];
  v5 = [v4 objectForKeyedSubscript:*MEMORY[0x263F496D8]];
...
{
  id v4 = [a3 tagData];
  v5 = [v4 objectForKeyedSubscript:*MEMORY[0x263F49700]];
...
{
  id v4 = [a3 tagData];
  v5 = [v4 objectForKeyedSubscript:*MEMORY[0x263F496D0]];
...
- (void)processAccessoryInfoEvent:(id)a3
{
  id v64 = a3;
  id v4 = [v64 tagData];
  v5 = [v4 objectForKeyedSubscript:*MEMORY[0x263F49748]];
  ...
  id v9 = [v64 tagData];
  v10 = [v9 objectForKeyedSubscript:*MEMORY[0x263F49740]];
  ...
  id v14 = [v64 tagData];
  v15 = [v14 objectForKeyedSubscript:*MEMORY[0x263F497A8]];
  ...
  int v20 = [v19 objectForKeyedSubscript:*MEMORY[0x263F49768]];
  ...
  v25 = [v24 objectForKeyedSubscript:*MEMORY[0x263F49760]];
  ...
  v61 = v22;
  v29 = [v64 tagData];
  uint64_t v30 = [v29 objectForKeyedSubscript:*MEMORY[0x263F49738]];
  ...
  long long v35 = [v34 objectForKeyedSubscript:*MEMORY[0x263F49798]];
  ...
  v39 = [v64 tagData];
  v40 = [v39 objectForKeyedSubscript:*MEMORY[0x263F49758]];
  ...
  v63 = v12;
  v44 = [v64 tagData];
  __int16 v45 = [v44 objectForKeyedSubscript:*MEMORY[0x263F49770]];
  ...
  v49 = v7;
  v50 = [v64 tagData];
  v51 = [v50 objectForKeyedSubscript:*MEMORY[0x263F49718]];
  ...
  v55 = [v64 tagData];
  v56 = [v55 objectForKeyedSubscript:*MEMORY[0x263F49730]];
...
- (void)processPairingErrorCancelledEvent:(id)a3
{
  uint64_t v4 = *MEMORY[0x263F0C710];
  id v7 = a3;
...
- (void)processPairingErrorEvent:(id)a3
{
  ...
  v5 = [v4 objectForKeyedSubscript:*MEMORY[0x263F49968]];
  ...
  {
    id v8 = [v28 tagData];
    id v9 = [v8 objectForKeyedSubscript:*MEMORY[0x263F49970]];
  ...
  uint64_t v19 = [v18 objectForKeyedSubscript:*MEMORY[0x263F49978]];
  ...
  {
    id v22 = [v28 tagData];
    uint64_t v23 = [v22 objectForKeyedSubscript:*MEMORY[0x263F49980]];
...
- (id)tagProcessingBlocks
{
  if (tagProcessingBlocks_token != -1) {
    dispatch_once(&tagProcessingBlocks_token, &__block_literal_global_261846);
  }
...
{
  v10[15] = *MEMORY[0x263EF8340];
  uint64_t v0 = *MEMORY[0x263F49790];
  v9[0] = *MEMORY[0x263F49788];
  v9[1] = v0;
  v10[0] = &__block_literal_global_11_261848;
  v10[1] = &__block_literal_global_13_261849;
  uint64_t v1 = *MEMORY[0x263F496F8];
  v9[2] = *MEMORY[0x263F49780];
  v9[3] = v1;
  v10[2] = &__block_literal_global_15_261850;
  v10[3] = &__block_literal_global_17_261851;
  uint64_t v2 = *MEMORY[0x263F496C0];
  v9[4] = *MEMORY[0x263F496B8];
  v9[5] = v2;
  v10[4] = &__block_literal_global_19_261852;
  v10[5] = &__block_literal_global_21_261853;
  uint64_t v3 = *MEMORY[0x263F49778];
  v9[6] = *MEMORY[0x263F49708];
  v9[7] = v3;
  v10[6] = &__block_literal_global_23_261854;
  v10[7] = &__block_literal_global_25_261855;
  uint64_t v4 = *MEMORY[0x263F497A0];
  v9[8] = *MEMORY[0x263F49720];
  v9[9] = v4;
  v10[8] = &__block_literal_global_27_261856;
  v10[9] = &__block_literal_global_29_261857;
  uint64_t v5 = *MEMORY[0x263F496E8];
  v9[10] = *MEMORY[0x263F497B0];
  v9[11] = v5;
  v10[10] = &__block_literal_global_31_261858;
  v10[11] = &__block_literal_global_33_261859;
  uint64_t v6 = *MEMORY[0x263F496C8];
  v9[12] = *MEMORY[0x263F49750];
  v9[13] = v6;
  v10[12] = &__block_literal_global_35_261860;
  v10[13] = &__block_literal_global_37_261861;
  v9[14] = *MEMORY[0x263F496E0];
  v10[14] = &__block_literal_global_39_261862;
  uint64_t v7 = [NSDictionary dictionaryWithObjects:v10 forKeys:v9 count:15];
...
- (HMDMatterThirdPartyPairingTagProcessor)initWithSubmitter:(id)a3
{
  ...
  if (v3)
  {
    ...
    uint64_t v6 = [objc_alloc(MEMORY[0x263F499D8]) initAutoStopPreviousState:0];
