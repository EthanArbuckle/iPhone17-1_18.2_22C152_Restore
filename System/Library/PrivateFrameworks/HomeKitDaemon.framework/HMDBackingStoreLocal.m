...
LABEL_13:
  ...
  if (v14 != 100)
  {
    if (a6 && v14 != 101)
    {
      *a6 = [MEMORY[0x263F087E8] errorWithSQLite3Statement:self->selectArchive];
    }
    sqlite3_reset(self->selectArchive);
    goto LABEL_13;
  }
  v15 = [NSString stringWithSQLite3Column:self->selectArchive column:1];
  v16 = [MEMORY[0x263EFF8F8] dataWithSQLite3Column:self->selectArchive column:2];
...
- (void)_selectAllLog:(id)a3
{
  ...
  while (1)
  {
    ...
    id v11 = [MEMORY[0x263EFF8F8] dataWithSQLite3Column:self->selectAllLog column:4];
  ...
  {
    id v12 = [MEMORY[0x263F087E8] errorWithSQLite3Statement:self->selectAllLog];
...
- (id)_selectLogOptionsWithID:(int64_t)a3
{
  ...
  while (1)
  {
    ...
    if (v6)
    {
      sqlite3_int64 v8 = (void *)MEMORY[0x230FBD990]();
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v23 = 2048;
        int64_t v24 = a3;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Got multiple results for xact_block %lu (using first one)", buf, 0x16u);
      }
    }
    else
    {
      sqlite3_int64 v6 = [MEMORY[0x263EFF8F8] dataWithSQLite3Column:self->selectLogOptions column:0];
    }
  }
  if (v7 != 101)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = [MEMORY[0x263F087E8] errorWithSQLite3Statement:self->selectLogOptions];
      *(_DWORD *)buf = 138543618;
      v22 = v15;
      __int16 v23 = 2112;
      int64_t v24 = (int64_t)v16;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@unexpected error to selectLogOptions: %@", buf, 0x16u);
    }
  }
  sqlite3_reset(self->selectLogOptions);
  if (v6)
  {
    id v17 = [MEMORY[0x263F08928] unarchivedObjectOfClass:objc_opt_class() fromData:v6 error:0];
  }
  else
  {
    id v17 = 0;
...
- (void)_selectLogWithMask:(int64_t)a3 compare:(int64_t)a4 callback:(id)a5
{
  ...
  else
  {
    while (1)
    {
      ...
      sqlite3_int64 v15 = (void *)MEMORY[0x263EFD7E8];
    ...
    {
      id v18 = [MEMORY[0x263F087E8] errorWithSQLite3Statement:self->selectChangeExistsLog];
...
- (void)_selectLogWithRoot:(id)a3 after:(int64_t)a4 mask:(int64_t)a5 compare:(int64_t)a6 callback:(id)a7
{
  ...
  else
  {
    ...
    while (1)
    {
      ...
      v29 = [MEMORY[0x263EFF8F8] dataWithSQLite3Column:v21 column:3];
    ...
    {
      v30 = [MEMORY[0x263F087E8] errorWithSQLite3Statement:v21];
...
LABEL_23:
        uint64_t v35 = [MEMORY[0x263F087E8] errorWithSQLite3Statement:*p_updateLogXactID];
LABEL_24:
        id v14 = (id)v35;
        break;
      }
...
- (void)_selectAllRecords:(id)a3
{
  ...
  while (1)
  {
    ...
    id v11 = [MEMORY[0x263EFF8F8] dataWithSQLite3Column:self->selectRecords column:6];
    int v12 = [MEMORY[0x263EFF8F8] dataWithSQLite3Column:self->selectRecords column:7];
  ...
  if ((v4 & 0xFFFFFFFE) != 0x64)
  {
    uint64_t v13 = [MEMORY[0x263F087E8] errorWithSQLite3Statement:self->selectRecords];
...
- (id)_fetchRecordWithUUID:(id)a3 root:(id)a4 error:(id *)a5
{
  ...
  if (v12 != 100)
  {
    if (a5 && v12 != 101)
    {
      *a5 = [MEMORY[0x263F087E8] errorWithSQLite3Statement:self->selectRecordUUIDNoShare];
    }
    sqlite3_reset(self->selectRecordUUIDNoShare);
    id v10 = 0;
    id v9 = 0;
LABEL_19:
  ...
  uint64_t v14 = [MEMORY[0x263EFF8F8] dataWithSQLite3Column:self->selectRecordUUIDNoShare column:1];
...
- (void)_fetchRecordsWithGroupID:(int64_t)a3 callback:(id)a4
{
  ...
  while (1)
  {
    ...
    id v10 = [MEMORY[0x263EFF8F8] dataWithSQLite3Column:self->selectRecordGroup column:1];
    sqlite3_int64 v11 = sqlite3_column_int64(self->selectRecordGroup, 2);
    uint64_t v12 = [MEMORY[0x263EFF8F8] dataWithSQLite3Column:self->selectRecordGroup column:3];
  ...
  id v6 = [MEMORY[0x263F087E8] errorWithSQLite3Statement:self->selectRecordGroup];
  sqlite3_reset(self->selectRecordGroup);
...
LABEL_7:
  ...
  id v6 = [MEMORY[0x263F087E8] errorWithSQLite3Statement:self->selectRecordGroupTypeSchema];
  sqlite3_reset(self->selectRecordGroupTypeSchema);
  sqlite3_int64 v7 = (void (**)(void, void, void, void))v12;
  if (v6)
  {
...
- (void)_fetchRecordCountWithGroupID:(int64_t)a3 callback:(id)a4
{
  ...
  id v6 = [MEMORY[0x263F087E8] errorWithSQLite3Statement:self->selectRecordCountGroup];
  sqlite3_reset(self->selectRecordCountGroup);
  sqlite3_int64 v7 = (void (**)(void, void, void))v10;
  if (v6)
  {
...
- (id)_updateRecordWithGroupID:(int64_t)a3 store:(int64_t)a4 name:(id)a5 model:(id)a6
{
  ...
  else
  {
    ...
    id v16 = (void *)[objc_alloc(MEMORY[0x263EFD7E8]) initWithRecordName:v10];
...
- (id)_updateRecordWithGroupID:(int64_t)a3 store:(int64_t)a4 record:(id)a5 data:(id)a6 encoding:(int64_t)a7
{
  ...
  id v15 = (void *)[objc_alloc(MEMORY[0x263F08910]) initRequiringSecureCoding:1];
...
- (id)_updateRecordWithGroupID:(int64_t)a3 store:(int64_t)a4 name:(id)a5 record:(id)a6 uuid:(id)a7 parentUUID:(id)a8 type:(id)a9 data:(id)a10 encoding:(int64_t)a11 schema:(id)a12
{
  ...
  if (os_log_type_enabled(v44, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544898;
    ...
    __int16 v78 = 2112;
    id v79 = v45;
    _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_DEBUG, "%{public}@Inserting/Updating record group: %lu, name: %@, uuid: %@, parent: %@, type: %@, schema: %@", buf, 0x48u);
...
LABEL_15:
  ...
  while (1)
  {
    ...
    if (v8)
    {
      ...
      id v12 = [MEMORY[0x263EFF8F8] dataWithSQLite3Column:self->selectGroups column:3];
      id v13 = [NSString stringWithSQLite3Column:self->selectGroups column:4];
      uint64_t v14 = [MEMORY[0x263EFF8F8] dataWithSQLite3Column:self->selectGroups column:5];
      id v15 = (void *)v14;
      if (v12)
      {
        id v16 = [MEMORY[0x263F08928] unarchivedObjectOfClass:objc_opt_class() fromData:v12 error:v22];
        if (v15) {
          goto LABEL_7;
        }
      }
      else
      {
        ...
        {
LABEL_7:
          id v17 = [MEMORY[0x263F08928] unarchivedObjectOfClass:objc_opt_class() fromData:v15 error:v22];
          goto LABEL_10;
        }
      }
      id v17 = 0;
LABEL_10:
  ...
  if (v7 != 101)
  {
    id *v22 = [MEMORY[0x263F087E8] errorWithSQLite3Statement:self->selectGroups];
  }
  ...
  id v19 = [MEMORY[0x263F087E8] errorWithSQLite3Statement:self->selectGroups];
  id *v22 = v19;
  if (v19) {
    goto LABEL_15;
  }
...
- (id)_updateGroupWithID:(int64_t)a3 subscription:(id)a4
{
  ...
  int v7 = [MEMORY[0x263F08910] archivedDataWithRootObject:a4 requiringSecureCoding:1 error:0];
  id v15 = 0;
...
- (id)_fetchZonesWithError:(id *)a3
{
  sqlite3_int64 v5 = [MEMORY[0x263EFF980] array];
  while (1)
  {
...
LABEL_15:
  ...
  else
  {
    if (a3)
    {
      *a3 = [MEMORY[0x263F087E8] errorWithSQLite3Statement:self->selectZones];
    }
...
- (id)_fetchUncommittedAndPushedTransactions
{
  ...
  selectSQLite3(connection, "SELECT id, xact_id, pushed, data, type, encoding, root FROM xact WHERE ((pushed & 0xffff0000) >> 16) != 0 AND disk_committed=0 ORDER BY root, xact_id, id;",
    MEMORY[0x263EFFA78],
  uint64_t v3 = &v6);
  id v4 = objc_msgSend(v3, "na_map:", &__block_literal_global_170620);
...
- (id)_dropUncommittedUnpushedTransactions
{
  ...
  if (!v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v9 = 138543362;
      id v10 = v7;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Dropped transactions that were not committed to disk.", (uint8_t *)&v9, 0xCu);
    }
  }
  return v3;
}
...
- (int64_t)_numUncommittedTransactions
{
  ...
  connection = self->connection;
  id v19 = 0;
  id v4 = selectSQLite3(connection, "SELECT count(*) FROM xact WHERE disk_committed=0", MEMORY[0x263EFFA78], &v19);;
  id v5 = v19;
  if (![v4 count]) {
    goto LABEL_12;
  }
...
LABEL_12:
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v22 = 2112;
      id v23 = v5;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Unable to determine number of uncommitted transactions %@", buf, 0x16u);
    }
    int64_t v13 = -1;
  }
...
- (id)_fillStoreCache
{
  ...
  if (v4 == 101)
  {
    if (sqlite3_reset(self->selectZones))
    {
      uint64_t v8 = [MEMORY[0x263F087E8] errorWithSQLite3Statement:self->selectZones];
    }
    else
    {
  ...
  else
  {
    ...
    if (sqlite3_reset(self->selectZones))
    {
      uint64_t v9 = [MEMORY[0x263F087E8] errorWithSQLite3Statement:self->selectZones];
...
- (void)_rollback
{
  ...
  if (connection && !sqlite3_get_autocommit(connection))
  {
    ...
    if (v4)
    {
      sqlite3_int64 v5 = (void *)MEMORY[0x230FBD990]();
      uint64_t v6 = self;
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v11 = 2112;
        id v12 = v4;
        _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@ROLLBACK FAILED!: %@", (uint8_t *)&v9, 0x16u);
      }
    }
  }
}
...
- (id)_instanceResources:(BOOL)a3 migrate:(BOOL)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@SQLite datastore file: %@", buf, 0x16u);
  }
  id v12 = [(HMDBackingStoreLocal *)v8 datastoreFile];

  if (!v12)
  {
    uint64_t v21 = [MEMORY[0x263F087E8] hmfErrorWithCode:2];
    goto LABEL_31;
  }
  sqlite3_initialize();
  if (v5)
  ...
  if (!v16)
  {
    ...
    id v27 = *p_connection;
    id v388 = 0;
    uint64_t v28 = selectSQLite3(v27, "PRAGMA user_version", MEMORY[0x263EFFA78], &v388);;
    id v26 = v388;
    v337 = v28;
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_DEFAULT, "%{public}@Current schema version: %@", buf, 0x16u);
...
LABEL_22:
      id v38 = [NSString stringWithFormat:@"PRAGMA cache_size = %@", &unk_26E4723E8];;
      id v39 = *p_connection;
      id v40 = v38;
      ...
      if (v41)
      {
        ...
        if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v394 = 2112;
          id v395 = v41;
          _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_ERROR, "%{public}@Unable to set sqlite cache size to %ld: %@", buf, 0x20u);
        }
        id v46 = v41;
      }
      else
      {
        ...
        if (!v47)
        {
          v66 = *p_connection;
          id v386 = 0;
          v67 = selectSQLite3(v66, "PRAGMA journal_mode=WAL", MEMORY[0x263EFFA78], &v386);;
          id v68 = v386;
          if (v68 || [v67 count])
          {
            int64_t v69 = (void *)MEMORY[0x230FBD990]();
            __int16 v70 = v8;
            HMFGetOSLogHandle();
            ...
            if (os_log_type_enabled(v71, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v394 = 2112;
              id v395 = v68;
              _os_log_impl(&dword_22F52A000, v71, OS_LOG_TYPE_DEFAULT, "%{public}@turning on WAL resulted in %@ / %@", buf, 0x20u);
          ...
          if (v216)
          {
            ...
            if (os_log_type_enabled(v219, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              _os_log_impl(&dword_22F52A000, v219, OS_LOG_TYPE_ERROR, "%{public}@unable to prepare SQL statements: %@", buf, 0x16u);
            }
            id v221 = v216;
          }
          else
            ...
            if ([(HMDBackingStoreLocal *)v8 _numUncommittedTransactions] >= 1)
            {
              ...
              if (os_log_type_enabled(v244, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                id v391 = v245;
                _os_log_impl(&dword_22F52A000, v244, OS_LOG_TYPE_ERROR, "%{public}@We crashed after running transaction but before saving to disk.", buf, 0xCu);
              }
            }
...
LABEL_29:
    ...
    if (os_log_type_enabled(v51, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v391 = v52;
      _os_log_impl(&dword_22F52A000, v51, OS_LOG_TYPE_DEFAULT, "%{public}@Validating database.", buf, 0xCu);
    }
    id v53 = *p_connection;
    id v387 = v26;
    id v54 = v50;
    id v55 = selectSQLite3(v53, "SELECT name FROM sqlite_master WHERE type='table' AND name='xact_block'", MEMORY[0x263EFFA78], &v387);
    id v56 = v55;
    id v57 = v387;
    if (v55) {
      BOOL v58 = v387 == 0;
...
LABEL_108:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v394 = 2112;
        id v395 = v57;
        _os_log_impl(&dword_22F52A000, v62, OS_LOG_TYPE_ERROR, "%{public}@initial migration test failed with result / error: %@ / %@", buf, 0x20u);
      }
      id v64 = [v57 userInfo];
      id v65 = [v64 objectForKey:@"extcode"];
      if ([v65 isEqual:&unk_26E472418])
      {
      ...
      else
      {
        ...
        int v225 = [v224 isEqual:&unk_26E472430];
      ...
      if (isInternalBuild())
      {
        v226 = [NSURL fileURLWithFileSystemRepresentation:"/var/mobile/Library/homed" isDirectory:1 relativeToURL:0];
        v227 = +[HMDTTRManager sharedManager];
        v389 = v226;
        v228 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v389 count:1];
    ...
    v229 = selectSQLite3(v53, "SELECT name FROM sqlite_master WHERE type='index' AND name='xact_pushed2'", MEMORY[0x263EFFA78], &v387);

    id v230 = v387;
    if (v387)
    {
      v231 = (void *)MEMORY[0x230FBD990]();
      v232 = v335;
      ...
      if (os_log_type_enabled(v233, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v394 = 2112;
        id v395 = v230;
        _os_log_impl(&dword_22F52A000, v233, OS_LOG_TYPE_ERROR, "%{public}@xact_pushed2 migration test failed with result %lu items %@", buf, 0x20u);
    ...
    id v56 = selectSQLite3(v53, "SELECT subscription_data FROM zone_group WHERE subscription_data IS NOT NULL LIMIT 1", MEMORY[0x263EFFA78], &v387);

    id v236 = v387;
    if (!v56 || v387)
    {
      v237 = (void *)MEMORY[0x230FBD990]();
      v238 = v335;
      ...
      if (os_log_type_enabled(v239, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v394 = 2112;
        id v395 = v236;
        _os_log_impl(&dword_22F52A000, v239, OS_LOG_TYPE_ERROR, "%{public}@zone_group.subscription_data migration test failed with result %lu items %@", buf, 0x20u);
...
LABEL_74:
    ...
    v229 = selectSQLite3(v53, "SELECT disk_committed FROM xact WHERE id IS NOT NULL LIMIT 1", MEMORY[0x263EFFA78], &v387);

    id v247 = v387;
    if (v229 && !v387) {
      goto LABEL_88;
    }
    v248 = (void *)MEMORY[0x230FBD990]();
    v249 = v335;
    ...
    if (os_log_type_enabled(v250, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v394 = 2112;
      id v395 = v247;
      _os_log_impl(&dword_22F52A000, v250, OS_LOG_TYPE_ERROR, "%{public}@xact.disk_committed migration test failed with result %lu items %@", buf, 0x20u);
    ...
    {
LABEL_88:
      v253 = selectSQLite3(v53, "SELECT schema FROM record WHERE data IS NOT NULL LIMIT 1", MEMORY[0x263EFFA78], &v387);
      ...
      if (!v253 || v387)
      {
        ...
        if (os_log_type_enabled(v257, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v394 = 2112;
          id v395 = v254;
          _os_log_impl(&dword_22F52A000, v257, OS_LOG_TYPE_ERROR, "%{public}@record.schema migration test failed with result %lu items %@", buf, 0x20u);
      ...
      v260 = selectSQLite3(v53, "SELECT name FROM sqlite_master WHERE type='table' AND name='zone_group'", MEMORY[0x263EFFA78], &v387);

      id v261 = v387;
      if (!v260 || v387)
      {
        v262 = (void *)MEMORY[0x230FBD990]();
        v263 = v335;
        ...
        if (os_log_type_enabled(v264, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v394 = 2112;
          id v395 = v261;
          _os_log_impl(&dword_22F52A000, v264, OS_LOG_TYPE_ERROR, "%{public}@zone_group migration test failed with result %lu items %@", buf, 0x20u);
      ...
      v268 = selectSQLite3(v53, "SELECT type FROM record WHERE uuid = ''", MEMORY[0x263EFFA78], &v387);
      ...
      if (!v268 || v387)
      {
        ...
        if (os_log_type_enabled(v286, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v394 = 2112;
          id v395 = v269;
          _os_log_impl(&dword_22F52A000, v286, OS_LOG_TYPE_ERROR, "%{public}@record table migration test failed with result %lu items %@", buf, 0x20u);
        ...
        if (!v268)
        {
          ...
          if (os_log_type_enabled(v300, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            id v391 = v306;
            _os_log_impl(&dword_22F52A000, v300, OS_LOG_TYPE_ERROR, "%{public}@record table migration test failed with nil result", buf, 0xCu);
          }
          id v56 = 0;
          goto LABEL_137;
        }
...
LABEL_133:
      ...
      id v56 = selectSQLite3(v53, "SELECT name FROM zone WHERE id = 0", MEMORY[0x263EFFA78], &v387);

      id v289 = v387;
      if (!v56 || v387)
      {
        v290 = (void *)MEMORY[0x230FBD990]();
        v291 = v335;
        ...
        if (os_log_type_enabled(v292, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v394 = 2112;
          id v395 = v289;
          _os_log_impl(&dword_22F52A000, v292, OS_LOG_TYPE_ERROR, "%{public}@zone migration test failed with result %lu items %@", buf, 0x20u);
      ...
      id v295 = selectSQLite3(v53, "SELECT type FROM xact WHERE id = 0", MEMORY[0x263EFFA78], &v387);
      v296 = v53;
      uint64_t v297 = (uint64_t)v387;
      v270 = v335;
      if (v387)
      {
        v298 = (void *)MEMORY[0x230FBD990](v296);
        v299 = v335;
        v300 = HMFGetOSLogHandle();
        if (os_log_type_enabled(v300, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          uint32_t v304 = 22;
LABEL_142:
          _os_log_impl(&dword_22F52A000, v303, OS_LOG_TYPE_ERROR, v302, buf, v304);

          goto LABEL_143;
        }
        goto LABEL_143;
      }
      v307 = selectSQLite3(v296, "SELECT id FROM xact WHERE pushed < 0x0100000000000000", MEMORY[0x263EFFA78], &v387);

      id v308 = v387;
      if (v387 || [v307 count])
      {
        id v56 = v307;
        v298 = (void *)MEMORY[0x230FBD990]();
        v309 = v335;
        v300 = HMFGetOSLogHandle();
        if (os_log_type_enabled(v300, OS_LOG_TYPE_ERROR))
        {
      ...
      if (isInternalBuild())
      {
        ...
        if ([v56 count])
        {
          ...
          if (os_log_type_enabled(v320, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            id v391 = v321;
            _os_log_impl(&dword_22F52A000, v320, OS_LOG_TYPE_ERROR, "%{public}@We have duplicate records with different share_ids deleting duplicates.", buf, 0xCu);
          }
...
LABEL_145:
              ...
              else
              {
                ...
                if (os_log_type_enabled(v316, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543362;
                  id v391 = v317;
                  _os_log_impl(&dword_22F52A000, v316, OS_LOG_TYPE_ERROR, "%{public}@want to rebuild the databse, but not allowed to.", buf, 0xCu);
                }
              ...
              if (v222)
              {
                ...
                if (!v276)
                {
                  ...
                  if (os_log_type_enabled(v283, OS_LOG_TYPE_DEFAULT))
                  {
                    ...
                    *(_DWORD *)buf = 138543618;
                    ...
                    __int16 v392 = 2048;
                    uint64_t v393 = 2;
                    _os_log_impl(&dword_22F52A000, v283, OS_LOG_TYPE_DEFAULT, "%{public}@Current schema version: %ld", buf, 0x16u);
                  }
                ...
                if (os_log_type_enabled(v279, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  __int16 v394 = 2112;
                  id v395 = v276;
                  _os_log_impl(&dword_22F52A000, v280, OS_LOG_TYPE_ERROR, "%{public}@Unable to update schema version to %ld: %@", buf, 0x20u);
                }
                id v25 = v276;
              }
              else
...
LABEL_168:
            _os_log_impl(&dword_22F52A000, v300, OS_LOG_TYPE_ERROR, v324, buf, 0xCu);
      ...
      id v56 = selectSQLite3(v334, "select uuid from record where share_id!=0", MEMORY[0x263EFFA78], &v387);;

      if (![v56 count]) {
        goto LABEL_170;
      }
      v325 = (void *)MEMORY[0x230FBD990]();
      v326 = v335;
      ...
      if (os_log_type_enabled(v327, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v391 = v328;
        _os_log_impl(&dword_22F52A000, v327, OS_LOG_TYPE_DEFAULT, "%{public}@Have records with share_id will migrate them.", buf, 0xCu);
      }
...
- (id)_updateRecordWithGroupID:(int64_t)a3 name:(id)a4 schema:(id)a5
{
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v32 = 2112;
    id v33 = v9;
    _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Updating record schema: %lu, name: %@, schema: %@", buf, 0x2Au);
  }
  if (v15)
  {
    id v20 = v15;
...
- (id)flush:(BOOL)a3
{
  ...
  int v16 = __Block_byref_object_copy__170764;
  id v17 = __Block_byref_object_dispose__170765;
  id v18 = 0;
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v16 = 2112;
      id v17 = v6;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@unable to instance our resources: %@", buf, 0x16u);
    }
    id v11 = 0;
  }
  else
    ...
    if (v12)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v22 = 2112;
        id v23 = v12;
        _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@unable to instance our resources: %@", buf, 0x16u);
      }
      id v17 = 0;
      if (a5) {
        *a5 = v12;
...
LABEL_16:
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@unable to initialize SQL context: %@", buf, 0x16u);
    }
LABEL_18:
        ...
        (BOOL v5 = objc_claimAutoreleasedReturnValue()) != 0))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v23 = 2112;
      uint64_t v24 = (uint64_t)v5;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@initial database row setup failed: %@", buf, 0x16u);
    }
    goto LABEL_18;
  }
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v25 = 2112;
      id v26 = v10;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@unable to set schema version to %ld failed: %@", buf, 0x20u);
    }
    sqlite3_close(self->connection);
    unlink((const char *)[v4 UTF8String]);
    id v20 = v10;
...
- (id)_createNewDatastore:(id)a3
{
  ...
  v47[2] = v6;
  uint64_t v7 = [MEMORY[0x263EFF8C0] arrayWithObjects:v47 count:3];
        ...
        if (unlink((const char *)[v13 UTF8String]) && *__error() != 2)
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v45 = 2080;
            id v46 = v19;
            _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@unable to remove old datastore file %@ (%s)", buf, 0x20u);
          }
          char v10 = 1;
        }
      }
  ...
  if (sqlite3_open_v2((const char *)[v20 UTF8String], &self->connection, 6, 0))
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v43 = 2112;
      uint64_t v44 = 0;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@unable to open new SQL context: %@", buf, 0x16u);
    }
LABEL_20:
    __int16 v25 = [MEMORY[0x263F087E8] hmfErrorWithCode:15];
    goto LABEL_27;
  }
  id v26 = [NSString stringWithFormat:@"PRAGMA cache_size = %@", &unk_26E4723E8];;
  connection = self->connection;
  id v28 = v26;
  ...
  if (v29)
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v45 = 2112;
      id v46 = v29;
      _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_ERROR, "%{public}@Unable to set sqlite cache size to %ld: %@", buf, 0x20u);
    }
    uint64_t v34 = v29;
  }
  else
...
void __35__HMDBackingStoreLocal_logCategory__block_invoke()
{
  ...
  logCategory__hmf_once_id v60 = v0;
}
...
+ (void)cleanDatastoreFilesAt:(id)a3 everything:(BOOL)a4
{
  ...
  if ([v6 isEqualToString:@":memory:"])
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v53 = v10;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Skipping because in memory store was specified.", buf, 0xCu);
    }
  }
  else
  {
    ...
    id v50 = 0;
    id v14 = [MEMORY[0x263F08AE8] regularExpressionWithPattern:v13 options:0 error:&v50];
    id v15 = v50;
    if (v15)
    {
      __int16 v16 = v15;
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v54 = 2112;
        id v55 = v16;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@unable to compile expression: %@", buf, 0x16u);
      }
    }
    else
    {
      ...
      if (v24)
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v56 = 2112;
          id v57 = v44;
          _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@unable to get files in %@ (%@)", buf, 0x20u);
        }
      }
      else
      {
