...
- (id)analyticsPresenceEventData
{
  ...
  if ([v4 isEqualToString:*MEMORY[0x263F0D4D0]])
  {
    uint64_t v5 = 1;
  }
  else if ([v4 isEqualToString:*MEMORY[0x263F0D4D8]])
  {
    uint64_t v5 = 2;
  }
  else if ([v4 isEqualToString:*MEMORY[0x263F0D4B0]])
  {
    uint64_t v5 = 3;
  }
  else
  {
    if (![v4 isEqualToString:*MEMORY[0x263F0D4C8]]) {
      goto LABEL_10;
    }
    uint64_t v5 = 4;
  }
...
- (void)_transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v48 = v13;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling transaction updated", buf, 0xCu);
  }
  id v14 = v8;
  objc_opt_class();
          ...
          (v19 & 1) == 0))
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v51 = 2112;
        v52 = v26;
        _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Updating presence type from %@ to %@", buf, 0x20u);
      }
...
- (id)_presenceTypeForClient
{
  ...
  uint64_t v4 = *MEMORY[0x263F0D4D0];
  if (([v3 isEqualToString:*MEMORY[0x263F0D4D0]] & 1) != 0
    || [v3 isEqualToString:*MEMORY[0x263F0D4D8]])
  {
    ...
    {
      v11 = (id *)MEMORY[0x263F0D4B8];
    }
    else
    {
      if (![v3 isEqualToString:*MEMORY[0x263F0D4D8]])
      {
LABEL_10:

        goto LABEL_11;
      }
      v11 = (id *)MEMORY[0x263F0D4C0];
    }
    id v12 = *v11;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if (([v18 isEqualToString:*MEMORY[0x263F0D4D0]] & 1) != 0
    || [v18 isEqualToString:*MEMORY[0x263F0D4D8]])
  {
    long long v22 = 0u;
    long long v23 = 0u;
    long long v20 = 0u;
    ...
    if (v6)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v6; ++i)
        {
          ...
          {
            v25 = v9;
            id v12 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v25 count:1];
...
- (HMDPresenceEvent)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    uint64_t v9 = [MEMORY[0x263F0E680] activationGranularityWithCoder:v4];
    ...
    id v12 = [MEMORY[0x263EFF8C0] arrayWithObjects:v42 count:2];
    ...
    uint64_t v27 = [MEMORY[0x263EFF8C0] arrayWithArray:v16];
    userUUIDs = v6->_userUUIDs;
    v6->_userUUIDs = (NSArray *)v27;

    uint64_t v29 = [NSDictionary dictionaryWithDictionary:v15];
    users = v6->_users;
...
- (void)_updateUsers:(id)a3 home:(id)a4
{
  ...
  long long v22 = v7;
  id v8 = [v7 usersIncludingPendingUsers:1];
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v32 = 2112;
    v33 = v8;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Updating users: %@, %@", buf, 0x20u);
  }
  long long v25 = 0u;
  long long v26 = 0u;
  long long v23 = 0u;
...
- (void)_handleUpdateRequest:(id)a3
{
  ...
  if (v5 | v6)
  {
    ...
    if (v5)
    {
      ...
      if (([(id)v5 isEqualToString:*MEMORY[0x263F0D4B8]] & 1) != 0
        || [(id)v5 isEqualToString:*MEMORY[0x263F0D4C0]])
      {
        v17 = [v16 currentUser];
  ...
  else
  {
    ...
    if (v7)
    {
      ...
      uint64_t v9 = [MEMORY[0x263F087E8] hmfErrorWithCode:8];
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v27 = v13;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Unable to update Presence event as parameters are NIL", buf, 0xCu);
    }
  }
}
...
- (BOOL)compatibleWithUser:(id)a3
{
  ...
  if (([v5 isEqualToString:*MEMORY[0x263F0D4B8]] & 1) != 0
    || [v5 isEqualToString:*MEMORY[0x263F0D4C0]])
  {
    uint64_t v6 = [(HMDPresenceEvent *)self thisUser];
    LOBYTE(v7) = HMFEqualObjects();
  }
  else if (([v5 isEqualToString:*MEMORY[0x263F0D4B0]] & 1) != 0 {
         || ([v5 isEqualToString:*MEMORY[0x263F0D4C8]] & 1) != 0)
  }
  {
    LOBYTE(v7) = 1;
  }
  else if (([v5 isEqualToString:*MEMORY[0x263F0D4D0]] & 1) != 0 {
         || [v5 isEqualToString:*MEMORY[0x263F0D4D8]])
  }
  {
    long long v20 = 0u;
    long long v21 = 0u;
...
LABEL_22:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v26 = 2112;
    uint64_t v27 = v12;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Checking if the username %@ is compatible: %@", buf, 0x20u);
  }
...
- (BOOL)_evaluateWithHomePresence:(id)a3 presenceType:(id)a4 users:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a5;
  if ([v9 isEqualToString:*MEMORY[0x263F0D4B8]])
  {
  ...
  {
    if (![v9 isEqualToString:*MEMORY[0x263F0D4C0]])
    {
      if ([v9 isEqualToString:*MEMORY[0x263F0D4B0]])
      {
        char v15 = [v8 isAnyUserAtHome];
      }
      else
      {
        if (![v9 isEqualToString:*MEMORY[0x263F0D4C8]])
        {
          if ([v9 isEqualToString:*MEMORY[0x263F0D4D0]])
          {
          ...
          {
            if (![v9 isEqualToString:*MEMORY[0x263F0D4D8]])
            {
              BOOL v13 = 0;
              goto LABEL_6;
            }
...
- (BOOL)evaluateWithUserPresence:(id)a3 presenceType:(id)a4
{
  ...
  id v6 = a3;
  id v7 = a4;
  if (([v7 isEqualToString:*MEMORY[0x263F0D4B8]] & 1) == 0
    && ([v7 isEqualToString:*MEMORY[0x263F0D4B0]] & 1) == 0
    && ![v7 isEqualToString:*MEMORY[0x263F0D4D0]])
  {
    if ((([v7 isEqualToString:*MEMORY[0x263F0D4C0]] & 1) != 0
       || ([v7 isEqualToString:*MEMORY[0x263F0D4C8]] & 1) != 0
       || [v7 isEqualToString:*MEMORY[0x263F0D4D8]])
      && [v6 isNotAtHome])
    {
      id v8 = (void *)MEMORY[0x230FBD990]();
      uint64_t v14 = self;
...
LABEL_14:
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      int v18 = 138543362;
      long long v19 = v16;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Returning result to not fire event", (uint8_t *)&v18, 0xCu);
    }
    BOOL v11 = 0;
    goto LABEL_17;
  }
...
LABEL_7:
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, v13, (uint8_t *)&v18, 0xCu);
  }
LABEL_17:
...
- (BOOL)evaluateWithHomePresenceUpdate:(id)a3 presenceType:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v21 = 2112;
    long long v22 = v12;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Evaluating with homePresenceUpdate %@, activation is set to %@", (uint8_t *)&v17, 0x20u);
  }
...
void __43__HMDPresenceEvent_didEndExecutionSession___block_invoke(uint64_t a1)
{
  ...
  if (v2 == v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      int v11 = 138543362;
      char v12 = v10;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating the current status to YES after the execution session is complete", (uint8_t *)&v11, 0xCu);
    }
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v13 = 2112;
      uint64_t v14 = v9;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@Received a callback that execution session %@ has ended, but is not known session", (uint8_t *)&v11, 0x16u);
    }
  }
}
  ...
  if ([(HMDEvent *)self activationType] > 1)
  {
      ...
      || ([v4 homePresence], int v11 = objc_claimAutoreleasedReturnValue(), v11, !v11))
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v92 = 2112;
        id v93 = v4;
        _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Received home presence update is nil: %@", buf, 0x16u);
      }
      goto LABEL_4;
    }
    ...
    if (v15 != v13)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v94 = 2112;
        v95 = v13;
        _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Received home presence update, homes are not matching: %@, ours: %@", buf, 0x20u);
      }
      goto LABEL_67;
    }
    os_unfair_lock_lock_with_options();
    ...
    if (([v4 isUpdate] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v91 = v52;
        _os_log_impl(&dword_22F52A000, v51, OS_LOG_TYPE_INFO, "%{public}@Home presence is not an update", buf, 0xCu);
      }
      goto LABEL_66;
    }
    ...
    if (v24)
    {
      if (([v23 isEqualToString:*MEMORY[0x263F0D4B8]] & 1) == 0
        && ([v23 isEqualToString:*MEMORY[0x263F0D4D0]] & 1) == 0
        && ([v23 isEqualToString:*MEMORY[0x263F0D4C0]] & 1) == 0
        && ![v23 isEqualToString:*MEMORY[0x263F0D4D8]]
        || ([v89 allValues],
...
LABEL_23:
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v92 = 2112;
          id v93 = v33;
          _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_INFO, "%{public}@Evaluated status: %@", buf, 0x16u);
        }
          ...
          if (v28)
          {
            if (v38)
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v92 = 2112;
              id v93 = v34;
              _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_INFO, "%{public}@Execution session %@ is already underway, no need to create another one", buf, 0x16u);
            }
            ...
            if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              __int16 v96 = 2112;
              v97 = v42;
              _os_log_impl(&dword_22F52A000, v46, OS_LOG_TYPE_INFO, "%{public}@%@ device to execution session %@, device %@", buf, 0x2Au);
            }
          }
          else
          {
            if (v38)
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v92 = 2112;
              id v93 = v34;
              _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_INFO, "%{public}@Evaluated status is changing to NO, resetting the execution session %@", buf, 0x16u);
            }
        ...
        else if (v28 == [(HMDPresenceEvent *)v30 currentStatus])
        {
          ...
          if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v92 = 2112;
            id v93 = v70;
            _os_log_impl(&dword_22F52A000, v68, OS_LOG_TYPE_INFO, "%{public}@Current status is not changing from %@", buf, 0x16u);
          }
        }
        else if ([v4 isUpdate])
        {
          if (v28)
          {
            ...
            v57 = (void *)MEMORY[0x230FBD990]([(HMDPresenceEvent *)v30 setExecutionSession:v56]);
            v58 = v30;
            ...
            if (os_log_type_enabled(v59, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v94 = 2112;
              v95 = v55;
              _os_log_impl(&dword_22F52A000, v59, OS_LOG_TYPE_INFO, "%{public}@Created execution session %@ with triggerDevice: %@", buf, 0x20u);
            }
            if (!v56)
            {
              ...
              if (os_log_type_enabled(v63, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543362;
                v91 = v64;
                _os_log_impl(&dword_22F52A000, v63, OS_LOG_TYPE_INFO, "%{public}@Could not create execution session, updating the current status to YES", buf, 0xCu);
              }
          ...
          else
          {
            ...
            if (os_log_type_enabled(v85, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v92 = 2112;
              id v93 = v87;
              _os_log_impl(&dword_22F52A000, v85, OS_LOG_TYPE_INFO, "%{public}@This event is moving to inactive state, current execution session %@", buf, 0x16u);
            }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v79, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v94 = 2112;
            v95 = v82;
            _os_log_impl(&dword_22F52A000, v79, OS_LOG_TYPE_INFO, "%{public}@Evaluation status is changing from %@ to %@", buf, 0x20u);
          }
      ...
      if (os_log_type_enabled(v73, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v92 = 2112;
        id v93 = v75;
        _os_log_impl(&dword_22F52A000, v73, OS_LOG_TYPE_INFO, "%{public}@User presence in the update is not relevant to the user in this event: %@", buf, 0x16u);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v73, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v91 = v74;
        _os_log_impl(&dword_22F52A000, v73, OS_LOG_TYPE_INFO, "%{public}@User Presence is nil, not firing event", buf, 0xCu);
      }
    }
...
LABEL_67:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v92 = 2112;
    id v93 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Ignoring the home presence update since the activation type is %@", buf, 0x16u);
  }
LABEL_4:
...
- (BOOL)_activate:(unint64_t)a3 completionHandler:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v20 = v12;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Ignoring request to activate since event hasn't been configured", buf, 0xCu);
    }
  ...
  if (v2 - 2 < 2)
  {
    if (*(unsigned char *)(a1 + 40))
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v15 = 2112;
        uint64_t v16 = v8;
        _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Activation is changing to %@, initializing the current status", (uint8_t *)&v13, 0x16u);
      }
...
void __43__HMDPresenceEvent__handlePrivilegeUpdate___block_invoke(uint64_t a1)
{
  ...
  {
    id v4 = [v3 users];
    id v5 = objc_msgSend(v4, "na_map:", &__block_literal_global_36_43493);
  ...
  else
  {
    ...
    {
      int v11 = HMFGetLogIdentifier();
      char v12 = [*(id *)(a1 + 32) uuid];
      *(_DWORD *)buf = 138543618;
      uint64_t v16 = v11;
      __int16 v17 = 2112;
      objc_super v18 = v12;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Unable to find the MKFPresenceEvent with modelID: %@", buf, 0x16u);
    }
  }
}
...
void __43__HMDPresenceEvent__handlePrivilegeUpdate___block_invoke_2(uint64_t a1)
{
  ...
  v3 = [*(id *)(a1 + 32) home];
  id v4 = (os_unfair_lock_s *)((char *)*v2 + 88);
  uint64_t v5 = os_unfair_lock_lock_with_options();
  id v6 = (void *)MEMORY[0x230FBD990](v5);
  id v7 = *v2;
  HMFGetOSLogHandle();
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v12 = 138543362;
    int v13 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@User privilege changed. Going to update users", (uint8_t *)&v12, 0xCu);
  }
  [*(id *)(a1 + 32) _updateUsers:*(void *)(a1 + 40) home:v3];
  os_unfair_lock_unlock(v4);
  id v10 = [v3 homeManager];
  int v11 = [*(id *)(a1 + 32) uuid];
  [v10 updateGenerationCounterWithReason:@"User Privilege changed" sourceUUID:v11 shouldNotifyClients:1];
}

id __43__HMDPresenceEvent__handlePrivilegeUpdate___block_invoke_33(uint64_t a1, void *a2)
{
  unint64_t v2 = [a2 modelID];
  v3 = [v2 UUIDString];
...
{
  v6.receiver = self;
  v6.super_class = (Class)HMDPresenceEvent;
  ...
  uint64_t v5 = [v3 notificationCenter];
...
- (id)createClientPayload
{
  ...
  os_unfair_lock_lock_with_options();
  objc_super v6 = [(HMDPresenceEvent *)self _presenceTypeForClient];
  [v5 setObject:v6 forKeyedSubscript:@"kPresenceEventPresence"];
  id v7 = [(HMDPresenceEvent *)self userUUIDs];
...
- (id)createDaemonPayload
{
  ...
  os_unfair_lock_lock_with_options();
  objc_super v6 = [(HMDPresenceEvent *)self presenceType];
  [v5 setObject:v6 forKeyedSubscript:@"kPresenceEventPresence"];
...
- (NSString)description
{
  ...
  unint64_t v5 = [(HMDPresenceEvent *)self users];
  os_unfair_lock_unlock(p_lock);
  objc_super v6 = [MEMORY[0x263F089D8] stringWithFormat:@"type: %@", v4];
  long long v20 = 0u;
  long long v21 = 0u;
  long long v18 = 0u;
  long long v19 = 0u;
...
- (HMDPresenceEvent)initWithModel:(id)a3 home:(id)a4 featuresDataSource:(id)a5
{
  ...
  if (v11)
  {
    ...
    __int16 v15 = (void *)MEMORY[0x263F0E680];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5_43524 != -1) {
    dispatch_once(&logCategory__hmf_once_t5_43524, &__block_literal_global_43525);
  }
  unint64_t v2 = (void *)logCategory__hmf_once_v6_43526;
  return v2;
}
...
void __31__HMDPresenceEvent_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v6_43526;
  logCategory__hmf_once_v6_43526 = v0;
}
