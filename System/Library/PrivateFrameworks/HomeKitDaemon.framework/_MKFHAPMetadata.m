...
+ (id)fetchRequest
{
  return (id)[MEMORY[0x263EFF260] fetchRequestWithEntityName:@"MKFHAPMetadata"];
}
...
{
  v9.receiver = self;
  v9.super_class = (Class)_MKFHAPMetadata;
  ...
  if (v5)
  {
    ...
    {
      objc_msgSend(MEMORY[0x263F087E8], "hmd_validationErrorWithDescription:", @"homeManager is required");
