...
- (void)handleMediaGroupsAggregateConsumerUpdatedAggregateDataNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v15 = 138543362;
    v16 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling media groups aggregate consumer updated aggregate data notification", (uint8_t *)&v15, 0xCu);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      int v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of media groups aggregate consumer updated aggregate data notification due to no delegate", (uint8_t *)&v15, 0xCu);
    }
  }
}
...
- (void)handleMediaDestinationControllerUpdatedDestinationNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v40 = 2112;
    id v41 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling media destination controller updated destination notification: %@", (uint8_t *)&v38, 0x16u);
  }
  v9 = [v4 userInfo];
  v10 = v9;
  if (v9)
  {
    ...
    if (!v11)
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v40 = 2112;
        id v41 = v10;
        _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to get media destination controller identifier from media destination controller updated destination notification user info: %@", (uint8_t *)&v38, 0x16u);
      }
      goto LABEL_26;
    }
    ...
    {
      v14 = [v12 UUIDString];
      int v15 = [v14 isEqualToString:*MEMORY[0x263F0D0D0]];
      ...
      if (!v15)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
          {
            ...
            int v38 = 138543362;
            v39 = v37;
            _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of media destination controller updated destination notification due to no delegate", (uint8_t *)&v38, 0xCu);
          }
        }
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        uint32_t v23 = 12;
LABEL_17:
        _os_log_impl(&dword_22F52A000, v21, v22, v20, (uint8_t *)&v38, v23);
      }
    }
    else
    {
...
LABEL_26:
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v40 = 2112;
    id v41 = v4;
    _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to get user info in media destination controller updated destination notification: %@", (uint8_t *)&v38, 0x16u);
  }
LABEL_27:
}
...
- (void)handleNotificationAccessoryChangedRoom:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v30 = 2112;
      id v31 = v4;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling accessory changed room notification: %@", (uint8_t *)&v28, 0x16u);
    }
          ...
          (v17 & 1) != 0))
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        {
          ...
          int v28 = 138543362;
          v29 = v23;
          _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of accessory changed rooms notification due to no delegate", (uint8_t *)&v28, 0xCu);
        }
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        int v28 = 138543362;
        v29 = v27;
        _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@Skipping accessory changed room notification due to no destination and no related destination controller", (uint8_t *)&v28, 0xCu);
      }
    }
  }
}
...
- (void)handleMediaSystemRemovedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    id v18 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling media system removed notification: %@", (uint8_t *)&v15, 0x16u);
  }
  v9 = [(HMDMediaDestinationControllerMessageHandler *)v6 delegate];
  v10 = v9;
  if (v9)
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      int v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of media system removed notification due to no delegate", (uint8_t *)&v15, 0xCu);
    }
  }
}
...
- (void)handleMediaSystemAddedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    id v18 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling media system added notification: %@", (uint8_t *)&v15, 0x16u);
  }
  v9 = [(HMDMediaDestinationControllerMessageHandler *)v6 delegate];
  v10 = v9;
  if (v9)
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      int v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of media system added notification due to no delegate", (uint8_t *)&v15, 0xCu);
    }
  }
}
...
- (void)handleHomeAccessoryRemovedNotification:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v25 = 2112;
      id v26 = v4;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling home accessory removed notification: %@", (uint8_t *)&v23, 0x16u);
    }
    v12 = [v7 audioDestination];
    if (v12)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
        {
          ...
          int v23 = 138543362;
          v24 = v22;
          _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of accessory removed notification due to no delegate", (uint8_t *)&v23, 0xCu);
        }
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        int v23 = 138543362;
        v24 = v18;
        _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Skipping home accessory removed notification due to no destination", (uint8_t *)&v23, 0xCu);
      }
    }
  }
}
...
- (void)handleMediaDestinationUpdatedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    id v18 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling media destination updated notification: %@", (uint8_t *)&v15, 0x16u);
  }
  v9 = [(HMDMediaDestinationControllerMessageHandler *)v6 delegate];
  v10 = v9;
  if (v9)
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      int v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of media destination updated notification due to no delegate", (uint8_t *)&v15, 0xCu);
    }
  }
}
...
- (void)handleMediaDestinationControllerUpdateDestinationRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v37 = 2112;
    id v38 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling update destination request message: %@", buf, 0x16u);
  }
    ...
    if (v11)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v39 = 2112;
        id v40 = v11;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to get destination identifier from update destination message: %@ error: %@", buf, 0x20u);
      }
    ...
    if (v17)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v39 = 2112;
        id v40 = v17;
        _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to get update options from update destination message: %@ error: %@", buf, 0x20u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v36 = v31;
        _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify of update destination request message due to no delegate", buf, 0xCu);
      }
      uint64_t v32 = [MEMORY[0x263F087E8] hmfErrorWithCode:15];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v37 = 2112;
      id v38 = v4;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to get response handler from update destination request message: %@", buf, 0x16u);
    }
...
- (unint64_t)upateOptionsInMessage:(id)a3 error:(id *)a4
{
  ...
  if (v7)
  {
    v9 = objc_msgSend(v7, "hmf_numberForKey:", *MEMORY[0x263F0D0B8]);
    v10 = v9;
    if (v9)
    {
...
LABEL_18:
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v29 = 2112;
        id v30 = v16;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to perform update due to unknown update options: %@", (uint8_t *)&v27, 0x16u);
      }
      if (a4)
      {
        uint64_t v17 = 3;
LABEL_16:
        [MEMORY[0x263F087E8] hmErrorWithCode:v17];
        unint64_t v11 = 0;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v29 = 2112;
        id v30 = v6;
        _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to get update options from message: %@", (uint8_t *)&v27, 0x16u);
      }
      if (a4)
      {
        uint64_t v17 = 20;
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v29 = 2112;
    id v30 = v6;
    _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to get payload from message: %@", (uint8_t *)&v27, 0x16u);
  }
  if (a4)
  {
...
- (id)destinationIdentifierInMessage:(id)a3 error:(id *)a4
{
  ...
  if (v7)
  {
    v9 = objc_msgSend(v7, "hmf_stringForKey:", *MEMORY[0x263F0D0C8]);
    v10 = v9;
    if (v9)
    {
      if (([v9 isEqualToString:*MEMORY[0x263F0D0D0]] & 1) == 0)
      {
        unint64_t v11 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v10];
        v12 = v11;
        if (v11)
        {
          id v13 = v11;
        ...
        else
        {
          ...
          if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
          {
            ...
            __int16 v31 = 2112;
            id v32 = v6;
            _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse destination identifier: %@ message: %@", (uint8_t *)&v27, 0x20u);
          }
          if (a4)
          {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v29 = 2112;
        id v30 = v6;
        _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to get destination identifier from message: %@", (uint8_t *)&v27, 0x16u);
      }
      if (a4)
      {
        [MEMORY[0x263F087E8] hmErrorWithCode:20];
...
LABEL_21:
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v29 = 2112;
    id v30 = v6;
    _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to get payload from message: %@", (uint8_t *)&v27, 0x16u);
  }
  if (a4)
  {
    [MEMORY[0x263F087E8] hmErrorWithCode:20];
...
- (void)notifyUpdatedDestinationWithIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v18 = 2112;
    id v19 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Notifying updated destination with identifier: %@", buf, 0x16u);
  }
  ...
  if (!v4)
  {
    ...
    v10 = (void *)[v11 initWithUUIDString:*MEMORY[0x263F0D0D0]];
  }
  v15[1] = v10;
...
LABEL_12:
  ...
  if (v10)
  {
    ...
    os_log_type_t v22 = [MEMORY[0x263EFF8C0] arrayWithObjects:v29 count:7];
  }
  else
  {
    os_log_type_t v22 = (void *)MEMORY[0x263EFFA68];
  }
  uint64_t v28 = *MEMORY[0x263F0D0B0];
  int v23 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v28 count:1];
  v27.receiver = self;
  v27.super_class = (Class)HMDMediaDestinationControllerMessageHandler;
  v24 = [(HMDAppleMediaAccessoryMessageHandler *)&v27 initWithMessageTargetUUID:v15 messageDispatcher:v16 notificationCenter:v17 ownerPrivateRemoteMessages:MEMORY[0x263EFFA68] adminPrivateRemoteMessages:v23 internalMessages:MEMORY[0x263EFFA68] notifications:v22 notificationsToObject:MEMORY[0x263EFFA78]];
  __int16 v25 = v24;
  if (v24)
  {
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t34_227237 != -1) {
    dispatch_once(&logCategory__hmf_once_t34_227237, &__block_literal_global_227238);
  }
  v2 = (void *)logCategory__hmf_once_v35_227239;
  return v2;
}
...
void __58__HMDMediaDestinationControllerMessageHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v35_227239;
  logCategory__hmf_once_v35_227239 = v0;
}
