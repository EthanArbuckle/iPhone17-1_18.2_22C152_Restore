...
- (id)messagePayload
{
  ...
  objc_super v7 = v4;
  v8[0] = v3;
  objc_super v5 = [NSDictionary dictionaryWithObjects:v8 forKeys:&v7 count:1];
...
+ (id)objWithMessage:(id)a3
{
  ...
  id v14 = 0;
  objc_super v7 = [MEMORY[0x263F08928] unarchivedObjectOfClass:objc_opt_class() fromData:v6 error:&v14];
  id v8 = v14;
  if (!v7)
  {
...
+ (id)objWithDict:(id)a3
{
  ...
  id v13 = 0;
  v6 = [MEMORY[0x263F08928] unarchivedObjectOfClass:objc_opt_class() fromData:v5 error:&v13];
  id v7 = v13;
  if (!v6)
  {
