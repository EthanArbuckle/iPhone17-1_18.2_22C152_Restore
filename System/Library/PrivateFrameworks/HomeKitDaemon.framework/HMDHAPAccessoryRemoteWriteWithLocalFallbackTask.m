...
- (id)_makeLocalTaskWithRequests:(id)a3 completion:(id)a4
{
  ...
  uint64_t v10 = objc_msgSend(v7, "na_map:", &__block_literal_global_530_265394);
...
- (id)_makeRemoteTaskWithRequests:(id)a3 delegateDevice:(id)a4 completion:(id)a5
{
  ...
  uint64_t v22 = objc_msgSend(v10, "na_map:", &__block_literal_global_530_265394);
