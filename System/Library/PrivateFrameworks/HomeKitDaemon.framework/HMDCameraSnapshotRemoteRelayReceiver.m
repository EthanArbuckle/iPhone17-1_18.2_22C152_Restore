...
- (void)relayReceiver:(id)a3 didReceiveData:(id)a4 error:(id)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v22 = 2112;
    id v23 = v10;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Image receive has completed with error: %@", (uint8_t *)&v20, 0x16u);
  }
  if (!v10)
  {
    ...
    {
      id v10 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1035];
    }
  }
  [(HMDCameraSnapshotRemoteRelayReceiver *)v13 _callDidSaveImageDelegateWithError:v10];
  [(HMDCameraSnapshotReceiver *)v13 _sendConfirmationToResident:&__block_literal_global_48_151353];
}
...
- (void)_callDidSaveImageDelegateWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v24 = 2112;
    v25 = v10;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Calling delegate that download of image %@ has completed with error %@ for session %@", buf, 0x2Au);
  }
  v11 = [MEMORY[0x263F424F0] currentActivity];
...
- (void)_callGettingImageDelegate:(id)a3
{
  ...
  id v10 = [MEMORY[0x263F424F0] currentActivity];
...
- (void)_getSnapshot:(unint64_t)a3
{
  ...
  id v26 = (id)[objc_alloc(MEMORY[0x263F424F0]) initWithName:@"Snapshot Relay Receiver"];
  ...
  if (WeakRetained)
  {
    if (v5)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v15 = 2112;
        id v16 = v5;
        _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Take snapshot relayed to resident has failed: %@", (uint8_t *)&v13, 0x16u);
      }
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v9 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting HMDCameraSnapshotRemoteRelayReceiver", buf, 0xCu);
  }
  v7.receiver = v4;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_151408 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_151408, &__block_literal_global_151409);
  }
  v2 = (void *)logCategory__hmf_once_v2_151410;
  return v2;
}
...
void __51__HMDCameraSnapshotRemoteRelayReceiver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_151410;
  logCategory__hmf_once_v2_151410 = v0;
}
