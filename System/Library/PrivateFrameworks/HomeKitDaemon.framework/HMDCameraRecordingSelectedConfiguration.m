...
- (BOOL)_parseFromTLVData
{
  ...
  v3 = [MEMORY[0x263F35990] wrappertlv:1 name:@"kSelectedConfigurationGeneral"];
  id v4 = [MEMORY[0x263F35990] wrappertlv:2 name:@"kSelectedConfigurationVideo"];
  v5 = [MEMORY[0x263F35990] wrappertlv:3 name:@"kSelectedConfigurationAudio"];
  v21[0] = v3;
  v21[1] = v4;
  v21[2] = v5;
  id v6 = [MEMORY[0x263EFF8C0] arrayWithObjects:v21 count:3];
