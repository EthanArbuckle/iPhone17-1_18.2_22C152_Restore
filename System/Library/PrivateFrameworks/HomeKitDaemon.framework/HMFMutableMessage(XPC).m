...
- (uint64_t)setRequiresWalletKeyEntitlement
{
  return [a1 setUserInfoValue:MEMORY[0x263EFFA88] forKey:@"requiresWalletKeyEntitlement"];
}
...
- (uint64_t)setRequiresPersonManagerEntitlement
{
  return [a1 setUserInfoValue:MEMORY[0x263EFFA88] forKey:@"requiresPersonManagerEntitlement"];
}

- (uint64_t)setRequiresMultiUserSetupEntitlement
{
  return [a1 setUserInfoValue:MEMORY[0x263EFFA88] forKey:@"requiresMultiUserSetupEntitlement"];
}

- (uint64_t)setRequiresCameraClipsEntitlement
{
  return [a1 setUserInfoValue:MEMORY[0x263EFFA88] forKey:@"requiresCameraClipsEntitlement"];
}

- (uint64_t)setRequiresMatterSetupPayloadEntitlement
{
  return [a1 setUserInfoValue:MEMORY[0x263EFFA88] forKey:@"requiresMatterSetupPayloadEntitlement"];
}

- (uint64_t)setRequiresSetupPayloadEntitlement
{
  return [a1 setUserInfoValue:MEMORY[0x263EFFA88] forKey:@"requiresSetupPayloadEntitlement"];
}
