...
+ (id)locationAuthorizedMessageWithName:()LocationMessage messagePayload:
{
  v0 = objc_msgSend(MEMORY[0x263F42590], "messageWithName:messagePayload:");
  [v0 setUserInfoValue:MEMORY[0x263EFFA88] forKey:@"locationAuthorized"];
  v1 = (void *)[v0 copy];
