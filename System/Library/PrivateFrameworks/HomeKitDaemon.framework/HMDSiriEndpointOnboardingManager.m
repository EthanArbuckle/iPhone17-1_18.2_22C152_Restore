  ...
  if (v9)
  {
    ...
    if (!v12)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v32 = 2112;
        id v33 = v7;
        _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@HAP accessory is not found. accessoryUUID: %@", (uint8_t *)&v30, 0x16u);
      }
      goto LABEL_19;
    }
...
LABEL_18:
        _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, v27, (uint8_t *)&v30, 0x16u);
      }
    }
LABEL_19:
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v32 = 2112;
    id v33 = v7;
    _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Accessory is not found. accessoryUUID: %@", (uint8_t *)&v30, 0x16u);
  }
  BOOL v16 = 0;
LABEL_21:
...
void __100__HMDSiriEndpointOnboardingManager__setNeedsOnboardingCompleteWitHomeUUID_accessoryUUID_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v11 = 2112;
      id v12 = v3;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Setting needsOnboarding complete failed with error: %@", (uint8_t *)&v9, 0x16u);
    }
  }
...
void __115__HMDSiriEndpointOnboardingManager__applyOnboardingSelections_accessoryUUID_homeUUID_userUUID_cacheKey_completion___block_invoke(id *a1, void *a2, uint64_t a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v26 = 2114;
    id v27 = v5;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Apply result received from controller: %{public}@ error:%{public}@", buf, 0x20u);
  }
  if (v5 || a3 != 2)
  {
...
void __115__HMDSiriEndpointOnboardingManager__applyOnboardingSelections_accessoryUUID_homeUUID_userUUID_cacheKey_completion___block_invoke_20(uint64_t a1, void *a2)
{
  ...
  if (!v3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v14 = 2112;
      uint64_t v15 = v10;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Removing cached onboarding selections, key: %@", (uint8_t *)&v12, 0x16u);
    }
...
- (void)applyCachedOnboardingSelectionsWithAccessoryUUID:(id)a3 homeUUID:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v43 = 2112;
    id v44 = v6;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Apply cached onboarding selections: homeUUID: %@ accessoryUUID: %@", buf, 0x20u);
  }
  int v12 = [(HMDSiriEndpointOnboardingManager *)v9 dataSource];
  id v13 = [v12 needsOnboardingForHomeUUID:v7 accessoryUUID:v6];
  __int16 v14 = v13;
  if (v13)
  {
    if ([v13 BOOLValue])
    {
      uint64_t v15 = objc_msgSend(MEMORY[0x263F08C38], "hmf_zeroUUID");
      uint64_t v16 = [NSString stringWithFormat:@"%@.%@", v7, v6];
      p_lock = &v9->_lock;
      os_unfair_lock_lock_with_options();
      id v18 = [(NSMutableDictionary *)v9->_onboardingSelections objectForKey:v16];
      BOOL v19 = v18 == 0;
      ...
      if (v19)
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v41 = 2112;
          id v42 = v16;
          _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_INFO, "%{public}@Onboarding selections matching key not found in the cache: %@", buf, 0x16u);
        }
        os_unfair_lock_unlock(p_lock);
      }
      else
      {
        id v20 = [(NSMutableDictionary *)v9->_onboardingSelections objectForKeyedSubscript:v16];
        id v21 = [(NSMutableDictionary *)v9->_onboardingUserUUID objectForKey:v16];
        ...
        else
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v41 = 2112;
            id v42 = v6;
            _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_INFO, "%{public}@It's not ready to apply onboarding. accessoryUUID: %@", buf, 0x16u);
          }
        }
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v41 = 2112;
        id v42 = v6;
        _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_INFO, "%{public}@Onboarding selections are already configured on the accessory: %@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v41 = 2112;
      id v42 = v6;
      _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@Could not determine needsOnboarding state. accessoryUUID: %@", buf, 0x16u);
    }
  }
}
...
LABEL_32:
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v59 = 2112;
    id v60 = v13;
    _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Apply onboarding selections: %@ homeUUID: %@ accessoryUUID: %@", buf, 0x2Au);
  }
  id v21 = [(HMDSiriEndpointOnboardingManager *)v18 dataSource];
  uint64_t v22 = [v21 needsOnboardingForHomeUUID:v14 accessoryUUID:v13];
  id v23 = v22;
  if (v22)
  {
    if ([v22 BOOLValue])
      ...
      if (v25)
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v55 = 2112;
          id v56 = v24;
          _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Onboarding selections are already cached, key: %@", buf, 0x16u);
        }
        v16[2](v16, 0, 1);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_INFO, "%{public}@Caching onboarding selections, key: %@", buf, 0x16u);
        }
        contexta = (void *)MEMORY[0x230FBD990]([(NSMutableDictionary *)v18->_onboardingSelections setObject:v12 forKey:v24]);
        v39 = v26;
        HMFGetOSLogHandle();
        ...
        if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v55 = 2112;
          id v56 = v50;
          _os_log_impl(&dword_22F52A000, v40, OS_LOG_TYPE_INFO, "%{public}@Caching onboarding user UUID %@", buf, 0x16u);
        }
        ...
        {
          os_unfair_lock_t locka = (os_unfair_lock_t)MEMORY[0x230FBD990]();
          id v42 = v39;
          ...
          if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v55 = 2112;
            id v56 = v13;
            _os_log_impl(&dword_22F52A000, v43, OS_LOG_TYPE_INFO, "%{public}@It's not ready to apply onboarding. accessoryUUID: %@", buf, 0x16u);
          }
          v16[2](v16, 0, 3);
        }
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v55 = 2112;
        id v56 = v13;
        _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_INFO, "%{public}@Onboarding selections are already configured on the accessory: %@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v55 = 2112;
      id v56 = v13;
      _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@Could not determine needsOnboarding state. accessoryUUID: %@", buf, 0x16u);
    }
    __int16 v24 = [MEMORY[0x263F087E8] hmfErrorWithCode:2];
...
- (void)handleAccessoryConfigured:(id)a3
{
  ...
  if (v7)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v21 = 2112;
        id v22 = v7;
        _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Accessory is configured with invalid home: %@", (uint8_t *)&v19, 0x16u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      int v19 = 138543362;
      id v20 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Invalid HAP accessory is configured", (uint8_t *)&v19, 0xCu);
    }
  }
}
...
- (void)handleCompositeSettingsControllerConfigured:(id)a3
{
  ...
  if (v8)
  {
    ...
    if (v11)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
        {
          ...
          int v27 = 138543362;
          uint64_t v28 = v26;
          _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@CompositeSettingsController is congigured with invalid homeUUID", (uint8_t *)&v27, 0xCu);
        }
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        int v27 = 138543362;
        uint64_t v28 = v22;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@CompositeSettingsController is congigured with invalid accessoryUUID", (uint8_t *)&v27, 0xCu);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      int v27 = 138543362;
      uint64_t v28 = v18;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@CompositeSettingsController is congigured with invalid homeUUID and ownerUUID info", (uint8_t *)&v27, 0xCu);
    }
  }
}
