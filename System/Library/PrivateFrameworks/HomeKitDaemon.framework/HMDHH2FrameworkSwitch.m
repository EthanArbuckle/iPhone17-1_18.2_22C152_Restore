...
void __50__HMDHH2FrameworkSwitch_handleTapToSetupFinished___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    v15 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Got TTSU finished notification with error: %@", (uint8_t *)&v12, 0x16u);
  }
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    v15 = v3;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Ignoring TTSU notification as either this is on a non-tvOS device or TTSU finished with error: %@", (uint8_t *)&v12, 0x16u);
  }
}
...
void __60__HMDHH2FrameworkSwitch_waitForCloudKitAccountToBeAvailable__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v14 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Wait for the CloudKit account to be available.", buf, 0xCu);
  }
  v7 = *(void **)(a1 + 32);
  id v6 = (id *)(a1 + 32);
...
void __60__HMDHH2FrameworkSwitch_waitForCloudKitAccountToBeAvailable__block_invoke_133(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v21 = 2112;
    id v22 = v6;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Looks like CloudKit account is now available. Performing cloud sync. [%@]", buf, 0x16u);
  }
  ...
  if (v6 || !WeakRetained)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v23 = 2112;
      id v24 = v6;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Error occurred : %@ / %@", buf, 0x20u);
    }
  }
  else
  {
...
- (int64_t)areCloudKitServersReachableWithError:(id *)a3
{
  ...
  id v5 = objc_alloc(MEMORY[0x263EFD620]);
  ...
  id v8 = (void *)[objc_alloc(MEMORY[0x263EFD610]) initWithContainerID:v6 options:v7];
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(void *)((char *)&buf + 4) = v13;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Waiting to check whether CloudKit is reachable or not... Start", (uint8_t *)&buf, 0xCu);
  }
  dispatch_group_enter(v9);
  *(void *)&long long buf = 0;
  *((void *)&buf + 1) = &buf;
  uint64_t v85 = 0x3032000000;
  v86 = __Block_byref_object_copy__180782;
  v87 = __Block_byref_object_dispose__180783;
  id v88 = 0;
  uint64_t v76 = 0;
  v77 = &v76;
  ...
  BOOL v17 = v16 == 0;
  id v22 = (void *)MEMORY[0x230FBD990](v16, v18, v19, v20, v21);
  __int16 v23 = v11;
  if (!v17)
  {
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)v80 = 138543362;
      v81 = v25;
      _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Fetching the CK account info operation timed out.", v80, 0xCu);
    }
LABEL_7:
    int64_t v26 = 0;
    goto LABEL_8;
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)v80 = 138543362;
    v81 = v29;
    _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_INFO, "%{public}@Waiting to check whether CloudKit is reachable or not... End", v80, 0xCu);
  }
  uint64_t v35 = v77[3];
  if (!v35 || *(void *)(*((void *)&buf + 1) + 40))
  {
    v36 = (void *)MEMORY[0x230FBD990](v30, v31, v32, v33, v34);
    v37 = v23;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)v80 = 138543618;
      ...
      __int16 v82 = 2112;
      uint64_t v83 = v40;
      _os_log_impl(&dword_22F52A000, v38, OS_LOG_TYPE_ERROR, "%{public}@CK account fetch info resulted into error : %@", v80, 0x16u);
    }
    if (a3)
    {
      int64_t v26 = 0;
  ...
  switch(v35)
  {
    case 1:
      ...
      v54 = (void *)MEMORY[0x230FBD990](v30, v31, v32, v33, v34);
      v55 = v23;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)v80 = 138543362;
        v81 = v57;
        _os_log_impl(&dword_22F52A000, v56, OS_LOG_TYPE_ERROR, "%{public}@CK account status available but need to verify terms", v80, 0xCu);
      }
      goto LABEL_35;
    case 2:
      v41 = (void *)MEMORY[0x230FBD990](v30, v31, v32, v33, v34);
      v42 = v23;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)v80 = 138543362;
        v81 = v44;
        _os_log_impl(&dword_22F52A000, v43, OS_LOG_TYPE_ERROR, "%{public}@CK account status is restricted", v80, 0xCu);
      }
      int64_t v26 = 2;
      break;
    case 3:
      v45 = (void *)MEMORY[0x230FBD990](v30, v31, v32, v33, v34);
      v46 = v23;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)v80 = 138543362;
        v81 = v48;
        _os_log_impl(&dword_22F52A000, v47, OS_LOG_TYPE_ERROR, "%{public}@CK account status is not signed in", v80, 0xCu);
      }
      int64_t v26 = 3;
      break;
    case 4:
      if (*((unsigned char *)v73 + 24))
      {
        ...
        v50 = (void *)MEMORY[0x230FBD990](v30, v31, v32, v33, v34);
        v51 = v23;
        if (v49)
        {
          HMFGetOSLogHandle();
          ...
          if (os_log_type_enabled(v60, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)v80 = 138543362;
            v81 = v61;
            _os_log_impl(&dword_22F52A000, v60, OS_LOG_TYPE_ERROR, "%{public}@CK account status is temporarily unavailable", v80, 0xCu);
          }
          int64_t v26 = 4;
        }
        else
        {
          ...
          if (os_log_type_enabled(v52, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)v80 = 138543362;
            v81 = v53;
            _os_log_impl(&dword_22F52A000, v52, OS_LOG_TYPE_ERROR, "%{public}@CK account status is need to verify terms", v80, 0xCu);
          }
          int64_t v26 = 6;
        }
      }
      else
      {
        ...
        if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)v80 = 138543362;
          v81 = v59;
          _os_log_impl(&dword_22F52A000, v56, OS_LOG_TYPE_ERROR, "%{public}@CK account status is invalid credentials", v80, 0xCu);
        }
LABEL_35:
...
void __62__HMDHH2FrameworkSwitch_areCloudKitServersReachableWithError___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v16 = 2112;
    id v17 = v6;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@CK account fetch info completed with : %@", (uint8_t *)&v14, 0x16u);
  }
...
- (BOOL)switchToSetupMode:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v24 = 2048;
    uint64_t v25 = v6;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Switching to setup mode: %lu, current mode: %lu", (uint8_t *)&v20, 0x20u);
  }
  if (v6 == a3 || a3 == 2 && !v6)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v20 = 138543362;
      uint64_t v21 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Already in requested setup mode", (uint8_t *)&v20, 0xCu);
    }
    return 1;
  }
  else
...
- (void)switchToHH2AndRelaunchHomedToPerformHH2Migration
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    id v8 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Switching to HH2 framework and relaunching homed in order to perform HH2 migration", (uint8_t *)&v7, 0xCu);
  }
...
- (void)removeHH2SentinelZoneWithCompletion:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)long long buf = 138543362;
    uint64_t v34 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Request to remove HH2 sentinel zone received", buf, 0xCu);
  }
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      uint64_t v34 = v22;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Cloud database is nil. Cannot perform initial sync. (c)", buf, 0xCu);
    }
  ...
  else
  {
    ...
    id v13 = objc_msgSend(v12, "na_firstObjectPassingTest:", &__block_literal_global_180801);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)long long buf = 138543362;
        uint64_t v34 = v26;
        _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@HH2 Sentinel zone does not exist", buf, 0xCu);
      }
      dispatch_time_t v15 = [MEMORY[0x263F087E8] hmfErrorWithCode:2];
      if (v4) {
        v4[2](v4, v15);
      }
    }
...
void __61__HMDHH2FrameworkSwitch_removeHH2SentinelZoneWithCompletion___block_invoke_106(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v11 = 138543362;
    id v12 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@HH2 sentinel zone removed successfully.", (uint8_t *)&v11, 0xCu);
  }
...
void __61__HMDHH2FrameworkSwitch_removeHH2SentinelZoneWithCompletion___block_invoke_110(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
  {
    ...
    int v11 = 138543362;
    id v12 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@Unable to delete HH2 sentinel zone from cloud database.", (uint8_t *)&v11, 0xCu);
  }
  [v7 waitForCloudKitAccountToBeAvailable];
  uint64_t v10 = *(void *)(a1 + 32);
  if (v10) {
...
void __58__HMDHH2FrameworkSwitch_waitForHH2SentinelZoneToBeRemoved__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v10 = 2112;
    id v11 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@HH2 sentinel zone removal status : %@", (uint8_t *)&v8, 0x16u);
  }
  dispatch_group_leave(*(dispatch_group_t *)(a1 + 40));
}
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)long long buf = 138544130;
      ...
      __int16 v31 = 2112;
      id v32 = v17;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Going to check our current environment: [doesSentinelZoneExist = %@] [current User HK Preference = %@] [setupMode = %@]", buf, 0x2Au);
    ...
    if (v18 == 1 && v6 != v8)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)long long buf = 138543362;
        uint64_t v26 = v22;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Looks like we are in wrong world. Let's make things right.", buf, 0xCu);
      }
      BOOL v7 = 0;
    }
  }
...
- (void)_makeSureWeAreRunningInRightEnvironment:(BOOL)a3
{
    ...
    if (![(HMDHH2FrameworkSwitch *)self _areWeRunningInRightEnvironment:v3])
    {
      if (v3 || [(HMDHH2FrameworkSwitch *)self checkExistenceOfHH2SentinelZone])
      {
        ...
        if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
        {
          ...
          int v20 = 138543362;
          uint64_t v21 = v10;
          _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Sentinel zone exist which mean we should be running HH2 world. Relaunching ourselves in HH2 world", (uint8_t *)&v20, 0xCu);
        }
        logger = v8->_logger;
        if (os_signpost_enabled(logger))
        {
          LOWORD(v20) = 0;
          _os_signpost_emit_with_name_impl(&dword_22F52A000, logger, OS_SIGNPOST_EVENT, 0xEEEEB0B5B2B2EEEELL, "ReadyToSwitchToHH2", "", (uint8_t *)&v20, 2u);
        }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      int v20 = 138543362;
      uint64_t v21 = v17;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Not enforcing HK environment as auto-switch is OFF", (uint8_t *)&v20, 0xCu);
    }
  }
}
...
- (void)cloudDatabase:(id)a3 didCreateZoneWithID:(id)a4
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      int v18 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@created / synced HH2 sentinel zone", buf, 0xCu);
    }
...
- (BOOL)checkExistenceOfHH2SentinelZone
{
  ...
  long long v17 = 0u;
  long long v18 = 0u;
  uint64_t v4 = [(HMDHH2FrameworkSwitch *)self cloudDatabaseToDetectHH2Zone];
  id v5 = [v4 privateZoneIDs];
  ...
  if (v6)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        int v10 = [*(id *)(*((void *)&v15 + 1) + 8 * i) zoneID];
        id v11 = [v10 zoneName];
...
- (BOOL)waitForHH2SentinelZoneToBeCreated:(double)a3 error:(id *)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    LODWORD(buf) = 138543362;
    *(void *)((char *)&buf + 4) = v10;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Going to create sentinel Zone", (uint8_t *)&buf, 0xCu);
  }
  ...
  *((void *)&buf + 1) = &buf;
  ...
  v45 = __Block_byref_object_copy__180782;
  v46 = __Block_byref_object_dispose__180783;
  id v47 = 0;
  ...
  if (v14)
  {
    long long v18 = (void *)MEMORY[0x230FBD990](v14, v15, v16, v17);
    uint64_t v19 = v8;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)v39 = 138543362;
      uint64_t v40 = v21;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Timed out while creating the HH2 sentinel zone.", v39, 0xCu);
    }
    if (a4)
    {
      objc_msgSend(MEMORY[0x263F087E8], "hmErrorWithCode:", 8, v33, v34, v35, v36);
...
LABEL_13:
  ...
  int v24 = (void *)MEMORY[0x230FBD990](0, v15, v16, v17);
  uint64_t v25 = v8;
  if (!v23)
  {
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)v39 = 138543618;
      ...
      __int16 v41 = 2112;
      uint64_t v42 = v28;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Unable to create Sentinel zone due to %@", v39, 0x16u);
    }
    if (a4)
    {
...
LABEL_14:
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)v39 = 138543362;
    uint64_t v40 = v31;
    _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_INFO, "%{public}@Successfully created sentinel Zone", v39, 0xCu);
  }
  BOOL v29 = 1;
LABEL_18:
...
- (void)createHH2SentinelZoneWithCompletionHandler:(id)a3
{
  ...
  if (v5)
  {
    ...
    uint64_t v7 = (void *)[v6 initWithZoneName:@"HH2-CD9D5508-EAED-4462-A7CB-AFB779F35A71" ownerName:*MEMORY[0x263EFD488]];
    id v8 = objc_alloc(MEMORY[0x263F49278]);
    ...
    char v12 = [(HMDHH2FrameworkSwitch *)self cloudDatabaseToDetectHH2Zone];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      uint64_t v26 = v20;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Cloud database is nil. Cannot perform initial sync. (b)", buf, 0xCu);
    }
    uint64_t v7 = [MEMORY[0x263F087E8] hmErrorWithCode:20];
    if (v4) {
...
- (void)performInitialSync:(id)a3
{
  ...
  if (v5)
  {
    ...
    uint64_t v7 = [v6 performInitialCloudSync];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(id *)((char *)location + 4) = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Cloud database is nil. Cannot perform initial sync. (a)", (uint8_t *)location, 0xCu);
    }
    uint64_t v7 = [MEMORY[0x263F087E8] hmErrorWithCode:20];
    if (v4) {
      (*((void (**)(id, void *))v4 + 2))(v4, v7);
...
void __44__HMDHH2FrameworkSwitch_performInitialSync___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    id v11 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Initial cloud sync finished on HH2 cloud database.", (uint8_t *)&v10, 0xCu);
  }
...
void __44__HMDHH2FrameworkSwitch_performInitialSync___block_invoke_104(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
  {
    ...
    int v10 = 138543362;
    id v11 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@Unable to perform initial sync on cloud database to determine sentinel zone.", (uint8_t *)&v10, 0xCu);
  }
  uint64_t v9 = *(void *)(a1 + 32);
  if (v9) {
...
- (BOOL)waitForHH2SentinelZoneToBeFetchedFromCloud
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)long long buf = 138543362;
    uint64_t v27 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Waiting for Initial sync to finish... Start", buf, 0xCu);
  }
  dispatch_group_enter(v3);
...
LABEL_8:
      _os_log_impl(&dword_22F52A000, v21, v22, v20, buf, 0xCu);
    }
  }
...
- (void)forceFetchSentinelZone
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)long long buf = 138543362;
    id v19 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Force fetching sentinel zone", buf, 0xCu);
  }
  id v7 = objc_alloc(MEMORY[0x263EFD808]);
  int v8 = (void *)[v7 initWithZoneName:@"HH2-CD9D5508-EAED-4462-A7CB-AFB779F35A71" ownerName:*MEMORY[0x263EFD488]];
  id v9 = objc_alloc(MEMORY[0x263F49278]);
  ...
  uint64_t v14 = [MEMORY[0x263EFFA08] setWithObject:v12];
...
void __47__HMDHH2FrameworkSwitch_forceFetchSentinelZone__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v16 = 2112;
    id v17 = v6;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Force fetch sentinel zone on HH1 container finished with error: %@", (uint8_t *)&v14, 0x16u);
  }
...
void __71__HMDHH2FrameworkSwitch_performInitialSyncAndSwitchFrameworkIfRequired__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)long long buf = 138543618;
    ...
    __int16 v25 = 2112;
    id v26 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Initial sync on HH1 container finished with error: %@", buf, 0x16u);
  }
  if (v3)
  {
    id v8 = (void *)MEMORY[0x230FBD990]();
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543618;
      ...
      __int16 v25 = 2112;
      id v26 = v3;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not perform initial sync : %@", buf, 0x16u);
    }
  ...
  {
    if (![*(id *)(a1 + 32) autoFrameworkSwitch]) {
      goto LABEL_18;
    }
    if (![*(id *)(a1 + 32) checkExistenceOfHH2SentinelZone])
    {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      id v24 = v21;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Skip force fetching sentinel zone from the cloud since it is already in the local database", buf, 0xCu);
    }
    __int16 v16 = [*(id *)(a1 + 32) fetchSentinelZoneDidFinishFuture];
...
- (void)createHH2CloudDatabaseAndStartSyncing
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v24 = 2112;
    __int16 v25 = v7;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Creating the Cloud database to detect HH2 cloud zone & will start sync after that. [Auto Switch: %@]", (uint8_t *)&v22, 0x16u);
  }
  id v8 = objc_alloc(MEMORY[0x263EFD620]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_FAULT))
    {
      ...
      __int16 v24 = 2114;
      __int16 v25 = v9;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_FAULT, "%{public}@Failed to create cloud database with containerID %{public}@", (uint8_t *)&v22, 0x16u);
    }
    id v19 = [MEMORY[0x263F087E8] hmfErrorWithCode:2 reason:@"Failed to create cloud database"];
    uint64_t v20 = [(HMDHH2FrameworkSwitch *)v16 homeManager];
    uint64_t v21 = [v20 currentAccessorySetupMetricDispatcher];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t46_180865 != -1) {
    dispatch_once(&logCategory__hmf_once_t46_180865, &__block_literal_global_126_180866);
  }
  v2 = (void *)logCategory__hmf_once_v47_180867;
  return v2;
}
...
void __36__HMDHH2FrameworkSwitch_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v47_180867;
  logCategory__hmf_once_v47_180867 = v0;
}
...
+ (id)errorFromHMDCKAccountStatus:(int64_t)a3
{
  ...
  {
    id v5 = objc_msgSend(MEMORY[0x263F087E8], "hmPrivateErrorWithCode:", qword_2303E45A0[a3 - 2], v3);
  }
  return v5;
}
...
{
  uint64_t v9 = *MEMORY[0x263EF8340];
  uint64_t v3 = (void *)MEMORY[0x230FBD990](a1, a2);
  id v4 = a1;
  id v5 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    id v8 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Switching to HH2 framework and relaunching homed", (uint8_t *)&v7, 0xCu);
  }
...
+ (void)switchBackToHH1AndRelaunchDueToHH2MigrationFailed
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v7 = 138543362;
    id v8 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Switching back to HK 1.0 framework as migration to HH2 failed", (uint8_t *)&v7, 0xCu);
  }
...
+ (void)switchBackToHH1AndDoNotLaunchDueToPrimaryAccountRemoval
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v7 = 138543362;
    id v8 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Switching back to HK 1.0 framework as primary account got removed. HomeKitDaemon will not be relaunched.", (uint8_t *)&v7, 0xCu);
  }
...
+ (void)relaunchHomedAfterSettingEnvironmentTo:(BOOL)a3 blockToExecuteBeforeReLaunch:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)long long buf = 138543618;
    ...
    __int16 v32 = 2112;
    uint64_t v33 = v12;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Going to relaunch homed in : [%@]", buf, 0x16u);
  }
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)long long buf = 138543618;
      ...
      __int16 v32 = 2112;
      uint64_t v33 = v19;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Calling block : %@", buf, 0x16u);
    }
    uint64_t v20 = dispatch_get_global_queue(0, 0);
    uint64_t v21 = (void *)[objc_alloc(MEMORY[0x263F42520]) initWithQueue:v20];
...
void __93__HMDHH2FrameworkSwitch_relaunchHomedAfterSettingEnvironmentTo_blockToExecuteBeforeReLaunch___block_invoke_2(uint64_t a1)
{
  ...
  uint64_t v3 = (void *)MEMORY[0x230FBD990](v2);
  id v4 = *(id *)(a1 + 32);
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v8 = 138543362;
    uint64_t v9 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@See you on the other side - restarting...", (uint8_t *)&v8, 0xCu);
  }
...
+ (void)setHH2SettingsMigrationKey:(BOOL)a3
{
  BOOL v3 = a3;
  uint64_t v15 = *MEMORY[0x263EF8340];
  char v5 = (void *)MEMORY[0x230FBD990](a1, a2);
  id v6 = a1;
  int v7 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Setting HH2 settings migration key to %@", (uint8_t *)&v11, 0x16u);
  }
...
+ (void)setHH2EnablementPreferenceKey:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Setting HH2 preference value to %@", (uint8_t *)&v11, 0x16u);
  }
  uint64_t v10 = (CFPropertyListRef *)MEMORY[0x263EFFB40];
  if (!v3) {
    uint64_t v10 = (CFPropertyListRef *)MEMORY[0x263EFFB38];
  }
