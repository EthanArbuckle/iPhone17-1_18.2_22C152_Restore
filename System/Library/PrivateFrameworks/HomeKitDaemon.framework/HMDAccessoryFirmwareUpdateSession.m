  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v21 = 2112;
      v22 = v6;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@No staged firmware in accessory %@", buf, 0x16u);
    }
    v13 = [MEMORY[0x263F087E8] hmErrorWithCode:3 description:0 reason:@"No staged firmware in accessory" suggestion:0];
...
void __56__HMDAccessoryFirmwareUpdateSession_rescindStagedAsset___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v3;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to rescind staged firmware for UARP accessory %@", (uint8_t *)&v12, 0x16u);
    }
    v11 = [MEMORY[0x263F087E8] hmErrorWithCode:58 description:0 reason:@"Failed to rescind staged firmware for UARP accessory %@" suggestion:0];
    (*(void (**)(void))(*(void *)(a1 + 48) + 16))();
  }
}
...
void __56__HMDAccessoryFirmwareUpdateSession_rescindStagedAsset___block_invoke_174(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v10 = 2112;
    id v11 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error opening socket for UARP communication: %@", (uint8_t *)&v8, 0x16u);
  }
...
- (void)_logDebugStates:(const char *)a3
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138546434;
    ...
    __int16 v59 = 2114;
    v60 = v24;
    _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@%@ States <Session internal %@, next %@, accessory %@, SU %@> Versions <available %@, staged %@ (last %@), accessory %@, asset %{public}@> Not Ready Reasons <Stage (%{public}@) Apply (%{public}@)>", buf, 0x84u);
...
uint64_t __51__HMDAccessoryFirmwareUpdateSession_logDebugStates__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    id v18 = v9;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory: %@, asset: %@, auto update: %@", (uint8_t *)&v11, 0x2Au);
  }
...
- (void)socket:(id)a3 didFailWithError:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v22 = 2112;
    id v23 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@HDS socket %@ closed: %@ failed for accessory %@ with error %@", (uint8_t *)&v14, 0x34u);
  }
  if (v6 && [v6 isClosed]) {
    ...
    && !CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)|| (-[HMDAccessoryFirmwareUpdateSession hapAccessory](self, "hapAccessory"), id v6 = objc_claimAutoreleasedReturnValue(), v7 = [v6 supportsCHIP], v6, !v7))
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(void *)&v42[14] = v17;
      ...
      __int16 v45 = 2112;
      v46 = v20;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@HDS socket closed in state %@ for %@accessory %@", v42, 0x2Au);
    }
    ...
    _os_log_impl(&dword_22F52A000, v33, v34, v32, v42, 0xCu);
...
LABEL_32:
    ...
    }
    {
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)uint64_t v42 = 138543362;
        *(void *)&v42[4] = v41;
        _os_log_impl(&dword_22F52A000, v40, OS_LOG_TYPE_DEFAULT, "%{public}@Registration complete", v42, 0xCu);
      }
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    *(void *)&v42[14] = "-[HMDAccessoryFirmwareUpdateSession socketDidClose:]";
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@%s: Matter accessory does not use this function", v42, 0x16u);
  }
LABEL_33:
}
...
- (void)_handleApplyTimerFired
{
  ...
  id v5 = (void *)MEMORY[0x230FBD990]([(HMDAccessoryFirmwareUpdateSession *)self setUserInitiatedInstall:0]);
  id v6 = self;
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v25 = 2112;
    char v26 = v11;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Apply timer fired for %@ %@ install", buf, 0x20u);
  }
  ...
  if ([(HMDAccessoryFirmwareUpdateSession *)v6 isFirmwareVersionUpToDate])
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v22 = v15;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Firmware is up to date", buf, 0xCu);
    }
  }
  else
  {
...
LABEL_8:
  ...
  id v5 = (void *)MEMORY[0x230FBD990](objc_msgSend(WeakRetained, "setCurrentAutomaticApplyRetriesCount:", objc_msgSend(WeakRetained, "currentAutomaticApplyRetriesCount") + 1));
  id v6 = WeakRetained;
  int v7 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v19 = 2112;
    BOOL v20 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Firmware is still not applied after apply timer fired: retries count=%@", buf, 0x16u);
  }
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v18 = v13;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Out of retries for automatic apply", buf, 0xCu);
  }
  [v11 _endSession];
LABEL_19:
}
...
LABEL_4:
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, v8, buf, 0xCu);
...
void __58__HMDAccessoryFirmwareUpdateSession__verifyUpdateComplete__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v27 = 138543362;
    v28 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Asking UARP for Apply Results", (uint8_t *)&v27, 0xCu);
  }
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      int v27 = 138543362;
      v28 = v12;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Start the timer for querying result", (uint8_t *)&v27, 0xCu);
    }
    id v13 = objc_alloc(MEMORY[0x263F42658]);
    dispatch_time_t v14 = [MEMORY[0x263F42608] sharedPreferences];
...
void __58__HMDAccessoryFirmwareUpdateSession__verifyUpdateComplete__block_invoke_133(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v10 = 2112;
      id v11 = v3;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error opening HDS socket: %@", (uint8_t *)&v8, 0x16u);
    }
  }
        ...
        else
        {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
            {
              ...
              int v20 = 138543362;
              uint64_t v21 = v19;
              _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Unknown timer", (uint8_t *)&v20, 0xCu);
            }
          }
        }
      }
     ...
     || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0))&& (-[HMDAccessoryFirmwareUpdateSession hapAccessory](self, "hapAccessory"), v7 = objc_claimAutoreleasedReturnValue(), int v8 = [v7 supportsCHIP], v7, v8))
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@%s: Matter Accessory responsible for staging firmware. No action taken.", buf, 0x16u);
    }
  }
  else
  {
...
void __78__HMDAccessoryFirmwareUpdateSession_stagedFirmwareRescindComplete_withStatus___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v14 = 2112;
    uint64_t v15 = v8;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Staged firmware rescinded with status: %@ for accessory %@", (uint8_t *)&v10, 0x20u);
  }
...
void __85__HMDAccessoryFirmwareUpdateSession_firmwareUpdateResult_vendorSpecificStatus_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v16 = 2112;
    unsigned int v17 = v8;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Results from apply accessory %@ status %@", (uint8_t *)&v12, 0x20u);
  }
...
- (void)firmwareStagingComplete:(id)a3 assetID:(id)a4 withStatus:(unint64_t)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v24 = 2112;
    __int16 v25 = v14;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEBUG, "%{public}@firmwareStagingComplete called with status %@", buf, 0x16u);
  }
    ...
    case 0:
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        ...
        _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_DEFAULT, "%{public}@Asset staging complete", buf, 0xCu);
      }
      ...
      if (v7)
      {
        if (v11)
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v51 = 2112;
          uint64_t v52 = v15;
          _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Staging %@ for asset %@", buf, 0x20u);
        }
      ...
      else
      {
        if (v11)
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v53 = 2112;
          v54 = v33;
          _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Ignoring Staging %@ for asset %@ with current asset %@", buf, 0x2Au);
        }
      }
LABEL_32:
...
LABEL_28:
        _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_DEFAULT, v46, buf, 0xCu);
      }
LABEL_29:
    ...
    case 5:
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        ...
        _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Update canceled", buf, 0xCu);
      }
    ...
    default:
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v51 = 2112;
        uint64_t v52 = v29;
        _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Staging completion status %@ not handled for accessory %@", buf, 0x20u);
      }
      [v25 _endSession];
      goto LABEL_32;
  }
...
- (void)firmwareStagingProgress:(id)a3 assetID:(id)a4 bytesSent:(unint64_t)a5 bytesTotal:(unint64_t)a6
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v24 = 2112;
    id v25 = v17;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEBUG, "%{public}@firmwareStagingProgress called for accessory %@ %@/%@ bytes sent", (uint8_t *)&v18, 0x2Au);
  }
}
...
void __80__HMDAccessoryFirmwareUpdateSession_assetAvailablityUpdateForAccessory_assetID___block_invoke(id *a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544898;
    ...
    __int16 v138 = 2112;
    id v139 = v12;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@assetAvailabilityUpdate called with firmware %{public}@,  status: <%{public}@, %{public}s> releaseNotes status: <%{public}@, %{public}s> for asset %@", buf, 0x48u);
  }
...
LABEL_9:
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138544386;
        ...
        __int16 v134 = 2112;
        v135 = v16;
        _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Ignoring assetAvailability with asset version %@: current asset %@, accessory %@, staged %@", buf, 0x34u);
...
LABEL_21:
  ...
  if ([a1[4] downloadStatus] == 2)
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v127 = v36;
      _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_ERROR, "%{public}@Firmware failed to download", buf, 0xCu);
  ...
  v38 = (void *)MEMORY[0x230FBD990](objc_msgSend(v4, "setUserInitiatedStaging:", objc_msgSend(a1[5], "userInitiatedFirmwareStaging")));
  id v39 = v4;
  v40 = HMFGetOSLogHandle();
  v124 = v16;
  if (os_log_type_enabled(v40, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v128 = 2112;
    v129 = v45;
    _os_log_impl(&dword_22F52A000, v40, OS_LOG_TYPE_DEBUG, "%{public}@userInitiatedFirmwareStaging: %@", buf, 0x16u);
...
LABEL_30:
    ...
    if (os_log_type_enabled(v58, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v127 = v59;
      _os_log_impl(&dword_22F52A000, v58, OS_LOG_TYPE_DEFAULT, "%{public}@No asset download needed", buf, 0xCu);
  ...
  switch([a1[4] updateAvailabilityStatus])
  {
    case 1:
      ...
      if (os_log_type_enabled(v62, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v130 = 2112;
        v131 = v66;
        _os_log_impl(&dword_22F52A000, v62, OS_LOG_TYPE_DEFAULT, "%{public}@telling uarpController to download asset for accessory:%@ assetID:%@", buf, 0x20u);
      ...
      uint64_t v67 = MEMORY[0x230FBD990]([v61 setUserInitiatedInstall:0]);
      }
      id v68 = v61;
      ...
      if (os_log_type_enabled(v69, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v130 = 2112;
        v131 = v72;
        _os_log_impl(&dword_22F52A000, v69, OS_LOG_TYPE_ERROR, "%{public}@downloadAvailableFirmwareUpdate failed for accessory:%@ assetID:%@", buf, 0x20u);
    ...
    case 2:
      ...
      if (os_log_type_enabled(v76, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v127 = v77;
        _os_log_impl(&dword_22F52A000, v76, OS_LOG_TYPE_DEFAULT, "%{public}@Firmware downloading", buf, 0xCu);
    ...
    case 3:
      ...
      if (os_log_type_enabled(v79, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v128 = 2114;
        v129 = v84;
        _os_log_impl(&dword_22F52A000, v79, OS_LOG_TYPE_DEFAULT, "%{public}@Firmware downloaded to %{public}@", buf, 0x16u);
...
LABEL_48:
      _os_log_impl(&dword_22F52A000, v47, OS_LOG_TYPE_ERROR, v53, buf, 0x16u);
...
LABEL_54:
      _os_log_impl(&dword_22F52A000, v90, v91, v89, buf, 0xCu);
...
LABEL_55:
  ...
  else
  {
    switch([a1[4] releaseNotesAvailabilityStatus])
    {
      case 1:
        ...
        if (os_log_type_enabled(v100, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v130 = 2112;
          v131 = v103;
          _os_log_impl(&dword_22F52A000, v100, OS_LOG_TYPE_DEFAULT, "%{public}@telling uarpController to download release notes for accessory:%@ assetID:%@", buf, 0x20u);
        ...
        if (os_log_type_enabled(v106, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v130 = 2112;
          v131 = v109;
          _os_log_impl(&dword_22F52A000, v106, OS_LOG_TYPE_ERROR, "%{public}@Download of release notes failed for accessory:%@ assetID:%@", buf, 0x20u);
      ...
      case 3:
        ...
        if (os_log_type_enabled(v113, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v128 = 2114;
          v129 = v115;
          _os_log_impl(&dword_22F52A000, v113, OS_LOG_TYPE_DEFAULT, "%{public}@Release notes downloaded to %{public}@", buf, 0x16u);
      ...
      case 8:
        v121 = v20;
        uint64_t v92 = MEMORY[0x230FBD990]();
        id v93 = v122;
...
LABEL_72:
        _os_log_impl(&dword_22F52A000, v94, OS_LOG_TYPE_ERROR, v97, buf, 0x16u);
     ...
     || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0))&& (-[HMDAccessoryFirmwareUpdateSession hapAccessory](self, "hapAccessory"), id v4 = objc_claimAutoreleasedReturnValue(), v5 = [v4 supportsCHIP], v4, v5))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@%s: called on accessory that supports Matter", buf, 0x16u);
    }
...
void __46__HMDAccessoryFirmwareUpdateSession__register__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v42 = 2112;
    id v43 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Register accessory failed for %@ - couldn't open socket error:%@", buf, 0x20u);
  }
  if ((unint64_t)[*(id *)(a1 + 32) currentRegisterFailureCount] < 0xA)
  {
    uint64_t v15 = (void *)MEMORY[0x230FBD990](objc_msgSend(*(id *)(a1 + 32), "setCurrentRegisterFailureCount:", objc_msgSend(*(id *)(a1 + 32), "currentRegisterFailureCount") + 1));
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      id v39 = v17;
      __int16 v40 = 2112;
      __int16 v41 = &unk_26E472580;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Rescheduling register in %@ seconds", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (v10)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v39 = v14;
        _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Register retry timer is active", buf, 0xCu);
      }
    }
    else
    {
      __int16 v20 = [MEMORY[0x263F42608] sharedPreferences];
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v40 = 2112;
        __int16 v41 = v29;
        _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_DEFAULT, "%{public}@Waiting up to %@ hours to retry registering accessory", buf, 0x16u);
      }
     ...
     || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0))&& (-[HMDAccessoryFirmwareUpdateSession hapAccessory](self, "hapAccessory"), v5 = objc_claimAutoreleasedReturnValue(), int v6 = [v5 supportsCHIP], v5, v6))
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@%s: Matter accessory does not use this function", buf, 0x16u);
    }
  }
  else
  {
...
void __58__HMDAccessoryFirmwareUpdateSession_socketDidReceiveData___block_invoke(uint64_t a1)
{
  ...
  if (v5)
  {
    ...
    *(void *)&long long v6 = 138543874;
    ...
    while (1)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_DEBUG, "%{public}@HDS socket received %@ bytes", buf, 0x16u);
      }
      ...
      if ((v14 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = v28;
          ...
          __int16 v35 = 2112;
          id v36 = v15;
          _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Couldn't send data from accessory %@ to controller: %@", buf, 0x20u);
        }
    ...
    double v24 = (void *)MEMORY[0x230FBD990]([v17 setDataStreamSocket:0]);
    id v25 = v17;
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v32 = v27;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Socket closed", buf, 0xCu);
    }
  }
LABEL_14:
...
- (BOOL)sendMessageToAccessory:(id)a3 uarpMsg:(id)a4 error:(id *)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v34 = 2112;
    __int16 v35 = v14;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEBUG, "%{public}@sendMessageToAccessory called with %@ bytes", buf, 0x16u);
  }
  if (((_os_feature_enabled_impl() & 1) != 0
     || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0))&& (-[HMDAccessoryFirmwareUpdateSession hapAccessory](v11, "hapAccessory"), id v15 = objc_claimAutoreleasedReturnValue(), v16 = [v15 supportsCHIP], v15, v16))
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@%s: Matter accessory does not use this function", buf, 0x16u);
    }
    char v21 = 0;
  }
  else
  {
    ...
    else
    {
      if (a5)
      {
        *a5 = [MEMORY[0x263F087E8] hmErrorWithCode:54 description:0 reason:@"Socket not open" suggestion:0];
      }
      double v24 = (void *)MEMORY[0x230FBD990]();
      id v25 = v11;
      id v26 = HMFGetOSLogHandle();
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        __int16 v33 = v27;
        _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@sendMessageToAccessory: Socket not open", buf, 0xCu);
      }
      char v21 = 0;
    }
  }
...
- (id)newDocumentationMetadata
{
  ...
  if ([(HMDAccessoryFirmwareUpdateSession *)self documentationAvailable])
  {
    ...
    if (v17)
    {
      id v19 = objc_alloc(MEMORY[0x263F0E7F0]);
      __int16 v20 = (void *)[objc_alloc(MEMORY[0x263F42518]) initWithAlgorithm:2 value:v17];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v33 = 2112;
        id v34 = v18;
        _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Couldn't create digest for URLs local %@ remote: %@ error: %@", buf, 0x2Au);
      }
      int v16 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v29 = 2112;
      id v30 = v15;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEBUG, "%{public}@No documentation available for %@", buf, 0x16u);
    }
    return 0;
  }
  return v16;
...
- (id)newSoftwareUpdateWithState:(int64_t)a3
{
  ...
  if (!v13)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v51 = 2112;
      uint64_t v52 = v18;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@No release date set for asset, using current date - assetID %@", buf, 0x16u);
    }
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138545154;
    ...
    __int16 v63 = 2112;
    v64 = v31;
    _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Creating SoftwareUpdate with version %@, state %@, downloadSize %@(uarpAccessory downloadSize %@), documentation %@, release date %@, duration %@", buf, 0x52u);
...
- (void)_updateAvailableSoftwareUpdateDocumentation
{
  ...
  if (v3)
  {
    ...
    if (!v5)
    {
      ...
      [v6 updateSoftwareUpdate:v5 completionHandler:&__block_literal_global_111_179110];
    }
  }
LABEL_6:
}
...
- (void)_updateAvailableSoftwareUpdateState:(int64_t)a3
{
  ...
  if (!v7)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v43 = 2112;
      int64_t v44 = v36;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Not updating state from %@ to %@ because update firmware version is not set by UARP", (uint8_t *)&v39, 0x20u);
    }
  ...
  {
    uint64_t v8 = MEMORY[0x230FBD990]();
    id v9 = self;
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      if ((unint64_t)(v12 - 1) > 4) {
        ...
        uint64_t v13 = off_264A23E58[v12 - 1];
      }
      int v39 = 138543618;
      __int16 v40 = v11;
      __int16 v41 = 2112;
      __int16 v42 = v13;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Not updating state from %@ to downloaded because firmware version is up to date", (uint8_t *)&v39, 0x16u);
    }
...
LABEL_24:
        ...
        v17))
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      if (v22 > 4) {
        ...
        uint64_t v23 = off_264A23E58[v22];
      }
      ...
      __int16 v43 = 2112;
      int64_t v44 = v38;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Updating available software update state from %@ to %@", (uint8_t *)&v39, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v41 = 2112;
      __int16 v42 = v34;
      _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_INFO, "%{public}@New available software update with state %@", (uint8_t *)&v39, 0x16u);
    }
    ...
    [v6 updateSoftwareUpdate:v35 completionHandler:&__block_literal_global_109_179116];
  }
LABEL_29:
}
...
void __72__HMDAccessoryFirmwareUpdateSession_updateAvailableSoftwareUpdateState___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v16 = 2112;
      int v17 = v11;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Not updating available software update state from %@ to %@ because apply timer is active", (uint8_t *)&v12, 0x20u);
    }
  }
  else
  {
...
- (void)_resetAvailableSoftwareUpdate
{
  ...
  if (v4) {
    [v5 updateSoftwareUpdate:0 completionHandler:&__block_literal_global_107_179119];
  }
}
...
LABEL_8:
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v48 = 2112;
      __int16 v49 = v9;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Session available firmware version (%@) is older than either current accessory version (%@) or the staged version (%@)", buf, 0x2Au);
...
LABEL_39:
      if ([v4 isEqualToVersion:v8])
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          __int16 v43 = v28;
          _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Session available firmware version is the same as the current accessory version. Software Update has been installed.", buf, 0xCu);
        }
        __int16 v29 = v26;
        uint64_t v30 = 4;
LABEL_23:
      ...
      if ([v4 isEqualToVersion:v9])
      {
        ...
        if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          __int16 v43 = v34;
          _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_INFO, "%{public}@Session available firmware version is staged on accessory. Software Update has been downloaded.", buf, 0xCu);
        }
        __int16 v29 = v32;
        uint64_t v30 = 2;
        goto LABEL_23;
    ...
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, v35, buf, 0xCu);
    goto LABEL_6;
  }
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v43 = v18;
    _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEBUG, "%{public}@firmware version not available in UARP accessory", buf, 0xCu);
  }
LABEL_12:
}
...
- (void)incrementMatterFirmwareUpdateRetryCount
{
  ...
  {
    id v3 = (void *)MEMORY[0x230FBD990]([(HMDAccessoryFirmwareUpdateSession *)self setMatterFirmwareUpdateRetryCount:[(HMDAccessoryFirmwareUpdateSession *)self matterFirmwareUpdateRetryCount]+ 1]);
    BOOL v4 = self;
    id v5 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v11 = 2048;
      uint64_t v12 = 10;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Matter firmware update retry attempt %lu of %lu", (uint8_t *)&v7, 0x20u);
    }
  }
}
...
void __72__HMDAccessoryFirmwareUpdateSession_updateAccessoryVendorIDAndProductID__block_invoke(uint64_t a1)
{
  ...
  if ((v8 & 1) == 0)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      int v26 = 138543362;
      int v27 = v24;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to update UARP accessory vendor ID property", (uint8_t *)&v26, 0xCu);
    }
    goto LABEL_14;
  }
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v28 = 2112;
    __int16 v29 = v14;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Accessory vendor ID updated to %@", (uint8_t *)&v26, 0x16u);
  }
  ...
  if ((v18 & 1) == 0)
  {
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      int v26 = 138543362;
      int v27 = v25;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to update UARP accessory product ID property", (uint8_t *)&v26, 0xCu);
    }
LABEL_14:
    goto LABEL_15;
  }
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v28 = 2112;
    __int16 v29 = v23;
    _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Accessory product ID updated to %@", (uint8_t *)&v26, 0x16u);
  }
...
- (void)_updateSoftwareUpdateNotReadyReasons
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v47 = 2112;
    __int16 v48 = v19;
    _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Unknown stagingNotReadyReasons %@", buf, 0x16u);
  }
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v47 = 2112;
    __int16 v48 = v27;
    _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Unknown applyNotReadyReasons %@", buf, 0x16u);
  }
  ...
  if (v28)
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138545410;
      ...
      __int16 v61 = 2114;
      v62 = v35;
      _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_INFO, "%{public}@SoftwareUpdate needsAttentionReasons changed - old %{public}@ (%{public}@) new %{public}@ (%{public}@) staging reasons %{public}@ (%{public}@) apply reasons %{public}@ (%{public}@)", buf, 0x5Cu);
...
void __82__HMDAccessoryFirmwareUpdateSession_handleFirmwareUpdateStateChangedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v20 = 2112;
    uint64_t v21 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Accessory state changed to %@", (uint8_t *)&v18, 0x16u);
  }
  if ([v6 internalState] == 2 && (!objc_msgSend(v4, "longValue") || objc_msgSend(v4, "longValue") == 2))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v18 = 138543362;
      id v19 = v13;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Restarting staging", (uint8_t *)&v18, 0xCu);
    }
    [v11 _schedule];
  }
  else if ([v6 internalState] == 3 && objc_msgSend(v4, "longValue") == 4)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v18 = 138543362;
      id v19 = v17;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Detected remote apply in progress", (uint8_t *)&v18, 0xCu);
    }
...
void __73__HMDAccessoryFirmwareUpdateSession_updateAccessoryStagedFirmwareVersion__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v41 = 2112;
    __int16 v42 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Staged firmware version changed from %@ to %@", (uint8_t *)&v37, 0x20u);
  }
  ...
  if (!v13)
  {
    ...
    if (v26)
    {
      if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
      {
        ...
        int v37 = 138543362;
        BOOL v38 = v31;
        _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_INFO, "%{public}@Updated UARP staged firmware version property", (uint8_t *)&v37, 0xCu);
      }
...
LABEL_19:
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v41 = 2112;
        __int16 v42 = v36;
        _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_ERROR, "%{public}@checkForUpdate failed for accessory %@ %@", (uint8_t *)&v37, 0x20u);
    ...
    else if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      int v37 = 138543362;
      BOOL v38 = v32;
      _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to update UARP staged firmware version property", (uint8_t *)&v37, 0xCu);
LABEL_17:
    }
    goto LABEL_19;
  }
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v39 = 2112;
    __int16 v40 = v18;
    _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Staged firmware version newer than available version (%@)", (uint8_t *)&v37, 0x16u);
  }
  if (([v11 checkForUpdateForAccessory:v2] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      int v37 = 138543362;
      BOOL v38 = v22;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Error request UARP to check for available updates", (uint8_t *)&v37, 0xCu);
    }
  }
LABEL_20:
}
...
LABEL_4:
    ...
    if (v20)
    {
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v42 = 2112;
        uint64_t v43 = v26;
        _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@Accessory %@: UARP accessory firmware version property updated to %@ (accessoryVersion is %@)", buf, 0x2Au);
      }
    ...
    else
    {
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        int v37 = v27;
        _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to update UARP accessory firmware version property", buf, 0xCu);
      }
    }
    goto LABEL_14;
  }
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    int v37 = v31;
    _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_INFO, "%{public}@Waiting for version number and version string to be in sync before proceeding", buf, 0xCu);
  }
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v43 = 2112;
      id v44 = v23;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@isAccessoryVersionInSyncWithAssetVersion: VersionNumberInSync : %@, VersionStringInSync: %@", buf, 0x20u);
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      __int16 v47 = 2112;
      id v48 = v13;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@isAccessoryVersionInSyncWithAssetVersion: AssetVersionNumber: %@, MatterFirmwareRevisionNumber: %@, AssetVersionString %@, FirmwareVersionString: %@", buf, 0x34u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v41 = 2112;
      id v42 = 0;
      _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_ERROR, "%{public}@Matter firmware version is invalid: %@", buf, 0x16u);
    }
    char v29 = 0;
    id v10 = v30;
  }
...
- (void)handleAccessoryFirmwareVersionChangedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    id v10 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Received accessory firmware updated notification", (uint8_t *)&v9, 0xCu);
  }
...
- (void)handleAccessoryVIDPIDChangedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    id v10 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Received matter VID PID updated notification", (uint8_t *)&v9, 0xCu);
  }
...
- (void)handleAccessoryFirmwareVersionNumberChangedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    id v10 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Received accessory firmware version number updated notification", (uint8_t *)&v9, 0xCu);
  }
  [(HMDAccessoryFirmwareUpdateSession *)v6 updateAccessoryFirmwareVersion];
}
  ...
  if (a3 == 1)
  {
    ...
    if ([v7 isEqualToVersion:v6])
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v33 = 2112;
        int v34 = v5;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Update is already installed for acc:%@ uarpAcc:%@ softwareUpdate:%@", (uint8_t *)&v27, 0x2Au);
      }
      uint64_t v13 = 4;
    }
    else
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v29 = 2112;
      id v30 = v26;
      _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@Marking Update as %@, matter accessory will trigger staging by itself.", (uint8_t *)&v27, 0x16u);
    }
    [(HMDAccessoryFirmwareUpdateSession *)v23 updateAvailableSoftwareUpdateState:v13];
  }
  else
  {
    char v15 = (void *)MEMORY[0x230FBD990](self, a2);
    __int16 v16 = self;
    int v17 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      id v30 = v20;
      uint64_t v21 = v20;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Unsupported state %@ for Matter Accessory, ignoring.", (uint8_t *)&v27, 0x16u);
    }
  }
}
...
- (void)_cancelApplyTimer
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v12 = 138543362;
    uint64_t v13 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Apply timer cancelled", (uint8_t *)&v12, 0xCu);
  }
...
- (void)_endSession
{
     ...
     || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0))&& [v4 supportsCHIP])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        int v23 = 138543362;
        uint64_t v24 = v11;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Couldn't get a strong ref to the software update provider delegate", (uint8_t *)&v23, 0xCu);
      }
    }
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v25 = 2112;
    char v26 = v16;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Session ended (already ended: %@)", (uint8_t *)&v23, 0x16u);
  }
...
LABEL_21:
      _os_log_impl(&dword_22F52A000, v20, v21, v19, (uint8_t *)&v23, 0xCu);
    }
LABEL_22:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      if ((unint64_t)(v13 - 1) > 4) {
        ...
        uint64_t v14 = off_264A23E58[v13 - 1];
      }
      int v23 = 138543618;
      uint64_t v24 = v12;
      __int16 v25 = 2112;
      char v26 = v14;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Scheduling next operation, state %@", (uint8_t *)&v23, 0x16u);
    }
...
- (void)_applyFailed
{
     ...
     || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0))&& (-[HMDAccessoryFirmwareUpdateSession hapAccessory](self, "hapAccessory"), unint64_t v4 = objc_claimAutoreleasedReturnValue(), v5 = [v4 supportsCHIP], v4, v5))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@%s: Matter Accessory responsible for managing firmware application. No action taken.", (uint8_t *)&v14, 0x16u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      int v14 = 138543362;
      char v15 = v13;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Apply did not complete or failed in the accessory", (uint8_t *)&v14, 0xCu);
    }
...
- (void)_stagingFailed
{
     ...
     || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0))&& [v4 supportsCHIP])
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@%s: Matter Accessory responsible for managing firmware staging. No action taken.", (uint8_t *)&v20, 0x16u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Staging failed", (uint8_t *)&v20, 0xCu);
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@No more staging retries for this accessory's firmware update session", (uint8_t *)&v20, 0xCu);
      }
    }
  }
}
...
void __74__HMDAccessoryFirmwareUpdateSession__handleAutomaticUpdateEnabledChanged___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v11 = v8;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@Notification missing required key", buf, 0xCu);
    }
  }
}
...
- (double)_expectedApplyDuration
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      int v12 = 138543362;
      uint64_t v13 = v10;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Expected duration is not set - default to minimum apply duration", (uint8_t *)&v12, 0xCu);
    }
...
- (void)startApplyDurationTimers
{
  ...
  if (!v5)
  {
    uint64_t v6 = (void *)[objc_alloc(MEMORY[0x263F42658]) initWithTimeInterval:1 options:v4];
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v24 = 2112;
    __int16 v25 = v19;
    _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Waiting up to %@ seconds for accessory to apply update", (uint8_t *)&v22, 0x16u);
  }
     ...
     || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0))&& [v4 supportsCHIP])
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@%s: Matter Accessory responsible for managing firmware application. No action taken.", buf, 0x16u);
    }
  }
  else
  {
    ...
    uint64_t v11 = (void *)MEMORY[0x230FBD990]([(HMDAccessoryFirmwareUpdateSession *)self setInternalState:4]);
    int v12 = self;
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v31 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@telling uarpController to apply asset", buf, 0xCu);
    }
    int v15 = [(HMDAccessoryFirmwareUpdateSession *)v12 uarpAccessory];
    __int16 v29 = v15;
    __int16 v16 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v29 count:1];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_ERROR, "%{public}@No firmwareUpdateProfile for accessory: %@", buf, 0x16u);
        }
    ...
    {
      int v20 = (void *)MEMORY[0x230FBD990]([(HMDAccessoryFirmwareUpdateSession *)v12 setUserInitiatedInstall:0]);
      os_log_type_t v21 = v12;
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v32 = 2112;
        __int16 v33 = v24;
        _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@applyFirmwareUpdateOnAccessoryList failed for %@", buf, 0x16u);
      }
    }
  }
}
        ...
        if (v13)
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v31 = 2112;
            __int16 v32 = v19;
            _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Staged version %@ is different then available version %@", buf, 0x20u);
          }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v29 = 2112;
          id v30 = v24;
          _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Not auto applying firmware update because isAutomaticThirdPartyAccessorySoftwareUpdateEnabled = %@", buf, 0x16u);
        }
      }
    }
  }
...
- (void)stagingComplete
{
     ...
     || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0))&& [v4 supportsCHIP])
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@%s: Matter Accessory responsible for managing firmware staging. No action taken.", (uint8_t *)&v14, 0x16u);
    }
  }
  else
  {
      ...
      || [(HMDAccessoryFirmwareUpdateSession *)self isUserInitiatedInstall])
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        int v14 = 138543362;
        int v15 = v12;
        _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Staging complete", (uint8_t *)&v14, 0xCu);
      }
     ...
     || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0))&& [v4 supportsCHIP])
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@%s: firmware has been downloaded for Matter Accessory. Matter Accessory responsible for staging firmware. No action taken.", buf, 0x16u);
    }
  }
  else
  {
...
void __50__HMDAccessoryFirmwareUpdateSession_stageFirmware__block_invoke(uint64_t a1)
{
  ...
  v16[0] = v4;
  double v5 = [MEMORY[0x263EFF8C0] arrayWithObjects:v16 count:1];
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      int v14 = 138543362;
      int v15 = v11;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@UARP initated asset staging", (uint8_t *)&v14, 0xCu);
    }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      int v14 = 138543362;
      int v15 = v13;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to initate asset staging in UARP controller", (uint8_t *)&v14, 0xCu);
    }
  }
}
    ...
    || ![v6 isGreaterThanVersion:v3])
  {
    if (![v7 isGreaterThanVersion:v6])
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        int v17 = 138543362;
        uint64_t v18 = v16;
        _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Unhandled version combination in nextStateToSchedule", (uint8_t *)&v17, 0xCu);
      }
      goto LABEL_6;
    }
...
- (BOOL)isReadyToApplyUpdate
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544642;
    ...
    __int16 v30 = 2112;
    __int16 v31 = v14;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Not ready for applying update - Not ready reason: %@ (%{public}@), updateState %@ (%@), isFirmwareVersionUpToDate %@", buf, 0x3Eu);
  }
  if (v6) {
    BOOL v15 = 0;
  }
...
- (BOOL)isCurrentUpdateLatest
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      int v14 = 138543362;
      BOOL v15 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@No available version from UARP", (uint8_t *)&v14, 0xCu);
    }
    char v5 = 0;
  }
...
- (BOOL)isReadyForStaging
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138544642;
    ...
    __int16 v30 = 2112;
    __int16 v31 = v14;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Not ready for staging - Not ready reasons: %@ (%{public}@), updateState %@ (%{public}@), isStagedFirmwareVersionUpToDate %@", buf, 0x3Eu);
  }
  if (v6) {
    BOOL v15 = 0;
  }
...
- (void)_evaluateHDSRetryForApplyFirmware
{
  ...
  {
    double v4 = (void *)MEMORY[0x230FBD990]();
    char v5 = self;
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@%s: called to control Matter Accessory. No sockets used with Matter Accessories. No action taken.", buf, 0x16u);
    }
    goto LABEL_24;
  }
...
LABEL_10:
    ...
    {
      int v13 = (void *)MEMORY[0x230FBD990]([(HMDAccessoryFirmwareUpdateSession *)self setApplyHDSRetryCount:[(HMDAccessoryFirmwareUpdateSession *)self applyHDSRetryCount] + 1]);
      int v14 = self;
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        __int16 v28 = v16;
        __int16 v29 = 2112;
        __int16 v30 = (const char *)&unk_26E472580;
        __int16 v31 = 2112;
        uint64_t v32 = v17;
        _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Rescheduling apply task after HDS failure in %@ sec for retry: %@", buf, 0x20u);
      }
      dispatch_time_t v18 = dispatch_time(0, 10000000000);
    ...
    else
    {
      if ([(HMDAccessoryFirmwareUpdateSession *)self internalState] == 3)
      {
        ...
        if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          __int16 v28 = v12;
          _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Out of HDS retries for apply. Moving update back to downloaded.", buf, 0xCu);
        }
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v29 = 2112;
    __int16 v30 = v25;
    _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Not performing HDS retries because firmware apply has not started and accessory %@ is unreachable", buf, 0x16u);
  }
...
void __70__HMDAccessoryFirmwareUpdateSession__evaluateHDSRetryForApplyFirmware__block_invoke(uint64_t a1)
{
  ...
  if ([*(id *)(a1 + 32) sessionEnded])
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
    {
      ...
      int v7 = 138543362;
      BOOL v8 = v5;
      _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Session has been ended, stop performing retries", (uint8_t *)&v7, 0xCu);
    }
  }
  else
  {
  ...
  if ([(HMDAccessoryFirmwareUpdateSession *)self internalState])
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      if ((unint64_t)(v8 - 1) > 4) {
        ...
        uint64_t v9 = off_264A23E58[v8 - 1];
      }
      int v10 = 138543618;
      char v11 = v7;
      __int16 v12 = 2112;
      int v13 = v9;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Synced state is: %@", (uint8_t *)&v10, 0x16u);
    }
  }
  else
  {
...
- (void)_withOpenSocketDoBlock:(id)a3 error:(id)a4
{
    ...
    && !CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)|| ![v9 supportsCHIP])
  {
    ...
    {
      uint64_t v14 = [MEMORY[0x263F087E8] hmErrorWithCode:15 description:0 reason:@"Socket open already in progress" suggestion:0];
      v7[2](v7, v14);
    }
    else
    {
      ...
      if (v14)
      {
        if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          __int16 v31 = v23;
          _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Opening HDS connection to accessory", buf, 0xCu);
        }
      ...
      else
      {
        if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          __int16 v31 = v24;
          _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@No dataStreamSocketController", buf, 0xCu);
        }
        __int16 v25 = [MEMORY[0x263F087E8] hmErrorWithCode:54 description:0 reason:@"No dataStreamSocketController" suggestion:0];
        v7[2](v7, v25);
      }
    }
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@%s: called to control Matter Accessory. No sockets used with Matter Accessories. No action taken.", buf, 0x16u);
  }
LABEL_20:
}
...
void __66__HMDAccessoryFirmwareUpdateSession__withOpenSocketDoBlock_error___block_invoke_2(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (v4)
    {
      ...
      id v5 = (void *)MEMORY[0x230FBD990]([v3 setApplyHDSRetryCount:0]);
      id v6 = v3;
      int v7 = HMFGetOSLogHandle();
      if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
      {
        ...
        int v28 = 138543362;
        __int16 v29 = v8;
        _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Opened HDS connection to accessory", (uint8_t *)&v28, 0xCu);
      }
      ...
      if (v14)
      {
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          int v28 = 138543362;
          __int16 v29 = v19;
          _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Notified UARP accessory is reachable", (uint8_t *)&v28, 0xCu);
        }
      ...
      else
      {
        if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        {
          ...
          int v28 = 138543362;
          __int16 v29 = v25;
          _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify about reachable accessory to UARP", (uint8_t *)&v28, 0xCu);
        }
        uint64_t v26 = *(void *)(a1 + 56);
        id v27 = [MEMORY[0x263F087E8] hmErrorWithCode:23 description:0 reason:@"UARP accessoryReachable failed" suggestion:0];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v30 = 2112;
        uint64_t v31 = v24;
        _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Couldn't open HDS connection to accessory error %@", (uint8_t *)&v28, 0x16u);
      }
...
- (void)_handleRegisterFailureRetryTimeout
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v8 = 138543362;
    id v9 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Register failure retry timeout", (uint8_t *)&v8, 0xCu);
  }
...
- (void)_cancelRegisterFailureRetryTimer
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v9 = 138543362;
    uint64_t v10 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Cancel register failure retry timer", (uint8_t *)&v9, 0xCu);
  }
...
- (void)_handleQueryFirmwareUpdateResultTimeout
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v8 = 138543362;
    int v9 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Query firmware update result duration timeout", (uint8_t *)&v8, 0xCu);
  }
...
- (void)_cancelQueryFirmwareUpdateResultTimer
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v9 = 138543362;
    uint64_t v10 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Cancel query firmware update result duration timer", (uint8_t *)&v9, 0xCu);
  }
...
- (void)_handleSocketTimeout
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v14 = 138543362;
    id v15 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Socket idle timeout", (uint8_t *)&v14, 0xCu);
  }
  if ((_os_feature_enabled_impl() & 1) != 0
    || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0))
  {
    ...
    if ([v8 supportsCHIP])
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@%s: called to control Matter Accessory. No sockets used with Matter Accessories. No action taken.", (uint8_t *)&v14, 0x16u);
      }
...
- (void)_cancelSocketIdleTimer
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v15 = 138543362;
    __int16 v16 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Cancel socket idle timer", (uint8_t *)&v15, 0xCu);
  }
  if (((_os_feature_enabled_impl() & 1) != 0
     || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0))&& (-[HMDAccessoryFirmwareUpdateSession hapAccessory](v5, "hapAccessory"), int v8 = objc_claimAutoreleasedReturnValue(), v9 = [v8 supportsCHIP], v8, v9))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@%s: called to control Matter Accessory. No sockets used with Matter Accessories. No action taken.", (uint8_t *)&v15, 0x16u);
    }
  }
  else
  {
...
- (void)_resetSocketIdleTimer
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v15 = 138543362;
    __int16 v16 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Reset socket idle timer", (uint8_t *)&v15, 0xCu);
  }
  if (((_os_feature_enabled_impl() & 1) != 0
     || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0))&& (-[HMDAccessoryFirmwareUpdateSession hapAccessory](v5, "hapAccessory"), int v8 = objc_claimAutoreleasedReturnValue(), v9 = [v8 supportsCHIP], v8, v9))
  {
...
- (void)_startSocketIdleTimer
{
     ...
     || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0))&& (-[HMDAccessoryFirmwareUpdateSession hapAccessory](self, "hapAccessory"), double v4 = objc_claimAutoreleasedReturnValue(), v5 = [v4 supportsCHIP], v4, v5))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@%s: called to control Matter Accessory. No sockets used with Matter Accessories. No action taken.", (uint8_t *)&v25, 0x16u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v27 = 2112;
      int v28 = v19;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Start socket idle timer for %@ seconds", (uint8_t *)&v25, 0x16u);
    }
    int v20 = (void *)[objc_alloc(MEMORY[0x263F42658]) initWithTimeInterval:1 options:v14];
...
- (void)resumeWithState:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    if (v10 > 4) {
      ...
      uint64_t v11 = off_264A23E58[v10];
    }
    ...
    if (a3 - 1 > 2) {
      ...
      __int16 v16 = off_264A23E40[a3 - 1];
    }
    *(_DWORD *)buf = 138544130;
    uint64_t v35 = v9;
    __int16 v36 = 2112;
    ...
    __int16 v40 = 2112;
    __int16 v41 = v16;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Resume called with sessionState: %@ accessoryState %@ resumeState %@", buf, 0x2Au);
  }
  if ((_os_feature_enabled_impl() & 1) != 0
    || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0))
  {
...
LABEL_21:
  ...
  id v21 = (void *)MEMORY[0x230FBD990]([(HMDAccessoryFirmwareUpdateSession *)v7 setLastStagedVersion:0]);
  __int16 v22 = v7;
  int v23 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
  {
    ...
    switch([*(id *)(a1 + 32) internalState])
    {
      case 0:
        ...
        if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
        {
          ...
          int v28 = 138543362;
          int v29 = v8;
          _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Next action: -", (uint8_t *)&v28, 0xCu);
        }
        goto LABEL_33;
      case 1:
        unint64_t v10 = (void *)MEMORY[0x230FBD990]();
...
LABEL_19:
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEBUG, v14, (uint8_t *)&v28, 0xCu);
...
LABEL_20:
      ...
      case 3:
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
        {
          ...
          int v28 = 138543362;
          int v29 = v18;
          _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Next action: applyFirmware", (uint8_t *)&v28, 0xCu);
        }
      ...
      case 4:
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
        {
          ...
          if ((unint64_t)(v22 - 1) > 4) {
            ...
            int v23 = off_264A23E58[v22 - 1];
          }
          int v28 = 138543618;
          int v29 = v21;
          __int16 v30 = 2112;
          uint64_t v31 = v23;
          _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Ignoring resume in state %@", (uint8_t *)&v28, 0x16u);
        }
LABEL_33:
        return;
      case 5:
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_DEBUG))
        {
          ...
          int v28 = 138543362;
          int v29 = v27;
          _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_DEBUG, "%{public}@Next action: register", (uint8_t *)&v28, 0xCu);
        }
        [*(id *)(a1 + 32) _register];
        return;
      default:
...
LABEL_12:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v24 = 2112;
    id v25 = v3;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@HAP Communication Error occurrence: %@ error: %@", buf, 0x20u);
  }
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v21 = v14;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Out of retries for socket open", buf, 0xCu);
  }
...
void __53__HMDAccessoryFirmwareUpdateSession_resumeWithState___block_invoke_90(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v6 = 138543362;
    id v7 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@rescheduling task after socket open failed", (uint8_t *)&v6, 0xCu);
  }
  [v3 _schedule];
}
...
- (void)pause
{
    ...
    || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0))
  {
    ...
    if (v5)
    {
      uint64_t v6 = MEMORY[0x230FBD990]();
      id v7 = self;
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@%s: called by the controller's scheduler. Only a Matter Accessory can pause a firmware staging/application. No action taken.", buf, 0x16u);
      }
...
LABEL_11:
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v19 = v16;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Pause ignored with socket in closing state", buf, 0xCu);
    }
    ...
    if ((v24 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v69 = 2112;
        v70 = v47;
        _os_log_impl(&dword_22F52A000, v40, OS_LOG_TYPE_ERROR, "%{public}@Requested install version %@ is different than available version %@ / %@", buf, 0x2Au);
    ...
    else
    {
      ...
      if (!v49)
      {
        ...
        if (os_log_type_enabled(v53, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543362;
          uint64_t v64 = v48;
          _os_log_impl(&dword_22F52A000, v53, OS_LOG_TYPE_DEFAULT, "%{public}@Starting user-initiated update", buf, 0xCu);
        }
...
LABEL_36:
            _os_log_impl(&dword_22F52A000, v59, v60, v58, buf, 0xCu);
...
LABEL_40:
          ...
          case 5uLL:
            ...
            *(_DWORD *)buf = 138543362;
            uint64_t v64 = (uint64_t)v32;
            _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@Cannot update while registration is in progress", buf, 0xCu);
            goto LABEL_25;
          default:
            goto LABEL_27;
        }
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        uint32_t v37 = 22;
LABEL_24:
        _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_ERROR, v35, buf, v37);
...
LABEL_27:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    __int16 v71 = 2112;
    id v72 = v21;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] Already has the latest version: %@. Ignoring the downloaded version: %@ / %@", buf, 0x34u);
...
- (HMFSoftwareVersion)accessoryVersion
{
  ...
  if ([v2 supportsCHIP])
  {
    ...
    uint64_t v9 = objc_msgSend(objc_alloc(MEMORY[0x263F42630]), "initWithMajorVersion:minorVersion:updateVersion:", objc_msgSend(v8, "unsignedLongValue"), 0, 0);
    int v5 = (void *)v9;
  }
  ...
  if (internalState != a3)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      if (a3 - 1 > 4) {
        ...
        int v12 = off_264A23E58[a3 - 1];
      }
      int v13 = 138543618;
      uint64_t v14 = v10;
      __int16 v15 = 2112;
      dispatch_time_t v16 = v12;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@State changed to %@", (uint8_t *)&v13, 0x16u);
    }
  }
}
...
- (HMDAccessoryFirmwareUpdateSession)initWithHAPAccessory:(id)a3 uarpAccessory:(id)a4 accessoryFirmwareUpdateManager:(id)a5 logEventManager:(id)a6 wingman:(id)a7
{
  ...
  if (v17)
  {
    ...
    v17->_id registerFailureRetryTimerFactory = &__block_literal_global_179280;
...
- (HMDAccessoryFirmwareUpdateSession)init
{
  unint64_t v2 = (void *)MEMORY[0x263EFF940];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t198 != -1) {
    dispatch_once(&logCategory__hmf_once_t198, &__block_literal_global_158);
  }
...
void __48__HMDAccessoryFirmwareUpdateSession_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v199;
...
+ (id)__calculateDigestDataFromFile:(id)a3 maxDataSize:(unint64_t)a4 error:(id *)a5
{
  ...
  id v12 = v11;
  id v13 = [MEMORY[0x263EFF950] inputStreamWithURL:v12];
  if (!v13)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v52 = 2112;
      id v53 = v12;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Couldn't open input stream for %@", (uint8_t *)&data, 0x16u);
    }
    goto LABEL_17;
  }
  ...
  if (v14 >= 1)
  {
    ...
    int v28 = (void *)MEMORY[0x230FBD990]([v13 close]);
    id v29 = v10;
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v48 = 2112;
      id v49 = v12;
      _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_ERROR, "%{public}@Data size is bigger than maximum %ld bytes on file %@", buf, 0x20u);
    }
    if (v7)
    {
      uint64_t v32 = [MEMORY[0x263F087E8] hmErrorWithCode:-1];
LABEL_26:
      uint64_t v23 = 0;
      void *v7 = v32;
      goto LABEL_33;
...
LABEL_11:
  ...
  if (v14 < 0)
  {
    uint64_t v33 = (void *)MEMORY[0x230FBD990](v19);
    id v34 = v10;
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v48 = 2112;
      id v49 = v37;
      _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_ERROR, "%{public}@Error reading documentation from %@: %@", buf, 0x20u);
    }
    if (v7)
    {
...
LABEL_17:
  ...
  uint64_t v20 = [MEMORY[0x263EFF990] dataWithLength:20];
  id v21 = v20;
  if (v20)
  {
    id v22 = v20;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v46 = 2048;
      uint64_t v47 = 20;
      _os_log_impl(&dword_22F52A000, v40, OS_LOG_TYPE_ERROR, "%{public}@Failed to allocate %lu bytes to hold digest", buf, 0x16u);
    }
    if (v7)
    {
