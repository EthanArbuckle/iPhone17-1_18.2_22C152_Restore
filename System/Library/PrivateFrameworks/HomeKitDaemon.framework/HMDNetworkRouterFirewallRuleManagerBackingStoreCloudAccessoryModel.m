...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_197332 != -1) {
    dispatch_once(&hmbProperties_onceToken_197332, &__block_literal_global_7_197333);
  }
  v2 = (void *)hmbProperties_properties_197334;
  return v2;
}
...
void __83__HMDNetworkRouterFirewallRuleManagerBackingStoreCloudAccessoryModel_hmbProperties__block_invoke()
{
  ...
  v3 = (void *)hmbProperties_properties_197334;
  hmbProperties_properties_197334 = v2;
}
...
+ (id)modelIDForRecordID:(id)a3
{
  ...
  objc_super v16 = (void *)MEMORY[0x263F08C38];
  v17 = [a1 namespaceID];
...
+ (NSUUID)namespaceID
{
  if (namespaceID_onceToken != -1) {
    dispatch_once(&namespaceID_onceToken, &__block_literal_global_2_197348);
  }
...
{
  uint64_t v0 = [objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:@"da9f7191-31bc-4567-9424-89b86310c2e7"];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_197353 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_197353, &__block_literal_global_197354);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v1_197355;
  return v2;
}
...
void __81__HMDNetworkRouterFirewallRuleManagerBackingStoreCloudAccessoryModel_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_197355;
  logCategory__hmf_once_v1_197355 = v0;
}
