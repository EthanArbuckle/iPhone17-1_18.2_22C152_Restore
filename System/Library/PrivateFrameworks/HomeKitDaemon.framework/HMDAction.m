...
- (HMDAction)initWithCoder:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v16 = 2112;
      v17 = @"actionUUID";
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode HMDAction missing key: %@", (uint8_t *)&v14, 0x16u);
    }
    v9 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_176868 != -1) {
    dispatch_once(&logCategory__hmf_once_t2_176868, &__block_literal_global_176869);
  }
  v2 = (void *)logCategory__hmf_once_v3_176870;
  return v2;
}
...
void __24__HMDAction_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_176870;
  logCategory__hmf_once_v3_176870 = v0;
}
