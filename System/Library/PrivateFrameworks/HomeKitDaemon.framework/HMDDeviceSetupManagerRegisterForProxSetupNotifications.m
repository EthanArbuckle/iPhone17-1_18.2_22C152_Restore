    ...
    else
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        *(void *)&buf[4] = v10;
        __int16 v17 = 2112;
        v18 = v11;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Received notification ProxSetup is running: %@", buf, 0x16u);
      }
      v12 = [(os_unfair_lock_s *)v8 notificationCenter];
      v15 = @"running";
      v13 = [NSNumber numberWithBool:v6];
      *(void *)buf = v13;
      v14 = [NSDictionary dictionaryWithObjects:buf forKeys:&v15 count:1];
