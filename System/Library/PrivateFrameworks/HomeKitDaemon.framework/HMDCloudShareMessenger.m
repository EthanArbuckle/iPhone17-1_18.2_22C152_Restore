...
- (void)handleShareRevokeMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    v15 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Received share revoke message: %@", (uint8_t *)&v12, 0x16u);
  }
...
- (void)handleShareRequestInviteMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v31 = 2112;
    v32 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Received share share request invite message: %@", (uint8_t *)&v29, 0x16u);
  }
  ...
  if (v11)
  {
    ...
    if (v12)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
        {
          ...
          int v29 = 138543362;
          v30 = v27;
          _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Cannot handle share request invite message because requesting device cannot be determined", (uint8_t *)&v29, 0xCu);
        }
        v28 = [MEMORY[0x263F087E8] hmfErrorWithCode:2];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        int v29 = 138543362;
        v30 = v23;
        _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Cannot handle share request invite message because requesting user cannot be determined", (uint8_t *)&v29, 0xCu);
      }
      __int16 v14 = [MEMORY[0x263F087E8] hmfErrorWithCode:2];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      int v29 = 138543362;
      v30 = v19;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Cannot handle share request invite message because home reference is nil", (uint8_t *)&v29, 0xCu);
    }
    int v12 = [MEMORY[0x263F087E8] hmfErrorWithCode:4];
...
- (void)handleShareInviteMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v23 = 2112;
    id v24 = v4;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Received share invite message: %@", buf, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v23 = 2112;
      id v24 = v17;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to find invitation data in share invite message payload: %@", buf, 0x16u);
    }
    v18 = [MEMORY[0x263F087E8] hmfErrorWithCode:2];
...
void __51__HMDCloudShareMessenger_handleShareInviteMessage___block_invoke(uint64_t a1, char a2, void *a3)
{
  ...
  if (a2)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      int v12 = 138543362;
      uint64_t v13 = v10;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Delegate successfully accepted share invitation", (uint8_t *)&v12, 0xCu);
    }
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v14 = 2112;
      id v15 = v5;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Delegate failed to accept share invitation: %@", (uint8_t *)&v12, 0x16u);
    }
    if (!v5)
    {
...
- (void)_requestShareInvitationDataFromUser:(id)a3 retryCount:(unint64_t)a4 activity:(id)a5
{
  ...
  if (v11)
  {
    ...
    int v29 = &unk_264A193B0;
    v30 = self;
    id v31 = v9;
    unint64_t v33 = a4;
    uint64_t v16 = v8;
    v32 = v16;
    v17 = (void *)MEMORY[0x230FBD990]([(HMDRemoteMessage *)v15 setResponseHandler:&v26]);
    v18 = self;
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v38 = 2112;
      v39 = v16;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Sending request CKShare invite message %@ to %@", buf, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v36 = 2112;
      v37 = v8;
      _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Could not request share invitation data from user with no account handle: %@", buf, 0x16u);
    }
  }
}
  ...
  if (*(void *)(a1 + 32))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v34 = 2114;
      uint64_t v35 = v8;
      _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_ERROR, "%{public}@[%{public}@] Failed to send request CKShare invite message: %{public}@", buf, 0x20u);
    }
    ...
    if (v9)
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v34 = 2048;
        uint64_t v35 = v17;
        _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@[%{public}@] Failed to send request share invitation message and reached retry limit %lu", buf, 0x20u);
      }
    }
    else
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v36 = 2048;
        uint64_t v37 = v21;
        _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@[%{public}@] Will retry sending request CKShare invite message in %fs (already retried %lu time(s))", buf, 0x2Au);
      }
...
- (void)_sendShareInvitationData:(id)a3 toDestination:(id)a4 retryCount:(unint64_t)a5 activity:(id)a6 completion:(id)a7
{
  ...
  v47 = @"invitationData";
  v48[0] = v12;
  uint64_t v17 = [NSDictionary dictionaryWithObjects:v48 forKeys:&v47 count:1];
  ...
  id v22 = v13;
  id v38 = v22;
  __int16 v23 = (void *)MEMORY[0x230FBD990]([(HMDRemoteMessage *)v18 setResponseHandler:v35]);
  id v24 = self;
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v45 = 2112;
    v46 = v30;
    _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@[%{public}@] Sending CKShare invite message: %@", buf, 0x20u);
  ...
  if (*(void *)(a1 + 32))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v39 = 2114;
      uint64_t v40 = v8;
      _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_ERROR, "%{public}@[%{public}@] Failed to send CKShare invite message: %{public}@", buf, 0x20u);
    }
    ...
    if (v9)
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v39 = 2048;
        uint64_t v40 = v17;
        _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@[%{public}@] Failed to send share invitation message and reached retry limit %lu", buf, 0x20u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v41 = 2048;
        uint64_t v42 = v24;
        _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@[%{public}@] Will retry sending CKShare invite message in %fs (already retried %lu time(s))", buf, 0x2Au);
      }
      objc_initWeak((id *)buf, *(id *)(a1 + 40));
...
- (void)notifyOfShareAccessRevocationForUser:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v22 = 2112;
      __int16 v23 = v10;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Sending share access revoked message: %@", (uint8_t *)&v20, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v22 = 2112;
      __int16 v23 = v4;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Could not notify of share access revocation for user with no account handle: %@", (uint8_t *)&v20, 0x16u);
    }
  }
}
...
- (void)requestShareInvitationDataFromUser:(id)a3
{
  ...
  v6 = (void *)[objc_alloc(MEMORY[0x263F424F0]) initWithName:@"Send request share invitation"];
...
- (void)sendShareInvitationData:(id)a3 toDevice:(id)a4 completion:(id)a5
{
  ...
  id v15 = (void *)[objc_alloc(MEMORY[0x263F424F0]) initWithName:@"Send share invitation to device"];
...
- (void)sendShareInvitationData:(id)a3 toUser:(id)a4 minimumHomeKitVersion:(id)a5 requiredSupportedFeatures:(id)a6 completion:(id)a7
{
  ...
  v39[0] = v21;
  __int16 v22 = [NSDictionary dictionaryWithObjects:v39 forKeys:&v38 count:1];
  ...
  if (v23)
  {
    ...
    uint64_t v26 = [(HMDRemoteAccountMessageDestination *)v24 initWithTarget:v25 handle:v23 multicast:1 deviceCapabilities:v22];

    *(void *)buf = [objc_alloc(MEMORY[0x263F424F0]) initWithName:@"Send share invitation to user"];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(void *)&uint8_t buf[4] = v30;
      __int16 v34 = 2112;
      id v35 = v12;
      _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@Could not send share invitation data to user with no account handle: %@", buf, 0x16u);
    }
...
- (void)unconfigure
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v8 = 138543362;
    id v9 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@De-registering from message dispatcher.", (uint8_t *)&v8, 0xCu);
  }
...
- (void)configure
{
  ...
  if (v3)
  {
    ...
    uint64_t v5 = +[HMDUserMessagePolicy userMessagePolicyWithHome:v3 userPrivilege:5 remoteAccessRequired:0];
    v14[0] = v4;
    v14[1] = v5;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v16 = v13;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Cannot configure cloud share messenger because home reference is nil", buf, 0xCu);
    }
  }
}
...
LABEL_9:
  ...
  if (v16)
  {
    ...
    v17->_id shareInvitationRetryHandler = &__block_literal_global_39048;
  }
  return v17;
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t24_39062 != -1) {
    dispatch_once(&logCategory__hmf_once_t24_39062, &__block_literal_global_51);
  }
  v2 = (void *)logCategory__hmf_once_v25_39063;
  return v2;
}
...
void __37__HMDCloudShareMessenger_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v25_39063;
  logCategory__hmf_once_v25_39063 = v0;
}
