...
LABEL_13:
          ...
          v15 = (void *)v17;
          id v18 = objc_alloc(*(Class *)(v9 + 2800));
          v19 = objc_msgSend(*(id *)(v10 + 2584), "numberWithUnsignedShort:", objc_msgSend(v12, "portStart"));
          ...
          {
            id v20 = objc_alloc(*(Class *)(v9 + 2800));
            v21 = objc_msgSend(*(id *)(v10 + 2584), "numberWithUnsignedShort:", objc_msgSend(v12, "portEnd"));
        ...
        if (v23)
        {
          ...
          id v27 = v16;
          id v28 = v70;
          v29 = objc_msgSend(MEMORY[0x263EFF980], "arrayWithCapacity:", objc_msgSend(v24, "count"));
        ...
        if (v36)
        {
          ...
          id v39 = v16;
          id v40 = v70;
          v41 = objc_msgSend(MEMORY[0x263EFF980], "arrayWithCapacity:", objc_msgSend(v24, "count"));
          *(void *)buf = MEMORY[0x263EF8330];
          *(void *)&buf[8] = 3221225472;
...
LABEL_21:
        ...
        if (v35)
        {
          ...
          v55 = v54;
          *(void *)buf = v54;
          v35 = [MEMORY[0x263EFF8C0] arrayWithObjects:buf count:1];
...
LABEL_24:
        ...
        if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_WORD *)&buf[12] = 2112;
          *(void *)&buf[14] = v12;
          _os_log_impl(&dword_22F52A000, v46, OS_LOG_TYPE_ERROR, "%{public}@Failed to convert WAN rule to TLV, skipping: %@", buf, 0x16u);
        }
        v35 = 0;
LABEL_27:
