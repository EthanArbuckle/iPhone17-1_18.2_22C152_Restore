...
- (void)timerDidFire:(id)a3
{
  ...
  if (objc_getProperty(self, v6, 80, 1) == _cmd)
  {
    ...
    if (v11 == -1)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v25 = 1024;
        int v26 = v22;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Failed to send the sample data %d", buf, 0x12u);
      }
      v16 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1025];
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v27 = 2048;
      ssize_t v28 = v11;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Data %u transfer is complete with total transferred bytes: %lu", buf, 0x1Cu);
    }
    goto LABEL_13;
  }
  ...
  if (v7)
  {
    v9 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1026];
...
void __46__HMDCameraIDSDeviceConnection_startKeepAlive__block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    id v3 = objc_alloc(MEMORY[0x263F42658]);
  ...
  if (v12)
  {
    ...
    dispatch_source_t v17 = dispatch_source_create(MEMORY[0x263EF83E8], v14, 0, Property);
...
void __54__HMDCameraIDSDeviceConnection__setReceiveByteHandler__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v21 = 2048;
    ssize_t v22 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Received keep-alive byte number %u with length %zd", buf, 0x1Cu);
  }
  if (v3 < 0)
  {
    SEL v9 = (void *)MEMORY[0x230FBD990]();
    id v10 = v5;
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      SEL v18 = v12;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Recv from socket returned error, marking the stream as failure", buf, 0xCu);
    }
    v13 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1027];
...
- (void)_createStreamSocketWithDevice:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[12] = 2112;
    *(void *)&buf[14] = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Creating stream sockets with device: %@", buf, 0x16u);
  }
  ...
  if (v100)
  {
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(void *)&buf[14] = v100;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Mapped HMDDevice to IDSDevice: %@", buf, 0x16u);
    }
    ...
    *(void *)&buf[16] = 0x2020000000;
    ...
    v124[2] = 0x2020000000;
    char v125 = 0;
    v91 = (void *)*MEMORY[0x263F49E70];
    uint64_t v39 = *MEMORY[0x263F49E70];
    uint64_t v93 = *MEMORY[0x263F49E80];
    v142[0] = *MEMORY[0x263F49E80];
    v142[1] = v39;
    v143[0] = &unk_26E471248;
    v143[1] = &unk_26E471260;
    uint64_t v90 = *MEMORY[0x263F49E78];
    v142[2] = *MEMORY[0x263F49E78];
    v143[2] = v23;
    v40 = [NSDictionary dictionaryWithObjects:v143 forKeys:v142 count:3];
    dispatch_group_enter(v38);
    v41 = [(HMDCameraIDSDeviceConnection *)v12 sessionID];
    v141[0] = @"IDSSetupVideoConnection";
    v141[1] = @"IDSSetupConnectionRequested";
    v42 = [MEMORY[0x263EFF8C0] arrayWithObjects:v141 count:2];
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)v137 = 138543618;
      ...
      __int16 v139 = 2112;
      v140 = v23;
      _os_log_impl(&dword_22F52A000, v45, OS_LOG_TYPE_INFO, "%{public}@Creating watch video connection with name: %@", v137, 0x16u);
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)v137 = 138543362;
        v138 = v52;
        _os_log_impl(&dword_22F52A000, v51, OS_LOG_TYPE_ERROR, "%{public}@Failed to create video IDSDeviceConnection", v137, 0xCu);
      }
      v34 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1021];
    }
    ...
    v135[0] = v93;
    v135[1] = v91;
    v136[0] = &unk_26E471248;
    v136[1] = &unk_26E471278;
    v135[2] = v90;
    v136[2] = v97;
    v53 = [NSDictionary dictionaryWithObjects:v136 forKeys:v135 count:3];
    dispatch_group_enter(group);
    v54 = [(HMDCameraIDSDeviceConnection *)v44 sessionID];
    v134[0] = @"IDSSetupAudioConnection";
    v134[1] = @"IDSSetupConnectionRequested";
    v55 = [MEMORY[0x263EFF8C0] arrayWithObjects:v134 count:2];
    ...
    if (os_log_type_enabled(v58, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)v137 = 138543618;
      ...
      __int16 v139 = 2112;
      v140 = v97;
      _os_log_impl(&dword_22F52A000, v58, OS_LOG_TYPE_INFO, "%{public}@Creating watch audio connection with name: %@", v137, 0x16u);
    }
    ...
    if (!v63)
    {
      ...
      if (os_log_type_enabled(v65, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)v137 = 138543362;
        v138 = v66;
        _os_log_impl(&dword_22F52A000, v65, OS_LOG_TYPE_ERROR, "%{public}@Failed to create audio IDSDeviceConnection", v137, 0xCu);
      }
      uint64_t v67 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1022];
    ...
    if (v63)
    {
      v132[0] = v93;
      v132[1] = v91;
      v133[0] = &unk_26E471290;
      v133[1] = &unk_26E471278;
      v132[2] = v90;
      v133[2] = v95;
      v94 = [NSDictionary dictionaryWithObjects:v133 forKeys:v132 count:3];
      ...
      v69 = [MEMORY[0x263EFF8C0] arrayWithObjects:v131 count:2];
      ...
      if (os_log_type_enabled(v72, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)v137 = 138543618;
        ...
        __int16 v139 = 2112;
        v140 = v95;
        _os_log_impl(&dword_22F52A000, v72, OS_LOG_TYPE_INFO, "%{public}@Creating keep alive connection with name: %@", v137, 0x16u);
      }
      ...
      if (!v77)
      {
        ...
        if (os_log_type_enabled(v79, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)v137 = 138543362;
          v138 = v80;
          _os_log_impl(&dword_22F52A000, v79, OS_LOG_TYPE_ERROR, "%{public}@Failed to create keep alive IDSDeviceConnection", v137, 0xCu);
        }
        uint64_t v81 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1023];
...
LABEL_35:
    ...
    if (v34)
    {
      ...
      if (os_log_type_enabled(v86, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(void *)&buf[14] = v34;
        _os_log_impl(&dword_22F52A000, v86, OS_LOG_TYPE_ERROR, "%{public}@Failed to create IDS connections: %@", buf, 0x16u);
      }
  ...
  else
  {
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_WORD *)&buf[22] = 2112;
      v145 = v33;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@Could not find IDSDevice matching IDS identifier %@. All devices: %@", buf, 0x20u);
    }
    v34 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1020];
  ...
  if (a2 == -1)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v19 = 2112;
      id v20 = v5;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to create video connection: %@", buf, 0x16u);
    }
  }
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v21 = 1024;
      int v22 = a2;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Created watch video connection with name: %@ socket: %d", buf, 0x1Cu);
    }
    *(unsigned char *)(*(void *)(*(void *)(a1 + 48) + 8) + 24) = 1;
    v13 = [v8 sessionID];
    v16[0] = @"IDSSetupVideoConnection";
    v16[1] = @"IDSSetupConnectionComplete";
    uintptr_t v14 = [MEMORY[0x263EFF8C0] arrayWithObjects:v16 count:2];
  ...
  if (a2 == -1)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v19 = 2112;
      id v20 = v5;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to create audio connection: %@", buf, 0x16u);
    }
  }
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v21 = 1024;
      int v22 = a2;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Created watch audio connection with name: %@ socket: %d", buf, 0x1Cu);
    }
    *(unsigned char *)(*(void *)(*(void *)(a1 + 48) + 8) + 24) = 1;
    v13 = [v8 sessionID];
  ...
  if (a2 == -1)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v19 = 2112;
      id v20 = v5;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to create keep alive connection: %@", buf, 0x16u);
    }
  }
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v21 = 1024;
      int v22 = a2;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Created watch keep alive connection with name: %@ socket: %d", buf, 0x1Cu);
    }
    *(unsigned char *)(*(void *)(*(void *)(a1 + 48) + 8) + 24) = 1;
    v13 = [v8 sessionID];
...
void __62__HMDCameraIDSDeviceConnection__createStreamSocketWithDevice___block_invoke_43(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    if (*(unsigned char *)(*(void *)(*(void *)(a1 + 56) + 8) + 24))
    {
      if (*(unsigned char *)(*(void *)(*(void *)(a1 + 64) + 8) + 24))
      {
        if (*(unsigned char *)(*(void *)(*(void *)(a1 + 72) + 8) + 24))
        {
          ...
          id v4 = (void *)MEMORY[0x230FBD990]([v3 setKeepAliveConnection:*(void *)(a1 + 48)]);
          id v5 = v3;
          ...
          if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
          {
            ...
            int v24 = 138543362;
            id v25 = v7;
            _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully created stream sockets", (uint8_t *)&v24, 0xCu);
          }
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
        {
          ...
          int v24 = 138543362;
          id v25 = v22;
          _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to open keep alive socket", (uint8_t *)&v24, 0xCu);
        }
        SEL v15 = (void *)MEMORY[0x263F087E8];
        uint64_t v16 = 1023;
      }
      else
      {
        dispatch_source_t v17 = (void *)MEMORY[0x230FBD990]();
        id v12 = v3;
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
        {
          ...
          int v24 = 138543362;
          id v25 = v19;
          _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to open video socket", (uint8_t *)&v24, 0xCu);
        }
        SEL v15 = (void *)MEMORY[0x263F087E8];
        uint64_t v16 = 1021;
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        int v24 = 138543362;
        id v25 = v14;
        _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to open audio socket", (uint8_t *)&v24, 0xCu);
      }
      SEL v15 = (void *)MEMORY[0x263F087E8];
      uint64_t v16 = 1022;
    }
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
  {
    ...
    int v24 = 138543362;
    id v25 = v10;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Lost self while creating sockets", (uint8_t *)&v24, 0xCu);
  }
LABEL_21:
}
...
LABEL_7:
  ...
  if (v13)
  {
    ...
    v14->_id idsDeviceConnectionFactory = &__block_literal_global_64228;
...
{
  id v8 = (objc_class *)MEMORY[0x263F4A020];
  id v9 = a5;
  id v10 = a4;
  id v11 = a3;
  id v12 = a2;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t25_64245 != -1) {
    dispatch_once(&logCategory__hmf_once_t25_64245, &__block_literal_global_51_64246);
  }
  id v2 = (void *)logCategory__hmf_once_v26_64247;
  return v2;
}
...
void __43__HMDCameraIDSDeviceConnection_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v26_64247;
  logCategory__hmf_once_v26_64247 = v0;
}
