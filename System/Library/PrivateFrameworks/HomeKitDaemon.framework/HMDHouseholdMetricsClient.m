...
- (id)handleRequestMessageWithPayload:(id)a3 outError:(id *)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v45 = 2112;
    v46 = v6;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Processing request, payload=%@", buf, 0x16u);
  }
  ...
  if (v12)
  {
    ...
    if (v16) {
      long long v17 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v16];
    }
    else {
      long long v17 = 0;
    }
    ...
    if (v17 && v25)
    {
      ...
      id v27 = v13;
      id v42 = v27;
      v28 = (void *)MEMORY[0x230FBD990]([v26 enumerateKeysAndObjectsUsingBlock:v41]);
      v29 = v8;
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v45 = 2112;
        v46 = (const char *)v27;
        _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_DEBUG, "%{public}@Responding with payload=%@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v45 = 2080;
        v46 = v37;
        _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_ERROR, "%{public}@Missing %s in request, responding with error", buf, 0x16u);
      }
      if (a4)
      {
        [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F41FD8] code:20 userInfo:0];
        v22 = 0;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      ...
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@DNU disabled, responding with error", buf, 0xCu);
    }
    if (a4)
    {
      [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F41FD8] code:17 userInfo:0];
      v22 = 0;
      *a4 = (id)objc_claimAutoreleasedReturnValue();
    }
    else
...
void __70__HMDHouseholdMetricsClient_handleRequestMessageWithPayload_outError___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v8 && (objc_opt_respondsToSelector() & 1) != 0)
  {
    ...
    if (v9)
    {
      if ([MEMORY[0x263F08AC0] propertyList:v9 isValidForFormat:200])
      {
...
LABEL_13:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v23 = 2114;
    id v24 = v5;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Dropping %{public}@ because it's factory doesn't serialize", (uint8_t *)&v21, 0x16u);
  }
LABEL_16:
}
...
- (HMDHouseholdMetricsClient)initWithCountersManager:(id)a3 dateProvider:(id)a4 remoteMessageDispatcher:(id)a5 requestCountProvider:(id)a6 logEventFactories:(id)a7
{
  return [(HMDHouseholdMetricsClient *)self initWithCountersManager:a3 dateProvider:a4 remoteMessageDispatcher:a5 requestCountProvider:a6 logEventFactories:a7 isDNUEnabledBlock:&__block_literal_global_256172];
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_256179 != -1) {
    dispatch_once(&logCategory__hmf_once_t9_256179, &__block_literal_global_21_256180);
  }
  v2 = (void *)logCategory__hmf_once_v10_256181;
  return v2;
}
...
void __40__HMDHouseholdMetricsClient_logCategory__block_invoke()
{
  ...
  uint64_t v1 = (void *)logCategory__hmf_once_v10_256181;
  logCategory__hmf_once_v10_256181 = v0;
}
