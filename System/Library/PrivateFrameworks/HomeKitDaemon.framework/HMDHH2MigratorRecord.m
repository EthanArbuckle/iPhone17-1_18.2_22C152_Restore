  ...
  if ((v5 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v18 = 2112;
      id v19 = v6;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Unable to remove migration record from disk %@ (%@)", buf, 0x20u);
    }
  }
...
LABEL_11:
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, v11, (uint8_t *)&v18, 0xCu);
    }
LABEL_12:
  ...
  if ([(HMDHH2MigratorRecord *)self migrateFromTestDirectory])
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      int v18 = 138543362;
      id v19 = v6;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Not enforcing the migration attempt as we are doing migration from test directory", (uint8_t *)&v18, 0xCu);
    }
    goto LABEL_13;
  }
...
LABEL_13:
  id v13 = (void *)MEMORY[0x230FBD990]([(HMDHH2MigratorRecord *)self setCurrentMigrationAttempt:[(HMDHH2MigratorRecord *)self currentMigrationAttempt] + 1]);
  v14 = self;
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Increased migration attempt to %u", (uint8_t *)&v18, 0x12u);
  }
...
- (BOOL)writeToDisk
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      int v10 = 138543362;
      v11 = v8;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@Cannot prepare HH2 migrator record dictionary", (uint8_t *)&v10, 0xCu);
    }
    BOOL v4 = 0;
  }
...
- (BOOL)writeMigratorRecord:(id)a3
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v4;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Unable to create an archive of the HH2 migrator record : %@", (uint8_t *)&v19, 0x16u);
LABEL_9:
    }
LABEL_10:
    BOOL v12 = 0;
  ...
  if ((v7 & 1) == 0)
  {
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v17;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Unable to write the HH2 migrator record to %@", (uint8_t *)&v19, 0x16u);
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v23 = 2112;
    v24 = v14;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Successfully written HH2 migrator record to disk: %@ : %@", (uint8_t *)&v19, 0x20u);
  }
LABEL_11:
...
LABEL_10:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
      {
        ...
        int v10 = 138543362;
        v11 = v8;
        _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@Cannot prepare HH2 migrator record", (uint8_t *)&v10, 0xCu);
      }
    }
    BOOL v3 = 0;
    goto LABEL_10;
...
- (id)attributeDescriptions
{
  ...
  v20[4] = v16;
  unsigned int v17 = [MEMORY[0x263EFF8C0] arrayWithObjects:v20 count:5];
...
- (void)unarchiveRecordFromData:(id)a3
{
  ...
  if (v5)
  {
    id v6 = (void *)MEMORY[0x230FBD990]([(HMDHH2MigratorRecord *)self updateValuesFromDict:v5]);
    char v7 = self;
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v15 = 2112;
      __int16 v16 = v10;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Successfully got the HH2 Migrator record : %@", (uint8_t *)&v13, 0x16u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      int v13 = 138543362;
      id v14 = v12;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@Unable to get the valid HH2 Migrator record from stored archive.", (uint8_t *)&v13, 0xCu);
    }
  }
}
...
- (void)readMigratorRecord
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v18 = 2112;
    id v19 = v7;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Going to read migrator record from : %@", buf, 0x16u);
  }
  id v8 = [(HMDHH2MigratorRecord *)v4 hh2MigratorRecordDataStorePath];
  id v15 = 0;
  v9 = [MEMORY[0x263EFF8F8] dataWithContentsOfFile:v8 options:2 error:&v15];
  id v10 = v15;
  if (v10 || !v9)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v18 = 2112;
      id v19 = v10;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Current device is not the migrator: %@", buf, 0x16u);
    }
  }
  else
  {
...
+ (id)lastMigrationFailure
{
  ...
  id v2 = (void *)lastMigrationFailure_migrationError;
  return v2;
}
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Found migration failure record on disk at %@. Going to read it.", buf, 0x16u);
    }
    id v51 = 0;
    objc_super v9 = [MEMORY[0x263EFF8F8] dataWithContentsOfFile:v2 options:2 error:&v51];
    id v10 = v51;
    if (v9)
    {
      ...
      int v13 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v53 count:1];
      id v14 = [v12 setWithArray:v13];
      id v15 = (void *)MEMORY[0x263EFFA08];
      uint64_t v52 = objc_opt_class();
      __int16 v16 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v52 count:1];
      ...
      if (v18)
      {
        ...
        if (v21)
        {
          v24 = [v20 objectForKeyedSubscript:*MEMORY[0x263F0CAF8]];
          objc_opt_class();
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_INFO, "%{public}@Successfully read the migration failure record %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_ERROR, "%{public}@Unable to open the migration failure record from archive data: %@", buf, 0x16u);

            v42 = v49;
          }

          uint64_t v46 = [MEMORY[0x263F087E8] hmErrorWithCode:-1];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive migration failure record from archive data: %@", buf, 0x16u);
        }
        id v41 = v19;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_ERROR, "%{public}@Unable to read the migration failure record due to an error: [%@]", buf, 0x16u);
      }
      id v36 = v10;
...
+ (BOOL)recordMigrationFailureWithError:(id)a3
{
  ...
  [v6 setObject:v5 forKeyedSubscript:*MEMORY[0x263F0CAF8]];
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v31 = 2112;
    id v32 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Going to write migration failure record : [%@] -> [%@]", (uint8_t *)&v27, 0x20u);
  }
  ...
  if (!v12)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      uint32_t v25 = 22;
LABEL_13:
      _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, v23, (uint8_t *)&v27, v25);
    }
LABEL_14:
    BOOL v20 = 0;
    goto LABEL_15;
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v31 = 2112;
    id v32 = v7;
    _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Successfully written migration failure record on disk : %@, %@", (uint8_t *)&v27, 0x20u);
  }
  BOOL v20 = 1;
LABEL_15:
...
+ (id)unarchiveMigratorDict:(id)a3
{
  ...
  id v10 = [MEMORY[0x263EFF8C0] arrayWithObjects:v27 count:3];
  ...
  if (!v12)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v25 = 2112;
      id v26 = v13;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive HMDHH2MigratorRecord from archive data: %@", buf, 0x16u);
    }
  }
  id v18 = v12;
  objc_opt_class();
...
+ (id)archiveMigratorDict:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Going to archive : %@", (uint8_t *)&v11, 0x16u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_123780 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_123780, &__block_literal_global_19_123781);
  }
  id v2 = (void *)logCategory__hmf_once_v5_123782;
  return v2;
}
...
void __35__HMDHH2MigratorRecord_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_123782;
  logCategory__hmf_once_v5_123782 = v0;
}

+ (id)singleRecord
{
  if (singleRecord_onceToken != -1) {
    dispatch_once(&singleRecord_onceToken, &__block_literal_global_123787);
  }
