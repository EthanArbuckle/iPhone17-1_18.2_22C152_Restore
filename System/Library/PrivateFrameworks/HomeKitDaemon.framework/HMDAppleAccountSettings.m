...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_16678 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_16678, &__block_literal_global_16679);
  }
  v2 = (void *)logCategory__hmf_once_v1_16680;
  return v2;
}
...
void __46__HMDAppleAccountSettings_Common__logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_16680;
  logCategory__hmf_once_v1_16680 = v0;
}
...
uint64_t __65__HMDAppleAccountSettings_handleManateeAvailabilityNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Received Manatee availability notification", (uint8_t *)&v7, 0xCu);
  }
...
- (void)__updateHomeEnabled:(BOOL)a3 userInitiated:(BOOL)a4 completionHandler:(id)a5
{
  ...
  if (+[HMDAppleAccountSettings supportsCloudSettings])
  {
    ...
    if (v11)
    {
      v13 = (void *)MEMORY[0x263EFB420];
      if (v6
        && (v14 = (__CFString *)*MEMORY[0x263EFB420],
            ([v11 isProvisionedForDataclass:*MEMORY[0x263EFB420]] & 1) == 0))
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v41 = 2112;
          v42 = v14;
          _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_ERROR, "%{public}@Unable to enable iCloud switch for account. Account currently unprovisioned for %@", buf, 0x16u);
        }
        if (v8)
        {
          v32 = [MEMORY[0x263F087E8] hmErrorWithCode:10];
          v8[2](v8, v32);
        }
      }
      else
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v41 = 2112;
          v42 = v20;
          _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Updating iCloud setting to %@", buf, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        ...
        _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to update iCloud setting, there is no primary account", buf, 0xCu);
      }
      if (v8)
      {
        v27 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
        v8[2](v8, v27);
      }
    }
  }
  ...
  {
    v22 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
    v8[2](v8, v22);
  }
}
...
void __79__HMDAppleAccountSettings___updateHomeEnabled_userInitiated_completionHandler___block_invoke(uint64_t a1, int a2, void *a3)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v15 = 2112;
      id v16 = v5;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to save iCloud setting with error: %@", (uint8_t *)&v13, 0x16u);
    }
  }
...
- (void)__registerForKeychainChangeNotifications
{
  ...
  CFPropertyListRef v3 = [NSString stringWithUTF8String:*MEMORY[0x263F342A0]];
...
- (void)__synchronize
{
  ...
  if (+[HMDAppleAccountSettings supportsCloudSettings])
  {
    ...
    if (homeEnabled != v6)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v45 = 2112;
        id v46 = v13;
        _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Updated to home enabled: %@", buf, 0x16u);
      }
    ...
    id v14 = objc_alloc_init(MEMORY[0x263F343F0]);
    id v42 = 0;
    ...
    if ((v15 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v45 = 2112;
        id v46 = v16;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@The v0 keychain is not enabled: %@", buf, 0x16u);
      }
    }
    if (self->_keychainSyncEnabled != v15)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v45 = 2112;
        id v46 = v25;
        _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Updated to keychain sync enabled: %@", buf, 0x16u);
      }
    ...
    if (self->_managed != v26)
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v45 = 2112;
        id v46 = v32;
        _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_INFO, "%{public}@Updated to managed account: %@", buf, 0x16u);
      }
      self->_managed = v27;
      BOOL v8 = 1;
    }
    ...
    if (self->_ephemeral != v34)
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v45 = 2112;
        id v46 = v39;
        _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_INFO, "%{public}@Updated to ephemeral account: %@", buf, 0x16u);
      }
      self->_ephemeral = v34;
      BOOL v8 = 1;
    }
...
uint64_t __38__HMDAppleAccountSettings_synchronize__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v7 = 138543362;
    BOOL v8 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Synchronizing apple account settings", (uint8_t *)&v7, 0xCu);
  }
  return objc_msgSend(*(id *)(a1 + 32), "__synchronize");
}
...
void __74__HMDAppleAccountSettings__notifyClientsOfUpdatedHomeState_userInitiated___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v15 = 2112;
    id v16 = v6;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Updated isHomeEnabled to %@", buf, 0x16u);
  }
  ...
  id v12 = v9;
  BOOL v10 = [NSDictionary dictionaryWithObjects:&v12 forKeys:&v11 count:1];
...
- (HMDAppleAccountSettings)init
{
  ...
  if (v2)
  {
    ...
    BOOL v9 = (void *)MEMORY[0x230FBD990]([(HMDAppleAccountSettings *)v3 __synchronize]);
    BOOL v10 = v3;
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      __int16 v27 = 2112;
      v28 = v16;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Initialized Apple account settings with isHomeEnabled: %@, isKeychainSyncEnabled: %@, isManaged: %@, isEphemeral: %@", buf, 0x34u);
    }
  }
  return v3;
}
...
+ (id)sharedSettings
{
  if (sharedSettings_onceToken != -1) {
    dispatch_once(&sharedSettings_onceToken, &__block_literal_global_38531);
  }
  id v2 = (void *)sharedSettings_sharedSettings;
  return v2;
}

void __41__HMDAppleAccountSettings_sharedSettings__block_invoke()
{
  uint64_t v0 = objc_alloc_init(HMDAppleAccountSettings);
