...
- (BOOL)loadMiscFields:(id)a3
{
  ...
  if ([v5 conformsToProtocol:&unk_26E4CA7A0]) {
    v6 = v5;
  }
  else {
    v6 = 0;
  ...
  if (v7)
  {
    ...
    v10 = [v8 extractNetworkConfig:v9 peerNameExtractor:MEMORY[0x263EF88D8]];
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v31 = 2112;
      v32 = v15;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@IDSDevice connection: Peer IP address: %@\n", (uint8_t *)&v29, 0x16u);
    }
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v31 = 2112;
      v32 = v20;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@IDSDevice connection: Peer port      : %@\n", (uint8_t *)&v29, 0x16u);
    }
    v21 = [v10 ipAddress];
...
- (HMDStreamInterface)initWithSessionID:(id)a3 workQueue:(id)a4 sessionHandler:(id)a5 localRTPSocket:(int)a6
{
  ...
  if (v14)
  {
    ...
    v15->_id socketCloseHandler = &__block_literal_global_83800;
  }
  return v15;
}
  ...
  if ((((uint64_t (*)(uint64_t, _WORD *, int *))a4)(v5, v30, &v18) & 0x80000000) != 0)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v21 = 1024;
      int v22 = v13;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Failed to get the peer name %d", buf, 0x12u);
    }
    v14 = 0;
  }
  else
...
LABEL_14:
    ...
    *(_DWORD *)buf = 138543362;
    ...
    uint32_t v21 = 12;
LABEL_17:
    _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, v19, buf, v21);
...
LABEL_8:
  id v10 = [a1 extractNetworkConfig:v6 peerNameExtractor:MEMORY[0x263EF88E0]];
  id v11 = [v10 rtpPort];
  [v4 setRtpPort:v11];
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v29 = 2112;
    v30 = v17;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Opened socket at address %@ and port %@", buf, 0x20u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_83822 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_83822, &__block_literal_global_13);
  }
  v2 = (void *)logCategory__hmf_once_v1_83823;
  return v2;
}
...
void __33__HMDStreamInterface_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_83823;
  logCategory__hmf_once_v1_83823 = v0;
}
