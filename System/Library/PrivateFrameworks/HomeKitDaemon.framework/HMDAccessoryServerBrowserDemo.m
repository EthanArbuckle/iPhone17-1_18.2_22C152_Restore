...
- (id)_handleTestModeConfigRequest:(id)a3 response:(id *)a4
{
  ...
  else
  {
    ...
    {
      v10 = objc_msgSend(v6, "hmf_arrayForKey:", @"kConfigTestingGenerateNotificationKey");
      if (v10)
      {
    ...
    *(void *)&long long v3 = 138543874;
    ...
    while (2)
    {
      ...
      do
      {
        ...
        v8 = objc_msgSend(v7, "hmf_stringForKey:", @"kAccessoryName", v44);
        ...
        if (!v60)
        {
          v40 = (void *)MEMORY[0x230FBD990](v10);
          ...
          if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v67 = 2112;
            v68 = v7;
            _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_INFO, "%{public}@No reachability setting for the setReachability request: %@", buf, 0x16u);
          }
          v4 = [MEMORY[0x263F087E8] hmfErrorWithCode:3];
          ...
          if (v21)
          {
            if (v35)
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              __int16 v71 = 2112;
              v72 = v37;
              _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_INFO, "%{public}@Setting the reachability of accessory %@+%@ to %@", buf, 0x2Au);
            }
          ...
          else
          {
            if (v35)
            {
              ...
              *(_DWORD *)buf = v44;
              ...
              __int16 v69 = 2112;
              v70 = v9;
              _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_INFO, "%{public}@Unable to look up accessory with deviceIdentifier %@, instanceID %@", buf, 0x20u);
            }
            int v38 = 2;
            v4 = [MEMORY[0x263F087E8] hmfErrorWithCode:2];
          }
          v29 = v46;
          int v31 = v38;
        }
...
LABEL_27:
          ...
          if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v67 = 2112;
            v68 = v8;
            _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_INFO, "%{public}@Unable to look up accessoryServer with deviceIdentifier %@", buf, 0x16u);
          }
          int v31 = 2;
          v4 = [MEMORY[0x263F087E8] hmfErrorWithCode:2];
        }
  ...
  if (v108)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v8 = objc_msgSend(v7, "hmf_stringForKey:", @"kAccessoryName");
        v9 = objc_msgSend(v7, "hmf_numberForKey:", @"kAccessoryInstanceIDKey");
...
LABEL_41:
                ...
                if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  __int16 v143 = 2112;
                  v144 = v9;
                  _os_log_impl(&dword_22F52A000, v46, OS_LOG_TYPE_INFO, "%{public}@Unable to look up accessory with deviceIdentifier %@, instanceID %@", buf, 0x20u);
                }
                int v30 = 2;
                uint64_t v5 = [MEMORY[0x263F087E8] hmfErrorWithCode:2];
                uint64_t v48 = 0;
LABEL_57:
                int v31 = v111;
                long long v61 = v112;
...
LABEL_54:
                  long long v58 = (void *)MEMORY[0x230FBD990]();
                  ...
                  if (os_log_type_enabled(v59, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)buf = 138544130;
                    ...
                    __int16 v145 = 2112;
                    v146 = v115;
                    _os_log_impl(&dword_22F52A000, v59, OS_LOG_TYPE_INFO, "%{public}@Unable to look up accessory with deviceIdentifier %@, instanceID %@, serviceInstanceID %@", buf, 0x2Au);
                  }
                  int v30 = 2;
                  uint64_t v5 = [MEMORY[0x263F087E8] hmfErrorWithCode:2];
                  goto LABEL_57;
...
LABEL_47:
                  ...
                  if (v113)
                  {
                    ...
                    if (os_log_type_enabled(v64, OS_LOG_TYPE_INFO))
                    {
                      ...
                      *(_DWORD *)buf = 138544642;
                      ...
                      __int16 v149 = 2112;
                      uint64_t v150 = v113;
                      _os_log_impl(&dword_22F52A000, v64, OS_LOG_TYPE_INFO, "%{public}@Setting the responseDelay for characteristic (%@+%@/%@/%@) to %@", buf, 0x3Eu);
                    }
                    ...
                    if (v73)
                    {
                      ...
                      if (os_log_type_enabled(v76, OS_LOG_TYPE_INFO))
                      {
                        ...
                        *(_DWORD *)buf = 138544642;
                        ...
                        _os_log_impl(&dword_22F52A000, v76, OS_LOG_TYPE_INFO, "%{public}@Getting the value for characteristic responseDelay (%@+%@/%@/%@): %@ ", buf, 0x3Eu);
                  ...
                  v99 = v62;
                  v79 = (void *)MEMORY[0x230FBD990](v66);
                  ...
                  if (v110)
                  {
                    ...
                    if (v81)
                    {
                      ...
                      *(_DWORD *)buf = 138544898;
                      ...
                      __int16 v151 = 2112;
                      v152 = v83;
                      _os_log_impl(&dword_22F52A000, v80, OS_LOG_TYPE_INFO, "%{public}@Setting the value for characteristic (%@+%@/%@/%@) to %@ with responseDelay %@ milliseconds", buf, 0x48u);
                  ...
                  else
                  {
                    ...
                    if (v81)
                    {
                      ...
                      *(_DWORD *)buf = 138544642;
                      ...
                      __int16 v149 = 2112;
                      uint64_t v150 = 0;
                      _os_log_impl(&dword_22F52A000, v80, OS_LOG_TYPE_INFO, "%{public}@Getting the value for characteristic (%@+%@/%@/%@): %@ ", buf, 0x3Eu);
                    ...
                    {
                      v87 = [MEMORY[0x263EFF9D0] null];
                      [v111 setObject:v87 forKey:@"kCharacteristicValue"];
                    }
                  }
                  if (v105)
                  {
                    v88 = (void *)MEMORY[0x230FBD990](v84);
                    ...
                    if (os_log_type_enabled(v89, OS_LOG_TYPE_INFO))
                    {
                      ...
                      *(_DWORD *)buf = 138544898;
                      ...
                      __int16 v151 = 2112;
                      v152 = v91;
                      _os_log_impl(&dword_22F52A000, v89, OS_LOG_TYPE_INFO, "%{public}@Triggering update notification for characteristic (%@+%@/%@/%@) with value %@, responseDelay %@ milliseconds", buf, 0x48u);
                    ...
                    v138 = v99;
                    v92 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v138 count:1];
...
LABEL_67:
                  ...
                  if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)buf = 138544386;
                    ...
                    __int16 v147 = 2112;
                    v148 = v114;
                    _os_log_impl(&dword_22F52A000, v68, OS_LOG_TYPE_INFO, "%{public}@Unable to look up accessory with deviceIdentifier %@, instanceID %@, serviceInstanceID %@, characteristicInstanceID %@", buf, 0x34u);
                  }
                  int v30 = 2;
                  uint64_t v70 = [MEMORY[0x263F087E8] hmfErrorWithCode:2];
                  __int16 v71 = v112;
                  v72 = (void *)v70;
                  v33 = (void *)v110;
                  id v32 = v104;
...
LABEL_91:
  ...
  v94 = (void *)[v100 copy];
  v137 = v94;
  *a4 = [NSDictionary dictionaryWithObjects:&v137 forKeys:&v136 count:1];
...
- (BOOL)_delegateRespondsToSelector:(SEL)a3
{
  id v4 = [(HMDAccessoryServerBrowserDemo *)self delegate];
  if (v4)
  {
    uint64_t v5 = [(HMDAccessoryServerBrowserDemo *)self delegateQueue];
    if (v5) {
...
{
  v2 = [*(id *)(a1 + 32) servers];
  long long v3 = objc_msgSend(v2, "hmf_firstObjectWithValue:forKeyPath:", *(void *)(a1 + 40), @"identifier");
...
void __52__HMDAccessoryServerBrowserDemo_resetDemoAccessory___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v19 = 2112;
    uint64_t v20 = v12;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@[CoreHAP] Discovered new accessory server %@ with Demo info", buf, 0x16u);
  }
...
void __48__HMDAccessoryServerBrowserDemo_appendDemoData___block_invoke(uint64_t a1)
{
  ...
  if ([v5 count])
  {
    id v12 = (void *)MEMORY[0x230FBD990]([v4 addObjectsFromArray:v5]);
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v36 = 2112;
      v37 = v4;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Updated demo accessory list: %@", buf, 0x16u);
    }
    id v32 = @"accessories";
    v33 = v4;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v35 = v22;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@No new accessories (but kicking re-discovery anyway).", buf, 0xCu);
    }
  }
...
void __48__HMDAccessoryServerBrowserDemo_appendDemoData___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if ((objc_msgSend(v4, "na_any:", v7) & 1) == 0)
  {
    ...
    [v6 setObject:MEMORY[0x263EFFA88] forKey:@"testMode"];
          ...
          for (uint64_t i = 0; i != v42; ++i)
          {
            ...
            if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v55 = 2112;
              id v56 = v10;
              _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Processing Demo Accessory information: %@ / %@", buf, 0x20u);
            }
            if (v9 && v10 && v11)
            {
              uint64_t v17 = [MEMORY[0x263F08900] JSONObjectWithData:v11 options:0 error:0];
              id v18 = (void *)v17;
              if (v17)
              {
                ...
                if (v21)
                {
                  ...
                  if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
                  {
                    ...
                    *(_DWORD *)buf = 138543874;
                    ...
                    __int16 v55 = 2112;
                    id v56 = v20;
                    _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Server already exists for Demo Accessory: %@ / %@ - leaving it in place", buf, 0x20u);
...
void __64__HMDAccessoryServerBrowserDemo_stopDiscoveringAccessoryServers__block_invoke(uint64_t a1)
{
  ...
  *(unsigned char *)(*(void *)(a1 + 32) + 61) = 0;
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_INFO))
  {
    ...
    int v4 = 138543362;
    id v5 = v3;
    _os_log_impl(&dword_22F52A000, v2, OS_LOG_TYPE_INFO, "%{public}@[Demo Accessory Browser] Stopping browse for Demo accessories", (uint8_t *)&v4, 0xCu);
  }
}
...
uint64_t __65__HMDAccessoryServerBrowserDemo_startDiscoveringAccessoryServers__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v9 = v4;
    _os_log_impl(&dword_22F52A000, v3, OS_LOG_TYPE_INFO, "%{public}@[Demo Accessory Browser] Starting browse for Demo accessories...", buf, 0xCu);
  }
