...
- (void)main
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v14 = 2112;
    v15 = v7;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Stopping advertisement for existing followup items: %@", buf, 0x16u);
  }
...
void __43__HMDCoreFollowUpRemoveItemsOperation_main__block_invoke(uint64_t a1, int a2, void *a3)
{
  ...
  if (a2)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v18 = 2112;
      v19 = v12;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Successfully stopped advertising followup items: %@", (uint8_t *)&v16, 0x16u);
    }
    [v8 finish];
  }
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v20 = 2112;
      v21 = v15;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to stop advertisement for followup items: %@, with error: %@", (uint8_t *)&v16, 0x20u);
    }
...
- (HMDCoreFollowUpRemoveItemsOperation)initWithIdentifiersToRemove:(id)a3 followUpController:(id)a4
{
  ...
  {
LABEL_7:
    v13 = (HMDUserCloudShareRequest *)_HMFPreconditionFailure();
    [(HMDUserCloudShareRequest *)v13 .cxx_destruct];
    return result;
  }
  v15.receiver = self;
