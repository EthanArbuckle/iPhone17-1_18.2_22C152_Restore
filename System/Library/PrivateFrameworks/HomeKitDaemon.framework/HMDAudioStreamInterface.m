...
void __48__HMDAudioStreamInterface_streamDidRTCPTimeOut___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v6 = 138543362;
    v7 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Audio stream RTCP has timed out", (uint8_t *)&v6, 0xCu);
  }
}
...
void __47__HMDAudioStreamInterface_streamDidRTPTimeOut___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v6 = 138543362;
    v7 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Audio stream RTP has timed out", (uint8_t *)&v6, 0xCu);
  }
}
...
void __46__HMDAudioStreamInterface_streamDidServerDie___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v8 = 138543362;
    v9 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Audio stream server died", (uint8_t *)&v8, 0xCu);
  }
  int v6 = *(void **)(a1 + 32);
  v7 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1014];
  [v6 _callStopped:v7];
}
...
uint64_t __50__HMDAudioStreamInterface_stream_didResume_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v7;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Audio stream resumed with didResume: %@ error: %@", (uint8_t *)&v9, 0x20u);
  }
...
uint64_t __49__HMDAudioStreamInterface_stream_didPause_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v7;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Audio stream paused with didPause: %@ error: %@", (uint8_t *)&v9, 0x20u);
  }
...
uint64_t __41__HMDAudioStreamInterface_streamDidStop___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    int v8 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Audio stream stopped", (uint8_t *)&v7, 0xCu);
  }
...
uint64_t __49__HMDAudioStreamInterface_stream_didStart_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v7;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Audio stream started with didStart: %@ error: %@", (uint8_t *)&v9, 0x20u);
  }
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Creating PHASE engine and controller for stream token: %ld", buf, 0x16u);
    }
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v20 = 2112;
      id v21 = v9;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to create PHASE engine and controller: %@", buf, 0x16u);
    }
  }
  else
  {
  ...
  if ([*(id *)(a1 + 32) state] == 3)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v15 = v5;
      _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Not starting PHASEExternalOutputStreamController as stream is already stopped", buf, 0xCu);
    }
    [*(id *)(a1 + 40) stop];
  }
  else
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v16 = 2112;
        id v17 = v8;
        _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to start PHASEExternalOutputStreamController: %@", buf, 0x16u);
      }
      [*(id *)(a1 + 40) stop];
    }
  }
...
- (void)_callStopped:(id)a3
{
  ...
  id v10 = (void *)MEMORY[0x230FBD990]([(HMDAudioStreamInterface *)self setEngine:0]);
  id v11 = self;
  BOOL v12 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    int v16 = 138543362;
    id v17 = v13;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Calling delegate audioStream:didStop", (uint8_t *)&v16, 0xCu);
  }
...
- (void)_callResumed:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v11 = 138543362;
    BOOL v12 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Calling delegate audioStream:didResume", (uint8_t *)&v11, 0xCu);
  }
...
- (void)_callPaused:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v11 = 138543362;
    BOOL v12 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Calling delegate audioStream:didPause", (uint8_t *)&v11, 0xCu);
  }
  id v10 = [(HMDAudioStreamInterface *)v7 delegate];
  if (objc_opt_respondsToSelector()) {
...
- (void)_callStarted:(id)a3
{
  ...
  int v6 = (void *)MEMORY[0x230FBD990]([(HMDStreamInterface *)self setState:2]);
  int v7 = self;
  id v8 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v11 = 138543362;
    BOOL v12 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Calling delegate audioStream:didStart", (uint8_t *)&v11, 0xCu);
  }
  id v10 = [(HMDAudioStreamInterface *)v7 delegate];
  if (objc_opt_respondsToSelector()) {
...
- (void)setMuted:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    __int16 v20 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Setting audio muted to %@", (uint8_t *)&v17, 0x16u);
  }
...
- (void)startSynchronizationWithVideoStreamToken:(int64_t)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2048;
    int64_t v14 = a3;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Starting synchronization with video stream token: %ld", (uint8_t *)&v11, 0x16u);
  }
...
- (void)_resumeStream
{
  ...
  if (v6)
  {
    if (v11)
    {
      ...
      int v15 = 138543362;
      int v16 = v12;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Resuming audio stream", (uint8_t *)&v15, 0xCu);
    }
  ...
  else
  {
    if (v11)
    {
      ...
      int v15 = 138543362;
      int v16 = v14;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Starting audio stream", (uint8_t *)&v15, 0xCu);
    }
...
- (void)_pauseStream
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    id v10 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Pausing audio stream", (uint8_t *)&v9, 0xCu);
  }
...
- (void)_stopStreamWithCompletion:(id)a3
{
  ...
  if ([(HMDStreamInterface *)self state] == 3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      int v15 = 138543362;
      int v16 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Not stopping stream because it has already stopped", (uint8_t *)&v15, 0xCu);
    }
    v4[2](v4);
  }
  else
  {
    id v10 = (void *)MEMORY[0x230FBD990]([(HMDAudioStreamInterface *)self setStopStreamCompletionHandler:v4]);
    uint64_t v11 = self;
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      int v15 = 138543362;
      int v16 = v13;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Stopping audio stream", (uint8_t *)&v15, 0xCu);
    }
...
- (void)updateAudioVolume:(id)a3 callback:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v29 = 2048;
    double v30 = v16;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Setting audio stream volume from %f to %f", (uint8_t *)&v25, 0x20u);
  }
  [v6 floatValue];
  int v18 = v17;
...
- (void)updateAudioSetting:(unint64_t)a3
{
  ...
  if (a3 - 1 >= 3)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v25 = 2048;
      unint64_t v26 = a3;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Invalid audio stream setting %tu", (uint8_t *)&v23, 0x16u);
    }
  ...
  if (v6 == a3)
  {
    if (v10)
    {
      ...
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Audio stream setting is already set to %@", (uint8_t *)&v23, 0x16u);
    }
    __int16 v13 = v7;
LABEL_9:
    return;
  ...
  if (v10)
  {
    ...
    __int16 v27 = 2112;
    double v28 = v20;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Changing the audio stream setting from %@ to %@", (uint8_t *)&v23, 0x20u);
  }
...
- (void)startStreamWithConfig:(id)a3
{
  ...
  if (!v6)
  {
    if (v10)
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v22 = v19;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Failed to load misc fields to audio config", buf, 0xCu);
    }
    id v14 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1016];
    goto LABEL_11;
  }
  if (v10)
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v23 = 2112;
    id v24 = v4;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Configuring audio stream with configuration: %@", buf, 0x16u);
  }
  ...
  if ((v13 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v23 = 2112;
      id v24 = v14;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to configure audio stream: %@", buf, 0x16u);
    }
LABEL_11:
...
- (NSNumber)syncSource
{
  ...
  BOOL v6 = [v5 objectForKeyedSubscript:*MEMORY[0x263F21000]];
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    int v9 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Deallocating HMDAudioStreamInterface object", buf, 0xCu);
  }
  v7.receiver = v4;
...
- (HMDAudioStreamInterface)initWithSessionID:(id)a3 workQueue:(id)a4 delegate:(id)a5 sessionHandler:(id)a6 localNetworkConfig:(id)a7
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v28 = v22;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to create audio stream interface", buf, 0xCu);
    }
    __int16 v23 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t45 != -1) {
    dispatch_once(&logCategory__hmf_once_t45, &__block_literal_global_59312);
  }
  v2 = (void *)logCategory__hmf_once_v46;
  return v2;
}
  ...
  if (v7 == -1)
  {
    if (v11)
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v31 = 1024;
      int v32 = v20;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Could not create rtp socket with port %@ %d", buf, 0x1Cu);
    }
    id v14 = 0;
  }
  else
  {
    if (v11)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v29 = 1024;
      LODWORD(v30) = v7;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Creating local audio stream with socket %d", buf, 0x12u);
    }
    xpc_object_t v13 = xpc_dictionary_create(0, 0, 0);
    xpc_dictionary_set_fd(v13, (const char *)*MEMORY[0x263F21008], v7);
    id v26 = 0;
    id v14 = (void *)[objc_alloc(MEMORY[0x263F20F80]) initWithNetworkSockets:v13 isOriginator:0 error:&v26];
    id v15 = v26;
    if (v14)
    {
      *a3 = v7;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v29 = 2112;
        id v30 = v15;
        _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to create local AVCAudioStream: %@", buf, 0x16u);
      }
      close(v7);
    }
  }
...
+ (int)_createLocalRTPSocketWithRemoteSender:(id)a3 localNetworkConfig:(id)a4
{
  ...
  if (v8 == -1)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v21 = 1024;
      int v22 = v15;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Could not create rtp socket with port %@ %d", (uint8_t *)&v17, 0x1Cu);
    }
  }
...
+ (id)_createStreamWithRemoteSocketReceiver:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Creating audio stream with socket: %d", buf, 0x12u);
  }
  xpc_object_t v9 = xpc_dictionary_create(0, 0, 0);
  xpc_dictionary_set_fd(v9, (const char *)*MEMORY[0x263F21008], [v4 remoteAudioSocket]);
  id v18 = 0;
  id v10 = (void *)[objc_alloc(MEMORY[0x263F20F80]) initWithNetworkSockets:v9 isOriginator:0 error:&v18];
  id v11 = v18;
  if (v10)
  {
    id v12 = v10;
  ...
  {
    xpc_object_t v13 = (void *)MEMORY[0x230FBD990]();
    id v14 = v6;
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v21 = 2112;
      id v22 = v11;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to create remote socket receiver AVCAudioStream: %@", buf, 0x16u);
    }
  }
...
+ (id)_createStreamWithRemoteDestinationReceiver:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v23 = 2112;
    id v24 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Creating audio stream with destination: %@", buf, 0x16u);
  }
  id v10 = objc_alloc(MEMORY[0x263F20F80]);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v23 = 2112;
      id v24 = v13;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to create remote destination receiver AVCAudioStream: %@", buf, 0x16u);
    }
  }
...
+ (id)_createAudioStreamWithSessionHandler:(id)a3 localNetworkConfig:(id)a4 localRTPSocket:(int *)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    int v26 = 138543362;
    id v27 = v13;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Creating the audio stream", (uint8_t *)&v26, 0xCu);
  }
  id v14 = v8;
  if ([v14 conformsToProtocol:&unk_26E4C4EC8]) {
    int v15 = v14;
  }
  else {
    int v15 = 0;
  ...
  {
    id v19 = v14;
    if ([v19 conformsToProtocol:&unk_26E5758A0]) {
      id v20 = v19;
    }
    else {
      id v20 = 0;
    ...
    {
      id v22 = v19;
      if ([v22 conformsToProtocol:&unk_26E4CA7A0]) {
        __int16 v23 = v22;
      }
      else {
        __int16 v23 = 0;
