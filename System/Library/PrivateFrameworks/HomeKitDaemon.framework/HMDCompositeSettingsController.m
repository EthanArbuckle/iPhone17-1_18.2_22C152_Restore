...
- (void)database:(id)a3 didConfigureWithError:(id)a4
{
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_WORD *)&v32[12] = 2112;
      *(void *)&v32[14] = v8;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Error configuring database adapter: %@", v32, 0x16u);
    }
  }
  else
  {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v37 = v27;
          _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@Nil database adapter (_migrateAndCreateSettings)", buf, 0xCu);
        }
        v23 = 0;
      }
...
- (id)_migrateUpdatedSettings:(void *)a1
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v33 = 2112;
      v34 = v9;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Settings to migrate: %@", buf, 0x16u);
    }
    if ([v9 count])
    {
      ...
      id v27 = v14;
      SEL v16 = (void *)MEMORY[0x263F581B8];
      v18 = objc_msgSend(objc_getProperty(v11, v17, 64, 1), "queue", v26, 3221225472, __58__HMDCompositeSettingsController__migrateUpdatedSettings___block_invoke_31, &unk_264A1F9B0, v11);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v32 = v24;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Nil database adapter (_migrateUpdatedSettings)", buf, 0xCu);
    }
    id v20 = 0;
  }
...
void __58__HMDCompositeSettingsController__migrateUpdatedSettings___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v19 = 2112;
    id v20 = v6;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Updating setting on model: %@, setting: %@", buf, 0x20u);
  }
}
  ...
  if (self)
  {
    ...
    if (v7)
    {
      if (v11)
      {
        ...
        __int16 v22 = 2112;
        id v23 = v6;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Processing  model deletion, model:%@", (uint8_t *)&v20, 0x16u);
      }
      id v14 = objc_getProperty(v9, v13, 64, 1);
      v15 = [(HMDCompositeSettingsController *)v9 uuid];
      [v14 stopObservingModelWithID:v15];

      SEL v16 = (void *)MEMORY[0x263EFFA78];
      objc_setProperty_atomic_copy(v9, v17, MEMORY[0x263EFFA78], 24);
    ...
    else
    {
      if (v11)
      {
        ...
        int v20 = 138543362;
        uint64_t v21 = v19;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Nil database adapter (_handleModelDeletion)", (uint8_t *)&v20, 0xCu);
      }
    }
  }
}
  ...
  if (a1)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v15 = v11;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Nil database (_handleModelCreationOrUpdate)", buf, 0xCu);
      }
    }
  }
}
...
- (id)_settingFromSetting:(id)a3 value:(id)a4 error:(id *)a5
{
  ...
  if (!v11)
  {
    ...
    if (v24)
    {
      ...
      {
        id v13 = [MEMORY[0x263F087E8] hmErrorWithCode:19, @"Invalid string setting value", 0, @"Setting type is String, please pass a String value" description reason suggestion];
        ...
        if (os_log_type_enabled(v67, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v149 = 2112;
          id v150 = v13;
          _os_log_impl(&dword_22F52A000, v67, OS_LOG_TYPE_ERROR, "%{public}@%@", buf, 0x16u);
        }
        if (v140)
        {
          id v13 = v13;
    ...
    else
    {
      ...
      if (v43)
      {
        ...
        {
          id v13 = [MEMORY[0x263F087E8] hmErrorWithCode:19, @"Invalid BOOL setting value", 0, @"Setting type is Bool, please pass a Bool value" description reason suggestion];
          ...
          if (os_log_type_enabled(v93, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v149 = 2112;
            id v150 = v13;
            _os_log_impl(&dword_22F52A000, v93, OS_LOG_TYPE_ERROR, "%{public}@%@", buf, 0x16u);
          }
          id v35 = v43;
          if (v140)
          {
      ...
      else
      {
        ...
        if (v71)
        {
          ...
          if (!v74)
          {
            id v13 = [MEMORY[0x263F087E8] hmErrorWithCode:19, @"Invalid Number setting value", 0, @"Setting type is Number, please pass a Number value" description reason suggestion];
            ...
            if (os_log_type_enabled(v77, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v149 = 2112;
              id v150 = v13;
              _os_log_impl(&dword_22F52A000, v77, OS_LOG_TYPE_ERROR, "%{public}@%@", buf, 0x16u);
            }
            if (v140)
            {
              id v13 = v13;
        ...
        else
        {
          ...
          if (v97)
          {
            ...
            id v145 = v8;
            id v98 = v9;
            if ([v98 conformsToProtocol:&unk_26E4D7DD8]) {
              v99 = v98;
            }
            else {
              v99 = 0;
            ...
            if (!v100)
            {
              id v13 = [MEMORY[0x263F087E8] hmErrorWithCode:19, @"Invalid Language setting value", 0, @"Setting type is Language, please pass a Language value" description reason suggestion];
              ...
              if (os_log_type_enabled(v103, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                __int16 v149 = 2112;
                id v150 = v13;
                _os_log_impl(&dword_22F52A000, v103, OS_LOG_TYPE_ERROR, "%{public}@%@", buf, 0x16u);
              }
              if (v140)
              {
                id v13 = v13;
          ...
          {
            id v118 = v8;
            id v13 = [MEMORY[0x263F087E8] hmErrorWithCode:19 description:@"trying to create an invalid setting from value" reason:0 suggestion:0];
            ...
            if (os_log_type_enabled(v121, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v149 = 2112;
              id v150 = v13;
              _os_log_impl(&dword_22F52A000, v121, OS_LOG_TYPE_ERROR, "%{public}@%@", buf, 0x16u);
            }
            if (v140)
            {
              id v13 = v13;
  ...
  if (self)
  {
    ...
    {
      id v35 = [MEMORY[0x263F087E8] hmErrorWithCode:3 description:@"Unable to derived setting" reason:@"unknown version type" suggestion:0];
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v151 = 2112;
        id v152 = v35;
        _os_log_impl(&dword_22F52A000, v38, OS_LOG_TYPE_ERROR, "%{public}@Failed to derive setting due to unknown version value type: %@ error: %@", buf, 0x20u);
      }
      if (a5)
      {
        id v35 = v35;
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            id v134 = v111;
            v123 = [MEMORY[0x263F087E8] hmErrorWithCode:19 description:@"Unable to derived setting" reason:@"unknown setting type" suggestion:0];
            ...
            if (os_log_type_enabled(v126, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v151 = 2112;
              id v152 = v123;
              _os_log_impl(&dword_22F52A000, v126, OS_LOG_TYPE_ERROR, "%{public}@Failed to derive setting due to unknown setting object type: %@ error: %@", buf, 0x20u);
            }
            id v35 = v138;
            if (v139) {
              id *v139 = v123;
...
- (void)updateSettingsForKeyPaths:(id)a3 callerVersion:(id)a4 completion:(id)a5
{
  ...
  if ([v8 count])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v34 = v26;
        _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@Nil database (updateSettingsForKeyPaths)", buf, 0xCu);
      }
      id v27 = [MEMORY[0x263F087E8] hmErrorWithCode:21];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v34 = v22;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@settings is empty", buf, 0xCu);
    }
  ...
  if (v53)
  {
    ...
    while (1)
    {
      ...
      do
      {
        ...
        if (!v13)
        {
          id v44 = [MEMORY[0x263F087E8] hmErrorWithCode:21 description:@"Setting has not been configured yet (no current setting)" reason:0 suggestion:0];
          ...
          if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_WORD *)&buf[12] = 2112;
            *(void *)&buf[14] = v44;
            _os_log_impl(&dword_22F52A000, v50, OS_LOG_TYPE_ERROR, "%{public}@Error: %@", buf, 0x16u);
          }
        ...
        if (v15)
        {
          ...
          if (v18)
          {
            id v8 = [MEMORY[0x263F087E8] hmErrorWithCode:10 description:@"Write version does not meet the minimum" reason:0 suggestion:0];
            ...
            if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_WORD *)&buf[12] = 2112;
              *(void *)&buf[14] = v8;
              _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Error: %@", buf, 0x16u);
            }
...
LABEL_27:
                ...
                *(_WORD *)&buf[12] = 2112;
                *(void *)&buf[14] = v8;
                _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_ERROR, "%{public}@Error: %@", buf, 0x16u);
              }
LABEL_28:
...
LABEL_29:
        ...
        else
        {
          ...
          if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_WORD *)&buf[12] = 2112;
            *(void *)&buf[14] = v16;
            _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_ERROR, "%{public}@Error: %@", buf, 0x16u);
          }
...
LABEL_40:
  ...
  if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)id v74 = 138543362;
    v75 = v43;
    _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_INFO, "%{public}@Nil database (_updateSettingsForKeyPaths)", v74, 0xCu);
  }
  id v44 = [MEMORY[0x263F087E8] hmErrorWithCode:21];
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v23 = 2112;
      id v24 = v3;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Finished updating models:%@ error:%@", buf, 0x20u);
    }
    ...
    id v17 = v3;
    id v18 = *(id *)(a1 + 40);
    id v11 = (void *)MEMORY[0x263F581B8];
    id v13 = objc_msgSend(objc_getProperty(v6, v12, 64, 1), "queue", v16[0], 3221225472, __86__HMDCompositeSettingsController__updateSettingsForKeyPaths_callerVersion_completion___block_invoke_92, &unk_264A1FA50);
...
- (void)updateSettingForKeyPath:(id)a3 value:(id)a4 callerVersion:(id)a5 completion:(id)a6
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v33 = v24;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Nil database (updateSettingForKeyPath)", buf, 0xCu);
    }
    uint64_t v25 = [MEMORY[0x263F087E8] hmErrorWithCode:21];
    ...
    if (!v9)
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
      {
        ...
        *(void *)&uint8_t buf[4] = v25;
        _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@Nil database (_updateSettingForKeyPath)", buf, 0xCu);
      }
      id v16 = [MEMORY[0x263F087E8] hmErrorWithCode:21];
      ...
      if (v47)
      {
        if (v48)
        {
          if (v7)
          {
            ...
            if (!v12)
            {
              id v16 = [MEMORY[0x263F087E8] hmErrorWithCode:21 description:@"Setting has not been configured yet (no current setting)" reason:0 suggestion:0];
              ...
              if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_WORD *)&buf[12] = 2112;
                *(void *)&buf[14] = v16;
                _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Error: %@", buf, 0x16u);
              }
            ...
            if (v15)
            {
              id v16 = [MEMORY[0x263F087E8] hmErrorWithCode:10 description:@"Write version does not meet the minimum" reason:0 suggestion:0];
              id v17 = [[HMDCompositeSettingOperationResult alloc] initWithKeyPath:v5 setting:0 metadata:0 error:v16];
              ...
              if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_WORD *)&buf[12] = 2112;
                *(void *)&buf[14] = v16;
                _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Error: %@", buf, 0x16u);
              }
              v7[2](v7, v17);
              goto LABEL_33;
            }
            ...
            if (!v17)
            {
              ...
              if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_WORD *)&buf[12] = 2112;
                *(void *)&buf[14] = v16;
                _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_ERROR, "%{public}@Error: %@", buf, 0x16u);
              }
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v29 = 2112;
      id v30 = v3;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@updating current setting:%@, new setting:%@ error:%@", buf, 0x2Au);
    }
    ...
    id v21 = *(id *)(a1 + 56);
    id v22 = *(id *)(a1 + 64);
    id v12 = (void *)MEMORY[0x263F581B8];
    uint64_t v14 = objc_msgSend(objc_getProperty(v6, v13, 64, 1), "queue", v17[0], 3221225472, __90__HMDCompositeSettingsController__updateSettingForKeyPath_value_callerVersion_completion___block_invoke_82, &unk_264A1FA28, v6);
...
void __90__HMDCompositeSettingsController__updateSettingForKeyPath_value_callerVersion_completion___block_invoke_82(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    uint64_t v16 = v9;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@updating setting:%@, error:%@", (uint8_t *)&v11, 0x20u);
  }
...
- (id)fetchSynchronousSettingsForKeyPaths:(id)a3 callerVersion:(id)a4 callerPrivilege:(unint64_t)a5
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v34 = v21;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Nil database (fetchSynchronousSettingsForKeyPaths)", buf, 0xCu);
    }
    id v22 = [MEMORY[0x263F087E8] hmErrorWithCode:21];
  ...
  if (a1 && v11)
  {
    if (objc_msgSend(objc_getProperty(a1, v12, 56, 1), "containsObject:", v9))
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v52 = 2112;
        id v53 = v9;
        _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Blocked fetch setting with key path: %@", buf, 0x16u);
      }
      id v19 = [MEMORY[0x263F087E8] hmErrorWithCode:23];
    ...
    if (!v19)
    {
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v51 = v40;
        _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_INFO, "%{public}@Nil database (_fetchSettingForKeyPath)", buf, 0xCu);
      }
      id v20 = [MEMORY[0x263F087E8] hmErrorWithCode:21];
    ...
    if (!v20)
    {
      v42 = [MEMORY[0x263F087E8] hmErrorWithCode:21 description:@"Setting has not been configured yet (no setting)" reason:0 suggestion:0];
      SEL v43 = (void *)MEMORY[0x230FBD990]();
      id v44 = a1;
      ...
      if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v52 = 2112;
        id v53 = v42;
        _os_log_impl(&dword_22F52A000, v45, OS_LOG_TYPE_ERROR, "%{public}@_fetchSettingForKeyPath Error: %@", buf, 0x16u);
      }
    ...
    if (!v25
      || ([(HMDCompositeSettingOperationResult *)v25 privileges],
          ...
          v28 == -1))
    {
      uint64_t v31 = [MEMORY[0x263F087E8] hmErrorWithCode:17 description:@"Insufficient User read Privilege or missing Metadata" reason:0 suggestion:0];
    ...
    else
    {
      ...
      uint64_t v31 = [MEMORY[0x263F087E8] hmErrorWithCode:10 description:@"Read version does not meet the minimum" reason:0 suggestion:0];
      id v32 = (void *)MEMORY[0x230FBD990]();
      id v33 = a1;
      id v34 = HMFGetOSLogHandle();
      if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
...
LABEL_19:
        _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_ERROR, v36, buf, 0x16u);
    ...
    if (![v10 count])
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        *(void *)((char *)&aBlock + 4) = v23;
        _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Empty keypaths array", (uint8_t *)&aBlock, 0xCu);

        id v20 = v33;
      }

      v18[2](v18, MEMORY[0x263EFFA68]);
    }
    if (self) {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
    {
      ...
      *(void *)((char *)&aBlock + 4) = v30;
      _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_INFO, "%{public}@Nil database (fetchSettingsForKeyPaths)", (uint8_t *)&aBlock, 0xCu);
    }
    uint64_t v31 = [MEMORY[0x263F087E8] hmErrorWithCode:21];
...
- (void)fetchSettingForKeyPath:(id)a3 callerVersion:(id)a4 callerPrivilege:(unint64_t)a5 completion:(id)a6
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v32 = v23;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Nil database (fetchSettingForKeyPath)", buf, 0xCu);
    }
    id v24 = [MEMORY[0x263F087E8] hmErrorWithCode:21];
...
- (void)_createSettingsFromModel:(id)a3
{
  ...
  if (v55)
  {
    ...
    if (self)
    {
      ...
      *(void *)id v58 = MEMORY[0x263EF8330];
      ...
      *(void *)&v58[16] = __74__HMDCompositeSettingsController__addedOrUpdatedSettingsFrom_newSettings___block_invoke;
      uint64_t v59 = &unk_264A1F988;
      id v60 = v12;
      id v16 = v15;
      v61 = v16;
      uint64_t v17 = (void *)MEMORY[0x230FBD990](objc_msgSend(v14, "na_each:", v58));
      id v18 = self;
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(void *)&buf[14] = v16;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Settings changed %@", buf, 0x16u);
      }
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&v58[12] = 2112;
      *(void *)&v58[14] = v21;
      _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@Updated Settings %@", v58, 0x16u);
    }
    if ([v21 count])
    {
      id v26 = v21;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
    {
      ...
      *(void *)&v58[4] = v45;
      _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_INFO, "%{public}@Nil database (_createSettingsFromModel)", v58, 0xCu);
    }
  }
}
...
void __62__HMDCompositeSettingsController_filteredSettingsForSettings___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v11 = 2112;
      id v12 = v3;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Filtering setting with blocked key path: %@", (uint8_t *)&v9, 0x16u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t13_119506 != -1) {
    dispatch_once(&logCategory__hmf_once_t13_119506, &__block_literal_global_119507);
  }
  v2 = (void *)logCategory__hmf_once_v14_119508;
  return v2;
}
...
void __45__HMDCompositeSettingsController_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v14_119508;
  logCategory__hmf_once_v14_119508 = v0;
}
