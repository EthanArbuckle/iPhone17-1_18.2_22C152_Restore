...
- (void)submitFailureEventOfType:(unint64_t)a3 message:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v21 = 2112;
    id v22 = v6;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Submitting failure event: %@ for message: %@", (uint8_t *)&v17, 0x20u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_167685 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_167685, &__block_literal_global_167686);
  }
  v2 = (void *)logCategory__hmf_once_v2_167687;
  return v2;
}
...
void __49__HMDMessageHandlerMetricsDispatcher_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_167687;
  logCategory__hmf_once_v2_167687 = v0;
}
