  ...
  if ([(HMDDuetPredictionSubscriber *)self duetPredictionsChangedNotificationToken] == -1)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v13 = v6;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Registering for duet prediction change notifications", buf, 0xCu);
    }
...
void __40__HMDDuetPredictionSubscriber_configure__block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      int v12 = 138543362;
      v13 = v6;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Received notification duet predictions changed", (uint8_t *)&v12, 0xCu);
    }
    ...
    v10 = [MEMORY[0x263F42590] entitledMessageWithName:*MEMORY[0x263F0DBB8] messagePayload:0];
...
- (HMDDuetPredictionSubscriber)initWithWorkQueue:(id)a3 messageDispatcher:(id)a4
{
  v6 = (objc_class *)MEMORY[0x263F0E2C0];
  id v7 = a4;
  id v8 = a3;
