...
- (BOOL)acceptMessage:(id)a3 error:(id *)a4
{
  ...
  id v6 = a3;
  long long v7 = [v6 destination];
  long long v8 = [v7 target];

  long long v30 = 0u;
  long long v31 = 0u;
  long long v28 = 0u;
  long long v29 = 0u;
  long long v9 = [(HMDMessageFilterChain *)self filters];
  ...
  if (v10)
  {
    ...
    while (2)
    {
      ...
      do
      {
        ...
        long long v16 = *(void **)(*((void *)&v28 + 1) + 8 * v14);
        id v27 = v15;
        ...
        if ((v17 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            __int16 v38 = 2112;
            id v39 = v12;
            _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@%@ Message %@ was rejected due to reason: %@", buf, 0x2Au);
          }
          BOOL v18 = 0;
          goto LABEL_13;
        }
...
- (NSArray)filters
{
  p_lock = &self->_lock;
  os_unfair_lock_lock_with_options();
  id v4 = (void *)[(NSMutableArray *)self->_filters copy];
  os_unfair_lock_unlock(p_lock);
  return (NSArray *)v4;
}
