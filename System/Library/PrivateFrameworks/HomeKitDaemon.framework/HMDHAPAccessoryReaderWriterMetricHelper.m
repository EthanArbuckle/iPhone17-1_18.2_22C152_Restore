          ...
          if (([*(id *)(a1 + 40) containsObject:v8] & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138545922;
              ...
              __int16 v55 = 2114;
              v56 = v19;
              _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@For Task: %{public}@ -- %{public}@ %tu characteristic(s) on accessory %{public}@ completed with error: %{public}@ (Resident first error: %{public}@), Total duration: %ld ms (Local duration: %ld ms, Resident first duration: %ld ms) using transport: %{public}@", buf, 0x70u);
...
+ (void)updateLogEvents:(id)a3 withResponses:(id)a4 forTaskID:(id)a5 shouldSubmit:(BOOL)a6
{
  id v10 = a3;
  id v11 = a5;
  id v12 = (void *)MEMORY[0x263F499B8];
  id v13 = a4;
  [v12 currentTime];
  uint64_t v15 = v14;
