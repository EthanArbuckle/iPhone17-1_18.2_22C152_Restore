...
- (HMDCameraReachabilityBulletinNotificationRegistration)initWithDictionary:(id)a3
{
  ...
  v18.receiver = self;
  v18.super_class = (Class)HMDCameraReachabilityBulletinNotificationRegistration;
...
LABEL_7:
  ...
  uint64_t v8 = [v4 objectForKeyedSubscript:@"HMDCRBNR.ck.au"];
  if (v8)
  {
    char v9 = (void *)v8;
  ...
  return [(HMDCameraReachabilityBulletinNotificationRegistration *)v14 initWithAccessoryUUID:v16 conditions:v17];
}
...
- (HMDCameraReachabilityBulletinNotificationRegistration)initWithAccessoryUUID:(id)a3 conditions:(id)a4
{
  ...
  if (v6)
  {
    uint64_t v8 = v7;
    v15.receiver = self;
    v15.super_class = (Class)HMDCameraReachabilityBulletinNotificationRegistration;
  ...
  else
  {
    ...
    return (HMDCameraReachabilityBulletinNotificationRegistration *)+[HMDCameraReachabilityBulletinNotificationRegistration supportsSecureCoding];
  }
}
