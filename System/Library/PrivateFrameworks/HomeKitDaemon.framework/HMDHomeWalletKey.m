...
- (id)xpcWalletKeyWithExpressEnabled:(BOOL)a3 uwbEnabled:(BOOL)a4 clientWalletKeyUUID:(id)a5;
- (int64_t)color;
- (int64_t)state;
- (unint64_t)hash;
...
- (id)attributeDescriptions
{
  ...
  v32[8] = v20;
  v21 = [MEMORY[0x263EFF8C0] arrayWithObjects:v32 count:9];
...
- (BOOL)isMissingNFCInfo
{
  ...
  char v7 = objc_msgSend(v6, "na_any:", &__block_literal_global_43078);
...
- (id)xpcWalletKeyWithExpressEnabled:(BOOL)a3 uwbEnabled:(BOOL)a4 clientWalletKeyUUID:(id)a5
{
  ...
  id v8 = a5;
  id v9 = [(HMDHomeWalletKey *)self customURL];
  ...
  uint64_t v10 = [(HMDHomeWalletKey *)self uuid];
  if (!_os_feature_enabled_impl()) {
    goto LABEL_12;
  }
  if ((isInternalBuild() & 1) == 0)
  {
    int AppBooleanValue = CFPreferencesGetAppBooleanValue(@"UWBUnlock", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0);
...
LABEL_9:
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      int64_t v18 = [(HMDHomeWalletKey *)v15 uuid];
      int v22 = 138543874;
      int v23 = v17;
      __int16 v24 = 2112;
      id v25 = v13;
      __int16 v26 = 2112;
      v27 = v18;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Client Wallet Key UUID set in local store, using it: %@ instead of %@", (uint8_t *)&v22, 0x20u);
    }
    goto LABEL_13;
  }
  if (v8) {
...
LABEL_12:
  id v13 = v10;
LABEL_13:
  id v19 = objc_alloc(MEMORY[0x263F0E3E0]);
  char v20 = [(HMDHomeWalletKey *)self customURL];
  int64_t v11 = objc_msgSend(v19, "initWithUUID:customURL:expressEnabled:uwbUnlockEnabled:color:", v13, v20, v6, v5, -[HMDHomeWalletKey color](self, "color"));
...
- (NSUUID)uuid
{
  ...
  BOOL v7 = [(HMDHomeWalletKey *)self nfcInfos];
...
- (HMDHomeWalletKey)initWithPKPass:(id)a3 flow:(id)a4
{
  ...
  if (v19 > 3) {
    uint64_t v20 = *MEMORY[0x263F0CF48];
  }
  else {
    uint64_t v20 = qword_2303E3D20[v19];
  }
  v21 = [v9 value];
  int v22 = [(HMDHomeWalletKey *)self initWithTypeIdentifier:v31 serialNumber:v30 state:v18 walletKeyDescription:v8 homeName:v21 color:v20 nfcInfos:v15];

  int v23 = [v6 fieldForKey:@"arbitrary_supplementary_field_accessCode"];
  __int16 v24 = [v10 link];

  if (v24)
  {
    id v25 = NSURL;
    __int16 v26 = [v10 link];
    __int16 v24 = [v25 URLWithString:v26];
  }
  v27 = [v23 value];
  [(HMDHomeWalletKey *)v22 setAccessCode:v27];

  [(HMDHomeWalletKey *)v22 setChangeAccessCodeHomeAppCustomURL:v24];
  uint64_t v28 = [v6 passURL];
...
- (HMDHomeWalletKey)initWithTypeIdentifier:(id)a3 serialNumber:(id)a4 state:(int64_t)a5 walletKeyDescription:(id)a6 homeName:(id)a7 color:(int64_t)a8 nfcInfos:(id)a9
{
  ...
  uint64_t v20 = [(HMDHomeWalletKey *)&v32 init];
  if (v20)
  {
