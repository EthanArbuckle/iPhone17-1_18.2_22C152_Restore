...
- (id)attributeDescriptions
{
  ...
  v4 = [(HMDCHIPControllerACLStorage *)self keyValueStore];
  ...
  if (v5)
  {
    ...
    v7 = NSNumber;
    v8 = [(HMDCHIPControllerACLStorage *)self keyValueStore];
...
{
  v2 = NSString;
  v3 = [(HMDCHIPControllerACLStorage *)self keyValueStore];
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = [+[HMDCHIPControllerACLStorage allocWithZone:a3] init];
  uint64_t v5 = [(HMDCHIPControllerACLStorage *)self keyValueStore];
  [(HMDCHIPControllerACLStorage *)v4 setKeyValueStore:v5];
...
- (unint64_t)hash
{
  v2 = [(HMDCHIPControllerACLStorage *)self keyValueStore];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v6)
  {
    v7 = [(HMDCHIPControllerACLStorage *)self keyValueStore];
    v8 = [v6 keyValueStore];
...
- (NSDictionary)debugDictionaryRepresentation
{
  ...
  id v4 = [(HMDCHIPControllerACLStorage *)self keyValueStore];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_268168 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_268168, &__block_literal_global_268169);
  }
  v2 = (void *)logCategory__hmf_once_v4_268170;
  return v2;
}
...
void __42__HMDCHIPControllerACLStorage_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_268170;
  logCategory__hmf_once_v4_268170 = v0;
}
