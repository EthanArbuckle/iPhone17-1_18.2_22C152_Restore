      ...
      if (*((unsigned char *)v42 + 24))
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v48 = 2112;
          v49 = @"RTP";
          _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Adding fallback LAN rules for %@", buf, 0x16u);
        }
      ...
      if (*((unsigned char *)v38 + 24))
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v48 = 2112;
          v49 = @"HDS";
          _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Adding fallback LAN rules for %@", buf, 0x16u);
        }
...
LABEL_20:
  ...
  v26 = [(HMDNetworkRouterFirewallRuleConfiguration *)&v30 initWithAccessoryIdentifier:v8 lastModifiedTime:v9 fullAccessLAN:v10 != 0 lanRules:v25 fullAccessWAN:0 wanRules:MEMORY[0x263EFFA68]];
...
{
  uint64_t v3 = *MEMORY[0x263F0D660];
  id v4 = a2;
...
void __84__HMDNetworkRouterHomeKitOnlyFirewallConfiguration_fallbackConfigurationForRuleset___block_invoke(uint64_t a1)
{
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v25 = v17;
        _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Unable to load fallback network protection rules", buf, 0xCu);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v25 = v13;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Unable to locate fallback network protection rules", buf, 0xCu);
    }
  }
}
...
void __84__HMDNetworkRouterHomeKitOnlyFirewallConfiguration_fallbackConfigurationForRuleset___block_invoke_20(uint64_t a1, void *a2, void *a3)
{
        ...
        v16 = [(HMDNetworkRouterFirewallRuleConfiguration *)v14 initWithAccessoryIdentifier:v15 jsonDictionary:v12], v15, !v16))
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v23 = 2112;
      id v24 = v7;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse fallback network protection rules for '%@'", (uint8_t *)&v21, 0x16u);
    }
  }
  else
  {
...
+ (id)fallbackIdentifier
{
  v2 = (void *)[objc_alloc(MEMORY[0x263F42670]) initWithMajorVersion:0 minorVersion:0 updateVersion:0];
