...
- (void)_backgroundTimerDidExpire:(id)a3
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v35 = 2112;
    v36 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@bundleIdentifier: %@ backgroundTimer: %@ expired.", (uint8_t *)&v31, 0x20u);
  }
  if (v7)
  {
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v35 = 2112;
    v36 = v18;
    _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@foregroundProcesses %@, backgroundProcesses %@", (uint8_t *)&v31, 0x20u);
  }
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v35 = 2112;
    v36 = v28;
    _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@self.isProcessForeground %@, isProcessForeground %@", (uint8_t *)&v31, 0x20u);
  }
  if (!v21)
  {
...
- (void)_removeBackgroundTimer:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v12 = 2112;
      id v13 = v4;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Remove backgroundTimer: %@", (uint8_t *)&v10, 0x16u);
    }
    [v4 suspend];
  }
}
...
- (id)_enableBackgroundTimerWithBundleIdentifier:(id)a3
{
  ...
  v19 = (void *)MEMORY[0x230FBD990](v14, v15, v16, v17, v18);
  v20 = self;
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v35 = 2112;
    v36 = v23;
    _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Starting backgroundTimer: %@ interval: %@", buf, 0x20u);
  }
  [v13 resume];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v21 = 1024;
      BOOL v22 = v4;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring foreground state change for application %@ with isActive: %{BOOL}d", buf, 0x1Cu);
    }
  }
}
...
void __101__HMDRemoteEventRouterProcessStateChangeAssertion_handleProcessWithBundleIdentifier_updatedIsActive___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v40 = 1024;
    LODWORD(v41) = v7;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Application %@ isActive state changed to %{BOOL}d", (uint8_t *)&v36, 0x1Cu);
  }
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v38 = 2112;
      v39 = v20;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@self.isProcessForeground %@, isProcessForeground YES", (uint8_t *)&v36, 0x16u);
    }
...
LABEL_13:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
    {
      ...
      int v36 = 138543362;
      uint64_t v37 = v35;
      _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_ERROR, "%{public}@Failed to enable background timer.", (uint8_t *)&v36, 0xCu);
    }
    id v13 = 0;
  }
LABEL_14:
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v40 = 2112;
    v41 = v31;
    _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_INFO, "%{public}@foregroundProcesses %@, backgroundProcesses %@", (uint8_t *)&v36, 0x20u);
  }
}
...
- (HMDRemoteEventRouterProcessStateChangeAssertion)initWithQueue:(id)a3 timerProvider:(id)a4 applicationsAndIntervals:(id)a5 dataSource:(id)a6
{
  ...
  if (v15)
  {
    ...
    uint64_t v18 = objc_msgSend(objc_alloc(MEMORY[0x263EFF9C0]), "initWithCapacity:", objc_msgSend(v13, "count"));
    foregroundProcesses = v16->_foregroundProcesses;
    v16->_foregroundProcesses = (NSMutableSet *)v18;

    uint64_t v20 = objc_msgSend(objc_alloc(MEMORY[0x263EFF9A0]), "initWithCapacity:", objc_msgSend(v13, "count"));
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t10_200083 != -1) {
    dispatch_once(&logCategory__hmf_once_t10_200083, &__block_literal_global_200084);
  }
  v2 = (void *)logCategory__hmf_once_v11_200085;
  return v2;
}
...
void __62__HMDRemoteEventRouterProcessStateChangeAssertion_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v11_200085;
  logCategory__hmf_once_v11_200085 = v0;
}
