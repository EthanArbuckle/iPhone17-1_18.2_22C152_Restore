  ...
  if (v13)
  {
    ...
    if (!v15)
    {
      ...
      if ((v19 & 1) == 0)
      {
        ...
        char v22 = [v21 isEqualToString:*MEMORY[0x263F0B0A0]];
...
LABEL_13:
            ...
            if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v48 = 2112;
              v49 = v40;
              _os_log_impl(&dword_22F52A000, v38, OS_LOG_TYPE_INFO, "%{public}@Populating configuredName with providedName: %@", buf, 0x16u);
            }
            v24 = [v7 providedName];
...
- (id)dumpDescription
{
  unint64_t v3 = [MEMORY[0x263EFF9A0] dictionaryWithCapacity:2];
  id v4 = NSString;
  ...
  [v3 setObject:v10 forKey:*MEMORY[0x263F41FA8]];
  return v3;
}
...
- (BOOL)isHAPAirPlay2Accessory
{
  ...
  if (v4)
  {
    ...
    char v6 = MEMORY[0x230FBC450]([v5 outputDevice]);
  }
  else
  {
    char v6 = 0;
...
- (HMDUnassociatedMediaAccessory)initWithIdentifier:(id)a3 name:(id)a4 category:(id)a5 messageDispatcher:(id)a6
{
  ...
  if (!v12)
  {
    v14 = (void *)MEMORY[0x263F0DF40];
    id v15 = objc_alloc(MEMORY[0x263F08C38]);
    v16 = (void *)[v15 initWithUUIDString:*MEMORY[0x263F0B130]];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_73167 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_73167, &__block_literal_global_73168);
  }
  v2 = (void *)logCategory__hmf_once_v5_73169;
  return v2;
}
...
void __44__HMDUnassociatedMediaAccessory_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_73169;
  logCategory__hmf_once_v5_73169 = v0;
}
