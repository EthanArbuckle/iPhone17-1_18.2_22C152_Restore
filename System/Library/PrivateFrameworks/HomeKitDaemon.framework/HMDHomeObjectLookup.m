...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_137745 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_137745, &__block_literal_global_137746);
  }
  v2 = (void *)logCategory__hmf_once_v4_137747;
  return v2;
}
...
void __34__HMDHomeObjectLookup_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_137747;
  logCategory__hmf_once_v4_137747 = v0;
}
