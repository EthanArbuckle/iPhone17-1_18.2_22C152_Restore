...
uint64_t __64__HMDCharacteristicsAvailabilityListener_handleServicesUpdated___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Services updated", (uint8_t *)&v7, 0xCu);
  }
...
uint64_t __71__HMDCharacteristicsAvailabilityListener_handleCharacteristicsUpdated___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Characteristics updated", (uint8_t *)&v7, 0xCu);
  }
  return [*(id *)(a1 + 32) _notifyDelegate];
}
...
- (void)_notifyDelegate
{
  ...
  if ((v6 & 1) == 0)
  {
    int v7 = (void *)MEMORY[0x230FBD990]([(HMDCharacteristicsAvailabilityListener *)self setAvailableCharacteristics:v4]);
    v8 = self;
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v15 = 2112;
      v16 = v4;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Notifying delegate of characteristics update: %@", (uint8_t *)&v13, 0x16u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_273539 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_273539, &__block_literal_global_273540);
  }
  v2 = (void *)logCategory__hmf_once_v4_273541;
  return v2;
}
...
void __53__HMDCharacteristicsAvailabilityListener_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_273541;
  logCategory__hmf_once_v4_273541 = v0;
}
