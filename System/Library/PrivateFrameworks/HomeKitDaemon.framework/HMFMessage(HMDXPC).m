...
- (uint64_t)source
{
  ...
  {
    id v4 = [v1 numberForKey:@"sourceType"];
    v5 = v4;
    if (v4)
    {
...
- (uint64_t)isEntitledForShortcutsAutomationAccess
{
  uint64_t v2 = [a1 proxyConnection];
  uint64_t v3 = v2;
  if (v2)
  {
    uint64_t v4 = [v2 isEntitledForShortcutsAutomationAccess];
  }
  else if ([a1 isSecureRemote])
  {
    v5 = [a1 headers];
    uint64_t v4 = objc_msgSend(v5, "hmf_BOOLForKey:", @"cl.shortcutent");
  }
  else
  {
    uint64_t v4 = 0;
...
- (uint64_t)isAuthorizedForLocationAccess
{
  ...
  if (v2)
  {
    uint64_t v4 = [v2 isAuthorizedForLocationAccess];
  }
  else if ([a1 isSecureRemote])
  {
    v5 = [a1 headers];
    uint64_t v4 = objc_msgSend(v5, "hmf_BOOLForKey:", @"cl.locauthz");
  }
  else
  {
    uint64_t v4 = 0;
...
{
  id v1 = [a1 userInfo];
  uint64_t v2 = [v1 objectForKeyedSubscript:@"requiresWalletKeyEntitlement"];
...
{
  id v1 = [a1 userInfo];
  uint64_t v2 = [v1 objectForKeyedSubscript:@"requiresPersonManagerEntitlement"];
...
{
  id v1 = [a1 userInfo];
  uint64_t v2 = [v1 objectForKeyedSubscript:@"requiresMultiUserSetupEntitlement"];
...
{
  id v1 = [a1 userInfo];
  uint64_t v2 = [v1 objectForKeyedSubscript:@"requiresCameraClipsEntitlement"];
...
{
  id v1 = [a1 userInfo];
  uint64_t v2 = [v1 objectForKeyedSubscript:@"requiresMatterSetupPayloadEntitlement"];
...
{
  id v1 = [a1 userInfo];
  uint64_t v2 = [v1 objectForKeyedSubscript:@"requiresSetupPayloadEntitlement"];
...
{
  id v1 = [a1 userInfo];
  uint64_t v2 = [v1 objectForKeyedSubscript:@"requiresNoSPIEntitlement"];
...
{
  id v1 = [a1 userInfo];
  uint64_t v2 = [v1 objectForKeyedSubscript:@"requiresSPIEntitlement"];
...
+ (id)nonSPIEntitledMessageWithName:()HMDXPC messagePayload:
{
  ...
  id v10 = [a1 alloc];
  v11 = [MEMORY[0x263F42570] allMessageDestinations];
