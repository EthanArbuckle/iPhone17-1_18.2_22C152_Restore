...
- (void)configureWithMessageDispatcher:(id)a3 configurationTracker:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v18 = 2112;
    v19 = v9;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Configuring profile: %@", buf, 0x16u);
  }
  if (v6)
  {
    if (v7) {
...
{
  v2 = NSDictionary;
  v3 = [(HMDAccessoryProfile *)self description];
  id v4 = [v2 dictionaryWithObject:v3 forKey:*MEMORY[0x263F41FA8]];
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if (v6)
    {
      uint64_t v7 = [(HMDAccessoryProfile *)self uniqueIdentifier];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_170283 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_170283, &__block_literal_global_170284);
  }
  v2 = (void *)logCategory__hmf_once_v2_170285;
  return v2;
}
...
void __34__HMDAccessoryProfile_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_170285;
  logCategory__hmf_once_v2_170285 = v0;
}
