      ...
      if (v10)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v31 = 2112;
          uint64_t v32 = v9;
          _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Results retrieval timed out for session with UUID: %@", buf, 0x16u);
        }
      ...
      if (v14)
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v31 = 2112;
          uint64_t v32 = v9;
          _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@End timed out for session with UUID: %@", buf, 0x16u);
        }
        v15 = [v11 UUID];
LABEL_18:
      ...
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        if (v15)
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
          {
            ...
            v20 = [v12 responseMessagePayloads];
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v37 = 2112;
            v38 = v22;
            _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Consuming %lu response message payloads for session with UUID: %@", buf, 0x20u);
...
- (void)endSessionWithUUID:(id)a3
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v49 = 2112;
      id v50 = v4;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_DEBUG, "%{public}@No existing session to end with UUID: %@", buf, 0x16u);
    }
    goto LABEL_7;
  }
  ...
  if (!v7)
  {
    ...
    v18 = [MEMORY[0x263F42608] sharedPreferences];
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v49 = 2112;
      id v50 = v4;
      _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Ending session with UUID: %@", buf, 0x16u);
    }
    ...
    if (v17)
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v49 = 2112;
        id v50 = v4;
        _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_INFO, "%{public}@XPC client connection is still active so not reporting completion of session with UUID: %@", buf, 0x16u);
      }
    }
    else
    {
      if ([v29 isEqualToString:*MEMORY[0x263F0D508]])
      {
        ...
        if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v49 = 2112;
          id v50 = v30;
          _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_INFO, "%{public}@Reporting completion of Siri request with requestInfo: %@", buf, 0x16u);
        }
      ...
      if (isInternalBuild() && [v29 isEqualToString:*MEMORY[0x263F0D510]])
      {
        ...
        if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v49 = 2112;
          id v50 = v30;
          _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_INFO, "%{public}@Reporting completion of HomeUtil request with requestInfo: %@", buf, 0x16u);
        }
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v51 = 2112;
        v52 = v30;
        _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_INFO, "%{public}@Not reporting completion of request with unhandled domain: %@, requestInfo: %@", buf, 0x20u);
      }
    }
...
LABEL_26:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v49 = 2112;
    id v50 = v12;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Not ending already-ended session with UUID: %@", buf, 0x16u);
  }
LABEL_7:
...
- (void)addResponseMessagePayload:(id)a3 toSessionWithUUID:(id)a4
{
  ...
  os_unfair_lock_lock_with_options();
  uint64_t v9 = [(HMDXPCMessageReportingSessionManager *)self sessionsByUUID];
  uint64_t v10 = [v9 objectForKeyedSubscript:v7];
  id v11 = [v10 responseMessagePayloads];
  ...
  if (v11)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v18 = 2112;
      id v19 = v7;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Adding response message payload to session with UUID: %@", (uint8_t *)&v16, 0x16u);
    }
    [v11 addObject:v6];
  }
...
- (void)startSessionWithUUID:(id)a3 reportContext:(id)a4 xpcClientConnection:(id)a5
{
  ...
  int v14 = (void *)MEMORY[0x230FBD990](v11);
  int v15 = self;
  int v16 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    uint64_t v17 = HMFGetLogIdentifier();
    __int16 v18 = [v9 reportDomain];
    ...
    __int16 v35 = 2048;
    double v36 = v13;
    _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Starting reporting session with UUID: %@, reportDomain: %@, requestInfo: %@, timeout: %fs", (uint8_t *)&v27, 0x34u);
  }
...
- (HMDXPCMessageReportingSessionManager)init
{
  ...
  if (v2)
  {
    ...
    v2->_id endSessionTimerFactory = &__block_literal_global_191082;

    id consumeSessionResultsTimerFactory = v2->_consumeSessionResultsTimerFactory;
    v2->_id consumeSessionResultsTimerFactory = &__block_literal_global_54_191083;

    id performBackgroundRequestHandler = v2->_performBackgroundRequestHandler;
    v2->_id performBackgroundRequestHandler = &__block_literal_global_57_191084;
  }
  return v2;
}
...
{
  id v4 = (objc_class *)MEMORY[0x263F28618];
  id v5 = a3;
  id v6 = a2;
  id v8 = (id)[[v4 alloc] initWithContext:v6];

  id v7 = (void *)[objc_alloc(MEMORY[0x263F28610]) initWithRequestInfo:v8];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t16_191095 != -1) {
    dispatch_once(&logCategory__hmf_once_t16_191095, &__block_literal_global_65_191096);
  }
  v2 = (void *)logCategory__hmf_once_v17_191097;
  return v2;
}
...
void __51__HMDXPCMessageReportingSessionManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v17_191097;
  logCategory__hmf_once_v17_191097 = v0;
}
