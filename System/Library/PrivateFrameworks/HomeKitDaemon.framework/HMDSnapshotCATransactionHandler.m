...
- (CGImage)createSnapshotCGImageRef:(id)a3
{
  ...
  v6 = (void *)*MEMORY[0x263EFFB38];
  v7 = (void *)*MEMORY[0x263F0F5F8];
...
LABEL_8:
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, v17, (uint8_t *)&v19, 0x16u);
    }
LABEL_9:
...
- (void)_deleteSlotWithIdentifier:(id)a3 filePath:(id)a4 snapshotCATransaction:(id)a5
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v22 = 2112;
    id v23 = v9;
    _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Released the snapshot slot %u for file %@", (uint8_t *)&v18, 0x1Cu);
  }
...
- (void)deleteSlotWithIdentifier:(id)a3 filePath:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  id v8 = (void *)[objc_alloc(MEMORY[0x263F425C0]) initWithName:@"com.apple.homed.snapshot-catransaction-deleteslot."];
...
- (id)_createSlotWithFilePath:(id)a3 snapshotCATransaction:(id)a4
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v20 = 2112;
    id v21 = v6;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Created snapshot slot %u for file %@", (uint8_t *)&v16, 0x1Cu);
  }
  [MEMORY[0x263F158F8] commit];
...
- (void)clearSlotWithIdentifier:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v4;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Clearing slot %@", (uint8_t *)&v11, 0x16u);
  }
...
- (void)fillSlotWithIdentifier:(id)a3 filePath:(id)a4
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v23 = 2112;
      uint64_t v24 = v11;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Filling snapshot slot %u for file %@ with image %@", (uint8_t *)&v17, 0x26u);
    }
...
- (id)createSlotWithFilePath:(id)a3
{
  ...
  __int16 v18 = __Block_byref_object_copy__62702;
  __int16 v19 = __Block_byref_object_dispose__62703;
  id v20 = 0;
  uint64_t v5 = (void *)[objc_alloc(MEMORY[0x263F425C0]) initWithName:@"com.apple.homed.snapshot-catransaction-createslot."];
...
- (void)_backboardServicesRelaunched
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v8 = 138543362;
    id v9 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Backboard services is relaunched", (uint8_t *)&v8, 0xCu);
  }
...
- (void)_createSnapshotContext
{
  uint64_t v3 = (void *)MEMORY[0x230FBD990](self, a2);
  [MEMORY[0x263F158F8] begin];
  id v4 = [MEMORY[0x263F15770] remoteContext];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_62721 != -1) {
    dispatch_once(&logCategory__hmf_once_t2_62721, &__block_literal_global_3_62722);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v3_62723;
  return v2;
}
...
void __46__HMDSnapshotCATransactionHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_62723;
  logCategory__hmf_once_v3_62723 = v0;
}

+ (id)sharedHandler
{
  if (sharedHandler_onceToken != -1) {
    dispatch_once(&sharedHandler_onceToken, &__block_literal_global_62728);
  }
