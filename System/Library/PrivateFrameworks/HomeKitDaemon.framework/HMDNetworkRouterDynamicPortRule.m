...
+ (id)ruleForHAP
{
  ...
  id v3 = (void *)[objc_alloc(MEMORY[0x263F35AF0]) initWithValue:&unk_26E4714E8];
  v4 = [HMDNetworkRouterLANIdentifierList alloc];
  v5 = [MEMORY[0x263EFF980] arrayWithObject:v3];
  ...
  id v11 = (void *)[objc_alloc(MEMORY[0x263F35AF0]) initWithValue:&unk_26E471500];
...
- (BOOL)parseFromData:(id)a3 error:(id *)a4
{
  ...
  if (v9)
  {
    ...
    while (1)
    {
      ...
      {
        case 1:
          BOOL v15 = objc_msgSend(MEMORY[0x263EFF8F8], "dataWithBytesNoCopy:length:freeWhenDone:");
          id v35 = v10;
          v16 = &v35;
        ...
        case 5:
          ...
          id v31 = v10;
          v16 = &v31;
          [MEMORY[0x263F35AF0] parsedFromData:v15 error:&v31];
          v12 = v17 = v12;
          goto LABEL_15;
        case 6:
          BOOL v15 = objc_msgSend(MEMORY[0x263EFF8F8], "dataWithBytesNoCopy:length:freeWhenDone:");
...
LABEL_26:
    ...
    uint64_t v24 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F41FD8] code:3 userInfo:0];
