...
void __60__HMDRemoteDeviceMonitor_observer_didUpdateDevice_isOnline___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v34 = 2112;
    v35 = v9;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Received IDS Activity update for device %{public}@: %@", buf, 0x20u);
  }
  ...
  if (!v13)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@No Device Information found for device: %{public}@", buf, 0x16u);
    }
    goto LABEL_10;
  }
  if (*(unsigned char *)(a1 + 48) == (*(unsigned char *)(v13 + 8) & 1))
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v18 = [*(id *)(a1 + 40) shortDescription];
      *(_DWORD *)buf = 138543618;
      v31 = v17;
      __int16 v32 = 2114;
      uint64_t v33 = (uint64_t)v18;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Server reachability is the same as our reachability for device: %{public}@", buf, 0x16u);
    }
LABEL_10:
  ...
  *(void *)(v13 + 40) &= ~8uLL;
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@Confirming device %{public}@ because server reachability is different from our reachability", buf, 0x16u);
  }
  [*(id *)(v13 + 64) suspend];
  v26 = *(void **)(v13 + 64);
  *(void *)(v13 + 64) = 0;
  ...
  v28[1] = 3221225472;
  v28[2] = __60__HMDRemoteDeviceMonitor_observer_didUpdateDevice_isOnline___block_invoke_192;
  v28[3] = &unk_264A2F370;
  v28[4] = v27;
  id v29 = *(id *)(a1 + 40);
...
- (id)_deviceInformationForDevice:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    uint64_t v2 = [*(id *)(v2 + 104) objectForKey:v3];
  }
  return (id)v2;
}

void __60__HMDRemoteDeviceMonitor_observer_didUpdateDevice_isOnline___block_invoke_192(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    v16 = v10;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Ping result due to IDS Activity for device %{public}@: %@", (uint8_t *)&v11, 0x20u);
  }
}
  ...
  if (a1)
  {
    ...
    if (v9)
    {
      ...
      if ([(id)a1 isReachable])
      {
        if ([v12 isCurrentDevice])
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
          {
            ...
            int v40 = 138543362;
            v41 = v16;
            _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Confirming ourselves, returning success", (uint8_t *)&v40, 0xCu);
          }
          if (v8) {
            v8[2](v8, 0);
          }
        ...
        if (v7)
        {
          ...
          if (((_BYTE)v7[1] & 1) == 0 && ((unint64_t)v7[5] & 0xA) != 0)
          {
            ...
            if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
            {
              ...
              __int16 v42 = 2114;
              v43 = v32;
              _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_INFO, "%{public}@The device is already unreachable: %{public}@", (uint8_t *)&v40, 0x16u);
            }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
          {
            ...
            __int16 v42 = 2114;
            v43 = v39;
            _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_INFO, "%{public}@The device is already being confirmed: %{public}@", (uint8_t *)&v40, 0x16u);
          }
        }
        goto LABEL_19;
      }
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v42 = 2114;
        v43 = v25;
        _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@We are currently unreachable, so failing confirm for device: %{public}@", (uint8_t *)&v40, 0x16u);
      }
      if (!v8) {
        goto LABEL_19;
      }
LABEL_18:
      v26 = [MEMORY[0x263F087E8] hmErrorWithCode:54];
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      int v40 = 138543362;
      v41 = v20;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Cannot confirm device before monitor has started", (uint8_t *)&v40, 0xCu);
    }
    if (v8)
    {
      ...
      if (objc_msgSend(objc_getProperty(v3, v4, 16, 1), "isCurrentDevice"))
      {
        ...
        if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
        {
          ...
          *(void *)&uint8_t buf[4] = v8;
          _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@Unable to send ping to ourselves", buf, 0xCu);
        }
LABEL_6:
      ...
      if (!v9)
      {
        if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
        {
          ...
          *(_WORD *)&buf[12] = 2114;
          *(void *)&buf[14] = v26;
          _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Already pinging to device: %{public}@", buf, 0x16u);
        }
        goto LABEL_6;
      }
      if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_WORD *)&buf[12] = 2114;
        *(void *)&buf[14] = v13;
        _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Sending ping to device: %{public}@", buf, 0x16u);
      }
      [v3[8] suspend];
        ...
        if (v19 <= 0.0)
        {
          ...
          if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(void *)&buf[14] = 0x4050400000000000;
            _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_DEFAULT, "%{public}@Push is available, using default ping timeout: %f", buf, 0x16u);
          }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(double *)&buf[14] = v19 + 65.0;
            _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Push is unavailable, using extended ping timeout: %f", buf, 0x16u);
          }
        }
      }
      ...
      id WeakRetained = objc_loadWeakRetained(v6 + 12);
      ...
      *(void *)&buf[16] = __61__HMDRemoteDeviceMonitor__createRemotePingOperation_timeout___block_invoke;
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&buf[22] = 2114;
        v53 = v44;
        _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_INFO, "%{public}@Starting ping operation %{public}@ for device: %{public}@", buf, 0x20u);
      }
...
void __44__HMDRemoteDeviceMonitor__sendPingToDevice___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v36 = 2112;
      id v37 = v3;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Confirmation completed for device %{public}@ with error: %@", (uint8_t *)&v32, 0x20u);
    }
    if (!v3)
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v34 = 2114;
        v35 = v30;
        _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@Confirmation succeeded to reachable device: %{public}@", (uint8_t *)&v32, 0x16u);
      }
    ...
    if (!v13 || (*(unsigned char *)(v13 + 8) & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v36 = 2112;
        id v37 = v3;
        _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Confirmation failed to unreachable device %{public}@ with error: %@", (uint8_t *)&v32, 0x20u);
      }
    }
    v21 = [v3 domain];
    if ([v21 isEqual:*MEMORY[0x263F41FD8]])
    {
...
void __61__HMDRemoteDeviceMonitor__createRemotePingOperation_timeout___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v54 = 2114;
    id v55 = v9;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Operation completed with error %@ to device %{public}@", (uint8_t *)&v50, 0x20u);
  }
  uint64_t v10 = *(void *)(a1 + 48);
  if (v10 && (*(unsigned char *)(v10 + 40) & 2) != 0)
  {
    uint64_t v11 = *(void *)(a1 + 40);
    SEL v12 = (void *)MEMORY[0x230FBD990]();
    id v13 = *(id *)(a1 + 32);
    ...
    if (v11)
    {
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v54 = 2112;
        id v55 = v20;
        _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to send ping to device %{public}@ with error: %@", (uint8_t *)&v50, 0x20u);
      }
      -[HMDRemoteDeviceInformation completeConfirmationsWithError:](*(void *)(a1 + 48), *(void **)(a1 + 40));
      uint64_t v22 = *(void *)(a1 + 32);
      if (v22) {
        id WeakRetained = objc_loadWeakRetained((id *)(v22 + 80));
      }
      else {
        id WeakRetained = 0;
      }
    ...
    else
    {
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v52 = 2114;
        v53 = v30;
        _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Successfully sent ping to device: %{public}@", (uint8_t *)&v50, 0x16u);
      }
    ...
    if (v34)
    {
      if (v38)
      {
        ...
        __int16 v52 = 2114;
        v53 = v42;
        _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_INFO, "%{public}@Resuming actively monitoring device: %{public}@", (uint8_t *)&v50, 0x16u);
      }
      if (v33)
      {
LABEL_31:
...
LABEL_33:
    ...
    else
    {
      if (v38)
      {
        ...
        __int16 v52 = 2114;
        v53 = v47;
        _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_INFO, "%{public}@Starting to actively monitor device: %{public}@", (uint8_t *)&v50, 0x16u);
      }
      id v48 = objc_loadWeakRetained(v36 + 12);
      ...
      if (v10)
      {
        if ((*((unsigned char *)v10 + 10) & 1) != 0 && a4 == 5 && (*((unsigned char *)v10 + 9) & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
          {
            ...
            _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Skipping updating reachability with reason: %{public}@ because initial reachability is set and waiting for non-network reachability changes for device: %@", (uint8_t *)&v36, 0x20u);
          }
          if ((a5 & 1) == 0) {
            goto LABEL_24;
          }
...
LABEL_17:
          unint64_t v23 = (void *)MEMORY[0x230FBD990]();
          id v24 = a1;
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
          {
            ...
            __int16 v42 = 2112;
            id v43 = v29;
            _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@Updating reachability to %{public}@ with reason: %{public}@, for device: %@", (uint8_t *)&v36, 0x2Au);
          }
          if (v10) {
...
LABEL_5:
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
    {
      ...
      int v36 = 138543362;
      id v37 = v35;
      _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_INFO, "%{public}@Skipping updating reachability with initial reachability reason", (uint8_t *)&v36, 0xCu);
    }
  }
LABEL_25:
}
...
- (void)notifyDeviceReachabilityChange:(void *)a3 forDevice:
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v19 = 2114;
    uint64_t v20 = v11;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Notifying clients of reachability change, %@, for device: %{public}@", (uint8_t *)&v15, 0x20u);
  }
  SEL v12 = [MEMORY[0x263F08A00] defaultCenter];
  id v13 = v12;
  if (a2) {
...
- (void)_handleIncomingMessageForDevice:(id)a3
{
  ...
  os_unfair_lock_lock_with_options();
  id v5 = -[HMDRemoteDeviceMonitor _deviceInformationForDevice:]((uint64_t)self, v4);
  ...
  if (v5)
  {
    ...
    if (*((void *)v6 + 8))
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        SEL v12 = objc_msgSend(objc_getProperty(v6, v11, 16, 1), "shortDescription");
        int v17 = 138543618;
        SEL v18 = v10;
        __int16 v19 = 2114;
        id v20 = v12;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Stopping actively monitoring device: %{public}@", (uint8_t *)&v17, 0x16u);
      }
      [*((id *)v6 + 8) suspend];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v4;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring incoming message from device %@ because no clients have registered to monitor it", (uint8_t *)&v17, 0x16u);
    }
  }
}
...
- (void)service:(id)a3 account:(id)a4 incomingMessage:(id)a5 fromID:(id)a6 context:(id)a7
{
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
  {
    ...
    uint64_t v21 = [v12 serviceIdentifier];
    *(_DWORD *)buf = 138543874;
    id v31 = v20;
    __int16 v32 = 2112;
    id v33 = v16;
    __int16 v34 = 2114;
    v35 = v21;
    _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Received incoming message from: %@, on service: %{public}@", buf, 0x20u);
  }
  ...
  {
    v28 = +[HMDRemoteMessageSerialization remoteMessageWithDictionary:v13 isHH2Payload:1 error:0];
    if (v28) {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v32 = 2112;
      id v33 = v23;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring incoming message from device because it is nil or it is the current device: %@", buf, 0x16u);
    }
  }
}
...
- (void)service:(id)a3 activeAccountsChanged:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v20 = v11;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@IDS Service active accounts changed", buf, 0xCu);
  }
  ...
  if (v12 && ([v12 isEqual:WeakRetained] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v20 = v16;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@iCloud account changed, updating delegate", buf, 0xCu);
...
- (void)account:(id)a3 loginChanged:(id)a4
{
  ...
  if (v10)
  {
    if (v14)
    {
      ...
      int v17 = 138543362;
      SEL v18 = v15;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@IDS Account login changed", (uint8_t *)&v17, 0xCu);
    }
  ...
  else
  {
    if (v14)
    {
      ...
      int v17 = 138543362;
      SEL v18 = v16;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Ignoring IDS Account login change on non-iCloud account", (uint8_t *)&v17, 0xCu);
    }
  }
}
...
- (void)account:(id)a3 isActiveChanged:(BOOL)a4
{
  ...
  if (v7)
  {
    if (v11)
    {
      ...
      __int16 v17 = 2112;
      SEL v18 = v13;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@IDS Account active state changed to %@", (uint8_t *)&v15, 0x16u);
    }
    [(HMDRemoteDeviceMonitor *)v9 _handleGlobalReachabilityChange];
  }
  else
  {
    if (v11)
    {
      ...
      int v15 = 138543362;
      v16 = v14;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Ignoring IDS Account active state change on non-iCloud account", (uint8_t *)&v15, 0xCu);
    }
  }
}
...
LABEL_19:
    v76 = v4;
    uint64_t v19 = (void *)MEMORY[0x230FBD990]([(HMFTimer *)self->_deviceHealthTimer resume]);
    id v20 = self;
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v88 = v22;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Confirming all reachable devices", buf, 0xCu);
    }
    long long v84 = 0u;
    long long v85 = 0u;
    long long v82 = 0u;
    ...
    if (v23)
    {
      ...
      v26 = &OBJC_IVAR___HMDNetworkRouterFirewallRuleWAN__portEnd;
      do
      {
        uint64_t v27 = 0;
        do
        {
          ...
          v28 = *(char **)(*((void *)&v82 + 1) + 8 * v27);
          if (v28) {
            uint64_t v29 = *(void *)&v28[v26[601]];
          }
          else {
            LOBYTE(v29) = 0;
          }
              ...
              if (v39)
              {
                ...
                if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v89 = 2114;
                  v90 = v45;
                  _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_INFO, "%{public}@Trying reachability health check to device: %{public}@", buf, 0x16u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v32, OS_LOG_TYPE_DEFAULT))
            {
              ...
              uint64_t v36 = [Property shortDescription];
              *(_DWORD *)buf = 138543618;
              v88 = v34;
              __int16 v89 = 2114;
              v90 = v36;
              _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_DEFAULT, "%{public}@Deferring ping to device while we are unreachable: %{public}@", buf, 0x16u);
        ...
        if (v13 == v4)
        {
          ...
          if (os_log_type_enabled(v49, OS_LOG_TYPE_DEBUG))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v89 = 2114;
            v90 = v53;
            _os_log_impl(&dword_22F52A000, v49, OS_LOG_TYPE_DEBUG, "%{public}@Timer fired for device: %{public}@", buf, 0x16u);
          }
          if ([(HMDRemoteDeviceMonitor *)v48 isReachable])
          {
            if (!v12 || (*(unsigned char *)(v12 + 40) & 1) == 0)
            {
              ...
              if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                __int16 v89 = 2114;
                v90 = v61;
                _os_log_impl(&dword_22F52A000, v56, OS_LOG_TYPE_INFO, "%{public}@Timer fired but should confirm is not set for device: %{public}@", buf, 0x16u);
            ...
            if (os_log_type_enabled(v64, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v89 = 2114;
              v90 = v68;
              _os_log_impl(&dword_22F52A000, v64, OS_LOG_TYPE_INFO, "%{public}@Retrying ping to device: %{public}@", buf, 0x16u);
            }
          ...
          else
          {
            ...
            if (os_log_type_enabled(v71, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v89 = 2114;
              v90 = v75;
              _os_log_impl(&dword_22F52A000, v71, OS_LOG_TYPE_INFO, "%{public}@Deferring ping while unreachable to device: %{public}@", buf, 0x16u);
            }
  ...
  {
    SEL v18 = HMFGetLogIdentifier();
    *(_DWORD *)buf = 138543618;
    v88 = v18;
    __int16 v89 = 2112;
    v90 = v4;
    _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Unhandled timer: %@", buf, 0x16u);
  }
LABEL_71:
}
...
uint64_t __54__HMDRemoteDeviceMonitor_networkMonitorIsUnreachable___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    uint64_t v8 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@NetworkMonitor status changed to disconnected", (uint8_t *)&v7, 0xCu);
  }
...
uint64_t __52__HMDRemoteDeviceMonitor_networkMonitorIsReachable___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    uint64_t v8 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@NetworkMonitor status changed to connected", (uint8_t *)&v7, 0xCu);
  }
  return [*(id *)(a1 + 32) _handleGlobalReachabilityChange];
}
...
- (id)newConfirmationHandlerWithTimeout:(double)a3 workQueue:(id)a4 handler:(id)a5
{
  int v7 = (objc_class *)MEMORY[0x263F42658];
  id v8 = a5;
  id v9 = a4;
...
- (id)newDeviceMonitoringTimer
{
  id v2 = objc_alloc(MEMORY[0x263F42528]);
...
- (id)newRepeatingDeviceHealthTimer
{
  id v2 = objc_alloc(MEMORY[0x263F42658]);
...
- (id)newInitialDeviceHealthTimer
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v14 = 1024;
    int v15 = v6;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Initial health timer interval is %d seconds", (uint8_t *)&v12, 0x12u);
  }
  return (id)[objc_alloc(MEMORY[0x263F42658]) initWithTimeInterval:0 options:(double)v6];
}
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v23 = 2114;
      uint64_t v24 = v10;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Stopping monitoring account: %{public}@", buf, 0x16u);
    }
    long long v18 = 0u;
    long long v19 = 0u;
    long long v16 = 0u;
    ...
    if (v3)
    {
      ...
      if (v5)
      {
        ...
        if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v18 = 2114;
          long long v19 = v12;
          _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Stopping monitoring of device: %{public}@", (uint8_t *)&v16, 0x16u);
        }
        id v13 = v8[8];
...
void __76__HMDRemoteDeviceMonitor_confirmDevice_forClient_timeout_completionHandler___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v10 = 2112;
      uint64_t v11 = v7;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_ERROR, "%{public}@Failed to obtain device information even after monitoring was started for device: %@", (uint8_t *)&v8, 0x16u);
    }
  }
}
...
- (HMDRemoteDeviceInformation)_startMonitoringDevice:(void *)a3 withInitialReachability:(void *)a4 forClient:
{
  ...
  if (a1)
  {
    ...
    if (v7)
    {
      ...
      __int16 v10 = [v9 deviceForDevice:v7 exists:&v69];
      ...
      if (([v10 isCurrentDevice] & 1) == 0)
      {
        ...
        if (!v12)
        {
          ...
          double v20 = (HMDRemoteDeviceInformation *)objc_claimAutoreleasedReturnValue();
          uint64_t v22 = v20;
          if (v20)
          {
          ...
          {
            id v18 = [HMDRemoteDeviceInformation alloc];
          ...
          if (v65)
          {
            os_unfair_lock_lock_with_options();
            if (v18) {
              __int16 v34 = v18->_clients;
            }
            else {
              __int16 v34 = 0;
            }
            v35 = v34;
            [(NSHashTable *)v35 addObject:v65];

            os_unfair_lock_unlock((os_unfair_lock_t)(a1 + 8));
          }
          if (v22)
          {
            if (v66 && ([v66 BOOLValue] & 1) == 0) {
              -[HMDRemoteDeviceMonitor handleReachabilityChange:deviceInformation:reason:didStartMonitoringDevice:]((void *)a1, [v66 BOOLValue], v18, 6uLL, 1);
            }
          }
          else
          {
            ...
            v64 = [Property account];
            if (v64)
            {
              __int16 v38 = [MEMORY[0x263F08A00] defaultCenter];
              [v38 addObserver:a1 selector:sel_handleDeviceRemovedFromAccount_ name:@"HMDAccountRemovedDeviceNotification" object:v64];
            }
            unsigned int obj = [(id)a1 isReachable];
            if (v62 && ([v62 BOOLValue] & 1) == 0)
            {
              unsigned int obj = [v62 BOOLValue];
              uint64_t v39 = 6;
            }
            else
            {
            ...
            if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
            {
              ...
              *(void *)&buf[14] = v45;
              __int16 v71 = 2112;
              v72 = v46;
              _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_INFO, "%{public}@Marking newly added device: %{public}@ with reachability: %@", buf, 0x20u);
            }
            -[HMDRemoteDeviceMonitor handleReachabilityChange:deviceInformation:reason:didStartMonitoringDevice:](v40, obj, v18, v58, 1);

            os_unfair_lock_lock_with_options();
            int v47 = BYTE1(v40[8]._os_unfair_lock_opaque);
            ...
            if (os_log_type_enabled(v50, OS_LOG_TYPE_INFO))
            {
              ...
              if (v18) {
                id v53 = objc_getProperty(v18, v51, 16, 1);
              }
              else {
                id v53 = 0;
              }
              __int16 v54 = [v53 shortDescription];
              *(_DWORD *)buf = 138543618;
              *(void *)&uint8_t buf[4] = v52;
              *(_WORD *)&buf[12] = 2114;
              *(void *)&buf[14] = v54;
              _os_log_impl(&dword_22F52A000, v50, OS_LOG_TYPE_INFO, "%{public}@Starting IDS Activity for device: %{public}@", buf, 0x16u);
            }
            id v56 = v49[8];
            if (v18) {
              id v57 = objc_getProperty(v18, v55, 16, 1);
            }
            else {
              id v57 = 0;
            }
            [v56 startObservingPresenceForDevice:v57];
          }
          goto LABEL_9;
        }
        id v13 = (void *)MEMORY[0x230FBD990]();
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
        {
          ...
          *(void *)&buf[14] = v10;
          __int16 v71 = 2112;
          v72 = v17;
          _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Cannot monitor a device without any handles: %@, device found in account register: %@", buf, 0x20u);
        }
      }
      id v18 = 0;
LABEL_9:
...
void __83__HMDRemoteDeviceMonitor__startMonitoringDevice_withInitialReachability_forClient___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v11 = 2114;
      int v12 = v8;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Determined newly monitored device is unreachable: %{public}@", (uint8_t *)&v9, 0x16u);
    }
  }
}
    ...
    while (1)
    {
      ...
      do
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          uint64_t v21 = objc_msgSend(Property, "shortDescription", v40);
          *(_DWORD *)buf = v40;
          __int16 v54 = v19;
          __int16 v55 = 2114;
          id v56 = v21;
          _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Marking formerly unreachable device as reachable now that we are reachable: %{public}@", buf, 0x16u);
...
LABEL_15:
        if (v13 & 1) == 0 && (v14)
        {
          ...
          if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
          {
            ...
            v28 = objc_msgSend(v27, "shortDescription", v40);
            *(_DWORD *)buf = v40;
            __int16 v54 = v26;
            __int16 v55 = 2114;
            id v56 = v28;
            _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@Confirming device due to network change: %{public}@", buf, 0x16u);
      ...
      *(unsigned char *)(a1 + 32) = a2;
      ...
      if (v6)
      {
        ...
        if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v15 = 2080;
          int v16 = v12;
          _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Marking current device as %s", (uint8_t *)&v13, 0x16u);
        }
...
void __57__HMDRemoteDeviceMonitor_stopMonitoringDevice_forClient___block_invoke(uint64_t a1)
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v22 = 2114;
      __int16 v23 = v17;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@There are still %lu clients monitoring device: %{public}@", (uint8_t *)&v18, 0x20u);
    }
  }
  os_unfair_lock_unlock(v2);
LABEL_10:
...
id __82__HMDRemoteDeviceMonitor_startMonitoringDevice_withInitialReachability_forClient___block_invoke(id *a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v13 = 2114;
    id v14 = v7;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Received request to start monitoring device: %{public}@ with initial reachability: %{public}@", (uint8_t *)&v9, 0x20u);
  }
...
void __31__HMDRemoteDeviceMonitor_start__block_invoke(uint64_t a1)
{
  ...
  id v10 = [v9 iCloudAccount];
  [v10 addDelegate:*(void *)(a1 + 32) queue:*(void *)(*(void *)(a1 + 32) + 16)];
  [v10 addRegistrationDelegate:*(void *)(a1 + 32) queue:*(void *)(*(void *)(a1 + 32) + 16)];
  uint64_t v11 = *(void *)(a1 + 32);
  id v33 = v10;
  if (v11 && (objc_storeWeak((id *)(v11 + 56), v10), (uint64_t v12 = *(void *)(a1 + 32)) != 0)) {
  ...
  [v15 _handleGlobalReachabilityChange];
  long long v37 = 0u;
  long long v38 = 0u;
  long long v35 = 0u;
  long long v36 = 0u;
    ...
    do
    {
      ...
      do
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
        {
          ...
          if (v20) {
            id Property = objc_getProperty(v20, v24, 16, 1);
          }
          else {
            id Property = 0;
          }
          id v27 = [Property shortDescription];
          *(_DWORD *)buf = 138543618;
          long long v40 = v25;
          __int16 v41 = 2114;
          __int16 v42 = v27;
          _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Initializing IDS Activity for device: %{public}@", buf, 0x16u);
        }
        v28 = *(void **)(a1 + 32);
        if (v28) {
          v28 = (void *)v28[8];
        ...
        v30 = v28;
        if (v20) {
          id v31 = objc_getProperty(v20, v29, 16, 1);
        }
        else {
          id v31 = 0;
        }
        [v30 startObservingPresenceForDevice:v31];

        isWatch();
        -[HMDRemoteDeviceInformation addState:]((uint64_t)v20, 1);
        -[HMDRemoteDeviceMonitor _confirmDevice:timeout:completionHandler:](*(void *)(a1 + 32), v20, 0, 65.0);
        ++v19;
      }
      while (v17 != v19);
      uint64_t v32 = [obj countByEnumeratingWithState:&v35 objects:v43 count:16];
      uint64_t v17 = v32;
    }
    while (v32);
  }
...
- (HMDRemoteDeviceMonitor)initWithAccountRegistry:(id)a3 activityObserver:(id)a4 queue:(id)a5 service:(id)a6 modernService:(id)a7 accountManager:(id)a8 remoteAccountManager:(id)a9 netMonitor:(id)a10 factory:(id)a11
{
  ...
  uint64_t v21 = [(HMDRemoteDeviceMonitor *)&v40 init];
  id v22 = v21;
  if (v21)
  {
    id v35 = v19;
    ...
    uint64_t v24 = (NSOperationQueue *)objc_alloc_init(MEMORY[0x263F08A48]);
    ...
    uint64_t v28 = [v20 newInitialDeviceHealthTimer];
    ...
    uint64_t v30 = [v20 newRepeatingDeviceHealthTimer];
    ...
    [v32 addObserver:v22 selector:sel_handleCurrentDeviceUpdate_ name:@"HMDAppleAccountManagerDeviceUpdatedNotification" object:v17];

    id v33 = [MEMORY[0x263F08A00] defaultCenter];
    [v33 addObserver:v22 selector:sel_handleAccountRemoved_ name:@"HMDAccountRegistryRemovedAccountNotification" object:v17];
...
- (HMDRemoteDeviceMonitor)initWithAccountRegistry:(id)a3 activityObserver:(id)a4 accountManager:(id)a5
{
  ...
  if (v12)
  {
    ...
    id v17 = +[HMDRemoteAccountManager sharedManager];
    id v18 = (void *)[objc_alloc(MEMORY[0x263F425B0]) initWithNetAddress:0];
    id v19 = [(HMDRemoteDeviceMonitor *)self initWithAccountRegistry:v8 activityObserver:v9 queue:v16 service:v12 modernService:0 accountManager:v10 remoteAccountManager:v17 netMonitor:v18 factory:self];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v32 = v25;
      _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: IDSService is nil", buf, 0xCu);
    }
    uint64_t v26 = [[HMDAssertionLogEvent alloc] initWithReason:@"IDSService is nil"];
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v32 = v30;
      _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@An IDS service is not available", buf, 0xCu);
    }
    id v20 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t55 != -1) {
    dispatch_once(&logCategory__hmf_once_t55, &__block_literal_global_227027);
  }
...
void __37__HMDRemoteDeviceMonitor_logCategory__block_invoke()
{
  ...
  uint64_t v1 = (void *)logCategory__hmf_once_v56;
  logCategory__hmf_once_id v56 = v0;
}
...
+ (id)pingMessageForDevice:(id)a3 timeout:(double)a4 restriction:(unint64_t)a5
{
  ...
  id v9 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:@"1CAEDC10-E3E5-41A4-BB17-A9EEBA14A938"];
  ...
  dispatch_queue_t v16 = [(HMDRemoteMessage *)v14 initWithName:v15 destination:v10 payload:0 type:0 timeout:0 secure:a5 restriction:a4];
