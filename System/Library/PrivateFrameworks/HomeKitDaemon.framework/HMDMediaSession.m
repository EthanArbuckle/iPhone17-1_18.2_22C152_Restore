...
void __32__HMDMediaSession_timerDidFire___block_invoke(uint64_t a1)
{
  ...
  if (v2 == v3)
  {
    id v4 = (void *)MEMORY[0x230FBD990]([*(id *)(a1 + 40) setSetPlaybackStateTimer:0]);
    id v5 = *(id *)(a1 + 40);
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v16 = v7;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Timed out waiting for media playback state notification - reading the state explicitly...", buf, 0xCu);
    }
    v9 = *(void **)(a1 + 40);
    id v8 = (id *)(a1 + 40);
    v10 = [v9 state];
...
{
  id v4 = a3;
  id v13 = [(HMDMediaSession *)self state];
  id v5 = objc_msgSend(NSNumber, "numberWithInteger:", objc_msgSend(v13, "playbackState"));
  [v4 encodeObject:v5 forKey:*MEMORY[0x263F0D1A0]];

  id v6 = objc_msgSend(NSNumber, "numberWithInteger:", objc_msgSend(v13, "shuffleState"));
  [v4 encodeObject:v6 forKey:*MEMORY[0x263F0D1F8]];

  v7 = objc_msgSend(NSNumber, "numberWithInteger:", objc_msgSend(v13, "repeatState"));
  [v4 encodeObject:v7 forKey:*MEMORY[0x263F0D1C8]];

  id v8 = [v13 volume];
  [v4 encodeObject:v8 forKey:*MEMORY[0x263F0D170]];

  v9 = [v13 muted];
  [v4 encodeObject:v9 forKey:*MEMORY[0x263F0D158]];

  v10 = [v13 mediaUniqueIdentifier];
  [v4 encodeObject:v10 forKey:*MEMORY[0x263F0D188]];

  v11 = [(HMDMediaSession *)self sessionIdentifier];
  [v4 encodeObject:v11 forKey:*MEMORY[0x263F0D1E0]];

  id v12 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", objc_msgSend(v13, "sleepWakeState"));
  [v4 encodeObject:v12 forKey:*MEMORY[0x263F0D208]];
}
...
void __46__HMDMediaSession_writeProperties_completion___block_invoke(uint64_t a1)
{
  ...
  uint64_t v27 = a1;
  v23 = objc_msgSend(MEMORY[0x263EFF980], "arrayWithCapacity:", objc_msgSend(*(id *)(a1 + 32), "count"));
  long long v37 = 0u;
  long long v38 = 0u;
  long long v36 = 0u;
  long long v35 = 0u;
  ...
  if (v2)
  {
    ...
    uint64_t v4 = *MEMORY[0x263F0D1A8];
        ...
        if (v8)
        {
          ...
          if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v22;
            ...
            __int16 v41 = 2112;
            v42 = v13;
            _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Setting playback state received from remote %@", buf, 0x16u);
          }
...
void __46__HMDMediaSession_writeProperties_completion___block_invoke_2(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v14 = 2048;
      uint64_t v15 = v4;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@responding to set playback with state %ld", (uint8_t *)&v12, 0x16u);
    }
...
void __45__HMDMediaSession_readProperties_completion___block_invoke(id *a1)
{
  ...
  group = dispatch_group_create();
  v53 = objc_msgSend(MEMORY[0x263EFF980], "arrayWithCapacity:", objc_msgSend(a1[4], "count"));
  ...
  long long v67 = 0u;
  id obj = a1[4];
  uint64_t v2 = [obj countByEnumeratingWithState:&v66 objects:v71 count:16];
  if (v2)
  {
    uint64_t v55 = *(void *)v67;
    uint64_t v3 = *MEMORY[0x263F0D1A8];
    uint64_t v51 = *MEMORY[0x263F0D200];
    uint64_t v50 = *MEMORY[0x263F0D1D0];
    uint64_t v49 = *MEMORY[0x263F0D220];
    uint64_t v48 = *MEMORY[0x263F0D190];
    uint64_t v47 = *MEMORY[0x263F0D210];
    do
    {
      uint64_t v4 = 0;
      do
      {
        ...
        else
        {
          ...
          if (v12)
          {
            ...
            uint64_t v16 = +[HMDMediaPropertyResponse responseWithRequest:v5 value:v15 updatedTime:v54];
          ...
          else
          {
            ...
            if (v18)
            {
              ...
              long long v22 = +[HMDMediaPropertyResponse responseWithRequest:v5 value:v21 updatedTime:v54];
            ...
            else
            {
              ...
              if (v24)
              {
                ...
                if (v26)
                {
                  ...
                  v28 = [v27 volume];
                  id v29 = +[HMDMediaPropertyResponse responseWithRequest:v5 value:v28 updatedTime:v54];
              ...
              else
              {
                ...
                if (v31)
                {
                  ...
                  if (v33)
                  {
                    ...
                    long long v36 = +[HMDMediaPropertyResponse responseWithRequest:v5 value:v35 updatedTime:v54];
                ...
                {
                  long long v37 = [v5 property];
                  int v38 = [v37 isEqual:v47];

                  if (v38)
                  {
                    v39 = NSNumber;
                    v40 = [a1[5] state];
                    __int16 v41 = objc_msgSend(v39, "numberWithUnsignedInteger:", objc_msgSend(v40, "sleepWakeState"));
                    v42 = +[HMDMediaPropertyResponse responseWithRequest:v5 value:v41 updatedTime:v54];
      ...
      while (v2 != v4);
      uint64_t v43 = [obj countByEnumeratingWithState:&v66 objects:v71 count:16];
      uint64_t v2 = v43;
    }
    while (v43);
  }

  uint64_t v44 = [a1[5] workQueue];
  block[0] = MEMORY[0x263EF8330];
  block[1] = 3221225472;
...
- (void)updateEndpoint:(id)a3
{
  ...
  if ((v11 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v5;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@MediaSession endpoint %@ changed to %@", (uint8_t *)&v15, 0x20u);
    }
  }
...
- (void)_handleMediaUpdateMuted:(id)a3
{
  uint64_t v3 = *MEMORY[0x263F0D160];
  id v4 = a3;
  ...
  uint64_t v6 = [MEMORY[0x263F087E8] hmErrorWithCode:v5];
...
{
  id v10 = a3;
  uint64_t v3 = [v10 numberForKey:*MEMORY[0x263F0D178]];
  id v4 = v3;
  if (v3)
  {
    [v3 floatValue];
...
- (void)_handleMediaSessionSetAudioControl:(id)a3
{
  ...
  uint64_t v5 = *MEMORY[0x263F0D178];
  uint64_t v6 = [v4 objectForKey:*MEMORY[0x263F0D178]];
...
- (void)_notifyClientsOfUpdatedVolume:(id)a3 muted:(id)a4 inResponseToMessage:(id)a5
{
  ...
  uint64_t v28 = *MEMORY[0x263F0D218];
  ...
  if (v10)
  {
    ...
    [v15 setObject:v16 forKey:*MEMORY[0x263F0D1D8]];
  }
  if (v8) {
    [v15 setObject:v8 forKey:*MEMORY[0x263F0D178]];
  }
  if (v9) {
    [v15 setObject:v9 forKey:*MEMORY[0x263F0D160]];
  }
  __int16 v17 = [MEMORY[0x263F08A00] defaultCenter];
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v26 = 2112;
    uint64_t v27 = v15;
    _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Sending internal notification %@ with payload %@", (uint8_t *)&v22, 0x20u);
  }
}
...
{
  id v4 = a3;
  uint64_t v5 = [v4 numberForKey:*MEMORY[0x263F0D1A8]];
  id v6 = v5;
  if (v5)
  {
    ...
    if ([(HMDMediaSession *)self isCurrentAccessorySession])
    {
      ...
      if (v10)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v40 = v26;
          _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot look up local origin for currentAccessory to set playback state", buf, 0xCu);
        }
        if (v7)
        {
          uint64_t v27 = [MEMORY[0x263F087E8] hmErrorWithCode:2005];
          uint64_t v28 = [MEMORY[0x263F087E8] hmErrorWithCode:4 description:@"Cannot lookup origin" reason:@"Cannot lookup origin" suggestion:0 underlyingError:v27];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v40 = v14;
          _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Attempting to set the playback state command with mediaRemote to local origin", buf, 0xCu);
        }
        ...
        if (v16)
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v40 = v20;
            _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Sending the command to mediaremote failed for mediaSession", buf, 0xCu);
          }
          uint64_t v21 = [MEMORY[0x263F087E8] hmErrorWithCode:2005];
          int v22 = [MEMORY[0x263F087E8] hmErrorWithCode:74 description:@"Media remote command send failure " reason:@"Media remote command send failure" suggestion:0 underlyingError:v21];
      ...
      if (v14 && v14 != 3)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = v28;
          ...
          __int16 v34 = 2048;
          uint64_t v35 = v15;
          _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Locally setting playback state failed with status: %ld", buf, 0x16u);
        }
        id v20 = [MEMORY[0x263F087E8] hmErrorWithCode:2005];
        uint64_t v21 = [MEMORY[0x263F087E8] hmErrorWithCode:74 description:@"Media remote command failure " reason:@"Media remote command failure" suggestion:0 underlyingError:v20];
...
LABEL_16:
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v34 = 2048;
    uint64_t v35 = v26;
    _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_DEBUG, "%{public}@Set plaback state to %ld on successfully sending mediaremote command", buf, 0x16u);
  }
...
- (void)_queueSetPlaybackStateCompletion:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (!v7)
    {
      id v8 = [MEMORY[0x263F42608] sharedPreferences];
      id v9 = [v8 preferenceForKey:@"playbackStateTimeout"];
      id v10 = [v9 numberValue];

      double v11 = (double)[v10 unsignedIntValue];
      CFIndex v12 = (void *)[objc_alloc(MEMORY[0x263F42658]) initWithTimeInterval:0 options:v11];
...
void __65__HMDMediaSession_updateWithResponses_requestMessageInformation___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v83 = 2112;
    uint64_t v84 = v6;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Updating media session with responses %@", buf, 0x16u);
  }
  long long v78 = 0u;
  long long v79 = 0u;
  long long v76 = 0u;
  long long v77 = 0u;
  id v7 = *(id *)(a1 + 40);
  uint64_t v75 = [v7 countByEnumeratingWithState:&v76 objects:v80 count:16];
  if (v75)
  {
    int v8 = 0;
    uint64_t v74 = *(void *)v77;
    uint64_t v73 = *MEMORY[0x263F0D1A8];
    uint64_t v72 = *MEMORY[0x263F0D200];
    uint64_t v71 = *MEMORY[0x263F0D1D0];
    uint64_t v70 = *MEMORY[0x263F0D220];
    uint64_t v69 = *MEMORY[0x263F0D190];
    id obj = v7;
    uint64_t v68 = *MEMORY[0x263F0D210];
    do
    {
      for (uint64_t i = 0; i != v75; ++i)
      {
        ...
        if ([v12 isEqual:v70])
        {
          ...
          if (v45)
          {
            id v46 = [*(id *)(a1 + 32) state];
            uint64_t v47 = [v46 volume];

            uint64_t v48 = [*(id *)(a1 + 32) state];
            [v48 setVolume:v45];

            uint64_t v49 = [v10 error];
            if (v49) {
        ...
        if ([v12 isEqual:v68])
        {
          ...
          {
            v60 = [*(id *)(a1 + 32) state];
            uint64_t v61 = [v60 sleepWakeState];

            uint64_t v62 = [v59 unsignedIntegerValue];
            id v63 = [*(id *)(a1 + 32) state];
            [v63 setSleepWakeState:v62];
...
- (void)_postNotificationOfMediaStateUpdateWithPayload:(id)a3
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v22 = 2112;
    id v23 = v11;
    _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Sending internal notification %@ with payload %@", (uint8_t *)&v18, 0x20u);
  }
...
- (void)_postNotificationOfMediaStateUpdateWithRequestMessageInformation:(id)a3
{
  ...
  if (a3)
  {
    uint64_t v7 = *MEMORY[0x263F0D1D8];
    v8[0] = a3;
    id v4 = NSDictionary;
    id v5 = a3;
...
void __56__HMDMediaSession_handleMediaPlaybackStateNotification___block_invoke(uint64_t a1)
{
  ...
  id v4 = objc_msgSend(*(id *)(a1 + 40), "hmf_numberForKey:", *MEMORY[0x263F54DF8]);
  id v5 = v4;
  if (v4)
  {
    ...
    if (v6 > 5) {
      ...
      uint64_t v7 = qword_2303E49F0[v6];
    }
...
void __43__HMDMediaSession__handleGetPlaybackState___block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    BOOL v3 = [MEMORY[0x263F087E8] hmErrorWithCode:52];
    if (!v3)
    {
LABEL_3:
      if (*(void *)(a1 + 32)) {
  ...
  if ([(HMDMediaSession *)self isCurrentAccessorySession])
  {
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v30 = v15;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot look up local origin for currentAccessory to get playback state", buf, 0xCu);
      }
      if (v5)
      {
        long long v16 = [MEMORY[0x263F087E8] hmErrorWithCode:2005];
        uint64_t v17 = [MEMORY[0x263F087E8] hmErrorWithCode:4 description:@"Cannot lookup origin" reason:@"Cannot lookup origin" suggestion:0 underlyingError:v16];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v30 = v11;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Attempting to locally read the playback state from media remote", buf, 0xCu);
      }
...
void __51__HMDMediaSession__getPlaybackStateWithCompletion___block_invoke(uint64_t a1, void *a2, unsigned int a3)
{
  ...
  else
  {
    if (a3 > 5) {
      ...
      uint64_t v8 = qword_2303E49F0[a3];
    }
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v17 = 2048;
      uint64_t v18 = v8;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Locally read the playback state as: %tu", (uint8_t *)&v15, 0x16u);
    }
  }
...
- (id)dumpState
{
  ...
  id v11 = [NSDictionary dictionaryWithObject:v10 forKey:*MEMORY[0x263F41FA8]];
...
- (id)_initWithEndpoint:(id)a3 mediaProfiles:(id)a4 state:(id)a5
{
  ...
  if (v13)
  {
    uint64_t v14 = [MEMORY[0x263EFF9C0] setWithArray:v10];
    ...
    uint64_t v18 = (void *)MEMORY[0x263F08C38];
    uint64_t v19 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:@"1CAEDC10-E3E5-41A4-BB17-A9EEBA14A938"];
...
{
  id v3 = a3;
  if (([v3 isEqualToString:*MEMORY[0x263F0D1A8]] & 1) != 0
    || ([v3 isEqualToString:*MEMORY[0x263F0D200]] & 1) != 0
    || ([v3 isEqualToString:*MEMORY[0x263F0D1D0]] & 1) != 0
    || ([v3 isEqualToString:*MEMORY[0x263F0D220]] & 1) != 0
    || ([v3 isEqualToString:*MEMORY[0x263F0D210]] & 1) != 0
    || [v3 isEqualToString:*MEMORY[0x263F0D190]])
  {
...
+ (NSArray)mediaPropertyMessageKeys
{
  ...
  uint64_t v2 = *MEMORY[0x263F0D200];
  v7[0] = *MEMORY[0x263F0D1A8];
  v7[1] = v2;
  uint64_t v3 = *MEMORY[0x263F0D220];
  v7[2] = *MEMORY[0x263F0D1D0];
  v7[3] = v3;
  uint64_t v4 = *MEMORY[0x263F0D210];
  void v7[4] = *MEMORY[0x263F0D190];
  void v7[5] = v4;
  id v5 = [MEMORY[0x263EFF8C0] arrayWithObjects:v7 count:6];
  return (NSArray *)v5;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t1_128919 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_128919, &__block_literal_global_128920);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v2_128921;
  return v2;
}
...
void __30__HMDMediaSession_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_128921;
  logCategory__hmf_once_v2_128921 = v0;
}
