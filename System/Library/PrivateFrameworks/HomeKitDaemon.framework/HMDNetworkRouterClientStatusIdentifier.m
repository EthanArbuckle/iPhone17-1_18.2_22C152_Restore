...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v13 = [(HMDNetworkRouterClientStatusIdentifier *)self macAddress];
        v26 = [(HMDNetworkRouterClientStatusIdentifier *)v7 macAddress];
      ...
      v14 = [(HMDNetworkRouterClientStatusIdentifier *)self ipAddress];
      uint64_t v15 = [(HMDNetworkRouterClientStatusIdentifier *)v7 ipAddress];
      if (v14 == (void *)v15)
      {
...
LABEL_18:
  ...
  char v10 = [(HMDNetworkRouterClientStatusIdentifier *)self macAddress];
...
LABEL_26:
  ...
  while (1)
  {
    ...
    {
      case 3:
        uint64_t v15 = objc_msgSend(MEMORY[0x263EFF8F8], "dataWithBytesNoCopy:length:freeWhenDone:");
        id v24 = v10;
        id v16 = &v24;
        +[HMDNetworkRouterIPAddress parsedFromData:v15 error:&v24];
        v11 = int v17 = v11;
        goto LABEL_14;
      case 2:
        uint64_t v15 = objc_msgSend(MEMORY[0x263EFF8F8], "dataWithBytesNoCopy:length:freeWhenDone:");
        id v25 = v10;
        id v16 = &v25;
        [MEMORY[0x263EFF8F8] parsedFromData:v15 error:&v25];
        id v12 = v17 = v12;
        goto LABEL_14;
      case 1:
        uint64_t v15 = objc_msgSend(MEMORY[0x263EFF8F8], "dataWithBytesNoCopy:length:freeWhenDone:");
        id v26 = v10;
        id v16 = &v26;
        [MEMORY[0x263F35AF0] parsedFromData:v15 error:&v26];
        v13 = int v17 = v13;
LABEL_14:
        id v18 = *v16;
...
- (HMDNetworkRouterClientStatusIdentifier)initWithClientIdentifier:(id)a3 macAddress:(id)a4 ipAddress:(id)a5
{
  ...
  id v12 = [(HMDNetworkRouterClientStatusIdentifier *)&v15 init];
  v13 = v12;
  if (v12)
  {
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HMDNetworkRouterClientStatusIdentifier);
  id v7 = v6;
  if (v6)
  {
    id v10 = 0;
    [(HMDNetworkRouterClientStatusIdentifier *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
