    ...
    if (v24)
    {
        ...
        while (2)
        {
          for (uint64_t i = 0; i != v28; ++i)
          {
            ...
            if ([*(id *)(*((void *)&v58 + 1) + 8 * i) isEqual:v24])
            {
              ...
              v39 = objc_msgSend(v17, "hmf_dateForKey:", *MEMORY[0x263F0EBA8]);
              if (v39)
              {
              ...
              else
              {
                ...
                if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543362;
                  v63 = v52;
                  _os_log_impl(&dword_22F52A000, v51, OS_LOG_TYPE_ERROR, "%{public}@Did not receive the snapshot timestamp in the IDS delegate callback", buf, 0xCu);

                  v50 = v53;
                }

                v42 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1035];
              }
              id v14 = v54;
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v66 = 2112;
        id v67 = v18;
        _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_ERROR, "%{public}@Ignoring incoming snapshot resource from unexpected device handle: %@ fromID: %@", buf, 0x20u);
      }
      id v14 = v54;
LABEL_26:
      id v15 = v55;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v64 = 2112;
        id v65 = v18;
        _os_log_impl(&dword_22F52A000, v46, OS_LOG_TYPE_ERROR, "%{public}@Could not determine device handle for fromID: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v64 = 2112;
      id v65 = v20;
      _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring incoming snapshot resource with unexpected request identifier: %@", buf, 0x16u);
    }
  }
}
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v9 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting the HMDCameraSnapshotIDSStreamReceiver", buf, 0xCu);
  }
  v7.receiver = v4;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_207258 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_207258, &__block_literal_global_207259);
  }
  v2 = (void *)logCategory__hmf_once_v2_207260;
  return v2;
}
...
void __49__HMDCameraSnapshotIDSStreamReceiver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_207260;
  logCategory__hmf_once_v2_207260 = v0;
}
