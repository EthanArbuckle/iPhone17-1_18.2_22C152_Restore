...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v10 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting the HMDCameraSnapshotIDSStream", buf, 0xCu);
  }
...
LABEL_9:
  ...
  if (v13)
  {
    ...
    uint64_t v15 = [objc_alloc(MEMORY[0x263F425C0]) initWithName:@"com.apple.homed.snapshot-stream"];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_129651 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_129651, &__block_literal_global_129652);
  }
  v2 = (void *)logCategory__hmf_once_v2_129653;
  return v2;
}
...
void __41__HMDCameraSnapshotIDSStream_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_129653;
  logCategory__hmf_once_v2_129653 = v0;
}
