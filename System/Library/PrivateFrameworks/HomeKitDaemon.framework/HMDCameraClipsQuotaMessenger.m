...
- (NSUUID)messageTargetUUID
{
  return (NSUUID *)[MEMORY[0x263F0E1D8] UUID];
}
...
- (void)handleUpdateCloudStorageMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v35 = 2114;
    v36 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling update cloud storage message: %{public}@", buf, 0x16u);
  }
  v10 = [v4 stringForKey:*MEMORY[0x263F0BC88]];
  if (v10)
  {
    int v11 = [v4 BOOLForKey:*MEMORY[0x263F0BC80]];
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v37 = 2112;
      v38 = v10;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Updating cloud storage to %@ for zone with name: %@", buf, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v35 = 2112;
      v36 = v26;
      _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Cannot find zone name in update cloud storage message payload: %@", buf, 0x16u);
    }
    v21 = [MEMORY[0x263F087E8] hmErrorWithCode:20];
...
- (void)handleFetchNamesForZonesWithEnabledCloudStorageMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v22 = 2114;
    v23 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling fetch names for zones with enabled cloud storage message: %{public}@", buf, 0x16u);
  }
...
void __87__HMDCameraClipsQuotaMessenger_handleFetchNamesForZonesWithEnabledCloudStorageMessage___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v14 = 2112;
    id v15 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully fetched names for zones with enabled cloud storage: %@", buf, 0x16u);
  }
  v8 = *(void **)(a1 + 40);
  uint64_t v10 = *MEMORY[0x263F0BC90];
  id v11 = v3;
...
- (void)configure
{
  ...
  uint64_t v5 = *MEMORY[0x263F0BC78];
  v11[0] = v3;
  ...
  uint64_t v8 = *MEMORY[0x263F0BC98];
  __int16 v10 = v3;
...
LABEL_7:
  ...
  if (v10)
  {
    ...
    v11->_id quotaManagerFactory = &__block_literal_global_127745;
  }
  return v11;
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_127757 != -1) {
    dispatch_once(&logCategory__hmf_once_t6_127757, &__block_literal_global_19_127758);
  }
  v2 = (void *)logCategory__hmf_once_v7_127759;
  return v2;
}
...
void __43__HMDCameraClipsQuotaMessenger_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_127759;
  logCategory__hmf_once_v7_127759 = v0;
}
