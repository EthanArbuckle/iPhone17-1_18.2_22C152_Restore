...
- (void)_notifyResidentsOfUpdatedFaceClassificationDependentData
{
  ...
  if (v4)
  {
    ...
    if (v7)
    {
      ...
      if (v9)
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v34 = 2112;
          v35 = v18;
          _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Sending message to notify resident devices of updated face-classification-dependent data: %@", (uint8_t *)&v32, 0x16u);
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
        {
          ...
          int v32 = 138543362;
          v33 = v31;
          _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_ERROR, "%{public}@No account handles found on owner account when notifying resident devices of updated face-classification-dependent data", (uint8_t *)&v32, 0xCu);
        }
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        int v32 = 138543362;
        v33 = v27;
        _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Owner account was nil when notifying resident devices of updated face-classification-dependent data", (uint8_t *)&v32, 0xCu);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v32 = 138543362;
      v33 = v23;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Home reference was nil when notifying resident devices of updated face-classification-dependent data", (uint8_t *)&v32, 0xCu);
    }
  }
}
...
- (void)_startDebounceTimerToNotifyResidentsOfUpdatedFaceClassificationDependentData
{
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      int v15 = 138543362;
      v16 = v8;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Starting timer to notify resident devices of updated face-classification-dependent data", (uint8_t *)&v15, 0xCu);
    }
...
LABEL_9:
  ...
  if (v12)
  {
    ...
    v12->_id notifyResidentsOfUpdatedDataDebounceTimerFactory = &__block_literal_global_254511;
  }
  return v12;
}
...
{
  v3 = (void *)[objc_alloc(MEMORY[0x263F42658]) initWithTimeInterval:a3 options:a1];
  return v3;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t6_254524 != -1) {
    dispatch_once(&logCategory__hmf_once_t6_254524, &__block_literal_global_16_254525);
  }
  v2 = (void *)logCategory__hmf_once_v7_254526;
  return v2;
}
...
void __43__HMDRemotePersonDataMessenger_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_254526;
  logCategory__hmf_once_v7_254526 = v0;
}
