...
- (HMDUserAccessorySettingsDataController)settingsController
{
  ...
  return (HMDUserAccessorySettingsDataController *)WeakRetained;
}
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if (!v18) {
          objc_msgSend(v10, "addObject:", v16, (void)v23);
        }
  ...
  int v19 = objc_msgSend(v4, "hmd_isForXPCTransport");
  uint64_t v20 = *MEMORY[0x263F0B9F8];
  if (v19)
  {
    objc_msgSend(v4, "hm_encodeArrayOfConditionalObjects:forKey:", v11, v20);
  }
  else
  {
    objc_msgSend(v4, "hm_encodeArrayOfConditionalObjects:forKey:", v10, v20);
    v21 = -[HMDAssistantAccessControl _hapAccessoryIdentifiers]((char *)self);
    v22 = objc_msgSend(v21, "na_map:", &__block_literal_global_65_250799);
...
- (HMDAssistantAccessControl)initWithCoder:(id)a3
{
  ...
  id v4 = a3;
  v5 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0AF38]];
  BOOL v6 = [(HMDAssistantAccessControl *)self initWithUser:v5];
  if (v6)
  {
    v6->_enabled = [v4 decodeBoolForKey:*MEMORY[0x263F0BA08]];
    v6->_options = [v4 decodeIntegerForKey:*MEMORY[0x263F0BA10]];
    uint64_t v7 = *MEMORY[0x263F0BA00];
    v6->_activityNotificationsEnabledForPersonalRequests = [v4 containsValueForKey:*MEMORY[0x263F0BA00]]? objc_msgSend(v4, "decodeBoolForKey:", v7): 1;
    uint64_t v8 = *MEMORY[0x263F0B9F8];
    if ([v4 containsValueForKey:*MEMORY[0x263F0B9F8]])
    {
      v9 = objc_msgSend(v4, "hm_decodeArrayOfConditionalObjects:forKey:", objc_opt_class(), v8);
      v10 = (void *)[v9 mutableCopy];

      id v11 = objc_msgSend(v4, "hm_decodeArrayOfConditionalObjects:forKey:", objc_opt_class(), @"HMD.ac.homepods");
      if (v11) {
      ...
      id v16 = [MEMORY[0x263EFF8C0] arrayWithObjects:v24 count:2];
      v17 = [v15 setWithArray:v16];
      id v18 = [v4 decodeObjectOfClasses:v17 forKey:@"HMD.ac.siriEndpointIdentifiers"];

      if ([v18 count])
      {
        int v19 = v6->_hapAccessoryIdentifiers;
        uint64_t v20 = objc_msgSend(v18, "na_map:", &__block_literal_global_63_250812);
        [(NSMutableSet *)v19 addObjectsFromArray:v20];
      }
      uint64_t v21 = [MEMORY[0x263EFF9C0] setWithArray:v10];
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        if (v9)
        {
          ...
          id v11 = [(HMDAssistantAccessControl *)self model];
          uint64_t v13 = [v11 accessoryModelIDs];
          v38 = (void *)[v13 mutableCopy];
...
- (void)transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  if (v12)
  {
    ...
    {
      long long v23 = [v14 accessoryModelIDs];
      int v24 = __modelIDsFromModelIDStrings(v23);

      long long v25 = __accessoriesWithModelIDs(v13, v24);
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v82 = 2112;
        v83 = v31;
        _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_DEFAULT, "%{public}@Got access control update for apple media accessories: %@, allCurrent:%@", buf, 0x20u);
      ...
      if (v32)
      {
        if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v79 = v37;
          _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_INFO, "%{public}@accessories list is the same skipping", buf, 0xCu);
        }
      }
      else
      {
        if (os_log_type_enabled(v35, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v82 = 2112;
          v83 = v72;
          _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_DEFAULT, "%{public}@Updated assistant access control apple media accessories to: %@, from: %@", buf, 0x20u);
        }
    ...
    if ([v14 propertyWasSet:@"siriEndpointAccessoryModelUUIDs"])
    {
      ...
      if (v13)
      {
        uint64_t v45 = objc_msgSend(v43, "na_map:", &__block_literal_global_36_250833);
      }
      else
      {
        uint64_t v45 = 0;
      ...
      if ((HMFEqualObjects() & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v49, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v82 = 2112;
          v83 = v46;
          _os_log_impl(&dword_22F52A000, v49, OS_LOG_TYPE_ERROR, "%{public}@Fatal: found non hap accessory in endpoint list %@, accessories: %@", buf, 0x20u);
        }
        long long v44 = v46;
      }
      id v71 = v9;
      ...
      if (os_log_type_enabled(v54, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v82 = 2112;
        v83 = v58;
        _os_log_impl(&dword_22F52A000, v54, OS_LOG_TYPE_DEFAULT, "%{public}@Got access control update for hap accessories: %@, allCurrent:%@", buf, 0x20u);
      ...
      if (v59)
      {
        if (os_log_type_enabled(v62, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v79 = v64;
          _os_log_impl(&dword_22F52A000, v63, OS_LOG_TYPE_INFO, "%{public}@endpoint list is the same skipping", buf, 0xCu);
        }
      }
      else
      {
        if (os_log_type_enabled(v62, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v82 = 2112;
          v83 = v51;
          _os_log_impl(&dword_22F52A000, v63, OS_LOG_TYPE_DEFAULT, "%{public}@Updated assistant access control accessories to: %@ from: %@", buf, 0x20u);
        }
    ...
    v38 = [(HMDAssistantAccessControl *)v13 user];
  ...
  {
    v38 = [v9 responseHandler];
    long long v39 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
...
- (id)transactionWithObjectChangeType:(unint64_t)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      int v15 = 138543362;
      uint64_t v16 = v13;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Unable to create model without parent user", (uint8_t *)&v15, 0xCu);
    }
    id v9 = 0;
  }
...
- (HMDAssistantAccessControlModel)model
{
  ...
  id v9 = objc_msgSend(v8, "na_map:", &__block_literal_global_44_250870);
...
- (void)_populateModel:(void *)a3 withAccessoryIdsFromAccessories:
{
  ...
  {
    id v4 = a2;
    objc_msgSend(a3, "na_map:", &__block_literal_global_33_250872);
...
void __61__HMDAssistantAccessControl_notifyClientOfUpdateWithMessage___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    id v4 = (void *)MEMORY[0x263F42590];
    uint64_t v5 = *MEMORY[0x263F0DBF0];
    id v6 = [*(id *)(a1 + 40) identifier];
    uint64_t v7 = *MEMORY[0x263F0DBE8];
    v20[0] = v3;
    uint64_t v8 = *MEMORY[0x263F0DBD8];
    v19[0] = v7;
    v19[1] = v8;
      ...
      if (v9 == 1)
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v37 = 2112;
          id v38 = v6;
          _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Accessory was removed: %@", buf, 0x16u);
        }
        id v14 = -[HMDAssistantAccessControl _appleMediaAccessories](*(char **)(a1 + 40));
        int v15 = (void *)[v14 mutableCopy];

        uint64_t v16 = -[HMDAssistantAccessControl _hapAccessoryIdentifiers](*(char **)(a1 + 40));
              ...
              v18))
        {
          ...
          long long v25 = objc_msgSend(v31, "na_map:", &__block_literal_global_250879);
          [v24 setSiriEndpointAccessoryModelUUIDs:v25];

          long long v26 = [*v22 user];
          v27 = [v26 home];
...
void __52__HMDAssistantAccessControl_handleRemovedAccessory___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      uint64_t v18 = v10;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@Error: %@ running transaction to remove accessory: %@ from ACL adding it back.", (uint8_t *)&v13, 0x20u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v15 = 2112;
      id v16 = v12;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Removed accessory %@ from assistant access control list.", (uint8_t *)&v13, 0x16u);
    }
    [v6 notifyClientOfUpdateWithMessage:0];
  }
}

uint64_t __52__HMDAssistantAccessControl_handleRemovedAccessory___block_invoke_26(uint64_t a1, void *a2)
{
  return [a2 UUIDString];
}
...
LABEL_18:
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v26 = 2112;
      id v27 = v15;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_DEFAULT, "%{public}@Removed accessory %@", (uint8_t *)&v24, 0x16u);
    }
    goto LABEL_18;
  }
LABEL_19:
...
- (void)addAccessory:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v22 = 2112;
      id v23 = v12;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Added accessory %@", (uint8_t *)&v20, 0x16u);
    }
  }
}
...
{
  uint64_t v28 = *MEMORY[0x263EF8340];
  id v3 = [(HMDAssistantAccessControl *)self settingsController];
  id v4 = v3;
  if (v3)
  {
    uint64_t v5 = (void *)MEMORY[0x263EFF980];
    id v6 = [v3 assistantAccessControlAccessoriesToEncode];
    uint64_t v7 = objc_msgSend(v5, "arrayWithCapacity:", objc_msgSend(v6, "count"));

    id v8 = [(HMDAssistantAccessControl *)self user];
    id v9 = [v8 home];
    ...
    long long v23 = 0u;
    long long v24 = 0u;
    uint64_t v10 = objc_msgSend(v4, "assistantAccessControlAccessoriesToEncode", 0);
    ...
    if (v11)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v11; ++i)
        {
          ...
          id v14 = [v9 accessoryWithUUID:*(void *)(*((void *)&v23 + 1) + 8 * i)];
          if (v14) {
            [v7 addObject:v14];
          }
        }
  ...
  {
    char v16 = [MEMORY[0x263EFF8C0] array];
    __int16 v17 = [MEMORY[0x263EFF8C0] array];
    p_lock = &self->_lock;
    os_unfair_lock_lock_with_options();
    unsigned __int8 v19 = [(NSMutableSet *)self->_hapAccessoryIdentifiers allObjects];

    os_unfair_lock_unlock(&self->_lock);
    if ([v19 count])
    {
      uint64_t v20 = __accessoriesWithModelIDs(self, v19);

      char v16 = (void *)v20;
    }
    os_unfair_lock_lock_with_options();
    uint64_t v21 = [(NSMutableSet *)self->_appleMediaAccessories allObjects];
    id v15 = [v21 arrayByAddingObjectsFromArray:v16];
...
- (BOOL)areActivityNotificationsEnabledForPersonalRequests
{
  ...
  if (v3)
  {
    char activityNotificationsEnabledForPersonalRequests = [v3 assistantAccessControlActivityNotificationsEnabledForPersonalRequests];
  }
  else
  {
    p_lock = &self->_lock;
    os_unfair_lock_lock_with_options();
    char activityNotificationsEnabledForPersonalRequests = self->_activityNotificationsEnabledForPersonalRequests;
    os_unfair_lock_unlock(p_lock);
  }
...
- (BOOL)isEnabled
{
  ...
  if (v3)
  {
    uint64_t v5 = [v3 assistantAccessControlAccessoriesToEncode];
    BOOL enabled = [v5 count] != 0;
  }
  else
  {
    p_lock = &self->_lock;
...
- (HMDAssistantAccessControl)initWithUser:(id)a3
{
  return [(HMDAssistantAccessControl *)self initWithUser:a3 appleAccessories:MEMORY[0x263EFFA68] hapAccessoryIdentifiers:MEMORY[0x263EFFA68] enabled:1 activityNotificationsEnabledForPersonalRequests:1];
}
...
- (HMDAssistantAccessControl)initWithUser:(id)a3 appleAccessories:(id)a4 hapAccessoryIdentifiers:(id)a5 enabled:(BOOL)a6 activityNotificationsEnabledForPersonalRequests:(BOOL)a7
{
  ...
  if (v15)
  {
    ...
    v16->_BOOL enabled = a6;
    v16->_char activityNotificationsEnabledForPersonalRequests = a7;
    uint64_t v17 = [MEMORY[0x263EFF9C0] setWithArray:v13];
    appleMediaAccessories = v16->_appleMediaAccessories;
    v16->_appleMediaAccessories = (NSMutableSet *)v17;

    uint64_t v19 = [MEMORY[0x263EFF9C0] setWithArray:v14];
    ...
    long long v23 = dispatch_queue_attr_make_with_autorelease_frequency(0, DISPATCH_AUTORELEASE_FREQUENCY_WORK_ITEM);
...
- (HMDAssistantAccessControl)initWithUser:(id)a3 appleAccessories:(id)a4 enabled:(BOOL)a5
{
  return [(HMDAssistantAccessControl *)self initWithUser:a3 appleAccessories:a4 hapAccessoryIdentifiers:MEMORY[0x263EFFA68] enabled:a5 activityNotificationsEnabledForPersonalRequests:1];
}
...
- (HMDAssistantAccessControl)initWithUser:(id)a3 model:(id)a4
{
  ...
  if (v7)
  {
    ...
    BOOL v11 = [(HMDAssistantAccessControl *)self initWithUser:v6 appleAccessories:MEMORY[0x263EFFA68] enabled:v10];
    if (v11)
    {
      id v12 = [v8 options];
      ...
      v11->_char activityNotificationsEnabledForPersonalRequests = [v13 BOOLValue];
      ...
      if ([v19 count])
      {
        uint64_t v20 = [MEMORY[0x263EFF9C0] setWithArray:v19];
        id v21 = v11->_hapAccessoryIdentifiers;
        v11->_hapAccessoryIdentifiers = (NSMutableSet *)v20;
      }
      __int16 v22 = (void *)MEMORY[0x263EFF9C0];
      long long v23 = __accessoriesWithModelIDs(v11, v15);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      int v32 = 138543362;
      id v33 = v30;
      _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@Model is required", (uint8_t *)&v32, 0xCu);
    }
    objc_super v27 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t53_250911 != -1) {
    dispatch_once(&logCategory__hmf_once_t53_250911, &__block_literal_global_47_250912);
  }
  id v2 = (void *)logCategory__hmf_once_v54_250913;
  return v2;
}
...
void __40__HMDAssistantAccessControl_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v54_250913;
  logCategory__hmf_once_v54_250913 = v0;
}

+ (id)modelIDNamespace
{
  if (modelIDNamespace_onceToken_250918 != -1) {
    dispatch_once(&modelIDNamespace_onceToken_250918, &__block_literal_global_41_250919);
  }
  id v2 = (void *)modelIDNamespace_modelIDNamespace_250920;
  return v2;
}

void __45__HMDAssistantAccessControl_modelIDNamespace__block_invoke()
{
  uint64_t v0 = [objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:@"5FF02DEF-EFB2-45C7-BF0C-042B4F336FD8"];
  v1 = (void *)modelIDNamespace_modelIDNamespace_250920;
  modelIDNamespace_modelIDNamespace_250920 = v0;
}
...
+ (HMDAssistantAccessControl)accessControlWithMessage:(id)a3 user:(id)a4 currentAccessories:(id)a5 error:(id *)a6
{
  ...
  id v11 = a4;
  id v79 = a5;
  id v12 = [v10 dataForKey:*MEMORY[0x263F0DBE8]];
  if (v12)
  {
    ...
    v85 = v16;
    uint64_t v17 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v85 count:1];
    id v18 = [v13 deserializeObjectWithData:v12 allowedClass:v14 frameworkClasses:v17];

    if (v18)
    {
      uint64_t v19 = [v10 arrayForKey:*MEMORY[0x263F0DBD8]];
      if (v19)
      {
        id v73 = v11;
        v72 = a6;
...
LABEL_6:
          ...
          while (1)
          {
            ...
            uint64_t v25 = [objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v24];
            if (!v25)
            {
              ...
              if (os_log_type_enabled(v57, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                __int16 v88 = 2112;
                id v89 = v24;
                _os_log_impl(&dword_22F52A000, v57, OS_LOG_TYPE_INFO, "%{public}@Invalid accessory identifier: %@", buf, 0x16u);
              }
              id v11 = v73;
              uint64_t v19 = v74;
              uint64_t v39 = v75;
              ...
              if (v72)
              {
                id *v72 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
              }
              goto LABEL_54;
            }
              ...
              && ([a1 isAccessorySupported:v28] & 1) == 0)
            {
              ...
              if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                __int16 v88 = 2112;
                id v89 = v28;
                _os_log_impl(&dword_22F52A000, v68, OS_LOG_TYPE_INFO, "%{public}@Accessory not supported: %@", buf, 0x16u);
              }
              v64 = v72;
              uint64_t v19 = v74;
              if (v72)
...
LABEL_51:
                ...
                id v38 = v76;
                char v59 = obj;
                id *v64 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:v65];
LABEL_53:
...
LABEL_52:
          ...
          if (os_log_type_enabled(v62, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v88 = 2112;
            id v89 = v24;
            _os_log_impl(&dword_22F52A000, v62, OS_LOG_TYPE_INFO, "%{public}@Failed to lookup accessory with identifier: %@", buf, 0x16u);
          }
          uint64_t v28 = 0;
          v64 = v72;
          uint64_t v19 = v74;
...
LABEL_21:
        ...
        if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v88 = 2112;
          id v89 = obj;
          _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_INFO, "%{public}@Generated access control from message with accessories %@", buf, 0x16u);
        }
        id v38 = v76;
...
LABEL_55:
      ...
      else
      {
        ...
        if (os_log_type_enabled(v52, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v88 = 2112;
          id v89 = v54;
          _os_log_impl(&dword_22F52A000, v52, OS_LOG_TYPE_INFO, "%{public}@Missing access control accessories in message payload: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v48, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v87 = v49;
        _os_log_impl(&dword_22F52A000, v48, OS_LOG_TYPE_INFO, "%{public}@Invalid access control in message payload", buf, 0xCu);
      }
      if (a6)
      {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v88 = 2112;
      id v89 = v45;
      _os_log_impl(&dword_22F52A000, v43, OS_LOG_TYPE_INFO, "%{public}@Missing serialized access control in message payload: %@", buf, 0x16u);
    }
    if (a6)
    {
      [MEMORY[0x263F087E8] hmErrorWithCode:2];
