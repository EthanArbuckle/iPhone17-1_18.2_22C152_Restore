...
- (void)networkMonitorIsUnreachable:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    v11 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Received network monitor is unreachable", (uint8_t *)&v10, 0xCu);
  }
...
- (void)networkMonitorIsReachable:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    v11 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Received network monitor is reachable", (uint8_t *)&v10, 0xCu);
  }
  ...
  if (v6 == v4)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v27 = 2112;
      v28 = v23;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Initial reachability timer fired with isReachable: %@", buf, 0x16u);
    }
    ...
    if (v7 == v4)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v29 = 2114;
        v30 = v13;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Reachability change debounce timer fired with last known reachability %{public}@ and current reachability %{public}@", buf, 0x20u);
      }
...
- (void)clipManagerDidStart:(id)a3
{
  ...
  if ((v10 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v19 = 2112;
      v20 = v15;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Suppressing all reachability notifications before %@", (uint8_t *)&v17, 0x16u);
    }
...
- (id)localZone:(id)a3 didProcessModelUpdate:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v15 = 2112;
    id v16 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Received model update: %@", (uint8_t *)&v13, 0x16u);
  }
...
void __80__HMDCameraRecordingReachabilityEventManager_localZone_didProcessModelDeletion___block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v20 = 2112;
      uint64_t v21 = v10;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Received deleted reachability event model: %@", (uint8_t *)&v18, 0x16u);
    }
    v11 = *(void **)(a1 + 40);
  ...
  else
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Deletion model %@ is not of expected type: %@", (uint8_t *)&v18, 0x20u);
    }
  }
}
...
void __80__HMDCameraRecordingReachabilityEventManager_localZone_didProcessModelCreation___block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v44 = 2114;
      v45 = v9;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Received new reachability event model: %{public}@", (uint8_t *)&v42, 0x16u);
    }
    ...
    if (!v10)
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v44 = 2112;
        v45 = v35;
        _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_ERROR, "%{public}@Failed to convert reachability model into event: %@", (uint8_t *)&v42, 0x16u);
      }
      goto LABEL_23;
    }
    ...
    if (v16 == -1)
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v46 = 2112;
        v47 = v38;
        _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@Ignoring created event with date of occurrence %@ because it is before %@", (uint8_t *)&v42, 0x20u);
      }
    }
    else
    {
      ...
      if (v19 && v21)
      {
        if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v44 = 2114;
          v45 = v10;
          _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@Inserting bulletin for new reachability event: %{public}@", (uint8_t *)&v42, 0x16u);
        }
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v48 = 2112;
        v49 = v41;
        _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_DEBUG, "%{public}@Not inserting bulletin for new reachability event: %@ due to reachabilityEventNotificationEnabled: %@ and isHomeEnabled: %@", (uint8_t *)&v42, 0x2Au);
      }
    }
...
- (void)handleDeleteAllEventsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v27 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling delete all reachability events message", buf, 0xCu);
  }
  ...
  if (v10)
  {
    ...
    uint64_t v12 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v25 count:1];
    int v13 = (void *)MEMORY[0x263F49318];
    BOOL v14 = [v4 name];
  ...
  else
  {
    ...
    int v18 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
...
- (void)handleFetchCountOfEventsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Received message to fetch count of events: %@", buf, 0x16u);
  }
  ...
  if (v11)
  {
    ...
    id v13 = objc_msgSend(v12, "hmf_dateForKey:", *MEMORY[0x263F0BCE8]);

    id v14 = [v4 messagePayload];
    __int16 v15 = objc_msgSend(v14, "hmf_dateForKey:", *MEMORY[0x263F0BCF0]);

    if (v13 && v15)
    {
      id v16 = (void *)[objc_alloc(MEMORY[0x263F08798]) initWithStartDate:v13 endDate:v15];
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Fetching count of reachability event models with date interval: %@", buf, 0x16u);
      }
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v44 = 2112;
        v45 = v16;
        _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@Successfully fetched count of %lu events with date interval: %@", buf, 0x20u);
      }
      uint64_t v27 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", objc_msgSend(v21, "count", *MEMORY[0x263F0BCE0]));
      v39 = v27;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_ERROR, "%{public}@Could not find required value in message payload: %@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v41 = v32;
      _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch count of events because zones are not ready", buf, 0xCu);
    }
...
- (void)handleFetchEventsMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v50 = 2112;
    v51 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Received message to fetch events: %@", buf, 0x16u);
  }
  id v11 = [(HMDCameraRecordingReachabilityEventManager *)v7 localZone];

  if (v11)
  {
    id v12 = [v4 dateForKey:*MEMORY[0x263F0BCE8]];
    id v13 = [v4 dateForKey:*MEMORY[0x263F0BCF0]];
    id v14 = [v4 numberForKey:*MEMORY[0x263F0BCF8]];
    uint64_t v15 = [v4 numberForKey:*MEMORY[0x263F0BD08]];
    id v16 = (void *)v15;
    if (v12 && v13 && v14 && v15)
    {
      __int16 v44 = v13;
      id v17 = (void *)[objc_alloc(MEMORY[0x263F08798]) initWithStartDate:v12 endDate:v13];
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v54 = 2112;
        v55 = v24;
        _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Fetching reachability event models with date interval: %@, limit: %lu, shouldOrderAscending: %@", buf, 0x2Au);
      ...
      if (v18) {
        uint64_t v27 = &__block_literal_global_104;
      }
      else {
        uint64_t v27 = &__block_literal_global_106_185822;
      }
      ...
      v39 = v29;
      id v13 = v44;
      v40 = objc_msgSend(v29, "na_map:", &__block_literal_global_109_185823);
      uint64_t v46 = *MEMORY[0x263F0BD18];
      v41 = encodeRootObjectForIncomingXPCMessage(v40, 0);
      v47 = v41;
      __int16 v42 = [NSDictionary dictionaryWithObjects:&v47 forKeys:&v46 count:1];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v49 = v33;
      _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_ERROR, "%{public}@Cannot fetch events because zones are not ready", buf, 0xCu);
    }
...
- (void)handleRemoteCameraReachabilityChange:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v11 = 138543362;
    id v12 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Received message to perform cloud pull for new reachability event", (uint8_t *)&v11, 0xCu);
  }
...
void __89__HMDCameraRecordingReachabilityEventManager_handleAppleAccountSettingsHomeStateUpdated___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v17 = 2112;
    int v18 = v6;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Received notification of an updated home state with account settings - %@", buf, 0x16u);
  }
  uint64_t v7 = [*(id *)(a1 + 32) accountSettings];
  int v8 = [v7 isHomeEnabled];

  if (v8)
  {
    v9 = [MEMORY[0x263EFF910] date];
    [*(id *)(a1 + 32) setSuppressNotificationsBeforeDate:v9];

    id v10 = [*(id *)(a1 + 32) performCloudPullWithLabel:@"Fetching reachability events due to account settings changed"];
    v14[0] = MEMORY[0x263EF8330];
    v14[1] = 3221225472;
    v14[2] = __89__HMDCameraRecordingReachabilityEventManager_handleAppleAccountSettingsHomeStateUpdated___block_invoke_97;
    v14[3] = &unk_264A2F398;
    v14[4] = *(void *)(a1 + 32);
    int v11 = [v10 addSuccessBlock:v14];
    v13[0] = MEMORY[0x263EF8330];
    v13[1] = 3221225472;
    v13[2] = __89__HMDCameraRecordingReachabilityEventManager_handleAppleAccountSettingsHomeStateUpdated___block_invoke_98;
    v13[3] = &unk_264A2F3E8;
    v13[4] = *(void *)(a1 + 32);
...
void __89__HMDCameraRecordingReachabilityEventManager_handleAppleAccountSettingsHomeStateUpdated___block_invoke_97(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully fetched the reachability events due to account settings changed", (uint8_t *)&v8, 0xCu);
  }
}

void __89__HMDCameraRecordingReachabilityEventManager_handleAppleAccountSettingsHomeStateUpdated___block_invoke_98(uint64_t a1, void *a2)
{
  uint64_t v12 = *MEMORY[0x263EF8340];
  id v3 = a2;
  id v4 = (void *)MEMORY[0x230FBD990]();
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v10 = 2112;
    id v11 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch the reachability events due to account settings changed with error - %@", (uint8_t *)&v8, 0x16u);
  }
}
...
void __95__HMDCameraRecordingReachabilityEventManager_handleHMDBridgedAccessoryUnreachableNotification___block_invoke(uint64_t a1)
{
  ...
  if ((v3 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v12 = 2112;
      uint64_t v13 = v9;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@HMDBridgedAccessoryUnreachableNotification for bridged camera %@", (uint8_t *)&v10, 0x16u);
    }
...
void __93__HMDCameraRecordingReachabilityEventManager_handleHMDBridgedAccessoryReachableNotification___block_invoke(uint64_t a1)
{
  ...
  if ((v3 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v12 = 2112;
      uint64_t v13 = v9;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@HMDBridgedAccessoryReachableNotification for bridged camera %@", (uint8_t *)&v10, 0x16u);
    }
...
uint64_t __74__HMDCameraRecordingReachabilityEventManager_handleAccessoryUnconfigured___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    __int16 v12 = v7;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Unconfigured camera %@", (uint8_t *)&v9, 0x16u);
  }
...
uint64_t __72__HMDCameraRecordingReachabilityEventManager_handleAccessoryConfigured___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    __int16 v12 = v7;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Configured camera %@", (uint8_t *)&v9, 0x16u);
  }
...
void __83__HMDCameraRecordingReachabilityEventManager_handleCameraProfileSettingsDidChange___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v30 = 138543362;
    uint64_t v31 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Received camera profile settings did change notification", (uint8_t *)&v30, 0xCu);
  }
      ...
      if ((v14 & 1) == 0)
      {
        if (v16)
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
          {
            ...
            int v30 = 138543362;
            uint64_t v31 = v20;
            _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Reachability event notifications are now enabled", (uint8_t *)&v30, 0xCu);
          }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v36 = 2112;
      v37 = v29;
      _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@Object for key %@ is not of expected type %@: %@", (uint8_t *)&v30, 0x2Au);
    }
  }
}
...
uint64_t __100__HMDCameraRecordingReachabilityEventManager_handleResidentDeviceConfirmedStateChangedNotification___block_invoke(uint64_t a1)
{
  ...
  if (v4 != result)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v16 = 2112;
      __int16 v17 = v11;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Notified that isCurrentDeviceConfirmedPrimaryResident changed from %@ to %@", (uint8_t *)&v12, 0x20u);
    }
...
- (id)mostRecentReachabilityEventModelInModels:(id)a3
{
  ...
  id v10 = __Block_byref_object_copy__185850;
  __int16 v11 = __Block_byref_object_dispose__185851;
  id v12 = 0;
...
- (void)startReachabilityChangeDebounceTimerWithReachability:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v22 = 2048;
    double v23 = v8;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Starting reachability change debounce timer with time interval of %fs", (uint8_t *)&v20, 0x16u);
  }
  ...
  __int16 v17 = [(HMDCameraRecordingReachabilityEventManager *)v10 reachabilityChangeDebounceTimer];
...
- (void)updateInitialReachabilityTimer
{
  ...
  if ([(HMDCameraRecordingReachabilityEventManager *)self shouldHandleReachabilityChanges])
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      int v15 = 138543362;
      __int16 v16 = v7;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Starting initial reachability timer", (uint8_t *)&v15, 0xCu);
    }
...
- (id)performCloudPullWithLabel:(id)a3
{
  ...
  if (v6)
  {
    double v7 = [MEMORY[0x263F49318] optionsWithLabel:v4];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v25 = v19;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Cannot perform cloud pull because zones are not ready", buf, 0xCu);
    }
    int v20 = (void *)MEMORY[0x263F58190];
...
void __72__HMDCameraRecordingReachabilityEventManager_performCloudPullWithLabel___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to perform cloud pull with options %@ due to error: %@", (uint8_t *)&v9, 0x20u);
  }
}
...
- (void)submitLogEventWithCurrentModel:(id)a3
{
  ...
  if ([v4 reachable])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_FAULT))
      {
        ...
        __int16 v24 = 2112;
        __int16 v25 = v7;
        _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_FAULT, "%{public}@Most recent reachability event model has no date of occurrence: %@", (uint8_t *)&v22, 0x16u);
      }
    }
  }
  ...
  uint64_t v19 = [(HMDCameraRecordingReachabilityEventManager *)self hapAccessory];
  ...
  int v21 = [(HMDCameraRecordingReachabilityEventManager *)self logEventSubmitter];
...
- (id)reachabilityEventModelForCurrentCameraReachability:(BOOL)a3 dateOfOccurrence:(id)a4
{
  ...
  int v9 = [MEMORY[0x263F08C38] UUID];
  ...
  if (v10)
  {
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Notifying %lu subscribed transports of %lu updated events, %lu removed events", buf, 0x2Au);
    }
    v39[0] = *MEMORY[0x263F0BD10];
    id v32 = v6;
    uint64_t v17 = encodeRootObjectForIncomingXPCMessage(v6, 0);
    v39[1] = *MEMORY[0x263F0BD00];
    v40[0] = v17;
    id v31 = v7;
    v40[1] = v7;
    unint64_t v18 = [NSDictionary dictionaryWithObjects:v40 forKeys:v39 count:2];
    ...
    if (v19)
    {
      ...
      uint64_t v22 = *MEMORY[0x263F0BCC8];
      do
      {
        uint64_t v23 = 0;
        do
        {
          ...
          __int16 v25 = [MEMORY[0x263F42590] entitledMessageWithName:v22 messagePayload:v18];
  ...
  else
  {
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEBUG, "%{public}@No subscribed transports to notify of %lu updated events, %lu removed events", buf, 0x20u);
    }
  }
}
...
- (void)notifySubscribersOfRemoteCameraReachabilityEvent
{
  ...
  if (v4)
  {
    ...
    if (v6)
    {
      uint64_t v8 = [v6 cameraBulletinNotificationManager];
      int v9 = [v8 devicesToNotifyForCameraReachabilityForAccessory:v5];
      ...
      if (objc_msgSend(v9, "hmf_isEmpty"))
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          uint64_t v24 = v13;
          _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@No devices need to be notified for accessory reachability event", buf, 0xCu);
        }
      }
      else
      {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        uint64_t v24 = v21;
        _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Home reference was nil when attempting to notify subscribers", buf, 0xCu);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v24 = v17;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@HAP accessory reference was nil when attempting to notify subscribers", buf, 0xCu);
    }
  }
}
...
void __94__HMDCameraRecordingReachabilityEventManager_notifySubscribersOfRemoteCameraReachabilityEvent__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = [v3 shortDescription];
    ...
    __int16 v23 = 2112;
    uint64_t v24 = v15;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Notifying device %@ for camera reachability change to %@ using message: %@", (uint8_t *)&v17, 0x2Au);
  }
...
- (void)addCameraReachabilityEventForCurrentCameraReachability:(BOOL)a3 dateOfOccurrence:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v37 = 2112;
    id v38 = v6;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Adding camera reachability event model %@ with current reachability: %@ date of occurrence: %@", buf, 0x2Au);
  }
  id v26 = [MEMORY[0x263F49318] optionsWithLabel:@"Create camera reachability event"];
  id v14 = [(HMDCameraRecordingReachabilityEventManager *)v10 localZone];
  uint64_t v15 = [MEMORY[0x263EFFA08] setWithObject:v8];
  ...
  [v16 flatMap:v30];
  int v17 = v25 = v6;
  unint64_t v18 = (void *)MEMORY[0x263F581B8];
...
id __118__HMDCameraRecordingReachabilityEventManager_addCameraReachabilityEventForCurrentCameraReachability_dateOfOccurrence___block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      int v13 = 138543362;
      id v14 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@No mirrorOutputResult future provided", (uint8_t *)&v13, 0xCu);
    }
    id v10 = (void *)MEMORY[0x263F58190];
    __int16 v11 = [MEMORY[0x263F087E8] hmfErrorWithCode:15];
...
void __118__HMDCameraRecordingReachabilityEventManager_addCameraReachabilityEventForCurrentCameraReachability_dateOfOccurrence___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to push event %@ to the cloud due to error: %@", (uint8_t *)&v9, 0x20u);
  }
}
...
void __77__HMDCameraRecordingReachabilityEventManager_handleInitialCameraReachability__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v30 = 2114;
    id v31 = v20;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Determining should add initial reachability event using current reachability: %{BOOL}d, most recent reachability event: %{public}@", buf, 0x1Cu);
  }
...
LABEL_11:
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEFAULT, v11, (uint8_t *)&v13, 0xCu);
  ...
  if (self->_currentDeviceConfirmedPrimaryResident != v3)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        ...
        int v18 = 138543362;
        __int16 v19 = v15;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Not updating notification registrations because accessory reference is nil", (uint8_t *)&v18, 0xCu);
      }
    }
  }
}
...
- (void)cleanUpEvents
{
  ...
  BOOL v4 = [MEMORY[0x263EFF910] dateWithTimeIntervalSinceNow:-*MEMORY[0x263F0BCB8]];
  id v5 = objc_alloc(MEMORY[0x263F08798]);
  char v6 = [MEMORY[0x263EFF910] distantPast];
  ...
  if ((unint64_t)[v8 count] > 1)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v30 = 2048;
      uint64_t v31 = v22;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Removing %lu expired records", buf, 0x16u);
    }
    id v23 = [MEMORY[0x263F49318] optionsWithLabel:@"Remove expired camera reachability event records"];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      int v29 = v12;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEBUG, "%{public}@No expired models to delete", buf, 0xCu);
    }
  }
}
...
- (void)configureWithMessageDispatcher:(id)a3 currentSettings:(id)a4 isCurrentDeviceConfirmedPrimaryResident:(BOOL)a5 isCurrentDeviceConnectedToNetwork:(BOOL)a6
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v66 = 2112;
    v67 = v17;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Configuring with current settings: %@, isCurrentDeviceConfirmedPrimaryResident: %@, isCurrentDeviceConnectedToNetwork: %@", buf, 0x2Au);
  }
  ...
  v59[1] = v21;
  uint64_t v49 = v10;
  id v25 = [MEMORY[0x263EFF8C0] arrayWithObjects:v59 count:2];
  ...
  uint64_t v27 = *MEMORY[0x263F0BCD8];
  v58[0] = v20;
  v58[1] = v21;
  __int16 v28 = [MEMORY[0x263EFF8C0] arrayWithObjects:v58 count:2];
  ...
  uint64_t v30 = *MEMORY[0x263F0BCD0];
  v57[0] = v20;
  v57[1] = v21;
  uint64_t v31 = [MEMORY[0x263EFF8C0] arrayWithObjects:v57 count:2];
  ...
  uint64_t v33 = *MEMORY[0x263F0BD28];
  v56[0] = v20;
  v56[1] = v21;
  long long v34 = [MEMORY[0x263EFF8C0] arrayWithObjects:v56 count:2];
  ...
  uint64_t v36 = *MEMORY[0x263F0BD30];
  v55[0] = v20;
  v55[1] = v21;
  __int16 v37 = [MEMORY[0x263EFF8C0] arrayWithObjects:v55 count:2];
  ...
  uint64_t v39 = *MEMORY[0x263F0BD20];
  v54[0] = v20;
  v54[1] = v21;
  v40 = [MEMORY[0x263EFF8C0] arrayWithObjects:v54 count:2];
  ...
  uint64_t v43 = *MEMORY[0x263F0BCC0];
  v53[0] = v20;
  v53[1] = v22;
  v53[2] = v41;
  uint64_t v44 = [MEMORY[0x263EFF8C0] arrayWithObjects:v53 count:3];
...
- (HMDCameraRecordingReachabilityEventManager)initWithAccessory:(id)a3 workQueue:(id)a4 identifier:(id)a5 bulletinBoard:(id)a6 logEventSubmitter:(id)a7 accountSettings:(id)a8 notificationCenter:(id)a9
{
  ...
  if (v18)
  {
    ...
    v19->_id initialReachabilityTimerFactory = &__block_literal_global_185928;

    id reachabilityChangeDebounceTimerFactory = v19->_reachabilityChangeDebounceTimerFactory;
    v19->_id reachabilityChangeDebounceTimerFactory = &__block_literal_global_15_185929;
  }
  return v19;
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t67_185937 != -1) {
    dispatch_once(&logCategory__hmf_once_t67_185937, &__block_literal_global_117_185938);
  }
  v2 = (void *)logCategory__hmf_once_v68_185939;
  return v2;
}
...
void __57__HMDCameraRecordingReachabilityEventManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v68_185939;
  logCategory__hmf_once_v68_185939 = v0;
}
