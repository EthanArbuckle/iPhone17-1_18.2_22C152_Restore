...
- (id)doorbellMessagePayloadWithChimeMode:(int64_t)a3 chimeDate:(id)a4 personIdentificationText:(id)a5 accessoryUUID:(id)a6
{
  ...
  [v13 setObject:v14 forKeyedSubscript:*MEMORY[0x263F0C6E0]];

  [v13 setObject:v12 forKeyedSubscript:*MEMORY[0x263F0C6D0]];
  [v13 setObject:v11 forKeyedSubscript:*MEMORY[0x263F0C6E8]];

  v15 = [v10 UUIDString];

  [v13 setObject:v15 forKeyedSubscript:*MEMORY[0x263F0C6C8]];
  v16 = (void *)[v13 copy];
...
- (void)handleDoorbellChimeMessage:(id)a3
{
  ...
  if (v7)
  {
    if ([v7 isCurrentAccessory])
    {
      ...
      uint64_t v10 = *MEMORY[0x263F0C6E0];
      id v11 = objc_msgSend(v8, "hmf_numberForKey:", *MEMORY[0x263F0C6E0]);
      [v9 setObject:v11 forKeyedSubscript:v10];

      uint64_t v12 = *MEMORY[0x263F0C6D0];
      v13 = objc_msgSend(v8, "hmf_dateForKey:", *MEMORY[0x263F0C6D0]);
      [v9 setObject:v13 forKeyedSubscript:v12];

      uint64_t v14 = *MEMORY[0x263F0C6E8];
      v15 = objc_msgSend(v8, "hmf_stringForKey:", *MEMORY[0x263F0C6E8]);
      [v9 setObject:v15 forKeyedSubscript:v14];

      uint64_t v16 = *MEMORY[0x263F0C6C8];
      v17 = objc_msgSend(v8, "hmf_UUIDForKey:", *MEMORY[0x263F0C6C8]);
      [v9 setObject:v17 forKeyedSubscript:v16];

      id v18 = objc_alloc(MEMORY[0x263F42568]);
      uint64_t v19 = *MEMORY[0x263F0C6D8];
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v38 = 2112;
        v39 = v28;
        _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_DEFAULT, "%{public}@Notifying framework to chime on current accessory - %@", (uint8_t *)&v36, 0x16u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
      {
        ...
        int v36 = 138543362;
        v37 = v35;
        _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_ERROR, "%{public}@Asked to chime on non-current accessory", (uint8_t *)&v36, 0xCu);
      }
    }
  }
}
...
- (void)sendDoorbellChimeMessageWithChimeMode:(int64_t)a3 chimeDate:(id)a4 personIdentificationText:(id)a5 accessoryUUID:(id)a6
{
        ...
        if (v22)
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138544386;
            ...
            __int16 v55 = 2112;
            id v56 = v11;
            _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@Ignoring chime (mode: %ld) that is duplicate of previous chime, date: %@, text: %@, accessoryUUID: %@", buf, 0x34u);
          }
  ...
  {
    id v28 = objc_alloc(MEMORY[0x263F42568]);
    id v29 = objc_alloc(MEMORY[0x263F42570]);
    v30 = [(HMDAccessoryProfile *)self uniqueIdentifier];
    uint64_t v31 = *MEMORY[0x263F0C6D8];
  ...
  else
  {
    ...
    if (v34)
    {
      ...
      v45 = [(HMDRemoteMessage *)v38 initWithName:*MEMORY[0x263F0C6D8] destination:v37 payload:v27];
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_22F52A000, v40, OS_LOG_TYPE_DEFAULT, "%{public}@Notifying remote device to chime - %@", buf, 0x16u);
      }
...
- (void)registerForMessages
{
  ...
  if (v4 && v5)
  {
    if ([v4 isCurrentAccessory])
    {
      ...
      uint64_t v10 = *MEMORY[0x263F0C6D8];
      v16[0] = v7;
      v16[1] = v8;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      double v18 = v15;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@Accessory or home is nil", buf, 0xCu);
    }
  }
}
