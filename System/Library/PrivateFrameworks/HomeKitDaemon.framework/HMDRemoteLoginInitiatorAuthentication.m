...
- (void)_handleAuthenticationResponse:(id)a3 error:(id)a4
{
  ...
  if ([v12 conformsToProtocol:&unk_26E4DDAE0]) {
    v13 = v12;
  }
  else {
    v13 = 0;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_252265 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_252265, &__block_literal_global_252266);
  }
  v2 = (void *)logCategory__hmf_once_v1_252267;
  return v2;
}
...
void __52__HMDRemoteLoginInitiatorAuthentication_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_252267;
  logCategory__hmf_once_v1_252267 = v0;
}
