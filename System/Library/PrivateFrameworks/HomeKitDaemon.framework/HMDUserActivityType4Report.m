...
- (id)copyReportWithLastUpdateTimestamp:(id)a3 reason:(unint64_t)a4
{
  ...
  unint64_t v9 = [(HMDUserActivityType4Report *)self state];
...
- (id)copyReportWithChangedTimestamp:(id)a3
{
  ...
  unint64_t v7 = [(HMDUserActivityType4Report *)self state];
...
- (id)serializedRemoteMessagePayload
{
  ...
  v5 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", -[HMDUserActivityType4Report state](self, "state"));
...
- (id)initFromMessagePayload:(id)a3 withUser:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  BOOL v8 = objc_msgSend(v6, "hmf_numberForKey:", @"HAS.V.UV");
  if (v8)
  {
    v12.receiver = self;
...
- (HMDUserActivityType4Report)initWithUser:(id)a3 state:(unint64_t)a4 withReason:(unint64_t)a5
{
  return [(HMDUserActivityType4Report *)self initWithUser:a3 state:a4 withReason:a5 changedTimestamp:0 lastUpdateTimestamp:0];
}
