...
- (void)transport:(id)a3 didReceiveRawFrame:(id)a4
{
  ...
  if (v8)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v146 = v13;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Data stream received frame", buf, 0xCu);
    }
  ...
  else
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v146 = v14;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Data stream received frame; but no delegate",
        buf,
        0xCu);
    }
  }
      ...
      case 2:
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v147 = 1024;
          LODWORD(v148) = v16;
          _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Data stream failed due to unrecognized frame type 0x%02x", buf, 0x12u);
        }
        goto LABEL_25;
      case 1:
...
LABEL_24:
            _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, v34, buf, 0xCu);
          }
LABEL_25:

          v30 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
          id v28 = 0;
          id v29 = 0;
          goto LABEL_26;
        }
...
LABEL_26:
          ...
          if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v147 = 2112;
            v148 = v30;
            _os_log_impl(&dword_22F52A000, v38, OS_LOG_TYPE_INFO, "%{public}@DataStream dropping incoming message (%@)", buf, 0x16u);
          }
...
LABEL_93:
            _os_log_impl(&dword_22F52A000, v111, OS_LOG_TYPE_INFO, v113, buf, 0xCu);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v123, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v147 = 2112;
              v148 = v61;
              _os_log_impl(&dword_22F52A000, v123, OS_LOG_TYPE_INFO, "%{public}@DataStream dropping incoming message (no protocol named %@)", buf, 0x16u);
            }
            v40 = 0;
          }
              ...
              if (v10)
              {
                ...
                if (os_log_type_enabled(v76, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)v151 = 138543618;
                  ...
                  __int16 v153 = 2112;
                  v154 = v79;
                  _os_log_impl(&dword_22F52A000, v76, OS_LOG_TYPE_INFO, "%{public}@Sending out all pending requests [%@]", v151, 0x16u);
                ...
                if (os_log_type_enabled(v95, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_DWORD *)v151 = 138543618;
                  ...
                  __int16 v153 = 2112;
                  v154 = v97;
                  _os_log_impl(&dword_22F52A000, v95, OS_LOG_TYPE_INFO, "%{public}@Sending out all pending events [%@]", v151, 0x16u);
                }
...
LABEL_68:
            ...
            if (os_log_type_enabled(v69, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v146 = v70;
              _os_log_impl(&dword_22F52A000, v69, OS_LOG_TYPE_ERROR, "%{public}@Received unexpected first message on the data stream", buf, 0xCu);
            }
          ...
          if (os_log_type_enabled(v66, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v149 = 2112;
            id v150 = v46;
            _os_log_impl(&dword_22F52A000, v66, OS_LOG_TYPE_ERROR, "%{public}@Received unexpected %@ key value: %@", buf, 0x20u);
          }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v57, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v149 = 2112;
            id v150 = v43;
            _os_log_impl(&dword_22F52A000, v57, OS_LOG_TYPE_ERROR, "%{public}@Expected protocol name: %@ received: %@", buf, 0x20u);
          }
          id v7 = v131;
          id v6 = v132;
          id v45 = v54;
...
LABEL_67:
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v146 = v24;
    _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@DataStream dropping truncated frame of zero-length", buf, 0xCu);
  }
LABEL_30:
}
...
LABEL_16:
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v44 = 2112;
    id v45 = v26;
    _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@No pending request found for response with header: %@. Pending %@", buf, 0x20u);
  }
  id v7 = v31;
LABEL_19:
}
...
- (void)transportDidOpen:(id)a3
{
  ...
  if (v5)
  {
    if (v9)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v30 = v10;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Data stream OPEN!", buf, 0xCu);
    }
  ...
  else
  {
    if (v9)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v30 = v11;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Data stream OPEN (but no delegate!)", buf, 0xCu);
    }
  }
...
- (void)transportDidClose:(id)a3
{
  ...
  if (v5)
  {
    if (v9)
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v25 = v10;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Data stream closed", buf, 0xCu);
    }
  ...
  else
  {
    if (v9)
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v25 = v11;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Data stream closed (but no delegate!)", buf, 0xCu);
    }
  }
  long long v21 = 0u;
  long long v22 = 0u;
  ...
  v18 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1061];
  ...
  if (v8)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v29 = 2112;
      id v30 = v7;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Data stream failure (%@)", buf, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v29 = 2112;
      id v30 = v7;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Data stream failure (%@); but no delegate",
        buf,
        0x16u);
    }
  }
...
- (void)setTrafficClass:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v12 = 2048;
    unint64_t v13 = a3;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Setting traffic class %lu on transport", (uint8_t *)&v10, 0x16u);
  }
...
- (void)sendRequestForProtocol:(id)a3 topic:(id)a4 payload:(id)a5 completion:(id)a6
{
  ...
  if ([(HMDDataStream *)self firstMessageReceived])
  {
    ...
    if ((v17 & 1) == 0)
    {
      uint64_t v20 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1062];
...
void __65__HMDDataStream_sendRequestForProtocol_topic_payload_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v12 = 2112;
      id v13 = v4;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_DEBUG, "%{public}@DataStream pending the request: %@", (uint8_t *)&v10, 0x16u);
    }
  }
}
    ...
    if (v13)
    {
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v26 = 2112;
        id v27 = v13;
        _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@DataStream encoding message failed (%@)", buf, 0x16u);
      }
      v9[2](v9, v13);
    }
    else
    {
      if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v28 = 2112;
        __int16 v29 = v20;
        _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEBUG, "%{public}@DataStream Sending Message: %@ --> %@", buf, 0x20u);
      }
...
- (void)sendEventForProtocol:(id)a3 topic:(id)a4 payload:(id)a5 completion:(id)a6
{
  ...
  if ([(HMDDataStream *)self firstMessageReceived])
  {
    ...
    {
      id v15 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1062];
...
- (void)close
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v20 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@DataStream closing", buf, 0xCu);
  }
...
- (void)connect
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v12 = 138543362;
    uint64_t v13 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@DataStream connecting", (uint8_t *)&v12, 0xCu);
  }
  if (v4)
  {
...
- (void)setActive:(BOOL)a3
{
  ...
  if (self->_active != v3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v14 = 2112;
      long long v15 = v10;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@DataStream changes active to %@", (uint8_t *)&v12, 0x16u);
    }
...
- (HMDDataStream)initWithTransport:(id)a3 sessionEncryption:(id)a4 workQueue:(id)a5 logIdentifier:(id)a6 connectionTimer:(id)a7 helloMessageResponseTimer:(id)a8
{
  ...
  if (v19)
  {
    ...
    uint64_t v23 = [MEMORY[0x263F08968] strongToStrongObjectsMapTable];
...
- (HMDDataStream)initWithTransport:(id)a3 sessionEncryption:(id)a4 workQueue:(id)a5 logIdentifier:(id)a6
{
  uint64_t v10 = (objc_class *)MEMORY[0x263F42658];
  id v11 = a6;
  id v12 = a5;
  id v13 = a4;
  id v14 = a3;
  id v15 = (void *)[[v10 alloc] initWithTimeInterval:0 options:10.0];
  id v16 = (void *)[objc_alloc(MEMORY[0x263F42658]) initWithTimeInterval:0 options:10.0];
