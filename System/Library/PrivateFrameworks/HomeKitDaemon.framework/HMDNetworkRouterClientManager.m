...
- (void)_unregisterForNetworkProtectionChangesToGroup:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v4;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Unregistering for network protection change notification to group %@", (uint8_t *)&v11, 0x16u);
  }
...
- (void)_registerForNetworkProtectionChangesToGroup:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v4;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Registering for network protection change notification to group %@", (uint8_t *)&v11, 0x16u);
  }
  uint64_t v10 = [(HMDNetworkRouterClientManager *)v7 notificationCenter];
  ...
  if (v9)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v28 = 2112;
      v29 = v9;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Fetching firewall rules for accessory %@ with identifier %@", buf, 0x20u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v26 = 2112;
      long long v27 = v19;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Unable to fetch firewall rules due to failure to derive identifier for accessory %@", buf, 0x16u);
    }
...
void __76__HMDNetworkRouterClientManager__fetchFirewallRulesForAccessory_completion___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v6;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@Fetched firewall rules for accessory %@ with identifier %@ failed with error %@", (uint8_t *)&v15, 0x2Au);
    }
...
- (void)_getNetworkConfigurationForAccessory:(id)a3 targetProtectionMode:(int64_t)a4 completion:(id)a5
{
  ...
  if (a4 == 3)
  {
    ...
    (*((void (**)(id, void, void *, void *, void))v9 + 2))(v9, 0, v12, &unk_26E472AA8, 0);
  }
  else
  {
  ...
  if (v5 == 1)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v34 = 2112;
      v35 = v15;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Using firewall configuration %@ for accessory %@", buf, 0x20u);
    }
  ...
  else if (v5)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v32 = 2112;
      v33 = v23;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Unexpected target network protection mode %@", buf, 0x16u);
    }
...
LABEL_7:
  ...
  if (a7 != 2)
  {
    uint64_t v33 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
LABEL_19:
...
LABEL_8:
  ...
  {
    uint64_t v33 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
    goto LABEL_19;
  }
  if ([v15 isReachable])
  {
    ...
    if (v69)
    {
      ...
      if (v64)
      {
        ...
        if (v17 || a7 != 2)
        {
          ...
          if (os_log_type_enabled(v52, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v90 = 2112;
            v91 = v54;
            _os_log_impl(&dword_22F52A000, v52, OS_LOG_TYPE_INFO, "%{public}@Attempting migration to %@ credential for accessory %@", buf, 0x20u);
          }
        ...
        else
        {
          ...
          v44 = (void *)[objc_alloc(MEMORY[0x263F35AF0]) initWithValue:v21];
      ...
      {
LABEL_31:
        v50 = [MEMORY[0x263F087E8] hmErrorWithCode:52];
        ((void (**)(id, void *))v67)[2](v67, v50);
      }
    }
    else
    {
      v41 = [MEMORY[0x263F087E8] hmErrorWithCode:52];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v88 = 2112;
      id v89 = v39;
      _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_INFO, "%{public}@Unable to perform Wi-Fi reconfiguration for unreachable accessory %@", buf, 0x16u);
    }
    v40 = [MEMORY[0x263F087E8] hmErrorWithCode:4];
...
void __136__HMDNetworkRouterClientManager__migrateAccessory_withConfiguration_clientStatus_fromCredentialType_toCredentialType_rotate_completion___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  id v5 = (void *)[objc_alloc(MEMORY[0x263F35AF0]) initWithValue:*(void *)(a1 + 32)];
...
void __136__HMDNetworkRouterClientManager__migrateAccessory_withConfiguration_clientStatus_fromCredentialType_toCredentialType_rotate_completion___block_invoke_6(uint64_t a1)
{
  ...
  if (!*(void *)(a1 + 40))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v17 = 2112;
      uint64_t v18 = v8;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Successfully completed migration to %@ credential for accessory %@", (uint8_t *)&v13, 0x20u);
    }
  ...
  [v10 removeClientConfigurationWithClientIdentifier:v2 completion:&__block_literal_global_56_197585];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v16 = 2112;
        uint64_t v17 = v9;
        _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Router did not return client status for accessory %@ with client identifier %@ (accessory offline or not connected to router?)", buf, 0x20u);
      }
...
void __155__HMDNetworkRouterClientManager__updateClientConfiguration_forAccessory_protectionMode_clientStatus_skipIfFingerprintMatches_clientReconfigurationAllowed___block_invoke(uint64_t a1, void *a2, void *a3, void *a4, void *a5)
{
  ...
  if (!v9 && v10)
  {
          ...
          v17))
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v56 = 2112;
        v57 = v21;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Skipping network configuration update for accessory %@ with mode %@ - fingerprint matches existing profile", buf, 0x20u);
      }
    ...
    {
      int64_t v26 = (void *)[objc_alloc(MEMORY[0x263F35AF0]) initWithValue:*(void *)(a1 + 56)];
...
void __155__HMDNetworkRouterClientManager__updateClientConfiguration_forAccessory_protectionMode_clientStatus_skipIfFingerprintMatches_clientReconfigurationAllowed___block_invoke_42(void *a1)
{
  ...
  uint64_t v4 = a1[7];
  id v5 = [v3 credential];
  [v1 _migrateAccessory:v2 withConfiguration:v3 clientStatus:v4 fromCredentialType:credentialTypeForCredential(v5) toCredentialType:3 rotate:0 completion:&__block_literal_global_44_197598];
}
...
void __155__HMDNetworkRouterClientManager__updateClientConfiguration_forAccessory_protectionMode_clientStatus_skipIfFingerprintMatches_clientReconfigurationAllowed___block_invoke_4(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    [v11 resetAccessViolationForClientIdentifier:*(void *)(a1 + 72) completion:&__block_literal_global_46_197594];
    ...
    if (*(unsigned char *)(a1 + 120))
    {
      if (*(void *)(a1 + 112) != 3)
      {
        ...
        [v12 _migrateAccessory:v13 withConfiguration:v15 clientStatus:v14 fromCredentialType:credentialTypeForCredential(v16) toCredentialType:3 rotate:0 completion:&__block_literal_global_48_197595];
      }
    }
  }
}
...
LABEL_5:
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v39 = 2112;
      id v40 = v27;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Updating existing client configuration for accessory %@ to comply with target network protection mode %@", buf, 0x20u);
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v39 = 2112;
    id v40 = v33;
    _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_INFO, "%{public}@No network configuration update necessary for accessory %@ with protection mode %@", buf, 0x20u);
  }
LABEL_12:
}
...
LABEL_12:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v25 = 2112;
      BOOL v26 = v22;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Unable to apply client configuration for unreachable accessory %@ with no prior client configuration and no saved PSK", (uint8_t *)&v23, 0x16u);
    }
  }
LABEL_17:
}
...
- (void)_createClientConfigurationForAccessory:(id)a3 credential:(id)a4 clientStatus:(id)a5 clientReconfigurationAllowed:(BOOL)a6
{
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v32 = 2112;
    uint64_t v33 = v18;
    _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Creating new client configuration for %@", buf, 0x16u);
  }
...
void __125__HMDNetworkRouterClientManager__createClientConfigurationForAccessory_credential_clientStatus_clientReconfigurationAllowed___block_invoke_3(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    if (*(unsigned char *)(a1 + 112))
    {
      if (*(void *)(a1 + 104) != 3)
      {
        id v13 = (void *)[objc_alloc(MEMORY[0x263F35AF0]) initWithValue:*(void *)(a1 + 56)];
        [*(id *)(a1 + 72) setClientIdentifier:v13];

        [*(id *)(a1 + 32) _migrateAccessory:*(void *)(a1 + 48) withConfiguration:*(void *)(a1 + 72) clientStatus:*(void *)(a1 + 88) fromCredentialType:credentialTypeForCredential(*(void **)(a1 + 96)) toCredentialType:3 rotate:0 completion:&__block_literal_global_197604];
      }
    }
  }
}
...
- (void)_replaceClientConfigurationForAccessory:(id)a3 credential:(id)a4 clientStatus:(id)a5 clientReconfigurationAllowed:(BOOL)a6
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v34 = 2112;
    v35 = v18;
    _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Replacing client configuration with identifier %@ with a new client configuration for %@", buf, 0x20u);
  }
...
- (void)_replaceNetworkClientIdentifierForAccessory:(id)a3 networkClientIdentifier:(id)a4 networkRouterUUID:(id)a5 clientStatus:(id)a6 clientReconfigurationAllowed:(BOOL)a7
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v41 = 2112;
    id v42 = v20;
    _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Replacing saved network client identifier %@ with %@ found on router for %@", buf, 0x2Au);
  }
  ...
  if (v14)
  {
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v46 = 2112;
      char v47 = v20;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Reconciling client configuration for accessory %@", buf, 0x16u);
    }
    ...
    else if (v22)
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v48 = 2112;
        int8x16_t v49 = v38;
        _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_INFO, "%{public}@Saving found network client identifier %@ for %@", buf, 0x20u);
...
LABEL_21:
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v46 = 2112;
    char v47 = v28;
    _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Router failed to report MAC address for accessory %@", buf, 0x16u);
  }
LABEL_23:
}
    ...
    if (v12)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v53 = 2112;
        id v54 = v12;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@Unable to get translate IP address %@ for accessory %@ because of %@", buf, 0x2Au);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v49 = 2112;
      uint64_t v50 = v20;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Unable to get IP address for accessory %@ because we don't have a connection", buf, 0x16u);
    }
    id v11 = 0;
  }
...
LABEL_13:
    ...
    id v25 = (void *)MEMORY[0x230FBD990]([(HMDNetworkRouterClientStatusIdentifier *)v24 setIpAddress:v11]);
    char v26 = self;
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v51 = 2112;
      v52 = v24;
      _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Querying the router for the status of accessory %@ with %@", buf, 0x20u);
    }
  ...
  if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v49 = 2112;
    uint64_t v50 = v39;
    _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_ERROR, "%{public}@Failed to extract any IP address for accessory %@", buf, 0x16u);
  }
LABEL_16:
}
...
- (void)_startManagingAccessory:(id)a3 initialHomeSetup:(BOOL)a4
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v17 = 2112;
      uint32_t v18 = v14;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Managing accessory %@ as a Network Router client", (uint8_t *)&v15, 0x16u);
    }
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v37 = 2112;
      v38 = v10;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Handling firewall rules update notification for home %@: %@", buf, 0x20u);
    }
  ...
  else
  {
    if (v7)
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v35 = 2112;
      uint64_t v36 = v25;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Ignoring firewall rules update since network protection is disabled for home %@", buf, 0x16u);
    }
  }
}
  ...
  if ([*(id *)(a1 + 32) started])
  {
    ...
    if (v4)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v19 = 2112;
        uint64_t v20 = v12;
        _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Network protection for home %@ changed to %@. Network router Accessory: %@", (uint8_t *)&v13, 0x2Au);
      }
      if ([v5 isReachable]) {
...
void __79__HMDNetworkRouterClientManager_handleNetworkProtectionGroupProtectionChanged___block_invoke(uint64_t a1)
{
  ...
  if ([*(id *)(a1 + 32) started])
  {
    ...
    uint64_t v3 = [v2 objectForKey:*MEMORY[0x263F0B430]];
    ...
    id v7 = [v6 objectForKey:*MEMORY[0x263F0B410]];
      ...
      if (v12 == 1)
      {
        if (v16)
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v37 = 2112;
          id v38 = v5;
          _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Updating accessory network configurations because protection mode changed to %@ for network protection group %@", buf, 0x20u);
        }
      ...
      else
      {
        if (v16)
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v39 = 2112;
          id v40 = v28;
          _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Ignoring protection mode change to %@ for network protection group %@ because home network protection is %@", buf, 0x2Au);
        }
      }
    }
  }
...
void __73__HMDNetworkRouterClientManager_handleNetworkProtectionGroupDeactivated___block_invoke(uint64_t a1)
{
  ...
  uint64_t v3 = [v2 objectForKey:*MEMORY[0x263F0B400]];
    ...
    if (v4)
    {
      ...
      if (v7)
      {
        ...
        if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
        {
          ...
          __int16 v15 = 2112;
          BOOL v16 = v12;
          _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Not reconciling client configuration for accessory %@ -- currently being reconfigured", (uint8_t *)&v13, 0x16u);
        }
      }
      else
      {
  ...
  if ([*(id *)(a1 + 32) started])
  {
    ...
    if (v4 && [v4 supportsNetworkProtection])
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v12 = 2112;
        int v13 = v9;
        _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Handling firmware version update for accessory %@", (uint8_t *)&v10, 0x16u);
      }
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v33 = 2112;
        uint64_t v34 = v12;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Stopping client manager due to removal of currently active network router accessory %@", buf, 0x16u);
      }
      [*(id *)(a1 + 32) _stop];
    }
    else
      ...
      if (v13)
      {
        if (v17)
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v35 = 2112;
          uint64_t v36 = v20;
          _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Removing client configuration with identifier %@ from router for removed accessory %@", buf, 0x20u);
        }
      ...
      else
      {
        if (v17)
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v33 = 2112;
          uint64_t v34 = v24;
          _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@No saved client identifier on removed accessory %@", buf, 0x16u);
        }
      }
...
void __56__HMDNetworkRouterClientManager_handleAccessoryRemoved___block_invoke_31(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Remove client configuration with identifier %@ completed with error %@", (uint8_t *)&v9, 0x20u);
  }
}
...
LABEL_8:
        _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, v9, (uint8_t *)&v14, 0x16u);
      }
    }
    else
    {
      ...
      if (!v10)
      {
        if (v11)
        {
          ...
          __int16 v16 = 2112;
          BOOL v17 = v13;
          _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Will not manage new accessory %@", (uint8_t *)&v14, 0x16u);
        }
        goto LABEL_10;
      }
      if (v11)
...
- (void)_handleRouterAccessoryReachable:(id)a3
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v26 = 2112;
    uint64_t v27 = v15;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Managed network enabled assume to be %@ for network router accessory %@", buf, 0x20u);
  }
  if (v12)
  {
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v18 = 2112;
      id v19 = v3;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Managed network enable for network router accessory %@ completed with error: %@", buf, 0x20u);
    }
...
void __65__HMDNetworkRouterClientManager__handleRouterAccessoryReachable___block_invoke_30(uint64_t a1)
{
  ...
  {
    id v3 = (void *)MEMORY[0x230FBD990](v2);
    id v4 = *(id *)(a1 + 32);
    id v5 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v20 = v6;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Initial Home-level protection setup is required", buf, 0xCu);
    }
...
- (void)_stop
{
  ...
  if ([(HMDNetworkRouterClientManager *)self started])
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v17 = 2112;
      __int16 v18 = v9;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Stopping network router client manager - active network router accessory %@", (uint8_t *)&v15, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      ...
      int v15 = 138543362;
      long long v16 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Client manager is already stopped", (uint8_t *)&v15, 0xCu);
    }
  }
}
...
- (void)_start
{
  ...
  if ([(HMDNetworkRouterClientManager *)self started])
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v44 = v7;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Client manager is already started", buf, 0xCu);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v45 = 2112;
      id v46 = v13;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Starting network router client manager with network router accessory %@", buf, 0x16u);
    }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v45 = 2112;
          id v46 = v37;
          _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_INFO, "%{public}@Network router: %@ is not reachable, waiting until it is", buf, 0x16u);
        }
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v44 = v32;
        _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_INFO, "%{public}@No home to register for notifications on", buf, 0xCu);
      }
    }
  }
}
  ...
  else
  {
    ...
    if (v8)
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        uint64_t v21 = v13;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Stale network client identifiers reset is already in progress", buf, 0xCu);
      }
    }
    else
    {
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v22 = 2112;
        uint64_t v23 = v16;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Resetting stale network client identifiers for accessories in the home %@ before starting", buf, 0x16u);
      }
...
{
  uint64_t v21 = *MEMORY[0x263EF8340];
  uint64_t v2 = (void *)MEMORY[0x230FBD990]([*(id *)(a1 + 32) setStaleClientIdentifiersResetInProgress:0]);
  id v3 = *(id *)(a1 + 32);
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    uint64_t v20 = v9;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Resetting stale network client identifiers completed for home %@, staleClientIdentifiersResetNeeded = %@, startPending = %@", (uint8_t *)&v13, 0x2Au);
  }
...
- (void)_evaluateManagement
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v23 = 2112;
    uint64_t v24 = v6;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Evaluating network router management responsibility. Resident Available: %@, Current Device Primary Resident: %@, Current Device Management Active: %@, Primary Managing Device: %@", (uint8_t *)&v15, 0x34u);
  }
  if (v6) {
    int v14 = 0;
  }
...
void __85__HMDNetworkRouterClientManager_migrateAccessory_toCredentialType_rotate_completion___block_invoke(uint64_t a1)
{
  ...
  if ([*(id *)(a1 + 32) started])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        uint64_t v28 = v19;
        _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Migration not possible, accessory has no existing client profile", buf, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v28 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Migration not possible, client manager is not running", buf, 0xCu);
    }
    uint64_t v15 = *(void *)(a1 + 48);
    uint64_t v2 = [MEMORY[0x263F087E8] hmErrorWithCode:52];
...
{
  uint64_t v2 = (void *)[objc_alloc(MEMORY[0x263F35AF0]) initWithValue:*(void *)(a1 + 40)];
...
void __69__HMDNetworkRouterClientManager_replaceActiveNetworkRouterAccessory___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (*(void *)(a1 + 40))
    {
      ...
      id v4 = (void *)MEMORY[0x230FBD990]([*(id *)(a1 + 32) _evaluateManagement]);
      id v5 = *(id *)(a1 + 32);
      id v6 = HMFGetOSLogHandle();
      if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v17 = 2112;
        uint64_t v18 = v9;
        _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Activated network router accessory %@ - previous active network router accessory was %@", (uint8_t *)&v13, 0x20u);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        int v13 = 138543362;
        id v14 = v12;
        _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Attempt to activate a nil network router accessory", (uint8_t *)&v13, 0xCu);
      }
    }
  }
}
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v30 = 2112;
      long long v31 = v19;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Initializing with network router accessory %@", buf, 0x16u);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t79 != -1) {
    dispatch_once(&logCategory__hmf_once_t79, &__block_literal_global_78_197671);
  }
