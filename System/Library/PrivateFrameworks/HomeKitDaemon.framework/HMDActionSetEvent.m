...
- (id)biomeEventsRepresentationForLogObserver:(id)a3
{
  ...
  if (v5)
  {
    ...
    id v32 = objc_alloc(MEMORY[0x263F2A7B0]);
    ...
    v44 = v39;
    v24 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v44 count:1];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v46 = v23;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Unable to log action set event metadata to biome, no home", buf, 0xCu);
    }
...
- (id)microLocationMetadataForLogEventObserver:(id)a3
{
  unsigned int v4 = (void *)MEMORY[0x263F55790];
...
- (HMDActionSetEvent)initWithActionSet:(id)a3 source:(unint64_t)a4 numAccessories:(unsigned int)a5 bundleId:(id)a6 transactionId:(id)a7
{
  ...
  if (v17)
  {
    ...
    v19 = [MEMORY[0x263F424F0] currentActivity];
    ...
    v31 = objc_msgSend(v30, "na_filter:", &__block_literal_global_124199);
    ...
    uint64_t v49 = objc_msgSend(v48, "na_map:", &__block_literal_global_3_124200);
    accessoryUUIDs = v17->_accessoryUUIDs;
    v17->_accessoryUUIDs = (NSArray *)v49;

    v51 = [v12 associatedAccessories];
    uint64_t v52 = objc_msgSend(v51, "na_map:", &__block_literal_global_5_124201);
