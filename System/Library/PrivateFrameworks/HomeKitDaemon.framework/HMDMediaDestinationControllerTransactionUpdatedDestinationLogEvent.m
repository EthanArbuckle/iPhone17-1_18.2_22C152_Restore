...
@implementation HMDMediaDestinationControllerTransactionUpdatedDestinationLogEvent
...
- (NSString)coreAnalyticsEventName
{
  return (NSString *)@"com.apple.HomeKit.daemon.media.destination.controller.transactionUpdatedDestination";
}

- (HMDMediaDestinationControllerTransactionUpdatedDestinationLogEvent)initWithExistingDestinationType:(id)a3 destinationType:(id)a4 isTriggeredOnControllerDevice:(id)a5 userPrivilege:(id)a6
{
  v7.receiver = self;
  v7.super_class = (Class)HMDMediaDestinationControllerTransactionUpdatedDestinationLogEvent;
