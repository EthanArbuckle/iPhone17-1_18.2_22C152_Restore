...
- (void)submitCounters
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v43 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Submitting counters", buf, 0xCu);
  }
...
- (id)sampleCountersAndReset:(BOOL)a3
{
  ...
  v14[0] = &unk_26E471728;
  uint64_t v6 = [(HMDXPCMessageCountTracker *)self acceptedRequests];
...
- (void)incrementCounterOfType:(int64_t)a3 clientIdentifier:(id)a4 messageName:(id)a5
{
  id v16 = a4;
  id v8 = a5;
  uint64_t v9 = [v16 stringByAppendingFormat:@"/%@", v8];
  uint64_t v10 = objc_msgSend(v9, "hmf_stringWithSmallestEncoding");

  p_lock = &self->_lock;
  os_unfair_lock_lock_with_options();
  v12 = [(HMDXPCMessageCountTracker *)self mutableCountersOfType:a3];
  uint64_t v13 = objc_msgSend(v12, "hmf_numberForKey:", v10);
  uint64_t v14 = [v13 unsignedLongValue];

  uint64_t v15 = [NSNumber numberWithUnsignedLong:v14 + 1];
...
- (id)mutableCountersOfType:(int64_t)a3
{
  ...
  if (a3 == 2)
  {
    uint64_t v5 = [(HMDXPCMessageCountTracker *)self sentNotifications];
  }
  else if (a3 == 1)
  {
    uint64_t v5 = [(HMDXPCMessageCountTracker *)self erroredRequests];
  }
  else
  {
    if (a3)
    {
      uint64_t v7 = (HMDXPCMessageCountTracker *)_HMFPreconditionFailureWithFormat();
      [(HMDXPCMessageCountTracker *)v7 _resetCounters];
      return result;
    }
    uint64_t v5 = [(HMDXPCMessageCountTracker *)self acceptedRequests];
  }
  return v5;
}
...
- (void)_resetCounters
{
  ...
  id v4 = [(HMDXPCMessageCountTracker *)self erroredRequests];
  [v4 removeAllObjects];
...
- (HMDXPCMessageCountTracker)init
{
  BOOL v3 = [MEMORY[0x263F42608] sharedPreferences];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_102773 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_102773, &__block_literal_global_29_102774);
  }
  v2 = (void *)logCategory__hmf_once_v5_102775;
  return v2;
}
...
void __40__HMDXPCMessageCountTracker_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_102775;
  logCategory__hmf_once_v5_102775 = v0;
}

+ (HMDXPCMessageCountTracker)sharedTracker
{
  if (sharedTracker_onceToken != -1) {
    dispatch_once(&sharedTracker_onceToken, &__block_literal_global_102780);
  }
...
{
  uint64_t v0 = objc_alloc_init(HMDXPCMessageCountTracker);
