...
- (BOOL)_parseFromTLVData
{
  ...
  v3 = [MEMORY[0x263F35A58] wrappertlv:1 name:@"kAudioCodecConfiguration__CodecGroupType"];
  id v4 = [MEMORY[0x263F35990] wrappertlv:2 name:@"kAudioCodecConfiguration__CodecParameters"];
  v23[0] = (uint64_t)v3;
  v23[1] = (uint64_t)v4;
