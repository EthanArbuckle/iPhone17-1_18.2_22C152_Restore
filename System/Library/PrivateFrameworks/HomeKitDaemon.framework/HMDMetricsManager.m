...
- (HMDCoreDataLogEventsAnalyzer)coreDataLogEventsAnalyzer;
...
- (HMDMetricsHomeDataChangedManager)metricsHomeDataChangedManager;
...
- (HMDUserActivityStateDetectorLogEventAnalyzer)userActivityStateDetectorLogEventAnalyzer;
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_userActivityStateDetectorLogEventAnalyzer, 0);
  ...
  objc_storeStrong((id *)&self->_coreDataLogEventsAnalyzer, 0);
  ...
  objc_storeStrong((id *)&self->_metricsHomeDataChangedManager, 0);
...
- (HMDUserActivityStateDetectorLogEventAnalyzer)userActivityStateDetectorLogEventAnalyzer
{
  return self->_userActivityStateDetectorLogEventAnalyzer;
}
...
- (HMDCoreDataLogEventsAnalyzer)coreDataLogEventsAnalyzer
{
  return self->_coreDataLogEventsAnalyzer;
}
...
- (HMDMetricsHomeDataChangedManager)metricsHomeDataChangedManager
{
  return self->_metricsHomeDataChangedManager;
}
...
- (BOOL)isCurrentDeviceConfirmedPrimaryResident
{
  ...
  v3 = [v2 homes];
  char v4 = objc_msgSend(v3, "na_any:", &__block_literal_global_387_117077);
...
- (void)waitToCompleteCurrentlyQueuedTasks
{
  ...
  dispatch_sync(v2, &__block_literal_global_383);
}
...
- (void)_handleFetchEventCounters:(id)a3
{
  ...
  v7 = objc_msgSend(MEMORY[0x263EFF9A0], "dictionaryWithCapacity:", objc_msgSend(v6, "count"));
  uint64_t v10 = MEMORY[0x263EF8330];
  uint64_t v11 = 3221225472;
  uint64_t v12 = __47__HMDMetricsManager__handleFetchEventCounters___block_invoke;
  uint64_t v13 = &unk_264A1F7E0;
  id v14 = v7;
  id v8 = v7;
  [v6 enumerateKeysAndObjectsUsingBlock:&v10];
  v15 = @"countersManager";
  v16[0] = v8;
  v9 = objc_msgSend(NSDictionary, "dictionaryWithObjects:forKeys:count:", v16, &v15, 1, v10, v11, v12, v13);
...
- (void)_handleDeleteEphemeralContainer:(id)a3
{
  ...
  if (-[HMDMetricsManager _canRunCountersManagerCommand:](self, "_canRunCountersManagerCommand:"))
  {
    ...
    if (!v4)
    {
      id v5 = [MEMORY[0x263F087E8] hmfErrorWithCode:3 reason:@"Ephemeral container name required"];
  ...
  if ([(HMDMetricsManager *)self _canRunCountersManagerCommand:v4])
  {
    ...
    else
    {
      if (!v54 || !v55)
      {
        ...
        id v14 = [MEMORY[0x263EFF960] localeWithLocaleIdentifier:@"en_US_POSIX"];
        [v13 setLocale:v14];
        ...
        long long v20 = [MEMORY[0x263F42620] productInfo];
        long long v21 = [MEMORY[0x263F42648] systemInfo];
        ...
        [v19 setObject:MEMORY[0x263EFFA88] forKeyedSubscript:@"isHH2Enabled"];
        if (v55)
        {
          v41 = NSNumber;
        ...
        v46 = (void *)[v49 copy];
        v75[1] = v46;
        v47 = [NSDictionary dictionaryWithObjects:v75 forKeys:v74 count:2];
...
void __41__HMDMetricsManager__handleReadCounters___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v8)
  {
    id v3 = [v7 objectForKeyedSubscript:*MEMORY[0x263F49958]];
    if (![v8 isEqual:v3])
    {
LABEL_29:
  ...
  if (v9)
  {
    id v4 = [v7 objectForKeyedSubscript:*MEMORY[0x263F49960]];
...
LABEL_8:
    uint64_t v12 = [v7 objectForKeyedSubscript:*MEMORY[0x263F49950]];
...
LABEL_17:
    if (*(void *)(a1 + 56))
    {
      ...
      if (v14)
      {
        ...
        v51[0] = v16;
        long long v17 = [NSDictionary dictionaryWithObjects:v51 forKeys:&v50 count:1];
...
LABEL_27:
    ...
    if (*(void *)(a1 + 80))
    {
      ...
      long long v19 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v49 count:1];
    }
    else
    {
...
LABEL_17:
    if (*(void *)(a1 + 56))
    {
      ...
      if (v14)
      {
        ...
        if (v15)
        {
          ...
          v53[0] = v15;
          long long v17 = [NSDictionary dictionaryWithObjects:v53 forKeys:&v52 count:1];
    ...
    if (*(void *)(a1 + 80))
    {
      ...
      long long v19 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v51 count:1];
    }
    else
    {
...
- (void)startAnalyzers
{
  ...
  id v5 = [MEMORY[0x263EFF8C0] arrayWithObjects:v27 count:2];
  ...
  uint64_t v8 = [MEMORY[0x263EFF8C0] arrayWithObjects:v26 count:7];
  ...
  long long v17 = [MEMORY[0x263EFF8C0] arrayWithObjects:v23 count:3];
  ...
  if (isInternalBuild())
  {
    ...
    if (v18)
    {
      ...
      [v19 addObserver:v20 forProtocol:&unk_26E477580];
    }
  }
...
- (void)registerTaggedLoggingProcessors
{
  ...
  id v3 = (void *)MEMORY[0x263F499E8];
  v6[0] = *MEMORY[0x263F49788];
...
- (BOOL)isDemoModeConfigured
{
  id v2 = [(HMDMetricsManager *)self homeManager];
...
- (BOOL)updateCachedWidgetCount
{
  char v3 = [(HMDMetricsManager *)self homeManager];
...
- (void)updateCachedConfiguration
{
  char v3 = +[HMDHAPMetadata getSharedInstance];
  id v4 = [v3 version];
...
- (void)logEventAggregationAnalysisLogEvents
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2114;
    uint64_t v20 = v10;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Current state of aggregated event counts since last metric submission (reset every 24 hrs): %{public}@", (uint8_t *)&v17, 0x16u);
  }
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2114;
    uint64_t v20 = v16;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Current state of aggregated error counts since last metric submission (reset every 24 hrs): %{public}@", (uint8_t *)&v17, 0x16u);
  }
}
...
- (void)submitResidentSelectionDenominatorEvents
{
  ...
  id v4 = +[HMDStatusChannelManagementLogEvent denominatorEvent];
  [v3 submitLogEvent:v4];

  uint64_t v5 = [(HMDMetricsManager *)self logEventDispatcher];
  uint64_t v6 = +[HMDStatusChannelObserveLogEvent denominatorEvent];
  ...
  if (v9)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v10; ++i)
      {
        ...
        {
          long long v14 = [(HMDMetricsManager *)self logEventDispatcher];
          long long v15 = [v13 uuid];
          long long v16 = [v13 residentDeviceManager];
          uint64_t v17 = +[HMDResidentSelectionPrimaryResidentChangedLogEvent denominatorEvent:residentSelectionMode:](HMDResidentSelectionPrimaryResidentChangedLogEvent, "denominatorEvent:residentSelectionMode:", v15, [v16 residentSelectionMode]);
          [v14 submitLogEvent:v17];

          id v18 = [(HMDMetricsManager *)self logEventDispatcher];
          __int16 v19 = [v13 uuid];
          uint64_t v20 = +[HMDResidentStatusChannelPublishLogEvent denominatorEvent:v19];
          [v18 submitLogEvent:v20];

          uint64_t v21 = [(HMDMetricsManager *)self logEventDispatcher];
          long long v22 = +[HMDStatusChannelPublishLogEvent denominatorEvent];
          [v21 submitLogEvent:v22];
        }
        long long v23 = [(HMDMetricsManager *)self logEventDispatcher];
        long long v24 = [v13 uuid];
        long long v25 = +[HMDResidentStatusChannelObserveLogEvent denominatorEvent:v24];
        [v23 submitLogEvent:v25];
      }
...
- (void)runDailyTask
{
  ...
  uint64_t v3 = [MEMORY[0x263F42620] productInfo];
  uint64_t v4 = [v3 productVariant];

  if (v4 == 3)
  {
    uint64_t v5 = [MEMORY[0x263F42648] systemInfo];
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v46 = 2112;
        long long v47 = v6;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@[CA] Serial Number: %@", buf, 0x16u);
      }
    }
  }
  ...
  long long v39 = 0u;
  long long v40 = 0u;
  uint64_t v11 = [(HMDMetricsManager *)self cachedConfiguration];
...
- (void)startMetricsCollection
{
  ...
  if ([(HMDMetricsManager *)self metricsCollectionStarted])
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      int v19 = 138543362;
      uint64_t v20 = v7;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Metrics collection already started", (uint8_t *)&v19, 0xCu);
    }
    os_unfair_lock_unlock(p_lock);
  }
  else
  ...
  if (v4 == 3)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v58 = v8;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Registering for homeutil messages", buf, 0xCu);
    }
    uint64_t v9 = [(HMDMetricsManager *)v6 messageDispatcher];
    id v10 = +[HMDXPCMessagePolicy policyWithEntitlements:5];
    v56 = v10;
    uint64_t v11 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v56 count:1];
    ...
    v55 = v13;
    uint64_t v14 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v55 count:1];
    ...
    v54 = v16;
    uint64_t v17 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v54 count:1];
    ...
    v53 = v19;
    uint64_t v20 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v53 count:1];
    ...
    uint64_t v52 = v22;
    long long v23 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v52 count:1];
    ...
    uint64_t v51 = v25;
    long long v26 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v51 count:1];
    ...
    uint64_t v50 = v28;
    long long v29 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v50 count:1];
    ...
    uint64_t v49 = v31;
    uint64_t v32 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v49 count:1];
    ...
    uint64_t v48 = v34;
    uint64_t v35 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v48 count:1];
    ...
    long long v47 = v37;
    v38 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v47 count:1];
    ...
    __int16 v46 = v40;
    long long v41 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v46 count:1];
    ...
    long long v45 = v43;
    long long v44 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v45 count:1];
...
- (void)_configureManagers
{
  ...
  id v5 = [HMDMetricsHomeDataChangedManager alloc];
  uint64_t v6 = [(HMDMetricsManager *)self legacyCountersManager];
  uint64_t v7 = [(HMDMetricsHomeDataChangedManager *)v5 initWithCountersManager:v6 currentHomeDataSource:self dateProvider:self->_dateProvider];
  ...
  uint64_t v9 = [HMDHouseholdMetricsManager alloc];
  id v10 = [(HMDMetricsManager *)self legacyCountersManager];
  uint64_t v11 = [(HMDMetricsManager *)self accessoryDetailsManager];
  long long v12 = [(HMDMetricsManager *)self metricsHomeDataChangedManager];
  uint64_t v13 = [(HMDMetricsManager *)self dailyScheduler];
  uint64_t v14 = [(HMDMetricsManager *)self logEventDispatcher];
  dateProvider = self->_dateProvider;
  v19[0] = self->_userActivityEventsAnalyzer;
  uint64_t v16 = [MEMORY[0x263EFF8C0] arrayWithObjects:v19 count:1];
  uint64_t v17 = [(HMDHouseholdMetricsManager *)v9 initWithCountersManager:v10 dataSource:self accessoryDetailsManager:v11 metricsHomeDataChangedManager:v12 dailyScheduler:v13 logEventSubmitter:v14 dateProvider:dateProvider activityContributors:v16];
  householdMetricsManager = self->_householdMetricsManager;
  self->_householdMetricsManager = v17;
}
...
- (void)addAnalyzer:(id)a3 toListOfAggregationAnalysisEventContributing:(id)a4
{
  id v6 = a3;
  id v5 = a4;
  if ([v6 conformsToProtocol:&unk_26E4C6A70]) {
    [v5 addObject:v6];
  }
}
...
- (void)_configureObservers
{
  ...
  v65[0] = v5;
  id v6 = [MEMORY[0x263EFF8C0] arrayWithObjects:v65 count:1];
  coreAnalyticsFilters = self->_coreAnalyticsFilters;
  self->_coreAnalyticsFilters = v6;

  uint64_t v8 = (HMMCoreAnalyticsLogEventObserver *)[objc_alloc(MEMORY[0x263F49990]) initWithDelegate:self->_coreAnalyticsDelegate filters:self->_coreAnalyticsFilters];
  ...
  id v14 = objc_alloc(MEMORY[0x263F499D0]);
  uint64_t v15 = [MEMORY[0x263F6C818] sharedStream];
  ...
  if (isInternalBuild())
  {
    ...
    dateProvider = self->_dateProvider;
    long long v26 = [MEMORY[0x263F42648] systemInfo];
  ...
  long long v40 = (void *)[objc_alloc(MEMORY[0x263F42658]) initWithTimeInterval:8 options:300.0];
  ...
  id v57 = [[HMDCoreDataLogEventsAnalyzer alloc] initWithDataSource:self];
  coreDataLogEventsAnalyzer = self->_coreDataLogEventsAnalyzer;
  self->_coreDataLogEventsAnalyzer = v57;

  [(HMDMetricsManager *)self addAnalyzer:self->_coreDataLogEventsAnalyzer toListOfAggregationAnalysisEventContributing:self->_aggregationAnalysisEventContributingAnalyzers];
  uint64_t v59 = [[HMDWidgetTimelineRefresherEventsAnalyzer alloc] initWithEventCountersManager:self->_legacyCountersManager logEventSubmitter:self->_logEventDispatcher dailyScheduler:self->_dailyScheduler];
  ...
  id v61 = +[HMDFeaturesDataSource defaultDataSource];
  int v62 = [v61 isUserActivityStateDetectionFeatureEnabled];

  if (v62)
  {
    id v63 = [[HMDUserActivityStateDetectorLogEventAnalyzer alloc] initWithDataSource:self];
...
- (HMDMetricsManager)initWithMessageDispatcher:(id)a3 accountManager:(id)a4 notificationSettingsProvider:(id)a5 logEventDispatcher:(id)a6 dailyScheduler:(id)a7 dateProvider:(id)a8 legacyCountersManager:(id)a9 flagsManager:(id)a10 ewsLogger:(id)a11 deviceStateManager:(id)a12 networkObserver:(id)a13 coreAnalyticsTagObserver:(id)a14 backgroundLoggingTimer:(id)a15 radarInitiator:(id)a16 notificationCenter:(id)a17 userDefaults:(id)a18 currentSoftwareVersion:(id)a19
{
  ...
  if (v28)
  {
    ...
    objc_msgSend(v24, "addCommonField:withValue:", @"isHH2Enabled", &unk_26E471878, a3);
...
- (HMDMetricsManager)initWithMessageDispatcher:(id)a3 accountManager:(id)a4 notificationSettingsProvider:(id)a5
{
  ...
  id v9 = objc_alloc_init(MEMORY[0x263F499C0]);
  id v51 = +[HMDLogEventDailyScheduler createSchedulerWithLogEventSubmitter:v9];
  uint64_t v10 = [MEMORY[0x263F499A8] sharedInstance];
  uint64_t v11 = +[HMDMetricsManager defaultRadarInitiator];
  ...
  if (a4)
  {
    if (v15)
    {
      ...
      *(_DWORD *)buf = 138543362;
      int v62 = v16;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Using Core Data metric counters", buf, 0xCu);
    }
    id v17 = (id)metricsCountersPersistentStorePath;
    id v18 = objc_alloc(MEMORY[0x263F499A0]);
    uint64_t v19 = [v18 initWithDataModelName:*MEMORY[0x263F49948] atPath:v17];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v63 = 2112;
        id v64 = v23;
        _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to create new counters manager. Falling back to legacy manager. Error: %@", buf, 0x16u);
  ...
  else
  {
    if (v15)
    {
      ...
      *(_DWORD *)buf = 138543362;
      int v62 = v26;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Using legacy metric counters", buf, 0xCu);
    }
    id v24 = objc_alloc_init(HMDEventCountersManager);
  }
  id v32 = objc_alloc(MEMORY[0x263F49998]);
  uint64_t v33 = [MEMORY[0x263F499E0] sharedInstance];
  ...
  v36 = [MEMORY[0x263F42608] sharedPreferences];
  v37 = [v36 preferenceForKey:@"backgroundLoggingPeriod"];
  id v49 = [v37 numberValue];

  id v38 = objc_alloc(MEMORY[0x263F42658]);
  [v49 doubleValue];
  ...
  long long v44 = [MEMORY[0x263F499C8] sharedManager];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t16_117354 != -1) {
    dispatch_once(&logCategory__hmf_once_t16_117354, &__block_literal_global_378);
  }
  id v2 = (void *)logCategory__hmf_once_v17_117355;
  return v2;
}
...
void __32__HMDMetricsManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v17_117355;
  logCategory__hmf_once_v17_117355 = v0;
}
...
+ (void)submitMinimalCoreAnalyticsEvent:(id)a3
{
  ...
  id v4 = objc_alloc(MEMORY[0x263F49990]);
  id v5 = (void *)[v4 initWithDelegate:v6 filters:MEMORY[0x263EFFA68]];
...
{
  os_unfair_lock_lock_with_options();
  id v2 = (void *)sharedDispatcher;
  if (!sharedDispatcher)
  {
    id v2 = (void *)bufferedSubmitter;
    if (!bufferedSubmitter)
    {
      id v3 = objc_alloc_init(MEMORY[0x263F49988]);
      id v4 = (void *)bufferedSubmitter;
...
+ (NSUUID)namespaceUUID
{
  if (namespaceUUID_onceToken != -1) {
    dispatch_once(&namespaceUUID_onceToken, &__block_literal_global_117362);
  }
...
{
  uint64_t v0 = [objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:@"D3872CF5-6B42-43E3-8D60-9E0A0C8483DA"];
