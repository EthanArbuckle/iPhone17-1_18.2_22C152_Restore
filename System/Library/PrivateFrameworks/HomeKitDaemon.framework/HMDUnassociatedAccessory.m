...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v20 encodeInteger:v9 forKey:*MEMORY[0x263F0AF80]];
  ...
  if (objc_msgSend(v20, "hmd_isForXPCTransportEntitledForSPIAccess"))
  {
    ...
    [v20 encodeBool:v10 forKey:*MEMORY[0x263F0B738]];
    BOOL v11 = [(HMDUnassociatedAccessory *)self isKnownToSystemCommissioner];
    [v20 encodeBool:v11 forKey:*MEMORY[0x263F0B388]];
    v12 = [(HMDUnassociatedAccessory *)self rootPublicKey];
    [v20 encodeObject:v12 forKey:*MEMORY[0x263F0B500]];

    v13 = [(HMDUnassociatedAccessory *)self nodeID];
    [v20 encodeObject:v13 forKey:*MEMORY[0x263F0B220]];

    v14 = [(HMDUnassociatedAccessory *)self commissioningID];
    [v20 encodeObject:v14 forKey:*MEMORY[0x263F0B218]];
    ...
    [v20 encodeObject:v16 forKey:*MEMORY[0x263F0B480]];

    v17 = [(HMDUnassociatedAccessory *)self vendorID];
    [v20 encodeObject:v17 forKey:*MEMORY[0x263F0B878]];

    BOOL v18 = [(HMDUnassociatedAccessory *)self requiresThreadRouter];
    [v20 encodeBool:v18 forKey:*MEMORY[0x263F0B4E0]];
...
- (void)identifyWithCompletionHandler:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    BOOL v11 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@The accessory does not support identify", (uint8_t *)&v10, 0xCu);
  }
  if (v4)
  {
    int64_t v9 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
    v4[2](v4, v9);
  }
}
...
- (void)_handleIdentify:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v14 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Identifying", buf, 0xCu);
  }
...
void __44__HMDUnassociatedAccessory__handleIdentify___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v3;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Identified with error: %@", (uint8_t *)&v11, 0x16u);
  }
...
- (void)updateCategoryWithCategoryIdentifier:(id)a3
{
  if (a3)
  {
    ...
    id v6 = objc_alloc(MEMORY[0x263F0DF40]);
    v7 = [v5 uuidStr];
...
- (void)setCategory:(id)a3
{
  ...
  if (v4)
  {
    ...
    {
      v5 = [MEMORY[0x263F0E340] cachedInstanceForHMAccessoryCategory:v4];
      category = self->_category;
      self->_category = v5;

      os_unfair_recursive_lock_unlock();
      v7 = encodeRootObjectForIncomingXPCMessage(v4, 0);
      v8 = (void *)MEMORY[0x263F42568];
...
- (id)dumpDescription
{
  ...
  [v3 setObject:v9 forKey:*MEMORY[0x263F41FA8]];
  return v3;
}
...
- (id)descriptionWithPointer:(BOOL)a3 additionalDescription:(id)a4
{
  ...
  {
    BOOL v18 = [v20 stringWithFormat:@"<%@%@, UUID = %@, knownToSystemCommissioner = %@, RPK(Hash) = %@, NodeID = %@, Identifier = %@, Name = %@, Category = %@%@>", v25, v23, v24, v7, v10, v11, v12, v13, v15, &stru_26E2EB898];
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t10_172627 != -1) {
    dispatch_once(&logCategory__hmf_once_t10_172627, &__block_literal_global_172628);
  }
  v2 = (void *)logCategory__hmf_once_v11_172629;
  return v2;
}
...
void __39__HMDUnassociatedAccessory_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v11_172629;
  logCategory__hmf_once_v11_172629 = v0;
}
...
+ (id)otherAccessoryCategory
{
  ...
  id v4 = objc_alloc(MEMORY[0x263F0DF40]);
  v5 = [v3 uuidStr];
  id v6 = [v3 catDescription];
  id v7 = (void *)[v4 initWithType:v5 name:v6];

  v8 = [MEMORY[0x263F0E340] cachedInstanceForHMAccessoryCategory:v7];
