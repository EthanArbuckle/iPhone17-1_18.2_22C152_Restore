...
- (void)updateNaturalLightingContext
{
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      int v35 = 138543362;
      v36 = v11;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Skipping updating natural lighting context, home is not set", (uint8_t *)&v35, 0xCu);
      goto LABEL_8;
    }
LABEL_9:
  ...
  if ((v6 & 1) == 0 && !v7)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v39 = 2112;
      v40 = v13;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Skipping updating natural lighting context, device is primary resident: %@ and demo mode is enabled: %@", (uint8_t *)&v35, 0x20u);
...
LABEL_8:
  ...
  if (v20)
  {
    if (v24)
    {
      ...
      __int16 v37 = 2112;
      v38 = v19;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Skipping updating natural lighting context, since it is already set: %@", (uint8_t *)&v35, 0x16u);
    }
  }
  else
  {
    if (v24)
    {
      ...
      __int16 v37 = 2112;
      v38 = v18;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Updating natural lighting context to %@", (uint8_t *)&v35, 0x16u);
    }
...
- (int64_t)colorTemperatureForTransitionPoint:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Minimum Brightness Transition Point: %@ is missing key: %@", (uint8_t *)&v14, 0x20u);
    }
    int64_t v8 = -1;
  }
...
LABEL_14:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        uint32_t v22 = 32;
LABEL_12:
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, v20, (uint8_t *)&v24, v22);
      }
    }
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v28 = 2112;
    v29 = @"TimeOfDay";
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@Minimum Brightness Transition Point: %@ is missing key: %@", (uint8_t *)&v24, 0x20u);
  }
  int64_t v11 = -1;
LABEL_15:
...
- (id)colorTemperatureTransitionPointsForMinimumBrightnessWithEncodeNaturalLightingCurve:(id)a3
{
  ...
  {
    int v14 = [v8 sortedArrayUsingComparator:&__block_literal_global_43_246670];
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v27 = v18;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Validating minimum brightness transition points dictionary", buf, 0xCu);
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v27 = v22;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to validate minimum brightness transitions points dictionary", buf, 0xCu);
      }
      v13 = 0;
      id v8 = v14;
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v30 = 2048;
      uint64_t v31 = 3;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Color Temperature Transition Points specified for minimum Brightness: %@ are less than %ld", buf, 0x20u);
    }
    v13 = 0;
  }
...
uint64_t __123__HMDHomeNaturalLightingContextUpdater_colorTemperatureTransitionPointsForMinimumBrightnessWithEncodeNaturalLightingCurve___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      id v18 = v3;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Missing %@ key in %@", (uint8_t *)&v13, 0x20u);
    }
    goto LABEL_8;
  }
...
uint64_t __123__HMDHomeNaturalLightingContextUpdater_colorTemperatureTransitionPointsForMinimumBrightnessWithEncodeNaturalLightingCurve___block_invoke_40(uint64_t a1, void *a2)
{
  ...
  if ((v5 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@Minimum Brightness, Object: %@ for key: %@ is not of type: NSDictionary", (uint8_t *)&v11, 0x20u);
    }
  }
...
- (id)colorTemperatureTransitionPointsForMaximumBrightnessWithEncodeNaturalLightingCurve:(id)a3
{
  ...
  if ((unint64_t)[v8 count] > 2)
  {
    id v14 = [v8 sortedArrayUsingComparator:&__block_literal_global_39_246678];
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v27 = v18;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Validating maximum brightness transition points dictionary", buf, 0xCu);
    }
    if ([(HMDHomeNaturalLightingContextUpdater *)v16 areEncodedBrightnessLevelTransitionPointsValid:v14])
    {
      id v8 = v14;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v27 = v22;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to validate maximum brightness transitions points dictionary", buf, 0xCu);
      }
      __int16 v13 = 0;
      id v8 = v14;
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v30 = 2048;
      uint64_t v31 = 3;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Color Temperature Transition Points specified for maximum Brightness: %@ are less than %ld", buf, 0x20u);
    }
    __int16 v13 = 0;
  }
...
uint64_t __123__HMDHomeNaturalLightingContextUpdater_colorTemperatureTransitionPointsForMaximumBrightnessWithEncodeNaturalLightingCurve___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v16 = 2112;
      id v17 = v3;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Missing %@ key in Natural Lighting Curve entry: %@", (uint8_t *)&v12, 0x20u);
    }
    goto LABEL_7;
  }
...
uint64_t __123__HMDHomeNaturalLightingContextUpdater_colorTemperatureTransitionPointsForMaximumBrightnessWithEncodeNaturalLightingCurve___block_invoke_35(uint64_t a1, void *a2)
{
  ...
  if ((v5 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v15 = 2112;
      __int16 v16 = @"ColorTemperatureTransitionPoints";
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@Maximum Brightness, Object: %@ for key: %@ is not of type: NSDictionary", (uint8_t *)&v11, 0x20u);
    }
  }
...
- (BOOL)areEncodedBrightnessLevelTransitionPointsValid:(id)a3
{
  ...
  if ([v7 isEqualToNumber:&unk_26E473828])
  {
    id v8 = [v4 lastObject];
    id v9 = objc_msgSend(v8, "hmf_numberForKey:", @"TimeOfDay");
    if ([v9 isEqualToNumber:&unk_26E473840])
    {
      ...
      if ((v12 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v30 = 2112;
          uint64_t v31 = v11;
          _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@First transition point color temperature:%@ doesn't match last transition point color temperature: %@", buf, 0x20u);
        }
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Last transition point time of day doesn't end at %llums", buf, 0x16u);
      }
      char v12 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v28 = 2048;
      uint64_t v29 = 0;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@First transition point doesn't begin at %llums", buf, 0x16u);
    }
    char v12 = 0;
  }
...
- (void)initalizeCurve
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v87 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Initializing transitions points for the curve", buf, 0xCu);
  }
  ...
  int v11 = objc_msgSend(v10, "na_filter:", &__block_literal_global_246693);
  ...
  if (!v11)
  {
    ...
    if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_ERROR, "%{public}@Missing natural lighting curve key in resource file content %@:%@", buf, 0x20u);
    }
    goto LABEL_52;
  }
  ...
  if (v12 != 2)
  {
    ...
    if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v90 = 2048;
      uint64_t v91 = 2;
      _os_log_impl(&dword_22F52A000, v48, OS_LOG_TYPE_ERROR, "%{public}@Natural Lighting Curve Brightness Level count: %lu is not equal to supported brightness level count: %lu", buf, 0x20u);
    }
LABEL_52:
    goto LABEL_75;
  }
...
LABEL_69:
                    _os_log_impl(&dword_22F52A000, v68, OS_LOG_TYPE_ERROR, v58, buf, 0x16u);
                  }
                  goto LABEL_70;
                }
              }
              v34 = objc_msgSend(MEMORY[0x263F358F8], "transitionPointWithMinimumBrightness:minimumBrightnessColorTemperature:maximumBrightness:maximumBrightnessColorTemperature:targetCompletionDuration:", -[HMDHomeNaturalLightingContextUpdater curveMinimumBrightness](v5, "curveMinimumBrightness"), v24, 100, v26, v80 - v78);
              [v16 addObject:v34];
        ...
        else
        {
          ...
          if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v87 = v62;
            _os_log_impl(&dword_22F52A000, v61, OS_LOG_TYPE_ERROR, "%{public}@No transition points found", buf, 0xCu);
          }
LABEL_71:
          id v14 = v72;
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v52, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v90 = 2048;
          uint64_t v91 = v55;
          _os_log_impl(&dword_22F52A000, v52, OS_LOG_TYPE_ERROR, "%{public}@Minimum Brightness Transition Points: %lu don't match maximum Brightness Transition Points: %lu", buf, 0x20u);
        }
      }
    }
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t36 != -1) {
    dispatch_once(&logCategory__hmf_once_t36, &__block_literal_global_52_246716);
  }
