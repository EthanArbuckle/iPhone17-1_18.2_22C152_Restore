...
+ (void)initialize
{
  ...
  uint64_t v4 = *MEMORY[0x263F0BE40];
  v5 = [(HMDAssistantColorCharacteristic *)v3 initWithReadCharacteristicType:*MEMORY[0x263F0C1C0] writeCharacteristicType:*MEMORY[0x263F0C1C0] format:*MEMORY[0x263F0BE40] mandatory:1];
  [v2 addObject:v5];
  v6 = [HMDAssistantColorCharacteristic alloc];
  v7 = [(HMDAssistantColorCharacteristic *)v6 initWithReadCharacteristicType:*MEMORY[0x263F0C398] writeCharacteristicType:*MEMORY[0x263F0C398] format:v4 mandatory:1];

  [v2 addObject:v7];
  v8 = [HMDAssistantColorCharacteristic alloc];
  v9 = [(HMDAssistantColorCharacteristic *)v8 initWithReadCharacteristicType:*MEMORY[0x263F0BF68] writeCharacteristicType:*MEMORY[0x263F0BF68] format:*MEMORY[0x263F0BE48] mandatory:1];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_19055 != -1) {
    dispatch_once(&logCategory__hmf_once_t2_19055, &__block_literal_global_19056);
  }
  v2 = (void *)logCategory__hmf_once_v3_19057;
  return v2;
}
...
void __34__HMDAssistantCommand_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_19057;
  logCategory__hmf_once_v3_19057 = v0;
}
...
- (void)performWithGather:(id)a3 queue:(id)a4 msgDispatcher:(id)a5 completion:(id)a6
{
  ...
  SEL v16 = a2;
  v17 = v12;
  v18 = MEMORY[0x230FBBCF0](self, v16);
  v19 = [v15 stringWithFormat:@"%@, %s:%ld", v18, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables/Sources/homed/Assistant/HMDAssistantCommand.m", 3730];
  ...
  if (!v23)
  {
    ...
    if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v63 = v48;
      _os_log_impl(&dword_22F52A000, v47, OS_LOG_TYPE_INFO, "%{public}@There are no homes, reporting the result right away", buf, 0xCu);
    }
    goto LABEL_10;
  }
  ...
  if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544642;
    ...
    __int16 v72 = 2112;
    v73 = v40;
    _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_INFO, "%{public}@Number of homes: %tu, Primary home: %@, Primary home ID: %@, Current home: %@, Current home ID: %@", buf, 0x3Eu);
  ...
  if (v42)
  {
    ...
    if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v63 = v50;
      _os_log_impl(&dword_22F52A000, v47, OS_LOG_TYPE_INFO, "%{public}@There are no homekit objects, calling completion", buf, 0xCu);
    }
LABEL_10:
...
void __72__HMDAssistantCommand_performWithGather_queue_msgDispatcher_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    uint64_t v5 = [MEMORY[0x263EFF910] timeIntervalSinceReferenceDate];
    double v7 = v6;
    double v8 = *(double *)(a1 + 48);
    v9 = (void *)MEMORY[0x230FBD990](v5);
    id v10 = WeakRetained;
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v23 = 2048;
      double v24 = v7 - v8;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Siri command took %.4f seconds", buf, 0x16u);
    }
    if ([v10 completionHandlerCalled])
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v22 = v16;
        _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Completion handler already called, not calling again", buf, 0xCu);
      }
    }
    else
    {
...
uint64_t __72__HMDAssistantCommand_performWithGather_queue_msgDispatcher_completion___block_invoke_155(uint64_t a1)
{
...
- (void)handleGetColor:(id)a3 forObjects:(id)a4 serviceType:(id)a5 completionHandler:(id)a6
{
  ...
  v15 = [v13 stringWithFormat:@"%@, %s:%ld", v14, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables/Sources/homed/Assistant/HMDAssistantCommand.m", 3630];
        ...
        if (v28)
        {
          ...
          do
          {
            for (uint64_t j = 0; j != v28; ++j)
            {
              ...
              v116 = v31;
              v32 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v116 count:1];
  ...
  if ([v69 count])
  {
    ...
    *((void *)&buf + 1) = &buf;
    ...
    v113 = __Block_byref_object_copy__19249;
    v114 = __Block_byref_object_dispose__19250;
    id v115 = [MEMORY[0x263EFF980] array];
    id v35 = [MEMORY[0x263F08968] weakToStrongObjectsMapTable];
    long long v91 = 0u;
    long long v92 = 0u;
    long long v89 = 0u;
    long long v90 = 0u;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
    {
      ...
      *(void *)((char *)&buf + 4) = v54;
      _os_log_impl(&dword_22F52A000, v53, OS_LOG_TYPE_INFO, "%{public}@No characteristics found after filtering objects", (uint8_t *)&buf, 0xCu);
    }
...
void __79__HMDAssistantCommand_handleGetColor_forObjects_serviceType_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v6;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Received error %@ for read request with response tuples: %@", (uint8_t *)&v17, 0x20u);
    }
...
uint64_t __79__HMDAssistantCommand_handleGetColor_forObjects_serviceType_completionHandler___block_invoke_149(uint64_t a1)
{
  ...
  id v2 = (void *)MEMORY[0x230FBD990]([*(id *)(a1 + 32) begin]);
  id v3 = *(id *)(a1 + 40);
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    double v8 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@All results have been received for set-action-types, calling result handler", (uint8_t *)&v7, 0xCu);
  }
...
- (void)handleSetColor:(id)a3 forObjects:(id)a4 service:(id)a5 completionHandler:(id)a6
{
  ...
  uint64_t v14 = [v12 stringWithFormat:@"%@, %s:%ld", v13, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables/Sources/homed/Assistant/HMDAssistantCommand.m", 3508];
  ...
  if ([v62 count])
  {
    ...
    id v65 = [MEMORY[0x263F08968] weakToStrongObjectsMapTable];
    uint64_t v99 = 0;
    long long v100 = &v99;
    uint64_t v101 = 0x3032000000;
    long long v102 = __Block_byref_object_copy__19249;
    long long v103 = __Block_byref_object_dispose__19250;
    id v104 = [MEMORY[0x263EFF980] array];
    ...
    if (v52)
    {
      ...
      uint64_t v57 = *MEMORY[0x263F0BE40];
      uint64_t v56 = *MEMORY[0x263F65288];
      do
      {
    ...
    uint64_t v29 = [MEMORY[0x263F08968] weakToStrongObjectsMapTable];
    long long v89 = 0u;
    long long v90 = 0u;
    long long v87 = 0u;
    long long v88 = 0u;
  ...
  {
    [(HMDAssistantCommand *)self reportOutcome:*MEMORY[0x263F65540] results:0 handler:v55];
  }
}
...
void __75__HMDAssistantCommand_handleSetColor_forObjects_service_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v5;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Received response %@ for write request with %@", (uint8_t *)&v17, 0x20u);
    }
    id v12 = [v9 handleReadWriteResponses:v6 error:v5 forAction:*(void *)(a1 + 40) inServiceType:*(void *)(a1 + 48) results:*(void *)(*(void *)(*(void *)(a1 + 80) + 8) + 40) forObjects:*(void *)(a1 + 56)];
    uint64_t v13 = [v5 code];
    uint64_t v14 = 82;
...
- (id)readRequestsForCharacteristic:(id)a3
{
  ...
  int v7 = [MEMORY[0x263EFF980] arrayWithObject:v6];
...
- (void)addLinkedServiceCharacteristicsFor:(id)a3 toCollection:(id)a4 assistantObjects:(id)a5
{
  ...
  uint64_t v10 = [v9 mapReadCharacteristicFromAssistantName:*MEMORY[0x263F65458]];
  uint64_t v11 = [v9 mapFromAssistantServiceName:*MEMORY[0x263F65760]];
  uint64_t v12 = [v9 mapFromAssistantServiceName:*MEMORY[0x263F657F0]];
...
- (void)addBridgedAccessoryCharacteristicsFor:(id)a3 toCollection:(id)a4 assistantObjects:(id)a5
{
  ...
  uint64_t v11 = [v10 mapReadCharacteristicFromAssistantName:*MEMORY[0x263F65458]];
  uint64_t v12 = [v10 mapFromAssistantServiceName:*MEMORY[0x263F657F0]];
  uint64_t v13 = [v10 mapFromAssistantServiceName:*MEMORY[0x263F65760]];
  uint64_t v14 = [v8 type];
  if ([v14 isEqual:v11])
  {
    int v15 = [v9 type];
...
- (void)addActivationCharacteristicsIfNeeded:(id)a3 forCharacteristic:(id)a4
{
  ...
  if ((isActivationCharacteristicType(v7) & 1) == 0)
  {
    id v8 = [v6 service];
    id v9 = [v8 type];
    if ([v9 isEqual:*MEMORY[0x263F0D780]])
    {
      id v10 = v7;
      if (([v10 isEqual:*MEMORY[0x263F0BF68]] & 1) == 0
        && ([v10 isEqual:*MEMORY[0x263F0C1C0]] & 1) == 0
        && ([v10 isEqual:*MEMORY[0x263F0C398]] & 1) == 0)
      {
        uint64_t v11 = (void *)MEMORY[0x263F0BFF8];
LABEL_23:
        ...
        uint64_t v12 = (void *)MEMORY[0x263F0C328];
LABEL_17:
...
LABEL_18:
    ...
    {
      if (![v9 isEqual:*MEMORY[0x263F0D6C8]])
      {
        if (([v9 isEqual:*MEMORY[0x263F0D890]] & 1) == 0
          && ([v9 isEqual:*MEMORY[0x263F0D618]] & 1) == 0
          && ![v9 isEqual:*MEMORY[0x263F0D708]])
        {
          goto LABEL_18;
        }
        id v13 = v7;
        if (([v13 isEqual:*MEMORY[0x263F0C370]] & 1) == 0
          && ([v13 isEqual:*MEMORY[0x263F0C378]] & 1) == 0)
        {
          char v15 = [v13 isEqual:*MEMORY[0x263F0C488]];

          if ((v15 & 1) == 0) {
            goto LABEL_18;
          }
          uint64_t v12 = (void *)MEMORY[0x263F0BEF8];
          goto LABEL_17;
        }
        uint64_t v12 = (void *)MEMORY[0x263F0BEF8];
        goto LABEL_16;
      ...
      id v10 = v7;
      if (([v10 isEqual:*MEMORY[0x263F0C370]] & 1) == 0)
      {
        uint64_t v11 = (void *)MEMORY[0x263F0C378];
        goto LABEL_23;
      }
    }
    uint64_t v12 = (void *)MEMORY[0x263F0C328];
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v12; ++i)
      {
        ...
        if (v17)
        {
          ...
          if (!v18) {
            [v8 setObject:MEMORY[0x263EFFA88] forKey:v15];
          }
          goto LABEL_12;
        }
      }
...
- (void)handleMediaReadWriteResponse:(id)a3 forAction:(id)a4 inServiceType:(id)a5 inHome:(id)a6 requestProperty:(id)a7 results:(id)a8 forObjects:(id)a9
{
  ...
  if (v43)
  {
    ...
    uint64_t v45 = *MEMORY[0x263F652C8];
    id v46 = v17;
    id v42 = v14;
    do
    {
            ...
            for (uint64_t i = 0; i != v54; ++i)
            {
              ...
              if (v26)
              {
                ...
                if (v28)
                {
                  ...
                  if (isKindOfClass)
                  {
                    id v31 = [MEMORY[0x263F08928] unarchivedObjectOfClass:objc_opt_class() fromData:v28 error:0];
                ...
                uint64_t v38 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v23];
...
- (id)handleReadWriteResponses:(id)a3 error:(id)a4 forAction:(id)a5 inServiceType:(id)a6 results:(id)a7 forObjects:(id)a8
{
  ...
  {
    id v62 = v15;
    long long v83 = [MEMORY[0x263F08968] strongToStrongObjectsMapTable];
    long long v98 = 0u;
    long long v99 = 0u;
    long long v100 = 0u;
    long long v101 = 0u;
    ...
    if (v74)
    {
      ...
      uint64_t v82 = *MEMORY[0x263F652C8];
      uint64_t v72 = *MEMORY[0x263F653C0];
      do
      {
        uint64_t v30 = 0;
        do
                ...
                if (v40)
                {
                  ...
                  if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)long long buf = 138544642;
                    ...
                    __int16 v113 = 2112;
                    v114 = v48;
                    _os_log_impl(&dword_22F52A000, v43, OS_LOG_TYPE_INFO, "%{public}@Error %tu for %@/%@/%@/%@", buf, 0x3Eu);
...
- (BOOL)populateColorResult:(id)a3 serviceType:(id)a4 service:(id)a5 action:(id)a6 responses:(id)a7 forObjects:(id)a8
{
  ...
  if (v56)
  {
    ...
    uint64_t v63 = *MEMORY[0x263F652F0];
    id v61 = v14;
    while (2)
    {
      uint64_t v17 = 0;
...
LABEL_41:
  ...
  if ([v15 length])
  {
    id v38 = objc_alloc_init(MEMORY[0x263F64968]);
    [v38 setValue:v15];
    ...
    if (v39)
    {
      ...
      if (v41)
      {
        ...
        int v44 = [v43 isEqualToString:*MEMORY[0x263F652F0]];
    ...
    if ((v7 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v61, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)long long buf = 138543618;
        ...
        __int16 v100 = 2112;
        long long v101 = v66;
        _os_log_impl(&dword_22F52A000, v61, OS_LOG_TYPE_DEFAULT, "%{public}@Action type for COLOR attribute is not GET/SET - %@", buf, 0x16u);
  ...
  if ((isKindOfClass & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v61, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)long long buf = 138543874;
      ...
      id v65 = v103;
      _os_log_impl(&dword_22F52A000, v61, OS_LOG_TYPE_DEFAULT, "%{public}@Value %@ for COLOR attribute is not string but %@", buf, 0x20u);
...
LABEL_68:
  ...
  uint64_t v15 = v14;
  id v16 = (id *)&unk_2686FE000;
  long long v88 = (void *)*MEMORY[0x263F0BE40];
  uint64_t v82 = (void *)*MEMORY[0x263F0BE48];
  uint64_t v83 = *(void *)v95;
  long long v79 = (void *)*MEMORY[0x263F0BE38];
  long long v87 = self;
  id v77 = v4;
  long long v75 = v13;
LABEL_7:
...
LABEL_8:
  ...
  if ([v19 count] == 2)
  {
    ...
    if (([v86 containsObject:v20] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)long long buf = 138543874;
        ...
        __int16 v102 = 2112;
        id v103 = v86;
        _os_log_impl(&dword_22F52A000, v51, OS_LOG_TYPE_INFO, "%{public}@Unsupported color space: %@; only support %@. Ignoring...",
          buf,
          0x20u);
      }
      id v16 = (id *)&unk_2686FE000;
    ...
    id v21 = [v16[433] objectForKey:v20];
    ...
    if (v23 != [v21 count])
    {
      ...
      if (os_log_type_enabled(v55, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)long long buf = 138544130;
        ...
        __int16 v104 = 2048;
        uint64_t v105 = v58;
        _os_log_impl(&dword_22F52A000, v55, OS_LOG_TYPE_INFO, "%{public}@Color space %@ requires %tu values - %tu provided. Ignoring...", buf, 0x2Au);
    ...
    while (1)
    {
      id v26 = (void *)MEMORY[0x263F08B08];
            ...
            if (v41)
            {
              if (v45)
              {
                ...
                *(_DWORD *)long long buf = 138544130;
                ...
                _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_INFO, "%{public}@Color space %@:  %@=%@", buf, 0x2Au);
            ...
            else
            {
              if (v45)
              {
                ...
                *(_DWORD *)long long buf = 138543874;
                ...
                __int16 v102 = 2112;
                id v103 = v32;
                _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_INFO, "%{public}@Color space %@ characteristicType %@ value is nil", buf, 0x20u);
              }
              char v47 = 0;
              int v24 = 1;
              self = v87;
...
LABEL_46:
            uint32_t v40 = 42;
LABEL_47:
            _os_log_impl(&dword_22F52A000, v38, OS_LOG_TYPE_INFO, v39, buf, v40);
...
LABEL_74:
  ...
  if (os_log_type_enabled(v70, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)long long buf = 138543618;
    ...
    __int16 v100 = 2112;
    long long v101 = v19;
    _os_log_impl(&dword_22F52A000, v70, OS_LOG_TYPE_ERROR, "%{public}@Color space encoding does not have two components: %@", buf, 0x16u);
  }
...
- (void)handleCommandWithCompletionHandler:(id)a3
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)long long buf = 138544130;
    ...
    __int16 v152 = 2112;
    v153 = v14;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Executing Siri command(%{public}@) serverValidity %{public}@:\n%@", buf, 0x2Au);
  }
  ...
  if (v15)
  {
    ...
    if (v19)
    {
      ...
      uint64_t v22 = [v21 isEqualToString:*MEMORY[0x263F656E8]];

      uint64_t v23 = [v6 attribute];
      int v24 = [v23 isEqualToString:*MEMORY[0x263F653F8]];

      if (v24)
      {
        uint64_t v25 = [v6 actionType];
        int v26 = [v25 isEqualToString:*MEMORY[0x263F65320]];

        [v19 entityType];
        uint64_t v28 = v27 = v19;
        int v29 = [v28 isEqualToString:*MEMORY[0x263F655E0]];
        ...
        if (!v26 || !v29 || !v35)
        {
          uint64_t v76 = (void *)MEMORY[0x230FBD990]();
          id v77 = v9;
          ...
          if (os_log_type_enabled(v78, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)long long buf = 138544130;
            ...
            __int16 v152 = 2112;
            v153 = v83;
            _os_log_impl(&dword_22F52A000, v78, OS_LOG_TYPE_INFO, "%{public}@entityType is SCENE with ENABLED action attribute but either action(%@) is not SET action/empty sceneName(%@)/Type(%@)", buf, 0x2Au);
          ...
          [(HMDAssistantCommand *)v77 reportOutcome:*MEMORY[0x263F65540] results:0 handler:v4];
          id v16 = v20;
          goto LABEL_85;
        }
      }
      ...
      else
      {
        ...
        char v104 = [v103 isEqualToString:*MEMORY[0x263F652F0]];
        ...
        if ((v104 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v109, OS_LOG_TYPE_FAULT))
          {
            ...
            *(_DWORD *)long long buf = 138543362;
            v147 = v110;
            _os_log_impl(&dword_22F52A000, v109, OS_LOG_TYPE_FAULT, "%{public}@Search filter must specify homeName or homeIdentifier for actions not of type GET", buf, 0xCu);
          }
          id v19 = v106;
          id v4 = v105;
        }
...
LABEL_70:
            ...
            if (!v111)
            {
              uint64_t v112 = (void *)MEMORY[0x230FBD990]();
              __int16 v113 = v9;
              ...
              if (os_log_type_enabled(v114, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)long long buf = 138543618;
                ...
                __int16 v148 = 2112;
                id v149 = v125;
                _os_log_impl(&dword_22F52A000, v114, OS_LOG_TYPE_ERROR, "%{public}@Cannot evaluate home for Siri command with filtered result: %@", buf, 0x16u);
          ...
          if (v22)
          {
            if (v119)
            {
              ...
              *(_DWORD *)long long buf = 138543362;
              v147 = v120;
              _os_log_impl(&dword_22F52A000, v118, OS_LOG_TYPE_INFO, "%{public}@Start handling command for Apple Media Accessory", buf, 0xCu);
            }
          ...
          else
          {
            if (v119)
            {
              ...
              *(_DWORD *)long long buf = 138543362;
              v147 = v122;
              _os_log_impl(&dword_22F52A000, v118, OS_LOG_TYPE_INFO, "%{public}@Start handling command for HAP Characteristic", buf, 0xCu);
            }
            id v6 = v133;
            id v4 = v41;
        ...
        else
        {
          ...
          if (os_log_type_enabled(v87, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)long long buf = 138543362;
            v147 = v89;
            _os_log_impl(&dword_22F52A000, v87, OS_LOG_TYPE_INFO, "%{public}@No matches found after filtering, bailing out", buf, 0xCu);
      ...
      if (os_log_type_enabled(v74, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)long long buf = 138543362;
        v147 = v75;
        _os_log_impl(&dword_22F52A000, v74, OS_LOG_TYPE_INFO, "%{public}@Could not figure out the home to apply the command to", buf, 0xCu);
      }
    }
    else
    {
        ...
        if (!v59)
        {
          if (![v58 count])
          {
            ...
            if (os_log_type_enabled(v92, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)long long buf = 138543362;
              v147 = v95;
              _os_log_impl(&dword_22F52A000, v92, OS_LOG_TYPE_INFO, "%{public}@Identifier list filter results in no matches - re-generating sync data and requesting re-sync", buf, 0xCu);
          ...
          if (v96)
          {
            ...
            uint64_t v100 = *MEMORY[0x263F656E8];
LABEL_58:
            uint64_t v101 = 0;
            while (1)
            {
        ...
        long long v60 = (void *)MEMORY[0x230FBD990]();
        id v61 = v9;
        ...
        if (os_log_type_enabled(v62, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)long long buf = 138543618;
          ...
          __int16 v148 = 2114;
          id v149 = v59;
          _os_log_impl(&dword_22F52A000, v62, OS_LOG_TYPE_INFO, "%{public}@Identifier list filter resolution failed with error %{public}@", buf, 0x16u);

          id v6 = v64;
          id v4 = v63;
        }

        [(HMDAssistantCommand *)v61 reportOutcome:*MEMORY[0x263F65540] results:0 handler:v4];
...
LABEL_85:
      ...
      if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)long long buf = 138543618;
        ...
        id v149 = v72;
        id v73 = v72;
        _os_log_impl(&dword_22F52A000, v68, OS_LOG_TYPE_INFO, "%{public}@Unsupported filter type - %@", buf, 0x16u);

        id v19 = 0;
        id v4 = v69;
      }
    }
    [(HMDAssistantCommand *)v67 reportOutcome:*MEMORY[0x263F65540] results:0 handler:v4];
    goto LABEL_85;
  }
  id v51 = (void *)MEMORY[0x230FBD990]();
  id v52 = v9;
  ...
  if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)long long buf = 138543362;
    v147 = v54;
    _os_log_impl(&dword_22F52A000, v53, OS_LOG_TYPE_INFO, "%{public}@There is no actionType, reporting malformed command", buf, 0xCu);
  }
  [(HMDAssistantCommand *)v52 reportOutcome:*MEMORY[0x263F65540] results:0 handler:v4];
LABEL_86:
}
...
- (void)_handleCommandForHAPAction:(id)a3 serviceType:(id)a4 objects:(id)a5 completionHandler:(id)a6
{
  ...
  if ([v14 isEqualToString:*MEMORY[0x263F652F0]])
  {
...
LABEL_4:
  ...
  int v16 = [v15 isEqualToString:*MEMORY[0x263F65310]];

  if (v16) {
    goto LABEL_4;
  }
  uint64_t v17 = [v10 actionType];
  if ([v17 isEqualToString:*MEMORY[0x263F65300]]) {
    goto LABEL_8;
  }
  id v18 = [v10 actionType];
  if ([v18 isEqualToString:*MEMORY[0x263F652F8]])
  {
...
LABEL_9:
  ...
  char v20 = [v19 isEqualToString:*MEMORY[0x263F65308]];

  if (v20) {
    goto LABEL_9;
  }
  id v21 = [v10 actionType];
  if ([v21 isEqualToString:*MEMORY[0x263F65320]]) {
    goto LABEL_15;
  }
  uint64_t v22 = [v10 actionType];
  if ([v22 isEqualToString:*MEMORY[0x263F65330]])
  {
...
LABEL_16:
  ...
  char v24 = [v23 isEqualToString:*MEMORY[0x263F65328]];

  if (v24) {
    goto LABEL_16;
  }
  uint64_t v25 = [v10 actionType];
  if ([v25 isEqualToString:*MEMORY[0x263F65318]]) {
    goto LABEL_21;
  }
  int v26 = [v10 actionType];
  if ([v26 isEqualToString:*MEMORY[0x263F652E8]])
  {
...
LABEL_22:
  ...
  char v28 = [v27 isEqualToString:*MEMORY[0x263F65338]];
  ...
  if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v38 = 2112;
    id v39 = v33;
    _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@%s ### Siri sent an unsupported action type: %@", (uint8_t *)&v34, 0x20u);
  }
  [(HMDAssistantCommand *)v30 reportOutcome:*MEMORY[0x263F65540] results:0 handler:v13];
LABEL_10:
}
...
- (void)_handleCommandForMediaAccessoryAction:(id)a3 objects:(id)a4 serviceType:(id)a5 completionHandler:(id)a6
{
  ...
  id v13 = a6;
  uint64_t v14 = [v10 actionType];
  int v15 = [v14 isEqualToString:*MEMORY[0x263F652F0]];
  ...
  id v19 = [v10 actionType];
  int v20 = [v19 isEqualToString:*MEMORY[0x263F65320]];
...
LABEL_7:
      ...
      __int16 v27 = 2112;
      char v28 = v22;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@%s ### Siri sent an unsupported action type: %@", (uint8_t *)&v23, 0x20u);
    }
LABEL_8:

    [(HMDAssistantCommand *)v17 reportOutcome:*MEMORY[0x263F65540] results:0 handler:v13];
    goto LABEL_9;
  }
...
- (void)handleUpdateActionTypes:(id)a3 serviceType:(id)a4 forObjects:(id)a5 completionHandler:(id)a6
{
  ...
  id v13 = NSString;
  val = self;
  uint64_t v14 = MEMORY[0x230FBBCF0](self, a2);
  int v15 = [v13 stringWithFormat:@"%@, %s:%ld", v14, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables/Sources/homed/Assistant/HMDAssistantCommand.m", 2519];
    ...
    if ([v98 count])
    {
      ...
      if (!v85)
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_WORD *)&buf[12] = 2112;
          *(void *)&buf[14] = v29;
          _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot map actionAttribute(%@) to a characteristicType", buf, 0x16u);
        }
        [(HMDAssistantCommand *)v26 reportOutcome:*MEMORY[0x263F65540] results:0 handler:v88];
        goto LABEL_82;
      }
      ...
      {
        v152[0] = v85;
        uint64_t v83 = [MEMORY[0x263EFF8C0] arrayWithObjects:v152 count:1];
        [(HMDAssistantCommand *)self filterObjects:v98 forCharacteristicTypes:v83];
      int v84 = };
      if (![v84 count])
      {
...
LABEL_82:
      ...
      if ([v31 isEqualToString:*MEMORY[0x263F65338]])
      {
        char v32 = [v82 isEqualToString:*MEMORY[0x263F0BE38]];
        ...
        if ((v32 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
          {
            ...
            *(void *)((char *)&v151 + 2) = v82;
            _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_ERROR, "%{public}@%s ### Siri passed an incorrect action (%@) to a %@ value type.", buf, 0x2Au);
          }
LABEL_79:

          [(HMDAssistantCommand *)v34 reportOutcome:*MEMORY[0x263F65540] results:0 handler:v88];
LABEL_80:
      ...
      uint64_t v39 = *MEMORY[0x263F652E8];
      if ([v38 isEqualToString:*MEMORY[0x263F652E8]])
      {
        if (([v82 isEqualToString:*MEMORY[0x263F0BE48]] & 1) == 0)
        {
          char v40 = [v82 isEqualToString:*MEMORY[0x263F0BE40]];
...
LABEL_30:
          ...
          *(void *)&buf[16] = 0x3032000000;
          __int16 v150 = __Block_byref_object_copy__19249;
          *(void *)&long long v151 = __Block_byref_object_dispose__19250;
          *((void *)&v151 + 1) = [MEMORY[0x263EFF980] array];
          ...
          if (v104)
          {
            ...
            id v95 = [MEMORY[0x263F08968] weakToStrongObjectsMapTable];
            ...
            {
              to = *(id **)v139;
              uint64_t v89 = *MEMORY[0x263F65288];
              do
              {
                uint64_t v101 = v44;
...
LABEL_38:
            ...
            if (obja)
            {
              ...
              do
              {
                for (uint64_t j = 0; j != obja; uint64_t j = (char *)j + 1)
                {
                  ...
                  if (v91)
                  {
                    id v63 = (void *)[objc_alloc(MEMORY[0x263EFF980]) initWithArray:v62];
                    long long v128 = 0u;
                    long long v129 = 0u;
                    long long v126 = 0u;
                    long long v127 = 0u;
          ...
          else
          {
            ...
            if (os_log_type_enabled(v76, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(void *)&location[4] = v77;
              __int16 v147 = 2112;
              __int16 v148 = v78;
              _os_log_impl(&dword_22F52A000, v76, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot map actionAttribute(%@) to a characteristicType", location, 0x16u);
            }
            [(HMDAssistantCommand *)v75 reportOutcome:*MEMORY[0x263F65540] results:0 handler:v88];
          }
      ...
      else
      {
        ...
        if (([v41 isEqualToString:*MEMORY[0x263F65318]] & 1) != 0
          && ([v82 isEqualToString:*MEMORY[0x263F0BE48]] & 1) == 0)
        {
          char v79 = [v82 isEqualToString:*MEMORY[0x263F0BE40]];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      *(void *)&uint8_t buf[4] = v24;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@In Update action types, There is no attribute in action - reporting as malformed command", buf, 0xCu);
    }
    [(HMDAssistantCommand *)v22 reportOutcome:*MEMORY[0x263F65540] results:0 handler:v88];
  }
LABEL_83:
}
...
void __88__HMDAssistantCommand_handleUpdateActionTypes_serviceType_forObjects_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  uint64_t v103 = a1;
  id v6 = (void *)MEMORY[0x230FBD990]([*(id *)(a1 + 32) begin]);
  id v91 = WeakRetained;
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)long long buf = 138543874;
    ...
    __int16 v135 = 2112;
    id v136 = v93;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Received response %@ for read request with error %@", buf, 0x20u);
  }
  long long v94 = [MEMORY[0x263F08968] weakToStrongObjectsMapTable];
  ...
  uint64_t v89 = *MEMORY[0x263F652C8];
  uint64_t v88 = *MEMORY[0x263F654C0];
  do
  {
    uint64_t v13 = 0;
    do
          ...
          if (v23)
          {
            ...
            if (v27)
            {
              ...
              if (v28)
              {
                ...
                uint64_t v31 = (objc_class *)MEMORY[0x263F64918];
                id v32 = *(id *)(v103 + 56);
                id v33 = v29;
                id v21 = v21;
                ...
                id v36 = objc_alloc_init(MEMORY[0x263F64920]);
                objc_msgSend(v36, "setValue:", objc_msgSend(&unk_26E470A98, "BOOLValue"));
...
LABEL_69:
  ...
  else
  {
    if ([v94 count])
    {
      long long v74 = [MEMORY[0x263EFF980] array];
      long long v115 = 0u;
      long long v113 = 0u;
      long long v114 = 0u;
      long long v112 = 0u;
...
uint64_t __88__HMDAssistantCommand_handleUpdateActionTypes_serviceType_forObjects_completionHandler___block_invoke_132(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    id v8 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@All results have been received for update-action-types, calling result handler", (uint8_t *)&v7, 0xCu);
  }
  [*(id *)(a1 + 40) reportResults:*(void *)(*(void *)(*(void *)(a1 + 56) + 8) + 40) handler:*(void *)(a1 + 48)];
  return [*(id *)(a1 + 32) end];
}
...
- (id)updateValue:(id)a3 forAction:(id)a4
{
  ...
  if ([v9 isEqualToString:*MEMORY[0x263F65338]])
  {
  ...
  uint64_t v55 = v9;
  uint64_t v51 = v10;
  if ([v12 isEqualToString:*MEMORY[0x263F0BE48]]) {
...
LABEL_13:
  ...
  id v50 = v33;
  if ([v30 isEqualToString:*MEMORY[0x263F65318]])
  {
    *(float *)&double v40 = v23 + v25;
  }
  else
  {
    int v41 = [v30 isEqualToString:*MEMORY[0x263F652E8]];
    double v40 = 0.0;
    if (v41) {
  ...
  if (v11)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      if (v17)
      {
        ...
        {
          int v19 = [v10 isEqualToString:*MEMORY[0x263F0BE48]];
...
- (void)handleSetActionTypes:(id)a3 serviceType:(id)a4 forObjects:(id)a5 completionHandler:(id)a6
{
  ...
  id v12 = NSString;
  val = self;
  int v13 = MEMORY[0x230FBBCF0](self, a2);
  uint64_t v14 = [v12 stringWithFormat:@"%@, %s:%ld", v13, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables/Sources/homed/Assistant/HMDAssistantCommand.m", 2199];
  ...
  if (!v15)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(void *)&uint8_t buf[4] = v22;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@In Set action types, There is no attribute in action - reporting as malformed command", buf, 0xCu);
    }
    goto LABEL_6;
  }
  uint64_t v16 = [v122 actionType];
  uint64_t v113 = *MEMORY[0x263F65320];
    ...
    if (!v17)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(void *)&uint8_t buf[4] = v21;
        _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@No value field for SET actionType", buf, 0xCu);
      }
LABEL_6:

      [(HMDAssistantCommand *)v19 reportOutcome:*MEMORY[0x263F65540] results:0 handler:v118];
      goto LABEL_86;
    }
  }
  else
  ...
  id v106 = [MEMORY[0x263F08A98] predicateWithFormat:@"%K =[d] %@", @"objectType", *MEMORY[0x263F655E0]];
  id v107 = [v120 filteredArrayUsingPredicate:v106];
  if ([v107 count])
  {
    float v23 = (void *)MEMORY[0x230FBD990]();
    int v24 = self;
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(void *)&uint8_t buf[4] = v26;
      _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@Entity specified is an action set, executing it", buf, 0xCu);
    }
  ...
  int v30 = [v29 isEqualToString:*MEMORY[0x263F653C0]];
  ...
  int v32 = [v31 isEqualToString:*MEMORY[0x263F65340]];
  ...
  if (!v101)
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_WORD *)&buf[12] = 2112;
      *(void *)&buf[14] = v39;
      _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot map actionAttribute(%@) to a characteristicType", buf, 0x16u);
    }
    [(HMDAssistantCommand *)v36 reportOutcome:*MEMORY[0x263F65540] results:0 handler:v118];
    goto LABEL_84;
  }
  ...
  {
    v160[0] = v101;
    long long v98 = [MEMORY[0x263EFF8C0] arrayWithObjects:v160 count:1];
    [(HMDAssistantCommand *)self filterObjects:v120 forCharacteristicTypes:v98];
  id v100 = };
  if (![v100 count])
  {
  ...
  id v43 = [MEMORY[0x263F08968] weakToStrongObjectsMapTable];
  *(void *)long long buf = 0;
  *(void *)&buf[8] = buf;
  *(void *)&buf[16] = 0x3032000000;
  v157 = __Block_byref_object_copy__19249;
  v158 = __Block_byref_object_dispose__19250;
  id v159 = [MEMORY[0x263EFF980] array];
  ...
  uint64_t v109 = *MEMORY[0x263F65328];
  uint64_t v105 = *MEMORY[0x263F65330];
  uint64_t v108 = *MEMORY[0x263F0C4D0];
  uint64_t v104 = *MEMORY[0x263F652C0];
  uint64_t v103 = *MEMORY[0x263F65270];
  uint64_t v111 = *MEMORY[0x263F65288];
  do
  {
    uint64_t v46 = 0;
    do
...
LABEL_54:
  ...
  long long v114 = [MEMORY[0x263F08968] weakToStrongObjectsMapTable];
  long long v144 = 0u;
  long long v145 = 0u;
  long long v142 = 0u;
  long long v143 = 0u;
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v67; ++i)
      {
        ...
        if (v72)
        {
          ...
          if (!v78)
          {
            id v91 = (void *)MEMORY[0x230FBD990]();
            id v92 = val;
            HMFGetOSLogHandle();
            ...
            if (os_log_type_enabled(v93, OS_LOG_TYPE_ERROR))
            {
              ...
              *(void *)&location[4] = v94;
              ...
              v153 = v95;
              id v96 = v95;
              _os_log_impl(&dword_22F52A000, v93, OS_LOG_TYPE_ERROR, "%{public}@Unknown value type found. Expected integer but got %@", location, 0x16u);
            }
            [(HMDAssistantCommand *)v92 reportOutcome:*MEMORY[0x263F65540] results:0 handler:v118];
...
- (id)handleSetNaturalLightingActionOnHAPLightProfiles:(id)a3 home:(id)a4 value:(BOOL)a5
{
  ...
  id v9 = a4;
  id v17 = 0;
  id v10 = [MEMORY[0x263F42538] futureWithPromise:&v17];
  ...
  {
    objc_initWeak(&location, self);
    id v11 = [v9 naturalLightingCurveWriter];
    ...
    id v14 = v17;
    [v11 setNaturalLightingEnabled:v5 forLightProfiles:v8 completion:v13];
...
void __83__HMDAssistantCommand_handleSetNaturalLightingActionOnHAPLightProfiles_home_value___block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    BOOL v5 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
  ...
  if (v23)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)long long buf = 138544130;
      ...
      __int16 v94 = 2112;
      id v95 = v65;
      _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Setting natural lighting %@ for HAP light profiles: %@ and matter light profiles: %@", buf, 0x2Au);

      id v20 = v30;
    }
    id v59 = v20;

    int v32 = objc_msgSend(MEMORY[0x263EFF9C0], "setWithCapacity:", objc_msgSend(v65, "count") + objc_msgSend(v20, "count"));
    id v33 = objc_alloc(MEMORY[0x263F42520]);
    id v34 = [(HMDAssistantCommand *)v25 queue];
    uint64_t v35 = [v33 initWithQueue:v34];

    id v36 = -[HMDAssistantCommand handleSetNaturalLightingActionOnHAPLightProfiles:home:value:](v25, "handleSetNaturalLightingActionOnHAPLightProfiles:home:value:", v20, v64, [v28 value]);
    ...
    v79[3] = &unk_264A2C4C8;
    v79[4] = v25;
    id v41 = (id)[v36 inContext:v35 then:v80 orRecover:v79];
    uint64_t v42 = objc_msgSend(v64, "handleSetNaturalLightingEnabled:forMatterLightProfiles:", objc_msgSend(v28, "value"), v65);
    v73[0] = MEMORY[0x263EF8330];
    v73[1] = 3221225472;
    ...
    id v45 = (id)[v42 inContext:v35 then:v73 orRecover:v72];
    uint64_t v46 = (void *)MEMORY[0x263F42538];
    v87[0] = v36;
    v87[1] = v42;
    char v47 = [MEMORY[0x263EFF8C0] arrayWithObjects:v87 count:2];
    char v48 = v46;
    id v20 = v59;
    id v49 = [v48 allSettled:v47];
    ...
    id v52 = v64;
    id v53 = v70;
    id v54 = (id)[v49 inContext:v44 then:v69 orRecover:v66];
  ...
  else
  {
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543618;
      ...
      __int16 v90 = 2112;
      id v91 = v57;
      _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_ERROR, "%{public}@Specified value is not of BOOLean type %@", buf, 0x16u);

      id v20 = v56;
    }

    id v50 = v63;
    [(HMDAssistantCommand *)v25 reportOutcome:*MEMORY[0x263F65540] results:MEMORY[0x263EFFA68] handler:v63];
    id v52 = v64;
    uint64_t v51 = v65;
  }
}
...
uint64_t __137__HMDAssistantCommand_handleSetNaturalLightingAction_serviceType_forObjects_hapLightProfiles_matterLightProfiles_home_completionHandler___block_invoke(id *a1, void *a2)
{
  ...
  if (v24)
  {
    ...
    uint64_t v21 = *MEMORY[0x263F65258];
    uint64_t v20 = *MEMORY[0x263F652C8];
    *(void *)&long long v3 = 138543874;
    ...
    do
    {
      for (uint64_t i = 0; i != v24; ++i)
      {
        ...
        BOOL v5 = *(void **)(*((void *)&v25 + 1) + 8 * i);
        id v6 = objc_msgSend(v5, "service", v18);
        int v7 = [v23 objectForKey:v5];
        id v8 = actionResultForAction(a1[5]);
        id v9 = entityForService(v6, a1[6], a1[7], [a1[5] includeCompleteInformation]);
        [v8 setEntity:v9];
        ...
        if (v7)
        {
          ...
          if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)long long buf = v18;
            ...
            __int16 v33 = 2112;
            id v34 = v7;
            _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to set natural lighting for hap light profile %@:%@", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)long long buf = v18;
            ...
            __int16 v33 = 2112;
            id v34 = 0;
            _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Successfully set natural lighting for hap light profile %@:%@", buf, 0x20u);
...
uint64_t __137__HMDAssistantCommand_handleSetNaturalLightingAction_serviceType_forObjects_hapLightProfiles_matterLightProfiles_home_completionHandler___block_invoke_117(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v11 = 2112;
    id v12 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to set natural lighting for all hap light profiles with error: %@", (uint8_t *)&v9, 0x16u);
  }
...
uint64_t __137__HMDAssistantCommand_handleSetNaturalLightingAction_serviceType_forObjects_hapLightProfiles_matterLightProfiles_home_completionHandler___block_invoke_119(id *a1, void *a2)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)long long buf = 138543618;
    ...
    __int16 v36 = 2112;
    id v37 = v27;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEBUG, "%{public}@handleSetNaturalLightingEnabled returned resultByLightProfile: %@", buf, 0x16u);
  }
  long long v31 = 0u;
  long long v32 = 0u;
  long long v29 = 0u;
  ...
  if (v28)
  {
    ...
    uint64_t v25 = *MEMORY[0x263F65258];
    uint64_t v24 = *MEMORY[0x263F652C8];
    *(void *)&long long v7 = 138543618;
    ...
    do
    {
      for (uint64_t i = 0; i != v28; ++i)
      {
        ...
        id v10 = objc_msgSend(v9, "service", v22);
        __int16 v11 = [v27 objectForKey:v9];
        id v12 = actionResultForAction(a1[6]);
        uint64_t v13 = entityForService(v10, a1[7], a1[8], [a1[6] includeCompleteInformation]);
        [v12 setEntity:v13];
        ...
        if (v13)
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)long long buf = v22;
            ...
            __int16 v36 = 2112;
            id v37 = v9;
            _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Successfully set natural lighting for matter light profile %@", buf, 0x16u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)long long buf = v22;
            ...
            __int16 v36 = 2112;
            id v37 = v9;
            _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to set natural lighting for matter light profile %@", buf, 0x16u);
...
uint64_t __137__HMDAssistantCommand_handleSetNaturalLightingAction_serviceType_forObjects_hapLightProfiles_matterLightProfiles_home_completionHandler___block_invoke_122(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v14 = 2112;
    uint64_t v15 = v8;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEBUG, "%{public}@handleSetNaturalLightingAction success reporting actionResults: %@", (uint8_t *)&v12, 0x16u);
  }
  int v9 = *(void **)(a1 + 32);
  id v10 = [*(id *)(a1 + 40) allObjects];
  [v9 reportResults:v10 handler:*(void *)(a1 + 48)];
...
uint64_t __137__HMDAssistantCommand_handleSetNaturalLightingAction_serviceType_forObjects_hapLightProfiles_matterLightProfiles_home_completionHandler___block_invoke_124(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v14 = 2112;
    uint64_t v15 = v8;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_DEBUG, "%{public}@handleSetNaturalLightingAction failed reporting actionResults: %@", (uint8_t *)&v12, 0x16u);
  }
  int v9 = *(void **)(a1 + 32);
  id v10 = [*(id *)(a1 + 40) allObjects];
  [v9 reportResults:v10 handler:*(void *)(a1 + 48)];
...
- (void)handleSetNaturalLightingAction:(id)a3 serviceType:(id)a4 forObjects:(id)a5 completionHandler:(id)a6
{
  ...
  int v12 = NSString;
  uint64_t v13 = MEMORY[0x230FBBCF0](self, a2);
  __int16 v14 = [v12 stringWithFormat:@"%@, %s:%ld", v13, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables/Sources/homed/Assistant/HMDAssistantCommand.m", 1984];
  id v59 = (void *)[v11 initWithName:v14];
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)long long buf = 138543618;
    ...
    __int16 v85 = 2112;
    id v86 = v62;
    _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Setting natural lighting enabled for objects: %@", buf, 0x16u);
  }
  uint64_t v18 = [v64 value];
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
    id v19 = v18;
  }
  ...
  if (v63)
  {
    uint64_t v66 = [MEMORY[0x263EFF9C0] set];
    id v65 = [MEMORY[0x263EFF9C0] set];
    long long v81 = 0u;
    long long v82 = 0u;
    long long v79 = 0u;
    long long v80 = 0u;
    obuint64_t j = v62;
    uint64_t v20 = 0;
    uint64_t v21 = [obj countByEnumeratingWithState:&v79 objects:v89 count:16];
    if (v21)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v21; ++i)
        {
          ...
          uint64_t v24 = *(void **)(*((void *)&v79 + 1) + 8 * i);
          uint64_t v25 = [(HMDAssistantCommand *)v68 serviceFromObject:v24];
          uint64_t v26 = v25;
          if (v25)
          {
            ...
            if (!v31)
            {
              ...
              v77[3] = &unk_264A1E6A8;
              id v78 = v26;
              id v34 = objc_msgSend(v33, "na_firstObjectPassingTest:", v77);
              ...
              if (v36)
              {
                if (!_os_feature_enabled_impl()
                  || (char v37 = [v34 supportsCHIP], v38 = v65, (v37 & 1) == 0))
                {
                  uint64_t v38 = v66;
                }
                [v38 addObject:v34];
          ...
          else
          {
            ...
            if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)long long buf = 138543618;
              ...
              __int16 v85 = 2112;
              id v86 = v24;
              _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_ERROR, "%{public}@Did not find service for filtered object: %@", buf, 0x16u);
            }
          }
        }
        uint64_t v21 = [obj countByEnumeratingWithState:&v79 objects:v89 count:16];
    ...
    if (objc_msgSend(v66, "hmf_isEmpty") && objc_msgSend(v65, "hmf_isEmpty"))
    {
      ...
      if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)long long buf = 138543362;
        id v84 = v46;
        _os_log_impl(&dword_22F52A000, v45, OS_LOG_TYPE_INFO, "%{public}@Did not find any light profiles to set natural lighting on", buf, 0xCu);
      }
      [(HMDAssistantCommand *)v44 reportResults:0 handler:v61];
    }
    else if (objc_msgSend(v65, "hmf_isEmpty"))
    {
      ...
      if (os_log_type_enabled(v49, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)long long buf = 138543874;
        ...
        __int16 v87 = 2112;
        uint64_t v88 = v66;
        _os_log_impl(&dword_22F52A000, v49, OS_LOG_TYPE_INFO, "%{public}@Setting natural lighting for light profiles %@:%@", buf, 0x20u);
      }
      objc_initWeak((id *)buf, v48);
      id v52 = [v20 naturalLightingCurveWriter];
      uint64_t v53 = [v63 value];
      v69[0] = MEMORY[0x263EF8330];
      v69[1] = 3221225472;
      ...
      id v74 = obj;
      id v75 = v61;
      [v52 setNaturalLightingEnabled:v53 forLightProfiles:v71 completion:v69];
    ...
    {
      [(HMDAssistantCommand *)v68 handleSetNaturalLightingAction:v64 serviceType:v60 forObjects:obj hapLightProfiles:v66 matterLightProfiles:v65 home:v20 completionHandler:v61];
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
    {
      ...
      uint64_t v58 = [v64 value];
      *(_DWORD *)long long buf = 138543618;
      id v84 = v57;
      __int16 v85 = 2112;
      id v86 = v58;
      _os_log_impl(&dword_22F52A000, v56, OS_LOG_TYPE_ERROR, "%{public}@Specified value is not of BOOLean type %@", buf, 0x16u);
    }
    [(HMDAssistantCommand *)v55 reportOutcome:*MEMORY[0x263F65540] results:MEMORY[0x263EFFA68] handler:v61];
  }
}
...
void __95__HMDAssistantCommand_handleSetNaturalLightingAction_serviceType_forObjects_completionHandler___block_invoke_113(uint64_t a1, void *a2)
{
  ...
  {
    [*(id *)(a1 + 32) begin];
    uint64_t v26 = objc_msgSend(MEMORY[0x263EFF9C0], "setWithCapacity:", objc_msgSend(*(id *)(a1 + 40), "count"));
    long long v29 = 0u;
    long long v30 = 0u;
    long long v31 = 0u;
    long long v32 = 0u;
    ...
    if (v28)
    {
      ...
      uint64_t v23 = *MEMORY[0x263F65258];
      uint64_t v22 = *MEMORY[0x263F652C8];
      *(void *)&long long v4 = 138543874;
      ...
      do
      {
        for (uint64_t i = 0; i != v28; ++i)
        {
          ...
          long long v7 = objc_msgSend(v6, "service", v20);
          uint64_t v8 = [v27 objectForKey:v6];
          int v9 = actionResultForAction(*(void **)(a1 + 48));
          ...
          if (v8)
          {
            ...
            if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)long long buf = v20;
              ...
              __int16 v37 = 2112;
              uint64_t v38 = v8;
              _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to set natural lighting for light profile %@:%@", buf, 0x20u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)long long buf = v20;
              ...
              __int16 v37 = 2112;
              uint64_t v38 = 0;
              _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Successfully set natural lighting for light profile %@:%@", buf, 0x20u);
...
- (void)handleGetNaturalLightingAction:(id)a3 forObjects:(id)a4 serviceType:(id)a5 completionHandler:(id)a6
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)long long buf = 138543618;
    ...
    __int16 v57 = 2112;
    id v58 = v10;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Getting natural lighting enabled for objects: %@", buf, 0x16u);
  }
  uint64_t v44 = [MEMORY[0x263EFF9C0] set];
  long long v50 = 0u;
  long long v51 = 0u;
  long long v52 = 0u;
  long long v53 = 0u;
  ...
  if (v47)
  {
    ...
    uint64_t v43 = *MEMORY[0x263F652C8];
    uint64_t v42 = *MEMORY[0x263F65340];
    do
    {
      for (uint64_t i = 0; i != v47; ++i)
      {
        ...
        id v19 = [(HMDAssistantCommand *)v12 serviceFromObject:v18];
        long long v20 = v19;
        if (v19)
        {
          uint64_t v21 = [v19 accessory];
          objc_opt_class();
          if (objc_opt_isKindOfClass()) {
            uint64_t v22 = v21;
          }
          ...
          id v25 = v20;
          id v49 = v25;
          uint64_t v26 = objc_msgSend(v24, "na_firstObjectPassingTest:", v48);
          ...
          if (v26)
          {
            ...
            if (v28)
            {
              ...
              id v31 = objc_alloc_init(MEMORY[0x263F64920]);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)long long buf = 138543618;
            ...
            __int16 v57 = 2112;
            id v58 = v18;
            _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_ERROR, "%{public}@Did not find service for filtered object: %@", buf, 0x16u);
...
- (void)handleGetActionTypes:(id)a3 serviceType:(id)a4 forObjects:(id)a5 completionHandler:(id)a6
{
  ...
  val = self;
  id v14 = MEMORY[0x230FBBCF0](self, a2);
  id v15 = [v13 stringWithFormat:@"%@, %s:%ld", v14, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables/Sources/homed/Assistant/HMDAssistantCommand.m", 1756];
  ...
  if (v16)
  {
    ...
    int v18 = [v17 isEqualToString:*MEMORY[0x263F653C0]];
    ...
    else
    {
      ...
      int v24 = [v23 isEqualToString:*MEMORY[0x263F65340]];
      ...
      else
      {
        ...
        if ([v27 count])
        {
          ...
          int v29 = [v28 isEqualToString:*MEMORY[0x263F65310]];
          ...
          uint64_t v66 = [v67 mapReadCharacteristicFromAssistantName:v30];
          }

          if (v66)
          {
            id v65 = objc_msgSend(v67, "getAliasedCharacteristicTypes:");
            if ([v65 count])
            {
              id v64 = [v65 arrayByAddingObject:v66];
              [(HMDAssistantCommand *)self filterObjects:v27 forCharacteristicTypes:v64];
            }
            else
            {
              v104[0] = v66;
              id v64 = [MEMORY[0x263EFF8C0] arrayWithObjects:v104 count:1];
              [(HMDAssistantCommand *)self filterObjects:v27 forCharacteristicTypes:v64];
            }
            obuint64_t j = (id)objc_claimAutoreleasedReturnValue();
            if ([obj count])
            {
              id v63 = [MEMORY[0x263EFF9C0] setWithArray:v27];
              char v36 = [MEMORY[0x263EFFA08] setWithArray:obj];
              ...
              uint64_t v40 = [MEMORY[0x263F08968] weakToStrongObjectsMapTable];
              long long v96 = 0u;
              long long v97 = 0u;
              long long v94 = 0u;
              long long v95 = 0u;
              ...
              if (v41)
              {
                ...
                do
                {
                  for (uint64_t i = 0; i != v41; ++i)
                  {
                    ...
                    if (!v48)
                    {
                      char v48 = [MEMORY[0x263EFF980] array];
              ...
              *(void *)&buf[8] = buf;
              *(void *)&buf[16] = 0x3032000000;
              id v100 = __Block_byref_object_copy__19249;
              uint64_t v101 = __Block_byref_object_dispose__19250;
              id v102 = [MEMORY[0x263EFF980] array];
              objc_initWeak(&location, self);
              long long v91 = 0u;
              long long v92 = 0u;
              long long v89 = 0u;
            ...
            else
            {
              ...
              if (os_log_type_enabled(v61, OS_LOG_TYPE_INFO))
              {
                ...
                *(void *)&uint8_t buf[4] = v62;
                _os_log_impl(&dword_22F52A000, v61, OS_LOG_TYPE_INFO, "%{public}@No characteristics found after filtering objects", buf, 0xCu);
              }
          ...
          else
          {
            ...
            if (os_log_type_enabled(v33, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_WORD *)&buf[12] = 2112;
              *(void *)&buf[14] = v35;
              _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot map actionAttribute(%@) to a characteristicType", buf, 0x16u);
            }
            [(HMDAssistantCommand *)v32 reportOutcome:*MEMORY[0x263F65540] results:0 handler:v72];
          }
        }
        else
        {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      *(void *)&uint8_t buf[4] = v22;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@In Get action types, There is no attribute in action, reporting results", buf, 0xCu);
    }
...
uint64_t __85__HMDAssistantCommand_handleGetActionTypes_serviceType_forObjects_completionHandler___block_invoke_109(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    id v8 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@All results have been received for get-action-types, calling result handler", (uint8_t *)&v7, 0xCu);
  }
  [*(id *)(a1 + 40) reportResults:*(void *)(*(void *)(*(void *)(a1 + 56) + 8) + 40) handler:*(void *)(a1 + 48)];
  return [*(id *)(a1 + 32) end];
}
...
- (void)handleMediaAccessorySetActionType:(id)a3 forObjects:(id)a4 withServiceType:(id)a5 completionHandler:(id)a6
{
  ...
  id v12 = NSString;
  uint64_t v13 = MEMORY[0x230FBBCF0](self, a2);
  uint64_t v14 = [v12 stringWithFormat:@"%@, %s:%ld", v13, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables/Sources/homed/Assistant/HMDAssistantCommand.m", 1677];
  ...
  if (v15)
  {
    ...
    int v17 = [v16 isEqualToString:*MEMORY[0x263F654C0]];

    if (v17)
    {
      int v18 = @"HMDMediaProfileSetPowerKey";
      __int16 v19 = [MEMORY[0x263F08968] weakToStrongObjectsMapTable];
      long long v75 = 0u;
      long long v76 = 0u;
      long long v73 = 0u;
      long long v74 = 0u;
      ...
      *((void *)&buf + 1) = &buf;
      ...
      long long v80 = __Block_byref_object_copy__19249;
      long long v81 = __Block_byref_object_dispose__19250;
      id v82 = [MEMORY[0x263EFF980] array];
      long long v69 = 0u;
      long long v70 = 0u;
      long long v71 = 0u;
      long long v72 = 0u;
      ...
      if (v30)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            __int16 v33 = [v29 objectForKey:v32];
            objc_initWeak(&location, self);
            ...
            id v63 = @"HMDMediaProfileSetPowerKey";
            p_long long buf = &buf;
            id v64 = obj;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
      {
        ...
        LODWORD(buf) = 138543362;
        *(void *)((char *)&buf + 4) = v44;
        _os_log_impl(&dword_22F52A000, v43, OS_LOG_TYPE_ERROR, "%{public}@In Set action types, passed-in attribute in action is not supported.", (uint8_t *)&buf, 0xCu);
      }
      [(HMDAssistantCommand *)v42 reportOutcome:*MEMORY[0x263F65540] results:0 handler:v50];
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
    {
      ...
      LODWORD(buf) = 138543362;
      *(void *)((char *)&buf + 4) = v40;
      _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_ERROR, "%{public}@In Set action types, there is no attribute in action, reporting malformed results", (uint8_t *)&buf, 0xCu);
    }
    [(HMDAssistantCommand *)v38 reportOutcome:*MEMORY[0x263F65540] results:0 handler:v50];
  }
}
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)long long buf = 138543874;
      ...
      __int16 v16 = 2112;
      id v17 = v6;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Received error %@ for read/write request with responses %@", buf, 0x20u);
    }
...
uint64_t __102__HMDAssistantCommand_handleMediaAccessorySetActionType_forObjects_withServiceType_completionHandler___block_invoke_106(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    id v8 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@All results have been received for Apple Media Accessory get-action-types, calling result handler", (uint8_t *)&v7, 0xCu);
  }
  [*(id *)(a1 + 40) reportResults:*(void *)(*(void *)(*(void *)(a1 + 56) + 8) + 40) handler:*(void *)(a1 + 48)];
  return [*(id *)(a1 + 32) end];
}
...
- (BOOL)populateResult:(id)a3 fromResponse:(id)a4 responses:(id)a5 forAction:(id)a6 serviceType:(id)a7 forObjects:(id)a8
{
  ...
  else
  {
    ...
    if (!v35) {
      [v32 setOutcome:*MEMORY[0x263F652C8]];
    }
  }
      ...
      if (v80)
      {
        ...
        if (v62)
        {
          ...
          if ([v62 unsignedIntegerValue])
          {
            ...
            id v63 = (id *)MEMORY[0x263F654A8];
          }
          else
          {
            id v63 = (id *)MEMORY[0x263F654B0];
          }
          id v55 = *v63;
        }
        else
...
- (void)handleGetMetadataActionTypes:(id)a3 serviceType:(id)a4 forObjects:(id)a5 completionHandler:(id)a6
{
  ...
  if (v14)
  {
    ...
    if ([v17 count])
    {
      ...
      if (v20)
      {
        ...
        {
          id v69 = v20;
          uint64_t v22 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v69 count:1];
        }
        id v54 = (void *)v22;
        ...
        if ([v32 count])
        {
          ...
          if (v63)
          {
            ...
            uint64_t v60 = *MEMORY[0x263F652C8];
            id v56 = self;
            int v57 = v33;
            do
            {
                ...
                else
                {
                  ...
                  if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)long long buf = 138543618;
                    ...
                    __int16 v72 = 2112;
                    long long v73 = v37;
                    _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_INFO, "%{public}@Not including the result: %@ to the action results", buf, 0x16u);
          ...
          if (os_log_type_enabled(v48, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)long long buf = 138543362;
            id v71 = v50;
            _os_log_impl(&dword_22F52A000, v48, OS_LOG_TYPE_INFO, "%{public}@All results have been received for get-metadata-action-types, calling result handler", buf, 0xCu);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)long long buf = 138543618;
          ...
          __int16 v72 = 2112;
          long long v73 = v31;
          _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot map actionAttribute(%@) to a characteristicType", buf, 0x16u);
        }
        [(HMDAssistantCommand *)v28 reportOutcome:*MEMORY[0x263F65540] results:0 handler:v13];
        uint64_t v20 = 0;
      }
    }
    else
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      id v71 = v26;
      _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@In Get metadata action types, There is no attribute in action, reporting results", buf, 0xCu);
    }
...
- (void)executeActionSet:(id)a3 action:(id)a4 withCompletionHandler:(id)a5
{
  ...
  id v12 = NSString;
  uint64_t v13 = MEMORY[0x230FBBCF0](self, a2);
  id v14 = [v12 stringWithFormat:@"%@, %s:%ld", v13, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables/Sources/homed/Assistant/HMDAssistantCommand.m", 1451];
  uint64_t v32 = (void *)[v11 initWithName:v14];

  id v15 = [v9 attribute];
  LOBYTE(v13) = [(id)*MEMORY[0x263F653F8] isEqualToString:v15];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(void *)&location[4] = v31;
        __int16 v41 = 2112;
        uint64_t v42 = v21;
        _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_DEFAULT, "%{public}@ActionSet action value %@ not true", location, 0x16u);
      }
      [(HMDAssistantCommand *)v29 reportOutcome:*MEMORY[0x263F65540] results:0 handler:v10];
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(void *)&location[4] = v26;
      __int16 v41 = 2112;
      uint64_t v42 = v27;
      _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Invalid action.attribute %@ for actionSet", location, 0x16u);
    }
    [(HMDAssistantCommand *)v24 reportOutcome:*MEMORY[0x263F65540] results:0 handler:v10];
  }
}
...
void __69__HMDAssistantCommand_executeActionSet_action_withCompletionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  id v11 = objc_alloc_init(MEMORY[0x263F64920]);
  ...
  id v12 = (id)*MEMORY[0x263F65548];
  [v11 setValue:1];
  if (!v5)
  {
    int v24 = v12;
    [v10 setOutcome:*MEMORY[0x263F652C8]];
LABEL_16:
    id v15 = 0;
    goto LABEL_17;
  }
  [v10 setOutcome:*MEMORY[0x263F65258]];
  if ([v5 code] == 25)
  {
    id v13 = (id)*MEMORY[0x263F65580];

    id v14 = (void *)MEMORY[0x263F65298];
LABEL_12:
    [v10 setOutcome:*v14];
LABEL_13:
    id v12 = v13;
  ...
  if ([v5 code] == 4000)
  {
    id v13 = (id)*MEMORY[0x263F65590];

    id v14 = (void *)MEMORY[0x263F652A8];
    goto LABEL_12;
  }
  if ([v5 code] == 64)
  {
    id v13 = (id)*MEMORY[0x263F65588];

    goto LABEL_13;
  }
  if ([v5 code] == 65)
  {
    id v13 = (id)*MEMORY[0x263F65578];

    id v14 = (void *)MEMORY[0x263F65268];
    goto LABEL_12;
  }
  if ([v5 code] == 15) {
    [v10 setOutcome:*MEMORY[0x263F65268]];
  }
LABEL_14:
  int v24 = v12;
  if (!v6) {
...
LABEL_17:
  __int16 v16 = (void *)MEMORY[0x230FBD990]([v10 setResultValue:v11]);
  id v17 = WeakRetained;
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)long long buf = 138543618;
    ...
    __int16 v28 = 2112;
    id v29 = v10;
    _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Result received for execute action set: %@, calling result handler", buf, 0x16u);

    id v11 = v19;
    id v6 = v23;
  }

  uint64_t v21 = objc_msgSend(objc_alloc(MEMORY[0x263EFF980]), "initWithObjects:", v10, 0);
  if ([v15 count]) {
...
- (id)actionOutcomeFromError:(id)a3
{
  ...
  if (v4 > 44)
  {
    if (v4 > 2403)
    {
      if (v4 == 2404)
      {
        id v5 = (id *)MEMORY[0x263F65240];
        goto LABEL_25;
      }
      if (v4 == 2405)
      {
        id v5 = (id *)MEMORY[0x263F65250];
        goto LABEL_25;
      }
    }
    else
    {
      if (v4 == 45)
      {
        id v5 = (id *)MEMORY[0x263F65270];
        goto LABEL_25;
      }
      if (v4 == 88)
      {
        id v5 = (id *)MEMORY[0x263F65248];
        goto LABEL_25;
      }
    }
    goto LABEL_22;
  ...
  if (v4 > 14)
  {
    if (v4 == 15)
    {
      id v5 = (id *)MEMORY[0x263F65268];
      goto LABEL_25;
    }
    if (v4 == 44)
    {
      id v5 = (id *)MEMORY[0x263F652C0];
      goto LABEL_25;
    }
    goto LABEL_22;
  }
  if (v4 != 4)
  {
    if (v4 == 5)
    {
      id v5 = (id *)MEMORY[0x263F65288];
      goto LABEL_25;
    }
LABEL_22:
    id v5 = (id *)MEMORY[0x263F65258];
    goto LABEL_25;
  }
...
- (void)returnResults:(id)a3 serviceType:(id)a4 forAction:(id)a5 completionHandler:(id)a6
{
  ...
  if (v14)
  {
    ...
    uint64_t v17 = *MEMORY[0x263F652C8];
    do
    {
      uint64_t v18 = 0;
      do
...
- (void)reportUnlockRequired:(id)a3
{
  ...
  uint64_t v6 = (void *)MEMORY[0x263F65598];
  if (v5 && isPasscodeEnabledOnThisDevice()) {
    uint64_t v6 = (void *)MEMORY[0x263F65570];
  }
...
- (void)reportResults:(id)a3 handler:(id)a4
{
  ...
  {
    id v7 = v10;
    uint64_t v8 = (id *)MEMORY[0x263F65548];
  }
  else
  {
    id v7 = [MEMORY[0x263EFF8C0] array];
    uint64_t v8 = (id *)MEMORY[0x263F65550];
  }
  id v9 = *v8;
...
- (void)reportOutcome:(id)a3 results:(id)a4 handler:(id)a5
{
  ...
  if (v10)
  {
    id v11 = objc_alloc_init(MEMORY[0x263F64930]);
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)long long buf = 138543874;
      ...
      __int16 v53 = 2112;
      id v54 = v28;
      _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@Response for Siri command(%@): %@", buf, 0x20u);
    }
    __int16 v41 = self;
...
- (void)_logEvent:(id)a3
{
  ...
  id v9 = [v7 stringWithFormat:@"%@, %s:%ld", v8, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables/Sources/homed/Assistant/HMDAssistantCommand.m", 1266];
  ...
  if (v12)
  {
    ...
    uint64_t v17 = *MEMORY[0x263F65268];
    do
    {
  ...
  if (v29)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v29; ++i)
      {
        ...
        if (v9)
        {
          id v10 = objc_msgSend(MEMORY[0x263EFF9A0], "dictionaryWithCapacity:", objc_msgSend(v27, "count"));
          long long v30 = 0u;
          long long v31 = 0u;
          long long v32 = 0u;
          long long v33 = 0u;
        ...
        else
        {
          ...
          if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)long long buf = 138543618;
            ...
            __int16 v41 = 2112;
            uint64_t v42 = v8;
            _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_DEFAULT, "%{public}@Filtered object %@ not a service", buf, 0x16u);
          }
        }
      }
      uint64_t v29 = [obj countByEnumeratingWithState:&v34 objects:v43 count:16];
...
- (id)filterObjects:(id)a3 forCharacteristicTypes:(id)a4
{
  ...
  if (v37)
  {
    ...
    *(void *)&long long v7 = 138543618;
    long long v33 = v7;
    uint64_t v8 = HMDHAPMediaProfile;
    do
    {
          ...
          if (v42)
          {
            ...
            do
            {
              for (uint64_t j = 0; j != v42; ++j)
              {
                ...
                uint64_t v16 = [&v8[1] getSharedInstance];
                ...
                if (v18)
                {
                  ...
                  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
                  {
                    ...
                    *(_DWORD *)long long buf = 138543874;
                    ...
                    __int16 v55 = 2112;
                    uint64_t v56 = v15;
                    _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Filtering out request for disallowed service type: %@ characteristic type: %@", buf, 0x20u);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)long long buf = v33;
            ...
            __int16 v53 = 2112;
            id v54 = v10;
            _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_DEFAULT, "%{public}@Filtered object is not a service: %@", buf, 0x16u);
          }
        }
      }
      uint64_t v37 = [obj countByEnumeratingWithState:&v47 objects:v58 count:16];
...
- (id)objectsWithSearchFilter:(id)a3 inHome:(id)a4 serviceTypeIsATV:(BOOL)a5 overrideServiceTypeIfNeeded:(id *)a6
{
  ...
  if ([v11 count])
  {
    ...
    uint64_t v13 = [MEMORY[0x263F08A98] predicateWithFormat:@"(%K = %@)", @"objectHomeIdentifier", v12];
    ...
    if (![v14 count])
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)long long buf = 138543874;
        ...
        __int16 v133 = 2112;
        id v134 = v36;
        _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_INFO, "%{public}@After filtering for home %@/%@, no objects to apply the command to", buf, 0x20u);
    ...
    if (v16)
    {
      uint64_t v17 = (void *)*MEMORY[0x263F655E8];
      if (v15)
      {
        if (([v15 isEqualToString:v17] & 1) == 0
          && ([v15 isEqualToString:*MEMORY[0x263F655E0]] & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)long long buf = 138543618;
            ...
            __int16 v131 = 2112;
            id v132 = v9;
            _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Attribute specified in search filter with entityType not SERVICE/SCENE(%@)", buf, 0x16u);
...
LABEL_18:
    uint64_t v37 = [MEMORY[0x263F08A98] predicateWithFormat:@"%K = %@", @"objectType", v15];
...
LABEL_22:
        _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_INFO, v44, buf, 0xCu);
      }
LABEL_23:
...
LABEL_25:
    ...
    __int16 v51 = objc_msgSend(MEMORY[0x263EFF980], "arrayWithCapacity:", objc_msgSend(v14, "count"));
    long long v124 = 0u;
    long long v125 = 0u;
    long long v126 = 0u;
    long long v127 = 0u;
...
LABEL_75:
          _os_log_impl(&dword_22F52A000, v72, OS_LOG_TYPE_INFO, v74, buf, 0xCu);
        }
LABEL_76:
...
LABEL_53:
        ...
        if (v66)
        {
          long long v67 = (void *)MEMORY[0x263F08A98];
          ...
          if (![v38 count])
          {
            long long v91 = (void *)MEMORY[0x230FBD990]();
            long long v92 = self;
            ...
            if (os_log_type_enabled(v93, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)long long buf = 138543362;
              long long v130 = v95;
              _os_log_impl(&dword_22F52A000, v93, OS_LOG_TYPE_INFO, "%{public}@After filtering for accessoryName, no objects to apply the command to", buf, 0xCu);
        ...
        if (v79)
        {
          int v80 = (void *)MEMORY[0x263F08A98];
        ...
        uint64_t v84 = (void *)MEMORY[0x263F08A98];
...
LABEL_104:
            ...
            if ([v98 isEqual:*MEMORY[0x263F653C0]])
            {
LABEL_109:
...
LABEL_111:
            ...
            if ([v99 isEqual:*MEMORY[0x263F65340]])
            {
            ...
            char v106 = [v105 isEqual:*MEMORY[0x263F655E0]];
...
LABEL_118:
          ...
          id v88 = [v9 sceneType];
          if ([v88 isEqualToString:*MEMORY[0x263F65610]])
          {
            long long v89 = (id *)MEMORY[0x263F0B960];
          }
          else if ([v88 isEqualToString:*MEMORY[0x263F65618]])
          {
            long long v89 = (id *)MEMORY[0x263F0B938];
          }
          else if ([v88 isEqualToString:*MEMORY[0x263F65620]])
          {
            long long v89 = (id *)MEMORY[0x263F0B908];
          }
          else
          {
            if (![v88 isEqualToString:*MEMORY[0x263F65628]])
            {
              id v96 = 0;
              goto LABEL_99;
            }
            long long v89 = (id *)MEMORY[0x263F0B918];
          }
          id v96 = *v89;
LABEL_99:
          ...
          if (v96)
          {
            uint64_t v45 = [MEMORY[0x263F08A98] predicateWithFormat:@"%K =[d] %@", @"objectSceneType", v96];
            ...
            if (![v38 count])
            {
              ...
              if (os_log_type_enabled(v102, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)long long buf = 138543362;
                long long v130 = v104;
                _os_log_impl(&dword_22F52A000, v102, OS_LOG_TYPE_INFO, "%{public}@After filtering for actionSetType, no objects to apply the command to", buf, 0xCu);
    ...
    if (os_log_type_enabled(v77, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)long long buf = 138543362;
      long long v130 = v78;
      _os_log_impl(&dword_22F52A000, v77, OS_LOG_TYPE_INFO, "%{public}@After filtering for serviceType, no objects to apply the command to", buf, 0xCu);
    }
...
LABEL_78:
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)long long buf = 138543362;
    long long v130 = v26;
    _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@No objects to apply the command to", buf, 0xCu);
  }
  id v27 = 0;
LABEL_81:
  ...
  if (v6)
  {
    ...
    if (v9)
    {
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v49 = 2112;
        uint64_t v50 = v15;
        _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Matched home %@ with the homeIdentifier %@ from SCF", (uint8_t *)&v45, 0x20u);
      }
      goto LABEL_31;
    }
    if (os_log_type_enabled(v12, OS_LOG_TYPE_FAULT))
    {
      ...
      __int16 v47 = 2112;
      id v48 = v17;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_FAULT, "%{public}@No home found with identifier %@", (uint8_t *)&v45, 0x16u);
    }
  }
  int v18 = [v4 homeName];
  ...
  if (v18)
  {
    ...
    if ((unint64_t)[v20 count] >= 2)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_FAULT))
      {
        ...
        __int16 v47 = 2112;
        id v48 = v25;
        _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_FAULT, "%{public}@Multiple homes found with name %@, homeIdentifier should be used instead", (uint8_t *)&v45, 0x16u);
      }
    }
    ...
    if (v28)
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v49 = 2112;
        uint64_t v50 = v33;
        _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_INFO, "%{public}@Matched home %@ with the homeName %@ from SCF after a homeIdentifier mismatch", (uint8_t *)&v45, 0x20u);
      }
LABEL_19:
      id v9 = v27;
...
LABEL_24:
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
    {
      ...
      int v45 = 138543362;
      long long v46 = v39;
      _os_log_impl(&dword_22F52A000, v38, OS_LOG_TYPE_INFO, "%{public}@No matches for the home name/identifier specified in Siri command - bailing out....", (uint8_t *)&v45, 0xCu);
    }
    id v9 = 0;
    goto LABEL_31;
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
    {
      ...
      int v45 = 138543362;
      long long v46 = v43;
      _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_INFO, "%{public}@Cannot evaluate the home to apply the Siri command to - bailing out....", (uint8_t *)&v45, 0xCu);
    }
  }
        ...
        !v9))
  {
           ...
           v19)))
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v32 = 2112;
        id v33 = v17;
        _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Defaulting to current home %@ of the device", (uint8_t *)&v30, 0x16u);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v32 = 2112;
        id v33 = v14;
        _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Defaulting to primary home %@ of the device", (uint8_t *)&v30, 0x16u);
      }
      uint64_t v17 = v14;
      uint64_t v16 = v24;
    }
...
LABEL_20:
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v32 = 2112;
    id v33 = v7;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Defaulting to home %@ that this device belongs to", (uint8_t *)&v30, 0x16u);
  }
  id v14 = v7;
  id v15 = v14;
LABEL_21:
...
- (id)filteredObjectsFromObjects:(id)a3 byCharacteristicType:(id)a4
{
  ...
  if (v7)
  {
    ...
    uint64_t v10 = *MEMORY[0x263F655E8];
    do
    {
...
- (id)filteredObjectsFromObjects:(id)a3 byAttribute:(id)a4 forActionType:(id)a5
{
  ...
  uint64_t v10 = +[HMDHAPMetadata getSharedInstance];
  if (!v9
    || ([v9 isEqualToString:*MEMORY[0x263F652F0]] & 1) != 0
    || ([v9 isEqualToString:*MEMORY[0x263F65338]] & 1) != 0
    || ([v9 isEqualToString:*MEMORY[0x263F65318]] & 1) != 0)
  {
    int v47 = 1;
  }
  else
  {
    int v47 = [v9 isEqualToString:*MEMORY[0x263F652E8]];
  }
  uint64_t v50 = [v10 mapReadCharacteristicFromAssistantName:v8];
  long long v46 = objc_msgSend(v10, "getAliasedCharacteristicTypes:");
  long long v43 = v9;
  if (([v9 isEqualToString:*MEMORY[0x263F65320]] & 1) != 0
    || ([v9 isEqualToString:*MEMORY[0x263F65310]] & 1) != 0
    || ([v9 isEqualToString:*MEMORY[0x263F65330]] & 1) != 0
    || ([v9 isEqualToString:*MEMORY[0x263F65328]] & 1) != 0
    || ([v9 isEqualToString:*MEMORY[0x263F65300]] & 1) != 0
    || ([v9 isEqualToString:*MEMORY[0x263F652F8]] & 1) != 0
    || ([v9 isEqualToString:*MEMORY[0x263F65308]] & 1) != 0
    || ([v9 isEqualToString:*MEMORY[0x263F65338]] & 1) != 0
    || ([v9 isEqualToString:*MEMORY[0x263F65318]] & 1) != 0)
  {
    int v53 = 1;
  ...
  {
    int v53 = [v9 isEqualToString:*MEMORY[0x263F652E8]];
  }
  long long v44 = v8;
  ...
  if (v11)
  {
    ...
    uint64_t v15 = *MEMORY[0x263F655E8];
    uint64_t v51 = *(void *)v65;
    uint64_t v52 = *MEMORY[0x263F655E8];
    do
    {
      uint64_t v16 = 0;
      uint64_t v54 = v13;
...
- (id)filteredObjectsFromObjects:(id)a3 forHomeName:(id)a4 roomName:(id)a5 zoneName:(id)a6
{
  ...
  if (v12 | v45)
  {
    ...
    {
      v61[0] = v12;
      uint64_t v14 = [MEMORY[0x263EFF8C0] arrayWithObjects:v61 count:1];
    }
    else if (v45)
    {
      id v40 = v10;
      ...
      if (v16)
      {
        ...
        uint64_t v19 = *MEMORY[0x263F655D8];
        do
        {
    ...
    if (v32)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          uint64_t v34 = [MEMORY[0x263F08A98] predicateWithFormat:@"%K =[d] %@", @"objectRoom", *(void *)(*((void *)&v46 + 1) + 8 * v36)];
        ...
        if (v15)
        {
          ...
          if (v10)
          {
            if (([v10 isEqualToString:v16] & 1) == 0)
            {
              if (v21)
              {
                id *v21 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
              }
      ...
      if (temperatureConversionIsNeeded(v12))
      {
        ...
        *(float *)&double v19 = (float)(v18 * 1.8) + 32.0;
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v31 = 2112;
          uint64_t v32 = v16;
          _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@adjustGet: Attribute %@ value %@  adjusted to Fahrenheit %@", (uint8_t *)&v25, 0x2Au);
        }
      }
    }
  }
      ...
      if (temperatureConversionIsNeeded(v12))
      {
        ...
        *(float *)&double v19 = (float)((float)(v18 + -32.0) * 5.0) / 9.0;
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v31 = 2112;
          uint64_t v32 = v16;
          _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@adjustSet: Attribute %@ value %@  converted to Celsius as %@", (uint8_t *)&v25, 0x2Au);
        }
      }
    }
  }
...
{
  id v3 = a3;
  id v4 = (void *)*MEMORY[0x263F0BE80];
  char v5 = [v3 isEqualToString:*MEMORY[0x263F0BE80]];
  id v6 = (void *)*MEMORY[0x263F0BE98];
  if ((v5 & 1) != 0 || (int v7 = [v3 isEqualToString:*MEMORY[0x263F0BE98]], v8 = v3, v7))
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)long long buf = 138543618;
        ...
        __int16 v59 = 2112;
        id v60 = v16;
        _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_INFO, "%{public}@There is no Siri mapping attribute and/or format for characteristic : %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)long long buf = 138543618;
      ...
      __int16 v59 = 2112;
      id v60 = v52;
      _os_log_impl(&dword_22F52A000, v38, OS_LOG_TYPE_INFO, "%{public}@Unable to get the entity for service : %@", buf, 0x16u);
...
- (id)actionResultForMediaProfile:(id)a3 action:(id)a4 objects:(id)a5 error:(id)a6
{
  ...
  if (v14)
  {
    ...
    if ([v19 isEqualToString:*MEMORY[0x263F65320]])
    {
      id v31 = v13;
      id v20 = [v17 attribute];
      int v21 = [v20 isEqualToString:*MEMORY[0x263F653F8]];

      if (v21)
      {
        uint64_t v22 = (void *)*MEMORY[0x263F65478];
        if ([v18 containsObject:*MEMORY[0x263F65478]]) {
          long long v23 = v22;
        }
        else {
          long long v23 = 0;
    ...
    id v29 = objc_alloc_init(MEMORY[0x263F64920]);
    [v29 setValue:1];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)long long buf = 138543618;
      ...
      __int16 v34 = 2112;
      id v35 = v10;
      _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_ERROR, "%{public}@Unable to get the entity for service : %@", buf, 0x16u);
    }
    id v15 = 0;
  }
...
- (id)failedActionResultsFromResponse:(id)a3 inActionSet:(id)a4 withAction:(id)a5
{
  ...
  id v58 = a4;
  id v60 = a5;
  long long v57 = [MEMORY[0x263EFF980] array];
  uint64_t v9 = [MEMORY[0x263F08A98] predicateWithFormat:@"%K =[d] %@", @"objectType", *MEMORY[0x263F655E8]];
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        uint64_t v19 = (void *)[objc_alloc(*(Class *)(v15 + 3128)) initWithUUIDString:v17];
        ...
        if (v20)
        {
          ...
          objc_msgSend(MEMORY[0x263F087E8], "hmf_unarchiveFromData:error:", v21, 0);
        ...
        else
        {
          ...
          int v25 = (void *)[objc_alloc(*(Class *)(v15 + 3128)) initWithUUIDString:v17];
                      ...
                      if (v35)
                      {
                        ...
                        if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
                        {
                          ...
                          *(_DWORD *)long long buf = 138543618;
                          ...
                          __int16 v79 = 2112;
                          int v80 = v35;
                          _os_log_impl(&dword_22F52A000, v38, OS_LOG_TYPE_INFO, "%{public}@Parsing error for Siri : %@", buf, 0x16u);
...
- (id)entityFromActionSet:(id)a3
{
  id v3 = (objc_class *)MEMORY[0x263F64938];
  id v4 = a3;
  ...
  [v5 setEntityType:*MEMORY[0x263F655E0]];
  id v10 = [v4 type];
...
- (BOOL)populateResult:(id)a3 withObject:(id)a4 serviceType:(id)a5 action:(id)a6
{
  ...
  if (v17
    && (uint64_t v18 = (void *)v17,
        ...
        int v20 = [v19 isEqualToString:*MEMORY[0x263F655E8]],
        v19,
        v18,
        v20))
  {
      ...
      else
      {
        ...
        if (!v27
          || (id v28 = (void *)v27,
              ...
              int v30 = [v29 isEqualToString:*MEMORY[0x263F652F0]],
              v29,
              v28,
              v30))
        {
...
LABEL_46:
      ...
      uint64_t v39 = (uint64_t *)MEMORY[0x263F652F0];
      long long v92 = v36;
      if (!v38)
      {
        uint64_t v42 = *MEMORY[0x263F652F0];
        goto LABEL_35;
      }
      id v40 = (void *)v38;
      ...
      if ([v43 isEqualToString:*MEMORY[0x263F65310]])
      {
...
LABEL_34:
      ...
      if ([v44 isEqualToString:*MEMORY[0x263F65320]])
      {
...
LABEL_33:
      ...
      if ([v45 isEqualToString:*MEMORY[0x263F65318]])
      {
...
LABEL_32:
      ...
      if ([v46 isEqualToString:*MEMORY[0x263F652E8]])
      {

        goto LABEL_32;
      }
      long long v87 = [v17 actionType];
      char v88 = [v87 isEqualToString:*MEMORY[0x263F65338]];
...
LABEL_45:
      ...
      if ([v63 isEqualToString:*MEMORY[0x263F65330]])
      {
      ...
      int v65 = [v64 isEqualToString:*MEMORY[0x263F65328]];
...
LABEL_52:
        if (v18)
        {
          ...
          [v13 setOutcome:*MEMORY[0x263F652C8]];
          goto LABEL_40;
        }
LABEL_64:
        LOBYTE(v26) = 0;
      ...
      uint64_t v72 = *MEMORY[0x263F65300];
      if (([v71 isEqualToString:*MEMORY[0x263F65300]] & 1) == 0)
      {
        long long v73 = [v17 actionType];
        if (![v73 isEqualToString:*MEMORY[0x263F652F8]])
        {
          __int16 v79 = [v17 actionType];
          char v96 = [v79 isEqualToString:*MEMORY[0x263F65308]];
...
LABEL_78:
          ...
          int v78 = [v77 isEqualToString:*MEMORY[0x263F652F8]];
...
LABEL_71:
          ...
          int v81 = [v80 isEqualToString:*MEMORY[0x263F65308]];
...
- (id)mediaProfileFromObject:(id)a3
{
  ...
  if ([v5 isEqualToString:*MEMORY[0x263F655E8]])
  {
    id v6 = v4;
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
