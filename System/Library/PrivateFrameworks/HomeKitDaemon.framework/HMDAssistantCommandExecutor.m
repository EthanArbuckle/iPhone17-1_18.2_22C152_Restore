  ...
  if (executionTimer == v4)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v25 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Timer expired - reporting results", buf, 0xCu);
    }
    if (self)
    {
...
- (void)performWithCompletion:(id)a3
{
  ...
  if (v8 + -2.0 < 3.0)
  {
    v9 = (void *)MEMORY[0x230FBD990](v8 + -2.0);
    v10 = self;
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v89 = 2112;
      v90 = v14;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Timeout %@ specified by Siri Command is below threshold, falling back to default timeout", buf, 0x16u);
    }
    double v8 = *(double *)&assistantClientReadWriteTimeoutSeconds;
  }
  uint64_t v15 = (HMFTimer *)[objc_alloc(MEMORY[0x263F42658]) initWithTimeInterval:19 options:v8];
  executionTimer = self->_executionTimer;
    ...
    if (!v22)
    {
      ...
      if (os_log_type_enabled(v56, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)v91 = 138543362;
        v92 = v57;
        _os_log_impl(&dword_22F52A000, v56, OS_LOG_TYPE_INFO, "%{public}@No actions to perform", v91, 0xCu);
      }
LABEL_48:
      dispatch_assert_queue_V2((dispatch_queue_t)self->_workQueue);
      id v35 = objc_alloc_init(MEMORY[0x263F64930]);
      [v35 setCommandOutcome:*MEMORY[0x263F65540]];
        ...
        if (v44)
        {
          ...
          do
          {
            for (uint64_t k = 0; k != v44; ++k)
            {
              ...
              v83 = v47;
              v51 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v83 count:1];
              [v48 setActions:v51];
...
void __53__HMDAssistantCommandExecutor_performWithCompletion___block_invoke(uint64_t a1)
{
  ...
  id v2 = [MEMORY[0x263F087E8] hmErrorWithCode:15];
  ...
  if (WeakRetained)
  {
    ...
    if (!v3)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v32 = 2112;
        BOOL v33 = v8;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Nil response for action %@", (uint8_t *)&v30, 0x16u);
      }
    }
    if (-[HMDAssistantCommandExecutor _initialCommandIsMultipleActions](v5))
    {
      ...
      if (v3)
      {
        v17 = (void *)[objc_alloc(MEMORY[0x263F64930]) initWithDictionary:v15];
        ...
        *(void *)(v5 + 48) = v18;
        ...
        if (mapToFailureActionOutcome_onceToken != -1) {
          dispatch_once(&mapToFailureActionOutcome_onceToken, &__block_literal_global_130572);
        }
      ...
      if (![*(id *)(v5 + 40) count])
      {
        ...
        id v25 = (id)*MEMORY[0x263F65548];
        dispatch_assert_queue_V2(v24);
        id v26 = objc_alloc_init(MEMORY[0x263F64930]);
...
- (void)_sendResponse:(uint64_t)a1
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      int v11 = 138543362;
      uint64_t v12 = v10;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Results already reported for Siri command - aborting report", (uint8_t *)&v11, 0xCu);
    }
  }
}
