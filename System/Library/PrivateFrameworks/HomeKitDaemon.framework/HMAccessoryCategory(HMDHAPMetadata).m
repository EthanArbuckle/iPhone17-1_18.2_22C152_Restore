...
+ (id)categoryForProductClass:()HMDHAPMetadata
{
  if (a3 == 6)
  {
    v3 = (void *)MEMORY[0x263F0DF40];
    id v4 = objc_alloc(MEMORY[0x263F08C38]);
    v5 = (void *)MEMORY[0x263F0B0A0];
  }
  else
  {
    v3 = (void *)MEMORY[0x263F0DF40];
    ...
    {
      id v4 = objc_alloc(MEMORY[0x263F08C38]);
      v5 = (void *)MEMORY[0x263F0B030];
    }
    else
    {
      id v4 = objc_alloc(MEMORY[0x263F08C38]);
      v5 = (void *)MEMORY[0x263F0B130];
    }
  }
  v6 = (void *)[v4 initWithUUIDString:*v5];
  v7 = [v3 categoryWithIdentifier:v6];
...
+ (id)categoryWithCategoryIdentifier:()HMDHAPMetadata
{
  ...
  id v7 = objc_alloc(MEMORY[0x263F0DF40]);
  v8 = [v5 uuidStr];
  v9 = [v5 catDescription];
  v10 = (void *)[v7 initWithType:v8 name:v9];

  v11 = [MEMORY[0x263F0E340] cachedInstanceForHMAccessoryCategory:v10];
...
+ (id)categoryWithIdentifier:()HMDHAPMetadata
{
  id v3 = a3;
  id v4 = objc_alloc(MEMORY[0x263F08C38]);
  v5 = (void *)[v4 initWithUUIDString:*MEMORY[0x263F0B178]];
  ...
  if (v6)
  {
    v9 = [v7 categoryForType:*MEMORY[0x263F0B170]];
  }
  else
  {
    v10 = [v3 UUIDString];
  ...
  id v12 = objc_alloc(MEMORY[0x263F0DF40]);
  v13 = [v3 UUIDString];
  v14 = [v9 catDescription];
  v15 = (void *)[v12 initWithType:v13 name:v14];

  v16 = [MEMORY[0x263F0E340] cachedInstanceForHMAccessoryCategory:v15];
