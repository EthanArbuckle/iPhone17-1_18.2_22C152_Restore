...
{
  v2 = NSString;
  int64_t v3 = [(HMDNetworkRouterClientStatusControlOperation *)self operation];
  if (v3 == 1)
  {
  ...
  {
    objc_msgSend(NSString, "stringWithFormat:", @"Unknown HMDNetworkRouterClientStatusControlOperationType %ld", v3);
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      v5 = v4;
      int64_t v6 = [(HMDNetworkRouterClientStatusControlOperation *)self operation];
      uint64_t v7 = [(HMDNetworkRouterClientStatusControlOperation *)v5 operation];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  int64_t v5 = [(HMDNetworkRouterClientStatusControlOperation *)self operation];
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HMDNetworkRouterClientStatusControlOperation);
  uint64_t v7 = v6;
  if (v6)
  {
    id v10 = 0;
    [(HMDNetworkRouterClientStatusControlOperation *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
