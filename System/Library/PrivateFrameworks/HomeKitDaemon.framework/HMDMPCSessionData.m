...
- (id)dictionaryRepresentation:(BOOL)a3
{
  ...
  v7 = objc_msgSend(v6, "na_map:", &__block_literal_global_185214);
  v8 = [v7 allObjects];
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v53 = 2112;
      id v54 = v18;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Encoding playbackArchive: %@", buf, 0x16u);
    }
    ...
    if (v3)
    {
      if (v22)
      {
        ...
        *(_DWORD *)buf = 138543362;
        v52 = v23;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Encoding playbackArchive in entirety", buf, 0xCu);
      }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v53 = 2112;
          id v54 = v27;
          _os_log_impl(&dword_22F52A000, v46, OS_LOG_TYPE_ERROR, "%{public}@Couldn't encode playbackArchive: %@", buf, 0x16u);
        }
      }
    }
    else
    {
      if (v22)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v53 = 2112;
        id v54 = v29;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Encoding playbackArchive session identifier: %@", buf, 0x16u);
      }
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v53 = 2112;
        id v54 = v43;
        _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_INFO, "%{public}@Encoding playbackArchive options: %@", buf, 0x16u);
      }
...
- (HMDMPCSessionData)initWithDictionaryRepresentation:(id)a3 profileSource:(id)a4
{
  ...
  id v8 = v6;
  id v9 = v7;
  v70 = objc_msgSend(MEMORY[0x263EFF9C0], "setWithCapacity:", objc_msgSend(v9, "count"));
  long long v73 = 0u;
  long long v74 = 0u;
  long long v75 = 0u;
  long long v76 = 0u;
  ...
  if (v10)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v11; ++i)
      {
        ...
        v15 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v14];
        ...
        else
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v79 = 2112;
            uint64_t v80 = v14;
            _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Could not map profile UUID (%@) to MediaProfile", buf, 0x16u);
  ...
  if (v20)
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)v81 = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_INFO, "%{public}@Decoding playbackArchive in entirety: %@", v81, 0x16u);

      id v8 = v68;
    }

    id v72 = 0;
    uint64_t v34 = [MEMORY[0x263F08928] unarchivedObjectOfClass:objc_opt_class() fromData:v20 error:&v72];
    id v35 = v72;
    if (!v34)
    {
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)v81 = 138543618;
        ...
        _os_log_impl(&dword_22F52A000, v38, OS_LOG_TYPE_ERROR, "%{public}@Couldn't decode playbackArchive: %@", v81, 0x16u);
      }
      id v8 = v68;
    }
  }
    ...
    if (v21)
    {
      if (v43)
      {
        ...
        *(_DWORD *)v81 = 138543618;
        ...
        __int16 v83 = 2112;
        uint64_t v84 = v21;
        _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_INFO, "%{public}@Decoding playbackArchive session identifier: %@", v81, 0x16u);
      }
      v61 = [v8 home];
      ...
      if (v34)
      {
        ...
        while (v46 >> v47++);
        context = (void *)MEMORY[0x230FBD990](v48);
        id v50 = v41;
        ...
        if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)v81 = 138543874;
          ...
          __int16 v85 = 2112;
          v86 = v54;
          _os_log_impl(&dword_22F52A000, v51, OS_LOG_TYPE_INFO, "%{public}@Decoding playbackArchive: %@ options: %@", v81, 0x20u);
        }
        id v8 = v68;
      }
      else
      {
        ...
        if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)v81 = 138543618;
          ...
          _os_log_impl(&dword_22F52A000, v51, OS_LOG_TYPE_ERROR, "%{public}@Couldn't decode playbackArchive session identifier. home %@", v81, 0x16u);
        }
        else
        {
          v52 = v61;
    ...
    else
    {
      if (v43)
      {
        ...
        *(_DWORD *)v81 = 138543362;
        v82 = v55;
        _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_INFO, "%{public}@Key to playbackArchive not found", v81, 0xCu);
      }
      uint64_t v34 = 0;
    }
  }
...
LABEL_9:
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, v23, buf, 0xCu);
  ...
  if (v25)
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v40 = 2112;
      v41 = v33;
      _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_INFO, "%{public}@HMDMPCSessionData initialized with playbackArchive: %@", buf, 0x16u);
    }
  }
  v20 = v26;
  v24 = v20;
