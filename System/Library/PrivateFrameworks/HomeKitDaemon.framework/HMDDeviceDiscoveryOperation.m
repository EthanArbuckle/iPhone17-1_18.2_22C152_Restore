...
LABEL_14:
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v49 = 2112;
        v50 = v32;
        _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring message from: %@", buf, 0x16u);
      }
      goto LABEL_24;
    }
  }
  ...
  v22 = +[HMDRemoteMessageSerialization remoteMessageWithDictionary:v45 isHH2Payload:1 error:0];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v49 = 2112;
          v50 = v35;
          _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_INFO, "%{public}@Discovered device: %@", buf, 0x16u);
        ...
        for (uint64_t i = 0; i != v11; ++i)
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v37 = 2112;
            v38 = v14;
            _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Adding known device: %@", buf, 0x16u);
          }
          os_unfair_lock_lock_with_options();
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v37 = 2112;
      v38 = v25;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Cannot discover devices for account without any handles: %@", buf, 0x16u);
    }
...
- (void)cancelWithError:(id)a3
{
  id v4 = a3;
  v5 = [v4 domain];
  if ([v5 isEqualToString:*MEMORY[0x263F41FD8]])
  {
    uint64_t v6 = [v4 code];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_43706 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_43706, &__block_literal_global_43707);
  }
  v2 = (void *)logCategory__hmf_once_v5_43708;
  return v2;
}
...
void __42__HMDDeviceDiscoveryOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_43708;
  logCategory__hmf_once_v5_43708 = v0;
}
