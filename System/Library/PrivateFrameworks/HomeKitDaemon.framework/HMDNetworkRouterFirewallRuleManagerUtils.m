...
+ (id)dumpTLVsFromJSONData:(id)a3 error:(id *)a4
{
  ...
  if (v46)
  {
    ...
    v58 = __Block_byref_object_copy__159576;
    v59 = __Block_byref_object_dispose__159577;
    id v60 = 0;
...
LABEL_43:
    ...
    else
    {
      if (!objc_msgSend(v44, "hmf_isEmpty"))
      {
        if ((unint64_t)[v44 count] >= 2)
        {
          ...
          if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v70 = 2048;
            uint64_t v71 = v14;
            _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Multiple declarations (%lu) found, choosing the first", buf, 0x16u);
          }
        }
        v37 = [v44 firstObject];
        ...
        if (objc_msgSend(v38, "hmf_isEmpty"))
        {
          ...
          if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543362;
            id v69 = v17;
            _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@No rule configurations were found", buf, 0xCu);
          }
          if (a4)
          {
        ...
        {
          v39 = objc_msgSend(MEMORY[0x263EFF9A0], "dictionaryWithCapacity:", objc_msgSend(v38, "count"));
          long long v50 = 0u;
          long long v51 = 0u;
          long long v48 = 0u;
          long long v49 = 0u;
              ...
              do
              {
                ...
                if (v23)
                {
                  ...
                  if (v24)
                  {
                    ...
                    v66[1] = v25;
                    v26 = [NSDictionary dictionaryWithObjects:v66 forKeys:v65 count:2];
          ...
          v33 = (void *)[v39 copy];
          v62 = v33;
          v34 = [NSDictionary dictionaryWithObjects:&v62 forKeys:&v61 count:1];
          v64 = v34;
          v35 = [NSDictionary dictionaryWithObjects:&v64 forKeys:&v63 count:1];

          v7 = [MEMORY[0x263F08900] dataWithJSONObject:v35 options:3 error:a4];
...
LABEL_40:
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v69 = v10;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@No network declarations were found", buf, 0xCu);
      }
      if (a4)
      {
  ...
  if (v9)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        int v18 = 138543362;
        uint64_t v19 = v14;
        _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Invalid declarations found", (uint8_t *)&v18, 0xCu);
      }
