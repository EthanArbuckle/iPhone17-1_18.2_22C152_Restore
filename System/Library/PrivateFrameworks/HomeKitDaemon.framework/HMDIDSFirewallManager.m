...
- (void)handleDidRemoveUser
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling did remove user", (uint8_t *)&v10, 0xCu);
  }
...
- (void)handleDidAddUserWithUserID:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543619;
    ...
    __int16 v20 = 2117;
    id v21 = v6;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Adding firewall entry for userID: %{sensitive}@", buf, 0x16u);
  }
...
- (void)handleDidAddUserWithUserID:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543619;
    ...
    __int16 v15 = 2117;
    id v16 = v4;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling did add user with userID: %{sensitive}@", buf, 0x16u);
  }
  id v12 = v4;
...
- (void)handleDidRemoveHome
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling did remove home", (uint8_t *)&v10, 0xCu);
  }
  v9 = [(HMDIDSFirewallManager *)v6 userIDs];
  [(HMDIDSFirewallManager *)v6 replaceFireWallEntriesWithUserIDs:v9];
}
...
- (void)handleDidAddHome
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v11 = 138543362;
    uint64_t v12 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling did add home", (uint8_t *)&v11, 0xCu);
  }
...
- (void)addFireWallEntryForUserIDs:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2117;
    id v16 = v4;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Adding firewall entries for userIDs: %{sensitive}@", (uint8_t *)&v13, 0x16u);
  }
...
- (void)replaceFireWallEntriesWithUserIDs:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2117;
    id v16 = v4;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Replacing firewall entries with userIDs: %{sensitive}@", (uint8_t *)&v13, 0x16u);
  }
  int v11 = [(HMDIDSFirewallManager *)v8 context];
  uint64_t v12 = +[HMDIDSFirewallManager firewallEntriesForUserIDs:v4];
...
- (void)start
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v11 = 138543362;
    uint64_t v12 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Starting HMDIDSFirewallManager", (uint8_t *)&v11, 0xCu);
  }
  v9 = [(HMDIDSFirewallManager *)v6 context];
  [v9 configure];
...
- (NSArray)userIDs
{
  ...
  v9 = objc_msgSend(v7, "na_flatMap:", &__block_literal_global_109_151109);
...
id __32__HMDIDSFirewallManager_userIDs__block_invoke(uint64_t a1, void *a2)
{
  ...
  v3 = objc_msgSend(v2, "na_map:", &__block_literal_global_112_151112);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t21_151118 != -1) {
    dispatch_once(&logCategory__hmf_once_t21_151118, &__block_literal_global_116);
  }
  v2 = (void *)logCategory__hmf_once_v22_151119;
  return v2;
}
...
void __36__HMDIDSFirewallManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v22_151119;
  logCategory__hmf_once_v22_151119 = v0;
}

+ (id)firewallEntriesForUserIDs:(id)a3
{
  return (id)objc_msgSend(a3, "na_map:", &__block_literal_global_102_151123);
}

id __51__HMDIDSFirewallManager_firewallEntriesForUserIDs___block_invoke(uint64_t a1, uint64_t a2)
{
  v2 = [MEMORY[0x263F4A0E8] URIWithUnprefixedURI:a2];
  v3 = (void *)[objc_alloc(MEMORY[0x263F4A048]) initWithURI:v2];
