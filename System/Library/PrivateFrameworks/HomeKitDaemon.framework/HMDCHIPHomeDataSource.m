  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v26 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@Home reference is nil", buf, 0xCu);
    }
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v27 = 2112;
      id v28 = v12;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Could not find accessories with Matter node ID: %@", buf, 0x16u);
    }
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v19 = 2112;
      id v20 = v7;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Could not find accessory with CHIP node ID: %@", buf, 0x16u);
    }
    v9 = 0;
  }
...
- (NSSet)allNodeIDs
{
  ...
  if (!v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      int v15 = 138543362;
      id v16 = v7;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Home reference is nil", (uint8_t *)&v15, 0xCu);
    }
  }
  v8 = (void *)MEMORY[0x263EFFA08];
  v9 = [v3 matterAccessories];
  uint64_t v10 = objc_msgSend(v9, "na_map:", &__block_literal_global_32537);
  v11 = (void *)v10;
  if (v10) {
    uint64_t v12 = v10;
  }
...
- (void)updateKeyValueStoreWithBlock:(id)a3 completion:(id)a4
{
  ...
  id v6 = (unsigned int (**)(id, void *, void *))a3;
  id v7 = a4;
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v33 = v17;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Home reference is nil", buf, 0xCu);
    }
...
LABEL_24:
  ...
  if (([v8 isCurrentDevicePrimaryResident] & 1) == 0
    && (!isFeatureMatteriPhoneOnlyPairingControlEnabled()
     || ([v9 isPrimaryResidentNodeReachable] & 1) != 0
     || ![v9 isOwnerUser]))
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v33 = v23;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Remotely updating home model key-value store", buf, 0xCu);
    }
    id v24 = [(HMDCHIPHomeDataSource *)v21 keyValueStore];
    ...
    {
      __int16 v27 = [MEMORY[0x263EFF9A0] dictionary];
    }
    v18 = v27;
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v33 = v13;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Locally updating home model key-value store", buf, 0xCu);
  }
  ...
  v30[4] = v11;
  v31 = v6;
  [(HMDCHIPHomeDataSource *)v11 _updateHomeModelWithLabel:@"Update CHIP key-value store" completion:v7 block:v30];
...
- (void)updateIntermediateCertificate:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v17 = 2112;
    id v18 = v6;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating home model intermediate certificate to %@", buf, 0x16u);
  }
...
- (void)updateOperationalCertificate:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v17 = 2112;
    id v18 = v6;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating home model operational certificate to %@", buf, 0x16u);
  }
  v13[0] = MEMORY[0x263EF8330];
  v13[1] = 3221225472;
...
- (void)updateRootCertificate:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v17 = 2112;
    id v18 = v6;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating home model root certificate to %@", buf, 0x16u);
  }
  v13[0] = MEMORY[0x263EF8330];
  v13[1] = 3221225472;
...
- (void)updateLastNodeID:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v17 = 2112;
    id v18 = v6;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating home model last node ID to %@", buf, 0x16u);
  }
  v13[0] = MEMORY[0x263EF8330];
  v13[1] = 3221225472;
...
- (void)updateFabricID:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v17 = 2112;
    id v18 = v6;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating home model fabric ID to %@", buf, 0x16u);
  }
  v13[0] = MEMORY[0x263EF8330];
  v13[1] = 3221225472;
...
LABEL_18:
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v40 = v22;
    _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Home reference is nil", buf, 0xCu);
  }
...
LABEL_7:
  ...
  if (v10)
  {
    ...
    id v12 = (NSRecursiveLock *)objc_alloc_init(MEMORY[0x263F08AE0]);
    lock = v11->_lock;
    v11->_lock = v12;
  }
  return v11;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t18_32586 != -1) {
    dispatch_once(&logCategory__hmf_once_t18_32586, &__block_literal_global_52);
  }
  id v2 = (void *)logCategory__hmf_once_v19_32587;
  return v2;
}
...
void __36__HMDCHIPHomeDataSource_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v19_32587;
  logCategory__hmf_once_v19_32587 = v0;
}
