  ...
  if (v6)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v7; ++i)
      {
        ...
        v10 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:*(void *)(*((void *)&v23 + 1) + 8 * i)];
        if (v10) {
          [v4 addObject:v10];
        }
      }
  ...
  if (v12)
  {
    ...
    do
    {
      for (uint64_t j = 0; j != v13; ++j)
      {
        ...
        v16 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:*(void *)(*((void *)&v19 + 1) + 8 * j)];
        if (v16) {
          [v4 addObject:v16];
        }
      }
...
+ (id)properties
{
  if (properties_onceToken_250861 != -1) {
    dispatch_once(&properties_onceToken_250861, &__block_literal_global_221);
  }
  v2 = (void *)properties__properties_250862;
  return v2;
}
...
void __44__HMDAssistantAccessControlModel_properties__block_invoke()
{
  ...
  uint64_t v7 = (void *)properties__properties_250862;
  properties__properties_250862 = v6;
}
