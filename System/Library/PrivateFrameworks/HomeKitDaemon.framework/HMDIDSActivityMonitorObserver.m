  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v34 = 2112;
      id v35 = v7;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Notifying delegates of IDS Activity update: %@", buf, 0x16u);
    }
    long long v29 = 0u;
    long long v30 = 0u;
    long long v27 = 0u;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v34 = 2112;
      id v35 = v7;
      _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Received IDS Activity update for unkonwn device: %@", buf, 0x16u);
    }
  }
}
...
- (void)stopObservingPresenceForDevice:(id)a3
{
  ...
  [v5 stopObservingDevice:v4 subActivity:*MEMORY[0x263F49E00]];
}
...
- (void)startObservingPresenceForDevice:(id)a3
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      int v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@startObservingPresenceForDevice: called before configureWithDataSource:", (uint8_t *)&v11, 0xCu);
    }
  }
  v10 = [(HMDIDSActivityMonitorObserver *)self dataSource];
  [v10 startObservingDevice:v4 subActivity:*MEMORY[0x263F49E00]];
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t17_196814 != -1) {
    dispatch_once(&logCategory__hmf_once_t17_196814, &__block_literal_global_147_196815);
  }
  v2 = (void *)logCategory__hmf_once_v18_196816;
  return v2;
}
...
void __44__HMDIDSActivityMonitorObserver_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v18_196816;
  logCategory__hmf_once_v18_196816 = v0;
}
