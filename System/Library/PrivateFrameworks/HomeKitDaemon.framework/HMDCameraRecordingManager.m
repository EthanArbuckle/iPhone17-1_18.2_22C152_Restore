...
- (id)_createRecordingSessionWithSelectedConfiguration:(id)a3;
- (id)logIdentifier;
...
- (void)_prepareRecordingSessionForTrigger:(unint64_t)a3 reason:(id)a4;
- (void)_prepareRecordingSessionForTrigger:(unint64_t)a3 reason:(id)a4 completionCallback:(id)a5;
- (void)_resetCurrentRecordingSession:(id)a3;
- (void)_resetRetryContextWithReason:(id)a3;
- (void)_shutDown;
- (void)_start;
- (void)_startRecordingSessionForTrigger:(unint64_t)a3 reason:(id)a4 selectedConfiguration:(id)a5 completionCallback:(id)a6;
...
void __71__HMDCameraRecordingManager_handleCameraSettingsDidChangeNotification___block_invoke(uint64_t a1)
{
  ...
  if ([*(id *)(a1 + 32) didShutDown])
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      int v17 = 138543362;
      v18 = v5;
      _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Ignoring handleCameraSettingsDidChangeNotification: because recording manager was shut down", (uint8_t *)&v17, 0xCu);
    }
  }
  else
  {
    ...
    if (HMIsRecordingAllowedForCameraAccessMode())
    {
      ...
      {
        v8 = (void *)MEMORY[0x230FBD990]([*(id *)(a1 + 32) _resetRetryContextWithReason:@"Settings changed to allow recording"]);
        id v9 = *(id *)(a1 + 32);
        ...
        if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
        {
          ...
          int v17 = 138543362;
          v18 = v11;
          _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Motion is active and settings changed to allow recording, attempting to coordinate a recording session", (uint8_t *)&v17, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v19 = 2112;
        v20 = v16;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Closing current session because current access mode is: %@", (uint8_t *)&v17, 0x16u);
      }
...
- (void)session:(id)a3 didEndWithError:(id)a4
{
  ...
  if ([(HMDCameraRecordingManager *)self didShutDown])
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      int v22 = 138543362;
      v23 = v12;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Ignoring closeSession:withError: delegate callback because recording manager was shut down", (uint8_t *)&v22, 0xCu);
    }
  }
  else
  {
    ...
    if (v13 == v6)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v24 = 1024;
        int v25 = v14;
        _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Closing current session with reason: %d", (uint8_t *)&v22, 0x12u);
      }
        ...
        if (v11)
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            __int16 v37 = 2112;
            id v38 = v4;
            _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Retrying session with identifier: %@ because motion active: %@, error: %@", buf, 0x2Au);
          }
          ...
          if (!v23)
          {
            ...
            if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v32 = v27;
              _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@Creating session retry context", buf, 0xCu);
            }
            v28 = [(HMDCameraRecordingManager *)v25 dependencyFactory];
            v29 = [(HMDCameraRecordingManager *)v25 workQueue];
            v30 = [v28 createRecordingSessionRetryContextWithWorkQueue:v29];
...
LABEL_8:
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v37 = 2112;
        id v38 = v4;
        _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Not retrying session with identifier: %@ because motion active: %@, error: %@", buf, 0x2Au);
      }
LABEL_11:
...
- (void)_startSessionRetryTimer
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v21 = 2048;
    double v22 = v7;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Starting session retry timer with interval: %f", (uint8_t *)&v19, 0x16u);
  }
...
- (void)_resetRetryContextWithReason:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v13 = 2112;
      id v14 = v4;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Resetting session retry context with reason: %@", (uint8_t *)&v11, 0x16u);
    }
...
LABEL_5:
  ...
  BOOL v10 = [MEMORY[0x263F087E8] errorWithDomain:@"HMDCameraRecordingBulkSessionCloseReason" code:v4 userInfo:0];
  ...
  if (v6 == v4)
  {
    ...
    if ([(HMDCameraRecordingManager *)self isMotionActive])
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        int v11 = 138543362;
        v12 = v10;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Starting recording session after session retry timer has expired", (uint8_t *)&v11, 0xCu);
      }
      [(HMDCameraRecordingManager *)v8 _prepareRecordingSessionForTrigger:0 reason:@"Retry timer expired"];
    }
  }
}
...
- (void)_handleBulkSendSessionCreated:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v26 = 2112;
    id v27 = v4;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Created bulk send session: %@", (uint8_t *)&v24, 0x16u);
  }
  BOOL v10 = [(HMDCameraRecordingManager *)v7 dependencyFactory];
  int v11 = [v10 preferences];
...
- (void)_startRecordingSessionForTrigger:(unint64_t)a3 reason:(id)a4 selectedConfiguration:(id)a5 completionCallback:(id)a6
{
  ...
  id v11 = a5;
  v12 = (void (**)(id, void))a6;
  uint64_t v13 = [(HMDCameraRecordingManager *)self workQueue];
  dispatch_assert_queue_V2(v13);

  double v14 = (void *)MEMORY[0x230FBD990]();
  uint64_t v15 = self;
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v55 = 2112;
    id v56 = v10;
    _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Starting recording session with reason: %@", buf, 0x16u);
  }
  v18 = [(HMDCameraRecordingManager *)v15 sessionRetryTimer];
  ...
  if (v18)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      uint64_t v23 = [(HMDCameraRecordingManager *)v20 sessionRetryTimer];
      [v23 timeInterval];
      *(_DWORD *)buf = 138543618;
      v54 = v22;
      __int16 v55 = 2048;
      id v56 = v24;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Waiting for retry timer with duration: %f to expire", buf, 0x16u);
    }
    v12[2](v12, 0);
    goto LABEL_16;
  }
  int v25 = [(HMDCameraRecordingManager *)v15 cameraLoadBalancer];
  __int16 v26 = [(HMDCameraRecordingManager *)v15 cameraUUID];
  char v27 = [v25 isReadyToRecordForCameraWithUUID:v26];
  ...
  if ((v27 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v54 = v38;
      _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_ERROR, "%{public}@Unable to start recording session, no backing store available", buf, 0xCu);
    }
    __int16 v33 = (void *)MEMORY[0x263F087E8];
    uint64_t v34 = 3302;
    goto LABEL_15;
  }
  uint64_t v28 = [(HMDCameraRecordingManager *)v15 currentBulkSendSessionReader];
  ...
  if (v28)
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v54 = v32;
      _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_INFO, "%{public}@A bulk send session is already opened", buf, 0xCu);
    }
    __int16 v33 = (void *)MEMORY[0x263F087E8];
    uint64_t v34 = 3303;
LABEL_15:
    uint64_t v39 = [v33 hmInternalErrorWithCode:v34];
    ((void (**)(id, void *))v12)[2](v12, v39);

    goto LABEL_16;
  }
  v40 = [(HMDCameraRecordingManager *)v15 bulkSendSessionInitiator];
  int v41 = [v40 isSessionOpenInProgress];
  ...
  if (v41)
  {
    if (v45)
    {
      ...
      *(_DWORD *)buf = 138543362;
      v54 = v46;
      _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_INFO, "%{public}@A bulk send session open is already in progress", buf, 0xCu);
    }
    __int16 v33 = (void *)MEMORY[0x263F087E8];
    uint64_t v34 = 3304;
    goto LABEL_15;
  ...
  if (v45)
  {
    ...
    *(_DWORD *)buf = 138543362;
    v54 = v47;
    _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_INFO, "%{public}@Opening new bulk send session", buf, 0xCu);
  }
  v48 = [(HMDCameraRecordingManager *)v43 bulkSendSessionInitiator];
  v49[0] = MEMORY[0x263EF8330];
  v49[1] = 3221225472;
  v49[2] = __110__HMDCameraRecordingManager__startRecordingSessionForTrigger_reason_selectedConfiguration_completionCallback___block_invoke;
  v49[3] = &unk_264A14990;
  v49[4] = v43;
  v51 = v12;
  id v50 = v11;
  unint64_t v52 = a3;
  [v48 openNewSessionWithCallback:v49];

LABEL_16:
}

void __110__HMDCameraRecordingManager__startRecordingSessionForTrigger_reason_selectedConfiguration_completionCallback___block_invoke(uint64_t a1, void *a2, void *a3)
{
  uint64_t v28 = *MEMORY[0x263EF8340];
  id v5 = a2;
  id v6 = a3;
  ...
  if (v5)
  {
    id v8 = [*(id *)(a1 + 32) _createRecordingSessionWithSelectedConfiguration:*(void *)(a1 + 40)];
    if (v8)
    {
      id v9 = (void *)MEMORY[0x230FBD990]();
      id v10 = *(id *)(a1 + 32);
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v26 = 2112;
        id v27 = v8;
        _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Created recording session: %@", (uint8_t *)&v24, 0x16u);
      }
      [*(id *)(a1 + 32) setCurrentRecordingSession:v8];
      uint64_t v13 = [*(id *)(a1 + 32) activeRecordingSessions];
      [v13 addObject:v8];

      [*(id *)(a1 + 32) _configureRecordingSession:v8 withTrigger:*(void *)(a1 + 56)];
    ...
    else
    {
      ...
      uint64_t v23 = [MEMORY[0x263F087E8] hmErrorWithCode:23];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v26 = 2112;
      id v27 = v6;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to open bulk send session: %@", (uint8_t *)&v24, 0x16u);
    }
    (*(void (**)(void))(*(void *)(a1 + 48) + 16))();
  }
}
...
- (void)_prepareRecordingSessionForTrigger:(unint64_t)a3 reason:(id)a4 completionCallback:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v35 = 2112;
    id v36 = v8;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Configuring recording session with reason: %@", buf, 0x16u);
  }
  double v14 = [HMDCameraRecordingSessionLogEvent alloc];
  uint64_t v15 = [(HMDCameraRecordingManager *)v11 accessory];
  double v16 = [v15 identifier];
  double v17 = [(HMDCameraRecordingSessionLogEvent *)v14 initWithAccessoryIdentifier:v16];
  [(HMDCameraRecordingManager *)v11 setRecordingSessionLogEvent:v17];

  v18 = [(HMDCameraRecordingManager *)v11 sessionRetryContext];

  if (v18)
  {
    id v19 = [(HMDCameraRecordingManager *)v11 sessionRetryContext];
    uint64_t v20 = [v19 retryCount];
    __int16 v21 = [(HMDCameraRecordingManager *)v11 recordingSessionLogEvent];
    [v21 setRetryCount:v20];
  }
  ...
  int v24 = [(HMDCameraRecordingManager *)v11 recordingSettingsControl];
  ...
  id v25 = v8;
  id v26 = v23;
  [v24 configureCameraRecordingSettingsWithCompletion:v27];
}
...
void __90__HMDCameraRecordingManager__prepareRecordingSessionForTrigger_reason_completionCallback___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    [*(id *)(a1 + 32) _startRecordingSessionForTrigger:*(void *)(a1 + 56) reason:*(void *)(a1 + 40) selectedConfiguration:v5 completionCallback:*(void *)(a1 + 48)];
  }
  else
  {
    double v7 = (void *)MEMORY[0x230FBD990]();
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v13 = 2112;
      id v14 = v6;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to configure camera recording settings: %@", (uint8_t *)&v11, 0x16u);
    }
    (*(void (**)(void))(*(void *)(a1 + 48) + 16))();
  }
}
...
- (void)_prepareRecordingSessionForTrigger:(unint64_t)a3 reason:(id)a4
{
  ...
  [(HMDCameraRecordingManager *)self _prepareRecordingSessionForTrigger:a3 reason:v7 completionCallback:&__block_literal_global_1925];
}
...
- (void)_submitRecordingSessionLogEventWithError:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v11 = 138543362;
      v12 = v10;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@There is no recording session log event to submit.", (uint8_t *)&v11, 0xCu);
    }
  }
}
...
- (void)handleStartRecordingSessionRequest:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v25 = 2112;
    id v26 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Received message to handle recording session: %@", buf, 0x16u);
  }
  int v11 = [v4 messagePayload];
  [(HMDCameraRecordingManager *)v7 assignAccessoryConnectionInfoUsingMessagePayload:v11];

  v12 = [v4 messagePayload];
  uint64_t v13 = objc_msgSend(v12, "hmf_numberForKey:", @"notificationTriggerType");
  ...
  if (v13)
  {
    ...
    v21[3] = &unk_264A2F3E8;
    id v22 = v4;
    [(HMDCameraRecordingManager *)v7 _prepareRecordingSessionForTrigger:v14 reason:@"request from primary resident" completionCallback:v21];
    uint64_t v15 = v22;
  }
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v25 = 2112;
      id v26 = v20;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Could not find trigger in message payload: %@", buf, 0x16u);
    }
...
- (void)assignAccessoryConnectionInfoUsingMessagePayload:(id)a3
{
  ...
  if (v5)
  {
    id v6 = (void *)[objc_alloc(MEMORY[0x263F35AA0]) initWithDictionary:v5];
    if (v6)
    {
      id v7 = objc_msgSend(v4, "hmf_dictionaryForKey:", @"HMDCameraRecordingAccessoryBonjourDeviceInfo");
      ...
      if (v7)
      {
        if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
        {
          ...
          int v23 = 138543362;
          int v24 = v12;
          _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Assigning connection info to accessory", (uint8_t *)&v23, 0xCu);
        }
      ...
      else
      {
        if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
        {
          ...
          int v23 = 138543362;
          int v24 = v22;
          _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEBUG, "%{public}@No bonjour device info received for start recording session request", (uint8_t *)&v23, 0xCu);
        }
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v25 = 2112;
        id v26 = v5;
        _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to create HAPSocketInfo for start recording request with dictionary: %@", (uint8_t *)&v23, 0x16u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
    {
      ...
      int v23 = 138543362;
      int v24 = v17;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_DEBUG, "%{public}@No socket info received for start recording session request", (uint8_t *)&v23, 0xCu);
    }
  }
}
...
- (id)_createRecordingSessionWithSelectedConfiguration:(id)a3
{
  ...
  id v7 = [v6 hapAccessory];
  id v8 = [v7 home];
  id v9 = [v6 clipManager];
  id v10 = [v9 localZone];

  if (v6 && v7 && v8 && v10)
  {
    BOOL v11 = [v4 generalConfiguration];
    v12 = [v11 mediaContainerConfigurations];
    uint64_t v13 = [v12 firstObject];
    [v13 parameters];
    id v14 = v36 = v8;
    [v14 fragmentLength];
    v15 = uint64_t v37 = v10;
    [v15 doubleValue];
    double v17 = v16 / 1000.0;

    v18 = [v4 generalConfiguration];
    id v19 = [v18 prebufferLength];
    [v19 doubleValue];
    double v21 = v20;

    id v22 = [MEMORY[0x263EFF910] dateWithTimeIntervalSinceNow:v21 / -1000.0];
    int v23 = [(HMDCameraRecordingManager *)self dependencyFactory];
    int v24 = [(HMDCameraRecordingManager *)self workQueue];
    __int16 v25 = [v6 uniqueIdentifier];
    id v26 = [v25 UUIDString];
    uint64_t v27 = [v23 createTimelineManagerWithWorkQueue:v24 fragmentDuration:v22 fragmentCreationReferenceDate:v26 logIdentifier:v17];

    id v8 = v36;
    id v28 = [(HMDCameraRecordingManager *)self dependencyFactory];
    id v29 = [(HMDCameraRecordingManager *)self workQueue];
    unint64_t v30 = [v28 createRecordingSessionWithWorkQueue:v29 camera:v6 hapAccessory:v7 home:v36 localZone:v37 configuredFragmentDuration:v27 timelineManager:v17];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      __int16 v46 = 2112;
      v47 = v10;
      _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_ERROR, "%{public}@Cannot start recording session because camera=%@ accessory=%@ home=%@ localZone=%@", buf, 0x34u);
    }
    unint64_t v30 = 0;
  }
...
{
  id v5 = a3;
  __int16 v35 = [v5 analysisNode];
  id v6 = [v35 metrics];
  __int16 v33 = objc_msgSend(v6, "hmf_dictionaryForKey:", @"recordingSessionSummaries");
  ...
  int v23 = objc_msgSend(NSNumber, "numberWithInteger:", objc_msgSend(v5, "numberOfAvailableDevices"));
  id v26 = [NSNumber numberWithUnsignedInteger:a4];
  ...
  unint64_t v30 = [v35 residentDevice];
  id v28 = [v30 device];
  uint64_t v27 = [v28 productInfo];
  [v27 productClass];
  double v21 = HMFProductClassToString();
  int v24 = [v35 metrics];
  ...
  double v16 = [v15 objectForKeyedSubscript:@"numberOfFullJobSlots"];
  double v17 = [v35 metrics];
  v18 = [v17 objectForKeyedSubscript:@"numberOfPartialJobSlots"];
  LOBYTE(v20) = v31;
  id v32 = [(HMDCameraRecordingLoadBalancerLogEvent *)v29 initWithNumberOfResidents:v23 numberOfRetries:v26 totalNumberOfJobSlots:v25 remainingNumberOfJobSlots:v12 selectedResidentDeviceType:v21 selectedResidentNumberOfActiveStreams:v13 selectedResidentSystemResourceUsageLevel:v14 selectedResidentJobSlots:v16 selectedResidentPartialJobSlots:v18 selectedResidentHasActiveSessionWithCamera:v20];

  id v19 = [(HMDCameraRecordingManager *)self logEventSubmitter];
...
- (void)_forwardRecordingSessionForTrigger:(unint64_t)a3 withLoadBalancerDecision:(id)a4 deviceFilter:(id)a5 sessionCoordinationLogEvent:(id)a6 retryAttemptNumber:(int64_t)a7
{
  ...
  int v41 = [v12 analysisNode];
  __int16 v40 = [v41 residentDevice];
  double v16 = [v40 device];
  unint64_t v39 = a3;
  if ([v16 isCurrentDevice])
  {
    double v17 = (void *)MEMORY[0x230FBD990]();
    v18 = self;
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v51 = v20;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@We are the best device for recording session, starting locally", buf, 0xCu);
    }
    [v14 setUsingRemoteDeviceAnalysisNode:0];
    [(HMDCameraRecordingManager *)v18 _prepareRecordingSessionForTrigger:v39 reason:@"current device picked itself"];
    [(HMDCameraRecordingManager *)v18 _submitLoadBalancingEventWithDecision:v12 numberOfRetries:a7];
    double v21 = [(HMDCameraRecordingManager *)v18 logEventSubmitter];
    [(HMDRemoteDeviceMessageDestination *)v21 submitLogEvent:v14];
    id v22 = v40;
  }
  else
  {
    ...
    int v23 = [HMDRemoteDeviceMessageDestination alloc];
    int v24 = [(HMDCameraRecordingManager *)self messageTargetUUID];
    double v21 = [(HMDRemoteDeviceMessageDestination *)v23 initWithTarget:v24 device:v16];

    id v36 = [(HMDCameraRecordingManager *)self messagePayloadForStartRecordingSessionWithTriggerType:a3];
    id v38 = [[HMDRemoteMessage alloc] initWithName:@"kStartRecordingSessionRequestKey" qualityOfService:25 destination:v21 payload:v36 type:0 timeout:1 secure:120.0];
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      v29 = id v35 = v12;
      unint64_t v30 = [(HMFObject *)v38 shortDescription];
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v54 = 2114;
      __int16 v55 = v30;
      _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Forwarding recording session to %{public}@ via message: %{public}@", buf, 0x20u);

      id v12 = v35;
    }

    BOOL v31 = [(HMDCameraRecordingManager *)v26 dependencyFactory];
    id v32 = [(HMDCameraRecordingManager *)v26 logIdentifier];
    __int16 v33 = [v31 createLoadBalancingAttemptWithLocalResponseTimeout:v32 logIdentifier:2.0];

    uint64_t v34 = [(HMDCameraRecordingManager *)v26 msgDispatcher];
    v42[0] = MEMORY[0x263EF8330];
    v42[1] = 3221225472;
    v42[2] = __149__HMDCameraRecordingManager__forwardRecordingSessionForTrigger_withLoadBalancerDecision_deviceFilter_sessionCoordinationLogEvent_retryAttemptNumber___block_invoke;
    v42[3] = &unk_264A14940;
    v42[4] = v26;
    id v43 = v16;
    id v44 = v14;
    ...
    id v47 = v37;
    unint64_t v49 = v39;
    [v33 startWithMessage:v38 messageDispatcher:v34 completion:v42];
  }
}
...
LABEL_11:
        _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, v9, buf, 0x20u);
...
LABEL_13:
    ...
    if (v18 == 21)
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        int v24 = [*(id *)(a1 + 40) shortDescription];
        *(_DWORD *)buf = 138543874;
        v74 = v23;
        __int16 v75 = 2114;
        v76 = v24;
        __int16 v77 = 2112;
        id v78 = v3;
        _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Received error that accessory is not configured from device %{public}@: %@", buf, 0x20u);
      }
      ...
      block[0] = MEMORY[0x263EF8330];
      block[1] = 3221225472;
      block[2] = __149__HMDCameraRecordingManager__forwardRecordingSessionForTrigger_withLoadBalancerDecision_deviceFilter_sessionCoordinationLogEvent_retryAttemptNumber___block_invoke_73;
      block[3] = &unk_264A2F7F8;
      block[4] = *(void *)(a1 + 32);
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v77 = 2112;
      id v78 = v3;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to forward recording session to device %{public}@: %@", buf, 0x20u);
    }
    ...
    unint64_t v30 = [HMDCameraRecordingSessionCoordinationLogEvent alloc];
    [*(id *)(a1 + 48) startTime];
    ...
    if (!v31)
    {
      ...
      if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v74 = v46;
        _os_log_impl(&dword_22F52A000, v45, OS_LOG_TYPE_ERROR, "%{public}@Camera reference is nil", buf, 0xCu);
      }
      id v47 = [*(id *)(a1 + 32) logEventSubmitter];
      int64_t v48 = [MEMORY[0x263F087E8] hmErrorWithCode:20];
    ...
    aBlock[0] = MEMORY[0x263EF8330];
    aBlock[1] = 3221225472;
    aBlock[2] = __149__HMDCameraRecordingManager__forwardRecordingSessionForTrigger_withLoadBalancerDecision_deviceFilter_sessionCoordinationLogEvent_retryAttemptNumber___block_invoke_74;
    aBlock[3] = &unk_264A148F0;
    id v70 = *(id *)(a1 + 64);
    id v71 = *(id *)(a1 + 72);
    id v32 = _Block_copy(aBlock);
    __int16 v33 = [*(id *)(a1 + 32) cameraLoadBalancer];
    uint64_t v34 = [v33 loadBalancingDecisionForCamera:v31 deviceFilter:v32];

    if (*(uint64_t *)(a1 + 80) < 3)
    {
      unint64_t v49 = [v34 analysisNode];

      if (v49)
      {
        id v50 = [*(id *)(a1 + 32) workQueue];
        v63[0] = MEMORY[0x263EF8330];
        v63[1] = 3221225472;
        v63[2] = __149__HMDCameraRecordingManager__forwardRecordingSessionForTrigger_withLoadBalancerDecision_deviceFilter_sessionCoordinationLogEvent_retryAttemptNumber___block_invoke_75;
        v63[3] = &unk_264A14918;
...
LABEL_36:
      ...
      if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v75 = 2112;
        v76 = v58;
        _os_log_impl(&dword_22F52A000, v56, OS_LOG_TYPE_ERROR, "%{public}@Exhausted devices, failed to start recording session for accessory %@", buf, 0x16u);

        double v17 = v61;
      }

      __int16 v40 = [*(id *)(a1 + 32) logEventSubmitter];
      int v41 = (void *)MEMORY[0x263F087E8];
      uint64_t v42 = 3301;
    }
    else
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
      {
        HMFGetLogIdentifier();
        id v38 = v60 = v17;
        unint64_t v39 = [*(id *)(a1 + 32) accessory];
        *(_DWORD *)buf = 138543618;
        v74 = v38;
        __int16 v75 = 2112;
        v76 = v39;
        _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_ERROR, "%{public}@Reached retry limit, failed to start recording session for accessory %@", buf, 0x16u);
    ...
    v59 = [v41 hmInternalErrorWithCode:v42];
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v75 = 2114;
    v76 = v14;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Successfully forwarded recording session to %{public}@", buf, 0x16u);
  }
...
void __149__HMDCameraRecordingManager__forwardRecordingSessionForTrigger_withLoadBalancerDecision_deviceFilter_sessionCoordinationLogEvent_retryAttemptNumber___block_invoke_73(uint64_t a1)
{
  id v1 = [*(id *)(a1 + 32) recordingSettingsControl];
  [v1 handleAccessoryIsNotConfiguredError];
}

uint64_t __149__HMDCameraRecordingManager__forwardRecordingSessionForTrigger_withLoadBalancerDecision_deviceFilter_sessionCoordinationLogEvent_retryAttemptNumber___block_invoke_74(uint64_t a1, void *a2)
{
  id v3 = a2;
...
uint64_t __149__HMDCameraRecordingManager__forwardRecordingSessionForTrigger_withLoadBalancerDecision_deviceFilter_sessionCoordinationLogEvent_retryAttemptNumber___block_invoke_75(uint64_t a1)
{
...
- (id)messagePayloadForStartRecordingSessionWithTriggerType:(unint64_t)a3
{
  ...
  id v7 = [(HMDCameraRecordingManager *)self accessory];
  id v8 = [v7 socketInfo];
  if (v8)
  {
    id v9 = (void *)MEMORY[0x230FBD990]();
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      id v13 = [v8 dictionaryRepresentation];
      int v22 = 138543618;
      int v23 = v12;
      __int16 v24 = 2112;
      __int16 v25 = v13;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Adding socket info to outgoing start recording message payload: %@", (uint8_t *)&v22, 0x16u);
    }
    id v14 = [v8 dictionaryRepresentation];
    [v5 setObject:v14 forKeyedSubscript:@"HMDCameraRecordingAccessorySocketInfo"];
  }
  uint64_t v15 = [v7 bonjourDeviceInfo];
  if (v15)
  {
    double v16 = (void *)MEMORY[0x230FBD990]();
    double v17 = self;
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v24 = 2112;
      __int16 v25 = v15;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Adding bonjour device info to outgoing start recording message: %@", (uint8_t *)&v22, 0x16u);
    }
    [v5 setObject:v15 forKeyedSubscript:@"HMDCameraRecordingAccessoryBonjourDeviceInfo"];
  }
  id v20 = (void *)[v5 copy];
  ...
  if (v7)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        __int16 v24 = v20;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@No device found for recording session, optimistically trying self", buf, 0xCu);
      }
      double v21 = [(HMDCameraRecordingManager *)v18 logEventSubmitter];
      [v21 submitLogEvent:v5];

      [(HMDCameraRecordingManager *)v18 _prepareRecordingSessionForTrigger:a3 reason:@"primary resident picked itself"];
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v25 = 2112;
      uint64_t v26 = v15;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Camera object with UUID:%@ is nil", buf, 0x16u);
    }
    id v9 = [(HMDCameraRecordingManager *)v12 logEventSubmitter];
    double v16 = [MEMORY[0x263F087E8] hmErrorWithCode:20];
...
uint64_t __68__HMDCameraRecordingManager__loadBalanceRecordingSessionForTrigger___block_invoke(uint64_t a1, void *a2)
{
  ...
  double v17 = [MEMORY[0x263F42608] sharedPreferences];
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v33 = 2112;
    uint64_t v34 = v28;
    _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@Excluding current device from camera recording load balancing because it is the primary resident: %@", (uint8_t *)&v31, 0x16u);
  }
LABEL_18:
  uint64_t v29 = 0;
LABEL_20:
  ...
  if (v6)
  {
    ...
    if (!v8)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        unint64_t v39 = v22;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Cannot coordinate recording session because accessory reference is nil", buf, 0xCu);
      }
      goto LABEL_21;
    }
    id v10 = [v8 home];
      ...
      if ([v10 isCurrentDeviceConfirmedPrimaryResident])
      {
        ...
        if (HMIsRecordingAllowedForCameraAccessMode())
        {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              unint64_t v39 = v35;
              _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_INFO, "%{public}@Synchronizing settings with camera because settings have recording enabled, but camera is not configured for recording", buf, 0xCu);
            }
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v40 = 2112;
          int v41 = v31;
          _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@Current access mode does not allow recording: %@", buf, 0x16u);
        }
LABEL_19:
...
LABEL_21:
    ...
    _os_log_impl(&dword_22F52A000, v28, v29, v27, buf, 0xCu);
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    unint64_t v39 = v18;
    _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Cannot coordinate recording session because camera reference is nil", buf, 0xCu);
  }
LABEL_22:
}
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v13 = 2112;
      id v14 = v3;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to synchronize settings with camera while coordinating recording session: %@", buf, 0x16u);
    }
  }
  else
  {
    ...
    v10[1] = 3221225472;
    v10[2] = __67__HMDCameraRecordingManager__coordinateRecordingSessionForTrigger___block_invoke_55;
    v10[3] = &unk_264A2C6A0;
...
uint64_t __67__HMDCameraRecordingManager__coordinateRecordingSessionForTrigger___block_invoke_55(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    int v8 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Successfully synchronized settings with camera while coordinating recording session", (uint8_t *)&v7, 0xCu);
  }
...
- (void)_clipManagerDidStartUpCloudZone
{
  ...
  if ([(HMDCameraRecordingManager *)self didShutDown])
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      int v14 = 138543362;
      uint64_t v15 = v7;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Ignoring clipManagerDidStartUpCloudZone because recording manager was shut down", (uint8_t *)&v14, 0xCu);
    }
  }
  else
  {
    ...
    if ([(HMDCameraRecordingManager *)self isMotionActive])
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        int v14 = 138543362;
        uint64_t v15 = v13;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Clip manager started up cloud zone and motion is active, attempting to coordinate a recording session", (uint8_t *)&v14, 0xCu);
      }
...
- (void)_shutDown
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    id v11 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Shutting down", (uint8_t *)&v10, 0xCu);
  }
...
- (void)_start
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    unint64_t v30 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Starting", buf, 0xCu);
  }
  int v8 = [(HMDCameraRecordingManager *)v5 cameraLoadBalancer];
  uint64_t v9 = [(HMDCameraRecordingManager *)v5 cameraUUID];
  [v8 setReadyToRecord:0 forCameraWithUUID:v9];
  ...
  double v21 = [(HMDCameraRecordingManager *)v5 camera];
  int v22 = [(HMDCameraRecordingManager *)v5 msgDispatcher];
  v28[0] = v18;
  v28[1] = v20;
  int v23 = [MEMORY[0x263EFF8C0] arrayWithObjects:v28 count:2];
...
- (void)recordingSettingsControlDidConfigure:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    int v21 = 138543362;
    int v22 = v9;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Recording settings control did configure", (uint8_t *)&v21, 0xCu);
  }
  BOOL v10 = [(HMDCameraRecordingManager *)v7 didShutDown];
  os_log_type_t v11 = (void *)MEMORY[0x230FBD990]();
  uint32_t v12 = v7;
  ...
  if (v10)
  {
    if (v14)
    {
      ...
      int v21 = 138543362;
      int v22 = v15;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Ignoring recordingSettingsControlDidConfigure: because recording manager was shut down", (uint8_t *)&v21, 0xCu);
    }
  }
  else
  {
    if (v14)
    {
      ...
      int v21 = 138543362;
      int v22 = v16;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Closing current session if one exists because recording settings have been configured", (uint8_t *)&v21, 0xCu);
    }
    ...
    if ([(HMDCameraRecordingManager *)v12 isMotionActive])
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        int v21 = 138543362;
        int v22 = v20;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Motion is active and camera did configure successfully, attempting to coordinate a recording session", (uint8_t *)&v21, 0xCu);
      }
...
void __48__HMDCameraRecordingManager_clipManagerDidStop___block_invoke(uint64_t a1)
{
  ...
  if ([*(id *)(a1 + 32) didShutDown])
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      int v12 = 138543362;
      int v13 = v5;
      _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Ignoring clipManagerDidStop: because recording manager was shut down", (uint8_t *)&v12, 0xCu);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      int v12 = 138543362;
      int v13 = v11;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Closing current session because clip manager became unavailable", (uint8_t *)&v12, 0xCu);
    }
    [*(id *)(a1 + 32) _closeCurrentSessionsWithReason:3];
  }
}
...
LABEL_15:
    ...
    id v20 = (void *)MEMORY[0x230FBD990]([(HMDCameraRecordingManager *)self _resetRetryContextWithReason:@"Received recording session trigger from accessory"]);
    int v21 = self;
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v26 = 2048;
      unint64_t v27 = a4;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Coordinating recording session for active trigger of type %lu", (uint8_t *)&v24, 0x16u);
    }
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    int v24 = 138543362;
    __int16 v25 = v13;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Ignoring notificationTrigger:didObserveTriggerType:changeToActive: because recording manager was shut down", (uint8_t *)&v24, 0xCu);
  }
LABEL_16:
}
...
- (NSDictionary)stateDump
{
  ...
  os_log_type_t v11 = &unk_264A2F820;
  id v12 = v3;
  int v13 = self;
  id v5 = v3;
  dispatch_sync(v4, &v8);
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Camera recording manager: %p destroyed", buf, 0x16u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t63 != -1) {
    dispatch_once(&logCategory__hmf_once_t63, &__block_literal_global_100);
  }
...
void __40__HMDCameraRecordingManager_logCategory__block_invoke()
{
  ...
  id v1 = (void *)logCategory__hmf_once_v64;
  logCategory__hmf_once_id v64 = v0;
}
