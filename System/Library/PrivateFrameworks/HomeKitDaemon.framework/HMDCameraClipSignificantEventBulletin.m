...
- (id)createUserInfoWithWithSignificantEvents:(id)a3 previewImageNotificationUUID:(id)a4 camera:(id)a5 home:(id)a6 accessory:(id)a7 recordingService:(id)a8 clipUUID:(id)a9
{
  ...
  v24 = objc_msgSend(v19, "na_map:", &__block_literal_global_67_233223);
  v41 = [v24 allObjects];

  uint64_t v25 = objc_msgSend(v19, "na_any:", &__block_literal_global_69);
  uint64_t v26 = *MEMORY[0x263F0BAA8];
  v43[0] = *MEMORY[0x263F0BAB0];
  v43[1] = v26;
  v44[0] = v41;
  v44[1] = v21;
  v43[2] = *MEMORY[0x263F0BAA0];
  v27 = [v18 UUIDString];

  uint64_t v28 = *MEMORY[0x263F0BAC8];
  v44[2] = v27;
  v44[3] = v23;
  uint64_t v29 = *MEMORY[0x263F0DCC0];
  v43[3] = v28;
  v43[4] = v29;
  ...
  v44[8] = v34;
  v35 = [NSDictionary dictionaryWithObjects:v44 forKeys:v43 count:9];
  v36 = (void *)[v35 mutableCopy];

  v37 = [v42 UUIDString];

  [v36 setObject:v37 forKeyedSubscript:*MEMORY[0x263F0BA98]];
  v38 = (void *)[v36 copy];
...
+ (id)actionURLForHomeUUID:(id)a3 cameraUUID:(id)a4
{
  v5 = (void *)MEMORY[0x263F0E140];
  id v6 = a4;
  v7 = [v5 tupleWithQueryType:0 uuidString:a3];
  v8 = [MEMORY[0x263F0E140] tupleWithQueryType:5 uuidString:v6];
...
+ (id)localizedMessageForSignificantEvents:(id)a3 cameraAccessory:(id)a4
{
  ...
  v10 = objc_msgSend(v9, "na_map:", &__block_literal_global_233265);
  SEL v55 = v10;
  id v56 = v9;
  if ([v10 count])
  {
