...
{
  v3 = NSString;
  v4 = [(HMDNetworkRouterAccessViolationControl *)self operation];
  v5 = [(HMDNetworkRouterAccessViolationControl *)self clientIdentifierList];
  v6 = [v3 stringWithFormat:@"<HMDNetworkRouterAccessViolationControl operation=%@, clientIdentifierList=%@>", v4, v5];
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      v6 = v5;
      v7 = [(HMDNetworkRouterAccessViolationControl *)self operation];
      v8 = [(HMDNetworkRouterAccessViolationControl *)v6 operation];
      if (v7 != v8)
      {
        v9 = [(HMDNetworkRouterAccessViolationControl *)self operation];
        v3 = [(HMDNetworkRouterAccessViolationControl *)v6 operation];
        if (![v9 isEqual:v3])
        {
          char v10 = 0;
LABEL_13:
...
LABEL_14:
      ...
      v11 = [(HMDNetworkRouterAccessViolationControl *)self clientIdentifierList];
      v12 = [(HMDNetworkRouterAccessViolationControl *)v6 clientIdentifierList];
      if (v11 == v12)
      {
        char v10 = 1;
      }
      ...
      {
        v13 = [(HMDNetworkRouterAccessViolationControl *)self clientIdentifierList];
        v14 = [(HMDNetworkRouterAccessViolationControl *)v6 clientIdentifierList];
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = +[HMDNetworkRouterAccessViolationControl allocWithZone:a3];
  v5 = [(HMDNetworkRouterAccessViolationControl *)self operation];
  v6 = [(HMDNetworkRouterAccessViolationControl *)self clientIdentifierList];
  v7 = [(HMDNetworkRouterAccessViolationControl *)v4 initWithOperation:v5 clientIdentifierList:v6];
...
- (id)serializeWithError:(id *)a3
{
  ...
  if (v5)
  {
    v6 = [(HMDNetworkRouterAccessViolationControl *)self operation];
    id v19 = 0;
...
LABEL_12:
  ...
  v12 = [(HMDNetworkRouterAccessViolationControl *)self clientIdentifierList];
  id v18 = 0;
...
- (HMDNetworkRouterAccessViolationControl)initWithOperation:(id)a3 clientIdentifierList:(id)a4
{
  ...
  uint64_t v9 = [(HMDNetworkRouterAccessViolationControl *)&v12 init];
  int v10 = v9;
  if (v9)
  {
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HMDNetworkRouterAccessViolationControl);
  id v7 = v6;
  if (v6)
  {
    id v10 = 0;
    [(HMDNetworkRouterAccessViolationControl *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
