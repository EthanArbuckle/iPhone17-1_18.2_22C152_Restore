    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v19 = 2112;
        v20 = v14;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@[%@] Not available session for accessory", buf, 0x16u);
      }
      v4 = [MEMORY[0x263F087E8] hmErrorWithCode:3 description:0 reason:@"Invalid state: session not available for accessory" suggestion:0];
      (*((void (**)(void))a1[5] + 2))();
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v19 = 2112;
      v20 = v9;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@[%@] Accessory not registered", buf, 0x16u);
    }
    v3 = [MEMORY[0x263F087E8] hmErrorWithCode:3 description:0 reason:@"accessory not registered" suggestion:0];
    (*((void (**)(void))a1[5] + 2))();
  }
}
...
- (id)UARPAccessoryForHMDAccessory:(id)a3
{
  ...
  if ([v4 identityType])
  {
    ...
    if (!v6)
    {
      char v6 = (void *)[objc_alloc(MEMORY[0x263F38308]) initWithHMDHAPAccessory:v4];
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v27 = 2112;
        v28 = v12;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEBUG, "%{public}@[%@] Initialized UARP Accessory %@ from HAP Accessory %@", (uint8_t *)&v21, 0x2Au);
      }
      if (v6)
      {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v25 = 2112;
      v26 = v19;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@[%@] Unknown identity type for %@", (uint8_t *)&v21, 0x20u);
    }
    char v6 = 0;
  }
...
- (id)findHMDHAPAccessoryWithUARPAccessory:(id)a3
{
  ...
  if (v7)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v25 = 2112;
        id v26 = v8;
        _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Accessory %@ is not a HAPAccessory", (uint8_t *)&v23, 0x16u);
      }
      id v12 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v25 = 2112;
      id v26 = v17;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Accessory %@ not found in homes", (uint8_t *)&v23, 0x16u);
    }
    id v12 = 0;
  }
...
- (id)addSessionForUARPAccessory:(id)a3
{
  ...
  if ([(HMDAccessoryFirmwareUpdateManager *)self supportsFirmwareUpdate])
  {
    ...
    if (v5)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v32 = 2112;
        id v33 = v4;
        _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@[%@] Created session %@ for accessory", (uint8_t *)&v28, 0x20u);
      }
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v32 = 2112;
        id v33 = v8;
        _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] New firmwareUpdateSession %@", (uint8_t *)&v28, 0x20u);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v30 = 2112;
        id v31 = v4;
        _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Couldn't find HAPAccessory from UARPHomeKitAccessory %@", (uint8_t *)&v28, 0x16u);
      }
      id v8 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v28 = 138543362;
      uint64_t v29 = v24;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@Firmware Update not enabled on this device; ignoring",
        (uint8_t *)&v28,
        0xCu);
    }
    id v8 = 0;
...
- (void)removeSession:(id)a3
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v4;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@[%@] Removing session %@", (uint8_t *)&v17, 0x20u);
    }
    p_lock = &v8->_lock;
    os_unfair_lock_lock_with_options();
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      int v17 = 138543362;
      v18 = v16;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@removeSession: No accessory UUID exists", (uint8_t *)&v17, 0xCu);
    }
  }
}
...
- (void)timerDidFire:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    v15 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Default asset source: %@", (uint8_t *)&v12, 0x16u);
  }
  id v11 = [(HMDAccessoryFirmwareUpdateManager *)v7 activeSessions];
  [v11 enumerateKeysAndObjectsUsingBlock:&__block_literal_global_93];
}
...
- (void)startStatusTimer
{
  v3 = (void *)[objc_alloc(MEMORY[0x263F42658]) initWithTimeInterval:13 options:86400.0];
...
- (BOOL)checkForUpdateForAccessory:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v16 = 2112;
      int v17 = v12;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] Cannot check for update for accessory - unsupported", (uint8_t *)&v14, 0x16u);
    }
    char v7 = 0;
  }
...
LABEL_13:
        _os_log_impl(&dword_22F52A000, v19, v20, v18, v28, 0x20u);
      }
    }
...
LABEL_15:
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_WORD *)&v28[22] = 2112;
    uint64_t v29 = v26;
    _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] Not unregistering accessory %@ - unsupported", v28, 0x20u);
  }
LABEL_16:
}
  ...
  if (v16)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v81 = 2112;
      v82 = v26;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_DEBUG, "%{public}@[%@] Setting userInitiatedFirmwareStaging to %@", buf, 0x20u);
    ...
    if ((v28 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v79 = 2112;
        v80 = v41;
        _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_ERROR, "%{public}@[%@] Cannot change source for unregistered accessory", buf, 0x16u);
      }
      ...
      if (os_log_type_enabled(v44, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v83 = 2112;
        v84 = v48;
        _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_DEBUG, "%{public}@[%@] Looking for %@ in accessoryList %@", buf, 0x2Au);

        id v13 = v47;
      }

      v36 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
      id v14 = v74;
      goto LABEL_33;
    }
    if (a4 == 2)
      ...
      if (![v13 length])
      {
        ...
        if (os_log_type_enabled(v63, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v81 = 2112;
          v82 = v67;
          _os_log_impl(&dword_22F52A000, v63, OS_LOG_TYPE_ERROR, "%{public}@[%@] Invalid path for asset source %@", buf, 0x20u);

          id v13 = v66;
          id v14 = v74;
        }
        v36 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
        goto LABEL_33;
      }
      id v29 = objc_alloc(MEMORY[0x263F38320]);
      uint64_t v30 = 0;
    }
    else
    {
    ...
    if (v13)
    {
      id v31 = [NSURL fileURLWithPath:v13 isDirectory:0];
      if (v14)
      {
LABEL_10:
        __int16 v32 = [NSURL fileURLWithPath:v14 isDirectory:0];
        ...
        if (v49)
        {
          if (os_log_type_enabled(v52, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138544898;
            ...
            __int16 v89 = 2112;
            v90 = v33;
            _os_log_impl(&dword_22F52A000, v53, OS_LOG_TYPE_INFO, "%{public}@[%@] Successfully changed source to %@ %@ %@ for accessory <%@> asset <%@>", buf, 0x48u);
        ...
        else
        {
          if (os_log_type_enabled(v52, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138544642;
            ...
            __int16 v87 = 2112;
            id v88 = v59;
            _os_log_impl(&dword_22F52A000, v53, OS_LOG_TYPE_ERROR, "%{public}@[%@] Failed to change source to %@ %@ %@ for accessory %@", buf, 0x3Eu);

            id v13 = v73;
            id v14 = v74;
          }
          v36 = [MEMORY[0x263F087E8] hmErrorWithCode:-1];
        }
...
LABEL_33:
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v79 = 2112;
    v80 = v35;
    _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@[%@] Cannot change source for unsupported accessory", buf, 0x16u);
  }
  v36 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
LABEL_34:
  ...
  if (![(HMDAccessoryFirmwareUpdateManager *)self isAccessoryRegistered:v8])
  {
       ...
       || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0))&& [v8 supportsCHIP])
    {
      ...
      if (v21)
      {
        ...
        int v23 = [v22 isEqualToNumber:&unk_26E472598] ^ 1;
      }
      else
      {
        int v23 = 0;
      ...
      if (v24)
      {
        ...
        int v160 = [v25 isEqualToNumber:&unk_26E472598] ^ 1;
      }
      else
      {
        int v160 = 0;
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544898;
        ...
        __int16 v181 = 2112;
        v182 = v37;
        _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_INFO, "%{public}@[%@] Matter AFU Settings: hasMatterFirmwareUpdateProfile: %@, hasMatterFirmwareRevisionNumber: %@, hasMatterVendorID: %@, hasMatterProductID: %@, hasHapAccessoryName: %@", buf, 0x48u);
...
LABEL_57:
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v171 = 2112;
        v172 = v65;
        _os_log_impl(&dword_22F52A000, v63, OS_LOG_TYPE_ERROR, "%{public}@[%@] Not registering with FirmwareUpdateManager due to invalid matter AFU settings", buf, 0x16u);
LABEL_55:
    ...
    if (![v8 identityType])
    {
      ...
      if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138545154;
        ...
        __int16 v183 = 2112;
        id v184 = v8;
        _os_log_impl(&dword_22F52A000, v55, OS_LOG_TYPE_ERROR, "%{public}@[%@] Not registering with FirmwareUpdateManager due to unknown identity type for manufacturer: %@ model: %@ productData: %@ vendorID: %@ productID: %@ accessory: %@", buf, 0x52u);
        ...
        if ([v69 state] == 2)
        {
          ...
          if (os_log_type_enabled(v76, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v171 = 2112;
            v172 = v78;
            _os_log_impl(&dword_22F52A000, v76, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] Verifying pending firmware version on registered accessory", buf, 0x16u);
          }
...
LABEL_60:
        ...
        if (!v82)
        {
          __int16 v83 = (void *)MEMORY[0x230FBD990]();
          v84 = v41;
          ...
          if (os_log_type_enabled(v85, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v171 = 2112;
            v172 = v87;
            _os_log_impl(&dword_22F52A000, v85, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] Not registering accessory with FirmwareUpdateManager - unsupported accessory type", buf, 0x16u);
          }
          BOOL v20 = 0;
          goto LABEL_96;
        }
        if (v167)
        {
          v162 = [NSURL fileURLWithPath:v167 isDirectory:0];
        }
        else
        {
          v162 = 0;
        }
        id v88 = objc_alloc(MEMORY[0x263F38320]);
        if ((unint64_t)(v163 - 1) > 8) {
          uint64_t v89 = 1;
        }
        else {
          uint64_t v89 = qword_2303E45C8[v163 - 1];
        }
        ...
        if (os_log_type_enabled(v94, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v175 = 2112;
          v176 = v90;
          _os_log_impl(&dword_22F52A000, v94, OS_LOG_TYPE_INFO, "%{public}@[%@] Registering UARP Accessory %@ with AssetID %@", buf, 0x2Au);
...
LABEL_75:
            ...
            if (os_log_type_enabled(v108, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138544386;
              ...
              __int16 v177 = 2112;
              v178 = v165;
              _os_log_impl(&dword_22F52A000, v108, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] Registered accessory %@ %@, version %@ with FirmwareUpdateManager", buf, 0x34u);
            ...
            if (([v91 updateProperty:4 value:v165 forAccessory:v82] & 1) == 0)
            {
              ...
              if (os_log_type_enabled(v114, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                __int16 v171 = 2112;
                v172 = v116;
                _os_log_impl(&dword_22F52A000, v114, OS_LOG_TYPE_ERROR, "%{public}@[%@] Failed to update UARP accessory firmware version property for accessory", buf, 0x16u);
              }
              id v9 = v167;
            }
            if ([v8 isAppleAccessory])
            {
              ...
              if (v117)
              {
                ...
                if (os_log_type_enabled(v120, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543874;
                  ...
                  __int16 v173 = 2112;
                  v174 = v123;
                  _os_log_impl(&dword_22F52A000, v120, OS_LOG_TYPE_ERROR, "%{public}@[%@] Session already created when trying to register accessory %@ with FirmwareUpdateSession", buf, 0x20u);
              ...
              if (os_log_type_enabled(v126, OS_LOG_TYPE_DEBUG))
              {
                ...
                *(_DWORD *)buf = 138543874;
                ...
                __int16 v173 = 2112;
                v174 = v129;
                _os_log_impl(&dword_22F52A000, v126, OS_LOG_TYPE_DEBUG, "%{public}@[%@] Creating session to register accessory %@ with FirmwareUpdateSession", buf, 0x20u);
            ...
            if (os_log_type_enabled(v133, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138544130;
              ...
              __int16 v175 = 2112;
              v176 = v165;
              _os_log_impl(&dword_22F52A000, v133, OS_LOG_TYPE_INFO, "%{public}@[%@] Accessory firmware version updated to %@ (%@)", buf, 0x2Au);
          ...
          if (os_log_type_enabled(v139, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v173 = 2112;
            v174 = 0;
            _os_log_impl(&dword_22F52A000, v139, OS_LOG_TYPE_ERROR, "%{public}@[%@] Matter firmware version is invalid: %@", buf, 0x20u);
          }
        }
        else
        {
          ...
          if (os_log_type_enabled(v139, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v173 = 2112;
            v174 = v82;
            _os_log_impl(&dword_22F52A000, v139, OS_LOG_TYPE_ERROR, "%{public}@[%@] Failed to register UARP accessory %@", buf, 0x20u);
...
LABEL_96:
      ...
      *(_DWORD *)buf = 138544386;
      ...
      __int16 v177 = 2112;
      v178 = v81;
      _os_log_impl(&dword_22F52A000, v63, OS_LOG_TYPE_ERROR, "%{public}@[%@] Not registering accessory %@ with FirmwareUpdateManager. Details: validAFUSettings = %@, validDynamicAssetUpdateSettings = %@", buf, 0x34u);
...
LABEL_45:
    ...
    *(_DWORD *)buf = 138544898;
    ...
    __int16 v181 = 2112;
    v182 = v66;
    _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_INFO, "%{public}@[%@] Valid AFU settings = %@ : isOwner = %@, hasFirmwareUpdateProfile = %@, hasFirmwareVersion = %@, identityType = %@", buf, 0x48u);
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v171 = 2112;
    v172 = v19;
    _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEBUG, "%{public}@[%@] Accessory already registered with FirmwareUpdateManager", buf, 0x16u);
  }
  BOOL v20 = 1;
LABEL_97:
...
void __55__HMDAccessoryFirmwareUpdateManager_registerAccessory___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    v15 = v6;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@[%@] Registering accessory with FirmwareUpdateManager", (uint8_t *)&v12, 0x16u);
  }
  if ((objc_msgSend(*(id *)(a1 + 32), "_registerAccessory:source:path:", *(void *)(a1 + 40), objc_msgSend(*(id *)(a1 + 32), "defaultUpdateAssetSourceWithAccessory:", *(void *)(a1 + 40)), 0) & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v14 = 2112;
      v15 = v11;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@[%@] FirmwareUpdateManager Registration failed for accessory", (uint8_t *)&v12, 0x16u);
    }
  }
}
...
void __72__HMDAccessoryFirmwareUpdateManager_defaultProductDataUpdateAssetSource__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v12 = 2112;
    id v13 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Setting MFi default container to: %@", (uint8_t *)&v10, 0x16u);
  }
}
...
- (void)_handleMatterSettingsUpdateNotification:(id)a3
{
  ...
  if (!v7)
  {
    if (v11)
    {
      ...
      int v84 = 138543362;
      __int16 v85 = v34;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Received matter settings update notification", (uint8_t *)&v84, 0xCu);
    }
    uint64_t v35 = MEMORY[0x230FBD990]();
    v36 = v9;
    ...
    __int16 v88 = 2112;
    uint64_t v89 = v42;
    _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_ERROR, "%{public}@The notification object of type %@ is not of expected type %@", (uint8_t *)&v84, 0x20u);
  ...
  if (v11)
  {
    ...
    __int16 v86 = 2112;
    __int16 v87 = v13;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@[%@] Received matter settings update notification", (uint8_t *)&v84, 0x16u);
  }
...
LABEL_29:
      _os_log_impl(&dword_22F52A000, v45, v46, v44, (uint8_t *)&v84, 0x16u);
...
LABEL_31:
  ...
  if (v15)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v86 = 2112;
      __int16 v87 = v20;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@[%@] Received VID/PID update notification", (uint8_t *)&v84, 0x16u);
    }
    ...
    if ([v25 isEqualToNumber:&unk_26E472598])
    {

LABEL_16:
LABEL_17:
      uint64_t v26 = MEMORY[0x230FBD990]();
      uint64_t v27 = v17;
...
LABEL_32:
      ...
      __int16 v90 = 2112;
      uint64_t v91 = v32;
      _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_INFO, "%{public}@[%@] Ignoring invalid VID: %@, PID: %@", (uint8_t *)&v84, 0x2Au);

LABEL_19:
      goto LABEL_20;
    }
    uint64_t v47 = [v7 matterProductID];
    char v48 = [v47 isEqualToNumber:&unk_26E472598];
  ...
  if (v50)
  {
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v86 = 2112;
      __int16 v87 = v55;
      _os_log_impl(&dword_22F52A000, v53, OS_LOG_TYPE_INFO, "%{public}@[%@] Received matter firmware revision number update notification", (uint8_t *)&v84, 0x16u);
    }
    ...
    if (os_log_type_enabled(v61, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_22F52A000, v61, OS_LOG_TYPE_INFO, "%{public}@[%@] Firmware Update Manager: Received matter firmware revision number update notification, request change to %@", (uint8_t *)&v84, 0x20u);
    }
    if (!v58)
    {
      uint64_t v26 = MEMORY[0x230FBD990]();
      ...
      __int16 v88 = 2112;
      uint64_t v89 = 0;
      _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_INFO, "%{public}@[%@] Ignoring invalid matterFirmwareRevisionNumber: %@", (uint8_t *)&v84, 0x20u);
      goto LABEL_19;
    }
  }
  ...
  if (v64)
  {
    ...
    if (os_log_type_enabled(v67, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v86 = 2112;
      __int16 v87 = v69;
      _os_log_impl(&dword_22F52A000, v67, OS_LOG_TYPE_ERROR, "%{public}@Failed to register and create session for accessory: %@", (uint8_t *)&v84, 0x16u);
    }
  }
  else
  {
    ...
    if (v71)
    {
      ...
      if (os_log_type_enabled(v74, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v88 = 2112;
        uint64_t v89 = 0;
        _os_log_impl(&dword_22F52A000, v74, OS_LOG_TYPE_INFO, "%{public}@[%@] Updating accessory vendor ID and product ID with new session %@", (uint8_t *)&v84, 0x20u);
      }
    ...
    else
    {
      ...
      if (v78)
      {
        __int16 v79 = (void *)MEMORY[0x230FBD990]();
        v80 = v9;
        ...
        if (os_log_type_enabled(v81, OS_LOG_TYPE_INFO))
        {
          ...
          __int16 v88 = 2112;
          uint64_t v89 = 0;
          _os_log_impl(&dword_22F52A000, v81, OS_LOG_TYPE_INFO, "%{public}@[%@] Updating matter firmware version number with new session %@", (uint8_t *)&v84, 0x20u);
        }
  ...
  if ([(HMDAccessoryFirmwareUpdateManager *)self supportsFirmwareUpdate])
  {
    ...
    if (!v7)
    {
      if (v11)
      {
        ...
        int v57 = 138543362;
        v58 = v29;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Received accessory firmware version update notification", (uint8_t *)&v57, 0xCu);
      }
      ...
      __int16 v61 = 2112;
      uint64_t v62 = v37;
      _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_ERROR, "%{public}@The notification object of type %@ is not of expected type %@", (uint8_t *)&v57, 0x20u);
    ...
    if (v11)
    {
      ...
      __int16 v59 = 2112;
      v60 = v13;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@[%@] Received accessory firmware version update notification", (uint8_t *)&v57, 0x16u);
    }
      ...
      if ([(HMDAccessoryFirmwareUpdateManager *)v9 isAccessoryRegistered:v7])
      {
        ...
        if (v14)
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
          {
            ...
            _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_DEBUG, "%{public}@[%@] Do not need to establish a new session with existing session: %@", (uint8_t *)&v57, 0x20u);
          }
          goto LABEL_48;
        }
          ...
          if (v41)
          {
            ...
            if (v42)
            {
              if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
              {
                ...
                __int16 v59 = 2112;
                v60 = v48;
                _os_log_impl(&dword_22F52A000, v46, OS_LOG_TYPE_ERROR, "%{public}@[%@] Ignoring this notification for updating UARP with firmware version", (uint8_t *)&v57, 0x16u);
              }
            }
            else
            {
              if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
              {
                ...
                __int16 v61 = 2112;
                uint64_t v62 = (uint64_t)v15;
                _os_log_impl(&dword_22F52A000, v46, OS_LOG_TYPE_INFO, "%{public}@[%@] Updating accessory firmware version with new session %@", (uint8_t *)&v57, 0x20u);
              }
...
LABEL_42:
            _os_log_impl(&dword_22F52A000, v51, OS_LOG_TYPE_ERROR, v54, (uint8_t *)&v57, 0x16u);
          }
        }
...
LABEL_27:
        _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_DEBUG, v39, (uint8_t *)&v57, 0x16u);
...
LABEL_30:
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
  {
    ...
    int v57 = 138543362;
    v58 = v24;
    _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Received accessory firmware version update notification", (uint8_t *)&v57, 0xCu);
  }
  ...
  if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v57 = 138543362;
    v58 = v28;
    _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_DEFAULT, "%{public}@Firmware Update not enabled on this device; ignoring",
      (uint8_t *)&v57,
      0xCu);
  }
LABEL_31:
...
- (id)UARPControllerForAccessory:(id)a3
{
     ...
     || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0))&& [v4 supportsCHIP])
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v20 = 2112;
      uint64_t v21 = v9;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@[%@] UARPControllerForAccessory: Returning Matter UARP Controller", (uint8_t *)&v18, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v20 = 2112;
      uint64_t v21 = v15;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@[%@] UARPControllerForAccessory: Returning default UARP Controller", (uint8_t *)&v18, 0x16u);
    }
...
LABEL_18:
      _os_log_impl(&dword_22F52A000, v21, v22, v20, (uint8_t *)&v38, 0x16u);
...
LABEL_19:
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v42 = 2112;
      id v43 = v8;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEBUG, "%{public}@[CHECK_AFU_SESSION][%@] Do not need to establish a new session, existing session found: %@", (uint8_t *)&v38, 0x20u);
    }
    uint64_t v14 = 0;
    goto LABEL_37;
  }
  ...
  if (v24)
  {
    ...
    if (v25)
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v40 = 2112;
        uint64_t v41 = v31;
        _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_INFO, "%{public}@[CHECK_AFU_SESSION][%@] Firmware update registration and session creation complete", (uint8_t *)&v38, 0x16u);
      }
      id v8 = v26;
      goto LABEL_36;
    }
...
LABEL_34:
      _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_ERROR, v37, (uint8_t *)&v38, 0x16u);
    }
  }
    ...
    if (!v7)
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v41 = 2080;
        __int16 v42 = "-[HMDAccessoryFirmwareUpdateManager availableSoftwareAssetForMatterAccessory:error:]";
        _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@[%@] %s: no session", buf, 0x20u);
      }
      id v9 = 0;
      if (!a4) {
        goto LABEL_32;
    ...
    if ((unint64_t)(v10 - 6) < 3)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v43 = 2114;
        uint64_t v44 = v31;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] %s: Image is not available %{public}@", buf, 0x2Au);
      }
      uint64_t v11 = 4;
    }
    else
      ...
      if ((unint64_t)(v10 - 1) >= 2)
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v43 = 2114;
          uint64_t v44 = v35;
          _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] %s: These statuses should never be seen, ignore status %{public}@.", buf, 0x2Au);
        }
        uint64_t v11 = 1;
      }
      else
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v41 = 2080;
          __int16 v42 = "-[HMDAccessoryFirmwareUpdateManager availableSoftwareAssetForMatterAccessory:error:]";
          _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@[%@] %s: Image is busy downloading", buf, 0x20u);
        }
        uint64_t v11 = 2;
      }
    }
...
LABEL_31:
    *a4 = [MEMORY[0x263F087E8] errorWithDomain:@"HMDAccessoryMatterUARPAssetErrorDomain" code:v11 userInfo:0];
    goto LABEL_32;
  }
  int v17 = (void *)MEMORY[0x230FBD990]();
  int v18 = self;
...
LABEL_14:
    _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, v22, buf, 0x20u);
  }
LABEL_15:

  if (a4)
  {
    [MEMORY[0x263F087E8] errorWithDomain:@"HMDAccessoryMatterUARPAssetErrorDomain" code:1 userInfo:0];
    id v9 = 0;
...
- (HMDAccessoryFirmwareUpdateManager)initWithHomeManager:(id)a3 wingman:(id)a4
{
  ...
  if (v8)
  {
    ...
    __int16 v20 = (NSMutableDictionary *)objc_alloc_init(MEMORY[0x263EFF9A0]);
    ...
    uint64_t v27 = [MEMORY[0x263F08968] weakToWeakObjectsMapTable];
    registeredAccessories = v9->_registeredAccessories;
    v9->_registeredAccessories = (NSMapTable *)v27;

    id v29 = (NSMutableDictionary *)objc_alloc_init(MEMORY[0x263EFF9A0]);
    ...
    uint64_t v37 = [MEMORY[0x263F42608] sharedPreferences];
    ...
    {
      id v55 = v7;
      id v40 = objc_alloc_init(MEMORY[0x263F08790]);
      [v40 setDateFormat:@"yyyy-MM-dd_HH-mm-ss"];
      __int16 v41 = NSString;
      __int16 v42 = [MEMORY[0x263EFF910] date];
      ...
      if ((v43 & 1) == 0)
      {
        os_log_type_t v46 = (void *)MEMORY[0x230FBD990]();
        uint64_t v47 = v9;
        ...
        if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v58 = v49;
          _os_log_impl(&dword_22F52A000, v48, OS_LOG_TYPE_ERROR, "%{public}@Error starting UARP packet capture for UARP Controller", buf, 0xCu);
        }
      }
      int v50 = (void *)MEMORY[0x230FBD990]();
      v51 = v9;
      v52 = HMFGetOSLogHandle();
      if (os_log_type_enabled(v52, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v59 = 2112;
        v60 = v44;
        _os_log_impl(&dword_22F52A000, v52, OS_LOG_TYPE_DEFAULT, "%{public}@Started UARP packet capture for UARP Controller in: %@", buf, 0x16u);
      }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t80 != -1) {
    dispatch_once(&logCategory__hmf_once_t80, &__block_literal_global_181666);
  }
