...
+ (id)properties
{
  if (properties_onceToken_30001 != -1) {
    dispatch_once(&properties_onceToken_30001, &__block_literal_global_195);
  }
  v2 = (void *)properties__properties_30002;
  return v2;
}
...
void __34__HMDServiceGroupModel_properties__block_invoke()
{
  ...
  v3 = (void *)properties__properties_30002;
  properties__properties_30002 = v2;
}
...
- (id)cd_generateValueForProperty:(id)a3 managedObjectField:(id)a4 context:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a5;
  if ([v9 isEqualToString:@"services_"])
  {
    if ([(HMDBackingStoreModelObject *)self propertyWasSet:@"services"])
    {
      uint64_t v11 = [(HMDServiceGroupModel *)self services];
  ...
  {
    v14.receiver = self;
    v14.super_class = (Class)HMDServiceGroupModel;
...
- (id)cd_generateValueForModelObjectFromManagedObject:(id)a3 modelObjectField:(id)a4 modelFieldInfo:(id)a5
{
  ...
  id v9 = a5;
  id v10 = a3;
  if ([v8 isEqualToString:@"services"])
  {
    uint64_t v11 = [v10 services];
