...
LABEL_15:
      _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_INFO, v31, buf, 0x16u);
    }
LABEL_16:
  ...
  if (v7)
  {
    ...
    v10 = objc_msgSend(v9, "na_map:", &__block_literal_global_182);
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Fetch collection completed with %ld items.", buf, 0x16u);
    ...
    v38[1] = 3221225472;
    v38[2] = __64__HMDRemoteEventRouterServer_pendingEventCollectionDidComplete___block_invoke_183;
    v38[3] = &unk_264A2F3E8;
    v38[4] = *(void *)(a1 + 32);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v41 = 2112;
      uint64_t v42 = v5;
      _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_ERROR, "%{public}@Device no longer available %@", buf, 0x16u);
    }
  }
...
void __64__HMDRemoteEventRouterServer_pendingEventCollectionDidComplete___block_invoke_183(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    v16 = v10;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Fetch collection response completed with %@%@", (uint8_t *)&v11, 0x20u);
  }
}

uint64_t __64__HMDRemoteEventRouterServer_pendingEventCollectionDidComplete___block_invoke_180(uint64_t a1, void *a2)
{
...
- (id)diagnosticInfo
{
  ...
  id v3 = objc_alloc_init(MEMORY[0x263F0E6A0]);
  [v3 setVersion:1];
    ...
    if (v8)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          id v13 = objc_alloc_init(MEMORY[0x263F0E698]);
          if (v12) {
            v14 = *(void **)(v12 + 16);
          }
          else {
...
- (void)configureWithHome:(id)a3 isPrimaryResident:(BOOL)a4 isResidentEventProviding:(BOOL)a5 additionalPolicies:(id)a6
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v19 = 2112;
    v20 = v16;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "Configuring on device isPrimaryResident. %@ isResidentEventProviding: %@", (uint8_t *)&v17, 0x16u);
  }
  os_unfair_lock_lock_with_options();
...
- (BOOL)shouldAllowEvent:(id)a3 topic:(id)a4 connection:(id)a5
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412546;
    ...
    __int16 v36 = 2112;
    id v37 = v7;
    _os_log_debug_impl(&dword_22F52A000, logger, OS_LOG_TYPE_DEBUG, "Checking access control connection: %@, topic: %@", buf, 0x16u);
  }
  os_unfair_lock_lock_with_options();
    ...
    if (v15)
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 138412290;
        v35 = v10;
        _os_log_error_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "Could not find user ACL provider for %@", buf, 0xCu);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_DEBUG))
      {
        *(_DWORD *)buf = 138412546;
        ...
        __int16 v36 = 2112;
        id v37 = v8;
        _os_log_debug_impl(&dword_22F52A000, v28, OS_LOG_TYPE_DEBUG, "No device when attempting to check access control for %@ to %@", buf, 0x16u);
      }
    }
    char v26 = 0;
LABEL_26:
...
- (void)server:(id)a3 sendEvents:(id)a4 cachedEvents:(id)a5 connection:(id)a6 completion:(id)a7
{
  ...
  uint64_t v19 = objc_msgSend(v11, "na_map:", &__block_literal_global_169_104710);
  id v20 = (void *)[v19 mutableCopy];
  int v21 = [(HMDRemoteEventRouterProtoServerMessage *)v15 updatedEvents];
  [v21 setEvents:v20];

  id v22 = objc_msgSend(v12, "na_map:", &__block_literal_global_171_104711);
    ...
    if (v28)
    {
      ...
      if (v32)
      {
        ...
        if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138412290;
          id v47 = v37;
          _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_DEFAULT, "Sending events of size: %@", buf, 0xCu);
        ...
        if (os_log_type_enabled(logger, OS_LOG_TYPE_DEBUG))
        {
          *(_DWORD *)buf = 138412290;
          id v47 = v11;
          _os_log_debug_impl(&dword_22F52A000, logger, OS_LOG_TYPE_DEBUG, "Sending events: %@", buf, 0xCu);
        }
      ...
      {
        uint64_t v42 = [MEMORY[0x263F087E8] hmErrorWithCode:52];
        v14[2](v14, v42);
        ...
        {
          *(_WORD *)buf = 0;
          _os_log_error_impl(&dword_22F52A000, v43, OS_LOG_TYPE_ERROR, "Could not create destination", buf, 2u);
        }
      }
    }
    else
    {
      v40 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
      v14[2](v14, v40);
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 138412290;
        id v47 = v25;
        _os_log_error_impl(&dword_22F52A000, v41, OS_LOG_TYPE_ERROR, "Device no longer available %@", buf, 0xCu);
      }
      v29 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138412290;
      id v47 = v25;
      _os_log_error_impl(&dword_22F52A000, v39, OS_LOG_TYPE_ERROR, "Could not find remote connection for connection %@", buf, 0xCu);
    }
    v29 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
    v14[2](v14, v29);
  }
}
...
- (void)server:(id)a3 connectionDidFail:(id)a4
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
  {
    int v8 = 138412290;
    id v9 = v5;
    _os_log_error_impl(&dword_22F52A000, logger, OS_LOG_TYPE_ERROR, "Removing connection on error %@", (uint8_t *)&v8, 0xCu);
  }
...
- (void)server:(id)a3 connectionDidExpire:(id)a4
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
  {
    int v8 = 138412290;
    id v9 = v5;
    _os_log_error_impl(&dword_22F52A000, logger, OS_LOG_TYPE_ERROR, "Removing connection on expiry %@", (uint8_t *)&v8, 0xCu);
  }
  id v7 = [(HMDRemoteEventRouterServer *)self currentConnections];
  [v7 removeObject:v5];
}
  ...
  if (-[HMDRemoteEventRouterServer isPrimaryResident]((os_unfair_lock_s *)self))
  {
    ...
    if (v15)
    {
      ...
      if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        id v25 = v15;
        _os_log_impl(&dword_22F52A000, logger, OS_LOG_TYPE_DEFAULT, "Notifying on connecting to primary %@", buf, 0xCu);
      }
...
- (BOOL)server:(id)a3 shouldProcessEventsForConnection:(id)a4 shouldLogState:(BOOL)a5
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v36 = 2112;
    id v37 = WeakRetained;
    _os_log_impl(&dword_22F52A000, logger, OS_LOG_TYPE_DEFAULT, "Checking if server should process events for connection: %@, dataSource: %@", (uint8_t *)&v34, 0x16u);
  }
LABEL_5:
  int v14 = v10;
  objc_opt_class();
    ...
    if (v20)
    {
      ...
      if (!-[HMDRemoteEventRouterServer isPrimaryResident]((os_unfair_lock_s *)self) || !v23)
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
        {
          ...
          __int16 v40 = 2112;
          __int16 v41 = v20;
          _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_DEFAULT, "Allow connection: %{public}@, for resident connection mode. isReceiverPrimary: %{public}@, incoming device:%@, primary device: %@", (uint8_t *)&v34, 0x2Au);
      ...
      if (v5)
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
        {
          ...
          __int16 v38 = 2112;
          v39 = v20;
          _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_DEFAULT, "Not allowing connection while both devices are known as primary, this should resolve shortly. isReceiverPrimary: %{public}@, incoming device:%@, primary device: %@", (uint8_t *)&v34, 0x20u);
...
LABEL_33:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        int v34 = 138412290;
        v35 = v26;
        _os_log_error_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "Unexpectedly did not find device for resident. %@", (uint8_t *)&v34, 0xCu);
        goto LABEL_23;
      }
    }
LABEL_24:
...
LABEL_14:
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v34 = 138543362;
      v35 = v21;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_DEFAULT, "Allow connection: %{public}@, for primary connection mode.", (uint8_t *)&v34, 0xCu);
LABEL_32:
...
uint64_t __81__HMDRemoteEventRouterServer_responseHandlerForSendMessageIdentifier_completion___block_invoke_2(void *a1)
{
  ...
  if (v2)
  {
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v16 = 2112;
      uint64_t v17 = v2;
      _os_log_error_impl(&dword_22F52A000, v4, OS_LOG_TYPE_ERROR, "Failed to send message: %@ error: %@", (uint8_t *)&v14, 0x16u);
    }
  }
  else
  {
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT)
      && (uint64_t v6 = a1[6],
          int v14 = 138412290,
          uint64_t v15 = v6,
          _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEFAULT, "Successfully sent message: %@", (uint8_t *)&v14, 0xCu), (uint64_t v3 = a1[5]) == 0))
    {
      id WeakRetained = 0;
    }
    else
    {
      id WeakRetained = objc_loadWeakRetained((id *)(v3 + 112));
    }
    id v8 = [WeakRetained currentAccessorySetupMetricDispatcher];
    uint64_t v10 = [WeakRetained currentAccessoryHomeUUID];
    if (v10)
    {
      id v11 = (void *)a1[5];
      id v12 = v11 ? objc_getProperty(v11, v9, 40, 1) : 0;
      if (objc_msgSend(v10, "hmf_isEqualToUUID:", v12)) {
        [v8 markSetupEndStage:16 error:a1[4]];
      }
    }
  }
...
- (void)_handleFetchEventsRequest:(id)a3 originalMessage:(id)a4 connectionMode:(int64_t)a5
{
  ...
  if (v8)
  {
    ...
    if (v12 && v13)
    {
      ...
      {
        id WeakRetained = objc_loadWeakRetained((id *)&self->_dataSource);
        __int16 v16 = [WeakRetained routerServerUserAccessControlProviderIdentifierForMessage:v10];
        if (v16
              ...
              (uint64_t v17 = objc_claimAutoreleasedReturnValue()) != 0))
        {
          ...
          if (v20)
          {
            ...
            id v23 = objc_alloc_init(MEMORY[0x263F493C8]);
            ...
            if (v22)
            {
              ...
              v29 = objc_msgSend(v28, "na_map:", &__block_literal_global_157_104741);
              [(HMDRemoteEventRouterServer *)self logMetricsForLiveEvents:MEMORY[0x263EFFA68] cachedEvents:v28 destinationDevice:v12 destinationDeviceIdentifier:v14 responseMessageType:1];
            ...
            else
            {
              if (!v26)
              {
                uint64_t v27 = [MEMORY[0x263F087E8] hmErrorWithCode:52];
              }
          ...
          else
          {
            ...
            {
              *(_WORD *)buf = 0;
              _os_log_error_impl(&dword_22F52A000, logger, OS_LOG_TYPE_ERROR, "Got a fetch request with no topics.", buf, 2u);
            }
            v44 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
        ...
        else
        {
          ...
          {
            *(_WORD *)buf = 0;
            _os_log_error_impl(&dword_22F52A000, v41, OS_LOG_TYPE_ERROR, "Could not find user for incoming request.", buf, 2u);
          }
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_error_impl(&dword_22F52A000, v42, OS_LOG_TYPE_ERROR, "Could not process fetch as non-resident event providing device.", buf, 2u);
      }
    ...
    else
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_error_impl(&dword_22F52A000, v38, OS_LOG_TYPE_ERROR, "Could not find device of incoming request.", buf, 2u);
      }
      v39 = (void *)MEMORY[0x263F087E8];
      uint64_t v40 = 2;
    }
...
LABEL_37:
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_error_impl(&dword_22F52A000, v37, OS_LOG_TYPE_ERROR, "Did not find fetch request in payload.", buf, 2u);
  }
...
id __87__HMDRemoteEventRouterServer__handleFetchEventsRequest_originalMessage_connectionMode___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (([v3 hasTopic] & 1) == 0)
  {
    ...
    {
      *(_WORD *)id v9 = 0;
      _os_log_error_impl(&dword_22F52A000, v4, OS_LOG_TYPE_ERROR, "No topic found!", v9, 2u);
    }
  }
  uint64_t v5 = (void *)MEMORY[0x263F425C8];
  id v6 = [v3 topic];
...
- (void)_handleKeepAliveRequest:(id)a3 originalMessage:(id)a4
{
  ...
  if (v6)
  {
      ...
      else
      {
        ...
        if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138412546;
          ...
          __int16 v29 = 2112;
          id v30 = v13;
          _os_log_error_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "No connection was found for keep alive request in current connections: %@ device identifier: %@", buf, 0x16u);
        }
        __int16 v16 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
    ...
    else
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_error_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "Could not find device of incoming request.", buf, 2u);
      }
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "Did not keep-alive request in payload.", buf, 2u);
    }
...
- (void)_handleChangeRegistrationsRequest:(id)a3 originalMessage:(id)a4
{
  ...
  if (v6)
  {
    ...
    if (v9 && v10)
    {
      ...
      if (v14)
      {
        ...
        uint64_t v18 = objc_msgSend(v28, "na_map:", &__block_literal_global_140_104757);
        uint64_t v19 = [v6 topicFilterRemovals];
        uint64_t v20 = objc_msgSend(v19, "na_map:", &__block_literal_global_142_104758);
      ...
      else
      {
        ...
        if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138412546;
          ...
          __int16 v40 = 2112;
          id v41 = v13;
          _os_log_error_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "No connection was found during change registrations request in current connections: %@ device identifier: %@", buf, 0x16u);
        }
    ...
    else
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_error_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "Could not find device of incoming request.", buf, 2u);
      }
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "Did not change registrations request in payload.", buf, 2u);
    }
    id v9 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
    [v8 respondWithError:v9];
  }
...
void __80__HMDRemoteEventRouterServer__handleChangeRegistrationsRequest_originalMessage___block_invoke_3(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    ...
    {
      uint64_t v8 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:3202];
  ...
  else
  {
    ...
    id v9 = objc_msgSend(v6, "na_map:", &__block_literal_global_146_104760);
    [*(id *)(a1 + 40) logMetricsForLiveEvents:MEMORY[0x263EFFA68] cachedEvents:v6 destinationDevice:*(void *)(a1 + 56) destinationDeviceIdentifier:*(void *)(a1 + 64) responseMessageType:3];
...
- (void)_handleDisconnectRequest:(id)a3 originalMessage:(id)a4
{
  ...
  if (v6)
  {
    ...
    if (v10 && v11)
    {
      ...
      else
      {
        ...
        {
          *(_WORD *)buf = 0;
          _os_log_error_impl(&dword_22F52A000, logger, OS_LOG_TYPE_ERROR, "No connection was found to disconnect.", buf, 2u);
        }
        int v21 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
        [v8 respondWithError:v21];
      }
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "Did not find disconnect request in payload.", buf, 2u);
    }
    uint64_t v10 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
...
- (void)refreshConnections:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v18 = 2112;
    id v19 = v5;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Refresh connections for user:%@", buf, 0x16u);
  }
...
- (void)_handleConnectRequest:(id)a3 originalMessage:(id)a4 connectionMode:(int64_t)a5
{
  ...
  uint64_t v13 = [WeakRetained currentAccessorySetupMetricDispatcher];
  id v15 = [WeakRetained currentAccessoryHomeUUID];
  if (!v15
    || (!self ? (id v16 = 0) : (id v16 = objc_getProperty(self, v14, 40, 1)),
        !objc_msgSend(v15, "hmf_isEqualToUUID:", v16)))
  {
    int v17 = 0;
    if (!v8) {
      goto LABEL_8;
...
LABEL_12:
    ...
    if (!v19 || !v20)
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_error_impl(&dword_22F52A000, logger, OS_LOG_TYPE_ERROR, "Could not find device of incoming request.", buf, 2u);
      }
      int v21 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
    ...
    int64_t v57 = a5;
    int v21 = [WeakRetained routerServerUserAccessControlProviderIdentifierForMessage:v10];
    if (!v21)
    {
      id v30 = self->_logger;
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_error_impl(&dword_22F52A000, v30, OS_LOG_TYPE_ERROR, "Could not find user for incoming request.", buf, 2u);
      }
      id v31 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
      [v10 respondWithError:v31];
      goto LABEL_48;
    }
    int v52 = v17;
    uint64_t v22 = [(HMDRemoteEventRouterServer *)self currentConnections];
    ...
    v65[1] = 3221225472;
    v65[2] = __83__HMDRemoteEventRouterServer__handleConnectRequest_originalMessage_connectionMode___block_invoke;
    v65[3] = &unk_264A1E738;
    id v54 = v58;
    id v66 = v54;
    objc_msgSend(v22, "na_firstObjectPassingTest:", v65);
    id v23 = (HMDRemoteEventRouterServerConnection *)objc_claimAutoreleasedReturnValue();

    v55 = v13;
    if (v23)
    {
      v56 = v23;
      if (v23->_connectionMode == v57)
      {
LABEL_37:
        if ([v8 hasConnectEvent])
        {
          id v37 = (void *)MEMORY[0x263F49388];
          __int16 v38 = [v8 connectEvent];
          v53 = [v37 fromProtobuff:v38];
        }
        else
        {
          v53 = 0;
        ...
        {
          v39 = (void *)MEMORY[0x263F49388];
          __int16 v40 = [v8 unregisterEvent];
          v51 = [v39 fromProtobuff:v40];
        }
        else
        {
          v51 = 0;
        ...
        uint64_t v42 = [v8 topicFilterAdditions];
        uint64_t v43 = [v42 count];

        if (v43)
        {
          char v45 = [v8 topicFilterAdditions];
          v46 = objc_msgSend(v45, "na_map:", &__block_literal_global_125);
          [v41 addObjectsFromArray:v46];
        }
        if (self) {
          id v47 = objc_getProperty(self, v44, 104, 1);
        }
        else {
          id v47 = 0;
        }
        ...
        v59[1] = 3221225472;
        v59[2] = __83__HMDRemoteEventRouterServer__handleConnectRequest_originalMessage_connectionMode___block_invoke_2;
        v59[3] = &unk_264A1E7A8;
        int64_t v64 = v57;
        v59[4] = self;
        id v60 = v10;
        ...
        v63 = v56;
        v50 = v56;
        [v48 connectWithConnection:v50 connectEvent:v53 unregisterEvent:v51 topicFilterAdditions:v49 completion:v59];
...
LABEL_49:
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
      {
        *(_DWORD *)buf = 138412290;
        v68 = v23;
        _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_DEFAULT, "Connection mode is different remove existing %@", buf, 0xCu);
      }
      id v25 = [(HMDRemoteEventRouterServer *)self currentConnections];
      [v25 removeObject:v23];
    }
    v56 = -[HMDRemoteEventRouterServerConnection initWithDevice:connectionMode:supportsFragmentMessage:userAccessControlProviderUUID:]([HMDRemoteEventRouterServerConnection alloc], "initWithDevice:connectionMode:supportsFragmentMessage:userAccessControlProviderUUID:", v19, v57, [v10 BOOLForKey:@"isFragmented"]);
    if (v57 == 1)
    {
      ...
      {
LABEL_33:
        uint64_t v32 = [(HMDRemoteEventRouterServer *)self currentConnections];
        [v32 addObject:v56];
        ...
        if (os_signpost_enabled(v33))
        {
          id v34 = NSNumber;
          id v35 = v33;
          __int16 v36 = [v34 numberWithInteger:v57];
          *(_DWORD *)buf = 138412290;
          v68 = v36;
          _os_signpost_emit_with_name_impl(&dword_22F52A000, v35, OS_SIGNPOST_EVENT, 0xEEEEB0B5B2B2EEEELL, "EventRouterServerConnectionCreated", "connectionMode=%{signpost.description:attribute}@ ", buf, 0xCu);

          uint64_t v13 = v55;
        }
        if (v26)
        {
          [v13 markSetupEndStage:15 error:0];
          [v13 markSetupBeginStage:16 error:0];
        }
        goto LABEL_37;
      }
      *(_DWORD *)buf = 138412290;
      v68 = v56;
      id v28 = "Created resident connection %@";
    }
    else
    {
      int v26 = v52;
      ...
      *(_DWORD *)buf = 138412290;
      v68 = v56;
      id v28 = "Created primary client connection %@";
    }
    _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_DEFAULT, v28, buf, 0xCu);
    goto LABEL_33;
  }
  [v13 markSetupBeginStage:15 error:0];
  int v17 = 1;
  if (v8) {
    goto LABEL_12;
  }
LABEL_8:
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_error_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "Did not find connect request in payload.", buf, 2u);
  }
...
void __83__HMDRemoteEventRouterServer__handleConnectRequest_originalMessage_connectionMode___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  {
    objc_msgSend(v16, "na_map:", &__block_literal_global_129_104783);
    id v7 = (id)objc_claimAutoreleasedReturnValue();
    id v9 = objc_msgSend(v7, "na_map:", &__block_literal_global_132_104784);
    [*(id *)(a1 + 32) logMetricsForLiveEvents:MEMORY[0x263EFFA68] cachedEvents:v7 destinationDevice:*(void *)(a1 + 48) destinationDeviceIdentifier:*(void *)(a1 + 56) responseMessageType:2];
...
- (void)_handleProtoRequest:(id)a3 originalMessage:(id)a4 connectionMode:(int64_t)a5
{
  ...
  switch([v8 request])
  {
    case 0u:
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_error_impl(&dword_22F52A000, logger, OS_LOG_TYPE_ERROR, "Unable to find request type.", buf, 2u);
      }
...
LABEL_15:
    ...
    default:
      ...
      {
        *(_WORD *)int v17 = 0;
        _os_log_error_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "Received an unrecognized request type.", v17, 2u);
      }
      uint64_t v11 = (void *)MEMORY[0x263F087E8];
      uint64_t v12 = -1;
LABEL_8:
...
- (void)_handleRequestMessage:(id)a3 connectionMode:(int64_t)a4
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138412546;
    ...
    __int16 v25 = 2112;
    int v26 = v10;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "Handle request message: %@ connection mode: %@", buf, 0x16u);
  }
  ...
  if (!v12)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "Did not find message payload.", buf, 2u);
    }
  ...
  if (!v14)
  {
    if (!v15)
    {
      ...
      {
        *(_WORD *)buf = 0;
        _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_DEFAULT, "No payload from fragment message", buf, 2u);
      }
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138412290;
      id v24 = v15;
      _os_log_error_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "Could not decode payload from fragment message %@", buf, 0xCu);
    }
LABEL_23:
  ...
  id v15 = (id)v14;
LABEL_11:
  int v17 = [[HMDRemoteEventRouterProtoMessage alloc] initWithData:v15];
  ...
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_error_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "Decoded payload does not have request.", buf, 2u);
    }
    id v19 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v18 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@user UUID missed", buf, 0xCu);
    }
  }
}
...
- (BOOL)isErrorHMENotAcceptingConnections:(id)a3
{
  id v3 = a3;
  id v4 = [v3 domain];
  if ([v4 isEqualToString:*MEMORY[0x263F49370]]) {
    BOOL v5 = [v3 code] == 4;
  }
  else {
    BOOL v5 = 0;
...
- (void)respondToMessage:(id)a3 underlyingResponseData:(id)a4 supportsFragmentMessage:(BOOL)a5 label:(id)a6
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
    {
      id v15 = NSNumber;
      id v16 = logger;
      int v17 = objc_msgSend(v15, "numberWithUnsignedInteger:", objc_msgSend(v11, "length"));
      *(_DWORD *)buf = 138412546;
      id v31 = v12;
      __int16 v32 = 2112;
      id v33 = v17;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_DEFAULT, "Responding to %@ with message size: %@, fragment: 0", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138412546;
      ...
      __int16 v32 = 2112;
      id v33 = v24;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_DEFAULT, "Responding to %@ with message size: %@", buf, 0x16u);
    }
    int v26 = @"message.payload";
    id v27 = v11;
    __int16 v25 = [NSDictionary dictionaryWithObjects:&v27 forKeys:&v26 count:1];
  ...
  if ([v8 count])
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v21 = 2112;
      id v22 = v13;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Removing connections: %@ due to removed user: %@", buf, 0x20u);
    }
  }
...
os_unfair_lock_s *__85__HMDRemoteEventRouterServer_handlePrimaryResidentIsCurrentDeviceChangeNotification___block_invoke(uint64_t a1)
{
  ...
  if (v4 != result)
  {
    ...
    int v15 = 138412290;
    id v16 = v10;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEFAULT, "Primary resident status changed to %@", (uint8_t *)&v15, 0xCu);
...
- (void)_registerForAccessoryMessages:(id)a3
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)&v38[14] = v7 != 0;
    __int16 v39 = 2112;
    __int16 v40 = v14;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEFAULT, "Registering for accessory messages %@, user privilege: (exists: %d) %@", v38, 0x1Cu);
  }
  ...
  if (v28)
  {
    ...
    *(void *)__int16 v38 = v33;
    uint64_t v34 = [MEMORY[0x263EFF8C0] arrayWithObjects:v38 count:1];
...
- (void)_registerForMessages:(id)a3 withHome:(id)a4
{
  ...
  v31[0] = v9;
  SEL v10 = [MEMORY[0x263EFF8C0] arrayWithObjects:v31 count:1];
  ...
  id v14 = Property;
  int v15 = objc_msgSend(v6, "na_firstObjectPassingTest:", &__block_literal_global_95_104820);
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
    SEL v16 = v15;
  }
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v29 = 2112;
    id v30 = v22;
    _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_DEFAULT, "Registering for messages with user privilege: (exists: %d) %@", (uint8_t *)v28, 0x12u);
  }
...
- (HMDRemoteEventRouterServer)initWithPrimaryModeUUID:(id)a3 residentModeUUID:(id)a4 queue:(id)a5 messageDispatcher:(id)a6 dataSource:(id)a7 notificationCenter:(id)a8 requestMessageName:(id)a9 updateMessageName:(id)a10 multiHopFetchResponseMessageName:(id)a11 logCategory:(const char *)a12 logEventSubmitter:(id)a13 connectionServerFactory:(id)a14
{
  ...
  if (v22)
  {
    ...
    *(_WORD *)&v23->_BOOL isPrimaryResident = 0;
    ...
    uint64_t v36 = [MEMORY[0x263F08968] strongToStrongObjectsMapTable];
...
{
  v1 = objc_msgSend(objc_alloc(MEMORY[0x263F493B0]), "initWithQueue:provider:registrationEventRouter:storeReadHandle:logCategory:", *(void *)(a1 + 32), *(void *)(a1 + 40), *(void *)(a1 + 48), *(void *)(a1 + 56), objc_msgSend(*(id *)(a1 + 64), "UTF8String"));
  return v1;
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t4_104843 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_104843, &__block_literal_global_104844);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v5_104845;
  return v2;
}
...
void __41__HMDRemoteEventRouterServer_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_104845;
  logCategory__hmf_once_v5_104845 = v0;
}
