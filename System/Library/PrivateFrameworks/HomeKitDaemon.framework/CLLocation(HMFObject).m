  ...
  if (v2)
  {
    ...
    if (v4)
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
      {
        ...
        int v28 = 138543362;
        v29 = v8;
        _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@CarPlay session is connected right now. Trusting this location", (uint8_t *)&v28, 0xCu);
      }
      return 0;
    }
...
LABEL_18:
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v34 = 2112;
        v35 = v24;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@It was a while between disconnecting the CarPlay session and when this location was determined. Considering this location as simulated. Last active CarPlay session: [%@], location timestamp: [%@], timeDiff: %@", (uint8_t *)&v28, 0x2Au);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        int v28 = 138543362;
        v29 = v26;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@We do not know whether there was any active car play session in the past from last homed boot. Considering this location as simulated", (uint8_t *)&v28, 0xCu);
      }
    }
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
  {
    ...
    int v28 = 138543362;
    v29 = v13;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@CLLocation timestamp is nil. We don't know whether we can trust it. Considering this location as simulated", (uint8_t *)&v28, 0xCu);
  }
  return 1;
}
    ...
    if (v10)
    {
      if ([v10 isSimulatedBySoftware])
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
        {
          ...
          int v20 = 138543362;
          v21 = v15;
          _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@CLLocation is simulated by the software", (uint8_t *)&v20, 0xCu);
        }
        uint64_t v9 = 1;
        goto LABEL_15;
      }
...
LABEL_17:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        int v20 = 138543362;
        v21 = v18;
        _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@CLLocation does not contain the location source information", (uint8_t *)&v20, 0xCu);
      }
    }
    uint64_t v9 = 0;
    goto LABEL_17;
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v20 = 138543362;
    v21 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Not checking for location simulation due to override", (uint8_t *)&v20, 0xCu);
  }
  return 0;
}
...
- (id)attributeDescriptions
{
  ...
  v24[4] = v19;
  int v20 = [MEMORY[0x263EFF8C0] arrayWithObjects:v24 count:5];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_264546 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_264546, &__block_literal_global_264547);
  }
  v0 = (void *)logCategory__hmf_once_v1_264548;
  return v0;
}
