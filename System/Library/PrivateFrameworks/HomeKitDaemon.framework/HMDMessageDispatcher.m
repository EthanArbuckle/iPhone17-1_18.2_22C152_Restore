...
- (id)sendMessageExpectingResponse:(id)a3
{
  ...
  if (v6)
  {
    ...
    id v16 = 0;
    v8 = [MEMORY[0x263F42538] futureWithPromise:&v16];
...
LABEL_11:
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_FAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: %@", buf, 0x16u);
  }
  id v13 = [[HMDAssertionLogEvent alloc] initWithReason:@"%@", @"Requested to send nil message"];
  v14 = +[HMDMetricsManager sharedLogEventSubmitter];
  [v14 submitLogEvent:v13];

  id v15 = [MEMORY[0x263F087E8] hmfErrorWithCode:8 reason:@"Requested to send nil message"];
  if (v7) {
    v7[2](v7, v15);
  }
LABEL_12:
...
void __40__HMDMessageDispatcher_dispatchMessage___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if ((atomic_exchange((atomic_uchar *volatile)(*(void *)(*(void *)(a1 + 64) + 8) + 32), 1u) & 1) == 0)
  {
    ...
    v9 = [v7 domain];
    if ([v9 isEqualToString:*MEMORY[0x263F41FD8]])
    {
      ...
      if (*(unsigned char *)(a1 + 72))
      {
        if (!*(unsigned char *)(a1 + 73))
        {
          ...
          if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
          {
            ...
            __int16 v30 = 2112;
            uint64_t v31 = v16;
            _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Dropping unhandled remote message as it is not secure: %@ (%@)", (uint8_t *)&v26, 0x20u);
          }
          goto LABEL_16;
        }
LABEL_15:
...
LABEL_16:
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v30 = 2112;
    uint64_t v31 = v22;
    _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Multiple invocations of response handler for message: %@ (%@)", (uint8_t *)&v26, 0x20u);
  }
LABEL_17:
}
...
- (id)messageHandlerWithReceiver:(id)a3 name:(id)a4 policies:(id)a5 selector:(SEL)a6
{
  ...
  id v11 = a4;
  id v12 = a5;
  id v13 = [MEMORY[0x263F42580] policyOfClass:objc_opt_class() fromPolicies:v12];

  if (v13)
  {
    v14 = [v10 messageTargetUUID];
    uint64_t v15 = [(HMDMessageDispatcher *)self homeForMessageTarget:v14];

    uint64_t v16 = [v15 administratorHandler];
    id v17 = [v16 wrapReceiver:v10];

    if (v17)
    {
      if (([v17 conformsToProtocol:&unk_26E5ADED0] & 1) == 0)
      {
        uint64_t v21 = (HMDMessageDispatcher *)_HMFPreconditionFailure();
        [(HMDMessageDispatcher *)v21 configureHomeManager:v23];
        return result;
      }
      id v18 = v17;
    ...
    if (v5)
    {
      ...
      while (2)
      {
        ...
        do
        {
          ...
          id v12 = [v8 resolveReceiverForMessageTargetUUID:v4];
...
- (HMDMessageDispatcher)initWithXPCTransport:(id)a3 secureRemoteTransport:(id)a4 messageFilterChain:(id)a5
{
  ...
  id v12 = [(HMFMessageDispatcher *)&v29 initWithTransport:0];
  id v13 = v12;
  if (v12)
  {
    ...
    uint64_t v19 = [MEMORY[0x263EFF8C0] arrayWithObjects:v30 count:9];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t9_114033 != -1) {
    dispatch_once(&logCategory__hmf_once_t9_114033, &__block_literal_global_114034);
  }
  id v2 = (void *)logCategory__hmf_once_v10_114035;
  return v2;
}
...
void __35__HMDMessageDispatcher_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v10_114035;
  logCategory__hmf_once_v10_114035 = v0;
}
...
void __41__HMDMessageDispatcher_defaultDispatcher__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    int v12 = 138543362;
    id v13 = v11;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Creating default message dispatcher", (uint8_t *)&v12, 0xCu);
  }
}
...
LABEL_7:
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v30 = 2112;
    id v31 = v14;
    _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@Could not create message destination with userID: %@ and destination: %@", (uint8_t *)&v26, 0x20u);
  }
  uint64_t v19 = 0;
LABEL_11:
      ...
      if ((v24 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v41, OS_LOG_TYPE_FAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          v57 = v39;
          v43 = (void *)v68;
          _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Mismatched device message destination: %@", buf, 0x16u);
      ...
      if ((v33 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v50, OS_LOG_TYPE_FAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          _os_log_impl(&dword_22F52A000, v50, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Mismatched account message destination: %@", buf, 0x16u);
...
- (id)residentCommunicationHandlerForHome:(id)a3
{
  ...
  id v15 = __Block_byref_object_copy__114101;
  id v16 = __Block_byref_object_dispose__114102;
  id v17 = 0;
  if (v4)
  {
    id v5 = [(HMFMessageDispatcher *)self workQueue];
...
LABEL_47:
      ...
      if (v8 && v13)
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v72 = 2112;
          id v73 = v9;
          _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_INFO, "%{public}@Ignoring setting a new peer since we already have an existing peer for home: %@", buf, 0x16u);
        }
        goto LABEL_47;
      }
      goto LABEL_31;
          ...
          v19))
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v72 = 2112;
        id v73 = v9;
        _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Ignoring setting a new remote access device as the current resident is reachable for home: %@", buf, 0x16u);
      }
      char v24 = 1;
      BOOL v5 = v65;
    }
    ...
    v34 = [MEMORY[0x263F42620] productInfo];
...
LABEL_31:
        if (v12 && (v24 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v72 = 2112;
            id v73 = v44;
            _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_INFO, "%{public}@Disabling resident remote access for home: %@", buf, 0x16u);
          ...
          if (v5)
          {
            v46 = (void *)MEMORY[0x230FBD990](v45);
            v47 = v41;
            ...
            if (os_log_type_enabled(v48, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v72 = 2112;
              id v73 = v50;
              _os_log_impl(&dword_22F52A000, v48, OS_LOG_TYPE_INFO, "%{public}@Sending notification that remote session was torn down for home: %@", buf, 0x16u);
            }
        ...
        if ((v54 & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v57, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v74 = 2112;
            v75 = v60;
            _os_log_impl(&dword_22F52A000, v57, OS_LOG_TYPE_INFO, "%{public}@Enabling resident remote access for home %@ via device: %@", buf, 0x20u);
          }
          if (!v12)
          {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v72 = 2112;
          id v73 = v8;
          _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_DEFAULT, "%{public}@Watch does not support the current resident: %@", buf, 0x16u);
        }
        char v29 = 0;
      }
      BOOL v5 = v66;
  ...
  if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v71 = v28;
    _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_ERROR, "%{public}@Invalid home specified to setup/disable remote access", buf, 0xCu);
  }
LABEL_48:
}
...
void __63__HMDMessageDispatcher_Deprecated__setCompanionDevice_forHome___block_invoke(id *a1)
{
  ...
  if (v5)
  {
    if (v9)
    {
      ...
      __int16 v23 = 2112;
      char v24 = v12;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Enabling companion remote access for home %@ via device: %@", (uint8_t *)&v19, 0x20u);
    }
    if (!v4)
    {
  ...
  else
  {
    if (v9)
    {
      ...
      __int16 v21 = 2112;
      id v22 = v16;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Disabling companion remote access for home: %@", (uint8_t *)&v19, 0x16u);
    }
  }
...
void __61__HMDMessageDispatcher_Deprecated__handleSecureSessionError___block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
          ...
          if ([v13 containsDevice:v31])
          {
            ...
            if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = v28;
              ...
              __int16 v40 = 2112;
              v41 = v17;
              _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Tearing down remote access session to device, %@, for home '%@'", buf, 0x20u);
    ...
    id v22 = [v21 domain];
    if ([v22 isEqualToString:*MEMORY[0x263F08410]])
    {
...
LABEL_27:
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        char v37 = v27;
        _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@Posting notification that remote session was torn down for an unknown home", buf, 0xCu);
      }
