    ...
    *(void *)&long long v8 = 138543618;
    ...
    do
    {
      for (uint64_t i = 0; i != v39; ++i)
      {
        ...
        v49 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v10];
        ...
        else
        {
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v34;
            ...
            __int16 v66 = 2112;
            uint64_t v67 = v10;
            _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_INFO, "%{public}@deserializeMediaResponse: Cannot find mediaProfile with identifier %@", buf, 0x16u);
          }
        }
      }
      uint64_t v39 = [obj countByEnumeratingWithState:&v58 objects:v68 count:16];
...
+ (id)serializeResponses:(id)a3
{
  ...
  id v3 = a3;
  v33 = objc_msgSend(MEMORY[0x263EFF9A0], "dictionaryWithCapacity:", objc_msgSend(v3, "count"));
  v36 = v3;
  ...
  if (v37)
  {
    ...
    uint64_t v32 = *MEMORY[0x263F0D180];
    do
    {
      uint64_t v4 = 0;
      do
      {
        ...
        id v6 = objc_msgSend(MEMORY[0x263EFF9A0], "dictionaryWithCapacity:", objc_msgSend(v36, "count"));
        long long v39 = 0u;
        long long v40 = 0u;
        long long v41 = 0u;
        long long v42 = 0u;
