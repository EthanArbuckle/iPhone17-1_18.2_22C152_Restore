...
void __63__HMDHomeEventsGenerated_expandedTopicsWithTopics_homeManager___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4 && [v4 isIndexTopic])
  {
    ...
    else
    {
      ...
      long long v64 = 0u;
      long long v65 = 0u;
      uint64_t v32 = [&unk_26E476768 countByEnumeratingWithState:&v64 objects:v72 count:16];
      if (v32)
      {
        uint64_t v33 = v32;
        ...
        do
        {
          ...
          {
            if (*(void *)v65 != v34) {
              objc_enumerationMutation(&unk_26E476768);
            }
            uint64_t v36 = *(void *)(*((void *)&v64 + 1) + 8 * i);
            v37 = [&unk_26E4767E0 objectForKeyedSubscript:v36];
          ...
          uint64_t v33 = [&unk_26E476768 countByEnumeratingWithState:&v64 objects:v72 count:16];
        }
        while (v33);
      }
...
+ (id)accessorySettingsTopicsForAccessory:(id)a3 homeUUID:(id)a4
{
  ...
  if (v8)
  {
    ...
    if ([v13 isEqualToString:*MEMORY[0x263F0B0A0]])
    {
...
+ (id)upstreamHomeAndAccessoryTopicsForTopic:(id)a3 homeUUID:(id)a4 accessoryUUID:(id)a5
{
  ...
  v13 = [MEMORY[0x263F0E300] decodeTopic:v8];
  v14 = v13;
  if (v13)
  {
...
{
  id v6 = a4;
  uint64_t v7 = [MEMORY[0x263F0E300] decodeTopic:a3];
  id v8 = v7;
  if (!v7) {
    goto LABEL_9;
  }
  ...
  v18 = (void *)v17;
  v19 = [v8 topicSuffix];
  v20 = [&unk_26E4766F0 objectForKeyedSubscript:v19];
...
+ (id)upstreamClientTopicForTopic:(id)a3
{
  id v3 = [MEMORY[0x263F0E300] decodeTopic:a3];
  id v4 = v3;
  if (v3)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (v6)
        {
          uint64_t v12 = [&unk_26E476678 objectForKeyedSubscript:@"indexes"];
...
id __75__HMDHomeEventsGenerated_forwardingTopicsWithTopics_forHomeRouterWithUUID___block_invoke(uint64_t a1, void *a2)
{
  ...
  id v3 = a2;
  id v4 = [MEMORY[0x263F0E300] decodeTopic:v3];
  id v5 = v4;
  if (!v4
    || ([v4 homeUUID],
  ...
  if (!v8)
  {
    ...
    else
    {
      ...
      if (v14)
      {
        ...
        uint64_t v16 = [&unk_26E476600 objectForKeyedSubscript:v15];
...
LABEL_17:
  ...
  id v9 = [*(id *)(a1 + 40) homeInfoIndexForHomeUUID:*(void *)(a1 + 32)];
  v25[0] = v9;
  id v10 = [MEMORY[0x263EFF8C0] arrayWithObjects:v25 count:1];
LABEL_18:
...
{
  id v5 = a4;
  id v6 = [&unk_26E476588 objectForKeyedSubscript:a3];
...
+ (id)allTopics
{
  return &unk_26E474548;
}

+ (id)topicMap
{
  return &unk_26E476510;
}
