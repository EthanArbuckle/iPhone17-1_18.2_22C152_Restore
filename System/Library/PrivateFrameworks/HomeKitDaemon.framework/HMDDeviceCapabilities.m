...
- (void)setModelParentIdentifier:(id)a3
{
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v31 = v22;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Parent identifier is already present for this object", buf, 0xCu);
      }
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v31 = v28;
        _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_ERROR, "%{public}@Parent identifier is already present for this object", buf, 0xCu);
      }
    }
    else
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v32 = 2112;
          id v33 = v11;
          _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to update model with error: %@", buf, 0x16u);
        }
      }
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v31 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Model parent UUID is a required argument", buf, 0xCu);
    }
  }
}
      ...
      if (v16)
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          *(void *)&uint8_t buf[4] = v20;
          _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Updating device capabilities", buf, 0xCu);
        }
        ...
        *(void *)buf = v17;
        v24 = [NSDictionary dictionaryWithObjects:buf forKeys:v40 count:1];
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if (v20 != [(HMDDeviceCapabilities *)v6 supportsHomeLevelLocationServiceSetting])goto LABEL_64; {
    ...
    if (v22 != [(HMDDeviceCapabilities *)v6 supportsCompanionInitiatedObliterate])goto LABEL_64; {
    ...
    if (v34 != [(HMDDeviceCapabilities *)v6 supportsCameraRecordingReachabilityNotifications])goto LABEL_64; {
    BOOL v35 = [(HMDDeviceCapabilities *)self supportsAnnounce];
    }
    if (v35 != [(HMDDeviceCapabilities *)v6 supportsAnnounce]) {
      goto LABEL_64;
    }
    BOOL v36 = [(HMDDeviceCapabilities *)self supportsAudioAnalysis];
    if (v36 != [(HMDDeviceCapabilities *)v6 supportsAudioAnalysis]) {
      goto LABEL_64;
    }
    BOOL v37 = [(HMDDeviceCapabilities *)self supportsDropIn];
    if (v37 != [(HMDDeviceCapabilities *)v6 supportsDropIn]) {
      goto LABEL_64;
    }
    BOOL v38 = [(HMDDeviceCapabilities *)self supportsThirdPartyMusic];
    if (v38 != [(HMDDeviceCapabilities *)v6 supportsThirdPartyMusic]) {
      goto LABEL_64;
    }
    BOOL v39 = [(HMDDeviceCapabilities *)self supportsPreferredMediaUser];
    if (v39 != [(HMDDeviceCapabilities *)v6 supportsPreferredMediaUser]) {
      goto LABEL_64;
    }
    BOOL v40 = [(HMDDeviceCapabilities *)self supportsThreadBorderRouter];
    if (v40 != [(HMDDeviceCapabilities *)v6 supportsThreadBorderRouter]) {
      goto LABEL_64;
    }
    BOOL v41 = [(HMDDeviceCapabilities *)self supportsSiriEndpointSetup];
    if (v41 != [(HMDDeviceCapabilities *)v6 supportsSiriEndpointSetup]) {
      goto LABEL_64;
    }
    BOOL v42 = [(HMDDeviceCapabilities *)self supportsHomeHub];
    if (v42 != [(HMDDeviceCapabilities *)v6 supportsHomeHub]) {
      goto LABEL_64;
    }
    BOOL v43 = [(HMDDeviceCapabilities *)self supportsWakeOnLAN];
    if (v43 != [(HMDDeviceCapabilities *)v6 supportsWakeOnLAN]) {
      goto LABEL_64;
    }
    BOOL v44 = [(HMDDeviceCapabilities *)self supportsLockNotificationContext];
    if (v44 != [(HMDDeviceCapabilities *)v6 supportsLockNotificationContext]) {
      goto LABEL_64;
    }
    BOOL v45 = [(HMDDeviceCapabilities *)self supportsCoordinationDoorbellChime];
    if (v45 != [(HMDDeviceCapabilities *)v6 supportsCoordinationDoorbellChime]) {
      goto LABEL_64;
    }
    BOOL v46 = [(HMDDeviceCapabilities *)self supportsCoordinationFreeDoorbellChime];
    if (v46 != [(HMDDeviceCapabilities *)v6 supportsCoordinationFreeDoorbellChime])goto LABEL_64; {
    BOOL v47 = [(HMDDeviceCapabilities *)self supportsTVOSUpdateManualUpdateAvailableNotification];
    }
    if (v47 != [(HMDDeviceCapabilities *)v6 supportsTVOSUpdateManualUpdateAvailableNotification])goto LABEL_64; {
    BOOL v48 = [(HMDDeviceCapabilities *)self supportsManagedConfigurationProfile];
    }
    if (v48 != [(HMDDeviceCapabilities *)v6 supportsManagedConfigurationProfile]) {
      goto LABEL_64;
    }
    BOOL v49 = [(HMDDeviceCapabilities *)self supportsAudioReturnChannel];
    if (v49 != [(HMDDeviceCapabilities *)v6 supportsAudioReturnChannel]) {
      goto LABEL_64;
    }
    BOOL v50 = [(HMDDeviceCapabilities *)self supportsWalletKey];
    if (v50 != [(HMDDeviceCapabilities *)v6 supportsWalletKey]) {
      goto LABEL_64;
    }
    BOOL v51 = [(HMDDeviceCapabilities *)self supportsCameraPackageDetection];
    if (v51 != [(HMDDeviceCapabilities *)v6 supportsCameraPackageDetection]) {
      goto LABEL_64;
    }
    BOOL v52 = [(HMDDeviceCapabilities *)self supportsAccessCodes];
    if (v52 != [(HMDDeviceCapabilities *)v6 supportsAccessCodes]) {
      goto LABEL_64;
    }
    BOOL v53 = [(HMDDeviceCapabilities *)self supportsCHIP];
    if (v53 != [(HMDDeviceCapabilities *)v6 supportsCHIP]) {
      goto LABEL_64;
    }
    BOOL v54 = [(HMDDeviceCapabilities *)self supportsUnifiedMediaNotifications];
    if (v54 != [(HMDDeviceCapabilities *)v6 supportsUnifiedMediaNotifications]) {
      goto LABEL_64;
    }
    BOOL v55 = [(HMDDeviceCapabilities *)self supportsCaptiveNetworks];
    if (v55 != [(HMDDeviceCapabilities *)v6 supportsCaptiveNetworks]) {
      goto LABEL_64;
    }
    BOOL v56 = [(HMDDeviceCapabilities *)self supportsModernTransport];
    if (v56 != [(HMDDeviceCapabilities *)v6 supportsModernTransport]) {
      goto LABEL_64;
    }
    BOOL v57 = [(HMDDeviceCapabilities *)self supportsResidentFirstAccessoryCommunication];
    if (v57 != [(HMDDeviceCapabilities *)v6 supportsResidentFirstAccessoryCommunication])goto LABEL_64; {
    BOOL v58 = [(HMDDeviceCapabilities *)self supportsMessagedHomePodSettings];
    }
    if (v58 == [(HMDDeviceCapabilities *)v6 supportsMessagedHomePodSettings]
      && (v59 = [(HMDDeviceCapabilities *)self supportsCustomMediaApplicationDestination], v59 == [(HMDDeviceCapabilities *)v6 supportsCustomMediaApplicationDestination])&& (v60 = [(HMDDeviceCapabilities *)self supportsThreadNetworkCredentialSharing], v60 == [(HMDDeviceCapabilities *)v6 supportsThreadNetworkCredentialSharing])&& (BOOL v61 = [(HMDDeviceCapabilities *)self supportsMatterSharedAdminPairing], v61 == [(HMDDeviceCapabilities *)v6 supportsMatterSharedAdminPairing])&& (v62 = [(HMDDeviceCapabilities *)self supportsRMVonAppleTV], v62 == [(HMDDeviceCapabilities *)v6 supportsRMVonAppleTV])&& (v63 = [(HMDDeviceCapabilities *)self supportsJustSiri], v63 == [(HMDDeviceCapabilities *)v6 supportsJustSiri])&& (v64 = [(HMDDeviceCapabilities *)self supportsThreadService], v64 == [(HMDDeviceCapabilities *)v6 supportsThreadService]))
    {
      BOOL v67 = [(HMDDeviceCapabilities *)self supportsMatterOwnerCertFetch];
      BOOL v65 = v67 ^ [(HMDDeviceCapabilities *)v6 supportsMatterOwnerCertFetch] ^ 1;
    }
    else
    {
LABEL_64:
...
- (HMDDeviceCapabilities)initWithObjectModel:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      BOOL v15 = v11;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Model object is a required argument", buf, 0xCu);
    }
    BOOL v8 = 0;
  }
...
- (HMDDeviceCapabilities)initWithProductInfo:(id)a3 mobileGestaltClient:(id)a4 homekitVersion:(id)a5
{
  ...
  if (v8)
  {
    ...
    BOOL v12 = [MEMORY[0x263F08C38] UUID];
    ...
    BOOL v18 = [NSNumber numberWithBool:productSupportsKeychainSync(v8)];
    ...
    BOOL v47 = objc_msgSend(NSNumber, "numberWithBool:", productSupportsAudioAnalysis(v8, v9));
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsAudioAnalysis:v47];

    BOOL v48 = objc_msgSend(NSNumber, "numberWithBool:", productSupportsDropIn(v8, v9));
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsDropIn:v48];

    BOOL v49 = [NSNumber numberWithBool:productSupportsThirdPartyMusic(v8)];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsThirdPartyMusic:v49];

    BOOL v50 = [NSNumber numberWithBool:productSupportsPreferredMediaUser(v8)];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsPreferredMediaUser:v50];

    BOOL v51 = [NSNumber numberWithBool:0];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsThreadBorderRouter:v51];

    BOOL v52 = [NSNumber numberWithBool:productSupportsThirdPartyMusic(v8)];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsDoorbellChime:v52];

    BOOL v53 = [NSNumber numberWithBool:productSupportsUserMediaSettings(v8)];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsUserMediaSettings:v53];

    BOOL v54 = [NSNumber numberWithBool:productSupportsCoordinationDoorbellChime(v8)];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsCoordinationDoorbellChime:v54];

    BOOL v55 = [NSNumber numberWithBool:productSupportsCoordinationFreeDoorbellChime(v8)];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsCoordinationFreeDoorbellChime:v55];

    BOOL v56 = NSNumber;
    [v8 productClass];
    BOOL v57 = [v56 numberWithBool:0];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsTVOSUpdateManualUpdateAvailableNotification:v57];

    BOOL v58 = [NSNumber numberWithBool:productSupportsSiriEndpointSetup(v8)];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsSiriEndpointSetup:v58];

    BOOL v59 = objc_msgSend(NSNumber, "numberWithBool:", productSupportsHomeHub(v8, v9));
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsHomeHub:v59];

    BOOL v60 = [NSNumber numberWithBool:productSupportsWakeOnLAN(v8)];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsWakeOnLAN:v60];

    BOOL v61 = [NSNumber numberWithBool:productSupportsLockNotificationContext(v8)];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsLockNotificationContext:v61];

    BOOL v62 = objc_msgSend(NSNumber, "numberWithBool:", productSupportsAudioReturnChannel(v8, v9));
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsAudioReturnChannel:v62];

    BOOL v63 = [NSNumber numberWithBool:productSupportsLockNotificationContext(v8)];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsWalletKey:v63];

    BOOL v64 = [NSNumber numberWithBool:productSupportsLockNotificationContext(v8)];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsCameraPackageDetection:v64];

    BOOL v65 = [NSNumber numberWithBool:productSupportsLockNotificationContext(v8)];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsAccessCodes:v65];

    v66 = [NSNumber numberWithBool:productSupportsLockNotificationContext(v8)];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsCHIP:v66];

    BOOL v67 = [NSNumber numberWithBool:productSupportsUnifiedMediaNotifications(v8)];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsUnifiedMediaNotifications:v67];

    id v68 = [NSNumber numberWithBool:productSupportsUserMediaSettings(v8)];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsManagedConfigurationProfile:v68];

    v69 = [NSNumber numberWithBool:productSupportsCaptiveNetworks(v8)];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsCaptiveNetworks:v69];

    [(HMDDeviceCapabilitiesModel *)v13 setSupportsModernTransport:MEMORY[0x263EFFA80]];
    v70 = [NSNumber numberWithBool:productSupportsResidentFirstAccessoryCommunication(v8)];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsResidentFirstAccessoryCommunication:v70];

    v71 = objc_msgSend(NSNumber, "numberWithBool:", productSupportsMessagedHomePodSettings(v8, v10));
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsMessagedHomePodSettings:v71];

    v72 = [NSNumber numberWithBool:productSupportsCustomMediaApplicationDestination(v8)];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsCustomMediaApplicationDestination:v72];

    v73 = objc_msgSend(NSNumber, "numberWithBool:", productSupportsThreadNetworkCredentialSharing(v8, v9, v10));
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsThreadNetworkCredentialSharing:v73];

    v74 = objc_msgSend(NSNumber, "numberWithBool:", productSupportsMatterSharedAdminPairing(v8, v9, v10));
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsMatterSharedAdminPairing:v74];

    v75 = [NSNumber numberWithBool:productSupportsRMVonAppleTV(v8)];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsRMVonAppleTV:v75];

    v76 = [NSNumber numberWithBool:productSupportsJustSiri(v8)];
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsJustSiri:v76];

    v77 = NSNumber;
    uint64_t v94 = 0;
    memset(buf, 0, sizeof(buf));
    id v78 = v8;
    v79 = [v78 softwareVersion];
    v80 = v79;
    if (v79)
    {
      [v79 operatingSystemVersion];
    }
    else
    {
      memset(buf, 0, sizeof(buf));
    ...
    uint64_t v85 = [v78 productPlatform];
    unint64_t v86 = [v78 productClass];
    ...
    if (v85 == 2
      && (long long v91 = *(_OWORD *)buf, v92 = v94, HMFOperatingSystemVersionCompare() != 1)
      && isFeatureMatteriPhoneOnlyPairingControlForThreadEnabled())
    {
LABEL_22:
      uint64_t v87 = MGGetBoolAnswer();
    }
    else
    {
      uint64_t v87 = 0;
...
LABEL_24:
    v88 = objc_msgSend(v77, "numberWithBool:", v87, v91, v92);
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsThreadService:v88];

    v89 = objc_msgSend(NSNumber, "numberWithBool:", productSupportsMatterOwnerCertFetch(v78, v9, v10));
    [(HMDDeviceCapabilitiesModel *)v13 setSupportsMatterOwnerCertFetch:v89];
  ...
  if (os_log_type_enabled(v82, OS_LOG_TYPE_ERROR))
  {
    ...
    *(void *)&uint8_t buf[4] = v83;
    _os_log_impl(&dword_22F52A000, v82, OS_LOG_TYPE_ERROR, "%{public}@Product info is a required argument", buf, 0xCu);
  }
  v84 = 0;
LABEL_25:
...
+ (BOOL)isInternalVirtualDevice
{
  if (isInternalVirtualDevice_onceToken != -1) {
    dispatch_once(&isInternalVirtualDevice_onceToken, &__block_literal_global_399_217620);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_217625 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_217625, &__block_literal_global_216_217626);
  }
  v2 = (void *)logCategory__hmf_once_v5_217627;
  return v2;
}
...
void __36__HMDDeviceCapabilities_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_217627;
  logCategory__hmf_once_v5_217627 = v0;
}

+ (HMDDeviceCapabilities)deviceCapabilities
{
  if (deviceCapabilities_onceToken != -1) {
    dispatch_once(&deviceCapabilities_onceToken, &__block_literal_global_217632);
  }
...
+ (BOOL)supportsAddingAccessory
{
  v2 = [MEMORY[0x263F42648] systemInfo];
  if ([v2 productPlatform] == 1)
  {
    unint64_t v3 = [MEMORY[0x263F42648] systemInfo];
...
+ (BOOL)supportsTargetControllerAutoConfigure
{
  ...
  unint64_t v3 = [MEMORY[0x263F42620] productInfo];
...
LABEL_4:
  ...
  id v6 = [MEMORY[0x263F42620] productInfo];
