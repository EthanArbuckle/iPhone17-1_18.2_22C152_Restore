...
- (NSDictionary)naturalLightingCurveResourceFileContent
{
  ...
  if (v3)
  {
    ...
    id v15 = 0;
    double v5 = [NSDictionary dictionaryWithContentsOfURL:v4 error:&v15];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v20 = 2112;
        v21 = v6;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to create dictionary from file URL %@:%@", buf, 0x20u);
      }
  ...
  {
    dispatch_time_t v8 = (void *)MEMORY[0x230FBD990]();
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v20 = 2112;
      v21 = @"plist";
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to locate the resource file with name: %@ with extension: %@", buf, 0x20u);
    }
    id v7 = (id)MEMORY[0x263EFFA78];
  }
...
- (NSTimeZone)localTimeZone
{
  return (NSTimeZone *)[MEMORY[0x263EFFA18] localTimeZone];
}
