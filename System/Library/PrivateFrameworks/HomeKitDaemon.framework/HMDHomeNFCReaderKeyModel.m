...
+ (id)properties
{
  if (properties_onceToken_383 != -1) {
    dispatch_once(&properties_onceToken_383, &__block_literal_global_386);
  }
  v2 = (void *)properties__properties_384;
  return v2;
}
