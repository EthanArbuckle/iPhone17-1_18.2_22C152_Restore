...
- (void)fetchHomeWidgetsWithCompletion:(id)a3
{
  ...
  {
    v6 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v28 = 2112;
      v29 = v16;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Fetched configured widgets: %@", buf, 0x16u);
    }
  ...
  if (!v14)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v90 = 2112;
      v91 = v28;
      _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@Ignoring widget configuration because the intent is not INAppIntent: %@", buf, 0x16u);
    }
    goto LABEL_21;
  }
  char v87 = 0;
  ...
  if (!v87)
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v92 = 2112;
      v93[0] = v31;
      _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@Ignoring widget configuration because %@ key is missing from serialized parameters: %@", buf, 0x20u);
    }
LABEL_21:
  ...
  if (v19)
  {
    id v20 = objc_alloc_init(MEMORY[0x263F502B8]);
    v21 = v20;
    int v78 = v16;
    if (v16)
    {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v62, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v90 = 2112;
        v91 = v57;
        _os_log_impl(&dword_22F52A000, v62, OS_LOG_TYPE_DEBUG, "%{public}@Handling single item accessories and scenes entry %@", buf, 0x16u);
      }
      v95[0] = v59;
      id v37 = [MEMORY[0x263EFF8C0] arrayWithObjects:v95 count:1];
                ...
                else
                {
                  ...
                  if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_DWORD *)buf = 138543618;
                    ...
                    __int16 v90 = 2112;
                    v91 = v44;
                    _os_log_impl(&dword_22F52A000, v55, OS_LOG_TYPE_ERROR, "%{public}@Unexpectedly missing the identifier in %@", buf, 0x16u);
              ...
              else
              {
                ...
                if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v90 = 2112;
                  v91 = v44;
                  _os_log_impl(&dword_22F52A000, v51, OS_LOG_TYPE_ERROR, "%{public}@accessoryOrScene is not a dictionary! %@", buf, 0x16u);
                }
              }
            }
...
LABEL_57:
    ...
    if (os_log_type_enabled(v69, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      WORD2(v93[0]) = 2112;
      *(void *)((char *)v93 + 6) = v79;
      _os_log_impl(&dword_22F52A000, v69, OS_LOG_TYPE_DEBUG, "%{public}@IFObjectHasher: computed widget identifier %{public}@ with useHomeKitRecommendations=%{BOOL}d, accessoriesAndScenes=%@", buf, 0x26u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v92 = 2112;
      v93[0] = v36;
      _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_DEFAULT, "%{public}@Ignoring widget configuration because %@ key is missing from serialized parameters: %@", buf, 0x20u);
    }
    uint64_t v10 = 0;
  }
...
- (id)fetchedHomeWidgets
{
  if (self)
  {
    ...
    v15 = __Block_byref_object_copy__134503;
    int v16 = __Block_byref_object_dispose__134504;
...
- (HMDWidgetConfigurationReader)init
{
  ...
  uint64_t v4 = *MEMORY[0x263F0C7A8];
  id v5 = objc_alloc_init(MEMORY[0x263F31E80]);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t12_134512 != -1) {
    dispatch_once(&logCategory__hmf_once_t12_134512, &__block_literal_global_134513);
  }
  v2 = (void *)logCategory__hmf_once_v13_134514;
  return v2;
}
...
void __43__HMDWidgetConfigurationReader_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v13_134514;
  logCategory__hmf_once_v13_134514 = v0;
}
