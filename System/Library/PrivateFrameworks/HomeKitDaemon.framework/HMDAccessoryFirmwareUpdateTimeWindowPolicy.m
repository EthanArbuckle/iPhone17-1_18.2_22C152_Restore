...
- (void)_startReevaluateTimer:(id)a3
{
  ...
  v9 = (void *)[objc_alloc(MEMORY[0x263F42658]) initWithTimeInterval:1 options:v8];
...
- (BOOL)evaluate
{
  ...
  if (!v12 || !v19)
  {
    v39 = (void *)MEMORY[0x230FBD990](v26);
    v40 = self;
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v58 = v42;
      _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_INFO, "%{public}@Invalid time window, policy status evaluated to NO", buf, 0xCu);
    }
    id v27 = objc_alloc_init(MEMORY[0x263EFF918]);
    [v27 setHour:12];
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v63 = 2112;
    v64 = v34;
    _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_INFO, "%{public}@Evaluate now=%@ in interval=[%@, %@]", buf, 0x2Au);
  ...
  {
    id v36 = objc_alloc_init(MEMORY[0x263EFF918]);
    [v36 setDay:1];
...
LABEL_18:
  ...
  if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v59 = 2112;
    v60 = v49;
    _os_log_impl(&dword_22F52A000, v47, OS_LOG_TYPE_INFO, "%{public}@Policy status evaluated to %@", buf, 0x16u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_174566 != -1) {
    dispatch_once(&logCategory__hmf_once_t2_174566, &__block_literal_global_67);
  }
  v2 = (void *)logCategory__hmf_once_v3_174567;
  return v2;
}
...
void __57__HMDAccessoryFirmwareUpdateTimeWindowPolicy_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_174567;
  logCategory__hmf_once_v3_174567 = v0;
}
