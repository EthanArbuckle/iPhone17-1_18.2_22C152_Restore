...
- (BOOL)_parseFromTLVData
{
  ...
  v3 = [MEMORY[0x263F35A58] wrappertlv:1 name:@"kAudioParameters_CodecGroup"];
  id v4 = [MEMORY[0x263F35990] wrappertlv:2 name:@"kAudioParameters_CodecParameters"];
  v5 = [MEMORY[0x263F35990] wrappertlv:3 name:@"kAudioParameters_RTPParameter"];
  id v6 = [MEMORY[0x263F35A58] wrappertlv:4 name:@"kAudioParameters_ComfortNoise"];
  v31[0] = v3;
  v31[1] = v4;
  void v31[2] = v5;
  v31[3] = v6;
  id v7 = [MEMORY[0x263EFF8C0] arrayWithObjects:v31 count:4];
