  ...
  if (v8)
  {
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v27 = 2114;
        id v28 = v14;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Forwarding decoded setting event for %{public}@", (uint8_t *)&v25, 0x16u);
      }
      v15 = [v9 keyPath];
    ...
    else
    {
      ...
      if (v15)
      {
        if (v19)
        {
          ...
          __int16 v27 = 2114;
          id v28 = v21;
          _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Forwarding decoded setting event for %{public}@", (uint8_t *)&v25, 0x16u);
        }
      ...
      else
      {
        if (v19)
        {
          ...
          __int16 v27 = 2114;
          id v28 = v7;
          _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Parsed setting for topic%{public}@ is neither BOOL nor integer", (uint8_t *)&v25, 0x16u);
        }
        v15 = 0;
      }
    }
...
- (id)_transformLegacyLanguageSettingValueToImmutableSetting:(id)a3
{
  ...
  if ((unint64_t)[v5 count] > 2)
  {
    ...
    v10 = (void *)[objc_alloc(MEMORY[0x263F0E740]) initWithInputLanguageCode:v11 outputVoiceLanguageCode:v12 outputVoiceGenderCode:v13 voiceName:v14];
  }
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v18 = 2112;
      id v19 = v4;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to get expected language code count from legacy language setting encoding: %@", (uint8_t *)&v16, 0x16u);
    }
    v10 = 0;
  }
...
- (id)_settingValueForKeyPath:(id)a3 value:(id)a4
{
  ...
  id v6 = a3;
  id v7 = a4;
  if ([MEMORY[0x263F0E048] isKeyPathForBooleanSettingType:v6])
  {
    id v8 = v7;
    objc_opt_class();
    ...
    if (v10)
    {
      uint64_t v11 = objc_msgSend(objc_alloc(MEMORY[0x263F0E728]), "initWithBoolValue:", objc_msgSend(v10, "BOOLValue"));
LABEL_31:
      v31 = (void *)v11;
LABEL_37:
...
LABEL_34:
    _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_ERROR, v36, (uint8_t *)&v48, 0x20u);
...
LABEL_36:
  ...
  if ([MEMORY[0x263F0E048] isKeyPathForConstrainedNumberSettingType:v6])
  {
    id v12 = v7;
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
    ...
    if (v10)
    {
      v14 = [MEMORY[0x263F0E048] scaleUpNumberSettingValue:v12];
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v54 = 2114;
        id v55 = v6;
        _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Updating legacy integer value %@ to %@: %{public}@", (uint8_t *)&v48, 0x2Au);
      }
      uint64_t v11 = [objc_alloc(MEMORY[0x263F0E738]) initWithIntegerValue:v15];
      goto LABEL_31;
    }
    v32 = (void *)MEMORY[0x230FBD990]();
    v33 = self;
  ...
  if ([MEMORY[0x263F0E048] isKeyPathForTapAssistanceSelectionSettingType:v6])
  {
    id v21 = v7;
    if (v21)
    {
      id v10 = v21;
      uint64_t v22 = [MEMORY[0x263F0E048] itemIndexWithTapAssistanceSelectionItem:v21];
      v23 = [NSNumber numberWithInteger:v22];
      v24 = [MEMORY[0x263F0E048] scaleUpNumberSettingValue:v23];
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v54 = 2114;
        id v55 = v6;
        _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_DEFAULT, "%{public}@Updating legacy selection item index value %@ to %@: %{public}@", (uint8_t *)&v48, 0x2Au);
      }
      v31 = (void *)[objc_alloc(MEMORY[0x263F0E738]) initWithIntegerValue:v25];
    ...
    if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v52 = 2114;
      id v53 = v6;
      _os_log_impl(&dword_22F52A000, v46, OS_LOG_TYPE_ERROR, "%{public}@Passed in value: %@ is not a selection item for setting: %{public}@", (uint8_t *)&v48, 0x20u);
    }
    goto LABEL_36;
  }
  v37 = [MEMORY[0x263F0E048] languageKeyPaths];
  ...
  if (v38)
  {
    ...
    if (!v10)
    {
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v50 = 2112;
        id v51 = v39;
        _os_log_impl(&dword_22F52A000, v43, OS_LOG_TYPE_DEFAULT, "%{public}@Passed value = %@, is not a language setting", (uint8_t *)&v48, 0x16u);
      }
    }
...
- (void)updateSettingWithKeyPath:(id)a3 settingValue:(id)a4 completion:(id)a5
{
  ...
  if (v11)
  {
    ...
    if (v12)
    {
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v26 = 2114;
        id v27 = v8;
        _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Sending update %{public}@ to controller", (uint8_t *)&v24, 0x16u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        int v24 = 138543362;
        uint64_t v25 = v22;
        _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@No current settings controller.", (uint8_t *)&v24, 0xCu);
      }
      v23 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
      v10[2](v10, v23);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      int v24 = 138543362;
      uint64_t v25 = v21;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Could not obtain setting value from given legacy value.", (uint8_t *)&v24, 0xCu);
    }
...
- (void)startup
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v26 = 2112;
    id v27 = v8;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Subscribing to home: %@, accessory: %@ keyPaths on startup.", buf, 0x20u);
  }
  id v9 = [MEMORY[0x263F0E048] defaultSettingsAllKeyPaths];
  ...
  uint64_t v11 = [MEMORY[0x263F0E048] languageKeyPaths];
  ...
  if (v13 && [v13 count])
  {
    ...
    v19[3] = &unk_264A2E660;
    v19[4] = v4;
    [v14 changeRegistrationsForConsumer:v4 topicFilterAdditions:v13 topicFilterRemovals:MEMORY[0x263EFFA68] completion:v19];
  }
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v23 = v18;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@No default settings keypaths are found", buf, 0xCu);
    }
  }
}
...

{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v18 = 2112;
      id v19 = v11;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@available language fetch returned Error =%@", (uint8_t *)&v16, 0x16u);
    }
  }
  else
  {
...
LABEL_13:
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = v25;
          ...
          __int16 v39 = 2114;
          uint64_t v40 = v8;
          _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Parsed setting for topic%{public}@ is not of {Integer, Bool, Language}", buf, 0x16u);
...
+ (id)parsedLanguageListSetting:(id)a3 topic:(id)a4
{
  ...
  id v6 = a3;
  id v7 = a4;
  uint64_t v8 = [MEMORY[0x263F0E300] decodeTopic:v7];
  ...
  id v30 = 0;
  id v13 = [MEMORY[0x263F0E3F8] decodeSettingFromEvent:v6 error:&v30];
  id v14 = v30;
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v35 = 2112;
    id v36 = v14;
    _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@unable to decode event:%@ %@", buf, 0x20u);
  }
  if (v13)
  {
    id v19 = v13;
...
+ (id)parsedLanguageSetting:(id)a3 topic:(id)a4
{
  ...
  id v26 = 0;
  id v13 = [MEMORY[0x263F0E3F8] decodeSettingFromEvent:v6 error:&v26];
  id v14 = v26;
  if (v13)
  {
    id v15 = v13;
...
LABEL_13:
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, v23, buf, 0x16u);
    }
  }
  else
  {
...
LABEL_5:
  id v25 = 0;
  id v15 = [MEMORY[0x263F0E3F8] decodeSettingFromEvent:v6 error:&v25];
  id v16 = v25;
  if (v15)
  {
    id v17 = v15;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v28 = 2114;
      id v29 = v7;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Obtained setting but not of bounded integer type. %{public}@", buf, 0x16u);
    }
    id v19 = 0;
  }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v33 = 2114;
          id v34 = v7;
          _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Obtained setting but not of BOOL type. %{public}@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v33 = 2114;
        id v34 = v7;
        _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Received setting change event but could not decode. %{public}@", buf, 0x16u);
      }
      id v19 = 0;
    }
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_237520 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_237520, &__block_literal_global_237521);
  }
  v2 = (void *)logCategory__hmf_once_v1_237522;
  return v2;
}
...
void __48__HMDLegacyAccessorySettingsAdaptor_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_237522;
  logCategory__hmf_once_v1_237522 = v0;
}
