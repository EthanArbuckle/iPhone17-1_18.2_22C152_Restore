...
- (void)timerDidFire:(id)a3
{
  ...
  if (!v7)
  {
    v9 = [MEMORY[0x263F087E8] hmErrorWithCode:8];
    if (self) {
...
- (void)markError:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@markError %@", (uint8_t *)&v17, 0x16u);
  }
  p_lock = &v6->_lock;
  ...
  if (!v6->submitted)
  {
    ...
    v13 = (void *)MEMORY[0x230FBD990](v10);
    v14 = v6;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v4;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Shared user invite error occured. Logging error metric %@", (uint8_t *)&v17, 0x16u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5_57675 != -1) {
    dispatch_once(&logCategory__hmf_once_t5_57675, &__block_literal_global_57676);
  }
  v2 = (void *)logCategory__hmf_once_v6_57677;
  return v2;
}
...
void __49__HMDSharedUserInviteLogEventBuilder_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v6_57677;
  logCategory__hmf_once_v6_57677 = v0;
}
