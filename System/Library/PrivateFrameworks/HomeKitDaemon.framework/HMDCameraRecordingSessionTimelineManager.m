...
- (BOOL)isMotionTriggerActiveAtAnyTimeAfterOffset:(double)a3
{
  ...
  v11 = (void *)[objc_alloc(MEMORY[0x263F08798]) initWithStartDate:v7 endDate:v8];
...
- (void)handleDoorbellDidActivateAtDate:(id)a3
{
  ...
  v11 = (void *)[objc_alloc(MEMORY[0x263F08798]) initWithStartDate:v8 endDate:v10];
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v29 = 2048;
    uint64_t v30 = v18;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Doorbell trigger activated at time offset: %f", (uint8_t *)&v27, 0x16u);
  }
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v29 = 2048;
    uint64_t v30 = v25;
    _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Doorbell trigger will be deactivated at time offset: %f", (uint8_t *)&v27, 0x16u);
  }
  ...
  if (v4)
  {
    if (!v9
      || ([v9 endDate],
          ...
          (v16 & 1) == 0))
    {
      v17 = (void *)[objc_alloc(MEMORY[0x263F08798]) initWithStartDate:v6 endDate:v10];
...
LABEL_12:
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, v25, (uint8_t *)&v34, 0x16u);
  ...
  else if (v9)
  {
    ...
    if (v27)
    {
      ...
      id v29 = objc_alloc(MEMORY[0x263F08798]);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_95007 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_95007, &__block_literal_global_95008);
  }
  v2 = (void *)logCategory__hmf_once_v5_95009;
  return v2;
}
...
void __55__HMDCameraRecordingSessionTimelineManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_95009;
  logCategory__hmf_once_v5_95009 = v0;
}
