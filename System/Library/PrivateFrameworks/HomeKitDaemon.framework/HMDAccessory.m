...
- (void)_handlePreviewAllowedHosts:(id)a3
{
  ...
  {
    v7 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
...
void __63__HMDAccessory_NetworkProtection2___handlePreviewAllowedHosts___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    uint64_t v10 = *MEMORY[0x263F0D250];
  ...
  else
  {
    if (!v6)
    {
      v7 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
    }
    id v9 = 0;
  }
...
- (void)notifyClientsOfUpdatedAccessoryControllableValue:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v32 = 2112;
    v33 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Notifying clients of updated accessory controllable value: %@", buf, 0x16u);
  }
  uint64_t v10 = objc_msgSend(NSNumber, "numberWithBool:", v3, *MEMORY[0x263F0B258]);
  v29 = v10;
  v11 = [NSDictionary dictionaryWithObjects:&v29 forKeys:&v28 count:1];

  uint64_t v12 = *MEMORY[0x263F0B260];
  v13 = [MEMORY[0x263F42590] entitledMessageWithName:*MEMORY[0x263F0B260] messagePayload:v11];
  id v14 = objc_alloc(MEMORY[0x263F42570]);
  v15 = [(HMDAccessory *)v6 messageTargetUUID];
...
- (void)handleRemovedSoftwareUpdateModel:(id)a3 message:(id)a4
{
  ...
  if (!v9)
  {
    if (v13)
    {
      ...
      __int16 v22 = 2112;
      v23 = v19;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Removing software update is not allowed from source %@", (uint8_t *)&v20, 0x16u);
    }
  ...
  if (v13)
  {
    ...
    __int16 v22 = 2112;
    v23 = v15;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Removing software update: %@", (uint8_t *)&v20, 0x16u);
  }
...
- (void)handleAddedSoftwareUpdateModel:(id)a3 message:(id)a4
{
  ...
  if (-[HMDAccessory _allowSoftwareUpdateChangeFromSource:](self, "_allowSoftwareUpdateChangeFromSource:", [v8 source]))
  {
    ...
    uint64_t v10 = (void *)MEMORY[0x230FBD990]([(HMDAccessory *)self setSoftwareUpdate:v9]);
    v11 = self;
    uint64_t v12 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v23 = 2112;
      uint64_t v24 = v9;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Added software update: %@", (uint8_t *)&v21, 0x16u);
    }
    [v8 markChanged];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v23 = 2112;
      uint64_t v24 = v20;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Adding software update is not allowed from source %@", (uint8_t *)&v21, 0x16u);
    }
    BOOL v9 = [MEMORY[0x263F087E8] hmErrorWithCode:-1];
...
- (void)handleUpdatedSoftwareUpdateModel:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", objc_msgSend(v11, "source"));
      int v18 = 138543618;
      v19 = v16;
      __int16 v20 = 2112;
      int v21 = v17;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Updating software update is not allowed from source %@", (uint8_t *)&v18, 0x16u);
    }
    uint64_t v12 = [MEMORY[0x263F087E8] hmErrorWithCode:-1];
    ...
    if (HMFEqualObjects())
    {
      ...
      if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v43 = v6;
        _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Cannot update software update, matches existing update", buf, 0xCu);
      }
      if (!*(void *)(a1 + 48)) {
        goto LABEL_39;
      }
      ...
      if (v16)
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v46 = 2112;
          v47 = v24;
          _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Software update, '%@', is older than current software version, '%@'", buf, 0x20u);
    ...
    if (v27 && ![v27 downloadSize])
    {
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v44 = 2112;
        v45 = v40;
        _os_log_impl(&dword_22F52A000, v38, OS_LOG_TYPE_DEFAULT, "%{public}@Software update, '%@', has invalid 0 download size.", buf, 0x16u);
      }
      if (!*(void *)(a1 + 48)) {
        goto LABEL_38;
      }
...
LABEL_23:
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v44 = 2112;
      v45 = v32;
      _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_DEFAULT, "%{public}@Updating software update to: %@", buf, 0x16u);
    }
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v43 = v11;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Cannot update software update for an accessory that does not support software update", buf, 0xCu);
  }
  if (*(void *)(a1 + 48))
  {
    v2 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
    (*(void (**)(void))(*(void *)(a1 + 48) + 16))();
LABEL_39:
  }
}
...
- (void)setSoftwareUpdate:(id)a3
{
  ...
  else
  {
    ...
    [v9 configureWithAccessory:self dataSource:self messageDispatcher:v6];
...
{
  os_unfair_recursive_lock_lock_with_options();
  uint64_t v3 = self->_softwareUpdate;
  os_unfair_recursive_lock_unlock();
  return v3;
}
...
- (void)__handlePairingIdentityRequest:(id)a3
{
  ...
  {
    id v8 = self;
    if ([(HMDAccessory *)v8 conformsToProtocol:&unk_26E4FFFE0]) {
      id v9 = v8;
    }
    else {
      id v9 = 0;
    ...
    if (!v10)
    {
      if (v14)
      {
        ...
        int v38 = 138543362;
        v39 = v30;
        _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Attempt to retrieve pairing identity from an accessory that does not support pairing identity", (uint8_t *)&v38, 0xCu);
      }
    ...
    if (v14)
    {
      ...
      int v38 = 138543362;
      v39 = v15;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Received request to to retrieve pairing identity for accessory", (uint8_t *)&v38, 0xCu);
    }
    int v16 = [(HMDAccessory *)v10 pairingIdentity];
    if (v16)
    {
      uint64_t v17 = [v4 BOOLForKey:*MEMORY[0x263F0B448]];
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        int v38 = 138543362;
        v39 = v23;
        _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Client requested private key but does not have entitlement for private key", (uint8_t *)&v38, 0xCu);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v40 = 2112;
        id v41 = v35;
        _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_ERROR, "%{public}@Pairing identity for accessory not found : %@", (uint8_t *)&v38, 0x16u);
      }
      uint64_t v24 = (void *)MEMORY[0x263F087E8];
      uint64_t v25 = 2;
    }
...
LABEL_26:
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v40 = 2112;
    id v41 = v4;
    _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_INFO, "%{public}@Attempt to retrieve pairing identity with mismatching identifier from message: %@", (uint8_t *)&v38, 0x16u);
  }
...
- (void)_updateHost:(id)a3
{
  ...
  BOOL v5 = objc_msgSend(MEMORY[0x263F08C38], "hmf_zeroUUID");
...
- (NSString)hashRouteID
{
  ...
  if ([(HMDAccessory *)self providesHashRouteID])
  {
    ...
    else
    {
      ...
      BOOL v7 = (void *)MEMORY[0x230FBD990](v6);
      id v8 = self;
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        int v18 = 138543362;
        char v19 = v10;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Do not have cached hashed route, reaching out to siri to fetch it", (uint8_t *)&v18, 0xCu);
      }
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v20 = 2112;
        int v21 = v5;
        _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Caching hashed route from siri: %@", (uint8_t *)&v18, 0x16u);
      }
      os_unfair_recursive_lock_lock_with_options();
...
- (void)resetHashedRoute
{
  ...
  if ([(HMDAccessory *)self providesHashRouteID])
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      int v8 = 138543362;
      char v9 = v6;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting cached hashed route", (uint8_t *)&v8, 0xCu);
    }
    os_unfair_recursive_lock_lock_with_options();
...
- (void)encodeWithCoder:(id)a3
{
  ...
  int v8 = [(HMDAccessory *)self uuid];
  char v9 = [v8 UUIDString];
  [v4 encodeObject:v9 forKey:@"accessoryUUID"];

  uint64_t v10 = [(HMDAccessory *)self getConfiguredName];
  [v4 encodeObject:v10 forKey:@"accessoryConfiguredName"];

  id v11 = [(HMDAccessory *)self displayableFirmwareVersion];
  [v4 encodeObject:v11 forKey:*MEMORY[0x263F0B2B8]];

  if (v5)
  {
    id v12 = [(HMDAccessory *)self name];
    [v4 encodeObject:v12 forKey:@"accessoryName"];

    id v13 = [(HMDAccessory *)self firmwareVersion];
    id v14 = [v13 shortVersionString];
    [v4 encodeObject:v14 forKey:@"HM.firmwareVersion"];
  ...
  {
    uint64_t v16 = [(HMDAccessory *)self configuredName];
    [v4 encodeObject:v16 forKey:@"accessoryName"];

    uint64_t v17 = [(HMDAccessory *)self firmwareVersion];
    int v18 = [v17 rawVersionString];
    [v4 encodeObject:v18 forKey:@"HM.firmwareVersion"];
  }
  char v19 = [(HMDAccessory *)self serialNumber];
  [v4 encodeObject:v19 forKey:@"HM.serialNumber"];

  int v15 = 1;
LABEL_6:
  __int16 v20 = [(HMDAccessory *)self manufacturer];
  [v4 encodeObject:v20 forKey:@"HM.manufacturer"];

  int v21 = [(HMDAccessory *)self model];
  [v4 encodeObject:v21 forKey:@"HM.model"];

  BOOL v22 = [(HMDAccessory *)self isSuspendCapable];
  [v4 encodeBool:v22 forKey:*MEMORY[0x263F0E938]];
  if (v6) {
  ...
  BOOL v23 = [(HMDAccessory *)self isCurrentAccessory];
  if (v5)
  {
    [v4 encodeBool:v23 forKey:*MEMORY[0x263F0B268]];
    BOOL v24 = [(HMDAccessory *)self supportsIdentify];
    [v4 encodeBool:v24 forKey:*MEMORY[0x263F0B768]];
  }
  if ((v7 & 0x9741) != 0 || v23 && (v7 & 0x10) != 0)
  {
    long long v25 = [(HMDAccessory *)self home];
    long long v26 = [(HMDAccessory *)self allowedHosts];
    [v4 encodeObject:v26 forKey:*MEMORY[0x263F0AF78]];

    long long v27 = [(HMDAccessory *)self networkAccessViolation];
    [v4 encodeObject:v27 forKey:*MEMORY[0x263F0B3C8]];

    if ((objc_msgSend(v4, "hmd_isForRemoteGatewayCoder") & 1) == 0)
    {
      long long v28 = [(HMDAccessory *)self category];
      [v4 encodeObject:v28 forKey:@"HM.accessoryCategory"];
    }
    if ((v5 & 1) == 0)
    {
      id v29 = [(HMDAccessory *)self firmwareVersion];
      [v4 encodeObject:v29 forKey:@"HM.firmwareVersionObject"];

      uint64_t v30 = [(HMDAccessory *)self productData];
      [v4 encodeObject:v30 forKey:@"HMDA.productData2"];

      v31 = [(HMDAccessory *)self primaryProfileVersion];
      __int16 v32 = [v31 versionString];
      [v4 encodeObject:v32 forKey:@"HMDA.primaryProfileVersion"];
    }
    if (objc_msgSend(v4, "hmd_isForLocalStore"))
    {
      v33 = objc_msgSend(NSNumber, "numberWithUnsignedInteger:", -[HMDAccessory configNumber](self, "configNumber"));
      [v4 encodeObject:v33 forKey:@"HMDAccessoryConfigurationNumberCodingKey"];

      uint64_t v34 = [(HMDAccessory *)self lastSeenDate];
      [v4 encodeObject:v34 forKey:@"HMDAccessoryLastSeenDateCodingKey"];
    ...
    {
      uint64_t v35 = [(HMDAccessory *)self networkClientIdentifier];
      [v4 encodeObject:v35 forKey:@"HMDA.nci"];

      v36 = [(HMDAccessory *)self networkRouterUUID];
      id v37 = [v36 UUIDString];
      [v4 encodeObject:v37 forKey:@"HMDA.nruuid"];

      objc_msgSend(v4, "encodeInteger:forKey:", -[HMDAccessory networkClientLAN](self, "networkClientLAN"), @"HMDA.ncl");
      int v38 = [(HMDAccessory *)self networkClientProfileFingerprint];
      v39 = [v38 UUIDString];
      [v4 encodeObject:v39 forKey:@"HMDA.ncfp"];

      __int16 v40 = [(HMDAccessory *)self wiFiUniquePreSharedKey];
      [v4 encodeObject:v40 forKey:@"HMDA.wifiUniquePSK"];

      id v41 = [(HMDAccessory *)self initialManufacturer];
      [v4 encodeObject:v41 forKey:@"HMDA.initialManufacturer"];

      uint64_t v42 = [(HMDAccessory *)self initialModel];
      [v4 encodeObject:v42 forKey:@"HMDA.initialModel"];

      v43 = [(HMDAccessory *)self initialCategoryIdentifier];
      [v4 encodeObject:v43 forKey:@"HMDA.initialCategoryIdentifier"];
    }
    if ((v15 & (objc_msgSend(v4, "hmd_isForRemoteGatewayCoder") ^ 1)) == 1)
    {
      int64_t v44 = [(HMDAccessory *)self targetNetworkProtectionMode];
      [v4 encodeInteger:v44 forKey:*MEMORY[0x263F0B830]];
      int64_t v45 = [(HMDAccessory *)self currentNetworkProtectionMode];
      [v4 encodeInteger:v45 forKey:*MEMORY[0x263F0B270]];
      int64_t v46 = [(HMDAccessory *)self wiFiCredentialType];
      [v4 encodeInteger:v46 forKey:*MEMORY[0x263F0B898]];
      if (v5)
      {
        v47 = [(HMDAccessory *)self networkProtectionGroupUUID];
        uint64_t v48 = (void *)MEMORY[0x263F0B488];
      }
      else
      {
        v47 = [(HMDAccessory *)self configuredNetworkProtectionGroupUUID];
        uint64_t v48 = (void *)MEMORY[0x263F0B230];
      }
      v49 = [v47 UUIDString];
      [v4 encodeObject:v49 forKey:*v48];

      if ([(HMDAccessory *)self supportsSoftwareUpdate])
      {
        if ((objc_msgSend(v4, "hmd_isForNonAdminSharedUser") & 1) == 0)
        {
          if (v5 && ![v25 isAdminUser]) {
            goto LABEL_35;
          }
          v50 = [(HMDAccessory *)self softwareUpdate];
          [v4 encodeObject:v50 forKey:*MEMORY[0x263F0B6D8]];
        }
      }
    }
    if (!v5)
    {
      [v4 encodeConditionalObject:v25 forKey:@"home"];
      v62 = [(HMDAccessory *)self appData];
      [v4 encodeObject:v62 forKey:@"HM.appDataRepository"];

      if ((objc_msgSend(v4, "hmd_isForRemoteGatewayCoder") & 1) == 0)
      {
        v63 = [(HMDAccessory *)self providedName];
        [v4 encodeObject:v63 forKey:@"accessoryProvidedName"];

        v64 = [(HMDAccessory *)self room];
        [v4 encodeConditionalObject:v64 forKey:@"accessoryRoom"];
      }
      v65 = [(HMDAccessory *)self identifier];
      [v4 encodeObject:v65 forKey:@"accessoryServerIdentifier"];
...
LABEL_35:
    ...
    if (v6)
    {
      int64_t v51 = [(HMDAccessory *)self reachableTransports];
      [v4 encodeInteger:v51 forKey:*MEMORY[0x263F0E948]];
      v52 = [(HMDAccessory *)self room];
      [v4 encodeObject:v52 forKey:@"accessoryRoom"];

      BOOL v53 = [(HMDAccessory *)self supportsNetworkProtection];
      [v4 encodeBool:v53 forKey:*MEMORY[0x263F0B438]];
      BOOL v54 = [(HMDAccessory *)self currentNetworkProtectionMode] == 1;
      [v4 encodeBool:v54 forKey:*MEMORY[0x263F0B3E0]];
      v55 = [(HMDAccessory *)self vendorInfo];
      v56 = [v55 appBundleID];
      [v4 encodeObject:v56 forKey:@"HM.bundleID"];

      v57 = [v55 appStoreID];
      [v4 encodeObject:v57 forKey:@"HM.storeID"];

      v58 = [(HMDAccessory *)self firmwareVersion];
      if (v58 && [(HMDAccessory *)self isPrimary])
      {
        v59 = [v55 firmwareVersion];
        v60 = [(HMDAccessory *)self firmwareVersion];
        uint64_t v61 = [v59 isGreaterThanVersion:v60];
      }
      else
      {
        uint64_t v61 = 0;
      ...
      [v4 encodeBool:v61 forKey:@"HM.firmwareUpdateAvailable"];
      v69 = [(HMDAccessory *)self identifier];
      [v4 encodeObject:v69 forKey:@"accessoryServerIdentifier"];

      BOOL v70 = [(HMDAccessory *)self supportsWiFiReconfiguration];
      [v4 encodeBool:v70 forKey:*MEMORY[0x263F0B8A8]];
      BOOL v71 = [(HMDAccessory *)self supportsMultiUser];
      [v4 encodeBool:v71 forKey:*MEMORY[0x263F0B3C0]];
      BOOL v72 = [(HMDAccessory *)self supportsHomeLevelLocationServiceSetting];
      [v4 encodeBool:v72 forKey:*MEMORY[0x263F0B368]];
      BOOL v73 = [(HMDAccessory *)self supportsDoorbellChime];
      [v4 encodeBool:v73 forKey:*MEMORY[0x263F0B758]];
      BOOL v74 = [(HMDAccessory *)self supportsUserMediaSettings];
      [v4 encodeBool:v74 forKey:*MEMORY[0x263F0B7E0]];
      BOOL v75 = [(HMDAccessory *)self supportsAudioReturnChannel];
      [v4 encodeBool:v75 forKey:*MEMORY[0x263F0B730]];
      BOOL v76 = [(HMDAccessory *)self supportsMusicAlarm];
      [v4 encodeBool:v76 forKey:*MEMORY[0x263F0B7A0]];
      BOOL v77 = [(HMDAccessory *)self supportsAnnounce];
      [v4 encodeBool:v77 forKey:*MEMORY[0x263F0B720]];
      BOOL v78 = [(HMDAccessory *)self supportsMediaActions];
      [v4 encodeBool:v78 forKey:*MEMORY[0x263F0B788]];
    }
    else
    {
      v66 = [(HMDAccessory *)self room];
      [v4 encodeObject:v66 forKey:@"accessoryRoom"];

      BOOL v67 = [(HMDAccessory *)self supportsNetworkProtection];
      [v4 encodeBool:v67 forKey:*MEMORY[0x263F0B438]];
      BOOL v68 = [(HMDAccessory *)self currentNetworkProtectionMode] == 1;
      [v4 encodeBool:v68 forKey:*MEMORY[0x263F0B3E0]];
    }
    v79 = [(HMDAccessory *)self appData];
    [v79 encodeForXPCTransportWithCoder:v4 key:@"HM.appData"];

    v80 = [(HMDAccessory *)self accessoryProfiles];
    v81 = (void *)[v80 copy];
    ...
    if (v6)
    {
      ...
      v88[1] = 3221225472;
      v83 = __32__HMDAccessory_encodeWithCoder___block_invoke;
    }
    else
    {
      v82 = &v86;
      ...
      v83 = __32__HMDAccessory_encodeWithCoder___block_invoke_2;
    }
    v82[2] = (uint64_t)v83;
    v82[3] = (uint64_t)&unk_264A1BEE0;
    v82[4] = (uint64_t)self;
    v84 = objc_msgSend(v81, "na_filter:", v86, v87);
    [v4 encodeObject:v84 forKey:@"HM.accessoryProfiles"];

LABEL_49:
    objc_msgSend(v4, "encodeBool:forKey:", -[HMDAccessory isPrimary](self, "isPrimary"), @"isPrimary");
    if (v15)
    {
      v85 = [(HMDAccessory *)self pendingConfigurationIdentifier];
      [v4 encodeObject:v85 forKey:*MEMORY[0x263F0B460]];
    }
  }
}
...
LABEL_43:
  ...
  int v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"accessoryUUID"];
  if (v6) {
    __int16 v7 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v6];
  }
  else {
    __int16 v7 = 0;
  }
  ...
  if (*p_uuid)
  {
    ...
    if (v5->_category)
    {
      uint64_t v14 = objc_msgSend(MEMORY[0x263F0DF40], "categoryIdentifierForCategory:");
    ...
    else
    {
      ...
      BOOL v23 = v5->_categoryIdentifier;
      v5->_categoryIdentifier = (NSNumber *)v22;

      uint64_t v24 = [MEMORY[0x263F0DF40] categoryWithCategoryIdentifier:v5->_categoryIdentifier];
    ...
    int v29 = [v28 isEqualToString:*MEMORY[0x263F0B178]];

    if (v29)
    {
      uint64_t v30 = (void *)MEMORY[0x263F0DF40];
      id v31 = objc_alloc(MEMORY[0x263F08C38]);
      __int16 v32 = (void *)[v31 initWithUUIDString:*MEMORY[0x263F0B170]];
    ...
    v5->_suspendCapable = [v4 decodeBoolForKey:*MEMORY[0x263F0E938]];
    ...
    else
    {
      ...
      uint64_t v47 = [MEMORY[0x263F35860] serverIdentifierWithUniqueIdentifier:identifier];
    ...
    uint64_t v63 = *MEMORY[0x263F0B2B8];
    if ([v4 containsValueForKey:*MEMORY[0x263F0B2B8]])
    {
    ...
    else
    {
      ...
      if (firmwareVersion)
      {
        BOOL v68 = [[HMDAccessoryVersion alloc] initWithVersionString:firmwareVersion];
        v69 = v5->_firmwareVersion;
        v5->_firmwareVersion = v68;
      }
    }

    uint64_t v70 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0B6D8]];
    ...
    BOOL v76 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"HMDA.nruuid"];
    uint64_t v77 = [objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v76];
    ...
    uint64_t v80 = [objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v79];
    networkClientProfileFingerprint = v5->_networkClientProfileFingerprint;
    v5->_networkClientProfileFingerprint = (NSUUID *)v80;

    uint64_t v82 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0B3C8]];
    networkAccessViolation = v5->_networkAccessViolation;
    v5->_networkAccessViolation = (HMDAccessoryNetworkAccessViolation *)v82;

    uint64_t v84 = *MEMORY[0x263F0B270];
    if ([v4 containsValueForKey:*MEMORY[0x263F0B270]]) {
      v5->_currentNetworkProtectionMode = [v4 decodeIntegerForKey:v84];
    }
    uint64_t v85 = *MEMORY[0x263F0B898];
    if ([v4 containsValueForKey:*MEMORY[0x263F0B898]]) {
      v5->_wiFiCredentialType = [v4 decodeIntegerForKey:v85];
    }
    uint64_t v86 = (void *)MEMORY[0x263EFFA08];
    v103[0] = objc_opt_class();
    v103[1] = objc_opt_class();
    uint64_t v87 = [MEMORY[0x263EFF8C0] arrayWithObjects:v103 count:2];
    v88 = objc_msgSend(v86, "setWithArray:", v87, v103[0]);
    uint64_t v89 = [v4 decodeObjectOfClasses:v88 forKey:*MEMORY[0x263F0AF78]];
    ...
    v93 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0B230]];
    if (v93)
    {
      uint64_t v94 = [objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v93];
    ...
    if (v96)
    {
      uint64_t v97 = [objc_alloc(MEMORY[0x263F42670]) initWithVersionString:v96];
    ...
    {
      v99 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"HM.hostAccessory"];
      [v99 addHostedAccessory:v5];
      objc_storeWeak((id *)&v5->_hostAccessory, v99);
    }
    uint64_t v100 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0B460]];
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_FAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v106 = 2112;
    v107 = v6;
    _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_FAULT, "%{public}@Cannot decode accessory with invalid uuid: %@", buf, 0x16u);
  }
...
- (id)dumpNetworkState
{
  ...
  id v5 = [MEMORY[0x263EFF9A0] dictionaryWithCapacity:1];
  if (v4)
  {
    int v6 = NSString;
    __int16 v7 = [(HMDAccessory *)v4 uuid];
    ...
    [v5 setObject:v11 forKeyedSubscript:*MEMORY[0x263F41FA8]];
  }
...
- (id)dumpSimpleState
{
  id v3 = [MEMORY[0x263EFF9A0] dictionaryWithCapacity:3];
  int v15 = NSString;
  ...
  [v3 setObject:v13 forKeyedSubscript:*MEMORY[0x263F41FA8]];
  return v3;
}
...
- (id)dumpState
{
  ...
  v81 = [MEMORY[0x263EFF9A0] dictionaryWithCapacity:5];
  id v3 = self;
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
    id v4 = v3;
  ...
  v79 = (void *)MEMORY[0x263F089D8];
  BOOL v76 = [(HMDAccessory *)v3 name];
  uint64_t v74 = [(HMDAccessory *)v3 providedName];
  uint64_t v72 = [(HMDAccessory *)v3 configuredName];
  BOOL v71 = [(HMDAccessory *)v3 uuid];
  uint64_t v70 = [v71 UUIDString];
  obuint64_t j = [(HMDAccessory *)v3 identifier];
  __int16 v7 = "YES";
  ...
  v69 = [(HMDAccessory *)v3 room];
  v65 = [v69 name];
  uint64_t v64 = [(HMDAccessory *)v3 firmwareVersion];
  [(HMDAccessory *)v3 primaryProfileVersion];
  uint64_t v12 = v82 = v3;
  id v13 = [(HMDAccessory *)v82 productData];
  uint64_t v14 = [(HMDAccessory *)v82 pendingConfigurationIdentifier];
  int v15 = [(HMDAccessory *)v82 urlString];
  uint64_t v16 = [(HMDAccessory *)v82 lastSeenDate];
  [(HMDAccessory *)v82 isLowBattery];
  uint64_t v17 = HMFBooleanToString();
  objc_msgSend(v79, "stringWithFormat:", @"name: %@, providedName: %@, configuredName: %@, uuid: %@, identifier: %@, Accessory Reachable: %s (local: %s, remote: %s), suspendCapable: %s, HAP secure session: %s, room: %@, firmwareVersion: %@, primaryProfileVersion: %@, productData: %@pendingConfigurationIdentifier: %@, assistantIdentifier: %@, lastSeenDate: %@, lowBattery: %@", v76, v74, v72, v70, obj, v7, v68, v67, v66, v8, v65, v64, v12, v13, v14, v15,
    v16,
  uint64_t v80 = v17);

  int v18 = v82;
  char v19 = [(HMDAccessory *)v82 wiFiUniquePreSharedKey];
  if (v19)
  {
    if (isInternalBuild()) {
  ...
  uint64_t v22 = v80;
  int v21 = v81;
  [(HMDAccessory *)v82 supportsWiFiReconfiguration];
  BOOL v23 = HMFBooleanToString();
  uint64_t v24 = objc_msgSend(NSNumber, "numberWithInteger:", -[HMDAccessory wiFiCredentialType](v82, "wiFiCredentialType"));
  [v80 appendFormat:@", supportsWiFiReconfiguration: %@, wiFiCredentialType: %@, wiFiUniquePreSharedKey: %@", v23, v24, v20];

  [(HMDAccessory *)v82 supportsNetworkProtection];
  uint64_t v25 = HMFBooleanToString();
  [v80 appendFormat:@", supportsNetworkProtection: %@", v25];

  if ([(HMDAccessory *)v82 supportsNetworkProtection])
  {
    BOOL v75 = v20;
    uint64_t v77 = v19;
    long long v26 = [(HMDAccessory *)v82 networkClientIdentifier];
    long long v27 = [(HMDAccessory *)v82 networkRouterUUID];
    long long v28 = [v27 UUIDString];
    int v29 = objc_msgSend(NSNumber, "numberWithInteger:", -[HMDAccessory targetNetworkProtectionMode](v82, "targetNetworkProtectionMode"));
    uint64_t v30 = objc_msgSend(NSNumber, "numberWithInteger:", -[HMDAccessory currentNetworkProtectionMode](v82, "currentNetworkProtectionMode"));
    id v31 = objc_msgSend(NSNumber, "numberWithInteger:", -[HMDAccessory networkClientLAN](v82, "networkClientLAN"));
    __int16 v32 = [(HMDAccessory *)v82 networkClientProfileFingerprint];
    [v80 appendFormat:@", networkClientIdentifier: %@, networkRouterUUID: %@, targetNetworkProtectionMode: %@, currentNetworkProtectionMode: %@, LAN: %@, Fingerprint: %@", v26, v28, v29, v30, v31, v32];

    int v21 = v81;
    uint64_t v33 = [(HMDAccessory *)v82 allowedHosts];
    uint64_t v34 = v33;
    if (v33)
    {
      int v35 = objc_msgSend(MEMORY[0x263EFF980], "arrayWithCapacity:", objc_msgSend(v33, "count"));
      long long v89 = 0u;
      long long v90 = 0u;
      long long v91 = 0u;
      long long v92 = 0u;
      BOOL v73 = v34;
      id obja = v34;
      uint64_t v36 = [obja countByEnumeratingWithState:&v89 objects:v94 count:16];
      if (v36)
      {
        uint64_t v37 = v36;
        ...
        do
        {
          for (uint64_t i = 0; i != v37; ++i)
          {
            ...
            __int16 v40 = *(void **)(*((void *)&v89 + 1) + 8 * i);
            id v41 = NSString;
            uint64_t v42 = [v40 name];
            v43 = [v40 addresses];
            uint64_t v44 = [v43 allObjects];
            uint64_t v45 = [v44 componentsJoinedByString:@","];
            int64_t v46 = [v41 stringWithFormat:@"Allow %@ (%@) purpose = 0x%lx", v42, v45, objc_msgSend(v40, "purpose")];
            [v35 addObject:v46];
          }
          uint64_t v37 = [obja countByEnumeratingWithState:&v89 objects:v94 count:16];
        }
        while (v37);
      }
      ...
      int v21 = v81;
      [v81 setObject:v47 forKeyedSubscript:@"Accessory Firewall WAN Rule"];
  ...
  [v22 appendFormat:@", supportsDiagnosticsTransfer: %@", v48];

  uint64_t v49 = (void *)[v22 copy];
  [v21 setObject:v49 forKeyedSubscript:*MEMORY[0x263F41FA8]];

  v50 = [(HMDAccessory *)v18 appData];
  uint64_t v51 = [v50 dumpState];
  [v21 setObject:v51 forKeyedSubscript:*MEMORY[0x263F41E98]];
  ...
  if (v52)
  {
    ...
    BOOL v54 = [v53 dumpState];
    [v21 setObject:v54 forKeyedSubscript:*MEMORY[0x263F41E68]];
  }
  uint64_t v55 = [(HMDAccessory *)v18 accessoryProfiles];
  if ([v55 count])
  {
    v56 = objc_msgSend(MEMORY[0x263EFF980], "arrayWithCapacity:", objc_msgSend(v55, "count"));
    long long v85 = 0u;
    long long v86 = 0u;
    long long v87 = 0u;
    long long v88 = 0u;
    id v57 = v55;
    uint64_t v58 = [v57 countByEnumeratingWithState:&v85 objects:v93 count:16];
    if (v58)
    {
      uint64_t v59 = v58;
      ...
      do
      {
        for (uint64_t j = 0; j != v59; ++j)
        {
          ...
          v62 = [*(id *)(*((void *)&v85 + 1) + 8 * j) dumpState];
          [v56 addObject:v62];
        }
        uint64_t v59 = [v57 countByEnumeratingWithState:&v85 objects:v93 count:16];
      }
      while (v59);
    }

    int v21 = v81;
    [v81 setObject:v56 forKeyedSubscript:*MEMORY[0x263F41E78]];
  }
  return v21;
}
    ...
    else
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
        {
          ...
          id v27 = v34;
          _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@Unknown model object (%@) sent to [%@ transactionObjectUpdated]", (uint8_t *)&v29, 0x20u);
        }
...
- (void)__handleShowMatterLockNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v36 = 2112;
    uint64_t v37 = v11;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@[NewFlow: %@] HomeUtil command for matter lock notifications called with message=%@", (uint8_t *)&v32, 0x20u);
  }
  id v12 = v7;
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
  ...
  if (v14)
  {
    ...
    uint64_t v16 = [v15 objectForKeyedSubscript:@"kShowMatterLockNotificationKeyType"];
    int v17 = [v16 intValue];

    int v18 = [v4 messagePayload];
    __int16 v19 = [v18 objectForKeyedSubscript:@"kShowMatterLockNotificationKeyValue"];

    id v20 = [v4 messagePayload];
    __int16 v21 = [v20 objectForKeyedSubscript:@"kShowMatterLockNotificationKeyName"];

    int v22 = +[HMDBulletinBoard sharedBulletinBoard];
    switch(v17)
    {
      case 2:
        unsigned __int8 v28 = [v19 intValue];
        int v29 = [v4 messagePayload];
        uint64_t v30 = [v29 objectForKeyedSubscript:@"kShowMatterLockNotificationKeyLockDataType"];
        unsigned __int8 v31 = [v30 intValue];

        objc_msgSend(v22, "insertBulletinForLockUserChange:lockDataType:dataOperationType:ecosystemName:isAffectedUser:flow:", v14, v31, v28, 0, objc_msgSend(v4, "BOOLForKey:", @"kShowMatterLockNotificationKeyIsAffectedUser"), v5);
        break;
      case 1:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v34 = 2112;
      uint64_t v35 = v27;
      _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed casting to HMDHAPAccessory", (uint8_t *)&v32, 0x16u);
    }
    __int16 v19 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
...
- (void)__handleListPairings:(id)a3
{
  ...
  id v4 = a3;
  id v5 = self;
  if ([(HMDAccessory *)v5 conformsToProtocol:&unk_26E4FFFE0]) {
    id v6 = v5;
  }
  else {
    id v6 = 0;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v16 = v12;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Does not support user management", buf, 0xCu);
    }
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v27 = 2112;
      id v28 = v4;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Notifying clients of error: %@", buf, 0x16u);
    }
    uint64_t v9 = [(HMDAccessory *)v6 home];
    uint64_t v10 = [MEMORY[0x263F08910] archivedDataWithRootObject:v4 requiringSecureCoding:1 error:0];
    uint64_t v11 = (void *)v10;
    if (v9 && v10)
    {
      id v12 = objc_alloc(MEMORY[0x263F42570]);
      id v13 = [v9 messageTargetUUID];
      id v14 = (void *)[v12 initWithTarget:v13];

      id v15 = (void *)MEMORY[0x263F42590];
      uint64_t v16 = *MEMORY[0x263F0C768];
      uint64_t v17 = [(HMDAccessory *)v6 uuid];
      int v18 = [v17 UUIDString];
      v23[1] = *MEMORY[0x263F0C838];
      v24[0] = v18;
      v24[1] = v11;
      __int16 v19 = [NSDictionary dictionaryWithObjects:v24 forKeys:v23 count:2];
...
- (void)__handleUpdatePendingConfigurationIdentifierMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v23 = 2112;
    id v24 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling update pending configuration identifier message payload: %@", (uint8_t *)&v21, 0x16u);
  }
  uint64_t v10 = [(HMDAccessory *)v6 home];
  if (v10)
  {
    uint64_t v11 = [v4 stringForKey:*MEMORY[0x263F0B460]];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      int v21 = 138543362;
      int v22 = v20;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Home is nil", (uint8_t *)&v21, 0xCu);
    }
    uint64_t v11 = [MEMORY[0x263F087E8] hmErrorWithCode:20];
...
- (NSUUID)defaultNetworkProtectionGroupUUID
{
  ...
  if (!v6)
  {
    if (self->_initialManufacturer && self->_initialCategoryIdentifier)
    {
      ...
      id v7 = (NSUUID *)objc_claimAutoreleasedReturnValue();
  ...
  uint64_t v9 = defaultNetworkProtectionGroupUUID;
...
- (void)_handleWiFiReconfiguration:(id)a3
{
  uint64_t v22 = *MEMORY[0x263EF8340];
  id v4 = a3;
  id v5 = [v4 numberForKey:*MEMORY[0x263F0D268]];
  uint64_t v6 = [v4 BOOLForKey:*MEMORY[0x263F0D288]];
  if (!v5)
  {
...
LABEL_7:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      int v21 = v17;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Unable to perform Wi-Fi reconfiguration -- no Client Manager", buf, 0xCu);
    }
    uint64_t v11 = [MEMORY[0x263F087E8] hmErrorWithCode:52];
    [v4 respondWithError:v11];
  }
...
void __58__HMDAccessory_saveWiFiUniquePreSharedKey_credentialType___block_invoke(uint64_t a1)
{
  ...
  if ((v3 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v17 = 2112;
      int v18 = v10;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Setting wiFiCredentialType to %@ in accessory transaction", (uint8_t *)&v15, 0x16u);
    }
...
{
  os_unfair_recursive_lock_lock_with_options();
  char v3 = self->_wiFiUniquePreSharedKey;
  os_unfair_recursive_lock_unlock();
  return v3;
}
...
void __96__HMDAccessory_saveCurrentNetworkProtectionMode_assignedLAN_allowedWANHosts_profileFingerprint___block_invoke(uint64_t a1)
{
        ...
        (v5 & 1) == 0))
  {
    ...
    id v6 = objc_msgSend(*(id *)(a1 + 40), "na_map:", &__block_literal_global_327_68319);
    if ([v6 count])
    {
      id v7 = (void *)[v6 copy];
...
{
  os_unfair_recursive_lock_lock_with_options();
  int v3 = self->_networkClientProfileFingerprint;
  os_unfair_recursive_lock_unlock();
  return v3;
}
...
- (int64_t)targetNetworkProtectionMode
{
  int v3 = [(HMDAccessory *)self home];
  id v4 = [v3 networkProtectionGroupRegistry];
  char v5 = [(HMDAccessory *)self networkProtectionGroupUUID];
...
{
  os_unfair_recursive_lock_lock_with_options();
  int v3 = self->_networkRouterUUID;
  os_unfair_recursive_lock_unlock();
  return v3;
}
...
{
  os_unfair_recursive_lock_lock_with_options();
  int v3 = self->_networkClientIdentifier;
  os_unfair_recursive_lock_unlock();
  return v3;
}
...
{
  os_unfair_recursive_lock_lock_with_options();
  int v3 = self->_primaryProfileVersion;
  os_unfair_recursive_lock_unlock();
  return v3;
}
...
- (void)setAccessoryProfiles:(id)a3
{
  ...
  if (v6)
  {
    objc_msgSend(MEMORY[0x263EFF9C0], "setWithArray:");
...
- (void)handleAddedSiriEndpointProfile:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    id v12 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling added siri endpoint profile: %@", (uint8_t *)&v9, 0x16u);
  }
}
...
- (void)handleAddedMediaProfile:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v11 = 2112;
    id v12 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling added media profile: %@", (uint8_t *)&v9, 0x16u);
  }
}
...
{
  os_unfair_recursive_lock_lock_with_options();
  int v3 = [(NSMutableSet *)self->_accessoryProfiles allObjects];
  os_unfair_recursive_lock_unlock();
  return (NSArray *)v3;
}
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v38 = 2112;
      uint64_t v39 = v10;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Going to update appData for accessory to: %@", buf, 0x16u);
    }
...
LABEL_18:
        ...
        __int16 v34 = @"com.apple.homekit-entitledclient.identifer";
        goto LABEL_19;
      }
    }
    id v15 = v35;
  ...
  if (os_log_type_enabled(v32, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v37 = v33;
    _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_DEFAULT, "%{public}@Attempted to set appData on an accessory that is no longer part of a home", buf, 0xCu);
  }
  id v8 = [v4 responseHandler];
  __int16 v34 = [MEMORY[0x263F087E8] hmErrorWithCode:12];
...
- (void)setConfigNumber:(unint64_t)a3
{
  ...
  id v9 = (void *)MEMORY[0x230FBD990](v8);
  id v10 = self;
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v20 = 1024;
    int v21 = a3;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@c# was set %u -> %u", buf, 0x18u);
  }
  if (v7)
  {
...
- (id)runtimeState
{
  ...
  int v3 = objc_msgSend(NSNumber, "numberWithBool:", -[HMDAccessory isReachableForXPCClients](self, "isReachableForXPCClients"));
  v8[0] = v3;
  v7[1] = *MEMORY[0x263F0B4A0];
...
- (void)_remoteAccessEnabled:(BOOL)a3
{
  ...
  if ([(HMDAccessory *)self isRemoteAccessEnabled] != a3)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v17 = 2114;
      __int16 v18 = v10;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Updating remote access enabled from %{public}@ to %{public}@", (uint8_t *)&v13, 0x20u);
    }
...
- (void)_notifyConnectivityChangedWithRemoteAccessChanged:(BOOL)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      int v10 = 138543362;
      __int16 v11 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Ignoring non-remote reachability change while remote access is enabled", (uint8_t *)&v10, 0xCu);
    }
  }
}
...
- (void)setRemotelyReachable:(BOOL)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v19 = 2114;
      __int16 v20 = v11;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Updated isRemotelyReachable to %{public}@", (uint8_t *)&v17, 0x16u);
    }
...
- (BOOL)_getLastKnownLowBatteryStatus
{
  ...
  BOOL v7 = [(HMDAccessory *)v6 findCharacteristicType:*MEMORY[0x263F0C430] forServiceType:*MEMORY[0x263F0D640]];
...
- (void)saveLastSeenToLocalStore
{
  ...
  BOOL v4 = objc_msgSend(NSNumber, "numberWithBool:", -[HMDAccessory _getLastKnownLowBatteryStatus](self, "_getLastKnownLowBatteryStatus"));
  [v9 setLowBattery:v4];

  BOOL v5 = [(HMDAccessory *)self home];
...
- (void)_checkForLastSeenUpdateOnBecomingUnreachable
{
  ...
  {
    id v17 = [MEMORY[0x263EFF910] distantPast];
  }
  __int16 v18 = v17;
    ...
    && fabs(v20) > v14)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v31 = 2112;
      int v32 = v25;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Saving lastSeen for accessory: %@ to %@", (uint8_t *)&v27, 0x20u);
    }
    long long v26 = [MEMORY[0x263EFF910] date];
...
- (void)setReachable:(BOOL)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v24 = 2114;
      uint64_t v25 = v11;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Updated isReachable to %{public}@", (uint8_t *)&v22, 0x16u);
    }
    uint64_t v12 = [(HMDAccessory *)v8 home];
    double v13 = v12;
    if (v12)
    ...
    if (v3)
    {
      ...
      __int16 v15 = [(HMDAccessory *)v8 notificationCenter];
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        double v20 = HMFBooleanToString();
        int v22 = 138543618;
        id v23 = v19;
        __int16 v24 = 2112;
        uint64_t v25 = v20;
        _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@reachabilityPingEnabled: %@", (uint8_t *)&v22, 0x16u);
      }
    ...
    else
    {
      ...
      uint64_t v21 = [(HMDAccessory *)v8 notificationCenter];
...
{
  os_unfair_recursive_lock_lock_with_options();
  BOOL v3 = self->_timeBecameReachable;
  os_unfair_recursive_lock_unlock();
  return v3;
}
...
{
  os_unfair_recursive_lock_lock_with_options();
  BOOL v3 = self->_timeBecameUnreachable;
  os_unfair_recursive_lock_unlock();
  return v3;
}
...
- (void)notifyAccessoryNameChanged:(BOOL)a3
{
  ...
  if (v5 && v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v32 = 2112;
      uint64_t v33 = v5;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Name changed to %@, notifying clients", buf, 0x16u);
    }
    uint64_t v12 = (void *)MEMORY[0x263F42568];
    ...
    v29[1] = v15;
    BOOL v16 = [NSDictionary dictionaryWithObjects:v29 forKeys:v28 count:2];
    ...
    __int16 v24 = __43__HMDAccessory_notifyAccessoryNameChanged___block_invoke;
    uint64_t v25 = &unk_264A2F820;
    uint64_t v26 = v8;
    id v27 = v5;
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v31 = v21;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Name or home is nil, cannot send name changed notification", buf, 0xCu);
    }
  }
}
...
- (HMDVendorModelEntry)vendorInfo
{
  ...
  uint64_t v3 = +[HMDVendorDataManager sharedVendorDataManager];
  ...
  {
    uint64_t v6 = [(HMDAccessory *)self manufacturer];
    id v7 = [(HMDAccessory *)self model];
    id v8 = self;
    objc_opt_class();
    if (objc_opt_isKindOfClass()) {
      id v9 = v8;
    ...
    if (v10
      ...
      && (long long v12 = (void *)v11, v13 = [(HMDAccessory *)v8 isPrimary], v12, !v13))
    {
      id v17 = [(HMDAccessory *)v10 bridge];
      uint64_t v15 = [v17 manufacturer];

      double v14 = [v17 model];
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v30 = 2114;
        __int16 v31 = v14;
        _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_DEBUG, "%{public}@Overriding vendor info for %{public}@ with Manufacturer: %{public}@ Model: %{public}@", buf, 0x2Au);
    ...
    if (v15 && v14)
    {
      uint64_t v5 = [v3 vendorModelEntryForManufacturer:v15 model:v14];
    }
  }
...
{
  os_unfair_recursive_lock_lock_with_options();
  uint64_t v3 = self->_serialNumber;
  os_unfair_recursive_lock_unlock();
  return v3;
}
...
- (void)setDisplayableFirmwareVersion:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v16 = 2112;
    uint64_t v17 = v5;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Updating displayable firmware version string from %@ to %@.", (uint8_t *)&v12, 0x20u);
  }
  os_unfair_recursive_lock_lock_with_options();
...
{
  os_unfair_recursive_lock_lock_with_options();
  uint64_t v3 = self->_displayableFirmwareVersion;
  os_unfair_recursive_lock_unlock();
  return v3;
}
...
- (void)setFirmwareVersion:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    __int16 v16 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating firmware version from %@ to %@.", (uint8_t *)&v11, 0x20u);
  }
  os_unfair_recursive_lock_lock_with_options();
...
{
  os_unfair_recursive_lock_lock_with_options();
  uint64_t v3 = self->_firmwareVersion;
  os_unfair_recursive_lock_unlock();
  return v3;
}
...
{
  os_unfair_recursive_lock_lock_with_options();
  uint64_t v3 = self->_initialManufacturer;
  os_unfair_recursive_lock_unlock();
  return v3;
}
...
{
  os_unfair_recursive_lock_lock_with_options();
  uint64_t v3 = self->_manufacturer;
  os_unfair_recursive_lock_unlock();
  return v3;
}
...
{
  os_unfair_recursive_lock_lock_with_options();
  uint64_t v3 = self->_initialModel;
  os_unfair_recursive_lock_unlock();
  return v3;
}
...
LABEL_9:
  ...
  if ([v5 length] > v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      int v26 = 138543362;
      id v27 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@New name is longer than the pre-defined max length", (uint8_t *)&v26, 0xCu);
    }
    id v8 = (void *)MEMORY[0x263F087E8];
    uint64_t v9 = 46;
    goto LABEL_9;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      int v26 = 138543362;
      id v27 = v22;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Unable to change name as no home is associated to the accessory", (uint8_t *)&v26, 0xCu);
    }
    uint64_t v23 = (void *)MEMORY[0x263F087E8];
    __int16 v24 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2018];
...
- (NSString)name
{
  ...
  id v3 = (void *)[(NSString *)configuredName copy];
  return (NSString *)v3;
}
  ...
  if ([(HMDAccessory *)self isPrimary])
  {
          ...
          !v24))
    {
      ...
      if (v8 || ([v7 categoryForOther], (id v8 = objc_claimAutoreleasedReturnValue()) != 0))
      {
        ...
        {
LABEL_17:
          id v15 = objc_alloc(MEMORY[0x263F0DF40]);
          ...
          if (a4)
          {
            ...
            uint64_t v21 = (void *)MEMORY[0x263F42568];
            int v26 = @"kAccessoryCategory";
            v27[0] = v20;
            uint64_t v22 = [NSDictionary dictionaryWithObjects:v27 forKeys:&v26 count:1];
...
- (void)updateCategory:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v4;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@No change in category -- old: %@, new: %@", (uint8_t *)&v17, 0x20u);
    }
  }
}
...
- (BOOL)_updateRoom:(id)a3 source:(unint64_t)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v43 = 2112;
    uint64_t v44 = v14;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@_updateRoom to: room: %@, source: %@", buf, 0x20u);
  }
  if (v8)
  {
    if (!v7) {
...
LABEL_12:
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v41 = 2112;
        id v42 = v6;
        _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to change room since room with UUID %@ or its home cannot be found", buf, 0x16u);
      }
      char v28 = 0;
      goto LABEL_21;
    }
  ...
  if (v18)
  {
    if (v22)
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v40 = v23;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Accessory is already in the same room. not updating.", buf, 0xCu);
    }
  }
  else
  {
    if (v22)
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v43 = 2112;
      uint64_t v44 = v8;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Updating room: %@ new room: %@", buf, 0x20u);
    }
    __int16 v30 = [(HMDAccessory *)v20 room];
    ...
    __int16 v38 = v33;
    uint64_t v34 = [NSDictionary dictionaryWithObjects:&v38 forKeys:&v37 count:1];
...
- (void)__handleUpdateRoom:(id)a3
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v47 = 2112;
    uint64_t v48 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@__handleUpdateRoom: home: %@, rooms: %@, newRoom: %@", buf, 0x2Au);
  }
  if (!v6)
  {
    ...
    {
      uint64_t v23 = HMFGetLogIdentifier();
      __int16 v24 = [(HMDAccessory *)v21 name];
      *(_DWORD *)buf = 138543618;
      id v42 = v23;
      __int16 v43 = 2112;
      uint64_t v44 = v24;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to change room for accessory %@ since home cannot be found on accessory", buf, 0x16u);
    }
    uint64_t v25 = (void *)MEMORY[0x263F087E8];
    uint64_t v26 = 2018;
    goto LABEL_15;
  ...
  if (!v7)
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v45 = 2112;
      int64_t v46 = v5;
      _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to change room for accessory %@ since room with UUID %@ cannot be found", buf, 0x20u);
    }
    uint64_t v25 = (void *)MEMORY[0x263F087E8];
    uint64_t v26 = 2017;
LABEL_15:
    ...
    if ((v14 & 1) == 0 && (unint64_t)[v6 accessoryCountForRoom:v7] >= 0x3E8)
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v45 = 2112;
        int64_t v46 = v38;
        _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_ERROR, "%{public}@Can't assign %@  to room %@; already at maximum accessories allowed",
          buf,
          0x20u);
      }
      uint64_t v32 = [MEMORY[0x263F087E8] hmErrorWithCode:49];
      goto LABEL_16;
    }
  }
...
void __35__HMDAccessory___handleUpdateRoom___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Finished updating the room (%@) for the accessory finished with error: %@", (uint8_t *)&v9, 0x20u);
  }
}
...
- (id)modelWithUpdatedRoom:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v16 = 2112;
      int v17 = v12;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Cannot create update room model because room was not specified for accessory %@", (uint8_t *)&v14, 0x16u);
    }
    id v5 = 0;
  }
...
- (NSUUID)spiClientIdentifier
{
  ...
  id v3 = spiClientIdentifierForUUID(v2);
...
- (void)unconfigure
{
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [*(id *)(*((void *)&v11 + 1) + 8 * v7++) unconfigure];
      }
      while (v5 != v7);
  ...
  long long v8 = [(HMDAccessory *)self msgDispatcher];
  [v8 deregisterReceiver:self];

  long long v9 = [(HMDAccessory *)self home];
  long long v10 = [v9 administratorHandler];
  [v10 deregisterReceiver:self];
}

- (BOOL)hasSiriEndpointProfile
{
  v2 = [(HMDAccessory *)self accessoryProfiles];
  char v3 = objc_msgSend(v2, "na_any:", &__block_literal_global_310_68362);
...
- (BOOL)hasMediaProfile
{
  ...
  char v3 = objc_msgSend(v2, "na_any:", &__block_literal_global_307_68364);
...
- (void)__handleIdentify:(id)a3
{
  ...
  id v4 = a3;
  isWatch();
  BOOL v5 = [(HMDAccessory *)self isReachable];
  ...
  if (v5)
  {
    if (v9)
    {
      ...
      int v19 = 138543362;
      double v20 = v10;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling identify", (uint8_t *)&v19, 0xCu);
    }
    [(HMDAccessory *)v7 handleIdentifyAccessoryMessage:v4];
  }
  else
  {
    if (v9)
    {
      ...
      __int16 v23 = 2112;
      __int16 v24 = v13;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Relaying request to identify accessory because we are a watch (%@) or the accessory is unreachable (%@)", (uint8_t *)&v19, 0x20u);
    }
    if ([(HMDAccessory *)v7 isRemoteAccessEnabled])
    {
      [(HMDAccessory *)v7 _relayIdentifyAccessorytoResidentForMessage:v4];
    }
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        int v19 = 138543362;
        double v20 = v17;
        _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@Cannot relay request to identify accessory because remote access is not enabled", (uint8_t *)&v19, 0xCu);
      }
...
- (void)handleAccessoryUpdateShouldProcessTransactionRemovalValueRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v21 = 2112;
    id v22 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling accessory update should process transaction removal value request message: %@", buf, 0x16u);
  }
  BOOL v9 = [v4 messagePayload];
  uint64_t v10 = *MEMORY[0x263F0B860];
  id v18 = 0;
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v23 = 2112;
      id v24 = v12;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to get value from payload: %@ error: %@", buf, 0x20u);
    }
...
- (void)_handleLinkQualityRequestMessage:(id)a3
{
  ...
  {
    BOOL v5 = [HMDRemoteMessage alloc];
    uint64_t v6 = [v4 name];
    id v7 = [v4 destination];
    uint64_t v8 = [v4 messagePayload];
    BOOL v9 = [(HMDRemoteMessage *)v5 initWithName:v6 destination:v7 payload:v8 type:0 timeout:1 secure:10.0];
    ...
    if (v13 && [(HMDAccessory *)v13 communicationProtocol] == 2)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543362;
          id v24 = v18;
          _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEBUG, "%{public}@LinkQuality: Re-dispatching to primary resident", buf, 0xCu);
        }
        int v19 = [(HMDAccessory *)v16 uuid];
        double v20 = [(HMDAccessory *)v16 workQueue];
        [v14 redispatchToResidentMessage:v9 target:v19 responseQueue:v20];
      }
    }
    else
    {
      long long v14 = [MEMORY[0x263F087E8] hmErrorWithCode:48 description:@"This Accessory type does not support link quality" reason:0 suggestion:0];
      [v10 respondWithError:v14];
    }
  }
  else
  {
    BOOL v9 = [MEMORY[0x263F087E8] hmErrorWithCode:48 description:@"Feature is disabled" reason:@"Feature flag is disabled" suggestion:0];
    [v4 respondWithError:v9];
  }
}
...
- (void)sendLastSeenStatusResponseMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v29 = 2112;
    id v30 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEBUG, "%{public}@LastSeen: Handling message %@", (uint8_t *)&v27, 0x16u);
  }
  if ([(HMDAccessory *)v6 isReachable])
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      int v27 = 138543362;
      char v28 = v12;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@LastSeen: Accessory is reachable responding with error", (uint8_t *)&v27, 0xCu);
    }
    uint64_t v13 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2505];
LABEL_16:
    int v19 = (void *)v13;
    ...
    || ![(HMDAccessory *)v6 _getLastKnownLowBatteryStatus])
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      int v27 = 138543362;
      char v28 = v18;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@LastSeen: Accessory did not report low battery - LastSeen is not tracked", (uint8_t *)&v27, 0xCu);
    }
    uint64_t v13 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
    goto LABEL_16;
  }
  if ([(HMDAccessory *)v6 hasBattery])
  {
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v31 = 2048;
    uint64_t v32 = v14;
    _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_DEBUG, "%{public}@LastSeen: Responding from primary with lastSeen: %@, batteryStatus: %lu", (uint8_t *)&v27, 0x20u);
  }
...
- (void)_handleLastSeenStatusRequestMessage:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v21 = v15;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEBUG, "%{public}@LastSeen: Re-dispatching to primary resident", buf, 0xCu);
    }
...
- (void)_registerForMessages
{
  ...
  v78[1] = v15;
  uint64_t v16 = [MEMORY[0x263EFF8C0] arrayWithObjects:v78 count:2];
  ...
  uint64_t v18 = *MEMORY[0x263F0B850];
  id v19 = +[HMDXPCMessagePolicy policyWithEntitlements:5];
  v77[0] = v19;
  double v20 = +[HMDConfigurationMessagePolicy policyWithOperationTypes:7];
  v77[1] = v20;
  __int16 v21 = [MEMORY[0x263EFF8C0] arrayWithObjects:v77 count:2];
  ...
  v76[0] = v23;
  v76[1] = v4;
  id v24 = [MEMORY[0x263EFF8C0] arrayWithObjects:v76 count:2];
  ...
  v75[1] = v27;
  char v28 = [MEMORY[0x263EFF8C0] arrayWithObjects:v75 count:2];
  ...
  if (isInternalBuild())
  {
    ...
    id v30 = +[HMDXPCMessagePolicy policyWithEntitlements:5];
    v74[0] = v30;
    __int16 v31 = +[HMDUserMessagePolicy userMessagePolicyWithHome:v3 userPrivilege:3 remoteAccessRequired:0];
    v74[1] = v31;
    uint64_t v32 = [MEMORY[0x263EFF8C0] arrayWithObjects:v74 count:2];
    [v29 registerForMessage:@"kShowMatterLockNotificationKey" receiver:self policies:v32 selector:sel___handleShowMatterLockNotification_];
  }
  uint64_t v33 = [(HMDAccessory *)self msgDispatcher];
  uint64_t v34 = *MEMORY[0x263F0B450];
  uint64_t v35 = +[HMDXPCMessagePolicy policyWithEntitlements:13];
  v73[0] = v35;
  v73[1] = v4;
  __int16 v36 = [MEMORY[0x263EFF8C0] arrayWithObjects:v73 count:2];
  [v33 registerForMessage:v34 receiver:self policies:v36 selector:sel___handlePairingIdentityRequest_];

  uint64_t v37 = +[HMDRemoteMessagePolicy defaultSecurePolicy];
  objc_msgSend(v37, "setRoles:", objc_msgSend(v37, "roles") | 6);
  __int16 v38 = (void *)[v37 copy];
  uint64_t v39 = [(HMDAccessory *)self msgDispatcher];
  id v40 = +[HMDXPCMessagePolicy policyWithEntitlements:1];
  v72[0] = v40;
  v72[1] = v38;
  v72[2] = v4;
  __int16 v41 = [MEMORY[0x263EFF8C0] arrayWithObjects:v72 count:3];
  [v39 registerForMessage:@"kIdentifyAccessoryRequestKey" receiver:self policies:v41 selector:sel___handleIdentify_];

  if (isInternalBuild())
  {
    id v42 = [(HMDAccessory *)self msgDispatcher];
    uint64_t v43 = *MEMORY[0x263F0D270];
    uint64_t v44 = +[HMDXPCMessagePolicy policyWithEntitlements:5];
    v71[0] = v44;
    __int16 v45 = +[HMDConfigurationMessagePolicy policyWithOperationTypes:2];
    v71[1] = v45;
    int64_t v46 = [MEMORY[0x263EFF8C0] arrayWithObjects:v71 count:2];
    [v42 registerForMessage:v43 receiver:self policies:v46 selector:sel__handleWiFiReconfiguration_];

    __int16 v47 = [(HMDAccessory *)self msgDispatcher];
    uint64_t v48 = *MEMORY[0x263F0B868];
    uint64_t v49 = +[HMDXPCMessagePolicy policyWithEntitlements:5];
    v70[0] = v49;
    v50 = +[HMDUserMessagePolicy userMessagePolicyWithHome:v3 userPrivilege:3 remoteAccessRequired:0];
    v70[1] = v50;
    uint64_t v51 = [MEMORY[0x263EFF8C0] arrayWithObjects:v70 count:2];
    [v47 registerForMessage:v48 receiver:self policies:v51 selector:sel_handleAccessoryUpdateShouldProcessTransactionRemovalValueRequestMessage_];
  }
  v52 = [(HMDAccessory *)self msgDispatcher];
  uint64_t v53 = *MEMORY[0x263F0B490];
  v69[0] = v4;
  BOOL v54 = +[HMDRemoteMessagePolicy defaultSecurePolicy];
  v69[1] = v54;
  uint64_t v55 = +[HMDXPCMessagePolicy policyWithEntitlements:5];
  v69[2] = v55;
  v56 = [MEMORY[0x263EFF8C0] arrayWithObjects:v69 count:3];
  [v52 registerForMessage:v53 receiver:self policies:v56 selector:sel__handleLastSeenStatusRequestMessage_];

  id v57 = [(HMDAccessory *)self msgDispatcher];
  uint64_t v58 = *MEMORY[0x263F0B498];
  v68[0] = v4;
  uint64_t v59 = +[HMDRemoteMessagePolicy defaultSecurePolicy];
  v68[1] = v59;
  uint64_t v60 = +[HMDXPCMessagePolicy policyWithEntitlements:5];
  v68[2] = v60;
  uint64_t v61 = [MEMORY[0x263EFF8C0] arrayWithObjects:v68 count:3];
  [v57 registerForMessage:v58 receiver:self policies:v61 selector:sel__handleLinkQualityRequestMessage_];

  if (self)
  {
    v62 = [(HMDAccessory *)self msgDispatcher];
    uint64_t v63 = *MEMORY[0x263F0D260];
    uint64_t v64 = +[HMDXPCMessagePolicy policyWithEntitlements:5];
    v81[0] = v64;
    v65 = +[HMDConfigurationMessagePolicy policyWithOperationTypes:2];
    v81[1] = v65;
    uint64_t v66 = [MEMORY[0x263EFF8C0] arrayWithObjects:v81 count:2];
    [v62 registerForMessage:v63 receiver:self policies:v66 selector:sel__handlePreviewAllowedHosts_];
  }
}
...
- (id)backingStoreObjects:(int64_t)a3
{
  ...
  if (a3 > 3)
  {
    BOOL v9 = [(HMDAccessory *)self softwareUpdate];
    id v10 = v9;
...
- (void)populateModelObject:(id)a3 version:(int64_t)a4
{
  ...
  if (v15)
  {
    ...
    int v17 = [(HMDAccessory *)self room];
    [v17 uuid];
    uint64_t v18 = v72 = a4;
    ...
    uint64_t v14 = [(HMDAccessory *)self room];
    __int16 v23 = [v14 uuid];
    id v24 = [v23 UUIDString];
    [v8 setRoomUUID:v24];
  }
LABEL_8:
  uint64_t v25 = [NSNumber numberWithBool:self->_suspendCapable];
  [v8 setSuspendCapable:v25];

  if (a4 >= 4)
  {
    uint64_t v26 = [(HMDAccessory *)self model];
    [v8 setPropertyIfNotNil:v26 named:@"model"];

    int v27 = [(HMDAccessory *)self manufacturer];
    [v8 setPropertyIfNotNil:v27 named:@"manufacturer"];

    char v28 = [(HMDAccessory *)self firmwareVersion];
    __int16 v29 = [v28 rawVersionString];
    [v8 setPropertyIfNotNil:v29 named:@"firmwareVersion"];

    id v30 = [(HMDAccessory *)self displayableFirmwareVersion];
    [v8 setPropertyIfNotNil:v30 named:@"displayableFirmwareVersion"];

    __int16 v31 = [(HMDAccessory *)self serialNumber];
    [v8 setPropertyIfNotNil:v31 named:@"serialNumber"];

    uint64_t v32 = objc_msgSend(NSNumber, "numberWithInteger:", -[HMDAccessory currentNetworkProtectionMode](self, "currentNetworkProtectionMode"));
    [v8 setCurrentNetworkProtectionMode:v32];

    uint64_t v33 = [(HMDAccessory *)self networkAccessViolation];
    uint64_t v34 = [v33 lastViolationDate];
    uint64_t v35 = EpochIntervalFromDate(v34);
    [v8 setLastNetworkAccessViolationOccurrenceSince1970:v35];

    __int16 v36 = [(HMDAccessory *)self networkAccessViolation];
    uint64_t v37 = [v36 lastResetDate];
    __int16 v38 = EpochIntervalFromDate(v37);
    [v8 setLastNetworkAccessViolationResetSince1970:v38];

    uint64_t v39 = (void *)MEMORY[0x263EFF980];
    id v40 = [(HMDAccessory *)self allowedHosts];
    __int16 v41 = objc_msgSend(v39, "arrayWithCapacity:", objc_msgSend(v40, "count"));

    long long v75 = 0u;
    long long v76 = 0u;
    long long v73 = 0u;
    long long v74 = 0u;
    id v42 = [(HMDAccessory *)self allowedHosts];
    ...
    if (v43)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v44; ++i)
        {
          ...
          __int16 v47 = [*(id *)(*((void *)&v73 + 1) + 8 * i) jsonWANRule];
          [v41 addObject:v47];
        }
    ...
    uint64_t v48 = (void *)[v41 copy];
    [v8 setAppliedFirewallWANRules:v48];

    uint64_t v49 = [(HMDAccessory *)self productData];
    ...
    uint64_t v53 = [(HMDAccessory *)self networkRouterUUID];
    BOOL v54 = [v53 UUIDString];
    [v8 setNetworkRouterUUID:v54];

    uint64_t v55 = objc_msgSend(NSNumber, "numberWithInteger:", -[HMDAccessory networkClientLAN](self, "networkClientLAN"));
    ...
    uint64_t v58 = objc_msgSend(NSNumber, "numberWithInteger:", -[HMDAccessory wiFiCredentialType](self, "wiFiCredentialType"));
    [v8 setWiFiCredentialType:v58];

    uint64_t v59 = [(HMDAccessory *)self wiFiUniquePreSharedKey];
    [v8 setWiFiUniquePreSharedKey:v59];

    uint64_t v60 = [(HMDAccessory *)self pendingConfigurationIdentifier];
    [v8 setPendingConfigurationIdentifier:v60];

    uint64_t v61 = [(HMDAccessory *)self primaryProfileVersion];
    v62 = [v61 versionString];
    [v8 setPropertyIfNotNil:v62 named:@"primaryProfileVersion"];

    uint64_t v63 = [(HMDAccessory *)self initialManufacturer];
    [v8 setPropertyIfNotNil:v63 named:@"initialManufacturer"];

    uint64_t v64 = [(HMDAccessory *)self initialModel];
    ...
    BOOL v67 = [v66 uuid];
    BOOL v68 = [v67 UUIDString];
    [v8 setHostAccessoryUUID:v68];

    v69 = [(HMDAccessory *)self lastSeenDate];
    [v8 setPropertyIfNotNil:v69 named:@"lastSeenDate"];

    uint64_t v70 = objc_msgSend(NSNumber, "numberWithBool:", -[HMDAccessory isLowBattery](self, "isLowBattery"));
...
- (id)transactionWithObjectChangeType:(unint64_t)a3
{
  BOOL v5 = [HMDAccessoryTransaction alloc];
  id v6 = [(HMDAccessory *)self uuid];
  id v7 = [(HMDAccessory *)self home];
  id v8 = [v7 uuid];
  BOOL v9 = [(HMDBackingStoreModelObject *)v5 initWithObjectChangeType:a3 uuid:v6 parentUUID:v8];
...
- (id)shortDescription
{
  ...
  if (v3)
  {
    ...
    BOOL v9 = [v4 stringWithFormat:@"%@/%@/%@/%@", v5, v6, v7, v8];
  }
  else
  {
    BOOL v5 = [(HMDAccessory *)self uuid];
    id v6 = [(HMDAccessory *)self identifier];
    [(HMDAccessory *)self isReachable];
    id v7 = HMFBooleanToString();
    BOOL v9 = [v4 stringWithFormat:@"%@/%@/%@", v5, v6, v7];
  }
...
- (void)setCategory:(id)a3
{
  id v4 = [MEMORY[0x263F0E340] cachedInstanceForHMAccessoryCategory:a3];
...
- (id)attributeDescriptions
{
  ...
  uint64_t v49 = [(HMDAccessory *)self name];
  uint64_t v48 = (void *)[v3 initWithName:@"Nm" value:v49];
  v50[0] = v48;
  id v4 = objc_alloc(MEMORY[0x263F424F8]);
  __int16 v47 = [(HMDAccessory *)self getConfiguredName];
  int64_t v46 = (void *)[v4 initWithName:@"CN" value:v47];
  v50[1] = v46;
  id v5 = objc_alloc(MEMORY[0x263F424F8]);
  uint64_t v45 = [(HMDAccessory *)self providedName];
  uint64_t v44 = (void *)[v5 initWithName:@"PN" value:v45];
  v50[2] = v44;
  id v6 = objc_alloc(MEMORY[0x263F424F8]);
  uint64_t v43 = [(HMDAccessory *)self uuid];
  id v42 = (void *)[v6 initWithName:@"UUID" value:v43];
  v50[3] = v42;
  id v7 = objc_alloc(MEMORY[0x263F424F8]);
  __int16 v41 = [(HMDAccessory *)self category];
  id v40 = [v41 name];
  uint64_t v39 = (void *)[v7 initWithName:@"Cat" value:v40];
  v50[4] = v39;
  id v8 = objc_alloc(MEMORY[0x263F424F8]);
  __int16 v38 = [(HMDAccessory *)self home];
  uint64_t v37 = [v38 name];
  __int16 v36 = (void *)[v8 initWithName:@"HM" value:v37];
  v50[5] = v36;
  id v9 = objc_alloc(MEMORY[0x263F424F8]);
  uint64_t v35 = [(HMDAccessory *)self room];
  uint64_t v34 = [v35 name];
  uint64_t v33 = (void *)[v9 initWithName:@"RM" value:v34];
  v50[6] = v33;
  id v10 = objc_alloc(MEMORY[0x263F424F8]);
  uint64_t v32 = [(HMDAccessory *)self manufacturer];
  __int16 v31 = (void *)[v10 initWithName:@"MFG" value:v32];
  v50[7] = v31;
  id v11 = objc_alloc(MEMORY[0x263F424F8]);
  id v30 = [(HMDAccessory *)self model];
  __int16 v29 = (void *)[v11 initWithName:@"MO" value:v30];
  v50[8] = v29;
  id v12 = objc_alloc(MEMORY[0x263F424F8]);
  char v28 = [(HMDAccessory *)self serialNumber];
  uint64_t v13 = (void *)[v12 initWithName:@"SN" value:v28];
  v50[9] = v13;
  id v14 = objc_alloc(MEMORY[0x263F424F8]);
  uint64_t v15 = [(HMDAccessory *)self productData];
  uint64_t v16 = (void *)[v14 initWithName:@"PD" value:v15];
  v50[10] = v16;
  id v17 = objc_alloc(MEMORY[0x263F424F8]);
  uint64_t v18 = [(HMDAccessory *)self firmwareVersion];
  id v19 = (void *)[v17 initWithName:@"FV" value:v18];
  v50[11] = v19;
  id v20 = objc_alloc(MEMORY[0x263F424F8]);
  __int16 v21 = [(HMDAccessory *)self displayableFirmwareVersion];
  uint64_t v22 = (void *)[v20 initWithName:@"DFV" value:v21];
  v50[12] = v22;
  id v23 = objc_alloc(MEMORY[0x263F424F8]);
  id v24 = [(HMDAccessory *)self softwareUpdate];
  uint64_t v25 = (void *)[v23 initWithName:@"SU" value:v24];
  v50[13] = v25;
  uint64_t v26 = [MEMORY[0x263EFF8C0] arrayWithObjects:v50 count:14];
...
- (void)dealloc
{
  id v3 = [(HMDAccessory *)self msgDispatcher];
...
- (void)sendRemovalRequestWithCompletion:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    id v14 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Sending removal request for accessory: %@", (uint8_t *)&v11, 0x16u);
  }
...
- (void)setDefaultPreferredMediaUserIfRemoved:(id)a3 defaultUser:(id)a4 completion:(id)a5
{
  ...
  if (v14)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v29 = 2112;
      id v30 = v9;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Resetting preferred media user: %@ to default user: %@.", (uint8_t *)&v25, 0x20u);
    }
    if (v9)
    {
      id v19 = [v9 uuid];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v27 = 2112;
      id v28 = v20;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Removed user is not current preferred media user: %@", (uint8_t *)&v25, 0x16u);
    }
    if (v11) {
...
void __63__HMDAccessory_setPreferredMediaUser_selectionType_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v12 = 2112;
      id v13 = v3;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to set preferred media user, error: %@", (uint8_t *)&v10, 0x16u);
    }
  }
...
- (void)encodePreferredMediaUser:(id)a3
{
  ...
  [v7 encodeObject:v4 forKey:*MEMORY[0x263F0B468]];
  ...
  if (v5)
  {
    ...
    [v7 encodeObject:v6 forKey:*MEMORY[0x263F0B478]];
  }
}
...
{
  id v4 = a3;
  id v5 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0B468]];
  [(HMDAccessory *)self setPreferredMediaUserUUID:v5];

  id v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0B478]];
...
- (void)transactionAccessoryUpdatedForPreferredMediaUser:(id)a3 completionHandler:(id)a4
{
        ...
        (v10 & 1) == 0))
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v29 = 2112;
      id v30 = v16;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Updated preferred media user UUID: %@", (uint8_t *)&v27, 0x16u);
    }
    id v17 = [v6 preferredMediaUserUUID];
  ...
  if ([v6 propertyWasSet:@"preferredUserSelectionType"])
  {
    ...
    if ((v20 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
      {
        ...
        __int16 v29 = 2112;
        id v30 = v25;
        _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@Updated preferred media user selection type: %@", (uint8_t *)&v27, 0x16u);
      }
...
LABEL_37:
  ...
  if (v8->_identifier)
  {
    ...
    if (v35)
    {
      __int16 v36 = [HMDAccessoryVersion alloc];
    ...
    id v66 = objc_alloc(MEMORY[0x263F08C38]);
    BOOL v67 = [v6 networkRouterUUID];
    ...
    int64_t v72 = [v6 wiFiCredentialType];
    ...
    if (v72)
    {
      ...
      if (os_log_type_enabled(v75, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v100 = 2112;
        id v101 = v77;
        _os_log_impl(&dword_22F52A000, v75, OS_LOG_TYPE_INFO, "%{public}@Setting accessory wiFiCredentialType to %@", (uint8_t *)&v98, 0x16u);
      }
    ...
    long long v85 = [v6 lastNetworkAccessViolationOccurrenceSince1970];
    long long v86 = [v6 lastNetworkAccessViolationResetSince1970];
    long long v87 = [(HMDAccessoryNetworkAccessViolation *)v84 initWithLastViolationTimeInterval:v85 lastViolationResetTimeInterval:v86];

    if ((HMFEqualObjects() & 1) == 0) {
      objc_storeStrong((id *)&v8->_networkAccessViolation, v87);
    }
    long long v88 = [v6 primaryProfileVersion];

    if (v88)
    {
      id v89 = objc_alloc(MEMORY[0x263F42670]);
    ...
    uint64_t v93 = [v6 pendingConfigurationIdentifier];
    pendingConfigurationIdentifier = v8->_pendingConfigurationIdentifier;
    v8->_pendingConfigurationIdentifier = (NSString *)v93;

    uint64_t v95 = [v6 hostAccessoryUUID];
    if (v95) {
      v96 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v95];
    }
    else {
      v96 = 0;
    }
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v100 = 2112;
    id v101 = v6;
    _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to create accessory from transaction with nil identifier: %@", (uint8_t *)&v98, 0x16u);
  }
  long long v26 = 0;
LABEL_38:
...
- (HMDAccessory)initWithNotificationCenter:(id)a3
{
  ...
  if (v6)
  {
    ...
    [MEMORY[0x263F42520] blessWithImplicitContext:v7->_workQueue];
    ...
    v7->_id hashedRouteFactory = &__block_literal_global_68495;
  }
  return v7;
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t164 != -1) {
    dispatch_once(&logCategory__hmf_once_t164, &__block_literal_global_452);
  }
  id v2 = (void *)logCategory__hmf_once_v165;
  return v2;
}
...
+ (BOOL)validateProductData:(id)a3
{
  ...
  if ([v3 length] == 16)
  {
    id v4 = [MEMORY[0x263F08708] characterSetWithCharactersInString:@"0123456789ABCDEFabcdef"];
...
- (id)metricLoggingVendorDetails
{
  id v2 = [[HMDAccessoryMetricVendorDetails alloc] initWithAccessory:self];
  return v2;
}
...
- (NSDictionary)assistantObject
{
    ...
    && ([(HMDAccessory *)self name], id v4 = objc_claimAutoreleasedReturnValue(), v4, v4))
  {
    ...
    v27[4] = v9;
    v27[5] = self;
    id v10 = [NSDictionary dictionaryWithObjects:v27 forKeys:v26 count:6];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v32 = 2112;
      uint64_t v33 = v24;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_DEFAULT, "%{public}@Skipping because accessory.home or accessory.name is nil for %@/%@", buf, 0x20u);
    }
    uint64_t v18 = 0;
  }
...
- (HMDNetworkRouterFirewallRuleAccessoryIdentifier)metadataIdentifier
{
  ...
  if (v3)
  {
    ...
    {
      dispatch_queue_t v12 = (void *)MEMORY[0x230FBD990]();
      id v13 = self;
      uint64_t v14 = HMFGetOSLogHandle();
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v21 = 2112;
        id v22 = v4;
        _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@Unable to generate meta-data identifier with product data '%@' and firmware version '%@'", (uint8_t *)&v17, 0x20u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      ...
      __int16 v19 = 2112;
      uint64_t v20 = v9;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_DEFAULT, "%{public}@Unable to generate meta-data identifier because the productData is nil -- %@", (uint8_t *)&v17, 0x16u);
    }
    id v6 = 0;
  }
