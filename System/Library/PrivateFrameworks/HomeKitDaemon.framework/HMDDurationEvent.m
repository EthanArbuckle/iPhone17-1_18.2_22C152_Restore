...
- (id)_nextTimerDate
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    v18 = v9;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Next Fire Date : [%@]", (uint8_t *)&v15, 0x16u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_252425 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_252425, &__block_literal_global_252426);
  }
  v2 = (void *)logCategory__hmf_once_v1_252427;
  return v2;
}
...
void __31__HMDDurationEvent_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_252427;
  logCategory__hmf_once_v1_252427 = v0;
}
