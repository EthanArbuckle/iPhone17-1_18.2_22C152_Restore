  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v49 = 2112;
      id v50 = v6;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Cannot determine rapport identity for current device with error %@", buf, 0x16u);
    }
...
LABEL_25:
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v48 = v38;
      _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_ERROR, "%{public}@Rapport did not return the self identity", buf, 0xCu);
    }
    v13 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
    v17 = 0;
    goto LABEL_28;
  }
  uint64_t v16 = v15;
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v49 = 2112;
    id v50 = v17;
    _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@Found current device RPIdentity: %@", buf, 0x16u);
  }
