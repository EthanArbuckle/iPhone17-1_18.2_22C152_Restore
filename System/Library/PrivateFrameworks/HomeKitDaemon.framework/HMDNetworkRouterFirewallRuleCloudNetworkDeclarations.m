...
- (HMDNetworkRouterFirewallRuleCloudNetworkDeclarations)initWithBaseAccessoryIdentifier:(id)a3 data:(id)a4 allowUnzippedData:(BOOL)a5
{
  ...
  id v9 = a4;
  id v35 = 0;
  unint64_t v10 = [MEMORY[0x263F08900] JSONObjectWithData:v9 options:0 error:&v35];
  id v11 = v35;
  id v12 = v11;
  if (v10) {
    BOOL v13 = v11 == 0;
  ...
  if (v13)
  {
    ...
    {
      v28 = (void *)MEMORY[0x230FBD990](v21);
      self = self;
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v38 = 2112;
        id v39 = v18;
        _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@JSON is not a dictionary: %@", buf, 0x16u);
      }
      v17 = 0;
    }
  }
...
+ (id)__decodeRuleConfigurationWithVersionString:(id)a3 ruleConfigurationValue:(id)a4 baseAccessoryIdentifier:(id)a5
{
  ...
  if (v11)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v33 = 2112;
        id v34 = v12;
        _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Rule configuration for version '%@' is not a dictionary: %@", (uint8_t *)&v29, 0x20u);
      }
      int v19 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v31 = 2112;
      id v32 = v8;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Rule configuration contains an invalid version string: %@", (uint8_t *)&v29, 0x16u);
    }
    int v19 = 0;
  }
...
LABEL_31:
        ...
        *(void *)&buf[16] = 0x2020000000;
        LOBYTE(v51) = 0;
        v37 = objc_msgSend(MEMORY[0x263EFF9A0], "dictionaryWithCapacity:", objc_msgSend(v10, "count", v40));
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_232419 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_232419, &__block_literal_global_232420);
  }
  v2 = (void *)logCategory__hmf_once_v1_232421;
  return v2;
}
...
void __67__HMDNetworkRouterFirewallRuleCloudNetworkDeclarations_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_232421;
  logCategory__hmf_once_v1_232421 = v0;
}
