...
- (void)_handleActionSetRunLogEvent:(id)a3
{
  ...
  char v5 = [v4 isEqualToString:*MEMORY[0x263F0B928]];
...
- (void)_handleAddActionSetLogEvent:(id)a3
{
  ...
  int v5 = [v4 isEqualToString:*MEMORY[0x263F0B928]];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t24_72898 != -1) {
    dispatch_once(&logCategory__hmf_once_t24_72898, &__block_literal_global_72899);
  }
  id v2 = (void *)logCategory__hmf_once_v25_72900;
  return v2;
}
...
void __46__HMDLogEventUserActivityAnalyzer_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v25_72900;
  logCategory__hmf_once_v25_72900 = v0;
}
