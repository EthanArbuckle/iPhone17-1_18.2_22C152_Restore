...
void __61__HMDHAPAccessoryReaderWriter__completionHandlerWithContext___block_invoke_2(uint64_t a1, char a2, void *a3, void *a4)
{
  ...
  if (a2)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v36 = 2114;
      v37 = v22;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@[%{public}@] Done sending all responses with error: %{public}@. Execution Time: %.3fs. Remaining Tasks: %{public}@", (uint8_t *)&v28, 0x34u);
...
LABEL_6:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v38 = 2112;
      v39 = v27;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEBUG, "%{public}@[%@] Done sending multi-part response(s)[%@] with error: %@. Execution Time: %.3fs. %@", (uint8_t *)&v28, 0x3Eu);
...
- (void)submitWriteRequests:(id)a3 sourceType:(unint64_t)a4 requestMessage:(id)a5
{
  ...
  id v16 = NSString;
  id v17 = MEMORY[0x230FBBCF0](self, a2);
  v18 = [v16 stringWithFormat:@"%@, %s:%ld", v17, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables/Sources/homed/HMDHAPAccessoryReaderWriter.m", 2464];
  v37 = (void *)v13;
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544386;
    ...
    __int16 v46 = 2114;
    v47 = v32;
    _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@[%{public}@] Executing with request: %{public}@. Current Tasks: %{public}@. Request Timeout %{public}@", buf, 0x34u);
...
- (void)submitReadRequests:(id)a3 sourceType:(unint64_t)a4 requestMessage:(id)a5
{
  ...
  id v16 = NSString;
  id v17 = MEMORY[0x230FBBCF0](self, a2);
  v18 = [v16 stringWithFormat:@"%@, %s:%ld", v17, "/Library/Caches/com.apple.xbs/Sources/HomeKit_executables/Sources/homed/HMDHAPAccessoryReaderWriter.m", 2418];
  v37 = (void *)v13;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t43_265496 != -1) {
    dispatch_once(&logCategory__hmf_once_t43_265496, &__block_literal_global_480);
  }
  v2 = (void *)logCategory__hmf_once_v44_265497;
  return v2;
}
...
void __42__HMDHAPAccessoryReaderWriter_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v44_265497;
  logCategory__hmf_once_v44_265497 = v0;
}
