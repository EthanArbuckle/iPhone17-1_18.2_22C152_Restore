...
- (void)netServiceBrowser:(id)a3 didStopBrowsingWithError:(id)a4
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v22 = 2112;
      v23 = v15;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Stopped browsing for services of type: %@ with error: %@. Found %@ servcies.", (uint8_t *)&v16, 0x2Au);
    }
  }
}
...
- (void)_updateTimerWithTimeout:(double)a3
{
  ...
  if (a3 > 0.0)
  {
    id v9 = (id)[objc_alloc(MEMORY[0x263F42658]) initWithTimeInterval:0 options:a3];
    [v9 setDelegate:self];
...
- (void)_stopBrowsers
{
  ...
  if (v4)
  {
    ...
    v12 = (void *)MEMORY[0x230FBD990]([(HMDBonjourBrowserHelper *)self _updateTimerWithTimeout:"_updateTimerWithTimeout:"]);
    v13 = self;
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v39 = 2112;
      v40 = v17;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Waiting to restart browsing after: %@ seconds", buf, 0x16u);
    }
  }
  long long v33 = 0u;
  long long v34 = 0u;
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v11 = (void *)[objc_alloc(MEMORY[0x263F425B8]) initWithDomain:@"local." serviceType:v10];
...
void __41__HMDBonjourBrowserHelper__startBrowsers__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v18 = 2112;
    long long v19 = v11;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Starting browsing for services of type: %@ with error: %@ for %@ seconds", (uint8_t *)&v12, 0x2Au);
  }
  if (v3) {
...
- (HMDBonjourBrowserHelper)initWithServicesOfTypes:(id)a3 browsingTimeInterval:(double)a4 browsingPeriodicity:(double)a5 workQueue:(id)a6
{
  ...
  if (a4 > 0.0 && [v11 count])
  {
    ...
    if (v13)
    {
      ...
      uint64_t v16 = objc_msgSend(MEMORY[0x263EFF980], "arrayWithCapacity:", objc_msgSend(v11, "count"));
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v27 = v23;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Browsing interval or types count must be greater than 0", buf, 0xCu);
    }
    uint64_t v20 = 0;
  }
