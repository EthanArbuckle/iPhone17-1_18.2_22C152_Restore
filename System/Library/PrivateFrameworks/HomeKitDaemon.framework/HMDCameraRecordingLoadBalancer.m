...
- (void)systemResourceUsageDidChangeTo:(int64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v22 = 2112;
    v23 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating resource usage to %@", (uint8_t *)&v20, 0x16u);
  }
  v10 = [(HMDCameraRecordingLoadBalancer *)v6 homeManager];
  v11 = [v10 residentMesh];

  v12 = [MEMORY[0x263F47CD8] sharedInstance];
  ...
  v15 = [MEMORY[0x263F47CD8] sharedInstance];
...
- (id)_loadBalancingDescriptionFromSortedNodes:(id)a3
{
  ...
  if ([v3 count])
  {
    unint64_t v4 = objc_msgSend(v3, "na_map:", &__block_literal_global_259768);
    v5 = NSString;
...
id __75__HMDCameraRecordingLoadBalancer__loadBalancingDescriptionFromSortedNodes___block_invoke(uint64_t a1, void *a2)
{
  ...
  [v20 removeObject:&stru_26E2EB898];
...
- (id)_loadBalancingDecisionForCamera:(id)a3 deviceFilter:(id)a4
{
            ...
            for (uint64_t i = 0; i != v11; ++i)
            {
              ...
              if (v15)
              {
                ...
                if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
                {
                  ...
                  *(_WORD *)&buf[12] = 2112;
                  *(void *)&buf[14] = v21;
                  _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Expiring cached HMDCameraRecordingLoadBalancerDecision: %@", buf, 0x16u);
                }
  ...
  if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
  {
    ...
    *(void *)&buf[4] = v42;
    _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_INFO, "%{public}@Skipping applying exclusion filter because override is set.", buf, 0xCu);
  }
LABEL_30:
  ...
  if (v44)
  {
    ...
    if (v47)
    {
      if (os_log_type_enabled(v50, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(void *)&buf[14] = v47;
        _os_log_impl(&dword_22F52A000, v51, OS_LOG_TYPE_INFO, "%{public}@Applying load balancer override with allow list: %@", buf, 0x16u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[22] = 2112;
        v141 = v56;
        _os_log_impl(&dword_22F52A000, v51, OS_LOG_TYPE_ERROR, "%{public}@Device names allow list was not an array (%@): %@", buf, 0x20u);
      }
    }
  }
  v57 = [v109 value];
  ...
  if (v57)
  {
    ...
    if (v60)
    {
      if (os_log_type_enabled(v63, OS_LOG_TYPE_INFO))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(void *)&buf[14] = v60;
        _os_log_impl(&dword_22F52A000, v64, OS_LOG_TYPE_INFO, "%{public}@Applying load balancer override with deny list: %@", buf, 0x16u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v63, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[22] = 2112;
        v141 = v69;
        _os_log_impl(&dword_22F52A000, v64, OS_LOG_TYPE_ERROR, "%{public}@Device names deny list was not an array (%@): %@", buf, 0x20u);
      }
    }
  }
  ...
  if (os_log_type_enabled(v73, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&buf[22] = 2112;
    v141 = v77;
    _os_log_impl(&dword_22F52A000, v73, OS_LOG_TYPE_INFO, "%{public}@Residents sorted for camera (%@): %@", buf, 0x20u);
  }
  *(void *)buf = 0;
  *(void *)&buf[8] = buf;
...
uint64_t __79__HMDCameraRecordingLoadBalancer__loadBalancingDecisionForCamera_deviceFilter___block_invoke(id *a1, void *a2, void *a3)
{
  ...
  BOOL v19 = &unk_26E473AB0;
  if (v16) {
    int v20 = (void *)v16;
  }
  else {
    int v20 = &unk_26E473AB0;
  }
  if (v18) {
    BOOL v19 = (void *)v18;
  }
...
void __79__HMDCameraRecordingLoadBalancer__loadBalancingDecisionForCamera_deviceFilter___block_invoke_2_74(void *a1, void *a2)
{
  ...
  if (!v6)
  {
    ...
    id v8 = [v9 UUIDString];
    [v7 setObject:MEMORY[0x263EFFA78] forKeyedSubscript:v8];
...
- (void)handleRecordingSessionForwardingSuccessForDecision:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v28 = 2112;
    id v29 = v4;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling successful load balancing decision: %@", (uint8_t *)&v26, 0x16u);
  }
...
- (void)setReadyToRecord:(BOOL)a3 forCameraWithUUID:(id)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v6;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Setting ready to record to %@ for camera with UUID %@", (uint8_t *)&v15, 0x20u);
  }
  os_unfair_lock_lock_with_options();
  ...
  if (v5)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v29 = 2112;
        id v30 = v4;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Got recordingDidEndForCamera: %@ with numberOfActiveRecordingSessions == 0", (uint8_t *)&v27, 0x16u);
      }
      unint64_t v7 = 0;
    }
    ...
    if (v15)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v29 = 2112;
        id v30 = v4;
        _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Got recordingDidEndForCamera: %@ with no corresponding entry in recordingSessionSummariesByCameraUUIDString", (uint8_t *)&v27, 0x16u);
      }
    }
...
- (HMDCameraRecordingLoadBalancer)initWithHomeManager:(id)a3 resourceUsageMonitor:(id)a4
{
  ...
  if (v8)
  {
    ...
    uint64_t v18 = [MEMORY[0x263F42608] sharedPreferences];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t28_259826 != -1) {
    dispatch_once(&logCategory__hmf_once_t28_259826, &__block_literal_global_109_259827);
  }
  id v2 = (void *)logCategory__hmf_once_v29_259828;
  return v2;
}
...
void __45__HMDCameraRecordingLoadBalancer_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v29_259828;
  logCategory__hmf_once_v29_259828 = v0;
}
