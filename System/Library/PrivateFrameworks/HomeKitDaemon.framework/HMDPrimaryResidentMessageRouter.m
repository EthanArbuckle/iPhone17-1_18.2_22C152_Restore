...
- (void)relayMessage:(id)a3 device:(id)a4
{
  ...
  if ([v6 isRemote])
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v27 = 2112;
      id v28 = v6;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Cannot relay message that is already remote: %@", (uint8_t *)&v25, 0x16u);
    }
    v12 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:3202];
  ...
  else
  {
    ...
    v17 = [v6 destination];
    v18 = [v17 target];
    v19 = [(HMDPrimaryResidentMessageRouter *)self homeUUID];
    v20 = [(HMDRemoteHomeMessageDestination *)v16 initWithTarget:v18 homeUUID:v19];
    [v13 setDestination:v20];
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v27 = 2112;
      id v28 = v13;
      _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Relaying remote message: %@", (uint8_t *)&v25, 0x16u);
    }
    v14 = [(HMDPrimaryResidentMessageRouter *)v22 messageDispatcher];
    [v14 sendMessage:v13];
  }
}
...
- (void)routeMessage:(id)a3 allowRemoteRelayFromPrimary:(BOOL)a4 localHandler:(id)a5
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v40 = 2112;
    v41 = v13;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Routing message: %@", (uint8_t *)&v38, 0x16u);
  }
  v14 = [(HMDPrimaryResidentMessageRouter *)v10 dataSourcePrimaryResidentDeviceWithMessage:v7];
  v15 = v14;
  if (!v14)
  {
    v17 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2032];
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v40 = 2112;
      v41 = v17;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to data source primary resident with error: %@", (uint8_t *)&v38, 0x16u);
    }
  ...
  {
    v17 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2033];
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v40 = 2112;
      v41 = v17;
      _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to get confirmed primary resident device with error: %@", (uint8_t *)&v38, 0x16u);
    }
    [v7 respondWithError:v17];
...
LABEL_14:
  ...
  {
    v31 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2034];
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v40 = 2112;
      v41 = v31;
      _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_ERROR, "%{public}@Failed to get destination device from primary resident device with error: %@", (uint8_t *)&v38, 0x16u);
    }
...
- (id)dataSourcePrimaryResidentDeviceWithMessage:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      int v15 = 138543362;
      v16 = v11;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to data source primary resident device due to no data source", (uint8_t *)&v15, 0xCu);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7_16413 != -1) {
    dispatch_once(&logCategory__hmf_once_t7_16413, &__block_literal_global_16414);
  }
  v2 = (void *)logCategory__hmf_once_v8_16415;
  return v2;
}
...
void __46__HMDPrimaryResidentMessageRouter_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v8_16415;
  logCategory__hmf_once_v8_16415 = v0;
}
