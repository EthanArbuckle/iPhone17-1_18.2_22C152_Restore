  ...
  if (v5)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v6; ++i)
      {
        ...
        double v24 = (void *)[objc_alloc(MEMORY[0x263F00A50]) initWithLatitude:v21 longitude:v23];
...
{
  uint64_t v3 = 3;
  id v4 = [MEMORY[0x263EFF980] arrayWithCapacity:3];
  uint64_t v5 = [(HMDLocationCluster *)self locations];
...
- (CLLocation)bestLocation
{
  ...
  if (v4)
  {
    ...
    if (v6 > 0xA)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v29 = 2112;
        long long v30 = v14;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Number of locations is %lu so using k-means-clustered location for best location: %@", (uint8_t *)&v25, 0x20u);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Number of locations is only %lu so sorting and using most accurate location for best location", (uint8_t *)&v25, 0x16u);
      }
      int v12 = [(HMDLocationCluster *)v8 locations];
      int v13 = [v12 sortedArrayUsingComparator:&__block_literal_global_233685];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      int v25 = 138543362;
      id v26 = v18;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Number of locations is 0 so returning nil for best location", (uint8_t *)&v25, 0xCu);
    }
    double v14 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_233696 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_233696, &__block_literal_global_6_233697);
  }
  v2 = (void *)logCategory__hmf_once_v4_233698;
  return v2;
}
...
void __33__HMDLocationCluster_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_233698;
  logCategory__hmf_once_v4_233698 = v0;
}
