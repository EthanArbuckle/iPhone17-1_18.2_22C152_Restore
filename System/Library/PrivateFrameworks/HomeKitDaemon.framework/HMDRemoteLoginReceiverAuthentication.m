...
- (void)_completedAuthenticationRequest:(id)a3 loggedInAccount:(id)a4
{
  ...
  if ([v7 conformsToProtocol:&unk_26E5AE560]) {
    v8 = v7;
  }
  else {
    v8 = 0;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(void *)&location[4] = v13;
      __int16 v17 = 2112;
      id v18 = v9;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Authentication results is not valid, resulted in error %@", location, 0x16u);
    }
...
- (void)_authenticateAccount:(id)a3 targetedAccountType:(unint64_t)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v16 = 2112;
    id v17 = v6;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Authenticating the account with context: %@", buf, 0x16u);
  }
...
- (void)_authenticateStoreWithAuthenticationResults:(id)a3 completionHandler:(id)a4
{
  ...
  id v6 = a3;
  id v7 = a4;
  id v8 = objc_msgSend(v6, "hmf_stringForKey:", *MEMORY[0x263F29010]);
  uint64_t v9 = objc_msgSend(v6, "hmf_stringForKey:", *MEMORY[0x263F28F58]);
  v10 = objc_msgSend(v6, "hmf_stringForKey:", *MEMORY[0x263F28FF0]);
  id v11 = objc_msgSend(v6, "hmf_stringForKey:", *MEMORY[0x263F28FF8]);
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v41 = 2112;
    v42 = v10;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Authenticating iTunes account with username %@, altDSID: %@, pet: %@", buf, 0x2Au);
  }
  v28 = (void *)v9;
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v37 = 2112;
    v38 = v20;
    _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Password: %@", buf, 0x16u);
  }
  id v21 = objc_alloc_init(MEMORY[0x263F27B00]);
  [v21 setAuthenticationType:1];
  v22 = (void *)[objc_alloc(MEMORY[0x263F27B18]) initWithAuthenticationResults:v6 options:v21];
...
void __102__HMDRemoteLoginReceiverAuthentication__authenticateStoreWithAuthenticationResults_completionHandler___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v15 = 2112;
    id v16 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@iTunes authentication failed. (%@). Error: %@", (uint8_t *)&v11, 0x20u);
  }
  uint64_t v9 = *(void *)(a1 + 48);
  v10 = [MEMORY[0x263F087E8] hmErrorWithCode:52];
...
void __102__HMDRemoteLoginReceiverAuthentication__authenticateStoreWithAuthenticationResults_completionHandler___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v20 = 2112;
    uint64_t v21 = v6;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@iTunes successfully authenticated. Making active. (%@).", buf, 0x16u);
  }
  id v7 = [*(id *)(a1 + 48) account];
  objc_msgSend(v7, "ams_setActive:forMediaType:", 1, 0);

  id v8 = [*(id *)(a1 + 48) account];
  [v8 setObject:MEMORY[0x263EFFA88] forKeyedSubscript:@"wasOtherAccount"];

  id v9 = objc_msgSend(MEMORY[0x263EFB210], "ams_sharedAccountStoreForMediaType:", 0);
...
void __102__HMDRemoteLoginReceiverAuthentication__authenticateStoreWithAuthenticationResults_completionHandler___block_invoke_36(uint64_t a1)
{
  ...
  {
    id v5 = HMFGetLogIdentifier();
    uint64_t v6 = [MEMORY[0x263F42610] defaultFormatter];
    ...
    __int16 v13 = 2112;
    id v14 = v8;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Succeeded in save of account: %@", (uint8_t *)&v11, 0x16u);
  }
  uint64_t v9 = *(void *)(a1 + 48);
...
void __102__HMDRemoteLoginReceiverAuthentication__authenticateStoreWithAuthenticationResults_completionHandler___block_invoke_38(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v17 = 2112;
    id v18 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to save account %@: %@", (uint8_t *)&v13, 0x20u);
  }
...
- (void)_authenticateForAccountType:(unint64_t)a3 usingAuthenticationResults:(id)a4 completionHandler:(id)a5
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v23 = 2112;
    id v24 = v14;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Authenticating account type %@", (uint8_t *)&v21, 0x16u);
  }
  if (a3)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v25 = 2112;
      id v26 = v19;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@%s: Unknown account services: %@", (uint8_t *)&v21, 0x20u);
    }
    __int16 v20 = [MEMORY[0x263F087E8] hmErrorWithCode:43];
    v9[2](v9, v20, 0);
  }
  else
  {
...
void __78__HMDRemoteLoginReceiverAuthentication__saveRemoteVerifiedAccount_completion___block_invoke(uint64_t a1, char a2, void *a3)
{
  ...
  if (a2)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v19 = 2112;
      __int16 v20 = v11;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Save of verified account successful; %@.",
        (uint8_t *)&v17,
        0x16u);
    }
  }
  else
  {
    ...
    if (v12 == 5)
    {
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v19 = 2112;
        __int16 v20 = v15;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Account already existed %@.", (uint8_t *)&v17, 0x16u);
      }
    }
    else if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      __int16 v20 = v6;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Save of account failed. This will stop further attempts as this should not fail. Error: %@", (uint8_t *)&v17, 0x16u);
    }
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_180313 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_180313, &__block_literal_global_180314);
  }
  v2 = (void *)logCategory__hmf_once_v1_180315;
  return v2;
}
...
void __51__HMDRemoteLoginReceiverAuthentication_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_180315;
  logCategory__hmf_once_v1_180315 = v0;
}
