...
- (id)prettyJSONDictionary
{
  ...
  if (v9 >= 2)
  {
    ...
    v14 = objc_msgSend(v12, "na_map:", &__block_literal_global_271948);
...
+ (id)createWithJSONDictionary:(id)a3 name:(id)a4 critical:(BOOL)a5 purpose:(unint64_t)a6 allowInterAccessoryConnections:(BOOL)a7 direction:(unsigned __int8)a8 requiredForHAPFunctionality:(BOOL)a9 ruleDictionary:(id)a10 error:(id *)a11
{
  ...
  if (v21)
  {
    ...
    if (!v23)
    {
      ...
      if (!v23)
      {
        v37 = (void *)MEMORY[0x230FBD990](v22);
        id v38 = a1;
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v55 = 2112;
          v56 = v22;
          _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_ERROR, "%{public}@Rule contains an invalid IP address value: %@", buf, 0x16u);
        }
        if (a11)
        {
          [MEMORY[0x263F087E8] hmErrorWithCode:3];
...
LABEL_41:
      if (a11)
      {
        *a11 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
      }
      goto LABEL_43;
    }
...
LABEL_39:
          _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_ERROR, v29, buf, 0xCu);
