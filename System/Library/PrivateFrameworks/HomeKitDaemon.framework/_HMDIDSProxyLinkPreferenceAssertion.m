...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v10 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting the link preference for proxy service", buf, 0xCu);
  }
  v7 = [(_HMDIDSProxyLinkPreferenceAssertion *)v4 proxyService];
  [v7 setLinkPreferences:MEMORY[0x263EFFA78]];
...
- (_HMDIDSProxyLinkPreferenceAssertion)initWithIDSProxyService:(id)a3
{
  ...
  if (v6)
  {
    ...
    objc_super v8 = [MEMORY[0x263EFF9A0] dictionaryWithCapacity:4];
    v9 = [NSNumber numberWithUnsignedInteger:150];
    [v8 setObject:v9 forKeyedSubscript:*MEMORY[0x263F49E60]];

    [v8 setObject:@"forceBTClassic" forKeyedSubscript:*MEMORY[0x263F49E50]];
    BOOL v10 = isWatch();
    if (v10) {
      uint64_t v11 = 6250;
    }
    ...
    [v8 setObject:v13 forKeyedSubscript:*MEMORY[0x263F49E48]];

    v14 = [NSNumber numberWithUnsignedInteger:v12];
    [v8 setObject:v14 forKeyedSubscript:*MEMORY[0x263F49E58]];
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v23 = 2112;
      v24 = v8;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Setting the link preference for proxy service with %@", buf, 0x16u);
    }
