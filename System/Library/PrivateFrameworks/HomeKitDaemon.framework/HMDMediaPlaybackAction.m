        ...
        if (v20 != v22)
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v52 = 2112;
            v53 = v27;
            _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@Couldn't find all media profiles on the home, found: %@ from UUIDs: %@", buf, 0x20u);
          }
        }
        v28 = [v12 uuid];
        v29 = [v12 state];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v50 = 2112;
          v51 = v39;
          _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_ERROR, "%{public}@Couldn't find any media profiles in the home for the UUIDs: %@", buf, 0x16u);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v4 encodeObject:v5 forKey:*MEMORY[0x263F0D118]];

  v6 = [(HMDMediaPlaybackAction *)self volume];
  [v4 encodeObject:v6 forKey:*MEMORY[0x263F0D128]];

  v7 = [(HMDMediaPlaybackAction *)self playbackArchive];
  [v4 encodeObject:v7 forKey:*MEMORY[0x263F0D0F8]];

  if (objc_msgSend(v4, "hmd_isForXPCTransport"))
  {
    id v8 = [(HMDMediaPlaybackAction *)self mediaProfiles];
    [v4 encodeObject:v8 forKey:*MEMORY[0x263F0D108]];
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544386;
      ...
      __int16 v33 = 2112;
      v34 = v17;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@XPC Encoded Playback action uuid %@ state %tu profiles %@ playbackArchive %@", buf, 0x34u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v31 = 2112;
      id v32 = v23;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Cloud Encoded Playback action uuid %@ state %tu profiles %@", buf, 0x2Au);
...
- (HMDMediaPlaybackAction)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    v25 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0D118]];
    uint64_t v24 = [v25 integerValue];
    v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0D128]];
    v7 = (void *)MEMORY[0x263EFFA08];
    v27[0] = objc_opt_class();
    v27[1] = objc_opt_class();
    id v8 = [MEMORY[0x263EFF8C0] arrayWithObjects:v27 count:2];
    id v9 = [v7 setWithArray:v8];

    id v10 = [v4 decodeObjectOfClasses:v9 forKey:@"HDMPA.profileUUIDs"];
    id v11 = (void *)[v10 mutableCopy];

    id v12 = [v4 decodeObjectOfClass:objc_opt_class() forKey:*MEMORY[0x263F0D0F8]];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v30 = 2112;
      id v31 = v22;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode base class: %@", buf, 0x16u);
    }
    id v18 = 0;
  }
...
- (void)_processPlaybackActionModelUpdated:(id)a3 message:(id)a4
{
  ...
  if (v25 && v26)
  {
    ...
    v33 = id v32 = v7;
    v47[2] = v33;
    uint64_t v34 = [NSDictionary dictionaryWithObjects:v47 forKeys:v46 count:3];
    ...
    v25 = (void *)v34;
LABEL_17:
    v40 = (void *)MEMORY[0x230FBD990]([v7 respondWithPayload:v25]);
    id v41 = self;
    ...
    if (os_log_type_enabled(v42, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v50 = 2112;
      id v51 = v25;
      _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_DEBUG, "%{public}@Responding to client after updating action with response: %@", buf, 0x16u);
    }
    [v8 markChanged];
    goto LABEL_20;
  }
  ...
  if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v54 = 2112;
    v55 = v27;
    _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_ERROR, "%{public}@Playback action Model object (%@) missing actionset %@ or home %@ ", buf, 0x2Au);
  }
...
- (void)transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  else
  {
    ...
    int v19 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
...
- (id)associatedAccessories
{
  ...
  v3 = objc_msgSend(v2, "na_map:", &__block_literal_global_38_247935);
  id v4 = [v3 allObjects];
...
- (NSString)description
{
  ...
  id v4 = objc_msgSend(v3, "na_map:", &__block_literal_global_247938);
  v5 = [v4 allObjects];
...
- (HMDMediaPlaybackActionAsCharacteristicWriteRequests)convertedCharacteristicWriteRequests
{
  ...
  else
  {
    ...
    v36 = objc_msgSend(MEMORY[0x263EFF9C0], "setWithCapacity:", objc_msgSend(v6, "count"));
    char v7 = objc_msgSend(MEMORY[0x263EFF980], "arrayWithCapacity:", 2 * objc_msgSend(v6, "count"));
    long long v37 = 0u;
    long long v38 = 0u;
    long long v39 = 0u;
    long long v40 = 0u;
...
- (id)validate
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_ERROR, "%{public}@Invalid configuration for media playback action - state: %tu  volume: %@  #Profiles: %tu", (uint8_t *)&v16, 0x2Au);
    }
    char v7 = [MEMORY[0x263F087E8] hmErrorWithCode:3 description:@"Invalid configuration for media playback action" reason:0 suggestion:0];
  }
  return v7;
}
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      double v21 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Executing media playback action", buf, 0xCu);
    }
...
- (id)dictionaryRepresentation
{
  ...
  v5 = objc_msgSend(NSNumber, "numberWithInteger:", -[HMDMediaPlaybackAction state](self, "state"));
  [v4 setObject:v5 forKeyedSubscript:*MEMORY[0x263F0D120]];

  id v6 = [(HMDMediaPlaybackAction *)self volume];
  [v4 setObject:v6 forKeyedSubscript:*MEMORY[0x263F0D130]];

  char v7 = [(HMDMediaPlaybackAction *)self mediaProfiles];
  id v8 = __mapProfilesToProfileUUIDs(v7);
  id v9 = [v8 allObjects];
  [v4 setObject:v9 forKeyedSubscript:*MEMORY[0x263F0D110]];
  ...
  if (v10)
  {
    ...
    if (v13)
    {
      [v4 setObject:v13 forKeyedSubscript:*MEMORY[0x263F0D100]];
    }
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v25 = 2112;
        id v26 = v14;
        _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Couldn't encode playbackArchive: %@", buf, 0x16u);
      }
    }
  }
...
- (void)configureWithHome:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    id v18 = v12;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Mapped profile UUIDs %@ to profiles %@", (uint8_t *)&v13, 0x20u);
  }
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t24_247978 != -1) {
    dispatch_once(&logCategory__hmf_once_t24_247978, &__block_literal_global_63_247979);
  }
  v2 = (void *)logCategory__hmf_once_v25_247980;
  return v2;
}
...
void __37__HMDMediaPlaybackAction_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v25_247980;
  logCategory__hmf_once_v25_247980 = v0;
}
      ...
      if (v15 != v17)
      {
        ...
        if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v48 = 2112;
          v49 = v22;
          _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Couldn't find all media profiles on the home, found: %@ from UUIDs: %@", buf, 0x20u);
        }
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v46 = 2112;
        id v47 = v39;
        _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_ERROR, "%{public}@Couldn't find any media profiles in the home for the UUIDs: %@", buf, 0x16u);
      }
      __int16 v30 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v33, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v46 = 2112;
      id v47 = v8;
      _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_ERROR, "%{public}@Invalid action type: %@", buf, 0x16u);
    }
    __int16 v30 = 0;
  }
