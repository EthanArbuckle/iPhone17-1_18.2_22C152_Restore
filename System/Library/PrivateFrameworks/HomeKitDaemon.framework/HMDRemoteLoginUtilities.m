...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_253151 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_253151, &__block_literal_global_253152);
  }
  v2 = (void *)logCategory__hmf_once_v5_253153;
  return v2;
}
...
void __38__HMDRemoteLoginUtilities_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_253153;
  logCategory__hmf_once_v5_253153 = v0;
}
...
+ (void)fetchIsTwoFactorAuthenticationEnabledForAccountWithReason:(id)a3 completionHandler:(id)a4
{
  ...
  id v14 = objc_alloc_init(MEMORY[0x263F29110]);
  [v14 setUsername:v10];
  [v14 setAltDSID:v13];
  [v14 setIsUsernameEditable:0];
  [v14 setReason:v6];
  [v14 setServiceType:0];
  v15 = (void *)MEMORY[0x230FBD990]([v14 setShouldPreventInteractiveAuth:1]);
  id v16 = a1;
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v30 = 2112;
    id v31 = v6;
    _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Querying 2FA status with username: %@ altDSID: %@ reason: %@", buf, 0x2Au);
  }
...
void __103__HMDRemoteLoginUtilities_fetchIsTwoFactorAuthenticationEnabledForAccountWithReason_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v5)
  {
    objc_msgSend(v5, "hmf_BOOLForKey:", *MEMORY[0x263F28FD8]);
...
LABEL_8:
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, v12, (uint8_t *)&v17, 0x16u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v6;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Unable to directly determine 2FA authentication status: %@", (uint8_t *)&v17, 0x16u);
    }
