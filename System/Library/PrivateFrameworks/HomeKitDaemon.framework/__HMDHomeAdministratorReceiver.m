...
- (void)__handleXPCMessage:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v14 = 2112;
      v15 = v10;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Locally dispatching message: %@", (uint8_t *)&v12, 0x16u);
    }
...
- (void)registerForMessage:(id)a3 policies:(id)a4
{
  ...
  {
    id v6 = a3;
    objc_msgSend(a4, "hmf_objectsPassingTest:", &__block_literal_global_119_240752);
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7_240765 != -1) {
    dispatch_once(&logCategory__hmf_once_t7_240765, &__block_literal_global_124_240766);
  }
  v2 = (void *)logCategory__hmf_once_v8_240767;
  return v2;
}
