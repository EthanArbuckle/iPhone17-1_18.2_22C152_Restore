...
void __55__HMDSiriServer_accessory_didCloseDataStreamWithError___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    v16 = v10;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@DataStream closed for accessory %@/%@.", (uint8_t *)&v11, 0x20u);
  }
}
...
void __44__HMDSiriServer_accessoryDidStartListening___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v13 = 138543362;
    v14 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory's DataStream started.", (uint8_t *)&v13, 0xCu);
  }
  id v6 = *(id *)(a1 + 40);
  objc_opt_class();
  if (objc_opt_isKindOfClass()) {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      int v13 = 138543362;
      v14 = v12;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Accessory provided is not a HMDHAPAccessory; cannot send targetControl identifier.",
        (uint8_t *)&v13,
        0xCu);
    }
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v20 = v15;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@Accessory provided is not a HMDHAPAccessory; cannot activate corresponding siri session.",
        buf,
        0xCu);
    }
  }
...
void __58__HMDSiriServer_accessory_didReceiveBulkSessionCandidate___block_invoke(uint64_t a1)
{
  ...
  if (!v2)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v29 = v20;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Received new Siri Audio stream but unable to create local context", buf, 0xCu);
    }
  ...
  if ((v5 & 1) == 0)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v29 = v23;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Received new Siri Audio stream but unable to activate Siri.", buf, 0xCu);
    }
    uint64_t v21 = *(void **)(a1 + 48);
    uint64_t v22 = 5;
LABEL_12:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v29 = v10;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Received new Siri Audio stream; setting it up.",
      buf,
      0xCu);
  }
...
void __58__HMDSiriServer_accessory_didReceiveBulkSessionCandidate___block_invoke_22(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      int v10 = 138543362;
      int v11 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Siri session canceled before it began; cleaning up.",
        (uint8_t *)&v10,
        0xCu);
    }
...
uint64_t __57__HMDSiriServer_monitor_willAllowAccessoryForDragonSiri___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v14 = 2112;
    uint64_t v15 = v8;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Accessory is ready to accept Siri; registering listener (%@/%@)",
      (uint8_t *)&v10,
      0x20u);
  }
...
uint64_t __55__HMDSiriServer__removeDataStreamListenerForAccessory___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v14 = 2112;
    uint64_t v15 = v8;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Accessory no longer able to accept Siri; deregistering listener (%@/%@)",
      (uint8_t *)&v10,
      0x20u);
  }
...
- (BOOL)_isSiriInputType:(int64_t)a3 supportedOnAccessory:(id)a4 siriAudioConfiguration:(id)a5
{
        ...
        !v11))
  {
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_DEBUG))
    {
      ...
      *(_WORD *)&v61[8] = 2112;
      *(void *)&v61[10] = v38;
      _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_DEBUG, "%{public}@Marking accessory not ready for connection due to missing Siri/Audio ability (%@/%@)", buf, 0x20u);
    }
    goto LABEL_17;
  }
  if ([v10 siriInputType] != a3)
  {
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
    {
      ...
      *(void *)&v61[20] = v42;
      ...
      _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_INFO, "%{public}@Checking for input type %ld, but accessory has input type %ld (%@/%@)", buf, 0x34u);
...
LABEL_17:
  ...
  if (v13)
  {
    ...
    if ((v16 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        *(void *)&v61[20] = v13;
        ...
        v24 = (void *)v63;
        _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Need to set the audio configuration (%@/%@) %@ != %@", buf, 0x34u);
    ...
    id v25 = (void *)MEMORY[0x230FBD990](v17);
    id v26 = self;
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_WORD *)&v61[8] = 2112;
      *(void *)&v61[10] = v31;
      _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Marking accessory READY for connection (%@/%@)", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(void *)&v61[16] = *(_WORD *)&v61[14] = 2112;
      v49 = *(void **)&v61[16];
      _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Marking accessory not ready for connection due to none of the %u codecs allowed (%@/%@)", buf, 0x26u);
    }
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v19 = 2112;
      v20 = v11;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Marking accessory not ready for connection due to missing HDS (%@/%@)", buf, 0x20u);
    }
    ...
    if (v4)
    {
      ...
      if (v6)
      {
        if (v10)
        {
          ...
          __int16 v17 = 2112;
          id v18 = v12;
          _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Created UI session with session id %@", (uint8_t *)&v15, 0x16u);
        }
...
LABEL_11:
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, v14, (uint8_t *)&v15, 0xCu);
      }
    }
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v20 = 2112;
      uint64_t v21 = v12;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Handling disconnect for %@/%@.", buf, 0x20u);
    }
...
uint64_t __54__HMDSiriServer_handleAccessoryHasBulkSendDataStream___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v8;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory has bulk-send Data Stream capability (%@/%@)", (uint8_t *)&v10, 0x20u);
  }
  return [*(id *)(a1 + 32) _checkSiriSupportByAccessory:*(void *)(a1 + 40)];
}
...
- (void)registerForMessages
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    int v11 = 138543362;
    __int16 v12 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Registering for messages.", (uint8_t *)&v11, 0xCu);
  }
