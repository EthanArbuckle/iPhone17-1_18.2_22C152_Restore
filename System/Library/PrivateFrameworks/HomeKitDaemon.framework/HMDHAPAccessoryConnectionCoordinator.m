        ...
        if (v3)
        {
          ...
          if (v12)
          {
            ...
            if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
            {
              ...
              *(void *)&buf[4] = v16;
              _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_DEBUG, "%{public}@Triggering evaluation of HAP servers", buf, 0xCu);
            }
            *(void *)buf = 0;
...
- (void)evaluateAccessoryConnectionStatus
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    __int16 v27 = 2114;
    v28 = v10;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Evaluating connection status for all accessories using - isCurrentDevicePrimaryResident = %{public}@, isCurrentDeviceAvailableResident = %{public}@, hasAnyResident = %{public}@", buf, 0x2Au);
  }
  long long v18 = 0u;
  long long v19 = 0u;
  long long v16 = 0u;
...
- (void)handlePrimaryResidentChanged:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    long long v10 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Primary resident changed, evaluating connection status with accessories", (uint8_t *)&v9, 0xCu);
  }
...
- (void)handleResidentChangedOnNonResident
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v16 = 2112;
    long long v17 = v11;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@A resident device was updated for home %@(%@), evaluating current non-resident device connection status with accessories", (uint8_t *)&v12, 0x20u);
  }
...
- (void)handleCurrentResidentChanged:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v16 = 2112;
    long long v17 = v11;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Current device resident enable = %@, isPrimary = %@, evaluate connection status with accessories", (uint8_t *)&v12, 0x20u);
  }
  [(HMDHAPAccessoryConnectionCoordinator *)v6 evaluateAccessoryConnectionStatus];
}
...
- (void)handleIsResidentFirstAccessoryCommunicationEnabledDidChangeNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    int v9 = 138543362;
    long long v10 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Home changed resident first accessory communication enablement", (uint8_t *)&v9, 0xCu);
  }
  [(HMDHAPAccessoryConnectionCoordinator *)v6 evaluateAccessoryConnectionStatus];
}
...
- (void)handleResidentUpdated:(id)a3
{
  ...
  {
    uint64_t v8 = (HMDHAPAccessoryConnectionCoordinator *)_HMFPreconditionFailure();
    [(HMDHAPAccessoryConnectionCoordinator *)v8 handleResidentAddRemove:v10];
  }
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t11_41776 != -1) {
    dispatch_once(&logCategory__hmf_once_t11_41776, &__block_literal_global_41777);
  }
  v2 = (void *)logCategory__hmf_once_v12_41778;
  return v2;
}
...
void __51__HMDHAPAccessoryConnectionCoordinator_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v12_41778;
  logCategory__hmf_once_v12_41778 = v0;
}
