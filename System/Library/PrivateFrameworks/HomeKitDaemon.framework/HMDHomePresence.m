...
- (BOOL)isPresenceRegionKnownForUser:(id)a3
{
  ...
  if (v6 == 1)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v24 = 2112;
        id v25 = v4;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Could not find user %@", (uint8_t *)&v22, 0x16u);
      }
      BOOL v12 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v24 = 2112;
      id v25 = v4;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_DEBUG, "%{public}@%@ is not presence-authorized, cannot determine isUserPresenceRegionKnown", (uint8_t *)&v22, 0x16u);
    }
    BOOL v12 = 0;
  }
...
- (BOOL)isUserNotAtHome:(id)a3
{
  ...
  if (v6 == 1)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        __int16 v23 = 2112;
        id v24 = v4;
        _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Could not find user %@", (uint8_t *)&v21, 0x16u);
      }
      BOOL v11 = 0;
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v23 = 2112;
      id v24 = v4;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEBUG, "%{public}@%@ is not presence-authorized, cannot determine isUserNotAtHome", (uint8_t *)&v21, 0x16u);
    }
    BOOL v11 = 0;
  }
...
- (BOOL)isUserAtHome:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      __int16 v23 = 2112;
      id v24 = v4;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEBUG, "%{public}@%@ is not presence-authorized, cannot determine isUserAtHome", (uint8_t *)&v21, 0x16u);
    }
    BOOL v11 = 0;
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      int v21 = v13;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@doAllUsersHavePresenceRegion - No users in presence map", buf, 0xCu);
    }
    BOOL v9 = 0;
  }
...
- (BOOL)isAnyUserAtHome
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      int v21 = v13;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@isAnyUserAtHome - No users in presence map", buf, 0xCu);
    }
    BOOL v7 = 0;
  }
...
- (BOOL)isNoUserAtHome
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      int v21 = v13;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@isNoUserAtHome - No users in presence map", buf, 0xCu);
    }
    BOOL v8 = 0;
  }
...
void __49__HMDHomePresence_serializedIdentifierDictionary__block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  {
LABEL_7:
    [*(id *)(a1 + 32) setObject:&unk_26E472B38 forKeyedSubscript:v9];
    goto LABEL_8;
  }
  ...
  if (!v12)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v21 = 2112;
      uint64_t v22 = v7;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Using HMDUserPresenceRegionStatusUnknown for user with nil presence: %@", (uint8_t *)&v19, 0x16u);
    }
    goto LABEL_7;
  }
...
LABEL_7:
    ...
    [v20 setObject:&unk_26E472B38 forKeyedSubscript:v12];
    goto LABEL_8;
  }
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v23 = 2112;
      id v24 = v7;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Using HMDUserPresenceRegionStatusUnknown for user with nil presence: %@", (uint8_t *)&v21, 0x16u);
    }
    goto LABEL_7;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_200774 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_200774, &__block_literal_global_200775);
  }
  v2 = (void *)logCategory__hmf_once_v4_200776;
  return v2;
}
...
void __30__HMDHomePresence_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_200776;
  logCategory__hmf_once_v4_200776 = v0;
}
