...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_155786 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_155786, &__block_literal_global_155787);
  }
  v2 = (void *)logCategory__hmf_once_v1_155788;
  return v2;
}
...
void __55__HMDRemoteLoginAnisetteDataProviderBridge_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_155788;
  logCategory__hmf_once_v1_155788 = v0;
}
