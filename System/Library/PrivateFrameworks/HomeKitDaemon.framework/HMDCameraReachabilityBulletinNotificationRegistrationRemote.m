...
- (HMDCameraReachabilityBulletinNotificationRegistrationRemote)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    id v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"HMDCRBNRR.ck.s"];
    if (v6)
    {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  id v6 = [(HMDCameraReachabilityBulletinNotificationRegistrationRemote *)self source];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v6
    && (v11.receiver = self,
        ...
        [(HMDCameraReachabilityBulletinNotificationRegistrationRemote *)&v11 isEqual:v6]))
  {
    v7 = [(HMDCameraReachabilityBulletinNotificationRegistrationRemote *)self source];
    v8 = [v6 source];
...
LABEL_7:
    ...
    return (HMDCameraReachabilityBulletinNotificationRegistrationRemote *)+[HMDCameraReachabilityBulletinNotificationRegistrationRemote supportsSecureCoding];
  }
  v15.receiver = self;
  v15.super_class = (Class)HMDCameraReachabilityBulletinNotificationRegistrationRemote;
  v10 = [(HMDCameraReachabilityBulletinNotificationRegistrationRemote *)&v15 init];
  objc_super v11 = v10;
  if (v10)
  {
