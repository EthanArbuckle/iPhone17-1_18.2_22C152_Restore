...
- (id)dumpState;
- (id)emptyModelObject;
- (id)eventModelWithDictionary:(id)a3 transaction:(id)a4 home:(id)a5 message:(id)a6 error:(id *)a7;
...
- (id)modelObjectWithChangeType:(unint64_t)a3 version:(int64_t)a4
{
  ...
  if (v11)
  {
    long long v12 = (void *)MEMORY[0x263F08910];
  ...
  if (v15)
  {
    long long v16 = (void *)MEMORY[0x263F08910];
...
- (void)_transactionObjectRemoved:(id)a3 message:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      int v15 = 138543362;
      int v16 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to cast the given model object to EventModel", (uint8_t *)&v15, 0xCu);
    }
  }
}
...
- (void)processEventRecords:(id)a3 message:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    int v14 = 138543362;
    int v15 = v11;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Saving to push the event records to cloud", (uint8_t *)&v14, 0xCu);
  }
...
- (void)_transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  if (v13)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      int v31 = 138543362;
      v32 = v17;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Handling event trigger update", (uint8_t *)&v31, 0xCu);
    }
  ...
  else
  {
    ...
    if (v20)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
        {
          ...
          int v31 = 138543362;
          v32 = v30;
          _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_INFO, "%{public}@Handling event add", (uint8_t *)&v31, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
      {
        ...
        int v31 = 138543362;
        v32 = v26;
        _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_INFO, "%{public}@Unknown model object", (uint8_t *)&v31, 0xCu);
      }
    }
  }
}
...
- (HMDEventTrigger)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    uint64_t v7 = [MEMORY[0x263EFF8C0] arrayWithObjects:v40 count:8];
    uint64_t v8 = [v6 setWithArray:v7];
    uint64_t v9 = [v4 decodeObjectOfClasses:v8 forKey:@"HM.eventTriggerEvents"];

    uint64_t v10 = [MEMORY[0x263EFF980] arrayWithArray:v9];
    ...
    uint64_t v21 = [MEMORY[0x263EFF8C0] arrayWithObjects:v38 count:2];
  ...
  if (v5 && v6)
  {
      ...
      if (!v13 || ([(HMDEventTriggerDevice *)v13 isOwner] & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v50 = 2112;
          id v51 = v9;
          _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_ERROR, "%{public}@Only owner may perform a user permission dialog: %@", buf, 0x16u);
        }
        ...
        v45 = [MEMORY[0x263F087E8] hmErrorWithCode:17];
    ...
    if (v14)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v49 = v20;
        _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@There is already a user confirmation session in progress, replacing it", buf, 0xCu);
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v50 = 2112;
      id v51 = v31;
      _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Created a user confirmation session %@", buf, 0x16u);
...
LABEL_26:
  ...
  if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v49 = v38;
    _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_ERROR, "%{public}@Did not receive execution session ID or requesting device", buf, 0xCu);
  }
  ...
  if (v39)
  {
    ...
    id v11 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
...
LABEL_5:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    int v18 = 138543362;
    uint64_t v19 = v15;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@There is no confirmation timer running, ignoring the response", (uint8_t *)&v18, 0xCu);
  }
...
- (void)_resetExecutionState
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    uint64_t v7 = [(HMDEventTrigger *)v4 executionSession];
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v8;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting execution sessions %@, confirmation session %@", (uint8_t *)&v9, 0x20u);
  }
...
uint64_t __43__HMDEventTrigger_executionComplete_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v17 = 2112;
    uint64_t v18 = v7;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Action set execution session %@ is complete with error %@", (uint8_t *)&v13, 0x20u);
  }
  ...
  if (!*(void *)(a1 + 48) && [*(id *)(a1 + 32) executeOnce])
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      int v13 = 138543362;
      uint64_t v14 = v11;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Trigger is marked to be executed once, deactivating", (uint8_t *)&v13, 0xCu);
    }
...
- (id)didOccurEvent:(id)a3 causingDevice:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v55 = 2112;
    v56 = v6;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Event occurred on device %@, %@", buf, 0x20u);
  }
  ...
  if (v12)
  {
    ...
    if (v7)
    {
      ...
      int v15 = [v14 needsUserConfirmationForDevice:v7];
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        if (v15) {
          uint64_t v20 = &stru_26E2EB898;
        }
        else {
          uint64_t v20 = @"not ";
        }
        uint64_t v21 = [(HMDEventTrigger *)v17 executionSession];
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v57 = 2112;
        v58 = v21;
        _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Execution session is already in progress, %@adding occurred device %@ for asking confirmation %@", buf, 0x2Au);
      }
      if (v15)
      {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v53 = 2112;
        v54 = v48;
        _os_log_impl(&dword_22F52A000, v46, OS_LOG_TYPE_INFO, "%{public}@Execution session is already in progress, not executing again %@", buf, 0x16u);
      }
    }
    uint64_t v23 = 0;
  }
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v53 = 2112;
      v54 = v28;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@Creating execution session with end events %@", buf, 0x16u);
    }
    ...
    if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v53 = 2112;
      v54 = v42;
      _os_log_impl(&dword_22F52A000, v40, OS_LOG_TYPE_INFO, "%{public}@Created action set execution session: %@", buf, 0x16u);
    }
...
- (BOOL)isEventTriggerOnLocalDeviceForAccessory:(id)a3
{
          ...
          if (v15)
          {
            ...
            if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@Event trigger will run locally. [%s]", buf, 0x16u);
            }
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v34 = 2080;
    long long v35 = "-[HMDEventTrigger isEventTriggerOnLocalDeviceForAccessory:]";
    _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Event trigger will run on the resident. [%s]", buf, 0x16u);
  }
  BOOL v20 = 0;
LABEL_19:
...
- (BOOL)isEventTriggerOnRemoteGatewayForAccessory:(id)a3
{
          ...
          if (v15)
          {
            ...
            if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@Event trigger will run on the resident. [%s]", buf, 0x16u);
            }
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v34 = 2080;
    long long v35 = "-[HMDEventTrigger isEventTriggerOnRemoteGatewayForAccessory:]";
    _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Event trigger will run locally. [%s]", buf, 0x16u);
  }
  BOOL v20 = 0;
LABEL_19:
...
- (void)_updateEventTriggerExecuteOnce:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      int v19 = 138543362;
      BOOL v20 = v18;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Execute once requires shared-trigger-activation capable homehub", (uint8_t *)&v19, 0xCu);
    }
  }
}
...
- (void)_handleUpdateEventTriggerExecuteOnce:(id)a3
{
  id v4 = [(HMDTrigger *)self updateEventTriggerMessage:6 message:a3 relay:1];
  if (v4)
  {
    uint64_t v5 = v4;
...
- (void)_updateOwningDevice:(id)a3
{
  ...
  if ([(HMDEventTrigger *)self checkSharedEventTriggerActivationResidentRequirement:v4])
  {
    ...
    id v27 = 0;
    id v6 = [MEMORY[0x263F08928] unarchivedObjectOfClass:objc_opt_class() fromData:v5 error:&v27];
    id v7 = v27;
    id v8 = (void *)MEMORY[0x230FBD990]();
    uint64_t v9 = self;
    id v10 = HMFGetOSLogHandle();
    ...
    if (v6)
    {
      if (v11)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v30 = 2112;
        id v31 = v6;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Taking over owner ship of trigger to %@", buf, 0x16u);
      }
    ...
    else
    {
      if (v11)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v30 = 2112;
        id v31 = v7;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Failed to unarchive device from device data: %@", buf, 0x16u);
      }
      ...
      objc_super v26 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
...
LABEL_17:
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    long long v29 = v23;
    _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Updating owning device requires shared-trigger-activation capable homehub", buf, 0xCu);
  }
LABEL_18:
}
...
- (void)_handleUpdateOwningDevice:(id)a3
{
  id v4 = [(HMDTrigger *)self updateEventTriggerMessage:7 message:a3 relay:1];
  if (v4)
  {
    uint64_t v5 = v4;
...
- (void)_handleUpdateEventTriggerCondition:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v31 = 2112;
      uint64_t v32 = v7;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Updating evaluation condition for trigger %@", (uint8_t *)&v29, 0x16u);
    }
      ...
      && ![(HMDEventTrigger *)v9 checkSharedEventTriggerActivationResidentRequirement:v6])
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        int v29 = 138543362;
        __int16 v30 = v28;
        _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Presence Event Condition requires shared-trigger-activation capable homehub", (uint8_t *)&v29, 0xCu);
      }
    }
    else
    {
      ...
      int v19 = [MEMORY[0x263F08910] archivedDataWithRootObject:v18 requiringSecureCoding:1 error:0];
...
- (void)_updateEventTriggerRecurrences:(id)a3
{
  ...
  if (+[HMDEventTrigger __validateRecurrences:](HMDEventTrigger, "__validateRecurrences:"))
  {
    ...
    id v8 = [MEMORY[0x263F08910] archivedDataWithRootObject:v15 requiringSecureCoding:1 error:0];
  ...
  {
    int v13 = [MEMORY[0x263F087E8] errorWithDomain:*MEMORY[0x263F0C710] code:3 userInfo:0];
...
- (void)_handleUpdateEventTriggerRecurrences:(id)a3
{
  id v4 = [(HMDTrigger *)self updateEventTriggerMessage:5 message:a3 relay:1];
  if (v4)
  {
    uint64_t v5 = v4;
  ...
  if (v12)
  {
    ...
    while (2)
    {
      for (uint64_t i = 0; i != v13; ++i)
      {
        ...
        uint64_t v19 = [objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v18];
        if (!v19)
        {
          id v18 = v16;
LABEL_25:
          ...
          if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v105 = 2112;
            id v106 = v18;
            _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_ERROR, "%{public}@Invalid ActionSet reference: '%@'", buf, 0x16u);
          }
        ...
        if (!v21)
        {
          ...
          if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v105 = 2112;
            id v106 = v20;
            _os_log_impl(&dword_22F52A000, v43, OS_LOG_TYPE_ERROR, "%{public}@Failed to resolve ActionSet reference: %@", buf, 0x16u);
          }
          v45 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
          v39 = v79;
  ...
  if (v26)
  {
    ...
    uint64_t v29 = *MEMORY[0x263F0B948];
    do
    {
...
LABEL_52:
    ...
    if (os_log_type_enabled(v66, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v104 = v67;
      _os_log_impl(&dword_22F52A000, v66, OS_LOG_TYPE_ERROR, "%{public}@Failed to modify trigger-owned action set", buf, 0xCu);
    }
    [v79 respondWithError:v20];
  }
  else
  {
    ...
    uint64_t v52 = objc_msgSend(MEMORY[0x263F08C38], "hm_deriveUUIDFromBaseUUID:", v51);
    __int16 v53 = [v52 UUIDString];

    v54 = (void *)*MEMORY[0x263F0B948];
    id v89 = 0;
    id v90 = 0;
    v75 = v53;
...
LABEL_50:
    ...
    if (os_log_type_enabled(v71, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v104 = v72;
      _os_log_impl(&dword_22F52A000, v71, OS_LOG_TYPE_ERROR, "%{public}@Failed to create trigger-owned action set", buf, 0xCu);
    }
    [v79 respondWithError:v20];
  }
LABEL_57:
...
LABEL_9:
  ...
  if ([v8 length] > v11)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      int v26 = 138543362;
      uint64_t v27 = v15;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@New name is longer than the pre-defined max length", (uint8_t *)&v26, 0xCu);
    }
    id v16 = (void *)MEMORY[0x263F087E8];
    uint64_t v17 = 46;
    goto LABEL_9;
  ...
  if (v22
    && ([v22 uuid],
        ...
        (v24 & 1) == 0))
  {
    long long v25 = [MEMORY[0x263F087E8] hmErrorWithCode:1];
...
- (Class)eventTriggerTypeToEventClass:(id)a3
{
  ...
  if (([v3 isEqualToString:@"kEventTriggerTypeCharacteristicEventKey"] & 1) != 0
    ...
    || ([v3 isEqualToString:*MEMORY[0x263F0E9D0]] & 1) != 0
...
- (void)_handleUpdateEventTrigger:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v70 = 2112;
    v71 = v9;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Received request to update Event Trigger %@ / %@", buf, 0x20u);
  }
...
LABEL_28:
    ...
    if (v49 || +[HMDEventTrigger __validateRecurrences:v48])
    {
      ...
      uint64_t v23 = [v12 stringForKey:*MEMORY[0x263F0DB68]];
      ...
      if (v46)
      {
        ...
        uint64_t v27 = [MEMORY[0x263F08910] archivedDataWithRootObject:v26 requiringSecureCoding:1 error:0];
      ...
      uint64_t v28 = [MEMORY[0x263F08910] archivedDataWithRootObject:v48 requiringSecureCoding:1 error:0];
      ...
      __int16 v30 = objc_msgSend(NSNumber, "numberWithBool:", objc_msgSend(v12, "BOOLForKey:", *MEMORY[0x263F0DB78]));
      ...
      if ([(HMDEventTrigger *)v6 _populateTriggerModel:v19 fromBuilderMessage:v50 transaction:v47 responsePayload:v31])
      {
        ...
        id v61 = 0;
        char v35 = -[HMDEventTrigger updateEventsFromInfo:existingEvents:preserveUUIDs:endEvent:transaction:message:error:](v45, v32, v34, MEMORY[0x263EFFA80], v47, v12, &v61);
        id v36 = v61;
        ...
        if (v35)
        {
          ...
          id v60 = 0;
          char v40 = -[HMDEventTrigger updateEventsFromInfo:existingEvents:preserveUUIDs:endEvent:transaction:message:error:](v45, v37, v39, MEMORY[0x263EFFA88], v47, v12, &v60);
          id v36 = v60;
          ...
          if (v40)
          {
            ...
            v53[1] = 3221225472;
            v53[2] = __45__HMDEventTrigger__handleUpdateEventTrigger___block_invoke_121;
            v53[3] = &unk_264A1C158;
            id v54 = v50;
            id v55 = v31;
            v56 = v19;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v68 = 2112;
        id v69 = v48;
        _os_log_impl(&dword_22F52A000, v43, OS_LOG_TYPE_ERROR, "%{public}@Received invalid values for recurrences: %@", buf, 0x16u);
      }
      BOOL v19 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
      [v50 respondWithError:v19];
    }

    goto LABEL_28;
  }
  id v51 = [MEMORY[0x263F087E8] hmErrorWithCode:91];
...
void __45__HMDEventTrigger__handleUpdateEventTrigger___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v16 = 2112;
    id v17 = v5;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Responding to the client about update event trigger status : Payload : [%@], error : [%@]", (uint8_t *)&v12, 0x20u);
  }
                ...
                else
                {
                  ...
                  if (os_log_type_enabled(v59, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *(_DWORD *)buf = v69;
                    ...
                    __int16 v104 = 2112;
                    id v105 = v77;
                    _os_log_impl(&dword_22F52A000, v59, OS_LOG_TYPE_ERROR, "%{public}@Failed to deserialize action: %@ with error: %@", buf, 0x20u);
                  }
                  if (v75)
                  {
                    void *v75 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
                  }
              ...
              else
              {
                ...
                if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *(_DWORD *)buf = 138543618;
                  ...
                  __int16 v102 = 2112;
                  id v103 = v80;
                  _os_log_impl(&dword_22F52A000, v51, OS_LOG_TYPE_ERROR, "%{public}@Invalid event trigger type: %@", buf, 0x16u);
            ...
            else
            {
              ...
              if (os_log_type_enabled(v47, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                __int16 v102 = 2112;
                id v103 = v24;
                _os_log_impl(&dword_22F52A000, v47, OS_LOG_TYPE_ERROR, "%{public}@Event must have trigger type %@", buf, 0x16u);
          ...
          else
          {
            ...
            if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v102 = 2112;
              id v103 = v41;
              _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_ERROR, "%{public}@Can't update events %@; invalid serialized event",
                buf,
                0x16u);
...
void __45__HMDEventTrigger__handleUpdateEventTrigger___block_invoke_121(uint64_t a1, uint64_t a2)
{
  if (a2)
  {
    id v3 = *(void **)(a1 + 32);
...
- (void)_addEventModelFromDictionary:(uint64_t)a3 endEvent:(void *)a4 transaction:(void *)a5 message:(void *)a6 error:
{
  ...
  id v13 = a5;
  id v96 = 0;
  id v14 = [a1 createEventModel:v11 endEvent:a3 message:v13 checkForSupport:1 transaction:v12 error:&v96];
  id v95 = v96;
  if (v14)
  {
    id v93 = v13;
    ...
    if (isKindOfClass)
    {
      ...
      if (v18)
      {
        ...
        if (objc_opt_isKindOfClass())
        {
          BOOL v19 = [MEMORY[0x263F08A00] defaultCenter];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v99 = 2112;
          id v100 = v15;
          _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
        }
      }
    }
    else
      ...
      else
      {
        ...
        if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v99 = 2112;
          id v100 = v29;
          _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
        }
      }
    }
    else
    ...
    if (v39)
    {
      ...
      {
        int v43 = (void *)MEMORY[0x230FBD990]();
        id v44 = a1;
        ...
        if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v99 = 2112;
          id v100 = v38;
          _os_log_impl(&dword_22F52A000, v45, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
        }
      }
    }
    else
    ...
    if (v48)
    {
      ...
      if (v50)
      {
        ...
        if (objc_opt_isKindOfClass())
        {
          id v51 = [MEMORY[0x263F08A00] defaultCenter];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v54, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v99 = 2112;
          id v100 = v47;
          _os_log_impl(&dword_22F52A000, v54, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
        }
      }
    }
    else
    ...
    if (v57)
    {
      ...
      if (v59)
      {
        ...
        if (objc_opt_isKindOfClass())
        {
          id v60 = [MEMORY[0x263F08A00] defaultCenter];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v63, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v99 = 2112;
          id v100 = v56;
          _os_log_impl(&dword_22F52A000, v63, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
        }
      }
    }
    else
    ...
    if (v66)
    {
      ...
      if (v68)
      {
        ...
        if (objc_opt_isKindOfClass())
        {
          long long v69 = [MEMORY[0x263F08A00] defaultCenter];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v72, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v99 = 2112;
          id v100 = v65;
          _os_log_impl(&dword_22F52A000, v72, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
        }
      }
    }
    else
    ...
    if (v75)
    {
      ...
      if (v77)
      {
        ...
        if (objc_opt_isKindOfClass())
        {
          v78 = [MEMORY[0x263F08A00] defaultCenter];
      ...
      else
      {
        ...
        if (os_log_type_enabled(v81, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v99 = 2112;
          id v100 = v74;
          _os_log_impl(&dword_22F52A000, v81, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
        }
      }
    }
    else
    ...
    if (v84)
    {
      long long v85 = [a1 home];
      long long v86 = [[HMDMatterAttributeEvent alloc] initWithModel:v83 home:v85];
      ...
      if (v86)
      {
        ...
        if (objc_opt_isKindOfClass())
        {
          long long v87 = [MEMORY[0x263F08A00] defaultCenter];
          [v87 postNotificationName:@"HMDEventTriggerCharacteristicBasedEventAddedNotification" object:v85 userInfo:0];
        }
      }
      else
      {
        ...
        if (os_log_type_enabled(v90, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v99 = 2112;
          id v100 = v83;
          _os_log_impl(&dword_22F52A000, v90, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
        }
        id v24 = v95;
      }
    }
    ...
    {
      long long v86 = (HMDMatterAttributeEvent *)v77;
      id v24 = v95;
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v99 = 2112;
      id v100 = v11;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Cannot create event model for event info %@", buf, 0x16u);
    }
    id v24 = v95;
    if (a6)
    {
      ...
      {
        id v92 = [MEMORY[0x263F087E8] hmErrorWithCode:20];
        *a6 = v92;
      }
    }
  }
      ...
      while (1)
      {
        ...
        if (![(HMDEventTrigger *)self _checkAddEventModel:v15 message:v69])
        {
          ...
          if (os_log_type_enabled(v55, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v67;
            __int16 v99 = v56;
            _os_log_impl(&dword_22F52A000, v55, OS_LOG_TYPE_INFO, "%{public}@Cannot update events - Incompatible home hub", buf, 0xCu);
          }
LABEL_42:
        ...
        if ([v75 isSharedAdmin])
        {
          ...
          if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v67;
            __int16 v99 = v19;
            _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@shared admin is sending the request to resident.", buf, 0xCu);
          }
          id v20 = objc_alloc(MEMORY[0x263F42570]);
          id v21 = [(HMDTrigger *)v17 uuid];
          id v22 = (void *)[v20 initWithTarget:v21];

          uint64_t v23 = (void *)MEMORY[0x263F42568];
          id v95 = @"kEventTriggerEventsKey";
          uint64_t v96 = v14;
          id v24 = [NSDictionary dictionaryWithObjects:&v96 forKeys:&v95 count:1];
      ...
      if (v51)
      {
        if (!v73)
        {
          id v73 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
        }
...
LABEL_17:
          ...
          if (v7 == [v29 isEndEvent])
          {
            ...
            if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v100 = 2112;
              id v101 = v29;
              _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_INFO, "%{public}@Deleting event %@", buf, 0x16u);
            }
            ...
            if ([v75 isSharedAdmin])
            {
              ...
              if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
              {
                ...
                *(_DWORD *)buf = 138543362;
                __int16 v99 = v41;
                _os_log_impl(&dword_22F52A000, v40, OS_LOG_TYPE_ERROR, "%{public}@Admin user : Remove event from trigger", buf, 0xCu);
              }
              id v42 = objc_alloc(MEMORY[0x263F42570]);
              int v43 = [(HMDTrigger *)v39 uuid];
              id v44 = (void *)[v42 initWithTarget:v43];

              v45 = (void *)MEMORY[0x263F42568];
              id v92 = @"kEventUUIDKey";
              id v46 = [v29 uuid];
              id v47 = [v46 UUIDString];
              id v93 = v47;
              char v48 = [NSDictionary dictionaryWithObjects:&v93 forKeys:&v92 count:1];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v60, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        __int16 v99 = v61;
        _os_log_impl(&dword_22F52A000, v60, OS_LOG_TYPE_ERROR, "%{public}@No events updated, calling the completion handler rightaway", buf, 0xCu);
      }
      v50[2](v50, 0);
    }
...
LABEL_47:
  ...
  {
    id obj = [MEMORY[0x263F087E8] hmErrorWithCode:85];
    uint64_t v63 = (void *)MEMORY[0x230FBD990]([v69 respondWithError:obj]);
    uint64_t v64 = self;
    ...
    if (os_log_type_enabled(v65, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v100 = 2112;
      id v101 = obj;
      _os_log_impl(&dword_22F52A000, v65, OS_LOG_TYPE_INFO, "%{public}@Client does not have authorization for location, cannot remove event. [%@]", buf, 0x16u);
    }
    char v57 = 0;
  }
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v20 = 2112;
      id v21 = v3;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Could not finish the request as self is no longer valid. Replying back to client with error:[%@]", buf, 0x16u);
    }
  ...
  if (*(void *)(a1 + 32))
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v30 = 2112;
      id v31 = v6;
      _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_ERROR, "%{public}@Error occurred while updating events on event trigger. [%@]", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v32 = 2112;
      uint64_t v33 = v7;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@All the events updated. Updating clients. %@ : %@]", buf, 0x20u);
    }
      ...
      if ([(HMDEventTrigger *)self checkSharedEventTriggerActivationResidentRequirement:0])
      {
        ...
        if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v39 = 2112;
          char v40 = v12;
          _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@The resident supports shared-trigger-activation, relaying the update events message as is : %@", buf, 0x16u);
        }
            ...
            for (uint64_t i = 0; i != v16; ++i)
            {
              ...
              if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                __int16 v39 = 2112;
                char v40 = v20;
                _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@The resident does not support shared-trigger-activation, relaying the message %@", buf, 0x16u);
...
- (BOOL)checkSharedEventTriggerActivationResidentRequirement:(id)a3
{
  ...
  if ([v6 count])
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v32 = v23;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Did not find any compatible resident device", buf, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v32 = v17;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Did not find any resident device", buf, 0xCu);
    }
    id v13 = [v4 responseHandler];
...
- (BOOL)addEventsFromMessage:(id)a3 preserveUUIDs:(BOOL)a4 transaction:(id)a5 error:(id *)a6
{
  ...
  if (v13)
  {
    if (!-[HMDEventTrigger addEventsFromInfo:preserveUUIDs:endEvent:transaction:message:error:](self, v12, a4, MEMORY[0x263EFFA80], v11, v10, a6))
    {
      BOOL v18 = 0;
      goto LABEL_7;
    }
    uint64_t v14 = (void *)MEMORY[0x263EFFA88];
    uint64_t v15 = self;
    uint64_t v16 = v13;
    char v17 = a4;
  }
...
- (void)_handleRemoveEventModel:(id)a3 message:(id)a4
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v27 = 2112;
    id v28 = v10;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Removing event %@", buf, 0x16u);
  }
  if (v10)
  {
    id v15 = v10;
...
- (void)_removeEventsFromEventTrigger:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      int v31 = 138543362;
      long long v32 = v27;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_INFO, "%{public}@Client does have authorization for location, cannot remove event", (uint8_t *)&v31, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v35 = 2112;
      id v36 = v21;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Couldn't find event with UUID %@ in trigger %@", (uint8_t *)&v31, 0x20u);
    }
    uint64_t v22 = (void *)MEMORY[0x263F087E8];
    uint64_t v23 = 2;
  }
...
- (void)_handleRemoveEventsFromEventTrigger:(id)a3 relay:(BOOL)a4
{
  ...
  {
    id v6 = v5;
    [(HMDEventTrigger *)self _removeEventsFromEventTrigger:v5];
    uint64_t v5 = v6;
  }
}
...
- (void)_handleAddEventModel:(id)a3 message:(id)a4
{
  ...
  id v6 = a3;
  id v7 = a4;
  uint64_t v8 = (HMDMatterAttributeEvent *)v6;
  objc_opt_class();
  char isKindOfClass = objc_opt_isKindOfClass();
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v93 = 2112;
        id v94 = v8;
        _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
      }
    }
  }
  id v17 = v8;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v93 = 2112;
        id v94 = v17;
        _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
      }
    }
  }
  else
  ...
  if (v8 && (v27 & 1) != 0)
  {
    ...
    if (v29)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        __int16 v30 = [MEMORY[0x263F08A00] defaultCenter];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v93 = 2112;
        id v94 = v26;
        _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
      }
    }
  }
  else
    ...
    else
    {
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v93 = 2112;
        id v94 = v35;
        _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
      }
    }
  }
  else
  ...
  if (v8 && (v45 & 1) != 0)
  {
    ...
    if (v47)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        char v48 = [MEMORY[0x263F08A00] defaultCenter];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v93 = 2112;
        id v94 = v44;
        _os_log_impl(&dword_22F52A000, v51, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
      }
    }
  }
  else
  ...
  if (v8 && (v54 & 1) != 0)
  {
    ...
    if (v56)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        char v57 = [MEMORY[0x263F08A00] defaultCenter];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v60, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v93 = 2112;
        id v94 = v53;
        _os_log_impl(&dword_22F52A000, v60, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
      }
    }
  }
  else
  ...
  if (v8 && (v63 & 1) != 0)
  {
    ...
    if (v65)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        char v66 = [MEMORY[0x263F08A00] defaultCenter];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v69, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v93 = 2112;
        id v94 = v62;
        _os_log_impl(&dword_22F52A000, v69, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
      }
    }
  }
  else
  ...
  if (v8 && (v72 & 1) != 0)
  {
    id v73 = [(HMDTrigger *)self home];
    id v74 = [[HMDMatterAttributeEvent alloc] initWithModel:v71 home:v73];
    ...
    if (v74)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        char v75 = [MEMORY[0x263F08A00] defaultCenter];
        [v75 postNotificationName:@"HMDEventTriggerCharacteristicBasedEventAddedNotification" object:v73 userInfo:0];
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v79, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v93 = 2112;
        id v94 = v71;
        _os_log_impl(&dword_22F52A000, v79, OS_LOG_TYPE_INFO, "%{public}@Failed to create event object with event model %@", buf, 0x16u);
      }
    }
...
LABEL_76:
  ...
  id v74 = (HMDMatterAttributeEvent *)v65;
  if (!v65) {
    goto LABEL_76;
  }
LABEL_81:
  char v81 = (void *)MEMORY[0x230FBD990]();
  id v82 = self;
  long long v83 = HMFGetOSLogHandle();
  if (os_log_type_enabled(v83, OS_LOG_TYPE_DEBUG))
  {
    long long v84 = HMFGetLogIdentifier();
    long long v85 = [(HMDEventTrigger *)v82 events];
    *(_DWORD *)buf = 138543874;
    id v92 = v84;
    __int16 v93 = 2112;
    id v94 = v74;
    __int16 v95 = 2112;
    uint64_t v96 = v85;
    _os_log_impl(&dword_22F52A000, v83, OS_LOG_TYPE_DEBUG, "%{public}@Added new event %@ to %@", buf, 0x20u);
  }
  long long v86 = [(HMDTrigger *)v82 msgDispatcher];
  id v87 = [(HMDTrigger *)v82 workQueue];
  [(HMDEvent *)v74 configure:v82 messageDispatcher:v86 queue:v87 delegate:v82];

  [(HMDEventTrigger *)v82 _activateWithCompletion:0];
  long long v88 = [(HMDMatterAttributeEvent *)v74 createPayload];
  long long v90 = v88;
  id v76 = [NSDictionary dictionaryWithObjects:&v90 forKeys:&v89 count:1];

  [(HMDTrigger *)v82 markChangedForMessage:v7];
LABEL_84:
  [v7 respondWithPayload:v76];
}
...
- (id)eventModelWithDictionary:(id)a3 transaction:(id)a4 home:(id)a5 message:(id)a6 error:(id *)a7
{
  ...
  id v14 = a5;
  id v15 = a6;
  id v16 = objc_msgSend(v12, "hmf_numberForKey:", *MEMORY[0x263F0C6F8]);
  uint64_t v83 = objc_msgSend(v12, "hmf_numberForKey:", *MEMORY[0x263F0C5F8]);
  uint64_t v82 = objc_msgSend(v12, "hmf_numberForKey:", *MEMORY[0x263F0BA78]);
  uint64_t v17 = objc_msgSend(v12, "hmf_UUIDForKey:", @"kAccessoryUUID");
  char v18 = [v14 accessoryWithUUID:v17];
  id v80 = v15;
  char v81 = v14;
  id v79 = (void *)v17;
  if (v18)
  {
    ...
    if (isKindOfClass & 1) != 0 || (v23)
    {
      ...
      uint64_t v41 = [v40 matterAdapter];
      long long v32 = (void *)v82;
      int v31 = (void *)v83;
      uint64_t v42 = [MEMORY[0x263F10C50] attributePathWithEndpointID:v78 clusterID:v83 attributeID:v82];
      char v72 = v41;
      int v43 = [v41 mtrAttributePaths];
      id v74 = (void *)v42;
      char v44 = [v43 containsObject:v42];

      if (v44)
      {
        uint64_t v70 = self;
        char v45 = +[HMDMatterPath PathWithAttributeID:v82 endpointID:v78 clusterID:v83];
        uint64_t v46 = [v45 setAccessory:v22];
        uint64_t v71 = v45;
        if (v45)
        {
          id v47 = [(HMDTrigger *)v70 uuid];
          __int16 v30 = +[HMDMatterAttributeEventModel eventModelWithDictionary:v12 home:v81 eventTriggerUUID:v47 message:v80 error:a7];

          if (v30)
          {
            char v48 = [v72 attributePaths];
            char v49 = [v48 containsObject:v71];

            if (v49)
            {
              id v50 = [v72 attributePaths];
              v84[0] = MEMORY[0x263EF8330];
              v84[1] = 3221225472;
              v84[2] = __75__HMDEventTrigger_eventModelWithDictionary_transaction_home_message_error___block_invoke;
              v84[3] = &unk_264A19B30;
              id v85 = v71;
              id v86 = v30;
              objc_msgSend(v50, "hmf_enumerateWithAutoreleasePoolUsingBlock:", v84);
            }
            else
            {
              uint64_t v64 = [v71 uuid];
              id v65 = [v22 uuid];
              char v66 = [v71 modelObjectWithChangeType:1 uuid:v64 parentUUID:v65];

              [v71 populateModelObject:v66];
              [v73 add:v66];
              long long v67 = [v71 uuid];
              [v30 setMatterPathUUID:v67];
            }
            id v55 = v72;
            id v16 = v78;
            long long v32 = (void *)v82;
          ...
          else
          {
            ...
            if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              _os_log_impl(&dword_22F52A000, v62, OS_LOG_TYPE_ERROR, "%{public}@Unable to create event model from dictionary: %@", buf, 0x16u);
            }
            id v16 = v78;
            long long v32 = (void *)v82;
            int v31 = (void *)v83;
        ...
        {
          id v16 = v78;
          id v56 = (void *)MEMORY[0x230FBD990](v46);
          char v57 = v70;
          ...
          if (os_log_type_enabled(v58, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138544130;
            ...
            __int16 v93 = 2112;
            uint64_t v94 = v83;
            _os_log_impl(&dword_22F52A000, v58, OS_LOG_TYPE_ERROR, "%{public}@Unable to create matter path from attributeID/endpointID/clusterID %@/%@/%@", buf, 0x2Au);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v53, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v91 = 2112;
          id v92 = v22;
          _os_log_impl(&dword_22F52A000, v53, OS_LOG_TYPE_ERROR, "%{public}@Failed to find attribute path %@ on accessory %@", buf, 0x20u);
        }
        __int16 v30 = 0;
        id v16 = v78;
        long long v32 = (void *)v82;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v89 = 2112;
        uint64_t v90 = v17;
        _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@Failed to find accessory with identifier: %@", buf, 0x16u);
      }
      __int16 v30 = 0;
      id v13 = v19;
      id v16 = v78;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v89 = 2112;
      uint64_t v90 = v17;
      _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_ERROR, "%{public}@Failed to find accessory with UUID %@", buf, 0x16u);
...
- (id)createEventModel:(id)a3 endEvent:(BOOL)a4 message:(id)a5 checkForSupport:(BOOL)a6 transaction:(id)a7 error:(id *)a8
{
  ...
  id v15 = a5;
  id v16 = a7;
  uint64_t v17 = objc_msgSend(v14, "hmf_stringForKey:", @"kEventTriggerTypeKey");
...
LABEL_15:
      ...
      uint64_t v21 = [(__objc2_class *)v19 eventModelWithDictionary:v14 home:v18 eventTriggerUUID:v20 message:v15];
      goto LABEL_16;
    }
LABEL_27:
    char v23 = 0;
...
LABEL_16:
  ...
  if (![v17 isEqualToString:@"kEventTriggerTypeLocationEventKey"])
  {
    ...
    {
      id v20 = [(HMDTrigger *)self uuid];
      uint64_t v21 = +[HMDCharacteristicThresholdRangeEventModel eventModelWithDictionary:v14 home:v18 eventTriggerUUID:v20 message:v15 checkForSupport:v10];
      goto LABEL_16;
    }
    if ([v17 isEqualToString:*MEMORY[0x263F0E9D0]])
    {
      char v23 = [(HMDEventTrigger *)self eventModelWithDictionary:v14 transaction:v16 home:v18 message:v15 error:a8];
      goto LABEL_28;
    }
  ...
  if (v15 && ([v15 isAuthorizedForLocationAccess] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
    {
      ...
      int v32 = 138543362;
      __int16 v33 = v30;
      _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_INFO, "%{public}@Client does have authorization for location, cannot add event", (uint8_t *)&v32, 0xCu);
    }
    if (a8)
    {
      [MEMORY[0x263F087E8] hmErrorWithCode:85];
      char v23 = 0;
  ...
  id v22 = [(HMDTrigger *)self uuid];
  char v23 = +[HMDLocationEventModel eventModelWithDictionary:v14 home:v18 eventTriggerUUID:v22 message:v15];

  long long v24 = [(HMDTrigger *)self owner];

  if (v24)
  {
    id v25 = [(HMDTrigger *)self owner];
    id v26 = [v25 uuid];
    [v23 setUserUUID:v26];
  }
LABEL_28:
  ...
  if (v11)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        uint64_t v21 = v18;
        _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Cannot add event - Incompatible home hub", buf, 0xCu);
      }
    }
  }
  else
...
- (void)_handleAddEventToEventTrigger:(id)a3
{
  id v4 = [(HMDTrigger *)self updateEventTriggerMessage:1 message:a3 relay:1];
  if (v4)
  {
    uint64_t v5 = v4;
...
- (void)_handleLocationAuthorizationChangedNotification:(id)a3
{
  ...
  id v6 = objc_msgSend(v5, "hmf_numberForKey:", @"HMDLocationAuthorizationKey");
      ...
      do
      {
        for (uint64_t i = 0; i != v33; ++i)
        {
          ...
          if (v20)
          {
            ...
            char v23 = [v22 instanceID];

            if (!v23)
            {
              char v23 = [v14 characteristicInstanceID];
            }
            ...
            {
              __int16 v39 = v14;
              id v25 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v39 count:1];
              id v26 = v9;
              id v27 = v7;
...
- (id)_modelWithRewrittenCondition:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating evaluation condition for trigger %@", (uint8_t *)&v17, 0x16u);
  }
  ...
  if (v13)
  {
    id v14 = [MEMORY[0x263F08910] archivedDataWithRootObject:v13 requiringSecureCoding:1 error:0];
...
- (void)handleRemovalOfUser:(id)a3 transaction:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v26 = 2112;
    id v27 = v6;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Preparing to remove references to user %@ from trigger", buf, 0x16u);
  }
  uint64_t v12 = [(HMDEventTrigger *)v9 predicateUtilities];
  id v13 = [(HMDEventTrigger *)v9 evaluationCondition];
  int v14 = [v12 containsPresenceEvents:v13];

  if (v14)
  {
    char v23 = 0;
    id v15 = [(HMDEventTrigger *)v9 predicateUtilities];
    int v16 = [(HMDEventTrigger *)v9 evaluationCondition];
    int v17 = [v15 updatePredicate:v16 removedUser:v6 conditionModified:&v23];
    ...
    if (v23)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v26 = 2112;
        id v27 = v6;
        _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Condition has been modified following removal of user %@", buf, 0x16u);
      }
      uint64_t v22 = [(HMDEventTrigger *)v19 _modelWithRewrittenCondition:v17];
      if (v22) {
        [v7 add:v22 withMessage:0];
      }
    }
  }
}
        ...
        if (objc_opt_isKindOfClass())
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v28 = 2112;
            uint64_t v29 = v11;
            _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Client does have authorization for location, cannot remove event %@", buf, 0x16u);
          }
        }
        else
        {
          ...
          __int16 v19 = [(HMDBackingStoreModelObject *)v16 initWithObjectChangeType:3 uuid:v17 parentUUID:v18];
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        long long v25 = v9;
        BOOL v10 = [NSDictionary dictionaryWithObjects:&v25 forKeys:&v24 count:1];

        id v11 = (void *)MEMORY[0x263F42568];
        id v12 = objc_alloc(MEMORY[0x263F42570]);
        id v13 = [(HMDTrigger *)self uuid];
        int v14 = (void *)[v12 initWithTarget:v13];
        id v15 = [v11 messageWithName:@"kRemoveEventFromEventTriggerRequestKey" destination:v14 payload:v10];
  ...
  if (WeakRetained)
  {
    ...
    if (!v10)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
      {
        ...
        int v16 = 138543362;
        int v17 = v14;
        _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@There are no triggering events anymore, removing the trigger", (uint8_t *)&v16, 0xCu);
      }
      id v15 = [v12 home];
...
- (void)_handleRemovalOfCharacteristic:(id)a3 withEvents:(id)a4 transaction:(id)a5
{
  ...
  if (!v9)
  {
    ...
    id v13 = [(HMDEventTrigger *)self characteristicBaseEvents];
    ...
    long long v54 = 0u;
    char v44 = self;
    int v14 = [(HMDEventTrigger *)self characteristicBaseEvents];
  ...
  long long v36 = [v33 updatePredicate:v34 currentCharacteristicInPredicate:&v51 conditionModified:&v52 removedCharacteristic:v8 underService:v35 underAccessory:v11];
  id v37 = v51;

  if (v52)
  {
    objc_super v38 = (void *)MEMORY[0x230FBD990]();
    __int16 v39 = self;
    char v40 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v59 = 2112;
      id v60 = v8;
      _os_log_impl(&dword_22F52A000, v40, OS_LOG_TYPE_INFO, "%{public}@Condition has been modified following removal of characteristic %@", buf, 0x16u);
    }
    uint64_t v42 = [(HMDEventTrigger *)v39 _modelWithRewrittenCondition:v36];
    if (v42) {
...
- (void)auditForStaleEventsWithAccessory:(id)a3 transaction:(id)a4
{
  ...
  {
    char v48 = 0;
    id v12 = [(HMDEventTrigger *)self predicateUtilities];
    id v13 = [(HMDEventTrigger *)self evaluationCondition];
    uint64_t v41 = [v12 predicateWithoutStaleCharacteristicsFromPredicate:v13 accessory:v11 conditionModified:&v48];
    ...
    if (v48)
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        uint64_t v18 = [(HMDEventTrigger *)v15 evaluationCondition];
        uint64_t v19 = [v9 shortDescription];
        *(_DWORD *)buf = 138544130;
        id v51 = v17;
        __int16 v52 = 2112;
        long long v53 = v18;
        ...
        __int16 v56 = 2112;
        char v57 = v19;
        _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Updating condition from %@ to %@ after removing stale characteristic sub-predicates for accessory %@", buf, 0x2Au);
      }
      long long v20 = [(HMDEventTrigger *)v15 _modelWithRewrittenCondition:v41];
      if (v20) {
        [v7 add:v20 withMessage:0];
      }
    }
    id v39 = v9;
    id v40 = v7;
    ...
    if (v22)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v23; ++i)
        {
          ...
          __int16 v26 = *(void **)(*((void *)&v44 + 1) + 8 * i);
          uint64_t v27 = [v26 accessoryUUID];
          __int16 v28 = [v11 uuid];
          int v29 = [v27 isEqual:v28];

          if (v29)
          {
            uint64_t v30 = [v26 characteristicInstanceID];
            uint64_t v31 = [v26 serviceID];
            uint64_t v32 = [v11 findCharacteristic:v30 forService:v31];
            ...
            if (!v32)
            {
              ...
              if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                __int16 v52 = 2112;
                long long v53 = v26;
                _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_INFO, "%{public}@Audit: Characteristic associated with event %@ no longer exists", buf, 0x16u);
    ...
    id v7 = v40;
    [(HMDEventTrigger *)self _handleRemovalOfEvents:v21 transaction:v40];
...
- (void)sendTriggerFiredNotification:(id)a3
{
  ...
  if (v6) {
    [MEMORY[0x263F42568] locationAuthorizedMessageWithName:@"kTriggerFiredNotificationKey" messagePayload:v4];
  }
  else {
  id v9 = [MEMORY[0x263F42568] messageWithName:@"kTriggerFiredNotificationKey" messagePayload:v4];
  }
...
- (void)_registerForMessages
{
  ...
  uint64_t v32 = [(HMDTrigger *)self home];
  uint64_t v31 = +[HMDRemoteMessagePolicy defaultSecurePolicy];
  objc_msgSend(v31, "setRoles:", objc_msgSend(v31, "roles") | 4);
  objc_super v4 = (void *)[v31 copy];
  id v5 = +[HMDUserMessagePolicy userMessagePolicyWithHome:v32 userPrivilege:4 remoteAccessRequired:0];
  uint64_t v6 = [v32 administratorHandler];
  ...
  v41[3] = v8;
  id v9 = [MEMORY[0x263EFF8C0] arrayWithObjects:v41 count:4];
  ...
  v40[3] = v11;
  uint64_t v12 = [MEMORY[0x263EFF8C0] arrayWithObjects:v40 count:4];
  ...
  v39[3] = v14;
  uint64_t v15 = [MEMORY[0x263EFF8C0] arrayWithObjects:v39 count:4];
  ...
  v38[3] = v17;
  long long v18 = [MEMORY[0x263EFF8C0] arrayWithObjects:v38 count:4];
  ...
  v37[3] = v20;
  objc_super v21 = [MEMORY[0x263EFF8C0] arrayWithObjects:v37 count:4];
  ...
  uint64_t v22 = +[HMDXPCMessagePolicy policyWithEntitlements:1];
  v36[0] = v22;
  v36[1] = v4;
  v36[2] = v5;
  uint64_t v23 = +[HMDConfigurationMessagePolicy policyWithOperationTypes:6];
  v36[3] = v23;
  uint64_t v24 = [MEMORY[0x263EFF8C0] arrayWithObjects:v36 count:4];
  ...
  __int16 v26 = +[HMDRemoteMessagePolicy defaultSecurePolicy];
  v35[0] = v26;
  v35[1] = v5;
  uint64_t v27 = [MEMORY[0x263EFF8C0] arrayWithObjects:v35 count:2];
  ...
  v34[1] = v29;
  uint64_t v30 = [MEMORY[0x263EFF8C0] arrayWithObjects:v34 count:2];
  [v6 registerForMessage:@"HMUpdateEventTriggerFromBuilderMessage" receiver:self policies:v30 selector:sel__handleUpdateEventTrigger_];
}
...
- (void)_migrateEventsToRecords
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v35 = 2112;
    long long v36 = v7;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Events migration %@", buf, 0x16u);
  }
  if (![(HMDEventTrigger *)v4 migratedEventsToRecords])
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v34 = v11;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@The events haven't been migrated, generating transactions for each event present", buf, 0xCu);
    }
    ...
    if (v15)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          long long v19 = [MEMORY[0x263F42568] messageWithName:@"kMigratedEventsToRecordsRequest" messagePayload:0];
          [(HMDTrigger *)v9 home];
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v6 == v4)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      int v11 = 138543362;
      uint64_t v12 = v10;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Debounce Timer expired: Going to activate the trigger", (uint8_t *)&v11, 0xCu);
    }
...
- (void)_configureDebounceTriggerActivationTimer
{
  ...
  if (!dependencyFactory)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v17 = 2112;
      objc_super v18 = v10;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@Missing dependency factory, reinitializing %@", (uint8_t *)&v15, 0x16u);
    }
    dependencyFactory = self->_dependencyFactory;
  }
        ...
        if (objc_msgSend(v10, "isActive", v17))
        {
          ...
          if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = v17;
            ...
            __int16 v24 = 2112;
            long long v25 = v10;
            _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Registering for relaunch on behalf of event: %@", buf, 0x16u);
          }
          char v7 = 1;
        }
      }
...
- (void)_activateWithCompletion:(id)a3
{
  ...
  if ([(HMDTrigger *)self isConfigured])
  {
    ...
    else
    {
      ...
      {
        uint64_t v10 = (void *)MEMORY[0x230FBD990]([(HMDEventTrigger *)self _configureDebounceTriggerActivationTimer]);
        int v11 = self;
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
        {
          ...
          __int16 v20 = 2112;
          long long v21 = v14;
          _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Reinitialized debounce timer from %@ to %@", (uint8_t *)&v16, 0x20u);
        }
      }
  ...
  else
  {
    ...
    if (v5)
    {
      uint64_t v6 = [MEMORY[0x263F087E8] hmPrivateErrorWithCode:2012];
      v5[2](v5, v6);
    }
  }
}
...
- (void)_activateEvents:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v61 = 2114;
    uint64_t v62 = v8;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Attempting to activate with activation type %{public}@, state %{public}@", buf, 0x20u);
  }
    ...
    if ((v15 & 1) == 0)
    {
      ...
      if (v19)
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543362;
          uint64_t v58 = v23;
          _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Home location is not known, cannot activate the trigger", buf, 0xCu);
        }
        __int16 v24 = [MEMORY[0x263F087E8] hmErrorWithCode:84];
        [v38 addObject:v24];
        goto LABEL_11;
      }
    }
...
void __35__HMDEventTrigger__activateEvents___block_invoke_5(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    uint64_t v15 = v7;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Completed activation with errors: %@", (uint8_t *)&v12, 0x16u);
  }
  if ([*(id *)(a1 + 32) count])
  {
...
- (void)_computeActivation
{
  ...
  uint64_t v7 = [(HMDEventTrigger *)self calendarEvents];
  uint64_t v76 = [v7 count];

  id v8 = [(HMDEventTrigger *)self significantTimeEvents];
  uint64_t v75 = [v8 count];

  id v9 = [(HMDEventTrigger *)self presenceEvents];
  uint64_t v74 = [v9 count];

  uint64_t v10 = [(HMDEventTrigger *)self charThresholdEvents];
  uint64_t v73 = [v10 count];

  uint64_t v11 = [(HMDEventTrigger *)self endEvents];
  uint64_t v72 = [v11 count];

  int v12 = [(HMDEventTrigger *)self attributeEvents];
  uint64_t v70 = [v12 count];

  uint64_t v13 = [(HMDTrigger *)self home];
  v78 = [v13 primaryResident];
  id v79 = [v78 device];
  int v14 = [v13 isCurrentDeviceConfirmedPrimaryResident];
  BOOL v15 = [(HMDEventTrigger *)self isThisDeviceDesignatedFMFDevice];
  BOOL v16 = [(HMDEventTrigger *)self isOwnerOfHome];
  int v71 = v14;
  if (v6) {
    BOOL v17 = 0;
  }
  ...
  if (v6 && v15)
  {
    BOOL v16 = [(HMDEventTrigger *)self doesTheLocationEventTargetCurrentUser];
    BOOL v77 = v16;
  }
  __int16 v18 = (void *)MEMORY[0x230FBD990](v16);
  BOOL v19 = self;
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138544898;
    ...
    _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Resident %@, this-device-is-resident: %@, this-device-owns-trigger: %@, owning-device: %@, FMF device: %@, Owner of home: %@", buf, 0x48u);
  ...
  if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138545154;
    ...
    __int16 v96 = 2048;
    uint64_t v97 = v72;
    _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_INFO, "%{public}@char: %tu, location: %tu, calendar: %tu, significant: %tu, presence: %tu, char-threshold: %tu, end: %tu", buf, 0x52u);
  }
  ...
  if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138545410;
    ...
    __int16 v98 = 2048;
    uint64_t v99 = v72;
    _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_INFO, "%{public}@char: %tu, location: %tu, calendar: %tu, significant: %tu, presence: %tu, char-threshold: %tu, attribute: %tu, end: %tu", buf, 0x5Cu);
  }
  BOOL v37 = [(HMDTrigger *)v33 hasNoActions];
  if ([(HMDTrigger *)v33 active] && !v37)
  {
    if (v6 && ![(HMDEventTrigger *)v33 isAuthorizedForLocation])
    {
      unint64_t v38 = 0;
      uint64_t v39 = 3;
      goto LABEL_47;
    }
    if (([v78 supportsSharedEventTriggerActivation] & 1) == 0
      && [(HMDEventTrigger *)v33 requiresDataVersion4])
    {
      unint64_t v38 = 0;
      if (v79) {
        uint64_t v39 = 2;
    ...
    if ([v78 supportsSharedEventTriggerActivation])
    {
      if (v6)
      {
        if (v71)
    ...
    if ([(HMDEventTrigger *)v33 requiresDataVersion4])
    {
      unint64_t v38 = 0;
    }
    else
...
LABEL_46:
  ...
  if (v37)
  {
    ...
    if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v83 = v43;
      _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_INFO, "%{public}@The trigger is disabled as there are no actions associated with this trigger.", buf, 0xCu);
    }
  }
  uint64_t v39 = 0;
  unint64_t v38 = 0;
LABEL_47:
  ...
  if (os_log_type_enabled(v48, OS_LOG_TYPE_INFO))
  {
    ...
    long long v50 = HMEventTriggerActivationStateAsString();
    long long v51 = HMDEventTriggerActivationTypeAsString(v38);
    *(_DWORD *)buf = 138543874;
    uint64_t v83 = v49;
    __int16 v84 = 2112;
    ...
    _os_log_impl(&dword_22F52A000, v48, OS_LOG_TYPE_INFO, "%{public}@Computed activation flags state:%@ type: %@", buf, 0x20u);
  }
  if ([(HMDEventTrigger *)v47 activationType] != v38)
  {
    ...
    if (os_log_type_enabled(v54, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v56 = HMDEventTriggerActivationTypeAsString([(HMDEventTrigger *)v53 activationType]);
      char v57 = HMDEventTriggerActivationTypeAsString(v38);
      *(_DWORD *)buf = 138543874;
      uint64_t v83 = v55;
      __int16 v84 = 2112;
      ...
      _os_log_impl(&dword_22F52A000, v54, OS_LOG_TYPE_INFO, "%{public}@Updating activation type from %@ to %@", buf, 0x20u);

      id v35 = v78;
    }

    [(HMDEventTrigger *)v53 setActivationType:v38];
  }
  if ([(HMDEventTrigger *)v47 activationState] != v39)
  {
    ...
    if (os_log_type_enabled(v60, OS_LOG_TYPE_INFO))
    {
      ...
      [(HMDEventTrigger *)v59 activationState];
      uint64_t v62 = HMEventTriggerActivationStateAsString();
      uint64_t v63 = HMEventTriggerActivationStateAsString();
      *(_DWORD *)buf = 138543874;
      uint64_t v83 = v61;
      __int16 v84 = 2112;
      ...
      _os_log_impl(&dword_22F52A000, v60, OS_LOG_TYPE_INFO, "%{public}@Updating activation state from %@ to %@", buf, 0x20u);
    }
    [(HMDEventTrigger *)v59 setActivationState:v39];
    id v80 = @"kEventTriggerActivationStateKey";
    uint64_t v64 = [NSNumber numberWithUnsignedInteger:v39];
    char v81 = v64;
    id v65 = [NSDictionary dictionaryWithObjects:&v81 forKeys:&v80 count:1];

    char v66 = [MEMORY[0x263F42568] messageWithName:@"kEventTriggerActivationStateNotificationKey" identifier:0 messagePayload:v65];
    long long v67 = [(HMDTrigger *)v59 msgDispatcher];
    id v68 = [(HMDTrigger *)v59 uuid];
    [v67 sendMessage:v66 target:v68];
  }
}
...
- (BOOL)doesTheLocationEventTargetCurrentUser
{
  ...
  char v3 = objc_msgSend(v2, "na_allObjectsPassTest:", &__block_literal_global_59_45053);
...
- (BOOL)compatible:(id)a3 user:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v24 = 2112;
    id v25 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Checking if the username %@ is compatible", buf, 0x16u);
  }
  if ([(HMDEventTrigger *)v9 requiresDataVersion4]
    && [v6 containsObject:&unk_26E470FF0])
  {
    long long v19 = 0u;
    long long v20 = 0u;
    long long v17 = 0u;
...
- (BOOL)requiresDataVersion4
{
  ...
  {
    unint64_t v3 = (void *)MEMORY[0x230FBD990]();
    uint64_t v4 = self;
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v23 = v6;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Contains execute once/policy, requires data version 4", buf, 0xCu);
    }
    return 1;
  }
...
- (void)invalidate
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v9 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Deactivating the trigger", buf, 0xCu);
  }
...
- (NSArray)recurrences
{
  ...
  os_unfair_lock_lock_with_options();
  uint64_t v4 = (void *)[(NSArray *)self->_recurrences copy];
...
- (NSArray)presenceEvents
{
  ...
  long long v14 = 0u;
  long long v15 = 0u;
  uint64_t v4 = [(HMDEventTrigger *)self triggerEvents];
...
- (NSArray)charThresholdEvents
{
  ...
  long long v14 = 0u;
  long long v15 = 0u;
  uint64_t v4 = [(HMDEventTrigger *)self events];
  uint64_t v5 = [v4 countByEnumeratingWithState:&v12 objects:v16 count:16];
  if (v5)
  {
    uint64_t v6 = v5;
...
- (id)dumpState
{
  ...
  if ([v5 count])
  {
    ...
    [v4 setObject:v6 forKeyedSubscript:*MEMORY[0x263F41EE0]];
  }
  long long v13 = [(HMDEventTrigger *)self evaluationCondition];
  ...
  if (v13)
  {
    ...
    [v4 setObject:v15 forKeyedSubscript:*MEMORY[0x263F41F58]];
  }
  uint64_t v16 = [(HMDEventTrigger *)self recurrences];
  ...
  if (v16)
  {
    ...
    [v4 setObject:v18 forKeyedSubscript:*MEMORY[0x263F41F60]];
  }
  long long v19 = objc_msgSend(NSNumber, "numberWithBool:", -[HMDEventTrigger executeOnce](self, "executeOnce"));
  [v4 setObject:v19 forKeyedSubscript:*MEMORY[0x263F41EE8]];
  ...
  if (v20)
  {
    ...
    [v4 setObject:v22 forKeyedSubscript:*MEMORY[0x263F41EF0]];
  }
  return v4;
}
...
- (HMDEventTrigger)initWithModel:(id)a3 home:(id)a4 message:(id)a5 factory:(id)a6
{
  ...
  if (v13)
  {
    ...
    long long v27 = (void *)MEMORY[0x263F08928];
    objc_super v28 = (void *)MEMORY[0x263EFFA08];
    v44[0] = objc_opt_class();
    v44[1] = objc_opt_class();
    long long v29 = [MEMORY[0x263EFF8C0] arrayWithObjects:v44 count:2];
    uint64_t v30 = [v28 setWithArray:v29];
    uint64_t v31 = [v10 recurrences];
    uint64_t v32 = [v27 unarchivedObjectOfClasses:v30 fromData:v31 error:0];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_45071 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_45071, &__block_literal_global_45072);
  }
  v2 = (void *)logCategory__hmf_once_v2_45073;
  return v2;
}
...
void __30__HMDEventTrigger_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_45073;
  logCategory__hmf_once_v2_45073 = v0;
}
