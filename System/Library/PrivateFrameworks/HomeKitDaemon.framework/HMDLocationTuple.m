...
- (HMDLocationTuple)initWithLocation:(id)a3 reachableIPAccessoryCount:(unint64_t)a4 reachableBTLEAccessoryCount:(unint64_t)a5 reachableMediaAccessoryCount:(unint64_t)a6
{
  ...
  if (v11)
  {
    v12 = v11;
    v17.receiver = self;
    v17.super_class = (Class)HMDLocationTuple;
    id v13 = [(HMDLocationTuple *)&v17 init];
    v14 = v13;
    if (v13)
    {
  ...
  else
  {
    ...
    return (HMDLocationTuple *)-[NSManagedObject(HomeKitDaemon) mkf_findRelationOnProperty:modelProtocol:keyValue:](v16);
  }
}
