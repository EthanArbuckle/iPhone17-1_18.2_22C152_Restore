...
+ (id)migrationLogEventRecord
{
  ...
  if ([(id)objc_opt_class() doesLogEventExistOnDisk])
  {
    id v3 = (id)hh2MigrationLogEventPath;
    id v34 = 0;
    int64_t v4 = [MEMORY[0x263EFF8F8] dataWithContentsOfFile:v3 options:2 error:&v34];
    id v5 = v34;
    if (v4)
    {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v38 = 2112;
            id v39 = v13;
            _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@Unable to open the migration log event record from archive data: %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v38 = 2112;
          id v39 = v12;
          _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive migration log event record from archive data: %@", buf, 0x16u);
        }
        BOOL v18 = [NSDictionary dictionary];
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v38 = 2112;
        id v39 = v5;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Unable to read the migration log event record due to an error: [%@]", buf, 0x16u);
      }
      BOOL v18 = [NSDictionary dictionary];
    }
  }
...
+ (void)commitMigrationLogEventToDisk:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v22 = 2112;
    id v23 = v4;
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Going to write migration log event : [%@]", (uint8_t *)&v20, 0x16u);
  }
...
+ (void)incrementAutoMigrationAttempt
{
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v31 = 2114;
        v32 = v6;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Incrementing auto migration attempt to %{public}@ for build %{public}@", buf, 0x20u);
      }
      id v25 = v6;
      uint64_t v26 = v9;
      int v14 = [NSDictionary dictionaryWithObjects:&v26 forKeys:&v25 count:1];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v29 = 2114;
        v30 = v6;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Initializing first auto migration attempt for build %{public}@", buf, 0x16u);
      }
      id v23 = v6;
      __int16 v24 = &unk_26E4704F8;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v28 = v18;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_FAULT, "%{public}@Should not get here, skipping incrementing auto migration attempt due to missing build version", buf, 0xCu);
    }
  }
}
...
+ (void)_addInfoFromCoreDataError:(id)a3 logEvent:(id)a4
{
  id v18 = a3;
  id v5 = a4;
  id v6 = [v18 localizedDescription];
  ...
  {
    id v8 = [v18 userInfo];
    id v9 = [v8 objectForKeyedSubscript:*MEMORY[0x263EFF190]];
    ...
    uint32_t v15 = [v14 objectForKeyedSubscript:*MEMORY[0x263EFF188]];
...
+ (void)recordMigrationFailedWithError:(id)a3 withReason:(id)a4
{
  ...
  v27 = __Block_byref_object_copy__6063;
  id v28 = __Block_byref_object_dispose__6064;
  id v9 = v5;
  id v29 = v9;
  v10 = [v9 userInfo];
  ...
  if (v10)
  {
    ...
    id v12 = [v11 objectForKeyedSubscript:*MEMORY[0x263EFEFF0]];
  ...
  if (v15)
  {
    ...
    id v18 = objc_msgSend(v16, "initWithDomain:code:userInfo:", v17, objc_msgSend((id)v25[5], "code"), 0);
  }
  else
  {
    ...
    uint64_t v21 = *MEMORY[0x263F0C710];
    __int16 v22 = [v19 errorWithDomain:*MEMORY[0x263F0C710] code:v20 userInfo:0];
    [v17 setObject:v22 forKeyedSubscript:*MEMORY[0x263F08608]];
    id v18 = (void *)[objc_alloc(MEMORY[0x263F087E8]) initWithDomain:v21 code:2717 userInfo:v17];
  }
