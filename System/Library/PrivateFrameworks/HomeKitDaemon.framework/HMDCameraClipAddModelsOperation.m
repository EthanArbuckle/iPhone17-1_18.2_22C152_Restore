...
- (void)main
{
  ...
  id v4 = objc_alloc(MEMORY[0x263F49318]);
...
id __39__HMDCameraClipAddModelsOperation_main__block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    v11 = [MEMORY[0x263F087E8] hmfErrorWithCode:15];
...
void __39__HMDCameraClipAddModelsOperation_main__block_invoke_5(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v8 = 138543362;
    v9 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully added models", (uint8_t *)&v8, 0xCu);
  }
  [*(id *)(a1 + 32) finish];
}
...
void __39__HMDCameraClipAddModelsOperation_main__block_invoke_7(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v10 = 2112;
    id v11 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to add models: %@", (uint8_t *)&v8, 0x16u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_247334 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_247334, &__block_literal_global_247335);
  }
  v2 = (void *)logCategory__hmf_once_v4_247336;
  return v2;
}
...
void __46__HMDCameraClipAddModelsOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_247336;
  logCategory__hmf_once_v4_247336 = v0;
}
