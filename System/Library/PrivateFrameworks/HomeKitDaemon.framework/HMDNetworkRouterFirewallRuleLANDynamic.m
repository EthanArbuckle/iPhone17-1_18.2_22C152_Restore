  ...
  }
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v38 = 2112;
      id v39 = v18;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Rule contains an invalid '%@' value: %@", buf, 0x20u);
    }
    if (a11)
    {
...
+ (BOOL)__decodeAdvertisingProtocol:(id)a3 advertisingProtocol:(unsigned __int8 *)a4 error:(id *)a5
{
  ...
  if ((v9 & 1) == 0)
  {
    if (a5)
    {
      BOOL v14 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
LABEL_12:
      BOOL v13 = 0;
      *a5 = v14;
      goto LABEL_14;
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v25 = 2112;
      id v26 = v8;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Rule contains an unknown '%@' value: %@", buf, 0x20u);
    }
    if (a5)
    {
      BOOL v14 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:1070];
      goto LABEL_12;
    }
    goto LABEL_13;
  }
