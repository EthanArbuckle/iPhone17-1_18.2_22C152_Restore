...
- (id)attributeDescriptions
{
  ...
  v8 = (void *)[v6 initWithName:@"Entitlements" value:v7];
  v14[1] = v8;
...
- (BOOL)canSendWithPolicyParameters:(id)a3
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      ...
      uint32_t v17 = 32;
LABEL_13:
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_DEBUG, v15, (uint8_t *)&v25, v17);
LABEL_17:
  ...
  if (v8 != [(HMDHomeManagerXPCMessageSendPolicy *)self entitlements])
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      ...
      v21 = "%{public}@Cannot send message with policy parameters because entitlements %@ do not contain all of the requi"
            "red entitlements: %@";
LABEL_16:
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEBUG, v21, (uint8_t *)&v25, 0x20u);
