...
- (void)_postWACMatchingAccessoryFound:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
    ...
    _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Post-WAC matching accessory found: %@", (uint8_t *)&v20, 0x16u);
  }
  ...
  if (state == 4)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
    {
      ...
      int v20 = 138543362;
      v21 = v14;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Post-WAC accessory found, but WAC hasn't completed.  Holding on to accessory until completion", (uint8_t *)&v20, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v22 = 2048;
      int64_t v23 = v19;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Invalid state (%ld) for postWACMatchingAccessoryFound call", (uint8_t *)&v20, 0x16u);
    }
  }
}
...
- (void)_abort:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v51 = 2112;
    v52 = wacDevice;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Cancelling WAC assocciation for %@", buf, 0x16u);
  }
  switch(v6->_state)
  {
    case 0:
    ...
    case 8:
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v50 = v13;
        _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Cancel: no action required", buf, 0xCu);
      }
      v4[2](v4);
      v14 = [MEMORY[0x263F087E8] hmErrorWithCode:79];
    ...
    case 2:
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v50 = v18;
        _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Cancel: notify delegate of cancellation", buf, 0xCu);
      }
      ...
      if (v19)
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v50 = v23;
          _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Notifying delegate that WAC was cancelled", buf, 0xCu);
        }
    ...
    case 4:
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v50 = v27;
        _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_DEBUG, "%{public}@Cancel: cancel WAC and notify delegate", buf, 0xCu);
      }
      ...
      if (v28)
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v50 = v32;
          _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_DEBUG, "%{public}@Notifying delegate that WAC was cancelled", buf, 0xCu);
        }
        [v28 unassociatedWACAccessoryDidFinishAssociation:v30 withError:v14];
      }
      id inited = objc_initWeak(&location, v25);
      v34 = (void *)MEMORY[0x230FBD990](inited);
      v35 = v25;
      HMFGetOSLogHandle();
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v51 = 2112;
        v52 = v38;
        _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_DEBUG, "%{public}@Cancelling WAC operation for %@", buf, 0x16u);
      }
      v39 = v35->_wacDevice;
    ...
    case 6:
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v50 = v43;
        _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_DEBUG, "%{public}@Notifying delegate that WAC was cancelled", buf, 0xCu);
      }
      v14 = [MEMORY[0x263F087E8] hmErrorWithCode:79];
...
void __38__HMDUnassociatedWACAccessory__abort___block_invoke_2(uint64_t a1)
{
  *(void *)(*(void *)(a1 + 32) + 152) = 0;
  ...
  v2 = *(void **)(a1 + 32);
  id v3 = [MEMORY[0x263F087E8] hmErrorWithCode:79];
...
- (void)_postWACMatchTimeout
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
  {
    ...
    int v10 = 138543362;
    v11 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_ERROR, "%{public}@Timeout waiting to find device post-WAC", (uint8_t *)&v10, 0xCu);
  }
  v7 = [MEMORY[0x263F087E8] hmErrorWithCode:79];
...
- (void)_waitForPostWACMatch
{
  ...
  if (self->_postWACAccessory)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      int v19 = 138543362;
      int v20 = v6;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Post WAC accessory already located, handoff", (uint8_t *)&v19, 0xCu);
    }
  ...
  {
    v7 = [MEMORY[0x263F42608] sharedPreferences];
    ...
    v15 = (void *)MEMORY[0x230FBD990](v14);
    v16 = self;
    v17 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v21 = 2112;
      __int16 v22 = v10;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_INFO, "%{public}@Starting Post-WAC match timeout for %@ seconds", (uint8_t *)&v19, 0x16u);
    }
...
- (void)_configureDeviceCompleted:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v21 = 2112;
    id v22 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@WAC completed with %@", (uint8_t *)&v19, 0x16u);
  }
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v21 = 2112;
      id v22 = v4;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@WAC Failed with %@, device should still be WAC-able", (uint8_t *)&v19, 0x16u);
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      int v19 = 138543362;
      int v20 = v17;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_ERROR, "%{public}@No delegate assigned, cannot continue WAC association", (uint8_t *)&v19, 0xCu);
    }
    v18 = [MEMORY[0x263F087E8] hmErrorWithCode:79];
...
- (void)_configureDevice
{
  ...
  if (v3)
  {
    ...
    id v6 = (void *)MEMORY[0x230FBD990](inited);
    v7 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Starting WAC process for %@", buf, 0x16u);
    }
    v7->_int64_t state = 4;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v21 = v15;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@No delegate assigned, cannot continue WAC association", buf, 0xCu);
    }
    v16 = [MEMORY[0x263F087E8] hmErrorWithCode:79];
...
- (void)_userPermissionResponse:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v18 = 2112;
    int v19 = v10;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Permission to share network: %@", (uint8_t *)&v16, 0x16u);
  }
  if (v3)
  {
    id v11 = [MEMORY[0x263F087E8] hmErrorWithCode:79];
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@User permission denied, return to ready state", (uint8_t *)&v16, 0xCu);
    }
    v13->_int64_t state = 0;
  }
  else
...
- (void)_requestUserPermission
{
  ...
  if (v3)
  {
    ...
    id inited = objc_initWeak(&location, self);
    id v5 = (void *)MEMORY[0x230FBD990](inited);
    id v6 = self;
    HMFGetOSLogHandle();
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v18 = v8;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Request user permission to share network", buf, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v18 = v12;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@No delegate assigned, cannot continue WAC association", buf, 0xCu);
    }
    v13 = [MEMORY[0x263F087E8] hmErrorWithCode:79];
...
- (void)cancelConfigurationWithCompletionHandler:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    uint64_t v14 = v8;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Cancellation requested, aborting association", buf, 0xCu);
  }
  queue = v6->_queue;
...
void __71__HMDUnassociatedWACAccessory_startConfigurationWithCompletionHandler___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    if (v6)
    {
      ...
      int v15 = 138543362;
      int v16 = v7;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@WAC association already in progress", (uint8_t *)&v15, 0xCu);
    }
    uint64_t v8 = *(void *)(a1 + 40);
    uint64_t v9 = [MEMORY[0x263F087E8] hmErrorWithCode:79];
  ...
  else
  {
    if (v6)
    {
      ...
      __int16 v17 = 2112;
      uint64_t v18 = v11;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Kicking off WAC association for %@", (uint8_t *)&v15, 0x16u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t32 != -1) {
    dispatch_once(&logCategory__hmf_once_t32, &__block_literal_global_101317);
  }
  uint64_t v2 = (void *)logCategory__hmf_once_v33;
  return v2;
}
