...
- (id)naturalLightingActiveTransitionContextLightProfile:()NaturalLighting
{
  ...
  id v4 = a3;
  v5 = [v4 service];
  uint64_t v6 = *MEMORY[0x263F0BFF8];
  v7 = [v5 findCharacteristicWithType:*MEMORY[0x263F0BFF8]];
  if (v7)
  {
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v18 = 2112;
      uint64_t v19 = v6;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Service doesn't support Color Temperature Characteristic %@:%@", (uint8_t *)&v14, 0x20u);
    }
    v8 = 0;
  }
...
- (HMDNaturalLightingActiveTransitionContext)naturalLightingActiveTransitionContextForCharacteristic:()NaturalLighting
{
  ...
  if (v8)
  {
    ...
    id v28 = 0;
    id v10 = [MEMORY[0x263F35920] parsedFromData:v9 error:&v28];
    id v11 = v28;
    if (!v10)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v33 = 2112;
        id v34 = v11;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode controller context %@:%@", buf, 0x20u);
      }
      uint64_t v19 = 0;
      goto LABEL_18;
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v31 = 2112;
        v32 = v10;
        _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Start time missing in the controller context %@", buf, 0x16u);
      }
    }
    uint64_t v19 = 0;
    goto LABEL_17;
...
+ (uint64_t)updateTransition:()NaturalLighting withCurve:brightnessCharacteristic:millisecondsElapsedSinceStartOfDay:transitionStartTimeInMilliseconds:
{
  ...
  id v12 = a4;
  id v66 = a5;
  uint64_t v13 = [objc_alloc(MEMORY[0x263F35928]) initWithValue:1];
  id v14 = objc_alloc(MEMORY[0x263F35AF0]);
  double v15 = [NSNumber numberWithUnsignedLongLong:a7];
  uint64_t v16 = [v14 initWithValue:v15];

  v77[0] = 0;
  v77[1] = 0;
  v64 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:@"C4F33DA9-63C9-4C0F-8B89-6C36A33EEF9E"];
  [v64 getUUIDBytes:v77];
  uint64_t v17 = [MEMORY[0x263EFF8F8] dataWithBytes:v77 length:16];
  id v18 = objc_alloc(MEMORY[0x263F35920]);
  id v19 = objc_alloc(MEMORY[0x263F35AF0]);
    ...
    if (v27)
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@No transition points found: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v75 = 2048;
        uint64_t v76 = v42;
        _os_log_impl(&dword_22F52A000, v46, OS_LOG_TYPE_INFO, "%{public}@Sending coalesced transition points to accessory, transition points count: %lu, start transition point: %@, time elapsed since start of the day: %llums", buf, 0x2Au);
      }
      *(_DWORD *)buf = [v12 minimumBrightness];
      v50 = [MEMORY[0x263EFF8F8] dataWithBytes:buf length:4];
      int v67 = [v12 maximumBrightness];
      v51 = [MEMORY[0x263EFF8F8] dataWithBytes:&v67 length:4];
      v52 = (void *)[objc_alloc(MEMORY[0x263F35900]) initWithLowerBound:v50 upperBound:v51];
      id v53 = objc_alloc(MEMORY[0x263F35AF0]);
      uint64_t v35 = v66;
      v54 = [v66 instanceID];
      v55 = (void *)[v53 initWithValue:v54];

      v56 = (void *)[objc_alloc(MEMORY[0x263F358F0]) initWithTransitionPoints:v43 sourceHAPInstanceID:v55 sourceValueRange:v52];
      id v11 = v61;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v73 = 2112;
      v74 = v39;
      _os_log_impl(&dword_22F52A000, v38, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize controller context %@:%@", buf, 0x20u);
...
+ (id)transitionPointsByCoalescingTransitionPoints:()NaturalLighting ofCurve:
{
  ...
  id v5 = a3;
  id v39 = a4;
  v40 = objc_msgSend(MEMORY[0x263EFF980], "arrayWithCapacity:", objc_msgSend(v5, "count"));
  if ([v5 count] == 1)
  {
    id v7 = 0;
    uint64_t v8 = 0;
    ...
    do
    {
      ...
      if (v10 && [a1 canCoalesceTransitionPoint1:v9 transitionPoint2:v10 ofCurve:v39])
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
        {
          ...
          *(_DWORD *)buf = v36;
          ...
          __int16 v50 = 2048;
          unint64_t v51 = v12;
          _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Coalescing transition point: %@ at index: %lu with transition point: %@ at index: %lu", buf, 0x34u);
      ...
      else
      {
        ...
        if (v11)
        {
          ...
          id v24 = objc_alloc(MEMORY[0x263F35AF0]);
  ...
  if (v7)
  {
    ...
    id v31 = objc_alloc(MEMORY[0x263F35AF0]);
...
LABEL_20:
      _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_ERROR, v46, buf, 0x16u);
    }
LABEL_21:
  ...
  if (v19 <= 0)
  {
    uint64_t v42 = (void *)MEMORY[0x230FBD990](v17);
    id v43 = a1;
    __int16 v44 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
    {
  ...
  if (!v71)
  {
    unint64_t v47 = (void *)MEMORY[0x230FBD990]();
    id v48 = a1;
    ...
    if (os_log_type_enabled(v49, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v76 = 2112;
      id v77 = v10;
      _os_log_impl(&dword_22F52A000, v49, OS_LOG_TYPE_ERROR, "%{public}@Natural lighting curve is not set on light profile %@:%@", buf, 0x20u);
    }
    id v40 = 0;
    id v30 = 0;
    goto LABEL_37;
  ...
  id v69 = v11;
  id v21 = [v10 service];
  v22 = (void *)*MEMORY[0x263F0BFF8];
  v70 = [v21 findCharacteristicWithType:*MEMORY[0x263F0BFF8]];
  if (!v70)
  {
    unint64_t v51 = (void *)MEMORY[0x230FBD990]();
    id v52 = a1;
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v76 = 2112;
      id v77 = v22;
      _os_log_impl(&dword_22F52A000, v53, OS_LOG_TYPE_ERROR, "%{public}@Service doesn't support Color Temperature Characteristic %@:%@", buf, 0x20u);
    }
    id v40 = 0;
    id v30 = v71;
    goto LABEL_36;
  }
  v23 = (void *)*MEMORY[0x263F0BF68];
  id v68 = v21;
  uint64_t v24 = [v21 findCharacteristicWithType:*MEMORY[0x263F0BF68]];
  int v67 = (void *)v24;
  if (!v24)
  {
    ...
    if (os_log_type_enabled(v57, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v76 = 2112;
      id v77 = v23;
      _os_log_impl(&dword_22F52A000, v57, OS_LOG_TYPE_ERROR, "%{public}@Service doesn't support brightness Characteristic %@:%@", buf, 0x20u);
    }
    id v40 = 0;
    id v30 = v71;
    goto LABEL_35;
  ...
  uint64_t v25 = v24;
  id v66 = v12;
  id v26 = objc_alloc(MEMORY[0x263F35AF0]);
  id v27 = [v70 instanceID];
  id v28 = (void *)[v26 initWithValue:v27];

  id v29 = objc_alloc_init(MEMORY[0x263F35908]);
  ...
  if (a4)
  {
    ...
    if (([(id)objc_opt_class() updateTransition:v29 withCurve:v71 brightnessCharacteristic:v25 millisecondsElapsedSinceStartOfDay:v20 transitionStartTimeInMilliseconds:v19] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        __int16 v73 = v62;
        _os_log_impl(&dword_22F52A000, v61, OS_LOG_TYPE_ERROR, "%{public}@Failed to update transition with Natural Lighting Curve", buf, 0xCu);
      }
      id v40 = 0;
      uint64_t v41 = v65;
      id v12 = v66;
    ...
    {
      id v35 = objc_alloc(MEMORY[0x263F35AF0]);
      long long v36 = v28;
    ...
    *(_DWORD *)buf = [v71 colorTemperatureNotifyValueChangeThreshold];
    if (*(int *)buf >= 1)
    {
      id v39 = [MEMORY[0x263EFF8F8] dataWithBytes:buf length:4];
