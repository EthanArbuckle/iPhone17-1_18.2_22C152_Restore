...
- (HMDSelectedRTPParameters)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v7 = [MEMORY[0x263EFF8C0] arrayWithObjects:v49 count:1];
    ...
    v12 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v48 count:1];
    ...
    v17 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v47 count:1];
...
- (BOOL)_parseFromTLVData
{
  ...
  uint64_t v3 = [MEMORY[0x263F35A58] wrappertlv:1 name:@"kRTPParameters_PayloadType"];
  id v4 = [MEMORY[0x263F35A58] wrappertlv:2 name:@"kRTPParameters_SynchronizationSource"];
  v5 = [MEMORY[0x263F35A58] wrappertlv:3 name:@"kRTPParameters_MinimumVideoBandwidth"];
  id v6 = [MEMORY[0x263F35A58] wrappertlv:4 name:@"kRTPParameters_RTCPInterval"];
  id v7 = [MEMORY[0x263F35A58] wrappertlv:5 name:@"kRTPParameters_MaxMTU"];
  v8 = [MEMORY[0x263F35A58] wrappertlv:6 name:@"kRTPParameters_ComfortNoisePayloadType"];
  v32 = (void *)v3;
  v34[0] = v3;
  v34[1] = v4;
  uint64_t v9 = v4;
  v34[2] = v5;
  v34[3] = v6;
  v10 = [MEMORY[0x263EFF8C0] arrayWithObjects:v34 count:4];
  v33[0] = v7;
  v33[1] = v8;
  id v11 = [MEMORY[0x263EFF8C0] arrayWithObjects:v33 count:2];
...
- (NSData)tlvData
{
  uint64_t v3 = [MEMORY[0x263F35AD8] creator];
