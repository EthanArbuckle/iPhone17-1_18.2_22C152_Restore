...
{
  v2 = NSString;
  unint64_t v3 = [(HMDSiriEndpointSessionStateTypeWrapper *)self value];
  if (v3 >= 4)
  {
    objc_msgSend(NSString, "stringWithFormat:", @"Unknown HMDSiriEndpointSessionStateType %ld", v3);
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      v5 = v4;
      int64_t v6 = [(HMDSiriEndpointSessionStateTypeWrapper *)self value];
      uint64_t v7 = [(HMDSiriEndpointSessionStateTypeWrapper *)v5 value];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  int64_t v5 = [(HMDSiriEndpointSessionStateTypeWrapper *)self value];
  return [(HMDSiriEndpointSessionStateTypeWrapper *)v4 initWithValue:v5];
}

- (id)serializeWithError:(id *)a3
{
  int64_t v3 = [(HMDSiriEndpointSessionStateTypeWrapper *)self value];
...
{
  id v5 = a3;
  id v6 = objc_alloc_init(HMDSiriEndpointSessionStateTypeWrapper);
  id v7 = v6;
  if (v6)
  {
    id v10 = 0;
    [(HMDSiriEndpointSessionStateTypeWrapper *)v6 parseFromData:v5 error:&v10];
    id v8 = v10;
    if (v8)
    {
