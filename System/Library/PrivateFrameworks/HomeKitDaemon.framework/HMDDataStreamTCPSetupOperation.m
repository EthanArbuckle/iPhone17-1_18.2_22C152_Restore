...
- (void)_finishStreamTransport
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      int v15 = 138543362;
      v16 = v8;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@[Start Stream] DataStream configuration valid; starting stream",
        (uint8_t *)&v15,
        0xCu);
    }
  ...
  else
  {
    if (v7)
    {
      ...
      __int16 v21 = 1024;
      BOOL v22 = v14 != 0;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@[Start Stream] Setup still in progress (hasPort=%d, hasHostname=%d, hasEnc=%d)", (uint8_t *)&v15, 0x1Eu);
    }
  }
}
...
- (id)_createTCPTransport
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      int v19 = 138543362;
      BOOL v20 = v8;
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@[Start Stream] Accessory is a Siri endpoint, creating transport with elevated scheduling mode", (uint8_t *)&v19, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *(id *)((char *)location + 4) = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to create new DataStream; device appears to have lost IP-connectivity",
        (uint8_t *)location,
        0xCu);
    }
    v10 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
  ...
  if (WeakRetained)
  {
    ...
    if (!v5 || v6)
    {
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v16 = 2112;
        id v17 = v6;
        _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to create secure session for the accessory (%@)", (uint8_t *)&v14, 0x16u);
      }
      if (!v6)
      {
    ...
    else
    {
      if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
      {
        ...
        __int16 v16 = 2112;
        id v17 = v5;
        _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEBUG, "%{public}@[Start Stream] Key creation succeeded; will use session encryption %@",
          (uint8_t *)&v14,
          0x16u);
      }
...
LABEL_10:
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, v20, (uint8_t *)&v22, 0xCu);
    }
LABEL_11:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v24 = 2112;
    v25 = v14;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEBUG, "%{public}@[Start Stream] The setup transfer succeeded; will use port %@",
      (uint8_t *)&v22,
      0x16u);
  }
...
- (void)startSetup
{
  ...
  if (v4)
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v33 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Creating new DataStream using TCP", buf, 0xCu);
    }
    v10 = [(HMDDataStreamTCPSetupOperation *)v6 controllerKeySalt];
    uint64_t v11 = (void *)[objc_alloc(MEMORY[0x263F35960]) initWithValue:0];
    id v12 = (void *)[objc_alloc(MEMORY[0x263F35970]) initWithValue:0];
    uint64_t v26 = (void *)[objc_alloc(MEMORY[0x263F35978]) initWithCommand:v11 transportType:v12 controllerKeySalt:v10];
    ...
    if (v13)
    {
      ...
      v31 = v17;
      int v19 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v31 count:1];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v34 = 2112;
        id v35 = v14;
        _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Failed to create new DataStream; cannot serialize request (%@)",
          buf,
          0x16u);
      }
  ...
  else
  {
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v33 = v21;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@Failed to create new DataStream; does not appear to be IP-connected",
        buf,
        0xCu);
    }
  ...
  if (WeakRetained)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      {
        ...
        int v13 = 138543362;
        id v14 = v10;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to create new DataStream; invalid IP address",
          (uint8_t *)&v13,
          0xCu);
      }
      id v11 = objc_alloc(MEMORY[0x263F087E8]);
      id v12 = (void *)[v11 initWithDomain:*MEMORY[0x263F0C710] code:54 userInfo:0];
