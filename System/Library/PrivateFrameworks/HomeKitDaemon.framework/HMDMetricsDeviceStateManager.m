...
- (void)updateHH2SentinelZoneExists:(BOOL)a3;
...
- (BOOL)hh2SentinelZoneExists
{
  return self->_hh2SentinelZoneExists;
}
...
- (void)runDailyTask
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    v8 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@runDailyTask", (uint8_t *)&v7, 0xCu);
  }
...
- (void)handleHomeDataLoaded
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    v8 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@handleHomeDataLoaded", (uint8_t *)&v7, 0xCu);
  }
  [(HMDMetricsDeviceStateManager *)v4 updateCachedPairingKeyStates];
}
...
- (void)updateHH2SentinelZoneExists:(BOOL)a3
{
  p_lock = &self->_lock;
  os_unfair_lock_lock_with_options();
  self->_hh2SentinelZoneExists = a3;
  os_unfair_lock_unlock(p_lock);
}
...
- (void)updateWithDataSyncState:(unint64_t)a3
{
  ...
  if (self->_currentDataSyncState != a3)
  {
    ...
    uint64_t v6 = [(HMDMetricsDeviceStateManager *)self logEventSubmitter];
    unint64_t v7 = [[HMDDataSyncStateLogEvent alloc] initWithDataSyncState:a3];
...
- (void)registerForNotifications
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    int v8 = 138543362;
    uint64_t v9 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@registerForEvents", (uint8_t *)&v8, 0xCu);
  }
...
- (HMDMetricsDeviceStateManager)initWithLogEventSubmitter:(id)a3 dailyScheduler:(id)a4 dateProvider:(id)a5
{
  int v8 = (void *)MEMORY[0x263F42620];
  id v9 = a5;
  id v10 = a4;
  id v11 = a3;
  ...
  id v15 = [MEMORY[0x263F35AD0] systemStore];
...
+ (int64_t)internalDeviceDaysSinceSoftwareUpdate
{
  v3 = [MEMORY[0x263F499A8] sharedInstance];
  id v4 = objc_opt_class();
  uint64_t v5 = [MEMORY[0x263F42620] productInfo];
...
+ (int64_t)_daysSinceSoftwareUpdateFrom:(id)a3 dateProvider:(id)a4
{
  ...
  unint64_t v7 = v6;
  if (!v6
    || (int v8 = (void *)MEMORY[0x263F499A8],
  ...
  {
    int64_t v11 = qword_2303E3DF8[v10];
  }
