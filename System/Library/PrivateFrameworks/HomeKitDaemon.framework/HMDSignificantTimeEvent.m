...
- (void)_transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    int v30 = 138543362;
    v31 = v14;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Handling transaction updated", (uint8_t *)&v30, 0xCu);
  }
  id v15 = v9;
  objc_opt_class();
...
- (void)_handleUpdateRequest:(id)a3
{
  ...
  uint64_t v7 = objc_msgSend(MEMORY[0x263EFF918], "hmf_unarchiveFromData:error:", v6, 0);
  if (v5 | v7)
  {
  ...
  {
    uint64_t v8 = [MEMORY[0x263F087E8] hmErrorWithCode:20];
...
+ (id)nextTimerDateFromHomeLocation:(id)a3 signifiantEvent:(id)a4 offset:(id)a5 loggingObject:(id)a6
{
  ...
  if (!v9)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v77 = v23;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to get next significant event fire date because home location is nil", buf, 0xCu);
    }
    v24 = 0;
    id v12 = v20;
    goto LABEL_51;
  ...
  objc_super v14 = (void *)MEMORY[0x230FBD990]();
  id v15 = v12;
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v80 = 2112;
    uint64_t v81 = v13;
    _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_INFO, "%{public}@Current Home Location & time : %@ / %@", buf, 0x20u);
  }
  if ([v10 isEqualToString:*MEMORY[0x263F0D8F8]])
  {
    uint64_t v18 = +[HMDLocation nextSunriseTimeForLocation:v9 date:v13];
  }
  else
  {
    if (![v10 isEqualToString:*MEMORY[0x263F0D908]])
    {
      v25 = 0;
      goto LABEL_13;
    }
...
LABEL_13:
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v78 = 2112;
    id v79 = v25;
    _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_INFO, "%{public}@nextSunEventDates %@", buf, 0x16u);
  }
  int v30 = (void *)MEMORY[0x230FBD990]();
  id v31 = v27;
  ...
  if (v25)
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
    {
      ...
      v35 = [v25 describeElements:&__block_literal_global_19];
      *(_DWORD *)buf = 138543618;
      v77 = v34;
      __int16 v78 = 2112;
      id v79 = v35;
      _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_INFO, "%{public}@Set of events to pick from %@", buf, 0x16u);
    }
    v69 = v25;
    if (v11)
    {
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v78 = 2112;
        id v79 = v11;
        _os_log_impl(&dword_22F52A000, v38, OS_LOG_TYPE_INFO, "%{public}@Adding offset %@ to the sun event dates", buf, 0x16u);
      }
      ...
      if (v42)
      {
        ...
        do
        {
          for (uint64_t i = 0; i != v43; ++i)
          {
            ...
            v47 = [MEMORY[0x263EFF8F0] currentCalendar];
    ...
    [v40 addObject:v13];
    v50 = [v40 sortedArrayUsingComparator:&__block_literal_global_25_98148];
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
    {
      ...
      v55 = [v40 describeElements:&__block_literal_global_27_98149];
      *(_DWORD *)buf = 138543618;
      v77 = v54;
      __int16 v78 = 2112;
      id v79 = v55;
      _os_log_impl(&dword_22F52A000, v53, OS_LOG_TYPE_INFO, "%{public}@Set of events to pick after offset & current time addition from %@", buf, 0x16u);
    ...
    if ([v50 count])
    {
      ...
      if (v56 == v58)
      {
        ...
        if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v77 = v62;
          _os_log_impl(&dword_22F52A000, v61, OS_LOG_TYPE_ERROR, "%{public}@Unable to determine next timer event for Significant Event", buf, 0xCu);
        }
        v24 = 0;
      }
      else
      {
        ...
        if (os_log_type_enabled(v61, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v78 = 2112;
          id v79 = v24;
          _os_log_impl(&dword_22F52A000, v61, OS_LOG_TYPE_INFO, "%{public}@Event next fire date : %@", buf, 0x16u);
        }
      }
    }
    else
...
LABEL_49:
  ...
  else
  {
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v77 = v49;
      _os_log_impl(&dword_22F52A000, v33, OS_LOG_TYPE_ERROR, "%{public}@Failed to get the sun event dates based on home location", buf, 0xCu);
    }
    v24 = 0;
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_98157 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_98157, &__block_literal_global_98158);
  }
  v2 = (void *)logCategory__hmf_once_v1_98159;
  return v2;
}
...
void __38__HMDSignificantTimeEvent_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_98159;
  logCategory__hmf_once_v1_98159 = v0;
}
