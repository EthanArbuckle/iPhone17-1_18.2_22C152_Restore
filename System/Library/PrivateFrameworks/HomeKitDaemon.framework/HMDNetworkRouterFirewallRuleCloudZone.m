  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v89 = 2112;
      id v90 = v23;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Signature verification of fetched network declarations failed for record %@/%@ with error %@", buf, 0x2Au);
      ...
      if (!v29)
      {
        ...
        if (os_log_type_enabled(v54, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v87 = 2112;
          v88 = v61;
          _os_log_impl(&dword_22F52A000, v54, OS_LOG_TYPE_ERROR, "%{public}@Fetched Paired metadata failed to parse for record %@/%@", buf, 0x20u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v89 = 2112;
        id v90 = v37;
        _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_ERROR, "%{public}@Signature verification of fetched Paired metadata failed for record %@/%@ with error %@", buf, 0x2Au);
...
LABEL_24:
  ...
  if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v87 = 2112;
    v88 = v51;
    _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_ERROR, "%{public}@Fetched network declarations failed to parse for record %@/%@", buf, 0x20u);
...
+ (BOOL)__verifyDigestDataAgainstSignatureFromRecord:(id)a3 digestData:(id)a4 signatureData:(id)a5 signatureVerificationPublicKeys:(id)a6 error:(id *)a7
{
  ...
  if (v13)
  {
    ...
    CFStringRef v17 = (const __CFString *)*MEMORY[0x263F172A8];
    while (2)
    {
      uint64_t v18 = 0;
      id v19 = v15;
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
  {
    ...
    *(void *)&error[4] = v26;
    ...
    __int16 v40 = 2112;
    v41 = v15;
    _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@Digest does not match signature on record %@: %@", error, 0x20u);
  }
  if (a7)
  {
    [MEMORY[0x263F087E8] hmErrorWithCode:53];
    BOOL v22 = 0;
...
+ (id)__getSignatureDataFromRecord:(id)a3 signatureKey:(id)a4 signatureAssetKey:(id)a5 maxSignatureSize:(unint64_t)a6 error:(id *)a7
{
  ...
  if (v8)
  {
    ...
    {
      *a7 = [MEMORY[0x263F087E8] hmErrorWithCode:53];
    }
  }
  else
  {
...
+ (id)__calculateDigestDataFromRecord:(id)a3 dataKey:(id)a4 dataAssetKey:(id)a5 maxDataSize:(unint64_t)a6 error:(id *)a7
{
  ...
  if (v25)
  {
    BOOL v28 = [MEMORY[0x263EFF950] inputStreamWithData:v25];
    id v27 = v28;
    if (v28)
    {
      id v29 = v28;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v97 = 2112;
        v98 = v25;
        _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_ERROR, "%{public}@Failed to create input stream with data: %@", buf, 0x16u);
      }
      uint64_t v16 = v78;
      id v9 = v82;
      if (v82)
      {
        *id v82 = [MEMORY[0x263F087E8] hmErrorWithCode:52];
      }
    }
  }
  else
...
LABEL_15:
  ...
  v100[1] = v37;
  __int16 v38 = [MEMORY[0x263EFF8C0] arrayWithObjects:v100 count:2];
...
LABEL_32:
    ...
    {
      v51 = [MEMORY[0x263EFF990] dataWithLength:32];
      v52 = v51;
      id v22 = v77;
      if (v51)
      {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v72, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)__int16 v89 = 138543618;
          ...
          __int16 v91 = 2048;
          uint64_t v92 = 32;
          _os_log_impl(&dword_22F52A000, v72, OS_LOG_TYPE_ERROR, "%{public}@Failed to allocate %lu bytes to hold digest", v89, 0x16u);
        }
        if (v83)
        {
    ...
    v63 = (void *)MEMORY[0x230FBD990](v50);
    id v64 = v79;
    ...
    if (os_log_type_enabled(v65, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)__int16 v89 = 138543874;
      ...
      __int16 v93 = 2112;
      v94 = v68;
      _os_log_impl(&dword_22F52A000, v65, OS_LOG_TYPE_ERROR, "%{public}@Error reading data from record %@: %@", v89, 0x20u);
...
LABEL_45:
  ...
  v55 = (void *)MEMORY[0x230FBD990]([v27 close]);
  id v56 = v79;
  ...
  if (os_log_type_enabled(v57, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)__int16 v89 = 138543874;
    ...
    __int16 v93 = 2112;
    v94 = v60;
    _os_log_impl(&dword_22F52A000, v57, OS_LOG_TYPE_ERROR, "%{public}@Data size is bigger than maximum %ld bytes on record %@", v89, 0x20u);
  ...
  v62 = [MEMORY[0x263F087E8] hmErrorWithCode:-1];
LABEL_44:
  v54 = 0;
  void *v61 = v62;
LABEL_46:
      ...
      if ((v18 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138544130;
          ...
          __int16 v41 = 2112;
          uint64_t v42 = v31;
          _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_ERROR, "%{public}@'%@' field value '%@' does not match record name on %@", buf, 0x2Au);
        }
        if (v33)
        {
          [MEMORY[0x263F087E8] hmErrorWithCode:53];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138544130;
        ...
        __int16 v41 = 2112;
        uint64_t v42 = v25;
        _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@'%@' field value '%@' does not match zone name on %@", buf, 0x2Au);
      }
      if (v33)
      {
        [MEMORY[0x263F087E8] hmErrorWithCode:53];
...
+ (unint64_t)__maxSizeFromPreferenceWithKey:(id)a3 defaultValue:(unint64_t)a4
{
  ...
  if (isInternalBuild())
  {
    id v6 = [MEMORY[0x263F42608] sharedPreferences];
...
- (void)__retryFetchWithFetchInfo:(id)a3
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Will %s in %lu seconds", buf, 0x20u);
  }
  [v4 setShouldRetry:0];
...
void __67__HMDNetworkRouterFirewallRuleCloudZone___retryFetchWithFetchInfo___block_invoke_2(uint64_t a1)
{
  ...
  {
    char v14 = [MEMORY[0x263F087E8] hmErrorWithCode:23];
...
- (BOOL)__canRecoverFromError:(id)a3 fetchInfo:(id)a4
{
  ...
  if ([v6 hmbIsCKPartialFailureError])
  {
    ...
    *(void *)&buf[16] = 0x3032000000;
    long long v34 = __Block_byref_object_copy__202700;
    long long v35 = __Block_byref_object_dispose__202701;
    id v36 = 0;
    id v8 = [v6 userInfo];
    id v9 = [v8 objectForKeyedSubscript:*MEMORY[0x263EFD4C8]];
  ...
  switch(v14)
  {
    case 21:
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(void *)&buf[14] = v6;
        _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@Change token has expired: %@", buf, 0x16u);
      }
      [v7 setChangeToken:0];
      [v7 setShouldRetry:1];
      goto LABEL_25;
    case 28:
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(void *)&buf[14] = v6;
        _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_DEFAULT, "%{public}@Zone was deleted: %@", buf, 0x16u);
      }
    ...
    case 26:
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(void *)&buf[14] = v6;
        _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Zone does not exist: %@", buf, 0x16u);
      }
LABEL_24:
...
- (BOOL)__commitLocalChanges:(id)a3 error:(id *)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v59 = v11;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Committing local changes", buf, 0xCu);
  }
  ...
  if ((v14 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v60 = 2112;
      id v61 = v41;
      _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_ERROR, "%{public}@Failed to commit: %@", buf, 0x16u);
    }
    LOBYTE(v42) = 0;
    goto LABEL_21;
  }
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v59 = v20;
    _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Committed successfully", buf, 0xCu);
  }
  ...
  if (!v23)
  {
    ...
    if (os_log_type_enabled(v45, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v60 = 2112;
      id v61 = v48;
      _os_log_impl(&dword_22F52A000, v45, OS_LOG_TYPE_INFO, "%{public}@Updating change token: %@", buf, 0x16u);
    }
    ...
    unint64_t v28 = (void *)MEMORY[0x230FBD990]();
    v55 = v44;
...
LABEL_16:
    _os_log_impl(&dword_22F52A000, v35, v36, v34, buf, 0x16u);
  }
LABEL_17:
...
- (void)__zoneChangesCompleted:(id)a3 fetchInfo:(id)a4
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v26 = 2112;
      id v27 = v6;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Zone change operation completed unsuccessfully: %@", buf, 0x16u);
    }
    id v14 = v6;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      __int16 v25 = v18;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Zone change operation completed successfully", buf, 0xCu);
    }
    id v23 = 0;
...
LABEL_11:
  ...
  {
    BOOL v22 = [MEMORY[0x263EFF9D0] null];
  ...
  if (!v11)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v33 = 2112;
      id v34 = v28;
      _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@Zone fetch completed successfully, token: %@, moreComing: %@", buf, 0x20u);
    }
LABEL_11:
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138544130;
    ...
    _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Zone fetch completed unsuccessfully, token: %@, error: %@, moreComing: %@", buf, 0x2Au);
  }
  if (v10) {
    goto LABEL_11;
  }
...
- (void)__zoneChangeTokensUpdated:(id)a3 fetchInfo:(id)a4
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v19 = 2112;
    id v20 = v16;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Change token updated: %@", buf, 0x16u);
  }
...
- (void)__recordDeleted:(id)a3 recordType:(id)a4 fetchInfo:(id)a5
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v39 = 2112;
    id v40 = v9;
    _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_DEFAULT, "%{public}@Fetched deleted recordID: %@ (%@)", buf, 0x20u);
  }
  id v34 = 0;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v37 = 2112;
        id v38 = v22;
        _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove model: %@", buf, 0x16u);
      }
    }
    id v19 = v22;
  }
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v37 = 2112;
      id v38 = v19;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to determine externalID: %@", buf, 0x16u);
    }
  }
}
...
- (void)__recordChanged:(id)a3 fetchInfo:(id)a4
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v60 = 2112;
    id v61 = v17;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Fetched changed record %@ (%@)", buf, 0x20u);
  }
  id v55 = 0;
        ...
        else
        {
          ...
          if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543874;
            ...
            __int16 v60 = 2112;
            id v61 = v50;
            _os_log_impl(&dword_22F52A000, v46, OS_LOG_TYPE_ERROR, "%{public}@Failed to update model for %@: %@", buf, 0x20u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v58 = 2112;
          id v59 = v24;
          _os_log_impl(&dword_22F52A000, v40, OS_LOG_TYPE_ERROR, "%{public}@Failed to determine externalData: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v58 = 2112;
        id v59 = v22;
        _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_ERROR, "%{public}@Failed to determine externalID: %@", buf, 0x16u);
      }
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v58 = 2112;
      id v59 = v20;
      _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode model: %@", buf, 0x16u);
    }
  }
}
...
- (void)__finalizeUpdatedRecordIDs
{
  v3 = (os_unfair_lock_s *)((char *)self + (int)*MEMORY[0x263F49350]);
...
{
  id v7 = a3;
  id v4 = (os_unfair_lock_s *)((char *)self + (int)*MEMORY[0x263F49350]);
  os_unfair_lock_lock_with_options();
  id v5 = [(HMDNetworkRouterFirewallRuleCloudZone *)self uncommittedModifiedRecordIDsFromLastPull];
...
- (void)__fetchZoneChangesWithFetchInfo:(id)a3
{
  ...
  id v4 = a3;
  id v5 = objc_alloc_init(MEMORY[0x263EFD6B0]);
  ...
  uint64_t v41 = v8;
  v42[0] = v5;
  id v9 = [NSDictionary dictionaryWithObjects:v42 forKeys:&v41 count:1];

  id v10 = objc_alloc(MEMORY[0x263EFD6B8]);
  id v11 = [(HMBCloudZone *)self cloudZoneID];
  id v12 = [v11 zoneID];
  id v40 = v12;
  BOOL v13 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v40 count:1];
...
LABEL_7:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      char v25 = v20;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@CloudZone has been deallocated", buf, 0xCu);
    }
    id v21 = *(void **)(a1 + 32);
    if (v21)
    {
    ...
    {
      id v22 = [MEMORY[0x263F087E8] hmErrorWithCode:23];
    }
    id v23 = v22;
    ...
    if ((v6 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v18 = 2112;
        id v19 = v11;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: recordZoneFetchCompletionBlock called with unknown zone: %@", buf, 0x16u);
      }
    ...
    if ((v6 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_FAULT))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v18 = 2112;
        id v19 = v11;
        _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: recordZoneChangeTokensUpdatedBlock called with unknown zone: %@", buf, 0x16u);
      }
      os_log_type_t v12 = [HMDAssertionLogEvent alloc];
      uint32_t v13 = [*(id *)(a1 + 32) hmbDescription];
...
- (id)fetchChangesWithToken:(id)a3 options:(id)a4
{
  ...
  os_log_type_t v12 = objc_msgSend(MEMORY[0x263F581B8], "globalAsyncScheduler", v15, v16, v17, v18);
...
void __71__HMDNetworkRouterFirewallRuleCloudZone_fetchChangesWithToken_options___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    id v6 = (os_unfair_lock_s *)&WeakRetained[*MEMORY[0x263F49350]];
    os_unfair_lock_lock_with_options();
      ...
      if (v40)
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(_DWORD *)buf = 138543874;
          ...
          __int16 v46 = 2112;
          BOOL v47 = v28;
          _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_DEFAULT, "%{public}@Fetching all changes for zone: %@, token: %@", buf, 0x20u);
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v44 = 2112;
          id v45 = v39;
          _os_log_impl(&dword_22F52A000, v36, OS_LOG_TYPE_ERROR, "%{public}@Failed to create mirror input: %@", buf, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_DEBUG))
      {
        ...
        *(_DWORD *)buf = 138543362;
        uint64_t v43 = v33;
        _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_DEBUG, "%{public}@Not watching any records", buf, 0xCu);
      }
  ...
  {
    id v29 = [MEMORY[0x263F087E8] hmErrorWithCode:23];
...
- (void)setUncommittedModifiedRecordIDsFromLastPull:(id)a3
{
  ...
  os_unfair_lock_assert_owner((const os_unfair_lock *)((char *)self + (int)*MEMORY[0x263F49350]));
...
- (NSSet)modifiedRecordIDsFromLastPull
{
  id v3 = (os_unfair_lock_s *)((char *)self + (int)*MEMORY[0x263F49350]);
  os_unfair_lock_lock_with_options();
...
- (id)attributeDescriptions
{
  ...
  v24[3] = v15;
  uint64_t v16 = (void *)[objc_alloc(MEMORY[0x263F424F8]) initWithName:@"UncommittedModifiedRecordIDsFromLastPull" value:v21];
  v24[4] = v16;
  id v17 = [MEMORY[0x263EFF8C0] arrayWithObjects:v24 count:5];
...
- (HMDNetworkRouterFirewallRuleCloudZone)initWithCloudDatabase:(id)a3 state:(id)a4 useAnonymousRequests:(BOOL)a5 watchedRecordIDs:(id)a6 signatureVerificationPublicKeys:(id)a7
{
  ...
  if (![v15 count])
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v28 = v24;
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must have verification keys", buf, 0xCu);
    }
