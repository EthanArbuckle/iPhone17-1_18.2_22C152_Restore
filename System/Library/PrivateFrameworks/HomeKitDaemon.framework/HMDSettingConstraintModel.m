...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_80836 != -1) {
    dispatch_once(&hmbProperties_onceToken_80836, &__block_literal_global_80837);
  }
  v2 = (void *)hmbProperties__properties_80838;
  return v2;
}
...
void __42__HMDSettingConstraintModel_hmbProperties__block_invoke()
{
  ...
  v5 = (void *)hmbProperties__properties_80838;
  hmbProperties__properties_80838 = v4;
}
