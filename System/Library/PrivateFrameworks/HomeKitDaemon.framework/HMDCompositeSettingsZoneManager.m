...
- (void)remove
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v13 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Removing Zone", buf, 0xCu);
  }
...
void __41__HMDCompositeSettingsZoneManager_remove__block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v15 = v12;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Unexpected nil zone during cleanup", buf, 0xCu);
    }
  }
}
...
- (void)database:(id)a3 didReceiveMessageWithUserInfo:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v14 = 2112;
    id v15 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@did receive message with  user info %@", (uint8_t *)&v12, 0x16u);
  }
}
...
uint64_t __76__HMDCompositeSettingsZoneManager_database_didRemoveZoneWithName_isPrivate___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    int v7 = 138543362;
    int v8 = v5;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Zone removed", (uint8_t *)&v7, 0xCu);
  }
  [*(id *)(a1 + 32) setCloudZone:0];
...
- (id)database:(id)a3 willRemoveZoneWithName:(id)a4 isPrivate:(BOOL)a5
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    int v15 = 138543362;
    uint64_t v16 = v12;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@will remove zone", (uint8_t *)&v15, 0xCu);
  }
...
- (void)database:(id)a3 didCreateZoneWithName:(id)a4 isPrivate:(BOOL)a5
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    int v13 = 138543362;
    __int16 v14 = v12;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@did create zone", (uint8_t *)&v13, 0xCu);
  }
}
...
void __93__HMDCompositeSettingsZoneManager_initWithDatabase_workQueue_zoneName_createZoneIfNotExists___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4)
  {
    ...
    id v6 = objc_alloc_init(MEMORY[0x263F492F8]);
    ...
    if (v7)
    {
      if (v11)
      {
        ...
        *(_WORD *)&buf[22] = 2112;
        v55 = v14;
        _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Finding Zone:%@ createIfNotExists:%@", buf, 0x20u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_WORD *)&buf[12] = 2112;
        *(void *)&buf[14] = v22;
        _os_log_impl(&dword_22F52A000, v40, OS_LOG_TYPE_ERROR, "%{public}@Failed to open zone: %@", buf, 0x16u);
      }
      v42 = (void *)MEMORY[0x263F58190];
      v28 = [MEMORY[0x263F087E8] hmfErrorWithCode:6];
...
void __45__HMDCompositeSettingsZoneManager__configure__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v10 = 2112;
    id v11 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@CloudZone Error: %@", (uint8_t *)&v8, 0x16u);
  }
}
...
void __45__HMDCompositeSettingsZoneManager__configure__block_invoke_13(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v8 = 138543362;
    id v9 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@CloudZone startup success", (uint8_t *)&v8, 0xCu);
  }
}

+ (id)logCategory
{
  if (logCategory__hmf_once_t5_234079 != -1) {
    dispatch_once(&logCategory__hmf_once_t5_234079, &__block_literal_global_234080);
  }
  v2 = (void *)logCategory__hmf_once_v6_234081;
  return v2;
}
...
void __46__HMDCompositeSettingsZoneManager_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v6_234081;
  logCategory__hmf_once_v6_234081 = v0;
}
