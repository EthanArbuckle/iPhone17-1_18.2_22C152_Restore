  ...
  if (v2 == v3)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v30 = v21;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@No user has responded to the confirmation yet, declaring confirmation denied", buf, 0xCu);
    }
    v22 = *(void **)(a1 + 32);
    v23 = [MEMORY[0x263F087E8] hmErrorWithCode:23];
  ...
  else
  {
    ...
    if (v4 == v5)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v30 = v9;
        _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Start char monitor timer has fired, activating monitoring events", buf, 0xCu);
      }
      long long v26 = 0u;
      long long v27 = 0u;
      long long v24 = 0u;
...
void __63__HMDEventTriggerExecutionSession_didOccurEvent_causingDevice___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v24 = 2112;
      uint64_t v25 = v8;
      _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@End Event has occurred, declaring execution complete, %@", (uint8_t *)&v22, 0x16u);
    }
...
LABEL_9:
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v24 = 2114;
      uint64_t v25 = v16;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Monitored Event %{public}@ has occurred", (uint8_t *)&v22, 0x16u);
    }
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v24 = 2112;
    uint64_t v25 = v21;
    _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Received a delegate callback on event occurrence from %@", (uint8_t *)&v22, 0x16u);
  }
}
...
LABEL_4:
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v21 = 2112;
      int v22 = v12;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Not ending the trigger execution session because there are write requests left %@ or media profiles %@", (uint8_t *)&v17, 0x20u);
    }
    return;
  }
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    int v17 = 138543362;
    id v18 = v16;
    _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@No more write requests in restore list, declaring execution complete", (uint8_t *)&v17, 0xCu);
  }
...
{
  id v4 = [a3 userInfo];
  uint64_t v5 = [v4 objectForKeyedSubscript:*MEMORY[0x263F0D218]];
  id v6 = [(HMDEventTriggerSession *)self workQueue];
...
void __81__HMDEventTriggerExecutionSession_handleSessionPlaybackStateUpdatedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v39 = 2112;
    uint64_t v40 = v6;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Received notification userInfo %@", buf, 0x16u);
  }
  id v7 = [*(id *)(a1 + 32) eventTrigger];
  id v8 = [v7 home];
  v9 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:*(void *)(a1 + 48)];
        ...
        if ([v11 containsObject:v20])
        {
          ...
          if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v39 = 2112;
            uint64_t v40 = v20;
            _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_INFO, "%{public}@Removing the media profile as it was changed, %@", buf, 0x16u);
        ...
        if (v15 == v16)
        {
          ...
          if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v34 = 2112;
            long long v35 = v13;
            _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Removing the write requests on characteristic as it was changed, %@", buf, 0x16u);
...
- (void)_restoreState
{
  ...
  if ([(HMDEventTriggerExecutionSession *)self restoreInProgress])
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      id v38 = v6;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@State restoration is already in progress, ignoring", buf, 0xCu);
    }
  }
  else
  {
    ...
    if (v8)
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        if (v17) {
          ...
          long long v35 = *MEMORY[0x263F42690];
        }
        long long v36 = v35;
        ...
        *(_DWORD *)buf = 138544386;
        ...
        __int16 v45 = 2048;
        uint64_t v46 = v26;
        _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Executing write requests for request identifier: %{public,uuid_t}.16P from event trigger execution session: %{public}@ count: %lu", buf, 0x30u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        id v38 = v25;
        _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@Failed to get valid Home reference", buf, 0xCu);
      }
...
- (void)_callExecutionComplete:(id)a3 callDelegate:(BOOL)a4
{
  ...
  if ([(HMDEventTriggerExecutionSession *)self executionCompleteCalled])
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v47 = v10;
      _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@Execution complete already called, ignoring", buf, 0xCu);
    }
  }
  else
  {
    ...
    if (v12)
    {
      ...
      do
      {
        for (uint64_t i = 0; i != v13; ++i)
        {
          ...
          if ([v16 conformsToProtocol:&unk_26E4DB6C0]) {
            uint64_t v17 = v16;
          }
          else {
            uint64_t v17 = 0;
    ...
    uint64_t v19 = (void *)MEMORY[0x230FBD990]([(HMDEventTriggerExecutionSession *)self _removeUserDialog]);
    uint64_t v20 = self;
    ...
    if (v4)
    {
      if (v22)
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v48 = 2114;
        id v49 = v6;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Informing that trigger action set execution is complete with error %{public}@", buf, 0x16u);
      }
    ...
    else
    {
      if (v22)
      {
        ...
        *(_DWORD *)buf = 138543362;
        v47 = v25;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Not calling the delegate", buf, 0xCu);
      }
    }
        ...
        for (uint64_t j = 0; j != v28; ++j)
        {
          ...
          if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v48 = 2112;
            id v49 = v31;
            _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_INFO, "%{public}@Deactivating end event %@", buf, 0x16u);
          }
...
- (id)_monitoringEventsFromActionSetResponse:(id)a3
{
  ...
  id v4 = a3;
  id v88 = [MEMORY[0x263EFF980] array];
          ...
          do
          {
            ...
            do
            {
              ...
              if ((HMFEqualObjects() & 1) == 0)
              {
                ...
                v95 = v13;
                double v15 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v13];
                ...
                if (!v18)
                {
                  uint64_t v19 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:v95];
                        ...
                        do
                        {
                          ...
                          do
                          {
                            ...
                            if (v33)
                            {
                              ...
                              if (v35 && ([v35 isEqual:MEMORY[0x263EFFA80]] & 1) == 0)
                              {
                                ...
                                if (os_log_type_enabled(v69, OS_LOG_TYPE_INFO))
                                {
                                  ...
                                  *(_DWORD *)buf = 138543618;
                                  ...
                                  __int16 v118 = 2112;
                                  v119 = (const char *)v33;
                                  _os_log_impl(&dword_22F52A000, v69, OS_LOG_TYPE_INFO, "%{public}@Did not create write request for characteristic because it was ON prior to trigger, %@", buf, 0x16u);
                                }
                                uint64_t v27 = v99;
                              }
                              else
                              {
                                ...
                                long long v39 = +[HMDCharacteristicWriteRequest writeRequestWithCharacteristic:v33 value:MEMORY[0x263EFFA80] authorizationData:v38 type:1];
...
LABEL_39:
                                ...
                                if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
                                {
                                  ...
                                  *(_DWORD *)buf = 138544130;
                                  ...
                                  __int16 v122 = 2112;
                                  v123 = v33;
                                  _os_log_impl(&dword_22F52A000, v43, OS_LOG_TYPE_INFO, "%{public}@%s write request for characteristic because characteristic type %s supported for Duration Event, %@", buf, 0x2Au);
                                  ...
                                  else
                                  {
                                    ...
                                    if (os_log_type_enabled(v65, OS_LOG_TYPE_ERROR))
                                    {
                                      ...
                                      *(_DWORD *)buf = 138543618;
                                      ...
                                      __int16 v118 = 2112;
                                      v119 = (const char *)v33;
                                      _os_log_impl(&dword_22F52A000, v65, OS_LOG_TYPE_ERROR, "%{public}@Failed to create monitor event for %@", buf, 0x16u);
                                ...
                                else
                                {
                                  ...
                                  if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR))
                                  {
                                    ...
                                    *(_DWORD *)buf = 138543618;
                                    ...
                                    __int16 v118 = 2112;
                                    v119 = (const char *)v33;
                                    _os_log_impl(&dword_22F52A000, v61, OS_LOG_TYPE_ERROR, "%{public}@No value reported in action set result, Not creating the monitor event for %@", buf, 0x16u);
                            ...
                            if (os_log_type_enabled(v57, OS_LOG_TYPE_ERROR))
                            {
                              ...
                              *(_DWORD *)buf = 138544130;
                              ...
                              __int16 v122 = 2112;
                              v123 = v30;
                              _os_log_impl(&dword_22F52A000, v57, OS_LOG_TYPE_ERROR, "%{public}@Could not find the characteristic %@/%@/%@", buf, 0x2Au);
                            }
LABEL_60:
...
uint64_t __51__HMDEventTriggerExecutionSession__activateEvents___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v13 = 2112;
    uint64_t v14 = v7;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Activating event failed with error %@, %@", (uint8_t *)&v9, 0x20u);
  }
  return [*(id *)(a1 + 32) _callExecutionComplete:*(void *)(a1 + 40)];
}
...
- (void)_handleActionSetExecutionResponse:(id)a3 actionSetError:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    *(void *)&v50[14] = v9;
    __int16 v51 = 2112;
    id v52 = v8;
    _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Action set execution responded with error %@ and response %@", v50, 0x20u);
  }
  ...
  if (v9)
  {
    ...
    if ([v18 isEqualToString:*MEMORY[0x263F0C710]])
    {
      ...
      if (v19 == 64)
      {
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
        {
          ...
          *(void *)&v50[4] = v23;
          _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@Action set has resulted in partial success, proceeding with successful ones", v50, 0xCu);
        }
        goto LABEL_11;
      }
    }
...
LABEL_20:
    _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_INFO, v39, v50, 0xCu);
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
  {
    ...
    *(_WORD *)&v50[12] = 2112;
    *(void *)&v50[14] = v31;
    _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_INFO, "%{public}@Created monitoring events %@", v50, 0x16u);
  }
...
LABEL_24:
  ...
  if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)v50 = 138543362;
    *(void *)&v50[4] = v45;
    _os_log_impl(&dword_22F52A000, v44, OS_LOG_TYPE_INFO, "%{public}@There are end events with the execution session, activating them", v50, 0xCu);
  }
  [(HMDEventTriggerExecutionSession *)v43 _activateDurationEvents];
  [(HMDEventTriggerExecutionSession *)v43 setExecutionState:4];
  id v46 = objc_alloc(MEMORY[0x263F42658]);
...
void __83__HMDEventTriggerExecutionSession__directlyExecuteActionSetsWithCompletionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (WeakRetained)
  {
    ...
    v13[1] = 3221225472;
    v13[2] = __83__HMDEventTriggerExecutionSession__directlyExecuteActionSetsWithCompletionHandler___block_invoke_70;
    v13[3] = &unk_264A2EE30;
    v13[4] = v8;
    id v14 = v6;
    id v15 = v5;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      long long v18 = v12;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Lost self while executing action set", buf, 0xCu);
    }
  }
}

uint64_t __83__HMDEventTriggerExecutionSession__directlyExecuteActionSetsWithCompletionHandler___block_invoke_70(uint64_t a1)
{
...
- (void)_addEvent:(id)a3 causingDevice:(id)a4
{
  ...
  if ([(HMDEventTriggerExecutionSession *)self executionState] > 2)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v34 = 2112;
      id v35 = v20;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Current state has moved beyond waiting for user response: %@", (uint8_t *)&v32, 0x16u);
    }
    id v15 = (void *)v16;
    goto LABEL_9;
  }
  ...
  if (v9)
  {
    if (v13)
    {
      ...
      __int16 v34 = 2112;
      id v35 = v7;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Device is already in the causing devices list, %@", (uint8_t *)&v32, 0x16u);
    }
    id v15 = v10;
LABEL_9:
    goto LABEL_17;
  ...
  if (v13)
  {
    ...
    __int16 v34 = 2112;
    id v35 = v7;
    _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Adding device to ask for confirmation, %@", (uint8_t *)&v32, 0x16u);
  }
  ...
  if ((v24 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v34 = 2112;
      id v35 = v6;
      _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_INFO, "%{public}@Adding event as an additional event, %@", (uint8_t *)&v32, 0x16u);
    }
...
- (void)_userResponse:(unint64_t)a3 device:(id)a4 completionHandler:(id)a5
{
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      int v48 = 138543362;
      id v49 = v23;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@There is no confirmation timer running, not processing the confirmation", (uint8_t *)&v48, 0xCu);
    }
  ...
  if (v11)
  {
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      int v48 = 138543362;
      id v49 = v16;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Action set execution is already in progress", (uint8_t *)&v48, 0xCu);
    }
    long long v17 = (void (**)(void *, void *))_Block_copy(v9);
    if (!v17) {
      goto LABEL_12;
...
LABEL_12:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v52 = 2112;
    uint64_t v53 = v26;
    _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Received response from %@ with %@", (uint8_t *)&v48, 0x20u);
  }
  switch(a3)
  {
    case 1uLL:
    case 4uLL:
      ...
      if (!v29)
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
        {
          ...
          int v48 = 138543362;
          id v49 = v33;
          _os_log_impl(&dword_22F52A000, v32, OS_LOG_TYPE_INFO, "%{public}@None of the devices have answered the dialog, ending the session", (uint8_t *)&v48, 0xCu);
        }
    ...
    case 2uLL:
      ...
      if (os_log_type_enabled(v40, OS_LOG_TYPE_INFO))
      {
        ...
        int v48 = 138543362;
        id v49 = v41;
        _os_log_impl(&dword_22F52A000, v40, OS_LOG_TYPE_INFO, "%{public}@User confirms to execute trigger", (uint8_t *)&v48, 0xCu);
      }
    ...
    case 3uLL:
      ...
      if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
      {
        ...
        int v48 = 138543362;
        id v49 = v44;
        _os_log_impl(&dword_22F52A000, v43, OS_LOG_TYPE_INFO, "%{public}@User confirms not to execute trigger", (uint8_t *)&v48, 0xCu);
      }
...
uint64_t __70__HMDEventTriggerExecutionSession_postponeRestoreIfWaitingForEndEvent__block_invoke(uint64_t a1)
{
  ...
  if (result == 4)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      int v7 = 138543362;
      id v8 = v6;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_INFO, "%{public}@Waiting for end event, received request to postpone the end event", (uint8_t *)&v7, 0xCu);
    }
...
void __72__HMDEventTriggerExecutionSession_cancelSessionIfWaitingForUserResponse__block_invoke(uint64_t a1)
{
  ...
  if ([*(id *)(a1 + 32) executionState] == 2)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      int v8 = 138543362;
      uint64_t v9 = v5;
      _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@Waiting for user response, received request to cancel the session", (uint8_t *)&v8, 0xCu);
    }
    uint64_t v6 = *(void **)(a1 + 32);
    int v7 = [MEMORY[0x263F087E8] hmErrorWithCode:23];
...
- (void)_executeTriggerAfterEvaluatingCondition:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v53 = 2112;
    id v54 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Going to evaluate the trigger After evaluating : %@", buf, 0x16u);
  }
  if (v4)
  {
    id v49 = @"THIS_OBJECT";
    ...
    __int16 v50 = v9;
    long long v10 = [NSDictionary dictionaryWithObjects:&v50 forKeys:&v49 count:1];
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v53 = 2112;
      id v54 = v10;
      _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Evaluating the trigger predicate using %@", buf, 0x16u);
    }
    [v4 allowEvaluation];
    ...
    if ((v16 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        __int16 v52 = v38;
        _os_log_impl(&dword_22F52A000, v37, OS_LOG_TYPE_INFO, "%{public}@Trigger condition evaluated to NO, not firing action set", buf, 0xCu);
      }
      long long v39 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:3006];
  ...
  if ([v17 count])
  {
    ...
    if (v18)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        __int16 v52 = v22;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Location triggers that contain secure action sets should ask for a confirmation before execution", buf, 0xCu);
      }
      long long v46 = 0u;
      long long v47 = 0u;
      long long v44 = 0u;
  ...
  if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    __int16 v52 = v43;
    _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_INFO, "%{public}@Directly executing action set as user confirmation is not required", buf, 0xCu);
  }
...
- (void)_evaluateFiringTrigger
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v83 = 2112;
    v84 = v6;
    _os_log_impl(&dword_22F52A000, v9, OS_LOG_TYPE_INFO, "%{public}@recurrences : %@, dateComponents: %@", buf, 0x20u);
  }
...
LABEL_6:
    ...
    if (v14)
    {
      v58 = [MEMORY[0x263F08968] strongToStrongObjectsMapTable];
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v83 = 2112;
        v84 = v57;
        _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_INFO, "%{public}@Evaluation condition : %@, Re-written predicate : %@", buf, 0x20u);
      }
      if ([v58 count])
      {
            ...
            for (uint64_t i = 0; i != v22; ++i)
            {
              ...
              if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
              {
                ...
                *(_DWORD *)buf = 138543618;
                ...
                _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_INFO, "%{public}@Going to read characteristics from accessory %@", buf, 0x16u);
              }
              long long v70 = 0u;
              long long v71 = 0u;
              long long v68 = 0u;
        ...
        long long v40 = (void *)MEMORY[0x230FBD990]([(HMDEventTriggerExecutionSession *)val setExecutionState:1]);
        uint64_t v41 = val;
        HMFGetOSLogHandle();
        ...
        if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v81 = 2048;
          uint64_t v82 = v44;
          _os_log_impl(&dword_22F52A000, v42, OS_LOG_TYPE_INFO, "%{public}@Waiting to read [%lu] characterics before executing the trigger", buf, 0x16u);
        }
    ...
    id v51 = (void *)MEMORY[0x230FBD990](v50);
    __int16 v52 = self;
    ...
    if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v53, OS_LOG_TYPE_INFO, "%{public}@EventTrigger Evaluation State : [%@]", buf, 0x16u);
    }
    return;
  }
  ...
  if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    id v80 = v48;
    _os_log_impl(&dword_22F52A000, v47, OS_LOG_TYPE_INFO, "%{public}@Trigger not fired since recurrence does not match", buf, 0xCu);
  }
  id v49 = [MEMORY[0x263F087E8] hmInternalErrorWithCode:3005];
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v27 = 2112;
      id v28 = v12;
      _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@Failed to fulfill read requests before evaluating trigger due to error (%@), (%@)", buf, 0x20u);
    }
  ...
  else
  {
    ...
    if (WeakRetained)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v27 = 2112;
        id v28 = v6;
        _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_INFO, "%{public}@Finished read requests %@ with response %@", buf, 0x20u);
      }
      BOOL v18 = [v14 workQueue];
      v21[0] = MEMORY[0x263EF8330];
      v21[1] = 3221225472;
      v21[2] = __57__HMDEventTriggerExecutionSession__evaluateFiringTrigger__block_invoke_65;
      v21[3] = &unk_264A2F820;
      v21[4] = v14;
      id v22 = *(id *)(a1 + 40);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        uint64_t v24 = v20;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Execution session is no more valid", buf, 0xCu);
      }
    }
  }
}

uint64_t __57__HMDEventTriggerExecutionSession__evaluateFiringTrigger__block_invoke_65(uint64_t a1)
{
...
- (void)setExecutionState:(unint64_t)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2114;
    char v16 = v10;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Setting the execution from %{public}@ to %{public}@", (uint8_t *)&v11, 0x20u);
  }
...
- (BOOL)needsUserConfirmationForDevice:(id)a3
{
  ...
  if (v6)
  {
    long long v7 = [v4 device];
    long long v8 = [v7 account];

    if (v8)
    {
      id v6 = [(HMDEventTriggerExecutionSession *)self causingDevices];
      v14[0] = MEMORY[0x263EF8330];
      v14[1] = 3221225472;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v18 = 2112;
        uint64_t v19 = v7;
        _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Unable to find account for causing device %@, but will still fall back to sending user confirmation", buf, 0x16u);
      }
      LOBYTE(v6) = 1;
    }
  }
...
uint64_t __66__HMDEventTriggerExecutionSession_needsUserConfirmationForDevice___block_invoke(uint64_t a1, void *a2)
{
  ...
  uint64_t v4 = [v2 isSameAccountWithDevice:v3];
...
{
  v2 = NSString;
  uint64_t v3 = [(HMDEventTriggerSession *)self logString];
  uint64_t v4 = [v2 stringWithFormat:@"[Trigger Execution Session: %@]", v3];
...
- (HMDEventTriggerExecutionSession)initWithEventTrigger:(id)a3 predicateUtilities:(id)a4 triggerEvent:(id)a5 causingDevice:(id)a6 workQueue:(id)a7 actionSets:(id)a8 evaluationCondition:(id)a9 recurrences:(id)a10 endEvents:(id)a11 msgDispatcher:(id)a12
{
  ...
  {
    v56[0] = v18;
    __int16 v25 = [MEMORY[0x263EFF8C0] arrayWithObjects:v56 count:1];
    ...
    long long v30 = (NSMutableSet *)objc_alloc_init(MEMORY[0x263EFF9C0]);
    ...
    {
      uint64_t v55 = v21;
      uint64_t v33 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v55 count:1];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_253821 != -1) {
    dispatch_once(&logCategory__hmf_once_t0_253821, &__block_literal_global_253822);
  }
  v2 = (void *)logCategory__hmf_once_v1_253823;
  return v2;
}
...
void __46__HMDEventTriggerExecutionSession_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v1_253823;
  logCategory__hmf_once_v1_253823 = v0;
}
