...
- (void)markMilestoneForPath:(id)a3
{
  ...
  v9 = [(id)objc_opt_class() uptimeNumberInMilliseconds];
  v10 = [v11 lastObject];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v10 = (void *)[v4 initWithSessionID:v5 hostProcessBundleIdentifier:v6 isSPIClient:v7 deviceSectionName:v8 description:v9];
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      id v5 = [(HMDCameraSessionID *)self sessionID];
      id v6 = [(HMDCameraSessionID *)v4 sessionID];
...
- (HMDCameraSessionID)initWithSessionID:(id)a3 message:(id)a4 description:(id)a5
{
  ...
  id v9 = a4;
  id v10 = a5;
  id v11 = +[HMDCameraSessionID hostProcessBundleIdentifierForMessage:v9];
...
+ (id)hostProcessBundleIdentifierForMessage:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (hostProcessBundleIdentifierForMessage__onceToken != -1) {
      dispatch_once(&hostProcessBundleIdentifierForMessage__onceToken, &__block_literal_global_244771);
    }
  ...
  else
  {
    ...
    id v11 = @"kDefaultCameraApplicationIdentifier";
    if (v10) {
...
void __60__HMDCameraSessionID_hostProcessBundleIdentifierForMessage___block_invoke()
{
  ...
  [v2 setObject:*MEMORY[0x263F0C7A8] forKeyedSubscript:*MEMORY[0x263F0D238]];
  uint64_t v0 = [v2 copy];
