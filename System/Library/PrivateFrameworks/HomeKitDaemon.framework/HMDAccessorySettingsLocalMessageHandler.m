  ...
  if ([v4 isRemote])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v16 = 2112;
        v17 = v5;
        _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to get caller version from remote source device: %@", (uint8_t *)&v14, 0x16u);
      }
    }
  }
  else
...
LABEL_7:
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, v14, (uint8_t *)&v16, 0xCu);
    }
  }
  else
  {
...
- (void)handleAccessorySettingsUpdateRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v39 = 2112;
    id v40 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling accessory settings update request message: %@", buf, 0x16u);
  }
  unint64_t v9 = [v4 messagePayload];
  if (v9)
  {
    v10 = (void *)[objc_alloc(MEMORY[0x263F0E070]) initWithPayload:v9];
    if (v10)
    {
      ...
      if (v11)
      {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543362;
              v38 = v36;
              _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_ERROR, "%{public}@Failed to update setting due to no delegate", buf, 0xCu);
            }
            int v14 = [MEMORY[0x263F087E8] hmfErrorWithCode:4];
        ...
        else
        {
          ...
          if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            v38 = v32;
            _os_log_impl(&dword_22F52A000, v31, OS_LOG_TYPE_ERROR, "%{public}@Failed to update setting as unable to determine setting value from payload", buf, 0xCu);
          }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543362;
          v38 = v28;
          _os_log_impl(&dword_22F52A000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to update setting due no caller version", buf, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v39 = 2112;
        id v40 = v9;
        _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to create update request payload with message payload: %@", buf, 0x16u);
      }
      v11 = [MEMORY[0x263F087E8] hmfErrorWithCode:3];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v38 = v20;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to update settings due to no payload found on message", buf, 0xCu);
    }
...
- (id)siriAvailableLanguagesSetting
{
  ...
  id v4 = (void *)[objc_alloc(MEMORY[0x263F0E420]) initWithKeyPath:@"root.siri.availableLanguages" readOnly:1 languageValues:v3];
  return v4;
}
...
- (void)handleAccessorySettingsFetchRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v52 = 2112;
    id v53 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling accessory settings fetch request message: %@", buf, 0x16u);
  }
  unint64_t v9 = [v4 messagePayload];
  if (v9)
  {
    v10 = (void *)[objc_alloc(MEMORY[0x263F0E058]) initWithPayload:v9];
    if (!v10)
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v52 = 2112;
        id v53 = v9;
        _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to create fetch request payload with message payload: %@", buf, 0x16u);
      }
      v11 = [MEMORY[0x263F087E8] hmfErrorWithCode:3];
      [v4 respondWithError:v11];
      goto LABEL_32;
    ...
    if (v11)
    {
          ...
          if ([v32 containsObject:@"root.siri.availableLanguages"])
          {
            ...
            if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
            {
              ...
              *(_DWORD *)buf = 138543362;
              ...
              v47 = v33;
              v37 = (void *)v36;
              _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_INFO, "%{public}@Fetching siri available language setting", buf, 0xCu);
        ...
        else
        {
          ...
          if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543362;
            ...
            _os_log_impl(&dword_22F52A000, v41, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch settings due to no delegate", buf, 0xCu);
          }
          v32 = [MEMORY[0x263F087E8] hmfErrorWithCode:4];
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v52 = 2112;
        id v53 = v14;
        _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch settings due caller privilege data sourcing error: %@", buf, 0x16u);
      }
    }
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
      {
        ...
        *(_DWORD *)buf = 138543362;
        ...
        _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to fetch settings due no caller version", buf, 0xCu);
      }
      int v14 = [MEMORY[0x263F087E8] hmfErrorWithCode:4];
    }
    [v4 respondWithError:v14];
...
LABEL_32:
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 138543362;
    ...
    _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to get payload on fetch request message", buf, 0xCu);
  }
  v10 = [MEMORY[0x263F087E8] hmfErrorWithCode:8];
  [v4 respondWithError:v10];
LABEL_33:
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t16_130017 != -1) {
    dispatch_once(&logCategory__hmf_once_t16_130017, &__block_literal_global_130018);
  }
  v2 = (void *)logCategory__hmf_once_v17_130019;
  return v2;
}
...
void __54__HMDAccessorySettingsLocalMessageHandler_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v17_130019;
  logCategory__hmf_once_v17_130019 = v0;
}
