...
LABEL_7:
    ...
    return (HMDCameraRecordingAnalysisNode *)+[HMDMemoryDiagnostic _nextLevelFromPreviousLevel:v17];
  }
  v18.receiver = self;
  v18.super_class = (Class)HMDCameraRecordingAnalysisNode;
  v10 = [(HMDCameraRecordingAnalysisNode *)&v18 init];
  v11 = v10;
  if (v10)
  {
