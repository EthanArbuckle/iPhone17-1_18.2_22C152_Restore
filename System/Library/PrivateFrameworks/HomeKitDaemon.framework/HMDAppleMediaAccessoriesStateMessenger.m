...
- (void)handleAppleMediaAccessoryModelIdentifierRequestMessage:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v27 = 2112;
    id v28 = v4;
    _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling apple media accessory model identifier request message: %@", (uint8_t *)&v25, 0x16u);
  }
  ...
  if (v9)
  {
    ...
    if (v10)
    {
      ...
      else
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
        {
          ...
          int v25 = 138543362;
          v26 = v24;
          _os_log_impl(&dword_22F52A000, v23, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify delegate of model identifier request message due to no delegate", (uint8_t *)&v25, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        __int16 v27 = 2112;
        id v28 = v9;
        _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_ERROR, "%{public}@Failed to get model identifier request payload from payload: %@", (uint8_t *)&v25, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v27 = 2112;
      id v28 = v4;
      _os_log_impl(&dword_22F52A000, v15, OS_LOG_TYPE_ERROR, "%{public}@Failed to get message payload from model identifier request message: %@", (uint8_t *)&v25, 0x16u);
    }
...
- (NSUUID)messageTargetUUID
{
  v3 = (void *)[objc_alloc(MEMORY[0x263F08C38]) initWithUUIDString:@"8218CC5D-C283-4FE6-9E57-848EF1092455"];
...
- (id)relayMessageName:(id)a3 payload:(id)a4 toAppleMediaAccessory:(id)a5
{
  ...
  if (v12)
  {
    ...
    v28[3] = &unk_264A2F0C8;
    id v29 = v11;
    v17 = (void *)MEMORY[0x230FBD990]([v16 setResponseHandler:v28]);
    v18 = self;
    v19 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v34 = 2112;
      id v35 = v10;
      _os_log_impl(&dword_22F52A000, v19, OS_LOG_TYPE_INFO, "%{public}@Relaying message: %@ to accessory: %@", buf, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      __int16 v36 = 2112;
      id v37 = v10;
      _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_INFO, "%{public}@Failed to get device to relay message name: %@ payload: %@ to apple media accessory: %@", buf, 0x2Au);
    }
    v15 = [MEMORY[0x263F087E8] hmfErrorWithCode:4];
...
void __89__HMDAppleMediaAccessoriesStateMessenger_relayMessageName_payload_toAppleMediaAccessory___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  else
  {
    ...
    if (!v7)
    {
      uint64_t v6 = [MEMORY[0x263F087E8] hmfErrorWithCode:15];
    }
    id v7 = (id)v6;
...
- (void)sendModelIdentifierRequestMessageToAppleMediaAccessory:(id)a3 withAccessoryIdentifier:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v31 = 2112;
    id v32 = v9;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_INFO, "%{public}@Sending model identifier request message to apple media accessory: %@ accessory identifier: %@", buf, 0x20u);
  }
...
void __132__HMDAppleMediaAccessoriesStateMessenger_sendModelIdentifierRequestMessageToAppleMediaAccessory_withAccessoryIdentifier_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v10 = 2112;
    id v11 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Relay model identifier request payload completed with error: %@", (uint8_t *)&v8, 0x16u);
  }
...
void __132__HMDAppleMediaAccessoriesStateMessenger_sendModelIdentifierRequestMessageToAppleMediaAccessory_withAccessoryIdentifier_completion___block_invoke_14(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v19 = 2112;
    id v20 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Relay model identifier request payload completed with response payload: %@", (uint8_t *)&v17, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v19 = 2112;
      id v20 = v3;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode model identifier response payload: %@", (uint8_t *)&v17, 0x16u);
    }
...
- (void)registerForMessagesWithHome:(id)a3
{
  ...
  v15[1] = v10;
  v15[2] = v11;
  v14 = [MEMORY[0x263EFF8C0] arrayWithObjects:v15 count:3];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7_222918 != -1) {
    dispatch_once(&logCategory__hmf_once_t7_222918, &__block_literal_global_222919);
  }
  v2 = (void *)logCategory__hmf_once_v8_222920;
  return v2;
}
...
void __53__HMDAppleMediaAccessoriesStateMessenger_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v8_222920;
  logCategory__hmf_once_v8_222920 = v0;
}
