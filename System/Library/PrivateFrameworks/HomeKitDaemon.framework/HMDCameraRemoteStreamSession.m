...
- (void)updateState:(int64_t)a3
{
  ...
  v5 = (void *)MEMORY[0x230FBD990]([(HMDCameraRemoteStreamSession *)self setStreamState:[(HMDCameraRemoteStreamSession *)self streamState] | a3]);
  BOOL v6 = self;
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_137923 != -1) {
    dispatch_once(&logCategory__hmf_once_t1_137923, &__block_literal_global_137924);
  }
  v2 = (void *)logCategory__hmf_once_v2_137925;
  return v2;
}
...
void __43__HMDCameraRemoteStreamSession_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v2_137925;
  logCategory__hmf_once_v2_137925 = v0;
}
