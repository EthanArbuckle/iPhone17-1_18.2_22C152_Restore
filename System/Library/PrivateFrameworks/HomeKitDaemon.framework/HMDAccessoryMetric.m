    ...
    if (!v5)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543362;
        v51 = v12;
        _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_INFO, "%{public}@Accessory disappeared, stopping accessory metric timer", buf, 0xCu);
      }
...
- (void)_initDiagnosticCounters
{
  ...
  uint64_t v3 = *MEMORY[0x263F49860];
  v19[0] = *MEMORY[0x263F49858];
  v19[1] = v3;
  uint64_t v4 = *MEMORY[0x263F498C0];
  v19[2] = *MEMORY[0x263F498B8];
  v19[3] = v4;
  uint64_t v5 = *MEMORY[0x263F498D8];
  v19[4] = *MEMORY[0x263F498D0];
  v19[5] = v5;
  uint64_t v6 = *MEMORY[0x263F498E8];
  v19[6] = *MEMORY[0x263F498E0];
  v19[7] = v6;
  uint64_t v7 = *MEMORY[0x263F49888];
  v19[8] = *MEMORY[0x263F498F0];
  v19[9] = v7;
  uint64_t v8 = *MEMORY[0x263F49880];
  v19[10] = *MEMORY[0x263F49878];
  v19[11] = v8;
  uint64_t v9 = *MEMORY[0x263F49898];
  v19[12] = *MEMORY[0x263F49890];
  v19[13] = v9;
  uint64_t v10 = *MEMORY[0x263F498A8];
  v19[14] = *MEMORY[0x263F498A0];
  v19[15] = v10;
  v11 = [MEMORY[0x263EFF8C0] arrayWithObjects:v19 count:16];
...
- (HMDAccessoryMetric)initWithAccessory:(id)a3
{
  ...
  if (v5)
  {
    ...
    uint64_t v17 = [objc_alloc(MEMORY[0x263F42658]) initWithTimeInterval:4 options:v5->_timerInterval];
    ...
    uint64_t v19 = (void *)MEMORY[0x230FBD990]([(HMDAccessoryMetric *)v5 _initDiagnosticCounters]);
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@[AccessoryMetric] Initialized session metric for accessory with submission interval: %f", buf, 0x16u);
    }
  }
  return v5;
}
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_96453 != -1) {
    dispatch_once(&logCategory__hmf_once_t4_96453, &__block_literal_global_148_96454);
  }
  v2 = (void *)logCategory__hmf_once_v5_96455;
  return v2;
}
...
void __33__HMDAccessoryMetric_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v5_96455;
  logCategory__hmf_once_v5_96455 = v0;
}
