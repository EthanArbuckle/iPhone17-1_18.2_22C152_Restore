  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(HMDRemoteEventRouterProtoEventsMessage *)self addEvents:*(void *)(*((void *)&v19 + 1) + 8 * v9++)];
      }
      while (v7 != v9);
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[HMDRemoteEventRouterProtoEventsMessage addCachedEvents:](self, "addCachedEvents:", *(void *)(*((void *)&v15 + 1) + 8 * v14++), (void)v15);
      }
      while (v12 != v14);
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v12 clearEvents];
    unint64_t v4 = [(HMDRemoteEventRouterProtoEventsMessage *)self eventsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        uint64_t v7 = [(HMDRemoteEventRouterProtoEventsMessage *)self eventsAtIndex:i];
        [v12 addEvents:v7];
      }
    }
  }
  if ([(HMDRemoteEventRouterProtoEventsMessage *)self cachedEventsCount])
  {
    ...
    unint64_t v8 = [(HMDRemoteEventRouterProtoEventsMessage *)self cachedEventsCount];
    if (v8)
    {
      unint64_t v9 = v8;
      for (uint64_t j = 0; j != v9; ++j)
      {
        uint64_t v11 = [(HMDRemoteEventRouterProtoEventsMessage *)self cachedEventsAtIndex:j];
...
- (BOOL)readFrom:(id)a3
{
  return HMDRemoteEventRouterProtoEventsMessageReadFrom(self, (uint64_t)a3);
}
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = objc_msgSend(objc_alloc(MEMORY[0x263EFF980]), "initWithCapacity:", -[NSMutableArray count](self->_events, "count"));
    long long v23 = 0u;
    long long v24 = 0u;
    long long v25 = 0u;
    long long v26 = 0u;
  ...
  {
    uint64_t v11 = objc_msgSend(objc_alloc(MEMORY[0x263EFF980]), "initWithCapacity:", -[NSMutableArray count](self->_cachedEvents, "count"));
    long long v19 = 0u;
    long long v20 = 0u;
    long long v21 = 0u;
    long long v22 = 0u;
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = (Class)HMDRemoteEventRouterProtoEventsMessage;
  id v4 = [(HMDRemoteEventRouterProtoEventsMessage *)&v8 description];
  unint64_t v5 = [(HMDRemoteEventRouterProtoEventsMessage *)self dictionaryRepresentation];
