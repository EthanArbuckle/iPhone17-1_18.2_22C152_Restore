...
+ (void)configureKeyedArchiverClassMappings
{
  [MEMORY[0x263F08910] setClassName:@"HMDAccessory" forClass:objc_opt_class()];
  [MEMORY[0x263F08928] setClass:objc_opt_class() forClassName:@"HMDAccessory"];
  [MEMORY[0x263F08910] setClassName:@"HMDCharacteristicNotificationRegistry" forClass:objc_opt_class()];
  [MEMORY[0x263F08928] setClass:objc_opt_class() forClassName:@"HMDCharacteristicNotificationRegistry"];
  [MEMORY[0x263F08928] setClass:objc_opt_class() forClassName:@"HMDWHAAccessory"];
  [MEMORY[0x263F08928] setClass:objc_opt_class() forClassName:@"HMDMediaSystemExtended"];
  [MEMORY[0x263F08928] setClass:objc_opt_class() forClassName:@"HMDMediaSystemExtendedV2"];
