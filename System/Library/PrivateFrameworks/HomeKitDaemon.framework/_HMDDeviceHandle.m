  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v16 = v12;
      _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_ERROR, "%{public}@Missing required parameter 'identifier'", buf, 0xCu);
    }
    v9 = 0;
  }
...
- (NSString)destination
{
  ...
  SEL v6 = [v4 stringWithFormat:@"You must override %@ in a subclass", v5];
...
- (_HMDDeviceHandle)init
{
  ...
  id v4 = NSString;
  id v5 = NSStringFromSelector(a2);
  SEL v6 = [v4 stringWithFormat:@"%@ is unavailable", v5];
  id v7 = [v2 exceptionWithName:v3 reason:v6 userInfo:0];
...
+ (NSUUID)identifierNamespace
{
  if (identifierNamespace_onceToken != -1) {
    dispatch_once(&identifierNamespace_onceToken, &__block_literal_global_34849);
  }
  v2 = (void *)identifierNamespace_namespace;
  return (NSUUID *)v2;
}
