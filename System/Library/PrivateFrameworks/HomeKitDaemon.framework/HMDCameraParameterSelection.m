...
+ (id)logCategory
{
  if (logCategory__hmf_once_t6_194908 != -1) {
    dispatch_once(&logCategory__hmf_once_t6_194908, &__block_literal_global_194909);
  }
  v2 = (void *)logCategory__hmf_once_v7_194910;
  return v2;
}
...
void __42__HMDCameraParameterSelection_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v7_194910;
  logCategory__hmf_once_v7_194910 = v0;
}
...
+ (id)_selectedCryptoSuiteFromCameraCryptoSuites:(id)a3
{
  ...
  id v4 = a3;
  id v5 = +[HMDSRTPCryptoSuite arrayWithSuites:&unk_26E4743B0];
  ...
  if (isInternalBuild() && v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      int v20 = 138543362;
      v21 = v13;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_INFO, "%{public}@Making SRTP camera stream unencrypted", (uint8_t *)&v20, 0xCu);
    }
...
+ (id)selectedSRTPParametersFromCryptoSuites:(id)a3
{
  ...
  if (v5)
  {
    ...
    v12 = [MEMORY[0x263EFF990] dataWithLength:v11];
    v13 = [MEMORY[0x263EFF990] dataWithLength:v10];
    v14 = (const __SecRandom *)*MEMORY[0x263F17510];
          ...
          SecRandomCopyBytes(v14, v17, (void *)[v18 mutableBytes])))
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        int v29 = 138543362;
        v30 = v22;
        _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to generate random bytes", (uint8_t *)&v29, 0xCu);
      }
      v23 = 0;
    }
    else
  ...
  else
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      int v29 = 138543362;
      v30 = v27;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to select Crypto Suite", (uint8_t *)&v29, 0xCu);
    }
    v23 = 0;
  }
...
LABEL_20:
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543874;
    ...
    __int16 v50 = 2112;
    id v51 = v15;
    _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_INFO, "%{public}@Local preference is set for %@, replying the same as filtered: %@", buf, 0x20u);
  }
  id v22 = v15;
LABEL_22:
