...
- (id)attributeDescriptions
{
  ...
  v4 = [(HMDCHIPControllerResidentNodeStorage *)self keyValueStore];
  ...
  if (v5)
  {
    ...
    v7 = NSNumber;
    v8 = [(HMDCHIPControllerResidentNodeStorage *)self keyValueStore];
...
{
  v2 = NSString;
  v3 = [(HMDCHIPControllerResidentNodeStorage *)self keyValueStore];
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = [+[HMDCHIPControllerResidentNodeStorage allocWithZone:a3] init];
  uint64_t v5 = [(HMDCHIPControllerResidentNodeStorage *)self keyValueStore];
  [(HMDCHIPControllerResidentNodeStorage *)v4 setKeyValueStore:v5];
...
- (unint64_t)hash
{
  v2 = [(HMDCHIPControllerResidentNodeStorage *)self keyValueStore];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v6)
  {
    v7 = [(HMDCHIPControllerResidentNodeStorage *)self keyValueStore];
    v8 = [v6 keyValueStore];
...
- (NSDictionary)debugDictionaryRepresentation
{
  ...
  id v4 = [(HMDCHIPControllerResidentNodeStorage *)self keyValueStore];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_268489 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_268489, &__block_literal_global_268490);
  }
  v2 = (void *)logCategory__hmf_once_v4_268491;
  return v2;
}
...
void __51__HMDCHIPControllerResidentNodeStorage_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_268491;
  logCategory__hmf_once_v4_268491 = v0;
}
