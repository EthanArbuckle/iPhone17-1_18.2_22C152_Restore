...
- (void)finishWithResult:(id)a3 error:(id)a4
{
  ...
  if (self->_finished)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v25 = v21;
      _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Finished more than once!", buf, 0xCu);
    }
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v26 = 2112;
      id v27 = v7;
      _os_log_impl(&dword_22F52A000, v12, OS_LOG_TYPE_ERROR, "%{public}@Fetch failed with error: %@", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      v25 = v17;
      _os_log_impl(&dword_22F52A000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Fetch succeeded", buf, 0xCu);
    }
...
- (void)setShouldRetry:(BOOL)a3
{
  if (a3)
  {
    if (self->_retryIntervalSeconds == *MEMORY[0x263F49248]) {
      self->_retryIntervalSeconds = 0.0;
    }
  }
  else
  {
    self->_retryIntervalSeconds = *(double *)MEMORY[0x263F49248];
  }
}
...
- (BOOL)shouldRetry
{
  ...
  if ([(HMDNetworkRouterFirewallRuleManagerBackingStoreFetchHelper *)self retryCount] <= v3)
  {
    ...
    if (!v10) {
      return self->_retryIntervalSeconds != *MEMORY[0x263F49248];
    }
...
LABEL_9:
      _os_log_impl(&dword_22F52A000, v7, OS_LOG_TYPE_ERROR, v9, buf, 0x16u);
    }
  }
...
- (void)dealloc
{
  ...
  if (!self->_finished)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_FAULT))
    {
      ...
      *(_DWORD *)buf = 138543362;
      uint64_t v11 = v6;
      _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Forgot to call finishWithError", buf, 0xCu);
    }
...
- (HMDNetworkRouterFirewallRuleManagerBackingStoreFetchHelper)initWithActivity:(id)a3 options:(id)a4 container:(id)a5 useAnonymousRequests:(BOOL)a6 promise:(id)a7
{
  ...
  id v13 = a4;
  id v14 = a7;
  int64_t v15 = (objc_class *)MEMORY[0x263EFD778];
  id v16 = a5;
  ...
  id v18 = objc_alloc_init(MEMORY[0x263EFD780]);
  v19 = [v13 label];
  [v18 setName:v19];
  ...
  if (v20)
  {
    ...
    v21->_retryIntervalSeconds = *(double *)MEMORY[0x263F49248];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0 != -1) {
    dispatch_once(&logCategory__hmf_once_t0, &__block_literal_global_636);
  }
