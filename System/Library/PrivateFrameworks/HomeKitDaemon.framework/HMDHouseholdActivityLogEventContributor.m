...
+ (id)logCategory
{
  if (logCategory__hmf_once_t2_33858 != -1) {
    dispatch_once(&logCategory__hmf_once_t2_33858, &__block_literal_global_33859);
  }
  v2 = (void *)logCategory__hmf_once_v3_33860;
  return v2;
}
...
void __54__HMDHouseholdActivityLogEventContributor_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v3_33860;
  logCategory__hmf_once_v3_33860 = v0;
}
