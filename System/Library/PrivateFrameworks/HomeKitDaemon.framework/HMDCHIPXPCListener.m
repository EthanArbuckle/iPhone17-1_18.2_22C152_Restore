...
- (BOOL)listener:(id)a3 shouldAcceptNewConnection:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v49 = 2112;
    id v50 = v7;
    _os_log_impl(&dword_22F52A000, v10, OS_LOG_TYPE_INFO, "%{public}@New CHIP XPC connection requested: %@", buf, 0x16u);
  }
  if (v7)
  {
    [v7 auditToken];
    ...
    if (v15)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v49 = 2112;
        id v50 = v24;
        _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_INFO, "%{public}@XPC connect entitlement for background mode: %@", buf, 0x16u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
      {
        ...
        *(_DWORD *)buf = 138543618;
        ...
        __int16 v49 = 2112;
        id v50 = v7;
        _os_log_impl(&dword_22F52A000, v39, OS_LOG_TYPE_INFO, "%{public}@XPC connection does not have public HomeKit entitlement: %@", buf, 0x16u);
      }
    }
  }
  else
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v49 = 2112;
      id v50 = v7;
      _os_log_impl(&dword_22F52A000, v35, OS_LOG_TYPE_DEFAULT, "%{public}@XPC connection has no permission to access Home data: %@", buf, 0x16u);
    }
    char v15 = 0;
  }
...
void __57__HMDCHIPXPCListener_listener_shouldAcceptNewConnection___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v19 = 1024;
    int v20 = v6;
    _os_log_impl(&dword_22F52A000, v4, OS_LOG_TYPE_INFO, "%{public}@CHIP XPC client invalidated: %d", buf, 0x12u);
  }
...
- (void)start
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    int v8 = 138543362;
    id v9 = v6;
    _os_log_impl(&dword_22F52A000, v5, OS_LOG_TYPE_DEBUG, "%{public}@Starting CHIP XPC listener", (uint8_t *)&v8, 0xCu);
  }
...
- (HMDCHIPXPCListener)initWithHomeManager:(id)a3
{
  ...
  if (v5)
  {
    ...
    uint64_t v13 = [v12 initWithMachServiceName:*MEMORY[0x263F0DE90]];
    listener = v6->_listener;
    v6->_listener = (NSXPCListener *)v13;

    [(NSXPCListener *)v6->_listener _setQueue:v6->_workQueue];
    [(NSXPCListener *)v6->_listener setDelegate:v6];
    uint64_t v15 = [MEMORY[0x263F08D80] interfaceWithProtocol:&unk_26E58C3F8];
    exportedInterface = v6->_exportedInterface;
    v6->_exportedInterface = (NSXPCInterface *)v15;

    uint64_t v17 = [MEMORY[0x263F08D80] interfaceWithProtocol:&unk_26E616950];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t11 != -1) {
    dispatch_once(&logCategory__hmf_once_t11, &__block_literal_global_7649);
  }
