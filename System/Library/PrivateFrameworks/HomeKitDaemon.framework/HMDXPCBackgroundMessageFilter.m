...
LABEL_19:
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
          {
            ...
            int v27 = 138543362;
            v28 = v21;
            _os_log_impl(&dword_22F52A000, v20, OS_LOG_TYPE_ERROR, "%{public}@Handler does not support background access", (uint8_t *)&v27, 0xCu);
          }
          if (a5)
          {
            *a5 = [MEMORY[0x263F087E8] hmErrorWithCode:80 description:0 reason:@"Handler does not support background access" suggestion:0];
          }
        }
        else
        {
          ...
          if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
          {
            ...
            int v27 = 138543362;
            v28 = v25;
            _os_log_impl(&dword_22F52A000, v24, OS_LOG_TYPE_ERROR, "%{public}@Missing background policy", (uint8_t *)&v27, 0xCu);
          }
        }
        int64_t v12 = -1;
        goto LABEL_19;
