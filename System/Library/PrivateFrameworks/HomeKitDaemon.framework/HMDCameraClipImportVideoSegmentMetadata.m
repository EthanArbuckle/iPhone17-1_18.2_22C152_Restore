  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v32 = 2112;
      id v33 = v4;
      _os_log_impl(&dword_22F52A000, v18, OS_LOG_TYPE_ERROR, "%{public}@Could not find resourcePath in video segment metadata: %@", buf, 0x16u);
    }
    goto LABEL_17;
  }
  v7 = (void *)v6;
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v32 = 2112;
      id v33 = v4;
      _os_log_impl(&dword_22F52A000, v22, OS_LOG_TYPE_ERROR, "%{public}@Could not find isHeader in video segment metadata: %@", buf, 0x16u);
    }
    goto LABEL_16;
  }
  v9 = (void *)v8;
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v32 = 2112;
      id v33 = v4;
      _os_log_impl(&dword_22F52A000, v26, OS_LOG_TYPE_ERROR, "%{public}@Could not find duration in video segment metadata: %@", buf, 0x16u);
    }
