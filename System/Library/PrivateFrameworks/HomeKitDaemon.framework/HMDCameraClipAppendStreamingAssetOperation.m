...
- (void)timerDidFire:(id)a3
{
  ...
  if (v5 == v4)
  {
    if (v9)
    {
      ...
      int v13 = 138543362;
      objc_super v14 = v12;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Retry timer fired for append", (uint8_t *)&v13, 0xCu);
    }
  ...
  else
  {
    if (v9)
    {
      ...
      int v13 = 138543362;
      objc_super v14 = v10;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_INFO, "%{public}@Operation timed out, cancelling", (uint8_t *)&v13, 0xCu);
    }
    v11 = [MEMORY[0x263F087E8] hmfErrorWithCode:13];
...
- (id)_retryDelayForError:(id)a3
{
        ...
        v5))
  {
    ...
    {
      id v8 = [v3 userInfo];
      v7 = objc_msgSend(v8, "hmf_numberForKey:", *MEMORY[0x263EFD4A0]);
    }
  }
  else
  {
...
- (id)_updateClipModel:(id)a3 usingStreamingAsset:(id)a4
{
  ...
  id v6 = a3;
  id v7 = a4;
  id v8 = (void *)[objc_alloc(MEMORY[0x263F49340]) initWithUploadStreamingAsset:v7];
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
  {
    ...
    *(_DWORD *)buf = 138543362;
    v36 = v30;
    _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_INFO, "%{public}@Submitting clip model update", buf, 0xCu);
  }
...
id __83__HMDCameraClipAppendStreamingAssetOperation__updateClipModel_usingStreamingAsset___block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      int v13 = 138543362;
      double v14 = v9;
      _os_log_impl(&dword_22F52A000, v8, OS_LOG_TYPE_ERROR, "%{public}@No mirrorOutputResult available for clip update, failing operation", (uint8_t *)&v13, 0xCu);
    }
...
- (void)main
{
  ...
  v12[1] = v12;
  v12[2] = 0x3032000000;
  v12[3] = __Block_byref_object_copy__177032;
  v12[4] = __Block_byref_object_dispose__177033;
  id v13 = 0;
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      _os_log_impl(&dword_22F52A000, v21, OS_LOG_TYPE_INFO, "%{public}@Appending %lu bytes of data to streaming asset", buf, 0x16u);
    }
    id v23 = objc_alloc_init(MEMORY[0x263F58190]);
    v24 = (void *)[objc_alloc(MEMORY[0x263EFD860]) initWithStreamingAsset:v10];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138544130;
      ...
      id v43 = v7;
      id v32 = v41;
      _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_ERROR, "%{public}@Property \"%@\" was of unexpected class %@: %@", buf, 0x2Au);
    }
    v33 = (void *)MEMORY[0x263F58190];
    v10 = [MEMORY[0x263F087E8] hmfErrorWithCode:3];
...
id __50__HMDCameraClipAppendStreamingAssetOperation_main__block_invoke_28(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v10 = 138543362;
    v11 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully appended to streaming asset", (uint8_t *)&v10, 0xCu);
  }
...
void __50__HMDCameraClipAppendStreamingAssetOperation_main__block_invoke_30(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    int v8 = 138543362;
    id v9 = v7;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully updated clip model with updated streaming asset", (uint8_t *)&v8, 0xCu);
  }
  [*(id *)(a1 + 32) finish];
}
...
void __50__HMDCameraClipAppendStreamingAssetOperation_main__block_invoke_32(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v29 = 2112;
    id v30 = v3;
    _os_log_impl(&dword_22F52A000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to append to streaming asset: %@", (uint8_t *)&v27, 0x16u);
  }
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v29 = 2112;
      id v30 = v9;
      _os_log_impl(&dword_22F52A000, v14, OS_LOG_TYPE_INFO, "%{public}@Retrying failed append in %@ seconds", (uint8_t *)&v27, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      int v27 = 138543362;
      id v28 = v26;
      _os_log_impl(&dword_22F52A000, v25, OS_LOG_TYPE_ERROR, "%{public}@Unable to retry append operation, canceling", (uint8_t *)&v27, 0xCu);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t12_177078 != -1) {
    dispatch_once(&logCategory__hmf_once_t12_177078, &__block_literal_global_177079);
  }
  v2 = (void *)logCategory__hmf_once_v13_177080;
  return v2;
}
...
void __57__HMDCameraClipAppendStreamingAssetOperation_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v13_177080;
  logCategory__hmf_once_v13_177080 = v0;
}
