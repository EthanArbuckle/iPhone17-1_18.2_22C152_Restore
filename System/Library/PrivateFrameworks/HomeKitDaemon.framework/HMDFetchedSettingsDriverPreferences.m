...
- (void)updateSettingWithKeyPath:(id)a3 primaryUserInfo:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v18 = 2112;
    id v19 = v8;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Primary user info is not supported for keyPath: %@", (uint8_t *)&v16, 0x16u);
  }
  v15 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
  v10[2](v10, v15);
}
...
- (void)updateSettingWithKeyPath:(id)a3 languageSettingValue:(id)a4 completion:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    ...
    __int16 v18 = 2112;
    id v19 = v8;
    _os_log_impl(&dword_22F52A000, v13, OS_LOG_TYPE_ERROR, "%{public}@Only BOOL settings are supported keyPath: %@", (uint8_t *)&v16, 0x16u);
  }
  v15 = [MEMORY[0x263F087E8] hmErrorWithCode:48];
  v10[2](v10, v15);
}
...
- (void)updateSettingWithKeyPath:(id)a3 integerSettingValue:(id)a4 completion:(id)a5
{
  ...
  char v13 = [MEMORY[0x263F0E048] isKeyPathForConstrainedNumberSettingType:v8];
  ...
  if (v13)
  {
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *(_DWORD *)buf = 138543874;
      ...
      __int16 v60 = 2112;
      id v61 = v9;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Updating %{public}@ to %@", buf, 0x20u);
    }
    if (self) {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v60 = 2112;
        id v61 = v33;
        _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_DEFAULT, "%{public}@Changing %{public}@ to %@", buf, 0x20u);
      ...
      v11[2](v11, 0);
      v38 = [MEMORY[0x263F0E048] defaultSettingsConstraintsForKeyPath:v54];
      if (v38)
      {
        id v52 = objc_alloc(MEMORY[0x263F0E138]);
        ...
        v55 = v47;
        v49 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v55 count:1];
        v50 = v43;
        id v8 = v54;
  ...
  else
  {
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v58 = 2114;
      id v59 = v8;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Key %{public}@ not part of expected integer keys", buf, 0x16u);
    }
    v22 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
...
- (void)updateSettingWithKeyPath:(id)a3 BOOLSettingValue:(id)a4 completion:(id)a5
{
  ...
  dispatch_assert_queue_V2(Property);
  char v13 = [MEMORY[0x263F0E048] isKeyPathForBooleanSettingType:v8];
  v14 = (void *)MEMORY[0x230FBD990]();
  v15 = self;
  int v16 = HMFGetOSLogHandle();
  v17 = v16;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *(_DWORD *)buf = 138543874;
        ...
        __int16 v43 = 2112;
        id v44 = v9;
        _os_log_impl(&dword_22F52A000, v29, OS_LOG_TYPE_DEFAULT, "%{public}@Changing %{public}@ to %@", buf, 0x20u);
      }
      if (self) {
      ...
      v11[2](v11, 0);
      v34 = objc_msgSend(objc_alloc(MEMORY[0x263F0E130]), "initWithKeyPath:readOnly:BOOLValue:", v8, 0, objc_msgSend(v9, "BOOLValue"));
      v35 = [(HMDFetchedSettingsDriverPreferences *)v28 delegate];
      v38 = v34;
      id v36 = [MEMORY[0x263EFF8C0] arrayWithObjects:&v38 count:1];
  ...
  else
  {
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 138543618;
      ...
      __int16 v41 = 2114;
      id v42 = v8;
      _os_log_impl(&dword_22F52A000, v17, OS_LOG_TYPE_ERROR, "%{public}@Key %{public}@ not part of expected BOOL keys", buf, 0x16u);
    }
    v22 = [MEMORY[0x263F087E8] hmErrorWithCode:2];
    ((void (**)(id, void *))v11)[2](v11, v22);
  }
...
- (void)fetchSettingsForKeyPaths:(id)a3 completion:(id)a4
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
  {
    ...
    *(_DWORD *)buf = 138543618;
    ...
    __int16 v83 = 2114;
    id v84 = v6;
    _os_log_impl(&dword_22F52A000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Got fetch request for keyPaths:%{public}@", buf, 0x16u);
  }
  v71 = objc_msgSend(MEMORY[0x263EFF980], "arrayWithCapacity:", objc_msgSend(v6, "count"));
  long long v76 = 0u;
  long long v77 = 0u;
  long long v78 = 0u;
  long long v79 = 0u;
  ...
  do
  {
    ...
    do
    {
      ...
      if (!v22)
      {
        ...
        if (os_log_type_enabled(v34, OS_LOG_TYPE_ERROR))
        {
          ...
          *(_DWORD *)buf = 138543618;
          ...
          __int16 v83 = 2114;
          id v84 = v17;
          _os_log_impl(&dword_22F52A000, v34, OS_LOG_TYPE_ERROR, "%{public}@Key %{public}@ not found", buf, 0x16u);

          v15 = v35;
          unint64_t v14 = 0x263F0E000;
        }
      ...
      if ([*(id *)(v14 + 72) isKeyPathForBooleanSettingType:v17])
      {
        if (self) {
        ...
        int v26 = (void *)[objc_alloc(MEMORY[0x263F0E130]) initWithKeyPath:v17 readOnly:0 BOOLValue:v25];
        v27 = (void *)MEMORY[0x230FBD990]();
        v28 = v10;
        v29 = HMFGetOSLogHandle();
        v30 = v29;
        if (v26)
        {
          if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v83 = 2114;
            id v84 = v17;
            _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_DEFAULT, "%{public}@BOOL %{public}@", buf, 0x16u);
        ...
        else
        {
          if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v83 = 2114;
            id v84 = v17;
            _os_log_impl(&dword_22F52A000, v30, OS_LOG_TYPE_ERROR, "%{public}@Boolean data type for Key %{public}@ had no integer setting", buf, 0x16u);
          }
          uint64_t v59 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
      ...
      {
        if (![*(id *)(v14 + 72) isKeyPathForConstrainedNumberSettingType:v17])
        {
          ...
          if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v83 = 2114;
            id v84 = v17;
            _os_log_impl(&dword_22F52A000, v55, OS_LOG_TYPE_ERROR, "%{public}@Data type of key %{public}@ is neither a BOOL nor a number", buf, 0x16u);
...
LABEL_36:
        ...
        int v26 = [*(id *)(v14 + 72) defaultSettingsConstraintsForKeyPath:v17];
        if (v26)
        {
          v70 = v15;
          if (self) {
          ...
          id v41 = objc_alloc(MEMORY[0x263F0E138]);
          ...
          if (v47)
          {
            if (os_log_type_enabled(v50, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v83 = 2114;
              id v84 = v17;
              _os_log_impl(&dword_22F52A000, v51, OS_LOG_TYPE_DEFAULT, "%{public}@int %{public}@", buf, 0x16u);
            }
            [v71 addObject:v47];
            self = v68;
            v15 = v70;
          ...
          else
          {
            if (os_log_type_enabled(v50, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v83 = 2114;
              id v84 = v17;
              _os_log_impl(&dword_22F52A000, v51, OS_LOG_TYPE_ERROR, "%{public}@Integer data type for Key %{public}@ had no integer setting", buf, 0x16u);
            }
            uint64_t v65 = [MEMORY[0x263F087E8] hmErrorWithCode:3];
        ...
        else
        {
          ...
          if (os_log_type_enabled(v62, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *(_DWORD *)buf = 138543618;
            ...
            __int16 v83 = 2114;
            id v84 = v17;
            _os_log_impl(&dword_22F52A000, v62, OS_LOG_TYPE_DEFAULT, "%{public}@Default settings constraints for Key %{public}@ not found", buf, 0x16u);
          }
  ...
  if (v15)
  {
    ...
    while (1)
    {
      for (uint64_t i = 0; i != v18; ++i)
      {
        ...
        if (!v25)
        {
          if ([*(id *)(v20 + 72) isKeyPathForBooleanSettingType:v22])
          {
            ...
            if (os_log_type_enabled(v28, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v59 = 2114;
              __int16 v60 = v22;
              _os_log_impl(&dword_22F52A000, v28, OS_LOG_TYPE_DEFAULT, "%{public}@Setting default BOOL value %@ for Key: %{public}@", buf, 0x20u);
          ...
          int v34 = [*(id *)(v20 + 72) isKeyPathForConstrainedNumberSettingType:v22];
          ...
          if (v34)
          {
            if (os_log_type_enabled(v37, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *(_DWORD *)buf = 138543874;
              ...
              __int16 v59 = 2114;
              __int16 v60 = v22;
              _os_log_impl(&dword_22F52A000, v38, OS_LOG_TYPE_DEFAULT, "%{public}@Setting default integer value %@ for Key: %{public}@", buf, 0x20u);
          ...
          else
          {
            if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
            {
              ...
              *(_DWORD *)buf = 138543618;
              ...
              __int16 v57 = 2114;
              __int16 v58 = v22;
              _os_log_impl(&dword_22F52A000, v38, OS_LOG_TYPE_ERROR, "%{public}@Data type for Key %{public}@ not supported", buf, 0x16u);
            }
          }
          uint64_t v19 = v47;
          id v14 = v48;
          unint64_t v20 = 0x263F0E000;
        }
      }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_51859 != -1) {
    dispatch_once(&logCategory__hmf_once_t3_51859, &__block_literal_global_51860);
  }
  v2 = (void *)logCategory__hmf_once_v4_51861;
  return v2;
}
...
void __50__HMDFetchedSettingsDriverPreferences_logCategory__block_invoke()
{
  ...
  v1 = (void *)logCategory__hmf_once_v4_51861;
  logCategory__hmf_once_v4_51861 = v0;
}
