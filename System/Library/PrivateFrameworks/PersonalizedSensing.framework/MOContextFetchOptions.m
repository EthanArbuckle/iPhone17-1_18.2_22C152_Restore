  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)buf = 134218496;
      ...
      __int16 v17 = 2048;
      unint64_t v18 = a5;
      _os_log_impl(&dword_259147000, v10, OS_LOG_TYPE_INFO, "ContextFetchOptions contextFormat,%lu,contextRetrieval,%lu,contextCount,%lu", buf, 0x20u);
    }
  }
  return v9;
}
...
{
  id v4 = a3;
  uint64_t v5 = [v4 decodeIntegerForKey:@"contextFormat"];
  uint64_t v6 = [v4 decodeIntegerForKey:@"contextRetrieval"];
  uint64_t v7 = [v4 decodeIntegerForKey:@"contextCount"];
