  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v21 = 2112;
      id v22 = v11;
      _os_log_impl(&dword_259147000, v14, OS_LOG_TYPE_INFO, "ContactMetaData contextContactIdentifier,%@,contactName,%@,mdEntityIdentifier,%@", buf, 0x20u);
    }
  }
  return v13;
}
...
{
  v2 = NSString;
  objc_super v3 = [(MOContextContactMetaData *)self contactName];
  id v4 = [v3 mask];
  id v5 = [v2 stringWithFormat:@"contact name, %@", v4];
