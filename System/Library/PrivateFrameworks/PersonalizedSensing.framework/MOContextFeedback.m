...
- (MOContextFeedback)initWithCoder:(id)a3
{
  ...
  if (v6)
  {
    ...
    uint64_t v12 = [v4 decodeObjectOfClasses:v11 forKey:@"contextStringFeedback"];
...
{
  v3 = NSString;
  id v4 = [(MOContextFeedback *)self contextIdentifier];
  char v5 = [(MOContextFeedback *)self contextFetchedTimestamp];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  char v5 = [(MOContextFeedback *)self contextIdentifier];
