...
- (id)description
{
  ...
  objc_super v12 = __Block_byref_object_copy__0;
  v13 = __Block_byref_object_dispose__0;
  v3 = NSString;
  id v4 = [(MOPerformanceMeasurement *)self name];
...
- (void)endSession
{
  ...
  if (self->_session)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      ...
      _os_log_debug_impl(&dword_259147000, v6, OS_LOG_TYPE_DEBUG, "METRICS: %s", (uint8_t *)&v8, 0xCu);
    }
  }
}
...
- (void)_addMetricWithKey:(id)a3 name:(id)a4 unit:(id)a5 denominator:(double)a6 pcMetricID:(unint64_t)a7
{
  ...
  id v12 = a4;
  id v13 = a5;
  id v14 = [[MOPerformanceMetric alloc] initWithDisplayName:v12 pcMetricID:a7 unit:v13 denominator:a6];
...
- (void)_evaluateEndedSession:(pc_session *)a3 duration:(double)a4
{
  ...
  uint64_t v9 = [(MOPerformanceMeasurement *)self metrics];
