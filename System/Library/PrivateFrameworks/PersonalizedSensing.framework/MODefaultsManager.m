...
- (void)deleteObjectForKey:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v9 = 2112;
      id v10 = v4;
      _os_log_impl(&dword_259147000, v5, OS_LOG_TYPE_INFO, "%s, deleting key, %@", (uint8_t *)&v7, 0x16u);
    }
...
- (void)setObject:(id)a3 forKey:(id)a4
{
  ...
  if (v7)
  {
    ...
    {
      int v10 = 136315650;
      uint64_t v11 = "-[MODefaultsManager setObject:forKey:]";
      __int16 v12 = 2112;
      id v13 = v7;
      __int16 v14 = 2112;
      id v15 = v6;
      _os_log_impl(&dword_259147000, v8, OS_LOG_TYPE_INFO, "%s, key, %@, value, %@", (uint8_t *)&v10, 0x20u);
    }
...
- (void)objectForKey:(os_log_t)log .cold.1(os_log_t log)
{
  ...
  _os_log_error_impl(&dword_259147000, log, OS_LOG_TYPE_ERROR, "%s, key cannot be nil!", (uint8_t *)&v1, 0xCu);
}

- (void)objectForKey:.cold.2()
{
  OUTLINED_FUNCTION_0_1();
  OUTLINED_FUNCTION_1_0(&dword_259147000, v0, v1, "Invalid parameter not satisfying: key (in %s:%d)", v2, v3, v4, v5, v6);
}
...
- (void)objectForKey:(os_log_t)log .cold.3(uint64_t a1, uint64_t a2, os_log_t log)
{
  ...
  __int16 v7 = 2112;
  uint64_t v8 = a2;
  _os_log_debug_impl(&dword_259147000, log, OS_LOG_TYPE_DEBUG, "%s, key, %@, value, %@", (uint8_t *)&v3, 0x20u);
}
