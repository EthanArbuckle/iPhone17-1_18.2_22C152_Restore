...
+ (id)extractHardwareAndSoftwareMetadata
{
  ...
  BOOL v7 = +[MOPlatformInfo isInternalBuild];
  BOOL v8 = +[MOPlatformInfo isSeedBuild];
  if (v3) {
...
+ (BOOL)wasBuildVersionUpdated
{
  ...
  if (v4)
  {
    char v5 = [v3 objectForKey:@"kMOBuildVersion"];
...
+ (unint64_t)generativeModelsAvailabilityStatus
{
  ...
  uint64_t v9 = 0;
  v2 = [MEMORY[0x263F565C0] sharedInstance];
...
+ (void)getHWModel
{
  ...
  OUTLINED_FUNCTION_0_2(&dword_259147000, v0, v1, "Could not get hardware version string", v2, v3, v4, v5, v6);
}

+ (void)getProductType
{
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_0_2(&dword_259147000, v0, v1, "Could not get product type", v2, v3, v4, v5, v6);
}

+ (void)getBuildVersion
{
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_0_2(&dword_259147000, v0, v1, "Could not get build version", v2, v3, v4, v5, v6);
}

+ (void)getProductVersion
{
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_0_2(&dword_259147000, v0, v1, "Could not get product version", v2, v3, v4, v5, v6);
}

void __52__MOPlatformInfo_generativeModelsAvailabilityStatus__block_invoke_cold_1()
{
  OUTLINED_FUNCTION_1_1();
  OUTLINED_FUNCTION_0_2(&dword_259147000, v0, v1, "Could not get GMS Availability", v2, v3, v4, v5, v6);
}
