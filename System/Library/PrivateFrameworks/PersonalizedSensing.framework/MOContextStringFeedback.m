...
{
  v3 = NSString;
  id v4 = [(MOContextStringFeedback *)self stringIdentifier];
  char v5 = [(MOContextStringFeedback *)self textString];
  v6 = [(MOContextStringFeedback *)self timestamp];
  unint64_t v7 = [(MOContextStringFeedback *)self score];
  v8 = [(MOContextStringFeedback *)self describeFeedbackMode];
  uint64_t v9 = [(MOContextStringFeedback *)self describeUsageFeedback];
  v10 = [v3 stringWithFormat:@"stringIdentifier, %@, string, %@, timestamp, %@, score ,%lu, mode, %@, usage, %@", v4, v5, v6, v7, v8, v9];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  char v5 = [(MOContextStringFeedback *)self stringIdentifier];
  v6 = [(MOContextStringFeedback *)v4 initWithContextStringIdentifier:v5];

  unint64_t v7 = [(MOContextStringFeedback *)self textString];
