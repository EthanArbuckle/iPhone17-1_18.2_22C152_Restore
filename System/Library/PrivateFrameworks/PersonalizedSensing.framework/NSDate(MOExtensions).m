...
- (id)stringFromDate
{
  ...
  uint64_t v4 = v3;
  v5 = [MEMORY[0x263EFF910] dateFormatter];
...
- (uint64_t)isSameDayWithDate:()MOExtensions timeZone:
{
  ...
  double v9 = (void *)[v8 initWithCalendarIdentifier:*MEMORY[0x263EFF3F8]];
  double v10 = v9;
  if (v7) {
    [v9 setTimeZone:v7];
  }
...
- (id)getBundleRelativeDate
{
  ...
  v2 = [MEMORY[0x263EFF910] dayNameFormatterInEnglish];
  id v3 = [v2 stringFromDate:a1];

  uint64_t v4 = [MEMORY[0x263EFF910] dayNameFormatterInEnglish];
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    __int16 v15 = 2112;
    v16 = v6;
    _os_log_impl(&dword_259147000, v7, OS_LOG_TYPE_INFO, "bundleDay: %@, nowDay: %@", (uint8_t *)&v13, 0x16u);
  }
  ...
  {
    uint64_t v10 = [MEMORY[0x263EFF910] monthDayFormatter];
