...
- (MOEventLifeEvents)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    v5->_unint64_t lifeEventCategory = (unint64_t)[v4 decodeIntegerForKey:@"lifeEventCategory"];
...
- (id)description
{
  ...
  id v5 = [v3 initWithFormat:@"life event category, %@, confidence score, %f", v4, *(void *)&self->_confidenceScore];
