...
- (MOEventBundleLabelTemplate)initWithConditionStrings:(id)a3 labels:(id)a4 context:(id)a5
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR)) {
      -[MOEventBundleLabelTemplate initWithConditionStrings:labels:context:](v15, v16, v17, v18, v19, v20, v21, v22);
    }
...
- (MOEventBundleLabelTemplate)initWithConditions:(id)a3 labels:(id)a4 context:(id)a5
{
    ...
    if (v13)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          uint64_t v17 = [[MOEventBundleLabelFormat alloc] initWithFormat:*(void *)(*((void *)&v28 + 1) + 8 * (void)v16)];
          [v11 addObject:v17];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR)) {
      -[MOEventBundleLabelTemplate initWithConditionStrings:labels:context:](v11, v19, v20, v21, v22, v23, v24, v25);
    }
    uint64_t v18 = 0;
  }
...
- (MOEventBundleLabelTemplate)initWithConditions:(id)a3 formats:(id)a4 context:(id)a5
{
  ...
  {
    v24.receiver = self;
    v24.super_class = (Class)MOEventBundleLabelTemplate;
    id v12 = [(MOEventBundleLabelTemplate *)&v24 init];
    p_isa = (id *)&v12->super.isa;
    if (v12)
    {
      objc_storeStrong((id *)&v12->_conditions, a3);
  ...
  {
    uint64_t v15 = _mo_log_facility_get_os_log(&MOLogFacilityGeneral);
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR)) {
      -[MOEventBundleLabelTemplate initWithConditions:formats:context:](v15, v16, v17, v18, v19, v20, v21, v22);
    }
...
+ (id)conditionsFromConditionStrings:(id)a3
{
  ...
  long long v53 = 0u;
  id obj = v3;
  id v41 = [obj countByEnumeratingWithState:&v50 objects:v56 count:16];
  if (v41)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        id v8 = objc_msgSend(v40, "matchesInString:options:range:", v7, 0, 0, objc_msgSend(v7, "length"));
        long long v46 = 0u;
        long long v47 = 0u;
        long long v48 = 0u;
        long long v49 = 0u;
        id v44 = [v8 countByEnumeratingWithState:&v46 objects:v55 count:16];
        if (v44)
        {
          ...
          do
          {
            for (i = 0; i != v44; i = (char *)i + 1)
            {
              ...
              if ([v11 numberOfRanges])
              {
                ...
                id v14 = [objc_alloc((Class)v5[241]) initWithKeyword:v45];
                id v15 = [v11 rangeAtIndex:1];
                if (v16)
                {
                  long long v17 = v5[241];
                  long long v18 = objc_msgSend(v7, "substringWithRange:", v15, v16);
                  id v19 = [v17 templateOperatorFromString:v18];
                ...
                if ([v14 templateOperator] != (id)8)
                {
                  ...
                  if (v21)
                  {
                    ...
                    long long v24 = v8;
                    long long v25 = v5;
                    long long v27 = v26 = v4;
                    id v28 = [v22 templateOperatorFromString:v27];
                    ...
                    if (v28)
                    {
                      ...
                      id v32 = [v11 rangeAtIndex:7];
                      if (v33)
                      {
                        v34 = v5[241];
                        v35 = objc_msgSend(v7, "substringWithRange:", v32, v33);
...
+ (id)conditionsFromExtendStrings:(id)a3
{
  ...
  id v64 = 0;
  id v41 = +[NSRegularExpression regularExpressionWithPattern:@"([0-9a-zA-Z\\-\\_]+)\\s?(:)\\s?([0-9a-zA-Z\\-\\_\\,\\s]+)" options:1 error:&v64];
  id v38 = v64;
  long long v60 = 0u;
  long long v61 = 0u;
  long long v62 = 0u;
  long long v63 = 0u;
  id obj = v3;
  id v42 = [obj countByEnumeratingWithState:&v60 objects:v67 count:16];
  if (v42)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        long long v59 = 0u;
        id v49 = v7;
        id v51 = [v7 countByEnumeratingWithState:&v56 objects:v66 count:16];
        if (v51)
        {
          ...
          do
          {
            for (i = 0; i != v51; i = (char *)i + 1)
            {
              ...
              if ([v9 numberOfRanges])
              {
                ...
                id v12 = objc_msgSend(v6, "substringWithRange:", v10, v11);
                id v13 = [objc_alloc((Class)v4[241]) initWithKeyword:v12];
                ...
                if (v15)
                {
                  ...
                  id v19 = [v16 templateOperatorFromString:v18];
                ...
                id v20 = [v9 rangeAtIndex:3];
                if (v21)
                {
                  id v22 = objc_msgSend(v6, "substringWithRange:", v20, v21);
                  if ([v22 length])
                  {
                    long long v23 = +[NSCharacterSet whitespaceAndNewlineCharacterSet];
                    ...
                    else
                    {
                      ...
                      id v27 = [v26 countByEnumeratingWithState:&v52 objects:v65 count:16];
                      if (v27)
                      {
                        id v28 = v27;
                        ...
                        do
                        {
                          for (j = 0; j != v28; j = (char *)j + 1)
                          {
                            ...
                            id v31 = *(void **)(*((void *)&v52 + 1) + 8 * (void)j);
                            id v32 = +[NSCharacterSet whitespaceAndNewlineCharacterSet];
                            uint64_t v33 = [v31 stringByTrimmingCharactersInSet:v32];

                            [v25 addObject:v33];
                          }
                          id v28 = [v26 countByEnumeratingWithState:&v52 objects:v65 count:16];
                        }
                        while (v28);
                      }
...
LABEL_35:
            ...
            id v51 = [v49 countByEnumeratingWithState:&v56 objects:v66 count:16];
          }
          while (v51);
        }
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; i = (char *)i + 1)
      {
        ...
        id v11 = objc_alloc((Class)MOEventBundleLabelCondition);
        id v12 = objc_msgSend(v11, "initWithKeyword:", v10, (void)v14);
...
- (id)formattedStringsForMetaData:(id)a3
{
  ...
  if (v80)
  {
    ...
    p_cache = &OBJC_METACLASS___MOGenericInteraction.cache;
    id v85 = v4;
    do
    {
      id v6 = 0;
      do
      {
        ...
        unsigned __int8 v11 = objc_msgSend(v79, "matchesInString:options:range:", v10, 0, 0, objc_msgSend(v8, "length"));
...
LABEL_76:
          long long v56 = objc_msgSend(p_cache + 113, "_Moments_LocalizedStringWithFormat:arguments:", v8, v82);
          ...
          if (v56)
          {
            ...
            {
              uint64_t v58 = objc_msgSend(p_cache + 113, "_Moments_CapitalizedStringForKey:", v56);
              goto LABEL_82;
            }
            if ([v84 capitalizationType] != (id)3) {
              goto LABEL_83;
            }
            uint64_t v58 = objc_msgSend(p_cache + 113, "_Moments_AllCapitalizedStringForKey:", v56);
LABEL_82:
          ...
          do
          {
            ...
            if (v23)
            {
              ...
              if ([(MOEventBundleLabelTemplate *)v92 needExtensionForKeyword:v20])
              {
                ...
                id v28 = +[NSString stringWithFormat:@"{%@}", v23];
                ...
                id v32 = +[MOEventBundleLabelLocalizer _Moments_CapitalizedStringForKey:v23];
...
LABEL_44:
                id v42 = +[NSString stringWithFormat:@"{%@}", v20];
...
LABEL_73:
        ...
        p_cache = (void **)(&OBJC_METACLASS___MOGenericInteraction + 16);
        id v6 = v81;
        if (v86) {
          goto LABEL_76;
        }
