...
- (MOResource)initWithEvergreenTypeName:(id)a3 promptIndex:(unint64_t)a4
{
  ...
  v7 = +[NSNumber numberWithUnsignedInteger:](NSNumber, "numberWithUnsignedInteger:", +[MOResource evergreenTypeFromEvergreenTypeString:v6]);
  v13[0] = v7;
...
- (MOResource)initWithEvergreenTypeName:(id)a3 promptIndexes:(id)a4
{
  ...
  v8 = +[NSNumber numberWithUnsignedInteger:](NSNumber, "numberWithUnsignedInteger:", +[MOResource evergreenTypeFromEvergreenTypeString:v7]);
  v14[0] = v8;
  v14[1] = v6;
...
- (MOResource)initWithIdentifier:(id)a3
{
  ...
  unint64_t v6 = [(MOResource *)self initWithIdentifier:v4 name:@"Resource" type:0 assets:0 data:0 value:0 priorityScore:0.0 photoCurationScore:-1.0 photoFaceCount:0 photoAssetMediaType:0];
...
- (MOResource)initWithName:(id)a3 type:(unint64_t)a4 assets:(id)a5
{
  ...
  v11 = [(MOResource *)self initWithIdentifier:v10 name:v9 type:a4 assets:v8 data:0 value:0 priorityScore:0.0 photoCurationScore:-1.0 photoFaceCount:0 photoAssetMediaType:0];
...
- (id)description
{
  id v3 = [(MOResource *)self identifier];
...
- (MOResource)initWithPlace:(id)a3 startDate:(id)a4 endDate:(id)a5
{
  ...
  id v14 = [v8 location];
  CFStringRef v15 = [v14 dictionary];
...
- (id)cityName
{
  ...
  if (v3)
  {
    ...
    id v5 = [v4 objectForKeyedSubscript:@"cityName"];
  }
  else
  {
    id v5 = 0;
...
- (id)enclosingArea
{
  ...
  {
    id v4 = [(MOResource *)self metaData];
    id v5 = [v4 objectForKeyedSubscript:@"enclosingArea"];
  }
  else
  {
    id v5 = 0;
...
- (unint64_t)placeUserType
{
  ...
  id v4 = [(MOResource *)self metaData];
  id v5 = [v4 objectForKeyedSubscript:@"placeUserType"];
  unint64_t v6 = (int)[v5 intValue];
...
- (unint64_t)placeType
{
  ...
  id v4 = [(MOResource *)self metaData];
  id v5 = [v4 objectForKeyedSubscript:@"placeType"];
  unint64_t v6 = (int)[v5 intValue];
...
- (id)poiCategory
{
  ...
  {
    id v4 = [(MOResource *)self metaData];
    id v5 = [v4 objectForKeyedSubscript:@"poiCategory"];
  }
  else
  {
    id v5 = 0;
...
- (MOResource)initWithWeather:(id)a3
{
  ...
  double v24 = +[MODictionaryEncoder encodeDictionary:v5];
  double v25 = +[NSUUID UUID];
  double v26 = [(MOResource *)self initWithIdentifier:v25 name:@"Weather" type:14 assets:0 data:v24 value:0 priorityScore:0.0 photoCurationScore:-1.0 photoFaceCount:0 photoAssetMediaType:0];
...
- (double)endDate
{
  ...
  id v4 = [(MOResource *)self metaData];
  id v5 = [v4 objectForKeyedSubscript:@"MOWeatherMetaDataKeyEndDate"];
  [v5 doubleValue];
  double v7 = v6;
...
- (double)startDate
{
  ...
  id v4 = [(MOResource *)self metaData];
  id v5 = [v4 objectForKeyedSubscript:@"MOWeatherMetaDataKeyStartDate"];
  [v5 doubleValue];
  double v7 = v6;
...
- (id)weatherSummary
{
  ...
  {
    id v4 = [(MOResource *)self metaData];
    id v5 = [v4 objectForKeyedSubscript:@"MOWeatherMetaDataKeyWeatherSummary"];
  }
  else
  {
    id v5 = 0;
...
- (id)weatherSymbolName
{
  ...
  {
    id v4 = [(MOResource *)self metaData];
    id v5 = [v4 objectForKeyedSubscript:@"MOWeatherMetaDataKeySymbolName"];
  }
  else
  {
    id v5 = 0;
...
+ (void)getDedupeKeyForResourceData:type:error:.cold.1()
{
  ...
  OUTLINED_FUNCTION_2_1((void *)&_mh_execute_header, v1, v2, "Malformed dictionary, %@, for resource type, %@, the key %@ is missing.", v3, v4, v5, v6, v7);
}
