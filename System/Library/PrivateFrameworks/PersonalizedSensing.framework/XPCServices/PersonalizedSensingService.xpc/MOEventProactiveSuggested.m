...
- (MOEventProactiveSuggested)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v5->_suggestedEventCategory = (unint64_t)[v4 decodeIntegerForKey:@"suggestedEventCategory"];
...
- (id)description
{
  ...
  id v5 = [v3 initWithFormat:@"suggestedEventTitle, %@, suggestedEventIdentifier, %@", v4, self->_suggestedEventIdentifier];
