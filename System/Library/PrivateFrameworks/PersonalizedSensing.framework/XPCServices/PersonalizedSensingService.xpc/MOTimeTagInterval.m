...
- (double)overlapsScoreForStartDate:(id)a3 endDate:(id)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    __int16 v41 = 2112;
    v42 = v30;
    _os_log_debug_impl((void *)&_mh_execute_header, v8, OS_LOG_TYPE_DEBUG, "overlapsScoreForStartDate, startDate, %@, endDate, %@, self.startDate, %@, self.endDate, %@", (uint8_t *)&v35, 0x2Au);
  }
  ...
  if ([v6 isAfterDate:v7])
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      __int16 v41 = 2112;
      v42 = v34;
      _os_log_error_impl((void *)&_mh_execute_header, v9, OS_LOG_TYPE_ERROR, "overlapsScoreForStartDate, invalid time range, startDate, %@, endDate, %@, self.startDate, %@, self.endDate, %@", (uint8_t *)&v35, 0x2Au);
    }
LABEL_9:
    v10 = [(MOTimeTagInterval *)self dateInterval];
    unsigned int v11 = [v10 containsDate:v6];
  ...
  id v14 = [objc_alloc((Class)NSDateInterval) initWithStartDate:v6 endDate:v7];
  [v14 duration];
  double v12 = 0.0;
  if (v15 > 0.0)
  {
    v16 = [(MOTimeTagInterval *)self dateInterval];
    unsigned int v17 = [v16 intersectsDateInterval:v14];
