...
- (MOPlace)initWithIdentifier:(id)a3
{
  ...
  v6 = [(MOPlace *)self initWithIdentifier:v4 placeName:&stru_1000AC528 enclosingArea:&stru_1000AC528 placeType:0 placeUserType:0 location:0 locationMode:-1.0 poiCategory:-1.0 distanceToHomeInMiles:0.0 placeNameConfidence:-1.0 familiarityIndexLOI:0 priorityScore:&stru_1000AC528 startDate:0 endDate:0];
...
- (MOPlace)initWithPlaceName:(id)a3 placeType:(unint64_t)a4 placeUserType:(unint64_t)a5 location:(id)a6 locationMode:(unint64_t)a7 poiCategory:(id)a8 distanceToHomeInMiles:(double)a9 placeNameConfidence:(double)a10 familiarityIndexLOI:(double)a11
{
  ...
  id v22 = a3;
  id v23 = +[NSUUID UUID];
  id v24 = [(MOPlace *)self initWithIdentifier:v23 placeName:v22 enclosingArea:&stru_1000AC528 placeType:a4 placeUserType:a5 location:v21 locationMode:a9 poiCategory:a10 distanceToHomeInMiles:a11 placeNameConfidence:-1.0 familiarityIndexLOI:a7 priorityScore:v20 startDate:0 endDate:0];
