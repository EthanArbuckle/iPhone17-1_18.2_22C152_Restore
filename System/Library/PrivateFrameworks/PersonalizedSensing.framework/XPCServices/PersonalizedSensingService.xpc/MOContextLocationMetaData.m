  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)buf = 138412802;
      ...
      __int16 v21 = 2112;
      id v22 = v11;
      _os_log_impl((void *)&_mh_execute_header, v14, OS_LOG_TYPE_INFO, "LocationMetaData place,%@,city,%@,visitTimeWindow,%@", buf, 0x20u);
    }
  }
  return v13;
}
...
- (id)description
{
  objc_super v3 = [(MOContextLocationMetaData *)self place];
  id v4 = [v3 mask];
  id v5 = [(MOContextLocationMetaData *)self city];
  v6 = [v5 mask];
  id v7 = [(MOContextLocationMetaData *)self visitTimeWindow];
  id v8 = +[NSString stringWithFormat:@"place, %@, city, %@, visit time window %@", v4, v6, v7];
