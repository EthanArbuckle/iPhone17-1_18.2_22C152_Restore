...
LABEL_16:
  ...
  v31.receiver = self;
  v31.super_class = (Class)MOEvent;
  v20 = [(MOEvent *)&v31 init];
  v21 = v20;
  if (v20)
  {
    objc_storeStrong((id *)&v20->_eventIdentifier, a3);
    v22 = (NSDate *)[v16 copy];
...
{
  if (a3 >= 0xC) {
    id v3 = objc_msgSend(objc_alloc((Class)NSString), "initWithFormat:", @"Unknown (%lu)", a3);
  }
  else {
    id v3 = *(&off_1000A5778 + a3);
  }
  return v3;
}
...
- (id)copy
{
  ...
  id v15 = (MOEventProactiveSuggested *)[(MOEventProactiveSuggested *)self->_proactiveSuggestedEvent copy];
  ...
  objc_super v31 = (MOEventAnalytics *)[(MOEventAnalytics *)self->_analyticsEvent copy];
  analyticsEvent = v8->_analyticsEvent;
  v8->_analyticsEvent = v31;

  v33 = (MOEventLifeEvents *)[(MOEventLifeEvents *)self->_lifeEventsEvent copy];
...
- (id)formatAddressWithFormatOption:(id)a3
{
  ...
  if (routineEvent)
  {
    id v4 = [(MOEventRoutine *)routineEvent formatAddressWithFormatOption:a3];
  }
  else
  {
    double v5 = _mo_log_facility_get_os_log(&MOLogFacilityGeneral);
...
- (id)formatLocalityWithFormatOption:(id)a3
{
  ...
  if (routineEvent)
  {
    id v4 = [(MOEventRoutine *)routineEvent formatLocalityWithFormatOption:a3];
  }
  else
  {
    double v5 = _mo_log_facility_get_os_log(&MOLogFacilityGeneral);
...
- (id)formatAdministrativeAreaWithFormatOption:(id)a3
{
  ...
  if (routineEvent)
  {
    id v4 = [(MOEventRoutine *)routineEvent formatAdministrativeAreaWithFormatOption:a3];
  }
  else
  {
    double v5 = _mo_log_facility_get_os_log(&MOLogFacilityGeneral);
...
- (id)formatCountryWithFormatOption:(id)a3
{
  ...
  if (routineEvent)
  {
    id v4 = [(MOEventRoutine *)routineEvent formatCountryWithFormatOption:a3];
  }
  else
  {
    double v5 = _mo_log_facility_get_os_log(&MOLogFacilityGeneral);
...
- (void)initWithEventIdentifier:startDate:endDate:creationDate:provider:category:.cold.1()
{
  ...
  OUTLINED_FUNCTION_1_4((void *)&_mh_execute_header, v0, v1, "Invalid parameter not satisfying: eventIdentifier", v2, v3, v4, v5, v6);
}

- (void)initWithEventIdentifier:startDate:endDate:creationDate:provider:category:.cold.2()
{
  OUTLINED_FUNCTION_1_5();
  OUTLINED_FUNCTION_1_4((void *)&_mh_execute_header, v0, v1, "Invalid parameter not satisfying: startDate", v2, v3, v4, v5, v6);
}

- (void)initWithEventIdentifier:startDate:endDate:creationDate:provider:category:.cold.3()
{
  OUTLINED_FUNCTION_1_5();
  OUTLINED_FUNCTION_1_4((void *)&_mh_execute_header, v0, v1, "Invalid parameter not satisfying: endDate", v2, v3, v4, v5, v6);
}

- (void)initWithEventIdentifier:startDate:endDate:creationDate:provider:category:.cold.4()
{
  OUTLINED_FUNCTION_1_5();
  OUTLINED_FUNCTION_1_4((void *)&_mh_execute_header, v0, v1, "Invalid parameter not satisfying: creationDate", v2, v3, v4, v5, v6);
}

- (void)formatAddressWithFormatOption:.cold.1()
{
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_1_0((void *)&_mh_execute_header, v0, v1, "request formatAddressWithFormatOption on non routine event instance (in %s:%d)", v2, v3, v4, v5, v6);
}

- (void)formatLocalityWithFormatOption:.cold.1()
{
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_1_0((void *)&_mh_execute_header, v0, v1, "request formatLocalityWithFormatOption on non routine event instance (in %s:%d)", v2, v3, v4, v5, v6);
}
...
{
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_1_0((void *)&_mh_execute_header, v0, v1, "request formatCountryWithFormatOption on non routine event instance (in %s:%d)", v2, v3, v4, v5, v6);
}
