...
- (MOEventExtendedAttributes)initWithLocalIdentifier:(id)a3
{
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR)) {
      -[MOEventExtendedAttributes initWithLocalIdentifier:](v5);
    }
  }
  v10.receiver = self;
  v10.super_class = (Class)MOEventExtendedAttributes;
  v6 = [(MOEventExtendedAttributes *)&v10 init];
  if (v6)
  {
    v7 = (NSString *)[v4 copy];
    photoMomentLocalIdentifier = v6->_photoMomentLocalIdentifier;
    v6->_photoMomentLocalIdentifier = v7;
  }
  return v6;
}
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; i = (char *)i + 1)
      {
        ...
        objc_super v10 = objc_msgSend(*(id *)(*((void *)&v12 + 1) + 8 * i), "lowercaseString", (void)v12);
        [v4 addObject:v10];
      }
...
- (id)description
{
  ...
  v9 = [v8 description];
  objc_super v10 = [(MOEventExtendedAttributes *)self momentPropertyOfAssets];
    ...
    if (v5)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
              ...
              (id v3 = objc_claimAutoreleasedReturnValue()) != 0))
        {
          ...
          objc_super v10 = [(MOEventExtendedAttributes *)v7 photoMomentLocalIdentifier];
