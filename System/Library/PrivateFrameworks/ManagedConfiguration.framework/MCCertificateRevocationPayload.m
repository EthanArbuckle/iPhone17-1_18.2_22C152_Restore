...
+ (id)typeStrings
{
  ...
  v4[0] = @"com.apple.security.certificaterevocation";
...
+ (id)localizedSingularForm
{
  return MCLocalizedFormat(@"CERTIFICATE_REVOCATION_DESCRIPTION_SINGULAR", (uint64_t)a2, v2, v3, v4, v5, v6, v7, v9);
}

+ (id)localizedPluralForm
{
  return MCLocalizedFormat(@"CERTIFICATE_REVOCATION_DESCRIPTION_PLURAL", (uint64_t)a2, v2, v3, v4, v5, v6, v7, v9);
}
...
- (MCCertificateRevocationPayload)initWithDictionary:(id)a3 profile:(id)a4 outError:(id *)a5
{
  ...
  id v49 = 0;
  v11 = [v8 MCValidateAndRemoveArrayOfClass:objc_opt_class() withKey:@"EnabledForCerts" isRequired:0 outError:&v49];
  id v12 = v49;
  if (v12) {
    goto LABEL_31;
  }
  ...
  uint64_t v42 = *MEMORY[0x1E4F3B910];
  uint64_t v41 = *MEMORY[0x1E4F3B918];
  v40 = v11;
  while (2)
  {
...
- (id)stubDictionary
{
  ...
  if (v4)
  {
    ...
    uint64_t v7 = *MEMORY[0x1E4F3B910];
    uint64_t v8 = *MEMORY[0x1E4F3B918];
    do
    {
  ...
  [v15 setObject:v3 forKeyedSubscript:@"EnabledForCerts"];
  return v15;
}
...
- (id)subtitle1Label
{
  ...
  {
    if (v2 == (void *)1) {
      uint64_t v3 = @"CERTIFICATE_REVOCATION_ADDITION_SINGULAR";
    }
    else {
      uint64_t v3 = @"CERTIFICATE_REVOCATION_ADDITION_PLURAL";
    }
