...
{
  v9.receiver = self;
  v9.super_class = (Class)SSLocaleObserver;
  v2 = [(SSLocaleObserver *)&v9 init];
  if (v2)
  {
    dispatch_queue_t v3 = dispatch_queue_create("com.apple.spotlight.SSLocaleObserver", 0);
    queue = v2->_queue;
...
- (void)dealloc
{
  ...
  dispatch_sync(queue, block);
  v4.receiver = self;
  v4.super_class = (Class)SSLocaleObserver;
