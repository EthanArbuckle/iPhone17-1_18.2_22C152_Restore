...
{
  id v3 = a3;
  v4 = [(id)objc_opt_class() attributionImageFromKey:0 pressedKey:0 punchOut:v3];
...
+ (id)attributionImageFromImageResource:(id)a3
{
  ...
  -[SiriUIAttributionImage setLogoSize:](v11, "setLogoSize:", v8, v10);
...
+ (id)attributionImageFromKey:(id)a3 pressedKey:(id)a4 punchOut:(id)a5
{
  ...
  -[SiriUIAttributionImage setLogoSize:](v24, "setLogoSize:", v21, v23);
...
- (void)getLogoWithCompletion:(id)a3
{
  ...
  if (v4)
  {
    double v5 = [(SiriUIAttributionImage *)self localResourceName];
    ...
    {
      double v6 = [(SiriUIAttributionImage *)self remoteURL];
...
- (CGSize)logoSize
{
  ...
  if ([v5 length])
  {
    double v6 = [(SiriUIAttributionImage *)self _imageInLocalResourceBundleNamed:v5];
    id v7 = v6;
    if (v6)
    {
      [v6 size];
...
- (void)_fetchLocalResourcesWithCompletion:(id)a3
{
  ...
  id v4 = [(SiriUIAttributionImage *)self localResourceName];
  double v5 = [(SiriUIAttributionImage *)self localPressedResourceName];
  double v6 = [(SiriUIAttributionImage *)self localPunchOut];
  if (v4)
  {
    id v7 = [(SiriUIAttributionImage *)self _imageInLocalResourceBundleNamed:v4];
    if (v5)
    {
LABEL_3:
      double v8 = [(SiriUIAttributionImage *)self _imageInLocalResourceBundleNamed:v5];
      goto LABEL_6;
    }
  }
  else
...
- (id)_imageInLocalResourceBundleNamed:(id)a3
{
  ...
  id v5 = a3;
  double v6 = [(SiriUIAttributionImage *)self localResourceBundle];
...
- (void)_fetchRemoteResourcesWithCompletion:(id)a3
{
  ...
  id v5 = [(SiriUIAttributionImage *)self remotePressedURL];
  double v6 = [(SiriUIAttributionImage *)self remotePunchOut];
  v31[0] = 0;
  v31[1] = v31;
  v31[2] = 0x3032000000;
  ...
  double v9 = +[SiriUIURLSession sharedURLSession];
  ...
  id v12 = +[SiriUIURLSession sharedURLSession];
...
uint64_t __62__SiriUIAttributionImage__fetchRemoteResourcesWithCompletion___block_invoke_3(void *a1)
{
