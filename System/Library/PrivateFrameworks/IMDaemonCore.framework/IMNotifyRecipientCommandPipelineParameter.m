...
- (IMNotifyRecipientCommandPipelineParameter)initWithIdsTrustedData:(id)a3 GUID:(id)a4 timestamp:(id)a5 isFromStorage:(BOOL)a6 isLastFromStorage:(BOOL)a7
{
  ...
  v15 = [(IMNotifyRecipientCommandPipelineParameter *)&v27 init];
  if (v15)
  {
...
- (id)description
{
  ...
  objc_msgSend(v3, "stringWithFormat:", @"<IMNotifyRecipientCommandPipelineParameter %p; GUID = %@; timestamp = %@; isFromStorage = %@; isLastFromStorage = %@; idsTrustedData = %@; OUTPUT chat = %@; numMessageItems = %lu}",
    self,
    v4,
    v5,
    v6,
