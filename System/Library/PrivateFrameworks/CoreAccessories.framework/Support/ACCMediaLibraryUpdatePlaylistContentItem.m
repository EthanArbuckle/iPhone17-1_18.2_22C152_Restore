...
- (id)description
{
  return +[NSString stringWithFormat:@"<ACCMediaLibraryUpdatePlaylistContentItem>[%@:%llu itemPersistentID=%llu '%@' validMask=%llxh]", self->_mediaLibraryUID, self->_playlistPersistentID, self->_persistentID, self->_title, self->_validMask];
}

- (id)debugDescription
{
  v3 = [(ACCMediaLibraryUpdatePlaylistContentItem *)self description];
  id v4 = [(ACCMediaLibraryUpdatePlaylistContentItem *)self copyNSRepresentation:3];
