...
- (ACCMemUsageStat)initWithName:(id)a3
{
  ...
  if (v6)
  {
    ...
    v8 = [[ACCMemUsageStatInfo alloc] initWithName:&stru_10021CEF8];
...
- (void)mark:(id)a3
{
  ...
  if (!v4)
  {
    id v5 = [ACCMemUsageStatInfo alloc];
    id v6 = +[NSString stringWithFormat:@"%@-mark-%@", self->_name, v7];
...
- (id)getMark:(id)a3
{
  return [(NSMutableDictionary *)self->_markList objectForKey:a3];
}
