...
- (id)description
{
  ...
  return +[NSString stringWithFormat:@"<ACCSettingsState>[%@:%@ = %ld (= %@), default = %ld, invalid = %ld]", self->_applicationID, self->_key, self->_intValue, v2, self->_defaultValue, self->_invalidValue];
}
