@interface _ACCOOBBTPairingProviderInfo
- (ACCOOBBTPairingServerRemote)serverRemote;
- (ACCOOBBTPairingXPCClientProtocol)remoteObject;
- (NSString)providerUID;
- (NSXPCConnection)connection;
- (_ACCOOBBTPairingProviderInfo)init;
- (id)description;
- (void)dealloc;
...
@implementation _ACCOOBBTPairingProviderInfo

- (_ACCOOBBTPairingProviderInfo)init
{
  v9.receiver = self;
  v9.super_class = (Class)_ACCOOBBTPairingProviderInfo;
  v2 = [(_ACCOOBBTPairingProviderInfo *)&v9 init];
  v3 = v2;
  if (v2)
  {
...
- (void)dealloc
{
  ...
  v7.receiver = self;
  v7.super_class = (Class)_ACCOOBBTPairingProviderInfo;
  [(_ACCOOBBTPairingProviderInfo *)&v7 dealloc];
}

- (id)description
{
  return +[NSString stringWithFormat:@"<_ACCOOBBTPairingProviderInfo>[\n    _connection=%@\n    _remoteObject=%@\n    _serverRemote=%@\n    _providerUID=%@]", self->_connection, self->_remoteObject, self->_serverRemote, self->_providerUID];
}
