...
- (id)description
{
  CFStringRef v2 = &stru_10021CEF8;
  if (self->_folder) {
    CFStringRef v3 = @" folder";
  }
  else {
    CFStringRef v3 = &stru_10021CEF8;
  }
  if (self->_geniusMix) {
    CFStringRef v4 = @" geniusMix";
  }
  else {
    CFStringRef v4 = &stru_10021CEF8;
  }
  if (self->_radioStation) {
    CFStringRef v5 = @" station";
  }
  else {
    CFStringRef v5 = &stru_10021CEF8;
  }
  if (self->_smartPlaylist) {
    CFStringRef v2 = @" smart";
  }
...
- (id)debugDescription
{
  CFStringRef v3 = [(ACCMediaLibraryUpdatePlaylist *)self description];
  id v4 = [(ACCMediaLibraryUpdatePlaylist *)self copyDict];
  CFStringRef v5 = +[NSString stringWithFormat:@"%@\n    %@", v3, v4];
