...
- (id)description
{
  id v3 = [(ACCNavigationRoadObjectRoadSignInfo *)self copyInfo:0];
  id v4 = [(ACCNavigationRoadObjectRoadSignInfo *)self copyInfo:1];
  id v5 = [(ACCNavigationRoadObjectRoadSignInfo *)self copyInfo:2];
  id v6 = [(ACCNavigationRoadObjectRoadSignInfo *)self copyInfo:3];
  id v7 = [(ACCNavigationRoadObjectRoadSignInfo *)self copyInfo:4];
  id v8 = [(ACCNavigationRoadObjectRoadSignInfo *)self copyInfo:5];
...
- (BOOL)_checkDataClassForType:(unsigned __int16)a3 data:(id)a4
{
  ...
  if (v4 > 5)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEFAULT))
    {
      v11[0] = 67109120;
      v11[1] = v4;
      _os_log_impl((void *)&_mh_execute_header, v10, OS_LOG_TYPE_DEFAULT, "[#Navigation] ERROR: Unknown RoadObjectDetection:RoadSign InfoType %d", (uint8_t *)v11, 8u);
    }
