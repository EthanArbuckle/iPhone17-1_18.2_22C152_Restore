...
- (id)_init
{
  ...
  if (v3)
  {
    uint64_t v4 = [objc_alloc(MEMORY[0x1E4F29268]) initWithServiceName:@"com.apple.coreaccessories.ACCCarPlayService"];
    xpcConnection = v3->_xpcConnection;
    v3->_xpcConnection = (NSXPCConnection *)v4;

    v6 = [MEMORY[0x1E4F29280] interfaceWithProtocol:&unk_1F0C7B140];
...
- (void)carPlayStartSessionForConnectionID:(unsigned int)a3 properties:(id)a4
{
  ...
  uint64_t v7 = [v8 remoteObjectProxyWithErrorHandler:&__block_literal_global_4];
...
- (void)carPlaySendConnectionTimeEvent:(int64_t)a3 connectionType:(int64_t)a4 eventTime:(id)a5
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    ...
    __int16 v21 = 2112;
    id v22 = v8;
    _os_log_impl(&dword_1B3C21000, v11, OS_LOG_TYPE_DEFAULT, "CarPlay Connection Event: %ld, %ld, %f, %@", (uint8_t *)&v15, 0x2Au);
  }
...
{
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_3_0(&dword_1B3C21000, v0, v1, "can't invoke remote object %@", v2, v3, v4, v5, v6);
}
...
{
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_2_0(&dword_1B3C21000, v0, v1, "failed to call ACCCarPlayService %@", v2, v3, v4, v5, v6);
}

void __78__ACCCarPlay_filterMatchingDigitalCarKeys_forAccessory_withCompletionHandler___block_invoke_35_cold_1()
{
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_2_0(&dword_1B3C21000, v0, v1, "call to ACCCarPlayService failed: %@", v2, v3, v4, v5, v6);
}

void __70__ACCCarPlay_carPlaySendConnectionTimeEvent_connectionType_eventTime___block_invoke_39_cold_1()
{
  OUTLINED_FUNCTION_5();
  OUTLINED_FUNCTION_2_0(&dword_1B3C21000, v0, v1, "failed to send CarPlay Connect event %@", v2, v3, v4, v5, v6);
}
