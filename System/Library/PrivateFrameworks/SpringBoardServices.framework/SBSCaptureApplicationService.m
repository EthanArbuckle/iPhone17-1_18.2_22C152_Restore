...
{
  v14.receiver = self;
  v14.super_class = (Class)SBSCaptureApplicationService;
...
void __36__SBSCaptureApplicationService_init__block_invoke_2()
{
  ...
  {
    *(_WORD *)v1 = 0;
    _os_log_impl(&dword_18FBC5000, v0, OS_LOG_TYPE_DEFAULT, "SBSCaptureApplicationService: interrupted", v1, 2u);
  }
}
...
void __36__SBSCaptureApplicationService_init__block_invoke_8(uint64_t a1)
{
  ...
  {
    *(_WORD *)v4 = 0;
    _os_log_impl(&dword_18FBC5000, v2, OS_LOG_TYPE_DEFAULT, "SBSCaptureApplicationService: remotely invalidated", v4, 2u);
  }
...
- (void)applicationDidCompleteTransition
{
  ...
  {
    *(_WORD *)v6 = 0;
    _os_log_impl(&dword_18FBC5000, v4, OS_LOG_TYPE_DEFAULT, "SBSCaptureApplicationService: Sending applicationDidCompleteTransition signal", v6, 2u);
  }

  v5 = [(BSServiceConnection *)self->_lock_connection remoteTarget];
  [v5 applicationDidCompleteTransition];
...
- (void)beginDelayingAppearance
{
  ...
  {
    *(_WORD *)v6 = 0;
    _os_log_impl(&dword_18FBC5000, v4, OS_LOG_TYPE_DEFAULT, "SBSCaptureApplicationService: Sending beginDelayingAppearance signal", v6, 2u);
  }

  v5 = [(BSServiceConnection *)self->_lock_connection remoteTarget];
  [v5 beginDelayingAppearance];
...
- (void)endDelayingAppearance
{
  ...
  {
    *(_WORD *)v6 = 0;
    _os_log_impl(&dword_18FBC5000, v4, OS_LOG_TYPE_DEFAULT, "SBSCaptureApplicationService: Sending endDelayingAppearance signal", v6, 2u);
  }

  v5 = [(BSServiceConnection *)self->_lock_connection remoteTarget];
  [v5 endDelayingAppearance];
