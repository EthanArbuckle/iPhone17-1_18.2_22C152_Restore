@interface SBSAutolockTimerRegisterForExternalChangeNotification
@end
...
{
  return notify_register_dispatch("com.apple.springboard.autolockfired", &_SBSAutolockTimerRegisterForExternalChangeNotification___token, MEMORY[0x1E4F14428], &__block_literal_global_7_4);
}
