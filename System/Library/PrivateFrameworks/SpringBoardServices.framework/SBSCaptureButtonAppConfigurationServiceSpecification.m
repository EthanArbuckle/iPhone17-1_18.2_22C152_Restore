@interface SBSCaptureButtonAppConfigurationServiceSpecification
...
+ (NSString)identifier
{
  return (NSString *)@"com.apple.springboard.configuration-service";
}
...
+ (BSServiceInterface)interface
{
  ...
  v2 = (void *)interface___interface_15;
...
{
  id v7 = [MEMORY[0x1E4F4F7B8] protocolForProtocol:&unk_1EDF67EA8];
  v2 = [MEMORY[0x1E4F4F7B8] protocolForProtocol:&unk_1EDF5FC40];
  ...
  [(id)interface___interface_15 setServer:v7];
  [(id)interface___interface_15 setClient:v2];
}
