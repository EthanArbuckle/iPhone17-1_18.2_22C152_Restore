...
+ (NSString)identifier
{
  return (NSString *)@"com.apple.springboard.focus-modes-home-screen-settings-service";
}
...
+ (BSServiceInterface)interface
{
  ...
  if (interface_onceToken_7 != -1) {
    dispatch_once(&interface_onceToken_7, block);
  }
  v2 = (void *)interface___interface_7;
...
void __73__SBSFocusModesHomeScreenSettingsServiceInterfaceSpecification_interface__block_invoke(uint64_t a1)
{
  ...
  v3 = [MEMORY[0x1E4F4F7B8] protocolForProtocol:&unk_1EDF6C118];
  [v6 setServer:v3];

  uint64_t v4 = [v6 copy];
  v5 = (void *)interface___interface_7;
  interface___interface_7 = v4;
}
