...
+ (NSString)identifier
{
  return (NSString *)@"com.apple.springboard.keyboard-focus-service";
}
...
+ (BSServiceInterface)interface
{
  ...
  v2 = (void *)interface___interface_12;
  return (BSServiceInterface *)v2;
}

void __49__SBSKeyboardFocusServiceSpecification_interface__block_invoke(uint64_t a1)
{
  id v7 = [MEMORY[0x1E4F4F7B8] protocolForProtocol:&unk_1EDF6C358];
  v2 = [MEMORY[0x1E4F4F7B8] protocolForProtocol:&unk_1EDF63350];
  ...
  [(id)interface___interface_12 setServer:v7];
  [(id)interface___interface_12 setClient:v2];
}
