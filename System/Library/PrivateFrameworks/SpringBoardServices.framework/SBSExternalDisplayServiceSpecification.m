...
+ (NSString)identifier
{
  return (NSString *)@"com.apple.springboard.external-display-service";
}
...
+ (BSServiceInterface)interface
{
  ...
  v2 = (void *)interface___interface_13;
  return (BSServiceInterface *)v2;
}

void __51__SBSExternalDisplayServiceSpecification_interface__block_invoke(uint64_t a1)
{
  id v7 = [MEMORY[0x1E4F4F7B8] protocolForProtocol:&unk_1EDF6C3B8];
  v2 = [MEMORY[0x1E4F4F7B8] protocolForProtocol:&unk_1EDF64FA8];
  ...
  [(id)interface___interface_13 setServer:v7];
  [(id)interface___interface_13 setClient:v2];
}
