...
- (_SUICEditScriptRanged)initWithOperationPrecedence:(int64_t)a3 dataClass:(Class)a4 chunkSize:(int64_t)a5 stringA:(id)a6 stringB:(id)a7 orderAtomsAscending:(BOOL)a8 options:(int64_t)a9
{
  ...
  id v16 = a7;
  v23.receiver = self;
  v23.super_class = (Class)_SUICEditScriptRanged;
...
- (NSString)stringA
{
  return (NSString *)[(_SUICEditScriptData *)self->super._itemAData stringValue];
}

- (NSString)stringB
{
  return (NSString *)[(_SUICEditScriptData *)self->super._itemBData stringValue];
}
...
+ (id)editScriptFromString:(id)a3 toString:(id)a4 chunkSize:(int64_t)a5 orderAtomsAscending:(BOOL)a6 operationPrecedence:(int64_t)a7 options:(int64_t)a8
{
  ...
  v13 = (__CFString *)a3;
  v14 = (__CFString *)a4;
  id v15 = [[_SUICEditScriptRanged alloc] initWithOperationPrecedence:a7 dataClass:objc_opt_class() chunkSize:a5 stringA:v13 stringB:v14 orderAtomsAscending:v10 options:a8];
  if (v13) {
    id v16 = v13;
  }
  else {
    id v16 = &stru_1EFB44F78;
  }
  if (v14) {
    v17 = v14;
  }
...
LABEL_10:
    ...
    uint64_t v20 = +[_SUICAtomRanged atomWithEditRange:replacementText:](_SUICAtomRanged, "atomWithEditRange:replacementText:", 0, [(__CFString *)v16 length], v17);
    [v19 addObject:v20];
...
- (void)addToCurrentScriptAtomEditOperation:(int64_t)a3 editIndex:(unint64_t)a4 newText:(id)a5 indexInArrayB:(unint64_t)a6
{
  ...
  if (a3)
  {
    ...
    if (a3 == 2)
    {
      ...
      {
LABEL_7:
        uint64_t v11 = [(_SUICAtomRanged *)self->_currentScriptAtom editRange];
        [(_SUICAtomRanged *)self->_currentScriptAtom editRange];
        -[_SUICAtomRanged setEditRange:](self->_currentScriptAtom, "setEditRange:", v11 - v10, v12 + v10);
        uint64_t v13 = NSString;
        uint64_t v14 = [(_SUICAtomRanged *)self->_currentScriptAtom replacementText];
...
LABEL_10:
    ...
    {
      uint64_t v10 = [(_SUICEditScriptData *)self->super._itemAData lengthOfItem:a4 - 1];
      if (currentScriptAtom) {
        goto LABEL_7;
      }
    }
    +[_SUICAtomRanged atomWithEditRange:replacementText:](_SUICAtomRanged, "atomWithEditRange:replacementText:", [(_SUICEditScriptData *)self->super._itemAData characterIndexForItem:a4] - v10, v10, v17);
    id v16 = (_SUICAtomRanged *)objc_claimAutoreleasedReturnValue();
  ...
  if (currentScriptAtom)
  {
    if (self->super._orderAtomsAscending)
    {
      ...
      if (v5 != v7)
      {
        ...
        long long v19 = 0u;
        long long v20 = 0u;
        uint64_t v9 = [(_SUICEditScript *)self script];
      ...
      id v17 = [(_SUICEditScript *)self script];
...
{
  BOOL v5 = a5;
  uint64_t v9 = [(_SUICEditScriptData *)self->super._itemAData length];
  uint64_t v10 = [(_SUICEditScriptData *)self->super._itemBData length];
  if (v9 >= v10) {
    uint64_t v11 = v10;
  }
  else {
...
- (void)computeSmallestSingleEdit
{
  ...
  char v17 = 0;
  uint64_t v16 = [(_SUICEditScriptData *)itemAData indexOfFirstDifferenceWithOtherData:self->super._itemBData shouldReverseIterate:0 fallsOnWordBoundary:&v17];
  if (v16 != -1)
  {
    uint64_t v15 = [(_SUICEditScriptData *)self->super._itemAData indexOfFirstDifferenceWithOtherData:self->super._itemBData shouldReverseIterate:1 fallsOnWordBoundary:0];
    ...
    uint64_t v4 = [(_SUICEditScriptData *)self->super._itemAData length];
    uint64_t v5 = v4 - v15;
    uint64_t v6 = [(_SUICEditScriptData *)self->super._itemBData length];
    uint64_t v7 = v6 - v15;
    uint64_t v8 = [(_SUICEditScriptData *)self->super._itemAData characterIndexForItem:v16];
    uint64_t v9 = [(_SUICEditScriptData *)self->super._itemAData characterIndexForItem:v5];
    uint64_t v10 = [(_SUICEditScriptData *)self->super._itemBData characterIndexForItem:v7] - v8;
    uint64_t v11 = [(_SUICEditScriptData *)self->super._itemBData stringValue];
    int64_t v12 = objc_msgSend(v11, "substringWithRange:", v8, v10);

    int64_t v13 = +[_SUICAtomRanged atomWithEditRange:replacementText:](_SUICAtomRanged, "atomWithEditRange:replacementText:", v8, v9 - v8, v12);
    uint64_t v14 = [(_SUICEditScript *)self script];
    [v14 addObject:v13];
  }
}
...
+ (id)editScriptForSmallestSingleEditFromString:(id)a3 toString:(id)a4 chunkSize:(int64_t)a5
{
  id v7 = a4;
  id v8 = a3;
  uint64_t v9 = [[_SUICEditScriptRanged alloc] initWithOperationPrecedence:-1 dataClass:objc_opt_class() chunkSize:a5 stringA:v8 stringB:v7 orderAtomsAscending:1 options:1];
