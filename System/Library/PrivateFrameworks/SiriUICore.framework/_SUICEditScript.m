...
{
  if ((unint64_t)(a3 - 1) > 4) {
    return &unk_1EFB50250;
  }
  else {
    return (id)qword_1E5C59418[a3 - 1];
  }
}
...
- (_SUICEditScript)initWithOperationPrecedence:(int64_t)a3 orderAtomsAscending:(BOOL)a4
{
  ...
  if (v6)
  {
    ...
    uint64_t v9 = [(_SUICEditScript *)v7 operationPrecedenceArrayFromOperationPrecedence:a3];
...
- (void)computeDistanceMatrix
{
  unint64_t v3 = [(_SUICEditScriptData *)self->_itemAData length];
  unint64_t v4 = [(_SUICEditScriptData *)self->_itemBData length];
  v5 = +[_SUICIntArray2D arrayWithISize:v3 + 1 jSize:v4 + 1];
  [(_SUICIntArray2D *)v5 setShouldBoundsCheck:1];
  if (v3)
  {
    for (unint64_t i = 1; i <= v3; ++i)
      [(_SUICIntArray2D *)v5 :i :0 newValue:i];
  }
  if (v4)
  {
    for (unint64_t j = 1; j <= v4; ++j)
      [(_SUICIntArray2D *)v5 :0 :j newValue:j];
    unint64_t v8 = 1;
    unint64_t v18 = v4;
    do
    {
      if (v3)
      {
        ...
        {
          uint64_t v10 = [(_SUICEditScriptData *)self->_itemAData stringAtIndex:k - 1];
          uint64_t v11 = [(_SUICEditScriptData *)self->_itemBData stringAtIndex:v8 - 1];
          int v12 = [v10 isEqualToString:v11];

          if (v12)
          {
            uint64_t v13 = [(_SUICIntArray2D *)v5 :k - 1 :v8 - 1];
          }
          else
          {
            uint64_t v14 = [(_SUICIntArray2D *)v5 :k - 1 :v8] + 1;
            uint64_t v15 = [(_SUICIntArray2D *)v5 :k :v8 - 1];
            if (v14 >= v15 + 1) {
              uint64_t v14 = v15 + 1;
            }
            uint64_t v16 = [(_SUICIntArray2D *)v5 :k - 1 :v8 - 1];
            if (v14 >= v16 + 1) {
              uint64_t v13 = v16 + 1;
            }
            else {
          ...
          [(_SUICIntArray2D *)v5 :k :v8 newValue:v13];
        }
      }
      ++v8;
    }
...
- (void)computeEditsFromMatrix
{
  ...
  uint64_t v3 = [(_SUICIntArray2D *)v29 iSize] - 1;
  uint64_t v4 = [(_SUICIntArray2D *)v29 jSize] - 1;
  if (v3 <= 0 && v4 < 1) {
    goto LABEL_57;
  }
  uint64_t v6 = 0;
  do
  {
    uint64_t v27 = v6;
    uint64_t v7 = v3--;
    uint64_t v8 = [(_SUICIntArray2D *)v29 :v3 :v4 outOfBoundsReturnValue:0x7FFFFFFFFFFFFFFFLL];
    uint64_t v28 = v4;
    uint64_t v9 = v4 - 1;
    uint64_t v10 = [(_SUICIntArray2D *)v29 :v7 :v4 - 1 outOfBoundsReturnValue:0x7FFFFFFFFFFFFFFFLL];
    uint64_t v11 = [(_SUICIntArray2D *)v29 :v3 :v4 - 1 outOfBoundsReturnValue:0x7FFFFFFFFFFFFFFFLL];
