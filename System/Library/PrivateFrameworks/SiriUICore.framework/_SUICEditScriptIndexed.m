...
- (id)applyToArray:(id)a3
{
  ...
  long long v18 = 0u;
  long long v19 = 0u;
  BOOL v7 = [(_SUICEditScript *)self script];
...
- (void)addToCurrentScriptAtomEditOperation:(int64_t)a3 editIndex:(unint64_t)a4 newText:(id)a5 indexInArrayB:(unint64_t)a6
{
  ...
  if (a3)
  {
    ...
    id v15 = v10;
    uint64_t v13 = +[_SUICAtomIndexed atomWithEditOperation:a3 indexToEdit:v12 newText:v10 indexInArrayB:a6];
    currentScriptAtom = self->_currentScriptAtom;
    self->_currentScriptAtom = v13;

    id v10 = (id)[(_SUICEditScriptIndexed *)self finalizeCurrentScriptAtom];
    id v11 = v15;
  }
