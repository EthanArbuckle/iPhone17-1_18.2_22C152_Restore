...
- (id)attachmentsForParameters:(id)a3
{
  ...
  if (v9)
  {
    uint64_t v10 = [v3 objectForKeyedSubscript:@"attachmentPath"];
  ...
  if (v11
    && ([v3 objectForKeyedSubscript:@"collect"],
  ...
  else
  {
    ...
    if (v14)
    {
      ...
      v26[0] = v8;
      v25[0] = @"folder";
      CFStringRef v15 = [v3 objectForKeyedSubscript:@"user"];
      v26[1] = v15;
