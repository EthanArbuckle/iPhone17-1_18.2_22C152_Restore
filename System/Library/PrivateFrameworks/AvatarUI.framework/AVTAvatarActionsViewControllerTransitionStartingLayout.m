...
{
  v8.receiver = self;
  v8.super_class = (Class)AVTAvatarActionsViewControllerTransitionStartingLayout;
  result = -[AVTAvatarActionsViewControllerLayout initWithContainerSize:insets:buttonCount:avtViewLayoutInfo:](&v8, sel_initWithContainerSize_insets_buttonCount_avtViewLayoutInfo_, a5, a6, a3.width, a3.height, a4.top, a4.left, a4.bottom, a4.right);
  if (result) {
