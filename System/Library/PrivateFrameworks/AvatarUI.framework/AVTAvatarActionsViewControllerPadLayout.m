...
- (CGRect)avatarContainerViewFrame
{
  ...
  double v4 = v3;
  [(AVTAvatarActionsViewControllerPadLayout *)self containerSize];
  double v6 = fmin(v5, 624.0);
  double v7 = [(AVTAvatarActionsViewControllerPadLayout *)self avtViewLayout];
  [v7 avtViewBackingSize];
  double v9 = v8;
  double v10 = [(AVTAvatarActionsViewControllerPadLayout *)self avtViewLayout];
