...
- (UIDelayedAction)initWithTarget:(id)a3 action:(SEL)a4 userInfo:(id)a5 delay:(double)a6
{
  return [(UIDelayedAction *)self initWithTarget:a3 action:a4 userInfo:a5 delay:*MEMORY[0x263EFF478] mode:a6];
}
...
- (void)touchWithDelay:(double)a3
{
  ...
  {
    v9 = (NSTimer *)[objc_alloc(MEMORY[0x263EFFA20]) initWithFireDate:v7 interval:self target:sel_timerFired_ selector:self->m_userInfo userInfo:0 repeats:a3];
    v10 = self->m_timer;
    self->m_timer = v9;
