@interface SCMLVisualGenerationHandling
+ (BOOL)allowImplicitDetections;
...
- (void)predictWithText:(NSString *)a3 completionHandler:(id)a4
{
  ...
  v15 = a3;
  v16 = self;
  sub_25BF86210((uint64_t)v9, (uint64_t)&unk_26A584870, (uint64_t)v14);
  swift_release();
}
