...
- (id)bindDataToInputsDirectly:(id)a3 batchSize:(int64_t)a4 error:(id *)a5 errorDomain:(id)a6
{
  ...
  id v26 = location[0];
  uint64_t v27 = [v26 countByEnumeratingWithState:__b objects:v50 count:16];
  if (v27)
  {
    ...
    while (1)
    {
      ...
      v37 = 0;
      id v17 = (id)[location[0] objectForKeyedSubscript:v39];
      ...
      if (v36)
      {
        ...
        if (v34)
        {
          uint64_t v10 = [v34 longValue];
          if (v37[2] * v37[3] * v37[4] * v37[5] == v10 * v42)
          {
            uint64_t v33 = *v37;
            unint64_t v32 = [v36 length] / 4uLL;
            for (unint64_t i = 0; i < v42; ++i)
            {
              unint64_t v30 = [v34 longValue];
              for (unint64_t j = 0; j < v30; ++j)
              {
                ...
                if (v28 >= v32)
                {
                  ...
                  id v14 = (id)[v13 initWithDomain:v40 code:91 userInfo:0];
                  id *v41 = v14;
                  id v45 = 0;
                  int v35 = 1;
                  goto LABEL_20;
          ...
          else
          {
            ...
            id v12 = (id)[v11 initWithDomain:v40 code:82 userInfo:0];
            id *v41 = v12;
            id v45 = 0;
            int v35 = 1;
          }
        ...
        else
        {
          ...
          id v9 = (id)[v8 initWithDomain:v40 code:80 userInfo:0];
          id *v41 = v9;
          id v45 = 0;
          int v35 = 1;
        }
LABEL_20:
      ...
      else
      {
        ...
        id v7 = (id)[v6 initWithDomain:v40 code:81 userInfo:0];
        id *v41 = v7;
        id v45 = 0;
        int v35 = 1;
      }
      ...
      {
        uint64_t v21 = 0;
        unint64_t v22 = [v26 countByEnumeratingWithState:__b objects:v50 count:16];
        if (!v22) {
          goto LABEL_24;
        }
      }
...
LABEL_24:
  ...
  if (!v35)
  {
    ...
    id v45 = (id)[NSNumber numberWithLong:1];
    int v35 = 1;
  }
