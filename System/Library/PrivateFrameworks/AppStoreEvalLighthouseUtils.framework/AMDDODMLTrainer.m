...
- (id)runTask:(id)a3 error:(id *)a4 errorDomain:(id)a5 dataProvider:(id)a6 attachmentProcessor:(id)a7
{
  ...
  if (v22)
  {
    ...
    if (v20)
    {
      uint64_t v19 = objc_msgSend(v24, "numberOfIterationsPerEpoch:", objc_msgSend(v22, "batchSize"));
      if (v19)
      {
        uint64_t v18 = [v22 numLocalIterations];
        if ([v22 numEpochs] > 0) {
          uint64_t v18 = [v22 numEpochs] * v19;
        }
        id v17 = (id)[v20 trainOnData:v24 numLocalIterations:v18 error:v26 errorDomain:v25];
        if (v17) {
      ...
      else
      {
        ...
        id v10 = (id)[v9 initWithDomain:v25 code:127 userInfo:0];
        id *v26 = v10;
        id v29 = 0;
        int v21 = 1;
      }
