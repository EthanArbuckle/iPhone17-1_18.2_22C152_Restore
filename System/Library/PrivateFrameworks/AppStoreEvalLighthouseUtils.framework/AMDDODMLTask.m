...
- (id)performTask:(id)a3 error:(id *)a4
{
  ...
  objc_storeStrong(location, a3);
  v101 = v87;
  id v88 = (id)[location[0] parameters];
  id v85 = v88;
  id v86 = (id)[v85 objectForKeyedSubscript:AttachmentInstructions];
  id v100 = v86;

  v84 = [AMDDODMLAttachmentProcessor alloc];
  id v83 = (id)[location[0] attachments];
  id v79 = v83;
  id v80 = v100;
  v81 = v87;
  ...
  if (v78)
  {
    ...
    id v74 = v76;
    id v75 = (id)[v74 objectForKeyedSubscript:DataProcessing];
    id v97 = v75;
    ...
    if (v97)
    {
      ...
      if (v68)
      {
        ...
        id v59 = v63;
        id v60 = (id)objc_msgSend(v96, "processRecipe:errorDomain:", v101);
        id v95 = v60;
        ...
        if (v95)
        {
          ...
          id v93 = 0;
          id v52 = (id)[v54 useCoreMLTrainer];
          id v50 = v52;
          uint64_t v51 = [v50 longValue];
          BOOL v49 = v51 != 0;

          if (v51)
          {
            v33 = [AMDCoreMLDataProvider alloc];
            uint64_t v32 = [v96 getInputSize];
            id v31 = (id)[v96 getElementsInSampleDictionary];
            id v29 = v31;
            id v30 = (id)[v96 getInputDictionary];
            id v27 = v30;
          ...
          else
          {
            ...
            uint64_t v47 = [v96 getInputSize];
            id v46 = (id)[v96 getElementsInSampleDictionary];
            id v44 = v46;
            id v45 = (id)[v96 getInputDictionary];
            id v42 = v45;
          ...
          if (v93)
          {
            id v18 = (id)[v93 JSONResult];
            id v17 = v18;
            NSLog(&stru_26FC16B00.isa, v17);
          }
          else
          {
      ...
      else
      {
        ...
        id v64 = v66;
        id v65 = (id)objc_msgSend(v67, "initWithDomain:code:userInfo:");
        id v6 = v65;
        id v7 = v64;
        id *v101 = v6;
    ...
    {
      id v73 = objc_alloc(MEMORY[0x263F087E8]);
      id v72 = [(AMDDODMLTask *)v103 errorDomain];
      id v70 = v72;
      id v71 = (id)objc_msgSend(v73, "initWithDomain:code:userInfo:");
      id v4 = v71;
      id v5 = v70;
      id *v101 = v4;
