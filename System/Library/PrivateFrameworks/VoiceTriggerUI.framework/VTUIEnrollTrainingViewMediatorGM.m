...
- (void)hideTrainingView:(BOOL)a3
{
  if (a3)
  {
    if (self->_trainingView)
    {
      ...
      v5[1] = 3221225472;
      v5[2] = __53__VTUIEnrollTrainingViewMediatorGM_hideTrainingView___block_invoke;
      v5[3] = &unk_264D4C280;
      v5[4] = self;
      v4[0] = MEMORY[0x263EF8330];
      v4[1] = 3221225472;
      v4[2] = __53__VTUIEnrollTrainingViewMediatorGM_hideTrainingView___block_invoke_2;
      v4[3] = &unk_264D4C5B0;
      v4[4] = self;
      [MEMORY[0x263F82E00] animateWithDuration:v5 animations:v4 completion:1.0];
    }
  }
  else
  {
...
void __53__VTUIEnrollTrainingViewMediatorGM_hideTrainingView___block_invoke_2(uint64_t a1, int a2)
{
  if (a2)
  {
    v3 = [*(id *)(a1 + 32) trainingView];
    [v3 setHidden:1];

    id v4 = [*(id *)(a1 + 32) trainingView];
    [v4 setAlpha:1.0];
  }
}
...
- (void)animateToListeningState
{
  id v2 = [(VTUIEnrollTrainingIntelligentLightView *)self->_trainingView lightLayer];
  [v2 setPaused:0];
}
...
- (void)addTargetToRadarExitButton:(id)a3 action:(SEL)a4 forControlEvents:(unint64_t)a5
{
  trainingView = self->_trainingView;
  id v8 = a3;
  id v9 = [(VTUIEnrollTrainingIntelligentLightView *)trainingView radarExitButton];
...
- (void)setPowerLevel:(float)a3
{
  id v5 = [(VTUIEnrollTrainingIntelligentLightView *)self->_trainingView lightLayer];
  *(float *)&double v4 = a3;
