...
- (unint64_t)hash
{
  return [(PXAppleMusicAsset *)self->_musicAsset hash];
}
...
- (NSString)uuid
{
  double v2 = [(PXAppleMusicArtworkAsset *)self musicAsset];
...
- (PXAppleMusicArtworkAsset)init
{
  ...
  objc_msgSend(v4, "handleFailureInMethod:object:file:lineNumber:description:", a2, self, @"PXAppleMusicArtworkAsset.m", 26, @"%s is not available as initializer", "-[PXAppleMusicArtworkAsset init]");
