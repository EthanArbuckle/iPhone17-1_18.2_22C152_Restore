...
- (id)performWithDataset:(id)a3 progressBlock:(id)a4
{
  ...
  if (![v8 count])
  {
    ...
    [v19 handleFailureInMethod:a2, self, @"PXStoryAutoEditMomentsProvider.m", 150, @"Invalid parameter not satisfying: %@", @"dataset.count > 0" object file lineNumber description];
  }
  char v20 = 0;
