...
- (void)setLensModel:(id)a3
{
  ...
  if (!v5)
  {
    ...
    [v9 handleFailureInMethod:a2, self, @"PXSmartAlbumEXIFCondition.m", 306, @"Invalid parameter not satisfying: %@", @"lensModel" object file lineNumber description];
  }
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    *(_DWORD *)buf = 138412290;
    id v11 = v5;
    _os_log_impl(&dword_1A9AE7000, v7, OS_LOG_TYPE_DEBUG, "PXSmartAlbums: lens model set to: \"%@\"", buf, 0xCu);
  }
