...
- (id)stateUpdatedWithChange:(id)a3 changeDetails:(id *)a4
{
  ...
  id v5 = a3;
  id v6 = [(PXCMMMomentsInvitationsDataSourceState *)self assetCollections];
  ...
  id v25 = [(PXCMMMomentsInvitationsDataSourceState *)self invitationsByAssetCollectionObjectID];
...
LABEL_27:
  ...
  if (v20 == v6 && v30 == v25) {
    ...
    v33 = [[PXCMMMomentsInvitationsDataSourceState alloc] initWithAssetCollections:v20 invitationsByAssetCollectionObjectID:v30];
  }
  v40 = v33;
...
{
  id v3 = a2;
  id v6 = +[PXCMMMomentsInvitation invitationWithAssetCollection:v3];
  v4 = *(void **)(a1 + 32);
  id v5 = [v3 objectID];
