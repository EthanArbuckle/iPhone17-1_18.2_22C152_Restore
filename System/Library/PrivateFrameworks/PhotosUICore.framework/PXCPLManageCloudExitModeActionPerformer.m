@interface PXCPLManageCloudExitModeActionPerformer
...
- (void)performBackgroundTask
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl(&dword_1A9AE7000, v3, OS_LOG_TYPE_DEFAULT, "Will navigate to iCloud Storage Settings", buf, 2u);
  }
  ...
  v4[3] = &unk_1E5DD3158;
  v4[4] = self;
  +[PXSystemNavigation navigateToDestination:5 completion:v4];
}
