...
uint64_t __36__PXDeleteAssetsAction_performUndo___block_invoke(uint64_t a1)
{
...
uint64_t __38__PXDeleteAssetsAction_performAction___block_invoke(uint64_t a1)
{
