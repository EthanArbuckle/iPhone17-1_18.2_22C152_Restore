...
+ (BOOL)canPerformWithSelectionSnapshot:(id)a3 person:(id)a4 socialGroup:(id)a5
{
  ...
  if (!v8)
  {
    ...
    [v12 handleFailureInMethod:a2, a1, @"PXPhotoKitRestoreAssetActionPerformer.m", 28, @"%@ should be an instance inheriting from %@, but it is nil", @"selectionSnapshot.dataSource", v14 object file lineNumber description];
LABEL_9:
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    [v12 handleFailureInMethod:a2, a1, @"PXPhotoKitRestoreAssetActionPerformer.m", 28, @"%@ should be an instance inheriting from %@, but it is %@", @"selectionSnapshot.dataSource", v14, v16 object file lineNumber description];

    goto LABEL_9;
  }
LABEL_4:
  v9 = [v8 containerCollection];
  char v10 = objc_msgSend(v9, "px_isRecentlyDeletedSmartAlbum");
