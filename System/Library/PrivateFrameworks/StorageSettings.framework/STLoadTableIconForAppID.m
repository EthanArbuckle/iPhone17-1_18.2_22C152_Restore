@interface STLoadTableIconForAppID
@end

@implementation STLoadTableIconForAppID

uint64_t ___STLoadTableIconForAppID_block_invoke()
{
  _gTableIconsByID = [MEMORY[0x263EFF9A0] dictionary];
...
{
  v2 = _LoadIconForAppID((void *)_gTableIconsByID, *(void **)(a1 + 32), 0, *(unsigned __int8 *)(a1 + 48));
