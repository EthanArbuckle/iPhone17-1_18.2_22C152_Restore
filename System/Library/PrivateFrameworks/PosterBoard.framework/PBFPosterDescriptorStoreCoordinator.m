...
- (id)_accessQueue_buildIdentityForVersion:(unint64_t)a3 supplement:(unint64_t)a4
{
  ...
  if (a4)
  {
    v15 = [NSString stringWithFormat:@"descriptors don't support multiple supplements : provider=%@ descriptor=%@ role=%@ posterUUID=%@ version=%llu supplement=%llu", v8, v9, v11, v10, a3, a4];
    if (os_log_type_enabled(MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR)) {
      -[PBFPosterDescriptorStoreCoordinator _accessQueue_buildIdentityForVersion:supplement:](a2, (uint64_t)self, (uint64_t)v15);
    }
LABEL_14:
    [v15 UTF8String];
  ...
  if (!v8 || !v9 || !v10 || !v11)
  {
    v15 = [NSString stringWithFormat:@"descriptors missing component : provider=%@ descriptor=%@ role=%@ posterUUID=%@ version=%llu supplement=%llu", v8, v9, v11, v10, a3, 0];
    if (os_log_type_enabled(MEMORY[0x1E4F14500], OS_LOG_TYPE_ERROR)) {
      -[PBFPosterDescriptorStoreCoordinator _accessQueue_buildIdentityForVersion:supplement:](a2, (uint64_t)self, (uint64_t)v15);
    }
    goto LABEL_14;
  }
  v13 = [MEMORY[0x1E4F924C8] descriptorIdentityWithProvider:v8 identifier:v9 role:v11 posterUUID:v10 version:a3];
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->_descriptorIdentifierURL, 0);
}
