...
- (id)addCSPNFiltersToBMDSL:(id)a3;
...
{
  id v5 = a3;
  if (qword_1000A4700 != -1) {
    dispatch_once(&qword_1000A4700, &stru_100091648);
  }
  if ((byte_1000A46F8 & 1) != 0
  ...
  {
    v18.receiver = self;
    v18.super_class = (Class)PMCoreSmartPowerNapLocationMonitor;
    ...
    if (v8)
    {
      ...
      v9 = (void *)qword_1000A4708;
      uint64_t v27 = qword_1000A4708;
      if (!qword_1000A4708)
      {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl((void *)&_mh_execute_header, v15, OS_LOG_TYPE_DEFAULT, "Initialized CoreSmartPowerNapLocationMonitor", buf, 2u);
    }
    self = v8;
    v16 = self;
  }
...
- (void)registerForLocalLOISignals
{
  ...
  if (objc_opt_class())
  {
    ...
    id v5 = [(PMCoreSmartPowerNapLocationMonitor *)self queue];
    ...
    v11[3] = &unk_1000915E0;
    v11[4] = self;
    v10 = [v9 sinkWithCompletion:&stru_1000915B8 receiveInput:v11];
...
- (void)registerForRemoteLOISignals
{
  ...
  unsigned int v7 = [(PMCoreSmartPowerNapLocationMonitor *)self queue];
  ...
  v13[3] = &unk_1000915E0;
  v13[4] = self;
  v12 = [v11 sinkWithCompletion:&stru_100091600 receiveInput:v13];
}

- (id)addCSPNFiltersToBMDSL:(id)a3
{
  return [a3 filterWithKeyPath:@"eventBody.userSpecificPlaceType" comparison:3 value:&off_10009AAD8];
}
