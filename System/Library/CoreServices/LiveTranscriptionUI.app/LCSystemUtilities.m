...
+ (BOOL)liveCaptionsSupported
{
  ...
  v2 = (uint64_t (*)(const __CFString *))off_10006CD00;
  v8 = off_10006CD00;
  if (!off_10006CD00)
  {
    v3 = (void *)sub_100004168();
    v6[3] = (uint64_t)dlsym(v3, "AXHasCapability");
    off_10006CD00 = (_UNKNOWN *)v6[3];
...
+ (void)registerLiveCaptionsPID
{
  ...
  v2 = (void *)qword_10006CD10;
  uint64_t v9 = qword_10006CD10;
  if (!qword_10006CD10)
  {
...
- (void)idleSleepTimerDisabled:(BOOL)a3
{
  ...
  if (a3)
  {
    ...
    uint64_t v5 = (void *)qword_10006CD18;
    uint64_t v17 = qword_10006CD18;
    if (!qword_10006CD18)
    {
    ...
    {
      LOWORD(v13[0]) = 0;
      _os_log_impl((void *)&_mh_execute_header, v10, OS_LOG_TYPE_DEFAULT, "Idle sleep assertion is acquired", (uint8_t *)v13, 2u);
    }
  }
  else
  {
    if (disableIdleTimerAssertion)
    {
      ...
      {
        LOWORD(v13[0]) = 0;
        _os_log_impl((void *)&_mh_execute_header, v11, OS_LOG_TYPE_DEFAULT, "Idle sleep assertion is invalidated", (uint8_t *)v13, 2u);
      }
