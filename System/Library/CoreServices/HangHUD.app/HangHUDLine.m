...
- (HangHUDLine)initWithQueue:(id)a3 processName:(id)a4 theme:(id)a5 fontSize:(double)a6 lineDelegate:(id)a7
{
  ...
  if (v16)
  {
    [(HUDLine *)v16 setSpacing:sub_10001AB84()];
    ...
    [(CATextLayer *)v16->_processNameLayer setFont:qword_10003E9C8];
    ...
    [(HUDDurationLayer *)v16->_durationLayer setFont:qword_10003E9D8];
...
- (int64_t)statusForHangWithDuration:(double)a3 timedOut:(BOOL)a4
{
  ...
  id v13 = objc_msgSend(v12, "runloopHangTimeoutDurationMSec", v9, v14, v5, v15, v6, v7);
...
LABEL_12:
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG)) {
    sub_10001CEDC((uint64_t)self, v7);
  }
LABEL_13:
}
