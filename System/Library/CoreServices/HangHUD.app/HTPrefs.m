...
- (NSArray)prefContextPrefixPriorityOrder
{
  if (qword_10003EA50 != -1) {
    dispatch_once(&qword_10003EA50, &stru_100031970);
  }
  v2 = (void *)qword_10003EA58;
...
- (id)prefNamed:(__CFString *)a3 domain:(__CFString *)a4 profile:(id)a5 matchingSelector:(SEL)a6 contextPrefixOut:(id *)a7
{
  ...
  if (v10)
  {
    ...
    while (2)
    {
      for (i = 0; i != v11; i = (char *)i + 1)
      {
        ...
        unsigned int v15 = [(__CFString *)v14 isEqualToString:&stru_100031C30];
        if (v15)
        {
          v16 = v26;
        }
  ...
  if (os_log_type_enabled(obj, OS_LOG_TYPE_DEBUG)) {
    sub_10001D574((uint64_t)v26, (uint64_t)a4, obj);
  }
  v19 = 0;
LABEL_25:
...
- (void)initPropertyHangtracerDaemonEnabled:(HTPrefInit *)a3
{
  ...
  if (![(NSString *)v9 isEqualToString:v8])
  {
    ...
    int v10 = sub_100006A20();
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG)) {
      sub_10001D5FC((uint64_t)v9, &self->_enablementPrefix, v10);
    }
  }
...
- (void)initPropertyReportPeriod:(HTPrefInit *)a3
{
  ...
  double v7 = v6 * 1000.0 / sub_10001B32C();
...
- (void)initPropertyProcessTerminationSubReasonsMonitored:(HTPrefInit *)a3
{
  uint64_t v4 = sub_10000525C();
  int v17 = +[NSMutableDictionary dictionary];
  unsigned int v19 = [@"HangTracerEnableTerminationsTrackedReasons" stringByAppendingString:@"."];
  long long v20 = 0u;
  long long v21 = 0u;
  long long v22 = 0u;
  long long v23 = 0u;
  ...
  if (v5)
  {
    ...
    do
    {
      for (i = 0; i != v6; i = (char *)i + 1)
      {
        ...
        objc_msgSend(v19, "stringByAppendingFormat:", @"%llu", objc_msgSend(v9, "unsignedLongLongValue"));
...
+ (id)sharedPrefs
{
  if (qword_10003EA68 != -1) {
    dispatch_once(&qword_10003EA68, &stru_100031990);
  }
  v2 = (void *)qword_10003EA60;
...
- (HTPrefInit)prefInitList
{
  ...
  if (!result)
  {
    ...
    result = (HTPrefInit *)malloc_type_malloc(0xFF0uLL, 0x3506460CuLL);
    ...
    result[72].var0 = @"PDSEPrefHTBadDayKillSwitch";
    result->var0 = @"HangTracerEnableTailspin";
    result->var1 = &self->_htTailspinEnabled;
    result[72].var1 = &self->_pdseHTBadDayKillSwitch;
    result[73].var0 = @"PDSEPrefAllowEnableTailspin";
    result[73].var1 = &self->_pdseAllowEnableTailspin;
    result[74].var0 = @"BadDaySecondsBetweenLastEnablementAndReferenceDate";
    result[1].var0 = @"HangTracerEnableHUD";
    result[1].var1 = &self->_hudEnabled;
    result[74].var1 = &self->_badDaySecondsBetweenLastEnablementAndReferenceDate;
    result[75].var0 = @"BadDayEnablementMinimumBreakDurationDays";
    result[75].var1 = &self->_badDayEnablementMinimumBreakDurationDays;
    result[76].var0 = @"BadDayEnablementDurationDaysKey";
    result[2].var0 = @"HangTracerCollectOSSignposts";
    result[2].var1 = &self->_shouldCollectOSSignposts;
    result[76].var1 = &self->_badDayEnablementDurationDays;
    result[77].var0 = @"BadDayEnablementForHangDurationMSec";
    result[77].var1 = &self->_badDayEnablementForHangDurationMSec;
    result[78].var0 = @"BadDayEnablementForLogCount";
    result[3].var0 = @"HangTracerCollectOSSignpostsDeferred";
    result[3].var1 = &self->_shouldCollectOSSignpostsDeferred;
    result[78].var1 = &self->_badDayEnablementForLogCount;
    result[79].var0 = @"BadDayEnablementForPreviousDays";
    result[79].var1 = &self->_badDayEnablementForPreviousDays;
    result[80].var0 = @"HangTracerTelemetryHaveNonDefaultFeatureFlags";
    ...
    result[80].var1 = &self->_haveNonDefaultFeatureFlags;
    result[81].var0 = @"HangTracerTelemetrySerialLoggingEnabled";
    result[81].var1 = &self->_haveSerialLoggingEnabled;
    result[82].var0 = @"HangTracerTelemetryNumOSCryptexFileExtents";
    result[82].var1 = &self->_numOSCryptexFileExtents;
    result[83].var0 = @"HangTracerTelemetryHaveRootsInstalled";
    result[83].var1 = &self->_haveRootsInstalled;
    HIDWORD(result[5].var2.var3) = *(_DWORD *)&v88[3];
    *(_DWORD *)(&result[5].var2.var0 + 1) = *(_DWORD *)v88;
    HIDWORD(result[5].var3.var3) = *(_DWORD *)&v87[3];
    *(_DWORD *)(&result[5].var3.var0 + 1) = *(_DWORD *)v87;
    HIDWORD(result[7].var2.var3) = *(_DWORD *)&v86[3];
    *(_DWORD *)(&result[7].var2.var0 + 1) = *(_DWORD *)v86;
    HIDWORD(result[7].var3.var3) = *(_DWORD *)&v85[3];
    *(_DWORD *)(&result[7].var3.var0 + 1) = *(_DWORD *)v85;
    HIDWORD(result[8].var2.var3) = *(_DWORD *)&v84[3];
    *(_DWORD *)(&result[8].var2.var0 + 1) = *(_DWORD *)v84;
    HIDWORD(result[8].var3.var3) = *(_DWORD *)&v83[3];
    *(_DWORD *)(&result[8].var3.var0 + 1) = *(_DWORD *)v83;
    HIDWORD(result[9].var2.var3) = *(_DWORD *)&v82[3];
    *(_DWORD *)(&result[9].var2.var0 + 1) = *(_DWORD *)v82;
    HIDWORD(result[9].var3.var3) = *(_DWORD *)&v81[3];
    *(_DWORD *)(&result[9].var3.var0 + 1) = *(_DWORD *)v81;
    HIDWORD(result[10].var2.var3) = *(_DWORD *)&v80[3];
    *(_DWORD *)(&result[10].var2.var0 + 1) = *(_DWORD *)v80;
    HIDWORD(result[10].var3.var3) = *(_DWORD *)&v79[3];
    *(_DWORD *)(&result[10].var3.var0 + 1) = *(_DWORD *)v79;
    HIDWORD(result[11].var2.var3) = *(_DWORD *)&v78[3];
    *(_DWORD *)(&result[11].var2.var0 + 1) = *(_DWORD *)v78;
    HIDWORD(result[11].var3.var3) = *(_DWORD *)&v77[3];
    *(_DWORD *)(&result[11].var3.var0 + 1) = *(_DWORD *)v77;
    *(_DWORD *)(&result[25].var2.var0 + 1) = *(_DWORD *)v76;
    *(_DWORD *)(&result[25].var3.var0 + 1) = *(_DWORD *)v75;
    *(_DWORD *)(&result[28].var2.var0 + 1) = *(_DWORD *)v74;
    *(_DWORD *)(&result[28].var3.var0 + 1) = *(_DWORD *)v73;
    HIDWORD(result[30].var2.var3) = *(_DWORD *)&v72[3];
    *(_DWORD *)(&result[30].var2.var0 + 1) = *(_DWORD *)v72;
    HIDWORD(result[30].var3.var3) = *(_DWORD *)&v71[3];
    *(_DWORD *)(&result[30].var3.var0 + 1) = *(_DWORD *)v71;
    *(_DWORD *)(&result[33].var2.var0 + 1) = *(_DWORD *)v70;
    *(_DWORD *)(&result[33].var3.var0 + 1) = *(_DWORD *)v69;
    HIDWORD(result[34].var2.var3) = *(_DWORD *)&v68[3];
    *(_DWORD *)(&result[34].var2.var0 + 1) = *(_DWORD *)v68;
    HIDWORD(result[34].var3.var3) = *(_DWORD *)&v67[3];
    *(_DWORD *)(&result[34].var3.var0 + 1) = *(_DWORD *)v67;
    *(_DWORD *)(&result[37].var2.var0 + 1) = *(_DWORD *)v66;
    *(_DWORD *)(&result[37].var3.var0 + 1) = *(_DWORD *)v65;
    HIDWORD(result[39].var2.var3) = *(_DWORD *)&v64[3];
    *(_DWORD *)(&result[39].var2.var0 + 1) = *(_DWORD *)v64;
    HIDWORD(result[39].var3.var3) = *(_DWORD *)&v63[3];
    *(_DWORD *)(&result[39].var3.var0 + 1) = *(_DWORD *)v63;
    *(_DWORD *)(&result[40].var2.var0 + 1) = *(_DWORD *)v62;
    HIDWORD(result[40].var3.var3) = *(_DWORD *)&v61[3];
    *(_DWORD *)(&result[40].var3.var0 + 1) = *(_DWORD *)v61;
    HIDWORD(result[43].var2.var3) = *(_DWORD *)&v60[3];
    *(_DWORD *)(&result[43].var2.var0 + 1) = *(_DWORD *)v60;
    HIDWORD(result[43].var3.var3) = *(_DWORD *)&v59[3];
    *(_DWORD *)(&result[43].var3.var0 + 1) = *(_DWORD *)v59;
    *(_DWORD *)(&result[46].var2.var0 + 1) = *(_DWORD *)v58;
    *(_DWORD *)(&result[46].var3.var0 + 1) = *(_DWORD *)v57;
    HIDWORD(result[47].var2.var3) = *(_DWORD *)&v56[3];
    *(_DWORD *)(&result[47].var2.var0 + 1) = *(_DWORD *)v56;
    HIDWORD(result[47].var3.var3) = *(_DWORD *)&v55[3];
    *(_DWORD *)(&result[47].var3.var0 + 1) = *(_DWORD *)v55;
    HIDWORD(result[48].var2.var3) = *(_DWORD *)&v54[3];
    *(_DWORD *)(&result[48].var2.var0 + 1) = *(_DWORD *)v54;
    *(_DWORD *)(&result[48].var3.var0 + 1) = *(_DWORD *)v53;
    HIDWORD(result[51].var2.var3) = *(_DWORD *)&v52[3];
    *(_DWORD *)(&result[51].var2.var0 + 1) = *(_DWORD *)v52;
    HIDWORD(result[51].var3.var3) = *(_DWORD *)&v51[3];
    *(_DWORD *)(&result[51].var3.var0 + 1) = *(_DWORD *)v51;
    HIDWORD(result[52].var2.var3) = *(_DWORD *)&v50[3];
    *(_DWORD *)(&result[52].var2.var0 + 1) = *(_DWORD *)v50;
    HIDWORD(result[52].var3.var3) = *(_DWORD *)&v49[3];
    *(_DWORD *)(&result[52].var3.var0 + 1) = *(_DWORD *)v49;
    HIDWORD(result[54].var2.var3) = *(_DWORD *)&v48[3];
    *(_DWORD *)(&result[54].var2.var0 + 1) = *(_DWORD *)v48;
    HIDWORD(result[54].var3.var3) = *(_DWORD *)&v47[3];
    *(_DWORD *)(&result[54].var3.var0 + 1) = *(_DWORD *)v47;
    HIDWORD(result[55].var2.var3) = *(_DWORD *)&v46[3];
    *(_DWORD *)(&result[55].var2.var0 + 1) = *(_DWORD *)v46;
    HIDWORD(result[55].var3.var3) = *(_DWORD *)&v45[3];
    *(_DWORD *)(&result[55].var3.var0 + 1) = *(_DWORD *)v45;
    HIDWORD(result[56].var2.var3) = *(_DWORD *)&v44[3];
    *(_DWORD *)(&result[56].var2.var0 + 1) = *(_DWORD *)v44;
    HIDWORD(result[56].var3.var3) = *(_DWORD *)&v43[3];
    *(_DWORD *)(&result[56].var3.var0 + 1) = *(_DWORD *)v43;
    HIDWORD(result[57].var2.var3) = *(_DWORD *)&v42[3];
    *(_DWORD *)(&result[57].var2.var0 + 1) = *(_DWORD *)v42;
    HIDWORD(result[57].var3.var3) = *(_DWORD *)&v41[3];
    *(_DWORD *)(&result[57].var3.var0 + 1) = *(_DWORD *)v41;
    HIDWORD(result[58].var2.var3) = *(_DWORD *)&v40[3];
    *(_DWORD *)(&result[58].var2.var0 + 1) = *(_DWORD *)v40;
    HIDWORD(result[58].var3.var3) = *(_DWORD *)&v39[3];
    *(_DWORD *)(&result[58].var3.var0 + 1) = *(_DWORD *)v39;
    HIDWORD(result[59].var2.var3) = *(_DWORD *)&v38[3];
    *(_DWORD *)(&result[59].var2.var0 + 1) = *(_DWORD *)v38;
    HIDWORD(result[59].var3.var3) = *(_DWORD *)&v37[3];
    *(_DWORD *)(&result[59].var3.var0 + 1) = *(_DWORD *)v37;
    HIDWORD(result[60].var2.var3) = *(_DWORD *)&v36[3];
    *(_DWORD *)(&result[60].var2.var0 + 1) = *(_DWORD *)v36;
    HIDWORD(result[60].var3.var3) = *(_DWORD *)&v35[3];
    *(_DWORD *)(&result[60].var3.var0 + 1) = *(_DWORD *)v35;
    *(_DWORD *)(&result[2].var2.var0 + 1) = *(_DWORD *)v92;
    HIDWORD(result[2].var2.var3) = *(_DWORD *)&v92[3];
    *(_DWORD *)(&result[2].var3.var0 + 1) = *(_DWORD *)v91;
    HIDWORD(result[2].var3.var3) = *(_DWORD *)&v91[3];
    *(_DWORD *)(&result[3].var2.var0 + 1) = *(_DWORD *)v90;
    HIDWORD(result[3].var2.var3) = *(_DWORD *)&v90[3];
    HIDWORD(result[3].var3.var3) = *(_DWORD *)&v89[3];
    *(_DWORD *)(&result[3].var3.var0 + 1) = *(_DWORD *)v89;
    ...
    HIDWORD(result[25].var2.var3) = *(_DWORD *)&v76[3];
    HIDWORD(result[25].var3.var3) = *(_DWORD *)&v75[3];
    ...
    HIDWORD(result[28].var2.var3) = *(_DWORD *)&v74[3];
    HIDWORD(result[28].var3.var3) = *(_DWORD *)&v73[3];
    ...
    HIDWORD(result[33].var2.var3) = *(_DWORD *)&v70[3];
    HIDWORD(result[33].var3.var3) = *(_DWORD *)&v69[3];
    ...
    HIDWORD(result[37].var2.var3) = *(_DWORD *)&v66[3];
    HIDWORD(result[37].var3.var3) = *(_DWORD *)&v65[3];
    ...
    HIDWORD(result[40].var2.var3) = *(_DWORD *)&v62[3];
    ...
    result[46].var0 = @"HangTracerEnableTerminationsInHUD";
    result[46].var1 = &self->_areProcessTerminationsMonitored;
    HIDWORD(result[46].var2.var3) = *(_DWORD *)&v58[3];
    HIDWORD(result[46].var3.var3) = *(_DWORD *)&v57[3];
    result[47].var0 = @"HangTracerEnableTerminationsAllProcessesTracked";
    result[47].var1 = &self->_areAllProcessTerminationsMonitored;
    result[48].var0 = @"HangTracerEnableTerminationsCriticalProcessesTracked";
    result[48].var1 = &self->_areCriticalProcessTerminationsMonitored;
    HIDWORD(result[48].var3.var3) = *(_DWORD *)&v53[3];
    result[49].var0 = @"HangTracerEnableTerminationsTrackedProcessesList";
    result[49].var1 = &self->_processTerminationNamesMonitored;
    result[49].var5 = "initNSObjectProperty:";
    result[50].var0 = @"HangTracerEnableTerminationsTrackedReasons";
    result[50].var1 = &self->_processTerminationReasonsMonitored;
    result[50].var5 = "initUnsignedLongLongProperty:";
    result[51].var0 = @"HangTracerThirdPartyDevHangHUDEnabled";
    result[51].var1 = &self->_thirdPartyDevHangHUDEnabled;
    result[52].var0 = @"HangTracerThirdPartyIncludeNonDevelopmentApps";
    result[52].var1 = &self->_thirdPartyIncludeNonDevelopmentApps;
    result[53].var0 = @"HangTracerHangWaitTimeoutDuration";
    result[53].var1 = &self->_hangWaitTimeoutDurationMSec;
    ...
    result[53].var5 = "initUnsignedLongProperty:";
    result[54].var0 = @"enableLoggingForPoster";
    result[54].var1 = &self->_enableLoggingForPoster;
    result[55].var0 = @"enableLoggingForWidgetRenderer";
    result[55].var1 = &self->_enableLoggingForWidgetRenderer;
    result[56].var0 = @"PDSEPrefHangTracerKillSwitch";
    result[56].var1 = &self->_pdseHangTracerKillSwitch;
    result[57].var0 = @"PDSEPrefHTRateOnlyKillSwitch";
    result[57].var1 = &self->_pdseHTRateOnlyKillSwitch;
    result[58].var0 = @"PDSEPrefHTThirdPartyKillSwitch";
    result[58].var1 = &self->_pdseHTThirdPartyKillSwitch;
    result[6].unint64_t var4 = 0;
    result[7].var0 = 0;
    result[7].unint64_t var4 = 0;
    __asm { FMOV            V6.2D, #2.0 }
    *(_OWORD *)&result[12].var2.var0 = _Q6;
    *(_OWORD *)&result[13].var2.var0 = xmmword_100023340;
    *(int64x2_t *)&result[21].var2.var0 = vdupq_n_s64(0x1F4uLL);
    *(int64x2_t *)&result[42].var2.var0 = vdupq_n_s64(0x40AC200000000000uLL);
    result[59].var0 = @"PDSEPrefAppLaunchKillSwitch";
    result->var2.var0 = 1;
    result->var3.var0 = 0;
    ...
    result[59].var1 = &self->_pdseAppLaunchKillSwitch;
    ...
    result[60].var0 = @"HangTracerShouldUploadToDiagPipe";
    ...
    result[60].var1 = &self->_shouldUploadToDiagPipe;
    ...
    *(int64x2_t *)&result[53].var2.var0 = v11;
    ...
    HIDWORD(result[61].var2.var3) = *(_DWORD *)&v34[3];
    *(_DWORD *)(&result[61].var2.var0 + 1) = *(_DWORD *)v34;
    result[61].var3.var0 = 1;
    HIDWORD(result[61].var3.var3) = *(_DWORD *)&v33[3];
    *(_DWORD *)(&result[61].var3.var0 + 1) = *(_DWORD *)v33;
    ...
    HIDWORD(result[62].var2.var3) = *(_DWORD *)&v32[3];
    *(_DWORD *)(&result[62].var2.var0 + 1) = *(_DWORD *)v32;
    result[62].var3.var0 = 1;
    HIDWORD(result[62].var3.var3) = *(_DWORD *)&v31[3];
    *(_DWORD *)(&result[62].var3.var0 + 1) = *(_DWORD *)v31;
    ...
    HIDWORD(result[63].var2.var3) = *(_DWORD *)&v30[3];
    *(_DWORD *)(&result[63].var2.var0 + 1) = *(_DWORD *)v30;
    result[63].var3.var0 = 1;
    HIDWORD(result[63].var3.var3) = *(_DWORD *)&v29[3];
    *(_DWORD *)(&result[63].var3.var0 + 1) = *(_DWORD *)v29;
    ...
    *(_DWORD *)(&result[72].var2.var0 + 1) = *(_DWORD *)v28;
    HIDWORD(result[72].var2.var3) = *(_DWORD *)&v28[3];
    result[72].var3.var0 = 1;
    *(_DWORD *)(&result[72].var3.var0 + 1) = *(_DWORD *)v27;
    HIDWORD(result[72].var3.var3) = *(_DWORD *)&v27[3];
    result[72].unint64_t var4 = 0;
    result[72].var5 = "initBoolProperty:";
    result[73].var2.var0 = 1;
    HIDWORD(result[73].var2.var3) = *(_DWORD *)&v26[3];
    *(_DWORD *)(&result[73].var2.var0 + 1) = *(_DWORD *)v26;
    result[73].var3.var0 = 1;
    HIDWORD(result[73].var3.var3) = *(_DWORD *)&v25[3];
    *(_DWORD *)(&result[73].var3.var0 + 1) = *(_DWORD *)v25;
    result[73].unint64_t var4 = 0;
    result[73].var5 = "initBoolProperty:";
    *(_OWORD *)&result[74].var2.var0 = 0u;
    result[74].unint64_t var4 = 0;
    result[74].var5 = "initDoubleProperty:";
    result[75].var2.var1 = 14;
    result[75].var3.var1 = 14;
    result[75].unint64_t var4 = 0;
    result[75].var5 = "initUnsignedIntProperty:";
    result[76].var2.var1 = 2;
    result[76].var3.var1 = 2;
    result[76].unint64_t var4 = 0;
    result[76].var5 = "initUnsignedIntProperty:";
    *(int64x2_t *)&result[77].var2.var0 = v10;
    result[77].unint64_t var4 = 0;
    result[77].var5 = "initUnsignedIntProperty:";
    result[78].var2.var1 = 8;
    result[78].var3.var1 = 8;
    result[78].unint64_t var4 = 0;
    result[78].var5 = "initUnsignedIntProperty:";
    result[79].var2.var1 = 1;
    result[79].var3.var1 = 1;
    result[79].unint64_t var4 = 1;
    result[79].var5 = "initUnsignedIntProperty:";
    result[80].var2.var0 = 0;
    *(_DWORD *)(&result[80].var2.var0 + 1) = *(_DWORD *)v24;
    HIDWORD(result[80].var2.var3) = *(_DWORD *)&v24[3];
    result[80].var3.var0 = 0;
    *(_DWORD *)(&result[80].var3.var0 + 1) = *(_DWORD *)v23;
    HIDWORD(result[80].var3.var3) = *(_DWORD *)&v23[3];
    result[80].unint64_t var4 = 0;
    result[80].var5 = "initBoolProperty:";
    result[81].var2.var0 = 0;
    HIDWORD(result[81].var2.var3) = *(_DWORD *)&v22[3];
    *(_DWORD *)(&result[81].var2.var0 + 1) = *(_DWORD *)v22;
    result[81].var3.var0 = 0;
    HIDWORD(result[81].var3.var3) = *(_DWORD *)&v21[3];
    *(_DWORD *)(&result[81].var3.var0 + 1) = *(_DWORD *)v21;
    result[81].unint64_t var4 = 0;
    result[81].var5 = "initBoolProperty:";
    result[82].var2.var1 = 0;
    result[82].var3.var1 = 0;
    result[82].unint64_t var4 = 0;
    result[82].var5 = "initIntProperty:";
    result[83].var2.var0 = 0;
    HIDWORD(result[83].var2.var3) = *(_DWORD *)&v20[3];
    *(_DWORD *)(&result[83].var2.var0 + 1) = *(_DWORD *)v20;
    result[83].var3.var0 = 0;
    HIDWORD(result[83].var3.var3) = *(_DWORD *)&v19[3];
    *(_DWORD *)(&result[83].var3.var0 + 1) = *(_DWORD *)v19;
    result[83].unint64_t var4 = 0;
    result[83].var5 = "initBoolProperty:";
    *(_OWORD *)&result[84].var0 = 0u;
    result[84].var2.var0 = 0;
    HIDWORD(result[84].var2.var3) = 0;
    *(_DWORD *)(&result[84].var2.var0 + 1) = 0;
    result[84].var5 = 0;
    *(_OWORD *)(&result[84].var3.var0 + 1) = v93;
...
- (void)refreshHTPrefs
{
  ...
  {
    LOWORD(v11[0]) = 0;
    _os_log_impl((void *)&_mh_execute_header, v3, OS_LOG_TYPE_INFO, "HTPrefs: Refreshing preferences", (uint8_t *)v11, 2u);
  }
  ...
  if (var5)
  {
    do
    {
      objc_msgSend(self, var5, v6);
      HTPrefDefaultVal v8 = v6 + 1;
      var5 = v6[1].var5;
      ++v6;
    }
    while (var5);
    HTPrefDefaultVal v6 = v8;
  }
  [(HTPrefs *)self initPropertyProcessTerminationSubReasonsMonitored:v6];
  if ([(HTPrefs *)self shouldPostHTPrefsChangedNotification])
  {
    [(HTPrefs *)self setShouldPostHTPrefsChangedNotification:0];
    int64x2_t v9 = sub_100006A20();
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)buf = 138412290;
      CFStringRef v13 = @"com.apple.hangtracer.htprefs.refreshed";
      _os_log_impl((void *)&_mh_execute_header, v9, OS_LOG_TYPE_INFO, "Posting notification %@", buf, 0xCu);
    }

    int64x2_t v10 = +[NSNotificationCenter defaultCenter];
...
- (void)__createInternalSettings
{
  ...
  {
    HTPrefDefaultVal v5 = sub_100006A20();
  ...
  CFPreferencesSetValue(@"HangTracerInternalSettingsVersion", &off_100035BB8, self->__htTaskingDomain, @"mobile", kCFPreferencesAnyHost);
LABEL_12:
...
- (void)setupPrefsWithQueue:(id)a3 profilePath:(id)a4 taskingDomainName:(__CFString *)a5 hangtracerDomain:(__CFString *)a6 setupInternalPrefs:(BOOL)a7
{
  ...
  *(void *)buf = 0;
  ...
  notify_register_dispatch(off_10003E8F8, v30 + 6, (dispatch_queue_t)self->__prefsQueue, v18);
  notify_register_dispatch(off_10003E8E0, (int *)v42 + 6, (dispatch_queue_t)self->__prefsQueue, v18);
  notify_register_dispatch(off_10003E8E8, v38 + 6, (dispatch_queue_t)self->__prefsQueue, v18);
  notify_register_dispatch(off_10003E8F0, v34 + 6, (dispatch_queue_t)self->__prefsQueue, v18);
  notify_register_dispatch(off_10003E900, v24 + 6, (dispatch_queue_t)self->__prefsQueue, v19);
  [(HTPrefs *)self setShouldPostHTPrefsChangedNotification:1];
...
- (void)_removeAllPrefs
{
  ...
  long long v21 = +[NSArray arrayWithObjects:v37 count:53];
  v3 = sub_10000525C();
  ...
  int64x2_t v11 = [v21 arrayByAddingObjectsFromArray:v4];
