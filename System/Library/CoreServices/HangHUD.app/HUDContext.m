...
+ (id)displayNameForHangInfo:(id)a3
{
  ...
  {
    if (qword_10003E990 != -1) {
      dispatch_once(&qword_10003E990, &stru_100030A68);
    }
    v4 = (void *)qword_10003E998;
    v5 = [v3 bundleId];
...
- (HUDContext)initWithRenderContext:(id)a3 queue:(id)a4
{
  ...
  if (v9)
  {
    ...
    LOBYTE(v32) = 0;
    v21 = [[HTHangHUDInfo alloc] initWithHangStartTime:0 hangEndTime:0 receivedTimestamp:0 hangDurationMS:&stru_100031C30 hudString:&stru_100031C30 shortenedBundle:@"com.apple.HangHUD" bundleId:10000.0 timedOut:v32];
    v22 = [HangHUDLine alloc];
    queue = v9->_queue;
    currentTheme = v9->_currentTheme;
    sub_10001A688();
    v25 = -[HangHUDLine initWithQueue:processName:theme:fontSize:lineDelegate:](v22, "initWithQueue:processName:theme:fontSize:lineDelegate:", queue, &stru_100031C30, currentTheme, 0);
...
- (void)clearHUDLinesAnimated:(BOOL)a3 withCompletion:(id)a4
{
  ...
  else
  {
    ...
    else
    {
      ...
      objc_msgSend(v16, "setFrame:", CGRectZero.origin.x, CGRectZero.origin.y, CGRectZero.size.width, CGRectZero.size.height);
...
- (void)determineNewFrameForRootLayer:(CGSize)a3 numberOfLines:(unint64_t)a4
{
  ...
  {
    double v15 = height + sub_10001A9B8();
    double v16 = width + self->_sidePadding * 2.0;
    double y = (sub_10001AA88() - v16) * 0.5;
    if (v9 == (void *)kCADisplayOrientationRotation270)
    {
      double x = sub_10001A528() - v15 - x;
  ...
  double v16 = height + sub_10001A9B8();
  double v13 = sub_10001A528();
  if (v9 == v10)
  {
...
- (CGSize)layoutHUDLines:(unint64_t)a3 ids:(id)a4
{
  ...
  double v12 = v36[3];
  double v13 = sub_10001AB84();
  double v14 = v32[3];
  sub_10001AB30();
  double v16 = v15;
  double sidePadding = self->_sidePadding;
  double v18 = sub_10001A9B8();
...
- (void)updateCurrentTheme
{
  sub_10000A400((uint64_t)[(UISCurrentUserInterfaceStyleValue *)self->_userInterfaceStyleObserver userInterfaceStyle]);
