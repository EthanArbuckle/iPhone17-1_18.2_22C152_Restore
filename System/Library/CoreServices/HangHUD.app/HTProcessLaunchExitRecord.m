...
+ (void)fetchProcessRecords
{
  if (qword_10003E948 != -1) {
    dispatch_once(&qword_10003E948, &stru_100030880);
  }
  ...
  else
  {
    ...
    for (unint64_t i = 0; i < (unint64_t)[(id)qword_10003E950 count]; ++i)
    {
      id v7 = [(id)qword_10003E950 objectAtIndex:i];
      id v8 = [v7 exitTimestamp];

      id v9 = +[HTPrefs sharedPrefs];
      unint64_t v10 = v5 - (void)v8;
      LODWORD(v8) = sub_10001B47C((unint64_t)[v9 runloopHangTimeoutDurationMSec] + 30000) < (double)(v5 - (unint64_t)v8);

      if (v8)
      {
        unsigned __int16 v11 = sub_100006A20();
        if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
        {
          double v12 = sub_10001B3C0(v10);
          v13 = +[HTPrefs sharedPrefs];
          uint64_t v14 = (char *)[v13 runloopHangTimeoutDurationMSec];
          v15 = [(id)qword_10003E950 getDescription:i];
...
+ (id)getProcessExitsAndLaunchesDuringHang:(unint64_t)a3 endTime:(unint64_t)a4
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 134218240;
    double v48 = sub_10001B3C0(a3);
    __int16 v49 = 2048;
    double v50 = sub_10001B3C0(a4);
  ...
  if ([(id)qword_10003E950 count])
  {
    uint64_t v5 = 0;
    unsigned int v6 = 1;
    do
    {
      id v7 = [(id)qword_10003E950 objectAtIndex:v5];
      v45[0] = @"processName";
      v42 = [v7 processName];
      v46[0] = v42;
      v45[1] = @"processID";
      ...
      v40 = [(id)qword_10003E950 dateFormatter];
      v39 = sub_100006584((uint64_t)[v7 spawnTimestamp], v33, v31);
      v38 = [v40 stringFromDate:v39];
      v46[2] = v38;
      v45[3] = @"exitTimestamp";
      v37 = [(id)qword_10003E950 dateFormatter];
      v36 = sub_100006584((uint64_t)[v7 exitTimestamp], v33, v31);
      ...
      double v12 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", v11, sub_10001B418(v10));
      v46[4] = v12;
      ...
      v17 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", v16, sub_10001B418(v15));
      v46[5] = v17;
      v45[6] = @"processUptime";
      dispatch_time_t v18 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"%.3lfs", sub_10001B418((unsigned char *)[v7 exitTimestamp] - (unsigned char *)objc_msgSend(v7, "spawnTimestamp")));
      v46[6] = v18;
      v45[7] = @"exitReasonCode";
      v19 = sub_100012A4C((int)[v7 exitReasonNamespace], (uint64_t)objc_msgSend(v7, "exitReasonCode"));
      v46[7] = v19;
      v45[8] = @"exitReasonNamespace";
      objc_super v20 = sub_1000117FC([v7 exitReasonNamespace]);
      v46[8] = v20;
      v45[9] = @"jetsamPriority";
      v21 = +[NSNumber numberWithUnsignedShort:](NSNumber, "numberWithUnsignedShort:", objc_msgSend(v7, "jetsam_priority"));
      v46[9] = v21;
    ...
    while ((unint64_t)[(id)qword_10003E950 count] > v6++);
  }
...
- (BOOL)isCurrent:(unint64_t)a3 withHUDUpdateInterval:(double)a4
{
  return sub_10001B3C0(a3 - self->_requestedToRenderTimestamp) < 200.0;
}
