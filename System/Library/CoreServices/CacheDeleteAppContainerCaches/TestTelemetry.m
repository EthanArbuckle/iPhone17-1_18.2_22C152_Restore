        ...
        && ([(id)v9 intValue] || objc_msgSend((id)v11, "intValue")))
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
        {
          *(_DWORD *)buf = 138412546;
          ...
          __int16 v24 = 2112;
          v25 = v5;
          _os_log_impl((void *)&_mh_execute_header, v17, OS_LOG_TYPE_DEFAULT, "initialized TestTelemetry: %@, info: %@", buf, 0x16u);
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
        {
          *(_DWORD *)buf = 138412290;
          v23 = v5;
          _os_log_error_impl((void *)&_mh_execute_header, v19, OS_LOG_TYPE_ERROR, "Invalid test parameters: %@", buf, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled((os_log_t)v9, OS_LOG_TYPE_ERROR))
      {
        *(_DWORD *)buf = 136315138;
        ...
        _os_log_error_impl((void *)&_mh_execute_header, (os_log_t)v9, OS_LOG_TYPE_ERROR, "[%s] no test parameters in info", buf, 0xCu);
      }
      v18 = 0;
    }
  }
...
- (id)description
{
  ...
  uint64_t v7 = v6;
  v8 = [(TestTelemetry *)self removeFailures];
  uint64_t v9 = +[NSString stringWithFormat:@"termination threshold: %f -- failures: %@, remove threshold: %f -- failures: %@", v4, v5, v7, v8];
...
{
  v1 = *(void **)(a1 + 32);
  v2 = (char *)objc_msgSend(v1, "files_deleted") + *(void *)(a1 + 40);
...
- (unint64_t)deletes
{
  ...
  uint64_t v10 = 0;
  uint64_t v3 = [(TestTelemetry *)self q];
  v6[0] = _NSConcreteStackBlock;
  v6[1] = 3221225472;
