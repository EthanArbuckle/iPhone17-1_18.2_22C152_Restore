...
- (void)menuItemWasActivated:(id)a3
{
  ...
  else
  {
    ...
    {
      v7.receiver = self;
      v7.super_class = (Class)SCATModernMenuGesturePanSheet;
...
- (SCATMenuPanItemsViewDelegate)delegate
{
  ...
  return (SCATMenuPanItemsViewDelegate *)WeakRetained;
}
