...
- (void)menuItemWasActivated:(id)a3
{
  ...
  else
  {
    ...
    {
      v7.receiver = self;
      v7.super_class = (Class)SCATModernMenuGestureFlickSheet;
...
- (SCATMenuFlickItemsViewDelegate)delegate
{
  ...
  return (SCATMenuFlickItemsViewDelegate *)WeakRetained;
}
