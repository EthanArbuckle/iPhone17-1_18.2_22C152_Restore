@interface RAWConvertSRGBtoLinear
- (id)outputImage;
@end
...
- (id)outputImage
{
  if (self->inputImage)
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_signpost_emit_with_name_impl(&dword_1DDA14000, v4, OS_SIGNPOST_INTERVAL_BEGIN, (os_signpost_id_t)self, "RAWConvertSRGBtoLinear", (const char *)&unk_1DDC3ACB6, buf, 2u);
    }
    ...
    v6 = self->inputImage;
    v10 = objc_msgSend_kernelWithName_(RAWKernels, v7, @"raw_srgb_to_linear", v8, v9);
