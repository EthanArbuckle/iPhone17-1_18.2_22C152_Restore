@interface RAWOpcodeFixVignetteRadial
- (CIImage)inputImage;
- (NSDictionary)arguments;
- (RAWOpcodeFixVignetteRadial)initWithArguments:(id)a3;
- (id)outputImage;
- (void)setArguments:(id)a3;
- (void)setInputImage:(id)a3;
@end

@implementation RAWOpcodeFixVignetteRadial

- (RAWOpcodeFixVignetteRadial)initWithArguments:(id)a3
{
  id v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)RAWOpcodeFixVignetteRadial;
  v5 = [(RAWOpcodeFixVignetteRadial *)&v11 init];
  v9 = v5;
  if (v5) {
...
- (id)outputImage
{
  ...
  objc_msgSend_kernelWithString_(MEMORY[0x1E4F1E010], a2, @"kernel vec4 rc_fix_vignette_radial (__sample c) { return c; }",
    v2,
  v5 = v3);
