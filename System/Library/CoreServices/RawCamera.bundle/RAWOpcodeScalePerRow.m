@interface RAWOpcodeScalePerRow
- (CIImage)inputImage;
- (NSDictionary)arguments;
- (RAWOpcodeScalePerRow)initWithArguments:(id)a3;
- (id)outputImage;
- (void)setArguments:(id)a3;
- (void)setInputImage:(id)a3;
@end

@implementation RAWOpcodeScalePerRow

- (RAWOpcodeScalePerRow)initWithArguments:(id)a3
{
  id v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)RAWOpcodeScalePerRow;
  v5 = [(RAWOpcodeScalePerRow *)&v11 init];
  v9 = v5;
  if (v5) {
...
- (id)outputImage
{
  ...
  objc_msgSend_kernelWithString_(MEMORY[0x1E4F1E010], a2, @"kernel vec4 rc_scale_per_row (__sample c) { return c; }",
    v2,
  v5 = v3);
