...
- (RAWOpcodeDeltaPerRow)initWithArguments:(id)a3;
- (id)outputImage;
...
- (RAWOpcodeDeltaPerRow)initWithArguments:(id)a3
{
  id v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)RAWOpcodeDeltaPerRow;
  v5 = [(RAWOpcodeDeltaPerRow *)&v11 init];
  v9 = v5;
  if (v5) {
...
- (id)outputImage
{
  ...
  objc_msgSend_kernelWithString_(MEMORY[0x1E4F1E010], a2, @"kernel vec4 rc_delta_per_row (__sample c) { return c; }",
    v2,
  v5 = v3);
