...
- (RAWOpcodeFixBadPixelsConstant)initWithArguments:(id)a3;
- (id)outputImage;
...
- (RAWOpcodeFixBadPixelsConstant)initWithArguments:(id)a3
{
  id v4 = a3;
  v11.receiver = self;
  v11.super_class = (Class)RAWOpcodeFixBadPixelsConstant;
...
- (id)outputImage
{
  ...
  objc_msgSend_kernelWithString_(MEMORY[0x1E4F1E010], a2, @"kernel vec4 rc_fix_bad_pixels_constant (__sample c) { return c; }",
    v2,
  v5 = v3);
