...
- (id)keyCommands
{
  id v3 = [(FKACrosshairPointPickerViewController *)self cachedKeyCommands];
...
- (void)_handleSpace:(id)a3
{
  ...
  id v6 = [(FKAPointPickerViewController *)self delegate];
...
- (void)_handleLeftArrow:(id)a3
{
  id v3 = [(FKACrosshairPointPickerViewController *)self pointPickerView];
  [v3 moveLeft];
}
...
- (void)_handleShiftLeftArrow:(id)a3
{
  ...
  id v5 = [(FKACrosshairPointPickerViewController *)self pointPickerView];
  [v5 moveLeft];
}
...
- (void)_handleEscape:(id)a3
{
  id v4 = [(FKAPointPickerViewController *)self delegate];
  [v4 dismissPointPickerViewController:self];
}
