...
- (id)keyCommands
{
  id v3 = [(FKAGridPointPickerViewController *)self cachedKeyCommands];
...
- (void)_handleSpace:(id)a3
{
  ...
  {
    *(_WORD *)v12 = 0;
    _os_log_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_INFO, "Handle space", v12, 2u);
  }
  ...
  objc_msgSend(v11, "pointPickerViewController:tapScreenPoint:", self, v7, v9);
}
...
- (void)_handleD:(id)a3
{
  ...
  {
    *(_WORD *)v12 = 0;
    _os_log_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_INFO, "Handle D", v12, 2u);
  }
  ...
  v11 = [(FKAPointPickerViewController *)self delegate];
  objc_msgSend(v11, "pointPickerViewController:doubleTapScreenPoint:", self, v7, v9);
}
...
- (void)_handleReturn:(id)a3
{
  ...
  {
    *(_WORD *)double v6 = 0;
    _os_log_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_INFO, "Handle return", v6, 2u);
  }
...
- (void)_handleShiftReturn:(id)a3
{
  ...
  {
    *(_WORD *)double v6 = 0;
    _os_log_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_INFO, "Handle shift return", v6, 2u);
  }
...
- (void)_handleLeftArrow:(id)a3
{
  ...
  {
    *(_WORD *)double v6 = 0;
    _os_log_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_INFO, "Handle left arrow", v6, 2u);
  }
...
- (void)_handleRightArrow:(id)a3
{
  ...
  {
    *(_WORD *)double v6 = 0;
    _os_log_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_INFO, "Handle right arrow", v6, 2u);
  }
...
- (void)_handleUpArrow:(id)a3
{
  ...
  {
    *(_WORD *)double v6 = 0;
    _os_log_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_INFO, "Handle up arrow", v6, 2u);
  }
...
- (void)_handleDownArrow:(id)a3
{
  ...
  {
    *(_WORD *)double v6 = 0;
    _os_log_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_INFO, "Handle down arrow", v6, 2u);
  }
...
- (void)_handleEscape:(id)a3
{
  ...
  {
    *(_WORD *)double v6 = 0;
    _os_log_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_INFO, "Handle escape", v6, 2u);
  }
