...
{
  v5.receiver = self;
  v5.super_class = (Class)FKAControlsViewController;
...
- (void)loadView
{
  ...
  objc_super v5 = [(FKAControlsViewController *)self _addButtonWithTitle:@"Tap" action:"performDefaultAction" toView:v67];
