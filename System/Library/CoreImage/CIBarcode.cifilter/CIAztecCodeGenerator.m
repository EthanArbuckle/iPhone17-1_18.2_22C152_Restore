...
- (void)setValue:(id)a3 forUndefinedKey:(id)a4
{
  ...
  {
    v15.receiver = self;
    v15.super_class = (Class)CIAztecCodeGenerator;
...
- (CGImage)outputCGImage
{
  ...
  {
    CFStringRef v5 = @"CIAztecCodeGenerator filter requires NSData for inputMessage";
    goto LABEL_9;
  }
  if (self->inputCorrectionLevel)
  {
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) == 0
      || ([(NSNumber *)self->inputCorrectionLevel floatValue], v3 < 5.0)
      || ([(NSNumber *)self->inputCorrectionLevel floatValue], v4 > 95.0))
    {
      CFStringRef v5 = @"CIAztecCodeGenerator filter requires nil or a number between 5 and 95 for inputCorrectionLevel";
LABEL_9:
  ...
  if (self->inputLayers)
  {
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) == 0
      || ([(NSNumber *)self->inputLayers floatValue], v8 < 1.0)
      || ([(NSNumber *)self->inputLayers floatValue], v9 > 32.0))
    {
      CFStringRef v5 = @"CIAztecCodeGenerator filter requires nil or a number between 1 and 32 for inputLayers";
      goto LABEL_9;
    }
  }
  if (self->inputCompactStyle)
  {
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) == 0
      || ([(NSNumber *)self->inputCompactStyle isEqual:&__kCFBooleanTrue] & 1) == 0
      && ([(NSNumber *)self->inputCompactStyle isEqual:&__kCFBooleanFalse] & 1) == 0)
    {
      CFStringRef v5 = @"CIAztecCodeGenerator filter requires nil or @YES or @NO for inputCompactStyle";
      goto LABEL_9;
    }
  }
  ...
  id v19 = 0;
  CGImageRef v6 = sub_CA60(inputMessage, v11, (uint64_t)&v19);
  id v16 = v19;
  v17 = v16;
  if (v6)
  {
...
- (void).cxx_destruct
{
  ...
  objc_storeStrong((id *)&self->inputLayers, 0);
