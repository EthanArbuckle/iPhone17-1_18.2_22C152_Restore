...
{
  if (qword_8D030 != -1) {
    dispatch_once(&qword_8D030, &stru_75998);
  }
  return (id)qword_8D028;
}

- (id)_mixKernel
{
  if (qword_8D040 != -1) {
    dispatch_once(&qword_8D040, &stru_759B8);
  }
  return (id)qword_8D038;
}
...
- (id)outputImage
{
  ...
  if (result)
  {
    ...
    if (v21)
    {
      ...
      long long v128 = 0u;
      long long v129 = 0u;
      id v22 = [(NSArray *)v21 countByEnumeratingWithState:&v128 objects:v146 count:16];
      if (v22)
      {
        id v23 = v22;
        ...
        do
        {
          ...
          do
          {
            ...
            v25 = *(void **)(*((void *)&v128 + 1) + 8 * (void)v24);
            float v26 = 0.0;
            float v27 = 0.0;
            ...
            {
              v32 = -[LightingFacePoints initWithFaceLandmarkDictionary:forImageRect:]([LightingFacePoints alloc], "initWithFaceLandmarkDictionary:forImageRect:", v25, v119, v118, v117, v116);
              v33 = [(LightingFacePoints *)v32 leftKickLights];
              v123 = +[CIVector vectorWithCGPoint:](CIVector, "vectorWithCGPoint:", *v33, v33[1]);
              v34 = [(LightingFacePoints *)v32 leftKickLights];
              v122 = +[CIVector vectorWithCGPoint:](CIVector, "vectorWithCGPoint:", v34[1].x, v34[1].y);
              v35 = [(LightingFacePoints *)v32 leftKickLights];
              v121 = +[CIVector vectorWithCGPoint:](CIVector, "vectorWithCGPoint:", v35[2].x, v35[2].y);
              v36 = [(LightingFacePoints *)v32 rightKickLights];
              v37 = +[CIVector vectorWithCGPoint:](CIVector, "vectorWithCGPoint:", *v36, v36[1]);
              v38 = v20;
              v39 = [(LightingFacePoints *)v32 rightKickLights];
              v40 = +[CIVector vectorWithCGPoint:](CIVector, "vectorWithCGPoint:", v39[1].x, v39[1].y);
              v41 = [(LightingFacePoints *)v32 rightKickLights];
              v42 = +[CIVector vectorWithCGPoint:](CIVector, "vectorWithCGPoint:", v41[2].x, v41[2].y);
              id v126 = [v25 objectForKeyedSubscript:@"orientation"];
              [(LightingFacePoints *)v32 faceWidth];
              float v44 = v43 / v117;
              [(NSNumber *)self->super.inputScale floatValue];
              v144[0] = @"inputImage";
              v144[1] = @"inputPt1";
              float v46 = fmin(v44 + v44, 1.0) * v45;
              v145[0] = v38;
              v145[1] = v123;
              v144[2] = @"inputPt2";
              v144[3] = @"inputPt3";
              ...
              v49 = +[CIVector vectorWithCGPoint:](CIVector, "vectorWithCGPoint:");
              [(LightingFacePoints *)v32 bottomShadow];
              v50 = +[CIVector vectorWithCGPoint:](CIVector, "vectorWithCGPoint:");
              [(LightingFacePoints *)v32 bottomShadow];
              v51 = +[CIVector vectorWithCGPoint:](CIVector, "vectorWithCGPoint:");
              v142[0] = @"inputImage";
              v142[1] = @"inputCenter1";
              v143[0] = v48;
              v143[1] = v49;
              ...
              v83 = +[CIVector vectorWithCGPoint:](CIVector, "vectorWithCGPoint:", *v82, v82[1]);
              v84 = [(LightingFacePoints *)v32 noseStrobe];
              v85 = +[CIVector vectorWithCGPoint:](CIVector, "vectorWithCGPoint:", v84[1].x, v84[1].y);
              v136[0] = @"inputImage";
              v136[1] = @"inputCenter1";
              v137[0] = v81;
              v137[1] = v83;
          ...
          while (v23 != v24);
          id v23 = [(NSArray *)v21 countByEnumeratingWithState:&v128 objects:v146 count:16];
        }
        while (v23);
      }
    }
    ...
    if (inputDepthMap)
    {
      ...
      if (v90 != v91)
      {
        ...
        [(CIImage *)self->inputDepthMap extent];
        float v100 = v99;
        CGAffineTransformMakeScale(&v127, v96, (float)(v98 / v100));
        inputDepthMap = [(CIImage *)inputDepthMap imageByApplyingTransform:&v127];
      }
      id v101 = [(CIPortraitEffectCommercial *)self _prepareDepth];
      [(CIImage *)self->super.inputImage extent];
      inputDepthThreshold = self->inputDepthThreshold;
      v135[0] = inputDepthMap;
      v135[1] = inputDepthThreshold;
      id v107 = objc_msgSend(v101, "applyWithExtent:arguments:", +[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", v135, 2), v103, v104, v105, v106);
    ...
    if (v109 < 1.0)
    {
      id v110 = [(CIPortraitEffectCommercial *)self _mixKernel];
      [(CIImage *)self->super.inputImage extent];
      v132[0] = self->super.inputImage;
      v132[1] = v20;
      v132[2] = self->super.inputStrength;
      v20 = (CIImage *)objc_msgSend(v110, "applyWithExtent:arguments:", +[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", v132, 3), v111, v112, v113, v114);
    }
