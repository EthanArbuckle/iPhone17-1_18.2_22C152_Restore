@interface PFBilateralGridHash
- (BOOL)_hashMapFindKey:(unint64_t)a3 to:(unsigned int *)a4;
- (PFBilateralGridHash)initWithWidth:(int)a3 height:(int)a4 maxHashTableSize:(unint64_t)a5;
...
@implementation PFBilateralGridHash
...
{
  v12.receiver = self;
  v12.super_class = (Class)PFBilateralGridHash;
  v8 = [(PFBilateralGridHash *)&v12 init];
  v9 = v8;
  if (v8)
  {
    v8->_n_dims = 0;
    ...
    *(void *)&v8->_sigma_r_luma = 0;
    ...
    v9->_hash_table = ($B3D8014AD49003293F7EA9812628114E *)malloc_type_malloc(24 * a5, 0x1000040504FFAC1uLL);
    ...
    v9->_hash_map = (BGHashMapContext *)sub_18208(a5);
...
- (void)dealloc
{
  ...
  sub_18298(self->_hash_map);
  v3.receiver = self;
  v3.super_class = (Class)PFBilateralGridHash;
  [(PFBilateralGridHash *)&v3 dealloc];
}
...
- (void)clear
{
  *(void *)&self->_sigma_r_luma = 0;
  ...
  sub_182EC((uint64_t)self->_hash_map);
}
...
- (int)_createWithSurface:(__IOSurface *)a3 region:(CGRect)a4 cropRect:(CGRect)a5 sigma_s:(int)a6 sigma_r_luma:(int)a7 sigma_r_chroma:(int)a8
{
  ...
  [(PFBilateralGridHash *)self clear];
  if (-[PFBilateralGridHash _computeBilateralSpaceYCC444:region:cropRect:sigma_s:sigma_r_luma:sigma_r_chroma:](self, "_computeBilateralSpaceYCC444:region:cropRect:sigma_s:sigma_r_luma:sigma_r_chroma:", a3, v10, v9, v8, v18, v17, v16, v15, x, y, width, height))
  {
  ...
  {
    [(PFBilateralGridHash *)self _computeBlurIndices];
    [(PFBilateralGridHash *)self _computeCoordIndices];
    [(PFBilateralGridHash *)self _computeInterpIndices];
    return 0;
  }
}
...
- (int)createWithSurface:(__IOSurface *)a3 region:(CGRect)a4 cropRect:(CGRect)a5 sigma_s:(int)a6 sigma_r_luma:(int)a7 sigma_r_chroma:(int)a8
{
  ...
  int result = -[PFBilateralGridHash _createWithSurface:region:cropRect:sigma_s:sigma_r_luma:sigma_r_chroma:](self, "_createWithSurface:region:cropRect:sigma_s:sigma_r_luma:sigma_r_chroma:", a3, *(void *)&a6, *(void *)&a7, *(void *)&a8);
  if (result)
  {
    return -[PFBilateralGridHash _createWithSurface:region:cropRect:sigma_s:sigma_r_luma:sigma_r_chroma:](self, "_createWithSurface:region:cropRect:sigma_s:sigma_r_luma:sigma_r_chroma:", a3, v9, v8, 255, v17, v16, v15, v14, x, y, width, height);
  }
  return result;
}
...
- (void)splat:(__CVBuffer *)a3 pout:(float *)a4
{
  signed int v7 = [(PFBilateralGridHash *)self countVertices];
  int v8 = [(PFBilateralGridHash *)self width];
  int v9 = [(PFBilateralGridHash *)self height];
...
- (void)splat_w_mul_x:(__CVBuffer *)a3 inPixelBuffer:(__CVBuffer *)a4 pout:(float *)a5
{
  signed int v19 = [(PFBilateralGridHash *)self countVertices];
  int v9 = [(PFBilateralGridHash *)self width];
  int v10 = [(PFBilateralGridHash *)self height];
  CVPixelBufferLockBaseAddress(a3, 0);
...
- (void)slice:(const float *)a3 outPixelBuffer:(__CVBuffer *)a4
{
  int v7 = [(PFBilateralGridHash *)self width];
  int v8 = [(PFBilateralGridHash *)self height];
  CVPixelBufferLockBaseAddress(a4, 0);
...
- (void)blur:(const float *)a3 pout:(float *)a4
{
  unsigned int v7 = [(PFBilateralGridHash *)self countDims];
  int v8 = [(PFBilateralGridHash *)self countVertices];
  if (v8 >= 1)
  {
    uint64_t v9 = v8;
    int v10 = a3;
...
- (void)normalize:(const float *)a3 pout:(float *)a4
{
  int v7 = [(PFBilateralGridHash *)self countVertices];
  if (v7 >= 1)
  {
    uint64_t v8 = v7;
...
- (void)splat_ones:(float *)a3
{
  int v5 = [(PFBilateralGridHash *)self countVertices];
  if (v5 >= 1)
  {
    uint64_t v6 = v5;
    p_var1 = &self->_hash_table->var1;
...
LABEL_35:
      ...
      while (1)
      {
        ...
        v49 += 4;
        unsigned int v51 = [(PFBilateralGridHash *)self _addHashKeyAtX:v48 Y:v46 key:(v48 >> v37) | ((unint64_t)(v46 >> v37) << 8) | (v50 >> v34 << 16) isKeyExist:0];
        if (v51) {
          break;
        }
        if (v25 == ++v48)
...
LABEL_43:
      ...
      while (1)
      {
        unsigned int v51 = [(PFBilateralGridHash *)self _addHashKeyAtX:v54 Y:v52 key:(v54 >> v37) | ((unint64_t)((v52 >> v37) | (v53[1] >> v34 << 8) | (*v53 >> v27 << 16) | (*(v53 - 1) >> v27 << 24)) << 8) isKeyExist:0];
        if (v51) {
          break;
        }
        v53 += 4;
...
LABEL_52:
      ...
      while (1)
      {
        ...
        v66[3] = *v57 / a8;
        v66[4] = *(v57 - 1) / a8;
        unsigned int v51 = [(PFBilateralGridHash *)self _addHashKeyAtX:v58 Y:v55 key:v56(v66) isKeyExist:0];
        if (v51) {
          break;
        }
        v57 += 4;
...
- (void)_computeBlurIndices
{
  int v3 = [(PFBilateralGridHash *)self countDims];
  int v4 = [(PFBilateralGridHash *)self countVertices];
  if (v4 >= 1)
  {
    uint64_t v5 = 0;
    unsigned int v6 = 0;
    ...
    do
    {
      ...
      if (v3 >= 1)
      {
        ...
        do
        {
          ...
          {
            char v13 = v12;
            uint64_t v14 = sub_29D60(var0, v9, dword_55E20[v11]);
            if (v14 != -1)
            {
              unsigned int v20 = 0;
              if ([(PFBilateralGridHash *)self _hashMapFindKey:v14 to:&v20])
              {
...
- (void)_computeCoordIndices
{
  int v3 = [(PFBilateralGridHash *)self width];
  int v4 = [(PFBilateralGridHash *)self height];
  int v5 = [(PFBilateralGridHash *)self countVertices];
...
- (void)_computeInterpIndices
{
  int v3 = [(PFBilateralGridHash *)self countVertices];
  if (v3 < 1)
  {
    unsigned int v5 = 0;
  }
  else
  {
    ...
    do
    {
      ...
      {
        unsigned int v8 = v7;
        unint64_t v9 = sub_29D9C(v7);
        unsigned int v11 = 0;
        if ([(PFBilateralGridHash *)self _hashMapFindKey:v9 + var0 to:&v11])
        {
...
- (BOOL)_hashMapFindKey:(unint64_t)a3 to:(unsigned int *)a4
{
  return sub_18354((uint64_t)self->_hash_map, a3, a4);
}
...
{
  unsigned int v17 = 0;
  if ([(PFBilateralGridHash *)self _hashMapFindKey:a5 to:&v17])
  {
    hash_table = self->_hash_table;
...
LABEL_6:
  ...
  if (self->_max_hash_table_size > hash_table_size)
  {
    ...
    *(_OWORD *)&v15->var1 = xmmword_55E10;
    self->_hash_matrix_data[a3 + self->_width * a4] = hash_table_size;
    -[PFBilateralGridHash _hashMapAddKey:andValue:](self, "_hashMapAddKey:andValue:", a5);
    BOOL v12 = 0;
    if (a6) {
      goto LABEL_6;
    }
