...
{
  if (qword_8CF10 != -1) {
    dispatch_once(&qword_8CF10, &stru_756A0);
  }
  return (id)qword_8CF08;
}
...
- (id)outputImage
{
  ...
  id v4 = [(CIBrightenSat *)self _brightenSat];
  ...
  return objc_msgSend(v4, "applyWithExtent:arguments:", +[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", v21, 6), v11, v13, v15, v17);
}
