...
- (id)outputImage
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)CIPortraitEffectStageMonoV2;
  id result = [(CIPortraitEffectStageV2 *)&v3 outputImage];
  if (result) {
    return objc_msgSend(objc_msgSend(objc_msgSend(result, "imageByApplyingFilter:", @"CIPhotoEffectStageMono"), "imageByApplyingFilter:withInputParameters:", @"CIHighKey", &off_7DD60), "imageByApplyingFilter:withInputParameters:", @"CISmartBlackAndWhite", &off_7DD88);
  }
  return result;
}
