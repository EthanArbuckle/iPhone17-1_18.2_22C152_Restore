...
- (id)outputImage
{
  ...
  id v4 = sub_18A44(inputLightMap, self->inputLightMapWidth, self->inputLightMapHeight);
  inputGuideImage = self->inputGuideImage;
  if (inputGuideImage)
  {
    CGAffineTransformMakeScale(&v9, 0.5, 0.5);
    id v6 = sub_18BCC(v4, [(CIImage *)inputGuideImage imageByApplyingTransform:&v9], (uint64_t)self->inputGuidedFilterEpsilon);
