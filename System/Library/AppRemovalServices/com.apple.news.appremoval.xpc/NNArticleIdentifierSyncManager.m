...
+ (id)savedManager
{
  if (qword_10000CFA8 != -1) {
    dispatch_once(&qword_10000CFA8, &stru_100008360);
  }
  v2 = (void *)qword_10000CFA0;
  return v2;
}

+ (id)seenManager
{
  if (qword_10000CFB8 != -1) {
    dispatch_once(&qword_10000CFB8, &stru_100008380);
  }
  v2 = (void *)qword_10000CFB0;
  return v2;
}
...
- (NNArticleIdentifierSyncManager)init
{
  return [(NNArticleIdentifierSyncManager *)self initWithReadonlyResetKey:&stru_100008580 readwriteResetKey:&stru_100008580 readonlyKey:&stru_100008580 readwriteKey:&stru_100008580];
}
