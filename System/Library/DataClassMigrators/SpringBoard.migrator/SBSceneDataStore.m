...
- (void)setArchivedObject:(id)a3 forKey:(id)a4
{
  ...
  if (!v9 || ([v9 isEqual:v7] & 1) == 0)
  {
    ...
    {
      id v14 = 0;
      id v11 = +[NSKeyedArchiver archivedDataWithRootObject:v7 requiringSecureCoding:1 error:&v14];
      id v12 = v14;
      if (!v11)
      {
...
- (id)unarchivedObjectOfClass:(Class)a3 forKey:(id)a4
{
  ...
  if (!v8)
  {
    ...
    {
      id v13 = 0;
      id v8 = +[NSKeyedUnarchiver unarchivedObjectOfClass:a3 fromData:v9 error:&v13];
      id v10 = v13;
      if (!v8)
      {
...
- (void)_invokeChangeHandler
{
  ...
  if (handler)
  {
    id v5 = (void (*)(void))*((void *)handler + 2);
    v5();
  }
}
