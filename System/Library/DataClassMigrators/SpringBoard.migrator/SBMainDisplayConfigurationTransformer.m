...
- (id)transformDisplayConfiguration:(id)a3
{
  ...
  if (v5 <= v9 || v5 >= 1.79769313e308 || v7 <= v9 || v7 >= 1.79769313e308)
  {
    ...
    v17 = +[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[SBMainDisplayConfigurationTransformer transformDisplayConfiguration:]");
    [v10 bounds];
    v18 = NSStringFromCGRect(v25);
    v19 = [v10 currentMode];
    v20 = [v10 currentMode];
    id v21 = [v20 preferredScale];
