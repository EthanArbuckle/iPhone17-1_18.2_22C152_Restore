id _TVRMControlCenterLog()
{
  ...
  if (_TVRMControlCenterLog_onceToken != -1) {
    dispatch_once(&_TVRMControlCenterLog_onceToken, &__block_literal_global);
  }
  v0 = (void *)_TVRMControlCenterLog_log;

  return v0;
}

uint64_t CCUILayoutShouldBePortrait()
{
  return MEMORY[0x270F18878]();
}
