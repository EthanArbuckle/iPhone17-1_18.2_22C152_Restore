...
{
  v21.receiver = self;
  v21.super_class = (Class)HearingDevicesCCModuleViewController;
  v2 = [(HearingDevicesCCModuleViewController *)&v21 init];
  if (v2)
  {
    id v3 = objc_alloc(MEMORY[0x263F474D8]);
    uint64_t v5 = objc_msgSend_initWithDelegate_andAvailableModules_(v3, v4, (uint64_t)v2, (uint64_t)&unk_26F84CC70);
    ...
    v17 = objc_msgSend__systemImageNamed_withConfiguration_(MEMORY[0x263F1C6B0], v16, @"hearingdevice.and.signal.meter", (uint64_t)v15);
...
{
  v41.receiver = self;
  v41.super_class = (Class)HearingDevicesCCModuleViewController;
...
{
  v15.receiver = self;
  v15.super_class = (Class)HearingDevicesCCModuleViewController;
