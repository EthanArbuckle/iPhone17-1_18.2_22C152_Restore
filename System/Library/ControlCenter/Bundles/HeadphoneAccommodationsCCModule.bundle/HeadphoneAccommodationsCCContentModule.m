@interface HeadphoneAccommodationsCCContentModule
...
@implementation HeadphoneAccommodationsCCContentModule
...
- (id)contentViewControllerForContext:(id)a3
{
  ...
  {
    v6 = objc_alloc_init(HeadphoneAccommodationsCCModuleViewController);
