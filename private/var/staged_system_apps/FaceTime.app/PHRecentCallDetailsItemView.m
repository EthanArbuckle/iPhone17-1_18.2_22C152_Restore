...
+ (id)_sharedTTYDirectImage
{
  if (qword_1000BBFA8 != -1) {
    dispatch_once(&qword_1000BBFA8, &stru_1000A1F30);
  }
  v2 = (void *)qword_1000BBF88;
...
+ (id)_sharedTTYRelayImage
{
  if (qword_1000BBFB0 != -1) {
    dispatch_once(&qword_1000BBFB0, &stru_1000A1F50);
  }
  v2 = (void *)qword_1000BBF90;
...
+ (id)_sharedDetailDisclosureImage
{
  if (qword_1000BBFB8 != -1) {
    dispatch_once(&qword_1000BBFB8, &stru_1000A1F70);
  }
  v2 = (void *)qword_1000BBF98;
...
+ (id)_verifiedCheckmarkImage
{
  if (qword_1000BBFC0 != -1) {
    dispatch_once(&qword_1000BBFC0, &stru_1000A1F90);
  }
  v2 = (void *)qword_1000BBFA0;
