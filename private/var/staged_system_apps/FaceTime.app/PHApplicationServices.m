...
- (TUCallProviderManager)callProviderManager
{
  ...
  if (!v4)
  {
    ...
    block[1] = 3221225472;
    block[2] = sub_10003A8C0;
    block[3] = &unk_1000A2350;
    v10 = &v11;
    v9 = v3;
...
+ (id)sharedInstance
{
  ...
  void block[4] = a1;
  if (qword_1000BC210 != -1) {
    dispatch_once(&qword_1000BC210, block);
  }
  v2 = (void *)qword_1000BC208;
