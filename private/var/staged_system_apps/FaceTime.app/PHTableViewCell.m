...
- (PHTableViewCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  id v4 = [(PHTableViewCell *)&v7 initWithStyle:a3 reuseIdentifier:a4];
...
- (void)updateFontsAndLayoutMetrics
{
  ...
  id v4 = [v3 font];
  double v5 = [v4 fontName];
  double v6 = &CNActionTypeMail_ptr;
  objc_super v7 = +[UIFont telephonyUIBodyShortEmphasizedFont];
  objc_super v8 = [v7 fontName];
  if ([v5 isEqual:v8])
  {
  ...
  v14 = [v6[149] telephonyUIBodyShortEmphasizedFont];
  v15 = [(PHTableViewCell *)self titleLabel];
  [v15 setFont:v14];

  v16 = [v6[149] telephonyUISubheadlineShortFont];
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  double v6 = [(PHTableViewCell *)self contentView];
  [v6 bounds];
  double v8 = v7;
  ...
  double v9 = [(PHTableViewCell *)self rootView];
