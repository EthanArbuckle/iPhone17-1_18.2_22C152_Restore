...
- (unint64_t)confidenceRating
{
  return *(unint64_t *)((char *)&self->super.isa
                             + OBJC_IVAR____TtC8FaceTime22FTTranscriptionMessage_confidenceRating);
}
...
- (_TtC8FaceTime22FTTranscriptionMessage)init
{
  result = (_TtC8FaceTime22FTTranscriptionMessage *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  v2 = (char *)self + OBJC_IVAR____TtC8FaceTime22FTTranscriptionMessage_transcriptData;
