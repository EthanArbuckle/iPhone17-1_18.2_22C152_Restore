...
+ (id)predicateForFilteringOutFaceTimeAudioCalls
{
  return +[NSPredicate predicateWithFormat:@"!(mediaType == %@ && serviceProvider == %@)", &off_1000A5F58, kCHServiceProviderFaceTime];
}
...
- (id)fullName
{
  ...
  if (v3)
  {
    ...
    id v7 = [v4 stringByReplacingOccurrencesOfString:v6 withString:&stru_1000A3488];
  }
  else
  {
    id v7 = 0;
