...
- (PHHandsetDialerLCDView)initWithFrame:(CGRect)a3 forDialerType:(int)a4
{
  ...
  if (v5)
  {
    ...
    [(PHLCDViewTextField *)v5->_numberTextField setText:&stru_1000A3488];
...
- (id)newAddContactButton
{
  ...
  double v10 = [v9 localizedStringForKey:@"ADD_NUMBER" value:&stru_1000A3488 table:@"Dialer"];
...
- (TPPillView)pillView
{
  ...
  if (!pillView)
  {
    id v4 = [objc_alloc((Class)TPPillView) initWithTitle:&stru_1000A3488 frame:3 CGRectZero.origin.x, CGRectZero.origin.y, CGRectZero.size.width, CGRectZero.size.height];
    [v4 setDelegate:self];
