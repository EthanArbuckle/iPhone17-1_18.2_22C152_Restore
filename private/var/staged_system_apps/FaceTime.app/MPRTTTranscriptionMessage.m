...
- (void)fetchRTTConversationForCallUUID:(id)a3
{
  ...
  if (v6)
  {
    ...
    block[1] = 3221225472;
    block[2] = sub_10003D254;
    block[3] = &unk_1000A2670;
    objc_copyWeak(v12, buf);
    v12[1] = v7;
    id v11 = v4;
    dispatch_async((dispatch_queue_t)rttConversationsQueue, block);
      ...
      do
      {
        for (i = 0; i != v6; i = (char *)i + 1)
        {
          ...
          if (([v9 isMe] & 1) == 0)
          {
            ...
            {
              id v11 = ttyLocString();
              v12 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", v11, &stru_1000A3488);

              uint64_t v13 = [v10 stringByReplacingOccurrencesOfString:v12 withString:&stru_1000A3488];
