...
+ (id)contactStore
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_ERROR)) {
      sub_10006AD9C(v3, v4, v5, v6, v7, v8, v9, v10);
    }
...
LABEL_19:
  ...
  if (v18 && [v18 code] != (id)200)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR)) {
      sub_10006AE14((uint64_t)v19, v20, v22, v23, v24, v25, v26, v27);
    }
    v16 = 0;
    goto LABEL_19;
  }
...
+ (id)suggestedContactStore
{
  ...
  {
    BOOL v5 = sub_100012C68();
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR)) {
      sub_10006AD9C(v5, v6, v7, v8, v9, v10, v11, v12);
    }
