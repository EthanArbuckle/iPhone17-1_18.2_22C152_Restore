...
- (NSCalendar)calendar
{
  v2 = (void *)qword_1000BC228;
  if (!qword_1000BC228)
  {
    uint64_t v3 = +[NSCalendar currentCalendar];
    objc_super v4 = (void *)qword_1000BC228;
    qword_1000BC228 = v3;
...
- (NSDateFormatter)dateFormatter
{
  v2 = (void *)qword_1000BC230;
  if (!qword_1000BC230)
  {
    id v3 = objc_alloc_init((Class)NSDateFormatter);
    objc_super v4 = (void *)qword_1000BC230;
    qword_1000BC230 = (uint64_t)v3;

    [(id)qword_1000BC230 setDateStyle:3];
    [(id)qword_1000BC230 setDoesRelativeDateFormatting:1];
    [(id)qword_1000BC230 setTimeStyle:0];
    v2 = (void *)qword_1000BC230;
  }
...
- (NSNumberFormatter)numberFormatter
{
  v2 = (void *)qword_1000BC238;
  if (!qword_1000BC238)
  {
    id v3 = objc_alloc_init((Class)NSNumberFormatter);
    objc_super v4 = (void *)qword_1000BC238;
    qword_1000BC238 = (uint64_t)v3;
...
- (NSDateFormatter)timeFormatter
{
  v2 = (void *)qword_1000BC240;
  if (!qword_1000BC240)
  {
    id v3 = objc_alloc_init((Class)NSDateFormatter);
    objc_super v4 = (void *)qword_1000BC240;
    qword_1000BC240 = (uint64_t)v3;

    [(id)qword_1000BC240 setDateStyle:0];
    [(id)qword_1000BC240 setTimeStyle:1];
    v2 = (void *)qword_1000BC240;
  }
...
- (void)addNotificationObservers
{
  ...
  if (!qword_1000BC218)
  {
    ...
    uint64_t v7 = [v5 addObserverForName:NSCurrentLocaleDidChangeNotification object:0 queue:v6 usingBlock:&stru_1000A2600];
    v8 = (void *)qword_1000BC218;
    qword_1000BC218 = v7;
  }
  if (!qword_1000BC220)
  {
    ...
    uint64_t v10 = [v12 addObserverForName:NSSystemTimeZoneDidChangeNotification object:0 queue:v9 usingBlock:&stru_1000A2600];
    v11 = (void *)qword_1000BC220;
    qword_1000BC220 = v10;
  }
}
...
- (void)loadSubviews
{
  ...
  v8 = &CNActionTypeMail_ptr;
  v9 = &CNActionTypeMail_ptr;
  v126 = (void *)v3;
  if (!v7)
  {
    char v136 = 0;
  ...
  do
  {
    ...
    do
    {
      ...
      v29 = [v8[149] preferredSubheadline1Font];
      [v28 setFont:v29];
      ...
      else
      {
        ...
        v39 = [(PHRecentCallDetailsView *)v127 topAnchor];
        v40 = [v8[149] preferredSubheadline1Font];
...
LABEL_28:
        [v43 localizedStringForKey:v45 value:&stru_1000A3488 table:@"PHCallHistory"];
        v141 = v140 = 0;
LABEL_29:
      ...
      if ((v112 & v21) != 0)
      {
        ...
        v141 = [v81 localizedStringForKey:v83 value:&stru_1000A3488 table:@"PHCallHistory"];
        ...
        if (v137)
        {
          ...
          v86 = [v9[62] mainBundle];
          v87 = [v86 localizedStringForKey:@"DURATION_DATA_FORMAT_%@_(%@)" value:&stru_1000A3488 table:@"PHCallHistory"];
...
LABEL_30:
      ...
      if (v49)
      {
        ...
        if ((v115 & ~v51) == 0)
        {
          v52 = [v9[62] mainBundle];
          v53 = v52;
          CFStringRef v54 = @"SHARED_ALLOWED_REMOTE_CONTROL";
LABEL_40:
          v55 = [v52 localizedStringForKey:v54 value:&stru_1000A3488 table:@"PHCallHistory"];
...
LABEL_41:
        ...
        if (v51)
        {
          v53 = [v9[62] mainBundle];
          v138 = [v53 localizedStringForKey:@"SHARED_SCREEN" value:&stru_1000A3488 table:@"PHCallHistory"];
          goto LABEL_41;
        }
      }
      v138 = 0;
...
LABEL_69:
  ...
  if (v136)
  {
    ...
    [v8[149] preferredCaption1Font];
    v93 = v92 = v9;
    [v91 setFont:v93];

    [v91 setTranslatesAutoresizingMaskIntoConstraints:0];
    v94 = [v92[62] mainBundle];
    v95 = [v94 localizedStringForKey:@"VERIFIED_EXPLANATION" value:&stru_1000A3488 table:@"PHRecents"];
    [v91 setText:v95];
    ...
    v108 = [v8[149] preferredSubheadline1Font];
  ...
  if (v89)
  {
    ...
    v107 = [v8[149] preferredSubheadline1Font];
  ...
  if ((unint64_t)a3)
  {
    if (v3 > 0x3B)
    {
      if (v3 > 0xE0F)
      {
        ...
        v22 = [v19 localizedStringForKey:v21 value:&stru_1000A3488 table:@"PHCallHistory"];
        ...
        v31 = [v28 localizedStringForKey:v30 value:&stru_1000A3488 table:@"PHCallHistory"];
      ...
      else
      {
        ...
        v8 = [v14 localizedStringForKey:v15 value:&stru_1000A3488 table:@"PHCallHistory"];
    ...
    else
    {
      ...
      v8 = [v5 localizedStringForKey:v7 value:&stru_1000A3488 table:@"PHCallHistory"];
...
- (id)emergencyItemLabelText:(id)a3
{
  ...
  if (!v7)
  {
    ...
    v9 = [v8 localizedStringForKey:@"Shared %lu videos" value:&stru_1000A3488 table:0];
LABEL_16:
...
LABEL_10:
  ...
  {
    v8 = +[NSBundle mainBundle];
    v9 = [v8 localizedStringForKey:@"Shared %lu photos" value:&stru_1000A3488 table:0];
  ...
  {
    v8 = +[NSBundle mainBundle];
    v9 = [v8 localizedStringForKey:@"Shared %lu videos and %lu photos" value:&stru_1000A3488 table:0];
    id v14 = v7;
    goto LABEL_16;
  }
LABEL_18:
