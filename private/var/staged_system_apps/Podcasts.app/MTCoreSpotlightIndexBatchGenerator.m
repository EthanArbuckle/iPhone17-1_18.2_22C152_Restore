...
- (MTCoreSpotlightIndexBatchGenerator)initWithStartingIndexPath:(id)a3
{
  ...
  if (v5)
  {
    if (qword_10060A7C8 != -1) {
      dispatch_once(&qword_10060A7C8, &stru_100550C38);
    }
    uint64_t v17 = 0;
    v18 = &v17;
    ...
    block[1] = 3221225472;
    block[2] = sub_1000DC04C;
    block[3] = &unk_10054D8A0;
    block[4] = &v17;
    dispatch_sync((dispatch_queue_t)qword_10060A7D0, block);
    int64_t v6 = v18[3];
...
- (id)nextBatchWithTransformationBlock:(id)a3
{
  ...
  {
    [(NSFetchRequest *)self->_currentFetchRequest setFetchOffset:5 * self->_nextIndexPath.batch];
    CFStringRef v7 = 0;
    uint64_t v29 = 0;
    v30 = &v29;
    ...
    while (![v7 count] && !*((unsigned char *)v20 + 24))
    {
      ...
      if (![(id)v24[5] count] && !*((unsigned char *)v20 + 24))
      {
        ...
        [(NSFetchRequest *)self->_currentFetchRequest setFetchOffset:5 * v9];
      }
...
{
  id v4 = a3;
  v5 = [(MTCoreSpotlightIndexBatchGenerator *)self nextBatchWithTransformationBlock:&stru_100550BC8];
  if ([v5 count])
  {
