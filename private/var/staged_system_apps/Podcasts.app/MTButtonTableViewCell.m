...
- (void)layoutSubviews
{
  ...
  id v3 = [(MTButtonTableViewCell *)self contentView];
  [v3 layoutIfNeeded];
...
- (CGSize)fittingSize
{
  ...
  -[MTButtonTableViewCell systemLayoutSizeFittingSize:](self, "systemLayoutSizeFittingSize:", UILayoutFittingCompressedSize.width, height);
