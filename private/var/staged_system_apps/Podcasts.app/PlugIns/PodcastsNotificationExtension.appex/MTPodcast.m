...
+ (id)sortDescriptorsForRecentlyUnfollowed
{
  v2 = +[NSSortDescriptor sortDescriptorWithKey:kLastUnfollowedDate ascending:0];
  v6[0] = v2;
  v3 = +[NSSortDescriptor sortDescriptorWithKey:kPodcastTitle ascending:0 selector:"localizedStandardCompare:"];
  v6[1] = v3;
  uint64_t v4 = +[NSArray arrayWithObjects:v6 count:2];
...
+ (id)allPossibleEpisodeListSortOrderProperties
{
  ...
  CFStringRef v15 = [v20 mt_compactMap:&stru_10002D1C0];
...
- (id)seasonNumbers
{
  ...
  char v12 = sub_100016280;
  uint64_t v13 = sub_100016290;
  id v14 = +[NSArray array];
  [(MTPodcast *)self managedObjectContext];
  v6[0] = _NSConcreteStackBlock;
  v6[1] = 3221225472;
  void v6[2] = sub_100016954;
  v6[3] = &unk_10002CC88;
  v6[4] = self;
  id v3 = (id)objc_claimAutoreleasedReturnValue();
  id v7 = v3;
...
- (id)seasonTrailerInSeason:(int64_t)a3
{
  ...
  uint64_t v21 = sub_100016280;
  __int16 v22 = sub_100016290;
  id v23 = 0;
  id v6 = [(MTPodcast *)self managedObjectContext];
