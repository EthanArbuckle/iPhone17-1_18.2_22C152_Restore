...
- (EpisodeAvailableViewController)initWithNotification:(id)a3
{
  ...
  if (v3)
  {
    ...
    uint64_t v6 = +[EpisodeAvailableStyle defaultStyle];
    style = v4->_style;
...
- (void)openAppShowingPodcastDetails
{
  ...
  id v5 = [(EpisodeAvailableViewController *)self episodePropertySource];
...
- (void)viewDidLoad
{
  ...
  id v3 = [objc_alloc((Class)UITapGestureRecognizer) initWithTarget:self action:"tapOnTopLevelViewGestureRecognized:"];
...
- (void)viewDidLayoutSubviews
{
  ...
  objc_super v3 = [(EpisodeAvailableViewController *)self lineCountLayoutGroup];
  [v3 layout];
}

- (id)actionsWithDefaultActions:(id)a3
{
  objc_super v3 = [(EpisodeAvailableViewController *)self episodePropertySource];
  unsigned int v4 = [v3 requiresForegroundLaunch];
  ...
  uint64_t v6 = +[UNNotificationAction mt_playEpisodeActionWithOptions:v5];
...
- (id)headerTitle
{
  ...
  objc_super v3 = [v2 localizedStringForKey:@"NOTIFICATION_EPISODE_AVAILABLE_HEADER" value:&stru_10002D2B8 table:0];
...
- (void)loadContentViews
{
  ...
  objc_super v3 = [(EpisodeAvailableViewController *)self view];
  unsigned int v4 = +[UIColor backgroundColor];
  [v3 setBackgroundColor:v4];

  uint64_t v5 = [(EpisodeAvailableStyle *)self->_style newArtworkView];
  ...
  v10 = [v9 localizedStringForKey:@"NOTIFICATION_SHOW_TITLE_HEADER" value:&stru_10002D2B8 table:0];
...
{
  objc_super v3 = [(EpisodeAvailableViewController *)self episodePropertySource];
  unsigned int v4 = [v3 podcastUuid];
  uint64_t v5 = [(EpisodeAvailableViewController *)self podcastTitleButton];
  uint64_t v6 = [v3 podcastTitle];
  ...
  objc_super v9 = [(EpisodeAvailableViewController *)self episodeTitleLabel];
  v10 = [v3 title];
  [v9 setText:v10];

  double v11 = [(EpisodeAvailableViewController *)self episodeSummaryLabel];
  double v12 = [v3 summary];
  [v11 setText:v12];
...
- (void)loadConstraints
{
  ...
  objc_super v3 = [(EpisodeAvailableViewController *)self style];
  unsigned int v4 = [(EpisodeAvailableViewController *)self view];
  uint64_t v5 = [(ContentAvailableViewController *)self headerTitleLabel];
  id v6 = [(EpisodeAvailableViewController *)self artworkView];
  ...
  NSAttributedStringKey v147 = NSFontAttributeName;
  v148 = v134;
  id v7 = +[NSDictionary dictionaryWithObjects:&v148 forKeys:&v147 count:1];
  ...
  v133 = [v6 widthAnchor];
  v132 = [v133 constraintEqualToConstant:(double)0x50uLL];
  v146[0] = v132;
  v131 = [v6 heightAnchor];
  v130 = [v131 constraintEqualToConstant:(double)0x50uLL];
  v146[1] = v130;
  id v11 = [v6 topAnchor];
  ...
  [v3 defaultMarginH];
  v126 = [v22 constraintEqualToAnchor:v23];
  ...
  objc_super v30 = [v3 mainHeaderBL_To_showTitleBL];
...
- (void)updateDynamicConstraints
{
  id v2 = [(EpisodeAvailableViewController *)self installedConstraints];
  ...
  if (v10)
  {
    if ([v9 count])
    {
      ...
      if ([v11 length])
      {
        ...
        double v12 = +[PUIObjCArtworkProvider shared];
