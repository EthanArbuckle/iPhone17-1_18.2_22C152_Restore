...
+ (id)allPossibleEpisodeListSortOrderProperties
{
  ...
  CFStringRef v15 = [v20 mt_compactMap:&stru_100014630];
...
- (id)seasonNumbers
{
  ...
  char v12 = sub_10000654C;
  uint64_t v13 = sub_10000655C;
...
- (id)seasonTrailerInSeason:(int64_t)a3
{
  ...
  uint64_t v21 = sub_10000654C;
  __int16 v22 = sub_10000655C;
  id v23 = 0;
  id v6 = [(MTPodcast *)self managedObjectContext];
