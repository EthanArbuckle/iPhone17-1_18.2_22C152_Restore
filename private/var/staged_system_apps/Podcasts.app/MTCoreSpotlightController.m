...
- (MTCoreSpotlightController)initWithAnnotator:(id)a3
{
  ...
  if (v6)
  {
    ...
    id v13 = objc_alloc((Class)CSSearchableIndex);
    v14 = (CSSearchableIndex *)[v13 initWithName:@"Podcasts" bundleIdentifier:kMTApplicationBundleIdentifier];
...
- (void)updateStationsWithUUIDs:(id)a3
{
  ...
  uint64_t v8 = [(MTCoreSpotlightController *)self searchableIndex];
...
- (void)scheduleIndexAllIfNecessary
{
  ...
  if (![(MTCoreSpotlightController *)self hasBeenIndexed])
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl((void *)&_mh_execute_header, v3, OS_LOG_TYPE_DEFAULT, "[Indexing] *** deferring initial indexAll until sync/feedUpdates are idle", buf, 2u);
    }

    [(MTCoreSpotlightController *)self setHasDeferredIndexAll:1];
    id v4 = +[MTFeedUpdateIdleCoordinator sharedInstance];
...
- (void)_performDeferredIndexAll
{
  if ([(MTCoreSpotlightController *)self hasDeferredIndexAll])
  {
    ...
    {
      *(_WORD *)id v5 = 0;
      _os_log_impl((void *)&_mh_execute_header, v3, OS_LOG_TYPE_DEFAULT, "[Indexing] *** performing initial indexAll", v5, 2u);
    }

    [(MTCoreSpotlightController *)self setHasDeferredIndexAll:0];
    id v4 = [(MTCoreSpotlightController *)self searchableIndex];
...
- (void)indexAllDataWithSearchableIndex:(id)a3 completionHandler:(id)a4
{
  id v5 = (Block_layout *)a4;
  if (v5) {
    id v6 = v5;
  }
  else {
    id v6 = &stru_1005500E0;
  }
...
- (void)updateSearchableIndexWithReason:(id)a3 searchableIndex:(id)a4 entityLoadingBlock:(id)a5 completion:(id)a6
{
  ...
  block[1] = 3221225472;
  block[2] = sub_1000B88F8;
  block[3] = &unk_100550108;
  block[4] = self;
  id v20 = v10;
  id v21 = v11;
  id v22 = v12;
...
- (void)_onQueueCancelCurrentReindexAll
{
  ...
  if (v3)
  {
    ...
    {
      id v5 = [(MTCoreSpotlightController *)self indexAllBatchGenerator];
      int v8 = 138412290;
      id v9 = v5;
      _os_log_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_DEFAULT, "[Indexing] *** canceling current indexAll [%@] ***", (uint8_t *)&v8, 0xCu);
    }
    id v6 = [(MTCoreSpotlightController *)self indexAllBatchGenerator];
    [v6 cancel];
...
- (void)_podcastArtworkDidChangeNotification:(id)a3
{
  ...
  {
    *(_WORD *)buf = 0;
    _os_log_impl((void *)&_mh_execute_header, v5, OS_LOG_TYPE_DEFAULT, "Got podcast artwork change notification", buf, 2u);
  }

  id v6 = MTImageDownloaderArtworkDidLoadCacheKeys();
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_1000B9C78;
  block[3] = &unk_10054D9B0;
  id v11 = v6;
  id v12 = self;
  id v9 = v6;
  ...
  else
  {
    ...
    if (v7)
    {
      *(void *)buf = 0;
      ...
      id v17 = sub_100056F8C;
      int64_t v18 = sub_100057290;
