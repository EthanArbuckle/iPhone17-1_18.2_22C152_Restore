...
- (void)layoutSubviews
{
  ...
  id v3 = [(MTInformativeTableViewCell *)self contentView];
  [v3 layoutIfNeeded];
...
- (CGSize)fittingSize
{
  ...
  -[MTInformativeTableViewCell systemLayoutSizeFittingSize:](self, "systemLayoutSizeFittingSize:", UILayoutFittingCompressedSize.width, height);
