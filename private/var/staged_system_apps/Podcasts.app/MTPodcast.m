...
+ (id)sortDescriptorsForSortType:(int64_t)a3
{
  ...
  {
    case 0:
      v3 = +[MTPodcast sortDescriptorsForManualOrder];
      break;
    case 1:
      uint64_t v4 = 0;
      goto LABEL_5;
    case 2:
      uint64_t v4 = 1;
LABEL_5:
      v3 = +[MTPodcast sortDescriptorsForDateAddedAscending:v4];
      break;
    case 4:
      uint64_t v5 = 0;
      goto LABEL_8;
    ...
    case 6:
      uint64_t v6 = 1;
LABEL_12:
      v3 = +[MTPodcast sortDescriptorsForFirstTimeAvailableAscending:v6];
      break;
    case 7:
      v3 = +[MTPodcast sortDescriptorsForRecentlyUnfollowed];
      break;
    default:
      uint64_t v5 = 1;
LABEL_8:
      v3 = +[MTPodcast sortDescriptorsForTitle:v5];
      break;
  }
...
+ (id)sortDescriptorsForFirstTimeAvailableAscending:(BOOL)a3
{
  ...
  v7[0] = v3;
  uint64_t v4 = +[NSSortDescriptor sortDescriptorWithKey:kPodcastTitle ascending:0 selector:"localizedStandardCompare:"];
  v7[1] = v4;
...
- (void)setTitle:(id)a3
{
  ...
  uint64_t v4 = [(MTPodcast *)self title];
  unint64_t v5 = v9 | v4;

  if (v5)
  {
    uint64_t v6 = [(MTPodcast *)self title];
...
- (void)setUpdatedFeedURL:(id)a3
{
  ...
  [v6 markSubscriptionSyncDirty:1 for:[self syncType]];
}
...
- (void)setSubscribed:(BOOL)a3
{
  ...
  if ([(MTPodcast *)self subscribed] != a3)
  {
    ...
    [v7 markSubscriptionSyncDirty:1 for:[self syncType]];
  }
}
...
{
  id v8 = a3;
  uint64_t v4 = [(MTPodcast *)self channel];
  unsigned __int8 v5 = [v8 isEqual:v4];

  if ((v5 & 1) == 0)
  {
    id v6 = [(MTPodcast *)self channel];
...
- (void)_updateChannelRelationship:(id)a3 deassociate:(BOOL)a4
{
  if (a3)
  {
    ...
    id v11 = (id)v8;
    unint64_t v9 = [(MTPodcast *)self uuid];
    if (v4) {
      [v11 removeObject:v9];
    }
    else {
...
- (void)prepareForDeletion
{
  id v3 = [(MTPodcast *)self channel];
  [(MTPodcast *)self _updateChannelRelationship:v3 deassociate:1];

  v4.receiver = self;
  v4.super_class = (Class)MTPodcast;
...
- (id)countOfNewEpisodes
{
  id v3 = +[MTPodcastDerivedPropertyObserver sharedInstance];
  objc_super v4 = [(MTPodcast *)self uuid];
  id v5 = +[NSNumber numberWithUnsignedInteger:](NSNumber, "numberWithUnsignedInteger:", [v3 countOfNewEpisodesForPodcast:v4]);
...
- (id)countOfUnplayedEpisodes
{
  id v3 = +[MTPodcastDerivedPropertyObserver sharedInstance];
  objc_super v4 = [(MTPodcast *)self uuid];
  id v5 = +[NSNumber numberWithUnsignedInteger:](NSNumber, "numberWithUnsignedInteger:", [v3 countOfUnplayedEpisodesForPodcast:v4]);
...
- (void)setLastDatePlayed:(double)a3
{
  ...
  if (v5 < a3)
  {
    ...
    id v8 = +[PodcastsStateCoordinator shared];
...
+ (id)predicateForSyncablePodcastsForSyncType:(int64_t)a3
{
  unint64_t v4 = [a1 predicateForNotHiddenNotImplicitlyFollowedPodcasts];
  double v5 = +[MTPodcast predicateForSubscriptionSyncType:a3];
...
+ (id)predicateForSubscriptionSyncType:(int64_t)a3
{
  ...
  double v5 = NSPersistentStringForMTDisplayType();
  uint64_t v6 = NSPersistentStringForMTDisplayType();
...
- (void)markPlaylistsForUpdate
{
  ...
  long long v11 = 0u;
  long long v12 = 0u;
  id v2 = [(MTPodcast *)self playlistSettings];
...
- (void)setShowTypeSetting:(int64_t)a3
{
  if ([(MTPodcast *)self showTypeSetting] != (id)a3)
  {
    ...
    if (v5)
    {
      ...
      int64_t v13 = +[NSNumber numberWithLongLong:a3];
...
- (void)setSortAscending:(BOOL)a3
{
  ...
  if (((((v11 & 2) == 0) ^ v3) & 1) == 0)
  {
    ...
    [(MTPodcast *)self markPlaylistsForUpdate];
    int64_t v13 = +[SyncKeysRepository shared];
...
+ (id)allPossibleEpisodeListSortOrderProperties
{
  ...
  id v2 = +[NSSortDescriptor sortDescriptorWithKey:ascending:](NSSortDescriptor, "sortDescriptorWithKey:ascending:");
  v23[0] = v2;
  ...
  v22[2] = v12;
  int64_t v13 = +[NSSortDescriptor sortDescriptorWithKey:v7 ascending:1 selector:"localizedStandardCompare:"];
  v22[3] = v13;
  int v14 = +[NSArray arrayWithObjects:v22 count:4];
  [v20 addObjectsFromArray:v14];

  CFStringRef v15 = [v20 mt_compactMap:&stru_100552150];
...
- (id)seasonNumbers
{
  ...
  char v12 = sub_1000570AC;
  uint64_t v13 = sub_100057320;
...
- (id)seasonTrailerInSeason:(int64_t)a3
{
  ...
  uint64_t v21 = sub_1000570AC;
  __int16 v22 = sub_100057320;
  id v23 = 0;
  id v6 = [(MTPodcast *)self managedObjectContext];
...
+ (id)sortDescriptorsForManualOrder
{
  id v2 = +[NSSortDescriptor sortDescriptorWithKey:kPodcastSortOrder ascending:0];
  v6[0] = v2;
  uint64_t v3 = +[NSSortDescriptor sortDescriptorWithKey:kPodcastSubscribed ascending:0];
  v6[1] = v3;
...
+ (id)sortDescriptorsForRecentlyUpdatedAscending:(BOOL)a3
{
  uint64_t v3 = +[NSSortDescriptor sortDescriptorWithKey:kPodcastFeedChangedDate ascending:a3];
  v7[0] = v3;
  id v4 = +[NSSortDescriptor sortDescriptorWithKey:kPodcastTitle ascending:0 selector:"localizedStandardCompare:"];
  v7[1] = v4;
...
+ (id)sortDescriptorsForRecentlyUnfollowed
{
  id v2 = +[NSSortDescriptor sortDescriptorWithKey:kLastUnfollowedDate ascending:0];
  v6[0] = v2;
  uint64_t v3 = +[NSSortDescriptor sortDescriptorWithKey:kPodcastTitle ascending:0 selector:"localizedStandardCompare:"];
  v6[1] = v3;
  id v4 = +[NSArray arrayWithObjects:v6 count:2];
...
+ (id)sortDescriptorsForTitle:(BOOL)a3
{
  uint64_t v3 = +[NSSortDescriptor sortDescriptorWithKey:kPodcastTitle ascending:a3 selector:"localizedStandardCompare:"];
  v7[0] = v3;
  id v4 = +[NSSortDescriptor sortDescriptorWithKey:kPodcastUpdatedDate ascending:0];
  v7[1] = v4;
  id v5 = +[NSArray arrayWithObjects:v7 count:2];
