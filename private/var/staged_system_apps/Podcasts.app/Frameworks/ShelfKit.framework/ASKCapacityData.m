...
- (ASKCapacityData)init
{
  ...
  if (v2)
  {
    ...
    uint64_t v4 = [v3 objectForKey:kMGQDiskUsageTotalSystemCapacity];
    v5 = (void *)v4;
    if (v4) {
      v6 = (_UNKNOWN **)v4;
    }
    ...
    uint64_t v7 = [v3 objectForKey:kMGQDiskUsageTotalSystemAvailable];
    v8 = (void *)v7;
    if (v7) {
      v9 = (_UNKNOWN **)v7;
    }
    ...
    uint64_t v10 = [v3 objectForKey:kMGQDiskUsageTotalDataCapacity];
    v11 = (void *)v10;
    if (v10) {
      v12 = (_UNKNOWN **)v10;
    }
    ...
    uint64_t v13 = [v3 objectForKey:kMGQDiskUsageTotalDataAvailable];
    v14 = (void *)v13;
    if (v13) {
      v15 = (_UNKNOWN **)v13;
    }
    ...
    uint64_t v16 = [v3 objectForKey:kMGQDiskUsageTotalDiskCapacity];
    v17 = (void *)v16;
    if (v16) {
      v18 = (_UNKNOWN **)v16;
    }
