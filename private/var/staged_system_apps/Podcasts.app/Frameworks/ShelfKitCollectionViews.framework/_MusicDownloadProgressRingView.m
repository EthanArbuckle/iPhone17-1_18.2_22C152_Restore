...
- (_MusicDownloadProgressRingView)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    id v7 = [(_MusicDownloadProgressRingView *)v4 tintColor];
...
- (void)tintColorDidChange
{
  ...
  [(_MusicDownloadProgressRingView *)&v6 tintColorDidChange];
  objc_super v3 = [(_MusicDownloadProgressRingView *)self tintColor];
...
- (BOOL)_shouldAnimatePropertyWithKey:(id)a3
{
  ...
  if ([(_MusicDownloadProgressRingView *)&v7 _shouldAnimatePropertyWithKey:v4]) {
    ...
    unsigned __int8 v5 = [v4 isEqualToString:@"strokeEnd"];
  }
...
{
  self->_progress = a3;
  id v4 = [(_MusicDownloadProgressRingView *)self layer];
...
- (void)_updateShapePath
{
  ...
  id v27 = [(_MusicDownloadProgressRingView *)self layer];
  [v27 lineWidth];
  CGFloat v15 = v14 * 0.5;
  ...
  [v20 moveToPoint:MidX, CGRectGetMinY(v32)];
  ...
  [v20 addArcWithCenter:1, v25, CGRectGetMidY(v36), v24, -1.57079633, 4.71238898];
  id v26 = v20;
  objc_msgSend(v27, "setPath:", objc_msgSend(v26, "CGPath"));
  [v27 setLineWidth:1.0 / v13 + 2.0];
}
