...
- (_TtC12NowPlayingUI15MultilineButton)initWithFrame:(CGRect)a3
{
  return (_TtC12NowPlayingUI15MultilineButton *)sub_A4308(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (BOOL)isEnabled
{
  return sub_A4E90(self, (uint64_t)a2, (SEL *)&selRef_isEnabled);
}
...
- (BOOL)isHighlighted
{
  return sub_A4E90(self, (uint64_t)a2, (SEL *)&selRef_isHighlighted);
}
...
- (BOOL)isSelected
{
  return sub_A4E90(self, (uint64_t)a2, (SEL *)&selRef_isSelected);
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  v5 = self;
  double v6 = sub_A527C(width, height);
  double v8 = v7;
