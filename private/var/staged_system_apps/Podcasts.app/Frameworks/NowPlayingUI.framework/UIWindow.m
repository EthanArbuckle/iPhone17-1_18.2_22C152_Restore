...
UIEdgeInsets __67__UIWindow_MusicLayoutAdditions__music_setWantsDefaultLayoutInsets__block_invoke(id a1, UIView *a2)
{
  ...
  if ([v3 horizontalSizeClass] != (char *)&dword_0 + 2
    || [v3 verticalSizeClass] != (char *)&dword_0 + 2
    || ([(UIView *)v2 bounds], v6 = 32.0, v7 <= 1025.0) && (double v4 = 20.0, v5 <= 1025.0))
  {
    if (_MusicDefaultLayoutInsetsForView_sOnceToken != -1) {
      dispatch_once(&_MusicDefaultLayoutInsetsForView_sOnceToken, &__block_literal_global_49);
    }
    double v6 = v4;
    if (_MusicDefaultLayoutInsetsForView_sViewControllerResponds)
    {
      +[UIViewController _horizontalContentMarginForView:v2];
      double v6 = v8;
    }
  }
...
UIEdgeInsets __65__UIWindow_MusicLayoutAdditions__music_setWantsMusicLayoutInsets__block_invoke(id a1, UIView *a2)
{
  [(UIView *)a2 bounds];
  CGRectGetWidth(v7);
  if (MTMPUFloatGreaterThanOrEqualToFloat())
  {
    double v2 = 52.0;
  }
  else
  {
    int v3 = MTMPUFloatGreaterThanOrEqualToFloat();
    double v2 = 20.0;
    if (v3) {
      double v2 = 34.0;
    }
...
+ (void)music_setWantsLayoutInsetsUsingBlock:(id)a3
{
  ...
  id v5 = v3;
  id v69 = v5;
  double v6 = objc_retainBlock(v68);
  CGRect v7 = imp_implementationWithBlock(v6);
  ...
  id v11 = v5;
  id v61 = v11;
  double v12 = objc_retainBlock(v60);
  double v13 = imp_implementationWithBlock(v12);
  double v14 = class_getInstanceMethod(v4, "traitCollectionDidChange:");
  double v15 = method_getTypeEncoding(v14);
  ...
  if (music_setWantsLayoutInsetsUsingBlock__onceToken != -1) {
    dispatch_once(&music_setWantsLayoutInsetsUsingBlock__onceToken, &__block_literal_global_34);
  }
  uint64_t v40 = 0;
  v41 = &v40;
  ...
  IMP v35 = class_replaceMethod(v29, "initWithFrame:backgroundViewClass:embeddedInView:", v32, v34);
...
{
  id v3 = a2;
  double v4 = *(void (**)(void))(*(void *)(*(void *)(a1 + 40) + 8) + 24);
  id v7 = v3;
  if (v4) {
    goto LABEL_2;
  }
  ...
  if (v5 == objc_opt_class())
  {
    ...
    {
      double v4 = MethodImplementation;
LABEL_2:
      v4();
    }
  }
...
void __71__UIWindow_MusicLayoutAdditions__music_setWantsLayoutInsetsUsingBlock___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  id v9 = a2;
  id v5 = a3;
  double v6 = *(void (**)(id, void, id))(*(void *)(*(void *)(a1 + 40) + 8) + 24);
  if (v6)
  {
    v6(v9, *(void *)(a1 + 48), v5);
  }
...
{
  id v11 = a2;
  double v12 = *(void (**)(id, void, double, double, double, double))(*(void *)(*(void *)(a1 + 40) + 8)
                                                                          + 24);
  if (v12)
  {
...
{
  id v15 = a2;
  IMP v16 = *(void (**)(id, void, uint64_t, uint64_t, double, double, double, double))(*(void *)(*(void *)(a1 + 40) + 8)
                                                                                            + 24);
  if (v16)
  {
    v16(v15, *(void *)(a1 + 48), a3, a4, a5, a6, a7, a8);
    uint64_t v17 = LABEL_3:;
  ...
  {
    IMP MethodImplementation = class_getMethodImplementation((Class)[v15 superclass], *(SEL *)(a1 + 48));
    if (MethodImplementation)
    {
      ((void (*)(id, void, uint64_t, uint64_t, double, double, double, double))MethodImplementation)(v15, *(void *)(a1 + 48), a3, a4, a5, a6, a7, a8);
      goto LABEL_3;
    }
  }
LABEL_5:
  (*(void (**)(void))(*(void *)(a1 + 32) + 16))();
  [v15 music_setLayoutInsets];
