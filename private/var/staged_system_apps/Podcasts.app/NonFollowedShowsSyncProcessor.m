...
- (void).cxx_destruct
{
  sub_10004D2D8((uint64_t)self + OBJC_IVAR____TtC8Podcasts29NonFollowedShowsSyncProcessor_nonFollowedShowsSyncStorage);
...
- (id)dataForSetTransaction:(id)a3 key:(id)a4 version:(id *)a5
{
  ...
  id v11 = a3;
  uint64_t v12 = self;
  uint64_t v13 = sub_100255CC0(v8, v10, a5);
  unint64_t v15 = v14;
...
LABEL_6:
  ...
  uint64_t v25 = 0;
LABEL_9:
  sub_100256800((uint64_t)a4, v18, v19, v21, v22, v24, (uint64_t (*)(void))v26, v25);
...
LABEL_6:
  ...
  uint64_t v25 = 0;
LABEL_9:
  sub_100256A58(v19, v21, v22, v24, (uint64_t (*)(void))v26, v25);
  sub_1000536BC((uint64_t)v26);
  swift_bridgeObjectRelease();
  swift_bridgeObjectRelease();
  sub_10021A3FC((uint64_t)a4, v18);
...
LABEL_6:
  ...
  uint64_t v25 = 0;
LABEL_9:
  sub_100256C94((uint64_t)a4, v18, v19, v21, v22, v24, (uint64_t (*)(void))v26, v25);
  sub_1000536BC((uint64_t)v26);
  swift_bridgeObjectRelease();
  swift_bridgeObjectRelease();
  sub_10021A3FC((uint64_t)a4, v18);
