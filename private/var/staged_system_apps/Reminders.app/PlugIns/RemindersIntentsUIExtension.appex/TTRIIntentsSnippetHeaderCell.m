...
- (void)prepareForReuse
{
  ...
  id v3 = &v2[OBJC_IVAR____TtC27RemindersIntentsUIExtension28TTRIIntentsSnippetHeaderCell_viewModel];
  *(void *)id v3 = 0;
  *((void *)v3 + 1) = 0;
...
- (_TtC27RemindersIntentsUIExtension28TTRIIntentsSnippetHeaderCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  return (_TtC27RemindersIntentsUIExtension28TTRIIntentsSnippetHeaderCell *)sub_1000165D8(a3, (uint64_t)a4, v6);
}

- (_TtC27RemindersIntentsUIExtension28TTRIIntentsSnippetHeaderCell)initWithCoder:(id)a3
{
  return (_TtC27RemindersIntentsUIExtension28TTRIIntentsSnippetHeaderCell *)sub_1000166F0(a3);
}
