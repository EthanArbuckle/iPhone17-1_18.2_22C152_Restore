...
- (_TtC7Journal27WorkoutGradientPathRenderer)initWithOverlay:(id)a3;
...
- (void)drawMapRect:(id)a3 zoomScale:(double)a4 inContext:(CGContext *)a5
{
  ...
  v11 = a5;
  v12 = self;
  [overlay -[WorkoutGradientPathRenderer boundingMapRect]];
  double v14 = v13;
  double v16 = v15;
  ...
  v18 = v12;
  sub_10019C44C(v11, v18, v9, v8, var0, var1, v17, v14, v16);
}

- (_TtC7Journal27WorkoutGradientPathRenderer)initWithOverlay:(id)a3
{
  swift_unknownObjectRetain();
  result = (_TtC7Journal27WorkoutGradientPathRenderer *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
