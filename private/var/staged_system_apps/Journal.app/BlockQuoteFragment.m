...
- (_TtC7Journal18BlockQuoteFragment)initWithCoder:(id)a3;
- (_TtC7Journal18BlockQuoteFragment)initWithTextElement:(id)a3 range:(id)a4;
...
- (double)leadingPadding
{
  uint64_t v2 = qword_1007F6C98;
  v3 = self;
  if (v2 != -1) {
    swift_once();
  }
  double v4 = *(double *)&qword_100805688;
...
- (double)topMargin
{
  uint64_t v1 = qword_1007F6C90;
  id v2 = a1;
  if (v1 != -1) {
    swift_once();
  }
  double v3 = *(double *)&qword_100805680;
...
- (void)drawAtPoint:(CGPoint)a3 inContext:(CGContext *)a4
{
  ...
  CGFloat v7 = a4;
  CGFloat v8 = self;
  sub_100265864(v7, x, y);
}

- (_TtC7Journal18BlockQuoteFragment)initWithTextElement:(id)a3 range:(id)a4
{
  *(Class *)((char *)&self->super.super.isa + OBJC_IVAR____TtC7Journal18BlockQuoteFragment_customColor) = 0;
  *((unsigned char *)&self->super.super.isa + OBJC_IVAR____TtC7Journal18BlockQuoteFragment_prevHasBlockQuote) = 0;
  *((unsigned char *)&self->super.super.isa + OBJC_IVAR____TtC7Journal18BlockQuoteFragment_nextHasBlockQuote) = 0;
  v7.receiver = self;
