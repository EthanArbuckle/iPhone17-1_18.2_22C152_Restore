...
- (_TtC21JournalShareExtension18VideoAssetGridView)initWithFrame:(CGRect)a3
{
  ...
  uint64_t v8 = OBJC_IVAR____TtC21JournalShareExtension18VideoAssetGridView_durationLabel;
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC21JournalShareExtension18VideoAssetGridView_durationLabel));
}
