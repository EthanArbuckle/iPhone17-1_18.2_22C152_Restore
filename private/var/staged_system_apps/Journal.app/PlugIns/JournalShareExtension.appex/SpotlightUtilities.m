...
+ (void)setDisableSearchInSpotlightFlagWithDisableSearchInSpotlight:(BOOL)a3 completionHandler:(id)a4
{
  uint64_t v7 = sub_100004BD4(&qword_10015A5F0);
  ...
  *(void *)(v11 + 32) = a1;
  ...
  v14[4] = &unk_10015CEE0;
  v14[5] = v13;
  sub_10008F748((uint64_t)v9, (uint64_t)&unk_10015CEE8, (uint64_t)v14);
  swift_release();
}
...
+ (void)deleteAllSearchableItemsWithCompletionHandler:(id)a3
{
  ...
  *(void *)(v9 + 24) = a1;
  ...
  v12[4] = &unk_10015CEB8;
  v12[5] = v11;
  sub_10008F748((uint64_t)v7, (uint64_t)&unk_10015CEC0, (uint64_t)v12);
  swift_release();
}
...
+ (void)reindexAllSearchableItemsWithSpotlightDelegate:(NSCoreDataCoreSpotlightDelegate *)a3 completionHandler:(id)a4
{
  ...
  v14[5] = v13;
  uint64_t v15 = a3;
  sub_10008F748((uint64_t)v9, (uint64_t)&unk_10015CE88, (uint64_t)v14);
  swift_release();
}
