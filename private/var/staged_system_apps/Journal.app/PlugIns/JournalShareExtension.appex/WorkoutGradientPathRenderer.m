...
- (_TtC21JournalShareExtension27WorkoutGradientPathRenderer)initWithOverlay:(id)a3;
...
- (void)drawMapRect:(id)a3 zoomScale:(double)a4 inContext:(CGContext *)a5
{
  ...
  v18 = v12;
  sub_100010F9C(v11, v18, v9, v8, var0, var1, v17, v14, v16);
}

- (_TtC21JournalShareExtension27WorkoutGradientPathRenderer)initWithOverlay:(id)a3
{
  swift_unknownObjectRetain();
  result = (_TtC21JournalShareExtension27WorkoutGradientPathRenderer *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
