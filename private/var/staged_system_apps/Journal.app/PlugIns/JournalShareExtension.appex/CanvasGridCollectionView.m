...
- (_TtC21JournalShareExtension24CanvasGridCollectionView)initWithFrame:(CGRect)a3 collectionViewLayout:(id)a4;
...
- (_TtC21JournalShareExtension24CanvasGridCollectionView)initWithFrame:(CGRect)a3 collectionViewLayout:(id)a4
{
  return (_TtC21JournalShareExtension24CanvasGridCollectionView *)CanvasGridCollectionView.init(frame:collectionViewLayout:)(a4, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC21JournalShareExtension24CanvasGridCollectionView)initWithCoder:(id)a3
{
  return (_TtC21JournalShareExtension24CanvasGridCollectionView *)CanvasGridCollectionView.init(coder:)(a3);
}
...
- (void).cxx_destruct
{
  double v2 = (char *)self + OBJC_IVAR____TtC21JournalShareExtension24CanvasGridCollectionView__isExpanded;
  uint64_t v3 = sub_100004BD4(&qword_10015E8E8);
