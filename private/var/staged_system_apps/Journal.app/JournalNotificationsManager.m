...
- (_TtC7Journal27JournalNotificationsManager)init;
...
- (_TtC7Journal27JournalNotificationsManager)init
{
  return (_TtC7Journal27JournalNotificationsManager *)sub_1002322D8();
}
...
- (void)userNotificationCenter:(UNUserNotificationCenter *)a3 didReceiveNotificationResponse:(UNNotificationResponse *)a4 withCompletionHandler:(id)a5
{
  ...
  v18 = a4;
  v19 = self;
  sub_10035886C((uint64_t)v11, (uint64_t)&unk_100804570, (uint64_t)v16);
  swift_release();
}
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.isa
                     + OBJC_IVAR____TtC7Journal27JournalNotificationsManager_notificationCenter));

  uint64_t v3 = *(uint64_t *)((char *)&self->super.isa + OBJC_IVAR____TtC7Journal27JournalNotificationsManager_actionHandler);
