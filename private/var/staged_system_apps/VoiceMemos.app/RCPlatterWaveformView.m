...
- (void)updateActiveSlicesForTimeRange:(id)a3
{
  ...
  if ([(NSMutableArray *)self->_activeSliceQueue count] != v8)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR)) {
      sub_10016C708(v12, v13, v14, v15, v16, v17, v18, v19);
    }
  }
...
- (void)_updateAmplitudes
{
  ...
  {
    double v4 = OSLogForCategory();
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR)) {
      sub_10016C780(v4, v6, v7, v8, v9, v10, v11, v12);
    }
  }
}
...
- (id)accessibilityLabel
{
  ...
  double v3 = [v2 localizedStringForKey:@"AX_WAVEFORM" value:&stru_100228BC8 table:0];
