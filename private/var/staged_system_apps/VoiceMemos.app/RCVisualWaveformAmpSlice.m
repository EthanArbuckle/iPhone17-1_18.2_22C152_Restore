...
+ (UIColor)resolvedMainColor
{
  return (UIColor *)(id)qword_10026A7A8;
}

+ (void)setResolvedMainColor:(id)a3
{
  id v6 = a3;
  objc_storeStrong((id *)&qword_10026A7A8, a3);
  uint64_t v4 = [(id)qword_10026A7A8 colorWithAlphaComponent:0.15];
  v5 = (void *)qword_10026A7B0;
  qword_10026A7B0 = v4;
}

+ (UIColor)resolvedHighlightColor
{
  return (UIColor *)(id)qword_10026A7B8;
}

+ (void)setResolvedHighlightColor:(id)a3
{
  id v6 = a3;
  objc_storeStrong((id *)&qword_10026A7B8, a3);
  uint64_t v4 = [(id)qword_10026A7B8 colorWithAlphaComponent:0.15];
  v5 = (void *)qword_10026A7C0;
  qword_10026A7C0 = v4;
}
...
+ (id)colorForSliceColor:(unint64_t)a3 dimmed:(BOOL)a4
{
  ...
  {
    v5 = &qword_10026A7A8;
    id v6 = &qword_10026A7B0;
    goto LABEL_5;
  }
  if (a3 == 2)
  {
    v5 = &qword_10026A7B8;
    id v6 = &qword_10026A7C0;
LABEL_5:
    if (a4) {
      v5 = v6;
    }
...
- (void)setFrame:(CGRect)a3
{
    ...
    || COERCE__INT64(v9 * v15) != COERCE__INT64(height * v9))
  {
    ...
    [v20 setFrame:CGRectMake(x, y, width, height)];
  }
}
