...
- (void)layoutSublayersOfLayer:(id)a3
{
  ...
  if (v6)
  {
    ...
    id v12 = [(RCView *)self renderer];
    if ([v12 displayMode] == (id)1)
    {
...
LABEL_13:
      ...
      +[CATransaction begin];
      id v12 = [(RCView *)self _createSpringAnimationWithKeyPath:@"bounds" basedOnPropertiesFromSpringAnimation:v9];
...
{
  id v2 = [(RCView *)self renderer];
  double v3 = [v2 splitViewController];
