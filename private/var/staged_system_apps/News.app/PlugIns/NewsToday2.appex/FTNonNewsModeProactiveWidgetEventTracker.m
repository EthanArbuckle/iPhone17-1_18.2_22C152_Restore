...
- (FTNonNewsModeProactiveWidgetEventTracker)init
{
  if (os_log_type_enabled((os_log_t)&_os_log_default, OS_LOG_TYPE_ERROR))
  {
    ...
    *(_DWORD *)buf = 136315906;
    v6 = "-[FTNonNewsModeProactiveWidgetEventTracker init]";
    __int16 v7 = 2080;
    v8 = "FTNonNewsModeProactiveWidgetEventTracker.m";
    __int16 v9 = 1024;
    int v10 = 19;
    __int16 v11 = 2114;
    id v12 = v2;
  ...
  v3 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"%@: %s", @"Do not call method", "-[FTNonNewsModeProactiveWidgetEventTracker init]");
...
+ (id)widgetEventTrackerWithMaxRowCount:(unint64_t)a3
{
  ...
  id v4 = [[FTConditionalWidgetEventTracker alloc] initWithWidgetEventTracker:v3 predicate:&stru_100123C68];
