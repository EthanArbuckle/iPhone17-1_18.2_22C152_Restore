...
- (FTNewsAnalyticsWidgetEventTracker)initWithUserIDProvider:(id)a3
{
  ...
  if (v5)
  {
    ...
    id v12 = [[FTConditionalWidgetEventTracker alloc] initWithWidgetEventTracker:v11 predicate:&stru_100123D40];
...
- (void)widgetDidAppearAtDate:(id)a3 withTrackableWidgetState:(id)a4
{
  ...
  objc_msgSend(v18, "setWidgetDisplayMode:", -[FTNewsAnalyticsWidgetEventTracker _pbDisplayModeWithDisplayMode:](self, "_pbDisplayModeWithDisplayMode:", objc_msgSend(v6, "activeDisplayMode")));
...
- (void)widgetDidDisappearAtDate:(id)a3 withTrackableWidgetState:(id)a4
{
  ...
  v14 = [v13 fc_arrayByTransformingWithBlock:&stru_100123D80];
