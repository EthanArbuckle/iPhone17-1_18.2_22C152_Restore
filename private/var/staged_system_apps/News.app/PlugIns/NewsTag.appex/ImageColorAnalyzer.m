...
- (NSArray)dominantColors
{
  ...
  CGRect v10 = 0;
  uint64_t v11 = 0;
  sub_10001CC6C(&__p, self->_analyzedColors.completeColorList.__begin_, (uint64_t)self->_analyzedColors.completeColorList.__end_, self->_analyzedColors.completeColorList.__end_ - self->_analyzedColors.completeColorList.__begin_);
  id v4 = (char *)__p;
  if (v10 != __p)
  {
    uint64_t v5 = 0;
...
- (BOOL)color:(id)a3 isCloseToOtherColor:(id)a4
{
  return [a3 _isSimilarToColor:a4 withinPercentage:0.2];
}
