...
- (void)widgetPerformedUpdateWithTodayResults:(id)a3 fetchInfo:(id)a4 error:(id)a5 updateFetchDuration:(double)a6
{
  ...
  if (([(FTProactiveWidgetEventTracker *)self trackedEvents] & 2) != 0)
  {
    ...
    [v10 trackUpdateWithTodaySource:v11 appConfigTreatmentID:v12 error:v9 updateFetchDuration:[v13 wifiReachable] cellularRadioAccessTechnology:[v13 cellularRadioAccessTechnology] a6];
  }
}
