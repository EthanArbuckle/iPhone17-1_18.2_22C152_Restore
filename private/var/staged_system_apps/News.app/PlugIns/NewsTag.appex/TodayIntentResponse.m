...
- (TodayIntentResponse)initWithCoder:(id)a3
{
  return (TodayIntentResponse *)sub_1000C5568((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithCoder_);
}

- (TodayIntentResponse)initWithBackingStore:(id)a3
{
  return (TodayIntentResponse *)sub_1000C5568((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithBackingStore_);
}

- (TodayIntentResponse)initWithPropertiesByName:(id)a3
{
  if (a3) {
    uint64_t v3 = sub_1000CC110();
  }
  else {
    uint64_t v3 = 0;
  }
