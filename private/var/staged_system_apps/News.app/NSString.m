...
- (id)fr_stringInitials
{
  ...
  v4 = +[NSSet setWithArray:&off_1000CFA38];
...
+ (id)fr_fontLookup
{
  if (qword_1000EE168 != -1) {
    dispatch_once(&qword_1000EE168, &stru_1000C9468);
  }
  v2 = (void *)qword_1000EE160;
...
+ (id)fr_attributesLookup
{
  ...
  block[1] = 3221225472;
  block[2] = sub_100056298;
  block[3] = &unk_1000C8748;
  block[4] = a1;
  if (qword_1000EE178 != -1) {
    dispatch_once(&qword_1000EE178, block);
  }
  v2 = (void *)qword_1000EE170;
...
- (id)fr_attributedStringForHeaderType:(int64_t)a3
{
  if (objc_msgSend((id)objc_opt_class(), "fr_shouldTitlecaseForFeedHeaderType:", a3))
  {
    BOOL v5 = [(NSString *)self uppercaseString];
  }
  else
  {
    BOOL v5 = self;
  ...
  BOOL v6 = v5;
  id v7 = [objc_opt_class() fr_attributesLookup];
  id v8 = +[NSNumber numberWithInteger:a3];
  id v9 = [v7 objectForKey:v8];

  id v10 = [objc_alloc((Class)NSAttributedString) initWithString:v6 attributes:v9];
