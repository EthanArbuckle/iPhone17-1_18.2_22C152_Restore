...
+ (OS_os_log)log
{
  ...
  block[1] = 3221225472;
  block[2] = sub_10005FD24;
  block[3] = &unk_1006044D8;
  block[4] = a1;
  if (qword_1006993B8 != -1) {
    dispatch_once(&qword_1006993B8, block);
  }
  v2 = (void *)qword_1006993B0;
...
- (ComposeNavigationController)initWithUserActivity:(id)a3 scene:(id)a4
{
  v5 = sub_10005FF9C((uint64_t)ComposeNavigationController, a3, a4);
