  ...
  if (v3)
  {
    ...
    if (![(MFExpandableCaptionView *)self isOutgoing])
    {
      ...
      if ([v13 count])
      {
        ...
        v15 = [v14 localizedStringForKey:@"TO_HEADER" value:&stru_100619928 table:@"Main"];
        uint64_t v16 = +[NSBundle mainBundle];
        v17 = [v16 localizedStringForKey:@"TO_TITLE" value:&stru_100619928 table:@"Main"];
    ...
    if ([v19 count])
    {
      ...
      BOOL v21 = [v20 localizedStringForKey:@"CC_HEADER" value:&stru_100619928 table:@"Main"];
      v22 = +[NSBundle mainBundle];
      id v23 = [v22 localizedStringForKey:@"CC_TITLE" value:&stru_100619928 table:@"Main"];
    ...
    if ([v25 count])
    {
      ...
      v27 = [v26 localizedStringForKey:@"BCC_HEADER" value:&stru_100619928 table:@"Main"];
      v28 = +[NSBundle mainBundle];
      v29 = [v28 localizedStringForKey:@"BCC_TITLE" value:&stru_100619928 table:@"Main"];
    ...
    if ([v31 count])
    {
      ...
      v33 = [v32 localizedStringForKey:@"OTHER_SIGNERS_HEADER" value:&stru_100619928 table:@"Main"];
      v34 = +[NSBundle mainBundle];
      v35 = [v34 localizedStringForKey:@"OTHER_SIGNERS_TITLE" value:&stru_100619928 table:@"Main"];
    ...
    if ([(MFExpandableCaptionView *)self isOutgoing])
    {
      ...
      if ([v37 count])
      {
        ...
        v39 = [v38 localizedStringForKey:@"FROM_HEADER" value:&stru_100619928 table:@"Main"];
        v40 = +[NSBundle mainBundle];
        v41 = [v40 localizedStringForKey:@"FROM_TITLE" value:&stru_100619928 table:@"Main"];
      ...
      && [(MFExpandableCaptionView *)self isBIMIVerified])
    {
      ...
      if (!v46)
      {
        ...
        v107[1] = 3221225472;
        v107[2] = sub_100196688;
        v107[3] = &unk_1006070F8;
