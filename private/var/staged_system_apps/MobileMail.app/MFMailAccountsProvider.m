...
- (id)_displayedAccountsIdentifiers
{
  ...
  v3 = [v2 ef_compactMap:&stru_10060B920];
  v4 = v3;
  if (v3)
  {
    id v5 = v3;
...
- (id)_executeChange:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = (char *)[v7 numberOfActiveAccounts];
...
- (id)_focusedAccountsIdentifiers
{
  ...
  BOOL v3 = [v2 ef_compactMap:&stru_10060B940];
...
- (NSArray)receivingAddresses
{
  ...
  BOOL v3 = [v2 ef_map:&stru_10060B8E0];
  v4 = [v3 ef_flatten];
  id v5 = [v4 ef_filter:EFIsNotNull];
...
- (id)legacyMailAccountForObjectID:(id)a3
{
  ...
  {
    uint64_t v6 = [(MFMailAccountsProvider *)self mailAccounts];
    v9[0] = _NSConcreteStackBlock;
    v9[1] = 3221225472;
    v9[2] = sub_10019E420;
    v9[3] = &unk_10060A858;
    id v10 = v5;
    id v7 = [v6 ef_firstObjectPassingTest:v9];
  }
  else
  {
    id v7 = 0;
...
- (NSArray)orderedAccounts
{
  if (pthread_main_np() != 1)
  {
    ...
    [v15 handleFailureInMethod:a2 object:self file:@"MFMailAccountsProvider.m" lineNumber:175 description:@"Current thread must be main"];
  }
  ...
  if (!orderedAccounts)
  {
    ...
    id v10 = [v9 arrayForKey:@"MailAccountsOrder"];
    ...
    id v12 = (NSArray *)[v8 copy];
    id v13 = self->_orderedAccounts;
...
{
  v2 = [(MFMailAccountsProvider *)self displayedAccounts];
  BOOL v3 = [v2 ef_filter:&stru_10060B960];
