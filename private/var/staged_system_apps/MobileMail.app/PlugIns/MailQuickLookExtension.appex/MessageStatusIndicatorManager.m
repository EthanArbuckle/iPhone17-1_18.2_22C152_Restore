...
- (double)midXToMidXSpacing
{
  double result = *(double *)&qword_100043D80;
  double v3 = -*(double *)&qword_100043D80;
  if (*(double *)&qword_100043D80 >= 0.0) {
    double v3 = *(double *)&qword_100043D80;
  }
  if (v3 < 2.22044605e-16)
  {
    ...
    [v4 size];
    *(double *)&qword_100043D80 = v5 * 1.5;

    return *(double *)&qword_100043D80;
  }
  return result;
}
