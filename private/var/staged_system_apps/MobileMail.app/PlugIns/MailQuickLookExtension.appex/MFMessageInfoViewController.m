...
+ (id)log
{
  ...
  if (qword_100043DB8 != -1) {
    dispatch_once(&qword_100043DB8, block);
  }
  v2 = (void *)qword_100043DB0;
...
- (void)collectionView:(id)a3 didSelectItemAtIndexPath:(id)a4
{
  ...
  id v6 = objc_msgSend(v5, "objectAtIndexedSubscript:", objc_msgSend(v27, "section"));
  ...
  if ((v7 & 1) == 0)
  {
    ...
    else
    {
      ...
      id v11 = objc_msgSend(v10, "objectAtIndexedSubscript:", objc_msgSend(v27, "section"));
      ...
      if (!v12)
      {
        ...
        if (v20)
        {
          ...
          BOOL v23 = objc_msgSend(v22, "objectAtIndexedSubscript:", objc_msgSend(v27, "item"));
          id v13 = [v23 richLink];
    ...
    id v14 = [v13 objectAtIndexedSubscript:[v27 section]];
...
- (void)_openContactCard:(id)a3
{
  ...
  if (v11)
  {
    ...
    [v7 setPreferredContentSize:CGSizeMake(320.0, v6)];
...
- (id)_contactViewControllerForAddress:(id)a3
{
  ...
  if (v10)
  {
    ...
    if ((+[MFContactsManager isAuthorizedToUseContacts](MFContactsManager, "isAuthorizedToUseContacts") & 1) == 0) [v16 setActions:((unint64_t)[v16 actions] & 0xFFFFFFFFFFFFFFDFLL)]; {
  ...
  else
  {
    ...
    {
      v18 = [v4 stringValue];
      sub_10001EF08(v18, (uint64_t)v6, buf, v17);
    }
