...
+ (OS_os_log)log
{
  ...
  block[1] = 3221225472;
  block[2] = sub_1000099D8;
  block[3] = &unk_1000388E0;
  block[4] = a1;
  if (qword_100043DA0 != -1) {
    dispatch_once(&qword_100043DA0, block);
  }
  v2 = (void *)qword_100043D98;
...
- (MFConversationItemHeaderBlock)initWithFrame:(CGRect)a3 contactStore:(id)a4 accountsProvider:(id)a5
{
  ...
  if (v13)
  {
    ...
    byte_100043DA8 = [v16 BOOLForKey:@"ShowMessageHeaderDetails"];

    v15->_showDetails = byte_100043DA8;
...
- (void)createPrimaryViews
{
  ...
  v16 = [v15 localizedStringForKey:@"FROM_HEADER" value:&stru_100039250 table:@"Main"];
  v17 = +[NSBundle mainBundle];
  v18 = [v17 localizedStringForKey:@"FROM_TITLE" value:&stru_100039250 table:@"Main"];
  v19 = +[MFAddressBookManager sharedManager];
  id v20 = objc_msgSend(v14, "initWithLabel:title:addressBook:", v16, v18, objc_msgSend(v19, "addressBook"));
...
- (void)_showMessageInfo
{
  ...
  id v44 = sub_10000E8E4;
  unsigned int v45 = sub_10000E8F4;
  id v46 = 0;
  if (_os_feature_enabled_impl())
  {
