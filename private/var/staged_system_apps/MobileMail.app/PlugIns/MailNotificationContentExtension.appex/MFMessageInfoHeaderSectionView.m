...
+ (NSString)reusableIdentifier
{
  return (NSString *)@"MFMessageInfoHeaderSectionViewIdentifier";
}

- (MFMessageInfoHeaderSectionView)initWithFrame:(CGRect)a3
{
  v22.receiver = self;
  v22.super_class = (Class)MFMessageInfoHeaderSectionView;
  v3 = -[MFMessageInfoHeaderSectionView initWithFrame:](&v22, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  v4 = v3;
  if (v3)
  {
