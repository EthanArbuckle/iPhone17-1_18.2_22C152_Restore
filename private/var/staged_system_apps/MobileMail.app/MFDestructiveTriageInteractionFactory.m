...
+ (id)interactionWithMessageListItemSelection:(id)a3 undoManager:(id)a4 origin:(int64_t)a5 actor:(int64_t)a6 deleteOrArchive:(unint64_t)a7
{
  id v12 = a3;
  id v13 = a4;
  v14 = objc_msgSend(objc_msgSend(a1, "interactionClassForMSDeleteOrArchive:", a7), "interactionWithMessageListItemSelection:undoManager:origin:actor:", v12, v13, a5, a6);
...
+ (id)interactionWithMessageListItems:(id)a3 undoManager:(id)a4 origin:(int64_t)a5 actor:(int64_t)a6 deleteOrArchive:(unint64_t)a7
{
  id v12 = a3;
  id v13 = a4;
  v14 = objc_msgSend(objc_msgSend(a1, "interactionClassForMSDeleteOrArchive:", a7), "interactionWithMessageListItems:undoManager:origin:actor:", v12, v13, a5, a6);
