  ...
  if (v8)
  {
    ...
    *((unsigned char *)v9 + 40) = *((unsigned char *)v9 + 40) & 0xFE | v4;
    if (v4)
    {
      ...
      id v13 = [v12 initWithObjects:MessageIsRead, 0];
...
- (BOOL)commitToMessages:(id)a3 failures:(id)a4 newMessages:(id)a5
{
    ...
    if (v14)
    {
      ...
      do
      {
        for (i = 0; i != v14; i = (char *)i + 1)
        {
          ...
          objc_super v17 = [v16 mailbox:v42];
  ...
  {
    id v37 = [objc_alloc((Class)ECMessageFlagChange) initWithBuilder:&stru_100609088];
    v38 = [v49 allObjects];
...
- (id)localizedErrorDescriptionForMessageCount:(unint64_t)a3
{
  ...
  v6 = v5;
  if (a3 == 1) {
    [v5 localizedStringForKey:@"ERROR_TRANSFERRING_LONG_FORMAT" value:&stru_100619928 table:@"Main"];
  }
  else {
  id v7 = [v5 localizedStringForKey:@"ERROR_TRANSFERRING_LONG_FORMAT_MANY" value:&stru_100619928 table:@"Main"];
  }
...
- (id)localizedErrorTitleForMessageCount:(unint64_t)a3
{
  ...
  BOOL v5 = v4;
  if (a3 == 1) {
    [v4 localizedStringForKey:@"ERROR_TRANSFERRING_TITLE" value:&stru_100619928 table:@"Main"];
  }
  else {
  v6 = [v4 localizedStringForKey:@"ERROR_TRANSFERRING_TITLE_MULTIPLE" value:&stru_100619928 table:@"Main"];
  }
...
- (id)localizedShortOperationDescription
{
  ...
  v3 = [v2 localizedStringForKey:@"OPERATION_TRANSFER_DESC" value:&stru_100619928 table:@"Main"];
