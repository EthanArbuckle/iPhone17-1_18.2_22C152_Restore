...
+ (id)sharedStorage
{
  pthread_once(&stru_10068E568, sub_100009AFC);
  v2 = (void *)qword_1006996D8;
...
- (void)removeAllDataBelongingToAccount:(id)a3
{
  ...
  long long v31 = 0u;
  long long v32 = 0u;
  id v5 = [&off_10062B3F0 countByEnumeratingWithState:&v29 objects:v35 count:16];
  if (v5)
  {
    ...
    do
    {
      ...
      {
        if (*(void *)v30 != v18) {
          objc_enumerationMutation(&off_10062B3F0);
        }
