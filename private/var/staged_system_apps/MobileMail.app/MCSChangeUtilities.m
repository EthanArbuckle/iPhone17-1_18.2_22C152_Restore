...
+ (id)flagChangesForKey:(id)a3
{
  ...
  if (!qword_100699798)
  {
    ...
    id v6 = [v4 initWithObjectsAndKeys:v5, MessageIsDeleted, 0, 0];
    v7 = (void *)qword_100699798;
    qword_100699798 = (uint64_t)v6;

    id v8 = objc_alloc((Class)NSDictionary);
    v9 = +[NSNumber numberWithBool:1];
    uint64_t v10 = MessageIsRead;
    id v11 = [v8 initWithObjectsAndKeys:v9, MessageIsRead, 0, 0];
    v12 = (void *)qword_1006997A0;
    qword_1006997A0 = (uint64_t)v11;

    id v13 = objc_alloc((Class)NSDictionary);
    v14 = +[NSNumber numberWithBool:0];
    id v15 = [v13 initWithObjectsAndKeys:v14, v10, 0, 0];
    v16 = (void *)qword_1006997A8;
    qword_1006997A8 = (uint64_t)v15;

    id v17 = objc_alloc((Class)NSDictionary);
    v18 = +[NSNumber numberWithBool:1];
    uint64_t v19 = MFMessageIsFlagged;
    id v20 = [v17 initWithObjectsAndKeys:v18, MFMessageIsFlagged, 0, 0];
    v21 = (void *)qword_1006997B0;
    qword_1006997B0 = (uint64_t)v20;

    id v22 = objc_alloc((Class)NSDictionary);
    v23 = +[NSNumber numberWithBool:0];
    id v24 = [v22 initWithObjectsAndKeys:v23, v19, 0, 0];
    v25 = (void *)qword_1006997B8;
    qword_1006997B8 = (uint64_t)v24;
  }
