...
- (id)visibleItemsOfType:(int64_t)a3
{
  ...
  v5[3] = &unk_100606AB0;
  v5[4] = a3;
  v3 = sub_10000E94C((id *)&self->super.isa, v5);
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v8 = +[FavoriteItem itemFromDictionary:](FavoriteItem, "itemFromDictionary:", *(void *)(*((void *)&v10 + 1) + 8 * (void)v7), (void)v10);
        v9 = v8;
        if (v8)
        {
          [v8 sourceType];
...
- (id)dictionaryRepresentation
{
  ...
  {
    uint64_t v6 = self->_invalidItemDicts;
    uint64_t v7 = [(NSMutableDictionary *)v6 allKeys];
...
- (FavoritesCollection)initWithDictionary:(id)a3
{
  ...
  uint64_t v5 = [(FavoritesCollection *)&v24 init];
  if (!v5) {
    goto LABEL_20;
  }
  uint64_t v6 = [v4 objectForKey:@"type"];
  id v23 = v4;
  v5->_uint64_t type = (unint64_t)[v6 integerValue];

  uint64_t v7 = [v4 objectForKey:@"displayName"];
  uint64_t v8 = v7;
...
LABEL_12:
  sub_100038758((uint64_t)v5, type);
  id v11 = [v4 objectForKey:@"items"];
  id v12 = objc_alloc_init((Class)NSMutableArray);
  uint64_t v13 = objc_opt_new();
  invalidItemDicts = v5->_invalidItemDicts;
  v5->_invalidItemDicts = (NSMutableDictionary *)v13;

  for (unint64_t i = 0; i < (unint64_t)[v11 count]; ++i)
  {
    id v16 = [v11 objectAtIndexedSubscript:i];
    id v17 = +[FavoriteItem itemFromDictionary:v16];
    v18 = v17;
    if (v17)
    {
      [v17 sourceType];
...
- (BOOL)addOrUpdateItem:(id)a3 replacedItem:(id *)a4
{
  ...
  id v23 = sub_1000BAA4C;
  objc_super v24 = sub_1000BAA5C;
  id v25 = 0;
  if (self) {
    state = self->_state;
  }
...
- (void)invalidateVisibleItems
{
  ...
  [(FavoritesCollection *)self performWhileLocked:&stru_100606A18];
}
...
+ (id)mailboxesCollection
{
  char v2 = sub_1000BA8C0([FavoritesCollection alloc], 1);
...
+ (id)accountsCollection
{
  char v2 = sub_1000BA8C0([FavoritesCollection alloc], 3);
...
+ (id)outboxCollection
{
  char v2 = sub_1000BA8C0([FavoritesCollection alloc], 2);
  id v3 = +[FavoriteItem itemForOutbox];
  [v2 addItem:v3];
...
- (void)addOrUpdateExpandedItem:(id)a3 replacedItem:(id *)a4
{
  ...
  uint64_t v18 = sub_1000BAA4C;
  char v19 = sub_1000BAA5C;
  id v20 = 0;
  if (self) {
    state = self->_state;
  }
...
- (id)removeItem:(id)a3
{
  ...
  uint64_t v17 = sub_1000BAA4C;
  uint64_t v18 = sub_1000BAA5C;
  id v19 = 0;
  if (self) {
    state = self->_state;
  }
...
- (id)removeExpandedItem:(id)a3
{
  ...
  uint64_t v16 = sub_1000BAA4C;
  uint64_t v17 = sub_1000BAA5C;
  id v18 = 0;
  if (self) {
    state = self->_state;
  }
...
- (id)removeItemWithSyncKey:(id)a3
{
  ...
  uint64_t v16 = &v15;
  uint64_t v17 = 0x3032000000;
  id v18 = sub_1000BAA4C;
  id v19 = sub_1000BAA5C;
  id v20 = 0;
  if (self) {
    state = self->_state;
  }
...
- (id)itemsOfType:(int64_t)a3
{
  ...
  v5[3] = &unk_100606AB0;
  v5[4] = a3;
  id v3 = sub_10000E94C((id *)&self->super.isa, v5);
...
- (id)itemsMatchingName:(id)a3
{
  ...
  id v8 = a3;
  id v4 = v8;
  uint64_t v5 = sub_1000BBA3C((id *)&self->super.isa, v7);
...
- (NSArray)itemsIncludingSubItems
{
  ...
  id v10 = sub_1000BAA4C;
  id v11 = sub_1000BAA5C;
...
- (NSString)displayName
{
  id v3 = sub_1000BC3AC((uint64_t)self, self->_type);
  id v4 = +[UIApplication sharedApplication];
  uint64_t v5 = [v4 accountsProvider];
  id v6 = [v5 displayedAccounts];
  ...
  else if ([(FavoritesCollection *)self isAccountsCollection])
  {
    ...
    if ((unint64_t)v15[3] <= 1)
    {
      ...
      uint64_t v11 = [v10 localizedStringForKey:@"SINGLE_ACCOUNT_MAILBOXES" value:&stru_100619928 table:@"Main"];
