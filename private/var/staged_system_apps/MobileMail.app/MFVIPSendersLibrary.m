...
+ (id)log
{
  ...
  block[1] = 3221225472;
  block[2] = sub_100203070;
  block[3] = &unk_1006044D8;
  block[4] = a1;
  if (qword_100699E28 != -1) {
    dispatch_once(&qword_100699E28, block);
  }
  v2 = (void *)qword_100699E20;
...
+ (id)defaultInstance
{
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_100203194;
  block[3] = &unk_1006044D8;
  block[4] = a1;
  if (qword_100699E38 != -1) {
    dispatch_once(&qword_100699E38, block);
  }
  v2 = (void *)qword_100699E30;
...
- (void)dealloc
{
  ...
  if (addressBook)
  {
    ...
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_100203720;
    block[3] = &unk_100609128;
    block[4] = v8;
    void block[5] = self;
...
- (void)checkForAddressBookChanges
{
  ...
  if (!self->_addressBook)
  {
    ...
    if (v4)
    {
      ...
      ABAddressBookRegisterExternalChangeCallback(self->_addressBook, (ABExternalChangeCallback)sub_100203838, self);
    }
    if (error) {
      CFRelease(error);
    }
    ...
    do
    {
      for (i = 0; i != v38; i = (char *)i + 1)
      {
        ...
        if (v3->_addressBook)
        {
          ...
          id v8 = [v36 existingPersonForVIP:v7];
          if (v8)
          {
...
LABEL_3:
    ...
    {
      id v17 = [v13 mf_copyIDNAEncodedEmailAddress];
      ...
      {
        id v18 = [v13 mf_copyIDNADecodedEmailAddress];
...
LABEL_17:
    ...
    while (1)
    {
      ...
      if (!v27 && v23 != 0) {
        BOOL v27 = [v23 mf_indexOfRecipientWithEmailAddress:*(void *)(*((void *)&v39 + 1) + 8 * v30)] != (id)0x7FFFFFFFFFFFFFFFLL;
      }
      if (!v28 && v24 != 0) {
        BOOL v28 = [v24 mf_indexOfRecipientWithEmailAddress:v31] != (id)0x7FFFFFFFFFFFFFFFLL;
      }
      if (v27 && v28) {
        break;
      }
...
- (id)_messagesForSenders:(id)a3 success:(BOOL *)a4
{
  ...
  BOOL v13 = ![v6 count] || [v12 count] || EFContentProtectionGetObservedState() == 0;
  *a4 = v13;
LABEL_10:
