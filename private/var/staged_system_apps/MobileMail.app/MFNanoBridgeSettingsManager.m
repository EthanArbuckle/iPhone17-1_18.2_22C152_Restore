...
+ (id)sharedInstance
{
  if (qword_100699BF8 != -1) {
    dispatch_once(&qword_100699BF8, &stru_10060CAD8);
  }
  v2 = (void *)qword_100699BF0;
...
- (MFNanoBridgeSettingsManager)init
{
  if (MFDeviceSupportsNanoCompanion())
  {
    ...
    if (v3)
    {
      ...
      v10 = (NPSManager *)objc_alloc_init(off_100690EA8());
...
- (void)notifyMobileMailAccountsChanged
{
  ...
  if ([(NSArray *)self->_activeAccounts count] < 2 || (id)[(NSArray *)v18 count] != (id)1)
  {
    if (!v7) {
      goto LABEL_22;
    }
...
- (id)_includeMailMailbox
{
  ...
  if (v19)
  {
    ...
    if (os_log_type_enabled(v2, OS_LOG_TYPE_DEFAULT))
    {
      *(_DWORD *)buf = 138543362;
      v28 = v19;
      _os_log_impl((void *)&_mh_execute_header, v2, OS_LOG_TYPE_DEFAULT, "#Nano Mailbox selection list is from legacy OS. %{public}@", buf, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)buf = 138543362;
      v28 = v20;
      _os_log_impl((void *)&_mh_execute_header, v3, OS_LOG_TYPE_INFO, "#Nano Mailbox selection list read from disk. %{public}@", buf, 0xCu);
    }
  }
...
LABEL_21:
          ...
          if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
          {
            *(_DWORD *)buf = 138543362;
            v28 = v11;
            _os_log_error_impl((void *)&_mh_execute_header, v12, OS_LOG_TYPE_ERROR, "#Nano Mailbox no longer available. Ignoring. %{public}@", buf, 0xCu);
          }
        }
LABEL_25:
...
LABEL_27:
  ...
  if ([v5 count])
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      *(_DWORD *)buf = 138543362;
      v28 = v5;
      _os_log_impl((void *)&_mh_execute_header, v13, OS_LOG_TYPE_INFO, "#Nano Mailbox selection list validated. %{public}@", buf, 0xCu);
    }
  }
  else
  {
    ...
    {
      *(_WORD *)buf = 0;
      _os_log_impl((void *)&_mh_execute_header, v14, OS_LOG_TYPE_DEFAULT, "#Nano Mailbox selection list does not exist. Creating default seletion", buf, 2u);
    }
...
- (BOOL)_askBeforeDeleting
{
  ...
  if (v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0)) {
    ...
    unsigned __int8 v5 = off_100690ED0();
  }
  BOOL v6 = v5;
...
- (BOOL)_loadRemoteImages
{
  ...
  if (v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0)) {
    ...
    unsigned __int8 v5 = off_100690EE0();
  }
  BOOL v6 = v5;
...
- (BOOL)_organizeByThread
{
  ...
  if (v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0)) {
    ...
    unsigned __int8 v5 = off_100690EF0();
  }
  BOOL v6 = v5;
...
- (id)_signature
{
  ...
  else
  {
    ...
    id v7 = off_100690F18();
    id v5 = [v6 localizedStringForKey:v7 value:&stru_100619928 table:@"NanoMailKit"];
  }
...
- (BOOL)_alwaysLoadContentDirectly
{
  ...
  if (v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0)) {
    ...
    unsigned __int8 v5 = off_100690F28();
  }
  BOOL v6 = v5;
...
- (BOOL)_cloudNotificationsEnabled
{
  ...
  if (v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0)) {
    ...
    unsigned __int8 v5 = off_100690F38();
  }
  BOOL v6 = v5;
...
- (BOOL)_mobileMailAskBeforeDeleting
{
  ...
  uint64_t v3 = [v2 objectForKey:ShowMessageDeleteConfirmationKey];
...
{
  v2 = +[NSUserDefaults em_userDefaults];
  unsigned __int8 v3 = [v2 objectForKey:DisableThreadingKey];
...
{
  v2 = +[NSUserDefaults em_userDefaults];
  unsigned __int8 v3 = [v2 objectForKey:RightSwipeActionKey];
...
LABEL_8:
  ...
  if (v24)
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_DEBUG)) {
      sub_10045D194((uint64_t)v11, v25);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
    {
      int v29 = 138412290;
      id v30 = v11;
      _os_log_impl((void *)&_mh_execute_header, v27, OS_LOG_TYPE_DEFAULT, "#Nano Posting Darwin Notification Bridge Setting has Changed for key: %@", (uint8_t *)&v29, 0xCu);
    }
...
- (id)domainAccessor
{
  ...
  if (!domainAccessor)
  {
    id v4 = (NPSDomainAccessor *)[objc_alloc(off_100690F50()) initWithDomain:@"com.apple.NanoMail"];
