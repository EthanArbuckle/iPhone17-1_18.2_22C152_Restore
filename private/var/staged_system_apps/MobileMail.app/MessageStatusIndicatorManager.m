...
+ (unint64_t)statusIndicatorOptionsForMessage:(id)a3;
+ (void)clearCache;
...
- (id)statusIndicatorImageWithOptionsMask:(unint64_t)a3
{
  ...
  {
    unint64_t v5 = 0;
    unint64_t v4 = &MFImageGlyphStatusIndicatorVIP;
    switch(v3)
    {
      case 0:
        goto LABEL_33;
      case 1:
        unint64_t v5 = +[MessageStatusIndicatorManager dotIndicatorImage];
        goto LABEL_29;
      case 2:
        goto LABEL_28;
      case 3:
      ...
      case 7:
        goto LABEL_30;
      case 4:
        unint64_t v5 = +[MessageStatusIndicatorManager flagShapeImage];
        goto LABEL_29;
      case 8:
        goto LABEL_15;
      default:
        if (v3 == 16)
        {
          unint64_t v4 = &MFImageGlyphStatusIndicatorForwarded;
        }
        else
        {
          if (v3 != 24) {
...
LABEL_15:
          unint64_t v4 = &MFImageGlyphStatusIndicatorReplied;
        }
        break;
    }
    goto LABEL_28;
  ...
  if (v3 > 511)
  {
    if (v3 > 2047)
    {
      if (v3 == 2048)
      {
        unint64_t v5 = +[MessageStatusIndicatorManager timeSensitivePromotionsImage];
        goto LABEL_29;
      }
      if (v3 == 4096)
      {
        unint64_t v5 = +[MessageStatusIndicatorManager timeSensitiveUpdatesImage];
        goto LABEL_29;
      }
    }
    else
    {
      if (v3 == 512)
      {
        unint64_t v4 = &MFImageGlyphStatusIndicatorReadLater;
        goto LABEL_28;
      }
      if (v3 == 1024)
      {
        unint64_t v5 = +[MessageStatusIndicatorManager timeSensitiveTransactionsImage];
        goto LABEL_29;
      }
    }
  }
  else if (v3 > 127)
  {
    if (v3 == 128)
    {
      unint64_t v4 = &MFImageGlyphStatusIndicatorMute;
      goto LABEL_28;
    }
    if (v3 == 256)
    {
      unint64_t v4 = &MFImageGlyphStatusIndicatorBlockSender;
      goto LABEL_28;
    }
  }
  else
  {
    if (v3 == 32)
    {
      unint64_t v4 = &MFImageGlyphStatusIndicatorAttachment;
      goto LABEL_28;
    }
    if (v3 == 64)
    {
      unint64_t v4 = &MFImageGlyphStatusIndicatorNotify;
LABEL_28:
      unint64_t v5 = +[UIImage mf_systemImageNamed:*v4 forView:12];
LABEL_29:
      if (v5) {
        goto LABEL_33;
      }
...
+ (id)statusIndicatorColorWithOptions:(unint64_t)a3 flagColors:(id)a4 useSelectedColors:(BOOL)a5
{
  ...
  int v8 = +[UIColor systemBlueColor];
  }
  if ((uint64_t)a3 > 127)
  {
    if ((uint64_t)a3 > 1023)
...
- (double)midXToMidXSpacing
{
  double result = *(double *)&qword_100699940;
  double v3 = -*(double *)&qword_100699940;
  if (*(double *)&qword_100699940 >= 0.0) {
    double v3 = *(double *)&qword_100699940;
  }
  if (v3 < 2.22044605e-16)
  {
    unint64_t v4 = +[MessageStatusIndicatorManager flagShapeImage];
    [v4 size];
    *(double *)&qword_100699940 = v5 * 1.5;

    return *(double *)&qword_100699940;
  }
  return result;
}
...
{
  id v3 = a3;
  unint64_t v4 = [v3 flags];
  unsigned int v5 = [v4 read];

  v6 = [v3 flags];
  LODWORD(v4) = [v6 flagged];

  id v7 = [v3 conversationNotificationLevel];
  unsigned int v8 = [v3 isBlocked];
  unint64_t v9 = v5 ^ 1;
  if (v4) {
    v9 |= 4uLL;
  }
