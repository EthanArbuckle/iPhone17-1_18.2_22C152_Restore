...
- (void)setLastSelectedItem:(id)a3
{
  ...
  if (self->_lastSelectedItem != v6)
  {
    ...
    sub_10001B1A4((uint64_t)self, v5);
  }
...
- (void)_accountsDidChange:(id)a3
{
  ...
  id v14 = v10;
  v15 = self;
  int v11 = +[EFScheduler mainThreadScheduler];
...
- (FavoritesPersistence)initWithConversationSubscriptionProvider:(id)a3 accountsProvider:(id)a4 mailboxPersistence:(id)a5 daemonInterface:(id)a6 analyticsCollector:(id)a7
{
  ...
  char v16 = [(FavoritesPersistence *)&v60 init];
  v17 = v16;
  if (v16)
  {
    ...
    else
    {
      ...
      if (v17->_kvStore)
      {
        [v27 addObserver:v17 selector:@selector(_keyValueStoreChangedExternally:) name:NSUbiquitousKeyValueStoreDidChangeExternallyNotification object:nil];
        block[0] = _NSConcreteStackBlock;
        block[1] = 3221225472;
        block[2] = sub_100006664;
        block[3] = &unk_100604618;
        v55 = v27;
        v56 = v17;
      ...
      else
      {
        ...
        if (os_log_type_enabled(v42, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *(void *)&uint8_t buf[4] = @"com.apple.mail.favorites";
    ...
    *(void *)buf = 0xAAAAAAAAAAAAAAAALL;
    ...
    id v45 = v43;
    id v52 = v45;
    uint64_t v46 = [v45 ef_observeKeyPath:v44 options:1 autoCancelToken:1 usingBlock:v51];
...
- (id)dictionaryRepresentation
{
  ...
  if (lastSelectedItem)
  {
    uint64_t v12 = [(FavoriteItem *)lastSelectedItem dictionaryRepresentation];
  ...
  if (v10)
  {
    ...
    do
    {
      for (i = 0; i != v10; i = (char *)i + 1)
      {
        ...
        {
          id v14 = v13;
          long long v15 = sub_1000C0CDC((uint64_t)self, (uint64_t)[v14 mailboxType]);
...
{
  id v4 = a3;
  id v5 = sub_100028EE4((uint64_t)self);
  for (unint64_t i = 0; ; ++i)
  {
    ...
    uint64_t v7 = [v5 objectAtIndex:i];
...
- (void)updateCollections:(id)a3 changeType:(unint64_t)a4 withReason:(id)a5 source:(id)a6
{
  ...
  id v10 = a5;
  id v11 = a6;
  sub_100037570((uint64_t)self, v15, v10);
  [(NSRecursiveLock *)self->_lock lock];
  uint64_t v12 = (NSMutableArray *)[v15 mutableCopy];
  ...
  [(NSRecursiveLock *)self->_lock unlock];
  if (a4 != 2) {
    sub_100052B2C((uint64_t)self, v11);
  }
}
...
- (void)updateCollections:(id)a3 forItemChangeAddedItems:(id)a4 removedItems:(id)a5 withReason:(id)a6 source:(id)a7
{
  ...
  [(NSRecursiveLock *)self->_lock lock];
  sub_1000C139C((id *)&self->super.isa, v12, v13);
  [(NSRecursiveLock *)self->_lock unlock];
}
...
LABEL_3:
    ...
    while (1)
    {
      ...
      id v12 = [v11 representingMailbox];
      if ([v12 isEqual:v5]) {
        break;
      }
    ...
    if ([v8 shouldSync])
    {
      ...
      sub_10001B1A4((uint64_t)self, v15);
    }
  }
  else
  {
...
- (void)setVisibility:(BOOL)a3 forSourceType:(unint64_t)a4
{
  ...
  else
  {
    ...
    else
    {
      ...
      sub_100037570((uint64_t)self, v13, @"_sharedMailboxControllerBadgeCountDidChange");
...
- (BOOL)hasFavoriteMailboxes
{
  ...
  unsigned __int8 v4 = [v3 ef_any:&stru_100607010];
...
- (id)orderedFavoriteMailboxesForAccount:(id)a3 includeUnifiedMailboxes:(BOOL)a4
{
  ...
  if (a4)
  {
    id v7 = [(FavoritesPersistence *)self mailboxesCollection];
    id v8 = [v7 visibleItems];
  }
  else
  {
    id v8 = sub_1000C0B44((uint64_t)self, 2);
  }
  long long v26 = 0u;
  long long v27 = 0u;
  long long v24 = 0u;
    ...
    do
    {
      for (unint64_t i = 0; i != v10; unint64_t i = (char *)i + 1)
      {
        ...
        if (objc_msgSend(v13, "type", v21) != (id)2)
        {
          ...
          v22[3] = &unk_100607038;
          id v23 = v6;
          long long v19 = [v18 ef_filter:v22];
    ...
    do
    {
      for (unint64_t i = 0; i != v6; unint64_t i = (char *)i + 1)
      {
        ...
        if (v9)
        {
          ...
          id v13 = +[NSNumber numberWithInteger:v12 + 1];
