...
- (void)invalidateVisibleItems
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEBUG)) {
    sub_100459BC0((uint64_t)self, v3);
  }
...
+ (OS_os_log)log
{
  ...
  block[1] = 3221225472;
  block[2] = sub_100009200;
  block[3] = &unk_1006044D8;
  block[4] = a1;
  if (qword_1006994D0 != -1) {
    dispatch_once(&qword_1006994D0, block);
  }
  v2 = (void *)qword_1006994C8;
...
{
  id v8 = a3;
  unsigned int v9 = [(FavoritesCollectionState *)self mutableItems];
  long long v10 = [v8 syncKey];
  id v11 = [(FavoritesCollectionState *)self itemWithSyncKey:v10];
...
LABEL_8:
  ...
  else
  {
    ...
    if (v12 != (id)0x7FFFFFFFFFFFFFFFLL)
    {
      long long v13 = [v9 objectAtIndexedSubscript:v12];
      goto LABEL_8;
    }
  }
...
- (FavoritesCollectionState)initWithType:(unint64_t)a3
{
  ...
  id v4 = [(FavoritesCollectionState *)&v12 init];
  if (v4)
  {
    ...
    id v7 = (NSArray *)objc_alloc_init((Class)NSMutableArray);
    expandedItems = v4->_expandedItems;
    v4->_expandedItems = v7;

    unsigned int v9 = (NSDictionary *)objc_alloc_init((Class)NSMutableDictionary);
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v8; i = (char *)i + 1)
      {
        ...
        id v11 = [*(id *)(*((void *)&v23 + 1) + 8 * i) dictionaryRepresentation];
        if (v11) {
          [v3 addObject:v11];
        }
      }
  ...
  if (v13)
  {
    ...
    do
    {
      for (j = 0; j != v13; j = (char *)j + 1)
      {
        ...
        long long v16 = [*(id *)(*((void *)&v19 + 1) + 8 * (void)j) dictionaryRepresentationRemovingSyncKeys];
        if (v16) {
          [v4 addObject:v16];
        }
      }
...
- (BOOL)addItem:(id)a3 ordered:(BOOL)a4
{
  BOOL v4 = a4;
  id v6 = a3;
  id v7 = [(FavoritesCollectionState *)self mutableItems];
...
- (BOOL)addExpandedItem:(id)a3
{
  ...
  if (v5)
  {
    ...
    id v7 = [(FavoritesCollectionState *)self mutableExpandedItemBySyncKey];
    ...
    {
      [v6 addObject:v4];
      long long v11 = [v4 syncKey];
      [v7 setObject:v4 forKeyedSubscript:v11];
    }
  }
  else
  {
    long long v12 = +[FavoritesCollectionState log];
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      id v14 = (id)objc_opt_class();
      long long v15 = [v4 ef_publicDescription];
      int v16 = 138412802;
      id v17 = v14;
      __int16 v18 = 2048;
      long long v19 = self;
...
- (id)addOrUpdateExpandedItem:(id)a3 didAdd:(BOOL *)a4 didReplace:(BOOL *)a5
{
  ...
  if (v9)
  {
    ...
    long long v11 = [(FavoritesCollectionState *)self mutableExpandedItemBySyncKey];
    long long v12 = [v8 syncKey];
    long long v13 = [(FavoritesCollectionState *)self expandedItemWithSyncKey:v12];
...
LABEL_15:
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
  {
    ...
    long long v22 = [v8 ef_publicDescription];
    int v23 = 138412802;
    id v24 = v21;
    __int16 v25 = 2048;
    long long v26 = self;
...
+ (id)displayOrder
{
  if (qword_1006994E0 != -1) {
    dispatch_once(&qword_1006994E0, &stru_100606B48);
  }
  v2 = (void *)qword_1006994D8;
...
{
  id v4 = a3;
  if (qword_1006994F0 != -1) {
    dispatch_once(&qword_1006994F0, &stru_100606B68);
  }
  ...
  if ([v5 count])
  {
    ...
    for (unint64_t i = 0; ; ++i)
    {
      ...
      if (([v9 isEqual:qword_1006994E8] & 1) == 0
...
{
  id v4 = a3;
  id v5 = [(FavoritesCollectionState *)self expandedItemBySyncKey];
...
- (id)removeExpandedItem:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      unsigned int v14 = [v4 ef_publicDescription];
      int v15 = 138412802;
      id v16 = v13;
      __int16 v17 = 2048;
      __int16 v18 = self;
...
- (NSArray)selectedItems
{
  ...
  {
    id v4 = [(FavoritesCollectionState *)self items];
    [v4 ef_filter:&stru_100606BD0];
    id v5 = (NSArray *)objc_claimAutoreleasedReturnValue();
    id v6 = self->_selectedItems;
...
- (void)setExpandedItems:(id)a3
{
  ...
  id v7 = +[NSDictionary dictionaryWithObjects:v8 forKeys:v6];
  [v5 setDictionary:v7];
}
...
- (unint64_t)countOfVisibleItems
{
  ...
  id v3 = [v2 ef_countObjectsPassingTest:&stru_100606BF0];
