...
+ (id)sharedInstance
{
  ...
  block[1] = 3221225472;
  block[2] = sub_100131A24;
  block[3] = &unk_1006044D8;
  block[4] = a1;
  if (qword_1006997C8 != -1) {
    dispatch_once(&qword_1006997C8, block);
  }
  v2 = (void *)qword_1006997C0;
  ...
  if (v12)
  {
    ...
    do
    {
      for (i = 0; i != v12; i = (char *)i + 1)
      {
        ...
        id v15 = [*(id *)(*((void *)&v16 + 1) + 8 * i) messageIDHash:(void)v16];
        if (v15) {
...
- (void)setLibrary:(id)a3
{
  ...
  if (self->_library != v5)
  {
    ...
    if (*p_library)
    {
      [v7 removeObserver:self name:MailMessageStoreMessageFlagsChanged object:nil];
    ...
    if (*p_library)
    {
      [v8 addObserver:self selector:@selector(_messagesFlagsChanged:) name:MailMessageStoreMessageFlagsChanged object:nil];
...
- (void)scanSummary:(id)a3 forMessage:(id)a4
{
  ...
  if (v8)
  {
    ...
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_1001326D0;
    block[3] = &unk_100609150;
    id v12 = v7;
...
- (void)_addAddressDetectorResult:(__DDResult *)a3 forMessage:(id)a4
{
  ...
  id v11 = [objc_opt_class() weightForMessage:v5 addressBook:[self addressBook] vipManager:v10];
  if (v11 && v7)
  {
    Class v12 = off_10068EC90();
    id v13 = off_10068EC98();
