...
+ (id)log
{
  ...
  block[1] = 3221225472;
  block[2] = sub_1001B559C;
  block[3] = &unk_1006044D8;
  block[4] = a1;
  if (qword_100699B88 != -1) {
    dispatch_once(&qword_100699B88, block);
  }
  v2 = (void *)qword_100699B80;
...
- (void)viewDidLoad
{
  ...
  id v13 = [v11 initWithFrame:v12 collectionViewLayout:CGRectZero.origin.x, CGRectZero.origin.y, CGRectZero.size.width, CGRectZero.size.height];
...
- (void)collectionView:(id)a3 didSelectItemAtIndexPath:(id)a4
{
  ...
  if ((v7 & 1) == 0)
  {
    ...
    id v15 = objc_msgSend(v14, "objectAtIndexedSubscript:", objc_msgSend(v27, "item"));
...
- (id)_contactViewControllerForAddress:(id)a3
{
  ...
  else
  {
    ...
    {
      v18 = [v4 stringValue];
      sub_10045CDE4(v18, (uint64_t)v6, buf, v17);
    }
