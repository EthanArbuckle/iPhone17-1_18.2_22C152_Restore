...
- (id)displayName
{
  ...
  switch(self->_type)
  {
    case 1uLL:
      ...
      uint64_t v4 = [v3 localizedStringForKey:@"VIP" value:&stru_100619928 table:@"Main"];
      goto LABEL_8;
    case 2uLL:
      v3 = +[NSBundle bundleForClass:objc_opt_class()];
      uint64_t v4 = [v3 localizedStringForKey:@"FLAGGED" value:&stru_100619928 table:@"Main"];
      goto LABEL_8;
    case 3uLL:
      v3 = +[NSBundle bundleForClass:objc_opt_class()];
      uint64_t v4 = [v3 localizedStringForKey:@"UNREAD" value:&stru_100619928 table:@"Main"];
      goto LABEL_8;
    case 4uLL:
      v3 = +[NSBundle bundleForClass:objc_opt_class()];
      uint64_t v4 = [v3 localizedStringForKey:@"TO_OR_CC" value:&stru_100619928 table:@"Main"];
      goto LABEL_8;
    case 6uLL:
      v3 = +[NSBundle bundleForClass:objc_opt_class()];
      uint64_t v4 = [v3 localizedStringForKey:@"IMPORTANT_THREADS" value:&stru_100619928 table:@"Main"];
      goto LABEL_8;
    case 7uLL:
      v3 = +[NSBundle bundleForClass:objc_opt_class()];
      uint64_t v4 = [v3 localizedStringForKey:@"TODAY" value:&stru_100619928 table:@"Main"];
LABEL_8:
      v2 = (void *)v4;
...
- (id)_includesMeIconImage
{
  v2 = (void *)qword_100699BD8;
  if (!qword_100699BD8)
  {
    v3 = UIContentSizeCategoryLarge;
    id v4 = +[NSBundle bundleForClass:objc_opt_class()];
    double v5 = sub_1001363DC(2, v3, v4, 35.0);

    id v6 = +[NSBundle bundleForClass:objc_opt_class()];
    double v7 = sub_1001363DC(3, v3, v6, 35.0);
    ...
    v10 = sub_100135D98(2, v3, v8, v9, 0, v5);

    v11 = +[NSBundle bundleForClass:objc_opt_class()];
    v12 = +[UIColor systemGrayColor];
    v13 = sub_100135D98(3, v3, v11, v12, 0, v5);
    ...
    [v10 size];
    [v13 drawInRect:CGRectMake(0.0, y + v22 + 2.0, v18, v20)];
    uint64_t v23 = UIGraphicsGetImageFromCurrentImageContext();
    v24 = (void *)qword_100699BD8;
    qword_100699BD8 = v23;
