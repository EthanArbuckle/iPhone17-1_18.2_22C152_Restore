...
- (void)_setUpIndicatorViews
{
  ...
  v4 = (NSMutableArray *)[objc_alloc((Class)NSMutableArray) initWithCapacity:12];
...
- (id)_accessibilityIdentifierForTier:(unint64_t)a3
{
  v3 = &qword_1005A8040[a3];
  if (a3 >= 3) {
    v3 = (uint64_t *)((char *)&unk_1005A8058 + 8 * a3 - 24);
  }
  uint64_t v4 = *v3;
  if (v4)
  {
...
- (id)_createStatusIndicatorViews:(unint64_t)a3
{
  ...
  statusIndicatorViews = self->_statusIndicatorViews;
  if (!statusIndicatorViews || [(NSMutableArray *)statusIndicatorViews count] != (id)12) {
  ...
  if ([(MessageStatusIndicatorManager *)self effectiveIndicatorOptions])
  {
    ...
    if (v8)
    {
      v9 = (uint64_t *)((char *)&unk_1005A8058 + 8 * v7 - 24);
      v10 = &qword_1005A8040[v7];
      do
      {
        if (v7 >= 3) {
          v11 = v9;
    ...
    if (v20)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          [*(id *)(*((void *)&v30 + 1) + 8 * (void)v22) mf_setAlpha:0.0];
          v22 = (char *)v22 + 1;
        }
        while (v20 != v22);
        id v20 = [(NSMutableArray *)v19 countByEnumeratingWithState:&v30 objects:v34 count:16];
...
- (id)primaryStatusIndicatorImage
{
  ...
  do
  {
    uint64_t v4 = [(MessageStatusIndicatorManager *)self statusIndicatorImageWithOptionsMask:qword_1005A8040[v3]];
    if (v4) {
      BOOL v5 = 1;
    }
    else {
...
- (LayoutStatusIndicatorInfo)layoutStatusIndicatorViewsInRect:(SEL)a3 contentView:(CGRect)a4 verticalPositions:(id)a5 avatarVerticalPostions:(id)a6 horizontalPoint:(id)a7 shouldAlignWithCenter:(CGPoint)a8
{
  ...
  v22 = [(MessageListStatusIndicatorManager *)self verticalStatusIndicatorViews];
  id v23 = [v15 count];
  v24 = v52;
  if (v23) {
    v24 = v15;
  ...
  while (v27 < (unint64_t)objc_msgSend(v22, "count", *(void *)&v48.x, *(void *)&v48.y))
  {
    ...
    [v29 setFrame:CGRectMake(x + v36, MinY, v32, v34)];
    [v29 frame];
...
- (CGRect)_layoutHorizontalStatusIndicatorViewsInRect:(CGRect)a3 contentView:(id)a4 midX:(double)MidX pointY:(double)a6 shouldAlignWithCenter:(BOOL)a7
{
  ...
  if (pthread_main_np() != 1)
  {
    BOOL v49 = +[NSAssertionHandler currentHandler];
  ...
  unsigned int v16 = [v50 mf_prefersRightToLeftInterfaceLayout];
  ...
  id v56 = v18;
  double v58 = a6;
  double v19 = objc_retainBlock(v55);
  CGFloat v20 = x;
  CGFloat v21 = y;
  CGFloat v22 = width;
  CGFloat v23 = height;
  ...
  if (v26)
  {
    ...
    do
    {
      for (uint64_t i = 0; i != v26; uint64_t i = (char *)i + 1)
      {
        ...
        long long v30 = *(void **)(*((void *)&v51 + 1) + 8 * i);
        double v31 = [v30 image];
        [v31 size];
        double v33 = v32;
        double v35 = v34;
...
+ (id)log
{
  ...
  block[1] = 3221225472;
  block[2] = sub_10014A560;
  block[3] = &unk_1006044D8;
  block[4] = a1;
  if (qword_100699910 != -1) {
    dispatch_once(&qword_100699910, block);
  }
  v2 = (void *)qword_100699908;
...
{
  unint64_t result = 0;
  uint64_t v4 = &qword_1005A8040;
  for (uint64_t i = &qword_1005A8040; ; ++i)
  {
    id v6 = result >= 3 ? v4 : i;
    if ((*v6 & a3) != 0) {
      break;
