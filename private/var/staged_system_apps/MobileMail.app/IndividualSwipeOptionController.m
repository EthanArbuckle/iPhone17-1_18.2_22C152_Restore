...
- (id)itemsFromParent
{
  ...
  if (self->_showArchiveFooter)
  {
    ...
    v7 = [v6 localizedStringForKey:@"SWIPE_OPTIONS_ARCHIVE_INFO" value:&stru_100619928 table:@"Preferences"];
  ...
  if (v10 == (id)1) {
    [v11 localizedStringForKey:@"SWIPE_DIRECTION_LEFT" value:&stru_100619928 table:@"Preferences"];
  }
  else {
  v12 = [v11 localizedStringForKey:@"SWIPE_DIRECTION_RIGHT" value:&stru_100619928 table:@"Preferences"];
  }

  v13 = +[NSBundle bundleForClass:objc_opt_class()];
  v14 = [v13 localizedStringForKey:@"SWIPE_OPTIONS_INFO %@" value:&stru_100619928 table:@"Preferences"];
...
- (BOOL)_canSelectOptionAtIndex:(unint64_t)a3
{
  ...
  {
    id v10 = [(IndividualSwipeOptionController *)self specifier];
    v11 = [v10 values];
...
- (void)tableView:(id)a3 willDisplayCell:(id)a4 forRowAtIndexPath:(id)a5
{
  ...
  if (!v8)
  {
    ...
    v13 = +[NSBundle bundleForClass:objc_opt_class()];
    if (v12 == (id)1) {
      [v13 localizedStringForKey:@"SWIPE_RIGHT" value:&stru_100619928 table:@"Preferences"];
    }
    else {
    v14 = [v13 localizedStringForKey:@"SWIPE_LEFT" value:&stru_100619928 table:@"Preferences"];
    }
