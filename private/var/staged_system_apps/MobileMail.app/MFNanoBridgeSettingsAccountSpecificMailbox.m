  ...
  if (!mailboxUid)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) != 0 || ![v4 isActive])
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR)) {
        sub_10045D044((uint64_t)self->_accountUniqueIdentifier, (char)[v4 isActive], v21, v7);
      }
    }
    else
    {
        ...
        if (!self->_mailboxUid)
        {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR)) {
              sub_10045D0A0((uint64_t *)&self->_mailboxURL, v19);
            }
          }
        }
      }
