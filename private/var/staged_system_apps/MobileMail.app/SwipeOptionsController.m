...
- (BOOL)_shouldReverseLayoutDirection
{
  ...
  if (v2) {
    LOBYTE(v2) = [UIApp userInterfaceLayoutDirection] == (id)1;
  }
  return v2;
}
...
- (id)specifiers
{
  ...
  if (!v4)
  {
    ...
    double v7 = v6;
    if (v5) {
      [v6 localizedStringForKey:@"SWIPE_RIGHT" value:&stru_100619928 table:@"Preferences"];
    }
    else {
    double v8 = [v6 localizedStringForKey:@"SWIPE_LEFT" value:&stru_100619928 table:@"Preferences"];
    }
    ...
    [v9 setProperty:&off_10062AE78 forKey:@"kSwipeDirection"];
    if (v5) {
      uint64_t v10 = 2;
    }
    else {
    ...
    if (v5) {
      [v15 localizedStringForKey:@"SWIPE_LEFT" value:&stru_100619928 table:@"Preferences"];
    }
    else {
    v16 = [v15 localizedStringForKey:@"SWIPE_RIGHT" value:&stru_100619928 table:@"Preferences"];
    }
    ...
    [v17 setProperty:&off_10062AE90 forKey:@"kSwipeDirection"];
    if (v5) {
      uint64_t v18 = 1;
    }
    else {
...
- (id)leftSwipeAction:(id)a3
{
  uint64_t v3 = sub_10021CA04(LeftSwipeActionKey);
  v4 = v3;
  if (!v3) {
    uint64_t v3 = (void *)SwipeActionFlag;
  }
  id v5 = v3;
...
- (id)rightSwipeAction:(id)a3
{
  uint64_t v3 = sub_10021CA04(RightSwipeActionKey);
  v4 = v3;
  if (!v3) {
    uint64_t v3 = (void *)SwipeActionRead;
  }
  id v5 = v3;
...
{
  id v5 = a3;
  sub_10021CAA0(RightSwipeActionKey, (uint64_t)v5);
...
- (id)swipeActionsAndTitles
{
  ...
  if (!swipeActionsAndTitles)
  {
    ...
    v19 = [v20 localizedStringForKey:@"SWIPE_ACTIONS_NONE" value:&stru_100619928 table:@"Preferences"];
    v22[0] = v19;
    v21[1] = SwipeActionRead;
    long long v17 = +[NSBundle bundleForClass:objc_opt_class()];
    uint64_t v18 = [v17 localizedStringForKey:@"SWIPE_ACTIONS_READ" value:&stru_100619928 table:@"Preferences"];
    v22[1] = v18;
    v21[2] = SwipeActionFlag;
    long long v15 = +[NSBundle bundleForClass:objc_opt_class()];
    long long v16 = [v15 localizedStringForKey:@"SWIPE_ACTIONS_FLAG" value:&stru_100619928 table:@"Preferences"];
    v22[2] = v16;
    v21[3] = SwipeActionMove;
    id v4 = +[NSBundle bundleForClass:objc_opt_class()];
    id v5 = [v4 localizedStringForKey:@"SWIPE_ACTIONS_MOVE" value:&stru_100619928 table:@"Preferences"];
    v22[3] = v5;
    v21[4] = SwipeActionArchive;
    id v6 = +[NSBundle bundleForClass:objc_opt_class()];
    id v7 = [v6 localizedStringForKey:@"SWIPE_ACTIONS_ARCHIVE" value:&stru_100619928 table:@"Preferences"];
    v22[4] = v7;
    v21[5] = SwipeActionTrash;
    uint64_t v8 = +[NSBundle bundleForClass:objc_opt_class()];
    objc_super v9 = [v8 localizedStringForKey:@"SWIPE_ACTIONS_TRASH" value:&stru_100619928 table:@"Preferences"];
    v22[5] = v9;
    v21[6] = SwipeActionAlternateDestructiveAction;
    uint64_t v10 = +[NSBundle bundleForClass:objc_opt_class()];
    objc_super v11 = [v10 localizedStringForKey:@"SWIPE_ACTIONS_ARCHIVE" value:&stru_100619928 table:@"Preferences"];
    v22[6] = v11;
