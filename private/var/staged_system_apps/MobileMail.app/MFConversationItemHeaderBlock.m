...
+ (OS_os_log)log
{
  ...
  block[1] = 3221225472;
  block[2] = sub_100189528;
  block[3] = &unk_1006044D8;
  block[4] = a1;
  if (qword_100699A68 != -1) {
    dispatch_once(&qword_100699A68, block);
  }
  v2 = (void *)qword_100699A60;
...
- (MFConversationItemHeaderBlock)initWithFrame:(CGRect)a3 contactStore:(id)a4 accountsProvider:(id)a5
{
  ...
  if (v13)
  {
    ...
    byte_100699A70 = [v16 BOOLForKey:@"ShowMessageHeaderDetails"];

    v15->_showDetails = byte_100699A70;
...
{
  v52.receiver = self;
  v52.super_class = (Class)MFConversationItemHeaderBlock;
  [(MFConversationItemHeaderBlock *)&v52 createPrimaryViews];
  ...
  v16 = [v15 localizedStringForKey:@"FROM_HEADER" value:&stru_100619928 table:@"Main"];
  v17 = +[NSBundle mainBundle];
  v18 = [v17 localizedStringForKey:@"FROM_TITLE" value:&stru_100619928 table:@"Main"];
  ...
  {
    v49 = [(MFConversationItemHeaderBlock *)self delegate];
    v50 = [v49 popoverManagerForForConversationItemHeader:self];

    v51 = [(MFConversationItemHeaderBlock *)self primaryAtomList];
    [v50 addPassthroughViewProvider:v51];
  }
...
- (void)initializePrimaryLayoutConstraints
{
  ...
  objc_super v52 = [(MFConversationItemHeaderBlock *)self timestampLabel];
...
- (void)updateConstraints
{
  ...
  else
  {
    ...
    if (v18)
    {
      ...
      objc_super v52 = objc_msgSend(v56, "constraintEqualToAnchor:constant:", -7.0);
      v58[0] = v52;
      v55 = [v19 widthAnchor];
...
- (void)_showMessageInfo
{
  ...
  id v44 = sub_10018E4B4;
  unsigned int v45 = sub_10018E4C4;
  id v46 = 0;
  if (_os_feature_enabled_impl())
  {
    ...
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_10018E724;
    block[3] = &unk_10060B3C8;
    id v20 = WeakRetained;
    CGFloat v21 = self;
    CGFloat v22 = &v41;
    double v23 = v39;
