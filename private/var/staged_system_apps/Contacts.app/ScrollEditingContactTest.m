...
- (BOOL)prepareForTestWithOptions:(id)a3
{
  id v4 = a3;
  v32.receiver = self;
  v32.super_class = (Class)ScrollEditingContactTest;
  ...
  if (v5)
  {
    ...
    if (v10)
    {
      ...
      v13 = [(ScrollEditingContactTest *)self navControllerDelegate];
      [v10 setDelegate:v13];
...
- (void)prepareForNextTest
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)ScrollEditingContactTest;
...
- (void)resetDelegate
{
  ...
  if (v9 == v4)
  {
    v6 = [(ScrollEditingContactTest *)self navControllerDelegate];
    v7 = [v6 delegate];
