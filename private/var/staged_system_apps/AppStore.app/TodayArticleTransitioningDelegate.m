...
- (id)presentationControllerForPresentedViewController:(id)a3 presentingViewController:(id)a4 sourceViewController:(id)a5
{
  ...
  id v10 = a5;
  v11 = self;
  id v12 = sub_1007960E4(v8, a4, v10);
...
- (_TtC8AppStore33TodayArticleTransitioningDelegate)init
{
  *(void *)&self->presentedViewController[OBJC_IVAR____TtC8AppStore33TodayArticleTransitioningDelegate_presentedViewController] = 0;
  swift_unknownObjectWeakInit();
  *(void *)&self->presentedViewController[OBJC_IVAR____TtC8AppStore33TodayArticleTransitioningDelegate_presentingViewController] = 0;
  swift_unknownObjectWeakInit();
  v3 = (char *)self + OBJC_IVAR____TtC8AppStore33TodayArticleTransitioningDelegate_selectedIndexPath;
