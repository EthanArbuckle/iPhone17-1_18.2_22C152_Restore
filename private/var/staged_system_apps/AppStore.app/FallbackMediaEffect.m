...
{
  v6.receiver = a1;
  v6.super_class = (Class)&OBJC_METACLASS___FallbackMediaEffect;
  v4 = [super effectWithStyle:2];
  [v4 setBrightness:a3];
...
{
  v6.receiver = self;
  v6.super_class = (Class)FallbackMediaEffect;
  v3 = [(FallbackMediaEffect *)&v6 effectSettings];
  unint64_t v4 = [(FallbackMediaEffect *)self brightness];
  switch(v4)
  {
    case 2uLL:
...
- (void)applyLowLumaSettingsToSettings:(id)a3
{
  ...
  if (v5 == (id)10 || IsReduceTransparencyEnabled)
  {
    ...
    if (IsReduceTransparencyEnabled)
    {
      ...
      v11 = +[UIColor colorWithRed:0.22745098 green:0.247058824 blue:0.254901961 alpha:1.0];
      }
  ...
  else
  {
    ...
    [v12 setGrayscaleTintMaskAlpha:1.0];
    [v12 setGrayscaleTintMaskImage:0];
    objc_super v6 = +[UIColor colorWithRed:0.588235294 green:0.588235294 blue:0.588235294 alpha:1.0];
    [v12 setColorTint:v6];
...
- (void)applyMediumLumaSettingsToSettings:(id)a3
{
  id v11 = a3;
  BOOL IsReduceTransparencyEnabled = UIAccessibilityIsReduceTransparencyEnabled();
  if ([v11 graphicsQuality] == (id)10 || IsReduceTransparencyEnabled)
  {
    ...
    if (IsReduceTransparencyEnabled)
    {
      ...
      v10 = +[UIColor colorWithRed:0.749019608 green:0.768627451 blue:0.776470588 alpha:1.0];
      }
  ...
  else if ([v11 graphicsQuality] == (id)100)
  {
    [v11 setRequiresColorStatistics:0];
    ...
    [v11 setGrayscaleTintMaskAlpha:1.0];
    [v11 setGrayscaleTintMaskImage:0];
    id v5 = +[UIColor colorWithRed:0.882352941 green:0.882352941 blue:0.882352941 alpha:1.0];
    [v11 setColorTint:v5];
...
- (void)applyHighLumaSettingsToSettings:(id)a3
{
  ...
  if ([v11 graphicsQuality] == (id)10 || IsReduceTransparencyEnabled)
  {
    ...
    if (IsReduceTransparencyEnabled)
    {
      ...
      v10 = +[UIColor colorWithRed:0.247058824 green:0.266666667 blue:0.274509804 alpha:1.0];
      }
      [v11 setColorTint:v10];
  ...
  else if ([v11 graphicsQuality] == (id)100)
  {
    ...
    [v11 setGrayscaleTintMaskAlpha:1.0];
    [v11 setGrayscaleTintMaskImage:0];
    id v5 = +[UIColor colorWithRed:0.117647059 green:0.117647059 blue:0.117647059 alpha:1.0];
    [v11 setColorTint:v5];
