...
- (_TtC8AppStore16SearchController)initWithCoder:(id)a3;
...
{
  id v4 = a3;
  v5 = (_TtC8AppStore16SearchController *)sub_100010A10((uint64_t)a3);
...
- (void)searchBarCancelButtonClicked:(id)a3
{
  id v4 = *(Class *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC8AppStore16SearchController_filterButton);
  id v5 = a3;
  v12 = self;
  [v4 setEnabled:0];
...
- (void)_searchBarWillLayoutSubviews:(id)a3 inSearchFieldContainer:(id)a4 searchTextFieldFrame:(CGRect)a5 cancelButtonFrame:(CGRect)a6
{
  ...
  id v17 = a4;
  v18 = self;
  sub_1003D0A74(a4, v13, v12, v11, v10, x, y, width, height);
}

- (NSArray)keyCommands
{
  objc_super v2 = self;
  unint64_t v3 = sub_1003CFE84();
...
- (_TtC8AppStore16SearchController)initWithNibName:(id)a3 bundle:(id)a4
{
  ...
  id v8 = a4;
  return (_TtC8AppStore16SearchController *)sub_1003D0088(v5, v7, a4);
}

- (_TtC8AppStore16SearchController)initWithCoder:(id)a3
{
  return (_TtC8AppStore16SearchController *)sub_1003D0210(a3);
}

- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore16SearchController_searchTextInput));
  objc_release(*(id *)((char *)&self->super.super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore16SearchController____lazy_storage____searchBar));
  sub_10006012C(*(uint64_t *)((char *)&self->super.super.super.super.isa
                           + OBJC_IVAR____TtC8AppStore16SearchController_filterButtonHandler));
  unint64_t v3 = *(Class *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC8AppStore16SearchController_filterButton);
}
