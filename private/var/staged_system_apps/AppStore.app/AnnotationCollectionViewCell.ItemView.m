...
- (_TtCC8AppStore28AnnotationCollectionViewCell8ItemView)initWithFrame:(CGRect)a3
{
  return (_TtCC8AppStore28AnnotationCollectionViewCell8ItemView *)sub_1001C8904(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtCC8AppStore28AnnotationCollectionViewCell8ItemView)initWithCoder:(id)a3
{
  ...
  *((unsigned char *)&self->super.super.super.isa + OBJC_IVAR____TtCC8AppStore28AnnotationCollectionViewCell8ItemView_isLastItem) = 0;
  id v4 = a3;

  result = (_TtCC8AppStore28AnnotationCollectionViewCell8ItemView *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
- (void)layoutSubviews
{
  ...
  uint64_t v4 = type metadata accessor for LayoutRect();
  uint64_t v5 = *(void *)(v4 - 8);
  __chkstk_darwin(v4);
  v7 = (char *)&v13 - ((v6 + 15) & 0xFFFFFFFFFFFFFFF0);
  uint64_t v8 = type metadata accessor for ProductAnnotationLayout.ItemLayout();
...
- (JUMeasurements)measurementsWithFitting:(CGSize)a3 in:(id)a4
{
  uint64_t v5 = type metadata accessor for ProductAnnotationLayout.ItemLayout();
