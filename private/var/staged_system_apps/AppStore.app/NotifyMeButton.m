...
- (_TtC8AppStore14NotifyMeButton)init
{
  return (_TtC8AppStore14NotifyMeButton *)sub_1004D3184();
}

- (_TtC8AppStore14NotifyMeButton)initWithCoder:(id)a3
{
  *((unsigned char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC8AppStore14NotifyMeButton_style) = 0;
  *((unsigned char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC8AppStore14NotifyMeButton_isActive) = 0;
  *(Class *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC8AppStore14NotifyMeButton_bellMicaPlayer) = 0;
  id v4 = a3;

  result = (_TtC8AppStore14NotifyMeButton *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
- (_TtC8AppStore14NotifyMeButton)initWithFrame:(CGRect)a3
{
  CGSize result = (_TtC8AppStore14NotifyMeButton *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  objc_super v3 = *(Class *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC8AppStore14NotifyMeButton_bellMicaPlayer);
}
