...
- (_TtC8AppStore16ArcadeHeaderView)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore16ArcadeHeaderView *)sub_100293810(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)preferredContentSizeCategoryDidChange
{
  v2 = *(Class *)((char *)&self->super.super.super.super.super.isa
                + OBJC_IVAR____TtC8AppStore15TitleHeaderView_titleLabel);
  v3 = self;
...
- (void).cxx_destruct
{
  ...
  uint64_t v4 = type metadata accessor for TitleEffect();
