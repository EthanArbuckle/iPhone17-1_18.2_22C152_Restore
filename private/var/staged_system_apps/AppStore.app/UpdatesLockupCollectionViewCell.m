...
- (_TtC8AppStore31UpdatesLockupCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore31UpdatesLockupCollectionViewCell *)sub_10061CF88(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  id v5 = self;
  double v6 = sub_10061E7AC(width, height);
  double v8 = v7;
...
- (void).cxx_destruct
{
  ...
  sub_100082BCC((uint64_t)self + OBJC_IVAR____TtC8AppStore31UpdatesLockupCollectionViewCell_fetchingArtworkTemplate, &qword_1009840F0);
}
