...
- (_TtC8AppStore33PresentationContextViewController)initWithCoder:(id)a3
{
  ...
  *((unsigned char *)&self->super.super.super.isa
  ...
  result = (_TtC8AppStore33PresentationContextViewController *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
- (void)dismissViewControllerWithTransition:(int)a3 completion:(id)a4
{
  ...
  v8 = self;
  sub_1000B85B4(v4, (uint64_t)v6, v7);
  sub_10006012C((uint64_t)v6);
}

- (_TtC8AppStore33PresentationContextViewController)initWithNibName:(id)a3 bundle:(id)a4
{
  id v4 = a4;
  result = (_TtC8AppStore33PresentationContextViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
