...
{
  v2 = self;
  sub_100296B70((SEL *)&selRef_as_viewWillBecomeFullyVisible, (unsigned int *)&enum case for StoreViewControllerLifecycleEvent.willAppear(_:));
}
...
{
  v2 = self;
  sub_100296B70((SEL *)&selRef_as_viewDidBecomeFullyVisible, (unsigned int *)&enum case for StoreViewControllerLifecycleEvent.didAppear(_:));
}
...
{
  v2 = self;
  sub_100296B70((SEL *)&selRef_as_viewDidBecomePartiallyVisible, (unsigned int *)&enum case for StoreViewControllerLifecycleEvent.didDisappear(_:));
}
...
{
  id v4 = a4;
  result = (_TtC8AppStore38InAppPurchaseInstallPageViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  sub_100092F18((uint64_t)self + OBJC_IVAR____TtC8AppStore38InAppPurchaseInstallPageViewController_delegate);
  swift_release();
  swift_release();
  swift_release();
  ...
  sub_100082BCC((uint64_t)self + OBJC_IVAR____TtC8AppStore38InAppPurchaseInstallPageViewController_appAdamId, &qword_1009845E0);
  swift_release();
  sub_100082BCC((uint64_t)self + OBJC_IVAR____TtC8AppStore38InAppPurchaseInstallPageViewController_lifecycleObserver, (uint64_t *)&unk_100982B20);
