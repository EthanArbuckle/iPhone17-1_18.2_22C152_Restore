...
- (_TtC8AppStore35TodayCardMarketingLockupOverlayView)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore35TodayCardMarketingLockupOverlayView *)sub_100352550(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void).cxx_destruct
{
  ...
  sub_10006012C(*(uint64_t *)((char *)&self->super.super.super.super.isa
                           + OBJC_IVAR____TtC8AppStore35TodayCardMarketingLockupOverlayView_impressionsUpdateBlock));
...
- (void)animationDidStart:(id)a3
{
  uint64_t v4 = OBJC_IVAR____TtC8AppStore35TodayCardMarketingLockupOverlayView_lockupView;
...
- (void)_setContinuousCornerRadius:(double)a3
{
  ...
  [*(id *)&v4[OBJC_IVAR____TtC8AppStore35TodayCardMarketingLockupOverlayView_materialBackground] _setCornerRadius:1 continuous:12 maskedCorners:a3];
}
...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  id v6 = *(id *)&v5[OBJC_IVAR____TtC8AppStore35TodayCardMarketingLockupOverlayView_lockupView];
