...
- (_TtC8AppStore38AppEventSearchResultCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore38AppEventSearchResultCollectionViewCell *)sub_10078113C(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
