...
- (_TtC8AppStore32ProductRatingsCollectionViewCell)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa
  ...
  result = (_TtC8AppStore32ProductRatingsCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  v5 = self;
  double v6 = sub_100547710(width, height);
  double v8 = v7;
...
- (void).cxx_destruct
{
  sub_1000A1D30((uint64_t)self + OBJC_IVAR____TtC8AppStore32ProductRatingsCollectionViewCell_itemLayoutContext);
