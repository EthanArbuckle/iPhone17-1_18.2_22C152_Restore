...
- (CGSize)pageContainerSize
{
  [*(id *)((char *)&self->super.isa+ OBJC_IVAR____TtC8AppStoreP33_CF26EB3C1E0829881961C198130D7D1F36UpsellBreakoutSizingTraitEnvironment_pageTraits) pageContainerSize];
  result.height = v3;
  result.width = v2;
  return result;
}
...
- (UIEdgeInsets)pageMarginInsets
{
  [*(id *)((char *)&self->super.isa+ OBJC_IVAR____TtC8AppStoreP33_CF26EB3C1E0829881961C198130D7D1F36UpsellBreakoutSizingTraitEnvironment_pageTraits) pageMarginInsets];
  result.right = v5;
  result.bottom = v4;
  result.left = v3;
  result.top = v2;
...
- (_TtP8AppStore20PageTraitEnvironment_)snapshotPageTraitEnvironment
{
  ...
  return (_TtP8AppStore20PageTraitEnvironment_ *)v2;
}

- (_TtC8AppStoreP33_CF26EB3C1E0829881961C198130D7D1F36UpsellBreakoutSizingTraitEnvironment)init
{
  UIEdgeInsets result = (_TtC8AppStoreP33_CF26EB3C1E0829881961C198130D7D1F36UpsellBreakoutSizingTraitEnvironment *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
