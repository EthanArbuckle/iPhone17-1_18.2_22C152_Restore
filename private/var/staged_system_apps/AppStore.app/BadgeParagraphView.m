...
- (_TtC8AppStore18BadgeParagraphView)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore18BadgeParagraphView *)sub_100545CE4(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC8AppStore18BadgeParagraphView)initWithCoder:(id)a3
{
  result = (_TtC8AppStore18BadgeParagraphView *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  double v10 = sub_100547160(v8, width);
  double v12 = v11;
...
- (void).cxx_destruct
{
  objc_release(*(id *)((char *)&self->super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore18BadgeParagraphView_paragraphLabel));
  v3 = (char *)self + OBJC_IVAR____TtC8AppStore18BadgeParagraphView_metrics;

  sub_100547388((uint64_t)v3);
}
