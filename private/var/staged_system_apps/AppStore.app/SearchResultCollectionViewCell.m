...
- (_TtC8AppStore30SearchResultCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore30SearchResultCollectionViewCell *)sub_10016A8D4(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC8AppStore30SearchResultCollectionViewCell)initWithCoder:(id)a3
{
  ...
  result = (_TtC8AppStore30SearchResultCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  sub_100082BCC((uint64_t)self + OBJC_IVAR____TtC8AppStore30SearchResultCollectionViewCell_itemLayoutContext, &qword_100984EA0);
