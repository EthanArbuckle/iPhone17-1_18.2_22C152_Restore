...
- (id)activityViewController:(id)a3 itemForActivityType:(id)a4
{
  ...
  uint64_t v14 = *(uint64_t *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC8AppStore24TextActivityItemProvider_text);
  uint64_t v13 = *(void *)&self->text[OBJC_IVAR____TtC8AppStore24TextActivityItemProvider_text];
  v21[3] = &type metadata for String;
  v21[0] = v14;
  v21[1] = v13;
  swift_bridgeObjectRetain();

  v15 = sub_100081D90(v21, (uint64_t)&type metadata for String);
...
- (_TtC8AppStore24TextActivityItemProvider)initWithPlaceholderItem:(id)a3
{
  ...
  result = (_TtC8AppStore24TextActivityItemProvider *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
