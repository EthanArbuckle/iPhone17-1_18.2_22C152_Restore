...
- (ASToastViewController)initWithTitle:(id)a3 message:(id)a4 duration:(double)a5 image:(id)a6
{
  ...
  if (v13)
  {
    ...
    v22 = [objc_alloc((Class)UIImageView) initWithFrame:CGRectZero.origin.x, y, width, height];
...
- (void)viewDidLoad
{
  ...
  [v18 addAttribute:NSParagraphStyleAttributeName value:v21 range:0, [v18 length]];
