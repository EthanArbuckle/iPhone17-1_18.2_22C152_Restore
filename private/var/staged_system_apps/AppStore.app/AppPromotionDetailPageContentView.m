...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  v5 = self;
  CGFloat v6 = sub_100719414(width, height);
  double v8 = v7;
...
- (_TtC8AppStore33AppPromotionDetailPageContentView)initWithFrame:(CGRect)a3
{
  CGSize result = (_TtC8AppStore33AppPromotionDetailPageContentView *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  id v3 = (char *)self + OBJC_IVAR____TtC8AppStore33AppPromotionDetailPageContentView_mediaOverlayStyle;
