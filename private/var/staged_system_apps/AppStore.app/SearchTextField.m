...
- (_TtC8AppStore15SearchTextField)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore15SearchTextField *)sub_1005E10B0(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
{
  v2 = self;
  unsigned __int8 v3 = sub_1005E2020();
...
- (BOOL)gestureRecognizerShouldBegin:(id)a3
{
  id v4 = a3;
  v5 = self;
  LOBYTE(self) = sub_1005E229C((uint64_t)v4);
