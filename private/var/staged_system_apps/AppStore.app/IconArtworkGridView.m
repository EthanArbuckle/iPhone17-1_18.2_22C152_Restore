...
- (_TtC8AppStore19IconArtworkGridView)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore19IconArtworkGridView *)sub_10010FDC4(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void).cxx_destruct
{
  ...
  sub_1001128F4((uint64_t)self + OBJC_IVAR____TtC8AppStore19IconArtworkGridView_layoutMetrics);
  double v3 = (char *)self + OBJC_IVAR____TtC8AppStore19IconArtworkGridView_config;

  sub_1001129D8((uint64_t)v3);
}
