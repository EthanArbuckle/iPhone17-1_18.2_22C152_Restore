...
- (_TtC8AppStore25LoadingPageViewController)initWithCoder:(id)a3
{
  ...
  *((unsigned char *)&self->super.super.super.isa + OBJC_IVAR____TtC8AppStore25LoadingPageViewController_startedAsFlowPreview) = 0;
  id v4 = a3;

  result = (_TtC8AppStore25LoadingPageViewController *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
{
  id v4 = a4;
  result = (_TtC8AppStore25LoadingPageViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
