...
- (_TtC8AppStore18UpsellBreakoutView)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore18UpsellBreakoutView *)sub_10069F594(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  uint64_t v6 = type metadata accessor for BreakoutDetails.TextAlignment();
  ...
  uint64_t v14 = BreakoutDetails.TextAlignment.textAlignment(in:)();
...
- (void).cxx_destruct
{
  ...
  id v3 = (char *)self + OBJC_IVAR____TtC8AppStore18UpsellBreakoutView_buttonDetailsTextAlignment;
  uint64_t v4 = type metadata accessor for BreakoutDetails.TextAlignment();
