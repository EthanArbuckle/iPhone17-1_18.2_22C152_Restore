...
- (_TtC8AppStore21ArcadeWelcomeItemView)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore21ArcadeWelcomeItemView *)sub_10053FE7C(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC8AppStore21ArcadeWelcomeItemView)initWithCoder:(id)a3
{
  ...
  *((unsigned char *)&self->super.super.super.isa + OBJC_IVAR____TtC8AppStore21ArcadeWelcomeItemView_shouldUpdateArtwork) = 0;
  id v4 = a3;

  result = (_TtC8AppStore21ArcadeWelcomeItemView *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
- (void)setFrame:(CGRect)a3
{
  ...
  v7 = self;
  sub_10054033C(x, y, width, height);
}
...
- (JUMeasurements)measurementsWithFitting:(CGSize)a3 in:(id)a4
{
  ...
  v8 = self;
  double v9 = sub_100540C0C((uint64_t)a4, width, height);
  double v11 = v10;
  double v13 = v12;
  double v15 = v14;
