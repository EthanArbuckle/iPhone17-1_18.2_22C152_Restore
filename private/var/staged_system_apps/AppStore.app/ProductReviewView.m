...
- (_TtC8AppStore17ProductReviewView)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore17ProductReviewView *)sub_1006B8270(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC8AppStore17ProductReviewView)initWithCoder:(id)a3
{
  id v3 = a3;
  return (_TtC8AppStore17ProductReviewView *)sub_1006BC710();
}
...
- (void).cxx_destruct
{
  ...
  sub_10006012C(*(uint64_t *)((char *)&self->super.super.super.isa
                           + OBJC_IVAR____TtC8AppStore17ProductReviewView_moreReviewTapHandler));
  sub_10006012C(*(uint64_t *)((char *)&self->super.super.super.isa
                           + OBJC_IVAR____TtC8AppStore17ProductReviewView_moreResponseTapHandler));
  objc_release(*(id *)((char *)&self->super.super.super.isa
  ...
  uint64_t v3 = *(uint64_t *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC8AppStore17ProductReviewView_actionHandler);
