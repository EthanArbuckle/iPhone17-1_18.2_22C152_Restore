...
- (_TtC8AppStore23StorefrontAgeRatingView)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore23StorefrontAgeRatingView *)sub_1005685F0(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC8AppStore23StorefrontAgeRatingView)initWithCoder:(id)a3
{
  uint64_t v5 = OBJC_IVAR____TtC8AppStore23StorefrontAgeRatingView_label;
  id v6 = objc_allocWithZone((Class)UILabel);
  id v7 = a3;
  *(Class *)((char *)&self->super.super.super.isa + v5) = (Class)[v6 init];
  uint64_t v8 = OBJC_IVAR____TtC8AppStore23StorefrontAgeRatingView_fontMetrics;
  *(Class *)((char *)&self->super.super.super.isa + v8) = (Class)[objc_allocWithZone((Class)UIFontMetrics) initForTextStyle:UIFontTextStyleSubheadline];
  ...
  result = (_TtC8AppStore23StorefrontAgeRatingView *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  double v3 = *(Class *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC8AppStore23StorefrontAgeRatingView_fontMetrics);
}
