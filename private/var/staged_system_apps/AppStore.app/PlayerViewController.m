...
- (_TtC8AppStore20PlayerViewController)initWithCoder:(id)a3;
- (_TtC8AppStore20PlayerViewController)initWithNibName:(id)a3 bundle:(id)a4;
- (_TtC8AppStore20PlayerViewController)initWithPlayerLayerView:(id)a3;
- (void)dealloc;
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  if (*((unsigned char *)v4 + OBJC_IVAR____TtC8AppStore20PlayerViewController_autoplay) == 1)
  {
    id v5 = [v4 player];
    [v5 play];
...
- (void)playerItemDidPlayToEndWithNotification:(id)a3
{
  ...
  if (*((unsigned char *)&self->super.super.super.super.isa
       + OBJC_IVAR____TtC8AppStore20PlayerViewController_shouldDismissWhenPlaysToEnd) == 1)
...
{
  if (*((unsigned char *)&self->super.super.super.super.isa
       + OBJC_IVAR____TtC8AppStore20PlayerViewController_alwaysShowDoneButton) == 1)
  {
...
- (_TtC8AppStore20PlayerViewController)initWithNibName:(id)a3 bundle:(id)a4
{
  if (a3)
  {
    ...
    *((unsigned char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC8AppStore20PlayerViewController_autoplay) = 0;
    *((unsigned char *)&self->super.super.super.super.isa
    + OBJC_IVAR____TtC8AppStore20PlayerViewController_shouldDismissWhenPlaysToEnd) = 1;
    *((unsigned char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC8AppStore20PlayerViewController_alwaysShowDoneButton) = 0;
    id v6 = a4;
