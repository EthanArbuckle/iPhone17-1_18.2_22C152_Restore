...
- (_TtC8AppStore37MaterialGradientSectionBackgroundView)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore37MaterialGradientSectionBackgroundView *)sub_1003C0C2C(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC8AppStore37MaterialGradientSectionBackgroundView)initWithCoder:(id)a3
{
  uint64_t v5 = OBJC_IVAR____TtC8AppStore37MaterialGradientSectionBackgroundView_gradientView;
  ...
  *(Class *)((char *)&self->super.super.super.super.isa + v5) = (Class)[v6 init];
  uint64_t v8 = OBJC_IVAR____TtC8AppStore37MaterialGradientSectionBackgroundView_materialView;
  *(Class *)((char *)&self->super.super.super.super.isa + v8) = (Class)[objc_allocWithZone((Class)UIVisualEffectView) init];

  result = (_TtC8AppStore37MaterialGradientSectionBackgroundView *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
- (void)layoutSubviews
{
  ...
  [v2 bounds];
  [v3 setFrame:];
  id v4 = *(id *)&v2[OBJC_IVAR____TtC8AppStore37MaterialGradientSectionBackgroundView_materialView];
  [v2 bounds];
  [v4 setFrame:];
}
