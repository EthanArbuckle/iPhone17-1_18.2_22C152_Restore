...
- (_TtC8AppStore34ProductTapToRateCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore34ProductTapToRateCollectionViewCell *)sub_100291D58(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC8AppStore34ProductTapToRateCollectionViewCell)initWithCoder:(id)a3
{
  uint64_t v5 = OBJC_IVAR____TtC8AppStore34ProductTapToRateCollectionViewCell_productTapToRateView;
  ...
  *(Class *)((char *)&self->super.super.super.super.super.isa + v5) = (Class)[v6 init];
  ...
  result = (_TtC8AppStore34ProductTapToRateCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
