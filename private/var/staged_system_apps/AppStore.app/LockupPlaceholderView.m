...
- (_TtC8AppStore21LockupPlaceholderView)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore21LockupPlaceholderView *)sub_1000A23E4(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (void).cxx_destruct
{
  ...
  id v3 = (char *)self + OBJC_IVAR____TtC8AppStore21LockupPlaceholderView_contentType;
