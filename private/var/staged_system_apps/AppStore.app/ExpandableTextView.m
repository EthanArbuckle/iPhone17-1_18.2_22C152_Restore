...
- (void)setBackgroundColor:(id)a3
{
  ...
  objc_super v6 = *(void **)&v5[OBJC_IVAR____TtC8AppStore18ExpandableTextView_textLabel];
...
- (void)tintColorDidChange
{
  ...
  double v3 = *(void **)&v2[OBJC_IVAR____TtC8AppStore18ExpandableTextView_moreButton];
  id v4 = [v2 tintColor];
...
- (JUMeasurements)measurementsWithFitting:(CGSize)a3 in:(id)a4
{
  ...
  [*(id *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC8AppStore18ExpandableTextView_textLabel) measurementsWithFitting:a4 in:a3.width, a3.height];
  double v8 = width;
  result.var3 = v7;
  result.var2 = v6;
  result.var1 = v5;
...
- (_TtC8AppStore18ExpandableTextView)initWithFrame:(CGRect)a3
{
  JUMeasurements result = (_TtC8AppStore18ExpandableTextView *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  uint64_t v3 = *(uint64_t *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC8AppStore18ExpandableTextView_moreTapHandler);
...
- (BOOL)hasContent
{
  return [*(id *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC8AppStore18ExpandableTextView_textLabel) hasContent];
}
