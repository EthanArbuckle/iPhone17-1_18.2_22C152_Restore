...
- (_TtC8AppStore39OnboardingLocationPrivacyViewController)initWithTitle:(id)a3 detailText:(id)a4 symbolName:(id)a5 contentLayout:(int64_t)a6
{
  result = (_TtC8AppStore39OnboardingLocationPrivacyViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  swift_release();
  swift_release();
  id v3 = *(void **)&self->OBWelcomeController_opaque[OBJC_IVAR____TtC8AppStore39OnboardingLocationPrivacyViewController_iconView];
}
