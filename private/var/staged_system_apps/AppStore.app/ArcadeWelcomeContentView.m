...
- (_TtC8AppStore24ArcadeWelcomeContentView)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore24ArcadeWelcomeContentView *)sub_100251814(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}

- (_TtC8AppStore24ArcadeWelcomeContentView)initWithCoder:(id)a3
{
  result = (_TtC8AppStore24ArcadeWelcomeContentView *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
