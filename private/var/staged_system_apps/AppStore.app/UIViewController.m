...
+ (void)as_activatePresentationHack
{
  ...
  block[1] = 3221225472;
  block[2] = sub_100014428;
  block[3] = &unk_1008B8D50;
  block[4] = a1;
  if (qword_1009AAAF0[0] != -1) {
    dispatch_once(qword_1009AAAF0, block);
  }
}
...
{
  id v13 = a3;
  double v4 = [v13 userInfo];
  double v5 = [v4 objectForKeyedSubscript:UIPresentationControllerDismissalTransitionDidEndCompletedKey];
...
- (id)as_viewControllersForVisibilityCallbackForwarding
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (v3)
    {
      double v4 = [(UIViewController *)self selectedViewController];
      id v9 = v4;
      double v5 = &v9;
LABEL_7:
...
LABEL_9:
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (v3)
    {
      double v4 = [(UIViewController *)self topViewController];
      uint64_t v8 = v4;
      double v5 = &v8;
      goto LABEL_7;
    }
  ...
  if (v3)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [*(id *)(*((void *)&v7 + 1) + 8 * (void)v6) as_viewWillBecomeFullyVisible];
  ...
  if (v3)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [*(id *)(*((void *)&v7 + 1) + 8 * (void)v6) as_viewDidBecomeFullyVisible];
        unsigned int v6 = (char *)v6 + 1;
      }
      while (v4 != v6);
      id v4 = [v2 countByEnumeratingWithState:&v7 objects:v11 count:16];
  ...
  if (v3)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [*(id *)(*((void *)&v7 + 1) + 8 * (void)v6) as_viewWillBecomePartiallyVisible];
        unsigned int v6 = (char *)v6 + 1;
      }
      while (v4 != v6);
      id v4 = [v2 countByEnumeratingWithState:&v7 objects:v11 count:16];
  ...
  if (v3)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [*(id *)(*((void *)&v7 + 1) + 8 * (void)v6) as_viewDidBecomePartiallyVisible];
        unsigned int v6 = (char *)v6 + 1;
      }
      while (v4 != v6);
      id v4 = [v2 countByEnumeratingWithState:&v7 objects:v11 count:16];
...
- (_TtP8AppStore20PageTraitEnvironment_)snapshotPageTraitEnvironment
{
  ...
  long long v8 = (objc_class *)type metadata accessor for SnapshotPageTraitEnvironment();
  long long v9 = (char *)objc_allocWithZone(v8);
  long long v10 = &v9[OBJC_IVAR____TtC8AppStore28SnapshotPageTraitEnvironment_pageContainerSize];
