...
- (_TtC8AppStore35PrivacyDefinitionCollectionViewCell)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore35PrivacyDefinitionCollectionViewCell *)sub_1000A18D8();
}
...
- (_TtC8AppStore35PrivacyDefinitionCollectionViewCell)initWithCoder:(id)a3
{
  ...
  result = (_TtC8AppStore35PrivacyDefinitionCollectionViewCell *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC8AppStore35PrivacyDefinitionCollectionViewCell_definitionLabel));
  v3 = (char *)self + OBJC_IVAR____TtC8AppStore35PrivacyDefinitionCollectionViewCell_itemLayoutContext;
