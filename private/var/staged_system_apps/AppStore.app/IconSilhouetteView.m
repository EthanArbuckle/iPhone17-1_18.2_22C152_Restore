...
- (_TtC8AppStore18IconSilhouetteView)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore18IconSilhouetteView *)sub_1002BBA68(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  (*(void (**)(char *, char *, uint64_t, __n128))(v5 + 16))(v8, (char *)self + OBJC_IVAR____TtC8AppStore18IconSilhouetteView_iconStyle, v4, v6);
  v10 = self;
...
- (void).cxx_destruct
{
  id v3 = (char *)self + OBJC_IVAR____TtC8AppStore18IconSilhouetteView_iconStyle;
  uint64_t v4 = type metadata accessor for Artwork.Style();
  (*(void (**)(char *, uint64_t))(*(void *)(v4 - 8) + 8))(v3, v4);
  uint64_t v5 = *(Class *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC8AppStore18IconSilhouetteView_titleLabel);
}
