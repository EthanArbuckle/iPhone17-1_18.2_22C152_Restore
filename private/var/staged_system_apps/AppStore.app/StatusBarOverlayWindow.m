...
- (_TtC8AppStoreP33_4C12C965B12FCBBF31BE3A1652C8D11F22StatusBarOverlayWindow)initWithContentRect:(CGRect)a3;
...
- (_TtC8AppStoreP33_4C12C965B12FCBBF31BE3A1652C8D11F22StatusBarOverlayWindow)initWithFrame:(CGRect)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.super.isa
           + OBJC_IVAR____TtC8AppStoreP33_4C12C965B12FCBBF31BE3A1652C8D11F22StatusBarOverlayWindow_interactionView) = 0;
  v11.receiver = self;
...
- (BOOL)pointInside:(CGPoint)a3 withEvent:(id)a4
{
  v4 = *(Class *)((char *)&self->super.super.super.super.isa
                + OBJC_IVAR____TtC8AppStoreP33_4C12C965B12FCBBF31BE3A1652C8D11F22StatusBarOverlayWindow_interactionView);
  if (!v4) {
    return 0;
  }
  double y = a3.y;
  ...
  unsigned __int8 v11 = [v10 pointInside:v8 withEvent:nil];
...
{
  id v3 = a3;
  result = (_TtC8AppStoreP33_4C12C965B12FCBBF31BE3A1652C8D11F22StatusBarOverlayWindow *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
