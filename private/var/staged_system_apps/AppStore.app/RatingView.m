...
- (_TtC8AppStore10RatingView)initWithCoder:(id)a3
{
  ...
  *(void *)v4 = 0;
  ...
  result = (_TtC8AppStore10RatingView *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  double v3 = *(Class *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC8AppStore10RatingView_filledStarRowView);
}
