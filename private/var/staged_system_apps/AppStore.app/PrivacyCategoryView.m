...
- (_TtC8AppStore19PrivacyCategoryView)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore19PrivacyCategoryView *)sub_1003BD8A8(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (_TtC8AppStore19PrivacyCategoryView)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC8AppStore19PrivacyCategoryView_category) = 0;
  ...
  result = (_TtC8AppStore19PrivacyCategoryView *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
- (JUMeasurements)measurementsWithFitting:(CGSize)a3 in:(id)a4
{
  ...
  v6 = self;
  double v7 = sub_1003BF058((uint64_t)a4);
  double v9 = v8;
  double v11 = v10;
  double v13 = v12;
