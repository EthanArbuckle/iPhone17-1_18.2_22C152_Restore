...
- (_TtC8AppStore33AppStoreVideoPlayerViewController)initWithCoder:(id)a3
{
  result = (_TtC8AppStore33AppStoreVideoPlayerViewController *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
{
  id v4 = a4;
  result = (_TtC8AppStore33AppStoreVideoPlayerViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
