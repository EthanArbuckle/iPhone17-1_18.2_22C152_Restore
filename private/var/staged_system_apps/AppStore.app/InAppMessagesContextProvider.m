...
- (id)contextPropertyWithName:(id)a3
{
  ...
  uint64_t v6 = v5;
  v7 = self;
  sub_1002F7780(v4, v6, (uint64_t)v16);

  swift_bridgeObjectRelease();
  uint64_t v8 = v17;
  if (v17)
  {
    v9 = sub_100081D90(v16, v17);
...
- (id)viewControllerForModalPresentation
{
  id v2 = *(Class *)((char *)&self->super.isa + OBJC_IVAR____TtC8AppStore28InAppMessagesContextProvider_rootViewController);
  if (v2) {
...
- (_TtC8AppStore28InAppMessagesContextProvider)init
{
  result = (_TtC8AppStore28InAppMessagesContextProvider *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  v3 = *(Class *)((char *)&self->super.isa + OBJC_IVAR____TtC8AppStore28InAppMessagesContextProvider_rootViewController);
}
