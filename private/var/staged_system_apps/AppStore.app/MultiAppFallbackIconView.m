...
- (_TtC8AppStore24MultiAppFallbackIconView)initWithFrame:(CGRect)a3
{
  return (_TtC8AppStore24MultiAppFallbackIconView *)sub_1001E9938(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  double v7 = sub_1001E9EE0(width, height);
  double v9 = v8;
...
- (void).cxx_destruct
{
  ...
  id v3 = (char *)self + OBJC_IVAR____TtC8AppStore24MultiAppFallbackIconView_iconReusePool;
