...
- (_TtC8AppStore25StoreNavigationController)initWithCoder:(id)a3
{
  result = (_TtC8AppStore25StoreNavigationController *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
- (_TtC8AppStore25StoreNavigationController)initWithNavigationBarClass:(Class)a3 toolbarClass:(Class)a4
{
  result = (_TtC8AppStore25StoreNavigationController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
