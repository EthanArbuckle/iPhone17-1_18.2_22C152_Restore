...
- (_TtC8AppStore28AlertActionTrailingImageView)initWithCoder:(id)a3;
- (_TtC8AppStore28AlertActionTrailingImageView)initWithFrame:(CGRect)a3;
- (void)layoutSubviews;
...
- (void)tintColorDidChange
{
  ...
  id v3 = *(void **)&v2[OBJC_IVAR____TtC8AppStore28AlertActionTrailingImageView_label];
  id v4 = [v2 tintColor];
  [v3 setTextColor:v4];
}
...
- (_TtC19AppStoreKitInternal16DynamicTypeLabel)accessibilityAlertActionLabel
{
  return (_TtC19AppStoreKitInternal16DynamicTypeLabel *)objc_retainAutoreleaseReturnValue(*(id *)((char *)&self->super.super.super.isa
                                                                                                + OBJC_IVAR____TtC8AppStore28AlertActionTrailingImageView_label));
}

- (_TtC8AppStore28AlertActionTrailingImageView)initWithFrame:(CGRect)a3
{
  CGSize result = (_TtC8AppStore28AlertActionTrailingImageView *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  double v3 = *(Class *)((char *)&self->super.super.super.isa
                + OBJC_IVAR____TtC8AppStore28AlertActionTrailingImageView_imageView);
}
