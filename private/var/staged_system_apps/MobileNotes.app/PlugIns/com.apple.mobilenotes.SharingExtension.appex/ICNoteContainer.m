...
- (void)undoablySetOrder:(unint64_t)a3 ofChild:(id)a4
{
  ...
  v15 = [v14 localizedStringForKey:@"Set Folder Order" value:&stru_1000F2510 table:0];
...
- (void)undoablyRemoveFromOrder:(id)a3
{
  ...
  v11 = [v10 localizedStringForKey:@"Remove Folder Order" value:&stru_1000F2510 table:0];
...
LABEL_10:
  ...
  id v13 = [objc_alloc((Class)NSMutableSet) initWithCapacity:[v12 count]];
  long long v42 = 0u;
  long long v43 = 0u;
  long long v44 = 0u;
  long long v45 = 0u;
