...
- (void)undoablySetFolder:(id)a3
{
  ...
  if ((v6 & 1) == 0)
  {
          ...
          ([v8 isTrashFolder] & 1) != 0))
    {
      ...
      v11 = [v10 localizedStringForKey:@"Trash Note" value:&stru_1000F2510 table:0];
    ...
    else
    {
      ...
      v11 = [v12 localizedStringForKey:@"Move Note" value:&stru_1000F2510 table:0];
    }
LABEL_8:
...
+ (id)undoablyDuplicateNotes:(id)a3
{
    ...
    && (+[ICNote containsUnduplicatableNotes:v3] & 1) == 0)
  {
    ...
    v7 = [v6 localizedStringForKey:@"Duplicate Notes" value:&stru_1000F2510 table:0];
...
- (id)undoablyDuplicate
{
  if ([(ICNote *)self isDuplicatable])
  {
    ...
    unsigned __int8 v9 = [v8 localizedStringForKey:@"Duplicate Note" value:&stru_1000F2510 table:0];
