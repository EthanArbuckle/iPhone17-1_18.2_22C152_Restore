...
+ (id)sharedManager
{
  if (qword_100105700 != -1) {
    dispatch_once(&qword_100105700, &stru_1000EEAF8);
  }
  v2 = (void *)qword_100105708;
...
- (id)mediaUTIs
{
  if (qword_100105718[0] != -1) {
    dispatch_once(qword_100105718, &stru_1000EEC58);
  }
  v2 = (void *)qword_100105710;
