...
- (void)undoablySetTitle:(id)a3
{
  ...
  v10 = [v9 localizedStringForKey:@"Set Folder Name" value:&stru_10063F3D8 table:0];
...
- (void)undoablySetParentFolder:(id)a3 moveAction:(id)a4
{
  ...
  v16 = [v15 localizedStringForKey:@"Move Folder" value:&stru_10063F3D8 table:0];
...
+ (void)undoablyMoveNotes:(id)a3 toFolder:(id)a4 isCopy:(BOOL)a5 noteMovedBlock:(id)a6
{
  ...
  id v13 = [v12 localizedStringForKey:@"Move %lu Notes" value:&stru_10063F3D8 table:0];
