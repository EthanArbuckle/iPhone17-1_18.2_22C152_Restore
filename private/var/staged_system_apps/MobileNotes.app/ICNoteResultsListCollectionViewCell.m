...
- (ICNoteResultsListCollectionViewCell)initWithFrame:(CGRect)a3
{
  ...
  v5 = v3;
  v6 = &OBJC_IVAR___ICDebuggingViewController__filteredSections;
  if (v3)
  {
    ...
    v41 = [objc_alloc((Class)UIImageView) initWithFrame:CGRectZero.origin.x, y, width, height];
    ...
    uint64_t v61 = [v116 constraintEqualToAnchor:v115];
  ...
  [*(id *)((char *)&v5->super.super.super.super.super.super.super.isa + v6[215]) setPriority:v4];
  return v5;
}
...
- (void)updateViewStateProperties
{
  ...
  -[ICNoteResultsListCollectionViewCell setIsInSplitView:](self, "setIsInSplitView:", [v7 _splitViewControllerContext] == (id)3);
...
- (void)updateBackgroundConfigurationUsingState:(id)a3
{
  ...
  if ([v7 cellDropState] == (id)2)
  {
    [v7 setCellDropState:1];
    [v7 setFocused:0];
  }
  ...
  id v6 = [v4 updatedConfigurationForState:v7];
  [(ICNoteResultsListCollectionViewCell *)self setBackgroundConfiguration:v6];
}
...
- (void)updateColorsUsingState:(id)a3
{
  ...
  if ([v4 cellDropState] == (id)2 || objc_msgSend(v4, "cellDropState") == (id)1)
  {
  ...
  if (v12)
  {
    ...
    {
      id v4 = [(ICNoteResultsListCollectionViewCell *)self window];
      [v4 tintColor];
    double v15 = };
    ...
    v47[1] = v19;
    v20 = +[NSDictionary dictionaryWithObjects:v47 forKeys:v46 count:2];
    v44[0] = NSFontAttributeName;
    uint64_t v21 = [(ICNoteResultsListCollectionViewCell *)self summaryLabel];
    v22 = [v21 font];
    v44[1] = NSForegroundColorAttributeName;
    v45[0] = v22;
    v23 = [(ICNoteResultsListCollectionViewCell *)self secondaryLabelColor];
    v45[1] = v23;
    uint64_t v24 = +[NSDictionary dictionaryWithObjects:v45 forKeys:v44 count:2];
...
- (void)enableIntrinsicSizeShortcut:(BOOL)a3
{
  ...
  id v7 = [(ICNoteResultsListCollectionViewCell *)self dateLabel];
  [v7 _setUseShortcutIntrinsicContentSize:v3];

  double v8 = [(ICNoteResultsListCollectionViewCell *)self participantsLabel];
...
LABEL_7:
    ...
    case 0:
      [(ICNoteResultsListCollectionViewCell *)self verticalPadding];
      double v6 = -v5;
      id v7 = [(ICNoteResultsListCollectionViewCell *)self verticalStackViewBottomConstraint];
      [v7 setConstant:v6];

      double v8 = [(ICNoteResultsListCollectionViewCell *)self verticalStackViewTrailingConstraint];
      [v8 setConstant:-12.0];
LABEL_8:
...
- (void)updateFromConfiguration
{
  ...
  double v8 = [(ICNoteResultsListCollectionViewCell *)self folderAndAccountLabel];
  ...
  id v43 = [(ICNoteResultsListCollectionViewCell *)self participantsLabel];
  [v43 setHidden:v13 ^ 1];
  ...
  if ([(ICNoteResultsListCollectionViewCell *)self isThumbnailPresent]
    ...
    && (id)[(ICNoteResultsListCollectionViewCell *)self currentThumbnailLocation] != (id)2
    || ![(ICNoteResultsListCollectionViewCell *)self isAXSize]
    && (id)[(ICNoteResultsListCollectionViewCell *)self currentThumbnailLocation] != (id)1)
  {
    if ([(ICNoteResultsListCollectionViewCell *)self isAXSize]
      && [(ICNoteResultsListCollectionViewCell *)self isThumbnailPresent])
    {
...
- (void)updateStatusIndicatorsUsingState:(id)a3
{
  ...
  double v8 = [v7 primaryStatusImage];
...
- (void)updateLabelsFromConfiguration
{
  ...
  if (v4)
  {
    ...
    if (v39)
    {
      ...
      id v43 = [(ICBaseNoteResultsCollectionViewCell *)self configuration];
      v44 = [v43 folderImage];
    ...
    double v49 = [(ICBaseNoteResultsCollectionViewCell *)self configuration];
    unsigned int v50 = [v49 searchResult];

    if (v50)
    {
      uint64_t v51 = [(ICNoteResultsListCollectionViewCell *)self superview];
      if (v51)
      {
        double v52 = (void *)v51;
        double v53 = +[UIApplication sharedApplication];
        unsigned int v54 = [v53 isRunningTest];

        if (v54)
        {
          id v55 = +[ICAppDelegate sharedInstance];
  ...
  else
  {
    ...
    if (v20)
    {
      ...
      id v55 = [(ICNoteResultsListCollectionViewCell *)self folderLabelImageView];
      [v55 setHidden:1];
LABEL_24:
    }
  }
  ...
  if ([(ICNoteResultsListCollectionViewCell *)self isThumbnailPresent])
  {
    ...
    if (v4)
    {
      ...
      if (v9)
      {
        ...
        id v24 = [v15 initForNoteListWithFoundAttachment:v14 preferredSize:v23 scale:v17 appearanceInfo:v19 v22];
      }
      else
      {
        if (+[UIDevice ic_isVision]) {
        ...
        [v62 scale];
        id v24 = [v57 initForNoteListWithNote:v23 preferredSize:v14 scale:v59 appearanceInfo:v61];
      }
    ...
    else
    {
      ...
      if (v29)
      {
        ...
        unsigned int v34 = [v33 ic_appearanceInfo];
        [(ICNoteResultsListCollectionViewCell *)self currentThumbnailSize];
        double v35 = [v32 thumbnailImageForAppearance:v34];
      ...
      else
      {
        ...
        double v49 = [(ICNoteResultsListCollectionViewCell *)self thumbnailImageView];
        [v49 setImage:v48];

        unsigned int v50 = [(ICNoteResultsListCollectionViewCell *)self thumbnailImageView];
        [v50 setContentMode:1];

        uint64_t v51 = +[UIColor clearColor];
