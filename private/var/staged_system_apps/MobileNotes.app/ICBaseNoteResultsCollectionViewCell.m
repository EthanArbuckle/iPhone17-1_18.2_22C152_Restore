...
- (void)setConfiguration:(id)a3 synchronously:(BOOL)a4
{
  ...
  objc_super v7 = [v9 note];
  objc_opt_class();
  v8 = ICClassAndProtocolCast();
  -[ICBaseNoteResultsCollectionViewCell ic_annotateWithNote:](self, "ic_annotateWithNote:", v8, &OBJC_PROTOCOL___ICSearchIndexableNote);

  if (([v9 isDataLoaded] & 1) == 0)
  {
    if (v4) {
...
- (void)updateViewStateProperties
{
  ...
  if (v7)
  {
    ...
    id v9 = [(ICBaseNoteResultsCollectionViewCell *)self folderAndAccountLabel];
    [v9 setFont:v8];
  }
...
- (void)updateConfigurationAttributes
{
  ...
  [v18 updateTitleLabelAttributes:v3, v4, v5, v7, v9, v11, v13, v14, v15, v16, v17];
}
