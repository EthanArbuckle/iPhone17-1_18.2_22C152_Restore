...
- (double)randomNegativeIntervalWithMinDays:(double)a3 maxDays:(double)a4;
...
- (double)randomNegativeIntervalWithMinDays:(double)a3 maxDays:(double)a4
{
  return -(a3 * 86400.0 + (double)arc4random() / 2147483650.0 * (a4 * 86400.0 - a3 * 86400.0));
}
...
- (id)importNoteFromFileAtURL:(id)a3
{
  ...
  id v23 = 0;
  id v24 = 0;
  id v5 = [objc_alloc((Class)NSAttributedString) initWithURL:v4 options:&__NSDictionary0__struct documentAttributes:&v24 error:&v23];
  id v6 = v24;
  id v7 = v23;
  if (v7)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR)) {
      sub_1004D56BC((uint64_t)v4, (uint64_t)v7, v8);
    }
    id v9 = 0;
  }
  else
  {
    ...
    id v9 = +[ICNote newEmptyNoteInFolder:v8];
    [v9 updateChangeCountWithReason:@"Imported test note"];
    id v11 = objc_alloc_init((Class)ICTextController);
    v12 = [v9 textStorage];
    [v12 setStyler:v11];

    v13 = [v9 textStorage];
    [v13 setConvertAttributes:1];

    v14 = [v9 textStorage];
    [v14 replaceCharactersInRange:0 withAttributedString:v5];

    v15 = [v9 textStorage];
    [v15 setConvertAttributes:0];

    v16 = [v9 textStorage];
    [v16 setStyler:0];

    [(ICNoteContext *)self randomNegativeIntervalWithMinDays:1.0 maxDays:60.0];
    v17 = +[NSDate dateWithTimeIntervalSinceNow:](NSDate, "dateWithTimeIntervalSinceNow:");
    [v9 setModificationDate:v17];

    [(ICNoteContext *)self randomNegativeIntervalWithMinDays:2.0 maxDays:30.0];
    double v19 = v18;
    v20 = [v9 modificationDate];
    v21 = +[NSDate dateWithTimeInterval:v20 sinceDate:v19];
...
+ (id)beginBackgroundTaskNamed:(id)a3
{
  ...
  id v11 = sub_1000EC470;
  v12 = &unk_100625AF0;
  id v13 = v3;
  id v5 = v3;
  id v6 = [v4 beginBackgroundTaskWithName:v5 expirationHandler:&v9];

  id v14 = v6;
  id v7 = +[NSValue value:withObjCType:](NSValue, "value:withObjCType:", &v14, "Q", v9, v10, v11, v12);
...
+ (void)endBackgroundTask:(id)a3
{
  UIBackgroundTaskIdentifier v4 = UIBackgroundTaskInvalid;
  [a3 getValue:&v4];
...
+ (void)importArchiveAtPath:(id)a3 intoAccount:(id)a4
{
  ...
  if (v8)
  {
    id v9 = +[NSURL fileURLWithPath:v5];
  }
  else
  {
    uint64_t v10 = +[NSBundle mainBundle];
    id v11 = +[ICArchive packageExtension];
    id v9 = [v10 URLForResource:v5 withExtension:v11];
  }
  v12 = +[ICNoteContext sharedContext];
  id v13 = [v12 managedObjectContext];

  id v14 = [[_TtC11MobileNotes17ICArchiveImporter alloc] initWithContext:v13];
  v15 = [v6 objectID];
  id v19 = 0;
  ...
  {
    if (v18) {
      sub_1004DCEFC((uint64_t)v16, (uint64_t)v6, v17);
    }
  }
  else if (v18)
  {
    sub_1004DCE84((uint64_t)v6, v17);
  }
...
- (void)undoablyDeleteAttachment:(id)a3
{
  ...
  if (([v9 markedForDeletion] & 1) == 0)
  {
    ...
    if ((v4 & 1) == 0)
    {
      id v6 = +[NSUndoManager shared];
      id v7 = +[NSBundle mainBundle];
      unsigned int v8 = [v7 localizedStringForKey:@"Delete Attachment" value:&stru_10063F3D8 table:0];
      [v6 setActionName:v8];
    }
  }
}
...
- (id)undoablyCopyNote:(id)a3 toFolder:(id)a4 moveAction:(id)a5 actionName:(id)a6
{
  ...
  if (!v13)
  {
    ...
    id v13 = [v14 localizedStringForKey:@"Copy Note" value:&stru_10063F3D8 table:0];
  }
...
- (id)undoablyCopyNotes:(id)a3 toFolder:(id)a4 actionName:(id)a5
{
  ...
  if (!v29)
  {
    ...
    id v10 = [v9 localizedStringForKey:@"Copy %lu Notes" value:&stru_10063F3D8 table:0];
...
- (void)undoablyMoveNotes:(id)a3 toNoteContainer:(id)a4 actionName:(id)a5 workerContext:(id)a6 completionHandler:(id)a7
{
  ...
  if (!v14)
  {
    ...
    id v16 = [v15 localizedStringForKey:@"Move %lu Notes" value:&stru_10063F3D8 table:0];
...
- (void)undoablyDeleteNote:(id)a3 moveAction:(id)a4 actionName:(id)a5
{
  ...
  if (([v8 markedForDeletion] & 1) == 0)
  {
    ...
    if (!v10)
    {
      ...
      {
        id v14 = +[NSBundle mainBundle];
        id v10 = [v14 localizedStringForKey:@"Delete Note" value:&stru_10063F3D8 table:0];
      }
    }
...
- (void)undoablyUndeleteNote:(id)a3 moveAction:(id)a4 actionName:(id)a5
{
  ...
  else
  {
    ...
    id v9 = +[NSBundle mainBundle];
    uint64_t v12 = [v9 localizedStringForKey:@"Delete Note" value:&stru_10063F3D8 table:0];
  }
...
- (id)undoablyAddFolderToAccount:(id)a3 moveAction:(id)a4 actionName:(id)a5
{
  ...
  else
  {
    ...
    id v9 = [v14 localizedStringForKey:@"Add Folder" value:&stru_10063F3D8 table:0];
  }
...
- (id)undoablyCopyFolder:(id)a3 toAccount:(id)a4 copyingNotes:(BOOL)a5 moveAction:(id)a6 actionName:(id)a7
{
  ...
  if (!v15)
  {
    ...
    id v15 = [v16 localizedStringForKey:@"Copy Folder" value:&stru_10063F3D8 table:0];
  }
  ...
  if ([v10 isDeletable])
  {
    if (([v10 markedForDeletion] & 1) == 0)
    {
      if (!v12)
      {
        ...
        id v12 = [v13 localizedStringForKey:@"Delete Folder" value:&stru_10063F3D8 table:0];
      }
      long long v46 = 0u;
      long long v47 = 0u;
      long long v44 = 0u;
...
- (void)undoablyUndeleteFolder:(id)a3 didMarkNotesForDeletion:(BOOL)a4 moveAction:(id)a5 actionName:(id)a6
{
  ...
  if (!v11)
  {
    ...
    id v11 = [v12 localizedStringForKey:@"Delete Folder" value:&stru_10063F3D8 table:0];
  }
...
- (void)undoablyDeleteUnusedTagsForSmartFolder:(id)a3
{
  ...
  id v9 = _NSConcreteStackBlock;
  uint64_t v10 = 3221225472;
  unsigned __int8 v11 = sub_100131F60;
  id v12 = &unk_100625860;
  id v13 = v4;
...
- (void)undoablyUndeleteUnusedTagsForSmartFolder:(id)a3
{
  ...
  id v9 = _NSConcreteStackBlock;
  uint64_t v10 = 3221225472;
  unsigned __int8 v11 = sub_100132120;
  id v12 = &unk_100625860;
  id v13 = v4;
  id v14 = (id)objc_claimAutoreleasedReturnValue();
  id v5 = v14;
...
- (void)undoablyUnmoveNoteIDs:(id)a3 toFolderIDs:(id)a4 originalToCopyNoteIDs:(id)a5 actionName:(id)a6 noteToFolderIDsForRedo:(id)a7 workerContext:(id)a8
{
  ...
  id v22 = v15;
  id v23 = v14;
  [(ICNoteContext *)self undoablyProcessNoteIDs:v19 progressStringBlock:&stru_10062AB80 workerContext:v16 processNoteBlock:v24 completionHandler:0];
}
...
- (void)undoablyMoveNoteIDs:(id)a3 toFolderIDs:(id)a4 actionName:(id)a5 workerContext:(id)a6 completionHandler:(id)a7
{
  ...
  id v25 = v39;
  id v26 = v38;
  [(ICNoteContext *)self undoablyProcessNoteIDs:v15 progressStringBlock:&stru_10062ABC8 workerContext:v22 processNoteBlock:v36 completionHandler:v28];
}
