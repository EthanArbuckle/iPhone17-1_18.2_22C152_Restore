...
LABEL_6:
  ...
  dispatch_once(&qword_10160F6B0, &stru_1012F69C0);
  if (!v5) {
    goto LABEL_6;
  }
LABEL_3:
...
LABEL_7:
  ...
  [(id)qword_10160F6A8 setLocalizedDateFormatFromTemplate:v15];
  [(id)qword_10160F6A8 setTimeZone:self->_destinationTimeZone];
  uint64_t v18 = (void *)qword_10160F6A8;
...
+ (id)_arrivalTimeStringForEtaDate:(id)a3 timeZone:(id)a4 includingAMPMSymbols:(BOOL)a5
{
  ...
  id v7 = a3;
  id v8 = a4;
  if (qword_10160F6C0 != -1) {
    dispatch_once(&qword_10160F6C0, &stru_1012F69E0);
  }
  [(id)qword_10160F6B8 setTimeZone:v8];
  if (v5) {
    CFStringRef v9 = @"j:mm";
  }
  else {
  ...
  [(id)qword_10160F6B8 setLocalizedDateFormatFromTemplate:v9];
  v10 = [(id)qword_10160F6B8 stringFromDate:v7];
...
- (void)_computeTimeProperties
{
  ...
  {
    uint64_t v12 = ((int)remainingMinutes_low / 60);
    if ((int)remainingMinutes_low <= 1439) {
      uint64_t v13 = ((int)remainingMinutes_low % 60);
    }
    else {
      uint64_t v13 = 0;
    }
    if (v13) {
      BOOL v14 = (remainingMinutes_low - 60) >= 0x3C;
    }
    else {
      BOOL v14 = 1;
    }
    ...
    if (v15)
    {
      if (v13)
      {
        ...
        double v17 = [v16 localizedStringForKey:@"Hours and minutes value [ETA]" value:@"localized string not found" table:0];
        +[NSString localizedStringWithFormat:](NSString, "localizedStringWithFormat:", v17, v12, v13);
      ...
      else
      {
        ...
        uint64_t v16 = self->_timeValue;
        self->_timeValue = v27;
      }

      v28 = +[NSBundle mainBundle];
      v29 = [v28 localizedStringForKey:@"Hours label [ETA]" value:@"localized string not found" table:0];
      +[NSString stringWithFormat:](NSString, "stringWithFormat:", v29, v15);
      v30 = (NSString *)objc_claimAutoreleasedReturnValue();
      timeUnit = self->_timeUnit;
      self->_timeUnit = v30;

      v34 = +[NSBundle mainBundle];
      objc_super v26 = [v34 localizedStringForKey:@"Hours accessibility label [ETA]" value:@"localized string not found" table:0];
      +[NSString stringWithFormat:](NSString, "stringWithFormat:", v26, v15);
    }
    else
    {
      uint64_t v20 = +[NSString localizedStringWithFormat:@"%d", LODWORD(self->_remainingMinutes)];
      uint64_t v21 = self->_timeValue;
      self->_timeValue = v20;

      v22 = +[NSBundle mainBundle];
      objc_super v23 = [v22 localizedStringForKey:@"Minutes label [ETA]" value:@"localized string not found" table:0];
      +[NSString stringWithFormat:](NSString, "stringWithFormat:", v23, remainingMinutes_low);
      v24 = (NSString *)objc_claimAutoreleasedReturnValue();
      v25 = self->_timeUnit;
      self->_timeUnit = v24;

      v34 = +[NSBundle mainBundle];
      objc_super v26 = [v34 localizedStringForKey:@"Minutes accessibility label [ETA]" value:@"localized string not found" table:0];
      +[NSString stringWithFormat:](NSString, "stringWithFormat:", v26, remainingMinutes_low);
    }
    v32 = (NSString *)objc_claimAutoreleasedReturnValue();
    timeUnitAccessibility = self->_timeUnitAccessibility;
    self->_timeUnitAccessibility = v32;

    uint64_t v11 = (NSString *)v34;
  }
  else
  {
    ...
    v10 = self->_timeUnit;
    uint64_t v11 = self->_timeUnitAccessibility;
...
- (void)_computeDistanceProperties
{
  ...
  if (qword_10160F6D0 != -1) {
    dispatch_once(&qword_10160F6D0, &stru_1012F6A00);
  }
  id v11 = (id)qword_10160F6C8;
  [v11 setUnitStyle:[self _unitStyleForUnit:v10]];
  uint64_t v12 = [v11 unitStringFromValue:v10 unit:v4];
  distanceUnit = self->_distanceUnit;
  self->_distanceUnit = v12;

  if (qword_10160F6E0 != -1) {
    dispatch_once(&qword_10160F6E0, &stru_1012F6A20);
  }
  id v14 = (id)qword_10160F6D8;
  uint64_t v15 = [v14 unitStringFromValue:v10 unit:v4];
  distanceUnitAccessibility = self->_distanceUnitAccessibility;
