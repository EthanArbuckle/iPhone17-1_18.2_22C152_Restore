...
- (void)initializeBrokerConnectionIfNeeded
{
  sub_1000ABFCC(OS_LOG_TYPE_INFO, @"MapsIPCInterface initializeBrokerConnectionIfNeeded", v2, v3, v4, v5, v6, v7, v23);
  if (!self->_brokerConnection)
  {
    ...
    sub_1000ABFCC(OS_LOG_TYPE_INFO, @"MapsIPCInterface Initializing broker connection.", v15, v16, v17, v18, v19, v20, v24);
...
{
  [(NSXPCListener *)self->_xpcListener invalidate];
  sub_1000ABFCC(OS_LOG_TYPE_INFO, @"MapsIPCInterface Tear down broker connection.", v3, v4, v5, v6, v7, v8, (uint64_t)v10.receiver);
...
- (void)performWithMapsRunning:(id)a3
{
  ...
  if (qword_101610188 != -1) {
    dispatch_once(&qword_101610188, &stru_1013037B0);
  }
  uint64_t v5 = +[FBSOpenApplicationOptions optionsWithDictionary:qword_101610180];
  sub_1000ABFCC(OS_LOG_TYPE_INFO, @"MapsIPCInterface performWithMapsRunning calling openApplication", v6, v7, v8, v9, v10, v11, v13);
...
- (NSXPCConnection)connection
{
  ...
  {
    sub_1000ABFCC(OS_LOG_TYPE_INFO, @"MapsIPCInterface Didn't get a dispatchGroup to wait on", v4, v5, v6, v7, v8, v9, v15);
  }
  id v13 = (id)v25[5];
...
- (BOOL)listener:(id)a3 shouldAcceptNewConnection:(id)a4
{
  ...
  id v7 = a4;
  sub_1000ABFCC(OS_LOG_TYPE_INFO, @"MapsIPCInterface %s %@ %@", v8, v9, v10, v11, v12, v13, (uint64_t)"-[_MapsIPCInterface listener:shouldAcceptNewConnection:]");
  xpcListener = self->_xpcListener;
  if (xpcListener == v6)
  {
    ...
    [v7 setInterruptionHandler:&stru_1013037F8];
    connectionQueue = self->_connectionQueue;
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_10096B400;
