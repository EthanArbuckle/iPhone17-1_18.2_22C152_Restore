...
- (CarDoneButton)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    if (v16)
    {
      ...
      uint64_t v22 = [v21 localizedStringForKey:@"CarGuidanceBar_Resume" value:@"localized string not found" table:0];
    ...
    [(CarFocusableBlurControl *)v3 setRoundedCornerRadius:14.0];
