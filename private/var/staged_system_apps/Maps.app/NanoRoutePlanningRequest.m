...
+ (id)requestForDirectionsWithCompanionRouteDetails:(id)a3 companionRouteContext:(id)a4
{
  ...
  id v8 = [v6 waypoints];
  id v9 = sub_100099700(v8, &stru_1012F8AA8);
...
- (id)requestedCompanionRouteDetails
{
  ...
  id v7 = sub_100099700(v6, &stru_1012F8AE8);
...
+ (id)requestWithTraceAtPath:(id)a3
{
  ...
  if (v5)
  {
    ...
    id v9 = [v8 waypoints];
    id v10 = sub_100099700(v9, &stru_1012F8B28);
