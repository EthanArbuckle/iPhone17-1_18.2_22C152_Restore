...
{
  v24.receiver = self;
  v24.super_class = (Class)TransitStationLineScheduleSectionHeaderView;
  v3 = -[TransitStationLineScheduleSectionHeaderView initWithFrame:](&v24, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  if (v3)
  {
    ...
    uint64_t v8 = [(TransitStationLineScheduleSectionHeaderView *)v3 _maps_addHairlineAtBottomWithMargin:0.0];
    bottomHairlineView = v3->_bottomHairlineView;
    v3->_bottomHairlineView = (HairlineView *)v8;
...
- (void)addButtonWithTarget:(id)a3 action:(SEL)a4
{
  ...
  if (v6 && a4)
  {
    if (!self->_focusGuide)
    {
      ...
      v9 = v30 = a4;
      id v10 = [(TransitStationLineScheduleSectionHeaderView *)self leadingAnchor];
    ...
    if (!button)
    {
      ...
      [(MapsThemeButton *)self->_button setTitleColorProvider:&stru_1012F7D28];
      ...
      objc_super v24 = [v29 constraintEqualToAnchor:v23 constant:-1.0];
      v32[0] = v24;
...
- (void)_addSecondaryView:(id)a3
{
  if (a3)
  {
    ...
    v22[0] = v19;
    objc_super v7 = [v4 trailingAnchor];
    id v8 = [(TransitStationLineScheduleSectionHeaderView *)self trailingAnchor];
    v9 = [v7 constraintEqualToAnchor:v8];
    v22[1] = v9;
    id v10 = [v4 firstBaselineAnchor];
