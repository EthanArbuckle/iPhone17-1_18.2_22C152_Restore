...
{
  v14.receiver = self;
  v14.super_class = (Class)MacCollectionRenameView;
  [(MacCollectionRenameView *)&v14 didMoveToWindow];
  v3 = [(MacCollectionRenameView *)self window];
  [v3 setCanResizeToFitContent:1];

  -[MacCollectionRenameView systemLayoutSizeFittingSize:](self, "systemLayoutSizeFittingSize:", UILayoutFittingCompressedSize.width, UILayoutFittingCompressedSize.height);
  double v5 = v4;
  double v7 = v6;
