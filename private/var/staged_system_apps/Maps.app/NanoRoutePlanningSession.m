...
- (NanoRoutePlanningSession)initWithOrigin:(unint64_t)a3
{
  ...
  if (v4)
  {
    ...
    *((void *)v4 + 2) = v10;
    ...
    dispatch_queue_set_specific(*((dispatch_queue_t *)v4 + 2), &unk_100F73D78, &unk_100F73D78, 0);
    ...
    *((void *)v4 + 3) = v15;
    ...
    dispatch_queue_set_specific(*((dispatch_queue_t *)v4 + 3), &off_1013208C0, &off_1013208C0, 0);
    *((void *)v4 + 4) = a3;
...
- (NSString)description
{
  if (dispatch_get_specific(&unk_100F73D78) == &unk_100F73D78)
  {
  ...
  else
  {
    ...
    dispatch_queue_t v10 = sub_1001044D0;
    v11 = sub_100104AD8;
    id v12 = 0;
...
- (id)_description
{
  ...
  id v4 = sub_100A3450C(self->_origin);
...
{
  id v4 = a3;
  specific = (_UNKNOWN **)dispatch_get_specific(&off_1013208C0);
  stateIsolationQueue = self->_stateIsolationQueue;
  if (specific == &off_1013208C0)
  {
  ...
  else
  {
    ...
    v16 = sub_1001044D0;
    uint64_t v17 = sub_100104AD8;
    id v18 = 0;
    uint64_t v7 = self->_stateIsolationQueue;
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_100CAE6E8;
...
+ (id)_defaultClassesBySessionState
{
  if (qword_101610D88 != -1) {
    dispatch_once(&qword_101610D88, &stru_1013208C8);
  }
  v2 = (void *)qword_101610D80;
...
- (void)_transitionToState:(int64_t)a3 withClass:(Class)a4
{
  ...
  if (a4)
  {
    ...
    id v12 = sub_100CAD3D4();
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      id v13 = sub_100A34658(a3);
...
- (void)_notifyDidChangeFromState:(int64_t)a3 toState:(int64_t)a4
{
  ...
  {
    id v8 = sub_100A34658(a3);
    id v9 = sub_100A34658(a4);
    int v11 = 134218498;
    id v12 = self;
    __int16 v13 = 2112;
    v14 = v8;
...
- (BOOL)hasReceivedAllExpectedRoutes
{
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_100CB0244;
  block[3] = &unk_1012EA120;
  block[4] = &v8;
