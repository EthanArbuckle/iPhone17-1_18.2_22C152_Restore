...
{
  v7.receiver = self;
  v7.super_class = (Class)PersistentHistory;
  v3 = [(PersistentHistory *)&v7 description];
  id v4 = [(PersistentHistory *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    id v4 = [objc_alloc((Class)NSMutableArray) initWithCapacity:-[NSMutableArray count](self->_items, "count")];
    long long v12 = 0u;
    long long v13 = 0u;
    long long v14 = 0u;
    long long v15 = 0u;
...
LABEL_13:
    ...
    if ((v7 >> 3) == 10)
    {
      long long v13 = objc_alloc_init(PersistentHistoryItem);
      [(PersistentHistory *)self addItems:v13];
      if (!PBReaderPlaceMark() || !sub_100BA7280((id *)v13, (uint64_t)a3))
      {
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v8 clearItems];
    unint64_t v4 = [(PersistentHistory *)self itemsCount];
    if (v4)
    {
      unint64_t v5 = v4;
      for (uint64_t i = 0; i != v5; ++i)
      {
        unint64_t v7 = [(PersistentHistory *)self itemsAtIndex:i];
        [v8 addItems:v7];
      }
    }
  }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[PersistentHistory addItems:](self, "addItems:", *(void *)(*((void *)&v9 + 1) + 8 * (void)v8), (void)v9);
        id v8 = (char *)v8 + 1;
      }
      while (v6 != v8);
