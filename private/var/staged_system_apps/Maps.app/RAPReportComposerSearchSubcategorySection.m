...
- (RAPReportComposerSearchSubcategorySection)initWithQuestion:(id)a3 selection:(id)a4
{
  ...
  id v8 = a4;
  v15.receiver = self;
  v15.super_class = (Class)RAPReportComposerSearchSubcategorySection;
  ...
  if (v9)
  {
    ...
    v13 = [(id)objc_opt_class() localizedHeaderText];
    [(RAPTablePartSection *)v10 setHeaderTitle:v13];

    [(RAPMenu *)v10->_question addObserver:v10 changeHandler:&stru_101320C38];
  }
