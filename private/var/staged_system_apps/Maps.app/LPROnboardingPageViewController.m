...
- (void)viewDidLoad
{
  ...
  id v9 = [v8 localizedStringForKey:@"[LPR Onboarding] Add License Plate subtitle" value:@"localized string not found" table:0];

  id v10 = +[UIImage imageNamed:@"LPR_onboarding_icon"];
  id v11 = [objc_alloc((Class)OBWelcomeController) initWithTitle:v7 detailText:v9 icon:v10];
  ...
  objc_super v14 = +[OBBoldTrayButton boldButton];
  v15 = [v14 titleLabel];
...
- (void)continuePressed
{
  BOOL v3 = [LPRRegionSelectionViewController alloc];
  ...
  objc_super v7 = [(LPROnboardingPageViewController *)self navigationController];
