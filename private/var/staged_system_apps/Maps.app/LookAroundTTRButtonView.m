...
- (void)_setupViews
{
  id v12 = +[UIImage imageNamed:@"LookAroundTTR"];
...
- (void)_setupConstraints
{
  ...
  double v5 = [v16 constraintEqualToAnchor:v15];
  v36[5] = v5;
  v22 = v4;
...
{
  id v4 = a3;
  id v5 = [(LookAroundTTRButtonView *)self delegate];
...
- (LookAroundTTRButtonViewDelegate)delegate
{
  ...
  return (LookAroundTTRButtonViewDelegate *)WeakRetained;
}
