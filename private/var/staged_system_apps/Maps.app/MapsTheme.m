...
- (MapsTheme)initWithMapsThemeStyle:(unint64_t)a3 visualEffectStyle:(unint64_t)a4
{
  ...
  if (v6)
  {
    ...
    v7->_isRTL = [v12 userInterfaceLayoutDirection] == (id)1;
  }
  return v7;
}
...
+ (id)sharedTheme
{
  if (qword_10160F820 != -1) {
    dispatch_once(&qword_10160F820, &stru_1012F7D90);
  }
  v2 = (void *)qword_10160F818;
...
+ (id)globalThemes
{
  if (qword_10160F810 != -1) {
    dispatch_once(&qword_10160F810, &stru_1012F7D70);
  }
  v2 = (void *)qword_10160F808;
...
- (void)_updateCurrentTheme
{
  ...
  id v3 = [(MapsTheme *)self _mapsThemeStyleKey:self->_mapsThemeStyle];
  CFStringRef v4 = [v6 objectForKeyedSubscript:v3];
...
+ (UIImage)locationImage
{
  ...
  id v3 = +[UIImageSymbolConfiguration configurationWithPointSize:17.0];
  CFStringRef v4 = [v2 imageWithConfiguration:v3];
...
- (unint64_t)infoCardThemeType
{
  if ([(MapsTheme *)self visualEffectStyle]
    && (id)[(MapsTheme *)self visualEffectStyle] != (id)1)
  {
    return 0;
  }
...
- (id)statusIndicatorBackgroundColor:(unint64_t)a3
{
  ...
  id v3 = [(MapsTheme *)self blueButtonBackgroundColor:0];
  }
...
- (id)blackCircleButtonBackgroundColor:(unint64_t)a3
{
  id v3 = +[UIColor colorWithWhite:dbl_100F71FE0[a3 == 1] alpha:1.0];
...
- (UIColor)navResumeRouteBannerHighlightColor
{
  ...
  id v3 = +[UIColor colorWithWhite:0.0 alpha:0.100000001];
  CFStringRef v4 = [v2 _colorBlendedWithColor:v3];
...
- (id)fadedGrayButtonBackgroundColor:(unint64_t)a3
{
  if (a3 == 1)
  {
    id v3 = +[UIColor colorWithWhite:0.0 alpha:0.0500000007];
    CFStringRef v4 = +[UIColor colorWithWhite:0.0 alpha:0.300000012];
...
+ (UIColor)ugcAddPhotoCellBackgroundColor
{
  ...
  id v3 = [v2 colorWithAlphaComponent:0.0500000007];
...
{
  v2 = +[UIColor labelColor];
  id v3 = [v2 colorWithAlphaComponent:0.100000001];
...
- (id)greenButtonTitleColor:(unint64_t)a3
{
  ...
  CFStringRef v4 = [(MapsTheme *)self _maps_colorNamed:v3];
...
- (UIColor)navSignSecondaryColor
{
  if (qword_10160F830 != -1) {
    dispatch_once(&qword_10160F830, &stru_1012F7E18);
  }
  v2 = (void *)qword_10160F828;
...
- (UIColor)dynamicControlBackgroundColor
{
  ...
  block[1] = 3221225472;
  block[2] = sub_10076B834;
  block[3] = &unk_1012E5D08;
  block[4] = self;
  if (qword_10160F840 != -1) {
    dispatch_once(&qword_10160F840, block);
  }
  return (UIColor *)(id)qword_10160F838;
}
...
- (UIColor)dynamicHairlineColor
{
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_10076BAD4;
  block[3] = &unk_1012E5D08;
  block[4] = self;
  if (qword_10160F850 != -1) {
    dispatch_once(&qword_10160F850, block);
  }
  return (UIColor *)(id)qword_10160F848;
}
...
- (id)greenButtonBackgroundColor:(unint64_t)a3
{
  ...
  CFStringRef v4 = [(MapsTheme *)self colorForTag:v3];
