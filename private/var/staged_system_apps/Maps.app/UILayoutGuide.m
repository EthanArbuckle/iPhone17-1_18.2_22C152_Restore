...
- (id)_maps_constraintsEqualToEdgesOfLayoutGuide:(id)a3 priority:(float)a4
{
  if (a3)
  {
    ...
    v23 = [v6 topAnchor];
    *(float *)&double v7 = a4;
    v8 = [v24 constraintEqualToAnchor:v23 constant:0.0 priority:v7];
    v22 = [(UILayoutGuide *)self leadingAnchor];
    v9 = [v6 leadingAnchor];
    *(float *)&double v10 = a4;
    v11 = [v22 constraintEqualToAnchor:v9 constant:0.0 priority:v10];
    v12 = [(UILayoutGuide *)self bottomAnchor];
    v13 = [v6 bottomAnchor];
    *(float *)&double v14 = a4;
    v15 = [v12 constraintEqualToAnchor:v13 constant:0.0 priority:v14];
    v16 = [(UILayoutGuide *)self trailingAnchor];
    v17 = [v6 trailingAnchor];

    *(float *)&double v18 = a4;
    v19 = [v16 constraintEqualToAnchor:v17 constant:0.0 priority:v18];
...
- (id)_maps_layoutGuideInsideEdgesWithPriority:(float)a3
{
  ...
  if (v5)
  {
    ...
    v28[1] = v12;
    v13 = [v6 bottomAnchor];
    double v14 = [(UILayoutGuide *)self bottomAnchor];
    LODWORD(v15) = 1148846080;
    v16 = [v13 constraintLessThanOrEqualToAnchor:v14 constant:0.0 priority:v15];
    v28[2] = v16;
    v17 = [v6 trailingAnchor];
    double v18 = [(UILayoutGuide *)self trailingAnchor];
...
- (id)_maps_layoutGuidePinnedToEdgesWithRelation:(int64_t)a3 withPriority:(float)a4
{
  ...
  if (v6)
  {
    ...
    *(float *)&double v9 = a4;
    ...
    v12 = [(UILayoutGuide *)self bottomAnchor];
    *(float *)&double v13 = a4;
    double v14 = [v11 constraintEqualToAnchor:v12 constant:0.0 priority:v13];
    v26[2] = v14;
    double v15 = [v7 trailingAnchor];
    v16 = [(UILayoutGuide *)self trailingAnchor];
    *(float *)&double v17 = a4;
    double v18 = [v15 constraintEqualToAnchor:v16 constant:0.0 priority:v17];
    v26[3] = v18;
...
- (NSLayoutXAxisAnchor)_maps_leftRHDAnchor
{
  ...
  if (objc_msgSend(v4, "_car_isHybridInstrumentCluster"))
  {
    v5 = [(UILayoutGuide *)self owningView];
    id v6 = [v5 window];
    BOOL v7 = [v6 _car_hybridInstrumentClusterAlignment] == (id)2;
  }
  else
  {
    BOOL v7 = 0;
  ...
  unsigned __int8 v9 = [v8 rightHandDrive];

  if ((v9 & 1) != 0 || v7)
  {
    double v10 = [(UILayoutGuide *)self rightAnchor];
  }
  else
  {
    double v10 = [(UILayoutGuide *)self leftAnchor];
  }
...
- (NSLayoutXAxisAnchor)_maps_rightRHDAnchor
{
  ...
  if (objc_msgSend(v4, "_car_isHybridInstrumentCluster"))
  {
    v5 = [(UILayoutGuide *)self owningView];
    id v6 = [v5 window];
    BOOL v7 = [v6 _car_hybridInstrumentClusterAlignment] == 2;
  }
  else
  {
    BOOL v7 = 0;
