...
{
  v11.receiver = self;
  v11.super_class = (Class)NavSignCollectionViewCell;
  v3 = -[NavSignCollectionViewCell initWithFrame:](&v11, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  if (v3)
  {
    ...
    v7 = -[NavSignView initWithFrame:]([NavManeuverSignView alloc], "initWithFrame:", CGRectZero.origin.x, CGRectZero.origin.y, CGRectZero.size.width, CGRectZero.size.height);
...
- (void)_configureConstraints
{
  ...
  v10 = [v9 bottomAnchor];
  objc_super v11 = [v8 constraintLessThanOrEqualToAnchor:v10];
  v20[3] = v11;
