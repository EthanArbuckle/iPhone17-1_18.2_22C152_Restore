...
- (TrafficIncidentLayout)initWithLayoutFormConfig:(id)a3 location:(id)a4
{
  ...
  uint64_t v8 = [(TrafficIncidentLayout *)&v11 init];
  v9 = v8;
  if (v8)
  {
...
- (BOOL)shouldInvalidateLayoutForLocation:(id)a3
{
  ...
  if (self->_layoutRequestLocation)
  {
    ...
    [(NSDate *)self->_layoutRequestTime timeIntervalSinceNow];
    double v8 = v7;
    uint64_t v9 = [v4 latLng];
    [v9 coordinate];
    BOOL v10 = [(GEOLocation *)self->_layoutRequestLocation latLng];
    [v10 coordinate];
    GEOCalculateDistance();
    double v12 = v11;

    if (v12 >= (double)self->_layoutFreshnessRadius)
    {
      BOOL v14 = 1;
    }
    else
    {
      ...
      BOOL v14 = v13 > (double)self->_layoutTimeToLive;
    }
    long long v15 = sub_100576E2C();
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      __int16 v21 = 2112;
      long long v22 = self;
      long long v16 = "TrafficIncidentLayout: shouldInvalidateLayout %d for %@";
      v17 = v15;
      uint32_t v18 = 18;
      goto LABEL_11;
    }
  ...
  else
  {
    ...
    {
      LOWORD(v20[0]) = 0;
      long long v16 = "TrafficIncidentLayout: Initial fetching";
      v17 = v15;
      uint32_t v18 = 2;
LABEL_11:
      _os_log_impl((void *)&_mh_execute_header, v17, OS_LOG_TYPE_INFO, v16, (uint8_t *)v20, v18);
    }
  }
