...
- (AdvertisementTableViewCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  if (v4)
  {
    ...
    v4->_advertisementLabel = (UILabel *)v5;
...
- (void)setupConstraints
{
  ...
  uint64_t v5 = [(AdvertisementTableViewCell *)self contentView];
  v6 = [v5 layoutMarginsGuide];
  v7 = [v6 topAnchor];
  v8 = [(AdvertisementTableViewCell *)self advertisementLabel];
  v9 = [v8 font];
  [v9 _mapkit_scaledValueForValue:18.0];
  v10 = [v4 constraintEqualToAnchor:v7];

  objc_super v11 = [(AdvertisementTableViewCell *)self contentView];
