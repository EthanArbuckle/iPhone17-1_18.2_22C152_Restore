...
- (void)_startObserving
{
  ...
  long long v24 = 0u;
  long long v25 = 0u;
  if (qword_10160ED90 != -1) {
    dispatch_once(&qword_10160ED90, &stru_1012EB890);
  }
  id v3 = (id)qword_10160ED98;
  ...
  if (v4)
  {
    ...
    do
    {
      for (i = 0; i != v5; i = (char *)i + 1)
      {
        ...
        id v9 = [(NavigationSettingsMonitor *)self userDefaults];
        [v9 addObserver:self forKeyPath:v8 options:0 context:&off_1012EB888];
      }
  ...
  long long v18 = 0u;
  long long v19 = 0u;
  id v10 = [&off_1013AE430 countByEnumeratingWithState:&v18 objects:v26 count:16];
  if (v10)
  {
    id v11 = v10;
    ...
    do
    {
      for (j = 0; j != v11; j = (char *)j + 1)
      {
        ...
        [v15 addObserver:self forKeyPath:v14 options:0 context:&off_1012EB888];
      }
      id v11 = [&off_1013AE430 countByEnumeratingWithState:&v18 objects:v26 count:16];
    }
    while (v11);
  }
...
- (void)_stopObserving
{
  ...
  long long v16 = 0u;
  long long v17 = 0u;
  id v10 = [&off_1013AE430 countByEnumeratingWithState:&v16 objects:v24 count:16];
  if (v10)
  {
    id v11 = v10;
    ...
    do
    {
      ...
      id v11 = [&off_1013AE430 countByEnumeratingWithState:&v16 objects:v24 count:16];
    }
    while (v11);
  }
}
...
- (void)observeValueForKeyPath:(id)a3 ofObject:(id)a4 change:(id)a5 context:(void *)a6
{
  ...
  id v11 = a4;
  id v12 = a5;
  if (!v10 || a6 != &off_1012EB888) {
    goto LABEL_8;
  }
  if (qword_10160ED90 != -1) {
    dispatch_once(&qword_10160ED90, &stru_1012EB890);
  }
  if (([(id)qword_10160ED98 containsObject:v10] & 1) != 0
    || [&off_1013AE430 containsObject:v10])
  {
