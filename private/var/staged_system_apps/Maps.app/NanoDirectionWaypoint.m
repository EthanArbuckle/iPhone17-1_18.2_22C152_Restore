...
+ (id)directionWaypointForComposedWaypoint:(id)a3
{
  ...
  if ([v3 isCurrentLocation])
  {
    if ([v3 hasLatLng])
    {
      ...
      id v6 = [v4 initWithLocation:v5 isUserLocation:[v3 isCurrentLocation] floorOrdinal:0x7FFFFFFFLL];
    }
    else
    {
      id v6 = 0;
...
- (id)companionWaypoint
{
  ...
  [v3 setIsCurrentLocation:[self isCurrentLocation]];
