...
+ (id)defaultManager
{
  ...
  block[1] = 3221225472;
  block[2] = sub_1007C821C;
  block[3] = &unk_1012E63F0;
  block[4] = a1;
  if (qword_10160F960 != -1) {
    dispatch_once(&qword_10160F960, block);
  }
  v2 = (void *)qword_10160F958;
  ...
  if (v5)
  {
    ...
    do
    {
      for (i = 0; i != v6; i = (char *)i + 1)
      {
        ...
        long long v24 = 0u;
        long long v25 = 0u;
        id v11 = [&off_1013ADFE0 countByEnumeratingWithState:&v24 objects:v32 count:16];
        if (v11)
        {
          id v12 = v11;
...
LABEL_10:
          ...
          {
            if (*(void *)v25 != v13) {
              objc_enumerationMutation(&off_1013ADFE0);
            }
            ...
            if (v12 == (id)++v14)
            {
              id v12 = [&off_1013ADFE0 countByEnumeratingWithState:&v24 objects:v32 count:16];
              if (v12) {
                goto LABEL_10;
              }
              goto LABEL_16;
...
- (id)devicePushToken
{
  ...
  id v11 = sub_1007C9854;
  int v12 = &unk_1012F9020;
  uint64_t v14 = &v15;
  ...
  id v5 = [(MapsPushManager *)self devicePushTokenCompletion];
...
- (id)_simulatedProblemStatus
{
  ...
  id v7 = [(MapsPushManager *)self _simulatedDetails];
  [v3 setDetails:v7];
...
- (void)fetchProblemStatus:(id)a3 problemReportIDs:(id)a4 manifestToken:(id)a5
{
  ...
  uint64_t v17 = +[GEOPlatform sharedPlatform];
  v18 = [v17 clientCapabilities];
  id v19 = [v18 transitMarketSupport];
  id v20 = [v11 clientCapabilities];
...
LABEL_5:
    ...
    while (1)
    {
      ...
      v21 = [*(id *)(*((void *)&v48 + 1) + 8 * v20) uniqueID:v40];
      id v22 = [v14 uniqueID];
...
LABEL_13:
    ...
    while (1)
    {
      ...
      long long v28 = [*(id *)(*((void *)&v44 + 1) + 8 * v27) uniqueID:v40];
