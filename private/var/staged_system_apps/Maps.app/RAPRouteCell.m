...
- (RAPRouteCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  if (v4)
  {
    ...
    v14 = [objc_alloc((Class)UIImageView) initWithFrame:CGRectZero.origin.x, y, width, height];
...
- (void)_setupConstraints
{
  ...
  v26 = [v28 topAnchor];
  objc_super v25 = [v27 constraintEqualToAnchor:v26 constant:40.0];
  v58[10] = v25;
...
- (id)_cellBackgroundColor
{
  ...
  double v7 = +[UIColor _dynamicColorWithColorsByTraitCollection:v6];
...
- (void)_setupStyling
{
  ...
  id v8 = +[UIFont _mapkit_preferredFontForTextStyleInTableViewCell:UIFontTextStyleSubheadline];
...
- (void)configureWithRequest:(id)a3
{
  ...
  id v6 = v5;
  id v7 = [v6 historyItem];
  id v8 = &OBJC_PROTOCOL___MSPHistoryEntryRoute;
  objc_opt_class();
  id v9 = v7;
  if (objc_opt_isKindOfClass()) {
    v10 = v9;
  ...
  if (v14)
  {
    ...
    [v14 timestamp];
    v19 = -[RAPRouteCell _formattedTimeStringSinceDirectionsWereTaken:](self, "_formattedTimeStringSinceDirectionsWereTaken:");
    [(UILabel *)self->_subtitleLabel setText:v19];

    v20 = [v14 historyEntry];
    id v21 = [v20 transportType];

    CFStringRef v22 = @"rp_drive";
    if (v21 == (id)2) {
      CFStringRef v22 = @"rp_walk";
    }
    if (v21 == (id)5) {
      CFStringRef v23 = @"rp_cycle";
    }
    else {
      CFStringRef v23 = v22;
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      *(_DWORD *)buf = 138412290;
      id v28 = v4;
      _os_log_impl((void *)&_mh_execute_header, v16, OS_LOG_TYPE_ERROR, "Failed to create a historyEntryRecentsItem from request: %@", buf, 0xCu);
    }
  }
}
...
- (id)_formattedTimeStringSinceDirectionsWereTaken:(double)a3
{
  double v3 = CFAbsoluteTimeGetCurrent() - a3;
  if (v3 < 60.0)
  {
    id v4 = +[NSBundle mainBundle];
    uint64_t v5 = [v4 localizedStringForKey:@"Just now [DirectionsHistoryItemCell]" value:@"localized string not found" table:0];
LABEL_3:
    id v6 = (void *)v5;
    goto LABEL_9;
  }
  if (v3 < 86400.0)
  {
    id v4 = +[NSDateComponentsFormatter _maps_stringLongFromTimeInterval:](NSDateComponentsFormatter, "_maps_stringLongFromTimeInterval:");
    id v7 = +[NSBundle mainBundle];
    id v8 = v7;
    CFStringRef v9 = @"%@ ago [DirectionsHistoryItemCell]";
LABEL_8:
    id v11 = [v7 localizedStringForKey:v9 value:@"localized string not found" table:0];
    id v6 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", v11, v4);
  ...
  if (v3 < 172800.0)
  {
    ...
    id v4 = +[NSDateFormatter _maps_timeForDate:v10];

    id v7 = +[NSBundle mainBundle];
    id v8 = v7;
    CFStringRef v9 = @"Yesterday %@ [DirectionsHistoryItemCell]";
    goto LABEL_8;
  }
  if (v3 >= 604800.0)
  {
    id v4 = +[NSDate dateWithTimeIntervalSinceNow:-v3];
    uint64_t v5 = +[NSDateFormatter _maps_dateStringWithoutYearForDate:v4];
    goto LABEL_3;
  }
  double v13 = -v3;
  id v14 = +[NSDate dateWithTimeIntervalSinceNow:-v3];
  id v4 = +[NSDateFormatter _maps_weekdayForDate:v14];

  v15 = +[NSDate dateWithTimeIntervalSinceNow:v13];
  v16 = +[NSDateFormatter _maps_timeForDate:v15];

  id v6 = +[NSString stringWithFormat:@"%@ %@", v4, v16];
