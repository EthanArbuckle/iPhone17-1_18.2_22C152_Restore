...
- (AudioPreferences)initWithDefaults:(id)a3
{
  ...
  objc_super v3 = [(WatchSyncedPreferences *)&v6 initWithDefaults:a3];
  v4 = v3;
  if (v3) {
...
- (void)synchronize
{
  ...
  long long v16 = 0u;
  long long v17 = 0u;
  v5 = [(AudioPreferences *)self _keys];
...
- (id)_keys
{
  return &off_1013AE448;
}

- (void)loadValuesFromDefaults
{
  objc_super v3 = [(WatchSyncedPreferences *)self defaults];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      {
        long long v14 = *(&off_101314E30 + v13);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
    {
      ...
      {
        long long v17 = *(&off_101314E30 + v16);
      }
      *(_DWORD *)buf = 138412290;
      id v31 = v17;
...
- (id)_values
{
  objc_super v3 = +[NSNumber numberWithUnsignedInteger:[(AudioPreferences *)self drivingVoiceGuidance]];
