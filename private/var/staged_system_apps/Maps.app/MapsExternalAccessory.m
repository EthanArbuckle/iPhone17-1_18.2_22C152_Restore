...
+ (id)sharedInstance
{
  if (qword_10160FDA0 != -1) {
    dispatch_once(&qword_10160FDA0, &stru_1012FF188);
  }
  v2 = (void *)qword_10160FD98;
...
- (void)_startListenForDebugTestNotifications
{
  if (qword_10160FDB0 != -1) {
    dispatch_once(&qword_10160FDB0, &stru_1012FF1A8);
  }
  long long v12 = 0u;
  long long v13 = 0u;
  long long v10 = 0u;
  long long v11 = 0u;
  id v3 = (id)qword_10160FDA8;
  ...
  if (v4)
  {
    ...
    do
    {
      for (i = 0; i != v5; i = (char *)i + 1)
      {
        ...
        CFNotificationCenterAddObserver(DarwinNotifyCenter, self, (CFNotificationCallback)sub_1008A8DA4, v8, 0, CFNotificationSuspensionBehaviorDeliverImmediately);
      }
...
- (void)_handleFake:(id)a3
{
  ...
  if (qword_10160FDB8 != -1) {
    dispatch_once(&qword_10160FDB8, &stru_1012FF1C8);
  }
  ...
  if ([v23 hasPrefix:@"com.apple.maps.FakeExternalAccessory.engine.type"])
  {
    ...
    id v7 = [(id)qword_10160FDC0 objectForKeyedSubscript:EAVehicleInfoEngineTypeBitmaskKey];
    unsigned int v8 = [v7 longLongValue];

    v9 = +[NSNumber numberWithUnsignedInt:sub_1008A67B8(v5) | v8];
    [(id)qword_10160FDC0 setObject:v9 forKeyedSubscript:v6];
  }
  else
  {
    if ([v23 hasPrefix:@"com.apple.maps.FakeExternalAccessory.engine.low"])
    {
      long long v10 = (void *)qword_10160FDC0;
      long long v11 = (void *)qword_10160FD80;
      long long v12 = +[NSNumber numberWithUnsignedInt:sub_1008A67B8(v5)];
      long long v13 = [v11 objectForKeyedSubscript:v12];
      [v10 setObject:&__kCFBooleanTrue forKeyedSubscript:v13];

      long long v14 = (void *)qword_10160FDC0;
      long long v15 = (void *)qword_10160FD78;
      v9 = +[NSNumber numberWithUnsignedInt:sub_1008A67B8(v5)];
      long long v16 = [v15 objectForKeyedSubscript:v9];
      long long v17 = &off_1013A9118;
    }
    else
    {
      ...
      v18 = (void *)qword_10160FDC0;
      uint64_t v19 = (void *)qword_10160FD80;
      v20 = +[NSNumber numberWithUnsignedInt:sub_1008A67B8(v5)];
      v21 = [v19 objectForKeyedSubscript:v20];
      [v18 setObject:&__kCFBooleanFalse forKeyedSubscript:v21];

      long long v14 = (void *)qword_10160FDC0;
      v22 = (void *)qword_10160FD78;
      v9 = +[NSNumber numberWithUnsignedInt:sub_1008A67B8(v5)];
      long long v16 = [v22 objectForKeyedSubscript:v9];
      long long v17 = &off_1013A9130;
    }
    [v14 setObject:v17 forKeyedSubscript:v16];
  }
LABEL_11:
  [(MapsExternalAccessory *)self _updateFromNotificationName:@"Fake Update" userInfo:qword_10160FDC0];
}
...
+ (id)instanceMethodSignatureForSelector:(SEL)a3
{
  ...
  id v4 = [super instanceMethodSignatureForSelector:];
  if (!v4)
  {
...
- (void)_postNotificationIfNeeded
{
  ...
  unsigned __int8 v5 = sub_1008A78B4();
  id v6 = v5;
  if (!v4)
  {
