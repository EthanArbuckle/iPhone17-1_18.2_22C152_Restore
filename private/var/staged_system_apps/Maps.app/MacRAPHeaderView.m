...
- (void)setTitle:(id)a3
{
  ...
  if (self->_title != v5)
  {
    ...
    [(UILabel *)self->_headerViewLabel setText:v5];
  }
}
...
- (MacRAPHeaderView)init
{
  ...
  if (v2)
  {
    ...
    uint64_t v19 = [v17 constraintEqualToAnchor:v18 constant:-10.0];
...
- (MacRAPHeaderView)initWithSearchBar:(id)a3
{
  ...
  if (v5)
  {
    ...
    uint64_t v9 = [v7 constraintEqualToAnchor:v8 constant:-10.0];
