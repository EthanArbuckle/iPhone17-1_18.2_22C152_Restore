...
+ (BOOL)isEnabled
{
  ...
  unsigned __int8 v3 = [v2 BOOLForKey:@"VLFSessionDebugPuckVisibilityMonitorEnabledKey"];
...
{
  unsigned __int8 v3 = +[NSUserDefaults standardUserDefaults];
  unsigned int v4 = [v3 BOOLForKey:@"VLFSessionDebugPuckVisibilityMonitorActiveKey"];
...
LABEL_5:
    ...
    [(VLFSessionDebugPuckVisibilityMonitor *)&v15 observeValueForKeyPath:v10 ofObject:v11 change:v12 context:a6];
    goto LABEL_6;
  }
  unsigned int v14 = [v10 isEqualToString:@"VLFSessionDebugPuckVisibilityMonitorActiveKey"];
