...
- (GuidanceSearchResultCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  if (v4)
  {
    ...
    v32 = (UIActivityIndicatorView *)[objc_alloc((Class)UIActivityIndicatorView) initWithActivityIndicatorStyle:100];
...
- (void)setActionButtonLoading:(BOOL)a3
{
  if (self->_actionButtonLoading != a3)
  {
    ...
    if (v3)
    {
      ...
      id v8 = [(GuidanceSearchResultCell *)self actionButtonActivityIndicatorView];
      [v8 startAnimating];
    }
    else
    {
...
{
  id v4 = a3;
  id v5 = [(GuidanceSearchResultCell *)self actionButton];

  if (v5 == v4)
  {
    id v6 = [(GuidanceSearchResultCell *)self delegate];
...
- (GuidanceSearchResultCellDelegate)delegate
{
  ...
  return (GuidanceSearchResultCellDelegate *)WeakRetained;
}
