...
{
  v74.receiver = self;
  v74.super_class = (Class)NavManeuverReroutingCell;
  v3 = -[NavManeuverReroutingCell initWithFrame:](&v74, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  if (v3)
  {
    ...
    v11 = (UIActivityIndicatorView *)[objc_alloc((Class)UIActivityIndicatorView) initWithActivityIndicatorStyle:101];
