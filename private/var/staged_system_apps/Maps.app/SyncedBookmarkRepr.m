...
- (id)richMapsActivity
{
  unsigned int v3 = [(SyncedBookmarkRepr *)self type];
  if (v3 == 4)
  {
...
LABEL_41:
    ...
    uint64_t v21 = [(SearchResult *)v19 composedWaypoint];
    v22 = (void *)v21;
    v14 = 0;
    if (v20 && v21)
    {
      unsigned int v23 = [(SyncedBookmarkRepr *)self directionsMode] - 2;
      if (v23 > 2) {
        unint64_t v24 = 0;
      }
      else {
        unint64_t v24 = qword_100F73770[v23] - 1;
      }
      v33 = objc_alloc_init(DirectionsPlan);
      id v34 = objc_alloc_init((Class)GEOStorageRouteRequestStorage);
      ...
      if (v24 > 7) {
        ...
        uint64_t v37 = dword_100F73788[v24];
      }
  ...
  if (v3 != 3)
  {
    if ([(SyncedBookmarkRepr *)self type] == 2
      && (![(SyncedBookmarkRepr *)self hasLatitude]
       || ![(SyncedBookmarkRepr *)self hasLongitude]))
    {
...
LABEL_38:
  ...
  if (v7.longitude >= -180.0 && v7.longitude <= 180.0 && v7.latitude >= -90.0 && v7.latitude <= 90.0)
  {
    ...
    if (v9 >= 0.0 && v9 <= 180.0 && v10 >= 0.0 && v10 <= 360.0)
    {
      ...
      v13 = +[MKMapCamera _cameraLookingAtMapRect:forViewSize:](MKMapCamera, "_cameraLookingAtMapRect:forViewSize:");
      v14 = objc_alloc_init(MapsActivity);
      id v15 = objc_alloc_init((Class)GEOURLOptions);
...
- (GEOMapRegion)mapRegion
{
  ...
  return (GEOMapRegion *)+[GEOMapRegion _mapkit_mapRegionForLatitude:v4 longitude:v6 latSpan:v8 longSpan:v9];
}
...
- (id)typeAsString:(int)a3
{
  if (a3 >= 6)
  {
    double v3 = +[NSString stringWithFormat:@"(unknown: %i)", *(void *)&a3];
  }
  else
  {
    double v3 = off_101323C40[a3];
  }
...
- (id)dictionaryRepresentation
{
  ...
  if (type >= 6)
  {
    double v5 = +[NSString stringWithFormat:@"(unknown: %i)", self->_type];
  }
  else
  {
    double v5 = off_101323C40[type];
  }
...
LABEL_24:
  id v15 = +[NSNumber numberWithDouble:self->_regionLatitude];
...
LABEL_28:
  ...
  {
LABEL_16:
    double v9 = +[NSNumber numberWithUnsignedLongLong:self->_businessID];
...
LABEL_17:
  ...
  if ((*(_WORD *)&self->_has & 0x80) != 0)
  {
    ...
    {
      v12 = off_101323C70[directionsMode];
    }
    [v3 setObject:v12 forKey:@"directionsMode"];
  }
  if ([(NSMutableArray *)self->_places count])
  {
    id v20 = [objc_alloc((Class)NSMutableArray) initWithCapacity:-[NSMutableArray count](self->_places, "count")];
    long long v28 = 0u;
    long long v29 = 0u;
    long long v30 = 0u;
    long long v31 = 0u;
    uint64_t v21 = self->_places;
    ...
    if (v22)
    {
      ...
      do
      {
        for (i = 0; i != v23; i = (char *)i + 1)
        {
          ...
          double v26 = [*(id *)(*((void *)&v28 + 1) + 8 * i) dictionaryRepresentation];
          [v20 addObject:v26];
        }
...
- (BOOL)readFrom:(id)a3
{
  return sub_100D91580(self, (uint64_t)a3);
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  double v5 = [[objc_opt_class() allocWithZone:a3] init];
  v5[28] = self->_type;
