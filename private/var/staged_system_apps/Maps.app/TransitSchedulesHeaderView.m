...
- (void)createViewsWithTitle:(id)a3 subtitle:(id)a4 artwork:(id)a5
{
  ...
  objc_super v10 = (UILabel *)objc_alloc_init((Class)UILabel);
  ...
  +[DynamicTypeWizard autorefreshLabel:self->_subtitleLabel withFontProvider:&stru_101321340];
  ...
  v44 = +[DynamicTypeWizard autoscaledConstraint:v45 constant:&stru_101321420 withFontProvider:36.0];
  v55[2] = v44;
  ...
  v28 = +[DynamicTypeWizard autoscaledConstraint:v27 constant:&stru_101321340 withFontProvider:21.0];
  v55[6] = v28;
...
- (void)setArtwork:(id)a3
{
  ...
  id v9 = [v5 imageForArtwork:v4 size:7 featureType:2 scale:[self _mapkit_isDarkModeEnabled] nightMode:v8];
  ...
  if (v9)
  {
    ...
    {
      v11 = (UIImageView *)[objc_alloc((Class)UIImageView) initWithImage:v9];
      ...
      double v24 = +[DynamicTypeWizard autoscaledConstraint:v25 constant:&stru_101321420 withFontProvider:20.0];
      v33[1] = v24;
      v16 = [(TransitSchedulesHeaderView *)self safeAreaLayoutGuide];
      v17 = [v16 bottomAnchor];
      double v18 = [(UIImageView *)self->_lineImageryView bottomAnchor];
      double v19 = [v17 constraintEqualToSystemSpacingBelowAnchor:v18 multiplier:1.0];
      v33[2] = v19;
      v20 = [(UILabel *)self->_titleLabel leadingAnchor];
