...
- (NavdDoomStorage)init
{
  ...
  if (v2)
  {
    ...
    [(NSMutableDictionary *)v2->_dict setObject:&off_1013AAED0 forKeyedSubscript:@"NavdDoomStorageKeyVersion"];
    v5 = v2;
  }
...
- (id)_readObjectFromKey:(unint64_t)a3
{
  ...
  if (a3 - 1 > 0x12) {
    ...
    CFStringRef v5 = *(&off_101320720 + a3 - 1);
  }
...
- (void)_writeObject:(id)a3 toKey:(unint64_t)a4 updateModTime:(BOOL)a5
{
  ...
  if (a4 - 1 > 0x12) {
    ...
    CFStringRef v10 = *(&off_101320720 + a4 - 1);
  }
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v6; i = (char *)i + 1)
      {
        ...
        int v11 = MapsSuggestionsIsInTheFuture();
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  id v5 = [objc_alloc((Class)NSMutableDictionary) initWithCapacity:-[NSMutableDictionary count](v3->_dict, "count")];
  dict = v4->_dict;
  v4->_dict = v5;
