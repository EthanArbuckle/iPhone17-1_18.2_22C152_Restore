...
+ (id)_createFakeLanes
{
  ...
  do
  {
    ...
    {
      uint64_t v10 = +[GEOComposedRouteLaneInfo _debug_laneWithDirections:&off_1013AE7F0 good:1 preferred:v6 == 0];
    }
    v11 = (void *)v10;
    [v8 addObject:v10];
...
- (NavSignLaneGuidanceInfo)initWithGuidanceLaneInfo:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (v10)
    {
      ...
      v12 = sub_100099700(v11, &stru_101320848);
    }
    else
    {
      v14 = [v4 instructions];
    ...
    if (v16)
    {
      ...
      v18 = sub_100099700(v17, &stru_101320868);
    }
    else
    {
      v19 = [v4 titles];
...
- (id)description
{
  ...
  {
    unint64_t v9 = +[NSString stringWithFormat:@"laneInfoID: [%@] %d lanes (forManeuver:%d) %@", v3, v5, v6, &stru_101324E70];
  }
