...
- (void)viewDidLoad
{
  ...
  if (sub_1000BBB44(self) == 5)
  {
    ...
    id v4 = [[ContainerHeaderView alloc] initWithCardButtonType:1];
    ...
    objc_super v9 = [[MacFooterView alloc] initWithRightButtonType:8];
    ...
    uint64_t v56 = [v55 leadingAnchor];
  ...
  {
    v26 = [[ContainerHeaderView alloc] initWithCardButtonType:0];
...
+ (BOOL)wantsDefaultHeaderContentViews
{
  return MapKitIdiomIsMacCatalyst() ^ 1;
}

- (id)transitIncidents
{
  return [(MKIncidentsViewController *)self->_incidentsViewController transitIncidents];
}
