...
+ (id)searchErrorWithUserInfo:(id)a3
{
  return +[NSError errorWithDomain:@"RoutingAppsStoreSuggestions.Search" code:100 userInfo:a3];
}

+ (id)storePlatformErrorWithUserInfo:(id)a3
{
  return +[NSError errorWithDomain:@"RoutingAppsStoreSuggestions.StorePlatform" code:100 userInfo:a3];
}
