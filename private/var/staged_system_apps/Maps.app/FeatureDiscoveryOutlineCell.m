...
{
  v31.receiver = self;
  v31.super_class = (Class)FeatureDiscoveryOutlineCell;
  v3 = -[SidebarOutlineCell initWithFrame:](&v31, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  if (v3)
  {
...
- (FeatureDiscoveryModel)cellModel
{
  return [(FeatureDiscoveryView *)self->_featureDiscoveryView model];
}
