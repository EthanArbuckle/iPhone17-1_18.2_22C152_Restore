...
- (TransitDirectionsBoardingInfoStackView)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    v58[6] = v15;
    uint64_t v16 = +[NSArray arrayWithObjects:v58 count:7];
    ...
    v57[6] = v26;
    uint64_t v27 = +[NSArray arrayWithObjects:v57 count:7];
...
- (void)_axisDidChange
{
  int64_t v3 = [(TransitDirectionsBoardingInfoStackView *)self axis];
  BOOL v4 = v3 != 0;
  +[NSLayoutConstraint deactivateConstraints:*(Class *)((char *)&self->super.super.super.isa+ OBJC_IVAR___TransitDirectionsBoardingInfoStackView__horizontalLayoutConstraints[v3 == 0])];
  uint64_t v5 = *(uint64_t *)((char *)&self->super.super.super.isa
                  + OBJC_IVAR___TransitDirectionsBoardingInfoStackView__horizontalLayoutConstraints[v4]);
