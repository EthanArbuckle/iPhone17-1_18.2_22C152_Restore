...
- (MacRAPBaseTableViewController)initWithStyle:(int64_t)a3
{
  ...
  if (v4)
  {
    v5 = [objc_alloc((Class)UITableView) initWithFrame:CGRectZero.origin.x, CGRectZero.origin.y, CGRectZero.size.width, CGRectZero.size.height];
...
- (void)viewDidLoad
{
  ...
  if (v7)
  {
    ...
    objc_super v9 = [(MacRAPBaseTableViewController *)self tableViewFooter];
    [v8 addSubview:v9];
  }
  ...
  if (v19)
  {
    ...
    uint64_t v37 = [v47 leadingAnchor];
    uint64_t v49 = [v43 constraintEqualToAnchor:v37];
    v58[0] = v49;
