...
- (_TtC4Maps16MapsFavoriteItem)observedEntry;
- (void)dealloc;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = (Class)_MapsFavoriteItemTwoLinesContentViewModel;
  [(_BasicTwoLinesContentViewModel *)&v3 dealloc];
}

- (void)setObservedEntry:(id)a3
{
  v5 = (_TtC4Maps16MapsFavoriteItem *)a3;
  ...
  if (observedEntry != v5)
  {
    ...
    [(MapsFavoriteItem *)*p_observedEntry removeObserver:self forKeyPath:@"subtitle"];
    objc_storeStrong((id *)&self->_observedEntry, a3);
    [(MapsFavoriteItem *)*p_observedEntry addObserver:self forKeyPath:@"title" options:1 context:0];
    [(MapsFavoriteItem *)*p_observedEntry addObserver:self forKeyPath:@"subtitle" options:1 context:0];
    v5 = v8;
  }
}
...
- (void)observeValueForKeyPath:(id)a3 ofObject:(id)a4 change:(id)a5 context:(void *)a6
{
  id v8 = a3;
  id v9 = a4;
  id v10 = [(_MapsFavoriteItemTwoLinesContentViewModel *)self observedEntry];
  if (v10 == v9)
  {
