...
- (void)_setupSubviews
{
  ...
  objc_super v7 = +[UIImageSymbolConfiguration configurationWithPointSize:21.0];
  ...
  v23 = [objc_alloc((Class)UIView) initWithFrame:CGRectZero.origin.x, y, width, height];
  ...
  id v31 = [(UGCAddPhotoCollectionViewCell *)self contentView];
  [v31 addSubview:self->_menuButton];
}

- (void)_setupConstraints
{
  id v3 = [(UGCAddPhotoCollectionViewCell *)self contentView];
  ...
  v75[20] = v6;
  objc_super v7 = [(MUPhotoOptionsMenuButton *)self->_menuButton topAnchor];
  v8 = [v4 topAnchor];
...
+ (id)reuseIdentifier
{
  return @"AddPhotosCollectionViewCell";
}
