...
- (StepperControl)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    v3->_singularValueTitleFormat = (NSString *)@"%ld";

    pluralValueTitleFormat = v3->_pluralValueTitleFormat;
    v3->_pluralValueTitleFormat = (NSString *)@"%ld";
...
- (void)setupConstraints
{
  ...
  id v37 = [v6 constraintEqualToAnchor:v8];
  ...
  objc_super v21 = +[NSLayoutConstraint constraintWithItem:v20 attribute:10 relatedBy:0 toItem:self attribute:10 multiplier:1.0 constant:0.0];
...
- (void)updateLabel
{
  if ((id)[(StepperControl *)self value] == (id)1) {
    [(StepperControl *)self singularValueTitleFormat];
  }
  else {
  id v7 = [(StepperControl *)self pluralValueTitleFormat];
  }
...
- (void)minusButtonTapped:(id)a3
{
  v4 = (char *)[(StepperControl *)self value] - 1;
...
{
  if (self->_value != a3
    && [(StepperControl *)self maxValue] >= a3
    && [(StepperControl *)self minValue] <= a3)
  {
    self->_value = a3;
    [(StepperControl *)self updateLabel];
