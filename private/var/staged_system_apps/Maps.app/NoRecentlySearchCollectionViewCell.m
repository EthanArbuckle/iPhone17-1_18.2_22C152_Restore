...
- (NoRecentlySearchCollectionViewCell)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    +[DynamicTypeWizard autorefreshLabel:v3->_titleLabel withFontProvider:&stru_101321380];
    ...
    +[DynamicTypeWizard autorefreshLabel:v3->_contentLabel withFontProvider:&stru_101321340];
...
- (void)clearHeightConstraint
{
  id v2 = [(NoRecentlySearchCollectionViewCell *)self heightConstraint];
  [v2 setActive:0];
}
...
- (void)_contentSizeCategoryDidChange
{
  ...
  id v12 = [(NoRecentlySearchCollectionViewCell *)self titleLabel];
  v8 = [v12 font];
...
- (void)setHeightConstraint:(double)a3 withPriority:(float)a4
{
  uint64_t v7 = [(NoRecentlySearchCollectionViewCell *)self heightConstraint];
  if (v7)
  {
    v8 = (void *)v7;
    double v9 = [(NoRecentlySearchCollectionViewCell *)self heightConstraint];
    [v9 priority];
    if (v10 == a4)
    {
    }
  ...
  if (v14)
  {
    ...
    id v25 = [(NoRecentlySearchCollectionViewCell *)self heightConstraint];
    *(float *)&double v19 = a4;
    [v25 setPriority:v19];
  }
  else
