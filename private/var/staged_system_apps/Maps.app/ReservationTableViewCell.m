...
- (void)loadDetailView
{
  ...
  id v8 = [(ReservationTableViewCell *)self detailLabel];
...
- (void)setupTextVerticalConstraints
{
  ...
  objc_super v15 = [(ReservationTableViewCell *)self titleLabel];
...
- (void)updateLabels
{
  ...
  id v6 = [(ReservationTableViewCell *)self detailText];
  v5 = [(ReservationTableViewCell *)self detailLabel];
  [v5 setText:v6];
}
...
{
  id v4 = a3;
  id v5 = [(ReservationTableViewCell *)self detailLabel];
  [v5 setTextColor:v4];
}
...
{
  id v4 = a3;
  id v5 = [(ReservationTableViewCell *)self titleLabel];
  [v5 setTextColor:v4];
}
