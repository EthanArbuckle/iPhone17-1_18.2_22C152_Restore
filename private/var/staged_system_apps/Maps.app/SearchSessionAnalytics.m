...
@implementation SearchSessionAnalytics

- (id)debugDescription
{
  uint64_t v3 = [(SearchSessionAnalytics *)self action];
  if ((int)v3 > 4000)
  {
    if ((int)v3 <= 10100)
    {
...
LABEL_46:
  ...
  uint64_t v5 = [(SearchSessionAnalytics *)self target];
  if ((int)v5 > 1000)
  {
    if ((int)v5 > 1600)
    {
...
LABEL_1353:
  ...
  v7 = +[NSString stringWithFormat:@"<Action: %@: Target: %@>", v4, v6];
