...
- (void)browseCategoryTapped:(id)a3;
...
- (SearchHomeAnalyticsManager)initWithSearchAlongRoute:(BOOL)a3
{
  BOOL v3 = a3;
  v6.receiver = self;
  v6.super_class = (Class)SearchHomeAnalyticsManager;
  ...
  if (result)
  {
    ...
    result->_curatedCollectionEvent.target = v5;
    result->_browseCategoryEvent.action = 2030;
    result->_browseCategoryEvent.target = v5;
    result->_recentEvent.action = 2025;
    result->_recentEvent.target = v5;
  }
  return result;
}
...
- (void)curatedCollectionsTappedWithMuid:(unint64_t)a3 horizontalIndex:(unint64_t)a4 isCurrentlySaved:(BOOL)a5
{
  ...
  value = self->_curatedCollectionEvent.value;
  self->_curatedCollectionEvent.value = (NSString *)@"Featured";
...
{
  [(SearchHomeAnalyticsManager *)self cleanup];
  self->_curatedCollectionEvent.action = 9038;
...
{
  [(SearchHomeAnalyticsManager *)self cleanup];
  self->_curatedCollectionEvent.action = 180;
...
{
  [(SearchHomeAnalyticsManager *)self cleanup];
  self->_curatedCollectionEvent.action = 210;
...
- (id)curatedCollectionEventDebugDescription
{
  int action = self->_curatedCollectionEvent.action;
  if (action > 4000)
  {
    if (action <= 10100)
    {
      ...
      if (action <= 16000)
      {
        ...
        else
        {
          switch(action)
          {
            ...
            default:
LABEL_46:
              v4 = +[NSString stringWithFormat:@"(unknown: %i)", self->_curatedCollectionEvent.action];
              break;
          }
        }
      }
  ...
  int target = self->_curatedCollectionEvent.target;
  if (target > 1000)
  {
    if (target > 1600)
    {
      ...
      {
        case 1700:
          objc_super v6 = @"LOOK_AROUND_PIP";
          break;
        case 1701:
          objc_super v6 = @"LOOK_AROUND_ACTION_SHEET";
          break;
        case 1702:
          objc_super v6 = @"LOOK_AROUND_VIEW";
          break;
        case 1703:
          objc_super v6 = @"LOOK_AROUND_PLATTER";
          break;
        case 1704:
          objc_super v6 = @"LOOK_AROUND_PIP_UNAVAILABLE_ZOOM";
          break;
        case 1705:
          objc_super v6 = @"LOOK_AROUND_PIP_UNAVAILABLE_REGION";
          break;
        case 1706:
          objc_super v6 = @"LOOK_AROUND_VIEW_PLACECARD";
          break;
        case 1707:
          objc_super v6 = @"LOOK_AROUND_PIP_PLACECARD";
          break;
        case 1708:
          objc_super v6 = @"OFFLINE_BROWSE_ONLY_SEARCH_TRAY";
          break;
        default:
          if (target == 1601)
          {
            objc_super v6 = @"MENU_ITEM_DARK_MAP";
          }
          else
          {
LABEL_1353:
            objc_super v6 = +[NSString stringWithFormat:@"(unknown: %i)", self->_curatedCollectionEvent.target];
          }
          break;
      }
    }
    else
    {
      ...
      {
        case 1001:
          objc_super v6 = @"CARPLAY_NAV";
          break;
        case 1002:
          objc_super v6 = @"CARPLAY_EXPLORE";
          break;
        case 1003:
          objc_super v6 = @"CARPLAY_DESTINATIONS";
          break;
        case 1004:
          objc_super v6 = @"CARPLAY_TRAFFIC_INCIDENT";
          break;
        case 1005:
          objc_super v6 = @"CARPLAY_CONTROL";
          break;
        case 1006:
          objc_super v6 = @"CARPLAY_PROACTIVE";
          break;
        case 1007:
          objc_super v6 = @"CARPLAY_ROUTING";
          break;
        case 1008:
          objc_super v6 = @"CARPLAY_MORE_ROUTES";
          break;
        case 1009:
          objc_super v6 = @"CARPLAY_SEARCH_ALONG_ROUTE";
          break;
        case 1010:
          objc_super v6 = @"CARPLAY_SEARCH";
          break;
        case 1011:
          objc_super v6 = @"CARPLAY_SEARCH_RESULTS";
          break;
        case 1012:
          objc_super v6 = @"CARPLAY_FAVORITES";
          break;
        case 1013:
          objc_super v6 = @"CARPLAY_NAV_CONFIRMATION";
          break;
        case 1014:
          objc_super v6 = @"CARPLAY_DESTINATION_SHARING";
          break;
        case 1015:
          objc_super v6 = @"CARPLAY_NOTIFICATION_BATTERY";
          break;
        case 1016:
          objc_super v6 = @"CARPLAY_NOTIFICATION_DOOM";
          break;
        case 1017:
          objc_super v6 = @"CARPLAY_NOTIFICATION_FUEL";
          break;
        case 1018:
          objc_super v6 = @"CARPLAY_NOTIFICATION_HYBRID";
          break;
        case 1019:
          objc_super v6 = @"CARPLAY_SHARE_ETA_TRAY";
          break;
        case 1020:
          objc_super v6 = @"CARPLAY_ETA_UPDATE_TRAY";
          break;
        case 1021:
          objc_super v6 = @"CARPLAY_ACTION_TRAY";
          break;
        case 1022:
          objc_super v6 = @"CARPLAY_PLACECARD";
          break;
        case 1023:
          objc_super v6 = @"CARPLAY_KEYBOARD";
          break;
        case 1024:
          objc_super v6 = @"CARPLAY_UI_TARGET_UNKNOWN";
          break;
        case 1025:
          objc_super v6 = @"CARPLAY_EDIT_STOPS";
          break;
        case 1026:
        case 1027:
        case 1028:
        ...
        case 1300:
          goto LABEL_1353;
        case 1100:
          objc_super v6 = @"RAP_DIRECTIONS_MENU";
          break;
        case 1101:
          objc_super v6 = @"RAP_DIRECTIONS_INSTRUCTIONS_INCORRECT_LIST";
          break;
        case 1102:
          objc_super v6 = @"RAP_DIRECTIONS_INSTRUCTIONS_INCORRECT_DETAILS_FORM";
          break;
        case 1103:
          objc_super v6 = @"RAP_DIRECTIONS_BETTER_ROUTE_AVAILABLE_FORM";
          break;
        case 1104:
          objc_super v6 = @"RAP_DIRECTIONS_ESTIMATED_TIME_INCORRECT_FORM";
          break;
        case 1105:
          objc_super v6 = @"RAP_DIRECTIONS_ARRIVAL_ENTRY_POINT_INCORRECT_FORM";
          break;
        case 1106:
          objc_super v6 = @"RAP_TRANSIT_MENU";
          break;
        case 1107:
          objc_super v6 = @"RAP_STATION_MAP";
          break;
        case 1108:
          objc_super v6 = @"RAP_STATION_MENU";
          break;
        case 1109:
          objc_super v6 = @"RAP_STATION_ENTRANCE_EXIT_INCORRECT_MAP";
          break;
        case 1110:
          objc_super v6 = @"RAP_STATION_ENTRANCE_EXIT_INCORRECT_FORM";
          break;
        case 1111:
          objc_super v6 = @"RAP_STATION_CLOSED_FORM";
          break;
        case 1112:
          objc_super v6 = @"RAP_LINE_MAP";
          break;
        case 1113:
          objc_super v6 = @"RAP_LINE_MENU";
          break;
        case 1114:
          objc_super v6 = @"RAP_LINE_NAME_FORM";
          break;
        case 1115:
          objc_super v6 = @"RAP_LINE_SHAPE_FORM";
          break;
        case 1116:
          objc_super v6 = @"RAP_LINE_SCHEDULE_INCORRECT_FORM";
          break;
        case 1117:
          objc_super v6 = @"RAP_ADD_PLACE_MENU";
          break;
        case 1118:
          objc_super v6 = @"RAP_ADD_POI_MAP";
          break;
        case 1119:
          objc_super v6 = @"RAP_CATEGORY_LIST";
          break;
        case 1120:
          objc_super v6 = @"RAP_POI_DETAILS_FORM";
          break;
        case 1121:
          objc_super v6 = @"RAP_ADD_STREET_MAP";
          break;
        case 1122:
          objc_super v6 = @"RAP_STREET_DETAILS_FORM";
          break;
        case 1123:
          objc_super v6 = @"RAP_ADD_OTHER_MAP";
          break;
        case 1124:
          objc_super v6 = @"RAP_OTHER_DETAILS_FORM";
          break;
        case 1125:
          objc_super v6 = @"RAP_CAMERA";
          break;
        case 1126:
          objc_super v6 = @"RAP_LABEL_MAP";
          break;
        case 1127:
          objc_super v6 = @"RAP_LABEL_DETAILS_FORM";
          break;
        case 1128:
          objc_super v6 = @"RAP_SEARCH_MENU";
          break;
        case 1129:
          objc_super v6 = @"RAP_SEARCH_UNEXPECTED_RESULT_FORM";
          break;
        case 1130:
          objc_super v6 = @"RAP_SEARCH_ADDRESS_INCORRECT_FORM";
          break;
        case 1131:
          objc_super v6 = @"RAP_SEARCH_LOCATION_INCORRECT_MAP";
          break;
        case 1132:
          objc_super v6 = @"RAP_SEARCH_LOCATION_INCORRECT_DETAILS_FORM";
          break;
        case 1133:
          objc_super v6 = @"RAP_SATELLITE_IMAGE_MAP";
          break;
        case 1134:
          objc_super v6 = @"RAP_SATELLITE_IMAGE_DETAILS_FORM";
          break;
        case 1135:
          objc_super v6 = @"RAP_OTHER_FORM";
          break;
        case 1136:
          objc_super v6 = @"RAP_PRIVACY";
          break;
        case 1137:
          objc_super v6 = @"RAP_CONFIRMATION";
          break;
        case 1138:
          objc_super v6 = @"RAP_POI_MENU";
          break;
        case 1139:
          objc_super v6 = @"RAP_SEARCH_AUTOCOMPLETE_MENU";
          break;
        case 1140:
          objc_super v6 = @"RAP_ADD_A_PLACE_MAP";
          break;
        case 1141:
          objc_super v6 = @"RAP_POI_LOCATION_MAP";
          break;
        case 1142:
          objc_super v6 = @"RAP_DIRECTIONS_ARRIVAL_ENTRY_POINT_INCORRECT_MAP";
          break;
        case 1143:
          objc_super v6 = @"RAP_POI_CLOSED_FORM";
          break;
        case 1144:
          objc_super v6 = @"RAP_CLAIM_BUSINESS_DIALOG";
          break;
        case 1145:
          objc_super v6 = @"RAP_BRAND_MENU";
          break;
        case 1146:
          objc_super v6 = @"RAP_BRAND_DETAILS_FORM";
          break;
        case 1147:
          objc_super v6 = @"RAP_LOOK_AROUND_IMAGE_QUALITY_FORM";
          break;
        case 1148:
          objc_super v6 = @"RAP_LOOK_AROUND_LABELS_STREET_FORM";
          break;
        case 1149:
          objc_super v6 = @"RAP_LOOK_AROUND_BLURRING_FORM";
          break;
        case 1150:
          objc_super v6 = @"RAP_LOOK_AROUND_REMOVE_HOME_FORM";
          break;
        case 1151:
          objc_super v6 = @"RAP_LOOK_AROUND_MENU";
          break;
        case 1152:
          objc_super v6 = @"RAP_LOOK_AROUND_LABELS_STORE_FORM";
          break;
        case 1153:
          objc_super v6 = @"RAP_LOOK_AROUND_PRIVACY_MENU";
          break;
        case 1154:
          objc_super v6 = @"RAP_LIGHTWEIGHT";
          break;
        case 1155:
          objc_super v6 = @"RAP_EDIT_PLACE_DETAILS";
          break;
        case 1156:
          objc_super v6 = @"RAP_ADD_CATEGORY";
          break;
        case 1157:
          objc_super v6 = @"RAP_ADD_HOURS";
          break;
        case 1158:
          objc_super v6 = @"RAP_EDIT_LOCATION";
          break;
        case 1159:
          objc_super v6 = @"RAP_EDIT_ENTRY_POINT";
          break;
        case 1160:
          objc_super v6 = @"RAP_LOOK_AROUND";
          break;
        case 1161:
          objc_super v6 = @"RAP_ADD_ENTRY_POINT";
          break;
        case 1201:
          objc_super v6 = @"WATCH_MAIN_MENU";
          break;
        case 1202:
          objc_super v6 = @"WATCH_MAIN_PRESS_MENU";
          break;
        case 1203:
          objc_super v6 = @"WATCH_SEARCH";
          break;
        case 1204:
          objc_super v6 = @"WATCH_DICTATION";
          break;
        case 1205:
          objc_super v6 = @"WATCH_FAVORITES";
          break;
        case 1206:
          objc_super v6 = @"WATCH_SUB_CATEGORY_LIST";
          break;
        case 1207:
          objc_super v6 = @"WATCH_SEARCH_RESULTS_LIST";
          break;
        case 1208:
          objc_super v6 = @"WATCH_MAP_VIEW";
          break;
        case 1209:
          objc_super v6 = @"WATCH_PLACECARD";
          break;
        case 1210:
          objc_super v6 = @"WATCH_ROUTE_PLANNING";
          break;
        case 1211:
          objc_super v6 = @"WATCH_ROUTE_DETAILS";
          break;
        case 1212:
          objc_super v6 = @"WATCH_NAV_TBT";
          break;
        case 1213:
          objc_super v6 = @"WATCH_NAV_MAP";
          break;
        case 1214:
          objc_super v6 = @"WATCH_NAV_PRESS_MENU";
          break;
        case 1215:
          objc_super v6 = @"WATCH_MAP_PRESS_MENU";
          break;
        case 1216:
          objc_super v6 = @"WATCH_ROUTING_PRESS_MENU";
          break;
        case 1217:
          objc_super v6 = @"WATCH_TRANSIT_MAP_VIEW";
          break;
        case 1218:
          objc_super v6 = @"WATCH_SCRIBBLE";
          break;
        case 1219:
          objc_super v6 = @"WATCH_COLLECTION_VIEW";
          break;
        case 1220:
          objc_super v6 = @"WATCH_ROUTE_PLANNING_WALKING";
          break;
        case 1221:
          objc_super v6 = @"WATCH_ROUTE_PLANNING_DRIVING";
          break;
        case 1222:
          objc_super v6 = @"WATCH_ROUTE_PLANNING_TRANSIT";
          break;
        case 1223:
          objc_super v6 = @"WATCH_PAIRED_DEVICE";
          break;
        case 1224:
          objc_super v6 = @"WATCH_NAV_DRIVING_SPLIT";
          break;
        case 1225:
          objc_super v6 = @"WATCH_NAV_DRIVING_PLATTER";
          break;
        case 1226:
          objc_super v6 = @"WATCH_NAV_DRIVING_MAP";
          break;
        case 1227:
          objc_super v6 = @"WATCH_NAV_WALKING_SPLIT";
          break;
        case 1228:
          objc_super v6 = @"WATCH_NAV_WALKING_PLATTER";
          break;
        case 1229:
          objc_super v6 = @"WATCH_NAV_WALKING_MAP";
          break;
        case 1230:
          objc_super v6 = @"WATCH_NAV_TRANSIT_SPLIT";
          break;
        case 1231:
          objc_super v6 = @"WATCH_NAV_TRANSIT_PLATTER";
          break;
        case 1232:
          objc_super v6 = @"WATCH_NAV_TRANSIT_MAP";
          break;
        case 1233:
          objc_super v6 = @"WATCH_ROUTE_INFO";
          break;
        case 1234:
          objc_super v6 = @"WATCH_NAV_CYCLING_MAP";
          break;
        case 1235:
          objc_super v6 = @"WATCH_NAV_CYCLING_PLATTER";
          break;
        case 1236:
          objc_super v6 = @"WATCH_NAV_CYCLING_SPLIT";
          break;
        case 1237:
          objc_super v6 = @"WATCH_ROUTE_PLANNING_CYCLING";
          break;
        case 1238:
          objc_super v6 = @"WATCH_SEARCH_INPUT";
          break;
        case 1239:
          objc_super v6 = @"WATCH_SIRI_SUGGESTION_RESUME_MULTIPOINT_ROUTE";
          break;
        case 1240:
          objc_super v6 = @"WATCH_SIRI_SUGGESTION_RESUME_ROUTE";
          break;
        case 1301:
          objc_super v6 = @"PERSONALIZED_ADDRESS_LIST";
          break;
        case 1302:
          objc_super v6 = @"PERSONALIZED_ADDRESS_FORM";
          break;
        case 1303:
          objc_super v6 = @"PERSONALIZED_LABEL_FORM";
          break;
        case 1304:
          objc_super v6 = @"PERSONALIZED_EDIT_MAP";
          break;
        case 1305:
          objc_super v6 = @"PERSONALIZED_CONFIRMATION";
          break;
        case 1306:
          objc_super v6 = @"PERSONALIZED_ADDRESS_DELETE_DIALOG";
          break;
        case 1307:
          objc_super v6 = @"PERSONALIZED_ADDRESS_INFO";
          break;
        case 1308:
          objc_super v6 = @"PERSONALIZED_ADDRESS_SEARCH";
          break;
        case 1309:
          objc_super v6 = @"PERSONALIZED_ADDRESS_SEARCH_RESULTS";
          break;
        case 1310:
          objc_super v6 = @"FAVORITE_SEARCH";
          break;
        case 1311:
          objc_super v6 = @"FAVORITE_LIST";
          break;
        case 1312:
          objc_super v6 = @"FAVORITE_INFO";
          break;
        case 1313:
          objc_super v6 = @"PERSONALIZED_CONFIRMATION_WITH_PRIVACY";
          break;
        default:
          switch(target)
          {
            case 1401:
              objc_super v6 = @"ROUTING_TRAY_RIDESHARE_RIDE_OPTIONS";
              break;
            case 1402:
              objc_super v6 = @"ROUTING_TRAY_RIDESHARE_DETAILS_PICKING";
              break;
            case 1403:
              objc_super v6 = @"ROUTING_TRAY_RIDESHARE_CONFIRMATION_REQUESTING";
              break;
            case 1404:
              objc_super v6 = @"ROUTING_TRAY_RIDESHARE_CONFIRMATION_CONFIRMED";
              break;
            case 1405:
              objc_super v6 = @"ROUTING_TRAY_RIDESHARE_SURGE_PRICING_DIALOG";
              break;
            case 1406:
              objc_super v6 = @"ROUTING_TRAY_RIDESHARE_FEEDBACK";
              break;
            case 1407:
              objc_super v6 = @"ROUTING_TRAY_RIDESHARE_ENABLE_ALL";
              break;
            default:
              switch(target)
              {
                case 1501:
                  objc_super v6 = @"PLACECARD_HEADER";
                  break;
                case 1502:
                  objc_super v6 = @"PLACECARD_ADDRESS";
                  break;
                case 1503:
                  objc_super v6 = @"PLACECARD_PHONE";
                  break;
                case 1504:
                  objc_super v6 = @"PLACECARD_URL";
                  break;
                default:
                  goto LABEL_1353;
              }
  ...
  {
    objc_super v6 = @"UI_TARGET_UNKNOWN";
    switch(target)
    {
      case 0:
        break;
      case 1:
        objc_super v6 = @"UI_TARGET_POI";
        break;
      case 2:
        objc_super v6 = @"UI_TARGET_SEARCH_RESULT_LIST";
        break;
      case 3:
        objc_super v6 = @"UI_TARGET_POPULAR_NEARBY_LIST";
        break;
      case 4:
        objc_super v6 = @"UI_TARGET_CALLOUT";
        break;
      case 5:
        objc_super v6 = @"UI_TARGET_SEARCH_PIN";
        break;
      case 6:
        objc_super v6 = @"UI_TARGET_DROPPED_PIN";
        break;
      case 7:
        objc_super v6 = @"UI_TARGET_TRANSIT_LINE";
        break;
      case 8:
        objc_super v6 = @"SEARCH_TRAY";
        break;
      case 9:
        objc_super v6 = @"SEARCH_TRAY_BROWSE";
        break;
      case 10:
        objc_super v6 = @"SEARCH_TRAY_POPULAR_NEARBY";
        break;
      case 11:
        objc_super v6 = @"SEARCH_TRAY_AC";
        break;
      case 12:
        objc_super v6 = @"SEARCH_TRAY_AC_INTERMEDIATE";
        break;
      case 13:
        objc_super v6 = @"SEARCH_TRAY_NO_QUERY";
        break;
      case 14:
        objc_super v6 = @"AR_WALKING_LEGAL_TRAY";
        break;
      case 15:
        objc_super v6 = @"RAISE_TO_START_AR_TRAY";
        break;
      case 16:
        objc_super v6 = @"EVENTS_ADVISORY_DETAILS_PAGE";
        break;
      case 17:
        objc_super v6 = @"INCIDENT_REPORT_TRAY_CARPLAY";
        break;
      case 18:
        objc_super v6 = @"HIGHLIGHTED_AREA";
        break;
      case 19:
        objc_super v6 = @"CURATED_COLLECTIONS_HOME";
        break;
      case 20:
        objc_super v6 = @"TRAVEL_PREFERENCES_TRAY";
        break;
      case 21:
        objc_super v6 = @"RESULT_TRAY_SEARCH";
        break;
      case 22:
        objc_super v6 = @"SINGLE_CARD_FILTER";
        break;
      case 23:
        objc_super v6 = @"FULL_CARD_FILTER";
        break;
      case 24:
        objc_super v6 = @"ACCOUNT_PRIVACY_TRAY";
        break;
      case 25:
        objc_super v6 = @"APPLE_RATINGS_HISTORY_TRAY";
        break;
      case 26:
        objc_super v6 = @"CURATED_COLLECTIONS_HOME_FILTERED";
        break;
      case 27:
        objc_super v6 = @"CITY_MENU";
        break;
      case 28:
        objc_super v6 = @"CURATED_COLLECTIONS_HOME_CONDENSED";
        break;
      case 29:
        objc_super v6 = @"ACCOUNT_TRAY";
        break;
      case 30:
        objc_super v6 = @"QUICK_ACTION_TRAY";
        break;
      case 31:
        objc_super v6 = @"SUBMIT_TRIP_FEEDBACK";
        break;
      case 32:
        objc_super v6 = @"RAP_PLACE_ISSUE_DETAILS";
        break;
      case 33:
        objc_super v6 = @"RAP_GUIDES_DETAILS";
        break;
      case 34:
        objc_super v6 = @"RAP_BAD_DIRECTIONS_DETAILS";
        break;
      case 35:
        objc_super v6 = @"RAP_ADD_MAP_DETAILS";
        break;
      case 36:
        objc_super v6 = @"WATCH_COMPLICATION";
        break;
      case 37:
        objc_super v6 = @"RAP_NAV_MENU";
        break;
      case 38:
        objc_super v6 = @"NOTIFICATION_ALIGHT_BANNER_TRANSIT";
        break;
      case 39:
        objc_super v6 = @"RAP_REPORT_MENU";
        break;
      case 40:
        objc_super v6 = @"RAP_CURATED_COLLECTION_MENU";
        break;
      case 41:
        objc_super v6 = @"RAP_REPORT_CARD_DETAILS";
        break;
      case 42:
        objc_super v6 = @"NOTIFICATION_NO_LOCATION_TRANSIT";
        break;
      case 43:
        objc_super v6 = @"RAP_STREET_ISSUE_DETAILS";
        break;
      case 44:
        objc_super v6 = @"NEARBY_TRANSIT_CARD";
        break;
      case 45:
        objc_super v6 = @"WATCH_NAV_MENU";
        break;
      case 46:
        objc_super v6 = @"GENERIC_ADVISORY_PAGE";
        break;
      case 47:
        objc_super v6 = @"USER_PROFILE_TRAY";
        break;
      case 48:
        objc_super v6 = @"MEDIA_APP_MENU";
        break;
      case 49:
        objc_super v6 = @"TEMPLATE_PLACE_TRAY";
        break;
      case 50:
        objc_super v6 = @"NOTIFICATION_CONSENT_REPROMPT_RAP";
        break;
      case 51:
        objc_super v6 = @"ALLOW_NOTIFICATION_DIALOG";
        break;
      case 52:
        objc_super v6 = @"NOTIFICATION_CONSENT_REPROMPT_DRIVING";
        break;
      case 53:
        objc_super v6 = @"NOTIFICATION_CONSENT_REPROMPT_ARP";
        break;
      case 54:
        objc_super v6 = @"NOTIFICATION_CONSENT_REPROMPT_TIME_ELAPSED";
        break;
      case 55:
        objc_super v6 = @"NOTIFICATION_CONSENT_PROMPT";
        break;
      case 56:
        objc_super v6 = @"QUICK_ACTION_TRAY_VENDORS_MENU";
        break;
      case 57:
        objc_super v6 = @"PLACECARD_TRAY_VENDORS_MENU";
        break;
      case 58:
        objc_super v6 = @"RESULTS_TRAY_SEARCH_ROUTE_PLANNING";
        break;
      case 59:
        objc_super v6 = @"SEARCH_ALONG_ROUTE_TRAY";
        break;
      case 60:
        objc_super v6 = @"MAP_RESULTS_SEARCH_ROUTE_PLANNING";
        break;
      case 61:
        objc_super v6 = @"PLACECARD_SHOWCASE_MENU";
        break;
      case 62:
        objc_super v6 = @"RAP_INLINE_ADD_DETAILS";
        break;
      case 63:
        objc_super v6 = @"RAP_EDIT_MENU_DETAILS";
        break;
      case 64:
        objc_super v6 = @"RAP_SUBMISSION_PROMPT";
        break;
      case 65:
        objc_super v6 = @"RAP_PLACECARD_EDIT_MENU";
        break;
      case 66:
        objc_super v6 = @"ARP_SUBMISSION_CONFIRMATION_PAGE";
        break;
      case 67:
        objc_super v6 = @"INCIDENT_REPORT_MENU";
        break;
      case 68:
        objc_super v6 = @"RAP_SELECT_BAD_ROUTES_STEPS";
        break;
      case 69:
        objc_super v6 = @"RAP_SELECT_BAD_ROUTES";
        break;
      case 70:
        objc_super v6 = @"SIRI_SUGGESTION_RESUME_ROUTE";
        break;
      case 71:
        objc_super v6 = @"SIRI_SUGGESTION_RESUME_MULTIPOINT_ROUTE";
        break;
      case 72:
        objc_super v6 = @"SPOTLIGHT_BUSINESS_ENTITY_LIST";
        break;
      case 73:
        objc_super v6 = @"SPOTLIGHT_BUSINESS_ENTITY";
        break;
      case 74:
        objc_super v6 = @"NOTIFICATION_ARP";
        break;
      case 75:
        objc_super v6 = @"IMPROVE_LOCATION_ACCURACY_PROMPT";
        break;
      case 76:
        objc_super v6 = @"YOUR_PHOTOS_ALBUM";
        break;
      case 77:
        objc_super v6 = @"ARP_PHOTO_CREDIT";
        break;
      case 78:
        objc_super v6 = @"RAP_OUTREACH_REVIEWED_REPORT";
        break;
      case 79:
        objc_super v6 = @"RAP_REPORT_MENU_MORE";
        break;
      case 80:
        objc_super v6 = @"WATCH_MAPS_SETTINGS";
        break;
      case 81:
        objc_super v6 = @"OFFLINE_FEATURE_PROMPT";
        break;
      case 82:
        objc_super v6 = @"EXPIRED_MAPS_DETAILS";
        break;
      case 83:
        objc_super v6 = @"MAPS_VIEW";
        break;
      case 84:
        objc_super v6 = @"NOTIFICATION_OFFLINE";
        break;
      case 85:
        objc_super v6 = @"EXPIRED_MAPS_MANAGEMENT";
        break;
      case 86:
        objc_super v6 = @"OFFLINE_NEW_MAPS_MANAGEMENT";
        break;
      case 87:
        objc_super v6 = @"EDIT_EXPIRED_MAPS_MANAGEMENT";
        break;
      case 88:
        objc_super v6 = @"OFFLINE_MAPS_MANAGEMENT";
        break;
      case 89:
        objc_super v6 = @"REGION_SELECTOR";
        break;
      case 90:
        objc_super v6 = @"OFFLINE_SUGGESTED_MAPS_MANAGEMENT";
        break;
      case 91:
        objc_super v6 = @"FIND_MY_ETA_SHARING_TRAY";
        break;
      case 92:
        objc_super v6 = @"WATCH_PLACE";
        break;
      case 93:
        objc_super v6 = @"WATCH_ROUTE_PLANNING_TRANSIT_CAROUSEL";
        break;
      case 94:
        objc_super v6 = @"WATCH_ROUTE_PLANNING_MAP";
        break;
      case 95:
        objc_super v6 = @"WATCH_NAV_WALKING_CONTROLS";
        break;
      case 96:
        objc_super v6 = @"WATCH_NAV_CYCLING_CONTROLS";
        break;
      case 97:
        objc_super v6 = @"WATCH_ROUTE_PLANNING_WALKING_CAROUSEL";
        break;
      case 98:
        objc_super v6 = @"WATCH_NAV_TRANSIT_CONTROLS";
        break;
      case 99:
        objc_super v6 = @"WATCH_SEARCH_RESULTS_CAROUSEL";
        break;
      case 100:
        objc_super v6 = @"WATCH_NAV_DRIVING_CONTROLS";
        break;
      case 101:
        objc_super v6 = @"RESULTS_TRAY_SEARCH";
        break;
      case 102:
        objc_super v6 = @"RESULTS_TRAY_BROWSE";
        break;
      case 103:
        objc_super v6 = @"RESULTS_TRAY_FAVORITES";
        break;
      case 104:
        objc_super v6 = @"RESULTS_TRAY_SEARCH_ALONG_ROUTE";
        break;
      case 105:
        objc_super v6 = @"RESULTS_TRAY_CLUSTER";
        break;
      case 106:
        objc_super v6 = @"RESULTS_TRAY_VENUE_BROWSE";
        break;
      case 107:
        objc_super v6 = @"WATCH_MAP_RESULTS";
        break;
      case 108:
        objc_super v6 = @"WATCH_NAV_WALKING_ELEVATION_VIEW";
        break;
      case 109:
        objc_super v6 = @"WATCH_PLACES";
        break;
      case 110:
        objc_super v6 = @"WATCH_NAV_CYCLING_ELEVATION_VIEW";
        break;
      case 111:
        objc_super v6 = @"WATCH_ROUTE_PLANNING_CYCLING_CAROUSEL";
        break;
      case 112:
        objc_super v6 = @"DOWNLOADED_MAPS_DETAILS";
        break;
      case 113:
        objc_super v6 = @"WATCH_ROUTE_PLANNING_DRIVING_CAROUSEL";
        break;
      case 114:
        objc_super v6 = @"WATCH_NAV_TRANSIT_OVERVIEW_MAP";
        break;
      case 115:
        objc_super v6 = @"WATCH_NAV_WALKING_OVERVIEW_MAP";
        break;
      case 116:
        objc_super v6 = @"WATCH_NAV_CYCLING_OVERVIEW_MAP";
        break;
      case 117:
        objc_super v6 = @"WATCH_ROUTE_OPTIONS";
        break;
      case 118:
        objc_super v6 = @"WATCH_NAV_DRIVING_OVERVIEW_MAP";
        break;
      case 119:
        objc_super v6 = @"WATCH_MORE_GUIDES";
        break;
      case 120:
        objc_super v6 = @"WATCH_RECENTLY_VIEWED";
        break;
      case 121:
        objc_super v6 = @"EV_SUCCESS_TRAY";
        break;
      case 122:
        objc_super v6 = @"PREFERRED_NETWORK_SELECTION_TRAY";
        break;
      case 123:
        objc_super v6 = @"PREFERRED_NETWORK_TRAY";
        break;
      case 124:
        objc_super v6 = @"WALKING_TRANSITION_SUGGESTION_TRAY";
        break;
      case 125:
        objc_super v6 = @"FINDMY_TRANSITION_SUGGESTION_TRAY";
        break;
      case 126:
        objc_super v6 = @"CARPLAY_FIND_MY_ETA_SHARING_TRAY";
        break;
      case 127:
        objc_super v6 = @"AC_KEYBOARD_TRAY";
        break;
      case 128:
        objc_super v6 = @"MORE_RELATED_TRAILS";
        break;
      case 129:
        objc_super v6 = @"MORE_RELATED_TRAILHEADS";
        break;
      case 130:
        objc_super v6 = @"ROUTING_TRAY_CUSTOM_ROUTE";
        break;
      case 131:
        objc_super v6 = @"CUSTOM_ROUTE_CREATION_TRAY";
        break;
      case 132:
        objc_super v6 = @"ROUTING_TRAY_CURATED_HIKE";
        break;
      case 133:
        objc_super v6 = @"MORE_CURATED_HIKES";
        break;
      case 134:
        objc_super v6 = @"CUSTOM_ROUTE_ONBOARDING";
        break;
      case 135:
        objc_super v6 = @"LIBRARY_ROUTES";
        break;
      case 136:
        objc_super v6 = @"HIKING_TRANSITION_SUGGESTION_TRAY";
        break;
      case 137:
        objc_super v6 = @"MY_LIBRARY";
        break;
      case 138:
        objc_super v6 = @"EDIT_NOTE_TRAY";
        break;
      case 139:
        objc_super v6 = @"CREATE_NOTE_TRAY";
        break;
      case 140:
        objc_super v6 = @"LIBRARY_PLACES";
        break;
      case 141:
        objc_super v6 = @"WATCH_ACCOUNT";
        break;
      case 142:
        objc_super v6 = @"WATCH_DOWNLOADED_MAPS";
        break;
      case 143:
        objc_super v6 = @"VISUAL_INTELLIGENCE_DETECTION_LIST";
        break;
      case 144:
        objc_super v6 = @"VISUAL_INTELLIGENCE_DETECTION";
        break;
      case 145:
        objc_super v6 = @"VISUAL_INTELLIGENCE_SNIPPET";
        break;
      case 146:
      case 147:
      case 148:
      ...
      case 800:
        goto LABEL_1353;
      case 201:
        objc_super v6 = @"PLACECARD_TRAY";
        break;
      case 202:
        objc_super v6 = @"WEB_MODULE";
        break;
      case 250:
        objc_super v6 = @"ADD_FAVORITE_TRAY";
        break;
      case 251:
        objc_super v6 = @"COLLECTION_LIST";
        break;
      case 252:
        objc_super v6 = @"COLLECTION_VIEW";
        break;
      case 253:
        objc_super v6 = @"FAVORITE_DETAILS";
        break;
      case 254:
        objc_super v6 = @"FAVORITES_TRAY";
        break;
      case 255:
        objc_super v6 = @"SHARED_COLLECTION";
        break;
      case 256:
        objc_super v6 = @"SHARED_COLLECTION_VIEW";
        break;
      case 257:
        objc_super v6 = @"RECENTLY_VIEWED";
        break;
      case 258:
        objc_super v6 = @"SHARED_WEB_COLLECTION";
        break;
      case 259:
        objc_super v6 = @"CURATED_COLLECTION_VIEW";
        break;
      case 260:
        objc_super v6 = @"FEATURED_COLLECTIONS";
        break;
      case 261:
        objc_super v6 = @"PUBLISHER_TRAY";
        break;
      case 262:
        objc_super v6 = @"SHARED_CURATED_COLLECTION_VIEW";
        break;
      case 263:
        objc_super v6 = @"CURATED_COLLECTION_NOTIFICATION";
        break;
      case 264:
        objc_super v6 = @"CURATED_COLLECTION_LIST";
        break;
      case 265:
        objc_super v6 = @"PUBLISHER_LIST";
        break;
      case 266:
        objc_super v6 = @"WATCH_CURATED_COLLECTION_VIEW";
        break;
      case 267:
        objc_super v6 = @"SIRI_SUGGESTION_SHARED_ETA_SUBLIST";
        break;
      case 268:
        objc_super v6 = @"SIRI_SUGGESTION_SHARED_ETA_CARPLAY_SUBLIST";
        break;
      case 301:
        objc_super v6 = @"ROUTING_TRAY_DRIVING";
        break;
      case 302:
        objc_super v6 = @"ROUTING_TRAY_WALKING";
        break;
      case 303:
        objc_super v6 = @"ROUTING_TRAY_TRANSIT";
        break;
      case 304:
        objc_super v6 = @"ROUTING_TRAY_RIDESHARE";
        break;
      case 305:
        objc_super v6 = @"ROUTING_TRAY_CYCLING";
        break;
      case 306:
        objc_super v6 = @"ROUTING_TRAY_VIRTUAL_GARAGE_VIEW";
        break;
      case 401:
        objc_super v6 = @"NAV_TRAY_DRIVING";
        break;
      case 402:
        objc_super v6 = @"NAV_TRAY_WALKING";
        break;
      case 403:
        objc_super v6 = @"NAV_TRAY_TRANSIT";
        break;
      case 404:
        objc_super v6 = @"NAV_TRAY_CYCLING";
        break;
      case 501:
        objc_super v6 = @"MAP_PLACECARD";
        break;
      case 502:
        objc_super v6 = @"MAP_SEARCH";
        break;
      case 503:
        objc_super v6 = @"MAP_RESULTS";
        break;
      case 504:
        objc_super v6 = @"MAP_ROUTING";
        break;
      case 505:
        objc_super v6 = @"MAP_NAV";
        break;
      case 506:
        objc_super v6 = @"MAP_RESULTS_SEARCH_ALONG_ROUTE";
        break;
      case 507:
        objc_super v6 = @"MAP_TRAFFIC_INCIDENT";
        break;
      case 508:
        objc_super v6 = @"MAP_FULL_SCREEN";
        break;
      case 509:
        objc_super v6 = @"MAP_DRIVE";
        break;
      case 510:
        objc_super v6 = @"MAP_LAUNCH_AND_GO";
        break;
      case 511:
        objc_super v6 = @"MAP_VIEW";
        break;
      case 601:
        objc_super v6 = @"MAPS_SETTINGS";
        break;
      case 602:
        objc_super v6 = @"MAPS_PREFERENCES";
        break;
      case 603:
        objc_super v6 = @"RAP";
        break;
      case 604:
        objc_super v6 = @"ROUTING_DRIVING_DETAILS";
        break;
      case 605:
        objc_super v6 = @"ROUTING_WALKING_DETAILS";
        break;
      case 606:
        objc_super v6 = @"ROUTING_TRANSIT_DETAILS";
        break;
      case 607:
        objc_super v6 = @"ROUTING_EDITOR";
        break;
      case 608:
        objc_super v6 = @"NAV_DRIVING_DETAILS";
        break;
      case 609:
        objc_super v6 = @"NAV_WALKING_DETAILS";
        break;
      case 610:
        objc_super v6 = @"NAV_TRANSIT_DETAILS";
        break;
      case 611:
        objc_super v6 = @"NAV_AUDIO_SETTINGS";
        break;
      case 612:
        objc_super v6 = @"PHOTO_VIEWER_ALL";
        break;
      case 613:
        objc_super v6 = @"PHOTO_VIEWER_SINGLE";
        break;
      case 614:
        objc_super v6 = @"ROUTE_OPTIONS_TRANSIT";
        break;
      case 615:
        objc_super v6 = @"TRAFFIC_INCIDENT_TRAY";
        break;
      case 616:
        objc_super v6 = @"NAV_DIRECTIONS_BANNER_DRIVING";
        break;
      case 617:
        objc_super v6 = @"NAV_DIRECTIONS_BANNER_WALKING";
        break;
      case 618:
        objc_super v6 = @"NAV_DIRECTIONS_BANNER_TRANSIT";
        break;
      case 619:
        objc_super v6 = @"REFINE_SEARCH_SUGGESTION_AREA";
        break;
      case 620:
        objc_super v6 = @"ADD_PHOTO_SHEET";
        break;
      case 621:
        objc_super v6 = @"ADD_PLACE_SHEET";
        break;
      case 622:
        objc_super v6 = @"SHARE_SHEET";
        break;
      case 623:
        objc_super v6 = @"EDIT_LOCATION_SHEET";
        break;
      case 624:
        objc_super v6 = @"ADD_CONTACT_SHEET";
        break;
      case 625:
        objc_super v6 = @"EDIT_NAME_SHEET";
        break;
      case 626:
        objc_super v6 = @"DRIVING_NAV_SETTINGS";
        break;
      case 627:
        objc_super v6 = @"TRANSIT_SETTINGS";
        break;
      case 628:
        objc_super v6 = @"TRANSIT_ADVISORY_SHEET";
        break;
      case 629:
        objc_super v6 = @"REMOVE_CAR_SHEET";
        break;
      case 630:
        objc_super v6 = @"ROUTE_OPTIONS_DRIVING";
        break;
      case 631:
        objc_super v6 = @"ROUTE_OPTIONS_DATETIME";
        break;
      case 632:
        objc_super v6 = @"TRANSIT_ADVISORY_BANNER";
        break;
      case 633:
        objc_super v6 = @"BOOK_TABLE_SELECT_TIME";
        break;
      case 634:
        objc_super v6 = @"BOOK_TABLE_MORE_OPTIONS";
        break;
      case 635:
        objc_super v6 = @"BOOK_TABLE_READY";
        break;
      case 636:
        objc_super v6 = @"BOOK_TABLE_BOOKED";
        break;
      case 637:
        objc_super v6 = @"TRANSIT_LINE_CLUSTER_SHEET";
        break;
      case 638:
        objc_super v6 = @"TRANSIT_LINE_LIST_SHEET";
        break;
      case 639:
        objc_super v6 = @"TRANSIT_BALANCE_BANNER";
        break;
      case 640:
        objc_super v6 = @"WEATHER_ICON";
        break;
      case 641:
        objc_super v6 = @"HELP_IMPROVE_MAPS_DIALOG";
        break;
      case 642:
        objc_super v6 = @"HELP_IMPROVE_COMMUTE_PREDICTION_ACCURACY_DIALOG";
        break;
      case 643:
        objc_super v6 = @"COMMUTE_PREDICTION_ACCURACY_DIALOG";
        break;
      case 644:
        objc_super v6 = @"FLOOR_PICKER";
        break;
      case 645:
        objc_super v6 = @"VENUE_LIST";
        break;
      case 646:
        objc_super v6 = @"AR_MODE";
        break;
      case 647:
        objc_super v6 = @"ROUTING_TRANSIT_TICKETS_SHEET";
        break;
      case 648:
        objc_super v6 = @"LINKED_SERVICE_HOURS";
        break;
      case 649:
        objc_super v6 = @"SHARE_ETA_TRAY";
        break;
      case 650:
        objc_super v6 = @"ETA_UPDATE_TRAY";
        break;
      case 651:
        objc_super v6 = @"SCHEDULECARD_TRAY";
        break;
      case 652:
        objc_super v6 = @"AR_NAV";
        break;
      case 653:
        objc_super v6 = @"TAP_TRANSIT_ACCESS_POINT";
        break;
      case 654:
        objc_super v6 = @"LOCATIONS_INSIDE";
        break;
      case 655:
        objc_super v6 = @"SIMILAR_LOCATIONS";
        break;
      case 656:
        objc_super v6 = @"LOCATIONS_AT_ADDRESS";
        break;
      case 657:
        objc_super v6 = @"NAV_DIRECTIONS_BANNER_CYCLING";
        break;
      case 658:
        objc_super v6 = @"ROUTE_OPTIONS_CYCLING";
        break;
      case 659:
        objc_super v6 = @"EV_CONNECTION_TRAY";
        break;
      case 660:
        objc_super v6 = @"VIRTUAL_GARAGE";
        break;
      case 661:
        objc_super v6 = @"VIRTUAL_GARAGE_BANNER";
        break;
      case 662:
        objc_super v6 = @"VIRTUAL_GARAGE_VEHICLE_VIEW";
        break;
      case 663:
        objc_super v6 = @"ADVISORY_DETAILS_PAGE";
        break;
      case 664:
        objc_super v6 = @"APP_CLIP_NOTIFICATION";
        break;
      case 665:
        objc_super v6 = @"PHOTO_VIEWER_GALLERY";
        break;
      case 666:
        objc_super v6 = @"RECOMMENDATION_CARD";
        break;
      case 667:
        objc_super v6 = @"INCIDENT_REPORT_TRAY";
        break;
      case 668:
        objc_super v6 = @"MAPS_WIDGET_DISPLAY";
        break;
      case 669:
        objc_super v6 = @"VISUAL_LOCATION_FRAMEWORK";
        break;
      case 670:
        objc_super v6 = @"APP_CLIP_TRAY";
        break;
      case 671:
        objc_super v6 = @"LICENSE_PLATE_SUGGESTION_PAGE";
        break;
      case 672:
        objc_super v6 = @"NOTIFICATION_ADD_PLATE";
        break;
      case 673:
        objc_super v6 = @"MAPS_RESULTS";
        break;
      case 674:
        objc_super v6 = @"MAPS_WIDGET_APP_CONNECTION";
        break;
      case 675:
        objc_super v6 = @"MAPS_WIDGET_CURRENT_LOCATION";
        break;
      case 676:
        objc_super v6 = @"MAPS_WIDGET_CURRENT_NAV";
        break;
      case 677:
        objc_super v6 = @"MAPS_WIDGET_ETA";
        break;
      case 678:
        objc_super v6 = @"MAPS_WIDGET_TRANSIT";
        break;
      case 679:
        objc_super v6 = @"MAPS_WIDGET_UPC_DESTINATION";
        break;
      case 680:
        objc_super v6 = @"WIDGET_CREATION_TRAY";
        break;
      case 681:
        objc_super v6 = @"MAPS_WIDGET_HOME";
        break;
      case 682:
        objc_super v6 = @"MAPS_WIDGET_PARKED_CAR";
        break;
      case 683:
        objc_super v6 = @"MAPS_WIDGET_POI";
        break;
      case 684:
        objc_super v6 = @"MAPS_WIDGET_SCHOOL";
        break;
      case 685:
        objc_super v6 = @"MAPS_WIDGET_WORK";
        break;
      case 686:
        objc_super v6 = @"AIRPORT_NOTIFICATION";
        break;
      case 687:
        objc_super v6 = @"MAPS_WIDGET_EMPTY";
        break;
      case 688:
        objc_super v6 = @"COARSE_LOCATION_OPTIONS_PROMPT";
        break;
      case 689:
        objc_super v6 = @"ALLOW_PRECISE_LOCATION_PROMPT";
        break;
      case 690:
        objc_super v6 = @"SHARE_MY_LOCATION";
        break;
      case 691:
        objc_super v6 = @"MARK_MY_LOCATION";
        break;
      case 692:
        objc_super v6 = @"AIRPORT_NOTIFICATION_WATCH";
        break;
      case 693:
        objc_super v6 = @"EDIT_FAVORITE";
        break;
      case 694:
        objc_super v6 = @"ROUTING_CYCLING_DETAILS";
        break;
      case 695:
        objc_super v6 = @"NAV_CYCLING_DETAILS";
        break;
      case 696:
        objc_super v6 = @"MAPS_SUGGESTION_WIDGET";
        break;
      case 697:
        objc_super v6 = @"ARP_TIPKIT";
        break;
      case 698:
        objc_super v6 = @"ARP_PRIVACY";
        break;
      case 699:
        objc_super v6 = @"ROUTE_OPTIONS_WALKING";
        break;
      case 701:
        objc_super v6 = @"SAFARI_SEARCH";
        break;
      case 702:
        objc_super v6 = @"SPOTLIGHT_SEARCH";
        break;
      case 703:
        objc_super v6 = @"SAFARI_MAPS_SEARCH_RESULTS";
        break;
      case 704:
        objc_super v6 = @"SPOTLIGHT_MAPS_SEARCH_RESULTS";
        break;
      case 705:
        objc_super v6 = @"WIDGET_MAPS_DESTINATIONS";
        break;
      case 706:
        objc_super v6 = @"WIDGET_MAPS_TRANSIT";
        break;
      case 707:
        objc_super v6 = @"WIDGET_MAPS_NEARBY";
        break;
      case 708:
        objc_super v6 = @"NOTIFICATION_FIND_MY_CAR";
        break;
      case 709:
        objc_super v6 = @"CONTROL_CENTER";
        break;
      case 710:
        objc_super v6 = @"NOTIFICATION_CENTER";
        break;
      case 711:
        objc_super v6 = @"NOTIFICATION_DOOM";
        break;
      case 712:
        objc_super v6 = @"NOTIFICATION_VENUES";
        break;
      case 713:
        objc_super v6 = @"NOTIFICATION_RAP_UPDATE";
        break;
      case 714:
        objc_super v6 = @"NOTIFICATION_TRIP_CANCELLED";
        break;
      case 715:
        objc_super v6 = @"NOTIFICATION_STOP_SKIPPED";
        break;
      case 716:
        objc_super v6 = @"NOTIFICATION_TRIP_DELAYED";
        break;
      case 717:
        objc_super v6 = @"NOTIFICATION_RAP";
        break;
      case 718:
        objc_super v6 = @"NOTIFICATION_PROXY_AUTH";
        break;
      case 719:
        objc_super v6 = @"NOTIFICATION_PUSH_TO_DEVICE";
        break;
      case 720:
        objc_super v6 = @"NOTIFICATION_LOW_FUEL";
        break;
      case 721:
        objc_super v6 = @"NOTIFICATION_FIND_MY_CAR_RESET";
        break;
      case 722:
        objc_super v6 = @"NOTIFICATION_TRAFFIC_CONDITIONS";
        break;
      case 723:
        objc_super v6 = @"NOTIFICATION_SHARED_ETA";
        break;
      case 724:
        objc_super v6 = @"NOTIFICATION_SHARED_ETA_UPDATE";
        break;
      case 725:
        objc_super v6 = @"ANNOUNCEMENT_TYPE_UNKNOWN";
        break;
      case 726:
        objc_super v6 = @"ANNOUNCEMENT_TYPE_GENERAL";
        break;
      case 727:
        objc_super v6 = @"ANNOUNCEMENT_TYPE_FLYOVER";
        break;
      case 728:
        objc_super v6 = @"ANNOUNCEMENT_TYPE_TRANSIT";
        break;
      case 729:
        objc_super v6 = @"ANNOUNCEMENT_TYPE_VENUES";
        break;
      case 730:
        objc_super v6 = @"ANNOUNCEMENT_TYPE_ENHANCED_DETAIL";
        break;
      case 731:
        objc_super v6 = @"ANNOUNCEMENT_TYPE_LANE_GUIDANCE";
        break;
      case 732:
        objc_super v6 = @"ANNOUNCEMENT_TYPE_LOOK_AROUND";
        break;
      case 733:
        objc_super v6 = @"APP_SHEET";
        break;
      case 734:
        objc_super v6 = @"CZ_ADVISORY_DETAILS_PAGE";
        break;
      case 735:
        objc_super v6 = @"SHARE_ETA_CONTACT_TRAY";
        break;
      case 736:
        objc_super v6 = @"SIRI_SHARE_ETA";
        break;
      case 737:
        objc_super v6 = @"SIRI_SUGGESTION_SHARED_ETA";
        break;
      case 738:
        objc_super v6 = @"SIRI_SUGGESTION_SHARED_ETA_CARPLAY";
        break;
      case 739:
        objc_super v6 = @"INCIDENT_ALERT_TRAY";
        break;
      case 740:
        objc_super v6 = @"INCIDENT_REPORT_CONFIRMATION_TRAY";
        break;
      case 741:
        objc_super v6 = @"RAP_INCIDENT_REPORT_VIEW";
        break;
      case 742:
        objc_super v6 = @"SEARCH_ALONG_ROUTE_CATEGORY_TRAY";
        break;
      case 743:
        objc_super v6 = @"TRAFFIC_ADVISORY_SHEET";
        break;
      case 801:
        objc_super v6 = @"SIRI_PLUGIN_SNIPPET";
        break;
      case 802:
        objc_super v6 = @"SIRI_PLUGIN_COMMAND";
        break;
      case 803:
        objc_super v6 = @"SIRI_SEARCH_RESULT_LIST";
        break;
      case 804:
        objc_super v6 = @"SIRI_DISAMBIGUATION_LIST";
        break;
      case 805:
        objc_super v6 = @"SIRI_PLACE_SNIPPET";
        break;
      default:
        if (target != 901) {
          goto LABEL_1353;
        }
        objc_super v6 = @"CHROME";
        break;
    }
  }
  v7 = +[NSString stringWithFormat:@"Action: %@ \nTarget: %@ \nValue: %@ \nCollectionId: %@ \nPublisherIds: %@ \nIsCollectionSaved: %@ \nVerticalIndex: %@ \nHorizontalIndex: %@", v4, v6, self->_curatedCollectionEvent.value, self->_curatedCollectionEvent.collectionId, self->_curatedCollectionEvent.publisherIds, self->_curatedCollectionEvent.collectionCurrentlySaved, self->_curatedCollectionEvent.verticalIndex, self->_curatedCollectionEvent.horizontalIndex];
...
- (void)recentTappedAtIndex:(unint64_t)a3 visibleSuggestions:(id)a4
{
  ...
  [(SearchHomeAnalyticsManager *)self logRecentEvent];
}

- (void)logRecentEvent
{
  +[GEOAPPortal captureUserAction:self->_recentEvent.action target:self->_recentEvent.target value:0];
  suggestions = self->_recentEvent.suggestions;
  if (suggestions) {
    +[GEOAPPortal captureClientACSuggestionWithQuery:&stru_101324E70 queryTokens:0 entries:suggestions selectedIndex:self->_recentEvent.selectedIndex selectedSectionIndex:0 withinSectionSelectedIndex:0 isRetainedQuery:0 isRerankerTriggered:0 shouldDifferentiateClientAndServerResults:0];
  }
}
...
- (void)autocompleteSessionsStartedWithVisibleSuggestions:(id)a3
{
  ...
  if (v5)
  {
    id v6 = v5;
    [(SearchHomeAnalyticsManager *)self cleanup];
    objc_storeStrong((id *)&self->_noTypingACEvent.suggestions, a3);
