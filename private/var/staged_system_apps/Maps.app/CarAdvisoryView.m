...
- (void)_updateContent
{
  id v3 = [(GEOComposedRouteAdvisory *)self->_advisory titleString];
  v4 = [v3 stringWithDefaultOptions];
  [(UILabel *)self->_advisoryLabel setText:v4];

  id v5 = [(GEOComposedRouteAdvisory *)self->_advisory artwork];
...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  id v5 = [(CarAdvisoryView *)self traitCollection];
