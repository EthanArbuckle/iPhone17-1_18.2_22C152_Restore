...
- (void)viewDidLoad
{
  ...
  self->_priorities = (NSArray *)&off_1013AE010;
  ...
  id v45 = [v37 initWithArrangedSubviews:v44];
...
{
  id v3 = a3;
  id v4 = +[CarFocusableButton button];
...
- (void)_updateLabel
{
  ...
  id v8 = [(CarCompressionTestCardViewController *)self view];
  [v8 bounds];
  v6 = +[NSString stringWithFormat:@"Height=%.1f (=%.1f/%.1f)", v4, *(void *)&Height, CGRectGetHeight(v11)];
...
- (void)setSpacerPriority:(float)a3
{
  if (self->_spacerPriority != a3)
  {
    ...
    self->_spacerPrioritdouble y = v5;
    BOOL v6 = [(CarCompressionTestCardViewController *)self spacerHeightConstraint];
    [v6 setActive:0];

    v7 = [(CarCompressionTestCardViewController *)self spacerHeightConstraint];
    *(float *)&double v8 = a3;
    [v7 setPriority:v8];

    v9 = [(CarCompressionTestCardViewController *)self spacerHeightConstraint];
    [v9 setActive:1];

    CGRect v10 = [(CarCompressionTestCardViewController *)self priorityButton];
    *(float *)&double v11 = a3;
...
- (void)_dismiss
{
  id v3 = [(CarCompressionTestCardViewController *)self delegate];
  [v3 compressionTestCardRequestsDismiss:self];
}

- (void)_disappearAndReturn
{
  id v7 = [(CarCompressionTestCardViewController *)self delegate];
  [(CarCompressionTestCardViewController *)self spacerHeight];
  double v4 = v3;
  [(CarCompressionTestCardViewController *)self spacerPriority];
  LODWORD(v6) = v5;
...
- (void)_incrementPriority
{
  *(float *)&double v2 = self->_spacerPriority;
  double v4 = +[NSNumber numberWithFloat:v2];
  NSUInteger v5 = [(NSArray *)self->_priorities indexOfObject:v4];
  ...
  id v8 = [(NSArray *)self->_priorities objectAtIndexedSubscript:v7];
...
- (NSArray)focusOrderSubItems
{
  ...
  double v4 = +[NSArray arrayWithObjects:v8 count:5];
  NSUInteger v5 = [v4 indexesOfObjectsPassingTest:&stru_1012F9EE0];
  unint64_t v6 = [v4 objectsAtIndexes:v5];
...
- (CarCompressionTestCardDelegate)delegate
{
  ...
  return (CarCompressionTestCardDelegate *)WeakRetained;
}
