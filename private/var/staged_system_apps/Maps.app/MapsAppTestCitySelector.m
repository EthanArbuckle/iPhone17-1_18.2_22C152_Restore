...
{
  id v4 = a3;
  id v5 = [(MapsAppTestCitySelector *)self updatedDataFetchers];
  v6 = [v4 object];

  [v5 addObject:v6];
  v7 = [(MapsAppTestCitySelector *)self updatedDataFetchers];
  id v8 = [v7 count];
  unint64_t v9 = [(MapsAppTestCitySelector *)self numberOfDataFetchers];
...
- (void)runScrollTest
{
  ...
  double v6 = v5;
  RPTGetBoundsForView();
  id v11 = [objc_alloc((Class)RPTScrollViewTestParameters) initWithTestName:@"scrollingCitySelector" scrollBounds:1 scrollContentLength:&stru_1013151A8 scrollDirection:v7 completionHandler:v6];
  objc_initWeak(&location, self);
  id v18 = v11;
  ...
  id v13 = +[RPTGroupScrollTestParameters newWithTestName:@"scrollingCitySelector" parameters:v12 completionHandler:v14];
