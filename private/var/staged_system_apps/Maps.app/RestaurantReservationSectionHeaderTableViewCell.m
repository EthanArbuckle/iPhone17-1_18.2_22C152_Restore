...
- (RestaurantReservationSectionHeaderTableViewCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  if (v4)
  {
    id v5 = objc_alloc_init((Class)MKViewWithHairline);
...
- (void)initConstraints
{
  ...
  id v5 = [v16 topAnchor];
  id v6 = [(RestaurantReservationSectionHeaderTableViewCell *)self headerLabel];
  v7 = [v6 font];
  [v7 _mapkit_scaledValueForValue:26.0];
  v8 = [v15 constraintEqualToAnchor:v5];
  v51[6] = v8;
...
- (void)updateTheme
{
  ...
  v4 = [v3 hairlineColor];
  id v5 = [(RestaurantReservationSectionHeaderTableViewCell *)self hairlineContainer];
...
{
  id v4 = a3;
  id v5 = [(RestaurantReservationSectionHeaderTableViewCell *)self headerLabel];
  [v5 setTextColor:v4];
}
...
- (void)setText:(id)a3
{
  id v5 = [a3 localizedUppercaseString];
  id v4 = [(RestaurantReservationSectionHeaderTableViewCell *)self headerLabel];
  [v4 setText:v5];
}
...
{
  BOOL v3 = a3;
  id v4 = [(RestaurantReservationSectionHeaderTableViewCell *)self hairlineContainer];
  [v4 setHidden:v3];
}
