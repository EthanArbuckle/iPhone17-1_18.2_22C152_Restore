...
- (MapsRadarDataAttachment)initWithFileName:(id)a3 data:(id)a4
{
  ...
  v15.receiver = self;
  v15.super_class = (Class)MapsRadarDataAttachment;
...
+ (id)attachmentWithFileName:(id)a3 data:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = [objc_alloc((Class)a1) initWithFileName:v7 data:v6];
...
- (id)temporaryFileURL
{
  ...
  if (!temporaryFileURL)
  {
    ...
    id v18 = 0;
    unsigned int v10 = [v9 writeToURL:v5 options:1 error:&v18];
    id v11 = v18;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        objc_super v15 = [(MapsRadarDataAttachment *)self data];
        *(_DWORD *)buf = 138413058;
        ...
        __int16 v25 = 2112;
        id v26 = v11;
        _os_log_impl((void *)&_mh_execute_header, v13, OS_LOG_TYPE_ERROR, "Failed to save file with name '%@' from data '%@' at path '%@': %@", buf, 0x2Au);
      }
      v12 = 0;
    }
...
- (id)description
{
  ...
  if (v5)
  {
    ...
    {
      id v8 = [(MapsRadarDataAttachment *)v5 performSelector:"accessibilityIdentifier"];
      v9 = v8;
