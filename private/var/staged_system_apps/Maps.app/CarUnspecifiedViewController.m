...
- (void)viewDidLoad
{
  ...
  v6 = (UITapGestureRecognizer *)[objc_alloc((Class)UITapGestureRecognizer) initWithTarget:self action:"_tappedWidget:"];
...
- (void)_tappedWidget:(id)a3
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    {
      id v8 = [(CarUnspecifiedViewController *)v5 performSelector:"accessibilityIdentifier"];
      objc_super v9 = v8;
