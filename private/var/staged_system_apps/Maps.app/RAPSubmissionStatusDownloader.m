...
- (RAPSubmissionStatusDownloader)init
{
  ...
  if (v2)
  {
    ...
    {
      *(_WORD *)v9 = 0;
      _os_log_impl((void *)&_mh_execute_header, v3, OS_LOG_TYPE_INFO, "Initializing submission status downloader from Maps", v9, 2u);
    }
...
- (void)_sendStatusChangeNotificationIfNeeded:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (WeakRetained)
    {
      ...
      +[RAPNotificationLogEvent reportNotificationWasShownWithRapId:v15 responseId:v17 notificationType:v14 completion:&stru_10131BA80];
    }
    else
    {
