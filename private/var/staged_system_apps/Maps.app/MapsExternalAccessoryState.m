...
+ (id)allKeys
{
  if (qword_10160FD90 != -1) {
    dispatch_once(&qword_10160FD90, &stru_1012FF118);
  }
  v2 = (void *)qword_10160FD88;
...
- (id)descriptionForKey:(id)a3
{
  ...
  else
  {
    ...
    {
      uint64_t v9 = sub_1008A6760((int)[(MapsExternalAccessoryState *)self engineTypes]);
    }
    else
    {
      v11.receiver = self;
...
- (void)updateWithInfo:(id)a3
{
        ...
        v11 == (id)v12))
  {
    ...
    if (v22)
    {
      ...
      [v23 setObject:v37 forKeyedSubscript:&off_1013A90B8];
...
LABEL_14:
    ...
    [v23 setObject:v38 forKeyedSubscript:&off_1013A90D0];
...
LABEL_16:
      ...
      [v23 setObject:v24 forKeyedSubscript:&off_1013A9100];

      goto LABEL_17;
    }
LABEL_33:
    v39 = +[MapsCarEngineState engineStateElectric];
    [v23 setObject:v39 forKeyedSubscript:&off_1013A90E8];
