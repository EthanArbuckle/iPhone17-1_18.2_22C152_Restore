...
- (ReservationActionButtonTableViewCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  if (v4)
  {
    ...
    v4->_accessoryTitleLabel = (UILabel *)v8;
...
- (void)setupConstraints
{
  ...
  uint64_t v5 = [(ReservationActionButtonTableViewCell *)self accessoryTitleLabel];
  [v5 setTranslatesAutoresizingMaskIntoConstraints:0];

  v6 = [(ReservationActionButtonTableViewCell *)self titleLabel];
  v7 = [v6 leadingAnchor];
  uint64_t v8 = [(ReservationActionButtonTableViewCell *)self contentView];
  v9 = [v8 layoutMarginsGuide];
  v10 = [v9 leadingAnchor];
  id v54 = [v7 constraintEqualToAnchor:v10];
  ...
  objc_super v22 = [(ReservationActionButtonTableViewCell *)self titleLabel];
...
- (void)layoutSubviews
{
  ...
  uint64_t v5 = [(ReservationActionButtonTableViewCell *)self accessoryTitle];
