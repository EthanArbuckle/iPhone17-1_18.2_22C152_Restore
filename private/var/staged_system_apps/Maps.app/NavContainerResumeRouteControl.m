...
{
  v114.receiver = self;
  v114.super_class = (Class)NavContainerResumeRouteControl;
  v3 = -[NavContainerResumeRouteControl initWithFrame:](&v114, "initWithFrame:", a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
  if (v3)
  {
    ...
    v6 = (UILayoutGuide *)objc_alloc_init((Class)UILayoutGuide);
    ...
    v25 = [objc_alloc((Class)UIButton) initWithFrame:CGRectZero.origin.x, y, width, height];
...
- (void)setTitle:(id)a3
{
  ...
  v6 = self->_titleText;
  id v7 = [(NavContainerResumeRouteControl *)self titleLabel];
  [v7 setText:v6];
}
...
- (id)constraintsForPositionInStatusBarBackgroundView:(id)a3
{
  ...
  v15[1] = v6;
  id v7 = [(NavContainerResumeRouteControl *)self leadingAnchor];
  v8 = [v4 leadingAnchor];
...
- (id)initialConstraintsForAnimatingPositionInStatusBarBackgroundView:(id)a3
{
  ...
  v14[1] = v8;
  id v9 = [(NavContainerResumeRouteControl *)self trailingAnchor];
