...
- (VLFCrowdsourcingPermissionContaineeViewController)initWithNibName:(id)a3 bundle:(id)a4
{
  id v5 = a3;
  id v6 = a4;
  result = (VLFCrowdsourcingPermissionContaineeViewController *)+[NSException raise:@"MethodNotAvailableException" format:@"This method is unavailable."];
  __break(1u);
  return result;
}
...
- (VLFCrowdsourcingPermissionContaineeViewController)initWithCompletion:(id)a3
{
  id v4 = a3;
  v15.receiver = self;
  v15.super_class = (Class)VLFCrowdsourcingPermissionContaineeViewController;
  id v5 = [(VLFCrowdsourcingPermissionContaineeViewController *)&v15 initWithNibName:0 bundle:0];
  if (v5)
  {
    id v6 = sub_1003EB134();
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = (Class)VLFCrowdsourcingPermissionContaineeViewController;
...
- (void)viewDidLoad
{
  ...
  id v5 = [v4 topAnchor];
  id v6 = [(VLFCrowdsourcingPermissionContaineeViewController *)self view];
  id v7 = [v6 topAnchor];
  ...
  id v16 = objc_alloc((Class)UIScrollView);
  double y = CGRectZero.origin.y;
  double width = CGRectZero.size.width;
  double height = CGRectZero.size.height;
  id v278 = [v16 initWithFrame:CGRectZero.origin.x, y, width, height];
  ...
  id v280 = [objc_alloc((Class)UIView) initWithFrame:CGRectZero.origin.x, y, width, height];
  ...
  id v41 = objc_alloc((Class)UIImageView);
  v42 = +[UIImage systemImageNamed:@"arkit"];
  id v277 = [v41 initWithImage:v42];
  ...
  id v79 = [objc_alloc((Class)UILabel) initWithFrame:CGRectZero.origin.x, y, width, height];
  ...
  v285[1] = 3221225472;
  v285[2] = sub_1003ED154;
  v285[3] = &unk_1012E8CD0;
  ...
  id v137 = objc_alloc((Class)UIStackView);
  ...
  id v142 = [v137 initWithArrangedSubviews:v141];
  ...
  v283[1] = 3221225472;
  v283[2] = sub_1003ED244;
  v283[3] = &unk_1012E8CD0;
  ...
  v281[1] = 3221225472;
  v281[2] = sub_1003ED398;
  v281[3] = &unk_1012E8CD0;
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  objc_super v4 = sub_1003EB134();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    *(_DWORD *)buf = 134349056;
    id v7 = self;
    _os_log_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_INFO, "[%{public}p] VLF Crowdsourcing Permission Card has been shown", buf, 0xCu);
  }
...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  id v6 = [(VLFCrowdsourcingPermissionContaineeViewController *)self traitCollection];
    ...
    if (GEOVisualLocalizationCrowdsourcingIsAllowed())
    {
      if (_GEOConfigHasValue())
      {
        ...
        if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
        {
          int v11 = 134349056;
          id v12 = a1;
          id v4 = "[%{public}p] Not showing VLF Crowdsourcing Permission Card because the user has already made a decision";
LABEL_13:
          _os_log_impl((void *)&_mh_execute_header, v3, OS_LOG_TYPE_INFO, v4, (uint8_t *)&v11, 0xCu);
        }
      }
      else
      {
        if (byte_10160EB90 != 1)
        {
          id v7 = +[PedestrianARSessionUsageTracker sharedInstance];
          v8 = (char *)[v7 numberOfTimesARLocalized];
          v9 = +[VLFSessionUsageTracker sharedInstance];
          objc_super v10 = &v8[(void)[v9 numberOfTimesVLFLocalized]];
          BOOL v5 = (uint64_t)v10 >= GEOConfigGetInteger();
        ...
        if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
        {
          int v11 = 134349056;
          id v12 = a1;
          id v4 = "[%{public}p] Not showing VLF Crowdsourcing Permission Card because the user has already seen the crowdsou"
    ...
    else
    {
      ...
      if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
      {
        int v11 = 134349056;
        id v12 = a1;
        id v4 = "[%{public}p] Not showing VLF Crowdsourcing Permission Card because the feature is not supported for the cur"
             "rent device posture";
        goto LABEL_13;
      }
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
    {
      int v11 = 134349056;
      id v12 = a1;
      id v4 = "[%{public}p] Not showing VLF Crowdsourcing Permission Card because the feature is not enabled";
      goto LABEL_13;
    }
  }
...
- (void)_updateForCurrentState
{
  id v3 = [(VLFCrowdsourcingPermissionContaineeViewController *)self traitCollection];
  id v4 = +[UIFont _maps_fontWithTextStyle:UIFontTextStyleLargeTitle weight:v3 compatibleWithTraitCollection:UIFontWeightBold];
  BOOL v5 = [(VLFCrowdsourcingPermissionContaineeViewController *)self titleLabel];
  [v5 setFont:v4];

  id v6 = [(VLFCrowdsourcingPermissionContaineeViewController *)self titleLabel];
  id v7 = [v6 font];
  [v7 capHeight];
  double v9 = v8 + 30.0;
  objc_super v10 = [(VLFCrowdsourcingPermissionContaineeViewController *)self titleLabelBaselineConstraint];
  [v10 setConstant:v9];

  int v11 = [(VLFCrowdsourcingPermissionContaineeViewController *)self traitCollection];
  id v12 = +[UIFontDescriptor preferredFontDescriptorWithTextStyle:UIFontTextStyleBody compatibleWithTraitCollection:v11];
  ...
  double v15 = [(VLFCrowdsourcingPermissionContaineeViewController *)self traitCollection];
  id v16 = +[UIFontDescriptor preferredFontDescriptorWithTextStyle:UIFontTextStyleBody compatibleWithTraitCollection:v15];
  v17 = +[UIFont fontWithDescriptor:v16 size:0.0];
  v18 = [(VLFCrowdsourcingPermissionContaineeViewController *)self learnMoreButton];
  v19 = [v18 titleLabel];
  [v19 setFont:v17];

  double v20 = [(VLFCrowdsourcingPermissionContaineeViewController *)self traitCollection];
  double v21 = +[UIFontDescriptor preferredFontDescriptorWithTextStyle:UIFontTextStyleBody compatibleWithTraitCollection:v20];
  ...
  id v41 = [(VLFCrowdsourcingPermissionContaineeViewController *)self denyButton];
  v42 = [v41 titleLabel];
  [v42 setFont:v40];

  v43 = [(VLFCrowdsourcingPermissionContaineeViewController *)self traitCollection];
  v44 = [v43 preferredContentSizeCategory];
  NSComparisonResult v45 = UIContentSizeCategoryCompareToCategory(v44, UIContentSizeCategoryAccessibilityExtraExtraExtraLarge);
