...
+ (id)sharedManager
{
  if (qword_10160F700 != -1) {
    dispatch_once(&qword_10160F700, &stru_1012F7188);
  }
  v2 = (void *)qword_10160F6F8;
...
- (void)_setDefaultsKeyForPreferences:(id)a3
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
  {
    *(_WORD *)objc_super v7 = 0;
    _os_log_impl((void *)&_mh_execute_header, v4, OS_LOG_TYPE_DEBUG, "Updating defaults with newest preferences", v7, 2u);
  }
