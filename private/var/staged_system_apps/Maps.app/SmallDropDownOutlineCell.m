...
{
  v36.receiver = self;
  v36.super_class = (Class)SmallDropDownOutlineCell;
  ...
  if (v3)
  {
    ...
    [(MapsThemeButton *)v3->_button setTitleColorProvider:&stru_10131D6D0];
    v8 = v3->_button;
    v9 = sub_100A92448();
...
- (void)setCellModel:(id)a3
{
  ...
  {
    v8 = v5;
    unsigned __int8 v7 = -[SmallDropDownOutlineCellModel isEqual:](v5, "isEqual:");
    v6 = v8;
    if ((v7 & 1) == 0)
    {
...
{
  button = self->_button;
  uint64_t v4 = [(SmallDropDownOutlineCellModel *)self->_cellModel buttonTitle];
...
- (void)_itemSelectedAtIndex:(int64_t)a3
{
  id v5 = [(SmallDropDownOutlineCellModel *)self->_cellModel delegate];
