...
- (BOOL)_maps_shouldBeDisplayed
{
  ...
  return ![(INRestaurantReservationUserBooking *)self requiresManualRequest]
      || (id)[(INRestaurantReservationUserBooking *)self status] != (id)2
      || v6 < 300.0;
}

- (id)_maps_schemaOrgRepresentationWithGEOMapItem:(id)a3
{
  uint64_t v4 = qword_1016111D0;
  id v5 = a3;
  if (v4 != -1) {
    dispatch_once(&qword_1016111D0, &stru_101323A18);
  }
