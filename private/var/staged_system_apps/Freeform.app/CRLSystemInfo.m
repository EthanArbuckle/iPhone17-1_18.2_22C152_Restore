...
+ (NSString)osVersion
{
  if (qword_1016A8F58 != -1) {
    dispatch_once(&qword_1016A8F58, &stru_1014CFD28);
  }
  int v2 = (void *)qword_1016A8F50;
...
+ (NSString)hwModel
{
  if (qword_1016A8F68 != -1) {
    dispatch_once(&qword_1016A8F68, &stru_1014CFD48);
  }
  int v2 = (void *)qword_1016A8F60;
