...
- (void)addMiniFormatterElementsToArray:(id)a3 atPoint:(CGPoint)a4
{
  ...
  id v7 = a3;
  v8 = self;
  sub_10077B644(v7, x, y);
}

+ (id)keyPathsForValuesAffectingSelectedObjectsSupportingReplacement
{
  sub_100508C28((uint64_t)&off_101504090);
  swift_arrayDestroy();
...
{
  v5.receiver = self;
  v5.super_class = (Class)type metadata accessor for CRLFileEditor();
...
LABEL_8:
  ...
  sub_10077C0F0(v16, v11, (Class)a5, v12, a6, v10, v14);
