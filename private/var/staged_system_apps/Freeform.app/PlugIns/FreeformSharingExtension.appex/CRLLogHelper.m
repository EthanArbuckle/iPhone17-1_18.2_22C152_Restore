...
+ (id)sharedInstance
{
  if (qword_10007DBA8 != -1) {
    dispatch_once(&qword_10007DBA8, &stru_100071CD0);
  }
  v2 = (void *)qword_10007DBA0;
...
- (BOOL)incrementThrottleCountAndCheckThottleMax:(unint64_t)a3
{
  ...
  if (v5 == a3)
  {
    if (CRLPerformanceCat_init_token != -1) {
      dispatch_once(&CRLPerformanceCat_init_token, &stru_100071CF0);
    }
  ...
  {
    if (CRLPerformanceCat_init_token != -1) {
      dispatch_once(&CRLPerformanceCat_init_token, &stru_100071D10);
    }
