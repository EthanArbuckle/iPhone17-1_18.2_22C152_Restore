...
+ (NSString)osVersion
{
  if (qword_10007DB28 != -1) {
    dispatch_once(&qword_10007DB28, &stru_1000716F8);
  }
  int v2 = (void *)qword_10007DB20;
...
+ (NSString)hwModel
{
  if (qword_10007DB38 != -1) {
    dispatch_once(&qword_10007DB38, &stru_100071718);
  }
  int v2 = (void *)qword_10007DB30;
