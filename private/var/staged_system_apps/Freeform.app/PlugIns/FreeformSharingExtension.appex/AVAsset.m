...
+ (id)crl_playableKeysWithKeys:(id)a3
{
  return _objc_msgSend(&off_100074620, "crl_arrayByAddingNonContainedObjectsFromArray:", a3);
}

+ (id)crl_codecTypesForProRes
{
  return &off_100074638;
}

- (BOOL)crl_isPlayable
{
  return [(AVAsset *)self isPlayable];
}
