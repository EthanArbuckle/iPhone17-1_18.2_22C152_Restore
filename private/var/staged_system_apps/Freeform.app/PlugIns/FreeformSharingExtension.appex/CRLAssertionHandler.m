...
+ (id)performBlockIgnoringAssertions:(id)a3
{
  [a1 p_performBlockIgnoringAssertions:a3 onlyFatal:0];
  v4 = [v3 lastObject];
...
+ (id)p_performBlockIgnoringAssertions:(id)a3 onlyFatal:(BOOL)a4
{
  ...
  id v7 = objc_retainBlock((id)qword_10007DD40);
  ...
  v10 = (void *)qword_10007DD40;
  qword_10007DD40 = (uint64_t)v9;

  v5[2](v5);
  id v11 = objc_retainBlock(v7);
  v12 = (void *)qword_10007DD40;
  qword_10007DD40 = (uint64_t)v11;
...
+ (void)logFullBacktrace
{
  if (CRLAssertCat_init_token != -1) {
    dispatch_once(&CRLAssertCat_init_token, &stru_100072380);
  }
...
+ (void)_logBacktraceWithCallStackSymbols:(id)a3
{
  id v4 = a3;
  if (CRLAssertCat_init_token != -1) {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000723A0);
  }
  v5 = CRLAssertCat_log_t;
  if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR)) {
    sub_10005BFEC(v5, (uint64_t)v4);
  }
  [a1 simulateCrashWithMessage:@"+[CRLAssert logBacktrace]"];
}
...
+ (id)packedBacktraceStringWithReturnAddresses:(id)a3
{
  ...
  v5 = +[NSMutableSet set];
  if (qword_10007DD48 != -1) {
    dispatch_once(&qword_10007DD48, &stru_1000723C0);
  }
    ...
    do
    {
      for (i = 0; i != v8; i = (char *)i + 1)
      {
        ...
        if (dladdr(v11, &v79))
        {
          ...
          {
            [v5 addObject:v12];
            os_unfair_lock_lock((os_unfair_lock_t)&dword_10007DD60);
            v13 = [(id)qword_10007DD58 objectForKeyedSubscript:v12];
            os_unfair_lock_unlock((os_unfair_lock_t)&dword_10007DD60);
            if (v13)
            {
              v14 = v55;
              id v15 = v13;
...
LABEL_30:
        ...
        if (ncmds)
        {
          ...
          {
            v31 = v30;
            v32 = +[NSMutableDictionary dictionaryWithSharedKeySet:qword_10007DD50];
            ...
            os_unfair_lock_lock((os_unfair_lock_t)&dword_10007DD60);
            [(id)qword_10007DD58 setObject:v32 forKeyedSubscript:v21];
            os_unfair_lock_unlock((os_unfair_lock_t)&dword_10007DD60);
            [v55 addObject:v32];
...
{
  id v3 = a3;
  if (qword_10007DD70 != -1)
  {
    id v7 = v3;
    dispatch_once(&qword_10007DD70, &stru_1000723E0);
    id v3 = v7;
  }
  id v4 = (void (*)(uint64_t, void, id))off_10007DD68;
  if (off_10007DD68)
  {
    id v6 = v3;
    uint64_t v5 = getpid();
...
+ (void)handleFailureInFunction:(id)a3 file:(id)a4 lineNumber:(int64_t)a5 isFatal:(BOOL)a6 format:(id)a7 args:(char *)a8
{
  ...
  else
  {
    ...
    uint64_t v19 = atomic_load((unsigned int *)dword_10007DD78);
...
+ (int)_atomicIncrementAssertCount
{
  return atomic_fetch_add(dword_10007DD78, 1u);
}
