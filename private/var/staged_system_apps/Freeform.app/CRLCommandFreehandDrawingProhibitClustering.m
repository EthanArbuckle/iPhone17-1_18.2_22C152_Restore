...
- (_TtC8Freeform43CRLCommandFreehandDrawingProhibitClustering)initWithId:(id)a3 prohibitsClustering:(BOOL)a4
{
  ...
  (*(void (**)(char *, char *, uint64_t))(v7 + 16))((char *)self + OBJC_IVAR____TtC8Freeform43CRLCommandFreehandDrawingProhibitClustering_id, v10, v6);
  *((unsigned char *)&self->super.super.isa
  ...
  v11 = (objc_class *)type metadata accessor for CRLCommandFreehandDrawingProhibitClustering();
  v14.receiver = self;
  v14.super_class = v11;
...
- (_TtC8Freeform43CRLCommandFreehandDrawingProhibitClustering)initWithFreehandDrawingItem:(id)a3 prohibitsClustering:(BOOL)a4
{
  ...
  v16 = [(CRLCommandFreehandDrawingProhibitClustering *)self initWithId:isa prohibitsClustering:v4];
...
- (_TtC8Freeform43CRLCommandFreehandDrawingProhibitClustering)init
{
  result = (_TtC8Freeform43CRLCommandFreehandDrawingProhibitClustering *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  NSUUID v2 = (char *)self + OBJC_IVAR____TtC8Freeform43CRLCommandFreehandDrawingProhibitClustering_id;
