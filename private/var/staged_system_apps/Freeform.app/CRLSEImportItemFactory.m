    ...
    do
    {
      ...
      do
      {
        ...
        if (qword_101719BC8 != -1) {
          dispatch_once(&qword_101719BC8, &stru_1014CF3D0);
        }
        v15 = off_10166B5F8;
        if (os_log_type_enabled((os_log_t)off_10166B5F8, OS_LOG_TYPE_DEBUG)) {
          sub_10106D0BC(v67, v15, v14, &v68);
        }
...
- (void)p_logItemProviderError:(id)a3 error:(id)a4
{
  ...
  id v6 = a4;
  if (qword_101719BC8 != -1) {
    dispatch_once(&qword_101719BC8, &stru_1014CF608);
  }
  id v7 = off_10166B5F8;
  if (os_log_type_enabled((os_log_t)off_10166B5F8, OS_LOG_TYPE_ERROR)) {
    sub_10106D500(v7, v5, v6);
  }
}
...
- (BOOL)p_file:(id)a3 conformsTo:(id)a4
{
  ...
  if ([v5 isFileURL])
  {
    ...
    {
      if (qword_101719BC8 != -1) {
        dispatch_once(&qword_101719BC8, &stru_1014CF628);
      }
      id v10 = off_10166B5F8;
      if (os_log_type_enabled((os_log_t)off_10166B5F8, OS_LOG_TYPE_ERROR)) {
        sub_10106D5D4((uint64_t)v5, v10, v8);
      }
