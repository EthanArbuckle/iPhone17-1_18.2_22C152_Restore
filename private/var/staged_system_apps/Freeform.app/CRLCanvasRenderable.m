...
{
  id v5 = a3;
  if ((-[CRLCanvasRenderable isMemberOfClass:](self, "isMemberOfClass:", objc_msgSend((id)objc_opt_class(), "crl_renderableClass")) & 1) == 0)
  {
    int v9 = +[CRLAssertionHandler _atomicIncrementAssertCount];
    if (qword_101719A70 != -1) {
      dispatch_once(&qword_101719A70, &stru_1014D85E0);
    }
    v10 = off_10166B4A0;
    if (os_log_type_enabled((os_log_t)off_10166B4A0, OS_LOG_TYPE_ERROR))
    {
      ...
      *(_DWORD *)buf = 67110402;
      ...
      __int16 v47 = 2114;
      v48 = v15;
      _os_log_error_impl((void *)&_mh_execute_header, v11, OS_LOG_TYPE_ERROR, "#Assert *** Assertion failure #%u: %{public}s %{public}s:%d Wrong renderable class (%{public}@) for layer class (%{public}@)!", buf, 0x36u);
    }
    if (qword_101719A70 != -1) {
      dispatch_once(&qword_101719A70, &stru_1014D8600);
    }
    v16 = off_10166B4A0;
    if (os_log_type_enabled((os_log_t)off_10166B4A0, OS_LOG_TYPE_ERROR)) {
      sub_101066770(v16, v9);
    }
    v17 = (objc_class *)objc_opt_class();
    v18 = NSStringFromClass(v17);
    v19 = (objc_class *)objc_opt_class();
    v35 = NSStringFromClass(v19);
    sub_1001D9720((uint64_t)"Fatal Assertion failure: %{public}s %{public}s:%d Wrong renderable class (%{public}@) for layer class (%{public}@)!", v20, v21, v22, v23, v24, v25, v26, (uint64_t)"-[CRLCanvasRenderable initWithCALayer:]");

    v27 = +[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[CRLCanvasRenderable initWithCALayer:]");
    ...
    +[CRLAssertionHandler handleFailureInFunction:file:lineNumber:isFatal:description:](CRLAssertionHandler, "handleFailureInFunction:file:lineNumber:isFatal:description:", v27, v28, 22, 1, "Wrong renderable class (%{public}@) for layer class (%{public}@)!", v30, v32, 22, v18, v35);

    SyncEvent.FetchedRecordZoneChanges.Deletion.init(recordID:recordType:)(v33, v34);
    abort();
  }
  v36.receiver = self;
  v36.super_class = (Class)CRLCanvasRenderable;
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if (objc_opt_isKindOfClass()) {
      unsigned __int8 v5 = [(CALayer *)self->_layer isEqual:v4->_layer];
    }
    else {
...
- (unint64_t)hash
{
  return (unint64_t)[(CALayer *)self->_layer hash];
}

+ (id)renderableFromLayer:(id)a3
{
  id v3 = a3;
  id v4 = objc_msgSend(objc_alloc((Class)objc_msgSend((id)objc_opt_class(), "crl_renderableClass")), "initWithCALayer:", v3);
...
+ (id)renderablesFromLayers:(id)a3
{
  return [a3 crl_arrayByMappingObjectsUsingBlock:&stru_1014D8640];
}
...
- (id)description
{
  ...
  unsigned __int8 v5 = [(CRLCanvasRenderable *)self layer];
...
{
  id v4 = a3;
  id v6 = [(CRLCanvasRenderable *)self layer];
  unsigned __int8 v5 = [v4 layer];
...
- (void)replaceSubrenderable:(id)a3 withRenderable:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v10 = [(CRLCanvasRenderable *)self layer];
  id v8 = [v7 layer];
...
- (NSArray)subrenderables
{
  ...
  unsigned __int8 v5 = [v4 sublayers];
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        id v10 = +[CRLCanvasRenderable renderableFromLayer:*(void *)(*((void *)&v14 + 1) + 8 * (void)v9)];
        [v3 addObject:v10];
...
- (CRLCanvasRenderable)presentationRenderable
{
  id v3 = [(CRLCanvasRenderable *)self layer];
  id v4 = [v3 presentationLayer];

  if (v4)
  {
    id v5 = [(CRLCanvasRenderable *)self layer];
    id v6 = [v5 presentationLayer];
    id v7 = +[CRLCanvasRenderable renderableFromLayer:v6];
  }
  else
  {
    id v7 = 0;
...
- (CALayerDelegate)delegate
{
  id v2 = [(CRLCanvasRenderable *)self layer];
  id v3 = [v2 delegate];
...
- (CGAffineTransform)affineTransform
{
  double v4 = [(CRLCanvasRenderable *)self layer];
  if (v4)
  {
    double v6 = v4;
    [v4 affineTransform];
...
- (void)setAffineTransform:(CGAffineTransform *)a3
{
  double v3 = [(CRLCanvasRenderable *)self layer];
...
{
  id v2 = [(CRLCanvasRenderable *)self layer];
  unsigned __int8 v3 = [v2 allowsGroupOpacity];
...
{
  id v2 = [(CRLCanvasRenderable *)self layer];
  unsigned __int8 v3 = [v2 masksToBounds];
...
{
  id v2 = [(CRLCanvasRenderable *)self layer];
  unsigned __int8 v3 = [v2 shouldRasterize];
...
{
  id v2 = [(CRLCanvasRenderable *)self layer];
  unsigned __int8 v3 = [v2 crl_tilingSafeHasContents];
...
- (void)addAnimation:(id)a3 forKey:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = [(CRLCanvasRenderable *)self layer];
...
- (BOOL)containsPoint:(CGPoint)a3
{
  ...
  double x = a3.x;
  id v5 = [(CRLCanvasRenderable *)self layer];
  unsigned __int8 v6 = [v5 containsPoint:x, y];
...
{
  id v2 = [(CRLCanvasRenderable *)self layer];
  unsigned __int8 v3 = [v2 contentsAreFlipped];
...
- (void)setIfDifferentFrame:(CGRect)a3 orTransform:(CGAffineTransform *)a4
{
  ...
  double y = a3.origin.y;
  double x = a3.origin.x;
  double v9 = [(CRLCanvasRenderable *)self layer];
