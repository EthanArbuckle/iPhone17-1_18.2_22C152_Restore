...
- (CRLDescription)initWithObject:(id)a3 class:(Class)a4 header:(id)a5
{
  id v8 = a3;
  id v9 = a5;
  +[CRLDescription pushDescriptionDepth];
  v15.receiver = self;
  v15.super_class = (Class)CRLDescription;
  v10 = [(CRLDescription *)&v15 init];
  v11 = v10;
  if (v10)
  {
...
- (CRLDescription)initWithObject:(id)a3 class:(Class)a4 format:(id)a5 arguments:(char *)a6
{
  ...
  v13 = [(CRLDescription *)self initWithObject:v11 class:a4 header:v12];
  return v13;
}

- (CRLDescription)initWithObject:(id)a3 class:(Class)a4 format:(id)a5
{
  return [(CRLDescription *)self initWithObject:a3 class:a4 format:a5 arguments:&v6];
}
...
- (CRLDescription)initWithObject:(id)a3 format:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  id v8 = [(CRLDescription *)self initWithObject:v7 class:object_getClass(v7) format:v6 arguments:&v10];
...
{
  id v4 = a3;
  v5 = [(CRLDescription *)self initWithObject:v4 class:object_getClass(v4) format:&stru_101538650];
...
+ (id)descriptionWithObject:(id)a3 class:(Class)a4 format:(id)a5
{
  id v7 = a5;
  id v8 = a3;
  id v9 = [[CRLDescription alloc] initWithObject:v8 class:a4 format:v7 arguments:&v12];
...
{
  id v5 = a3;
  id v6 = [[CRLDescription alloc] initWithObject:v5 class:a4 format:&stru_101538650];
...
+ (id)descriptionWithObject:(id)a3 format:(id)a4
{
  id v5 = a4;
  id v6 = a3;
  id v7 = [[CRLDescription alloc] initWithObject:v6 class:object_getClass(v6) format:v5 arguments:&v10];
...
+ (id)descriptionWithCFType:(void *)a3 format:(id)a4
{
  ...
  id v7 = [[CRLDescription alloc] initWithCFType:a3 header:v6];
...
+ (id)descriptionWithObject:(id)a3
{
  return [a1 descriptionWithObject:a3 format:&stru_101538650];
}
...
+ (unint64_t)pushDescriptionDepth
{
  ...
  id v4 = [v3 objectForKeyedSubscript:@"CRLDescriptionDepthThreadLocalKey"];
  id v5 = (char *)[v4 unsignedIntegerValue];

  unint64_t v6 = (unint64_t)(v5 + 1);
  id v7 = +[NSNumber numberWithUnsignedInteger:v5 + 1];
  [v3 setObject:v7 forKeyedSubscript:@"CRLDescriptionDepthThreadLocalKey"];
...
- (void)addField:(id)a3 format:(id)a4
{
  ...
  [(CRLDescription *)self addField:v7 value:v8];
}
...
- (void)addFieldWithFormat:(id)a3
{
  ...
  [(CRLDescription *)self addField:0 value:v5];
}
...
- (void)addSuperDescription
{
  ...
  v3 = [(CRLDescription *)&v4 description];
  -[CRLDescription addFieldValue:](self, "addFieldValue:", v3, v4.receiver, v4.super_class);
}
...
- (NSString)descriptionString
{
  p_superclass = __CRLiOSCanvasViewControllerAccessibility_super.superclass;
  if (!self->_fields) {
    goto LABEL_5;
  }
  if (+[CRLDescription peekDescriptionDepth] < 5)
  {
    id v8 = [(CRLDescription *)self p_header];
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          else
          {
            ...
            v23 = v20;
            [v22 crl_indentBy:self->_fieldNameWidth];
            if ([(__CFString *)v23 hasPrefix:@"$$$"])
            {

              v23 = &stru_101538650;
            }
            [v22 replaceCharactersInRange:0, -[__CFString length](v23, "length"), v23];
      ...
      p_superclass = (__objc2_class **)(__CRLiOSCanvasViewControllerAccessibility_super + 8);
      id v7 = v27;
    }
    else
    {
    ...
    while (([v31 hasSuffix:@"\n"] & 1) != 0
         || [v31 hasSuffix:@" "])
      [v31 deleteCharactersInRange:[v31 length] - 1, 1];
    id v6 = v31;
    [v31 crl_indentBy:2];
    [v7 appendFormat:@"\n%@\n}", v31];
  ...
  {
LABEL_5:
    id v7 = [(CRLDescription *)self p_header];
    goto LABEL_31;
  }
...
LABEL_31:
  [p_superclass + 264 popDescriptionDepth];
