...
+ (id)p_performBlockIgnoringAssertions:(id)a3 onlyFatal:(BOOL)a4
{
  ...
  id v7 = objc_retainBlock((id)qword_1016A92B0);
  ...
  v10 = (void *)qword_1016A92B0;
  qword_1016A92B0 = (uint64_t)v9;

  v5[2](v5);
  id v11 = objc_retainBlock(v7);
  v12 = (void *)qword_1016A92B0;
  qword_1016A92B0 = (uint64_t)v11;
...
+ (void)logFullBacktrace
{
  if (qword_101719A70 != -1) {
    dispatch_once(&qword_101719A70, &stru_1014E03B8);
  }
  v3 = off_10166B4A0;
...
+ (void)_logBacktraceWithCallStackSymbols:(id)a3
{
  id v4 = a3;
  if (qword_101719A70 != -1) {
    dispatch_once(&qword_101719A70, &stru_1014E03D8);
  }
  v5 = off_10166B4A0;
  if (os_log_type_enabled((os_log_t)off_10166B4A0, OS_LOG_TYPE_ERROR)) {
    sub_1010881A4(v5, (uint64_t)v4);
  }
  [a1 simulateCrashWithMessage:@"+[CRLAssert logBacktrace]"];
}
...
+ (id)packedBacktraceStringWithReturnAddresses:(id)a3
{
  ...
  v5 = +[NSMutableSet set];
  if (qword_1016A92B8 != -1) {
    dispatch_once(&qword_1016A92B8, &stru_1014E03F8);
  }
    ...
    do
    {
      for (i = 0; i != v8; i = (char *)i + 1)
      {
        ...
        if (dladdr(v11, &v79))
        {
          ...
          {
            [v5 addObject:v12];
            os_unfair_lock_lock((os_unfair_lock_t)&dword_1016A92D0);
            v13 = [(id)qword_1016A92C8 objectForKeyedSubscript:v12];
            os_unfair_lock_unlock((os_unfair_lock_t)&dword_1016A92D0);
            if (v13)
            {
              v14 = v55;
              id v15 = v13;
...
LABEL_30:
        ...
        if (ncmds)
        {
          ...
          {
            v31 = v30;
            v32 = +[NSMutableDictionary dictionaryWithSharedKeySet:qword_1016A92C0];
            ...
            os_unfair_lock_lock((os_unfair_lock_t)&dword_1016A92D0);
            [(id)qword_1016A92C8 setObject:v32 forKeyedSubscript:v21];
            os_unfair_lock_unlock((os_unfair_lock_t)&dword_1016A92D0);
            [v55 addObject:v32];
...
{
  id v3 = a3;
  if (qword_1016A92E0 != -1)
  {
    id v7 = v3;
    dispatch_once(&qword_1016A92E0, &stru_1014E0418);
    id v3 = v7;
  }
  id v4 = (void (*)(uint64_t, void, id))off_1016A92D8;
  if (off_1016A92D8)
  {
    id v6 = v3;
    uint64_t v5 = getpid();
...
+ (void)handleFailureInFunction:(id)a3 file:(id)a4 lineNumber:(int64_t)a5 isFatal:(BOOL)a6 format:(id)a7 args:(char *)a8
{
  ...
  else
  {
    ...
    uint64_t v19 = atomic_load((unsigned int *)&dword_1016A92E8);
...
+ (int)_atomicIncrementAssertCount
{
  return atomic_fetch_add(&dword_1016A92E8, 1u);
}
