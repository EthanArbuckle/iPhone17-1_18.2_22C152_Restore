...
{
  v4.receiver = self;
  v4.super_class = (Class)_s4ItemC14ViewControllerC18ThumbnailImageViewCMa();
  v2 = -[CRLiOSFolderGridViewController.Item.ViewController.ThumbnailImageView initWithFrame:](&v4, "initWithFrame:", 0.0, 0.0, 0.0, 0.0);
  [(CRLiOSFolderGridViewController.Item.ViewController.ThumbnailImageView *)v2 setAccessibilityIgnoresInvertColors:1];
  return v2;
}

- (_TtCCCC8Freeform30CRLiOSFolderGridViewController4Item14ViewController18ThumbnailImageView)initWithCoder:(id)a3
{
  result = (_TtCCCC8Freeform30CRLiOSFolderGridViewController4Item14ViewController18ThumbnailImageView *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
{
  id v3 = a3;
  CGSize result = (_TtCCCC8Freeform30CRLiOSFolderGridViewController4Item14ViewController18ThumbnailImageView *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
