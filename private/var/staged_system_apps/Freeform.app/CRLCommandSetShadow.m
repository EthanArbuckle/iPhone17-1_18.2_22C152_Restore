...
- (_TtC8Freeform19CRLCommandSetShadow)initWithId:(id)a3 shadow:(id)a4
{
  ...
  id v9 = a4;
  v10 = (_TtC8Freeform19CRLCommandSetShadow *)sub_1009B6970((uint64_t)v8, a4);
...
- (_TtC8Freeform19CRLCommandSetShadow)initWithBoardItem:(id)a3 shadow:(id)a4
{
  ...
  v16 = [(CRLCommandSetShadow *)self initWithId:isa shadow:v14];
...
- (_TtC8Freeform19CRLCommandSetShadow)init
{
  result = (_TtC8Freeform19CRLCommandSetShadow *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  uint64_t v5 = *(Class *)((char *)&self->super.super.isa + OBJC_IVAR____TtC8Freeform19CRLCommandSetShadow_shadow);
}
