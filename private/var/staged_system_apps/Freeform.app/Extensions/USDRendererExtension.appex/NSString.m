...
- (id)crl_stringByUniquingPathInsideDirectory:(id)a3 withFormat:(id)a4
{
  ...
  if (!v6)
  {
    ...
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &stru_100081AF8);
    }
    if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR)) {
      sub_10005D47C();
    }
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &stru_100081B18);
    }
...
- (id)crl_stringByRemovingCharactersInSet:(id)a3 options:(unsigned int)a4
{
  ...
  else
  {
    +[CRLAssertionHandler _atomicIncrementAssertCount];
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &stru_100081B38);
    }
    if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR)) {
      sub_10005D514();
    }
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &stru_100081B58);
    }
...
- (id)crl_escapeForIcuRegex
{
  if (qword_100095A48 != -1) {
    dispatch_once(&qword_100095A48, &stru_100081B78);
  }
  uint64_t v3 = self;
  NSUInteger v4 = [(NSString *)v3 length];
  *(void *)&long long v13 = [(NSString *)v3 rangeOfCharacterFromSet:qword_100095A40];
    ...
    if (v4 != (char *)v13)
    {
      do
      {
        ...
        *((void *)&v13 + 1) = &v4[-v13];
        ...
        if (v4 != (char *)v13)
        {
          *(void *)&long long v12 = [(NSString *)v3 rangeOfCharacterFromSet:qword_100095A40 options:0 range:(void)v13];
          *((void *)&v12 + 1) = v9;
          long long v13 = v12;
...
LABEL_8:
      if (v10 == (char *)v12)
      {
        unsigned int v19 = &stru_1000851B8;
      }
      else
      {
...
- (id)crl_stringWithPathRelativeTo:(id)a3 allowBacktracking:(BOOL)a4
{
  ...
  if (a4)
  {
    ...
    if (v13 <= v16)
    {
      long long v23 = &stru_1000851B8;
    }
    else
    {
      long long v22 = &stru_1000851B8;
      do
      {
...
{
  id v4 = a3;
  if ([(NSString *)self isEqualToString:&stru_1000851B8]
    || [v4 isEqualToString:&stru_1000851B8])
  {
    id v5 = self;
LABEL_4:
...
- (id)crl_stringWithoutAttachmentCharacters
{
  if (qword_100095A58 != -1) {
    dispatch_once(&qword_100095A58, &stru_100081BF8);
  }
  uint64_t v3 = qword_100095A50;

  return [(NSString *)self stringByReplacingOccurrencesOfString:v3 withString:&stru_1000851B8];
}
...
- (id)crl_stringWithNormalizedHyphens
{
  if (qword_100095A60 != -1) {
    dispatch_once(&qword_100095A60, &stru_100081C18);
  }
  uint64_t v3 = qword_100095A68;
...
- (id)crl_stringWithNormalizedQuotationMarks
{
  if (qword_100095A70 != -1) {
    dispatch_once(&qword_100095A70, &stru_100081C38);
  }
  uint64_t v3 = qword_100095A78;
...
- (id)crl_stringWithoutBidiControls
{
  ...
  id v4 = [(NSString *)self crl_stringByReplacingInstancesOfCharactersInSet:v3 withString:&stru_1000851B8];
...
- (id)crl_regexForTitleParsingWithLocalizedCopyString:(id)a3 isFirstCopyFormatString:(BOOL)a4
{
  ...
  else
  {
    ...
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &stru_100081C58);
    }
    ...
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &stru_100081C78);
    }
...
- (id)crl_stringByApplyingSubstitutions:(id)a3
{
  ...
  id v8 = [v7 sortedArrayUsingComparator:&stru_100081CE0];
...
{
  id v4 = a3;
  if (qword_100095A88 != -1) {
    dispatch_once(&qword_100095A88, &stru_100081D00);
  }
  [v4 appendString:@"\""];
  if ([(NSString *)self rangeOfCharacterFromSet:qword_100095A80] != (id)0x7FFFFFFFFFFFFFFFLL)
  {
    NSUInteger v5 = [(NSString *)self length];
...
+ (id)crl_stringWithItemProviderData:(id)a3 typeIdentifier:(id)a4 error:(id *)a5
{
  ...
  if (!v8)
  {
    ...
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &stru_100081D20);
    }
    if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR)) {
      sub_10005D644((uint64_t)v7, v9);
    }
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &stru_100081D40);
    }
...
- (BOOL)crl_isCJKString
{
  ...
  for (i = 0; (id)i != v6; BOOL v9 = i >= (unint64_t)v6)
  {
    ...
    char v14 = vmaxv_u8((uint8x8_t)vmovn_s16((int16x8_t)vcgtq_u16((uint16x8_t)xmmword_1000707D0, (uint16x8_t)vaddq_s16(v12, (int16x8_t)xmmword_1000707C0)))) | vmaxv_u16((uint16x4_t)vceq_s16(v13, (int16x4_t)0x3190300011002E80));
...
+ (id)crl_localizedDisplayNameWithPersonNameComponents:(id)a3
{
  ...
  if (CRLDefaultCat_init_token != -1) {
    dispatch_once(&CRLDefaultCat_init_token, &stru_100081D60);
  }
...
- (id)crl_initRedactedWithFormat:(id)a3 arguments:(char *)a4
{
  ...
  id v6 = [objc_alloc((Class)NSString) initWithFormat:v5 arguments:a4];
  if (qword_100095A98 != -1) {
    dispatch_once(&qword_100095A98, &stru_100081D80);
  }
  id v7 = [qword_100095A90 stringByReplacingMatchesInString:v6 options:0 range:[v6 length] withTemplate:@"<redacted>"];
