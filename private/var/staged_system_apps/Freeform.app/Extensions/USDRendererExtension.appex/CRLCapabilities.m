...
LABEL_6:
  ...
  {
    int64x2_t v4 = (int64x2_t)xmmword_100070800;
    goto LABEL_6;
  }
  if ([v19 hasPrefix:@"iPhone2,"])
  {
    int64x2_t v4 = (int64x2_t)xmmword_100070810;
    goto LABEL_6;
  }
  if ([v19 hasPrefix:@"iPhone3,"])
  {
    int64x2_t v4 = (int64x2_t)xmmword_100070820;
    goto LABEL_6;
  }
  if ([v19 hasPrefix:@"iPhone4,"])
  {
    int64x2_t v4 = (int64x2_t)xmmword_100070830;
    goto LABEL_6;
  }
  if ([v19 hasPrefix:@"iPhone5,"])
  {
    int64x2_t v4 = (int64x2_t)xmmword_100070840;
    goto LABEL_6;
  }
  if ([v19 hasPrefix:@"iPhone7,"])
  {
    int64x2_t v4 = (int64x2_t)xmmword_100070850;
    goto LABEL_6;
  }
  if ([v19 hasPrefix:@"iPhone8,4"])
  {
    int64x2_t v4 = (int64x2_t)xmmword_100070860;
    goto LABEL_6;
  }
  if ([v19 hasPrefix:@"iPhone8,"])
  {
    int64x2_t v4 = (int64x2_t)xmmword_100070870;
    goto LABEL_6;
  }
  if ([v19 hasPrefix:@"iPhone9,"])
  {
    int64x2_t v4 = (int64x2_t)xmmword_100070880;
    goto LABEL_6;
  }
  if ([v19 hasPrefix:@"iPhone10,6"])
  {
    int64x2_t v4 = (int64x2_t)xmmword_100070890;
    goto LABEL_6;
  }
  if ([v19 hasPrefix:@"iPhone10,"])
  {
    int64x2_t v4 = (int64x2_t)xmmword_1000708A0;
    goto LABEL_6;
  }
  if ([v19 hasPrefix:@"iPad1,"])
  {
    int64x2_t v4 = (int64x2_t)xmmword_1000708B0;
    goto LABEL_6;
  }
  if (![v19 hasPrefix:@"iPad2,"])
  {
    ...
    {
      long long v17 = xmmword_100070970;
      if (([v19 hasPrefix:@"iPad3,1"] & 1) == 0
        && ([v19 hasPrefix:@"iPad3,2"] & 1) == 0)
      {
        unsigned __int8 v6 = [v19 hasPrefix:@"iPad3,3"];
        int64x2_t v4 = (int64x2_t)xmmword_100070970;
        if (v6) {
          goto LABEL_6;
        }
        long long v17 = xmmword_100070980;
    ...
    {
      long long v17 = xmmword_100070940;
      if (([v19 hasPrefix:@"iPad4,4"] & 1) == 0
        && ([v19 hasPrefix:@"iPad4,5"] & 1) == 0)
      {
        unsigned __int8 v8 = [v19 hasPrefix:@"iPad4,6"];
        int64x2_t v4 = (int64x2_t)xmmword_100070940;
        if (v8) {
          goto LABEL_6;
        }
        long long v17 = xmmword_100070950;
          ...
          && ([v19 hasPrefix:@"iPad4,8"] & 1) == 0)
        {
          ...
          int64x2_t v4 = (int64x2_t)xmmword_100070950;
          if (v9) {
            goto LABEL_6;
          }
          long long v17 = xmmword_100070960;
    ...
    {
      long long v17 = xmmword_100070920;
      if (([v19 hasPrefix:@"iPad5,3"] & 1) == 0)
      {
        unsigned __int8 v10 = [v19 hasPrefix:@"iPad5,4"];
        int64x2_t v4 = (int64x2_t)xmmword_100070920;
        if (v10) {
          goto LABEL_6;
        }
        long long v17 = xmmword_100070930;
    ...
    {
      long long v17 = xmmword_1000708F0;
      if (([v19 hasPrefix:@"iPad6,3"] & 1) == 0)
      {
        unsigned __int8 v11 = [v19 hasPrefix:@"iPad6,4"];
        int64x2_t v4 = (int64x2_t)xmmword_1000708F0;
        if (v11) {
          goto LABEL_6;
        }
        long long v17 = xmmword_100070900;
        if ((objc_msgSend(v19, "hasPrefix:", @"iPad6,7", COERCE_DOUBLE(24)) & 1) == 0)
        {
          unsigned __int8 v12 = [v19 hasPrefix:@"iPad6,8"];
          int64x2_t v4 = (int64x2_t)xmmword_100070900;
          if (v12) {
            goto LABEL_6;
          }
          long long v17 = xmmword_100070910;
...
LABEL_80:
  ...
  long long v17 = xmmword_100070990;
  ...
  int64x2_t v4 = (int64x2_t)xmmword_100070990;
  if (v5) {
    goto LABEL_6;
  }
  if (objc_msgSend(v19, "hasPrefix:", @"iPad2,4", COERCE_DOUBLE(15)))
  {
    int64x2_t v4 = (int64x2_t)xmmword_1000709A0;
    goto LABEL_6;
  }
  long long v17 = xmmword_1000709B0;
...
- (CRLCapabilities)init
{
  ...
  if (v2)
  {
    ...
    block[1] = 3221225472;
    block[2] = sub_10000B4DC;
    block[3] = &unk_100081E88;
    int64x2_t v4 = v2;
    CFStringRef v7 = v4;
    if (qword_100095AB0 != -1) {
      dispatch_once(&qword_100095AB0, block);
    }
...
+ (CRLCapabilities)currentCapabilities
{
  if (qword_100095AC0 != -1) {
    dispatch_once(&qword_100095AC0, &stru_100081EA8);
  }
  v2 = (void *)qword_100095AC8;
...
LABEL_6:
  ...
  else
  {
    ...
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &stru_100081EC8);
    }
    if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR)) {
      sub_10005D934();
    }
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &stru_100081EE8);
    }
...
- (CGSize)maximumImageSize
{
  ...
  switch(self->_platform)
  {
    case 0:
      +[CRLAssertionHandler _atomicIncrementAssertCount];
      if (CRLAssertCat_init_token != -1) {
        dispatch_once(&CRLAssertCat_init_token, &stru_100081F08);
      }
      if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR)) {
        sub_10005D9BC();
      }
      if (CRLAssertCat_init_token != -1) {
        dispatch_once(&CRLAssertCat_init_token, &stru_100081F28);
      }
      uint64_t v5 = CRLAssertCat_log_t;
      if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR)) {
        sub_10005D3DC(v5);
      }
...
- (CGSize)maximumMetalTextureSizeForDevice:(id)a3
{
  ...
  else
  {
    +[CRLAssertionHandler _atomicIncrementAssertCount];
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &stru_100081F48);
    }
    if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR)) {
      sub_10005DA44();
    }
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &stru_100081F68);
    }
    unsigned __int8 v6 = CRLAssertCat_log_t;
    if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR)) {
      sub_10005D3DC(v6);
...
- (id)metalCapabilitiesForDevice:(id)a3
{
  ...
  if (!v3)
  {
    +[CRLAssertionHandler _atomicIncrementAssertCount];
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &stru_100081F88);
    }
    if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR)) {
      sub_10005DACC();
    }
    if (CRLAssertCat_init_token != -1) {
      dispatch_once(&CRLAssertCat_init_token, &stru_100081FA8);
    }
    double v4 = CRLAssertCat_log_t;
    if (os_log_type_enabled((os_log_t)CRLAssertCat_log_t, OS_LOG_TYPE_ERROR)) {
      sub_10005D3DC(v4);
    }
  ...
  if (qword_100095AD8 != -1) {
    dispatch_once(&qword_100095AD8, &stru_100081FC8);
  }
  CFStringRef v7 = [(id)qword_100095AD0 objectForKey:v3];
  if (!v7)
  {
    CFStringRef v7 = [[CRLMetalDeviceCapabilities alloc] initWithDevice:v3];
    [(id)qword_100095AD0 setObject:v7 forKey:v3];
  }
