...
- (_TtC8Freeform22CRLCommandReplaceImage)initWithId:(id)a3 imageData:(id)a4 thumbnailData:(id)a5
{
  ...
  (*(void (**)(char *, char *, uint64_t))(v9 + 16))((char *)self + OBJC_IVAR____TtC8Freeform22CRLCommandReplaceImage_id, v12, v8);
  ...
  *(Class *)((char *)&self->super.super.isa + OBJC_IVAR____TtC8Freeform22CRLCommandReplaceImage_thumbnailData) = (Class)a5;
  v13 = (objc_class *)type metadata accessor for CRLCommandReplaceImage();
  v18.receiver = self;
  v18.super_class = v13;
  id v14 = a4;
  id v15 = a5;
...
- (_TtC8Freeform22CRLCommandReplaceImage)initWithImageItem:(id)a3 imageData:(id)a4 thumbnailData:(id)a5
{
  ...
  (*(void (**)(char *, uint64_t))(v9 + 8))(v12, v8);
  v19 = [(CRLCommandReplaceImage *)v22 initWithId:isa imageData:v15 thumbnailData:v16];
...
- (_TtC8Freeform22CRLCommandReplaceImage)init
{
  result = (_TtC8Freeform22CRLCommandReplaceImage *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  v5 = *(Class *)((char *)&self->super.super.isa + OBJC_IVAR____TtC8Freeform22CRLCommandReplaceImage_thumbnailData);
}
