...
{
  v7.receiver = self;
  v7.super_class = (Class)CRLiOSUnhittableView;
  -[CRLiOSUnhittableView hitTest:withEvent:](&v7, "hitTest:withEvent:", a4, a3.x, a3.y);
  objc_super v5 = (CRLiOSUnhittableView *)objc_claimAutoreleasedReturnValue();
  if (v5 == self)
  {
