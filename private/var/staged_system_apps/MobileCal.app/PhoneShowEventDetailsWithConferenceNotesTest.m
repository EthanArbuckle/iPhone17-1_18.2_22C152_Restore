...
- (void)_detailViewControllerAppeared:(id)a3
{
  id v10 = [(id)objc_opt_class() testName];
...
- (id)_createTestEventWithStartDate:(id)a3
{
  ...
  id v10 = [objc_alloc((Class)NSMutableString) initWithString:@"Test conference string\n"];
  int v11 = 20;
  do
  {
