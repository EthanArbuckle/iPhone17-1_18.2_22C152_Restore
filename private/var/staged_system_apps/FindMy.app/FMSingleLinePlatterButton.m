...
- (void).cxx_destruct
{
  ...
  v3 = *(Class *)((char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC6FindMy25FMSingleLinePlatterButton_color);
}
...
- (void)setUserInteractionEnabled:(BOOL)a3
{
  ...
  [*(id *)&v4[OBJC_IVAR____TtC6FindMy25FMSingleLinePlatterButton_label] setEnabled:v3];
}

- (_TtC6FindMy25FMSingleLinePlatterButton)init
{
  result = (_TtC6FindMy25FMSingleLinePlatterButton *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
