...
LABEL_5:
    uint64_t v14 = 0;
    uint64_t v16 = 0;
    return (_TtC6FindMy27FMDeviceEraseViewController *)sub_1002F511C(v9, v11, (uint64_t)a4, v13, v14, v16, a6);
  }
...
- (_TtC6FindMy27FMDeviceEraseViewController)initWithTitle:(id)a3 detailText:(id)a4 icon:(id)a5 contentLayout:(int64_t)a6
{
  ...
  v16.receiver = self;
  v16.super_class = (Class)type metadata accessor for FMDeviceEraseViewController();
