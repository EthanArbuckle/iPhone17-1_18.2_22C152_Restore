...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  id v4 = v7.receiver;
  [(FMNoveltyViewController *)&v7 viewWillAppear:v3];
...
LABEL_5:
    uint64_t v14 = 0;
    uint64_t v16 = 0;
    return (_TtC6FindMy23FMNoveltyViewController *)sub_10050F5E4(v9, v11, (uint64_t)a4, v13, v14, v16, a6);
  }
...
- (_TtC6FindMy23FMNoveltyViewController)initWithTitle:(id)a3 detailText:(id)a4 icon:(id)a5 contentLayout:(int64_t)a6
{
  ...
  id v14 = a5;
  return (_TtC6FindMy23FMNoveltyViewController *)sub_10050F844(v9, v11, (uint64_t)a4, v13, a5, a6);
}
...
- (void).cxx_destruct
{
  ...
  swift_bridgeObjectRelease();
  uint64_t v3 = &self->OBWelcomeController_opaque[OBJC_IVAR____TtC6FindMy23FMNoveltyViewController_delegate];
