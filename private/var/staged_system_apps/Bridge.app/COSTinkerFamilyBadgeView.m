...
{
  v28.receiver = self;
  v28.super_class = (Class)COSTinkerFamilyBadgeView;
  v2 = [(COSTinkerFamilyBadgeView *)&v28 init];
  if (v2)
  {
    self;
    id v3 = +[UIColor systemGray5Color];
    id v4 = [v3 CGColor];
    ...
    CGPathRef v7 = CGPathCreateWithEllipseInRect(v30, 0);
    v8 = [(COSTinkerFamilyBadgeView *)v2 layer];
    [v8 setPath:v7];

    id v9 = +[UIColor colorWithWhite:0.0 alpha:0.2];
    id v10 = [v9 CGColor];
    v11 = [(COSTinkerFamilyBadgeView *)v2 layer];
    [v11 setStrokeColor:v10];

    id v12 = [objc_alloc((Class)UIImageView) initWithFrame:CGRectZero.origin.x, CGRectZero.origin.y, CGRectZero.size.width, CGRectZero.size.height];
