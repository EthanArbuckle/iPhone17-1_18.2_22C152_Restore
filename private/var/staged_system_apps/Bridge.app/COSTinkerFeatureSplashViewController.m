...
{
  v5.receiver = self;
  v5.super_class = (Class)COSTinkerFeatureSplashViewController;
...
{
  v24.receiver = self;
  v24.super_class = (Class)COSTinkerFeatureSplashViewController;
  ...
  if (!v4)
  {
    unsigned __int8 v4 = +[UIImage imageNamed:PBAssetsFamilySetupSplashFallbackAssetName];
  }
...
- (id)titleString
{
  ...
  v3 = [v2 localizedStringForKey:@"TINKER_FEATURE_SPLASH_TITLE" value:&stru_100249230 table:@"Localizable-tinker"];
...
{
  v2 = +[NSBundle mainBundle];
  v3 = [v2 localizedStringForKey:@"TINKER_FEATURE_SPLASH_DETAIL" value:&stru_100249230 table:@"Localizable-tinker"];
...
- (void)okayButtonPressed:(id)a3
{
  id v4 = [(COSTinkerFeatureSplashViewController *)self delegate];
