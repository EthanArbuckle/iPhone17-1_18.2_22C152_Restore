...
{
  v6.receiver = self;
  v6.super_class = (Class)COSPairingTableCell;
...
{
  v23.receiver = self;
  v23.super_class = (Class)COSPairingTableCell;
  id v4 = a3;
  ...
  v16 = [v15 localizedStringForKey:@"GIZMO_DESCRIPTION_FORMAT_%@_%@" value:&stru_100249230 table:@"Pairing"];
  v17 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", v16, v13, v14, v23.receiver, v23.super_class);
