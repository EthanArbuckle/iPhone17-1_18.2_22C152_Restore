...
{
  v91.receiver = self;
  v91.super_class = (Class)COSRemoteManagementInformationCell;
  ...
  if (v4)
  {
    ...
    v24 = [v23 localizedStringForKey:@"UI_DEVICE_ENROLLMENT_CONSENT" value:&stru_100249230 table:@"Localizable-yorktown"];
    [(UILabel *)v5->_descriptionView setText:v24];

    [(UIView *)v5->_containerView addSubview:v5->_descriptionView];
    uint64_t v25 = +[UIButton buttonWithType:1];
    learnMoreButton = v5->_learnMoreButton;
    v5->_learnMoreButton = (UIButton *)v25;
    ...
    v33 = [v32 localizedStringForKey:@"LEARN_MORE_ABOUT_REMOTE_MANAGEMENT_TITLE" value:&stru_100249230 table:@"Localizable-yorktown"];
...
- (COSRemoteManagementInformationCellDelegate)delegate
{
  ...
  return (COSRemoteManagementInformationCellDelegate *)WeakRetained;
}
