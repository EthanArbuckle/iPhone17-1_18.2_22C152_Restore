...
{
  v5.receiver = self;
  v5.super_class = (Class)COSWatchDiscoveryTimeoutError;
...
{
  BOOL v3 = a3;
  objc_super v5 = [(COSWatchDiscoveryTimeoutError *)self navigationController];
  ...
  v6.receiver = self;
  v6.super_class = (Class)COSWatchDiscoveryTimeoutError;
...
- (void)_showRadarUI
{
  ...
  objc_super v6 = +[UIColor systemOrangeColor];
  [v5 setTintColor:v6];
...
- (void)_radarButtonTapped
{
  id v3 = [objc_alloc((Class)BPSTTRMetadata) initWithComponent:0];
...
- (id)titleString
{
  ...
  id v3 = [v2 localizedStringForKey:@"WATCH_IS_OFF_OR_ALREADY_PAIRED_ALERT_TITLE" value:&stru_100249230 table:@"Localizable"];
...
{
  v2 = +[NSBundle mainBundle];
  id v3 = [v2 localizedStringForKey:@"WATCH_IS_OFF_OR_ALREADY_PAIRED_ALERT_BODY" value:&stru_100249230 table:@"Localizable"];
...
{
  v2 = +[NSBundle mainBundle];
  id v3 = [v2 localizedStringForKey:@"CANCEL_SETUP_FLOW" value:&stru_100249230 table:@"Localizable"];
...
{
  v2 = +[NSBundle mainBundle];
  id v3 = [v2 localizedStringForKey:@"GENERIC_PAIRING_FAILURE_ALERT_LEARN_MORE" value:&stru_100249230 table:@"Localizable"];
...
- (id)imageResource
{
  return sub_1000328FC(@"Screen-Diagnostics");
}
...
- (void)suggestedButtonPressed:(id)a3
{
  ...
  {
    int v5 = 136315138;
    objc_super v6 = "-[COSWatchDiscoveryTimeoutError suggestedButtonPressed:]";
