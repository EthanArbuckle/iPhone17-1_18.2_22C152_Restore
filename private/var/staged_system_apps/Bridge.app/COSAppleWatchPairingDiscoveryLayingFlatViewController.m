...
- (COSAppleWatchCameraAlignementView)instructionView;
...
{
  v5.receiver = self;
  v5.super_class = (Class)COSAppleWatchPairingDiscoveryLayingFlatViewController;
...
{
  v21.receiver = self;
  v21.super_class = (Class)COSAppleWatchPairingDiscoveryLayingFlatViewController;
  ...
  objc_super v5 = -[COSAppleWatchCameraAlignementView initWithFrame:]([COSAppleWatchCameraAlignementView alloc], "initWithFrame:", CGRectZero.origin.x, CGRectZero.origin.y, CGRectZero.size.width, CGRectZero.size.height);
...
{
  v4.receiver = self;
  v4.super_class = (Class)COSAppleWatchPairingDiscoveryLayingFlatViewController;
...
- (id)titleString
{
  ...
  v3 = [v2 localizedStringForKey:@"APPLE_WATCH_DETECTED_TITLE" value:&stru_100249230 table:@"Localizable"];
...
{
  v2 = +[NSBundle mainBundle];
  v3 = [v2 localizedStringForKey:@"APPLE_WATCH_DETECTED_DETAIL_TEXT" value:&stru_100249230 table:@"Localizable"];
