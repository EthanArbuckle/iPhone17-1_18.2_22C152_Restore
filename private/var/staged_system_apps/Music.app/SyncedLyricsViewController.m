...
- (void).cxx_destruct
{
  ...
  sub_100046744((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_delegate);
  swift_release();
  sub_1000637B8((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_timingProvider, &qword_1010CAA80);
...
- (BOOL)gestureRecognizer:(id)a3 shouldReceiveTouch:(id)a4
{
  ...
  id v7 = a4;
  id v8 = self;
  unsigned __int8 v9 = sub_100B3A388(v7);
