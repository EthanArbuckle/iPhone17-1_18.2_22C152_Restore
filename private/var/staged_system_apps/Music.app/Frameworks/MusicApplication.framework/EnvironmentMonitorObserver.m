...
- (void).cxx_destruct
{
  ...
  uint64_t v4 = __swift_instantiateConcreteTypeFromMangledName(&qword_DF0418);
  (*(void (**)(char *, uint64_t))(*(void *)(v4 - 8) + 8))(v3, v4);
  v5 = (char *)self + OBJC_IVAR____TtC9MusicCore26EnvironmentMonitorObserver__isNetworkConstrained;
  uint64_t v6 = __swift_instantiateConcreteTypeFromMangledName(&qword_DEC9B0);
  (*(void (**)(char *, uint64_t))(*(void *)(v6 - 8) + 8))(v5, v6);
  v7 = (char *)self + OBJC_IVAR____TtC9MusicCore26EnvironmentMonitorObserver__thermalLevel;
  uint64_t v8 = __swift_instantiateConcreteTypeFromMangledName(&qword_DF0438);
