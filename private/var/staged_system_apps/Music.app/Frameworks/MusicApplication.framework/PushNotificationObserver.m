...
- (void)connection:(id)a3 didReceiveMessageForTopic:(id)a4 userInfo:(id)a5
{
  uint64_t v9 = __swift_instantiateConcreteTypeFromMangledName(&qword_DEA5F0);
  __chkstk_darwin(v9 - 8);
  v11 = (char *)&v18 - ((v10 + 15) & 0xFFFFFFFFFFFFFFF0);
  if (a4)
  {
    uint64_t v12 = sub_AB6510();
    a4 = v13;
    if (a5)
    {
LABEL_3:
      uint64_t v14 = sub_AB6250();
      uint64_t v15 = sub_AB6C00();
      ...
      id v17 = a3;
      swift_bridgeObjectRetain();
      sub_63C820((uint64_t)v11, (uint64_t)&unk_DEC940, (uint64_t)v16);
      swift_release();
...
- (_TtC9MusicCore24PushNotificationObserver)init
{
  ...
  swift_retain();
  *(void *)&self->connection[8] = sub_609AC4((uint64_t)_swiftEmptyArrayStorage);
  *(_OWORD *)&self->connection[16] = 0u;
  *(_OWORD *)&self->pushConfiguration[8] = 0u;
