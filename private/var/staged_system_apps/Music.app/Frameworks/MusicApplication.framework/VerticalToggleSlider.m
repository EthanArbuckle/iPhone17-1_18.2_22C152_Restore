...
- (BOOL)isEnabled
{
  return sub_986580(self, (uint64_t)a2, (SEL *)&selRef_isEnabled);
}
...
- (BOOL)isHighlighted
{
  return sub_986580(self, (uint64_t)a2, (SEL *)&selRef_isHighlighted);
}
