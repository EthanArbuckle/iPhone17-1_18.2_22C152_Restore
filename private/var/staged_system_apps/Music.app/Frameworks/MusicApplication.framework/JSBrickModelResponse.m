...
- (id)newOperationForDetailedKeepLocalStatusConfigurationForSectionAtIndex:(int64_t)a3 responseHandler:(id)a4
{
  ...
  *(void *)(v7 + 16) = v6;
  v8 = *(void **)&self->MPModelResponse_opaque[OBJC_IVAR____TtC16MusicApplication20JSBrickModelResponse_personalizationResponse];
  v13[4] = sub_B6D6C;
  v13[5] = v7;
...
{
  id v3 = a3;
  result = (_TtC16MusicApplication20JSBrickModelResponse *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  id v3 = *(void **)&self->MPModelResponse_opaque[OBJC_IVAR____TtC16MusicApplication20JSBrickModelResponse_jsResults];
}
