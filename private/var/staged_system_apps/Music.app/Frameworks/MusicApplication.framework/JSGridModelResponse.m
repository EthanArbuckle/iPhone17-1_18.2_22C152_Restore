...
{
  id v3 = a3;
  result = (_TtC16MusicApplication19JSGridModelResponse *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  swift_release();
  swift_release();
  id v3 = *(void **)&self->MPModelResponse_opaque[OBJC_IVAR____TtC16MusicApplication19JSGridModelResponse_jsResults];
}
...
- (BOOL)hasVideoArtworkAt:(id)a3
{
  return sub_3BEFE0((char *)self, (uint64_t)a2, a3, &OBJC_IVAR____TtC16MusicApplication19JSGridModelResponse_jsResults, (void (*)(void))type metadata accessor for JSGridItem);
}
