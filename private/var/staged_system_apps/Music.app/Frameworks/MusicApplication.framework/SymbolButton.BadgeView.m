...
- (BOOL)isHidden
{
  return sub_96AFBC(self, (uint64_t)a2, (uint64_t (*)(void))type metadata accessor for SymbolButton.BadgeView, (SEL *)&selRef_isHidden);
}
...
- (void)layoutSubviews
{
  __swift_instantiateConcreteTypeFromMangledName(&qword_DFB060);
  __chkstk_darwin();
