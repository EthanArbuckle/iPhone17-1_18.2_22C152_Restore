...
- (BOOL)isEqual:(id)a3
{
  ...
  sub_100009790((uint64_t)v8, (uint64_t *)&unk_100574DB0);
  return v6 & 1;
}
...
- (void)groupSessionDidConnect:(id)a3
{
  uint64_t v5 = sub_100005BFC(&qword_100574B80);
  ...
  v11[4] = a3;
  v11[5] = v9;
  sub_1000FFB78((uint64_t)v7, (uint64_t)&unk_100579AA0, (uint64_t)v11);
  swift_unknownObjectRelease();
...
- (void)groupSession:(id)a3 didInvalidateWithError:(id)a4
{
  uint64_t v6 = sub_100005BFC(&qword_100574B80);
  ...
  v15[4] = v12;
  v15[5] = v13;
  sub_1000FFB78((uint64_t)v8, (uint64_t)&unk_100579A98, (uint64_t)v15);
  swift_unknownObjectRelease();
