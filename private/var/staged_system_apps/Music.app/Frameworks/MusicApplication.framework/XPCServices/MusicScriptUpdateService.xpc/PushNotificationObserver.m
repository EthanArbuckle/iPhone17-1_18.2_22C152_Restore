...
- (void)connection:(id)a3 didReceiveMessageForTopic:(id)a4 userInfo:(id)a5
{
  uint64_t v9 = sub_100005BFC(&qword_100574B80);
...
LABEL_3:
      ...
      id v17 = a3;
      swift_bridgeObjectRetain();
      sub_1000FFB78((uint64_t)v11, (uint64_t)&unk_100576ED0, (uint64_t)v16);
      swift_release();
...
- (_TtC9MusicCore24PushNotificationObserver)init
{
  ...
  swift_retain();
  *(void *)self->registeredHandlers = sub_1000CB768((uint64_t)_swiftEmptyArrayStorage);
