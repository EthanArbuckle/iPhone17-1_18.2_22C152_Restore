...
- (void).cxx_destruct
{
  ...
  sub_10013FEE4((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_delegate);
  swift_release();
  sub_100009790((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_timingProvider, &qword_10057F5C0);
...
- (BOOL)gestureRecognizer:(id)a3 shouldReceiveTouch:(id)a4
{
  ...
  id v7 = a4;
  id v8 = self;
  unsigned __int8 v9 = sub_100344064(v7);
