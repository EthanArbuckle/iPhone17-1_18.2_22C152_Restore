...
- (void)tintColorDidChange
{
  ...
  swift_beginAccess();
  sub_100443B60(v7, (uint64_t)v4, type metadata accessor for SymbolButton.Configuration);
  sub_100436B58((uint64_t)v4);
  sub_10043B8A4((uint64_t)v4, type metadata accessor for SymbolButton.Configuration);
}
...
- (BOOL)isHighlighted
{
  return sub_100435054(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isHighlighted);
}
...
- (BOOL)isSelected
{
  return sub_100435054(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isSelected);
}
...
- (BOOL)isEnabled
{
  return sub_100435054(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isEnabled);
}
...
- (void).cxx_destruct
{
  sub_10004CAE0(*(uint64_t *)((char *)&self->super.super.super.super.isa
                           + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_configurationProvider));
  sub_10004CAE0(*(uint64_t *)((char *)&self->super.super.super.super.isa
                           + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_handler));
  sub_10043B8A4((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton__configuration, type metadata accessor for SymbolButton.Configuration);
  sub_10004CAE0(*(uint64_t *)((char *)&self->super.super.super.super.isa
  ...
  sub_100009790((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton____lazy_storage___metrics, &qword_100585AC0);
}
