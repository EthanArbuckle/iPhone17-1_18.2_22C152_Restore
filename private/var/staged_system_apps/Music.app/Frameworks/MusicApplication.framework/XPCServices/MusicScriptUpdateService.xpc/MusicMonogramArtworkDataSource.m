...
+ (MusicMonogramArtworkDataSource)sharedMonogramArtworkDataSource
{
  if (qword_10059EFA8 != -1) {
    dispatch_once(&qword_10059EFA8, &stru_10053E940);
  }
  v2 = (void *)qword_10059EFA0;
...
+ (OS_dispatch_queue)loadingQueue
{
  if (qword_10059EFB8 != -1) {
    dispatch_once(&qword_10059EFB8, &stru_10053E960);
  }
  v2 = (void *)qword_10059EFB0;
...
- (void)loadRepresentationForArtworkCatalog:(id)a3 completionHandler:(id)a4
{
  ...
  block[1] = 3221225472;
  block[2] = sub_1002D4478;
  block[3] = &unk_10053E9B0;
  id v12 = v6;
  v13 = self;
  id v14 = v7;
  id v9 = v7;
...
- (void)_monogramImageForToken:(id)a3 fittingSize:(CGSize)a4 scale:(double)a5 completionHandler:(id)a6
{
  ...
  if (!self->_renderer)
  {
    ...
    v16 = (void *)qword_10059EFC0;
    uint64_t v41 = qword_10059EFC0;
    if (!qword_10059EFC0)
    {
    ...
    v39 = &v38;
    uint64_t v40 = 0x2050000000;
    v19 = (void *)qword_10059EFD0;
    uint64_t v41 = qword_10059EFD0;
    if (!qword_10059EFD0)
    {
      v33 = _NSConcreteStackBlock;
      uint64_t v34 = 3221225472;
  ...
  v39 = &v38;
  uint64_t v40 = 0x2050000000;
  v24 = (void *)qword_10059EFD8;
  uint64_t v41 = qword_10059EFD8;
  if (!qword_10059EFD8)
  {
    v33 = _NSConcreteStackBlock;
    uint64_t v34 = 3221225472;
  ...
  v39 = &v38;
  uint64_t v40 = 0x2050000000;
  v27 = (void *)qword_10059EFE0;
  uint64_t v41 = qword_10059EFE0;
  if (!qword_10059EFE0)
  {
    v33 = _NSConcreteStackBlock;
    uint64_t v34 = 3221225472;
