...
- (void)imagePickerController:(id)a3 didFinishPickingMediaWithInfo:(id)a4
{
  ...
  sub_1003FE664(&qword_10057D790, type metadata accessor for InfoKey);
...
- (void)documentPickerWasCancelled:(id)a3
{
  ...
  sub_1003FE700((uint64_t)self + OBJC_IVAR____TtCV11MusicCoreUI11ImagePicker11Coordinator_imagePicker, (uint64_t)v7);
  v8 = &v7[*(int *)(v5 + 40)];
  uint64_t v9 = *(void *)v8;
  ...
  id v11 = a3;
  v12 = self;
  sub_100005BFC(&qword_100584380);
  sub_10045F5F0();
  [v11 dismissViewControllerAnimated:1 completion:0];
  sub_1003FE764((uint64_t)v7);
}
...
- (void).cxx_destruct
{
  sub_1003FE764((uint64_t)self + OBJC_IVAR____TtCV11MusicCoreUI11ImagePicker11Coordinator_imagePicker);
