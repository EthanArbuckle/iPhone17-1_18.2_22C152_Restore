...
- (void)execute
{
  ...
  *(void *)(v3 + 16) = v2;
  id v4 = v2;
  static OS_dispatch_queue.asyncOnMainIfNeeded(_:)((uint64_t (*)(void))sub_2A4524, v3);
...
- (_TtC16MusicApplication37JSMusicVideoViewModelRequestOperation)init
{
  result = (_TtC16MusicApplication37JSMusicVideoViewModelRequestOperation *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
