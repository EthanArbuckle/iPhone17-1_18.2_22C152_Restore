...
- (_TtC16MusicApplication27JSLiveRadioCaseModelRequest)init
{
  *(void *)&self->MPModelRequest_opaque[OBJC_IVAR____TtC16MusicApplication27JSLiveRadioCaseModelRequest_liveRadioCaseViewModel] = 0;
  v3.receiver = self;
  v3.super_class = (Class)type metadata accessor for JSLiveRadioCaseModelRequest();
...
{
  v4 = self;
  sub_249A78((uint64_t)a3, (uint64_t)v7);
...
- (id)newOperationWithResponseHandler:(id)a3
{
  ...
  *(void *)(v5 + 16) = v4;
  ...
  v12[4] = sub_B6D6C;
  v12[5] = v5;
  id v13 = objc_allocWithZone((Class)type metadata accessor for JSLiveRadioCaseModelRequestOperation());
  id v14 = sub_24B824(v6, (uint64_t)sub_24B818, (uint64_t)v12);
