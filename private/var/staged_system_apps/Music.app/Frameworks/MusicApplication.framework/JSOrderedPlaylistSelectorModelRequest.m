...
- (_TtC16MusicApplication37JSOrderedPlaylistSelectorModelRequest)init
{
  ...
  *(void *)&self->MPModelRequest_opaque[OBJC_IVAR____TtC16MusicApplication37JSOrderedPlaylistSelectorModelRequest_orderedPlaylistSelector] = 0;
  v5.receiver = self;
...
{
  v4 = self;
  sub_51FF5C((uint64_t)a3, (uint64_t)v7);
...
- (id)newOperationWithResponseHandler:(id)a3
{
  ...
  *(void *)(v5 + 16) = v4;
  ...
  v12[4] = sub_B6D6C;
  v12[5] = v5;
  id v13 = objc_allocWithZone((Class)type metadata accessor for JSOrderedPlaylistSelectorRequestOperation());
  id v14 = sub_521068(v6, (uint64_t)sub_52105C, (uint64_t)v12);
