...
- (void)tintColorDidChange
{
  ...
  swift_beginAccess();
  sub_100C35BE4(v7, (uint64_t)v4, type metadata accessor for SymbolButton.Configuration);
  sub_100C28D38((uint64_t)v4);
...
- (BOOL)isHighlighted
{
  return sub_100C27234(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isHighlighted);
}
...
- (BOOL)isSelected
{
  return sub_100C27234(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isSelected);
}
...
- (BOOL)isEnabled
{
  return sub_100C27234(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isEnabled);
}
...
- (void).cxx_destruct
{
  ...
  sub_100C2DA84((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton__configuration, type metadata accessor for SymbolButton.Configuration);
  sub_10006ADFC(*(uint64_t *)((char *)&self->super.super.super.super.isa
  ...
  sub_1000637B8((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton____lazy_storage___metrics, &qword_1010D0F80);
}
