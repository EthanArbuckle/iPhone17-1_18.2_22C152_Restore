...
- (void)touchesBegan:(id)a3 withEvent:(id)a4
{
  sub_100057778(0, &qword_1010D0A60);
  sub_100C1D638();
...
- (_TtCC11MusicCoreUI10SliderViewP33_54515F1554A39BA10CF5FF24DBCB49D920PanGestureRecognizer)initWithTarget:(id)a3 action:(SEL)a4
{
  ...
  return (_TtCC11MusicCoreUI10SliderViewP33_54515F1554A39BA10CF5FF24DBCB49D920PanGestureRecognizer *)sub_100C1A418((uint64_t)v6, (uint64_t)a4);
}
