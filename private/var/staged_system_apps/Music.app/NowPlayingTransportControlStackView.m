...
- (_TtC5Music35NowPlayingTransportControlStackView)initWithCoder:(id)a3;
- (_TtC5Music35NowPlayingTransportControlStackView)initWithFrame:(CGRect)a3;
@end
...
- (_TtC5Music35NowPlayingTransportControlStackView)initWithFrame:(CGRect)a3
{
  ...
  *((unsigned char *)&self->super.super.super.super.isa
  + OBJC_IVAR____TtC5Music35NowPlayingTransportControlStackView_useBoundsAsPointInside) = 0;
  v8.receiver = self;
...
- (BOOL)pointInside:(CGPoint)a3 withEvent:(id)a4
{
  ...
  id v8 = a4;
  v9 = self;
  LOBYTE(v4) = sub_100390C88(v4, x, y);
