...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  else
  {
    ...
    char v15 = v7[24];
    v16 = self;
    sub_1003B1CDC(width, height, v14, v8);
    double v10 = v17;
    sub_1003B1CDC(width, height, v13, v15);
    double v12 = v18;
  }
  double v19 = v10;
  double v20 = v12;
...
- (void).cxx_destruct
{
  sub_1003B5D58((uint64_t)self + OBJC_IVAR____TtCV11MusicCoreUI7Artwork4View_typedConfiguration, type metadata accessor for Artwork);
