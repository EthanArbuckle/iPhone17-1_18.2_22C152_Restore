...
- (void)engine:(id)a3 didFailToPlayFirstItem:(id)a4 withError:(id)a5
{
  sub_100123DA4(0, (unint64_t *)&qword_1006697B0);
  ...
  id v15 = v10;
  id v16 = a3;
  static OS_dispatch_queue.asyncOnMainIfNeeded(_:)((uint64_t (*)(void))sub_10029EB68, (uint64_t)v9);
...
- (void)engine:(id)a3 requiresAuthorizationToPlayItem:(id)a4 reason:(int64_t)a5 authorizationHandler:(id)a6
{
  ...
  *(void *)(v11 + 16) = v10;
  ...
  id v16 = a3;
  swift_retain();
  static OS_dispatch_queue.asyncOnMainIfNeeded(_:)(sub_10029C3D4, (uint64_t)v12);
