...
- (void)tintColorDidChange
{
  ...
  swift_beginAccess();
  sub_100516EAC(v7, (uint64_t)v4, type metadata accessor for SymbolButton.Configuration);
  sub_100509EA4((uint64_t)v4);
  sub_10050EBF0((uint64_t)v4, type metadata accessor for SymbolButton.Configuration);
}
...
- (BOOL)isHighlighted
{
  return sub_1005083A0(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isHighlighted);
}
...
- (BOOL)isSelected
{
  return sub_1005083A0(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isSelected);
}
...
- (BOOL)isEnabled
{
  return sub_1005083A0(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isEnabled);
}
...
- (void).cxx_destruct
{
  sub_100121638(*(uint64_t *)((char *)&self->super.super.super.super.isa
                           + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_configurationProvider));
  sub_100121638(*(uint64_t *)((char *)&self->super.super.super.super.isa
                           + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_handler));
  sub_10050EBF0((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton__configuration, type metadata accessor for SymbolButton.Configuration);
  sub_100121638(*(uint64_t *)((char *)&self->super.super.super.super.isa
  ...
  sub_100013C44((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton____lazy_storage___metrics, &qword_100678F50);
}
