...
- (void)connection:(id)a3 didReceiveMessageForTopic:(id)a4 userInfo:(id)a5
{
  uint64_t v9 = sub_100007568(&qword_1005A5030);
  __chkstk_darwin(v9 - 8);
  v11 = (char *)&v18 - ((v10 + 15) & 0xFFFFFFFFFFFFFFF0);
  if (a4)
  {
    uint64_t v12 = sub_100483E10();
    a4 = v13;
    if (a5)
    {
LABEL_3:
      uint64_t v14 = sub_100483BF0();
      uint64_t v15 = sub_100484420();
      ...
      id v17 = a3;
      swift_bridgeObjectRetain();
      sub_10012368C((uint64_t)v11, (uint64_t)&unk_1005A7380, (uint64_t)v16);
      swift_release();
...
- (_TtC9MusicCore24PushNotificationObserver)init
{
  ...
  swift_retain();
  *(void *)self->registeredHandlers = sub_1000EF8F8((uint64_t)_swiftEmptyArrayStorage);
