...
- (void).cxx_destruct
{
  ...
  sub_100013294((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_delegate);
  swift_release();
  sub_1000130E4((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI26SyncedLyricsViewController_timingProvider, &qword_1005AFA70);
...
- (BOOL)gestureRecognizer:(id)a3 shouldReceiveTouch:(id)a4
{
  ...
  id v7 = a4;
  id v8 = self;
  unsigned __int8 v9 = sub_1003672D8(v7);
