...
- (BOOL)isEqual:(id)a3
{
  ...
  sub_1000130E4((uint64_t)v8, (uint64_t *)&unk_1005A5260);
  return v6 & 1;
}
...
- (void).cxx_destruct
{
  ...
  uint64_t v11 = sub_100007568(&qword_1005A9D60);
...
- (void)groupSessionDidConnect:(id)a3
{
  uint64_t v5 = sub_100007568(&qword_1005A5030);
  __chkstk_darwin(v5 - 8);
  v7 = (char *)&v12 - ((v6 + 15) & 0xFFFFFFFFFFFFFFF0);
  uint64_t v8 = sub_100484420();
  (*(void (**)(char *, uint64_t, uint64_t, uint64_t))(*(void *)(v8 - 8) + 56))(v7, 1, 1, v8);
  sub_1004843E0();
  swift_unknownObjectRetain_n();
  v9 = self;
  uint64_t v10 = sub_1004843D0();
  uint64_t v11 = (void *)swift_allocObject();
  v11[2] = v10;
  v11[3] = &protocol witness table for MainActor;
  v11[4] = a3;
  v11[5] = v9;
  sub_10012368C((uint64_t)v7, (uint64_t)&unk_1005A9F50, (uint64_t)v11);
  swift_unknownObjectRelease();
...
- (void)groupSession:(id)a3 didInvalidateWithError:(id)a4
{
  uint64_t v6 = sub_100007568(&qword_1005A5030);
  ...
  v13 = v11;
  swift_unknownObjectRetain();
  uint64_t v14 = sub_1004843D0();
  v15 = (void *)swift_allocObject();
  v15[2] = v14;
  v15[3] = &protocol witness table for MainActor;
  v15[4] = v12;
  v15[5] = v13;
  sub_10012368C((uint64_t)v8, (uint64_t)&unk_1005A9F48, (uint64_t)v15);
  swift_unknownObjectRelease();
