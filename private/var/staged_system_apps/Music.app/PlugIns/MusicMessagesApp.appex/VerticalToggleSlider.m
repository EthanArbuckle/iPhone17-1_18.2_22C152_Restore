...
- (BOOL)isEnabled
{
  return sub_100473908(self, (uint64_t)a2, (SEL *)&selRef_isEnabled);
}
...
- (BOOL)isHighlighted
{
  return sub_100473908(self, (uint64_t)a2, (SEL *)&selRef_isHighlighted);
}
