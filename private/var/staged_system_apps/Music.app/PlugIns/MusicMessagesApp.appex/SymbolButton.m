...
- (void)tintColorDidChange
{
  ...
  swift_beginAccess();
  sub_100466C78(v7, (uint64_t)v4, type metadata accessor for SymbolButton.Configuration);
  sub_100459C70((uint64_t)v4);
  sub_10045E9BC((uint64_t)v4, type metadata accessor for SymbolButton.Configuration);
}
...
- (BOOL)isHighlighted
{
  return sub_10045816C(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isHighlighted);
}
...
- (BOOL)isSelected
{
  return sub_10045816C(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isSelected);
}
...
- (BOOL)isEnabled
{
  return sub_10045816C(self, (uint64_t)a2, type metadata accessor for SymbolButton, (SEL *)&selRef_isEnabled);
}
...
- (void).cxx_destruct
{
  sub_1000109BC(*(uint64_t *)((char *)&self->super.super.super.super.isa
                           + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_configurationProvider));
  sub_1000109BC(*(uint64_t *)((char *)&self->super.super.super.super.isa
                           + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton_handler));
  sub_10045E9BC((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton__configuration, type metadata accessor for SymbolButton.Configuration);
  sub_1000109BC(*(uint64_t *)((char *)&self->super.super.super.super.isa
  ...
  sub_1000130E4((uint64_t)self + OBJC_IVAR____TtC11MusicCoreUI12SymbolButton____lazy_storage___metrics, &qword_1005B5F70);
}
