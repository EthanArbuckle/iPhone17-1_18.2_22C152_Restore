...
- (void)imagePickerController:(id)a3 didFinishPickingMediaWithInfo:(id)a4
{
  ...
  sub_1004216B0(&qword_1005ADC40, type metadata accessor for InfoKey);
  uint64_t v6 = sub_100483BF0();
  id _ = a3;
  v7 = self;
...
- (void)documentPickerWasCancelled:(id)a3
{
  ...
  sub_10042174C((uint64_t)self + OBJC_IVAR____TtCV11MusicCoreUI11ImagePicker11Coordinator_imagePicker, (uint64_t)v7);
  v8 = &v7[*(int *)(v5 + 40)];
  uint64_t v9 = *(void *)v8;
  ...
  id v11 = a3;
  v12 = self;
  sub_100007568(&qword_1005B4830);
  sub_100482740();
  [v11 dismissViewControllerAnimated:1 completion:0];
  sub_1004217B0((uint64_t)v7);
}
...
- (void).cxx_destruct
{
  sub_1004217B0((uint64_t)self + OBJC_IVAR____TtCV11MusicCoreUI11ImagePicker11Coordinator_imagePicker);
