...
- (void)tintColorDidChange
{
  ...
  v3 = (void (**)(void))&v2[OBJC_IVAR____TtC5Music22TintColorObservingView_tintColorDidChangeCallback];
  swift_beginAccess();
  v4 = *v3;
  if (!*v3) {
    goto LABEL_4;
...
- (_TtC5Music22TintColorObservingView)initWithFrame:(CGRect)a3
{
  ...
  v8 = (Class *)((char *)&self->super.super.super.isa
               + OBJC_IVAR____TtC5Music22TintColorObservingView_tintColorDidChangeCallback);
