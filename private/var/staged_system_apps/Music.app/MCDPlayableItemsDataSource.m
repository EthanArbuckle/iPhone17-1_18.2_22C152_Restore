...
+ (id)requiredPropertiesForSongs
{
  ...
  uint64_t v13 = MPModelPropertyHomeSharingAssetAvailable;
...
+ (id)requiredPlaylistEntryPropertiesForModelClass:(Class)a3
{
  ...
  {
    v9 = [(id)objc_opt_class() requiredPropertiesForSongs];
    uint64_t v10 = [v8 propertySetByCombiningWithPropertySet:v9];
