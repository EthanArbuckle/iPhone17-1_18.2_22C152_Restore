...
- (BOOL)isEnabled
{
  return sub_100C42848(self, (uint64_t)a2, (SEL *)&selRef_isEnabled);
}
...
- (BOOL)isHighlighted
{
  return sub_100C42848(self, (uint64_t)a2, (SEL *)&selRef_isHighlighted);
}
