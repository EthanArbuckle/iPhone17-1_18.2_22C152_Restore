...
- (id)_modelRequest
{
  id v3 = objc_alloc_init((Class)MPModelLibraryRequest);
  ...
  if ([(_MCDContentManager *)self showLocalContent]) {
    [v3 setFilteringOptions:[v3 filteringOptions] | 2];
  }
  if ([(_MCDContentManager *)self showFavoriteContent])
  {
    ...
    if (v36)
    {
      ...
      [v3 setFilteringOptions:([v3 filteringOptions] | [v37 favoriteFilteringOptions])];
    }
  }
