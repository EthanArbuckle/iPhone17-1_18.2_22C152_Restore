...
- (BOOL)isEqual:(id)a3
{
  ...
  sub_1000637B8((uint64_t)v8, (uint64_t *)&unk_1010C0270);
  return v6 & 1;
}
...
- (void)groupSessionDidConnect:(id)a3
{
  uint64_t v5 = sub_100063814(&qword_1010C0040);
  ...
  v11[4] = a3;
  v11[5] = v9;
  sub_100066A68((uint64_t)v7, (uint64_t)&unk_1010C4F60, (uint64_t)v11);
  swift_unknownObjectRelease();
...
- (void)groupSession:(id)a3 didInvalidateWithError:(id)a4
{
  ...
  v15[4] = v12;
  v15[5] = v13;
  sub_100066A68((uint64_t)v8, (uint64_t)&unk_1010C4F58, (uint64_t)v15);
  swift_unknownObjectRelease();
