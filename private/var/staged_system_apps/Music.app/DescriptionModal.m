...
- (_TtC5Music16DescriptionModal)initWithCoder:(id)a3
{
  result = (_TtC5Music16DescriptionModal *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
- (_TtC5Music16DescriptionModal)initWithNavigationBarClass:(Class)a3 toolbarClass:(Class)a4
{
  result = (_TtC5Music16DescriptionModal *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
