...
- (BKLibraryBookshelfLibraryCollectionViewConfiguration)initWithCollection:(id)a3
{
  ...
  if (v5)
  {
    ...
    uint64_t v10 = kBKCollectionDefaultAll;
...
- (id)productInfoFilter
{
  return +[NSPredicate predicateWithFormat:@"(state = %@ || state = %@) && contentType != %@", &off_100A830C8, &off_100A830E0, &off_100A830E0];
}
...
- (BOOL)supportsReadingListsButton
{
  ...
  v3 = [v2 collectionID];
  unsigned __int8 v4 = [v3 isEqualToString:kBKCollectionDefaultAll];
...
- (id)sortControlConfig
{
  ...
  unsigned __int8 v4 = [(BKLibraryBookshelfLibraryBaseViewConfiguration *)self collectionID];
  ...
  uint64_t v6 = +[BKLibraryManager predicateForAssetsInCollectionID:v5 allowExplicit:1];
  ...
  uint64_t v12 = [v11 localizedStringForKey:@"Sort by…" value:&stru_100A70340 table:0];

  v13 = objc_alloc_init(BKLibrarySortByMode);
  [(BKLibrarySortByMode *)v13 setSortMode:1];
  v14 = +[NSBundle mainBundle];
  objc_super v15 = [v14 localizedStringForKey:@"Recent" value:&stru_100A70340 table:0];
  ...
  v20 = [v19 localizedStringForKey:@"Title" value:&stru_100A70340 table:0];
  ...
  v25 = [v24 localizedStringForKey:@"Author" value:&stru_100A70340 table:0];
  ...
  v29 = [v28 localizedStringForKey:@"Manual" value:&stru_100A70340 table:0];
