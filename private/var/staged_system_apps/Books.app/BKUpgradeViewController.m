...
- (void)viewDidLoad
{
  ...
  int64_t v3 = +[UIColor bc_booksBackground];
...
- (void)_setupSmartInvert
{
  ...
  int64_t v4 = [(BKUpgradeViewController *)self _computedUserInterfaceStyle];
...
- (BKUpgradeViewController)initWithCoder:(id)a3
{
  ...
  int64_t v3 = [(BKUpgradeViewController *)&v6 initWithCoder:a3];
  int64_t v4 = v3;
  if (v3) {
