@interface PPTPageScrollerBackwardPageTurnTest
- (void)turnPage;
@end

@implementation PPTPageScrollerBackwardPageTurnTest
...
- (void)turnPage
{
  ...
  unsigned __int8 v9 = +[RETestDriver turnPageWithViewController:v8 forward:0];
