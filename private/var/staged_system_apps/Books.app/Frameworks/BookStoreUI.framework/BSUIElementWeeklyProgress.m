...
+ (id)supportedAttributes
{
  return +[BSUIWeeklyProgressMetrics supportedAttributes];
}
...
+ (BOOL)supportAttribute:(unsigned __int16)a3 feature:(id)a4
{
  return [a4 isEqualToString:@"supportsWidgetFormat"];
}
...
+ (void)configureObject:(id)a3 withBuilder:(id)a4 context:(id)a5
{
  ...
  id v14 = [v9 weeklyProgressMetrics];
...
+ (void)configureBox:(id)a3 withNode:(id)a4 attributes:(id)a5 context:(id)a6
{
  ...
  id v10 = a5;
  id v11 = a3;
  id v12 = [[BSUIWeeklyProgressMetrics alloc] initWithNode:a4.var0 attributes:v10 context:v9];
