...
+ (id)tui_colorWithHexString:(id)a3
{
  v4 = [a3 stringByReplacingOccurrencesOfString:@"#" withString:&stru_257BF0];
  ...
  switch((unint64_t)[v5 length])
  {
    ...
    case 6uLL:
      ...
      uint64_t v14 = 2;
LABEL_5:
      [v11 tui_colorComponentFrom:v12 start:v13 length:v14];
      double v18 = v25;
      double v26 = 1.0;
      goto LABEL_8;
    case 8uLL:
      ...
      uint64_t v22 = 2;
LABEL_7:
      [v19 tui_colorComponentFrom:v20 start:v21 length:v22];
      double v26 = v30;
LABEL_8:
