...
+ (id)transactionWithName:(id)a3 options:(id)a4
{
  id v5 = a4;
  id v6 = a3;
  id v7 = [_TUITransactionAutoProxy alloc];
...
+ (id)currentOrNewTransactionWithOptions:(id)a3 block:(id)a4
{
  return _[a1 _currentOrNewTransactionWithName:0 options:a3 block:a4];
}

+ (id)currentOrNewTransactionWithName:(id)a3 options:(id)a4 block:(id)a5
{
  return _[a1 _currentOrNewTransactionWithName:a3 options:a4 block:a5];
}
...
+ (void)js_transactionWithBlock:(id)a3 options:(id)a4
{
  ...
  if ([v6 isObject])
  {
    id v8 = +[TUITransactionOptions defaultImplicitOptions];
    ...
    id v21 = [v6 callWithArguments:v20];
