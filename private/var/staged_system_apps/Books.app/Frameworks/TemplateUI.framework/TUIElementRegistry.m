...
- (TUIElementRegistry)init
{
  kdebug_trace();
  v9.receiver = self;
  v9.super_class = (Class)TUIElementRegistry;
  v3 = [(TUIElementRegistry *)&v9 init];
  if (v3)
  {
    uint64_t v4 = objc_opt_new();
    elements = v3->_elements;
    v3->_elements = (NSMutableDictionary *)v4;

    uint64_t v6 = objc_opt_new();
    features = v3->_features;
    v3->_features = (NSMutableSet *)v6;
...
- (Class)elementClassForName:(id)a3
{
  if (a3)
  {
    id v4 = -[NSMutableDictionary objectForKeyedSubscript:](self->_elements, "objectForKeyedSubscript:");
  }
  else
  {
    id v4 = 0;
