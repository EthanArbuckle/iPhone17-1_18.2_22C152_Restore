...
+ (id)imaxLocalizedDouble:(double)a3
{
  return _[a1 imaxLocalizedDouble:1 maximumNumberOfDigitsAfterDecimalSeparator:a3];
}
...
+ (id)imaxLocalizedPercentage:(double)a3
{
  return [a1 imaxLocalizedPercentage:1 maximumNumberOfDigitsAfterDecimalSeparator:a3];
}
...
+ (id)imaxLocalizedNumber:(id)a3
{
  return [a1 imaxLocalizedNumber:a3 maximumNumberOfDigitsAfterDecimalSeparator:1];
}

+ (id)imaxLocalizedNumber:(id)a3 maximumNumberOfDigitsAfterDecimalSeparator:(unint64_t)a4
{
  return [a1 imaxLocalizedNumber:a3 numberStyle:1 maximumNumberOfDigitsAfterDecimalSeparator:a4];
}

+ (id)imaxLocalizedNumber:(id)a3 numberStyle:(unint64_t)a4
{
  return [a1 imaxLocalizedNumber:a3 numberStyle:a4 maximumNumberOfDigitsAfterDecimalSeparator:1];
}
