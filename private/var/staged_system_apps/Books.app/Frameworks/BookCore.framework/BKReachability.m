...
- (BOOL)startNotifier
{
  ...
  v7.info = self;
  int v3 = SCNetworkReachabilitySetCallback(self->reachabilityRef, (SCNetworkReachabilityCallBack)sub_153098, &v7);
  if (v3)
  {
...
+ (void)_updateIsOffline
{
  id v2 = +[BKReachability sharedReachabilityForInternetConnection];
  byte_3426F0 = [v2 currentReachabilityStatus] == 0;
}
...
+ (id)sharedReachabilityForInternetConnection
{
  ...
  block[4] = a1;
  if (qword_3493C0 != -1) {
    dispatch_once(&qword_3493C0, block);
  }
  id v2 = (void *)qword_3493B8;
