...
+ (id)cacheItemWithItem:(id)a3 key:(id)a4 cost:(unint64_t)a5
{
  ...
  [v9 setKey:v7];
  id v10 = [v8 conformsToProtocol:&OBJC_PROTOCOL___NSDiscardableContent];
...
- (id)description
{
  return +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"<%@: %p>; Item: %@; Cost: %d; Key: %@; Conforms: %d",
           objc_opt_class(),
           self,
           self->_item,
           self->_cost,
