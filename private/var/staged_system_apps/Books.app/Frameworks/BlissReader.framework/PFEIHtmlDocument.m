...
+ (id)elementReaders
{
  ...
  if (!qword_5737D0)
  {
    ...
    if (!qword_5737D0)
    {
      ...
      objc_opt_class();
      -[PFXElementReaderDictionary addEntryWithElementName:elementNamespace:mappingClass:](v4, "addEntryWithElementName:elementNamespace:mappingClass:");
      ...
      __dmb(0xBu);
      qword_5737D0 = (uint64_t)v4;
    }
    objc_sync_exit(a1);
    return (id)qword_5737D0;
  }
  return result;
}
