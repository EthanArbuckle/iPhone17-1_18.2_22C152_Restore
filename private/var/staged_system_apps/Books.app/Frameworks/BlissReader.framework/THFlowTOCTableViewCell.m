...
- (void)updateBackgroundImage
{
  ...
  objc_super v6 = [(THFlowTOCTableViewCell *)self delegate];
  unsigned int v7 = [v6 tableViewCellShouldStayHighlighted:self];

  uint64_t v8 = [(THFlowTOCTableViewCell *)self isHighlighted] | v7;
  v9 = [(THFlowTOCTableViewCell *)self delegate];
  [v9 tableViewCell:self hideSeparators:v8];

  id v12 = [(THFlowTOCTableViewCell *)self delegate];
...
- (void)startProgressIndicator
{
  ...
  id v4 = [(THFlowTOCTableViewCell *)self activityIndicatorView];
  [v4 setAlpha:0.0];

  id v5 = [(THFlowTOCTableViewCell *)self activityIndicatorView];
  [v5 setHidden:0];

  objc_super v6 = [(THFlowTOCTableViewCell *)self activityIndicatorView];
  [v6 startAnimating];
...
- (void)setHighlighted:(BOOL)a3 animated:(BOOL)a4
{
  ...
  id v5 = [(THFlowTOCTableViewCell *)self delegate];
...
- (void)p_setupContentView
{
  if (self->mOrdinalLabel)
  {
    ...
    id v4 = +[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[THFlowTOCTableViewCell p_setupContentView]");
  ...
  id v12 = [(THFlowTOCTableViewCell *)self contentView];
  [v12 addSubview:self->mOrdinalLabel];

  if (self->mRowLabel)
  {
    v13 = +[TSUAssertionHandler currentHandler];
    v14 = +[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[THFlowTOCTableViewCell p_setupContentView]");
  ...
  if (self->mPageNumberLabel)
  {
    ...
    v20 = +[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[THFlowTOCTableViewCell p_setupContentView]");
  ...
  if (self->mOpenCloseButton)
  {
    ...
    v26 = +[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[THFlowTOCTableViewCell p_setupContentView]");
  ...
  v28 = [objc_alloc((Class)UIButton) initWithFrame:CGRectZero.origin.x, y, width, height];
  ...
  if (self->mActivityIndicatorView)
  {
    ...
    v32 = +[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[THFlowTOCTableViewCell p_setupContentView]");
  ...
  v34 = (UIActivityIndicatorView *)[objc_alloc((Class)UIActivityIndicatorView) initWithActivityIndicatorStyle:100];
...
- (void)p_setupConstraints
{
  ...
  {
    v3 = +[TSUAssertionHandler currentHandler];
    id v4 = +[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[THFlowTOCTableViewCell p_setupConstraints]");
    id v5 = +[NSString stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/Alder/bliss/Classes/THFlowTOCViewController.m"];
  ...
  if (self->mOrdinalLabelWidthConstraint)
  {
    ...
    unsigned int v7 = +[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[THFlowTOCTableViewCell p_setupConstraints]");
    uint64_t v8 = +[NSString stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/Alder/bliss/Classes/THFlowTOCViewController.m"];
  ...
  if (self->mRowLabelLeadingConstraint)
  {
    ...
    v10 = +[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[THFlowTOCTableViewCell p_setupConstraints]");
  ...
  if (self->mPageNumberLabelTrailingConstraint)
  {
    ...
    v13 = +[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[THFlowTOCTableViewCell p_setupConstraints]");
  ...
  if (self->mPageNumberLabelWidthConstraint)
  {
    ...
    v16 = +[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[THFlowTOCTableViewCell p_setupConstraints]");
  ...
  if (self->mOpenCloseButtonTrailingConstraint)
  {
    ...
    v19 = +[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[THFlowTOCTableViewCell p_setupConstraints]");
  ...
  if (self->mOpenCloseButtonWidthConstraint)
  {
    ...
    v22 = +[NSString stringWithUTF8String:](NSString, "stringWithUTF8String:", "-[THFlowTOCTableViewCell p_setupConstraints]");
  ...
  v85[2] = v25;
  v78 = [(UILabel *)self->mOrdinalLabel widthAnchor];
  v27 = [v78 constraintEqualToConstant:0.0];
...
- (void)updateConstraintsWithConfiguration:(id)a3
{
  ...
  id v11 = [(THFlowTOCTableViewCell *)self contentView];
  [v11 setNeedsLayout];
}
...
- (void)updatePageNumberLabelWidth:(double)a3
{
  ...
  if (v5 != a3)
  {
    ...
    double v6 = [(UILabel *)self->mPageNumberLabel superview];
    [v6 setNeedsLayout];
