...
+ (BOOL)handleStylesheetAt:(id)a3 ofType:(id)a4 withMediaType:(id)a5 readerState:(id)a6
{
  ...
  if (+[PFXStylesheet isMediaTypeSupportedInPaginated:a5])
  {
    [a6 setPaginatedAsCurrent];
    BOOL v9 = +[PFXStylesheet readStylesheetFromEntry:a3 readerState:a6];
  }
  else
  {
    BOOL v9 = 1;
  }
  if (!+[PFXStylesheet isMediaTypeSupportedInFlow:a5]) {
    return v9;
  }
  [a6 setFlowAsCurrent];
  if (!v9) {
...
+ (id)elementReaders
{
  ...
  if (!qword_573718)
  {
    ...
    if (!qword_573718)
    {
      ...
      [(PFXElementReaderDictionary *)v4 addEntryWithElementName:"lp" elementNamespace:PFXCommonHintNS[0] mappingClass:objc_opt_class()];
      [(PFXElementReaderDictionary *)v4 addEntryWithElementName:"sp" elementNamespace:PFXCommonHintNS[0] mappingClass:objc_opt_class()];
      [(PFXElementReaderDictionary *)v4 addEntryWithElementName:"switch" elementNamespace:PFXCommonEpubOpsNS[0] mappingClass:objc_opt_class()];
      [(PFXElementReaderDictionary *)v4 addEntryWithElementName:"default" elementNamespace:PFXCommonEpubOpsNS[0] mappingClass:objc_opt_class()];
      [(PFXElementReaderDictionary *)v4 addEntryWithElementName:"case" elementNamespace:PFXCommonEpubOpsNS[0] mappingClass:objc_opt_class()];
      __dmb(0xBu);
      qword_573718 = (uint64_t)v4;
    }
    objc_sync_exit(a1);
    return (id)qword_573718;
  }
  return result;
}
