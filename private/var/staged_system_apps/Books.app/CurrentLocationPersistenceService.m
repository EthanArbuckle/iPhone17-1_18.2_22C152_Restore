...
- (_TtC5Books33CurrentLocationPersistenceService)init
{
  result = (_TtC5Books33CurrentLocationPersistenceService *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  _s5Books15CurrentPageViewVwxx_0((uint64_t)self + OBJC_IVAR____TtC5Books33CurrentLocationPersistenceService_bookEntity);
  swift_unknownObjectRelease();
  swift_bridgeObjectRelease();
  v3 = (char *)self + OBJC_IVAR____TtC5Books33CurrentLocationPersistenceService__persistedLocation;
  uint64_t v4 = sub_100058D18(&qword_100B3BEE8);
...
- (void)controller:(id)a3 didChangeObject:(id)a4 atIndexPath:(id)a5 forChangeType:(unint64_t)a6 newIndexPath:(id)a7
{
  ...
  CurrentLocationPersistenceService.controller(_:didChange:at:for:newIndexPath:)(v18, (uint64_t)v27, v25, a6);
