...
{
  v11.receiver = self;
  v11.super_class = (Class)BKLibraryBookshelfLibraryWantToReadViewConfiguration;
...
- (id)viewTitle
{
  return +[BCCollection titleForDefaultCollectionID:kBKCollectionDefaultIDWantToRead];
}
...
- (id)sortControlConfig
{
  ...
  uint64_t v3 = kBKCollectionDefaultIDWantToRead;
