...
+ (id)setupBookshelfWithConfig:(id)a3
{
  ...
  if (v4 && ([v4 isDefaultCollection] & 1) == 0) {
    unsigned int v75 = [v5 isSeriesCollection] ^ 1;
  }
  else {
    unsigned int v75 = 0;
  }
  ...
  if (v5) {
    id v10 = [v5 resolvedSortMode];
  }
  else {
    id v10 = [v3 initialSortMode];
  }
  ...
  id v44 = [v3 providesReviewData];
  id v45 = [v3 providesProductInfoData];
  ...
  id v65 = [(BKLibraryBookshelfSupplementaryDataSource *)v8 viewMode];
...
+ (id)libraryViewControllerWithIdentifier:(id)a3
{
  ...
  if (v3)
  {
    id v10 = [v9 objectForKeyedSubscript:v3];
  ...
  if (v13)
  {
    ...
    id v13 = [v15 mutableCollectionWithCollectionID:v13 inManagedObjectContext:v17 error:0];
  ...
  if (v24)
  {
    ...
    while (2)
    {
      for (i = 0; i != v25; i = (char *)i + 1)
      {
        ...
        {
          v29 = (BKLibraryBookshelfLibraryCollectionViewConfiguration *)objc_alloc_init((Class)[v23 objectForKeyedSubscript:v28]);
...
+ (id)supplementalContentPDFPickerWithPlaylistID:(id)a3 fromActionMenu:(BOOL)a4
{
  ...
  id v6 = a3;
  kdebug_trace();
  uint64_t v7 = kBKCollectionDefaultIDPDFs;
  ...
  id v13 = [[BKLibraryBookshelfSupplementalPDFPickerCollectionViewConfiguration alloc] initWithCollection:v12 storePlaylistID:v6 fromActionMenu:v4];
