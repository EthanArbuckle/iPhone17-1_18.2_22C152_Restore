...
- (_TtC5Files39DOCServiceDocumentBrowserViewController)initWithCoder:(id)a3
{
  ...
  *((unsigned char *)&self->super.super.super.super.super.isa
  + OBJC_IVAR____TtC5Files39DOCServiceDocumentBrowserViewController_hasAddedUIPBackdrop) = 0;
  uint64_t v4 = OBJC_IVAR____TtC5Files39DOCServiceDocumentBrowserViewController_updateBarButtonTrackingViews_lastSentFramesByUUID;
  id v5 = a3;
  *(Class *)((char *)&self->super.super.super.super.super.isa + v4) = (Class)sub_100494BA4((uint64_t)_swiftEmptyArrayStorage);

  result = (_TtC5Files39DOCServiceDocumentBrowserViewController *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
- (void)_renameDocumentAtURL:(id)a3 newName:(id)a4 completion:(id)a5
{
  ...
  id v11 = a3;
  id v12 = self;
  sub_10044A260(v11, v8, v10, v12, (void (**)(const void *, void, void *))v7);
  _Block_release(v7);
  _Block_release(v7);
...
- (void)_getAnimationInfoForDocumentAtURL:(id)a3 completion:(id)a4
{
  ...
  *(void *)(v7 + 16) = v6;
  id v8 = a3;
  uint64_t v9 = self;
  sub_100443958(v8, (uint64_t)sub_100292E70, v7);
...
- (BOOL)documentBrowser:(id)a3 shouldShowActivityViewControllerForDocumentURLs:(id)a4 popoverTracker:(id)a5 isContentManaged:(BOOL)a6 additionalActivities:(id)a7 activityProxy:(id)a8
{
  ...
  *(void *)(v16 + 48) = a8;
  ...
  swift_retain();
  swift_bridgeObjectRetain();
  sub_100445658(v13, 0, (uint64_t)sub_10044BE88, v16);
...
- (void)documentBrowser:(id)a3 didImportDocumentAtURL:(id)a4 toDestinationURL:(id)a5
{
  ...
  id v14 = a3;
  uint64_t v15 = self;
  sub_10044B918((uint64_t)v13, (uint64_t)v10);
...
{
  id v3 = a3;
  id result = (_TtC5Files39DOCServiceDocumentBrowserViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
{
  id v2 = self;
  unsigned __int8 v3 = sub_100446B88();
...
{
  BOOL v4 = a4;
  uint64_t v7 = type metadata accessor for UITraitOverrides();
  __chkstk_darwin(v7);
  id v8 = a3;
  id v9 = self;
