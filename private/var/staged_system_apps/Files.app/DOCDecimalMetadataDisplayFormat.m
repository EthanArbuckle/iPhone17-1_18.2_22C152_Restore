...
- (DOCDecimalMetadataDisplayFormat)init
{
  ...
  if (v2)
  {
    ...
    *(_OWORD *)&v2->_maxFractionalDigits = xmmword_10059B730;
...
- (id)_decimalLengthFormattedDoubleValue:(double)a3
{
  ...
  id v7 = [v5 stringFromValue:-[DOCDecimalMetadataDisplayFormat lengthUnits](self, "lengthUnits") unit:a3];
...
- (void)_configureNumberFormatter:(id)a3
{
  id v4 = a3;
  [v4 setNumberStyle:1];
  [v4 setMaximumFractionDigits:[self maxFractionalDigits]];
}
