...
- (void)didMoveToWindow
{
  ...
  double v3 = (char *)v2;
  sub_100295EE4(v3, (unsigned __int8 *)v3);
}
...
- (_TtC5Files34DOCProgressCollectionIndicatorView)initWithFrame:(CGRect)a3
{
  CGSize result = (_TtC5Files34DOCProgressCollectionIndicatorView *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  sub_10003A094((uint64_t)self + OBJC_IVAR____TtC5Files34DOCProgressCollectionIndicatorView_delegate);
