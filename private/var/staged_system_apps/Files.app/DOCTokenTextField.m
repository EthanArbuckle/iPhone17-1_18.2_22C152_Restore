...
- (void)setFont:(id)a3
{
  ...
  v6 = (char *)sub_1003BE64C();
  id v7 = [v5 font];
  v8 = *(void **)&v6[OBJC_IVAR____TtC5FilesP33_D8D362724F0696B48319604C3F2D1F0417DOCTokenChainView_font];
  *(void *)&v6[OBJC_IVAR____TtC5FilesP33_D8D362724F0696B48319604C3F2D1F0417DOCTokenChainView_font] = v7;
  id v9 = v7;

  v10 = v6;
  sub_1003C3144(v10, (uint64_t)v10);
}
...
- (_TtC5Files17DOCTokenTextField)initWithFrame:(CGRect)a3
{
  ...
  *(void *)&self->dataSource[OBJC_IVAR____TtC5Files17DOCTokenTextField_dataSource] = 0;
...
- (_TtC5Files17DOCTokenTextField)initWithCoder:(id)a3
{
  return (_TtC5Files17DOCTokenTextField *)sub_1003C1D3C(a3);
}
...
- (NSArray)keyCommands
{
  return (NSArray *)sub_1003C1F78(self, (uint64_t)a2, (uint64_t (*)(void))sub_1003C2000);
}
...
- (BOOL)canPerformAction:(SEL)a3 withSender:(id)a4
{
  ...
  char v8 = sub_1003C226C((uint64_t)a3, (uint64_t)v10);
...
- (CGRect)textRectForBounds:(CGRect)a3
{
  double v3 = sub_1003C2658(self, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height, (uint64_t)a2, (SEL *)&selRef_textRectForBounds_);
...
- (CGRect)editingRectForBounds:(CGRect)a3
{
  double v3 = sub_1003C2658(self, a3.origin.x, a3.origin.y, a3.size.width, a3.size.height, (uint64_t)a2, (SEL *)&selRef_editingRectForBounds_);
  result.size.double height = v6;
  result.size.double width = v5;
  result.origin.double y = v4;
  result.origin.double x = v3;
...
- (void).cxx_destruct
{
  sub_10003A094((uint64_t)self + OBJC_IVAR____TtC5Files17DOCTokenTextField_dataSource);
