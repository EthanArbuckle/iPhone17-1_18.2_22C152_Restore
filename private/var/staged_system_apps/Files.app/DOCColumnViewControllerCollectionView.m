...
- (_TtC5Files37DOCColumnViewControllerCollectionView)initWithCoder:(id)a3
{
  return (_TtC5Files37DOCColumnViewControllerCollectionView *)sub_100412960(self, (uint64_t)a2, (uint64_t)a3, v3, (uint64_t (*)(uint64_t))type metadata accessor for DOCColumnViewControllerCollectionView);
}
