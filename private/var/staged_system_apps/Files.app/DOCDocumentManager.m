...
- (void)setActiveDocumentCreationSession:(id)a3
{
  id v4 = *(Class *)((char *)&self->super.isa + OBJC_IVAR____TtC5Files18DOCDocumentManager_activeDocumentCreationSession);
...
- (void)importDocumentAt:(id)a3 mode:(unint64_t)a4 toDefaultLocationWithCompletion:(id)a5
{
  ...
  *(void *)(v15 + 16) = v14;
  ...
  unint64_t v22 = *(Class *)((char *)&self->super.isa + OBJC_IVAR____TtC5Files18DOCDocumentManager_configuration);
  uint64_t v23 = v16;
  unint64_t v21 = *(Class *)((char *)&self->super.isa + OBJC_IVAR____TtC5Files18DOCDocumentManager_sourceObserver);
  ...
  *(void *)(v19 + ((v18 + 15) & 0xFFFFFFFFFFFFFFF8)) = v24;
  id v20 = self;
  swift_retain();
  sub_100230898(v22, v21, 0, (uint64_t)sub_1003881B0, v19);
...
- (void)importDocumentAt:(id)a3 mode:(unint64_t)a4 toCurrentBrowserLocationWithCompletion:(id)a5
{
  ...
  *(void *)(v13 + 16) = v12;
  uint64_t v14 = self;
  sub_1004CB1F4(v11, a4, (uint64_t)sub_1004CF328, v13);
...
- (_TtC5Files18DOCDocumentManager)init
{
  result = (_TtC5Files18DOCDocumentManager *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  sub_10003A094((uint64_t)self + OBJC_IVAR____TtC5Files18DOCDocumentManager_uiBrowserDelegate);
