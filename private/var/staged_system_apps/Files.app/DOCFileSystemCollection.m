...
- (BOOL)isGathering
{
  return *((unsigned char *)&self->super.isa + OBJC_IVAR____TtC5Files23DOCFileSystemCollection_isGathering);
}

- (void)setIsGathering:(BOOL)a3
{
  *((unsigned char *)&self->super.isa + OBJC_IVAR____TtC5Files23DOCFileSystemCollection_isGathering) = a3;
  if (a3)
  {
...
- (_TtC5Files23DOCFileSystemCollection)init
{
  result = (_TtC5Files23DOCFileSystemCollection *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  swift_unknownObjectRelease();
  sub_10003A094((uint64_t)self + OBJC_IVAR____TtC5Files23DOCFileSystemCollection_delegate);
  ...
  sub_1000CBBA4((uint64_t)self + OBJC_IVAR____TtC5Files23DOCFileSystemCollection_lastFlushTime, &qword_100713790);
  v5 = *(Class *)((char *)&self->super.isa + OBJC_IVAR____TtC5Files23DOCFileSystemCollection_observer);
}
