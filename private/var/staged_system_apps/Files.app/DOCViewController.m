...
- (_TtC5Files17DOCViewController)init
{
  uint64_t v3 = OBJC_IVAR____TtC5Files17DOCViewController_appearStateTracker;
...
- (_TtC5Files17DOCViewController)initWithCoder:(id)a3
{
  uint64_t v5 = OBJC_IVAR____TtC5Files17DOCViewController_appearStateTracker;
  type metadata accessor for DOCAppearStateTracker();
  ...
  *(Class *)((char *)&self->super.super.super.isa + v5) = (Class)v6;
  ...
  result = (_TtC5Files17DOCViewController *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
- (_TtC5Files17DOCViewController)initWithNibName:(id)a3 bundle:(id)a4
{
  uint64_t v6 = OBJC_IVAR____TtC5Files17DOCViewController_appearStateTracker;
  type metadata accessor for DOCAppearStateTracker();
