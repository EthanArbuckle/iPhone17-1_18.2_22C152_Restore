...
- (void)traitCollectionDidChange:(id)a3
{
  id v5 = a3;
  v6 = self;
  sub_1002E378C((uint64_t)a3);
}

- (BOOL)isEditing
{
  return [*(id *)((char *)&self->super.super.super.super.super.isa+ OBJC_IVAR____TtC5Files27DOCProgressCollectionViewer_listViewController) isEditing];
}
...
- (void)setEditing:(BOOL)a3
{
  ...
  v6 = self;
  v7 = self;
  [v5 setEditing:v3 animated:[v6 areAnimationsEnabled]];
  sub_1002E3970();
}
...
- (_TtC5Files27DOCProgressCollectionViewer)init
{
  CGSize result = (_TtC5Files27DOCProgressCollectionViewer *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
