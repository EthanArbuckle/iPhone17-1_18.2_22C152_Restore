...
- (void)viewWillTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
  ...
  id v8 = [v7[OBJC_IVAR____TtC5Files28DOCViewOptionsViewController_viewOptionsHostingController] navigationItem];
...
- (void)preferredContentSizeDidChangeForChildContentContainer:(id)a3
{
  ...
  id v5 = *(void **)&v4[OBJC_IVAR____TtC5Files28DOCViewOptionsViewController_viewOptionsHostingController];
  ...
  [v5 preferredContentSize];
  [v4 setPreferredContentSize:CGSizeMake(v7, v10 + v11)];
  swift_unknownObjectRelease();
}

- (_TtC5Files28DOCViewOptionsViewController)init
{
  result = (_TtC5Files28DOCViewOptionsViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
