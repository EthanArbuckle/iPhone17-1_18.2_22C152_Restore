...
- (CGSize)intrinsicContentSize
{
  ...
  if (self->layoutTraits[OBJC_IVAR____TtC5Files22DOCItemStatusBadgeView_layoutTraits + 24])
  {
    v5.receiver = self;
...
- (_TtC5Files22DOCItemStatusBadgeView)initWithImage:(id)a3
{
  double v4 = (char *)self + OBJC_IVAR____TtC5Files22DOCItemStatusBadgeView_layoutTraits;
  *(_OWORD *)double v4 = 0u;
  *((_OWORD *)v4 + 1) = 0u;
  v4[32] = 1;
  v6.receiver = self;
...
- (_TtC5Files22DOCItemStatusBadgeView)initWithImage:(id)a3 highlightedImage:(id)a4
{
  objc_super v6 = (char *)self + OBJC_IVAR____TtC5Files22DOCItemStatusBadgeView_layoutTraits;
