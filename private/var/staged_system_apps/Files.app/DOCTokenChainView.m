...
- (_TtC5FilesP33_D8D362724F0696B48319604C3F2D1F0417DOCTokenChainView)initWithFrame:(CGRect)a3
{
  return (_TtC5FilesP33_D8D362724F0696B48319604C3F2D1F0417DOCTokenChainView *)sub_1003BFAC8(a3.origin.x, a3.origin.y, a3.size.width, a3.size.height);
}
...
- (NSArray)keyCommands
{
  return (NSArray *)sub_1003C1F78(self, (uint64_t)a2, sub_1003C01B4);
}
...
- (void).cxx_destruct
{
  sub_10003A094((uint64_t)self + OBJC_IVAR____TtC5FilesP33_D8D362724F0696B48319604C3F2D1F0417DOCTokenChainView_delegate);
...
- (id)selectionRectsForRange:(id)a3
{
  sub_10009E6C4(0, &qword_100713A28);
