...
LABEL_8:
        ...
        v16 = [[_TtC5Files32DOCItemInfoContentViewController alloc] initWithConfiguration:v10 nodes:v9 allowOpenButton:v15 documentManager:0 actionManager:0 actionDelegate:0];
...
- (void)displayTagView
{
  ...
  [v11 setIsInfoInPopoverMode:[self isInfoInPopoverMode]];
...
- (void)displayAddTagsViewWithItems:(id)a3
{
  ...
  [v12 setIsInfoInPopoverMode:[self isInfoInPopoverMode]];
