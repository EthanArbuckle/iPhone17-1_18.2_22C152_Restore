...
- (_TtC5Files16DOCNavigationBar)initWithFrame:(CGRect)a3
{
  ...
  *((unsigned char *)&self->super.super.super.super.isa + OBJC_IVAR____TtC5Files16DOCNavigationBar_chromelessAppearanceDisabled) = 0;
  *(Class *)((char *)&self->super.super.super.super.isa
...
- (void)layoutSubviews
{
  ...
  id v3 = [v2 doc_nearestAncestorViewController];
...
- (_TtC5Files16DOCNavigationBar)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.super.isa
  ...
  result = (_TtC5Files16DOCNavigationBar *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
