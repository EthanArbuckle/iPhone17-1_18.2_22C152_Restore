...
- (DOCPickerSource)initWithPicker:(id)a3 providerDomain:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  id v8 = objc_alloc((Class)LSApplicationExtensionRecord);
  v9 = [v6 identifier];
  id v10 = [v8 initWithBundleIdentifier:v9 error:0];
  ...
  v15 = [(DOCPickerSource *)self initWithTitle:v11 attributes:v12 optedIn:v13 identifier:v14 providerDomain:v7 pickerExtension:v6];
      ...
      if (v25)
      {
        ...
        do
        {
          for (i = 0; i != v26; i = (char *)i + 1)
          {
            ...
            unsigned __int8 v30 = [v29 isEqualToString:@"UIDocumentPickerModeImport" v39];
            v31 = &off_1006BB3C8;
            if ((v30 & 1) == 0)
            {
