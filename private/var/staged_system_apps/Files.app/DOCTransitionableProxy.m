...
- (void)getTransitionControllerForURL:(id)a3 completionBlock:(id)a4
{
  ...
  _Block_copy(v10);
  swift_retain();
  sub_10019CDA4((uint64_t)v9, (uint64_t)self, (void (**)(void, void))v10);
  _Block_release(v10);
  _Block_release(v10);
  swift_release();
...
- (void)getViewFor:(id)a3 waitForNewThumbnail:(BOOL)a4 :(id)a5
{
  ...
  id v9 = a3;
  swift_retain();
  sub_10019DC10((uint64_t)v9, a4, (uint64_t)self, (uint64_t)v8);
  _Block_release(v8);
  _Block_release(v8);
...
- (void)revealWithItems:(id)a3 selectEvenIfVisible:(BOOL)a4 completionBlock:(id)a5
{
  ...
  *(void *)(v8 + 16) = v6;
  swift_retain();
  sub_10019CA88(v7, a4, (uint64_t)sub_100180CF4, v8);
  swift_release();
