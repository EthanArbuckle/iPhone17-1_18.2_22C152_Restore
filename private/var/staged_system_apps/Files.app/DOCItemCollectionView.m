...
{
  id v4 = a4;
  result = (_TtC5Files21DOCItemCollectionView *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  sub_10003A094((uint64_t)self + OBJC_IVAR____TtC5Files21DOCItemCollectionView_displayDelegate);
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
                     + OBJC_IVAR____TtC5Files21DOCItemCollectionView__dragInteraction));
  sub_10003A094((uint64_t)self + OBJC_IVAR____TtC5Files21DOCItemCollectionView_focusableCollectionViewDelegate);
  swift_release();
  sub_10003A094((uint64_t)self + OBJC_IVAR____TtC5Files21DOCItemCollectionView_gestureDelegate);
  objc_release(*(id *)((char *)&self->super.super.super.super.super.isa
...
- (void)_backgroundTapGestureRecognized:(id)a3
{
  objc_super v5 = (char *)self + OBJC_IVAR____TtC5Files21DOCItemCollectionView_gestureDelegate;
