...
- (_TtC5Files23DOCPickerViewController)initWithCoder:(id)a3
{
  ...
  *(void *)&self->source[OBJC_IVAR____TtC5Files23DOCPickerViewController_delegate] = 0;
  swift_unknownObjectWeakInit();
  id v5 = a3;

  result = (_TtC5Files23DOCPickerViewController *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
- (void)_displayLocationsMenuFromRect:(CGRect)a3
{
  ...
  if (swift_unknownObjectWeakLoadStrong())
  {
    ...
    (*(void (**)(_TtC5Files23DOCPickerViewController *, uint64_t, uint64_t, double, double, double, double))(v9 + 8))(self, ObjectType, v9, x, y, width, height);
    swift_unknownObjectRelease();
  }
}
...
{
  id v4 = a4;
  result = (_TtC5Files23DOCPickerViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  uint64_t v3 = (char *)self + OBJC_IVAR____TtC5Files23DOCPickerViewController_delegate;
