...
{
  v2 = self;
  sub_1002ABD5C((uint64_t)&v3);
  if (v4)
  {
    sub_1001146DC(&v3, (uint64_t)v5);
    sub_1002AFE10(v5);
    sub_10009B1B8((uint64_t)v5);
  }
  else
  {
    sub_1000CBBA4((uint64_t)&v3, &qword_10070D7D0);
  }
}
...
- (_TtC5Files21DOCGoToViewController)init
{
  result = (_TtC5Files21DOCGoToViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  sub_10003A094((uint64_t)self + OBJC_IVAR____TtC5Files21DOCGoToViewController_delegate);
  ...
  sub_10009B1B8((uint64_t)self + OBJC_IVAR____TtC5Files21DOCGoToViewController_initialCandidateSource);
  sub_1000CBBA4((uint64_t)self + OBJC_IVAR____TtC5Files21DOCGoToViewController_filteringSource, &qword_10070D7F8);
  objc_release(*(id *)((char *)&self->super.super.super.super.isa
                     + OBJC_IVAR____TtC5Files21DOCGoToViewController_scrollViewDidScrollObservation));
  sub_1000CBBA4((uint64_t)self + OBJC_IVAR____TtC5Files21DOCGoToViewController_currentGoToLocation, &qword_10070D7E8);
  long long v3 = (char *)self + OBJC_IVAR____TtC5Files21DOCGoToViewController_requestID;
  ...
  id v5 = *(void **)&self->filteringSource[OBJC_IVAR____TtC5Files21DOCGoToViewController_metrics + 7];
