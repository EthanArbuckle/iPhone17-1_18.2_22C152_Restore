...
- (void)_setSelectedViewController:(id)a3
{
  ...
  if (soleValidIndex)
  {
    ...
    v8 = [(DOCAutoBarHidingTabBarController *)self viewControllers];
...
- (id)_selectedOrInflightSelectedViewController
{
  ...
  {
    uint64_t v3 = tabViewControllerBeingSelected;
  }
  else
  {
    uint64_t v3 = [(DOCAutoBarHidingTabBarController *)self _underlyingSelectedViewController];
  }
