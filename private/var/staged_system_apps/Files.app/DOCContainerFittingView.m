...
- (_TtC5Files23DOCContainerFittingView)initWithCoder:(id)a3
{
  ...
  void *v4 = 0;
  v4[1] = 0;
  *((unsigned char *)&self->super.super.super.isa + OBJC_IVAR____TtC5Files23DOCContainerFittingView_preventContentOffsetUpdates) = 0;
  ...
  *(Class *)((char *)&self->super.super.super.isa + OBJC_IVAR____TtC5Files23DOCContainerFittingView_observationContext) = 0;
  ...
  result = (_TtC5Files23DOCContainerFittingView *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
- (CGSize)systemLayoutSizeFittingSize:(CGSize)a3
{
  double v3 = (double *)((char *)self + OBJC_IVAR____TtC5Files23DOCContainerFittingView_fittingSize);
  swift_beginAccess();
  double v4 = *v3;
  double v5 = v3[1];
  result.height = v5;
...
- (_TtC5Files23DOCContainerFittingView)initWithFrame:(CGRect)a3
{
  CGSize result = (_TtC5Files23DOCContainerFittingView *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
