...
- (UIColor)backgroundColor
{
  return (UIColor *)sub_1002AAEF8(self, (uint64_t)a2, (SEL *)&selRef_backgroundColor);
}
...
- (BOOL)textView:(id)a3 shouldChangeTextInRange:(_NSRange)a4 replacementText:(id)a5
{
  ...
  if (!v12 && (v7 == 10 && v9 == 0xE100000000000000 || (_stringCompareWithSmolCheck(_:_:expecting:)() & 1) != 0))
  {
    sub_1002A7EBC(1);
    BOOL v13 = 0;
  }
...
- (id)textView:(id)a3 editMenuForTextInRange:(_NSRange)a4 suggestedActions:(id)a5
{
  ...
  UIMenuElementSize v7 = static Array._unconditionallyBridgeFromObjectiveC(_:)();
  id v8 = a3;
  uint64_t v9 = self;
  Class v10 = sub_1002AB764(v7);
...
{
  id v4 = a4;
  result = (_TtC5Files21DOCItemRenameTextView *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  sub_10003A094((uint64_t)self + OBJC_IVAR____TtC5Files21DOCItemRenameTextView_itemRenameDelegate);
  swift_release();
...
- (UITextViewDelegate)delegate
{
  return (UITextViewDelegate *)sub_1002AAEF8(self, (uint64_t)a2, (SEL *)&selRef_delegate);
}
