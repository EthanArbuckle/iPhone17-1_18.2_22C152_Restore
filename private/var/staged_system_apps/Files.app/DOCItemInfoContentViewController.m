...
- (UIEdgeInsets)layoutMargins
{
  ...
  double v3 = *(double *)&self->configuration[OBJC_IVAR____TtC5Files32DOCItemInfoContentViewController_layoutMargins];
  double v4 = *(double *)&self->actionManager[OBJC_IVAR____TtC5Files32DOCItemInfoContentViewController_layoutMargins];
  double v5 = *(double *)&self->documentManager[OBJC_IVAR____TtC5Files32DOCItemInfoContentViewController_layoutMargins];
  result.right = v5;
  result.bottom = v4;
  result.left = v3;
  result.top = v2;
...
- (void)setLayoutMargins:(UIEdgeInsets)a3
{
  *(UIEdgeInsets *)((char *)&self->super.super.super.isa
  ...
  [*(id *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC5Files32DOCItemInfoContentViewController_rootContentView) setLayoutMargins:];
}
...
- (_TtP5Files30DOCItemInfoContentTagsDelegate_)tagsWorkflowDelegate
{
  ...
  return (_TtP5Files30DOCItemInfoContentTagsDelegate_ *)Strong;
}
...
{
  double v2 = self;
  double v3 = sub_100272F24(&OBJC_IVAR____TtC5Files32DOCItemInfoContentViewController____lazy_storage___metadataView, (uint64_t (*)(uint64_t))sub_100273614);
  char v4 = v3[OBJC_IVAR____TtC5Files15DOCMetadataView_showsItemLocation];
...
- (void)setShowsItemLocation:(BOOL)a3
{
  int v3 = a3;
  char v4 = self;
  double v5 = (unsigned __int8 *)sub_100272F24(&OBJC_IVAR____TtC5Files32DOCItemInfoContentViewController____lazy_storage___metadataView, (uint64_t (*)(uint64_t))sub_100273614);
  int v6 = v5[OBJC_IVAR____TtC5Files15DOCMetadataView_showsItemLocation];
  id v7 = v5;
...
- (_TtC5Files32DOCItemInfoContentViewController)initWithConfiguration:(id)a3 nodes:(id)a4 allowOpenButton:(BOOL)a5 documentManager:(id)a6 actionManager:(id)a7 actionDelegate:(id)a8
{
  ...
  return (_TtC5Files32DOCItemInfoContentViewController *)sub_100276468(v13, v12, a5, a6, a7);
}
...
- (double)layoutHeightForWidth:(double)a3
{
  ...
  [*(id *)((char *)&self->super.super.super.isa+ OBJC_IVAR____TtC5Files32DOCItemInfoContentViewController_rootContentView) systemLayoutSizeFittingSize:a3 withHorizontalFittingPriority:UILayoutFittingCompressedSize.height verticalFittingPriority:v3];
  return v5;
}
...
{
  id v4 = a4;
  UIEdgeInsets result = (_TtC5Files32DOCItemInfoContentViewController *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
...
- (void).cxx_destruct
{
  ...
  double v3 = *(void **)&self->metrics[OBJC_IVAR____TtC5Files32DOCItemInfoContentViewController_metrics + 32];

  sub_10003A094((uint64_t)self + OBJC_IVAR____TtC5Files32DOCItemInfoContentViewController_actionDelegate);
  sub_10003A094((uint64_t)self + OBJC_IVAR____TtC5Files32DOCItemInfoContentViewController_eventReporting);
  sub_10003A094((uint64_t)self + OBJC_IVAR____TtC5Files32DOCItemInfoContentViewController_actionReporting);
  sub_10003A094((uint64_t)self + OBJC_IVAR____TtC5Files32DOCItemInfoContentViewController_tagsWorkflowDelegate);
  objc_release(*(id *)((char *)&self->super.super.super.isa
  ...
  sub_1000D8158(*(id *)((char *)&self->super.super.super.isa
...
+ (BOOL)itemTapDrillsIntoNode:(id)a3
{
  ...
  if ([a3 isFolder])
  {
    unsigned __int8 v4 = [a3 doc_isCollaborationInvitation];
    swift_unknownObjectRelease();
    if ((v4 & 1) == 0) {
      return 1;
    }
