...
- (int)startObservingDefaultSaveLocation
{
  ...
  handler[2] = sub_1000E86B8;
  handler[3] = &unk_100688D28;
  objc_copyWeak(&v6, &location);
...
- (void)updateCachedDisplayNamesFromSources
{
  ...
  if (!v4)
  {
    ...
    uint64_t v8 = [v6 dictionaryForKey:DOCUserDefaultsCachedDisplayNamesBySourceIdentifier];
...
- (void)providersChanged
{
  ...
  id v13 = +[DOCManagedPermission defaultPermission];
...
- (void)sourceObserverQueue_didReceiveSourceUpdate
{
  ...
  if ([(DOCSourceObserver *)self hasReceivedFirstFullUpdate])
  {
    ...
    uint64_t v6 = [(DOCSourceObserver *)self actionManagersFromSources];
...
- (id)_addSubscriberForConfiguration:(id)a3 usingBlock:(id)a4
{
  id v6 = a3;
  id v7 = a4;
  id v8 = objc_alloc_init(DOCSourceObserverToken);
  objc_initWeak(&location, self);
  id v9 = [(DOCSourceObserver *)self sourceObserverQueue];
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_1000705A8;
  block[3] = &unk_1006893C0;
...
- (DOCSourceObserver)initWithUserAction:(unint64_t)a3 hostIdentifier:(id)a4
{
  ...
  id v7 = [(DOCSourceObserver *)&v31 init];
  if (v7)
  {
    ...
    long long v14 = [[DOCSourceBuilder alloc] initWithUserAction:a3 hostIdentifier:v6];
    sourceBuilder = v7->_sourceBuilder;
    v7->_sourceBuilder = v14;

    long long v16 = objc_alloc_init(_TtC5Files16DOCActionManager);
    ...
    long long v23 = +[NSOperationQueue mainQueue];
  ...
  if (v5)
  {
    ...
    do
    {
      for (i = 0; i != v6; i = (char *)i + 1)
      {
        ...
        {
          dispatch_queue_t v10 = [v9 actionManager];
          [v3 addObject:v10];
        }
      }
...
- (void)notifySubscriber:(id)a3
{
  ...
  if (v5)
  {
    ...
    id v6 = v4;
    id v18 = v6;
    uint64_t v7 = +[NSPredicate predicateWithBlock:v17];
    id v8 = [(DOCSourceObserver *)self sources];
    id v9 = [v8 filteredArrayUsingPredicate:v7];

    dispatch_queue_t v10 = [v6 block];
    id v11 = [v6 token];
    uint64_t v12 = [(DOCSourceObserver *)self sourcesObserverError];
  ...
  if (v6)
  {
    ...
    while (2)
    {
      for (i = 0; i != v6; i = (char *)i + 1)
      {
        ...
        id v9 = *(void **)(*((void *)&v13 + 1) + 8 * i);
        dispatch_queue_t v10 = [v9 identifier];
...
- (void)removeSubscriberForToken:(id)a3
{
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_1000E7B48;
  block[3] = &unk_100689410;
...
{
  id v4 = a3;
  uint64_t v5 = [(DOCSourceObserver *)self providerNodes];
...
- (void)stopObservingLegacyPickers
{
  id v3 = [(DOCSourceObserver *)self legacyPickersObserverContext];
...
- (id)cachedDisplayNameForSourceIdentifier:(id)a3
{
  ...
  unsigned __int8 v6 = [v5 dictionaryForKey:DOCUserDefaultsCachedDisplayNamesBySourceIdentifier];
