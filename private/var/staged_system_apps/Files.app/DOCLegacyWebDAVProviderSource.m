...
- (void)dealloc
{
  ...
  *(void *)(v4 + 16) = v3;
  aBlock[4] = sub_10048C8B8;
  aBlock[5] = v4;
  aBlock[0] = _NSConcreteStackBlock;
  aBlock[1] = 1107296256;
  aBlock[2] = sub_1000666D8;
  aBlock[3] = &unk_1006AEF40;
...
- (void).cxx_destruct
{
  v3 = *(void **)&self->super.DOCDocumentSource_opaque[OBJC_IVAR____TtC5Files29DOCLegacyWebDAVProviderSource_fileManager];
}
...
- (void)dataForCollectionShouldBeReloaded:(id)a3
{
  id v4 = a3;
  v5 = self;
  sub_10048C614("WebDAV collection was reloaded. Setting is ejectable to true");
}
...
- (void)collection:(id)a3 didPerformBatchUpdateWithReplayBlock:(id)a4
{
  ...
  id v7 = a3;
  objc_super v8 = self;
  sub_10048C614("WebDAV collection was updated. Setting is ejectable to true");
  _Block_release(v6);
}
