...
- (void)updatePreferredDisplayModeFromPersistentStore
{
  if (![(DOCSplitBrowserViewController *)self _sidebarVisibilityPinnedToWindowSizingOnly])
  {
    ...
    else
    {
      ...
      int64_t v6 = [v4 interfaceStateForConfiguration:v5];
...
- (BOOL)isCollapsed
{
  if (([(id)objc_opt_class() disableWorkaroundFor124376396] & 1) != 0
    || ([(DOCSplitBrowserViewController *)self doc_splitViewStateTransitionEnd],
        (unint64_t v3 = objc_claimAutoreleasedReturnValue()) == 0))
  {
    if (+[DOCFeature _UIPTabInfrastructureEnabled](DOCFeature, "_UIPTabInfrastructureEnabled")&& (-[DOCSplitBrowserViewController traitCollection](self, "traitCollection"), objc_super v7 = objc_claimAutoreleasedReturnValue(), v8 = [v7 horizontalSizeClass], v7, v8 == (id)1))
    {
      return 1;
    }
    else
...
- (DOCSplitBrowserViewController)initWithConfiguration:(id)a3 sourceObserver:(id)a4
{
  ...
  objc_super v9 = [(DOCSplitBrowserViewController *)&v75 initWithStyle:1];
  v10 = v9;
  if (v9)
  {
    id v66 = v8;
    ...
    v26 = [[_TtC5Files24DOCSidebarViewController alloc] initWithConfiguration:v25 sourceObserver:*p_sourceObserver];
    ...
    v36 = objc_alloc_init(_TtC5Files34DOCSidebarPaneNavigationController);
            ...
            for (i = 0; i != v43; i = (char *)i + 1)
            {
              ...
              if (!v49)
              {
                ...
                if (os_log_type_enabled(v53, OS_LOG_TYPE_ERROR)) {
                  sub_100583750((uint64_t)v46, (uint64_t)v50, v53);
                }
...
LABEL_23:
        ...
        v57 = [_TtC5Files16DOCPickerContext alloc];
        v58 = v57;
        if (v54 == v56)
        {
      ...
      {
        v51 = [_TtC5Files16DOCPickerContext alloc];
...
- (void)updateDisplayModeButtonVisibility
{
  if (![(DOCSplitBrowserViewController *)self _sidebarVisibilityPinnedToWindowSizingOnly])
  {
    ...
    if ([(DOCConfiguration *)self->_configuration isPickerUI])
    {
      id v7 = [(DOCSplitBrowserViewController *)self traitCollection];
...
- (int64_t)_customPreferredSplitBehavior_EmbeddedScreen
{
  unsigned int v3 = (char *)[(DOCSplitBrowserViewController *)self doc_deprecated_interfaceOrientation];
  unsigned int v4 = (char *)[(DOCSplitBrowserViewController *)self _rotatingToInterfaceOrientation];
  if (v4) {
    unsigned int v3 = v4;
  }
  if ([(DOCConfiguration *)self->_configuration isPickerUI]) {
...
- (void)saveUserPrefersSidebarHidden:(BOOL)a3
{
  ...
  int v5 = +[DOCUserInterfaceStateStore sharedStore];
  uint64_t v6 = [v5 interfaceStateForConfiguration:v8];
  if (v6)
  {
...
- (void)setPickerContext:(id)a3
{
  int v5 = (_TtC5Files16DOCPickerContext *)a3;
...
- (void)configureUIPDocumentLandingStyleIfNecessary
{
  ...
  int v5 = +[UIColor _splitViewBorderColor];
...
- (void)viewDidLoad
{
  ...
  int v5 = [(DOCSplitBrowserViewController *)self view];
  objc_super v6 = v5;
  if (v4) {
  ...
  v20 = v8;
  unsigned int v9 = +[NSArray arrayWithObjects:&v20 count:1];
  ...
  uint64_t v10 = [(DOCSplitBrowserViewController *)self fullDocumentManagerViewController];
  [(DOCSplitBrowserViewController *)self setViewController:v10 forColumn:2];

  uint64_t v11 = [(DOCSplitBrowserViewController *)self fullDocumentManagerViewController];
  [(DOCSplitBrowserViewController *)self setViewController:v11 forColumn:3];

  [(DOCFullDocumentManagerViewController *)self->_fullDocumentManagerViewController addObserver:self forKeyPath:@"editing" options:1 context:off_1007049D8];
  [(DOCSidebarViewController *)self->_sidebarViewController addObserver:self forKeyPath:@"editing" options:1 context:off_1007049D8];
  id v12 = [[_TtC5Files24DOCContentDimmingOverlay alloc] initForCovering:self->_sidebarNavigationController];
  ...
  id v16 = [[_TtC5Files24DOCContentDimmingOverlay alloc] initForCovering:self->_fullDocumentManagerViewController];
...
- (void)viewWillDisappear:(BOOL)a3
{
  ...
  int v5 = [(DOCSplitBrowserViewController *)self sidebarViewController];
  [v5 setEditing:0];
}
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  int v5 = [(DOCSplitBrowserViewController *)self itemToFocusDuringAppearance];
...
- (void)observeValueForKeyPath:(id)a3 ofObject:(id)a4 change:(id)a5 context:(void *)a6
{
  long long v10 = (_TtC5Files24DOCSidebarViewController *)a4;
  if (off_1007049D8 == a6)
  {
...
- (void)updateContentEditingOverlaysForState:(id)a3
{
  ...
  {
    objc_super v6 = [(DOCFullDocumentManagerViewController *)self->_fullDocumentManagerViewController effectiveBrowserViewController];
  ...
  objc_super v8 = [(DOCContentDimmingOverlay *)self->_sourcesOverlay superview];

  if (v8)
  {
    long long v9 = [(DOCContentDimmingOverlay *)self->_sourcesOverlay superview];
    [v9 bringSubviewToFront:self->_sourcesOverlay];
  }
  [(DOCContentDimmingOverlay *)self->_browserOverlay setActive:v4];
  long long v10 = [(DOCContentDimmingOverlay *)self->_browserOverlay superview];

  if (v10)
  {
    unsigned __int8 v11 = [(DOCContentDimmingOverlay *)self->_browserOverlay superview];
...
- (void)dealloc
{
  ...
  {
    BOOL v3 = [(DOCSplitBrowserViewController *)self fullDocumentManagerViewController];
...
- (void)showSidebarAnimated:(BOOL)a3 withCompletion:(id)a4
{
  ...
  if ([(DOCSplitBrowserViewController *)self isCollapsed])
  {
    ...
    objc_super v8 = [(DOCSplitBrowserViewController *)self fullDocumentManagerViewController];
    long long v9 = [v8 transitionCoordinator];

    if (!v9)
    {
LABEL_6:
      long long v9 = [(DOCSplitBrowserViewController *)self _definiteTransitionCoordinator];
    }
  }
  else
  {
    long long v10 = [(DOCSplitBrowserViewController *)self doc_splitViewState];
    ...
    long long v9 = [(DOCSplitBrowserViewController *)self transitionCoordinator];
    if (!v9) {
      goto LABEL_6;
    }
  }
  ...
  id v14 = v6;
  id v12 = v6;
  [v9 animateAlongsideTransition:&stru_100688F40 completion:v13];
}
...
- (void)hideSidebar
{
  BOOL v3 = [(DOCSplitBrowserViewController *)self doc_splitViewState];
...
- (id)preferredFocusEnvironments
{
  BOOL v3 = [(DOCSplitBrowserViewController *)self itemToFocusDuringAppearance];
  ...
  objc_super v8 = +[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", v5, 1, v10, v11, v12);
...
- (void)_splitViewController:(id)a3 animateTransitionToStateRequest:(id)a4 detailSize:(CGSize)a5 duration:(double)a6
{
  ...
  id v12 = [v11 preferredNavigationBarStyle_objc];
...
- (void)willTransitionToTraitCollection:(id)a3 withTransitionCoordinator:(id)a4
{
  id v6 = a4;
  id v7 = a3;
  objc_super v8 = [(DOCSplitBrowserViewController *)self doc_splitViewState];
  ...
  id v9 = v8;
  id v10 = [v9 withIsCollapsed:[v7 horizontalSizeClass] == (id)1];
...
- (void)viewWillTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
  ...
  if (!v7)
  {
    objc_super v8 = [(DOCSplitBrowserViewController *)self _definiteTransitionCoordinator];
  }
...
- (void)clearSplitViewStateTransitionStateIfNecessary
{
  ...
  {
    BOOL v3 = [(DOCSplitBrowserViewController *)self doc_splitViewStateTransitionStart];
...
{
  id v6 = a3;
  id v7 = [(DOCSplitBrowserViewController *)self transitionCoordinator];
  if (v7) {
  ...
  id v9 = [(DOCSplitBrowserViewController *)self _activeTransitionCoordinator];
  BOOL v27 = v9 != 0;
  if (!v9)
  {
    id v9 = [(DOCSplitBrowserViewController *)self _definiteTransitionCoordinator];
  }
  ...
  id v15 = [v14 withIsCollapsed:[v6 isCollapsed]];
...
- (int64_t)splitViewController:(id)a3 topColumnForCollapsingToProposedTopColumn:(int64_t)a4
{
  ...
  id v7 = [(DOCSplitBrowserViewController *)self viewControllerForColumn:0];
  id v8 = self;
  ...
  if (a3 || [(DOCSplitBrowserViewController *)self isCollapsed])
  {
    if ([(DOCSplitBrowserViewController *)self includeSidebarInCollapsedNavStack])
    {
      ...
      if (v6 != v5)
      {
        ...
        id v7 = [(DOCSplitBrowserViewController *)self sidebarViewController];
...
- (int64_t)splitViewController:(id)a3 displayModeForExpandingToProposedDisplayMode:(int64_t)a4
{
  ...
  [v18 doc_removeFromParentWithRemoveSubviewBlock:0];
...
- (id)targetForAction:(SEL)a3 withSender:(id)a4
{
  ...
  if (v18)
  {
    ...
    objc_super v14 = (void *)_bridgeAnythingToObjectiveC<A>(_:)();
