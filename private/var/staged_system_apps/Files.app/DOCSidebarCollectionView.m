...
- (_TtC5Files24DOCSidebarCollectionView)initWithCoder:(id)a3
{
  ...
  *((unsigned char *)&self->super.super.super.super.super.isa
  ...
  result = (_TtC5Files24DOCSidebarCollectionView *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
- (id)dequeueReusableCellWithReuseIdentifier:(id)a3 forIndexPath:(id)a4
{
  ...
  objc_super v12 = self;
  v13 = (void *)sub_1004690E8(v9, v11, (uint64_t)v8);
...
- (void)touchesEnded:(id)a3 withEvent:(id)a4
{
  ...
  uint64_t v6 = OBJC_IVAR____TtC5Files24DOCSidebarCollectionView_isHandlingTouchesEndedCount;
  ...
  {
    *(Class *)((char *)&self->super.super.super.super.super.isa
             + OBJC_IVAR____TtC5Files24DOCSidebarCollectionView_isHandlingTouchesEndedCount) = v9;
    id v10 = a4;
    uint64_t v11 = self;
