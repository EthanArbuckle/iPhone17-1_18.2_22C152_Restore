...
- (CHFriendEmptyListView)initWithOutgoingInvites:(unint64_t)a3
{
  ...
  if (v7)
  {
    ...
    v11 = [v10 localizedStringForKey:@"SHARING_SETUP_TITLE" value:&stru_1008D8AB8 table:@"Localizable"];
    ...
    id v19 = objc_alloc_init((Class)UILayoutGuide);
...
- (void)updateOutgoingInvites:(unint64_t)a3
{
  id v4 = [(CHFriendEmptyListView *)self _descriptionForOutgoingInvites:a3];
...
- (id)_descriptionForOutgoingInvites:(unint64_t)a3
{
  ...
  v5 = v4;
  if (a3) {
    CFStringRef v6 = @"SHARING_LIST_PENDING";
  }
  else {
    CFStringRef v6 = @"SHARING_LIST_EMPTY";
  }
  v7 = [v4 localizedStringForKey:v6 value:&stru_1008D8AB8 table:@"Localizable"];
