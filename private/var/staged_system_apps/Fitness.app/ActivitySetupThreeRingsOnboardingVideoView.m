...
- (_TtC10FitnessApp42ActivitySetupThreeRingsOnboardingVideoView)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.super.isa
  ...
  CGSize result = (_TtC10FitnessApp42ActivitySetupThreeRingsOnboardingVideoView *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
- (_TtC10FitnessApp42ActivitySetupThreeRingsOnboardingVideoView)initWithFrame:(CGRect)a3
{
  CGSize result = (_TtC10FitnessApp42ActivitySetupThreeRingsOnboardingVideoView *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
