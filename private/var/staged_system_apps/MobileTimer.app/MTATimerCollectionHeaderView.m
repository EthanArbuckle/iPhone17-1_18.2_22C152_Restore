...
- (void)setupHeaderTitle
{
  ...
  objc_super v6 = [(MTATimerCollectionHeaderView *)self headerTitle];
  ...
  id v9 = [(MTATimerCollectionHeaderView *)self headerTitle];
...
- (void)setupConstraints
{
  ...
  id v9 = [(MTATimerCollectionHeaderView *)self trailingAnchor];
