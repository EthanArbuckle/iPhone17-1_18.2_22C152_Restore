@interface MTATimerTipCollectionViewCell
...
@implementation MTATimerTipCollectionViewCell

- (void)prepareForReuse
{
  v4.receiver = self;
  v4.super_class = (Class)MTATimerTipCollectionViewCell;
  [(MTATimerTipCollectionViewCell *)&v4 prepareForReuse];
...
- (void)setSiriTipView:(id)a3
{
  ...
  if (siriTipView != v5)
  {
    ...
    if (v5)
    {
      ...
      v9 = [(MTATimerTipCollectionViewCell *)self contentView];
