...
- (MTAStopwatchLapTableHeaderView)initWithFrame:(CGRect)a3
{
  ...
  if (v3)
  {
    ...
    v13 = [v12 localizedStringForKey:@"STOPWATCH_LAP_HEADER" value:&stru_1000A2560 table:0];
    ...
    v21 = [v20 localizedStringForKey:@"STOPWATCH_SPLIT_HEADER" value:&stru_1000A2560 table:0];
    ...
    v29 = [v28 localizedStringForKey:@"STOPWATCH_TOTAL_HEADER" value:&stru_1000A2560 table:0];
...
- (void)_updateForContentSizeChange
{
  id v12 = [(MTAStopwatchLapTableHeaderView *)self labelFont];
...
- (void)setupConstraints
{
  ...
  double v6 = [(MTAStopwatchLapTableHeaderView *)self bottomKeylineView];
  [v6 setTranslatesAutoresizingMaskIntoConstraints:0];

  id v56 = (id)objc_opt_new();
  double v7 = [(MTAStopwatchLapTableHeaderView *)self lapNumberLabel];
  v8 = [v7 leadingAnchor];
  double v9 = [(MTAStopwatchLapTableHeaderView *)self leadingAnchor];
  double v10 = [v8 constraintEqualToAnchor:v9];
  [v56 addObject:v10];

  v11 = [(MTAStopwatchLapTableHeaderView *)self labelFont];
  id v12 = [(MTAStopwatchLapTableHeaderView *)self lapNumberLabel];
  ...
  id v18 = [(MTAStopwatchLapTableHeaderView *)self lapNumberLabel];
  ...
  id v26 = [(MTAStopwatchLapTableHeaderView *)self splitLabel];
  ...
  objc_super v40 = [(MTAStopwatchLapTableHeaderView *)self bottomKeylineView];
