...
- (_TtC7Measure23SCNSegmentationDebugger)initWithCoder:(id)a3
{
  ...
  *(Class *)((char *)&self->super.super.isa
  ...
  result = (_TtC7Measure23SCNSegmentationDebugger *)_assertionFailure(_:_:file:line:flags:)();
  __break(1u);
  return result;
}
...
- (_TtC7Measure23SCNSegmentationDebugger)init
{
  result = (_TtC7Measure23SCNSegmentationDebugger *)_swift_stdlib_reportUnimplementedInitializer();
  __break(1u);
  return result;
}
