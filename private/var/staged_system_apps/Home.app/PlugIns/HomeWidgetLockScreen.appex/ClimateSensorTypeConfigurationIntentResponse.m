...
- (ClimateSensorTypeConfigurationIntentResponse)initWithCoder:(id)a3
{
  return (ClimateSensorTypeConfigurationIntentResponse *)sub_10006CE98((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithCoder_);
}

- (ClimateSensorTypeConfigurationIntentResponse)initWithBackingStore:(id)a3
{
  return (ClimateSensorTypeConfigurationIntentResponse *)sub_10006CE98((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithBackingStore_);
}
