...
- (SecurityAccessoryConfigurationIntentResponse)initWithCoder:(id)a3
{
  return (SecurityAccessoryConfigurationIntentResponse *)sub_10006C2AC((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithCoder_);
}

- (SecurityAccessoryConfigurationIntentResponse)initWithBackingStore:(id)a3
{
  return (SecurityAccessoryConfigurationIntentResponse *)sub_10006C2AC((char *)self, (uint64_t)a2, (uint64_t)a3, (SEL *)&selRef_initWithBackingStore_);
}

- (SecurityAccessoryConfigurationIntentResponse)initWithPropertiesByName:(id)a3
{
  if (a3) {
    uint64_t v3 = sub_10006F478();
  }
  else {
    uint64_t v3 = 0;
  }
