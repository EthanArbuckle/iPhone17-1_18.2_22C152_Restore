...
{
  id v4 = a3;
  id v5 = [(HomeNotificationStatusView *)self statusLabel];
  [v5 setText:v4];
}
...
{
  id v4 = a3;
  id v5 = [(HomeNotificationStatusView *)self accessoryImage];
  BOOL v6 = v5 == 0;
...
- (void)updateConstraints
{
  ...
  id v5 = [(HomeNotificationStatusView *)self bottomAnchor];
  BOOL v6 = [v4 constraintEqualToAnchor:v5 constant:-10.0];
  v36[1] = v6;
  ...
  id v12 = [(HomeNotificationStatusView *)self accessoryImage];
